...
from open_webui.utils.oauth import (
    OAuthClientInformationFull, decrypt_data, encrypt_data, get_discovery_urls,
    get_oauth_client_info_with_dynamic_client_registration,
    get_oauth_client_info_with_static_credentials, resolve_oauth_client_info)
from open_webui.utils.tools import (get_tool_server_data, get_tool_server_url,
                                    set_terminal_servers, set_tool_servers)
...
async def register_oauth_client(
    ...
    try:
        ...
        if form_data.client_secret:
            # Static credentials: skip dynamic registration, build from
